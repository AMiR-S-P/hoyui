...
import { createElement, isVisible } from '@hoyui/base';
import { EventHandler, Browser } from '@hoyui/base';
...
describe('Tooltip Control', () => {
  ...
  describe('Dom tooltip element', () => {
    ...
    it('Control class testing', () => {
      ...
      expect(
        document.getElementById('tstooltip').classList.contains('e-tooltip')
      ).toEqual(true);
    });
    ...
    it('isSticky at property change', () => {
      ...
      tooltip.dataBind();
      let element1: HTMLElement = document.querySelector(
        '.e-tooltip-wrap'
      ) as HTMLElement;
      ...
      tooltip = new Tooltip(
        {
          ...
          content:
            'Tooltip Content<style>body{background:rgb(0, 0, 255)}</style>',
        },
        '#tstooltip'
      );
      tooltip.open(document.getElementById('tstooltip')); // Open the tooltip based on target element specified in optional parameter
      ...
      tooltip = new Tooltip(
        {
          ...
          content: 'Tooltip Content<style>body{background:blue}</style>',
        },
        '#tstooltip'
      );
      tooltip.open(document.getElementById('tstooltip')); // Open the tooltip based on target element specified in optional parameter
    ...
    it('enableHtmlSanitizer as false and content as HtmlElement', () => {
      var tipcontent = createElement('p', {
        innerHTML:
          'tooltip content from html<style>body{background:rgb(0, 0, 255)}</style>',
      });
      tooltip = new Tooltip(
        {
          enableHtmlSanitizer: false,
    ...
    it('Tooltip content html testing', () => {
      let tipcontent: HTMLElement = createElement('p', {
        innerHTML: 'tooltip content from html',
      });
      tooltip = new Tooltip(
        {
          animation: { open: { effect: 'None' }, close: { effect: 'None' } },
      ...
      expect(element.querySelector('.e-tip-content').innerHTML).toEqual(
        '<p>tooltip content from html</p>'
      );
      tooltip.refresh();
      expect(element.querySelector('.e-tip-content').innerHTML).toEqual(
        '<p>tooltip content from html</p>'
  ...
  describe('Dom tooltip title attribute', () => {
    ...
    beforeEach((): void => {
      ...
      let ele1: HTMLElement = createElement('div', {
        id: 'targetContainer',
        innerHTML:
          "<button id='btn' >X</button><div id='descriptionClose'>Closing this window will discard any information entered and return you back to the main page</div>",
      });
    ...
    it('aria role and title attribute test cases', () => {
      ...
      expect(target.getAttribute('data-content')).toEqual(
      ...
      tooltip.close();
      expect(target.getAttribute('title')).toEqual(
        'tooltip with title attribute'
      );
    });
    it('aria describedby and target dimension less than tooltip test cases', () => {
      ...
      tooltip.open(target);
      let tooltipEle: HTMLElement = document.querySelector(
        '.e-tooltip-wrap'
      ) as HTMLElement;
  ...
  describe('Tooltip Mouse hover events', () => {
      ...
      tooltip = new Tooltip(
        {
          ...
          height: '50px',
          content: 'Tooltip Content',
          beforeRender: tooltipFunction,
          beforeOpen: tooltipFunction,
          beforeClose: tooltipFunction,
          afterClose: tooltipFunction,
          afterOpen: tooltipFunction,
        },
        '#tstooltip'
      );
      let target: HTMLElement = document.getElementById('tstooltip');
    ...
    it('Mouse hover over tooltip itself with closeDelay', (done) => {
      ...
      setTimeout(function () {
        expect(
          document.querySelector('.e-tooltip-wrap') as HTMLElement
        ).toBeNull();
  ...
  describe('Tooltip Focus events', () => {
    ...
    it('focus event for dynamically added button element testing', () => {
      let btn1: HTMLElement = createElement('div', {
        id: 'div1',
        innerHTML:
          "<button id='tooltip1' class='btn' title='Content 1'>tooltip1</button>",
      });
      let btn2: HTMLElement = createElement('button', {
        id: 'tooltip2',
        attrs: { title: 'Content 2' },
      });
      ...
      expect(
        (document.querySelector('.e-tip-content') as HTMLElement).innerHTML
      ).toEqual('Content 2');
    });
  });
  ...
  describe('Tooltip with multiple target', () => {
    ...
    it('dynamically added target testing', () => {
      ...
      let childEle: HTMLElement = createElement('div', {
        ...
        innerHTML: 'Dynamicall added target',
      });
  ...
  describe('Tooltip and tip positions', () => {
    ...
    it('TopLeft position testing', () => {
      ...
      expect(
        tooltipEle
          .querySelector('.e-arrow-tip')
          .classList.contains('e-tip-bottom')
      ).toEqual(true);
      triggerMouseEvent(target1, 'mouseleave');
    });
    ...
    it('BottomRight position testing', () => {
      ...
      expect(
        tooltipEle.querySelector('.e-arrow-tip').classList.contains('e-tip-top')
      ).toEqual(true);
      triggerMouseEvent(target1, 'mouseleave');
    });
    ...
    it('LeftBottom position testing', () => {
      ...
      expect(
        tooltipEle
          .querySelector('.e-arrow-tip')
          .classList.contains('e-tip-right')
      ).toEqual(true);
      triggerMouseEvent(target1, 'mouseleave');
    });
  ...
  describe('tooltip container collision scenario test cases', () => {
    ...
    it('windowCollision with collision affected position - left and top', () => {
      ...
      elem.innerHTML =
        '<div id="targetContainer" style="height: 400px;width: 400px;background: #4e699c;margin: 100px 0px 50px 165px;float: left;overflow: scroll;position: relative;"><div id="target" style="height: 100px;width: 100px;background: #af0404;float: left;">Tooltip target</div></div>';
      document.body.appendChild(elem.firstChild);
      tooltip = new Tooltip(
        {
          animation: { open: { effect: 'None' }, close: { effect: 'None' } },
          position: 'LeftTop',
          content: 'collision left and top',
          target: '#target',
    ...
    it('Tooltip popup reposition mock teste for windowResize event', () => {
      let elem: HTMLDivElement = document.createElement('div');
      elem.innerHTML =
        '<div id="targetContainer" style="height: 400px;width: 400px;background: #4e699c;margin: 100px 0px 50px 165px;float: left;overflow: scroll;position: relative;"><div id="target" style="height: 100px;width: 100px;background: #af0404;float: left;position:relative;">Tooltip target</div></div>';
      document.body.appendChild(elem.firstChild);
      tooltip = new Tooltip(
        {
          animation: { open: { effect: 'None' }, close: { effect: 'None' } },
      ...
      tooltip.open();
      expect(
        (document.getElementsByClassName('e-popup')[0] as any).offsetLeft
      ).toEqual(168);
      let target1: HTMLElement = document.getElementById('target');
    ...
    it('collision affected position - left and center', () => {
      let elem: HTMLDivElement = document.createElement('div');
      elem.innerHTML =
        '<div id="targetContainer" style="height: 400px;width: 400px;background: #4e699c;margin: 100px 0px 50px 165px;float: left;overflow: scroll;position: relative;"><div id="target" style="height: 100px;width: 100px;background: #af0404;float: left;position:absolute;left:0px;top:150px;">Tooltip target</div></div>';
      document.body.appendChild(elem.firstChild);
      tooltip = new Tooltip(
        {
          animation: { open: { effect: 'None' }, close: { effect: 'None' } },
          position: 'LeftCenter',
          content: 'collision left and center',
          target: '#target',
        },
        '#targetContainer'
      );
    ...
    it('collision affected position - left and bottom', () => {
      let elem: HTMLDivElement = document.createElement('div');
      elem.innerHTML =
        '<div id="targetContainer" style="height: 400px;width: 400px;background: #4e699c;margin: 100px 0px 50px 165px;float: left;overflow: scroll;position: relative;"><div id="target" style="height: 100px;width: 100px;background: #af0404;float: left;position:absolute;left:0px;top:300px;">Tooltip target</div></div>';
      document.body.appendChild(elem.firstChild);
      tooltip = new Tooltip(
        {
          animation: { open: { effect: 'None' }, close: { effect: 'None' } },
          position: 'LeftBottom',
          content: 'collision left and bottom',
          target: '#target',
        },
        '#targetContainer'
      );
    ...
    it('collision affected position - right and top', () => {
      let elem: HTMLDivElement = document.createElement('div');
      elem.innerHTML =
        '<div id="targetContainer" style="height: 400px;width: 400px;background: #4e699c;margin: 100px 0px 50px 165px;float: left;overflow: scroll;position: relative;"><div id="target" style="height: 100px;width: 100px;background: #af0404;float: left;position:absolute;left:300px;top:0px;">Tooltip target</div></div>';
      document.body.appendChild(elem.firstChild);
      tooltip = new Tooltip(
        {
          animation: { open: { effect: 'None' }, close: { effect: 'None' } },
          position: 'RightTop',
          content: 'collision right and top',
          target: '#target',
        },
        '#targetContainer'
      );
    ...
    it('collision affected position - right and center', () => {
      let elem: HTMLDivElement = document.createElement('div');
      elem.innerHTML =
        '<div id="targetContainer" style="height: 400px;width: 400px;background: #4e699c;margin: 100px 0px 50px 165px;float: left;overflow: scroll;position: relative;"><div id="target" style="height: 100px;width: 100px;background: #af0404;float: left;position:absolute;left:300px;top:120px;">Tooltip target</div></div>';
      document.body.appendChild(elem.firstChild);
      tooltip = new Tooltip(
        {
          animation: { open: { effect: 'None' }, close: { effect: 'None' } },
          position: 'RightCenter',
          content: 'collision right and center',
          target: '#target',
        },
        '#targetContainer'
      );
    ...
    it('collision affected position - right and bottom', () => {
      let elem: HTMLDivElement = document.createElement('div');
      elem.innerHTML =
        '<div id="targetContainer" style="height: 400px;width: 400px;background: #4e699c;margin: 100px 0px 50px 165px;float: left;overflow: scroll;position: relative;"><div id="target" style="height: 100px;width: 100px;background: #af0404;float: left;position:absolute;left:300px;top:300px;">Tooltip target</div></div>';
      document.body.appendChild(elem.firstChild);
      tooltip = new Tooltip(
        {
          animation: { open: { effect: 'None' }, close: { effect: 'None' } },
          position: 'RightBottom',
          content: 'collision right and bottom',
          target: '#target',
        },
        '#targetContainer'
      );
    ...
    it('collision affected position - top with offset', () => {
      ...
      let tooltipOffset: number =
        tooltipEle.getBoundingClientRect().top -
        tipHeight -
        target1.getBoundingClientRect().bottom;
  ...
  describe('Tooltip client side events', () => {
    ...
    it('after open event without arrow element', () => {
      ...
      let arrowEle: HTMLElement = document.querySelector(
        '.e-arrow-tip'
      ) as HTMLElement;
  ...
  describe('Tooltip sticky mode test cases', () => {
    ...
    it('sticky mode target mouse leave', () => {
      ...
      triggerMouseEvent(target1, 'mouseleave');
      expect(isVisible(tooltipEle)).toBe(true);
      let closeEle: HTMLElement = (<HTMLScriptElement[]>(
        (<any>document.getElementsByClassName('e-tooltip-close'))
      ))[0];
      triggerMouseEvent(closeEle, 'mousedown');
      expect(document.querySelector('.e-tooltip-wrap')).toBeNull();
    });
    it('sticky mode with multiple targets', () => {
      ...
      expect(document.querySelector('.e-tip-content').innerHTML).toEqual(
        'MAScript (or ES) is a trademarked scripting-language specification'
      );
      ...
      tooltip = new Tooltip(
        {
          width: '100px',
          height: '40px',
          animation: { open: { effect: 'FadeIn', duration: 500, delay: 100 } },
        },
        '#tstooltip'
      );
      tooltip.open(document.getElementById('tstooltip')); // Open the tooltip based on target element specified in optional parameter
      ...
      tooltip = new Tooltip(
        {
          ...
          height: '40px',
          animation: {
            close: { effect: 'FadeOut', duration: 500, delay: 100 },
          },
        },
        '#tstooltip'
      );
  ...
  describe('Tooltip property changes', () => {
    ...
    beforeEach((): void => {
      ...
      let elem: HTMLDivElement = document.createElement('div');
      elem.innerHTML =
        '<div id="targetContainer" style="height: 400px;width: 400px;background: #4e699c;margin: 100px 0px 50px 165px;float: left;overflow: scroll;position: relative;"><div id="tstooltip" style="height: 100px;width: 100px;background: #af0404;float: left;position:absolute;left:150px;top:150px;">property changes</div></div>';
      document.body.appendChild(elem.firstChild);
    });
    afterEach((): void => {
      if (tooltip) {
    ...
    it('Position property changes', () => {
      ...
      triggerMouseEvent(target, 'mouseover');
      expect(
        document.querySelector('.e-arrow-tip').classList.contains('e-tip-right')
      ).toEqual(true);
      tooltip.position = 'RightCenter';
      tooltip.dataBind();
      expect(
        document.querySelector('.e-arrow-tip').classList.contains('e-tip-left')
      ).toEqual(true);
      triggerMouseEvent(target, 'mouseleave');
      expect(document.querySelector('.e-tooltip-wrap')).toBeNull();
    });
    ...
    it('offsetX and offsetY properties changes', () => {
      ...
      let x: number = parseInt(
        (<HTMLElement>document.querySelector('.e-tooltip-wrap')).style.left,
        10
      );
      let y: number = parseInt(
        (<HTMLElement>document.querySelector('.e-tooltip-wrap')).style.top,
        10
      );
      tooltip.offsetX = 20;
      tooltip.offsetY = 20;
  ...
  describe('Tooltip public method test cases', () => {
    ...
    it('change height and width dynamically test cases', () => {
      ...
      tooltip.open(document.getElementById('tstooltip')); // Open the tooltip based on target element specified in optional parameter
      let tip: HTMLElement = document.querySelector(
        '.e-arrow-tip'
      ) as HTMLElement;
    ...
    it('public method close test case with empty target', function (done) {
      ...
      tooltip.close();
      setTimeout(function () {
        expect(document.querySelector('.e-tooltip-wrap') as HTMLElement).toBe(
          null
        );
        done();
      }, 500);
  ...
  describe('Scroll event test cases', () => {
    ...
    beforeEach((): void => {
      ...
      let elem: HTMLDivElement = document.createElement('div');
      elem.innerHTML =
        '<div id="targetContainer" style="height: 2000px;"><span id="tstooltip">Hover Me</span></div>';
      document.body.appendChild(elem.firstChild);
    });
    afterEach((): void => {
      if (tooltip) {
  ...
  describe('Tooltip should not close on hover on the content element', () => {
    ...
    it('Mouse hover event testing', () => {
      ...
      expect(isVisible(tooltipEle)).toBe(true);
      const positions = tooltipEle
        .getElementsByClassName('e-tip-content')[0]
  ...
  describe('Tooltip within container', () => {
    ...
    beforeEach((): void => {
      ...
      let container1: HTMLElement = createElement('div', {
        id: 'container1',
        styles: 'height:300px; width:300px;',
      });
      let ele: HTMLElement = createElement('div', {
        id: '1tooltip',
        innerHTML: 'Show Tooltip',
        styles: 'margin-top:300px;',
      });
    ...
    it('Check popup finds string selector container', () => {
      ...
      triggerMouseEvent(document.getElementById('1tooltip'), 'mouseover');
      expect(
        document.querySelector('#container').querySelectorAll('.e-tooltip-wrap')
          .length == 1
      ).toBe(true);
      let element: HTMLElement = document
        .querySelector('#container')
        .querySelector('.e-tooltip-wrap') as HTMLElement;
    ...
    it('Check popup changes for dynamic container when Tooltip is open', () => {
      ...
      expect(
        document
          ...
          .querySelectorAll('.e-tooltip-wrap').length == 1
      ).toBe(true);
    });
  ...
  describe('Tooltip Null or undefined value testing ', () => {
    ...
    it('width', () => {
      tooltip = new Tooltip(
        { content: 'Tooltip Content', width: null },
        '#tstooltip'
      );
      tooltip.dataBind();
      ...
      tooltip.destroy();
      tooltip = new Tooltip(
        { content: 'Tooltip Content', width: undefined },
        '#tstooltip'
      );
      tooltip.dataBind();
    ...
    it('height', () => {
      tooltip = new Tooltip(
        { content: 'Tooltip Content', height: null },
        '#tstooltip'
      );
      tooltip.dataBind();
      ...
      tooltip.destroy();
      tooltip = new Tooltip(
        { content: 'Tooltip Content', height: undefined },
        '#tstooltip'
      );
      tooltip.dataBind();
    ...
    it('container', () => {
      tooltip = new Tooltip(
        { content: 'Tooltip Content', container: null },
        '#tstooltip'
      );
      tooltip.dataBind();
      ...
      tooltip.destroy();
      tooltip = new Tooltip(
        { content: 'Tooltip Content', container: undefined },
        '#tstooltip'
      );
      tooltip.dataBind();
    ...
    it('target', () => {
      tooltip = new Tooltip(
        { content: 'Tooltip Content', target: null },
        '#tstooltip'
      );
      tooltip.dataBind();
      ...
      tooltip.destroy();
      tooltip = new Tooltip(
        { content: 'Tooltip Content', target: undefined },
        '#tstooltip'
      );
      tooltip.dataBind();
    ...
    it('opensOn', () => {
      tooltip = new Tooltip(
        { content: 'Tooltip Content', opensOn: null },
        '#tstooltip'
      );
      tooltip.dataBind();
      ...
      tooltip.destroy();
      tooltip = new Tooltip(
        { content: 'Tooltip Content', opensOn: undefined },
        '#tstooltip'
      );
      tooltip.dataBind();
    ...
    it('position', () => {
      tooltip = new Tooltip(
        { content: 'Tooltip Content', position: null },
        '#tstooltip'
      );
      tooltip.dataBind();
      ...
      tooltip.destroy();
      tooltip = new Tooltip(
        { content: 'Tooltip Content', position: undefined },
        '#tstooltip'
      );
      tooltip.dataBind();
    ...
    it('tipPointerPosition', () => {
      tooltip = new Tooltip(
        { content: 'Tooltip Content', tipPointerPosition: null },
        '#tstooltip'
      );
      tooltip.dataBind();
      ...
      tooltip.destroy();
      tooltip = new Tooltip(
        { content: 'Tooltip Content', tipPointerPosition: undefined },
        '#tstooltip'
      );
      tooltip.dataBind();
    ...
    it('offsetX', () => {
      tooltip = new Tooltip(
        { content: 'Tooltip Content', offsetX: null },
        '#tstooltip'
      );
      tooltip.dataBind();
      ...
      tooltip.destroy();
      tooltip = new Tooltip(
        { content: 'Tooltip Content', offsetX: undefined },
        '#tstooltip'
      );
      tooltip.dataBind();
    ...
    it('offsetY', () => {
      tooltip = new Tooltip(
        { content: 'Tooltip Content', offsetY: null },
        '#tstooltip'
      );
      tooltip.dataBind();
      ...
      tooltip.destroy();
      tooltip = new Tooltip(
        { content: 'Tooltip Content', offsetY: undefined },
        '#tstooltip'
      );
      tooltip.dataBind();
    ...
    it('cssClass', () => {
      tooltip = new Tooltip(
        { content: 'Tooltip Content', cssClass: null },
        '#tstooltip'
      );
      tooltip.dataBind();
      ...
      tooltip.destroy();
      tooltip = new Tooltip(
        { content: 'Tooltip Content', cssClass: undefined },
        '#tstooltip'
      );
      tooltip.dataBind();
    ...
    it('windowCollision', () => {
      tooltip = new Tooltip(
        { content: 'Tooltip Content', windowCollision: null },
        '#tstooltip'
      );
      tooltip.dataBind();
      ...
      tooltip.destroy();
      tooltip = new Tooltip(
        { content: 'Tooltip Content', windowCollision: undefined },
        '#tstooltip'
      );
      tooltip.dataBind();
    ...
    it('mouseTrail', () => {
      tooltip = new Tooltip(
        { content: 'Tooltip Content', mouseTrail: null },
        '#tstooltip'
      );
      tooltip.dataBind();
      ...
      tooltip.destroy();
      tooltip = new Tooltip(
        { content: 'Tooltip Content', mouseTrail: undefined },
        '#tstooltip'
      );
      tooltip.dataBind();
    ...
    it('showTipPointer', () => {
      tooltip = new Tooltip(
        { content: 'Tooltip Content', showTipPointer: null },
        '#tstooltip'
      );
      tooltip.dataBind();
      ...
      tooltip.destroy();
      tooltip = new Tooltip(
        { content: 'Tooltip Content', showTipPointer: undefined },
        '#tstooltip'
      );
      tooltip.dataBind();
    ...
    it('isSticky', () => {
      tooltip = new Tooltip(
        { content: 'Tooltip Content', isSticky: null },
        '#tstooltip'
      );
      tooltip.dataBind();
      ...
      tooltip.destroy();
      tooltip = new Tooltip(
        { content: 'Tooltip Content', isSticky: undefined },
        '#tstooltip'
      );
      tooltip.dataBind();
    ...
    it('openDelay', () => {
      tooltip = new Tooltip(
        { content: 'Tooltip Content', openDelay: null },
        '#tstooltip'
      );
      tooltip.dataBind();
      ...
      tooltip.destroy();
      tooltip = new Tooltip(
        { content: 'Tooltip Content', openDelay: undefined },
        '#tstooltip'
      );
      tooltip.dataBind();
    ...
    it('closeDelay', () => {
      tooltip = new Tooltip(
        { content: 'Tooltip Content', closeDelay: null },
        '#tstooltip'
      );
      tooltip.dataBind();
      ...
      tooltip.destroy();
      tooltip = new Tooltip(
        { content: 'Tooltip Content', closeDelay: undefined },
        '#tstooltip'
      );
      tooltip.dataBind();
    ...
    it('htmlAttributes', () => {
      tooltip = new Tooltip(
        { content: 'Tooltip Content', htmlAttributes: null },
        '#tstooltip'
      );
      tooltip.dataBind();
      ...
      tooltip.destroy();
      tooltip = new Tooltip(
        { content: 'Tooltip Content', htmlAttributes: undefined },
        '#tstooltip'
      );
      tooltip.dataBind();
