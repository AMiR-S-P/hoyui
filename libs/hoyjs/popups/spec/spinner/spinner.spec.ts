...
describe('Spinner Control', () => {
  ...
  describe('create simple spinner', () => {
    beforeEach((): void => {
      target = createElement('div', {
        id: 'spinner-01',
        className: 'spinner-demo',
        styles:
          'width: 400px;height: 400px;border: 1px solid red; display: block;position: relative;',
      });
    ...
    it('Ensure element structure and class testing', () => {
      ...
      expect(
        (
          container.querySelector('.e-spinner-pane') as HTMLElement
        ).classList.contains('e-spinner-pane')
      ).toEqual(true);
      let innerObject = <HTMLElement>(
        (container.querySelector('.e-spinner-pane') as HTMLElement)
          .childNodes[0]
      );
      ...
      expect(
        (<HTMLElement>materialObj.childNodes[0]).classList.contains(
          'e-path-circle'
        )
      ).toEqual(true);
    });
    ...
    it('Ensure high contrast theme element structure and class testing', () => {
      ...
      expect(
        highContrastObj.classList.contains('e-spin-high-contrast')
      ).toEqual(true);
      expect(
        (<HTMLElement>highContrastObj.childNodes[0]).classList.contains(
          'e-path-circle'
        )
      ).toEqual(true);
      expect(
        (<HTMLElement>highContrastObj.childNodes[1]).classList.contains(
          'e-path-arc'
        )
      ).toEqual(true);
      expect(
        (<HTMLElement>innerObject.childNodes[1]).classList.contains(
          'e-spin-label'
        )
      ).toEqual(true);
    });
    it('Ensure fabric theme element structure and class testing', () => {
      ...
      expect(
        (<HTMLElement>fabricObj.childNodes[0]).classList.contains(
          'e-path-circle'
        )
      ).toEqual(true);
      expect(
        (<HTMLElement>fabricObj.childNodes[1]).classList.contains('e-path-arc')
      ).toEqual(true);
      expect(
        (<HTMLElement>innerObject.childNodes[1]).classList.contains(
          'e-spin-label'
    ...
    it('Spinner width testing for material', () => {
      ...
      showSpinner(container);
      expect(
        (container.querySelector('.e-spin-material') as HTMLElement).style.width
      ).toEqual('50px');
      expect(
        (container.querySelector('.e-spin-material') as HTMLElement).style
          .height
      ).toEqual('50px');
    });
    it('Spinner width testing for bootstrap4', () => {
      ...
      showSpinner(container);
      expect(
        (container.querySelector('.e-spin-bootstrap4') as HTMLElement).style
          .width
      ).toEqual('50px');
      expect(
        (container.querySelector('.e-spin-bootstrap4') as HTMLElement).style
    ...
    it('Spinner width testing for fabric', () => {
      ...
      showSpinner(container);
      expect(
        (container.querySelector('.e-spin-fabric') as HTMLElement).style.width
      ).toEqual('50px');
      expect(
        (container.querySelector('.e-spin-fabric') as HTMLElement).style.height
      ).toEqual('50px');
    });
    it('Spinner width testing for bootstrap', () => {
      ...
      showSpinner(container);
      expect(
        (container.querySelector('.e-spin-bootstrap') as HTMLElement).style
          .width
      ).toEqual('50px');
      expect(
        (container.querySelector('.e-spin-bootstrap') as HTMLElement).style
    ...
    it('Spinner width testing for high contrast', () => {
      ...
      showSpinner(container);
      expect(
        (container.querySelector('.e-spin-high-contrast') as HTMLElement).style
          .width
      ).toEqual('50px');
      expect(
        (container.querySelector('.e-spin-high-contrast') as HTMLElement).style
    ...
    it('Spinner without label testing', () => {
      ...
      let container = document.getElementById('spinner-01');
      showSpinner(container);
      expect(container.querySelector('.e-spin-label') as HTMLElement).toEqual(
        null
      );
    });
    it('Spinner label testing', () => {
      ...
      showSpinner(container);
      expect(
        (container.querySelector('.e-spin-label') as HTMLElement).innerHTML
      ).toEqual('Loading...');
    });
    it('Spinner cssClass testing', () => {
      ...
      expect(
        (
          container.querySelector('.e-spinner-pane') as HTMLElement
        ).classList.contains('e-custom-spinner')
      ).toEqual(true);
    });
    it('Spinner on the left side of the target', () => {
      ...
      expect(
        (
          container.querySelector('.e-spinner-pane') as HTMLElement
        ).classList.contains('e-spin-left')
      ).toEqual(true);
      let axis = (<HTMLElement>(
        (container.querySelector('.e-spinner-pane') as HTMLElement)
          .childNodes[0]
    ...
    it('Spinner on the right side of the target', () => {
      ...
      expect(
        (
          container.querySelector('.e-spinner-pane') as HTMLElement
        ).classList.contains('e-spin-right')
      ).toEqual(true);
      let axis = (<HTMLElement>(
        (container.querySelector('.e-spinner-pane') as HTMLElement)
          .childNodes[0]
    ...
    it('Add overlay to the spinner', () => {
      ...
      expect(
        (
          container.querySelector('.e-spinner-pane') as HTMLElement
        ).classList.contains('e-spin-overlay')
      ).toEqual(true);
    });
    it('Spinner rendered with template content', () => {
      let spinObject = createSpinner({
        ...
        label: 'Loading...',
        template:
          '<h4> Template Content </h4> <span class="custom-spinner"></span>',
      });
      let container = document.getElementById('spinner-01');
      showSpinner(container);
      expect(container.querySelector('.custom-spinner')).not.toBeNull();
      expect(
        container.querySelector('.e-spin-material') as HTMLElement
      ).toBeNull();
      expect(
        container.querySelector('.e-spin-fabric') as HTMLElement
      ).toBeNull();
    });
  });
  ...
  describe('Spinner public methods', () => {
    ...
    it('Ensure show and hide spinner testing', () => {
      ...
      expect(
        (
          container1.querySelector('.e-spinner-pane') as HTMLElement
        ).classList.contains('e-spin-show')
      ).toEqual(true);
      hideSpinner(container);
      expect(
    ...
    it('Ensure set spinner testing', () => {
      ...
      expect(
        (
          container.querySelector('.e-spinner-pane') as HTMLElement
        ).classList.contains('e-spin-custom')
      ).toEqual(true);
      expect(
        (
          container1.querySelector('.e-spinner-pane') as HTMLElement
      ...
      expect(
        container1.querySelector('.e-spin-material') as HTMLElement
      ).toBeNull();
      expect(
        container1.querySelector('.e-spin-fabric') as HTMLElement
      ).toBeNull();
    });
    ...
    it('Ensure set spinner testing', () => {
      ...
      expect(
        (
          container.querySelector('.e-spinner-pane') as HTMLElement
        ).querySelector('.e-spin-material') as HTMLElement
      ).toBeNull();
      expect(
        (
          container.querySelector('.e-spinner-pane') as HTMLElement
        ).querySelector('.e-spin-fabric') as HTMLElement
      ).toBeNull();
      expect(
        (
          container1.querySelector('.e-spinner-pane') as HTMLElement
    ...
    it('Ensure set spinner testing for material to bootstrap', () => {
      ...
      expect(
        container.querySelector('.e-spin-bootstrap') as HTMLElement
      ).not.toBeNull();
      expect(
        container1.querySelector('.e-spin-material') as HTMLElement
      ).toBeNull();
      expect(
        container1.querySelector('.e-spin-bootstrap') as HTMLElement
      ).not.toBeNull();
    });
    ...
    it('Ensure set spinner testing for material to bootstrap4', () => {
      ...
      expect(
        container.querySelector('.e-spin-bootstrap4') as HTMLElement
      ).not.toBeNull();
      expect(
        container1.querySelector('.e-spin-material') as HTMLElement
      ).toBeNull();
      expect(
        container1.querySelector('.e-spin-bootstrap4') as HTMLElement
      ).not.toBeNull();
    });
    ...
    it('Ensure set spinner testing for material to high contrast', () => {
      ...
      expect(
        container.querySelector('.e-spin-high-contrast') as HTMLElement
      ).not.toBeNull();
      expect(
        container.querySelector('.e-spin-material') as HTMLElement
      ).toBeNull();
      expect(
        container1.querySelector('.e-spin-high-contrast') as HTMLElement
      ).not.toBeNull();
      expect(
        container1.querySelector('.e-spin-material') as HTMLElement
      ).toBeNull();
  ...
  describe('Spinner with different sizes', () => {
    ...
    it('Ensure spinner on left', () => {
      ...
      let axis1 = (<HTMLElement>(
        container1.childNodes[0]
      )).getBoundingClientRect();
      ...
      expect(
        (
          container2.querySelector('.e-spinner-pane') as HTMLElement
        ).classList.contains('e-spin-left')
      ).toEqual(true);
      let axis2 = (<HTMLElement>(
        (container2.querySelector('.e-spinner-pane') as HTMLElement)
          .childNodes[0]
      )).getBoundingClientRect();
  ...
  describe('Spinner with different target sizes', () => {
    beforeEach((): void => {
      target = createElement('div', {
        ...
        className: 'spinner-demo',
        styles:
          'width: 300px;height: 300px;border: 1px solid red; display: block;position: relative;',
      });
      document.body.appendChild(target);
      target_01 = createElement('div', {
        id: 'spinner-02',
  ...
  describe('create spinner with virtual', () => {
    ...
    it('Virtual Spinner Testing without appending DOM', () => {
      ...
      showSpinner(container);
      let spinWrap: HTMLElement = container.querySelector(
        '.e-spinner-pane'
      ) as HTMLElement;
  ...
  describe('Change the Spinner template dynamically', () => {
    ...
    it('Change the Spinner template dynamically', () => {
      createSpinner({
        ...
        template:
          '<div style="width:100%;height:100%" class="custom-rolling1"><div></div></div>',
      });
      ...
      let innserObject1 = <HTMLElement>(
        (document.querySelector('.e-spinner-inner') as HTMLElement)
          .childNodes[0]
      );
  ...
  describe('EJ2-72096 - Spinner actions on parent element affecting the child element spinner', () => {
    ...
    beforeEach((): void => {
      target = createElement('div', {
        id: 'container1',
        styles: 'height: 500px; width: 800px;',
      });
      document.body.appendChild(target);
      ...
      target_01 = createElement('div', {
        id: 'Box1',
        styles:
          'border: 2px solid bisque; height: 300px; width: 500px; position: relative',
      });
    ...
    it('Spinner actions on parent element affecting the child element spinner', () => {
      ...
      let spinWrap1: HTMLElement = container.querySelector(
        '.e-spin-show'
      ) as HTMLElement;
