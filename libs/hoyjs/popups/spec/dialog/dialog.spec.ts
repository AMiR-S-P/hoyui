...
describe('getDimension method testing while resizing the dialog', () => {
  ...
  it('getDimension while resizing south-east', (done: Function) => {
    dialog = new Dialog({
      ...
      resizeStart: function () {
        expect(
          (
            document.querySelector('.e-south-east') as HTMLElement
          ).classList.contains('e-focused-handle')
        ).toBe(true);
      },
      resizing: function () {
        expect(
    ...
    (document.querySelector('.e-south-east') as HTMLElement).dispatchEvent(
      mouseEvent
    );
  ...
  it('getDimension while resizing south-west', (done: Function) => {
    dialog = new Dialog({
      ...
      resizeStart: function () {
        expect(
          (
            document.querySelector('.e-south-west') as HTMLElement
          ).classList.contains('e-focused-handle')
        ).toBe(true);
      },
      resizing: function () {
    ...
    let mouseEvent = document.createEvent('MouseEvents');
    mouseEvent.initEvent('mousedown', true, true);
    (document.querySelector('.e-south-west') as HTMLElement).dispatchEvent(
      mouseEvent
    );
    mouseEvent.initEvent('mousemove', true, true);
    (document.querySelector('.e-south-west') as HTMLElement).dispatchEvent(
  ...
  it('getDimension while resizing east', (done: Function) => {
    dialog = new Dialog({
      ...
      resizeStart: function () {
        expect(
          (document.querySelector('.e-east') as HTMLElement).classList.contains(
            'e-focused-handle'
          )
        ).toBe(true);
      },
    ...
    let mouseEvent = document.createEvent('MouseEvents');
    mouseEvent.initEvent('mousedown', true, true);
    (document.querySelector('.e-east') as HTMLElement).dispatchEvent(
      mouseEvent
    );
    mouseEvent.initEvent('mousemove', true, true);
    (document.querySelector('.e-east') as HTMLElement).dispatchEvent(
  ...
  it('getDimension while resizing north-east', (done: Function) => {
    dialog = new Dialog({
      ...
      resizeStart: function () {
        expect(
          (
            document.querySelector('.e-north-east') as HTMLElement
          ).classList.contains('e-focused-handle')
        ).toBe(true);
      },
      resizing: function () {
    ...
    let mouseEvent = document.createEvent('MouseEvents');
    mouseEvent.initEvent('mousedown', true, true);
    (document.querySelector('.e-north-east') as HTMLElement).dispatchEvent(
      mouseEvent
    );
    mouseEvent.initEvent('mousemove', true, true);
    (document.querySelector('.e-north-east') as HTMLElement).dispatchEvent(
  ...
  it('getDimension while resizing north-west', (done: Function) => {
    dialog = new Dialog({
      ...
      resizeStart: function () {
        expect(
          (
            document.querySelector('.e-north-west') as HTMLElement
          ).classList.contains('e-focused-handle')
        ).toBe(true);
      },
      resizing: function () {
    ...
    let mouseEvent = document.createEvent('MouseEvents');
    mouseEvent.initEvent('mousedown', true, true);
    (document.querySelector('.e-north-west') as HTMLElement).dispatchEvent(
      mouseEvent
    );
    mouseEvent.initEvent('mousemove', true, true);
    (document.querySelector('.e-north-west') as HTMLElement).dispatchEvent(
  ...
  it('getDimension while resizing west', (done: Function) => {
    dialog = new Dialog({
      ...
      resizeStart: function () {
        expect(
          (document.querySelector('.e-west') as HTMLElement).classList.contains(
            'e-focused-handle'
          )
        ).toBe(true);
      },
    ...
    let mouseEvent = document.createEvent('MouseEvents');
    mouseEvent.initEvent('mousedown', true, true);
    (document.querySelector('.e-west') as HTMLElement).dispatchEvent(
      mouseEvent
    );
    mouseEvent.initEvent('mousemove', true, true);
    (document.querySelector('.e-west') as HTMLElement).dispatchEvent(
  ...
  it('getDimension while resizing south', (done: Function) => {
    dialog = new Dialog({
      ...
      resizeStart: function () {
        expect(
          (
            document.querySelector('.e-south') as HTMLElement
          ).classList.contains('e-focused-handle')
        ).toBe(true);
      },
      resizing: function () {
    ...
    let mouseEvent = document.createEvent('MouseEvents');
    mouseEvent.initEvent('mousedown', true, true);
    (document.querySelector('.e-south') as HTMLElement).dispatchEvent(
      mouseEvent
    );
    mouseEvent.initEvent('mousemove', true, true);
    (document.querySelector('.e-south') as HTMLElement).dispatchEvent(
  ...
  it('getDimension while resizing north', (done: Function) => {
    dialog = new Dialog({
      ...
      resizeStart: function () {
        expect(
          (
            document.querySelector('.e-north') as HTMLElement
          ).classList.contains('e-focused-handle')
        ).toBe(true);
      },
      resizing: function () {
    ...
    let mouseEvent = document.createEvent('MouseEvents');
    mouseEvent.initEvent('mousedown', true, true);
    (document.querySelector('.e-north') as HTMLElement).dispatchEvent(
      mouseEvent
    );
    mouseEvent.initEvent('mousemove', true, true);
    (document.querySelector('.e-north') as HTMLElement).dispatchEvent(
...
describe('create alert utility dialog with button click as typeof function', () => {
  ...
  it('alert utility dialog footer button click', () => {
    ...
    expect(
      document.getElementsByClassName('e-btn')[0].textContent == 'OK'
    ).toBe(true);
    (<HTMLElement>document.getElementsByClassName('e-btn')[0]).dispatchEvent(
      clickEvent
    );
  });
  afterAll(() => {
...
describe('create alert utility dialog with modal', () => {
  ...
  it('alert utility dialog to test modal behavior and destroy functionality', () => {
    ...
    clickEvent.initEvent('click', false, true);
    expect(
      document.getElementsByClassName('e-btn')[0].textContent == 'new button'
    ).toBe(true);
    expect(
      document
        .getElementsByClassName('e-btn')[0]
        .classList.contains('syncfusion')
    ).toBe(true);
    (<HTMLElement>document.getElementsByClassName('e-btn')[0]).dispatchEvent(
      clickEvent
    );
...
describe('alert utility dialog with closeICon and custom footer button', () => {
  ...
  it('alert dialog should remove from DOM', () => {
    ...
    expect(isNullOrUndefined(document.getElementsByClassName('e-btn')[0])).toBe(
      false
    );
  });
  afterAll(() => {
...
describe('confirm utility dialog without modal and default button actions', () => {
  ...
  it('close event will trigger on closeicon click', () => {
    ...
    (<HTMLElement>document.getElementsByClassName('e-btn')[1]).dispatchEvent(
      clickEvent
    );
  });
  afterAll(() => {
...
describe('create alert utility dialog', () => {
  ...
  it('close event will trigger on clik closeicon', () => {
    ...
    (<HTMLElement>document.getElementsByClassName('e-btn')[2]).dispatchEvent(
      clickEvent
    );
  });
  afterAll(() => {
...
describe('create confirm utility dialog', () => {
  ...
  it('Dialog utility confirm dialog default rendering', () => {
    expect(
      document
        .getElementsByClassName('e-confirm-dialog')[0]
        .classList.contains('e-confirm-dialog')
    ).toBe(true);
  });
  afterAll(() => {
    destroyDialog(dialogObj);
...
describe('create alert utility dialog', () => {
  ...
  it('alert utility dialog with api default rendering', () => {
    expect(
      document
        .getElementsByClassName('e-alert-dialog')[0]
...
describe('closeOnEscape property', () => {
  ...
  it('Any other key press- testing ', () => {
    ...
    expect(
      document.getElementById('dialog1').classList.contains('e-popup-open')
    ).toEqual(true);
  });
  afterAll(() => {
...
describe('closeOnEscape property', () => {
  ...
  it('Esc key press to hide testing ', () => {
    ...
    events.keyDown(eventArgs);
    expect(
      document.getElementById('dialog2').classList.contains('e-popup-close')
    ).toEqual(true);
  });
  afterAll(() => {
    destroyDialog(events);
...
describe('Dialog Control', () => {
      ...
      dialog = new Dialog(
        {
          ...
          width: '250px',
          visible: false,
          content: 'Your information is updated successfully',
        },
        '#dialog'
      );
      dialog.show();
  ...
  describe('Dom Dialog element', () => {
    ...
    it('Control class testing', () => {
      ...
      expect(
        document.getElementById('dialog').classList.contains('e-dialog')
      ).toEqual(true);
    });
    ...
    it('Destroy Method testing', () => {
      ...
      dialog = new Dialog(
        {
          header: 'Dialog',
          buttons: [
            { buttonModel: { content: 'Ok' }, click: buttonClick },
            { buttonModel: { content: 'Cancel' }, click: buttonClick },
          ],
          content: 'Your information is updated successfully',
        },
        '#dialog'
      ...
      dialog.show();
      expect(
        document.getElementById('dialog').classList.contains('e-popup-open')
      ).toEqual(false);
      dialog.hide();
      expect(
        document.getElementById('dialog').classList.contains('e-popup-close')
      ).toEqual(false);
    });
    ...
    it('Full screen:true/false Method Testing', () => {
      ...
      dialog.show(true);
      expect(
        document.getElementById('dialog').classList.contains('e-dlg-fullscreen')
      ).toEqual(true);
      dialog.show(false);
      expect(
        document.getElementById('dialog').classList.contains('e-dlg-fullscreen')
    ...
    it('Full screen:true/false method testing with allowDragging true', () => {
      ...
      dialog.show(true);
      expect(
        document.getElementById('dialog').classList.contains('e-draggable')
      ).toEqual(false);
      dialog.show(false);
      expect(
        document.getElementById('dialog').classList.contains('e-draggable')
    ...
    it('cssClass testing', () => {
      dialog = new Dialog(
        { header: 'Dialog', cssClass: 'class1 class2' },
        '#dialog'
      );
      expect(
        document.getElementById('dialog').classList.contains('class1')
      ).toEqual(true);
      expect(
        document.getElementById('dialog').classList.contains('class2')
      ).toEqual(true);
    });
    ...
    it('showCloseIcon testing', () => {
      ...
      expect(
        document.getElementById('dialog').querySelectorAll('.e-icon-dlg-close')
          .length
      ).toBe(1);
    });
    ...
    it('showCloseIcon with header given as Template testing', () => {
      ...
      dialog = new Dialog(
        { showCloseIcon: true, header: headerTemplateContent },
        '#dialog'
      );
      expect(
        document.getElementById('dialog').querySelectorAll('.e-icon-dlg-close')
    ...
    it('header given as Template notify property with showCloseIcon testing', () => {
      ...
      expect(
        document.getElementById('dialog').querySelectorAll('.e-dlg-header')
          .length
      ).toBe(1);
      let headerContent: HTMLElement = document
        .getElementById('dialog')
        .querySelector('.e-dlg-header-content');
    ...
    it('showCloseIcon notify property changes testing if header and content is given to empty', () => {
      ...
      expect(
        document.getElementById('dialog').querySelectorAll('.e-dlg-content')
          .length
      ).toBe(0);
      dialog.showCloseIcon = true;
      dialog.dataBind();
    ...
    it('getZindexPartial testing', () => {
      ...
      expect(document.getElementById('dialogCtrl12').style.zIndex).toEqual(
        '10001'
      );
      destroyDialog(dialog);
      dialog = undefined;
    ...
    it('Width and Height- property testing', () => {
      dialog = new Dialog(
        { header: 'Dialog', width: '250px', height: '250px' },
        '#dialog'
      );
    ...
    it('Height and width property declared as % testing', () => {
      dialog = new Dialog(
        { header: 'Dialog', width: '30%', height: '10%' },
        '#dialog'
      );
    ...
    it('Height and width property declared as integer testing', () => {
      dialog = new Dialog(
        { header: 'Dialog', width: 250, height: 200 },
        '#dialog'
      );
    ...
    it('header property and aria attribute testing', () => {
      ...
      expect(
        document.getElementById('dialog').getAttribute('aria-modal')
      ).toEqual('false');
      expect(
        document.getElementById('dialog').getAttribute('aria-describedby')
      ).toEqual('dialog_title dialog_dialog-content');
    });

    it('position property offset value for x and y testing', () => {
      dialog = new Dialog(
        { header: 'Dialog', position: { X: 100, Y: 200 } },
        '#dialog'
      );
    ...
    it('position property offset value for x and y testing', () => {
      dialog = new Dialog(
        { header: 'Dialog', position: { X: '100.5', Y: '200' } },
        '#dialog'
      );
    ...
    it('position property offset value for x and y testing', () => {
      dialog = new Dialog(
        { header: 'Dialog', position: { X: '100', Y: '200.8' } },
        '#dialog'
      );
      expect((dialog.element as HTMLElement).style.left).toBe('100px');
    ...
    it('position property offset value for x and y testing', () => {
      dialog = new Dialog(
        { header: 'Dialog', position: { X: 'left', Y: '300' } },
        '#dialog'
      );
    ...
    it('position property offset value for x and y testing', () => {
      dialog = new Dialog(
        { header: 'Dialog', position: { X: '300', Y: 'top' } },
        '#dialog'
      );
    ...
    it('dialog footertemplate testing', () => {
      ...
      dialog = new Dialog(
        {
          content: 'Your information is updated successfully',
          footerTemplate: footerTemplateContent,
        },
        '#dialog'
      );
      expect(
        document.getElementById('dialog').querySelectorAll('.e-footer-content')
          .length
      ).toBe(1);
      ...
      expect(
        isNullOrUndefined(
          document.getElementById('dialog').querySelector('.e-footer-content')
        )
      ).toBe(true);
    ...
    it('dialog allowdragging testing', () => {
      let dlgcontent: HTMLElement = createElement('div');
      dialog = new Dialog(
        { header: 'Dialog', content: dlgcontent, allowDragging: true },
        '#dialog'
      );
      expect(
        document.getElementById('dialog').classList.contains('e-draggable')
    ...
    it('dialog allowdragging without header testing', () => {
      let dlgcontent: HTMLElement = createElement('div');
      dialog = new Dialog(
        { content: dlgcontent, allowDragging: true },
        '#dialog'
      );
      expect(
        document.getElementById('dialog').classList.contains('e-draggable')
    ...
    it('allowdragging:false notify property with modal dialog and aria attribute testing', () => {
      ...
      expect(parseInt(dialog.element.style.zIndex)).toBe(
        parseInt(dialog.element.parentElement.style.zIndex) + 1
      );
      expect(parseInt(dialog.element.style.zIndex) - 1).toBe(
        parseInt((dialog.element.nextSibling as HTMLElement).style.zIndex) + 1
      );
    });
    ...
    it('dragStop events testing in modal dialog', () => {
      ...
      expect(
        document
          ...
          .children[0].classList.contains('e-dlg-center-center')
      ).toEqual(false);
      ...
      expect(
        document
          .getElementById('block')
          .children[0].classList.contains('e-dlg-right-top')
      ).toEqual(true);
      expect(
        document
          .getElementById('block')
          .children[0].classList.contains('e-dlg-container')
      ).toEqual(true);
      expect(((dialog.element as HTMLElement).style.position = 'relative'));
      destroyDialog(dialog);
      dialog = undefined;
    ...
    it('dialog events testing', (done) => {
      ...
      expect(
        document.getElementById('dialog').classList.contains('created')
      ).toEqual(true);
      expect(
        document.getElementById('dialog').classList.contains('open')
      ).toEqual(true);
      expect(
        document.getElementById('dialog').classList.contains('beforeopen')
      ).toEqual(true);
      expect(
        document.getElementById('dialog').classList.contains('close')
      ).toEqual(true);
      expect(
        document.getElementById('dialog').classList.contains('beforeclose')
      ).toEqual(true);
      expect(dialog.visible).toEqual(false);
      dialog.destroy();
      expect(
        document.getElementById('dialog').classList.contains('dlg-destroy')
      ).toEqual(true);
    ...
    it('dialog RTL testing', () => {
      ...
      dlgcontent.className = 'samplecontent';
      dialog = new Dialog(
        { header: 'Dialog', content: dlgcontent, enableRtl: true },
        '#dialog'
      );
      expect(
        document.getElementById('dialog').classList.contains('e-rtl')
      ).toEqual(true);
    });
    ...
    it('dialog buttons testing', () => {
      ...
      dialog = new Dialog(
        {
          ...
          content: dlgcontent1,
          buttons: [
            { buttonModel: { content: 'left' } },
            { buttonModel: { content: 'right' } },
          ],
        },
        '#dialog'
      );
      expect(
        document
          .getElementById('dialog')
          .querySelectorAll('.e-footer-content .e-btn').length
      ).toBe(2);
    ...
    it('EJ2-22770-dynamic dialog buttons testing', () => {
      ...
      dlgcontent1.className = 'samplecontent';
      dialog = new Dialog(
        { header: 'Dialog', content: dlgcontent1 },
        '#dialog'
      );
      expect(
        document
      ...
      dialog = new Dialog(
        {
          ...
          content: dlgcontent1,
          buttons: [
            { buttonModel: { content: 'left' }, type: 'Submit' },
            { buttonModel: { content: 'right' } },
          ],
        },
        '#dialog'
    ...
    it('dialog Button Model property testing', () => {
      ...
      dialog = new Dialog(
        {
          ...
          content: dlgcontent,
          buttons: [
            { buttonModel: { cssClass: 'e-success', content: 'left' } },
            { buttonModel: { content: 'right' } },
          ],
        },
        '#dialog'
      ...
      expect(
        document
          .getElementById('dialog')
          .querySelectorAll('.e-footer-content .e-btn')[0]
          .classList.contains('e-success')
      );
    });
      ...
      dialog = new Dialog(
        {
          header: 'Dialog',
          content: dlgcontent,
          buttons: [{ buttonModel: { content: 'left' } }],
        },
        '#dialog'
      );
      expect(
    ...
    it('dialog button empty options testing', () => {
      ...
      dlgcontent.className = 'samplecontent';
      dialog = new Dialog(
        { header: 'Dialog', content: dlgcontent, buttons: [{}] },
        '#dialog'
      );
      expect(
        document.getElementById('dialog').querySelectorAll('.e-footer-content')
    ...
    it('dialog primary button testing', () => {
      ...
      expect(
        document.getElementById('dialog').querySelectorAll('.e-primary').length
      ).toBe(1);
      expect(
        document.getElementById('dialog').querySelectorAll('.e-flat').length
      ).toBe(3);
    });
    ...
    it('checking for the presence of e-flat class', () => {
      ...
      let buttonElements: NodeListOf<HTMLButtonElement> =
        document.querySelectorAll('.e-footer-content > button');
    ...
    it('Header with initial rendering and notify property property testing', () => {
      let headerTemplateContent =
        "<div class='templateclass'>Template content</div>";
      dialog = new Dialog({ header: 'Dialog' }, '#dialog');
      dialog.header = headerTemplateContent;
      dialog.dataBind();
      expect(
        document
          .getElementById('dialog')
          .querySelectorAll('.e-dlg-header .templateclass').length
      ).toBe(1);
    });
    ...
    it('Property change testing for footerTemplate as HTML element and string', () => {
      let footerTemplateContent: HTMLElement = createElement('div', {
        id: 'test',
      });
      footerTemplateContent.innerHTML = 'Footer Template content';
      document.body.appendChild(footerTemplateContent);
      dialog = new Dialog(
        { header: 'New Dialog', content: 'New content updated successfully' },
        '#dialog'
      );
    ...
    it('Property change testing for header as HTML element and string', () => {
      let headerTemplateContent: HTMLElement = createElement('div', {
        id: 'test',
      });
      ...
      expect(
        document
          .getElementById('dialog')
          .querySelectorAll('.e-dlg-header-content').length
      ).toBe(1);
    ...
    it('notify property changes testing combination of showCloseIcon and cssClass property', () => {
      dialog = new Dialog(
        { header: 'Dialog', showCloseIcon: false },
        '#dialog'
      );
      dialog.showCloseIcon = true;
      ...
      expect(
        document.getElementById('dialog').classList.contains('css-classname')
      ).toEqual(true);
    });
    ...
    it('notify property testing-showCloseIcon:true if header is not given,cssClass and dialog buttons Testing', () => {
      ...
      expect(
        document.getElementById('dialog').classList.contains('newCssClass')
      ).toEqual(true);
    });

    it('header given as Template testing and content property given as string-notify property changes', () => {
      let headerTemplateContent = '<div>Template content</div>';
      let newheaderTemplateContent =
        "<div class='newhdrtemplate'>New Template content</div>";
      dialog = new Dialog(
        { showCloseIcon: false, header: headerTemplateContent },
        '#dialog'
      );
      ...
      expect(
        document
          .getElementById('dialog')
          .querySelectorAll('.e-dlg-header .newhdrtemplate').length
      ).toBe(1);
    });

    it('Content notify property changes ', () => {
      dialog = new Dialog(
        { header: 'Dialog', content: 'Dialog content', showCloseIcon: false },
        '#dialog'
      );
      dialog.content = 'New content';
      dialog.dataBind();
      expect(
        document.getElementById('dialog').querySelectorAll('.e-dlg-content')[0]
          .innerHTML
      ).toEqual('New content');
    });
    ...
    it('Modal dialog:true notify property and aria attr testing', () => {
      ...
      dialog.dataBind();
      expect(
        document.getElementById('dialog').classList.contains('e-dlg-modal')
      ).toBe(true);
      expect(
        document.getElementById('dialog').getAttribute('aria-modal')
      ).toEqual('true');
      expect(
        (<any>document.getElementsByClassName('e-dlg-container')[0]).style
          .display
      ).not.toEqual('none');
    ...
    it('Modal dialog:false notify property and aria attr testing', () => {
      ...
      expect(document.getElementsByClassName('e-dlg-overlay').length).toEqual(
        0
      );
      expect(
        document.getElementById('dialog').getAttribute('aria-modal')
    ...
    it('Header notify property testing with Draggable', () => {
      dialog = new Dialog(
        { showCloseIcon: true, isModal: false, allowDragging: true },
        '#dialog'
      );
    ...
    it('showCloseIcon notify property testing when header is given to empty', () => {
      ...
      expect(
        document
          .getElementById('dialog')
          .classList.contains('e-dlg-header-content')
      ).toEqual(false);
    });
    ...
    it('Modal dialog:false with target-notify  property testing', () => {
      ...
      expect(
        document
          .getElementById('block')
          .children[0].classList.contains('e-dialog')
      ).toEqual(true);
      destroyDialog(dialog);
      dialog = undefined;
      detach(target);
...
describe('Drag related events testing', () => {
  ...
  beforeEach(() => {
    ...
    mousedown.target = mousedown.currentTarget =
      document.getElementsByClassName('e-dlg-header-content')[0];
    EventHandler.trigger(
      document.getElementsByClassName('e-dlg-header-content')[0] as HTMLElement,
      'mousedown',
      mousedown
    );
    mousemove.srcElement =
      mousemove.target =
      mousemove.toElement =
        document.getElementsByClassName('e-dlg-header-content');
...
describe('EJ2-62114 - Need to prevent drag action on the dialog content', () => {
  ...
  beforeEach(() => {
    ...
    mousedown = setMouseCoordinates(mousedown, 5, 5);
    mousedown.target = mousedown.currentTarget =
      document.getElementsByClassName('e-dlg-content')[0];
    EventHandler.trigger(
      document.getElementsByClassName('e-dlg-content')[0] as HTMLElement,
      'mousedown',
      mousedown
    );
    mousemove.srcElement =
      mousemove.target =
      mousemove.toElement =
        document.getElementsByClassName('e-dlg-content');
    EventHandler.trigger(<any>document, 'mousemove', mousemove);
    mousemove = setMouseCoordinates(mousemove, 5, 5);
    mouseUp = getEventObject('MouseEvents', 'mouseup');
    mouseUp.srcElement =
...
describe('Position property testing using string type', () => {
  ...
  it('Initial and dynamic change on position property default positions', () => {
    dialog = new Dialog(
      { header: 'Dialog', position: { X: 'center', Y: 'center' } },
      '#dialog'
    );
    expect(
      document
    ...
    expect(
      document
        .getElementById('dialog')
        .children[0].classList.contains('e-dlg-center-top')
    ).toEqual(false);
  });
  it('Initial and dynamic change on position property using custom values for Modal dialog', () => {
    dialog = new Dialog(
      { header: 'Dialog', position: { X: '100', Y: '200' }, isModal: true },
      '#dialog'
    );
    expect((dialog.element as HTMLElement).style.left).toBe('100px');
    expect((dialog.element as HTMLElement).style.top).toBe('200px');
  ...
  it('Initial and dynamic change on position property default position for Modal dialog', () => {
    ...
    expect(
      document
        .getElementById('dialog')
        .parentElement.classList.contains('e-dlg-center-center')
    ).toEqual(true);
    dialog.position = { X: 'center', Y: 'top' };
    dialog.dataBind();
    expect(
      document
        .getElementById('dialog')
        .parentElement.classList.contains('e-dlg-center-top')
    ).toEqual(true);
  });
});
...
describe('Dialog min height testing', () => {
  ...
  it('Min - height testing', () => {
    ...
    dialog.show();
    expect(document.getElementById('dialog').style.minHeight === '200px').toBe(
      true
    );
  });
});
...
describe('Isprimary Button Action while focus on form element', () => {
  describe('Application side ', () => {
    ...
    beforeAll(() => {
      ...
      events = new Dialog({
        ...
        content:
          "<form><div class='form-group'><label for='email'>Email address:</label>" +
  ...
  describe('focus action', () => {
    ...
    it('focus primary button', () => {
      ...
      events.show();
      expect(
        (document.activeElement as HTMLElement).classList.contains('e-primary')
      ).toBe(true);
    });
    ...
    it('focus first form element in dialog content', () => {
      ...
      events.show();
      expect(
        (document.activeElement as HTMLElement).classList.contains('email')
      ).toBe(true);
    });
    ...
    it('focus first form element in dialog content-when set first input element as display:none', () => {
      ...
      events.show();
      expect(
        (document.activeElement as HTMLElement).classList.contains('pwd')
      ).toBe(true);
    });
  ...
  describe('EJ2-51744 - Styles are not properly removed from the body when open and close the fullscreen modal dialog', () => {
    ...
    it('Check the scroll class being removed', (done) => {
      ...
      clickEvent.initEvent('click', false, true);
      (<HTMLButtonElement>(
        document.querySelector('.e-dlg-header-content .e-dlg-closeicon-btn')
  ...
  describe('focus action innerHTML', () => {
    ...
    beforeAll(() => {
      let ele: HTMLElement = createElement('div', {
        id: 'dialog',
        innerHTML: '<input type="text" class="text"/>',
      });
      document.body.appendChild(ele);
      events = new Dialog({
        closeOnEscape: true,
    ...
    it('Focus inner html textbox', () => {
      expect(
        (document.activeElement as HTMLElement).classList.contains('text')
      ).toBe(true);
    });
  ...
  describe('focus action in modal dialog overlayclick', () => {
    ...
    beforeAll(() => {
      let ele: HTMLElement = createElement('div', {
        id: 'dialog',
        innerHTML: 'This is a dialog content',
      });
      document.body.appendChild(ele);
      events = new Dialog({
        closeOnEscape: true,
    ...
    it('Focus the primary button if overlayclicked', () => {
      let ele1: HTMLElement = (<HTMLScriptElement[]>(
        (<any>document.getElementsByClassName('e-dlg-overlay'))
      ))[0];
      ele1.click();
...
describe('visible:false Property ', () => {
  ...
  it('visible property:false with modal enabled testing', () => {
    ...
    expect(
      (document.getElementsByClassName('e-dlg-overlay')[0] as HTMLElement).style
        .display
    ).toEqual('none');
    expect(
      document
        .getElementById('dialogctrl14')
        .classList.contains('e-popup-close')
    ).toEqual(true);
    expect(dialog.visible).toEqual(false);
    dialog.visible = true;
  ...
  it('visible property:false with modal enabled testing', () => {
    ...
    document.body.appendChild(ele);
    dialog = new Dialog(
      { visible: false, target: document.body, isModal: true },
      '#dialogctrl31'
    );
    dialog.isModal = false;
    dialog.dataBind();
...
describe('visible:true:notify Property ', () => {
  ...
  it('visible:true notify property testing', () => {
    expect(
      document.getElementById('dialogctrl').classList.contains('e-popup-open')
    ).toEqual(true);
  });
});
...
describe('Close icon ', () => {
  ...
  beforeAll((done: Function) => {
    ...
    dialog.dataBind();
    let ele1: HTMLElement = (<HTMLScriptElement[]>(
      (<any>document.getElementsByClassName('e-icon-dlg-close'))
    ))[0];
    ele1.click();
    setTimeout(() => {
      done();
...
describe('Dialog Modal', () => {
  ...
  beforeAll((done: Function) => {
    ...
    dialog = new Dialog(
      {
        animationSettings: { effect: 'None' },
        buttons: [
          { buttonModel: { content: 'Confirm' }, click: buttonClick },
          { buttonModel: { content: 'close' } },
        ],
        showCloseIcon: true,
        isModal: true,
    ...
    dialog.dataBind();
    let ele1: HTMLElement = (<HTMLScriptElement[]>(
      (<any>document.getElementsByClassName('e-btn'))
    ))[0];
    ele1.click();
    dialog.hide();
    setTimeout(() => {
...
describe('Dialog', () => {
  ...
  it('locale property testing', () => {
    ...
    expect(
      document
        .getElementsByClassName('e-dlg-closeicon-btn')[0]
        .getAttribute('title')
    ).toEqual('schlieen');
  });
  ...
  it('isDevice Condition check', () => {
    ...
    expect(
      document.getElementById('dialog').classList.contains('e-device')
    ).toBe(true);
  });
});
...
describe('Dynamically change', () => {
  ...
  beforeAll((done: Function) => {
    ...
    document.body.appendChild(ele);
    dialog = new Dialog(
      { showCloseIcon: true, content: 'Dialog content' },
      '#dialog'
    );
    dialog.dataBind();
    setTimeout(() => {
  ...
  it('dialog content', () => {
    dialog.content = '';
    dialog.dataBind();
    expect(isNullOrUndefined(document.querySelector('.e-dlg-content'))).toBe(
      true
    );
  ...
  it('showcloseIcon', () => {
    ...
    dialog.dataBind();
    expect(
      isNullOrUndefined(document.querySelector('.e-dlg-header-content'))
    ).toBe(true);
    dialog.showCloseIcon = true;
    dialog.dataBind();
    expect(
...
describe('Cancel', () => {
  ...
  beforeAll((done: Function) => {
    ...
    dialog = new Dialog(
      {
        showCloseIcon: true,
        beforeOpen: cancelEvents,
        beforeClose: cancelEvents,
        content: 'Dialog content',
        position: { X: 200, Y: 300 },
        isModal: true,
      },
...
describe('Closed by argument testing with closeIcon -', () => {
  ...
  it('Dialog closed by close icon click', () => {
    dialog.show();
    (
      dialog.element.querySelector('.e-dlg-closeicon-btn') as HTMLButtonElement
    ).click();
    ...
    dialog = new Dialog(
      {
        showCloseIcon: true,
        beforeClose: cancelEvents,
        buttons: [{ buttonModel: { content: 'Ok' }, click: buttonClick }],
        content: 'Dialog content',
        position: { X: 200, Y: 300 },
        isModal: true,
      },
...
describe('Hide() method', () => {
  ...
  beforeAll((done: Function) => {
    ...
    function closeEvents(args: any) {
      expect(
        (document.getElementsByClassName('e-dlg-overlay')[0] as HTMLElement)
          .style.display
      ).toEqual('block');
      expect(
        (document.getElementsByClassName('e-dlg-container')[0] as HTMLElement)
          .style.display
      ).toEqual('none');
    }
    dialog = new Dialog(
      { isModal: true, close: closeEvents, content: 'Dialog content' },
      '#dialog'
    );
    dialog.hide();
    dialog.dataBind();
...
describe('Dialog with animation', function () {
  ...
  beforeEach(function (done) {
    ...
    dialog = new Dialog(
      {
        header: 'Dialog',
        animationSettings: { effect: 'Fade', delay: 0, duration: 0 },
        content: 'Dialog content',
        footerTemplate: footerTemplateContent,
        showCloseIcon: true,
      },
...
describe('notify property testig-All properties combination', function () {
  ...
  it(' Dialog control notify property testig-All properties combination', (done) => {
    ...
    let newfooterTemplateContent1 =
      "<div class='newftrtemplate'>Footer Template content</div>";
    dialog1 = new Dialog(
      {
        header: 'Dialog',
        animationSettings: { effect: 'None' },
        content: 'Dialog content',
        footerTemplate: footerTemplateContent1,
        showCloseIcon: true,
      },
      '#dialog1'
    );
    ...
    expect(
      document.getElementById('dialog1').classList.contains('e-rtl')
    ).toEqual(true);
    expect(
      document.getElementById('dialog1').querySelectorAll('.e-dlg-header')
        .length
    ).toBe(1);
    expect(
      document
        .getElementById('dialog1')
        .querySelectorAll('.e-footer-content .newftrtemplate').length
    ).toBe(1);
    expect(
      document.getElementById('dialog1').querySelectorAll('.e-icon-dlg-close')
        .length
    ).toBe(0);
...
describe('Maximum Zindex value testing for modal dialog', () => {
  ...
  it('dialog Zindex', () => {
    ...
    expect(
      (document.querySelector('.e-dlg-container .e-dlg-overlay') as HTMLElement)
        .style.zIndex
    ).toEqual('2147483646');
  });
});
...
describe('Testing resizing option with target body', () => {
  ...
  it('Checking handlers', () => {
    expect(!isNullOrUndefined(document.querySelector('.e-south-east'))).toBe(
      true
    );
...
describe('Testing resizing option with selected target', () => {
  ...
  it('Enabling resize through onproperty change', () => {
    ...
    dialog.dataBind();
    expect(!isNullOrUndefined(document.querySelector('.e-south-west'))).toBe(
      true
    );
    expect(isNullOrUndefined(document.querySelector('.e-south-east'))).toBe(
      true
...
describe('Testing resizing option with RTL mode', () => {
  ...
  it('RTL Mode', (done) => {
    expect(
      !isNullOrUndefined(dialog.element.classList.contains('e-viewport'))
    ).toBe(true);
    dialog.enableRtl = true;
    dialog.dataBind();
    expect(
      !isNullOrUndefined(dialog.element.classList.contains('e-resize-left'))
    ).toBe(true);
...
describe('Testing resizing with resizeHandle property with all edges', () => {
  ...
  it('Resize in all edges', () => {
    ...
    expect(!isNullOrUndefined(document.querySelector('.e-north-east'))).toBe(
      true
    );
    expect(!isNullOrUndefined(document.querySelector('.e-north-west'))).toBe(
      true
    );
    ...
    dialog = new Dialog({
      ...
      open: function () {
        ...
        headerHeight = parseInt(
          computedHeaderHeight.slice(0, computedHeaderHeight.indexOf('p')),
          10
        );
...
describe('confirm utility dialog without modal and default button actions', () => {
  ...
  it('confirm utility - cssClass Checking', (done: Function) => {
    ...
    (<HTMLElement>document.getElementsByClassName('e-confirm-dialog')[0]).style
      .zIndex === '250';
    setTimeout(() => {
      expect(
        document.querySelector('.e-confirm-dialog').classList.contains('open')
      ).toEqual(true);
      expect(
        document.querySelector('.e-confirm-dialog').classList.contains('close')
      ).toEqual(false);
      done();
    }, 500);
  });
...
describe('alert utility dialog without model', () => {
  ...
  it('alert utility - cssClass Checking', (done: Function) => {
    ...
    (<HTMLElement>document.getElementsByClassName('e-alert-dialog')[0]).style
      .zIndex === '250';
    setTimeout(() => {
      expect(
        document.querySelector('.e-alert-dialog').classList.contains('open')
      ).toEqual(true);
      expect(
        document.querySelector('.e-alert-dialog').classList.contains('close')
      ).toEqual(false);
      done();
    }, 500);
  });
...
describe('EJ2-33526 XSS attack prevention', () => {
  ...
  it('check the script element', () => {
    expect(
      (<any>dialog).contentEle.querySelectorAll('script').length
    ).toBeGreaterThan(0);
  });
});
...
describe('EJ2-33526 XSS attack prevention', () => {
  ...
  beforeEach((): void => {
    ...
    dialog = new Dialog({
      header: 'Demo',
      content: '<style>bod{width:100px;}</style>',
      beforeSanitizeHtml: (args: BeforeSanitizeHtmlArgs) => {
...
describe('Update target of dialog', () => {
  ...
  it('check dynamic target', (done) => {
    ...
    setTimeout(function () {
      ...
      expect(document.querySelector('BODY') === (dialog as any).targetEle).toBe(
        true
      );
      done();
    });
...
describe('EJ2-34370- web accessebility issue', () => {
  ...
  it('check aria-attribute', () => {
    expect(
      document
        .querySelectorAll('.e-dlg-closeicon-btn')[0]
...
describe('EJ2-34298 - Destroy method correction testing', () => {
  ...
  it('Modal Dialog - After destroy classlist availability testing', () => {
    ...
    dialog.appendTo('#dialog');
    dialog.destroy();
    let targetEle: HTMLElement = document.querySelector(
      '#dialog'
    ) as HTMLElement;
    ...
    expect(document.body.classList.contains('e-scroll-disabled')).toEqual(
      false
    );
    ...
    expect(document.querySelectorAll('.e-dlg-container').length > 0).toEqual(
      false
    );
    expect(document.querySelectorAll('.e-dlg-overlay').length > 0).toEqual(
      false
    );
    detach(dialog.element);
  });
...
describe('EJ2-34298 - Ref element testing', () => {
  ...
  it('Default target with Ref element availability testing', () => {
    ...
    dialog.appendTo('#dialog');
    expect(
      document.querySelectorAll('.e-dlg-ref-element').length === 1
    ).toEqual(true);
    expect(
      document.querySelector('.e-dlg-ref-element').parentElement.id
    ).toEqual('dialogWrapper');
    expect(document.querySelector('.e-dialog').parentElement.tagName).toEqual(
      'BODY'
    );
    dialog.destroy();
    dialog = undefined;
    expect(document.querySelectorAll('.e-dlg-ref-element').length > 0).toEqual(
      false
    );
    expect(document.querySelector('#dialog').parentElement.tagName).toEqual(
      'DIV'
    );
    expect(document.querySelector('#dialog').parentElement.id).toEqual(
      'dialogWrapper'
    );
  });
  ...
  it('Target as `dialogRoot` with Ref element availability testing', () => {
    ...
    expect(document.querySelector('.e-dialog').parentElement.id).toEqual(
      'dialogRoot'
    );
    dialog.destroy();
    dialog = undefined;
  ...
  it('`isModal: true` - Default target with Ref element availability testing', () => {
    ...
    expect(
      document.querySelector('.e-dlg-container').parentElement.tagName
    ).toEqual('BODY');
    expect(document.querySelectorAll('.e-dlg-overlay').length > 0).toEqual(
      true
    );
  ...
  it('`isModal: true` - Target as `dialogRoot` with Ref element availability testing', () => {
    ...
    expect(document.querySelector('.e-dlg-container').parentElement.id).toEqual(
      'dialogRoot'
    );
    expect(document.querySelectorAll('.e-dlg-overlay').length > 0).toEqual(
      true
...
describe('EJ2-34298 - Dialog render with virtual DOM testing', () => {
  ...
  it('OnPropertyChange - Default target with Ref element availability testing', () => {
    ...
    expect(document.querySelectorAll('.e-dlg-container').length === 1).toEqual(
      true
    );
    expect(document.querySelectorAll('.e-dialog').length === 1).toEqual(true);
    expect(
    ...
    dialog = new Dialog(
      {
        ...
        animationSettings: { effect: 'None' },
        buttons: [
          { buttonModel: { isPrimary: true, content: 'ok' }, isFlat: true },
        ],
      },
      '#dialog'
    );
    ...
    dialog = new Dialog(
      {
        ...
        animationSettings: { effect: 'None' },
        buttons: [
          { buttonModel: { isPrimary: true, content: 'ok' }, isFlat: false },
        ],
      },
      '#dialog'
    );
...
describe('EJ2-62519-Provide the width and height property to the dialog utility', () => {
  ...
  it('check height and width of alert utility dialog', () => {
    expect(
      (document.getElementsByClassName('e-alert-dialog')[0] as HTMLElement)
        .style.height
    ).toBe('150px');
    expect(
      (document.getElementsByClassName('e-alert-dialog')[0] as HTMLElement)
...
describe('EJ2-62519-Provide the width and height property to the dialog utility', () => {
  ...
  it('check height and width of confirm utility dialog  ', () => {
    expect(
      (document.getElementsByClassName('e-confirm-dialog')[0] as HTMLElement)
        .style.height
    ).toBe('150px');
    expect(
      (document.getElementsByClassName('e-confirm-dialog')[0] as HTMLElement)
...
describe('EJ2-67757 Dialog closed when esc key action-', () => {
  ...
  it('Dialog closed by esc key action ', () => {
    expect(dlgObj.element.classList.contains('e-popup-close') !== true).toBe(
      true
    );
    eventArgs = { keyCode: 27, altKey: false, ctrlKey: false, shiftKey: false };
