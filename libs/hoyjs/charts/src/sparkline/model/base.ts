 ...
 */
import { Property, ChildProperty, Complex } from '@hoyui/base';
import {
...
export class SparklineTooltipSettings extends ChildProperty<SparklineTooltipSettings> {
   ...
   */
  @Complex<SparklineFontModel>(
    { size: '12px', fontWeight: null, fontStyle: 'Normal', fontFamily: null },
    SparklineFont
  )
...
export class SparklineDataLabelSettings extends ChildProperty<SparklineDataLabelSettings> {
   ...
   */
  @Complex<SparklineFontModel>(
    { size: null, fontWeight: null, fontStyle: null, fontFamily: null },
    SparklineFont
  )
  public textStyle: SparklineFontModel;
  /**
