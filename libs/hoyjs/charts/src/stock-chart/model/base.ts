...
import {
  ...
  Series,
  Trendline,
} from '../../chart/series/chart-series';
import {
  MarkerSettingsModel,
  TrendlineModel,
} from '../../chart/series/chart-series-model';
...
export class StockChartIndicator extends ChildProperty<StockChartIndicator> {
   ...
   */
  @Complex<StockChartConnectorModel>(
    { color: '#ff9933', width: 2 },
    StockChartConnector
  )
