...
import { Size, PathOption } from '@hoyui/svg-base';
import {
  ChartLocation,
  appendChildElement,
  removeElement,
...
export class FunnelSeries extends TriangularBase {
  ...
  private getSegmentData(
    ...
    if (
      bottom > area.height - neckSize.height ||
      area.height === neckSize.height
    ) {
