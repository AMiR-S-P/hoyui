 ...
 */
export interface CircularChart3DLoadedEventArgs
  extends CircularChart3DEventArgs {
 ...
 * @extends CircularChart3DEventArgs
 */
export interface CircularChart3DLegendRenderEventArgs
  extends CircularChart3DEventArgs {
 ...
 * @extends CircularChart3DEventArgs
 */
export interface CircularChart3DLegendClickEventArgs
  extends CircularChart3DEventArgs {
 ...
 * @extends CircularChart3DEventArgs
 */
export interface CircularChart3DSelectionCompleteEventArgs
  extends CircularChart3DEventArgs {
 ...
 * @extends CircularChart3DEventArgs
 */
export interface CircularChart3DPointRenderEventArgs
  extends CircularChart3DEventArgs {
 ...
 * @extends CircularChart3DEventArgs
 */
export interface CircularChart3DTextRenderEventArgs
  extends CircularChart3DEventArgs {
  /** Defines the current series. */
 ...
 */
export interface CircularChart3DExportEventArgs
  extends CircularChart3DEventArgs {
  /**
 ...
 * @extends CircularChart3DEventArgs
 */
export interface CircularChart3DPrintEventArgs
  extends CircularChart3DEventArgs {
 ...
 * @extends CircularChart3DEventArgs
 */
export interface CircularChart3DMouseEventArgs
  extends CircularChart3DEventArgs {
