  ...
  public renderPoint(
    ...
    if (
      ...
      if (!argsData.cancel) {
        ...
        const open: ChartLocation = {
          x: point.regions[index1 as number].x,
          y: point.regions[index1 as number].y,
        };
        const close: ChartLocation = {
          x: point.regions[index2 as number].x,
          y: point.regions[index2 as number].y,
        };
        this.drawHiloOpenClosePath(
          series,
          point,
          open,
          close,
  ...
  protected drawHiloOpenClosePath(
    ...
    if (series.chart.requireInvertedAxis) {
      ...
      direction +=
        ...
        'L' +
        ' ' +
        (rect.x + rect.width / 2 + argsData.border.width / 2) +
        ' ' +
        open.y +
        ' ';
