    ...
    for (
      ...
      if (
        ...
        if (
          ...
          direction = this.closeRangeAreaPath(
            visiblePoints,
            point,
            series,
            direction,
  ...
  protected closeRangeAreaPath(
    ...
    for (let j: number = i; j >= 0; j--) {
      if (
        ...
        visiblePoints[j as number].symbolLocations[0]
      ) {
        ...
        for (
          ...
          if (endPathCommands.length !== startPathCommands.length) {
            startPathCommands.splice(
              ...
              0,
              startPathCommands
                .slice(0, (startPathCommands.length - 1) / 2)
                .pop(),
              startPathCommands
                .slice(0, (startPathCommands.length - 1) / 2 + 1)
                .pop()
            );
          }
        }
