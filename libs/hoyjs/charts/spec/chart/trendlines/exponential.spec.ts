...
let series1: Object[] = [];
let yValue: number[] = [
  7.66, 8.03, 8.41, 8.97, 8.77, 8.2, 8.16, 7.89, 8.68, 9.48, 10.11, 11.36,
  12.34, 12.6, 12.95, 13.91, 16.21, 17.5, 22.72, 28.14, 31.26, 31.39, 32.43,
  35.52, 36.36, 41.33, 43.12, 45.0, 47.23, 48.62, 46.6, 45.28, 44.01, 45.17,
  41.2, 43.41, 48.32, 45.65, 46.61, 53.34, 58.53,
];
let point1: Object;
let categoyData: any = [
  {
...
describe('Chart', () => {
  ...
  describe('Exponential Trendlines', () => {
    ...
    it('Exponential Trendlines with series points and with trendline validcollection', (done: Function) => {
      ...
      chartObj.series[0].dataSource = series1;
      chartObj.series[0].trendlines = [
        { type: 'Exponential', animation: { enable: false } },
      ];
      chartObj.refresh();
    });
    ...
    it('Exponential Trendlines with tooltip', (done: Function) => {
      loaded = (args: Object): void => {
        ...
        ).toEqual('Exponential1993 : 22.382');
        expect(
  ...
  describe('multiple panes Trendlines', () => {
    ...
    beforeAll(() => {
      ...
      chartObj = new Chart({
        ...
        axes: [{ name: 'horizontalAxis2', columnIndex: 1 }],
        series: [
          {
            type: 'Scatter',
            name: 'series1',
            ...
            yName: 'y',
            dataSource: series1,
            trendlines: [{ type: 'Exponential', animation: { enable: false } }],
            animation: { enable: false },
          },
          {
            type: 'Scatter',
