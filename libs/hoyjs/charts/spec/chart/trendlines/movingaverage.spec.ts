...
describe('Chart', () => {
  ...
  describe('MovingAverage Trendlines', () => {
    ...
    it('MovingAverage Trendlines with series points and with trendline validcollection', (done: Function) => {
      ...
      chartObj.loaded = loaded;
      chartObj.series[0].trendlines = [
        { type: 'MovingAverage', animation: { enable: false } },
      ];
      chartObj.refresh();
    });
    ...
    it('MovingAverage Trendlines with tooltip', (done: Function) => {
      loaded = (args: Object): void => {
        ...
        ).toEqual('MovingAverage1975 : 8.220');
        expect(
  ...
  describe('MovingAverage Trendlines with category data', () => {
    let chartObj: Chart;
    let loaded: EmitType<ILoadedEventArgs>;
    let trigger: MouseEvents = new MouseEvents();
    element = createElement('div', { id: 'container' });
    ...
    it('MovingAverage Trendlines with category values', (done: Function) => {
      loaded = (args: Object): void => {
        let svg: number = document.getElementById('containerSeriesGroup0')
          .childNodes.length;
