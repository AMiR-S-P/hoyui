...
describe('Chart', () => {
  ...
  describe('EMA Technical Indicators', () => {
    let chartObj: Chart;
    ...
    it('EMA Technical Indicators without series', (done: Function) => {
    ...
    it('EMA Technical indicator for a series with 0 points', (done: Function) => {
      loaded = (args: Object): void => {
    ...
    it('EMA Technical Indicator for a series with 1 point', (done: Function) => {
      loaded = (args: Object): void => {
        //define check condition
        let indicator: HTMLElement = document.getElementById(
          'containerIndicatorGroup0'
    ...
    it('EMA Technical indicator for a series with valid points & primary axis', (done: Function) => {
      loaded = (args: Object): void => {
        //define check condition
        let signalLine: HTMLElement = document.getElementById(
          'container_Indicator_0_EMA'
        );
        ...
        expect(chartObj.visibleSeries[1].points[3].y).toBe(6.175000000000001);
        expect(chartObj.visibleSeries[1].points[5].y).toBe(9.44375);
        expect(chartObj.visibleSeries[1].points[8].y).toBe(4.49296875);
        done();
      };
    ...
    //negative points
    it('EMA Technical indicator for a series with negative points', (done: Function) => {
      loaded = (args: Object): void => {
        //define check condition
        ...
        expect(chartObj.visibleSeries[1].points[4].y).toBe(2.687500000000001);
        expect(chartObj.visibleSeries[1].points[3].y).toBe(-3.0249999999999995);
        done();
    ...
    it('EMA Technical indicator for a series with secondary y axis', (done: Function) => {
      loaded = (args: Object): void => {
        //define check condition
        let svg: HTMLElement = document.getElementById('containerAxisLine_2');
        expect(
          svg.getAttribute('d').split(' ')[1] == '766.5' ||
    ...
    it('EMA Technical indicator with hidden series', (done: Function) => {
      loaded = (args: Object): void => {
        //define check condition
        let signalLine: HTMLElement = document.getElementById(
          'container_Indicator_0_EMA'
    ...
    it('EMA Technical indicator with opposed position', (done: Function) => {
      loaded = (args: Object): void => {
        //define check condition
        let signalLine: HTMLElement = document.getElementById(
          'container_Indicator_0_EMA'
        ...
        expect(
          svg.getAttribute('d').split(' ')[2] == '89.75' ||
            svg.getAttribute('d').split(' ')[2] == '95.75'
        ).toBe(true);
        expect(
          svg.getAttribute('d').split(' ')[4] == '767.5' ||
            svg.getAttribute('d').split(' ')[4] == '767.5'
        ...
        expect(
          svg.getAttribute('d').split(' ')[5] == '89.75' ||
            svg.getAttribute('d').split(' ')[5] == '95.75'
        ).toBe(true);
        done();
      };
    ...
    //plot offset
    it('EMA Technical indicator with secondary axis and plot offset', (done: Function) => {
      loaded = (args: Object): void => {
        //define check condition
        let signalLine: HTMLElement = document.getElementById(
          'container_Indicator_0_EMA'
    ...
    //---appearance----
    it('EMA Technical indicator with default appearance', (done: Function) => {
      loaded = (args: Object): void => {
        //define check condition
        let signalLine: HTMLElement = document.getElementById(
          'container_Indicator_0_EMA'
    ...
    it('EMA Technical indicator with custom color', (done: Function) => {
      loaded = (args: Object): void => {
        //define check condition
        let signalLine: HTMLElement = document.getElementById(
          'container_Indicator_0_EMA'
    ...
    it('EMA Technical indicator with custom stroke style', (done: Function) => {
      loaded = (args: Object): void => {
        //define check condition
        let signalLine: HTMLElement = document.getElementById(
          'container_Indicator_0_EMA'
    ...
    //tooltip
    it('EMA Technical indicator with tooltip', (done: Function) => {
      loaded = (args: Object): void => {
        //define check condition
    ...
    //crosshair
    it('EMA Technical indicator with cross hair', (done: Function) => {
      loaded = (args: Object): void => {
        //define check condition
        let chartArea: HTMLElement = document.getElementById(
          'container_ChartAreaBorder'
    ...
    //trackball
    it('EMA Technical indicator with track ball', (done: Function) => {
      loaded = (args: Object): void => {
        //define check condition
        let tooltip: Element;
    ...
    //resizing charts
    it('EMA Technical indicator when resizing the chart', (done: Function) => {
      loaded = (args: Object): void => {
        //define check condition
    ...
    //default period
    it('EMA Technical indicator with default period', (done: Function) => {
      loaded = (args: Object): void => {
        let signalLine: HTMLElement = document.getElementById(
          'container_Indicator_0_EMA'
        );
    ...
    //custom period
    it('EMA Technical indicator with custom period', (done: Function) => {
      loaded = (args: Object): void => {
        let signalLine: HTMLElement = document.getElementById(
          'container_Indicator_0_EMA'
        );
        ...
        expect(chartObj.visibleSeries[1].points[1].y).toBe(4.911818181818182);
        expect(chartObj.visibleSeries[1].points[2].y).toBe(4.94603305785124);
        done();
      };
    ...
    //---multiple panel----
    it('EMA Technical indicator using panels', (done: Function) => {
      loaded = (args: Object): void => {
        ...
        expect(
          Math.round(rect.top) === 370 || rect.top == 368.9305114746094
        ).toBe(true);
        done();
      };
      chartObj.axes = [
    ...
    it('Moving Average with comparative field as open', (done: Function) => {
      loaded = (args: Object): void => {
        ...
        expect(chartObj.visibleSeries[1].points[5].y).toBe(13.9625);
        expect(chartObj.visibleSeries[1].points[8].y).toBe(8.6703125);
        done();
      };
    ...
    it('Moving Average with comparative field as high', (done: Function) => {
      loaded = (args: Object): void => {
        ...
        expect(chartObj.visibleSeries[1].points[3].x).toBe('Jun');
        expect(chartObj.visibleSeries[1].points[5].y).toBe(17.817708333333332);
        expect(chartObj.visibleSeries[1].points[8].y).toBe(10.814713541666666);
        done();
      };
