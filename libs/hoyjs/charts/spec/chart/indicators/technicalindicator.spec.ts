...
let singleData: object[] = [
  { x: 'Jan', low: 40, high: 100, open: 50, close: 70 },
];
...
let financialData: object[] = [
  ...
  { x: 'May', low: 5.7, high: 14.4, open: 12.2, close: 7 },
  { x: 'Jun', low: 8.4, high: 16.9, open: 15, close: 10 },
  { x: 'Jul', low: 10.6, high: 19.2, open: 15.6, close: 13 },
...
describe('Chart', () => {
  ...
  describe('SMA Technical Indicators', () => {
    let chartObj: Chart;
    ...
    it('SMA Technical Indicators without series', (done: Function) => {
    ...
    it('SMA Technical indicator for a series with 0 points', (done: Function) => {
      loaded = (args: Object): void => {
        //define check condition
        let indicator: HTMLElement = document.getElementById(
          'containerIndicatorGroup0'
        );
    ...
    it('SMA Technical Indicator for a series with 1 point', (done: Function) => {
      loaded = (args: Object): void => {
        //define check condition
        let indicator: HTMLElement = document.getElementById(
          'containerIndicatorGroup0'
    ...
    it('SMA Technical indicator for a series with valid points & primary axis', (done: Function) => {
      loaded = (args: Object): void => {
        //define check condition
        let signalLine: HTMLElement = document.getElementById(
          'container_Indicator_0_SMA'
        );
        ...
        expect(chartObj.visibleSeries[1].points[0].y).toBe(1.3);
        expect(chartObj.visibleSeries[1].points[3].y).toBe(5.733333333333334);
        expect(chartObj.visibleSeries[1].points[5].y).toBe(9.833333333333334);
        expect(chartObj.visibleSeries[1].points[8].y).toBe(5.333333333333333);
        done();
      };
    ...
    //negative points
    it('SMA Technical indicator for a series with negative points', (done: Function) => {
      loaded = (args: Object): void => {
        //define check condition
        let point: HTMLElement = document.getElementById(
        ...
        expect(chartObj.visibleSeries[1].points[4].y).toBe(1.3666666666666671);
        expect(chartObj.visibleSeries[1].points[3].y).toBe(
          -0.39999999999999974
        );
        done();
    ...
    it('SMA Technical indicator for a series with secondary y axis', (done: Function) => {
      loaded = (args: Object): void => {
        //define check condition
        let svg: HTMLElement = document.getElementById('containerAxisLine_2');
        expect(
          svg.getAttribute('d').split(' ')[1] == '767.5' ||
            svg.getAttribute('d').split(' ')[1] == '767.5'
        ).toBe(true);
        expect(
          svg.getAttribute('d').split(' ')[2] == '43.25' ||
            svg.getAttribute('d').split(' ')[2] == '45.25'
        ).toBe(true);
        expect(
          svg.getAttribute('d').split(' ')[4] == '767.5' ||
            svg.getAttribute('d').split(' ')[4] == '767.5'
        ).toBe(true);
        expect(
          svg.getAttribute('d').split(' ')[5] == '360.5' ||
            svg.getAttribute('d').split(' ')[5] == '360.5'
        ).toBe(true);
      ...
      chartObj.axes = [
        { name: 'secondary', minimum: 0, maximum: 25, opposedPosition: true },
      ];
    ...
    it('SMA Technical indicator with hidden series', (done: Function) => {
      loaded = (args: Object): void => {
        //define check condition
        let signalLine: HTMLElement = document.getElementById(
          'container_Indicator_0_SMA'
    ...
    it('SMA Technical indicator with opposed position', (done: Function) => {
      loaded = (args: Object): void => {
        //define check condition
        let signalLine: HTMLElement = document.getElementById(
          'container_Indicator_0_SMA'
        ...
        expect(
          svg.getAttribute('d').split(' ')[1] == '53.5' ||
            svg.getAttribute('d').split(' ')[1] == '62.5' ||
            svg.getAttribute('d').split(' ')[1] == '53.5'
        ).toBe(true);
        expect(
          svg.getAttribute('d').split(' ')[2] == '89.75' ||
            svg.getAttribute('d').split(' ')[2] == '88.75'
        ).toBe(true);
        expect(
          svg.getAttribute('d').split(' ')[4] == '767.5' ||
            svg.getAttribute('d').split(' ')[4] == '767.5'
        ...
        expect(
          svg.getAttribute('d').split(' ')[5] == '89.75' ||
            svg.getAttribute('d').split(' ')[5] == '88.75'
        ).toBe(true);
        done();
      };
    ...
    //plot offset
    it('SMA Technical indicator with secondary axis and plot offset', (done: Function) => {
      loaded = (args: Object): void => {
        //define check condition
        let signalLine: HTMLElement = document.getElementById(
          'container_Indicator_0_SMA'
    ...
    //---appearance----
    it('SMA Technical indicator with default appearance', (done: Function) => {
      loaded = (args: Object): void => {
        //define check condition
        let signalLine: HTMLElement = document.getElementById(
          'container_Indicator_0_SMA'
    ...
    it('SMA Technical indicator with custom color', (done: Function) => {
      loaded = (args: Object): void => {
        //define check condition
        let signalLine: HTMLElement = document.getElementById(
          'container_Indicator_0_SMA'
    ...
    it('SMA Technical indicator with custom stroke style', (done: Function) => {
      loaded = (args: Object): void => {
        //define check condition
        let signalLine: HTMLElement = document.getElementById(
          'container_Indicator_0_SMA'
    ...
    //tooltip
    it('SMA Technical indicator with tooltip', (done: Function) => {
      loaded = (args: Object): void => {
        //define check condition
        ...
        let y: number =
          ...
          series.points[1].regions[0].height / 2 +
        ...
        expect(target.getAttribute('aria-label') == 'Feb:6.3:1.3:2.5:4.8').toBe(
          true
        );
    ...
    //crosshair
    it('SMA Technical indicator with cross hair', (done: Function) => {
      loaded = (args: Object): void => {
        //define check condition
        let chartArea: HTMLElement = document.getElementById(
          'container_ChartAreaBorder'
        ...
        let y: number =
          ...
          series.points[2].regions[0].height / 2 +
          parseFloat(chartArea.getAttribute('y'));
        let x: number =
        ...
        expect(
          Math.round(+element1.textContent) == 6 ||
            Math.round(+element1.textContent) == 8
        ).toBe(true);
        done();
      };
      chartObj.tooltip = { enable: true };
    ...
    //trackball
    it('SMA Technical indicator with track ball', (done: Function) => {
      loaded = (args: Object): void => {
        //define check condition
        let tooltip: Element;
        ...
        expect(
          (<Element>text1.childNodes[0]).getAttribute('fill') ==
            'rgba(249, 250, 251, 1)'
        ).toBe(true);
        expect(
          text1.textContent.replace(/\u200E/g, '') ==
            'FebgoldHigh : 6.3Low : 1.3Open : 4.8Close : 2.5'
        ).toBe(true);
    ...
    //resizing charts
    it('SMA Technical indicator when resizing the chart', (done: Function) => {
      loaded = (args: Object): void => {
        //define check condition
    ...
    //default period
    it('SMA Technical indicator with default period', (done: Function) => {
      loaded = (args: Object): void => {
        let signalLine: HTMLElement = document.getElementById(
          'container_Indicator_0_SMA'
        );
    ...
    //custom period
    it('SMA Technical indicator with custom period', (done: Function) => {
      loaded = (args: Object): void => {
        let signalLine: HTMLElement = document.getElementById(
          'container_Indicator_0_SMA'
        );
        ...
        expect(chartObj.visibleSeries[1].points[0].y).toBe(5.67);
        expect(chartObj.visibleSeries[1].points[1].y).toBe(5.75);
        expect(chartObj.visibleSeries[1].points[2].y).toBe(6.130000000000001);
        done();
      };
    ...
    it('checking mouse wheel zooming', (done: Function) => {
      loaded = (args: Object): void => {
        ...
        expect(
          chartObj.primaryXAxis.zoomFactor.toFixed(2) == '1.00' ||
            chartObj.primaryXAxis.zoomFactor.toFixed(2) == '0.72'
        ).toBe(true);
        expect(
          chartObj.primaryYAxis.zoomFactor.toFixed(2) == '1.00' ||
            chartObj.primaryYAxis.zoomFactor.toFixed(2) == '0.72'
        ).toBe(true);
        expect(
          chartObj.primaryXAxis.zoomPosition.toFixed(2) == '0.00' ||
            chartObj.primaryXAxis.zoomPosition.toFixed(2) == '0.11'
        ).toBe(true);
        expect(
          chartObj.primaryYAxis.zoomPosition.toFixed(2) == '0.00' ||
            chartObj.primaryYAxis.zoomPosition.toFixed(2) == '0.01' ||
            chartObj.primaryYAxis.zoomPosition.toFixed(2) == '0.02'
        ).toBe(true);
        done();
      };
    ...
    it('checking  zooming with touch', (done: Function) => {
      loaded = (args: Object): void => {
        ...
        expect(
          content == '1.00' || content == '0.23' || content == '0.17'
        ).toBe(true);
        content = chartObj.primaryYAxis.zoomFactor.toFixed(2);
        expect(
          content == '1.00' || content == '0.63' || content == '0.45'
        ).toBe(true);
        content = chartObj.primaryXAxis.zoomPosition.toFixed(2);
        expect(
          content == '0.00' || content == '0.72' || content == '0.63'
        ).toBe(true);
        chartObj.mouseLeave(
          <PointerEvent>(
    ...
    //---multiple panel----
    it('SMA Technical indicator using panels', (done: Function) => {
      loaded = (args: Object): void => {
        ...
        expect(
          Math.round(rect.top) === 368 || Math.round(rect.top) === 369
        ).toBe(true);
        done();
      };
      chartObj.axes = [
    ...
    it('Moving Average with comparative field as open', (done: Function) => {
      loaded = (args: Object): void => {
        ...
        expect(signalLine.getAttribute('d')).not.toBeNull();
        expect(chartObj.visibleSeries[1].points[0].x).toBe('Mar');
        expect(chartObj.visibleSeries[1].points[0].y).toBe(5.6000000000000005);
        expect(chartObj.visibleSeries[1].points[3].x).toBe('Jun');
        expect(chartObj.visibleSeries[1].points[5].y).toBe(14.866666666666669);
        expect(chartObj.visibleSeries[1].points[8].y).toBe(9.533333333333337);
        done();
      };
    ...
    it('Moving Average with comparative field as high', (done: Function) => {
      loaded = (args: Object): void => {
        ...
        expect(signalLine.getAttribute('d')).not.toBeNull();
        expect(chartObj.visibleSeries[1].points[0].x).toBe('Mar');
        expect(chartObj.visibleSeries[1].points[0].y).toBe(6.966666666666666);
        expect(chartObj.visibleSeries[1].points[3].x).toBe('Jun');
        expect(chartObj.visibleSeries[1].points[5].y).toBe(18.333333333333332);
        expect(chartObj.visibleSeries[1].points[8].y).toBe(11.833333333333334);
        done();
      };
