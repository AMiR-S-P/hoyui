  ...
  describe('AD Technical Indicators', () => {
    ...
    it('AD Technical indicator for a series with valid points & primary axis', (done: Function) => {
      loaded = (args: Object): void => {
        ...
        let signalLine: HTMLElement = document.getElementById(
          'container_Indicator_0_AccumulationDistribution'
        );
    ...
    it('AD Technical indicator for a series with secondary y axis', (done: Function) => {
      loaded = (args: Object): void => {
        ...
        expect(
          svg.getAttribute('d').split(' ')[1] == '763.5' ||
        ...
        expect(
          svg.getAttribute('d').split(' ')[4] == '763.5' ||
      ...
      loaded = (args: Object): void => {
        ...
        expect(
          text1.textContent.replace(/\u200E/g, '') ==
            'FebgoldHigh : 6.3Low : 1.3Open : 4.8Close : 2.5AccumulationDistribution : -10.385'
        ).toBe(true);
