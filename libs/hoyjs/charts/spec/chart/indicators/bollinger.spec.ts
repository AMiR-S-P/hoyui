  ...
  describe('BollingerBand Indicators', () => {
    ...
    it('BollingerBand Technical indicator for a series with valid points & primary axis', (done: Function) => {
      loaded = (args: Object): void => {
        ...
        let signalLine: HTMLElement = document.getElementById(
          'container_Indicator_0_BollingerBand'
        );
        ...
        expect(Math.round(<number>chartObj.visibleSeries[2].points[0].y)).toBe(
          3
        );
        expect(chartObj.visibleSeries[1].points[3].x).toBe('Jun');
        expect(Math.round(<number>chartObj.visibleSeries[2].points[5].y)).toBe(
          10
        );
        done();
      };
    ...
    it('BollingerBand Technical indicator for a series with negative points', (done: Function) => {
      loaded = (args: Object): void => {
        ...
        expect(Math.round(<number>chartObj.visibleSeries[2].points[3].y)).toBe(
          5
        );
        done();
    ...
    it('checking zooming with touch', (done: Function) => {
      loaded = (args: Object): void => {
        ...
        expect(
          content == '0.02' || content == '0.23' || content == '0.17'
        ).toBe(true);
        ...
        expect(
          content == '0.625' || content == '0.72' || content == '0.63'
        ).toBe(true);
        chartObj.mouseLeave(
          <PointerEvent>(
    ...
    it('BollingerBand Technical indicator using panels', (done: Function) => {
      loaded = (args: Object): void => {
        ...
        expect(Math.round(rect.top) == 378 || Math.round(rect.top) == 377).toBe(
          true
        );
        chartObj.loaded = null;
        done();
    ...
    it('Checking series animationEvent', (done: Function) => {
      animationComplete = (args: IAnimationCompleteEventArgs): void => {
        ...
        expect(
          point.getAttribute('transform') === 'translate(57.5,312.925)' ||
