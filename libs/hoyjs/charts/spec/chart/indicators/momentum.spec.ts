    ...
    it('Momentum Technical indicator for a series with valid points & primary axis', (done: Function) => {
      loaded = (args: Object): void => {
        ...
        let signalLine: HTMLElement = document.getElementById(
          'container_Indicator_0_Momentum'
        );
      ...
      loaded = (args: Object): void => {
        ...
        expect(
          text1.textContent.replace(/\u200E/g, '') ==
            'FebgoldHigh : 6.3Low : 1.3Open : 4.8Close : 2.5UpperLine : 100'
        ).toBe(true);
    ...
    it('Momentum Technical indicator using panels', (done: Function) => {
      loaded = (args: Object): void => {
        let element: HTMLElement = document.getElementById(
          'container_Indicator_0_UpperLine_Group'
        );
        let rect: ClientRect;
        rect = element.getBoundingClientRect();
        expect(
          Math.round(rect.top) === 392 || Math.round(rect.top) === 391
        ).toBe(true);
        done();
      };
      chartObj.axes = [
