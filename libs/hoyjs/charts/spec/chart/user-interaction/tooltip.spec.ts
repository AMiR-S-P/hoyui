  ...
  describe('Chart Tooltip', () => {
    ...
    it('Point mouse move and click', (done: Function) => {
      loaded = (args: Object): void => {
        targetElement = chartObj.element.querySelector(
        ...
        y =
          parseFloat(targetElement.getAttribute('cy')) +
          parseFloat(chartArea.getAttribute('y')) +
          elem.offsetTop;
        x =
          parseFloat(targetElement.getAttribute('cx')) +
    ...
    it('Default Tooltip', (done: Function) => {
      loaded = (args: Object): void => {
        ...
        let group: HTMLElement = tooltip.childNodes[0]
        ...
        expect(
          text1.textContent.replace(/\u200E/g, '') ==
            'ChartSeriesNameGold$2000.00 : 40'
        ).toBe(true);
        ...
        expect(
          (<HTMLElement>group.childNodes[2]).getAttribute('d') != '' || ' '
        ).toBe(true);
        done();
      };
    ...
    it('Edge Tooltip', () => {
      ...
      let text2: HTMLElement = tooltip.childNodes[0].childNodes[0]
        .childNodes[1] as HTMLElement;
      expect(text2.textContent.replace(/\u200E/g, '')).toEqual(
        'ChartSeriesNameGold$1000.00 : 70'
      );
      ...
      x =
        ...
        1;
      trigger.mousemovetEvent(targetElement, Math.ceil(x), Math.ceil(y));
      let text1: HTMLElement = tooltip.childNodes[0].childNodes[0]
        .childNodes[1] as HTMLElement;

      expect(
        text1.textContent.replace(/\u200E/g, '') ==
          'ChartSeriesNameGold$8000.00 : 70'
      ).toBe(true);
      expect(
        (<HTMLElement>(
          tooltip.childNodes[0].childNodes[0].childNodes[2]
        )).getAttribute('d') != '' || ' '
      ).toBe(true);
    });
    ...
    it('Tooltip with Highlight color', (done: Function) => {
      ...
      loaded = (args: Object): void => {
        ...
        y =
          series.points[5].regions[0].y +
          parseFloat(chartArea.getAttribute('y')) +
          elem.offsetTop;
        x =
          series.points[5].regions[0].x +
          parseFloat(chartArea.getAttribute('x')) +
          elem.offsetLeft;
        trigger.mousemovetEvent(target, Math.ceil(x), Math.ceil(y));
        expect(target.getAttribute('opacity') == '1').toBe(true);
    ...
    it('Tooltip for Negative point', (done: Function) => {
      ...
      loaded = (args: Object): void => {
        ...
        expect(
          parseFloat(tooltip.style.top) <
            series.points[1].regions[0].height +
              series.points[1].regions[0].y +
              parseFloat(chartArea.getAttribute('y'))
        );
        ...
        expect(
          parseFloat(tooltip.style.top) >
            series.points[5].regions[0].height +
              series.points[5].regions[0].y +
              parseFloat(chartArea.getAttribute('y'))
        );
        done();
    ...
    it('Tooltip for Category Axis', (done: Function) => {
      loaded = (args: Object): void => {
        let target: HTMLElement = document.getElementById(
          'container_Series_0_Point_6_Symbol'
        );
        let chartArea: HTMLElement = document.getElementById(
          'container_ChartAreaBorder'
        );
    ...
    it('checking tooltip with fixed location', (done: Function) => {
      loaded = (args: Object): void => {
        ...
        y = (<Points>(<Series>chartObj.series[0]).points[2]).symbolLocations[0]
          .y;
        x = (<Points>(<Series>chartObj.series[0]).points[2]).symbolLocations[0]
          .x;
    ...
    it('Tooltip Without marker', (done: Function) => {
      ...
      loaded = (args: Object): void => {
        ...
        y = (<Points>(<Series>chartObj.series[0]).points[4]).symbolLocations[0]
          .y;
        x = (<Points>(<Series>chartObj.series[0]).points[4]).symbolLocations[0]
          .x;
        y += parseFloat(chartArea.getAttribute('y')) + elem.offsetTop;
        x += parseFloat(chartArea.getAttribute('x')) + elem.offsetLeft;
        trigger.mousemovetEvent(chartArea, Math.ceil(x), Math.ceil(y));
    ...
    it('Tooltip for datetime Axis', (done: Function) => {
      loaded = (args: Object): void => {
        ...
        expect(
          text1.textContent.replace(/\u200E/g, '') ==
            'ChartSeriesNameGold2006 : 65'
        ).toBe(true);
        remove(document.getElementById('container_tooltip'));
        remove(
          document.getElementById('container_Series_0_Point_3_Trackball_0')
        );
        remove(
          document.getElementById('container_Series_0_Point_3_Trackball_1')
        );
        done();
      };
    ...
    it('Changing the visibility of tooltip with axis label format', (done: Function) => {
      ...
      loaded1 = (args: Object): void => {
        ...
        expect(
          text1.textContent.replace(/\u200E/g, '') ==
            'ChartSeriesNameGold#3000 : 70C'
        ).toBe(true);
        expect(
          document
            .getElementById('container_Series_0_Point_2_Trackball_0')
            .getAttribute('fill') == 'transparent'
        ).toBe(true);
      ...
      chartObj.animationComplete = (args: Object): void => {
        let track: HTMLElement = document.getElementById(
          'container_Series_0_Point_2_Trackball_0'
        );
    ...
    it('Tooltip for column with marker', (done: Function) => {
      loaded = (args: Object): void => {
        ...
        let tooltip: HTMLElement = document.getElementById('container_tooltip');
        expect(
          +tooltip.style.top.replace('px', '') < +target.getAttribute('cy')
        ).toBe(true);
        expect(tooltip != null).toBe(true);
        done();
      };
    ...
    it('checking with tooltipRender event with template', (done: Function) => {
      loaded = (args: Object): void => {
        ...
        let target1: HTMLElement = document.getElementById(
        ...
        let tooltip: HTMLElement = document.getElementById('container_tooltip');
        expect(tooltip != null).toBe(true);
        expect(tooltip.firstElementChild.innerHTML).toEqual(
          '<div>40C</div><div>7000</div>'
        );
        y =
          parseFloat(target1.getAttribute('cy')) +
          parseFloat(chartArea.getAttribute('y')) +
          elem.offsetTop;
        x =
          parseFloat(target1.getAttribute('cx')) +
          parseFloat(chartArea.getAttribute('x')) +
          elem.offsetLeft;
        trigger.mousemovetEvent(target1, Math.ceil(x), Math.ceil(y));
        expect(tooltip.firstElementChild.innerHTML).toEqual(
          '<div>6000</div><div>-20C</div>'
        );
        done();
      };
      chartObj.loaded = loaded;
      ...
      chartObj.series = [
        {
          type: 'Line',
          dataSource: [
            { x: new Date(2012, 9, 11), y: 80 },
            { x: new Date(2012, 10, 11), y: 90 },
          ],
          xName: 'x',
          yName: 'y',
          animation: { enable: false },
        ...
        {
          type: 'Line',
          dataSource: [{ x: new Date(2012, 11, 11), y: 70 }],
          xName: 'x',
          yName: 'y',
          animation: { enable: false },
        ...
        {
          type: 'Line',
          dataSource: [{ x: new Date(2013, 1, 11), y: 70 }],
          xName: 'x',
          yName: 'y',
          animation: { enable: false },
          marker: { visible: true, shape: 'Circle' },
  ...
  describe('Chart- tooltip opacity and theme', () => {
    ...
    it('Checking tooltip module fade out method', (done: Function) => {
      loaded = (args: ILoadedEventArgs): void => {
        ...
        args.chart.tooltipModule.removeTooltip(0);
        trigger.mousemovetEvent(chartArea, Math.ceil(0), Math.ceil(0));
        args.chart.tooltipModule.fadeOut(
          (args.chart.series[0] as any).points[1]
        );
        ...
        args.chart.tooltipModule.removeHighlightedMarker(
          (args.chart.series[0] as any).points[1],
          true
        );
