...
describe('Chart Crosshair', () => {
  ...
  describe('Chart Crosshair Default', () => {
    ...
    it('Default Crosshair', (done: Function) => {
      loaded = (args: Object): void => {
        ...
        expect(
          element1.textContent == '$39.86' || element1.textContent == '$39.85'
        ).toBe(true);
    ...
    it('Customizing Axis Tooltip', (done: Function) => {
      loaded = (args: Object): void => {
        ...
        y =
          parseFloat(chartArea.getAttribute('y')) +
          parseFloat(chartArea.getAttribute('height')) / 4 +
          elem.offsetTop;
        x =
          parseFloat(chartArea.getAttribute('x')) +
          parseFloat(chartArea.getAttribute('width')) / 4 +
          elem.offsetLeft;
        trigger.mousemovetEvent(chartArea, Math.ceil(x), Math.ceil(y));
    ...
    it('Inversed Axis with tooltip', (done: Function) => {
      ...
      loaded = (args: Object): void => {
        ...
        element1 = <HTMLElement>(
          document.getElementById('container_axis_tooltip_text_0')
        );
        expect(element1.textContent == 'USA').toBe(true);
        done();
      };
  ...
  describe('Chart Crosshair Default', () => {
    ...
    beforeAll(() => {
      ...
      chartObj1 = new Chart({
        ...
        axes: [
          ...
          { name: 'yAxis1', crosshairTooltip: { enable: true } },
          { name: 'yAxis2', opposedPosition: true },
          {
            name: 'xAxis2',
            valueType: 'DateTime',
            crosshairTooltip: { enable: true },
    ...
    it('Default Crosshair with different type of axis', (done: Function) => {
      loaded = (args: Object): void => {
        ...
        element1 = <HTMLElement>crosshair.childNodes[2].childNodes[3];
        expect(
          element1.textContent == '$59.81' || element1.textContent == '$59.74'
        ).toBe(true);
    ...
    it('Changing the Visibility different axis', (done: Function) => {
      loaded = (args: Object): void => {
        ...
        element1 = <HTMLElement>crosshair.childNodes[2].childNodes[1];
        expect(
          element1.textContent == '$59.74' || element1.textContent == '$59.73'
        ).toBe(true);
    ...
    it('crosshair with multiple axes', (done: Function) => {
      loaded = (args: Object): void => {
        ...
        element1 = <HTMLElement>crosshair.childNodes[2].childNodes[1];
        expect(
          element1.textContent == '104.7' || element1.textContent == '102.9'
        ).toBe(true);
        done();
      };
      ...
      chartObj1.rows = [
        { height: '200', border: { width: 2, color: 'red' } },
  ...
  describe('Crosshair customization', () => {
    ...
    it('X axis crosshair opacity checking', (done: Function) => {
      loaded = (args: Object): void => {
        let chartArea: HTMLElement = document.getElementById(
          'crosshairContainer_ChartAreaBorder'
        );
        y =
          parseFloat(chartArea.getAttribute('y')) +
          parseFloat(chartArea.getAttribute('height')) / 4 +
        ...
        trigger.mousemovetEvent(chartArea, Math.ceil(x), Math.ceil(y));
        let crosshair: Element = <Element>(
          document.getElementById('crosshairContainer_svg').lastChild
        );
        let element1: HTMLElement;
        let element2: HTMLElement;
        expect(
          crosshair.childNodes.length == 3 || crosshair.childNodes.length == 2
        ).toBe(true);
        element1 = <HTMLElement>crosshair.childNodes[0];
        expect(
          element1.getAttribute('opacity') == '0.5' ||
            element1.getAttribute('opacity') == '1'
        ).toBe(true);
        element2 = <HTMLElement>crosshair.childNodes[1];
        expect(
          element2.getAttribute('opacity') == '0.5' ||
            element2.getAttribute('opacity') == null
        ).toBe(true);
        done();
      };
    ...
    it('Customizing crosshair color', (done: Function) => {
      loaded = (args: Object): void => {
        ...
        element2 = <HTMLElement>crosshair.childNodes[1];
        expect(
          element1.getAttribute('fill') == 'red' ||
            element1.getAttribute('fill') == 'transparent'
        ).toBe(true);
        expect(
          element2.getAttribute('fill') == 'green' ||
            element2.getAttribute('fill') == null
        ).toBe(true);
        done();
      };
    ...
    it('Crosshair color checking with Bootstrap5 theme', (done: Function) => {
      loaded = (args: Object): void => {
        ...
        element2 = <HTMLElement>crosshair.childNodes[1];
        expect(
          element1.getAttribute('fill') == '#343A40' ||
            element1.getAttribute('fill') == 'transparent'
        ).toBe(true);
        expect(
          element2.getAttribute('fill') == '#343A40' ||
            element2.getAttribute('fill') == null
        ).toBe(true);
        done();
      };
    ...
    it('Crosshair color checking with Bootstrap5 dark theme', (done: Function) => {
      loaded = (args: Object): void => {
        ...
        element2 = <HTMLElement>crosshair.childNodes[1];
        expect(
          element1.getAttribute('fill') == '#ADB5BD' ||
            element1.getAttribute('fill') == 'transparent'
        ).toBe(true);
        expect(
          element2.getAttribute('fill') == '#ADB5BD' ||
            element2.getAttribute('fill') == null
        ).toBe(true);
        done();
      };
