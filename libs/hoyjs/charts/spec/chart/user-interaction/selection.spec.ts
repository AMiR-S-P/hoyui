...
describe('Chart Control Selection ', () => {
  ...
  beforeAll(() => {
    ...
    document.body.appendChild(
      createElement('style', {
        innerHTML:
          ' .selection { stroke-width: 5; fill: lime; stroke: red; opacity: 1; } ',
      })
    );
    chartObj = new Chart({
  ...
  it('MultiSelect true Selection Mode Series', (done: Function) => {
    loaded = () => {
      ...
      trigger.clickEvent(element);
      expect(
        document.getElementsByClassName(selection + '0')[0].childNodes.length
      ).toBe(chartObj.visibleSeries[0].points.length + 1);
      expect(
        document.getElementsByClassName(selection + '1')[0].childNodes.length
      ).toBe(chartObj.visibleSeries[1].points.length + 1);
      expect(
        document.getElementsByClassName(selection + '2')[0].childNodes.length
      ).toBe(chartObj.visibleSeries[2].points.length + 1);
  ...
  it('Multiple point selection and UnSelection', (done: Function) => {
    loaded = () => {
      for (j = 0; j < seriesCollection.length; j++) {
        let val: number = 0;
        for (
          i = 0, length = chartObj.visibleSeries[j].points.length;
          i < length;
          i++
        ) {
          element = document.getElementById(
            id + '_Series_' + j + '_Point_' + i
          );
          trigger.clickEvent(element);
  ...
  it('Selection mode DragX', (done: Function) => {
    loaded = () => {
      ...
      expect(
        element.getAttribute('height') == '419.75' ||
          element.getAttribute('height') == '421.75'
      ).toBe(true);
  ...
  it('Selection mode DragY', (done: Function) => {
    loaded = () => {
      ...
      expect(
        element.getAttribute('x') == '33.25' ||
          element.getAttribute('x') == '32.25'
      ).toBe(true);
      expect(element.getAttribute('y')).toEqual('92');
      expect(element.getAttribute('height')).toEqual('200');
      expect(
        element.getAttribute('width') == '757' ||
          element.getAttribute('width') == '758'
      ).toBe(true);
      done();
    };
  ...
  it('DragComplete selection event', (done: Function) => {
    let dragCompleted: EmitType<IDragCompleteEventArgs> = (
      args: IDragCompleteEventArgs
    ) => {
  ...
  it('Multiple axis drag selection ', (done: Function) => {
    loaded = () => {
      element = document.getElementById(id + '_Series_2_Point_' + 3);
      trigger.clickEvent(element);
      expect(document.getElementsByClassName(selection + 1).length > 0).toBe(
        false
      );
      trigger.draganddropEvent(chartContainer, 250, 100, 450, 250);
      element = document.getElementById(draggedRectGroup);
    ...
    chartObj.selectionMode = 'DragXY';
    chartObj.columns = [
      { width: '50%', border: { width: 4, color: 'red' } },
  ...
  it('Patterns with Dots', (done: Function) => {
    loaded = () => {
      expect(
        document.getElementById(id + '_svg').querySelectorAll('pattern').length
      ).toBe(3);
      expect(
        document.getElementById(id + '_svg').querySelectorAll('pattern')[0]
          .id === 'ej2Container_Dots_Selection_0'
      ).toBe(true);
      done();
    };
    chartObj.loaded = loaded;
  ...
  it('Patterns with DiagonalForward', (done: Function) => {
    loaded = () => {
      ...
      expect(
        document.getElementById(id + '_svg').querySelectorAll('pattern')[0]
          .id === 'ej2Container_DiagonalForward_Selection_0'
      ).toBe(true);
      done();
    };
    chartObj.loaded = loaded;
  ...
  it('Patterns with Crosshatch', (done: Function) => {
    loaded = () => {
      ...
      expect(
        document.getElementById(id + '_svg').querySelectorAll('pattern')[0]
          .id === 'ej2Container_Crosshatch_Selection_0'
      ).toBe(true);
      done();
    };
    chartObj.loaded = loaded;
  ...
  it('Patterns with Pacman', (done: Function) => {
    loaded = () => {
      ...
      expect(
        document.getElementById(id + '_svg').querySelectorAll('pattern')[0]
          .id === 'ej2Container_Pacman_Selection_0'
      ).toBe(true);
      done();
    };
    chartObj.loaded = loaded;
  ...
  it('Patterns with DiagonalBackward', (done: Function) => {
    loaded = () => {
      ...
      expect(
        document.getElementById(id + '_svg').querySelectorAll('pattern')[0]
          .id === 'ej2Container_DiagonalBackward_Selection_0'
      ).toBe(true);
      done();
    };
    chartObj.loaded = loaded;
  ...
  it('Patterns with Grid', (done: Function) => {
    loaded = () => {
      ...
      expect(
        document.getElementById(id + '_svg').querySelectorAll('pattern')[0]
          .id === 'ej2Container_Grid_Selection_0'
      ).toBe(true);
      done();
    };
    chartObj.loaded = loaded;
  ...
  it('Patterns with Turquoise', (done: Function) => {
    loaded = () => {
      ...
      expect(
        document.getElementById(id + '_svg').querySelectorAll('pattern')[1]
          .id === 'ej2Container_Turquoise_Selection_1'
      ).toBe(true);
      done();
    };
    chartObj.loaded = loaded;
  ...
  it('Patterns with Star', (done: Function) => {
    loaded = () => {
      ...
      expect(
        document.getElementById(id + '_svg').querySelectorAll('pattern')[0]
          .id === 'ej2Container_Star_Selection_0'
      ).toBe(true);
      done();
    };
    chartObj.loaded = loaded;
  ...
  it('Patterns with Triangle', (done: Function) => {
    loaded = () => {
      ...
      expect(
        document.getElementById(id + '_svg').querySelectorAll('pattern')[2]
          .id === 'ej2Container_Triangle_Selection_2'
      ).toBe(true);
      done();
    };
    chartObj.loaded = loaded;
  ...
  it('Patterns with Chessboard', (done: Function) => {
    loaded = () => {
      ...
      expect(
        document.getElementById(id + '_svg').querySelectorAll('pattern')[2]
          .id === 'ej2Container_Chessboard_Selection_2'
      ).toBe(true);
      done();
    };
    chartObj.loaded = loaded;
  ...
  it('Patterns with Circle', (done: Function) => {
    loaded = () => {
      ...
      expect(
        document.getElementById(id + '_svg').querySelectorAll('pattern')[0]
          .id === 'ej2Container_Circle_Selection_0'
      ).toBe(true);
      done();
    };
    chartObj.loaded = loaded;
  ...
  it('Patterns with Tile', (done: Function) => {
    loaded = () => {
      ...
      expect(
        document.getElementById(id + '_svg').querySelectorAll('pattern')[0]
          .id === 'ej2Container_Tile_Selection_0'
      ).toBe(true);
      done();
    };
    chartObj.loaded = loaded;
  ...
  it('Patterns with HorizontalDash', (done: Function) => {
    loaded = () => {
      ...
      expect(
        document.getElementById(id + '_svg').querySelectorAll('pattern')[0]
          .id === 'ej2Container_HorizontalDash_Selection_0'
      ).toBe(true);
      done();
    };
    chartObj.loaded = loaded;
  ...
  it('Patterns with VerticalDash', (done: Function) => {
    loaded = () => {
      ...
      expect(
        document.getElementById(id + '_svg').querySelectorAll('pattern')[0]
          .id === 'ej2Container_VerticalDash_Selection_0'
      ).toBe(true);
      done();
    };
    chartObj.loaded = loaded;
  ...
  it('Patterns with Rectangle', (done: Function) => {
    loaded = () => {
      ...
      expect(
        document.getElementById(id + '_svg').querySelectorAll('pattern')[0]
          .id === 'ej2Container_Rectangle_Selection_0'
      ).toBe(true);
      done();
    };
    chartObj.loaded = loaded;
  ...
  it('Patterns with Box', (done: Function) => {
    loaded = () => {
      ...
      expect(
        document.getElementById(id + '_svg').querySelectorAll('pattern')[0]
          .id === 'ej2Container_Box_Selection_0'
      ).toBe(true);
      done();
    };
    chartObj.loaded = loaded;
  ...
  it('Patterns with VerticalStripe', (done: Function) => {
    loaded = () => {
      ...
      expect(
        document.getElementById(id + '_svg').querySelectorAll('pattern')[0]
          .id === 'ej2Container_VerticalStripe_Selection_0'
      ).toBe(true);
      done();
    };
    chartObj.loaded = loaded;
  ...
  it('Patterns with Bubble', (done: Function) => {
    loaded = () => {
      ...
      expect(
        document.getElementById(id + '_svg').querySelectorAll('pattern')[0]
          .id === 'ej2Container_Bubble_Selection_0'
      ).toBe(true);
      done();
    };
    chartObj.loaded = loaded;
  ...
  it('Patterns with HorizontalStripe', (done: Function) => {
    loaded = () => {
      ...
      expect(
        document.getElementById(id + '_svg').querySelectorAll('pattern')[0]
          .id === 'ej2Container_HorizontalStripe_Selection_0'
      ).toBe(true);
      done();
    };
    chartObj.loaded = loaded;
...
describe('Range color mapping charts selection in Point mode', function () {
  ...
  it('range color mapping Star selection in point mode', function (done) {
    loaded = function () {
      ...
      expect(
        document.querySelectorAll('pattern')[0].id === id + '_Star_Selection_0'
      ).toBe(true);
      done();
    };
    chartObj.loaded = loaded;
  ...
  it('range color mapping Circle selection in point mode', function (done) {
    loaded = function () {
      ...
      trigger.clickEvent(element2);
      expect(
        document.querySelectorAll('pattern')[0].id ===
          id + '_Circle_Selection_0'
      ).toBe(true);
      done();
    };
    chartObj.loaded = loaded;
  ...
  it('range color mapping Circle selection in point mode', function (done) {
    loaded = function () {
      ...
      trigger.clickEvent(element2);
      expect(
        document.querySelector('pattern').children[1].getAttribute('fill') ===
          element2.getAttribute('fill')
      ).toBe(true);
      done();
    };
    chartObj.loaded = loaded;
  ...
  it('range color mapping chart legend deselected', function (done) {
    loaded = function () {
      ...
      expect(
        document
          .getElementById(id + '_chart' + '_legend_shape_1')
          .getAttribute('class') ===
          id + '_ej2_deselected'
      ).toBe(true);
      done();
  ...
  it('range color mapping chart point deselected', function (done) {
    loaded = function () {
      ...
      expect(
        document
          .getElementById(id + '_Series_0' + '_Point_' + 3)
          .getAttribute('class') ===
          id + '_ej2_deselected'
      ).toBe(true);
      done();
  ...
  it('range color mapping chart point highlighting', function (done) {
    loaded = function () {
      ...
      expect(
        document.querySelectorAll('pattern')[1].id ===
          id + '_Circle_Selection_0'
      ).toBe(true);
      done();
    };
  ...
  it('range color mapping chart point color', function (done) {
    loaded = function () {
      ...
      expect(
        document
          .querySelectorAll('pattern')[0]
          .children[1].getAttribute('fill') === element2.getAttribute('fill')
      ).toBe(true);
      done();
    };
    chartObj.loaded = loaded;
  ...
  it('range color mapping chart legend point highlighted', function (done) {
    loaded = function () {
      ...
      expect(
        document
          .getElementById(id + '_Series_0' + '_Point_' + 0)
          .getAttribute('class') ===
          id + '_ej2_chart_highlight_series_0'
      ).toBe(true);
      expect(
        document
          .getElementById(id + '_Series_0' + '_Point_' + 1)
          .getAttribute('class') ===
          id + '_ej2_chart_highlight_series_0'
      ).toBe(true);
      expect(
        document
          .getElementById(id + '_Series_0' + '_Point_' + 11)
          .getAttribute('class') ===
          id + '_ej2_chart_highlight_series_0'
      ).toBe(true);
      expect(
  ...
  it('range color mapping chart legend higlighted another legend deselected', function (done) {
    loaded = function () {
      ...
      expect(
        document
          .getElementById(id + '_chart' + '_legend_shape_0')
          .getAttribute('class') ==
          id + '_ej2_deselected'
      ).toBe(true);
      expect(
        document
          .getElementById(id + '_chart' + '_legend_shape_2')
          .getAttribute('class') ==
          id + '_ej2_deselected'
      ).toBe(true);
      done();
...
describe('Point color mapping chart highlight and selection', function () {
    ...
    loaded = function () {
      ...
      expect(
        document
          .getElementById(id + '_Series_0' + '_Point_' + 0)
          .getAttribute('class') ===
          id + '_ej2_chart_selection_series_0'
      ).toBe(true);
      expect(
        document
          .getElementById(id + '_Series_0' + '_Point_' + 3)
  ...
  it('Point color mapping chart  point highlighted in Cluster Mode', function (done) {
    loaded = function () {
      ...
      expect(
        document
          .getElementById(id + '_Series_1' + '_Point_' + 0)
          .getAttribute('class') ===
          id + '_ej2_chart_selection_series_1'
      ).toBe(true);
      done();
    };
    chartObj.loaded = loaded;
    ...
    loaded = function () {
      ...
      expect(
        document
          .getElementById(id + '_Series_1' + '_Point_' + 0)
          .getAttribute('class') ===
          id + '_ej2_chart_highlight_series_1'
      ).toBe(true);
      done();
    };
    chartObj.loaded = loaded;
...
describe('Chart Selection: Checking drag ', () => {
  ...
  it('Chart selection checking index elements', (done: Function) => {
    loaded = (args: ILoadedEventArgs) => {
      args.chart.selectionModule.findElements(
        args.chart,
        args.chart.series[0],
        { series: 0, point: 0 },
        'element'
  ...
  it('Chart selection checking perform selection', (done: Function) => {
    loaded = (args: ILoadedEventArgs) => {
      ...
      args.chart.selectionModule.performSelection(
        { series: 0, point: 0 },
        args.chart,
        element
      );
