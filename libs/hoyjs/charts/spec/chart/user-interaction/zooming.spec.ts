...
export let categoryData: DataValue[] = [
  { x: 'USA', y: 50 },
  { x: 'China', y: 40 },
  { x: 'Japan', y: 70 },
  { x: 'Australia', y: 60 },
...
export let categoryData1: DataValue[] = [
  { x: 'USA', y: 70 },
  { x: 'China', y: 60 },
  { x: 'Japan', y: 60 },
  { x: 'Australia', y: 56 },
...
describe('Chart Control', () => {
  ...
  describe('Default Zooming Selection', () => {
    ...
    it('Selection zooming - false', (done: Function) => {
      loaded = (args: Object): void => {
        ...
        resetElement = document.getElementById('container_Zooming_Reset');
        expect(
          document.getElementById('container0_AxisLabel_0').textContent !=
            '2200.0'
        ).toBe(true);
        expect(resetElement == null).toBe(true);
        done();
    ...
    it('Checking series path', (done: Function) => {
      loaded = (args: Object): void => {
        ...
        resetElement = document.getElementById('container_Zooming_Reset');
        expect(
          document.getElementById('container_Series_0').getAttribute('d') != ''
        ).toBe(true);
    ...
    it('checking selection zooming in toolkit', (done: Function) => {
      loaded = (args: Object): void => {
        ...
        targetElement = document.getElementById(
          'container_Zooming_KitCollection'
        );
        trigger.dragEvent(targetElement, 10, 10, -400, 300);
        resetElement = document.getElementById('container_ZoomArea');
        expect(resetElement == null).toBe(true);
        trigger.mousedownEvent(
          document.getElementById('container_Zooming_Reset'),
          0,
          0,
          5,
          5
    ...
    it('checking selection zooming upTo bottom of the axis line', (done: Function) => {
      loaded = (args: Object): void => {
        ...
        expect(
          chartObj.primaryYAxis.zoomFactor.toFixed(2) == '0.84' ||
            chartObj.primaryYAxis.zoomFactor.toFixed(2) == '0.85'
        ).toBe(true);
        expect(chartObj.primaryYAxis.zoomPosition.toFixed(2) == '0.00').toBe(
          true
        );
        trigger.mousedownEvent(resetElement, 0, 0, 5, 5);
        done();
  ...
  describe('Checking Zooming Toolkit', () => {
    ...
    it('Selection zooming - shown single item Reset', (done: Function) => {
      loaded = (args: Object): void => {
        ...
        expect(
          path == 'translate(744,53.25)' || path == 'translate(759,50.25)'
        ).toBe(true);
        done();
      };
    ...
    it('Selection zooming - shown Reset and zoom', (done: Function) => {
      loaded = (args: Object): void => {
        ...
        expect(path == 'translate(46,13)' || path == 'translate(31,5)').toBe(
          true
        );
        done();
      };
    ...
    it('Selection zooming - Clicking zoom Button', (done: Function) => {
      ...
      trigger.mousedownEvent(
        document.getElementById('container_Zooming_Zoom'),
        0,
        0,
        5,
        5
    ...
    it('Checking Tooltip - Zoom Kit', (done: Function) => {
      ...
      let position: string =
        document.getElementById('chartmeasuretext').style.position;
    ...
    it('Checking pan Tooltip text with panning', (done: Function) => {
      chartObj.loaded = null;
      chartObj.zoomModule.isPanning = true;
      targetElement = document.getElementById(
        'container_Zooming_KitCollection'
      );
      trigger.mousemoveEvent(targetElement, 0, 0, 5, 5);
  ...
  describe('Checking Panning', () => {
    ...
    it('Checking Pan with mode X', (done: Function) => {
      loaded = (args: Object): void => {
        ...
        content = chartObj.primaryXAxis.zoomFactor.toFixed(2);
        expect(content == '0.41' || content == '0.42').toBe(true);
        expect(chartObj.primaryXAxis.zoomPosition.toFixed(2) == '0.55').toBe(
          true
        );
        done();
      };
    ...
    it('Checking Pan with mode Y', (done: Function) => {
      loaded = (args: Object): void => {
        ...
        expect(
          chartObj.primaryYAxis.zoomPosition.toFixed(2) == '0.16' ||
            chartObj.primaryYAxis.zoomPosition.toFixed(2) == '0.15'
        ).toBe(true);
        done();
      };
      chartObj.loaded = loaded;
    ...
    it('Checking deferred panning', (done: Function) => {
      loaded = (args: Object): void => {
        ...
        expect(chartObj.primaryXAxis.zoomPosition.toFixed(1) == '0.2').toBe(
          true
        );
        expect(chartObj.primaryYAxis.zoomPosition == 0).toBe(true);
    ...
    it('Checking touch panning', (done: Function) => {
      loaded = (args: Object): void => {
        ...
        chartObj.chartOnMouseDown(
          <PointerEvent>(
            trigger.onTouchStart(targetElement, 608, 189, null, null, 504, 289)
          )
        );
        chartObj.mouseMove(
          <PointerEvent>(
            trigger.onTouchMove(targetElement, 728, 389, null, null, 404, 189)
          )
        );
        chartObj.mouseEnd(
          <PointerEvent>(
            trigger.onTouchEnd(targetElement, 728, 389, null, null, 404, 189)
          )
        );
        content = chartObj.primaryXAxis.zoomFactor.toFixed(2);
    ...
    it('Checking deferred panning with outside of the area', (done: Function) => {
      loaded = (args: Object): void => {
        ...
        expect(chartObj.primaryYAxis.zoomFactor.toFixed(1) == '0.8').toBe(true);
        expect(chartObj.primaryXAxis.zoomPosition.toFixed(1) == '0.4').toBe(
          true
        );
        expect(chartObj.primaryYAxis.zoomPosition.toFixed(1) == '0.2').toBe(
          true
        );
        resetElement = document.getElementById('container_Zooming_Reset');
        expect(resetElement != null).toBe(true);
    ...
    it('Checking Panning with datetime axis', (done: Function) => {
      loaded = (args: Object): void => {
        ...
        trigger.dragEvent(elem, 400, 200, -200, 200);
        expect(
          document.getElementById('container_Zoom_0_AxisLabel_0') == null
        ).toBe(true);
        content = chartObj.primaryXAxis.zoomFactor.toFixed(2);
        expect(content == '0.41' || content == '0.42').toBe(true);
        content = chartObj.primaryYAxis.zoomFactor.toFixed(2);
  ...
  describe('Checking mode', () => {
    ...
    it('Checking zoom in with mode X ', (done: Function) => {
      loaded = (args: Object): void => {
        ...
        expect(chartObj.primaryXAxis.zoomFactor.toFixed(2) == '0.32').toBe(
          true
        );

        expect(chartObj.primaryYAxis.zoomFactor.toFixed(2) == '1.00').toBe(
          true
        );
    ...
    it('Checking zoom in with mode Y ', (done: Function) => {
      loaded = (args: Object): void => {
        ...
        trigger.mousedownEvent(targetElement, 0, 0, 5, 5);
        trigger.mousedownEvent(targetElement, 0, 0, 5, 5);
        expect(chartObj.primaryXAxis.zoomFactor.toFixed(2) == '1.00').toBe(
          true
        );
        expect(chartObj.primaryYAxis.zoomFactor.toFixed(2) == '0.37').toBe(
          true
        );
        expect(chartObj.primaryXAxis.zoomPosition.toFixed(2) == '0.00').toBe(
          true
        );
        expect(chartObj.primaryYAxis.zoomPosition.toFixed(2) == '0.24').toBe(
          true
        );
        done();
      };
  ...
  describe('Checking Mouse Wheel', () => {
    ...
    it('Checking mouse wheel as forward ', (done: Function) => {
      loaded = (args: Object): void => {
        ...
        chartObj.zoomModule.chartMouseWheel(<WheelEvent>wheelArgs);
        expect(chartObj.primaryXAxis.zoomFactor.toFixed(2) == '0.72').toBe(
          true
        );
        expect(chartObj.primaryYAxis.zoomFactor.toFixed(2) == '0.72').toBe(
          true
        );
        expect(chartObj.primaryXAxis.zoomPosition.toFixed(2) == '0.07').toBe(
          true
        );
        expect(chartObj.primaryYAxis.zoomPosition.toFixed(2) == '0.19').toBe(
          true
        );
        done();
      };
    ...
    it('Checking mouse wheel as backward ', (done: Function) => {
      loaded = (args: Object): void => {
        ...
        chartObj.zoomModule.chartMouseWheel(<WheelEvent>wheelArgs);
        expect(chartObj.primaryXAxis.zoomFactor.toFixed(2) == '0.97').toBe(
          true
        );
        expect(chartObj.primaryYAxis.zoomFactor.toFixed(2) == '0.97').toBe(
          true
        );
        expect(chartObj.primaryYAxis.zoomPosition.toFixed(2) == '0.02').toBe(
          true
        );
        done();
      };
    ...
    it('Checking mouse wheel as forward with mode x ', (done: Function) => {
      loaded = (args: Object): void => {
        ...
        chartObj.zoomModule.chartMouseWheel(<WheelEvent>wheelArgs);
        expect(chartObj.primaryXAxis.zoomFactor.toFixed(2) == '0.55').toBe(
          true
        );
        expect(chartObj.primaryYAxis.zoomFactor.toFixed(2) == '0.72').toBe(
          true
        );
        expect(chartObj.primaryXAxis.zoomPosition.toFixed(2) == '0.11').toBe(
          true
        );
        expect(chartObj.primaryYAxis.zoomPosition.toFixed(2) == '0.19').toBe(
          true
    ...
    it('Checking mouse wheel as forward with mode y ', (done: Function) => {
      loaded = (args: Object): void => {
        ...
        expect(chartObj.primaryYAxis.zoomFactor.toFixed(2) == '0.55').toBe(
          true
        );
        expect(chartObj.primaryXAxis.zoomPosition.toFixed(2) == '0.11').toBe(
          true
        );
        expect(chartObj.primaryYAxis.zoomPosition.toFixed(2) == '0.31').toBe(
          true
        );
        done();
      };
  ...
  describe('Checking Pinch Zooming', () => {
    ...
    it('Checking pinch zooming with label', (done: Function) => {
      loaded = (args: Object): void => {
        ...
        chartObj.chartOnMouseDown(
          <PointerEvent>(
            trigger.onTouchStart(areaElement, 608, 189, 504, 289, 504, 289)
          )
        );
        chartObj.mouseMove(
          <PointerEvent>(
            trigger.onTouchMove(areaElement, 728, 389, 404, 289, 404, 189)
          )
        );
        chartObj.mouseMove(
          <PointerEvent>(
            trigger.onTouchMove(areaElement, 748, 129, 304, 289, 304, 289)
          )
        );
        content = chartObj.primaryXAxis.zoomFactor.toFixed(2);
        ...
        expect(
          document
            .getElementById('containerTextGroup0')
            .getAttribute('visibility') == 'hidden'
        ).toBe(true);
        chartObj.mouseLeave(
          <PointerEvent>(
            trigger.onTouchLeave(areaElement, 748, 129, 304, 289, 304, 289)
          )
        );
        done();
      };
    ...
    it('Checking pinch zooming with mode Y', (done: Function) => {
      loaded = (args: Object): void => {
        ...
        expect(
          document.getElementById('container_Zoom_0_AxisLabel_1') == null
        ).toBe(true);
        content = document.getElementById(
          'container_Zoom_1_AxisLabel_0'
        ).textContent;

        expect(
          content == '13.0' || content == '12.9' || content == '12.5'
        ).toBe(true);
        content = document.getElementById(
          'container_Zoom_1_AxisLabel_1'
        ).textContent;

        expect(
          content == '63.0' || content == '62.9' || content == '62.5'
        ).toBe(true);
        chartObj.mouseLeave(
          <PointerEvent>(
            trigger.onTouchLeave(areaElement, 748, 129, 304, 289, 304, 289)
    ...
    it('Checking pinch zooming with Pointer_1', (done: Function) => {
      loaded = (args: Object): void => {
        ...
        areaElement = document.getElementById('container_ChartAreaBorder');
        chartObj.chartOnMouseDown(
          <PointerEvent>trigger.onPointerStart(areaElement, 608, 189, 25)
        );
        chartObj.chartOnMouseDown(
          <PointerEvent>trigger.onPointerStart(areaElement, 504, 289, 26)
        );
        chartObj.mouseMove(
          <PointerEvent>trigger.onPointerMove(areaElement, 728, 389, 25)
        );
        chartObj.mouseMove(
          <PointerEvent>trigger.onPointerMove(areaElement, 404, 289, 26)
        );
        chartObj.mouseMove(
          <PointerEvent>trigger.onPointerMove(areaElement, 768, 399, 25)
        );
        chartObj.mouseMove(
          <PointerEvent>trigger.onPointerMove(areaElement, 304, 289, 26)
        );
        expect(
          document.getElementById('container_Zoom_1_AxisLabel_0')
            .textContent !== null
        ).toBe(true);
        chartObj.mouseLeave(
          <PointerEvent>trigger.onPointerLeave(areaElement, 768, 399, 25)
        );
        chartObj.mouseLeave(
          <PointerEvent>trigger.onPointerLeave(areaElement, 304, 289, 26)
        );
        trigger.doDoubleTab(
          areaElement,
          608,
    ...
    it('Checking pinch zooming with Pointer ', (done: Function) => {
      loaded = (args: Object): void => {
        ...
        expect(
          document.getElementById('container_Zoom_1_AxisLabel_0') !== null
        ).toBe(true);
        chartObj.mouseLeave(
          <PointerEvent>trigger.onPointerLeave(areaElement, 768, 399, 25)
        );
    ...
    it('Checking pinch zooming with Pointer ', () => {
      ...
      chartObj.mouseMove(
        <PointerEvent>(
          trigger.onTouchMove(targetElement, 768, 399, null, null, 404, 189)
        )
      );
      chartObj.mouseMove(
        <PointerEvent>(
          trigger.onTouchMove(targetElement, 304, 289, null, null, 404, 189)
        )
      );
      expect(document.getElementById('container_Zooming_Zoom_3') !== null).toBe(
        true
      );
      chartObj.mouseLeave(
        <PointerEvent>trigger.onPointerLeave(areaElement, 768, 399, 25)
    ...
    it('Checking pinch zooming height and width', (done: Function) => {
      loaded = (args: Object): void => {
        ...
        if (
          (chartObj.zoomModule.zoomingRect.width > 0 &&
            chartObj.zoomModule.zoomingRect.height > 0) ||
          (chartObj.startMove && chartObj.crosshair.enable)
        ) {
  ...
  describe('Checking touch and device ', () => {
    ...
    it('Checking zooming with legend visibility', (done: Function) => {
      loaded = (args: Object): void => {
        ...
        expect(resetElement != null).toBe(true);
        targetElement = document.getElementById(
          'container_chart_legend_text_' + 0
        );
    ...
    it('Checking touch resize event', (done: Function) => {
      loaded = (args: Object): void => {
        chartObj.loaded = null;
        expect(
          document.getElementById('container_svg').getAttribute('width') ==
            '800'
        ).toBe(true);
        done();
      };
  ...
  describe('Checking zooming with enablePan', () => {
    ...
    it('Defualt selection zoom with enablePan', (done: Function) => {
      loaded = (args: Object): void => {
        chartObj.loaded = null;
        trigger.draganddropEvent(elem, 200, 200, 350, 350);
        let panElementFill: string = document
          .getElementById('container_Zooming_Pan_2')
          .getAttribute('fill');
        let zoomIconFill: string = document
          .getElementById('container_Zooming_Zoom_3')
          .getAttribute('fill');
        let zoomInFill: string = document
          .getElementById('container_Zooming_ZoomIn_2')
          .getAttribute('fill');
        let zoomOutFill: string = document
          .getElementById('container_Zooming_ZoomOut_2')
          .getAttribute('fill');
        let zoomResetFill: string = document
          .getElementById('container_Zooming_Reset_2')
          .getAttribute('fill');
        let seriesTransform: string = document
          .getElementById('containerSeriesGroup0')
        ...
        expect(
          seriesTransform == 'translate(53.5,43.25)' ||
            seriesTransform == 'translate(74.5,43.25)'
        ).toBe(true);
        done();
      };
      chartObj.loaded = loaded;
    ...
    it('Enable panning programatically with enablePan', (done: Function) => {
      loaded = (args: Object): void => {
        chartObj.loaded = null;
        trigger.draganddropEvent(elem, 100, 100, 400, 400);
        let panElement: Element = document.getElementById(
          'container_Zooming_Pan_2'
        );
        let zoomIcon: Element = document.getElementById(
          'container_Zooming_Zoom_3'
        );
        let zoomIn: Element = document.getElementById(
          'container_Zooming_ZoomIn_2'
        );
        let zoomOut: Element = document.getElementById(
          'container_Zooming_ZoomOut_2'
        );
        let zoomReset: Element = document.getElementById(
          'container_Zooming_Reset_2'
        );
        let seriesTransform: string = document
          .getElementById('containerSeriesGroup0')
          .getAttribute('transform');
        ...
        expect(
          seriesTransform == 'translate(53.5,43.25)' ||
            seriesTransform == 'translate(53.5,42.25)'
        ).toBe(true);
        done();
      };
      chartObj.zoomSettings.enableSelectionZooming = true;
  ...
  describe('checking of initial loading of toolbar', () => {
    ...
    it('checking the enable of zoomIn and zoomOut while zoom icon selection', (done: Function) => {
      let zoomElement: Element = document.getElementById(
        'container_Zooming_Zoom'
      );
      trigger.clickEvent(zoomElement);
      let zoomInElement: string = document
        .getElementById('container_Zooming_ZoomIn_1')
        .getAttribute('opacity');
      expect(zoomInElement == '1').toBe(true);
      let zoomOutElement: string = document
        .getElementById('container_Zooming_ZoomOut_1')
        .getAttribute('opacity');
    ...
    it('checking the toolbar initial loading', (done: Function) => {
      let zoomInElement: string = document
        .getElementById('container_Zooming_ZoomIn')
        .getAttribute('opacity');
      expect(zoomInElement == '1').toBe(true);
      let panElement: string = document
        .getElementById('container_Zooming_Pan')
        .getAttribute('opacity');
      expect(panElement == '0.2').toBe(true);
      let resetElement: string = document
        .getElementById('container_Zooming_Reset')
        .getAttribute('opacity');
...
describe('Area series zooming', () => {
  ...
  it('Checking toolkit with fluent2 theme', (done: Function) => {
    loaded = (args: Object): void => {
      ...
      let color: string = document
        .getElementById('Zoomingcontainer_Zooming_Zoom_3')
        .getAttribute('fill');
  ...
  it('Checking with scroll bar', (done: Function) => {
    loaded = (args: Object): void => {
      ...
      element1 = document.getElementById(
        'Zoomingcontainer_scrollBarBackRect_primaryXAxis'
      );
    ...
    chartObj.primaryXAxis.scrollbarSettings = {
      enable: true,
      range: { maximum: 3, minimum: 4.5 },
    };
    chartObj.primaryYAxis.scrollbarSettings = {
      enable: true,
      range: { maximum: 2000, minimum: 1900 },
    };
    chartObj.loaded = loaded;
    chartObj.refresh();
  });
  it('Checking scroll bar with RTL', (done: Function) => {
    loaded = (args: Object): void => {
      ...
      chartObj.loaded = null;
      element1 = document.getElementById(
        'Zoomingcontainer_scrollBar_leftCircle_primaryXAxis'
      );
...
describe('Checking Zooming Toolkit with fluent2 high contrast theme', () => {
  ...
  it('Checking tooltip div hovering zoom icon', function (done: Function) {
    trigger.draganddropEvent(elem, 100, 100, 400, 400);
    let targetElement1 = document.getElementById(
      'chartContainer_Zooming_KitCollection'
    );
  ...
  it('Checking tooltip div hovering zoomin icon', function (done: Function) {
    ...
    trigger.mousemoveEvent(targetElement1, 0, 0, 5, 5);
    let targetElement2 = document.getElementById(
      'chartContainer_Zooming_ZoomIn'
    );
    trigger.mouseoverEvent(targetElement2);
    expect(document.getElementById('EJ2_Chart_ZoomTip') != null);
    trigger.mouseoutEvent(targetElement2);
  ...
  it('Checking Fluent2 highcontrast theme', function (done: Function) {
    loaded = (args: Object): void => {
      chartObj.loaded = null;
      trigger.draganddropEvent(elem, 200, 200, 350, 350);
      let resetElement1 = document.getElementById(
        'chartContainer_Zooming_KitCollection'
      );
