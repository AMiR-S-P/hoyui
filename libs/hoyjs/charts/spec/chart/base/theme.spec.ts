  ...
  describe('Chart Bar series', () => {
        ...
        series: [
          {
            ...
            type: 'Column',
            name: 'USA',
            marker: { dataLabel: { visible: true, fill: material[0] } },
          },
          {
            dataSource: [{ x: 1, y: 17 }],
            xName: 'x',
            ...
            type: 'Column',
            name: 'GBR',
            marker: { dataLabel: { visible: true, fill: material[1] } },
          },
          {
            dataSource: [{ x: 1, y: 16 }],
            xName: 'x',
            ...
            type: 'Column',
            name: 'CHN',
            marker: { dataLabel: { visible: true, fill: material[2] } },
          },
          {
            dataSource: [{ x: 1, y: 19 }],
            xName: 'x',
            ...
            type: 'Column',
            name: 'RUS',
            marker: { dataLabel: { visible: true, fill: material[3] } },
          },
          {
            dataSource: [{ x: 1, y: 17 }],
            xName: 'x',
            ...
            type: 'Column',
            name: 'GER',
            marker: { dataLabel: { visible: true, fill: material[4] } },
          },
          {
            dataSource: [{ x: 1, y: 12 }],
            xName: 'x',
            ...
            type: 'Column',
            name: 'JAP',
            marker: { dataLabel: { visible: true, fill: material[5] } },
          },
          {
            dataSource: [{ x: 1, y: 10 }],
            xName: 'x',
            ...
            type: 'Column',
            name: 'FRN',
            marker: { dataLabel: { visible: true, fill: material[6] } },
          },
          {
            dataSource: [{ x: 1, y: 18 }],
            xName: 'x',
            ...
            type: 'Column',
            name: 'IND',
            marker: { dataLabel: { visible: true, fill: material[7] } },
          },
          {
            dataSource: [{ x: 1, y: 10 }],
            xName: 'x',
            ...
            type: 'Column',
            name: 'AUS',
            marker: { dataLabel: { visible: true, fill: material[8] } },
          },
          {
            dataSource: [{ x: 1, y: 15 }],
            xName: 'x',
            ...
            type: 'Column',
            name: 'NZ',
            marker: { dataLabel: { visible: true, fill: material[9] } },
          },
          {
            dataSource: [{ x: 1, y: 19 }],
            xName: 'x',
    ...
    it('Checking with default pattern color', (done: Function) => {
      loaded = (args: Object): void => {
        ...
        expect(getElement(prefix + 0 + suffix).getAttribute('fill')).toBe(
          material[0]
        );
        expect(getElement(prefix + 1 + suffix).getAttribute('fill')).toBe(
          material[1]
        );
        expect(getElement(prefix + 2 + suffix).getAttribute('fill')).toBe(
          material[2]
        );
        expect(getElement(prefix + 3 + suffix).getAttribute('fill')).toBe(
          material[3]
        );
        expect(getElement(prefix + 4 + suffix).getAttribute('fill')).toBe(
          material[4]
        );
        expect(getElement(prefix + 5 + suffix).getAttribute('fill')).toBe(
          material[5]
        );
        expect(getElement(prefix + 6 + suffix).getAttribute('fill')).toBe(
          material[6]
        );
        expect(getElement(prefix + 7 + suffix).getAttribute('fill')).toBe(
          material[7]
        );
        expect(getElement(prefix + 8 + suffix).getAttribute('fill')).toBe(
          material[8]
        );
        expect(getElement(prefix + 9 + suffix).getAttribute('fill')).toBe(
          material[9]
        );
        expect(getElement(prefix + 10 + suffix).getAttribute('fill')).toBe(
          material[0]
        );
        expect(getElement(prefix + 11 + suffix).getAttribute('fill')).toBe(
          material[1]
        );
        done();
      };
    ...
    it('Checking chart-series animate method without tooltip', (done: Function) => {
      chartObj.loaded = (args: ILoadedEventArgs): void => {
        ...
        args.chart.markerRender.previousPoints = [
          (args.chart.series[0] as Series).points[0],
        ] as any;
        args.chart.animate(0);
        args.chart.chartOnMouseDown(
          <PointerEvent>(
            trigger.onTouchStart(
              document.getElementById('theme_Series_0_Point_0'),
              0,
              0,
              0,
              0,
    ...
    it('Checking chart PNG export with vertical', (done: Function): void => {
      chartObj.loaded = (args: ILoadedEventArgs): void => {
        ...
        args.chart.exportModule.export(
          'PNG',
          'png',
          null,
          [args.chart],
