  ...
  describe('Numeric value Type', () => {
    ...
    beforeAll(() => {
      ...
      chartObj = new Chart({
        ...
        width: '800',
        title: 'Chart Empty Point Sample',
        loaded: loaded,
    ...
    it('Empty Point with Line Series Zero mode', (done: Function) => {
      ...
      chartObj.series[1].emptyPointSettings = {
        mode: 'Zero',
        fill: 'blue',
        border: { width: 2, color: 'purple' },
      };
    ...
    it('Empty Point with Range Column Series Average and Zero', (done: Function) => {
      ...
      chartObj.series[0].dataSource = [
        ...
        { x: 'Apr', low: null, high: 10.8 },
        { x: 'May', low: 5.7, high: 14.4 },
        { x: 'June', low: 8.4, high: null },
        { x: 'July', low: 10.6, high: 19.2 },
        { x: 'Aug', low: 10.5, high: 18.9 },
        { x: 'Sep', low: 8.5, high: 16.1 },
        { x: 'Oct', low: null, high: null },
      ...
      chartObj.series[1].dataSource = [
        { x: 'Jan', low: 1.7, high: 7.1 },
        { x: 'Feb', low: 1.9, high: 7.7 },
        { x: 'Mar', low: 1.2, high: 7.5 },
        { x: 'Apr', low: null, high: 9.8 },
        { x: 'May', low: 4.7, high: 11.4 },
        { x: 'June', low: 6.4, high: null },
        { x: 'July', low: 9.6, high: 17.2 },
        { x: 'Aug', low: 10.7, high: 17.9 },
        { x: 'Sep', low: 7.5, high: 15.1 },
        { x: 'Oct', low: null, high: null },
        { x: 'Nov', low: 1.2, high: 7.9 },
