...
describe('Chart', () => {
  ...
  describe('Spline Range Area Series', () => {
    ...
    it('Selection mode DragX', (done: Function) => {
      loaded = () => {
        ...
        expect(
          element.getAttribute('y') == '43' ||
            element.getAttribute('y') == '45.25'
        );
        expect(
          element.getAttribute('height') == '560.75' ||
  ...
  describe('Inversed Spline Range Area Series', () => {
    ...
    it('Checking inversed  spline range area series', (done: Function) => {
      loaded = (args: Object): void => {
        ...
        expect(
          Math.round(bounds.top) == 82 || Math.round(bounds.top) == 80
        ).toBe(true);
        expect(bounds.left == 92.5 || bounds.left == 67.5).toBe(true);
        expect(bounds.width == 705.5 || bounds.width == 730.5).toBe(true);
        expect(
          Math.round(bounds.height) == 233 || Math.round(bounds.height) == 238
        ).toBe(true);
        let element1: number = +document
          .getElementById('container_Series_0_Point_2_Text_0')
          .getAttribute('y');
        expect(Math.round(element1) == 122 || Math.round(element1) == 124).toBe(
          true
        );
        element1 = +document
          .getElementById('container_Series_0_Point_2_Text_1')
          .getAttribute('y');
        expect(Math.round(element1) == 54 || Math.round(element1) == 55).toBe(
          true
        );
        done();
      };
    ...
    it('Checking transposed  spline range area series', (done: Function) => {
      loaded = (args: Object): void => {
        ...
        expect(
          Math.round(bounds.left) == 158 || Math.round(bounds.left) == 155
        ).toBe(true);
        expect(
          Math.round(bounds.width) == 594 || Math.round(bounds.width) == 597
        ).toBe(true);
        expect(
        ...
        let element1: number = +document
          .getElementById('container_Series_0_Point_2_Text_0')
          .getAttribute('x');
        expect(Math.round(element1) == 488 || Math.round(element1) == 490).toBe(
          true
        );
        element1 = +document
          .getElementById('container_Series_0_Point_2_Text_1')
          .getAttribute('x');
        expect(Math.round(element1) == 612 || Math.round(element1) == 615).toBe(
          true
        );
        done();
      };
  ...
  describe('SplineRangeAreaSeries- checking animation on data changes.', () => {
    ...
    it('Spline range area series - Checking remove point method', (done: Function) => {
      ...
      chartObj.series[0].removePoint(3);
      chartObj.series[0].removePoint(4);
      chartObj.series[0].removePoint(5);
      chartObj.series[0].removePoint(6);
      chartObj.series[0].removePoint(7);
      chartObj.series[0].removePoint(8);
      chartObj.refresh();
      unbindResizeEvents(chartObj);
    });
