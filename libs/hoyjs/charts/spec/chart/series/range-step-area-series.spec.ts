...
let datatime: object[] = [
  { x: new Date(1995, 3, 14), low: 0.1, high: 0.15 },
  { x: new Date(1996, 7, 2), low: 0.1, high: 0.15 },
  { x: new Date(1997, 1, 5), low: 0.12, high: 0.17 },
  { x: new Date(1998, 5, 6), low: 0.13, high: 0.2 },
  { x: new Date(1999, 9, 4), low: 0.15, high: 0.2 },
  { x: new Date(2000, 11, 5), low: 0.15, high: 0.22 },
  { x: new Date(2001, 4, 3), low: 0.15, high: 0.22 },
  { x: new Date(2002, 6, 7), low: 0.19, high: 0.23 },
  { x: new Date(2003, 10, 10), low: 0.2, high: 0.23 },
  { x: new Date(2004, 2, 8), low: 0.2, high: 0.24 },
  ...
  describe('Range Step Area Series', () => {
    ...
    it('Showing default marker', (done: Function) => {
      loaded = (args: Object): void => {
        ...
        let marker: HTMLElement = document.getElementById(
          'container_Series_0_Point_5_Symbol'
        );
    ...
    it('Selection mode DragX', (done: Function) => {
      loaded = () => {
        ...
        expect(
          element.getAttribute('y') == '43' || element.getAttribute('y') == '45'
        );
        expect(
    ...
    it('Selection mode DragY', (done: Function) => {
      loaded = () => {
        ...
        expect(
          element.getAttribute('width') == '1134' ||
    ...
    it('checking with tooltip', (done: Function) => {
      loaded = (args: Object): void => {
        let target: HTMLElement = document.getElementById(
          'container_Series_0_Point_7_Symbol'
        );
        ...
        ).toEqual('RenewableAugHigh : 18.9Low : 10.5');
        done();
      };
      chartObj.loaded = loaded;
    ...
    it('Tooltip with given label format', (done: Function) => {
      ...
      chartObj.loaded = (args: Object): void => {
        let target: Element = document.getElementById(
          'container_Series_0_Point_4_Symbol'
        );
        let series: Series = <Series>chartObj.series[0];
        ...
        let y: number =
          series.points[4].regions[0].y +
          10 +
          parseFloat(chartArea.getAttribute('y')) +
          (element.offsetTop || 0);
        let x: number =
          series.points[4].regions[0].x +
          15 +
          parseFloat(chartArea.getAttribute('x')) +
          (element.offsetLeft || 0);
        trigger.mousemovetEvent(target, Math.ceil(x), Math.ceil(y));
        ...
        expect(
          (<HTMLElement>text1.childNodes[0]).getAttribute('fill') == 'blue'
        ).toBe(true);
        done();
      };
      chartObj.refresh();
    ...
    it('checking with track ball', (done: Function) => {
      ...
      loaded = (args: Object): void => {
        let target: HTMLElement = document.getElementById(
          'container_Series_0_Point_9_Symbol'
        );
        let series: Series = <Series>chartObj.series[0];
        ...
        let y: number =
          series.points[9].regions[0].y +
          10 +
          parseFloat(chartArea.getAttribute('y')) +
          (element.offsetTop || 0);
        let x: number =
          series.points[9].regions[0].x +
          15 +
          parseFloat(chartArea.getAttribute('x')) +
          (element.offsetLeft || 0);
        trigger.mousemovetEvent(target, Math.ceil(x), Math.ceil(y));
        ...
        let tooltip: HTMLElement = document.getElementById('container_tooltip');
        expect(tooltip != null).toBe(true);
        expect(tooltip.offsetTop < y + series.points[9].regions[0].height).toBe(
          true
        );
        tooltip = document.getElementById('container_tooltip');
        expect(tooltip != null).toBe(true);
    ...
    it('Legend Rendering Event', (done: Function) => {
      loaded = (args: Object) => {
        ...
        expect(legendElement.getAttribute('d')).not.toEqual(null);
        let legendShape: Element = document.getElementById(
          'container_chart_legend_shape_1'
        );
