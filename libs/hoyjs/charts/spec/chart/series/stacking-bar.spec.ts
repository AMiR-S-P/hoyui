  ...
  describe('Chart stackingBar series', () => {
    ...
    it('Checking with negative Points', (done: Function) => {
      loaded = (args: Arg): void => {
        ...
        expect(
          series1.points[1].regions[0].y <
            parseFloat(zeroLabel.getAttribute('y'))
        ).toBe(true);
        done();
      };
      chartObj.loaded = loaded;
      ...
      loaded = (args: Arg): void => {
        ...
        expect(
          series1.points[2].regions[0].y ==
            series2.points[2].regions[0].height + series2.points[2].regions[0].y
        ).toBe(true);
        done();
      };
      chartObj.series = [
    ...
    it('Checking with multiple axes ', (done: Function) => {
      loaded = (args: Object): void => {
        ...
        point2 = document.getElementById('container_Series_1_Point_1');
        expect(point2.getAttribute('fill') === 'rgba(135,000,235,1)').toBe(
          true
        );
        done();
      };
  ...
  describe('StackingBar Series with data label', () => {
      ...
      chartObj = new Chart({
        ...
        series: [
          ...
          },
          {
            ...
            marker: {
              visible: false,
              dataLabel: { visible: true, fill: 'black' },
            },
          },
          {
            animation: { enable: false },
    ...
    it('With negative location with auto position', (done: Function) => {
      loaded = (args: Object): void => {
        ...
        svg = +document
          .getElementById('container_Series_2_Point_6_TextShape_0')
          .getAttribute('x');
        point0Location = (<Points>(<Series>chartObj.series[2]).points[6])
          .regions[0].x;
  ...
  describe('StackingBar and StackingBar100 Series in Cyliderical shape', () => {
    ...
    it('StackingBar Series type with ColumnFacet property as Cylinder', (done: Function) => {
      loaded = (args: Object): void => {
        ...
        expect(
          region1 ===
            'M57.03244318181818,235.42386363636365a2.527556818181818,10.110227272727272 0 1,0 0,20.220454545454544a2.527556818181818,10.110227272727272 0 1,0 0,-20.220454545454544'
        ).toBe(true);
        expect(
          region2 ===
            'M138.9274431818182,235.42386363636365a2.527556818181818,10.110227272727272 0 1,0 0,20.220454545454544a2.527556818181818,10.110227272727272 0 1,0 0,-20.220454545454544'
        ).toBe(true);
        expect(
          region3 ===
            'M57.03244318181818,235.42386363636365a2.527556818181818,10.110227272727272 0 1,0 0,20.220454545454544l81.89500000000001 0a2.527556818181818,10.110227272727272 0 1,1 0,-20.220454545454544 z'
        ).toBe(true);
        done();
      };
      chartObj.loaded = loaded;
    ...
    it('StackingBar100 Series Type with ColumnFacet property as Cylinder', (done: Function) => {
      loaded = (args: Object): void => {
        ...
        expect(
          region1 ===
            'M2.5275568181818215,206.53749999999997a2.5275568181818215,10.110227272727286 0 1,0 0,20.220454545454572a2.5275568181818215,10.110227272727286 0 1,0 0,-20.220454545454572'
        ).toBe(true);
        expect(
          region2 ===
            'M263.1025568181818,206.53749999999997a2.5275568181818215,10.110227272727286 0 1,0 0,20.220454545454572a2.5275568181818215,10.110227272727286 0 1,0 0,-20.220454545454572'
        ).toBe(true);
        expect(
          region3 ===
            'M2.5275568181818215,206.53749999999997a2.5275568181818215,10.110227272727286 0 1,0 0,20.220454545454572l260.575 0a2.5275568181818215,10.110227272727286 0 1,1 0,-20.220454545454572 z'
        ).toBe(true);
        done();
      };
      chartObj.loaded = loaded;
    ...
    it('Stacking bar - Checking setData method', (done: Function) => {
      loaded = (args: Object): void => {
        let seriesElement = document.getElementById(
          'StackingBarcontainer_Series_0_Point_1'
        );
    ...
    it('Stacking Bar - legend click animation', (done: Function) => {
      loaded = (args: Object): void => {
        let legendElement = document.getElementById(
          'Stackingbarcontainer_chart_legend_text_0'
        );
