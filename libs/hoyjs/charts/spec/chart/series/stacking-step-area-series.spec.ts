...
describe('Chart Control', () => {
      ...
      chart = new Chart({
        ...
        series: [
          ...
          },
          {
            ...
            marker: {
              visible: false,
              dataLabel: { visible: true, fill: 'Red' },
            },
          },
        ],
        width: '800',
  ...
  describe('checking rotated step area chart', () => {
    ...
    it('checking with datalabel Auto position', (done: Function) => {
      loaded = (args: Object): void => {
        ...
        dataLabel1 = document.getElementById(
          'container_Series_1_Point_2_Text_0'
        );
  ...
  describe('Stacking step area - animation on data changes', () => {
    ...
    it('Stacking Step area - Checking removePoint method', (done: Function) => {
      ...
      chart.series[0].removePoint(1);
      chart.series[0].removePoint(2);
      chart.series[0].removePoint(3);
      chart.series[0].removePoint(4);
      chart.refresh();
    });
  });
  it('memory leak', () => {
