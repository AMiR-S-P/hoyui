...
describe('Chart Control Series', () => {
  ...
  describe('Line Series - Marker', () => {
    ...
    it('Showing default marker', (done: Function) => {
      loaded = (args: Object): void => {
        ...
        let series1: HTMLElement = document.getElementById(
          'container_Series_3_Point_1_Symbol'
        );
    ...
    it('with image', (done: Function) => {
      loaded = (args: Object): void => {
        let series1 = document.getElementById(
          'container_Series_1_Point_0_Symbol'
        );
    ...
    it('with marker properties', (done: Function) => {
      loaded = (args: Object): void => {
        let series1 = document.getElementById(
          'container_Series_2_Point_2_Symbol'
        );
    ...
    it('Checking Marker highlight explode', (done: Function) => {
      loaded = (): void => {
        let series1: HTMLElement = document.getElementById(
          'container_Series_2_Point_4_Symbol'
        );
        let chartArea: Element = document.getElementById(
          'container_ChartAreaBorder'
        );
        y =
          parseFloat(series1.getAttribute('cy')) +
          parseFloat(chartArea.getAttribute('y')) +
          element.offsetTop;
        x =
          parseFloat(series1.getAttribute('cx')) +
          parseFloat(chartArea.getAttribute('x')) +
          element.offsetLeft;
        trigger.mousemovetEvent(series1, Math.ceil(x), Math.ceil(y));
        expect(
          document.getElementById('container_Series_2_Point_4_Trackball_1')
        ).toBe(null);
        expect(
          document.getElementById('container_Series_2_Point_4_Trackball_0')
        ).toBe(null);
        done();
      };
      chartObj.loaded = loaded;
    ...
    it('checking filled enable color change', function (done) {
      loaded = function (args) {
        markerColor = document
          .getElementById('container_Series_0_Point_3_Symbol')
          .getAttribute('fill');
  ...
  describe('Line Series', () => {
    ...
    it('Default Series Type without data Points', (done: Function) => {
      loaded = (args: Object): void => {
        ...
        let xAxisLabelCollection = document.getElementById(
          'containerAxisLabels0'
        );
        expect(xAxisLabelCollection.childNodes.length == 11).toBe(true);
        let yAxisLabelCollection = document.getElementById(
    ...
    it('with range', (done: Function) => {
      loaded = (args: Object): void => {
        ...
        chartObj.primaryXAxis.maximum = null;
        chartObj.primaryXAxis.interval = null;
        let seriesElements: HTMLElement =
          document.getElementById('container_Series_0');
    ...
    it('Animation', (done: Function) => {
      animate = (args: IAnimationCompleteEventArgs): void => {
        let pathLength: number = (<SVGPathElement>(
          args.series.pathElement
        )).getTotalLength();
  ...
  describe('Line series with drag and drop support', () => {
    ...
    it('line series drag and drop with minY value', (done: Function) => {
      loaded = (): void => {
        ...
        expect(chartObj.visibleSeries[0].yAxis.visibleRange.min < 21).toBe(
          true
        );
        chartObj.loaded = null;
        done();
  ...
  describe('Area Series', () => {
    ...
    it('with fill and stroke', (done: Function) => {
      loaded = (args: Object): void => {
        let seriesElements = document.getElementById('container_Series_0');
        expect(seriesElements.getAttribute('stroke') == 'transparent').toBe(
          true
        );
        expect(seriesElements.getAttribute('stroke') != 'red').toBe(true);
        expect(seriesElements.getAttribute('stroke-width') != '10').toBe(true);
    ...
    it('with  stroke while applied border', (done: Function) => {
      loaded = (args: Object): void => {
        let seriesElements = document.getElementById(
          'container_Series_border_0'
        );
        expect(seriesElements.getAttribute('stroke') == 'green').toBe(true);
        done();
      };
  ...
  describe('Line Series - Data Label', () => {
    ...
    it('with marker visibility', (done: Function) => {
      loaded = (args: Object): void => {
        ...
        expect(element != null).toBe(true);
        let marker: number = +document
          .getElementById('container_Series_0_Point_3_Symbol')
          .getAttribute('cy');
        let label: number = +document
    ...
    it('Checking edge dataLabel', (done: Function) => {
      loaded = (args: Object): void => {
        let marker: HTMLElement = document.getElementById(
          'container_Series_0_Point_5_Text_0'
        );
        let location: number =
    ...
    it('Checking Datalabel alignment with position auto - alignment near', (done: Function) => {
      ...
      expect(
        svg >
          (<Points>(<Series>chartObj.series[0]).points[4]).symbolLocations[0].y
      ).toBe(true);
      chartObj.loaded = loaded;
    ...
    it('Checking Data label alignment except Auto position in Bottom Position - far', (done: Function) => {
      loaded = (args: Object): void => {
        ...
        expect(hiddenShape != null).toBe(true);
        let elementY: number = +document
          .getElementById('container_Series_1_Point_2_Text_0')
          .getAttribute('y');
        let elementHeight: number = +document
          .getElementById('container_Series_1_Point_2_Symbol')
          .getAttribute('height');
        let symbolLocation = (<Points>(<Series>chartObj.series[1]).points[2])
          .symbolLocations[0].y;
        done();
      };
      chartObj.loaded = loaded;
    ...
    it('Checking Datalabel alignment except Auto position in Outer Position - near', (done: Function) => {
      loaded = (args: Object): void => {
        ...
        let elementHeight: number = +document
          .getElementById('container_Series_1_Point_2_Text_0')
          .getAttribute('height');
        expect(elementY < symbolLocation - elementHeight - elementHeight).toBe(
          true
        );
        done();
      };
    ...
    it('checking stepline Top edge', (done: Function) => {
      loaded = (args: Object): void => {
        let element: number = +document
          .getElementById('container_Series_0_Point_0_Text_0')
          .getAttribute('y');
        let location: number = (<Points>(<Series>chartObj.series[0]).points[0])
          .symbolLocations[0].y;
        expect(element < location).toBe(true);
        element = +document
          .getElementById('container_Series_0_Point_1_Text_0')
          .getAttribute('y');
        location = (<Points>(<Series>chartObj.series[0]).points[1])
          .symbolLocations[0].y;
        expect(element < location).toBe(true);
        element = +document
          .getElementById('container_Series_0_Point_2_Text_0')
          .getAttribute('y');
        location = (<Points>(<Series>chartObj.series[0]).points[2])
          .symbolLocations[0].y;
        expect(element < location).toBe(true);
        element = +document
          .getElementById('container_Series_0_Point_3_Text_0')
          .getAttribute('y');
        location = (<Points>(<Series>chartObj.series[0]).points[3])
          .symbolLocations[0].y;
        expect(element > location).toBe(true);
        element = +document
          .getElementById('container_Series_0_Point_4_Text_0')
          .getAttribute('y');
        location = (<Points>(<Series>chartObj.series[0]).points[4])
          .symbolLocations[0].y;
        expect(element > location).toBe(true);
        element = +document
          .getElementById('container_Series_0_Point_5_Text_0')
          .getAttribute('y');
        location = (<Points>(<Series>chartObj.series[0]).points[5])
          .symbolLocations[0].y;
        expect(element < location).toBe(true);
        done();
      };
  ...
  describe('Data Label with Event checking', () => {
        ...
        series: [
          {
            ...
            marker: {
              visible: true,
              dataLabel: { visible: true, fill: 'transparent' },
            },
            animation: { enable: false },
            dataSource: [
              { x: new Date(2000, 6, 11), y: 10 },
    ...
    it('checking text render event', (done: Function) => {
      loaded = (args: Object): void => {
        let element: Element = document.getElementById(
          'datalabelcontainer_Series_0_Point_4_TextShape_0'
        );
        expect(
          document.getElementById(
            'datalabelcontainer_Series_0_Point_3_TextShape_0'
          ) == null
        ).toBe(true);
        expect(element != null).toBe(true);
        expect(element.getAttribute('fill') == 'transparent').toBe(true);
        expect(
          document.getElementById(
            'datalabelcontainer_Series_0_Point_5_TextShape_0'
          ) == null
        ).toBe(true);
        element = document.getElementById(
          'datalabelcontainer_Series_0_Point_5_Text_0'
        );
        expect(element.getAttribute('fill') == 'black').toBe(true);
        element = document.getElementById(
          'datalabelcontainer_Series_0_Point_4_Text_0'
        );
        expect(element.getAttribute('fill') == 'black').toBe(true);
        element = document.getElementById(
          'datalabelcontainer_Series_0_Point_2_TextShape_0'
        );
        expect(element.getAttribute('fill') == 'red').toBe(true);
        element = document.getElementById(
          'datalabelcontainer_Series_0_Point_2_Text_0'
        );
        expect(element.getAttribute('fill') == 'white').toBe(true);
        element = document.getElementById(
          'datalabelcontainer_Series_0_Point_3_Text_0'
        );
        expect(element.getAttribute('fill') == 'black').toBe(true);
        element = document.getElementById(
          'datalabelcontainer_Series_0_Point_5_Text_0'
    ...
    it('checking top corner text color', (done: Function) => {
      loaded = (args: Object): void => {
        let element: Element = document.getElementById(
          'datalabelcontainer_Series_0_Point_0_Text_0'
        );
        expect(element.getAttribute('fill') == 'black').toBe(true);
        element = document.getElementById(
          'datalabelcontainer_Series_0_Point_1_Text_0'
        );
        expect(element.getAttribute('fill') == 'white').toBe(true);
        done();
      };
  ...
  describe('Area Series Inversed axis', () => {
    ...
    it('With Label position Auto', (done: Function) => {
      loaded = (args: Object): void => {
        dataLabelY = +document
          .getElementById('container_Series_0_Point_2_TextShape_0')
          .getAttribute('y');
        pointY = (<Points>(<Series>chart.series[0]).points[2])
          .symbolLocations[0].y;
    ...
    it('With Label position Top', (done: Function) => {
      loaded = (args: Object): void => {
        ...
        expect(dataLabelY > pointY).toBe(true);
        dataLabelY = +document
          .getElementById('container_Series_0_Point_6_TextShape_0')
          .getAttribute('y');
        pointY = (<Points>(<Series>chart.series[0]).points[6])
          .symbolLocations[0].y;
        expect(dataLabelY > pointY).toBe(true);
        done();
      };
  ...
  describe('checking rotated area chart', () => {
    ...
    it('checking with datalabel Auto position', (done: Function) => {
      loaded = (args: Object): void => {
        ...
        expect(+dataLabel.getAttribute('y') < point.symbolLocations[0].y).toBe(
          true
        );
        done();
      };
    ...
    it('checking with datalabel Middle position', (done: Function) => {
      loaded = (args: Object): void => {
        ...
        point = <Points>(<Series>chart.series[0]).points[2];
        expect(
          +dataLabel.getAttribute('y') >
            point.symbolLocations[0].y - point.regions[0].height / 2
        ).toBe(true);
        done();
      };
      chart.loaded = loaded;
  ...
  describe('Line Series - Data Label with rotation', () => {
    ...
    it('Datalabel count check', (done: Function) => {
      chartObj.loaded = (args: Object): void => {
        let groupElement: Element = document.getElementById(
          'containerTextGroup0'
        );
  ...
  describe('Area Series - Checking animation on data changes.', () => {
    ...
    it('Checking area series addPoint method with single point', (done: Function) => {
      ...
      chartObj.series[0].dataSource = [{ x: 'Jan', y: 54.481, text: '54.48%' }];
      chartObj.refresh();
      chartObj.series[0].border.width = 1;
      chartObj.series[0].addPoint({
        x: 'Decemeber',
    ...
    it('Checking area series setData method', (done: Function) => {
      ...
      chartObj.series[0].setData([
        { x: 'Jan', y: 54.481, text: '54.48%' },
        { x: 'Decemeber', y: 55.481, text: '55.48%' },
      ]);
      chartObj.refresh();
    });
    it('Checking area series removePoint method', (done: Function) => {
