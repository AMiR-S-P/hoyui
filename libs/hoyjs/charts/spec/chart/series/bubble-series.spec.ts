 ...
 */
import { remove, createElement, Browser } from '@hoyui/base';
...
let labelRender: EmitType<IPointRenderEventArgs> = (
  args: IPointRenderEventArgs
): void => {
...
export let data: any[] = [
  { x: 1000, y: 2, size: 5000 },
  { x: 2000, y: 89, size: 6000 },
  { x: 3000, y: 3, size: -30000 },
  { x: 4000, y: 15, size: 14000 },
  { x: 5000, y: 16, size: -30000 },
  { x: 6000, y: 10, size: 13000 },
  { x: 7000, y: -60, size: 18000 },
  { x: 8000, y: 90, size: 12000 },
  { x: 9000, y: 23, size: 10000 },
  { x: 10000, y: 41, size: 15000 },
];

export let dataText: any[] = [
  { x: 1000, y: 2, size: 5000 },
  { x: 2000, y: 89, size: 6000, text: 'Australia is the greatest country' },
  { x: 3000, y: 3, size: -30000 },
  { x: 4000, y: 15, size: 14000 },
  { x: 5000, y: 16, size: -30000, text: 'America is the greatest country' },
  { x: 6000, y: 10, size: 13000 },
  { x: 7000, y: -60, size: 18000 },
  { x: 8000, y: 21, size: 12000, text: 'Somalia is the greatest country' },
  { x: 9000, y: 22, size: 10000, text: 'Japan is the greatest country' },
  { x: 10000, y: 41, size: 15000 },
];
export let data2: any[] = [
  { x: 1000, y: 12, size: 5000 },
  { x: 2000, y: 8, size: 6000 },
  { x: 3000, y: 30, size: -30000 },
  { x: 4000, y: 60, size: 14000 },
  { x: 5000, y: 25, size: -30000 },
  { x: 6000, y: 34, size: 13000 },
  { x: 7000, y: -60, size: 18000 },
  { x: 8000, y: 51, size: 12000 },
  { x: 9000, y: 49, size: 10000 },
  { x: 10000, y: 42, size: 15000 },
];

export let Datedata: any[] = [
  { x: new Date(0, 0, 2000), y: 2, size: 5000 },
  { x: new Date(0, 0, 2001), y: 89, size: 6000 },
  { x: new Date(0, 0, 2002), y: 3, size: -30000 },
  { x: new Date(0, 0, 2003), y: 0, size: 14000 },
  { x: new Date(0, 0, 2004), y: 16, size: -30000 },
  { x: new Date(0, 0, 2005), y: 0, size: 13000 },
  { x: new Date(0, 0, 2006), y: -60, size: 18000 },
  { x: new Date(0, 0, 2007), y: 21, size: 12000 },
  { x: new Date(0, 0, 2008), y: 23, size: 10000 },
  { x: new Date(0, 0, 2009), y: 41, size: 15000 },
];

export let categorySize: any[] = [
  { x: 'USA', y: 70, size: 0.01 },
  { x: 'China', y: 60, size: 0.1 },
  { x: 'Japan', y: 60, size: 0.08 },
  { x: 'Australia', y: 56, size: 0.15 },
  { x: 'France1', y: 45, size: 0.121 },
  { x: 'Germany1', y: 30, size: -0.01 },
  { x: 'Italy', y: 35, size: 0.2 },
  { x: 'Sweden', y: 25, size: 0.3 },
];
...
export let logData: any[] = [
  ...
  { x: 2000, y: 89, size: 6000 },
  { x: 3000, y: 3, size: 30000 },
  { x: 4000, y: 0, size: 14000 },
  { x: 4100, y: 10, size: 14000 },
  { x: 5000, y: 16, size: 30000 },
  { x: 6000, y: 0, size: 13000 },
  { x: 7000, y: 60, size: 18000 },
  { x: 8000, y: 21, size: 12000 },
  { x: 9000, y: 23, size: 10000 },
  { x: 10000, y: 41, size: 15000 },
];
...
describe('Chart Control', () => {
  ...
  describe('Chart Bubble series', () => {
    ...
    it('Checking with negative Points', (done: Function) => {
      loaded = (args: Arg): void => {
        ...
        expect(
          parseFloat(svg.getAttribute('y')) <
            series.points[6].symbolLocations[0].y
        ).toBe(true);
        done();
      };
      chartObj.loaded = loaded;
    ...
    it('Checking with single Points', (done: Function) => {
      loaded = (args: Object): void => {
        let seriesGroup: HTMLElement = document.getElementById(
    ...
    it('Checking with category axis BetweenTicks', (done: Function) => {
      loaded = (args: Object): void => {
        ...
        let axisStart: HTMLElement = document.getElementById(
          'containerAxisLine_0'
        );
        expect(
          +axisLabel.getAttribute('x') >
            +axisStart.getAttribute('d').split(' ')[1]
        ).toBe(true);
        done();
      };
      chartObj.loaded = loaded;
    ...
    it('Checking with DateTime axis', (done: Function) => {
      loaded = (args: Object): void => {
        ...
        axisLabel = document.getElementById('container0_AxisLabel_0');
        expect(
          axisLabel.textContent === '23' || axisLabel.textContent === 'Jun 23'
        ).toBe(true);
        done();
      };
      chartObj.loaded = loaded;
    ...
    it('checking with datalabel position as default', (done: Function) => {
      loaded = (args: Object): void => {
        ...
        labelText = document.getElementById(
          'container_Series_0_Point_1_Text_0'
        );
        expect(
          +point.getAttribute('cy') - +point.getAttribute('ry') >
            +labelText.getAttribute('y')
        ).toBe(true);
        done();
      };
      chartObj.loaded = loaded;
    ...
    it('checking with datalabel position as Bottom with border', (done: Function) => {
      loaded = (args: Object): void => {
        let shape: HTMLElement = document.getElementById(
          'container_Series_0_Point_0_TextShape_0'
        );
    ...
    it('Checking Legend Shape ', (done: Function) => {
      loaded = (args: Object): void => {
        let legendElement: HTMLElement = document.getElementById(
          'container_chart_legend_shape_0'
        );
    ...
    it('bubble Tooltip', (done: Function) => {
      loaded = (args: Object): void => {
        ...
        y =
          ...
          series.points[0].regions[0].height / 2 +
          parseFloat(chartArea.getAttribute('y')) +
          elem.offsetTop;
        x =
          series.points[0].regions[0].x +
          series.points[0].regions[0].width / 2 +
          parseFloat(chartArea.getAttribute('x')) +
          elem.offsetLeft;
        trigger.mousemovetEvent(targetElement, Math.ceil(x), Math.ceil(y));
        expect(targetElement.getAttribute('opacity')).toEqual('1');
        ...
        y =
          series.points[7].regions[0].y +
          series.points[7].regions[0].height / 2 +
          parseFloat(chartArea.getAttribute('y')) +
          elem.offsetTop;
        x =
          series.points[7].regions[0].x +
          parseFloat(chartArea.getAttribute('x')) +
          elem.offsetLeft;
        trigger.mousemovetEvent(targetElement, Math.ceil(x), Math.ceil(y));
        expect(tooltip != null).toBe(true);
        ...
        expect(targetElement.textContent.replace(/\u200E/g, '')).toEqual(
          'Gold8000 : 90  Size : 12000'
        );
        done();
      };
      chartObj.loaded = loaded;
    ...
    it('Checking tooltip  bottom with datalabel position as Middle', (done: Function) => {
      loaded = (args: Object): void => {
        ...
        y =
          series.points[6].regions[0].y +
          series.points[6].regions[0].height / 2 +
          parseFloat(chartArea.getAttribute('y')) +
          elem.offsetTop;
        x =
          series.points[6].regions[0].x +
          parseFloat(chartArea.getAttribute('x')) +
          elem.offsetLeft;
        trigger.mousemovetEvent(targetElement, Math.ceil(x), Math.ceil(y));
        tooltip = document.getElementById('container_tooltip');
        ...
        tooltipY = parseFloat(tooltip.style.top);
        labelText = document.getElementById(
          'container_Series_0_Point_6_Text_0'
        );
        dataLabelY = parseFloat(labelText.getAttribute('y'));
        expect(tooltipY < dataLabelY).toBe(true);
        done();
    ...
    it('Default Crosshair', (done: Function) => {
      loaded = (args: Object): void => {
        ...
        let crosshair: Element = <Element>(
          document.getElementById('container_UserInteraction')
        );
        let element1: HTMLElement;
        expect(crosshair.childNodes.length).toEqual(3);
        element1 = <HTMLElement>crosshair.childNodes[0];
        expect(
          element1.getAttribute('d').indexOf(chartArea.getAttribute('x')) > 0
        ).toBe(true);
        element1 = <HTMLElement>crosshair.childNodes[1];
        expect(
          element1.getAttribute('d').indexOf(chartArea.getAttribute('y')) > 0
        ).toBe(true);
        ...
        expect(
          element1.textContent == '5503.287' ||
            element1.textContent == '5509.650'
        ).toBe(true);
    ...
    it('Single point selection', (done: Function) => {
      loaded = () => {
        ...
        selected = document.getElementsByClassName(
          'container_ej2_chart_selection_series_0 '
        );
    ...
    it('series selection ', (done: Function) => {
      loaded = () => {
        elementSelect = document.getElementById('container_Series_0_Point_4');
        let series: HTMLElement = document.getElementById(
          'containerSeriesGroup0'
        );
        trigger.clickEvent(elementSelect);
        selected = document.getElementsByClassName(
    ...
    it('Cluster selection', (done: Function) => {
      loaded = () => {
        ...
        expect(elementSelect).toBe(<HTMLElement>selected[0]);
        let selected1 = document.getElementsByClassName(
          'container_ej2_chart_selection_series_1 '
        );
    ...
    it('Checking with datalabel position auto(Middle) and tooltip', (done: Function) => {
      loaded = (args: Object): void => {
        ...
        y =
          series.points[0].symbolLocations[0].y +
          parseFloat(chartArea.getAttribute('y')) +
          elem.offsetTop;
        x =
          series.points[0].symbolLocations[0].x +
          parseFloat(chartArea.getAttribute('x')) +
          elem.offsetLeft;
        trigger.mousemovetEvent(targetElement, Math.ceil(x), Math.ceil(y));
        tooltip = document.getElementById('container_tooltip');
      ...
      chartObj.series = [
        {
          dataSource: [{ x: 2006, y: 7.8, size: 11 }],
          type: 'Bubble',
          xName: 'x',
          yName: 'y',
          size: 'size',
    ...
    it('Checking with multiple axes ', (done: Function) => {
      loaded = (args: Object): void => {
        ...
        let axisCollection = document.getElementById(
          'containerAxisInsideCollection'
        );
        expect(+axisCollection.childElementCount).toEqual(5);

        let axis2 = document.getElementById('containerAxisLine_1');
        expect(+axis1.getAttribute('d').split(' ')[4]).toEqual(
          +axis2.getAttribute('d').split(' ')[1]
        );
    ...
    it('Checking with axis with opposed position', (done: Function) => {
      loaded = (args: Object): void => {
        ...
        let svg1: HTMLElement = document.getElementById(
          'container2_AxisLabel_0'
        );
        expect(
          parseFloat(svg.getAttribute('x')) +
            parseFloat(svg.getAttribute('width')) <
            parseFloat(svg1.getAttribute('x'))
        ).toBe(true);
        done();
      };
      chartObj.loaded = loaded;
  ...
  describe('Checking Zooming ', () => {
    ...
    it('checking zooming with cross hair', (done: Function) => {
      loaded = (args: Object): void => {
        ...
        let element1: HTMLElement = <HTMLElement>(
          crosshair.childNodes[2].childNodes[1]
        );
        expect(
          element1.textContent == '3224.4' || element1.textContent == '3187.0'
        ).toBe(true);
        element1 = <HTMLElement>crosshair.childNodes[2].childNodes[3];
        expect(
          element1.textContent == '38.1' || element1.textContent == '37.8'
        ).toBe(true);
        trigger.mousedownEvent(resetElement, 0, 0, 5, 5);
        done();
      };
    ...
    it('checking zooming with tooltip', (done: Function) => {
      loaded = (args: Object): void => {
        ...
        targetElement = document.getElementById('container_tooltip_text');
        expect(targetElement.textContent.replace(/\u200E/g, '')).toEqual(
          'ChartSeriesNameGold3000.0 : 3.0  Size : -30000'
        );
        trigger.mousedownEvent(resetElement, 0, 0, 5, 5);
        done();
      };
  ...
  describe('Checking with multiple series ', () => {
    ...
    it('Checking default rendering', (done: Function) => {
      loaded = (args: Object): void => {
        let svg: Element = document.getElementById(
        ...
        series: [
          {
            type: 'Bubble',
            dataSource: [
              { x: new Date(2005, 0, 1), y: 21, size: '1' },
              { x: new Date(2006, 0, 1), y: 24, size: '2' },
              { x: new Date(2007, 0, 1), y: 36, size: '1.5' },
              { x: new Date(2008, 0, 1), y: 38, size: '1.8' },
              { x: new Date(2009, 0, 1), y: 54, size: '2.2' },
              { x: new Date(2010, 0, 1), y: 57, size: '3' },
...
describe('Checking bubble series animation on data changes.', () => {
      ...
      series: [
        {
          ...
          dataSource: [
            ...
            },
            {
              ...
              size: 0.197,
              text: 'Brazil',
              dataLabelName: Browser.isDevice ? 'BR' : 'Brazil',
            },
            {
              x: 99,
              y: 0.7,
              size: 0.0818,
              text: 'Germany',
              dataLabelName: Browser.isDevice ? 'DE' : 'Germany',
            },
            {
              x: 72,
              y: 2.0,
              size: 0.0826,
              text: 'Egypt',
              dataLabelName: Browser.isDevice ? 'EG' : 'Egypt',
            },
            {
              x: 99.6,
              y: 3.4,
              size: 0.143,
              text: 'Russia',
              dataLabelName: Browser.isDevice ? 'RUS' : 'Russia',
            },
            {
              x: 96.5,
              y: 0.2,
              size: 0.128,
              text: 'Japan',
              dataLabelName: Browser.isDevice ? 'JP' : 'Japan',
            },
            {
              x: 86.1,
              y: 4.0,
            ...
            },
            {
              ...
              size: 0.7,
              text: 'Hong Kong',
              dataLabelName: Browser.isDevice ? 'HK' : 'Hong Kong',
            },
            {
              x: 79.2,
              y: 4.9,
            ...
            },
            {
              ...
              size: 0.21,
              text: 'Australia',
              dataLabelName: Browser.isDevice ? 'AU' : 'Australia',
            },
            {
              x: 66.8,
              y: 3.9,
            ...
            },
            {
              ...
              size: 0.231,
              text: 'Taiwan',
              dataLabelName: Browser.isDevice ? 'TW' : 'Taiwan',
            },
          ],
          xName: 'x',
          yName: 'y',
  ...
  it('checking bubble series updated direction', (done: Function) => {
    loaded = (args: Object): void => {
      let seriesElement: Element = document.getElementById(
        'BubbleContainer_Series_0_Point_1'
      );
