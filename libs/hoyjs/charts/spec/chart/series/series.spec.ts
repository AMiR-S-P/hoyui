...
describe('Chart Control', () => {
  ...
  let query: Query = new Query()
    .take(50)
    .where('Estimate', 'greaterThan', 0, false);
      ...
      chartEle = new Chart({
        series: [
          ...
          },
          {
            ...
            xName: 'x',
            yName: 'y',
            animation: { enable: true, delay: 300 },
          },
        ],
        legendSettings: { visible: false },
      });
  ...
  describe('marker in line chart', () => {
    ...
    it('checking with marker shape rectangle', (done: Function) => {
      loaded = (args: Object): void => {
        marker = document.getElementById('container_Series_0_Point_2_Symbol');
        expect(marker.getAttribute('stroke') === chartObj.series[0].fill).toBe(
          true
        );
        expect(marker.getAttribute('d') !== '').toBe(true);
        done();
        ...
        series: [
          {
            ...
            xName: 'x',
            yName: 'y',
            animation: { enable: false, delay: 300 },
            marker: { visible: true },
          },
        ],
        legendSettings: { visible: false },
  ...
  describe('Checking datalabel intersect action is None', () => {
    ...
    it('checking datalabel template cout without None', (done: Function) => {
      loaded = (args: Object): void => {
        ...
        dataLabel = document.getElementById(
          'container_Series_1_DataLabelCollections'
        );
        expect(dataLabel.childElementCount === 6).toBe(true);
        done();
      };
  ...
  describe('testing label in chart', () => {
          ...
          series: [
            {
              ...
              marker: {
                visible: true,
                shape: 'Circle',
                dataLabel: { visible: true, format: 'n3' },
                fill: 'black',
                height: 10,
                width: 10,
              },
    ...
    it('checking the  axis label for the custom format like ${value}', (done: Function) => {
      loaded = (args: Object): void => {
        ...
        dataLabel = document.getElementById(
          'container_Series_1_Point_4_Text_0'
        );
