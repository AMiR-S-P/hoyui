...
describe('Chart Control', () => {
  ...
  describe('Chart StackingColumn series', () => {
    ...
    it('Checking with negative Points', (done: Function) => {
      loaded = (args: Arg): void => {
        ...
        let series2: Series = <Series>args.chart.series[1];
        expect(
          series1.points[1].regions[0].y + series1.points[0].regions[0].height >
            parseFloat(axisLabel.getAttribute('y'))
        ).toBe(true);
        expect(
          series2.points[4].regions[0].y + series2.points[4].regions[0].height >
            parseFloat(axisLabel.getAttribute('y'))
        ).toBe(true);
        done();
      };
    ...
    it('Checking with different stackingGroup', (done: Function) => {
      loaded = (args: Arg): void => {
        ...
        let series2: Series = <Series>args.chart.series[1];
        expect(
          series1.points[1].regions[0].x < series2.points[1].regions[0].x
        ).toBe(true);
        done();
      };
      chartObj.loaded = loaded;
    ...
    it('Checking with default DataLabel ', (done: Function) => {
      loaded = (args: Object): void => {
        ...
        dataLabel = document.getElementById(
          'container_Series_1_Point_0_Text_0'
        );
    ...
    it('Checking with DataLabel bottom position', (done: Function) => {
      loaded = (args: Arg): void => {
        ...
        expect(
          series1.points[0].regions[0].y + series1.points[0].regions[0].height >
            parseFloat(dataLabel.getAttribute('y'))
        ).toBe(true);
        ...
        expect(
          series2.points[0].regions[0].y + series2.points[0].regions[0].height >
            parseFloat(dataLabel.getAttribute('y'))
        ).toBe(true);
        done();
      };
    ...
    it('Checking with DataLabel middle position for stackingcolumn100', (done: Function) => {
      loaded = (args: Arg): void => {
        ...
        expect(
          (series1.points[0].regions[0].y +
            series1.points[0].regions[0].height) /
            2 <=
            parseFloat(dataLabel.getAttribute('y'))
        ).toBe(true);
        dataLabel = document.getElementById(
        ...
        expect(
          (series2.points[0].regions[0].y +
            series2.points[0].regions[0].height) /
            2 <=
            parseFloat(dataLabel.getAttribute('y'))
        ).toBe(true);
        done();
    ...
    it('Checking with DataLabel top position for negative points', (done: Function) => {
      loaded = (args: Arg): void => {
        ...
        expect(
          series1.points[2].regions[0].y + series1.points[2].regions[0].height >
            parseFloat(dataLabel.getAttribute('y'))
        ).toBe(true);

        svg = document.getElementById('container_Series_1_Point_5');
        dataLabel = document.getElementById(
          'container_Series_1_Point_5_Text_0'
        );
        expect(
          series2.points[5].regions[0].y + series2.points[5].regions[0].height >
            parseFloat(dataLabel.getAttribute('y'))
        ).toBe(true);
        done();
      };
    ...
    it('Checking with empty data', (done: Function) => {
      loaded = (args: Object): void => {
        ...
        expect(svg.childElementCount === 8 || svg.childElementCount === 9).toBe(
          true
        );
        done();
      };
  ...
  describe('StackingColumn and StackingColumn100 Series in Cyliderical shape', () => {
    ...
    it('StackingColumn Series type with ColumnFacet property as Cylinder', (done: Function) => {
      loaded = (args: Object): void => {
        let region1: string = document
          .getElementById('container_Series_1_Point_2_Region_1')
          .getAttribute('d');
        let region2: string = document
          .getElementById('container_Series_1_Point_2_Region_0')
          .getAttribute('d');
        let region3: string = document
          .getElementById('container_Series_1_Point_2_Region_2')
          .getAttribute('d');
        expect(
          region1 ===
            'M301.43,122.53484968749999a49.07000000000002,12.267500000000005 0 1,0 98.14000000000004,0a49.07000000000002,12.267500000000005 0 1,0 -98.14000000000004,0'
        ).toBe(true);
        expect(
          region2 ===
            'M301.43,199.38250986249997a49.07000000000002,12.267500000000005 0 1,0 98.14000000000004,0a49.07000000000002,12.267500000000005 0 1,0 -98.14000000000004,0'
        ).toBe(true);
        expect(
          region3 ===
            'M301.43,122.53484968749999a49.07000000000002,12.267500000000005 0 1,0 98.14000000000004,0l0 76.84766017499999a49.07000000000002,12.267500000000005 0 1,1 -98.14000000000004,0 z'
        ).toBe(true);
        done();
      };
      chartObj.loaded = loaded;
    ...
    it('ColumnFacet property as Cylinder with DataLabel', (done: Function) => {
      loaded = (args: Object): void => {
        let region1: string = document
          .getElementById('container_Series_0_Point_3_Region_1')
          .getAttribute('d');
        let region2: string = document
          .getElementById('container_Series_0_Point_3_Region_0')
          .getAttribute('d');
        let region3: string = document
          .getElementById('container_Series_0_Point_3_Region_2')
          .getAttribute('d');
        expect(
          region1 ===
            'M441.63,114.49378545833335a16.356666666666655,4.089166666666664 0 1,0 32.71333333333331,0a16.356666666666655,4.089166666666664 0 1,0 -32.71333333333331,0'
        ).toBe(true);
        expect(
          region2 ===
            'M441.63,334.16083333333336a16.356666666666655,4.089166666666664 0 1,0 32.71333333333331,0a16.356666666666655,4.089166666666664 0 1,0 -32.71333333333331,0'
        ).toBe(true);
        expect(
          region3 ===
            'M441.63,114.49378545833335a16.356666666666655,4.089166666666664 0 1,0 32.71333333333331,0l0 219.66704787499998a16.356666666666655,4.089166666666664 0 1,1 -32.71333333333331,0 z'
        ).toBe(true);
        done();
      };
      chartObj.loaded = loaded;
    ...
    it('StackingColumn100 Series Type with ColumnFacet property as Cylinder', (done: Function) => {
      loaded = (args: Object): void => {
        ...
        expect(
          region1 ===
            'M460.53000000000003,157.96054671091775a51.16999999999999,12.792499999999997 0 1,0 102.33999999999997,0a51.16999999999999,12.792499999999997 0 1,0 -102.33999999999997,0'
        ).toBe(true);
        expect(
          region2 ===
            'M460.53000000000003,325.4575a51.16999999999999,12.792499999999997 0 1,0 102.33999999999997,0a51.16999999999999,12.792499999999997 0 1,0 -102.33999999999997,0'
        ).toBe(true);
        expect(
          region3 ===
            'M460.53000000000003,157.96054671091775a51.16999999999999,12.792499999999997 0 1,0 102.33999999999997,0l0 167.49695328908226a51.16999999999999,12.792499999999997 0 1,1 -102.33999999999997,0 z'
        ).toBe(true);
        done();
      };
      chartObj.loaded = loaded;
  ...
  describe('StackingColumn100 Series in Cyliderical shape', () => {
    ...
    it('ColumnFacet property as Cylinder with fill color', (done: Function) => {
      loaded = (args: Object): void => {
        let region1: string = document
          .getElementById('container_Series_2_Point_3_Region_1')
          .getAttribute('d');
        let region2: string = document
          .getElementById('container_Series_2_Point_3_Region_0')
          .getAttribute('d');
        let region3: string = document
          .getElementById('container_Series_2_Point_3_Region_2')
          .getAttribute('d');
        expect(
          region1 === 'M441,12.25a49,12.25 0 1,0 98,0a49,12.25 0 1,0 -98,0'
        ).toBe(true);
        expect(
          region2 ===
            'M441,41.69595282694144a49,12.25 0 1,0 98,0a49,12.25 0 1,0 -98,0'
        ).toBe(true);
        expect(
          region3 ===
            'M441,12.25a49,12.25 0 1,0 98,0l0 29.445952826941443a49,12.25 0 1,1 -98,0 z'
        ).toBe(true);
        done();
      };
      chartObj.loaded = loaded;
    ...
    it('Stacking column - legend click animation', (done: Function) => {
      loaded = (args: Object): void => {
        let legendElement = document.getElementById(
          'StackingColumncontainer_chart_legend_text_0'
        );
