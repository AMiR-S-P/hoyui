...
describe('Column Series', () => {
  ...
  describe('Column Series', () => {
    ...
    it('Added data Source', (done: Function) => {
      loaded = (args: Object): void => {
        let svg: HTMLElement = document.getElementById(
          'container_Series_0_Point_0'
        );
    ...
    it('Checking series visibility', (done: Function) => {
      loaded = (args: Object): void => {
        let seriesElements: number = document.getElementById(
          'containerSeriesCollection'
        ).childNodes.length;
    ...
    it('with dateTimeRange', (done: Function) => {
      loaded = (args: Object): void => {
        ...
        let labelElement: HTMLElement = document.getElementById(
          'container0_AxisLabel_3'
        );
        expect(
          labelElement.textContent == '2002' ||
            labelElement.textContent == '2003'
        ).toBe(true);
        done();
      };
      chartObj.loaded = loaded;
    ...
    it('within xAxis range', (done: Function) => {
      loaded = (args: Object): void => {
        let svgLength: number = document.getElementById('containerSeriesGroup0')
          .childNodes.length;
    ...
    it('checking with columnWidthInPixel', (done: Function) => {
      loaded = (args: Object): void => {
        ...
        let path = svg.getAttribute('d');
        expect(
          'M 542.375 175.125 Q 542.375 175.125 542.375 175.125 L 562.375 175.125 Q 562.375 175.125 562.375 175.125 L 562.375 350.25 Q 562.375 350.25 562.375 350.25 L 542.375 350.25 Q 542.375 350.25 542.375 350.25 L 542.375 175.125 Z' ===
            path
        ).toBe(true);
        done();
      };
  ...
  describe('Column Series with negative', () => {
    ...
    it('Default Series Type with negative points', (done: Function) => {
      loaded = (args: Object): void => {
        ...
        let seriesElements1: HTMLElement = document.getElementById(
          'container_Series_0_Point_5'
        );
        expect(seriesElements != null).toBe(true);
        expect(seriesElements1 != null).toBe(true);
        done();
    ...
    it('Checking animation', (done: Function) => {
      animationCOmplete = (args: IAnimationCompleteEventArgs): void => {
        let point = document.getElementById(
          'container_Series_' + args.series.index + '_Point_0'
        );
  ...
  describe('Column Series in Cyliderical shape', () => {
    ...
    it('Column Series Type with ColumnFacet property as Cylinder', (done: Function) => {
      loaded = (args: Object): void => {
        let region1: string = document
          .getElementById('container_Series_0_Point_2_Region_1')
          .getAttribute('d');
        let region2: string = document
          .getElementById('container_Series_0_Point_2_Region_0')
          .getAttribute('d');
        let region3: string = document
          .getElementById('container_Series_0_Point_2_Region_2')
          .getAttribute('d');
        expect(
          region1 ===
            'M144.04999999999998,278.2675a23.450000000000003,5.862500000000001 0 1,0 46.900000000000006,0a23.450000000000003,5.862500000000001 0 1,0 -46.900000000000006,0'
        ).toBe(true);
        expect(
          region2 ===
            'M144.04999999999998,332.3875a23.450000000000003,5.862500000000001 0 1,0 46.900000000000006,0a23.450000000000003,5.862500000000001 0 1,0 -46.900000000000006,0'
        ).toBe(true);
        expect(
          region3 ===
            'M144.04999999999998,278.2675a23.450000000000003,5.862500000000001 0 1,0 46.900000000000006,0l0 54.120000000000005a23.450000000000003,5.862500000000001 0 1,1 -46.900000000000006,0 z'
        ).toBe(true);
        done();
      };
      chartObj.loaded = loaded;
    ...
    it('Checking animation for Cylindrical chart', (done: Function) => {
      animationCOmplete = (args: IAnimationCompleteEventArgs): void => {
        let point = document.getElementById(
          'container_Series_' + args.series.index + '_Point_4_Region_2'
        );
        expect(point.getAttribute('transform') === 'translate(0,0)').toBe(true);
        done();
      };
  ...
  describe('Column Series in Cyliderical shape with DateTime Category', () => {
    ...
    it('Column Series Type with ColumnFacet property as Cylinder', (done: Function) => {
      loaded = (args: Object): void => {
        let region1: string = document
          .getElementById('container_Series_0_Point_5_Region_1')
          .getAttribute('d');
        let region2: string = document
          .getElementById('container_Series_0_Point_5_Region_0')
          .getAttribute('d');
        let region3: string = document
          .getElementById('container_Series_0_Point_5_Region_2')
          .getAttribute('d');
        expect(
          region1 ===
            'M636.9009658955401,41.0508347245409a38.74666110183642,9.686665275459106 0 1,0 77.49332220367285,0a38.74666110183642,9.686665275459106 0 1,0 -77.49332220367285,0'
        ).toBe(true);
        expect(
          region2 ===
            'M636.9009658955401,328.5633347245409a38.74666110183642,9.686665275459106 0 1,0 77.49332220367285,0a38.74666110183642,9.686665275459106 0 1,0 -77.49332220367285,0'
        ).toBe(true);
        expect(
          region3 ===
            'M636.9009658955401,41.0508347245409a38.74666110183642,9.686665275459106 0 1,0 77.49332220367285,0l0 287.5125a38.74666110183642,9.686665275459106 0 1,1 -77.49332220367285,0 z'
        ).toBe(true);
        done();
      };
      chartObj.loaded = loaded;
  ...
  describe('Checking Cylindrical chart in Canvas Mode.', () => {
    ...
    it('Checking Cylindrical chart render in canvas mode', (done: Function) => {
      loaded = (args: Object): void => {
        expect(document.getElementsByTagName('canvas')[0].id).toEqual(
          'CanvasContainer_canvas'
        );
        done();
      };
  ...
  describe('DataLabel', () => {
    ...
    it('Showing default marker', (done: Function) => {
      loaded = (args: Object): void => {
        let element: HTMLElement = document.getElementById(
          'container_Series_0_Point_3_Text_0'
        );
        expect(element.textContent == '65').toBe(true);
        expect(
          document.getElementById('containerShapeGroup0').childNodes.length == 0
        ).toBe(true);
        done();
      };
    ...
    it('Showing default marker shape', (done: Function) => {
      loaded = (args: Object): void => {
        ...
        expect(
          document.getElementById('containerShapeGroup0').childNodes.length == 6
        ).toBe(true);
        done();
      };
      chartObj.loaded = loaded;
    ...
    it('with marker visibility', (done: Function) => {
      loaded = (args: Object): void => {
        ...
        expect(element != null).toBe(true);
        let marker: HTMLElement = document.getElementById(
    ...
    it('with marker size without marker visibility', (done: Function) => {
      loaded = (args: Object): void => {
        ...
        let location: number =
          +marker.getAttribute('x') + +marker.getAttribute('width');
        ...
        let point0: number = +document
          .getElementById('container_Series_0_Point_0_Text_0')
          .getAttribute('y');
        let point1: number = +document
          .getElementById('container_Series_0_Point_1_Text_0')
          .getAttribute('y');
        let point2: number = +document
          .getElementById('container_Series_0_Point_2_Text_0')
          .getAttribute('y');
        let point3: number = +document
          .getElementById('container_Series_0_Point_3_Text_0')
          .getAttribute('y');
        let point4: number = +document
          .getElementById('container_Series_0_Point_4_Text_0')
          .getAttribute('y');
        let point5: number = +document
          .getElementById('container_Series_0_Point_5_Text_0')
          .getAttribute('y');
        let point0Location: number = (<Points>(
          (<Series>chartObj.series[0]).points[0]
        )).symbolLocations[0].y;
        let point1Location: number = (<Points>(
          (<Series>chartObj.series[0]).points[1]
        )).symbolLocations[0].y;
        let point2Location: number = (<Points>(
          (<Series>chartObj.series[0]).points[2]
        )).symbolLocations[0].y;
        let point3Location: number = (<Points>(
          (<Series>chartObj.series[0]).points[3]
        )).symbolLocations[0].y;
        let point4Location: number = (<Points>(
          (<Series>chartObj.series[0]).points[4]
        )).symbolLocations[0].y;
        let point5Location: number = (<Points>(
          (<Series>chartObj.series[0]).points[5]
        )).symbolLocations[0].y;
    ...
    it('Checking default data label position with multiple series', (done: Function) => {
      loaded = (args: Object): void => {
        let point0: number = +document
          .getElementById('container_Series_1_Point_0_Text_0')
          .getAttribute('y');
        let point1: number = +document
          .getElementById('container_Series_1_Point_1_Text_0')
          .getAttribute('y');
        let point2: number = +document
          .getElementById('container_Series_1_Point_2_Text_0')
          .getAttribute('y');
        let point3: number = +document
          .getElementById('container_Series_1_Point_3_Text_0')
          .getAttribute('y');
        let point4: number = +document
          .getElementById('container_Series_1_Point_4_Text_0')
          .getAttribute('y');
        let point5: number = +document
          .getElementById('container_Series_1_Point_5_Text_0')
          .getAttribute('y');
        let point0Location: number = (<Points>(
          (<Series>chartObj.series[1]).points[0]
        )).symbolLocations[0].y;
        let point1Location: number = (<Points>(
          (<Series>chartObj.series[1]).points[1]
        )).symbolLocations[0].y;
        let point2Location: number = (<Points>(
          (<Series>chartObj.series[1]).points[2]
        )).symbolLocations[0].y;
        let point3Location: number = (<Points>(
          (<Series>chartObj.series[1]).points[3]
        )).symbolLocations[0].y;
        let point4Location: number = (<Points>(
          (<Series>chartObj.series[1]).points[4]
        )).symbolLocations[0].y;
        let point5Location: number = (<Points>(
          (<Series>chartObj.series[1]).points[5]
        )).symbolLocations[0].y;
        expect(point0 < point0Location).toBe(true);
        expect(point1 < point1Location).toBe(true);
        expect(point2 < point2Location).toBe(true);
    ...
    it('Checking data label shape without fill', (done: Function) => {
      loaded = (args: Object): void => {
        let marker: HTMLElement = document.getElementById(
          'container_Series_1_Point_2_TextShape_0'
        );
    ...
    it('Checking font color saturation - background black', (done: Function) => {
      loaded = (args: Object): void => {
        let marker: HTMLElement = document.getElementById(
          'container_Series_1_Point_3_Text_0'
        );
    ...
    it('Checking dataLabel positions Default', (done: Function) => {
      loaded = (args: Object): void => {
        let hiddenShape: HTMLElement = document.getElementById(
          'container_Series_1_Point_1_TextShape_0'
        );
        let hiddenText: HTMLElement = document.getElementById(
          'container_Series_1_Point_1_Text_0'
        );
        expect(hiddenText != null).toBe(true);
        expect(hiddenShape != null).toBe(true);
        let element: number = +document
          .getElementById('container_Series_1_Point_2_Text_0')
          .getAttribute('y');
        expect(
          (<Points>(<Series>chartObj.series[1]).points[2]).symbolLocations[0]
            .y < element
        ).toBe(true);
        done();
      };
    ...
    it('Checking dataLabel positions Middle', (done: Function) => {
      loaded = (args: Object): void => {
        let element: number = +document
          .getElementById('container_Series_1_Point_2_Text_0')
          .getAttribute('y');
        let locationY: number = (<Points>(<Series>chartObj.series[1]).points[2])
          .symbolLocations[0].y;
        let height: number = document
          .getElementById('container_Series_1_Point_2_Text_0')
    ...
    it('Checking Data label alignment with position auto - near alignment', (done: Function) => {
      loaded = (args: Object): void => {
        let svg: number = +document
          .getElementById('container_Series_0_Point_4_TextShape_0')
          .getAttribute('y');
        expect(
          svg >
            (<Points>(<Series>chartObj.series[0]).points[4]).symbolLocations[0]
              .y
        ).toBe(true);
        done();
      };
    ...
    it('Checking Data label alignment except Auto position - bottom Position alignment far', (done: Function) => {
      loaded = (args: Object): void => {
        ...
        expect(hiddenShape != null).toBe(true);
        let elementY: HTMLElement = document.getElementById(
          'container_Series_1_Point_2_TextShape_0'
        );
    ...
    it('Checking Data label alignment except Auto position - Outer Position  - alignment near', (done: Function) => {
      loaded = (args: Object): void => {
        ...
        expect(hiddenShape != null).toBe(true);
        let elementYLocation: number = +document
          .getElementById('container_Series_1_Point_2_TextShape_0')
          .getAttribute('y');
        let symbolLocation: number = (<Points>(
          (<Series>chartObj.series[1]).points[2]
        )).symbolLocations[0].y;
        expect(elementYLocation > symbolLocation).toBe(true);
        elementYLocation = +document
          .getElementById('container_Series_1_Point_2_TextShape_0')
          .getAttribute('y');
        symbolLocation = (<Points>(<Series>chartObj.series[1]).points[2])
          .symbolLocations[0].y;
        expect(elementYLocation > symbolLocation).toBe(true);
        done();
      };
    ...
    it('Checking Data label alignment except Auto position - Outer Position  - alignment far', (done: Function) => {
      loaded = (args: Object): void => {
        let xLocation = +document
          .getElementById('container_Series_0_Point_5_Text_0')
          .getAttribute('x');
        let width = +document
          .getElementById('container_ChartAreaBorder')
          .getAttribute('width');
    ...
    it('Checking Data label alignment except Auto position - Outer Position - alignment center', (done: Function) => {
      loaded = (args: Object): void => {
        let hiddenShape: HTMLElement = document.getElementById(
          'container_Series_0_Point_1_Text_0'
        );
        expect(hiddenShape != null).toBe(true);
        let elementYLocation: number = +document
          .getElementById('container_Series_0_Point_2_Text_0')
    ...
    it('Checking Data label alignment except Auto position - Top Position', (done: Function) => {
      loaded = (args: Object): void => {
        ...
        symbolLocation = (<Points>(<Series>chartObj.series[1]).points[2])
          .symbolLocations[0].y;
        let elementHeight: number = +document
          .getElementById('container_Series_1_Point_2_TextShape_0')
          .getAttribute('height');
        expect(elementYLocation != symbolLocation - elementHeight - 5).toBe(
          true
        );
        done();
      };
    ...
    it('Checking margin', (done: Function) => {
      loaded = (args: Object): void => {
        let shape: HTMLElement = document.getElementById(
          'container_Series_0_Point_2_TextShape_0'
        );
        ...
        let text: HTMLElement = document.getElementById(
          'container_Series_0_Point_2_Text_0'
        );
    ...
    it('Checking Overlap data', (done: Function) => {
      chartObj.loaded = (args: Object): void => {
        expect(
          document.getElementById('containerShapeGroup2').childNodes.length == 6
        ).toBe(true);
        expect(
          document.getElementById('container_Series_2_Point_0_TextShape_0') !=
            null
        ).toBe(true);
        expect(
          document.getElementById('container_Series_2_Point_2_TextShape_0') !=
            null
        ).toBe(true);
        done();
      };
    ...
    it('Changing series Type', (done: Function) => {
      loaded = (args: Object): void => {
        expect(
          document.getElementById('containerShapeGroup2').childNodes.length > 4
        ).toBe(true);
        done();
      };
      chartObj.loaded = loaded;
    ...
    it('Checking properties', (done: Function) => {
      loaded = (args: Object): void => {
        ...
        expect(
          document.getElementById('container_Series_0_Point_3_Text_0')
            .textContent == '65.00'
        ).toBe(true);
        let element: HTMLElement = document.getElementById(
          'container_Series_1_Point_2_TextShape_0'
    ...
    it('Series Visible', (done: Function) => {
      loaded = (args: Object): void => {
        ...
        let y: number =
          series.points[1].regions[0].y +
          parseFloat(chartArea.getAttribute('y')) +
          element.offsetTop;
        let x: number =
          series.points[1].regions[0].x +
        ...
        let legendElement: HTMLElement = document.getElementById(
          legendId + '_text_' + 0
        );
  ...
  describe('Column Series with negative point data label', () => {
        ...
        series: [
          {
            ...
            marker: {
              visible: false,
              dataLabel: { visible: true, fill: 'violet' },
            },
          },
        ],
        width: '800',
    ...
    it('With negative location', (done: Function) => {
      loaded = (args: Object): void => {
        let svg: number = +document
          .getElementById('container_Series_0_Point_1_TextShape_0')
          .getAttribute('y');
        let point0Location = (<Points>(<Series>chartObj.series[0]).points[1])
          .symbolLocations[0].y;
    ...
    it('With Label position Bottom', (done: Function) => {
      loaded = (args: Object): void => {
        ...
        expect(svg < point0Location).toBe(true);
        let rect: number = +document
          .getElementById('container_Series_0_Point_1')
          .getAttribute('y');
        let rectHeight: number = +document
          .getElementById('container_Series_0_Point_1')
          .getAttribute('height');
        expect(svg == rect + 5);
        done();
    ...
    it('Color saturation middle position', (done: Function) => {
      loaded = (args: Object): void => {
        let element: HTMLElement = document.getElementById(
          'container_Series_0_Point_4_Text_0'
        );
        expect(element.getAttribute('fill') == 'white').toBe(true);
        done();
      };
  ...
  describe('column Series Inversed axis', () => {
    ...
    it('With Label position Auto', (done: Function) => {
      loaded = (args: Object): void => {
        dataLabelY = +document
          .getElementById('container_Series_0_Point_1_TextShape_0')
          .getAttribute('y');
        pointY = (<Points>(<Series>chart.series[0]).points[1])
          .symbolLocations[0].y;
        expect(dataLabelY < pointY).toBe(true);
        dataLabelY = +document
          .getElementById('container_Series_0_Point_0_TextShape_0')
          .getAttribute('y');
        pointY = (<Points>(<Series>chart.series[0]).points[0])
          .symbolLocations[0].y;
        expect(dataLabelY > pointY).toBe(true);
        done();
      };
    ...
    it('With Label position Middle', (done: Function) => {
      loaded = (args: Object): void => {
        let labelY: number = +document
          .getElementById('container_Series_0_Point_1_TextShape_0')
          .getAttribute('y');
        let labelHeight: number = +document
          .getElementById('container_Series_0_Point_1_TextShape_0')
          .getAttribute('height');
        let point: Points = <Points>(<Series>chart.series[0]).points[1];
        expect(labelY + labelHeight / 2).toEqual(
          point.regions[0].y + point.regions[0].height / 2
        );
        done();
      };
      chart.loaded = loaded;
  ...
  describe('checking Column rotated chart', () => {
    ...
    it('checking with datalabel Auto position', (done: Function) => {
      loaded = (args: Object): void => {
        //positive yValues
        dataLabel = document.getElementById(
          'container_Series_0_Point_2_Text_0'
        );
        point = <Points>(<Series>chart.series[0]).points[2];
        expect(+dataLabel.getAttribute('x') > point.symbolLocations[0].x).toBe(
          true
        );
        //negative yValues
        dataLabel = document.getElementById(
    ...
    it('checking with datalabel Middle position', (done: Function) => {
      loaded = (args: Object): void => {
        ...
        point = <Points>(<Series>chart.series[0]).points[2];
        expect(
          +dataLabel.getAttribute('x') <
            point.symbolLocations[0].x + point.regions[0].width / 2
        ).toBe(true);
        done();
      };
      chart.loaded = loaded;
    ...
    it('checking with datalabel bottom position', (done: Function) => {
      loaded = (args: Object): void => {
        ...
        expect(
          +dataLabel.getAttribute('x') >
            point.symbolLocations[0].x - point.regions[0].width
        ).toBe(true);
        //negative yValues
        dataLabel = document.getElementById(
          'container_Series_0_Point_1_Text_0'
    ...
    it('checking with tooltip positive values', (done: Function) => {
      loaded = (args: Object): void => {
        ...
        chartArea = document.getElementById('container_ChartAreaBorder');
        y =
          series.points[2].regions[0].y +
          parseFloat(chartArea.getAttribute('y')) +
          element.offsetTop;
        x =
          series.points[2].regions[0].x +
          parseFloat(chartArea.getAttribute('x')) +
          element.offsetLeft;
    ...
    it('checking with tooltip negative values', (done: Function) => {
      loaded = (args: Object): void => {
        ...
        y =
          (parseFloat(chartArea.getAttribute('height')) + element.offsetTop) /
            2 +
          10;
        x =
          (parseFloat(chartArea.getAttribute('width')) + element.offsetLeft) /
            2 +
          60;
        trigger.mousemovetEvent(dataLabel, Math.ceil(x), Math.ceil(y));
        done();
      ...
      let animate: EmitType<IAnimationCompleteEventArgs> = (
        ...
        let tooltip: HTMLElement = document.getElementById(
          'container_Series_0_Point_1'
        );
  ...
  describe('Column Series - Marker', () => {
    ...
    it('Changing visibility', (done: Function) => {
      loaded = (args: Object): void => {
        let series1: HTMLElement = document.getElementById(
          'containerSymbolGroup0'
        );
    ...
    it('with image', (done: Function) => {
      loaded = (args: Object): void => {
        let series1 = document.getElementById(
          'container_Series_0_Point_0_Symbol'
        );
        expect(series1.getAttribute('href') == 'base/spec/img/img1.jpg').toBe(
          true
        );
        done();
      };
    ...
    it('Checking with Cross marker shape ', (done: Function) => {
      loaded = (args: Object): void => {
        let series1: HTMLElement = document.getElementById(
          'container_Series_0_Point_1_Symbol'
        );
    ...
    it('with marker and datalabel', (done: Function) => {
      loaded = (args: Object): void => {
        ...
        let datalabel = document.getElementById(
          'container_Series_0_Point_0_Text_0'
        );
        expect(+datalabel.getAttribute('y') < +series1.getAttribute('cy')).toBe(
          true
        );
        done();
      };
  ...
  describe('Column series with drag and drop support', () => {
    ...
    it('Column series drag and drop with marker true', (done: Function) => {
      loaded = (): void => {
        let target: HTMLElement = document.getElementById(
          'dragColumn_Series_0_Point_3_Symbol'
        );
        let chartArea: HTMLElement = document.getElementById(
          'dragColumn_ChartAreaBorder'
        );
        y =
          parseFloat(target.getAttribute('cy')) +
          parseFloat(chartArea.getAttribute('y')) +
          columnContainer.offsetTop;
        x =
          parseFloat(target.getAttribute('cx')) +
          parseFloat(chartArea.getAttribute('x')) +
          columnContainer.offsetLeft;
        trigger.mousemovetEvent(target, Math.ceil(x), Math.ceil(y));
        trigger.draganddropEvent(
          columnContainer,
          Math.ceil(x),
          Math.ceil(y),
          Math.ceil(x),
    ...
    it('Column series drag and drop with marker false', (done: Function) => {
      loaded = (): void => {
        let target: HTMLElement = document.getElementById(
          'dragColumn_Series_0_Point_3'
        );
        let chartArea: HTMLElement = document.getElementById(
          'dragColumn_ChartAreaBorder'
        );
        x =
          columnChart.visibleSeries[0].points[3].regions[0].x +
          parseFloat(chartArea.getAttribute('x')) +
          columnContainer.offsetLeft;
        y =
          columnChart.visibleSeries[0].points[3].regions[0].y +
          parseFloat(chartArea.getAttribute('y')) +
          columnContainer.offsetTop;
        trigger.mousemovetEvent(target, Math.ceil(x), Math.ceil(y));
        trigger.draganddropEvent(
    ...
    it('Column series drag and drop with dragged point fill color', (done: Function) => {
      loaded = (): void => {
        ...
        let yValue: number = columnChart.visibleSeries[0].points[3].yValue;
        expect(yValue == 80.27 || yValue == 79.91).toBe(true);
        let color: string = document
          .getElementById('dragColumn_Series_0_Point_3')
          .getAttribute('fill');
  ...
  describe('Column series with grouping support', () => {
    ...
    it('Column series group support', (done: Function) => {
      loaded = (): void => {
        let direction: string[] = document
          .getElementById('groupColumn_Series_0_Point_0')
          .getAttribute('d')
          .split(' ');
        let point: number = parseFloat(direction[direction.indexOf('L') + 1]);
        let direction1: string[] = document
          .getElementById('groupColumn_Series_1_Point_0')
          .getAttribute('d')
          .split(' ');
        let point1: number = parseFloat(
          direction1[direction1.indexOf('L') + 1]
        );
        expect(point > point1).toBe(true);
        let direction2: string[] = document
          .getElementById('groupColumn_Series_2_Point_0')
          .getAttribute('d')
          .split(' ');
        let point2: number = parseFloat(
          direction2[direction2.indexOf('L') + 1]
        );
        let direction3: string[] = document
          .getElementById('groupColumn_Series_3_Point_0')
          .getAttribute('d')
          .split(' ');
        let point3: number = parseFloat(
  ...
  describe('Column Series - Cheking animation on data changes.', () => {
    ...
    chartContainerDiv = createElement('div', {
      id: 'ColumnContainer',
      styles: 'height:250px;width:590px;float: left;',
    });
    beforeAll(() => {
    ...
    it('Checking column series updated direction', (done: Function) => {
      chartObj.loaded = (args: Object): void => {
        let element: Element = document.getElementById(
          'ColumnContainer_Series_0_Point_0'
        );
        expect(element.getAttribute('d')).toBe(
          'M 6.843750000000001 54.626609374999994 Q 6.843750000000001 54.626609374999994 6.843750000000001 54.626609374999994 L 38.78125 54.626609374999994 Q 38.78125 54.626609374999994 38.78125 54.626609374999994 L 38.78125 171.25 Q 38.78125 171.25 38.78125 171.25 L 6.843750000000001 171.25 Q 6.843750000000001 171.25 6.843750000000001 171.25 L 6.843750000000001 54.626609374999994 Z'
        );
        done();
      };
        ...
        series: [
          {
            ...
            marker: {
              visible: true,
              dataLabel: { visible: true, position: 'Top', name: 'a' },
            },
          },
        ],
        chartArea: { border: { width: 0 } },
