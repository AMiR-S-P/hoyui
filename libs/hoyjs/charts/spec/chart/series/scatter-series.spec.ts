...
describe('Chart Control', () => {
  ...
  describe('Chart Scatter series', () => {
      ...
      loaded = (args: Arg): void => {
        ...
        expect(
          parseFloat(svg.getAttribute('y')) <
            series.points[1].symbolLocations[0].y
        ).toBe(true);
        done();
      };
      chartObj.loaded = loaded;
    ...
    it('Checking with marker shape Circle without tooltip', (done: Function) => {
      loaded = (args: Object): void => {
        ...
        let tooltip: HTMLElement = document.getElementById(
          'container_Series_0_Point_2_Trackball_1'
        );
    ...
    it('Checking with marker size', (done: Function) => {
      ...
      loaded = (args: Object): void => {
        let value: number = Math.round(
          (<Series>chartObj.series[0]).points[2].regions[0].y
        );
    ...
    it('checking with dateTime', (done: Function) => {
      loaded = (args: Object): void => {
        let axislabel: HTMLElement = document.getElementById(
      ...
      series: [
        {
          ...
          type: 'Scatter',
          name: 'ChartSeriesNameGold',
          fill: 'green', //marker: { visible: true, dataLabel: { visible: true } },
          xAxisName: 'xAxis1',
          yAxisName: 'yAxis1',
        },
        {
          ...
          type: 'Line',
          name: 'ChartSeriesNameGold',
          fill: 'red', //marker: { visible: true, dataLabel: { visible: true } },
          xAxisName: 'xAxis1',
          yAxisName: 'yAxis1',
        },
        {
          ...
          fill: 'black', //marker: { visible: true, dataLabel: { visible: true } },
          xAxisName: 'xAxis1',
          yAxisName: 'yAxis1',
        },
        {
          ...
          fill: 'blue', //marker: { visible: true, dataLabel: { visible: true } },
          xAxisName: 'xAxis2',
          yAxisName: 'yAxis2',
        },
        {
        ...
        },
        {
          ...
          fill: 'rgba(135,000,235,1)', //marker: { visible: true, dataLabel: { visible: true } },
          xAxisName: 'xAxis3',
          yAxisName: 'yAxis5',
        },
        {
          ...
          fill: 'purple', //marker: { visible: true, dataLabel: { visible: true } },
          xAxisName: 'xAxis4',
          yAxisName: 'yAxis6',
        },
        {
  ...
  it('With Label position Auto', (done: Function) => {
    loaded = (args: Object): void => {
      dataLabelY = +document
        ...
        .getAttribute('y');
      pointY = (<Points>(<Series>chart.series[0]).points[2]).symbolLocations[0]
        .y;
      expect(dataLabelY > pointY).toBe(true);
      dataLabelY = +document
        .getElementById('container_Series_0_Point_6_TextShape_0')
        .getAttribute('y');
      pointY = (<Points>(<Series>chart.series[0]).points[6]).symbolLocations[0]
        .y;
      expect(dataLabelY < pointY).toBe(true);
      done();
    };
  ...
  beforeAll(() => {
    ...
    chart = new Chart({
      ...
      series: [
        ...
        },
        {
          ...
          fill: 'White',
          width: 3,
          marker: { visible: true, shape: 'Diamond', width: 10, height: 10 },
        },
        {
          dataSource: scatter2,
          type: 'Polar',
          ...
          fill: '#F9E79F',
          width: 2,
          marker: { visible: true, width: 12, height: 12 },
        },
        {
          dataSource: scatter3,
          type: 'Polar',
          ...
          fill: '#F9E79F',
          width: 2,
          marker: { visible: true, width: 36, height: 35 },
        },
        {
          dataSource: dataa2,
          type: 'Polar',
        ...
        },
        {
          ...
          fill: 'White',
          width: 2,
          marker: { visible: true, shape: 'Diamond', width: 12, height: 10 },
        },
      ],
      pointClick: function (args: IPointEventArgs): void {
        if (args.point.x > 86 || args.point.x < 15) {
          var newPoint = getPolarpoint(
            args.x,
            args.y,
            <Series>args.series,
            (<Series>args.series).chart
          );
          (<Series>args.series).chart.addSeries([
            {
              type: 'Polar',
              drawType: 'Scatter',
              dataSource: [{ x: newPoint.x, y: newPoint.y }],
              xName: 'x',
              width: 2,
              animation: { enable: false },
              yName: 'y',
    ...
    function getPolarpoint(
      ...
      var centerX = series.clipRect.width / 2 + series.clipRect.x,
        ...
        yValue =
          Value * series.yAxis.visibleRange.delta +
          series.yAxis.visibleRange.min,
        difference,
        result1;
      ...
      difference =
        series.xAxis.visibleRange.max - series.xAxis.visibleRange.min;
  ...
  it('checking scatter series', () => {
    loaded = (args: Object): void => {
      ...
      trigger.mousedownEvent(
        ...
        0,
        0,
        Math.ceil(576.0000000000002),
        Math.ceil(63.999999999999886)
      );
      let clip: HTMLElement = document.getElementById(
        'container_ChartSeriesClipRect_11_Circle'
      );
