...
export let categoryData: any[] = [
  { x: 'USA', low: -12, high: 0 },
  { x: 'China', low: 12, high: 10 },
  { x: 'Japan', low: 23, high: 10 },
  { x: 'Australia', low: 202, high: 43 },
  { x: 'France1', low: 0, high: 10 },
  { x: 'Germany1', low: -22, high: 34 },
  { x: 'Italy', low: -12, high: 23 },
  { x: 'Sweden', low: 12, high: 40 },
];
...
export let dateTimeData: any[] = [
  { x: new Date(1, 0, 2000), low: -12, high: 0 },
  { x: new Date(1, 0, 2001), low: 12, high: 10 },
  { x: new Date(1, 0, 2002), low: 23, high: 10 },
  { x: new Date(1, 0, 2003), low: 202, high: 43 },
  { x: new Date(1, 0, 2004), low: 0, high: 10 },
  { x: new Date(1, 0, 2005), low: -22, high: 34 },
  { x: new Date(1, 0, 2006), low: -12, high: 23 },
  { x: new Date(1, 0, 2007), low: 12, high: 40 },
];
...
describe('Chart', () => {
  ...
  describe('Range Column Series', () => {
    ...
    beforeAll(() => {
      ...
      let template1: Element = createElement('div', {
        id: 'template1',
        styles: 'display: none;',
      });
    ...
    it('with dateTimeRange', (done: Function) => {
      loaded = (args: Object): void => {
        ...
        expect(
          labelElement.textContent == 'Jun 25' ||
            labelElement.textContent == 'Jun 26'
        ).toBe(true);
        done();
      };
      chartObj.loaded = loaded;
    ...
    it('Checking with category axis BetweenTicks', (done: Function) => {
      loaded = (args: Object): void => {
        ...
        expect(point != null).toBe(true);
        let axisLabel: Element = document.getElementById(
        ...
        expect(
          parseInt(axisLabel.getAttribute('x')) >
            parseInt(axisStart.getAttribute('d').split(' ')[1])
        ).toBe(true);
        done();
      };
      chartObj.loaded = loaded;
    ...
    it('checking with multiple series', (done: Function) => {
      loaded = (args: Object): void => {
        ...
        expect(
          series1.points[2].regions[0].x ==
            series0.points[2].regions[0].width + series0.points[2].regions[0].x
        ).toBe(true);
        done();
      };
      ...
      loaded = (args: Object): void => {
        ...
        expect(
          series.points[1].regions[0].y <
            parseFloat(axisLabel.getAttribute('y'))
        ).toBe(true);
        done();
      };
      chartObj.loaded = loaded;
    ...
    it('Single point selection', (done: Function) => {
      loaded = () => {
        ...
        let selected: HTMLCollection = document.getElementsByClassName(
    ...
    it('Cluster selection', (done: Function) => {
      loaded = () => {
        ...
        let element1: Element = document.getElementById(
    ...
    it('checking with track ball', (done: Function) => {
      ...
      loaded = (args: Object): void => {
        ...
        let y: number =
          series.points[3].regions[0].y +
          parseFloat(chartArea.getAttribute('y')) +
          element.offsetTop;
        let x: number =
          series.points[3].regions[0].x +
          parseFloat(chartArea.getAttribute('x')) +
          element.offsetLeft;
        trigger.mousemovetEvent(target, Math.ceil(x), Math.ceil(y));
        ...
        let tooltip: HTMLElement = document.getElementById('container_tooltip');
        expect(tooltip != null).toBe(true);
        expect(tooltip.offsetTop < y + series.points[3].regions[0].height).toBe(
          true
        );
    ...
    it('checking with cross hair', (done: Function) => {
      loaded = (args: Object): void => {
        ...
        let x: number =
          ...
          series.points[2].regions[0].width / 2 +
          parseFloat(chartArea.getAttribute('x')) +
          element.offsetLeft;
        trigger.mousemovetEvent(chartArea, Math.ceil(x), Math.ceil(y));
        let crosshair: Element = <Element>(
          document.getElementById('container_svg').childNodes[5]
        );
        ...
        expect(
          Math.round(+element1.textContent) == 23 ||
            Math.round(+element1.textContent) == 22
        ).toBe(true);
        done();
      };
      chartObj.loaded = loaded;
    ...
    it('checking with log axis with dataTime axis', (done: Function) => {
      loaded = (args: Object): void => {
        let axisLabel: Element = document.getElementById(
          'container1_AxisLabel_1'
        );
        expect(axisLabel.textContent == '10').toBe(true);
        let axisLabelLast: Element = document.getElementById(
          'container1_AxisLabel_5'
        );
      ...
      chartObj.series = [
        {
          ...
          high: 'high',
          dataSource: [
            { x: new Date(1, 0, 2000), low: 100, high: 10000 },
            { x: new Date(1, 0, 2001), low: 120, high: 2000 },
            { x: new Date(1, 0, 2002), low: 232, high: 1233 },
            { x: new Date(1, 0, 2003), low: 202, high: 4003 },
            { x: new Date(1, 0, 2004), low: 0, high: 10342 },
            { x: new Date(1, 0, 2005), low: 4622, high: 340 },
            { x: new Date(1, 0, 2006), low: 120, high: 2300 },
            { x: new Date(1, 0, 2007), low: 1223, high: 4000 },
          ],
        },
      ];
      chartObj.refresh();
      ...
      chartObj.series = [
        {
          ...
          high: 'high',
          dataSource: [
            { x: 100, low: 100, high: 10000 },
            { x: 200, low: 120, high: 2000 },
            { x: 300, low: 232, high: 1233 },
            { x: 1000, low: 202, high: 4003 },
            { x: 10000, low: 0, high: 10342 },
            { x: 1500, low: 4622, high: 340 },
            { x: 2000, low: 120, high: 2300 },
            { x: 8000, low: 1223, high: 4000 },
          ],
        },
      ];
      chartObj.refresh();
    ...
    it('checking with datalabel outer position', (done: Function) => {
      loaded = (args: Object): void => {
        ...
        let height: number =
          (<Points>(<Series>chartObj.series[0]).points[1]).regions[0].height /
          2;
        expect(label.textContent).toEqual('12K');
        expect(svg < point0Location - height).toBe(true);
        let svg1: number = +document
          .getElementById('container_Series_0_Point_1_TextShape_1')
          .getAttribute('y');
        let label2: Element = document.getElementById(
          'container_Series_0_Point_1_Text_1'
        );
    ...
    it('checking with datalabel top position', (done: Function) => {
      chartObj.loaded = (args: Object): void => {
        ...
        let svg1: number = +document
          .getElementById('container_Series_0_Point_1_TextShape_1')
          .getAttribute('y');
        let pointLocation1: number = (<Points>(
          (<Series>chartObj.series[0]).points[1]
        )).symbolLocations[0].y;
    ...
    it('checking elements counts with using template without element', (done: Function) => {
      chartObj.loaded = (args: ILoadedEventArgs): void => {
        ...
        element = document.getElementById(
          'container_Series_0_DataLabelCollections'
        );
        expect(element).toBe(null);
        done();
      };
    ...
    it('checking elements counts and datalabel with using template as html string', (done: Function) => {
      chartObj.loaded = (args: ILoadedEventArgs): void => {
        ...
        expect(element.children[0].id).toBe(
          'container_Series_0_DataLabelCollections'
        );
        element = document.getElementById(
          'container_Series_0_DataLabelCollections'
    ...
    it('checking template as point x value and cheecking style', (done: Function) => {
      chartObj.loaded = (args: ILoadedEventArgs): void => {
        let element: HTMLElement = document.getElementById(
          'container_Series_0_DataLabel_5'
        );
      ...
      chartObj.series[0].marker.dataLabel.template =
        '<div>${point.high} : ${point.low}</div>';
      chartObj.refresh();
    });
    ...
    it('Checking with column series', (done: Function) => {
      loaded = (args: Object): void => {
        ...
        let series1: Series = <Series>chartObj.series[1];
        expect(
          Math.round(series1.points[2].regions[0].x) ==
            Math.round(
              series0.points[2].regions[0].width +
                series0.points[2].regions[0].x
            )
        ).toBe(true);
        done();
      };
    ...
    it('Changing the visibility of tooltip with axis label format', (done: Function) => {
      ...
      chartObj.loaded = (args: Object): void => {
        let target: Element = document.getElementById(
          'container_Series_0_Point_1'
        );
        let series: Series = <Series>chartObj.series[0];
        ...
        expect(
          (<HTMLElement>text1.childNodes[0]).getAttribute('fill') == 'red'
        ).toBe(true);
        expect(
          text1.textContent.replace(/\u200E/g, '') ==
            'series1#2High : 10CLow : 12C'
        ).toBe(true);
    ...
    it('Changing the trackball', (done: Function) => {
      ...
      chartObj.loaded = (args: Object): void => {
        ...
        expect(
          text1.textContent.replace(/\u200E/g, '') ==
            '#2series1High : 10CLow : 12Cseries2 : 10C'
        ).toBe(true);
        trigger.mousemovetEvent(target, Math.ceil(x), Math.ceil(y + 50));
        done();
      };
    ...
    it('Checking with template', (done: Function) => {
      ...
      loaded = (args: Object): void => {
        ...
        expect(tooltip != null).toBe(true);
        y =
          parseFloat(chartArea.getAttribute('height')) +
          parseFloat(chartArea.getAttribute('y')) +
          200 +
          element.offsetTop;
        x =
          parseFloat(chartArea.getAttribute('width')) +
          parseFloat(chartArea.getAttribute('x')) +
          element.offsetLeft;
      ...
      chartObj.tooltip.template =
        '<div>${x}</div><div>${high}</div><div>${low}</div>';
      chartObj.tooltip.shared = false;
  ...
  describe('checking for multiple axes', () => {
      ...
      chartObj = new Chart({
        ...
        series: [
          ...
          },
          {
            ...
            animation: { enable: false },
            type: 'RangeColumn',
            name: 'ChartSeriesNamePlatinum',
            fill: 'rgba(135,000,235,1)',
            xAxisName: 'xAxis3',
            yAxisName: 'yAxis5',
          },
          {
    ...
    it('Checking with axes', (done: Function) => {
      loaded = (args: Object): void => {
        ...
        let axisCollection: Element = document.getElementById(
          'containerAxisInsideCollection'
        );
        expect(+axisCollection.childElementCount).toEqual(19);
        let seriesCollection: Element = document.getElementById(
          'containerSeriesCollection'
        );
  ...
  describe('Range column Series with Inversed axis', () => {
    ...
    it('With Label position Auto', (done: Function) => {
      loaded = (args: Object): void => {
        ...
        let point0Location: number = (<Points>(
          (<Series>chart.series[0]).points[1]
        )).symbolLocations[0].y;
        let height: number =
          (<Points>(<Series>chart.series[0]).points[1]).regions[0].height / 2;
        expect(svg > point0Location + height).toBe(true);
        let svg2: number = +document
          .getElementById('container_Series_0_Point_1_TextShape_1')
          .getAttribute('y');
        let label2: Element = document.getElementById(
          'container_Series_0_Point_1_Text_1'
        ...
        series: [
          {
            type: 'RangeColumn',
            name: 'columnSeries1',
            dataSource: doubleRangeColumnData,
            xName: 'x',
            low: 'low',
            high: 'high',
            animation: { enable: false },
  ...
  describe('Range Column Series - Marker', () => {
    ...
    it('Checking specify marker color', (done: Function) => {
      loaded = (args: Object): void => {
        ...
        let series2: HTMLElement = document.getElementById(
          'container_Series_0_Point_3_Symbol1'
        );
    ...
    it('with image', (done: Function) => {
      loaded = (args: Object): void => {
        ...
        let series2 = document.getElementById(
          'container_Series_0_Point_1_Symbol1'
        );
        expect(series2.getAttribute('href') == 'base/spec/img/img1.jpg').toBe(
          true
        );
        done();
      };
    ...
    it('with marker properties', (done: Function) => {
      loaded = (args: Object): void => {
        ...
        let series2 = document.getElementById(
          'container_Series_0_Point_2_Symbol1'
        );
    ...
    it('with marker and datalabel', (done: Function) => {
      loaded = (args: Object): void => {
        ...
        let datalabel2 = document.getElementById(
          'container_Series_0_Point_1_Text_1'
        );
        expect(
          +datalabel2.getAttribute('y') > +series2.getAttribute('cy')
        ).toBe(true);
        done();
      };
      chartObj.loaded = loaded;
  ...
  describe('Checking Range column series setData method.', () => {
    ...
    it('RangeColumn - setData', (done: Function) => {
      ...
      let rangeColumnData = [
        { x: new Date(1, 0, 2000), low: -12, high: 0 },
        { x: new Date(1, 0, 2001), low: 12, high: 10 },
        { x: new Date(1, 0, 2002), low: 30, high: 10 },
        { x: new Date(1, 0, 2003), low: 202, high: 43 },
        { x: new Date(1, 0, 2004), low: 0, high: 10 },
        { x: new Date(1, 0, 2005), low: -22, high: 34 },
        { x: new Date(1, 0, 2006), low: -12, high: 27 },
        { x: new Date(1, 0, 2007), low: 12, high: 40 },
      ];
