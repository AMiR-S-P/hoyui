  ...
  describe('pareto Series', () => {
    ...
    it('Checking with axis with opposed position', (done: Function) => {
      loaded = (args: Object): void => {
        ...
        expect(
          parseFloat(svg.getAttribute('x')) < parseFloat(svg1.getAttribute('x'))
        ).toBe(true);
        done();
      };
    ...
    it('Checking dataLabel positions Middle', (done: Function) => {
      loaded = (args: Object): void => {
        let element: number = +document
          ...
          .getAttribute('y');
        let locationY: number = (<Points>(<Series>chartObj.series[0]).points[0])
          .symbolLocations[0].y;
    ...
    it('Checking the last text value as 100', (done: Function) => {
      loaded = (args: Object): void => {
        expect(
          document.getElementById('container_Series_1_Point_7_Text_0')
            .textContent
        ).toBe(100 + '%');
        done();
      };
    ...
    it('Checking line series marker color', (done: Function) => {
      loaded = (args: Object): void => {
        let element1: HTMLElement = document.getElementById(
          'container_Series_1_Point_2_Symbol'
        );
    ...
    it('Checking column series in descending order', (done: Function) => {
      loaded = (args: Object): void => {
        ...
        expect(
          parseFloat(element1.getAttribute('y')) <
