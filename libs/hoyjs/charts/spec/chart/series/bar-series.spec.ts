...
describe('Chart Control', () => {
  ...
  describe('Chart Bar series', () => {
      ...
      loaded = (args: Object): void => {
        ...
        expect(
          series.points[1].regions[0].x <
            parseFloat(axisLabel.getAttribute('x'))
        ).toBe(true);
        done();
      };
      chartObj.loaded = loaded;
    ...
    it('checking multiple series bar chart', (done: Function) => {
      loaded = (args: Object): void => {
        ...
        expect(
          series0.points[2].regions[0].y ==
            series1.points[2].regions[0].height + series1.points[2].regions[0].y
        ).toBe(true);
        done();
      };
      chartObj.series = [
      ...
      loaded = (args: Object): void => {
        ...
        expect(
          parseFloat(tooltip.style.left) >
            elem.offsetLeft +
              series.points[7].regions[0].x +
              series.points[7].regions[0].width / 2 +
              parseFloat(chartArea.getAttribute('x'))
        ).toBe(true);
        done();
      };
    ...
    it('negative Tooltip', (done: Function) => {
      ...
      loaded = (args: Object): void => {
        ...
        let transform: string[] = document
          .getElementById('container_tooltip_group')
        ...
        expect(
          parseFloat(translateX[0]) <
            series.points[1].regions[0].x +
              series.points[1].regions[0].width +
              parseFloat(chartArea.getAttribute('x'))
        ).toBe(true);
        done();
      };
    ...
    it('checking with track ball', (done: Function) => {
      loaded = (args: Object): void => {
        ...
        let tooltip: HTMLElement = document.getElementById('container_tooltip');
        expect(tooltip != null).toBe(true);
        expect(tooltip.offsetTop < y + series.points[7].regions[0].height).toBe(
          true
        );
        tooltip = document.getElementById('container_tooltip');
        expect(tooltip != null).toBe(true);
    ...
    it('checking with cross hair', (done: Function) => {
      ...
      loaded = (args: Object): void => {
        ...
        expect(
          element1.textContent == '35.075' || element1.textContent == '35.076'
        ).toBe(true);
        done();
      };
      chartObj.loaded = loaded;
    ...
    it('Checking with multiple axes rows', (done: Function) => {
      loaded = (args: Object): void => {
        ...
        expect(point1.getAttribute('fill') === 'rgba(135,000,235,1)').toBe(
          true
        );
        done();
      };
    ...
    it('checking data label position with multiple axes - rows', (done: Function) => {
      chartObj.loaded = (args: Object): void => {
        expect(
          document.getElementById('containerTextGroup1').childElementCount
        ).toBe(
      ...
      chartObj.rows = [
        { height: '50%', border: { width: 4, color: 'red' } },
    ...
    it('With Label position Top', (done: Function) => {
      loaded = (args: Object): void => {
        ...
        let svg1: number = +document
          .getElementById('container_Series_0_Point_1_TextShape_0')
          .getAttribute('x');
        let pointLocation1 = (<Points>(<Series>chartObj.series[0]).points[0])
          .symbolLocations[0].x;
    ...
    it('With Label position Bottom', (done: Function) => {
      loaded = (args: Object): void => {
        let svg: number = +document
          .getElementById('container_Series_0_Point_1_TextShape_0')
          .getAttribute('x');
        let point0Location: number =
          (<Points>(<Series>chartObj.series[0]).points[1]).regions[0].x +
          (<Points>(<Series>chartObj.series[0]).points[1]).regions[0].width;
        expect(svg < point0Location).toBe(true);
        let svg1: number = +document
          .getElementById('container_Series_0_Point_0_TextShape_0')
          .getAttribute('x');
        let point0Location1 = (<Points>(<Series>chartObj.series[0]).points[0])
          .regions[0].x;
  ...
  describe('Bar Series Cyliderical shape', () => {
    ...
    it('Bar Series Type with ColumnFacet property as Cylinder', (done: Function) => {
      loaded = (args: Object): void => {
        ...
        expect(
          region1 ===
            'M2.527556818181818,235.42386363636365a2.527556818181818,10.110227272727272 0 1,0 0,20.220454545454544a2.527556818181818,10.110227272727272 0 1,0 0,-20.220454545454544'
        ).toBe(true);
        expect(
          region2 ===
            'M121.64755681818183,235.42386363636365a2.527556818181818,10.110227272727272 0 1,0 0,20.220454545454544a2.527556818181818,10.110227272727272 0 1,0 0,-20.220454545454544'
        ).toBe(true);
        expect(
          region3 ===
            'M2.527556818181818,235.42386363636365a2.527556818181818,10.110227272727272 0 1,0 0,20.220454545454544l119.12 0a2.527556818181818,10.110227272727272 0 1,1 0,-20.220454545454544 z'
        ).toBe(true);
        done();
      };
      chartObj.loaded = loaded;
  ...
  describe('Bar Series Inversed axis', () => {
    ...
    it('With Label position Auto', (done: Function) => {
      loaded = (args: Object): void => {
        dataLabelX = +document
          .getElementById('container_Series_0_Point_1_TextShape_0')
          .getAttribute('x');
        pointX = (<Points>(<Series>chart.series[0]).points[1])
          .symbolLocations[0].x;
        expect(dataLabelX > pointX).toBe(true);
        dataLabelX = +document
          .getElementById('container_Series_0_Point_0_TextShape_0')
          .getAttribute('x');
        pointX = (<Points>(<Series>chart.series[0]).points[0])
          .symbolLocations[0].x;
        expect(dataLabelX < pointX).toBe(true);
        done();
      };
    ...
    it('With Label position Middle', (done: Function) => {
      loaded = (args: Object): void => {
        ...
        let labelHeight: number = +document
          ...
          .getAttribute('width');
        let point: Points = <Points>(<Series>chart.series[0]).points[1];
        expect(labelX + labelHeight / 2).toEqual(
          point.regions[0].x + point.regions[0].width / 2
        );
        done();
      };
      chart.loaded = loaded;
    ...
    it('checking with axis area', (done: Function) => {
      loaded = (args: ILoadedEventArgs): void => {
        expect(
          document.getElementById('container_Series_0_DataLabelCollections')
            .childElementCount
        ).toEqual(11);
        done();
      };
  ...
  describe('checking rotated bar chart', () => {
    ...
    it('checking with datalabel bottom position', (done: Function) => {
      loaded = (args: Object): void => {
        ...
        expect(
          +dataLabel.getAttribute('y') <
            point.symbolLocations[0].y + point.regions[0].height
        ).toBe(true);
        //negative yValues
        dataLabel = document.getElementById(
          'container_Series_0_Point_1_Text_0'
  ...
  describe('Bar Series - Marker', () => {
    ...
    it('with marker and datalabel', (done: Function) => {
      loaded = (args: Object): void => {
        ...
        expect(+datalabel.getAttribute('x') < +series1.getAttribute('cx')).toBe(
          true
        );
        done();
      };
  ...
  describe('Bar series with drag and drop support', () => {
    ...
    it('Bar series drag and drop with marker true', (done: Function) => {
      loaded = (): void => {
        let target: HTMLElement = document.getElementById(
          'bar-drag_Series_0_Point_3_Symbol'
        );
        let chartArea: HTMLElement = document.getElementById(
          'bar-drag_ChartAreaBorder'
        );
        y =
          parseFloat(target.getAttribute('cy')) +
          parseFloat(chartArea.getAttribute('y')) +
          barContainer.offsetTop;
        x =
          parseFloat(target.getAttribute('cx')) +
          parseFloat(chartArea.getAttribute('x')) +
          barContainer.offsetLeft;
        trigger.mousemovetEvent(target, Math.ceil(x), Math.ceil(y));
    ...
    it('Checking Bar series updated direction', (done: Function) => {
      chartObj.loaded = (args: Object): void => {
        let element: Element = document.getElementById(
          'BarContainer_Series_0_Point_0'
        );
        expect(element.getAttribute('d')).toBe(
          'M 0 159.11458333333334 Q 0 159.11458333333334 0 159.11458333333334 L 418.33625 159.11458333333334 Q 418.33625 159.11458333333334 418.33625 159.11458333333334 L 418.33625 169.11458333333334 Q 418.33625 169.11458333333334 418.33625 169.11458333333334 L 0 169.11458333333334 Q 0 169.11458333333334 0 169.11458333333334 L 0 159.11458333333334 Z'
        );
        done();
      };
