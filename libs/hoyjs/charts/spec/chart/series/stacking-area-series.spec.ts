  ...
  describe('Chart StackingArea series', () => {
    ...
    it('Checking with default points', (done: Function) => {
      loaded = (args: Object): void => {
        ...
        expect(series1.getAttribute('fill') == 'rgba(135,206,235,1)').toBe(
          true
        );

        let series2: HTMLElement =
          document.getElementById('container_Series_1');
    ...
    it('Stacking Area - legend click animation', (done: Function) => {
      loaded = (args: Object): void => {
        let legendElement = document.getElementById(
          'Stackingareacontainer_chart_legend_text_0'
        );
