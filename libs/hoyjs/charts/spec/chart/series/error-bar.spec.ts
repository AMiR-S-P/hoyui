...
import {
  ErrorBarSettings,
  ErrorBarCapSettings,
} from '../../../src/chart/series/chart-series';
...
describe('Chart Control', () => {
  ...
  describe('Error Bar for series', () => {
        ...
        series: [
          {
            ...
            fill: 'green',
            errorBar: { visible: false, errorBarCap: { length: 0 } },
            marker: {
              visible: false,
              dataLabel: { visible: false, position: 'Top' },
            },
          },
        ],
        width: '800',
    ...
    it('Checking with errorBar visibilty false', (done: Function) => {
      loaded = (args: Object): void => {
        let svg: HTMLElement = document.getElementById(
          'container_Series__ErrorBarGroup_0_Point_0'
        );
    ...
    it('Checking with errorBarCap visibilty', (done: Function) => {
      loaded = (args: Object): void => {
        let cap: HTMLElement = document.getElementById(
          'container_Series__ErrorBarGroup_0_Point_0'
        );
    ...
    it('Checking with errorBar Fixed type', (done: Function) => {
      loaded = (args: Object): void => {
        let fixElem: HTMLElement = document.getElementById(
          'container_Series__ErrorBarGroup_0_Point_1'
        );
        ...
        let fixElem1: HTMLElement = document.getElementById(
          'container_Series__ErrorBarGroup_0_Point_2'
        );
        ...
        expect(
          fixElem.getAttribute('errorHeight') ==
            fixElem1.getAttribute('errorHeight')
        ).toBe(true);
        done();
      };
      chartObj.loaded = loaded;
    ...
    it('Checking with errorBar percentage type', (done: Function) => {
      loaded = (args: Object): void => {
        let percent: HTMLElement = document.getElementById(
          'container_Series__ErrorBarGroup_0_Point_0'
        );
        ...
        let errorHeight = value1 + value2;
        let percent1: HTMLElement = document.getElementById(
          'container_Series__ErrorBarGroup_0_Point_1'
        );
        ...
        expect(
          percent.getAttribute('errorHeight') ==
            percent1.getAttribute('errorHeight1')
        );
        done();
      };
      chartObj.loaded = loaded;
    ...
    it('Checking with errorBar standard deviation type', (done: Function) => {
      loaded = (args: Object): void => {
        let sdElem: HTMLElement = document.getElementById(
          'container_Series__ErrorBarGroup_0_Point_1'
        );
    ...
    it('Checking with errorBar standard error type', (done: Function) => {
      loaded = (args: Object): void => {
        let sdErrorElem: HTMLElement = document.getElementById(
          'container_Series__ErrorBarGroup_0_Point_0'
        );
    ...
    it('Checking with errorBar custom type', (done: Function) => {
      loaded = (args: Object): void => {
        let customElem: HTMLElement = document.getElementById(
          'container_Series__ErrorBarGroup_0_Point_0'
        );
    ...
    it('Checking with errorBar vertical mode', (done: Function) => {
      loaded = (args: Object): void => {
        ...
        let value21 = parseInt(heightElement[2]) - parseInt(heightElement[5]);
        expect(
          fixElem.getAttribute('value1') == fixElem1.getAttribute('value21')
        ).toBe(true);
        done();
      };
      chartObj.loaded = loaded;
    ...
    it('Checking with errorBar both direction', (done: Function) => {
      loaded = (args: Object): void => {
        ...
        expect(
          fixElem.getAttribute('errorHeight') ==
            fixElem1.getAttribute('errorHeight1')
        ).toBe(true);
        done();
      };
      chartObj.loaded = loaded;
    ...
    it('Checking with marker visible', (done: Function) => {
      loaded = (args: Object): void => {
        ...
        let fixElement: HTMLElement = document.getElementById(
          'container_Series__ErrorBarGroup_0_Point_0'
        );
    ...
    it('With Label position Auto', (done: Function) => {
      loaded = (args: Object): void => {
        let dataLabelY = +document
          .getElementById('container_Series_0_Point_1_Text_0')
          .getAttribute('y');
        let pointY = (<Points>(<Series>chartObj.series[0]).points[2])
          .symbolLocations[0].y;
    ...
    it('With Label position Top', (done: Function) => {
      loaded = (args: Object): void => {
        ...
        dataLabelY = +document
          ...
          .getAttribute('y');
        pointY = (<Points>(<Series>chartObj.series[0]).points[5])
          .symbolLocations[0].y;
        expect(dataLabelY < pointY).toBe(true);
        done();
      };
    ...
    it('Checking with errorBar visibilty in polarseries', (done: Function) => {
      loaded = (args: Object): void => {
        let errorElem: HTMLElement = document.getElementById(
          'container_Series__ErrorBarGroup_0_Point_0'
        );
    ...
    beforeAll(() => {
      ...
      chartObj = new Chart({
        ...
        tooltip: {
          ...
          textStyle: { size: '12px' },
          format: '${series.name} : ${point.x} <br/> : ${point.y}',
        },
        legendSettings: { visible: false },
        title: 'Chart TS Title',
      });
  ...
  describe('Chart StackingColumn series', () => {
    ...
    it('Checking with errorBar  fixed type horizontal mode', (done: Function) => {
      loaded = (args: Object): void => {
        ...
        let svg1: HTMLElement = document.getElementById(
          'container_Series__ErrorBarGroup_1_Point_1'
        );
    ...
    it('Checking with custom type vertical mode', (done: Function) => {
      loaded = (args: Object): void => {
        let cusErrorElem: HTMLElement = document.getElementById(
          'container_Series__ErrorBarGroup_0_Point_0'
        );
    ...
    it('Checking pinch zooming with label', (done: Function) => {
      loaded = (args: Object): void => {
        ...
        let content: string;
        let areaElement: HTMLElement = document.getElementById(
          'container_ChartAreaBorder'
        );
