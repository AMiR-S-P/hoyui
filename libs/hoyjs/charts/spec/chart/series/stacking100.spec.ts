      ...
      loaded = (args: Arg): void => {
        ...
        expect(
          series1.points[1].regions[0].y +
            series1.points[1].regions[0].height ===
            parseFloat(chartArea.getAttribute('y'))
        );
        expect(
          series2.points[1].regions[0].y +
            series2.points[1].regions[0].height ===
            parseFloat(chartArea.getAttribute('y'))
        );
        done();
      };
  ...
  describe('Chart StackingArea100 series', () => {
    ...
    it('checking with stackingcolumn series', (done: Function) => {
      loaded = (args: Arg): void => {
        ...
        expect(Math.round(series1.stackedValues.endValues[0]) === 100).toBe(
          true
        );
        done();
      };
  ...
  describe('chart stacking percent series with user interaction', () => {
    ...
    it('Default Crosshair for stackingcolumn100', (done: Function) => {
      loaded = (args: Object): void => {
        ...
        let crosshair: Element = <Element>(
          document.getElementById('container_svg').lastChild
        );
        ...
        expect(
          element1.textContent == '4502.776' ||
            element1.textContent == '4502.776'
        ).toBe(true);
        element1 = <HTMLElement>crosshair.childNodes[2].childNodes[3];
        expect(
          element1.textContent == '49.964' || element1.textContent == '49.822'
        ).toBe(true);
    ...
    it('Default Crosshair for stackingbar100', (done: Function) => {
      loaded = (args: Object): void => {
        ...
        element1 = <HTMLElement>crosshair.childNodes[2].childNodes[1];
        expect(
          element1.textContent == '4497.153' ||
            element1.textContent == '4485.724'
        ).toBe(true);
        element1 = <HTMLElement>crosshair.childNodes[2].childNodes[3];
        expect(
          element1.textContent == '50.035' || element1.textContent == '50.104'
        ).toBe(true);
    ...
    it('Default Crosshair for stackingarea100', (done: Function) => {
      loaded = (args: Object): void => {
        ...
        element1 = <HTMLElement>crosshair.childNodes[2].childNodes[1];
        expect(
          element1.textContent == '4502.429' ||
            element1.textContent == '4502.429'
        ).toBe(true);
        element1 = <HTMLElement>crosshair.childNodes[2].childNodes[3];
        expect(
          element1.textContent == '49.822' || element1.textContent == '49.818'
        ).toBe(true);
    ...
    it('Cluster selection for stackingarea100 series', (done: Function) => {
      loaded = () => {
        ...
        let element1 = document.getElementById(
          'container_Series_1_Point_4_Symbol'
        );
        trigger.clickEvent(element);
        let selected = document.getElementsByClassName(
          'container_ej2_chart_selection_series_0'
