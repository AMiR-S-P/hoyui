...
describe('Chart Control', () => {
  ...
  describe('Chart Histogram series', () => {
    ...
    let values: number[] = [
      23, 34, 23, 45, 56, 67, 12, 12, 43, 34, 23, 34, 23, 45, 56, 67, 12, 12,
      43, 34, 23, 34, 23, 45, 56, 67, 12, 12, 43, 34, 23, 34, 23, 45, 56, 67,
      12, 12, 43, 34, 23, 34, 23, 45, 56, 67, 12, 12, 43, 34,
    ];
    ...
    it('Checking with X-axis inversed', (done: Function) => {
      loaded = (args: Object): void => {
        let point1: HTMLElement = document.getElementById(
          'container_Series_0_Point_0'
        );
    ...
    it('Checking with animation', (done: Function) => {
      animationComplete = (args: IAnimationCompleteEventArgs): void => {
        ...
        let elem: HTMLElement = document.getElementById(
          'container_Series_' + args.series.index + '_NDLine'
        );
  ...
  describe('Histogram Series with data label', () => {
    ...
    beforeAll(() => {
      ...
      chartObj = new Chart({
        ...
        width: '800',
        title: 'Hisogram Age collections',
        loaded: loaded,
        legendSettings: { visible: false },
      });
      chartObj.appendTo('#container');
    ...
    it('Color saturation with data label fill color', (done: Function) => {
      loaded = (args: ILoadedEventArgs): void => {
        let element: HTMLElement = document.getElementById(
          'container_Series_0_Point_1_TextShape_0'
        );
  ...
  describe('Histogram Series Checking animation on data chages.', () => {
    ...
    let chartData: Object[] = [];
    let points: number[] = [
      5.25, 7.75, 0, 8.275, 9.75, 7.75, 8.275, 6.25, 5.75, 5.25, 23.0, 26.5,
      27.75, 25.025, 26.5, 26.5, 28.025, 29.25, 26.75, 27.25, 26.25, 25.25,
      34.5, 25.625, 25.5, 26.625, 36.275, 36.25, 26.875, 40.0, 43.0, 46.5,
      47.75, 45.025, 56.5, 56.5, 58.025, 59.25, 56.75, 57.25, 46.25, 55.25,
      44.5, 45.525, 55.5, 46.625, 46.275, 56.25, 46.875, 43.0, 46.25, 55.25,
      44.5, 45.425, 55.5, 56.625, 46.275, 56.25, 46.875, 43.0, 46.25, 55.25,
      44.5, 45.425, 55.5, 46.625, 56.275, 46.25, 56.875, 41.0, 63.0, 66.5,
      67.75, 65.025, 66.5, 76.5, 78.025, 79.25, 76.75, 77.25, 66.25, 75.25,
      74.5, 65.625, 75.5, 76.625, 76.275, 66.25, 66.875, 80.0, 85.25, 87.75,
    ...
    it('Checking Histrogram series x axis minimum', (done: Function) => {
      loaded = (args: Object): void => {
        ...
        expect(seriesElement.getAttribute('d')).toBe(
          'M 171.82083333333333 63.09000000000002 Q 171.82083333333333 63.09000000000002 171.82083333333333 63.09000000000002 L 284.8458333333333 63.09000000000002 Q 284.8458333333333 63.09000000000002 284.8458333333333 63.09000000000002 L 284.8458333333333 350.5 Q 284.8458333333333 350.5 284.8458333333333 350.5 L 171.82083333333333 350.5 Q 171.82083333333333 350.5 171.82083333333333 350.5 L 171.82083333333333 63.09000000000002 Z'
        );
        done();
      };
      chartObj.loaded = loaded;
    ...
    it('Histogram - Checking addPoint', (done: Function) => {
      loaded = (args: Object): void => {
        ...
        expect(seriesElement.getAttribute('d')).toBe(
          'M 171.82083333333333 56.08000000000001 Q 171.82083333333333 56.08000000000001 171.82083333333333 56.08000000000001 L 284.8458333333333 56.08000000000001 Q 284.8458333333333 56.08000000000001 284.8458333333333 56.08000000000001 L 284.8458333333333 350.5 Q 284.8458333333333 350.5 284.8458333333333 350.5 L 171.82083333333333 350.5 Q 171.82083333333333 350.5 171.82083333333333 350.5 L 171.82083333333333 56.08000000000001 Z'
        );
        done();
      };
      chartObj.loaded = loaded;
