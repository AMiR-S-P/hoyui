...
import {
  ...
  chartMouseUp,
  load,
} from '../../../src/common/model/constants';
import {
  tool1,
  tool2,
  datetimeData,
...
describe('Chart Control', () => {
  ...
  describe('Polar-Radar series', () => {
        ...
        series: [
          {
            ...
            yName: 'y',
            type: 'Polar',
            drawType: 'Line', //name: 'Polar-Radar'
          },
        ],
    ...
    it('touch Tooltip', (done: Function) => {
      loaded = (args: Arg): void => {
        ...
        let target: Element = getElement(
          'chartContainer_Series_0_Point_1_Symbol'
        );
        ...
        chartObj.mouseEnd(
          trigger.onTouchEnd(target, 0, 0, 150, 150, x, y) as PointerEvent
        );

        let tooltip: HTMLElement = document.getElementById(
          'chartContainer_tooltip'
        );
    ...
    it('default Tooltip', (done: Function) => {
      ...
      let target: HTMLElement = document.getElementById(
        'chartContainer_Series_0_Point_2_Symbol'
      );
      let series: Series = <Series>chartObj.series[0];
      ...
      target = document.getElementById(
        'chartContainer_Series_0_Point_3_Symbol'
      );
    ...
    it('Shared Tooltip', (done: Function) => {
      loaded = (args: Arg): void => {
        let rect: ClientRect = args.chart.element.getBoundingClientRect();
        let target: HTMLElement = document.getElementById(
          'chartContainer_Series_0_Point_0_Symbol'
        );
        let series: Series = <Series>chartObj.series[0];
    ...
    it('Checking line series with negative points', (done: Function) => {
      loaded = (args: Object): void => {
        ...
        let Positivelabel: HTMLElement = document.getElementById(
          'chartContainer1_AxisLabel_3'
        );
        expect(ele.getAttribute('cy') > Positivelabel.getAttribute('y')).toBe(
          true
        );
        done();
      };
    ...
    it('Checking scatter series with negative point', (done: Function) => {
      loaded = (args: Object): void => {
        ...
        expect(ele.getAttribute('y') > Positivelabel.getAttribute('y')).toBe(
          true
        );
        done();
      };
    ...
    it('default Tooltip for column', (done: Function) => {
      loaded = (args: Arg): void => {
        let target: HTMLElement = document.getElementById(
          'chartContainer_Series_0_Point_6'
        );
        let rect: ClientRect = args.chart.element.getBoundingClientRect();
        let series: Series = <Series>chartObj.series[0];
    ...
    it('Checking datalabel with axis interval', (done: Function) => {
      loaded = (args: Object): void => {
        ele = document.getElementById('chartContainer_Series_0_Point_1_Text_0');
        expect(
          ele.getAttribute('x') === '464.70201785076335' ||
            ele.getAttribute('x') === '575.34846446017' ||
            ele.getAttribute('x') === '696.9949110695768' ||
            ele.getAttribute('x') === '458.70201785076335' ||
            ele.getAttribute('x') === '711.84846446017' ||
            ele.getAttribute('x') === '464.20201785076335'
        ).toBe(true);
        expect(
          ele.getAttribute('y') === '154.67298214923667' ||
            ele.getAttribute('y') === '155.02653553982995' ||
            ele.getAttribute('y') === '155.3800889304232' ||
            ele.getAttribute('y') === '153.92298214923667'
        ).toBe(true);
        done();
      };
      chartObj.loaded = loaded;
    ...
    it('default Tooltip for rangecolumn', (done: Function) => {
      loaded = (args: Arg): void => {
        let target: HTMLElement = document.getElementById(
          'chartContainer_Series_0_Point_4'
        );
        let series: Series = <Series>chartObj.series[0];
    ...
    it('default Tooltip for stackingcolumn with y axis inversed', (done: Function) => {
      loaded = (args: Arg): void => {
        let target: HTMLElement = document.getElementById(
          'chartContainer_Series_0_Point_2'
        );
        let rect: ClientRect = args.chart.element.getBoundingClientRect();
        let series: Series = <Series>chartObj.series[0];
    ...
    it('Checking with spline area draw type', (done: Function) => {
      loaded = (args: Arg): void => {
        expect(
          document
            .getElementById('chartContainer_chart_legend_shape_0')
            .getAttribute('d')
            .indexOf('Q') > 0
        ).toBe(true);
        expect(
          document
            .getElementById('chartContainer_chart_legend_shape_1')
            .getAttribute('d')
            .indexOf('Q') > 0
        ).toBe(true);
        done();
  ...
  describe('Customer issue', () => {
    ...
    beforeAll((): void => {
      ...
      chartObj = new Chart({
        ...
        tooltip: { enable: true },
        title: 'Average Sales (Inversed Polar)',
      });
    ...
    it('Checking with ColumnSeries OnTicks label', () => {
      let point: Element = document.getElementById(
        'customerIssue_Series_0_Point_1'
      );
      expect(point.getAttribute('d')).toBe(
        'M 290.375 225.125 A 94.125 94.125 0 0 1 317.9435076644237 158.56864077727528 L 273.5725127740395 114.19773462879215 A 156.875 156.875 1 0 0 227.625 225.12500000000003 Z'
      );
    });
    it('checking columnSeries with between ticks', (done: Function) => {
      chartObj.loaded = () => {
        ...
        expect(point.getAttribute('d')).toBe(
          'M 317.94357422081623 291.68142577918377 A 94.125 94.125 0 0 1 290.37500000004707 225.12509412500003 L 227.62500000007844 225.12515687500004 A 156.875 156.875 1 0 0 273.5726237013604 336.0523762986396 Z'
        );
        done();
      };
      chartObj.primaryXAxis.labelPlacement = 'BetweenTicks';
  ...
  describe('Customer issue: Radar chart with X axis label placement is OnTicks', () => {
    ...
    it('Checking with OnTicks label', () => {
      ...
      expect(point.getAttribute('d')).toBe(
        'M 274.7692777451016 210.5580357142857 L 299.9999708660714 195.991071428586 L 300 225.125 L 300 225.125 Z'
      );
    });
    it('checking with between ticks', (done: Function) => {
      chartObj.loaded = () => {
        ...
        expect(point.getAttribute('d')).toBe(
          'M 300 195.99107142857142 L 325.2307076879215 210.55801048357074 L 300 225.125 L 300 225.125 Z'
        );
        done();
      };
      chartObj.primaryXAxis.labelPlacement = 'BetweenTicks';
  ...
  describe('Polar Radar Smart Datalabel', () => {
    ...
    it('Polar Chart: datalabel count check with X axis label outside', (done: Function) => {
      chartObj.loaded = (args: Arg): void => {
        ...
        expect(
          datalabel.childElementCount === 28 ||
            datalabel.childElementCount === 31 ||
            datalabel.childElementCount === 32
        ).toBe(true);
        done();
      };
      chartObj.refresh();
    ...
    it('Polar Chart: datalabel count check with X axis label inside', (done: Function) => {
      chartObj.loaded = (args: Arg): void => {
        let datalabel: Element = getElement('containerTextGroup0');
        expect(
          datalabel.childElementCount === 16 ||
            datalabel.childElementCount === 19
        ).toBe(true);
        done();
      };
    ...
    it('Polar Chart: datalabel count check with Y axis label inside', (done: Function) => {
      chartObj.loaded = (args: Arg): void => {
        let datalabel: Element = getElement('containerTextGroup0');
        expect(
          datalabel.childElementCount === 14 ||
            datalabel.childElementCount === 16 ||
            datalabel.childElementCount === 17
        ).toBe(true);
        done();
      };
    ...
    it('Radar Chart: datalabel count check with X axis label outside', (done: Function) => {
      chartObj.loaded = (args: Arg): void => {
        let datalabel: Element = getElement('containerTextGroup0');
        expect(
          datalabel.childElementCount === 36 ||
            datalabel.childElementCount === 28 ||
            datalabel.childElementCount === 32
        ).toBe(true);
        done();
      ...
      chartObj.series[0].type = 'Radar';
      chartObj.primaryXAxis.labelPosition =
