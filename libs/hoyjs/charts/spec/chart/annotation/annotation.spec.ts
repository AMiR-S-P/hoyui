...
describe('Chart Control', () => {
  ...
  describe('Annotation for Chart', () => {
    ...
    beforeAll(() => {
      ...
      template.innerHTML =
        "<img src='../base/spec/img/img1.jpg' style='border-radius: 30px;width: 30px;height: 30px;margin: 0 auto;' />";
    ...
    it('Checking annotaiton as default', (done: Function) => {
      chartObj.loaded = (args: Object): void => {
        ...
        expect(element.children[0].children[0].id).toBe(
          'container_Annotation_0'
        );
        done();
      };
    ...
    it('Checking annotaiton region as series', (done: Function) => {
      chartObj.loaded = (args: Object): void => {
        element = getElement('container_Annotation_0');
        expect(
          (element as HTMLElement).style.left == '55.5px' ||
            (element as HTMLElement).style.left == '50.5px'
        ).toBe(true);
        expect(
          (element as HTMLElement).style.top == '26.25px' ||
            (element as HTMLElement).style.top == '28.25px'
        ).toBe(true);
        done();
      };
    ...
    it('Checking annotaiton region as series with near and top', (done: Function) => {
      chartObj.loaded = (args: Object): void => {
        element = getElement('container_Annotation_0');
        expect(
          (element as HTMLElement).style.left == '40.5px' ||
            (element as HTMLElement).style.left == '35.5px'
        ).toBe(true);
        expect(
          (element as HTMLElement).style.top == '9.25px' ||
            (element as HTMLElement).style.top == '11.25px'
        ).toBe(true);
        done();
      };
    ...
    it('Checking annotaiton region as series with near and bottom', (done: Function) => {
      chartObj.loaded = (args: Object): void => {
        ...
        expect(
          (element as HTMLElement).style.top == '43.25px' ||
            (element as HTMLElement).style.top == '45.25px'
        ).toBe(true);
        done();
      };
      chartObj.annotations[0].horizontalAlignment = 'Near';
    ...
    it('Checking annotaiton region as series with far and top', (done: Function) => {
      chartObj.loaded = (args: Object): void => {
        element = getElement('container_Annotation_0');
        expect(
          (element as HTMLElement).style.left == '70.5px' ||
            (element as HTMLElement).style.left == '65.5px'
        ).toBe(true);
        expect(
          (element as HTMLElement).style.top == '9.25px' ||
            (element as HTMLElement).style.top == '11.25px'
    ...
    it('Checking annotaiton unit as point with numeric value type - negative - inverted axis', (done: Function) => {
      chartObj.loaded = (args: Object): void => {
        element = getElement('container_Annotation_0');
        expect(
          (element as HTMLElement).style.left == '100.469px' ||
            (element as HTMLElement).style.left == '95.7812px'
        ).toBe(true);
        expect(
          (element as HTMLElement).style.top == '135.016px' ||
            (element as HTMLElement).style.top == '135.703px'
        ).toBe(true);
        done();
      };
    ...
    it('Checking annotaiton unit as point with numeric value type - positive - inverted axis', (done: Function) => {
      chartObj.loaded = (args: Object): void => {
        element = getElement('container_Annotation_0');
        expect(
          (element as HTMLElement).style.left == '550.156px' ||
            (element as HTMLElement).style.left == '548.594px'
        ).toBe(true);
        done();
      };
      chartObj.annotations[0].y = 50;
    ...
    it('Checking annotaiton unit as point with numeric value type - negative', (done: Function) => {
      chartObj.loaded = (args: Object): void => {
        element = getElement('container_Annotation_0');
        expect(
          (element as HTMLElement).style.left == '567.429px' ||
            (element as HTMLElement).style.left == '566.286px'
        ).toBe(true);
        expect(
          (element as HTMLElement).style.top == '354.609px' ||
            (element as HTMLElement).style.top == '350.984px'
        ).toBe(true);
        done();
      };
    ...
    it('Checking annotaiton unit as point with numeric value type - positive', (done: Function) => {
      chartObj.loaded = (args: Object): void => {
        ...
        expect(
          (element as HTMLElement).style.top == '135.703px' ||
            (element as HTMLElement).style.top == '135.828px'
        ).toBe(true);
        done();
      };
      chartObj.annotations[0].y = 50;
    ...
    it('Checking annotaiton unit as point with date time value type', (done: Function) => {
      chartObj.loaded = (args: Object): void => {
        element = getElement('container_Annotation_0');
        expect(
          (element as HTMLElement).style.left == '481.174px' ||
            (element as HTMLElement).style.left == '479.556px'
        ).toBe(true);
        expect(
          (element as HTMLElement).style.top == '131.325px' ||
            (element as HTMLElement).style.top == '131.525px'
        ).toBe(true);
        done();
      };
    ...
    it('Checking annotaiton unit as point with category value type', (done: Function) => {
      chartObj.loaded = (args: Object): void => {
        element = getElement('container_Annotation_0');
        expect(
          (element as HTMLElement).style.left == '546.094px' ||
            (element as HTMLElement).style.left == '544.844px'
        ).toBe(true);
        expect(
          (element as HTMLElement).style.top == '70.0312px' ||
            (element as HTMLElement).style.top == '71.2813px'
        ).toBe(true);
        done();
      };
  ...
  describe('Annotation for Chart', () => {
    ...
    it('Checking annotaiton in series region', (done: Function) => {
      ...
      chartObj.loaded = (args: Object): void => {
        ...
        element = getElement('container_Annotation_0');
        expect(
          (element as HTMLElement).style.left == '367px' ||
            (element as HTMLElement).style.left == '372.5px'
        ).toBe(true);

        expect(
          (element as HTMLElement).style.top == '208.125px' ||
            (element as HTMLElement).style.top == '207.625px'
        ).toBe(true);
        element = getElement('container_Annotation_1');
        expect(
          (element as HTMLElement).style.left == '342.891px' ||
            (element as HTMLElement).style.left == '348.391px'
        ).toBe(true);

        expect(
          (element as HTMLElement).style.top == '216.125px' ||
            (element as HTMLElement).style.top == '215.625px'
        ).toBe(true);
        done();
      };
      chartObj.annotations[0].region = 'Series';
    ...
    it('Checking annotaiton in point units', (done: Function) => {
      ...
      chartObj.loaded = (args: Object): void => {
        element = getElement('container_Annotation_0');
        expect(
          (element as HTMLElement).style.left == '38.7708px' ||
            (element as HTMLElement).style.left == '38.0417px'
        ).toBe(true);

        expect(
          (element as HTMLElement).style.top == '333.225px' ||
            (element as HTMLElement).style.top == '333.125px'
        ).toBe(true);
        element = getElement('container_Annotation_1');
        expect(
          (element as HTMLElement).style.left == '14.6615px' ||
            (element as HTMLElement).style.left == '13.9323px'
        ).toBe(true);

        expect(
          (element as HTMLElement).style.top == '341.225px' ||
            (element as HTMLElement).style.top == '341.125px'
        ).toBe(true);
        done();
      };
      chartObj.annotations[0].coordinateUnits = 'Point';
    ...
    it('Checking annotaiton in point units with xAxis', (done: Function) => {
      ...
      chartObj.loaded = (args: Object): void => {
        element = getElement('container_Annotation_0');
        expect(
          (element as HTMLElement).style.left == '152.938px' ||
            (element as HTMLElement).style.left == '154.375px'
        ).toBe(true);

        expect(
          (element as HTMLElement).style.top == '129.938px' ||
            (element as HTMLElement).style.top == '129.188px'
        ).toBe(true);
        element = getElement('container_Annotation_1');
        expect(
          (element as HTMLElement).style.left == '471.328px' ||
            (element as HTMLElement).style.left == '479.266px'
        ).toBe(true);

        expect(
          (element as HTMLElement).style.top == '139.688px' ||
            (element as HTMLElement).style.top == '137.938px'
        ).toBe(true);
        done();
      };
    ...
    it('Checking annotaiton in point units with yAxis', (done: Function) => {
      ...
      chartObj.loaded = (args: Object): void => {
        element = getElement('container_Annotation_0');
        expect(
          (element as HTMLElement).style.left == '324.188px' ||
            (element as HTMLElement).style.left == '328.875px'
        ).toBe(true);

        expect(
          (element as HTMLElement).style.top == '331.725px' ||
            (element as HTMLElement).style.top == '333.225px'
        ).toBe(true);
        element = getElement('container_Annotation_1');
        expect(
          (element as HTMLElement).style.left == '528.411px' ||
            (element as HTMLElement).style.left == '537.432px'
        ).toBe(true);

        expect(
          (element as HTMLElement).style.top == '293.563px' ||
            (element as HTMLElement).style.top == '294.312px'
        ).toBe(true);
        done();
      };
  ...
  describe('Annotation for Chart - logarithmic axis', () => {
    ...
    it('Checking annotation within x axis', (done: Function) => {
      chartObj.loaded = (args: Object): void => {
        element = getElement('container_Annotation_0');
        expect(
          (element as HTMLElement).style.left == '400.75px' ||
            (element as HTMLElement).style.left == '403.25px'
        ).toBe(true);

        expect(
          (element as HTMLElement).style.top == '214.24px' ||
            (element as HTMLElement).style.top == '216.437px'
        ).toBe(true);
        done();
      };
    ...
    it('Checking annotation within y axis', (done: Function) => {
      chartObj.loaded = (args: Object): void => {
        ...
        expect(
          (element as HTMLElement).style.top == '105.813px' ||
            (element as HTMLElement).style.top == '105.562px'
        ).toBe(true);
        done();
      };
    ...
    it('Checking annotation within y axis - inverted axis', (done: Function) => {
      chartObj.loaded = (args: Object): void => {
        ...
        expect(
          left == '566.875px' || left == '573.625px' || left == '607.7px'
        ).toBe(true);
