...
describe('Chart control checking', () => {
  ...
  describe('Stripline checking', () => {
    ...
    it('Stripline visible false', (done: Function) => {
      loaded = () => {
        let element: Element = document.getElementById(
          stripLineId + '_Behind_rect_' + 'primaryXAxis' + '_0'
        );
        expect(element).toBe(null);
        element = document.getElementById(
          stripLineId + '_Over_rect_' + 'primaryXAxis' + '_0'
        );
        expect(element).toBe(null);
        done();
      };
    ...
    it(' XAxis Stripline', (done: Function) => {
      loaded = () => {
        stripLineElement = document.getElementById(
          stripLineId + '_Over_rect_' + 'primaryXAxis' + '_0'
        );
    ...
    it(' YAxis Stripline', (done: Function) => {
      loaded = () => {
        stripLineElement = document.getElementById(
          stripLineId + '_Over_rect_' + 'primaryYAxis' + '_0'
        );
        expect(stripLineElement).not.toEqual(null);
        stripLineElement = document.getElementById(
          stripLineId + '_Behind_rect_' + 'primaryYAxis' + '_0'
        );
        expect(stripLineElement).not.toEqual(null);
        done();
      };
    ...
    it('XAxis Size', (done: Function) => {
      loaded = () => {
        ...
        expect(
          direction ===
            'M 207.58333333333331 10.25 L 207.58333333333331 309.5' ||
            direction === 'M 206.8611111111111 10.25 L 206.8611111111111 310.5'
        ).toBe(true);
        stripLineElement = document.getElementById(
          stripLineId + '_Behind_rect_' + 'primaryXAxis_' + '1'
        );
        direction = stripLineElement.getAttribute('d');
        expect(
          direction === 'M 472.3333333333333 10.25 L 472.3333333333333 309.5' ||
            direction === 'M 472.1111111111111 10.25 L 472.1111111111111 310.5'
        ).toBe(true);
        done();
      };
      chart.primaryYAxis.stripLines = [];
      chart.primaryXAxis.stripLines = [
        { start: 1, color: '#663AB6', size: 3 },
    ...
    it('YAxis Size', (done: Function) => {
      loaded = () => {
        stripLineElement = document.getElementById(
          stripLineId + '_Behind_rect_' + 'primaryYAxis_' + '0'
        );
        let direction: string = stripLineElement.getAttribute('d');
        expect(
          direction === 'M 60.5 202.625 L 590 202.625' ||
            direction === 'M 59.5 203.26785714285714 L 590 203.26785714285714'
        ).toBe(true);
        stripLineElement = document.getElementById(
          stripLineId + '_Behind_rect_' + 'primaryYAxis_' + '1'
        );
        direction = stripLineElement.getAttribute('d');
        expect(
          direction === 'M 60.5 127.81249999999999 L 590 127.81249999999999' ||
            direction === 'M 59.5 128.20535714285714 L 590 128.20535714285714'
        ).toBe(true);
        done();
      };
      chart.primaryXAxis.stripLines = [];
      chart.primaryYAxis.stripLines = [
        { start: 10, end: 50, color: '#663AB6', size: 60 },
    ...
    it('Stripline Dash Array Present', (done: Function) => {
      loaded = () => {
        ...
        let dasharray: string =
          stripLineElement.getAttribute('stroke-dasharray');
    ...
    it('Basic Dash Array Requirement Checking', (done: Function) => {
      ...
      chart.primaryXAxis.stripLines = [];
      chart.primaryYAxis.stripLines = [
        { start: 0, end: 5, color: '#663AB6', dashArray: '10,2' },
      ];
      chart.loaded = loaded;
      chart.refresh();
    });
    it('Color, Opacity, Border Color and Dash Array', (done: Function) => {
      loaded = () => {
        stripLineElement = document.getElementById(
          stripLineId + '_Behind_rect_' + 'primaryXAxis_' + '0'
        );
        ...
        expect(stripLineElement.getAttribute('stroke-dasharray')).toEqual(
          '10,2'
        );
        done();
      };
    ...
    it('Inversed axis stripline', (done: Function) => {
      loaded = () => {
        ...
        expect(
          temp === 'M 384.08333333333337 10.25 L 384.08333333333337 309.5' ||
            temp === 'M 383.69444444444446 10.25 L 383.69444444444446 310.5'
        ).toBe(true);
        stripLineElement = document.getElementById(
          stripLineId + '_Behind_rect_' + 'primaryYAxis_' + '0'
        );
        ...
        expect(
          temp === 'M 60.5 138.50000000000003 L 590 138.50000000000003' ||
            temp === 'M 59.5 138.92857142857144 L 590 138.92857142857144'
        ).toBe(true);
        done();
      };
  ...
  describe('Stripline Size Type checking', () => {
    ...
    it('Pixel Type', (done: Function) => {
      loaded = () => {
        stripLineElement = document.getElementById(
          stripLineId + '_Behind_path_' + 'primaryXAxis_' + '0'
        );
    ...
    it('Years Type', (done: Function) => {
      loaded = () => {
        ...
        expect(
          d === 'M 134.16191236878137 43.5 L 134.16191236878137 380.5' ||
            d === 'M 93.84744408945687 44.5 L 93.84744408945687 380.5'
        ).toBe(true);
        done();
      };
      chart.primaryXAxis = {
        ...
        isInversed: false,
        stripLines: [
          { start: new Date(2005, 0, 1), size: 1, sizeType: 'Years' },
          {
    ...
    it('Months Type', (done: Function) => {
      loaded = () => {
        ...
        expect(
          direction === 'M 41.13429940666362 43.5 L 41.13429940666362 380.5' ||
            direction === 'M 38.62539936102237 44.5 L 38.62539936102237 380.5'
        ).toBe(true);
        done();
      };
      (chart.primaryXAxis = {
        ...
        intervalType: 'Months',
        stripLines: [
          { start: new Date(2005, 0, 1), size: 1, sizeType: 'Months' },
          {
            start: new Date(2005, 0, 1),
    ...
    it('Days Type', (done: Function) => {
      loaded = () => {
        ...
        const direction: string = stripLineElement.getAttribute('d');
        expect(
          direction === 'M 40.85577361935189 43.5 L 40.85577361935189 380.5' ||
            direction === 'M 38.460063897763575 44.5 L 38.460063897763575 380.5'
        ).toBe(true);
        done();
      };
      (chart.primaryXAxis = {
        ...
        intervalType: 'Days',
        stripLines: [
          { start: new Date(2005, 0, 1), size: 30, sizeType: 'Days' },
          {
            start: new Date(2005, 0, 1),
            end: new Date(2005, 0, 30),
            sizeType: 'Days',
          },
        ],
      }),
    ...
    it('Hours Type', (done: Function) => {
      ...
      (chart.primaryXAxis = {
        ...
        intervalType: 'Hours',
        stripLines: [
          { start: new Date(2005, 0, 1), size: 720, sizeType: 'Hours' },
          {
            start: new Date(2005, 0, 1),
            end: new Date(2005, 0, 2, 20),
            sizeType: 'Hours',
          },
        ],
      }),
    ...
    it('Minutes Type', (done: Function) => {
      ...
      (chart.primaryXAxis = {
        ...
        stripLines: [
          { start: new Date(2005, 0, 1), size: 43200, sizeType: 'Minutes' },
          {
            start: new Date(2005, 0, 1),
            end: new Date(2005, 0, 1, 1, 60),
            sizeType: 'Minutes',
          },
        ],
      }),
    ...
    it('Seconds Type', (done: Function) => {
      ...
      (chart.primaryXAxis = {
        ...
        stripLines: [
          { start: new Date(2005, 0, 1), size: 2592000, sizeType: 'Seconds' },
          {
            start: new Date(2005, 0, 1),
            end: new Date(2005, 0, 1, 5, 59, 44),
            sizeType: 'Seconds',
          },
        ],
      }),
    ...
    it('sizeType Auto checking', (done: Function) => {
      loaded = () => {
        ...
        expect(
          direction ===
            'M 117.17183934276585 43.5 L 117.17183934276585 380.5' ||
            direction === 'M 134.02396166134184 44.5 L 134.02396166134184 380.5'
        ).toBe(true);
        done();
      };
  ...
  describe('Stripline recurrence checking', () => {
    ...
    it('Horizontal Recurrence for Numeric Axis', (done: Function) => {
      loaded = () => {
        ...
        let direction: string = stripLineElement.getAttribute('d');
        expect(
          direction === 'M 64.64473684210526 43.25 L 64.64473684210526 381.5' ||
            direction ===
              'M 51.618421052631575 43.25 L 51.618421052631575 381.5'
        ).toBe(true);
        stripLineElement = document.getElementById(
          stripLineId + '_Behind_rect_' + 'primaryXAxis_' + '1'
        );
        direction = stripLineElement.getAttribute('d');
        expect(
          direction === 'M 193.2236842105263 43.25 L 193.2236842105263 381.5' ||
            direction === 'M 128.0921052631579 43.25 L 128.0921052631579 381.5'
        ).toBe(true);
        stripLineElement = document.getElementById(
          stripLineId + '_Behind_rect_' + 'primaryXAxis_' + '2'
        );
        direction = stripLineElement.getAttribute('d');
        expect(
          direction ===
            'M 321.80263157894734 43.25 L 321.80263157894734 381.5' ||
            direction ===
              'M 204.56578947368422 43.25 L 204.56578947368422 381.5'
        ).toBe(true);
        done();
      };
      chart.primaryXAxis = {
    ...
    it('Horizontal Recurrence for Category Axis', (done: Function) => {
      loaded = () => {
        ...
        let direction: string = stripLineElement.getAttribute('d');
        expect(
          direction === 'M 83.39583333333333 43.25 L 83.39583333333333 381.5' ||
            direction === 'M 62.77083333333333 43.25 L 62.77083333333333 381.5'
        ).toBe(true);
        stripLineElement = document.getElementById(
          stripLineId + '_Behind_rect_' + 'primaryXAxis_' + '1'
        );
        ...
        expect(
          direction ===
            'M 286.97916666666663 43.25 L 286.97916666666663 381.5' ||
            direction ===
              'M 183.85416666666666 43.25 L 183.85416666666666 381.5'
        ).toBe(true);
        stripLineElement = document.getElementById(
          stripLineId + '_Behind_rect_' + 'primaryXAxis_' + '2'
        );
        direction = stripLineElement.getAttribute('d');
        expect(
          direction === 'M 490.5625 43.25 L 490.5625 381.5' ||
            direction === 'M 304.9375 43.25 L 304.9375 381.5'
        ).toBe(true);
        done();
      };
      chart.primaryXAxis = {
    ...
    it('Recurrence checking with size and end value', (done: Function) => {
      loaded = () => {
        ...
        expect(stripLineElement !== null).toBe(true);
        stripLineElement = document.getElementById(
          stripLineId + '_Behind_rect_' + 'primaryXAxis_' + '3'
        );
        expect(stripLineElement === null).toBe(true);
        done();
      };
    ...
    it('Horizontal Recurrence for DateTime Axis', (done: Function) => {
      loaded = () => {
        ...
        expect(
          direction ===
            'M 134.24520766773162 43.25 L 134.24520766773162 381.5' ||
            direction === 'M 93.01403468735737 43.25 L 93.01403468735737 381.5'
        ).toBe(true);
        stripLineElement = document.getElementById(
          stripLineId + '_Behind_rect_' + 'primaryXAxis_' + '1'
        );
        direction = stripLineElement.getAttribute('d');
        expect(
          direction === 'M 541.2260383386581 43.25 L 541.2260383386581 381.5' ||
            direction ===
              'M 335.07017343678683 43.25 L 335.07017343678683 381.5'
        ).toBe(true);
        stripLineElement = document.getElementById(
          stripLineId + '_Behind_rect_' + 'primaryXAxis_' + '2'
        );
        direction = stripLineElement.getAttribute('d');
        expect(
          direction === 'M 948.7643769968051 43.25 L 948.7643769968051 381.5' ||
            direction === 'M 577.4578959379279 43.25 L 577.4578959379279 381.5'
        ).toBe(true);
        done();
      };
      chart.series = [
    ...
    it('Horizontal Recurrence for Logarithmic Axis', (done: Function) => {
      loaded = () => {
        ...
        let direction: string = stripLineElement.getAttribute('d');
        expect(
          direction === 'M 93.57499999999999 43.25 L 93.57499999999999 381.5' ||
            direction === 'M 68.82499999999999 43.25 L 68.82499999999999 381.5'
        ).toBe(true);
        stripLineElement = document.getElementById(
          stripLineId + '_Behind_rect_' + 'primaryXAxis_' + '1'
        );
        direction = stripLineElement.getAttribute('d');
        expect(
          direction === 'M 398.95 43.25 L 398.95 381.5' ||
            direction === 'M 250.45 43.25 L 250.45 381.5'
        ).toBe(true);
        stripLineElement = document.getElementById(
          stripLineId + '_Behind_rect_' + 'primaryXAxis_' + '2'
        );
        direction = stripLineElement.getAttribute('d');
        expect(
          direction === 'M 704.325 43.25 L 704.325 381.5' ||
            direction ===
              'M 432.07500000000005 43.25 L 432.07500000000005 381.5'
        ).toBe(true);
        done();
      };
      chart.series = [
    ...
    it('Horizontal Recurrence for Multiple Axis', (done: Function) => {
      loaded = () => {
        ...
        let direction: string = stripLineElement.getAttribute('d');
        expect(
          direction === 'M 52.36666666666667 67.75 L 52.36666666666667 381.5' ||
            direction === 'M 44.11666666666667 68.75 L 44.11666666666667 381.5'
        ).toBe(true);
        stripLineElement = document.getElementById(
          stripLineId + '_Behind_rect_' + 'primaryXAxis_' + '1'
        );
        direction = stripLineElement.getAttribute('d');
        expect(
          direction === 'M 154.2 67.75 L 154.2 381.5' ||
            direction ===
              'M 104.69999999999999 68.75 L 104.69999999999999 381.5'
        ).toBe(true);
        stripLineElement = document.getElementById(
          stripLineId + '_Behind_rect_' + 'primaryXAxis_' + '2'
        );
        direction = stripLineElement.getAttribute('d');
        expect(
          direction === 'M 256.0333333333333 67.75 L 256.0333333333333 381.5' ||
            direction ===
              'M 165.28333333333333 68.75 L 165.28333333333333 381.5'
        ).toBe(true);
        done();
      };
      chart.series = [
        ...
        },
        {
          dataSource: [
            ...
            { x: 'UC Browser', y: 27, text: '17%' },
            { x: 'iPhone', y: 29, text: '19%' },
            { x: 'Others', y: 14, text: '4%' },
            { x: 'Opera', y: 21, text: '11%' },
    ...
    it('Vertical Recurrence for Numeric Axis', (done: Function) => {
      loaded = () => {
        ...
        let direction: string = stripLineElement.getAttribute('d');
        expect(
          direction === 'M 38.11 53.75 L 38.11 414.5' ||
            direction === 'M 35.635 53.75 L 35.635 413.5'
        ).toBe(true);
        stripLineElement = document.getElementById(
          stripLineId + '_Behind_rect_' + 'primaryXAxis_' + '1'
        );
        direction = stripLineElement.getAttribute('d');
        expect(
          direction === 'M 68.66 53.75 L 68.66 414.5' ||
            direction ===
              'M 53.809999999999995 53.75 L 53.809999999999995 413.5'
        ).toBe(true);
        stripLineElement = document.getElementById(
          stripLineId + '_Behind_rect_' + 'primaryXAxis_' + '2'
        );
        direction = stripLineElement.getAttribute('d');
        expect(
          direction === 'M 99.21 53.75 L 99.21 414.5' ||
            direction === 'M 71.98499999999999 53.75 L 71.98499999999999 413.5'
        ).toBe(true);
        done();
      };
      chart.primaryXAxis = {};
    ...
    it('Vertical Recurrence for Logarithmic Axis', (done: Function) => {
      loaded = () => {
        ...
        let direction: string = stripLineElement.getAttribute('d');
        expect(
          direction === 'M 81.86666666666667 53.75 L 81.86666666666667 414.5' ||
            direction === 'M 73.61666666666667 53.75 L 73.61666666666667 413.5'
        ).toBe(true);
        stripLineElement = document.getElementById(
          stripLineId + '_Behind_rect_' + 'primaryXAxis_' + '1'
        );
        direction = stripLineElement.getAttribute('d');
        expect(
          direction === 'M 181.2 53.75 L 181.2 414.5' ||
            direction === 'M 131.7 53.75 L 131.7 413.5'
        ).toBe(true);
        stripLineElement = document.getElementById(
          stripLineId + '_Behind_rect_' + 'primaryXAxis_' + '2'
        );
        direction = stripLineElement.getAttribute('d');
        expect(
          direction === 'M 280.5333333333333 53.75 L 280.5333333333333 414.5' ||
            direction ===
              'M 189.78333333333333 53.75 L 189.78333333333333 413.5'
        ).toBe(true);
        done();
      };
      chart.series = [
  ...
  describe('Segmented Stripline checking', () => {
    ...
    it('Vertical Segmented stripline on Numeric Axis', (done: Function) => {
      loaded = () => {
        ...
        expect(
          direction ===
            'M 161.07894736842104 291.4166666666667 L 353.9473684210526 291.4166666666667' ||
            direction ===
              'M 108.97368421052632 290.75 L 223.68421052631578 290.75'
        ).toBe(true);
        done();
      };
      chart.primaryXAxis = {};
    ...
    it('Vertical Segmented stripline on Category Axis', (done: Function) => {
      loaded = () => {
        ...
        expect(
          direction ===
            'M 745.0416666666667 353.4583333333333 L 948.625 353.4583333333333' ||
            direction === 'M 456.2916666666667 352.625 L 577.375 352.625'
        ).toBe(true);
        stripLineElement = document.getElementById(
          stripLineId + '_Behind_rect_' + 'primaryYAxis_' + '1'
        );
        ...
        expect(
          direction ===
            'M 337.875 403.0916666666667 L 541.4583333333334 403.0916666666667' ||
            direction === 'M 214.125 402.125 L 335.20833333333337 402.125'
        ).toBe(true);
        done();
      };
    ...
    it('Segment check without segmentStart and segmentEnd', (done: Function) => {
      loaded = () => {
        ...
        const direction: string = stripLineElement.getAttribute('d');
        expect(
          direction === 'M 439.6666666666667 43.25 L 439.6666666666667 415.5' ||
            direction === 'M 274.6666666666667 43.25 L 274.6666666666667 414.5'
        ).toBe(true);
        done();
      };
      chart.primaryXAxis = {
    ...
    it('Vertical Segmented stripline on DateTime Axis', (done: Function) => {
      loaded = () => {
        ...
        expect(
          direction ===
            'M 439.4808306709265 182.84375 L 1050.5095846645368 182.84375' ||
            direction ===
              'M 274.55613874942946 182.46875 L 637.9719306252853 182.46875'
        ).toBe(true);
        done();
      };
      chart.primaryXAxis = {
        ...
        stripLines: [
          {
            ...
            isSegmented: true,
            segmentStart: new Date(2007, 0, 1),
            segmentEnd: new Date(2010, 0, 1),
            color: 'green',
          },
        ],
      };
    ...
    it('Horizontal Segmented stripline on Numeric Axis', (done: Function) => {
      loaded = () => {
        ...
        expect(
          direction ===
            'M 643.2500028275463 129.08333333333331 L 643.2500028275463 214.91666666666663' ||
            direction ===
              'M 395.75000168171294 125.75 L 395.75000168171294 208.25'
        ).toBe(true);
        done();
      };
      chart.primaryXAxis = {
    ...
    it('Horizontal Segmented stripline on Logarithmic Axis', (done: Function) => {
      loaded = () => {
        ...
        const direction: string = stripLineElement.getAttribute('d');
        expect(
          direction === 'M 658.2500006895256 120.5 L 658.2500006895256 275' ||
            direction === 'M 410.75000040306713 117.5 L 410.75000040306713 266'
        ).toBe(true);
        done();
      };
      chart.primaryXAxis = {
    ...
    it('Segmented stripline in Multiple Axis', (done: Function) => {
      loaded = () => {
        ...
        expect(
          direction ===
            'M 635.0000017259838 214.91666666666666 L 635.0000017259838 322.2083333333333' ||
            direction ===
              'M 387.50000100983794 208.25 L 387.50000100983794 311.375'
        ).toBe(true);
        done();
      };
      chart.primaryXAxis = {
    ...
    it('Vertical Segmented stripline on Logarithmic Axis', (done: Function) => {
      loaded = () => {
        ...
        const direction: string = stripLineElement.getAttribute('d');
        expect(
          direction === 'M 1108.9 43.25 L 1108.9 77.0909090909091' ||
            direction ===
              'M 663.4000000000001 43.25 L 663.4000000000001 77.00000000000001'
        ).toBe(true);
        done();
      };
      chart.primaryXAxis = {
    ...
    it('Segmented stripline on DateTimeCategory axis', (done: Function) => {
      loaded = () => {
        ...
        expect(
          direction ===
            'M 152.10000000000002 43.25 L 152.10000000000002 415.5' ||
            direction ===
              'M 102.60000000000001 43.25 L 102.60000000000001 414.5'
        ).toBe(true);
        done();
      };
      chart.primaryXAxis = {
  ...
  describe('Stripline text checking', () => {
            ...
            stripLines: [
              {
                start: 20,
                color: '#663AB6',
                text: 'Column Definition Stripline',
                size: 15,
              },
            ],
          },
    ...
    it('Location y and Height', (done: Function) => {
      loaded = () => {
        stripLineElement = document.getElementById(
          stripLineId + '_Behind_rect_' + 'yAxis1_' + '0'
        );
        const direction: string = stripLineElement.getAttribute('d');
        expect(
          direction === 'M 82.5 75.8375 L 590 75.8375' ||
            direction === 'M 80.5 76.3875 L 590 76.3875'
        ).toBe(true);
        done();
      };
      chart.loaded = loaded;
    ...
    it('Location x and Width', (done: Function) => {
      stripLineElement = document.getElementById(
        stripLineId + '_Behind_rect_' + 'xAxis1_' + '0'
      );
      const direction: string = stripLineElement.getAttribute('d');
      expect(
        direction === 'M 445.15625 10.25 L 445.15625 309.5' ||
          direction === 'M 444.03125 10.25 L 444.03125 310.5'
      ).toBe(true);
      done();
    });
    it('text content', (done: Function) => {
      stripLineElement = document.getElementById(
        stripLineId + '_Behind_text_' + 'yAxis1_' + '0'
      );
      expect(stripLineElement.textContent).toEqual('Row Definition Stripline');
      stripLineElement = document.getElementById(
        stripLineId + '_Behind_text_' + 'xAxis1_' + '0'
      );
      expect(stripLineElement.textContent).toEqual(
        'Column Definition Stripline'
      );
      done();
    });
    ...
    it('Start horizontalAlignment and Start verticalAlignment', (done: Function) => {
      loaded = () => {
        ...
        expect(stripLineElement.getAttribute('text-anchor') === 'Start').toBe(
          true
        );
        let x: number = parseInt(stripLineElement.getAttribute('x'), 10);
        ...
        expect(stripLineElement.getAttribute('text-anchor') === 'End').toBe(
          true
        );
        x = parseInt(stripLineElement.getAttribute('x'), 10);
    ...
    it('Text Rotation', (done: Function) => {
      loaded = () => {
        ...
        expect(
          stripLineElement.getAttribute('transform').indexOf('rotate(-30') > -1
        ).toBe(true);
        stripLineElement = document.getElementById(
          stripLineId + '_Behind_text_' + 'xAxis1_' + '0'
        );
        expect(
          stripLineElement.getAttribute('transform').indexOf('rotate(60') > -1
        ).toBe(true);
        done();
      };
      chart.loaded = loaded;
    ...
    it('Category Value', (done: Function) => {
      loaded = () => {
        stripLineElement = document.getElementById(
          stripLineId + '_Over_text_' + 'primaryXAxis_' + '0'
        );
        expect(stripLineElement.textContent).toEqual('Category Axis Over');
        stripLineElement = document.getElementById(
          stripLineId + '_Behind_text_' + 'primaryXAxis_' + '0'
        );
    ...
    it('Logarithmic Value', (done: Function) => {
      loaded = () => {
        stripLineElement = document.getElementById(
          stripLineId + '_Over_text_' + 'primaryYAxis_' + '0'
        );
        expect(stripLineElement.textContent).toEqual('Logarithmic Axis Over');
        stripLineElement = document.getElementById(
          stripLineId + '_Behind_text_' + 'primaryYAxis_' + '0'
        );
  ...
  describe('Stripline checking with rows and columns', () => {
      ...
      chart = new Chart(
        {
          ...
          axes: [
            { name: '2ndyAxis', rowIndex: 1, title: '2ndyAxis' },
            {
              name: 'xAxis',
              columnIndex: 1,
              title: '2ndxAxis',
    ...
    it('Default segmentAxisName checking', (done: Function) => {
      loaded = () => {
        stripLineElement = document.getElementById(
          stripLineId + '_Behind_rect_' + 'xAxis_' + '0'
        );
        const direction: string = stripLineElement.getAttribute('d');
        expect(
          direction ===
            'M 825.6071428571429 243.08333333333334 L 825.6071428571429 301.2916666666667' ||
            direction ===
              'M 507.0357142857143 243.75 L 507.0357142857143 302.125'
        ).toBe(true);
        done();
      };
    ...
    it('Zooming checking', (done: Function) => {
      loaded = () => {
        let column1: Element = document.getElementById(
          id + '_AxisBottom_Column1'
        );
