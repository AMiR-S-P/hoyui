...
describe('Chart Legend', () => {
  ...
  describe('Chart Control Legend Checking', () => {
    ...
    it('Single Series Static Name and Multiple series legend text', (done: Function) => {
      loaded = (args: Object): void => {
        ...
        for (
          let i: number = 0, length: number = chartObj.series.length;
          i < length;
          i++
        ) {
      ...
      loaded = (args: Object): void => {
        ...
        for (
          ...
          if (i % 5 === 0 && i !== 0) {
            ...
            expect(legendElement.getAttribute('fill')).toEqual(
              chartObj.series[i].fill
            );
          }
    ...
    it('Style font, background, padding', (done: Function) => {
      loaded = (args: Object): void => {
        chartObj.loaded = null;
        let legendgroup: Element = document.getElementById(
          legendId + '_element'
        );
        ...
        expect(legendElement.getAttribute('font-size')).toEqual(
          chartObj.legendSettings.textStyle.size
        );
        expect(legendElement.getAttribute('fill')).toEqual(
          chartObj.legendSettings.textStyle.color
        );
        expect(parseFloat(legendElement.getAttribute('opacity'))).toEqual(
          chartObj.legendSettings.textStyle.opacity
        );
        expect(legendElement.getAttribute('font-style')).toEqual(
          chartObj.legendSettings.textStyle.fontStyle
        );
        expect(legendElement.getAttribute('font-family')).toEqual(
          chartObj.legendSettings.textStyle.fontFamily
        );
        expect(legendElement.getAttribute('font-weight')).toEqual(
          chartObj.legendSettings.textStyle.fontWeight
        );
        done();
      };
      chartObj.legendSettings = {
    ...
    it('Legend Page Navigation Down and Up for vertical orientation', (done: Function) => {
      loaded = (args: Object): void => {
        ...
        let downclick: number = 3;
        for (i = 1; i < downclick; i++) {
          trigger.clickEvent(legendElement);
          pagenumber = parseInt(
            document
              .getElementById(legendId + '_pagenumber')
              .textContent.split('/')[0],
            10
          );
        }
    ...
    it('Legend Rendering Event args cancel Checking', (done: Function) => {
      loaded = (args: Object): void => {
        ...
        expect(
          legendElement.getAttribute('y') == '311' ||
            legendElement.getAttribute('y') == '301.25'
        ).toBe(true);
        legendElement = document.getElementById(legendId + '_text_' + 2);
        expect(legendElement).not.toBe(null);
        ...
        expect(
          legendElement.getAttribute('y') == '333' ||
            legendElement.getAttribute('y') == '326.25'
        ).toBe(true);
        legendElement = document.getElementById(legendId + '_text_' + 3);
        expect(legendElement).not.toBe(null);
        ...
        expect(
          legendElement.getAttribute('y') == '355' ||
            legendElement.getAttribute('y') == '351.25'
        ).toBe(true);
    ...
    it('Bottom Position with margin', function (done) {
      loaded = function (args) {
        ...
        legendElement = document.getElementById(legendId + '_element');
        expect(
          parseInt(legendElement.getAttribute('y'), 10) == 306 ||
            parseInt(legendElement.getAttribute('y'), 10) == 310
        );
        done();
      };
      chartObj.legendSettings = {
    ...
    it('Item Padding', function (done) {
      loaded = function (args) {
        ...
        legendElement = document.getElementById(
          'container1_chart_legend_shape_marker_2'
        );
        expect(
          parseInt(legendElement.getAttribute('cx'), 10) == 324 ||
            parseInt(legendElement.getAttribute('cx'), 10) == 303
        );
        expect(
          parseInt(legendElement.getAttribute('cy'), 10) == 322 ||
            parseInt(legendElement.getAttribute('cx'), 10) == 342.5
        );
        done();
      };
      chartObj.legendSettings = {
    ...
    it('Legend Size Improvement', function (done) {
      loaded = function (args) {
        chartObj.loaded = null;
        legendElement = document.getElementById(
          'container1_chart_legend_shape_marker_1'
        );
        expect(
          legendElement.getAttribute('d') === 'M 222.5 322 L 237.5 322' ||
            legendElement.getAttribute('d') === 'M 222.5 342.5 L 237.5 342.5'
        );
        done();
      };
      chartObj.loaded = loaded;
  ...
  describe('Customer issue: Legend color is not working when use point color mapping', () => {
    ...
    it('Legend Symbol Color Checking with point color mapping', (done: Function) => {
      chartObj.loaded = (args: Object): void => {
        let color1: string = document
          .getElementById('container_chart_legend_shape_0')
          .getAttribute('fill');
        expect(color1 === 'fuchsia').toBe(true);
        let color2: string = document
          .getElementById('container_chart_legend_shape_1')
          .getAttribute('fill');
        expect(color2 === 'skyblue').toBe(true);
        let color3: string = document
          .getElementById('container_chart_legend_shape_2')
          .getAttribute('fill');
        expect(color3 === 'purple').toBe(true);
        let color4: string = document
          .getElementById('container_chart_legend_shape_3')
          .getAttribute('fill');
  ...
  describe('Legend new paging support checking', () => {
    ...
    it('01.legend bottom: without legend title', (done: Function) => {
      chartObj.loaded = (args: Object): void => {
        ...
        expect(
          path ===
            'M 25 267.5 L 17 271.5 L 25 275.5 L 25 273.5 L 21 271.5 L25 269.5 Z' ||
            path ===
              'M 29 267.5 L 21 271.5 L 29 275.5 L 29 273.5 L 25 271.5 L29 269.5 Z'
        ).toBe(true);
        opacity = backArrow.getAttribute('opacity');
        expect(opacity === '0').toBe(true);
        forwardArrow = document.getElementById(
          'container_chart_legend_pagedown'
        );
        path = forwardArrow.getAttribute('d');
        expect(
          path ===
            'M 275 267.5 L 283 271.5 L 275 275.5 L 275 273.5 L 279 271.5 L275 269.5 Z' ||
            path ===
              'M 271 267.5 L 279 271.5 L 271 275.5 L 271 273.5 L 275 271.5 L271 269.5 Z'
        ).toBe(true);
        opacity = forwardArrow.getAttribute('opacity');
        expect(opacity === '1').toBe(true);
        let legendGroup = document.getElementById(
          'container_chart_legend_translate_g'
        );
    ...
    it('02.legend bottom: with legend title top', (done: Function) => {
      chartObj.loaded = (args: Object): void => {
        ...
        expect(
          path ===
            'M 25 262.5 L 17 266.5 L 25 270.5 L 25 268.5 L 21 266.5 L25 264.5 Z' ||
            path ===
              'M 29 262.5 L 21 266.5 L 29 270.5 L 29 268.5 L 25 266.5 L29 264.5 Z'
        ).toBe(true);
        opacity = backArrow.getAttribute('opacity');
        expect(opacity === '0').toBe(true);
        forwardArrow = document.getElementById(
        ...
        expect(
          path ===
            'M 275 262.5 L 283 266.5 L 275 270.5 L 275 268.5 L 279 266.5 L275 264.5 Z' ||
            path ===
              'M 271 262.5 L 279 266.5 L 271 270.5 L 271 268.5 L 275 266.5 L271 264.5 Z'
        ).toBe(true);
        opacity = forwardArrow.getAttribute('opacity');
        expect(opacity === '1').toBe(true);
        let legendGroup = document.getElementById(
    ...
    it('03.legend bottom: with legend title left', (done: Function) => {
      chartObj.loaded = (args: Object): void => {
        ...
        expect(
          path ===
            'M 84.5 267.5 L 76.5 271.5 L 84.5 275.5 L 84.5 273.5 L 80.5 271.5 L84.5 269.5 Z' ||
            path ===
              'M 83.5 267.5 L 75.5 271.5 L 83.5 275.5 L 83.5 273.5 L 79.5 271.5 L83.5 269.5 Z'
        ).toBe(true);
        opacity = backArrow.getAttribute('opacity');
        expect(opacity === '0').toBe(true);
        forwardArrow = document.getElementById(
        ...
        expect(
          path ===
            'M 272.5 267.5 L 280.5 271.5 L 272.5 275.5 L 272.5 273.5 L 276.5 271.5 L272.5 269.5 Z' ||
            path ===
              'M 269.5 267.5 L 277.5 271.5 L 269.5 275.5 L 269.5 273.5 L 273.5 271.5 L269.5 269.5 Z'
        ).toBe(true);
        opacity = forwardArrow.getAttribute('opacity');
        expect(opacity === '1').toBe(true);
        let legendGroup = document.getElementById(
    ...
    it('04.legend bottom: with legend title right', (done: Function) => {
      chartObj.loaded = (args: Object): void => {
        ...
        expect(
          path ===
            'M 27.5 267.5 L 19.5 271.5 L 27.5 275.5 L 27.5 273.5 L 23.5 271.5 L27.5 269.5 Z' ||
            path ===
              'M 30.5 267.5 L 22.5 271.5 L 30.5 275.5 L 30.5 273.5 L 26.5 271.5 L30.5 269.5 Z'
        ).toBe(true);
        opacity = backArrow.getAttribute('opacity');
        expect(opacity === '0').toBe(true);
        forwardArrow = document.getElementById(
        ...
        expect(
          path ===
            'M 210.5 267.5 L 218.5 271.5 L 210.5 275.5 L 210.5 273.5 L 214.5 271.5 L210.5 269.5 Z' ||
            path ===
              'M 211.5 267.5 L 219.5 271.5 L 211.5 275.5 L 211.5 273.5 L 215.5 271.5 L211.5 269.5 Z'
        ).toBe(true);
        opacity = forwardArrow.getAttribute('opacity');
        expect(opacity === '1').toBe(true);
        let legendGroup = document.getElementById(
    ...
    it('05.legend top: without legend title', (done: Function) => {
      chartObj.loaded = (args: Object): void => {
        ...
        path = backArrow.getAttribute('d');
        expect(
          path === 'M 25 62 L 17 66 L 25 70 L 25 68 L 21 66 L25 64 Z' ||
            path === 'M 29 58 L 21 62 L 29 66 L 29 64 L 25 62 L29 60 Z'
        ).toBe(true);
        opacity = backArrow.getAttribute('opacity');
        expect(opacity === '0').toBe(true);
        forwardArrow = document.getElementById(
        ...
        path = forwardArrow.getAttribute('d');
        expect(
          path === 'M 275 62 L 283 66 L 275 70 L 275 68 L 279 66 L275 64 Z' ||
            path === 'M 271 58 L 279 62 L 271 66 L 271 64 L 275 62 L271 60 Z'
        ).toBe(true);
        opacity = forwardArrow.getAttribute('opacity');
        expect(opacity === '1').toBe(true);
        let legendGroup = document.getElementById(
    ...
    it('06.legend top: with legend title top', (done: Function) => {
      chartObj.loaded = (args: Object): void => {
        ...
        path = backArrow.getAttribute('d');
        expect(
          path === 'M 25 78 L 17 82 L 25 86 L 25 84 L 21 82 L25 80 Z' ||
            path === 'M 29 74 L 21 78 L 29 82 L 29 80 L 25 78 L29 76 Z'
        ).toBe(true);
        opacity = backArrow.getAttribute('opacity');
        expect(opacity === '0').toBe(true);
        forwardArrow = document.getElementById(
        ...
        path = forwardArrow.getAttribute('d');
        expect(
          path === 'M 275 78 L 283 82 L 275 86 L 275 84 L 279 82 L275 80 Z' ||
            path === 'M 271 74 L 279 78 L 271 82 L 271 80 L 275 78 L271 76 Z'
        ).toBe(true);
        opacity = forwardArrow.getAttribute('opacity');
        expect(opacity === '1').toBe(true);
        console.log(opacity);
    ...
    it('07.legend top: with legend title left', (done: Function) => {
      chartObj.loaded = (args: Object): void => {
        ...
        expect(
          path ===
            'M 84.5 62 L 76.5 66 L 84.5 70 L 84.5 68 L 80.5 66 L84.5 64 Z' ||
            path ===
              'M 89.5 62 L 81.5 66 L 89.5 70 L 89.5 68 L 85.5 66 L89.5 64 Z'
        ).toBe(true);
        opacity = backArrow.getAttribute('opacity');
        expect(opacity === '0').toBe(true);
        forwardArrow = document.getElementById(
        ...
        expect(
          path ===
            'M 272.5 62 L 280.5 66 L 272.5 70 L 272.5 68 L 276.5 66 L272.5 64 Z' ||
            path ===
              'M 269.5 58 L 277.5 62 L 269.5 66 L 269.5 64 L 273.5 62 L269.5 60 Z'
        ).toBe(true);
        opacity = forwardArrow.getAttribute('opacity');
        expect(opacity === '1').toBe(true);
        let legendGroup = document.getElementById(
    ...
    it('08.legend top: with legend title right', (done: Function) => {
      chartObj.loaded = (args: Object): void => {
        ...
        expect(
          path ===
            'M 27.5 62 L 19.5 66 L 27.5 70 L 27.5 68 L 23.5 66 L27.5 64 Z' ||
            path ===
              'M 30.5 58 L 22.5 62 L 30.5 66 L 30.5 64 L 26.5 62 L30.5 60 Z'
        ).toBe(true);
        opacity = backArrow.getAttribute('opacity');
        expect(opacity === '0').toBe(true);
        forwardArrow = document.getElementById(
        ...
        expect(
          path ===
            'M 210.5 62 L 218.5 66 L 210.5 70 L 210.5 68 L 214.5 66 L210.5 64 Z' ||
            path ===
              'M 211.5 58 L 219.5 62 L 211.5 66 L 211.5 64 L 215.5 62 L211.5 60 Z'
        ).toBe(true);
        opacity = forwardArrow.getAttribute('opacity');
        expect(opacity === '1').toBe(true);
        let legendGroup = document.getElementById(
    ...
    it('09.legend right: without legend title', (done: Function) => {
      chartObj.loaded = (args: Object): void => {
        ...
        path = backArrow.getAttribute('d');
        expect(
          path === 'M 333 61 L 337 53 L 341 61L 339 61 L 337 57L335 61 Z' ||
            path === 'M 333 61 L 337 53 L 341 61L 339 61 L 337 57L335 61 Z'
        ).toBe(true);
        opacity = backArrow.getAttribute('opacity');
        expect(opacity === '0').toBe(true);
        ...
        expect(
          path ===
            'M 333 180.5 L 337 188.5 L 341 180.5L 339 180.5 L 337 184.5L335 180.5 Z' ||
            path ===
              'M 333 172.5 L 337 180.5 L 341 172.5L 339 172.5 L 337 176.5L335 172.5 Z'
        ).toBe(true);
        opacity = forwardArrow.getAttribute('opacity');
        expect(opacity === '1').toBe(true);
        let legendGroup = document.getElementById(
    ...
    it('10.legend right: with legend title left', (done: Function) => {
      chartObj.loaded = (args: Object): void => {
        ...
        path = backArrow.getAttribute('d');
        expect(
          path === 'M 333 77 L 337 69 L 341 77L 339 77 L 337 73L335 77 Z' ||
            path === 'M 333 77 L 337 69 L 341 77L 339 77 L 337 73L335 77 Z'
        ).toBe(true);
        opacity = backArrow.getAttribute('opacity');
        expect(opacity === '0').toBe(true);
    ...
    it('12.legend left: without legend title', (done: Function) => {
      chartObj.loaded = (args: Object): void => {
        ...
        path = backArrow.getAttribute('d');
        expect(
          path === 'M 59 61 L 63 53 L 67 61L 65 61 L 63 57L61 61 Z' ||
            path === 'M 56 61 L 60 53 L 64 61L 62 61 L 60 57L58 61 Z'
        ).toBe(true);
        opacity = backArrow.getAttribute('opacity');
        expect(opacity === '0').toBe(true);
        forwardArrow = document.getElementById(
        ...
        expect(
          path ===
            'M 59 180.5 L 63 188.5 L 67 180.5L 65 180.5 L 63 184.5L61 180.5 Z' ||
            path ===
              'M 56 172.5 L 60 180.5 L 64 172.5L 62 172.5 L 60 176.5L58 172.5 Z'
        ).toBe(true);
        opacity = forwardArrow.getAttribute('opacity');
        expect(opacity === '1').toBe(true);
        let legendGroup = document.getElementById(
    ...
    it('13.legend left: with legend title top', (done: Function) => {
      chartObj.loaded = (args: Object): void => {
        ...
        path = backArrow.getAttribute('d');
        expect(
          path === 'M 59 77 L 63 69 L 67 77L 65 77 L 63 73L61 77 Z' ||
            path === 'M 56 77 L 60 69 L 64 77L 62 77 L 60 73L58 77 Z'
        ).toBe(true);
        opacity = backArrow.getAttribute('opacity');
        expect(opacity === '0').toBe(true);
        forwardArrow = document.getElementById(
  ...
  describe('Check the RTL behaviour for legend', () => {
    ...
    it('legend highlight with patterns', (done: Function) => {
      loaded = (args: Object): void => {
        chart.loaded = null;
        let legendElement = document.getElementById(
          'container_chart_legend_text_0'
        );
        trigger.mousemoveEvent(legendElement, 0, 0, 387, 309.25);
