  ...
  describe('Range Color Mapping With Varies Legend Mode', () => {
    ...
    it('Series Legend mode', (done: Function) => {
      loaded = (args: Object): void => {
        ...
        let legendContainer: HTMLElement = document.getElementById(
          legendId + '_translate_g'
        );
        expect(chartObj.series.length).toEqual(
          legendContainer.childElementCount
        );
        done();
      };
    ...
    it('Point Legend mode', (done: Function) => {
      loaded = (args: Object): void => {
        ...
        expect(chartObj.visibleSeries[0].points.length).toEqual(
          legendContainer.childElementCount
        );
        done();
      };
    ...
    it('Range Legend mode with full range', (done: Function) => {
      loaded = (args: Object): void => {
        ...
        expect(chartObj.rangeColorSettings.length).toEqual(
          legendContainer.childElementCount
        );
        done();
      };
