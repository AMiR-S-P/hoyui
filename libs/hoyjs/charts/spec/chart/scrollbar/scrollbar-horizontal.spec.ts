...
import { createElement, EventHandler, Browser } from '@hoyui/base';
...
describe('Scrollbar Chart ', () => {
  ...
  describe('Horizontal Scrollbar Default', () => {
    ...
    it('Checking module name', () => {
      expect(chartObj.axisCollections[0].zoomingScrollBar.getModuleName()).toBe(
        'ScrollBar'
      );
    });
    it('Checking svg element', (done: Function) => {
      loaded = (args: Object): void => {
        ...
        let scrollEle = document.getElementById(
          'container_scrollBar_svgprimaryXAxis'
        );
        expect(scrollEle.parentElement.id == 'container_scrollElement').toBe(
          true
        );
        ...
        expect(
          scrollEle.style.top == '374.5px' || scrollEle.style.top == '378px'
        ).toBe(true);
        expect(
          scrollEle.style.left == '57.5px' || scrollEle.style.left == '53.5px'
        ).toBe(true);
        done();
      };
    ...
    it('Child Element Count of SVG', () => {
      let svgChildEle: Element = document.getElementById(
        'container_scrollBar_svgprimaryXAxis'
      ).children[0];
    ...
    it('Back Rect Element check', () => {
      ...
      expect(
        svgChildEle.getAttribute('transform') === 'translate(0,0) rotate(0)'
      ).toBe(true);
      ...
      expect(
        backRectEle.id === 'container_scrollBarBackRect_primaryXAxis'
      ).toBe(true);
    });
    it('Thumb Rect Element check', () => {
      ...
      expect(thumbRectEle.id === 'container_scrollBarThumb_primaryXAxis').toBe(
        true
      );
    });
    it('Left Circle Element check', () => {
      ...
      expect(
        leftCircle.id === 'container_scrollBar_leftCircle_primaryXAxis'
      ).toBe(true);
    });
    it('Right Circle Element check', () => {
      ...
      expect(
        rightCircle.id === 'container_scrollBar_rightCircle_primaryXAxis'
      ).toBe(true);
    });
    it('Left Arrow Element check', () => {
      ...
      expect(
        d === 'M 130.5 8 L 136.5 12 L 136.5 4 Z' ||
          d === 'M 134.5 8 L 140.5 12 L 140.5 4 Z' ||
          d === 'M 131.5 8 L 136.5 11 L 136.5 5 Z' ||
          d === 'M 135.5 8 L 140.5 11 L 140.5 5 Z'
      ).toBe(true);
      expect(
        leftArrow.id === 'container_scrollBar_leftArrow_primaryXAxis'
      ).toBe(true);
    });
    it('Right Arrow Element check', () => {
      ...
      expect(
        d === 'M 288.5 8 L 282.5 12 L 282.5 4 Z' ||
          d === 'M 292.5 8 L 286.5 12 L 286.5 4 Z' ||
          d === 'M 288 8 L 282.5 11.5 L 282.5 4.5 Z' ||
          d === 'M 292 8 L 286.5 11.5 L 286.5 4.5 Z'
      ).toBe(true);
      expect(
        rightArrow.id === 'container_scrollBar_rightArrow_primaryXAxis'
      ).toBe(true);
    });
    it('1st Grip Circle Element check', () => {
      let gripCircle: Element = document.getElementById(
        'container_scrollBar_gripCircle1_primaryXAxis'
      );
    ...
    it('2nd Grip Circle Element check', () => {
      let gripCircle: Element = document.getElementById(
        'container_scrollBar_gripCircle2_primaryXAxis'
      );
      let cx: string = gripCircle.getAttribute('cx');
    ...
    it('3rd Grip Circle Element check', () => {
      let gripCircle: Element = document.getElementById(
        'container_scrollBar_gripCircle3_primaryXAxis'
      );
      let cx: string = gripCircle.getAttribute('cx');
    ...
    it('4th Grip Circle Element check', () => {
      let gripCircle: Element = document.getElementById(
        'container_scrollBar_gripCircle4_primaryXAxis'
      );
      let cx: string = gripCircle.getAttribute('cx');
      expect(cx === '0').toBe(true);
    ...
    it('5th Grip Circle Element check', () => {
      let gripCircle: Element = document.getElementById(
        'container_scrollBar_gripCircle5_primaryXAxis'
      );
      let cx: string = gripCircle.getAttribute('cx');
      expect(cx === '5').toBe(true);
      expect(gripCircle.getAttribute('cy') === '5').toBe(true);
    ...
    it('6th Grip Circle Element check', () => {
      let gripCircle: Element = document.getElementById(
        'container_scrollBar_gripCircle6_primaryXAxis'
      );
      let cx: string = gripCircle.getAttribute('cx');
      expect(cx === '10').toBe(true);
      expect(gripCircle.getAttribute('cy') === '5').toBe(true);
    ...
    it('Grip Circle Group Element', () => {
      let gripGroup: Element = document.getElementById(
        'container_scrollBar_gripCircle_primaryXAxis'
      );
      let transform: string = gripGroup.getAttribute('transform');
      expect(
        transform === 'translate(204.5,5) rotate(0)' ||
          transform === 'translate(213.5,6) rotate(0)' ||
          transform === 'translate(208.5,5) rotate(0)'
      ).toBe(true);
    });
    it('Chart Element with Scrollbar', () => {
      let chartAreaHt: string = document
        .getElementById('container_ChartAreaBorder')
        .getAttribute('height');
      let majorTick: string = document
        .getElementById('container_MajorTickLine_0_0')
        .getAttribute('d')
        .split('M ')[1];
      let xAxisLabel: Element = document.getElementById(
        'container0_AxisLabel_0'
      );
      let xAxisTitle: Element = document.getElementById(
        'container_AxisTitle_0'
      );
      ...
      expect(
        majorTick === '97.4859583333334 378 L 97.4859583333334 399' ||
          majorTick === '97.4859583333334 378 L 97.4859583333334 399'
      ).toBe(true);
  ...
  describe('Horizontal Scrollbar with Labels, Ticks and Border ', () => {
    ...
    it('Scrollbar position', (done: Function) => {
      loaded = (args: Object): void => {
        ...
        expect(scrollEle.getAttribute('height') == '16').toBe(true);
        expect(
          scrollEle.style.top == '405.5px' || scrollEle.style.top == '408px'
        ).toBe(true);
        expect(
          scrollEle.style.left == '57.5px' || scrollEle.style.left == '53.5px'
        ).toBe(true);
    ...
    it('Ticks and Labels Position Check', (done: Function) => {
      ...
      expect(
        majorTick === '119.59062500000013 421 L 119.59062500000013 399' ||
          majorTick === '97.4859583333334 424 L 97.4859583333334 402'
      ).toBe(true);
      expect(
        labelX === '113.09062500000013' || labelX === '91.4859583333334'
      ).toBe(true);
    ...
    it('X Axis Labels Border Outside', function (done) {
      loaded = (args: Object): void => {
        chartObj.loaded = null;
        trigger.draganddropEvent(ele, 200, 250, 350, 400);
        let border: string = document
          .getElementById('container_BorderLine_0')
          .getAttribute('d')
          .split('M  ')[1];
        expect(
          border === '57.5 389.5L 890 389.5' ||
            border === '53.5 393.5L 890 393.5'
        ).toBe(true);
        done();
      };
    ...
    it('X Axis Labels Border Inside', function (done) {
      loaded = (args: Object): void => {
        ...
        let border: string = document
          ...
          .split('M  ')[1];
        expect(
          border === '57.5 404.5L 890 404.5' ||
            border === '53.5 407.5L 890 407.5'
        ).toBe(true);
        done();
      };
  ...
  describe('Axis Crossing', () => {
    ...
    it('Ticks and Labels Position Check', (done: Function) => {
      ...
      expect(
        majorTick ===
          '119.59062500000013 239.875 L 119.59062500000013 244.875' ||
          majorTick === '97.4859583333334 238.875 L 97.4859583333334 243.875'
      ).toBe(true);
      expect(
        xAxisLabel.getAttribute('x') === '113.09062500000013' ||
          xAxisLabel.getAttribute('x') === '91.4859583333334'
      ).toBe(true);
      expect(
        xAxisLabel.getAttribute('y') === '260.125' ||
          xAxisLabel.getAttribute('y') === '259.625'
      ).toBe(true);
      expect(xAxisLabel.innerHTML === '17').toBe(true);
      expect(
        xAxisTitle.getAttribute('x') === '473.75' ||
          xAxisTitle.getAttribute('x') === '471.75'
      ).toBe(true);
      expect(
        xAxisTitle.getAttribute('y') === '284.625' ||
          xAxisTitle.getAttribute('y') === '280.375'
      ).toBe(true);
      done();
    });
  });
  ...
  describe('Multilevel Labels', () => {
          ...
          multiLevelLabels: [
            {
              ...
              categories: [
                { start: 15, end: 25, text: 'Label 1' },
                { start: 25, end: 40, text: 'Label 2' },
              ],
            },
          ],
        },
    ...
    it('Label and Border Position - Inside', (done: Function) => {
      loaded = (args: Object): void => {
        ...
        let mulitiLevelLabel: Element = document.getElementById(
          'container0_Axis_MultiLevelLabel_Level_0_Text_0'
        );
        let border: string = document
          .getElementById('container0_Axis_MultiLevelLabel_Rect_0_0')
          .getAttribute('d')
          .split('M')[1];
        let x: string = mulitiLevelLabel.getAttribute('x');
        let y: string = mulitiLevelLabel.getAttribute('y');
        expect(x === '469.17125000000004' || x === '457.1112499999999').toBe(
          true
        );
        expect(y === '405.5' || y === '409').toBe(true);
        expect(
          border === ' 122.643125 387.5 L 122.643125 415.5 ' ||
            border === ' 107.24512499999994 391.5 L 107.24512499999994 418.5 '
        ).toBe(true);
        done();
      };
      chartObj.loaded = loaded;
    ...
    it('Label and Border Position - Outside', (done: Function) => {
      loaded = (args: Object): void => {
        ...
        expect(
          border === ' 122.643125 389.5 L 122.643125 361.5 ' ||
            border === ' 107.24512499999994 377.5 L 107.24512499999994 350.5 '
        ).toBe(true);
        done();
      };
      chartObj.primaryXAxis.labelPosition = 'Inside';
  ...
  describe('Date Time Axis', () => {
    ...
    it('Element Position Check', (done: Function) => {
      loaded = (args: Object): void => {
        ...
        let thumbEle: Element = document.getElementById(
          'container_scrollBarThumb_primaryXAxis'
        );
        ...
        expect(scrollEle != null).toBe(true);
        expect(
          scrollEle.getAttribute('width') == '856.5' ||
            scrollEle.getAttribute('width') == '857.5'
        ).toBe(true);
        expect(scrollEle.getAttribute('height') == '16').toBe(true);
        expect(
          scrollEle.style.top == '398.5px' || scrollEle.style.top == '399px'
        ).toBe(true);
        expect(
          scrollEle.style.left == '33.5px' || scrollEle.style.left == '32.5px'
        ).toBe(true);
        done();
      };
      chartObj.loaded = loaded;
    ...
    it('Crosshair Label', (done: Function) => {
      loaded = (args: Object): void => {
        ...
        let y: number =
          ...
          parseFloat(chartArea.getAttribute('height')) / 2 +
          ele.offsetTop;
        let x: number =
          parseFloat(chartArea.getAttribute('x')) +
          parseFloat(chartArea.getAttribute('width')) / 2 +
          ele.offsetLeft;
        trigger.mousemovetEvent(chartArea, Math.ceil(x), Math.ceil(y));
        let crossHairEle: string = document
          .getElementById('container_axis_tooltip_0')
          .getAttribute('d')
          .split(' L')[0];
        expect(
          crossHairEle === 'M 450.5 404.5 Q 450.5 402.5 452.5 402.5' ||
            crossHairEle === 'M 449 404.5 Q 449 402.5 451 402.5'
        ).toBe(true);
        let text: string = document.getElementById(
          'container_axis_tooltip_text_0'
        ).innerHTML;
  ...
  describe('Scrollbar User Interaction', () => {
    ...
    it('Mouse Move with Thumb', (done: Function) => {
      trigger.draganddropEvent(ele, 150, 150, 400, 400);
      let currentTarget: Element = document.getElementById(
        'container_scrollBarThumb_primaryXAxis'
      );
      chartObj.axisCollections[0].zoomingScrollBar.scrollMouseDown(
        <PointerEvent>trigger.onTouchStart(currentTarget, 0, 0, 0, 0, 300, 390)
      );
      chartObj.axisCollections[0].zoomingScrollBar.scrollMouseMove(
        <PointerEvent>trigger.onTouchMove(currentTarget, 0, 0, 0, 0, 450, 390)
      );
      let thumbEle: Element = document.getElementById(
        'container_scrollBarThumb_primaryXAxis'
      );
      expect(
        thumbEle.getAttribute('x') === '234.5' ||
          thumbEle.getAttribute('x') === '237.5'
      ).toBe(true);
      expect(
        thumbEle.getAttribute('width') === '250' ||
          thumbEle.getAttribute('width') === '250.00000000000003'
      ).toBe(true);
    ...
    it('Right Resize using Circle', (done: Function) => {
      let currentTarget: Element = document.getElementById(
        'container_scrollBar_rightCircle_primaryXAxis'
      );
      chartObj.axisCollections[0].zoomingScrollBar.scrollMouseDown(
        <PointerEvent>(
          trigger.onTouchStart(currentTarget, 0, 0, 0, 0, 550, 390, true)
        )
      );
      chartObj.axisCollections[0].zoomingScrollBar.scrollMouseMove(
        <PointerEvent>trigger.onTouchMove(currentTarget, 0, 0, 0, 0, 650, 390)
      );
      let thumbEle: Element = document.getElementById(
        'container_scrollBarThumb_primaryXAxis'
      );
      let thumbX: string = parseFloat(thumbEle.getAttribute('x'))
        .toFixed(1)
        .toString();
      let thumbWidth: string = Math.round(
        parseFloat(thumbEle.getAttribute('width'))
      ).toLocaleString();
    ...
    it('Left resize using circle', (done: Function) => {
      let currentTarget: Element = document.getElementById(
        'container_scrollBar_leftCircle_primaryXAxis'
      );
      chartObj.axisCollections[0].zoomingScrollBar.scrollMouseDown(
        <PointerEvent>trigger.onTouchStart(currentTarget, 0, 0, 0, 0, 300, 390)
      );
      chartObj.axisCollections[0].zoomingScrollBar.scrollMouseMove(
        <PointerEvent>trigger.onTouchMove(currentTarget, 0, 0, 0, 0, 120, 390)
      );
      let thumbEle: Element = document.getElementById(
        'container_scrollBarThumb_primaryXAxis'
      );
      ...
      chartObj.axisCollections[0].zoomingScrollBar.scrollMouseMove(
        <PointerEvent>trigger.onTouchMove(currentTarget, 0, 0, 0, 0, 250, 390)
      );
      thumbX = parseFloat(thumbEle.getAttribute('x')).toFixed(1).toString();
      thumbWidth = Math.round(
        parseFloat(thumbEle.getAttribute('width'))
    ...
    it('Checking mouse wheel as forward ', (done: Function) => {
      loaded = (args: Object): void => {
        ...
        chartObj.axisCollections[0].zoomingScrollBar.scrollMouseWheel(
          <WheelEvent>wheelArgs
        );
        let thumbEle: Element = document.getElementById(
          'container_scrollBarThumb_primaryXAxis'
        );
        ...
        expect(
          thumbWidth === '60' || thumbWidth === '60' || thumbWidth === '49'
        ).toBe(true);
        done();
      };
    ...
    it('Mouse wheel with detial argument negative  ', (done: Function) => {
      loaded = (args: Object): void => {
        ...
        expect(
          thumbX === '212.76' || thumbX === '217.16' || thumbX === '350.44'
        ).toBe(true);
        expect(thumbWidth === '40').toBe(true);
        done();
      };
    ...
    it('Mouse Down on Back Rect - Right Side Click', (done: Function) => {
      loaded = (args: Object): void => {
        ...
        trigger.draganddropEvent(ele, 150, 150, 400, 400);
        let currentTarget: Element = document.getElementById(
          'container_scrollBarBackRect_primaryXAxis'
        );
        chartObj.axisCollections[0].zoomingScrollBar.animateDuration = 0;
        chartObj.axisCollections[0].zoomingScrollBar.scrollMouseDown(
          <PointerEvent>(
            trigger.onTouchStart(currentTarget, 0, 0, 0, 0, 500, 390)
          )
        );
        let thumbEle: Element = document.getElementById(
          'container_scrollBarThumb_primaryXAxis'
        ...
        expect(
          thumbEle.getAttribute('x') === '166.15' ||
            thumbEle.getAttribute('x') === '170.55'
        ).toBe(true);
        expect(
          thumbEle.getAttribute('width') === '250' ||
            thumbEle.getAttribute('width') === '250.00000000000003'
    ...
    it('Mouse Down on Back Rect - Left side Click', (done: Function) => {
      ...
      chartObj.axisCollections[0].zoomingScrollBar.animateDuration = 0;
      chartObj.axisCollections[0].zoomingScrollBar.scrollMouseDown(
        <PointerEvent>trigger.onTouchStart(currentTarget, 0, 0, 0, 0, 140, 390)
      );
      let thumbEle: Element = document.getElementById(
        'container_scrollBarThumb_primaryXAxis'
      );
      expect(
        thumbEle.getAttribute('x') === '84.5' ||
          thumbEle.getAttribute('x') === '88.5'
      ).toBe(true);
      expect(
        thumbEle.getAttribute('width') === '250' ||
          thumbEle.getAttribute('width') === '250.00000000000003'
        ...
        chartObj.axisCollections[0].zoomingScrollBar.scrollMouseDown(
          <PointerEvent>(
            trigger.onTouchStart(
              ...
              0,
              0,
              chartObj.axisCollections[0].rect.x - circleRadius,
              390
            )
          )
        );
        expect(
          thumbEle.getAttribute('x') === '9.5' ||
            thumbEle.getAttribute('x') === '13.5'
        ).toBe(true);
    ...
    it('Checking mouse x value on scroll width', (done: Function) => {
      loaded = (args: Object): void => {
        ...
        chartObj.axisCollections[0].zoomingScrollBar.scrollMouseDown(
          <PointerEvent>(
            trigger.onTouchStart(currentTarget, 0, 0, 0, 0, 890, 390)
          )
        );
        let thumbEle: Element = document.getElementById(
          'container_scrollBarThumb_primaryXAxis'
        ...
        expect(
          thumbEle.getAttribute('x') === '92.5' ||
            thumbEle.getAttribute('x') === '96.5'
        ).toBe(true);
    ...
    it('Left Circle Resize - X within Circle Radius', (done: Function) => {
      loaded = (args: Object): void => {
        ...
        chartObj.axisCollections[0].zoomingScrollBar.scrollMouseDown(
          <PointerEvent>trigger.onTouchStart(currentTarget, 0, 0, 0, 0, 80, 390)
        );
        chartObj.axisCollections[0].zoomingScrollBar.scrollMouseMove(
          <PointerEvent>trigger.onTouchMove(currentTarget, 0, 0, 0, 0, 70, 390)
        );
        let thumbEle: Element = document.getElementById(
          'container_scrollBarThumb_primaryXAxis'
        );
        expect(
          thumbEle.getAttribute('x') === '14.5' ||
            thumbEle.getAttribute('x') === '8.5'
        ).toBe(true);
        expect(
          thumbEle.getAttribute('width') === '720' ||
            thumbEle.getAttribute('width') === '730'
        ).toBe(true);
        done();
      };
      chartObj.primaryXAxis.zoomFactor = 1;
    ...
    it('Removing scrollbar svg element', (done: Function) => {
      ...
      expect(
        document.getElementById('container_scrollBar_svgprimaryXAxis')
      ).toBeNull(true);
      chartObj.refresh();
      done();
    });
  ...
  describe('Thumb Limits', () => {
    ...
    it('Checking less than SVG X value - Left resize', (done: Function) => {
      loaded = (args: Object): void => {
        ...
        chartObj.axisCollections[0].zoomingScrollBar.scrollMouseDown(
          <PointerEvent>(
            trigger.onTouchStart(currentTarget, 0, 0, 0, 0, 160, 390)
          )
        );
        chartObj.axisCollections[0].zoomingScrollBar.scrollMouseMove(
          <PointerEvent>trigger.onTouchMove(currentTarget, 0, 0, 0, 0, 50, 390)
        );
        let thumbEle: Element = document.getElementById(
          'container_scrollBarThumb_primaryXAxis'
        );
    ...
    it('Checking less than SVG X value - Thumb Mouse move', (done: Function) => {
      ...
      chartObj.axisCollections[0].zoomingScrollBar.scrollMouseDown(
        <PointerEvent>trigger.onTouchStart(currentTarget, 0, 0, 0, 0, 160, 390)
      );
      chartObj.axisCollections[0].zoomingScrollBar.scrollMouseMove(
        <PointerEvent>trigger.onTouchMove(currentTarget, 0, 0, 0, 0, 50, 390)
      );
    ...
    it('Checking Hover Fill - Right Arrow with Circle', (done: Function) => {
      let currentTarget: Element = document.getElementById(
        'container_scrollBar_rightArrow_primaryXAxis'
      );
      chartObj.axisCollections[0].zoomingScrollBar.scrollMouseMove(
        <PointerEvent>trigger.onTouchMove(currentTarget, 0, 0, 0, 0, 400, 390)
      );
      let circleEle: Element = document.getElementById(
        'container_scrollBar_rightCircle_primaryXAxis'
      );
    ...
    it('Checking Hover Fill - Left Arrow with Circle', (done: Function) => {
      let currentTarget: Element = document.getElementById(
        'container_scrollBar_leftArrow_primaryXAxis'
      );
      chartObj.axisCollections[0].zoomingScrollBar.scrollMouseMove(
        <PointerEvent>trigger.onTouchMove(currentTarget, 0, 0, 0, 0, 500, 390)
      );
      let circleEle: Element = document.getElementById(
        'container_scrollBar_leftCircle_primaryXAxis'
      );
    ...
    it('Checking Hover Fill - Right Arrow Element', (done: Function) => {
      loaded = (args: Object): void => {
        ...
        chartObj.axisCollections[0].zoomingScrollBar.scrollMouseMove(
          <PointerEvent>trigger.onTouchMove(currentTarget, 0, 0, 0, 0, 698, 390)
        );
        let circleEle: Element = document.getElementById(
          'container_scrollBar_rightArrow_primaryXAxis'
        );
    ...
    it('Shadow Element Check', (done: Function) => {
      let shadowEle: Element = document.getElementById(
        'container_' + chartObj.axisCollections[0].name + '_thumb_shadow'
      );
    ...
    it('Checking Circle fill in Material Dark theme', (done: Function) => {
      loaded = (args: Object): void => {
        ...
        expect(
          document
            .getElementById('container_scrollBar_leftCircle_primaryXAxis')
            .getAttribute('fill') === '#757575'
        ).toBe(true);
        done();
      };
      chartObj.loaded = loaded;
  ...
  describe('Scrollbar Animation', () => {
    ...
    it('Mouse Down on Back Rect with animation', (done: Function) => {
      loaded = (args: Object): void => {
        ...
        chartObj.axisCollections[0].zoomingScrollBar.scrollMouseDown(
          <PointerEvent>(
            trigger.onTouchStart(currentTarget, 0, 0, 0, 0, 550, 390)
          )
        );
        expect(svgChildEle).not.toBeNull();
        expect(svgChildEle.childElementCount).toBe(2);
  ...
  describe('Lazy Loading', () => {
    ...
    it('Mouse Move with Thumb', (done: Function) => {
      ...
      chartObj.axisCollections[0].zoomingScrollBar.scrollMouseDown(
        <PointerEvent>trigger.onTouchStart(currentTarget, 0, 0, 0, 0, 150, 390)
      );
      chartObj.axisCollections[0].zoomingScrollBar.scrollMouseMove(
        <PointerEvent>trigger.onTouchMove(currentTarget, 0, 0, 0, 0, 450, 390)
      );
      ...
      expect(
        thumbEle.getAttribute('x') === '8' ||
          thumbEle.getAttribute('x') === '308'
      ).toBe(true);
      expect(
        thumbEle.getAttribute('width') === '100.25999999999999' ||
          thumbEle.getAttribute('width') === '100.38'
      ).toBe(true);
      chartObj.axisCollections[0].zoomingScrollBar.scrollMouseUp();
      done();
    });
    it('Checking mouse wheel as forward ', (done: Function) => {
      loaded = (args: Object): void => {
        ...
        expect(
          thumbEle.getAttribute('x') === '344.9' ||
            thumbEle.getAttribute('x') === '346.0686415320167'
        ).toBe(true);
        expect(
          thumbEle.getAttribute('width') === '99.89999999999999' ||
            thumbEle.getAttribute('width') === '100.38'
        ).toBe(true);
    ...
    it('Checking mouse wheel as backward ', (done: Function) => {
      loaded = (args: Object): void => {
        ...
        expect(
          thumbEle.getAttribute('x') === '345.36905390315076' ||
            thumbEle.getAttribute('x') === '345.000412371134'
        ).toBe(true);
        expect(
          thumbEle.getAttribute('width') === '99.89999999999999' ||
            thumbEle.getAttribute('width') === '100.38'
    ...
    it('Mouse Down on Back Rect - Right Side Click', (done: Function) => {
      loaded = (args: Object): void => {
        ...
        expect(
          thumbEle.getAttribute('x') === '425.86525773195876' ||
            thumbEle.getAttribute('x') === '427.41905390315077'
        ).toBe(true);
        expect(
          thumbEle.getAttribute('width') === '99.89999999999999' ||
            thumbEle.getAttribute('width') === '100.38'
    ...
    it('Mouse Down on Back Rect - Left side Click', (done: Function) => {
      ...
      expect(
        thumbEle.getAttribute('x') === '344.2152577319588' ||
          thumbEle.getAttribute('x') === '345.36905390315076'
      ).toBe(true);
      expect(
        thumbEle.getAttribute('width') === '99.89999999999999' ||
    ...
    it('Right Resize using Circle', (done: Function) => {
      ...
      expect(
        thumbEle.getAttribute('x') === '344.21525773195873' ||
          thumbEle.getAttribute('x') === '345.36905390315076'
      ).toBe(true);
      expect(
        thumbEle.getAttribute('width') === '240.2847422680412' ||
          thumbEle.getAttribute('width') === '243.13094609684924'
      ).toBe(true);
      chartObj.axisCollections[0].zoomingScrollBar.scrollMouseUp();
      done();
    });
  ...
  describe('Inversed Scrollbar ', function () {
    ...
    it('Checking scrollbar is isInversed', function (done) {
      trigger.draganddropEvent(ele, 200, 200, 350, 350);
      var svgChildEle = document.getElementById(
        'container_scrollBar_svgprimaryXAxis'
      ).children[0];
      ...
      expect(svgChildEle.id === 'container_scrollBar_primaryXAxis').toBe(true);
      expect(
        svgChildEle.getAttribute('transform') ===
          'translate(832.5,16) rotate(180)' ||
          svgChildEle.getAttribute('transform') ===
            'translate(836.5,16) rotate(180)'
      ).toBe(true);
      expect(backRectEle.getAttribute('x') === '0').toBe(true);
      expect(backRectEle.getAttribute('y') === '0').toBe(true);
      expect(backRectEle.getAttribute('height') === '16').toBe(true);
    ...
    it('Right Resize for Inversed axis', (done: Function) => {
      ...
      expect(
        thumbEle.getAttribute('x') === '134.5' ||
          thumbEle.getAttribute('x') === '8'
      ).toBe(true);
      expect(
        thumbEle.getAttribute('width') === '109.5' ||
          thumbEle.getAttribute('width') === '240'
      ).toBe(true);
      chartObj.axisCollections[0].zoomingScrollBar.scrollMouseUp();
      done();
    });
    it('Mouse Move with Thumb', (done: Function) => {
      ...
      chartObj.axisCollections[0].zoomingScrollBar.scrollMouseDown(
        <PointerEvent>trigger.onTouchStart(currentTarget, 0, 0, 0, 0, 800, 390)
      );
      chartObj.axisCollections[0].zoomingScrollBar.scrollMouseMove(
        <PointerEvent>trigger.onTouchMove(currentTarget, 0, 0, 0, 0, 450, 390)
      );
      ...
      let thumbX: string = Math.round(
        parseFloat(thumbEle.getAttribute('x'))
      ).toLocaleString();
      let thumbWidth: string = Math.round(
        parseFloat(thumbEle.getAttribute('width'))
      ).toLocaleString();
    ...
    it('Mouse Move with Thumb on inverted axis', (done: Function) => {
      ...
      chartObj.axisCollections[0].zoomingScrollBar.scrollMouseDown(
        <PointerEvent>trigger.onTouchStart(currentTarget, 0, 0, 0, 0, 450, 390)
      );
      chartObj.axisCollections[0].zoomingScrollBar.scrollMouseMove(
        <PointerEvent>trigger.onTouchMove(currentTarget, 0, 0, 0, 0, 450, 390)
      );
  ...
  describe('Horizontal Scrollbar with customize option', () => {
    ...
    it('Checking scrollbar custom color', function (done) {
      trigger.draganddropEvent(ele, 200, 200, 350, 350);
      let track: HTMLElement = document.getElementById(
        'container_scrollBarBackRect_primaryXAxis'
      );
    ...
    it('Checking scrollbar with RTL', (done: Function) => {
      loaded = (args: Object): void => {
        ...
        expect(
          svgChildEle.getAttribute('transform') ===
            'translate(832.5,10) rotate(180)' ||
            svgChildEle.getAttribute('transform') ===
              'translate(836.5,10) rotate(180)'
        ).toBe(true);
