...
describe('Stacking Bar Series', () => {
  ...
  describe('Stacking Bar Series', () => {
    ...
    it('Added data Source', (done: Function) => {
      loaded = (args: Object): void => {
        const svg: HTMLElement = document.getElementById(
          'barElement-svg-4-region-series-1-point-0'
        );
    ...
    it('checking datasource in Chart', (done: Function) => {
      chartObj.loaded = (args: Object) => {
        const svg1: HTMLElement = document.getElementById(
          'barElement-svg-0-region-series-2-point-0'
        );
        expect(svg1.getAttribute('d') !== '').toBe(true);
        const svg2: HTMLElement = document.getElementById(
          'barElement-svg-0-region-series-0-point-0'
        );
        expect(svg2.getAttribute('d') !== '').toBe(true);
        const svg3: HTMLElement = document.getElementById(
          'barElement-svg-0-region-series-1-point-0'
        );
    ...
    it('with fill and stroke', (done: Function) => {
      loaded = (args: Object): void => {
        ...
        seriesElements = document.getElementById(
          'barElement-svg-2-region-series-2-point-3'
        );
  ...
  describe('DataLabel', () => {
    ...
    it('Showing default datalabel', (done: Function) => {
      loaded = (args: Object): void => {
        const element: HTMLElement = document.getElementById(
          'barElement-svg-series-0-point-1-data-label'
        );
    ...
    it('Showing default datalabel text', (done: Function) => {
      loaded = (args: Object): void => {
        const element: HTMLElement = document.getElementById(
          'barElement-svg-series-0-point-2-data-label'
        );
    ...
    it('Checking default data label position with multiple series', (done: Function) => {
      loaded = (args: Object): void => {
        const point0: number = +document
          .getElementById('barElement-svg-series-1-point-5-data-label')
          .getAttribute('y');
        const point1: number = +document
          .getElementById('barElement-svg-series-1-point-4-data-label')
          .getAttribute('y');
    ...
    it('Checking data label shape without fill', (done: Function) => {
      loaded = (args: Object): void => {
        const shapeElememt: HTMLElement = document.getElementById(
          'barElement-svg-data-label-series-1-point-2'
        );
    ...
    it('Checking font color saturation - background black', (done: Function) => {
      loaded = (args: Object): void => {
        const textElement: HTMLElement = document.getElementById(
          'barElement-svg-series-1-point-3-data-label'
        );
    ...
    it('Checking font color saturation with font color', (done: Function) => {
      loaded = (args: Object): void => {
        const textElement: Element = document.getElementById(
          'barElement-svg-series-1-point-2-data-label'
        );
    ...
    it('Checking Data label format with globalize format', (done: Function) => {
      loaded = (args: Object): void => {
        const textElement: Element = document.getElementById(
          'barElement-svg-series-1-point-5-data-label'
        );
    ...
    it('Checking margin', (done: Function) => {
      loaded = (args: Object): void => {
        ...
        const text: HTMLElement = document.getElementById(
          'barElement-svg-series-1-point-4-data-label'
        );
