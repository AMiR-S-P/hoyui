  ...
  describe('Stacking Column-100 Series', () => {
    ...
    it('checking datasource in Chart', (done: Function) => {
      ...
      chartObj.loaded = (args: Object) => {
        ...
        expect(svg.getAttribute('d')).toBe(
          'M 185.19626168224298 290.12149532710276 L 185.19626168224298 290.12149532710276 L 674.0934579439252 290.12149532710276 L 674.0934579439252 387.31775700934577 L 185.19626168224298 387.31775700934577 '
        );
        const svg1: HTMLElement = document.getElementById(
          'container-svg-0-region-series-1-point-0'
        );
        expect(svg1.getAttribute('d')).toBe(
          'M 185.19626168224298 104.47663551401868 L 185.19626168224298 104.47663551401868 L 674.0934579439252 104.47663551401868 L 674.0934579439252 290.12149532710276 L 185.19626168224298 290.12149532710276 '
        );
        done();
      };
      chartObj.series[0].dataSource = [
    ...
    it('Checking stacking end values for last series', (done: Function) => {
      loaded = (args: Object): void => {
        ...
        expect(Math.round(series2.stackedValues.endValues[0]) === 100).toBe(
          true
        );
        done();
      };
    ...
    it('Stacking Column-100 Series with negative', (done: Function) => {
      loaded = (args: Object): void => {
        ...
        expect(seriesElements.getAttribute('d')).toBe(
          'M 205.607476635514 132.66355140186914 L 205.607476635514 132.66355140186914 L 278.50467289719626 132.66355140186914 L 278.50467289719626 218.19626168224298 L 205.607476635514 218.19626168224298 '
        );
        const seriesElement1: HTMLElement = document.getElementById(
          'container-svg-0-region-series-0-point-3'
        );
        expect(seriesElement1.getAttribute('d')).toBe(
          'M 451.5140186915887 141.411214953271 L 451.5140186915887 141.411214953271 L 524.411214953271 141.411214953271 L 524.411214953271 218.19626168224298 L 451.5140186915887 218.19626168224298 '
        );
        ...
        expect(seriesElements2.getAttribute('d')).toBe(
          'M 205.607476635514 76.28971962616822 L 205.607476635514 76.28971962616822 L 278.50467289719626 76.28971962616822 L 278.50467289719626 132.66355140186914 L 205.607476635514 132.66355140186914 '
        );
        const seriesElement3: HTMLElement = document.getElementById(
          'container-svg-0-region-series-1-point-3'
        );
        expect(seriesElement3.getAttribute('d')).toBe(
          'M 451.5140186915887 76.28971962616822 L 451.5140186915887 76.28971962616822 L 524.411214953271 76.28971962616822 L 524.411214953271 141.411214953271 L 451.5140186915887 141.411214953271 '
        );
        done();
      };
      chartObj.loaded = loaded;
    ...
    it('Stacking Column-100 Series with Rotation', (done: Function) => {
      loaded = (args: Object): void => {
        ...
        expect(seriesElements.getAttribute('d')).toBe(
          'M 427.1172547121968 309.6679246235514 L 427.1172547121968 309.6679246235514 L 484.1108568248266 313.30402383826873 L 484.1108568248266 398.49143507048086 L 427.1172547121968 391.3475695545069 '
        );
        const seriesElements1: HTMLElement = document.getElementById(
          'container-svg-0-region-series-1-point-3'
        );
        expect(seriesElements1.getAttribute('d')).toBe(
          'M 427.1172547121968 101.48443937270156 L 427.1172547121968 101.48443937270156 L 484.1108568248266 96.18001228299629 L 484.1108568248266 313.30402383826873 L 427.1172547121968 309.6679246235514 '
        );
        done();
      };
      chartObj.loaded = loaded;
      ...
      loaded = (args: Object): void => {
        ...
        expect(
          seriesElements.getAttribute('d') ===
            'M 449.70460959548444 307.8410159924741 L 449.70460959548444 307.8410159924741 L 523.7742238946378 307.8410159924741 L 523.7742238946378 387.75823142050797 L 449.70460959548444 387.75823142050797 '
        ).toBe(true);
        const seriesElements1: HTMLElement = document.getElementById(
          'container-svg-0-region-series-1-point-3'
        );
        expect(
          seriesElements1.getAttribute('d') ===
            'M 449.70460959548444 104.14957666980244 L 449.70460959548444 104.14957666980244 L 523.7742238946378 104.14957666980244 L 523.7742238946378 307.8410159924741 L 449.70460959548444 307.8410159924741 '
        ).toBe(true);
        done();
      };
      chartObj.loaded = loaded;
    ...
    it('Stacking Column-100 Series with perspectiveAngle', (done: Function) => {
      loaded = (args: Object): void => {
        ...
        expect(
          seriesElements.getAttribute('d') ===
            'M 429.14285714285717 273.57142857142856 L 429.14285714285717 273.57142857142856 L 472.57142857142856 273.57142857142856 L 472.57142857142856 320.42857142857144 L 429.14285714285717 320.42857142857144 '
        ).toBe(true);
        const seriesElements1: HTMLElement = document.getElementById(
          'container-svg-0-region-series-1-point-3'
        );
        expect(
          seriesElements1.getAttribute('d') ===
            'M 429.14285714285717 154.14285714285714 L 429.14285714285717 154.14285714285714 L 472.57142857142856 154.14285714285714 L 472.57142857142856 273.57142857142856 L 429.14285714285717 273.57142857142856 '
        ).toBe(true);
        done();
      };
      chartObj.loaded = loaded;
    ...
    it('Stacking Column-100 Series with Tilt', (done: Function) => {
      loaded = (args: Object): void => {
        ...
        expect(
          seriesElements.getAttribute('d') ===
            'M 446.1329280177647 295.3588173746814 L 446.1329280177647 295.3588173746814 L 514.8800364363944 295.3588173746814 L 510.58371177074093 343.2152957206217 L 444.40763228588804 343.2152957206217 '
        ).toBe(true);
        const seriesElements1: HTMLElement = document.getElementById(
          'container-svg-0-region-series-1-point-3'
        );
        expect(
          seriesElements1.getAttribute('d') ===
            'M 451.203254557926 154.7174375851701 L 451.203254557926 154.7174375851701 L 527.5061437030708 154.7174375851701 L 514.8800364363944 295.3588173746814 L 446.1329280177647 295.3588173746814 '
        ).toBe(true);
        done();
      };
      chartObj.loaded = loaded;
    ...
    it('Stacking Column-100 Series Type with ColumnFacet property as Cylinder', (done: Function) => {
      loaded = (args: Object): void => {
        ...
        expect(region10).toBe(
          'M 168.5779387411695 103.67656644015904 L 168.5779387411695 103.67656644015904 L 168.5779387411695 375.9378149799596 L 165.76288736304298 376.1584705595699 L 165.76288736304298 103.49920404389009 '
        );
        const region20: string = document
          .getElementById('container-svg-20-region-series-0-point-1')
          .getAttribute('d');
        expect(region20).toBe(
          'M 170.61682242990653 101.5607476635514 L 170.61682242990653 101.5607476635514 L 170.61682242990653 378.5700934579439 L 173.83337569605072 378.5212045963204 L 173.83337569605072 101.60004440675519 '
        );
        const region25: string = document
          .getElementById('container-svg-25-region-series-0-point-1')
          .getAttribute('d');
        expect(region25).toBe(
          'M 183.84962723238445 102.40991993090253 L 183.84962723238445 102.40991993090253 L 183.84962723238445 377.51364292060947 L 184.77777777777777 377.14814814814815 L 184.77777777777777 102.7037037037037 '
        );
        done();
      };
      chartObj.loaded = loaded;
    ...
    it('Checking Cylindrical chart with negative points', (done: Function) => {
      loaded = (args: Object): void => {
        const region10: string = document
          ...
          .getAttribute('d');
        expect(region10).toBe(
          'M 425.0766939444553 159.0841187745746 L 425.0766939444553 159.0841187745746 L 425.0766939444553 250.7931709142969 L 422.63661739623603 250.83087788043287 L 422.63661739623603 158.9877565277828 '
        );
        const region20: string = document
          .getElementById('container-svg-20-region-series-0-point-0')
          .getAttribute('d');
        expect(region20).toBe(
          'M 431.5887850467289 157.93457943925233 L 431.5887850467289 157.93457943925233 L 431.5887850467289 251.24299065420558 L 434.72225819043047 251.23463622848513 L 434.72225819043047 157.95592963831584 '
        );
        const region25: string = document
          .getElementById('container-svg-25-region-series-0-point-0')
          .getAttribute('d');
        expect(region25).toBe(
          'M 443.0262925753188 158.39594074986044 L 443.0262925753188 158.39594074986044 L 443.0262925753188 251.06245796744594 L 443.3333333333333 250.99999999999997 L 443.3333333333333 158.55555555555554 '
        );
        done();
      };
      chartObj.loaded = loaded;
    ...
    it('Checking margin', (done: Function) => {
      loaded = (args: Object): void => {
        ...
        expect(shape.getAttribute('d')).toBe(
          'M 448.1809744779583 376.24747099767984 L 498.1809744779583 376.24747099767984 L 498.1809744779583 417.24747099767984 L 448.1809744779583 417.24747099767984 L 448.1809744779583 376.24747099767984 z'
        );
