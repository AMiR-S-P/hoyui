  ...
  describe('Column Series', () => {
    ...
    it('checking datasource in Chart', (done: Function) => {
      ...
      chartObj.loaded = (args: Object) => {
        ...
        expect(svg1.getAttribute('d')).toBe(
          'M 171.58878504672896 90.86915887850468 L 171.58878504672896 90.86915887850468 L 672.1495327102804 90.86915887850468 L 672.1495327102804 387.31775700934577 L 171.58878504672896 387.31775700934577 '
        );
        done();
      };
      chartObj.dataSource = [
    ...
    it('with fill and opacity', (done: Function) => {
      loaded = (args: Object): void => {
        ...
        seriesElements = document.getElementById(
          'container-svg-1-region-series-0-point-0'
        );
        expect(seriesElements.getAttribute('fill') === '#ff0000').toBe(true);
        seriesElements = document.getElementById(
          'container-svg-2-region-series-0-point-0'
        );
        expect(seriesElements.getAttribute('fill') === '#E50000').toBe(true);
        seriesElements = document.getElementById(
          'container-svg-3-region-series-0-point-0'
        );
        expect(seriesElements.getAttribute('fill') === '#E50000').toBe(true);
        seriesElements = document.getElementById(
          'container-svg-4-region-series-0-point-0'
        );
        expect(seriesElements.getAttribute('fill') === '#B20000').toBe(true);
        seriesElements = document.getElementById(
          'container-svg-5-region-series-0-point-0'
        );
        expect(seriesElements.getAttribute('fill') === '#B20000').toBe(true);
    ...
    it('Column Series with negative', (done: Function) => {
      loaded = (args: Object): void => {
        ...
        expect(seriesElements.getAttribute('d')).toBe(
          'M 193.94392523364485 238.607476635514 L 193.94392523364485 238.607476635514 L 268.78504672897196 238.607476635514 L 268.78504672897196 302.75700934579436 L 193.94392523364485 302.75700934579436 '
        );
        const seriesElement1: HTMLElement = document.getElementById(
          'container-svg-0-region-series-0-point-3'
        );
        expect(seriesElement1.getAttribute('d')).toBe(
          'M 444.7102803738317 164.73831775700933 L 444.7102803738317 164.73831775700933 L 519.5514018691589 164.73831775700933 L 519.5514018691589 302.75700934579436 L 444.7102803738317 302.75700934579436 '
        );
        done();
      };
      chartObj.loaded = loaded;
    ...
    it('Column Series with Rotation', (done: Function) => {
      loaded = (args: Object): void => {
        ...
        expect(seriesElements.getAttribute('d')).toBe(
          'M 423.5317853273407 165.39587470427938 L 423.5317853273407 165.39587470427938 L 480.9894270907686 162.80831880510846 L 480.9894270907686 398.10017932578154 L 423.5317853273407 390.8981487397558 '
        );
        done();
      };
      chartObj.loaded = loaded;
      ...
      loaded = (args: Object): void => {
        ...
        expect(
          seriesElements.getAttribute('d') ===
            'M 444.8316086547507 166.52398871119473 L 444.8316086547507 166.52398871119473 L 519.8758231420508 166.52398871119473 L 519.8758231420508 387.75823142050797 L 444.8316086547507 387.75823142050797 '
        ).toBe(true);
        done();
      };
      chartObj.loaded = loaded;
    ...
    it('Column Series with perspectiveAngle', (done: Function) => {
      loaded = (args: Object): void => {
        ...
        expect(
          seriesElements.getAttribute('d') ===
            'M 426.2857142857143 190.71428571428572 L 426.2857142857143 190.71428571428572 L 470.2857142857143 190.71428571428572 L 470.2857142857143 320.42857142857144 L 426.2857142857143 320.42857142857144 '
        ).toBe(true);
        done();
      };
      chartObj.loaded = loaded;
    ...
    it('Column Series with Tilt', (done: Function) => {
      loaded = (args: Object): void => {
        ...
        expect(
          seriesElements.getAttribute('d') ===
            'M 444.679604383033 200.96165666523652 L 444.679604383033 200.96165666523652 L 519.4693769372404 200.96165666523652 L 507.1007602189066 343.2152957206217 L 440.0539428460951 343.2152957206217 '
        ).toBe(true);
        done();
      };
      chartObj.loaded = loaded;
    ...
    it('Checking with multiple column series', (done: Function) => {
      loaded = (args: Object): void => {
        ...
        expect(
          seriesElements.getAttribute('d') ===
            'M 443.9090909090909 204 L 443.9090909090909 204 L 517.4090909090909 204 L 517.4090909090909 384.4090909090909 L 443.9090909090909 384.4090909090909 '
        ).toBe(true);
        ...
        expect(
          seriesElements1.getAttribute('d') ===
            'M 442.61764705882354 190.72058823529414 L 442.61764705882354 190.72058823529414 L 513.9558823529412 190.72058823529414 L 513.9558823529412 379.7205882352941 L 442.61764705882354 379.7205882352941 '
        ).toBe(true);
        done();
      };
      chartObj.loaded = loaded;
    ...
    it('Checking with enableSideBySidePlacement', (done: Function) => {
      loaded = (args: Object): void => {
        ...
        expect(seriesElements.getAttribute('d')).toBe(
          'M 445.47368421052636 204.1578947368421 L 445.47368421052636 204.1578947368421 L 478.63157894736844 204.1578947368421 L 478.63157894736844 383.2105263157895 L 445.47368421052636 383.2105263157895 '
        );
        const seriesElements1: HTMLElement = document.getElementById(
          'container-svg-0-region-series-1-point-3'
        );
        expect(seriesElements1.getAttribute('d')).toBe(
          'M 482.42105263157896 189.9473684210527 L 482.42105263157896 189.9473684210527 L 514.6315789473684 189.9473684210527 L 514.6315789473684 383.2105263157895 L 482.42105263157896 383.2105263157895 '
        );
        done();
      };
      chartObj.loaded = loaded;
    ...
    it('Column Series Type with ColumnFacet property as Cylinder', (done: Function) => {
      loaded = (args: Object): void => {
        const region5: string = document
          .getElementById('container-svg-5-region-series-0-point-1')
          .getAttribute('d');
        expect(region5).toBe(
          'M 174.5431562833286 206.8227155656214 L 174.5431562833286 206.8227155656214 L 174.5431562833286 376.1584705595699 L 172.39914924699124 375.9378149799596 L 172.39914924699124 206.8492500973466 '
        );
        ...
        const region15: string = document
          .getElementById('container-svg-15-region-series-0-point-1')
          .getAttribute('d');
        expect(region15).toBe(
          'M 152.33514856917992 206.65975180068622 L 152.33514856917992 206.65975180068622 L 152.33514856917992 377.51364292060947 L 152.9875997681882 377.8558139534884 L 152.9875997681882 206.6186046511628 '
        );
    ...
    it('Checking Cylindrical chart with negative points', (done: Function) => {
      loaded = (args: Object): void => {
        const region5: string = document
          ...
          .getAttribute('d');
        expect(region5).toBe(
          'M 431.8952359069001 231.69689426529743 L 431.8952359069001 231.69689426529743 L 431.8952359069001 329.2802107024881 L 429.3755557635048 329.12798628364305 L 429.3755557635048 231.68711838518809 '
        );
        const region10: string = document
          .getElementById('container-svg-10-region-series-0-point-0')
          .getAttribute('d');
        expect(region10).toBe(
          'M 417.4342729328118 231.68711838518809 L 417.4342729328118 231.68711838518809 L 417.4342729328118 329.12798628364305 L 414.98302395018186 329.2802107024881 L 414.98302395018186 231.69689426529743 '
        );
        const region15: string = document
          .getElementById('container-svg-15-region-series-0-point-0')
          .getAttribute('d');
        expect(region15).toBe(
          'M 411.9944520226225 231.75693354711564 L 411.9944520226225 231.75693354711564 L 411.9944520226225 330.21510809080024 L 413.2294602333045 330.4511627906977 L 413.2294602333045 231.77209302325582 '
        );
        const region20: string = document
          .getElementById('container-svg-20-region-series-0-point-0')
          .getAttribute('d');
        expect(region20).toBe(
          'M 423.8130841121495 231.803738317757 L 423.8130841121495 231.803738317757 L 423.8130841121495 330.94392523364485 L 426.9490326412497 330.9101981075881 L 426.9490326412497 231.8015723555332 '
        );
        const region25: string = document
          .getElementById('container-svg-25-region-series-0-point-0')
          .getAttribute('d');
        expect(region25).toBe(
          'M 435.3040828071867 231.75693354711564 L 435.3040828071867 231.75693354711564 L 435.3040828071867 330.21510809080024 L 435.62962962962956 329.96296296296293 L 435.62962962962956 231.74074074074073 '
        );
        done();
      };
      chartObj.loaded = loaded;
    ...
    it('Checking margin', (done: Function) => {
      loaded = (args: Object): void => {
        ...
        expect(shape.getAttribute('d')).toBe(
          'M 427.3457943925233 128.71046728971965 L 477.3457943925233 128.71046728971965 L 477.3457943925233 169.71046728971965 L 427.3457943925233 169.71046728971965 L 427.3457943925233 128.71046728971965 z'
        );
    ...
    it('Column series group support', (done: Function) => {
      loaded = (): void => {
        ...
        const direction1: string[] = document
          .getElementById('container-svg-0-region-series-1-point-1-front')
          .getAttribute('d')
          .split(' ');
        const point1: number = parseFloat(
          direction1[direction1.indexOf('L') + 1]
        );
        ...
        const direction2: string[] = document
          ...
          .getAttribute('d')
          .split(' ');
        const point2: number = parseFloat(
          direction2[direction2.indexOf('L') + 1]
        );
        const direction3: string[] = document
          .getElementById('container-svg-0-region-series-2-point-2-front')
          .getAttribute('d')
          .split(' ');
        const point3: number = parseFloat(
          direction3[direction3.indexOf('L') + 1]
        );
