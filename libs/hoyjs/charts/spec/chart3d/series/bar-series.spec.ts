...
import { Rect } from '@hoyui/svg-base';
Chart3D.Inject(
  ColumnSeries3D,
  BarSeries3D,
  Category3D,
...
describe('Bar Series', () => {
  ...
  describe('Bar Series', () => {
    ...
    it('checking datasource in Chart', (done: Function) => {
      ...
      chartObj.loaded = (args: Object) => {
        ...
        expect(
          svg1.getAttribute('d') ===
            'M 85.08411214953271 98.98504672897207 L 85.08411214953271 98.98504672897207 L 692.3177570093458 98.98504672897207 L 692.3177570093458 336.43551401869144 L 85.08411214953271 336.43551401869144 '
        ).toBe(true);
        done();
      };
      chartObj.dataSource = [
    ...
    it('with fill and opacity', (done: Function) => {
      loaded = (args: Object): void => {
        ...
        seriesElements = document.getElementById(
          'container-svg-1-region-series-0-point-3'
        );
        expect(seriesElements.getAttribute('fill') === '#ff0000').toBe(true);
        seriesElements = document.getElementById(
        ...
        seriesElements = document.getElementById(
          'container-svg-3-region-series-0-point-3'
        );
        expect(seriesElements.getAttribute('fill') === '#E50000').toBe(true);
        seriesElements = document.getElementById(
        ...
        seriesElements = document.getElementById(
          'container-svg-5-region-series-0-point-3'
        );
        expect(seriesElements.getAttribute('fill') === '#B20000').toBe(true);
      ...
      loaded = (args: Object): void => {
        ...
        expect(
          seriesElements.getAttribute('d') ===
            'M 193.45794392523365 292.28013088124175 L 193.45794392523365 292.28013088124175 L 369.14018691588785 292.28013088124175 L 369.14018691588785 328.2403137405243 L 193.45794392523365 328.2403137405243 '
        ).toBe(true);
        const seriesElement1: HTMLElement = document.getElementById(
          'container-svg-0-region-series-0-point-3'
        );
        expect(
          seriesElement1.getAttribute('d') ===
            'M 193.45794392523365 172.22408731954238 L 193.45794392523365 172.22408731954238 L 574.1028037383177 172.22408731954238 L 574.1028037383177 208.184270178825 L 193.45794392523365 208.184270178825 '
        ).toBe(true);
        done();
      };
      chartObj.loaded = loaded;
    ...
    it('Bar Series with Rotation', (done: Function) => {
      loaded = (args: Object): void => {
        ...
        expect(
          seriesElements.getAttribute('d') ===
            'M 198.55928824400945 180.22862996521485 L 198.55928824400945 180.22862996521485 L 491.93696537368186 168.27213323055636 L 491.93696537368186 206.9250784595185 L 198.55928824400945 210.73471828356315 '
        ).toBe(true);
        done();
      };
      chartObj.loaded = loaded;
    ...
    it('Bar Series with Depth', (done: Function) => {
      loaded = (args: Object): void => {
        ...
        expect(
          seriesElements.getAttribute('d') ===
            'M 75.45813734713076 172.08087169427878 L 75.45813734713076 172.08087169427878 L 533.471495766698 172.08087169427878 L 533.471495766698 208.13863808762488 L 75.45813734713076 208.13863808762488 '
        ).toBe(true);
        done();
      };
      chartObj.loaded = loaded;
    ...
    it('Bar Series with perspectiveAngle', (done: Function) => {
      loaded = (args: Object): void => {
        ...
        expect(
          seriesElements.getAttribute('d') ===
            'M 209.71428571428572 193.97240298456612 L 209.71428571428572 193.97240298456612 L 478.25714285714287 193.97240298456612 L 478.25714285714287 215.1138291710674 L 209.71428571428572 215.1138291710674 '
        ).toBe(true);
        done();
      };
      chartObj.loaded = loaded;
    ...
    it('Bar Series with Tilt', (done: Function) => {
      loaded = (args: Object): void => {
        ...
        expect(
          seriesElements.getAttribute('d') ===
            'M 77.4940192473562 204.93584446497638 L 77.4940192473562 204.93584446497638 L 532.6342164086323 204.93584446497638 L 530.190800482979 230.17545960687355 L 83.43529345869275 230.17545960687355 '
        ).toBe(true);
        done();
      };
      chartObj.loaded = loaded;
    ...
    it('Checking with multiple Bar series', (done: Function) => {
      loaded = (args: Object): void => {
        ...
        expect(
          seriesElements.getAttribute('d') ===
            'M 82.13636363636364 173.1698095310366 L 82.13636363636364 173.1698095310366 L 489.9442148760331 173.1698095310366 L 489.9442148760331 208.48560100166947 L 82.13636363636364 208.48560100166947 '
        ).toBe(true);
        ...
        expect(
          seriesElements1.getAttribute('d') ===
            'M 91.48529411764706 174.69422689777082 L 91.48529411764706 174.69422689777082 L 517.7459893048127 174.69422689777082 L 517.7459893048127 208.9713186192674 L 91.48529411764706 208.9713186192674 '
        ).toBe(true);
        done();
      };
      chartObj.loaded = loaded;
      ...
      chartObj.series = [
        chartObj.series[0],
        {
          ...
          dataSource: [
            { x: new Date(2000, 6, 11), y: 12 },
            { x: new Date(2002, 3, 7), y: 35 },
            { x: new Date(2004, 3, 6), y: 20 },
            { x: new Date(2006, 3, 30), y: 70 },
            { x: new Date(2008, 3, 8), y: 85 },
            { x: new Date(2010, 3, 8), y: 92 },
          ],
          xName: 'x',
          yName: 'y',
        },
    ...
    it('Checking with enableSideBySidePlacement', (done: Function) => {
      loaded = (args: Object): void => {
        ...
        expect(seriesElements.getAttribute('d')).toBe(
          'M 84.5263157894737 191.96089629332099 L 84.5263157894737 191.96089629332099 L 489.2679425837321 191.96089629332099 L 489.2679425837321 207.7335129350923 L 84.5263157894737 207.7335129350923 '
        );
        const seriesElements1: HTMLElement = document.getElementById(
          'container-svg-0-region-series-1-point-3'
        );
        expect(seriesElements1.getAttribute('d')).toBe(
          'M 84.5263157894737 174.43576669135277 L 84.5263157894737 174.43576669135277 L 520.4019138755981 174.43576669135277 L 520.4019138755981 190.2083833331241 L 84.5263157894737 190.2083833331241 '
        );
        done();
      };
      chartObj.loaded = loaded;
  ...
  describe('Bar Series in Cylinderical shape', () => {
    ...
    it('Bar Series Type with ColumnFacet property as Cylinder', (done: Function) => {
      loaded = (args: Object): void => {
        const region1: string = document
          .getElementById('container-svg-21-region-series-0-point-1')
          .getAttribute('d');
        expect(region1).toBe(
          'M 55.66313810520663 316.5482791627418 L 55.66313810520663 316.5482791627418 L 431.4268009165953 316.5482791627418 L 431.4031913755856 318.8373000426884 L 55.92182289096158 318.8373000426884 '
        );
        done();
      };
      chartObj.loaded = loaded;
    ...
    it('Checking Cylindrical chart with negative points', (done: Function) => {
      loaded = (args: Object): void => {
        const region5: string = document
          .getElementById('container-svg-5-region-series-0-point-0')
          .getAttribute('d');
        expect(region5).toBe(
          'M 163.32325267167215 210.97367523057503 L 163.32325267167215 210.97367523057503 L 377.1455195708105 210.97367523057503 L 377.1788817013422 208.52102969364364 L 163.66874468855121 208.52102969364364 '
        );
        const region10: string = document
          .getElementById('container-svg-10-region-series-0-point-0')
          .getAttribute('d');
        expect(region10).toBe(
          'M 163.66874468855121 196.57974686295063 L 163.66874468855121 196.57974686295063 L 377.1788817013422 196.57974686295063 L 377.1455195708105 194.06146327385682 L 163.32325267167215 194.06146327385682 '
        );
        const region15: string = document
          .getElementById('container-svg-15-region-series-0-point-0')
          .getAttribute('d');
        expect(region15).toBe(
          'M 161.2013882118587 190.6611934138298 L 161.2013882118587 190.6611934138298 L 376.9406236090499 190.6611934138298 L 376.88888888888886 191.7922509309789 L 160.66563307493539 191.7922509309789 '
        );
        const region20: string = document
          .getElementById('container-svg-20-region-series-0-point-0')
          .getAttribute('d');
        expect(region20).toBe(
          'M 159.54724818276216 202.15887850467288 L 159.54724818276216 202.15887850467288 L 376.78089304257526 202.15887850467288 L 376.7882848184185 205.30967934616507 L 159.62379603818061 205.30967934616507 '
        );
        const region25: string = document
          .getElementById('container-svg-25-region-series-0-point-0')
          .getAttribute('d');
        expect(region25).toBe(
          'M 161.2013882118587 213.97082419839398 L 161.2013882118587 213.97082419839398 L 376.9406236090499 213.97082419839398 L 376.9958847736625 214.4074074074074 L 161.7736625514403 214.4074074074074 '
        );
        done();
      };
      chartObj.loaded = loaded;
  ...
  describe('DataLabel', () => {
    ...
    it('Checking dataLabel positions Bottom', (done: Function) => {
      loaded = (args: Object): void => {
        ...
        expect(textElement.getAttribute('y') === '209.26185283947447').toBe(
          true
        );
        expect(textElement.getAttribute('x') === '54.58969837587008').toBe(
          true
        );
        const textElement1: Element = document.getElementById(
          'container-svg-series-1-point-3-data-label'
        ...
        expect(textElement1.getAttribute('y') === '190.2302262692821').toBe(
          true
        );
        expect(textElement1.getAttribute('x') === '54.58969837587008').toBe(
          true
        );
        done();
      };
    ...
    it('Checking margin', (done: Function) => {
      loaded = (args: Object): void => {
        ...
        expect(shape.getAttribute('d')).toBe(
          'M 522.4766355140187 177.01153872386328 L 572.4766355140187 177.01153872386328 L 572.4766355140187 218.01153872386328 L 522.4766355140187 218.01153872386328 L 522.4766355140187 177.01153872386328 z'
        );
    ...
    it('Checking Data label template', (done: Function) => {
      loaded = (args: Object): void => {
        ...
        expect(
          document.getElementById('container-series-0-data-label-5').style.left
        ).toBe('728.748px');
        done();
      };
      chartObj.loaded = loaded;
    ...
    it('Checking Data label event with cancel as false', (done: Function) => {
      loaded = (args: Chart3DLoadedEventArgs): void => {
        ...
        args.chart.dataLabel3DModule.calculateTemplateLabelSize(
          document.getElementById('container-series-0-data-label-collections'),
          document.getElementById('container-series-0-data-label-0') as any,
          args.chart.visibleSeries[0].points[0],
          args.chart.visibleSeries[0],
          args.chart.series[0].dataLabel,
          new Rect(0, 0, 0, 0),
          false,
          { x: 0, y: 0 },
          true
  ...
  describe('Bar series with grouping support', () => {
    ...
    it('Bar series group support', (done: Function) => {
      loaded = (): void => {
        const direction: string = document
          .getElementById('container-svg-0-region-series-0-point-1')
          .getAttribute('d');
        expect(
          direction ===
            'M 68.34270952927669 248.01974741676233 L 68.34270952927669 248.01974741676233 L 578.2738231917336 248.01974741676233 L 578.2738231917336 277.74144661308844 L 68.34270952927669 277.74144661308844 '
        ).toBe(true);
        const direction1: string = document
          .getElementById('container-svg-1-region-series-1-point-1-front')
          .getAttribute('d');
        expect(
          direction1 ===
            'M 240.3879456706282 247.69405772495756 L 240.3879456706282 247.69405772495756 L 72.81578947368422 247.69405772495756 L 72.81578947368422 236.29915110356538 L 240.3879456706282 236.29915110356538 '
        ).toBe(true);
        const direction2: string = document
          .getElementById('container-svg-0-region-series-0-point-2')
          .getAttribute('d');
        expect(
          direction2 ===
            'M 68.34270952927669 137.93938002296207 L 68.34270952927669 137.93938002296207 L 691.5918484500573 137.93938002296207 L 691.5918484500573 167.66107921928815 L 68.34270952927669 167.66107921928815 '
        ).toBe(true);
        chartObj.loaded = null;
        done();
      };
  ...
  describe('EmptyPoint Settings', () => {
    ...
    it('Empty points Zero mode', (done: Function) => {
      loaded = (args: Object): void => {
        const region1: string = document
          .getElementById('container-svg-1-region-series-0-point-1')
          .getAttribute('d');
        expect(region1).toBe(
          'M 59.72350230414747 303.2984499371596 L 59.72350230414747 303.2984499371596 L 431.0562211981567 303.2984499371596 L 431.0562211981567 322.6345203183913 L 59.72350230414747 322.6345203183913 '
        );
        done();
      };
    ...
    it('Empty points Gap mode', (done: Function) => {
      loaded = (args: Object): void => {
        const region1: Element = document.getElementById(
          'container-svg-0-region-series-0-point-6'
        );
