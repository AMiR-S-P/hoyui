...
let value: number = 0;
let data: Points[] = [];
const seriesCollection: Chart3DSeriesModel[] = [];
const colors: string[] = [
  '#663AB6',
  '#EB3F79',
  '#F8AB1D',
...
describe('Chart Legend', () => {
  ...
  describe('Chart Control Legend Checking', () => {
    ...
    const series: Chart3DSeriesModel[] = [
      seriesCollection[0],
      seriesCollection[1],
      seriesCollection[2],
      seriesCollection[3],
    ...
    it('Style font, background, padding', (done: Function) => {
      loaded = (args: Object): void => {
        chartObj.loaded = null;
        const legendgroup: Element = document.getElementById(
          legendId + '_element'
        );
  ...
  describe('Legend title checking', () => {
    ...
    it('legend with RTL', (done: Function) => {
      chartObj.loaded = (args: Object): void => {
        const legendText: Element = document.getElementById(
          'container_chart_legend_text_0'
        );
