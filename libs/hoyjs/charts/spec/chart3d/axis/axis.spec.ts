  ...
  describe('Axis Behavior', () => {
    ...
    it('Checking bottom wall brushes', (done: Function) => {
      loaded = (args: Object): void => {
        let axis = document.getElementById(
          'chartContainer-svg-2-bottom-wall-brush'
        );
        expect(
          parseFloat(axis.getAttribute('d').split(' ')[5]) ===
            parseFloat(axis.getAttribute('d').split(' ')[2])
        ).toBe(true);
        axis = document.getElementById(
          'chartContainer-svg-1-bottom-wall-brush-back'
        );
        expect(
          parseFloat(axis.getAttribute('d').split(' ')[5]) ===
            parseFloat(axis.getAttribute('d').split(' ')[2])
    ...
    it('Checking left wall brushes', (done: Function) => {
      loaded = (args: Object): void => {
        let axis = document.getElementById(
          'chartContainer-svg-1-left-wall-brush-back'
        );
        expect(
          parseFloat(axis.getAttribute('d').split(' ')[5]) ===
            parseFloat(axis.getAttribute('d').split(' ')[2])
        ...
        axis = document.getElementById(
          'chartContainer-svg-0-left-wall-brush-back'
        );
        expect(
          parseFloat(axis.getAttribute('d').split(' ')[5]) ===
            parseFloat(axis.getAttribute('d').split(' ')[2])
    ...
    it('Checking Xaxis title default position', (done: Function) => {
      loaded = (args: Object): void => {
        let area: HTMLElement = document.getElementById(
          'chartContainer-svg-axis-title-0'
        );
    ...
    it('Checking Yaxis title default position', (done: Function) => {
      loaded = (args: Object): void => {
        let area: HTMLElement = document.getElementById(
          'chartContainer-svg-axis-title-1'
        );
    ...
    it('Checking Xaxis title Rotation', (done: Function) => {
      loaded = (args: Object): void => {
        ...
        expect(area.getAttribute('transform')).toBe(
          'rotate(90,402.1522411128284,424.12881040499417)'
        );
        done();
      };
      chartObj.loaded = loaded;
    ...
    it('Checking Yaxis title Rotation', (done: Function) => {
      loaded = (args: Object): void => {
        ...
        expect(area.getAttribute('transform')).toBe(
          'rotate(90,16.25463678516229,186.80423544363407)'
        );
        done();
      };
      chartObj.loaded = loaded;
    ...
    it('Checking Xaxis label rotation', (done: Function) => {
      loaded = (args: Object): void => {
        ...
        expect(label.getAttribute('transform')).toBe(
          'rotate(45,59.40455950540958,377.660978252405)'
        );
        done();
      };
      chartObj.loaded = loaded;
    ...
    it('Checking Yaxis label rotation', (done: Function) => {
      loaded = (args: Object): void => {
        let label = document.getElementById('chartContainer-1-axis-label-0');
        expect(label.getAttribute('transform')).toBe(
          'rotate(45,60.52462913595727,357.3918083462133)'
        );
        done();
      };
      chartObj.loaded = loaded;
    ...
    it('Checking Major GridLine and Tick Lines with opposed position', (done: Function) => {
      loaded = (args: Object): void => {
        svg = document.getElementById(
          'chartContainer1-0-parallel-grid-lines-0'
        );
        expect(svg.getAttribute('stroke') == '#C2C924').toBe(true);
        expect(svg.getAttribute('stroke-width') == '2').toBe(true);
  ...
  describe('Checking the label intersect action', () => {
    ...
    it('checking with label intersect action as MultipleRows', (done: Function) => {
      loaded = (args: Object): void => {
        ...
        let thirdLabel: HTMLElement = document.getElementById(
          'chartContainer2-0-axis-label-4'
        );
        let fourthLabel: HTMLElement = document.getElementById(
          'chartContainer2-0-axis-label-3'
        );
        expect(firstLabel.getAttribute('y')).toEqual(
          fourthLabel.getAttribute('y')
        );
        expect(secondLabel.getAttribute('y')).toEqual(
          thirdLabel.getAttribute('y')
        );
        done();
      };
      chartObj.loaded = loaded;
      chartObj.series[0].dataSource = [
        { x: 'South Korea custom Labels', y: 39.4 },
        { x: 'India custom Labels', y: 61.3 },
        { x: 'Pakistan custom Labels', y: 20.4 },
        { x: 'Germany custom Labels', y: 65.1 },
        { x: 'Australia custom Labels', y: 15.8 },
        { x: 'Italy custom Labels', y: 29.2 },
      ];
      chartObj.primaryXAxis = {
