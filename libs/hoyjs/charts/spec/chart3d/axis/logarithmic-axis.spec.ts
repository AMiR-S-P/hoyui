  ...
  describe(' Logarithmic Axis Behavior', () => {
    ...
    it('Checking Xaxis label rotation', (done: Function) => {
      loaded = (args: Object): void => {
        ...
        expect(label.getAttribute('transform')).toBe(
          'rotate(45,59.40455950540958,380.78148459651186)'
        );
        done();
      };
      chartObj.loaded = loaded;
      ...
      chartObj.loaded = (args: Object): void => {
        ...
        expect(
          tick.getBoundingClientRect().top == 304.3954162597656 ||
            tick.getBoundingClientRect().top == 193.7574462890625
        ).toBe(true);
        done();
      };
    ...
    it('Checking with series', (done: Function) => {
      chartObj.loaded = (args: Object): void => {
        ...
        expect(
          parseInt(tick.getAttribute('x')) == 158 ||
            parseInt(tick.getAttribute('x')) == 73
        ).toBe(true);
        done();
      };
