...
describe('Chart Control', () => {
  ...
  describe('Category Axis Behavior', () => {
    ...
    it('Checking axis label with plotOffsetTop', (done: Function) => {
      chartObj.loaded = (args: Object): void => {
        ...
        expect(
          parseInt(tick.getAttribute('x')) === 111 ||
            parseInt(tick.getAttribute('x')) === 120
        ).toBe(true);
        done();
      };
    ...
    it('Checking axis label with plotOffsetLeft', (done: Function) => {
      chartObj.loaded = (args: Object): void => {
        ...
        expect(
          parseInt(tick.getAttribute('x')) === 124 ||
            parseInt(tick.getAttribute('x')) === 119
        ).toBe(true);
        done();
      };
    ...
    it('Checking axis label with axis opposite', (done: Function) => {
      chartObj.loaded = (args: Object): void => {
        ...
        expect(
          parseInt(tick.getAttribute('x')) === 70 ||
            parseInt(tick.getAttribute('x')) === 65
        ).toBe(true);
        done();
      };
  ...
  describe('category Axis Behavior', () => {
    ...
    it('Checking axis with row multiple planes', (done: Function) => {
      chartObj.loaded = (args: Object): void => {
        let tick: Element = document.getElementById(
          'chartContainer-1-axis-label-5'
        );
        expect(tick !== null).toBe(true);
        let tick1: Element = document.getElementById(
          'chartContainer-2-axis-label-0'
        );
    ...
    it('Checking axis with multiple columns', (done: Function) => {
      ...
      (chartObj.series[1].xAxisName = 'xAxis'), chartObj.refresh();
    });
    it('Checking axis with multiple columns', (done: Function) => {
      chartObj.loaded = (args: Object): void => {
        let tick: Element = document.getElementById(
