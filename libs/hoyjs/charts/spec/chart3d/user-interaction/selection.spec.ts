import { Browser, createElement, EmitType } from '@hoyui/base';
...
import {
  ...
  secondSeries,
  thirdSeries,
} from '../../chart/base/data.spec';
import { Selection3D } from '../../../src/chart3d/user-interaction/selection';

Chart3D.Inject(ColumnSeries3D, BarSeries3D, Highlight3D, Legend3D, Selection3D);
...
describe('3DChart Control Selection ', () => {
  ...
  it('MultiSelect false Selection Mode Point', (done: Function) => {
    loaded = () => {
      element = document.getElementById(
        id + '-svg-0-region-series-0' + '-point-3'
      );
      ...
      trigger.clickEvent(element);
      element = document.getElementById(
        id + '-svg-0-region-series-0' + '-point-5'
      );
      trigger.clickEvent(element);
  ...
  it('MultiSelect false Selection Mode Cluster', (done: Function) => {
    loaded = () => {
      ...
      trigger.clickEvent(element);
      element = document.getElementById(
        id + '-svg-0-region-series-1' + '-point-2'
      );
      trigger.clickEvent(element);
  ...
  it('MultiSelect false Selection Mode Series', (done: Function) => {
    loaded = () => {
      ...
      trigger.clickEvent(element);
      element = document.getElementById(
        id + '-svg-0-region-series-1' + '-point-3'
      );
      trigger.clickEvent(element);
  ...
  it('MultiSelect true Selection Mode Series', (done: Function) => {
    loaded = () => {
      ...
      trigger.clickEvent(element);
      element = document.getElementById(
        id + '-svg-0-region-series-2' + '-point-' + 3
      );
      trigger.clickEvent(element);
      ...
      element = document.getElementById(
        id + '-svg-0-region-series-0' + '-point-' + 2
      );
      trigger.clickEvent(element);
      element = document.getElementById(
        id + '-svg-0-region-series-1' + '-point-' + 4
      );
      trigger.clickEvent(element);
      element = document.getElementById(
        id + '-svg-0-region-series-2' + '-point-' + 3
  ...
  it('MultiSelect true Selection Mode Point', (done: Function) => {
    loaded = () => {
      ...
      trigger.clickEvent(element);
      element = document.getElementById(
        id + '-svg-0-region-series-2' + '-point-' + 4
      );
      trigger.clickEvent(element);
  ...
  it('Multiple Series selection and UnSelection', (done: Function) => {
    loaded = () => {
      ...
      for (i = 0, length = seriesCollection.length; i < length; i++) {
        element = document.getElementById(
          id + '-svg-0-region-series-' + i + '-point-0'
        );
        trigger.clickEvent(element);
      ...
      for (; i > 0; i--) {
        element = document.getElementById(
          id + '-svg-0-region-series-' + (i - 1) + '-point-4'
        );
        trigger.clickEvent(element);
  ...
  it('Single Cluster selection and UnSelection', (done: Function) => {
    loaded = () => {
      ...
      element = document.getElementById(
        id + '-svg-0-region-series-1-point-' + index
      );
      trigger.clickEvent(element);
      ...
      element = document.getElementById(
        id + '-svg-0-region-series-0-point-' + index
      );
      trigger.clickEvent(element);
      for (i = 0; i < seriesCollection.length; i++) {
        selected = document.getElementsByClassName(selection + i);
  ...
  it('Multiple Cluster selection and UnSelection', (done: Function) => {
    loaded = () => {
      element = document.getElementById(
        id + '-svg-0-region-series-1-point-' + 1
      );
      trigger.clickEvent(element);
      element = document.getElementById(
        id + '-svg-0-region-series-0-point-' + 3
      ...
      trigger.clickEvent(element);
      element = document.getElementById(
        id + '-svg-0-region-series-2-point-' + 5
      );
      trigger.clickEvent(element);
      for (i = 0; i < seriesCollection.length; i++) {
        selected = document.getElementsByClassName(selection + i);
...
describe('Point color mapping chart highlight and selection', function () {
  ...
  it('Point color mapping chart  point Selection in Point mode', function (done) {
    loaded = function () {
      ...
      expect(
        document
          .getElementById(id + '-svg-0-region-series-0' + '-point-' + 0)
          .getAttribute('class') ===
          id + '_ej2_chart_selection_series_0'
      ).toBe(true);
      expect(
        document
          .getElementById(id + '-svg-0-region-series-0' + '-point-' + 3)
          .getAttribute('class') ===
          id + '_ej2_deselected'
      ).toBe(true);
      done();
  ...
  it('Point color mapping chart  point highlighted in Cluster Mode', function (done) {
    loaded = function () {
      ...
      expect(
        document
          .getElementById(id + '-svg-0-region-series-1' + '-point-' + 0)
          .getAttribute('class') ===
  ...
  it('Point color mapping chart legend', function (done) {
    loaded = function () {
      ...
      trigger.clickEvent(element1);
      element1 = document.getElementById(
        id + '-svg-0-region-series-1' + '-point-' + 0
      );
  ...
  it('selection checking index finder', function (done) {
    loaded = function (args: Chart3DLoadedEventArgs) {
      ...
      args.chart.selection3DModule.highlightDataIndexes = [
        { series: 0, point: 0 },
      ] as any;
      args.chart.selection3DModule.styleId =
        'PointColorMapping_ej2_chart_highlight';
      args.chart.selection3DModule.redrawSelection(args.chart, null, null);
      let element: HTMLElement = document.getElementById(id);
      args.chart.selectionMode = 'None';
      args.chart.selection3DModule.isAlreadySelected(element, 'click', [
        { series: 0, point: 0 },
      ] as any);
      expect(element !== null).toBe(true);
      done();
