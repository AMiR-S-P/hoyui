...
} from '../../src/stock-chart/model/base';
...
describe('Stock Chart', () => {
  ...
  describe('default stock chart', () => {
    ...
    it('checked with custom periods', (done: Function) => {
      ...
      chart.periods = [
        { interval: 1, intervalType: 'Years', text: '1M' },
        { interval: 2, intervalType: 'Years', text: '2M' },
    ...
    it('Checking with panning mouse events', (done: Function) => {
      ...
      chart.loaded = (args: Object): void => {
        chart.loaded = null;
        let previousRange: VisibleRangeModel = (
          chart.chart.primaryXAxis as Axis
        ).visibleRange;
        ...
        let currentRange: VisibleRangeModel = (chart.chart.primaryXAxis as Axis)
          .visibleRange;
  ...
  describe('checking datetime category in stock chart', () => {
    ...
    it('Checking default date time category', (done: Function) => {
      chart.loaded = (args: Object): void => {
        ...
        expect(
          element.childNodes[1].firstChild.textContent === '1/30/2017' ||
            element.childNodes[1].firstChild.textContent === 'Feb 13'
        ).toBe(true);
        done();
      };
      chart.refresh();
    ...
    it('Checking default date time category with unordered data', (done: Function) => {
      chart.loaded = (args: Object): void => {
        element = document.getElementById('stock_stockChart_chartAxisLabels0');
        expect(
          element.childNodes[1].firstChild.textContent === '4/23/2012' ||
            element.childNodes[1].firstChild.textContent === '4/30/2012'
        ).toBe(true);
        done();
      };
      chart.series = [
    ...
    it('Checking with year as interval type ', (done: Function) => {
      chart.loaded = (args: Object): void => {
        element = document.getElementById('stock_stockChart_chartAxisLabels0');
        expect(element.childNodes[0].firstChild.textContent).toEqual(
          'Jan 2017'
        );
        done();
      };
    ...
    it('Checking with panning mouse events', (done: Function) => {
      ...
      chart.loaded = (args: Object): void => {
        chart.loaded = null;
        const previousRange: VisibleRangeModel = (
          chart.chart.primaryXAxis as Axis
        ).visibleRange;
        ...
        chart.stockChartOnMouseMove(<PointerEvent>eventObj);
        const currentRange: VisibleRangeModel = (
          chart.chart.primaryXAxis as Axis
        ).visibleRange;
        //expect(previousRange.min).not.toEqual(currentRange.min);
        eventObj = {
  ...
  describe('checking stock chart', () => {
    ...
    it('Checking default label position category', (done: Function) => {
      chart.loaded = (args: Object): void => {
        ...
        expect(
          element.childNodes[1].firstChild.textContent === '1/30/2017' ||
            element.childNodes[1].firstChild.textContent
        ).toBe('4/16/2012');
        done();
      };
      chart.refresh();
    ...
    it('Checking point click and point move', (done: Function) => {
      chart.loaded = (args: Object): void => {
        setTimeout(() => {
          element = document.getElementById(
            'stock_stockChart_chart_Series_0_Point_2'
          );
      ...
      chart.pointMove = (args: IPointEventArgs) => {
        args.cancel = false;
      };
      chart.refresh();
    });
