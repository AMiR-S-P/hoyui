...
describe('Smithchart legend properties tesing', () => {
  ...
  describe('Legend testing', () => {
          ...
          series: [
            ...
            },
            {
              points: [
                ...
                { resistance: 1.5, reactance: 1.0 },
                { resistance: 2.0, reactance: 1.2 },
                { resistance: 2.5, reactance: 1.3 },
                { resistance: 3.5, reactance: 1.6 },
                { resistance: 4.5, reactance: 2.0 },
                { resistance: 6.0, reactance: 4.5 },
    ...
    it('Checking with legend  with description', () => {
      smithchart.loaded = (args: ISmithchartLoadedEventArgs) => {
        let element: Element = document.getElementById(
          smithchart.element.id + '_legend_group'
        );
        expect(element.childElementCount).toBeGreaterThanOrEqual(1);
      };
      smithchart.legendSettings.description =
        'It represents to show and hide the legend series';
      smithchart.refresh();
    });
    ...
    it('Checking with legend title with description', () => {
      ...
      smithchart.legendSettings.title.text = 'legendgroup';
      smithchart.legendSettings.title.description =
        'It represents the legend title';
      smithchart.refresh();
    });
    ...
    it('checking legend title with alignement center ', () => {
      ...
      smithchart.legendSettings.title.text =
        'smithchartlegendtitlegrouptextrendering';
