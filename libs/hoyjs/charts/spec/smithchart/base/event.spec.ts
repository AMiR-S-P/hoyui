...
describe('Smithchart tooltip spec', () => {
  ...
  describe('Events spec', () => {
    ...
    it('Checking Load Event', (done: Function) => {
      smithchart.loaded = (args: ISmithchartLoadedEventArgs): void => {
        svg = document.getElementById(
          'container_svg_horizontalAxisMajorGridLines'
        );
    ...
    it('Checking axis Label location', (done: Function) => {
      smithchart.axisLabelRender = (
        args: ISmithchartAxisLabelRenderEventArgs
      ): void => {
        if (args.text === '0.5') {
          args.x = 700;
          args.y = 100;
    ...
    it('Checking load event', (done: Function) => {
      ...
      smithchart.loaded = (args: ISmithchartLoadedEventArgs): void => {
        svg = document.getElementById('container_Title_Group');
        expect(svg.childElementCount).toBe(1);
        expect(svg.children[0].textContent).toBe(
          'Transmission of resistance value'
        );
        done();
      };
    ...
    it('Checking legend event fill', (done: Function) => {
      smithchart.legendRender = (
        args: ISmithchartLegendRenderEventArgs
      ): void => {
        args.fill = 'red';
      };
      smithchart.loaded = (args: ISmithchartLoadedEventArgs): void => {
  ...
  describe('Events spec', () => {
    ...
    it('Checking Datalabel Event', (done: Function) => {
      ...
      smithchart.loaded = (args: ISmithchartLoadedEventArgs): void => {
        ...
        svg = document.getElementById(
          'container_Series0_Points0_dataLabel_displayText0'
        );
