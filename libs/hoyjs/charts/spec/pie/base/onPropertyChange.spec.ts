...
describe('Accumulation Chart Control', () => {
  ...
  describe('accumulation on-property-change checking on', () => {
    ...
    it('height, width, margin change checking', (done: Function) => {
      ...
      accumulation.margin.left =
        accumulation.margin.right =
        accumulation.margin.top =
        accumulation.margin.bottom =
          5;
    ...
    it('dataLabel visible change checking', (done: Function) => {
      ...
      accumulation.loaded = (args: IAccLoadedEventArgs) => {
        accumulation.loaded = null;
        let dataLabel: Element = getElement(
          'acc-chart_datalabel_Series_0_text_1'
        );
    ...
    it('datasource change and datalabel changed checking', (done: Function) => {
      ...
      accumulation.loaded = (args: IAccLoadedEventArgs) => {
        ...
        let dataLabel: Element = getElement(
          'acc-chart_datalabel_Series_0_text_9'
        );
    ...
    it('enableSmartLabels change checking', (done: Function) => {
      ...
      let dataLabel: Element = getElement(
        'acc-chart_datalabel_Series_0_text_0'
      );
      let temp: number = parseInt(dataLabel.getAttribute('x'), 10);
      expect(temp === 223 || temp === 226).toBe(true);
      ...
      expect(temp === 256 || temp === 258).toBe(true);
      temp = parseInt(dataLabel.getAttribute('y'), 10);
    ...
    it('Selection change checking', (done: Function) => {
      ...
      expect(slice.getAttribute('class')).toBe(
        'acc-chart_ej2_chart_selection_series_0' + '_point_3'
      );
      ...
      expect(slice.getAttribute('class')).toBe(
        'acc-chart_ej2_chart_selection_series_0' + '_point_7'
      );
      done();
    });
    ...
    it('Annotation change checking', (done: Function) => {
      ...
      annotation = getElement('acc-chart_Secondary_Element');
      expect(annotation.children[0].id).toBe(
        'acc-chart_Annotation_Collections'
      );
      expect(annotation.children[0].children[0].id).toBe(
        'acc-chart_Annotation_0'
      );
      done();
    });
    ...
    it('Legend shape change checking', (done: Function) => {
      ...
      let path: string = getElement(
        'acc-chart_chart_legend_shape_0'
      ).getAttribute('d');
      accumulation.loaded = (args: IAccLoadedEventArgs) => {
        accumulation.loaded = null;
        let path1: string = getElement(
          'acc-chart_chart_legend_shape_0'
        ).getAttribute('d');
    ...
    it('Series palettes change checking', (done: Function) => {
      ...
      accumulation.series[0].palettes = [
        'skyblue',
        'lightgreen',
        'turquoise',
        'teal',
