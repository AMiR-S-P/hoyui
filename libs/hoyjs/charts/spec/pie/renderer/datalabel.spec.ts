...
describe('Accumulation Chart Control', () => {
  ...
  describe('Data Label checking for the pie doughnut series', () => {
    ...
    beforeAll((): void => {
      ...
      let template2: Element = createElement('div', {
        id: 'template2',
        styles: 'display: none;',
      });
    ...
    it('Datalabel Inside checking', (done: Function) => {
      accumulation.loaded = (args: IAccLoadedEventArgs) => {
        ...
        expect(
          withInBounds(
            points[3].labelRegion.x,
            points[3].labelRegion.y,
            accumulation.visibleSeries[0].accumulationBound,
            points[3].labelRegion.width,
            points[3].labelRegion.height
          )
        ).toBe(true);
        done();
      };
    ...
    it('Datalabel Inside Smart Labels checking with title bound', (done: Function) => {
      accumulation.loaded = (args: IAccLoadedEventArgs) => {
        ...
        expect(isOverlap(points[0].labelRegion, points[5].labelRegion)).toBe(
          false
        );
        expect(
          isOverlap(
            points[0].labelRegion,
            accumulation.accumulationDataLabelModule.titleRect
          )
        ).toBe(false);
        done();
      };
    ...
    it('Datalabel Outside Smart Labels checking with title bound', (done: Function) => {
      accumulation.loaded = (args: IAccLoadedEventArgs) => {
        points = args.accumulation.visibleSeries[0].points;
        expect(isOverlap(points[2].labelRegion, points[5].labelRegion)).toBe(
          false
        );
        expect(
          isOverlap(
            points[2].labelRegion,
            accumulation.accumulationDataLabelModule.titleRect
          )
        ).toBe(false);
        done();
    ...
    it('Datalabel trimmed label mouse move tooltip', () => {
      ...
      datalabel = getElement(labelId + 4);
      accumulation.accumulationMouseEnd(
        trigger.onTouchEnd(datalabel, 0, 0, 210, 480, 210, 480) as PointerEvent
      );
    ...
    it('checking text render event', (done: Function) => {
      accumulation.loaded = (args: IAccLoadedEventArgs): void => {
        let element: HTMLElement = document.getElementById(
          'ej2container_datalabel_Series_0_shape_1'
        );
        expect(+element.getAttribute('stroke-width')).toEqual(2);
        element = document.getElementById(
          'ej2container_datalabel_Series_0_shape_2'
        );
    ...
    it('Checking font color change using text render event', (done: Function) => {
      accumulation.loaded = (args: IAccLoadedEventArgs): void => {
        let textElement: HTMLElement = document.getElementById(
          'ej2container_datalabel_Series_0_text_1'
        );
      ...
      accumulation.textRender = (args: IAccTextRenderEventArgs): void => {
        if (args.text.indexOf('Bison : 23') > -1) {
          ...
          (args.font.fontFamily = 'Segoe UI'), (args.color = 'yellow');
          args.border.width = 1;
    ...
    it('checking elements counts without using template', (done: Function) => {
      accumulation.loaded = (args: IAccLoadedEventArgs): void => {
        let element: HTMLElement = document.getElementById(
          'ej2container_datalabel_Series_0_text_0'
        );
    ...
    it('checking elements counts with using template without element', (done: Function) => {
      accumulation.loaded = (args: IAccLoadedEventArgs): void => {
        let element: HTMLElement = document.getElementById(
          'ej2container_datalabel_Series_0_text_4'
        );
        expect(element).toBe(null);
        element = document.getElementById('ej2container_Secondary_Element');
        expect(element.childElementCount).toBe(0);
        element = document.getElementById(
          'ej2container_Series_0_DataLabelCollections'
        );
        expect(element).toBe(null);
        done();
      };
    ...
    it('checking template as point x value and cheecking style', (done: Function) => {
      accumulation.loaded = (args: IAccLoadedEventArgs): void => {
        let element: HTMLElement = document.getElementById(
          'ej2container_Series_0_DataLabel_1'
        );
      ...
      accumulation.series[0].dataLabel.template =
    ...
    it('Pie series Datalabel count with radius mapping(Datalabel inside)', (done: Function) => {
      accumulation.loaded = (args: IAccLoadedEventArgs): void => {
        let element: HTMLElement = document.getElementById(
          'ej2container_datalabel_Series_0'
        );
    ...
    it('Datalabel bounds check with radius mapping', (done: Function) => {
      accumulation.loaded = (args: IAccLoadedEventArgs) => {
        ...
        expect(
          withInBounds(
            points[0].labelRegion.x,
            points[0].labelRegion.y,
            accumulation.visibleSeries[0].accumulationBound,
            points[0].labelRegion.width,
            points[0].labelRegion.height
          )
        ).toBe(true);
        done();
      };
      ...
      accumulation.series = [
        {
          dataSource: [
            { x: 'Labour', y: 18000 },
            { x: 'Legal', y: 8000, text: 'feb: 10000' },
            { x: 'Production', y: 15000 },
            { x: 'License', y: 11000, text: '70000' },
            { x: 'Facilities', y: 18000 },
            { x: 'Taxes', y: 14000 },
            { x: 'Insurance', y: 16000 },
          ],
          dataLabel: {
    ...
    it('Checking datalabel text after enable group separator with template', (done: Function) => {
      accumulation.loaded = (args: IAccLoadedEventArgs) => {
        let element: HTMLElement = document.getElementById(
          'ej2container_Series_0_DataLabel_0'
        );
      ...
      accumulation.series = [
        {
          dataSource: [
            { x: 'Labour', y: 18 },
            { x: 'Legal', y: 80, text: 'feb: 10000' },
            { x: 'Production', y: 15 },
            { x: 'License', y: 11, text: '70000' },
            { x: 'Facilities', y: 18 },
            { x: 'Taxes', y: 14 },
            { x: 'Insurance', y: 16 },
          ],
  ...
  describe('Data label with dynamic changing legend', () => {
        ...
        series: [
          {
            ...
            dataSource: [
              ...
              {
                x: 'Engineering & Non-Residential',
                y: 539.1,
                text: '539  defect(s)',
              },
              { x: 'Commercial', y: 465.9, text: '466  defect(s)' },
              {
                x: 'Residential (New & Renovations)',
                y: 348.3,
                text: '348  defect(s)',
              },
    ...
    it('Checking datalabel text without legend', (done: Function) => {
      accumulation.loaded = (args: IAccLoadedEventArgs) => {
        let element: HTMLElement = document.getElementById(
          'ej2-container_datalabel_Series_0_text_11'
        );
        expect(element != null).toBe(true);
        done();
      };
    ...
    it('Checking datalabel text after enable legend', (done: Function) => {
      accumulation.loaded = (args: IAccLoadedEventArgs) => {
        let element: HTMLElement = document.getElementById(
          'ej2-container_datalabel_Series_0_text_13'
        );
        expect(element == null).toBe(true);
        done();
      };
  ...
  describe('Checking Text wrap support for datalabel', () => {
    ...
    it('DataLabel Wrap with MaxWidth value(Datalabel outside)', (done: Function) => {
      accumulation.loaded = (args: IAccLoadedEventArgs) => {
        textEle = document.getElementById(
          'ej2-container_datalabel_Series_0_text_1'
        );
        expect(textEle.childNodes.length == 5).toBe(true);
        textEle = document.getElementById(
          'ej2-container_datalabel_Series_0_text_3'
        );
    ...
    it('DataLabel Wrap without MaxWidth value(Datalabel outside)', (done: Function) => {
      accumulation.loaded = (args: IAccLoadedEventArgs) => {
        ...
        textEle = document.getElementById(
          'ej2-container_datalabel_Series_0_text_6'
        );
        expect(textEle.childNodes.length > 1).toBe(true);
        done();
      };
