  ...
  describe('Pyramid Series checking', () => {
    ...
    it('Checking default legend shape', (done: Function) => {
      ...
      expect(
        group.getAttribute('d') ==
          'M 83.5 32 L 88.5 22 L 93.5 32 L 83.5 32 z' ||
          group.getAttribute('d') ==
            'M 93.5 32 L 98.5 22 L 103.5 32 L 93.5 32 z'
      ).toBe(true);
      done();
    });
    ...
    it('Pyramid segments with gaps', (done: Function) => {
      chart.loaded = () => {
        ...
        let bounds: ClientRect = group.getBoundingClientRect();
        expect(
          bounds.top == 150.496826171875 || bounds.top == 149.781494140625
        ).toBe(true);
    ...
    it('Pyramid series with default data label', (done: Function) => {
      chart.loaded = () => {
        ...
        expect(
          group.getAttribute('x') == '291' || group.getAttribute('x') == '290.5'
        ).toBe(true);
        expect(
          group.getAttribute('y') == '222.44647735442126' ||
            group.getAttribute('y') == '221.948490294752'
        ).toBe(true);
        done();
      };
    ...
    it('Pyramid series with outside labels', (done: Function) => {
      chart.loaded = () => {
        ...
        expect(
          group.getAttribute('y') == '221.44647735442126' ||
            group.getAttribute('y') == '220.948490294752'
        ).toBe(true);
        done();
      };
    ...
    it('Data labels with connector (custom length)', (done: Function) => {
      chart.loaded = () => {
        ...
        expect(
          group.getAttribute('d') ==
            'M 361.2523364485981 151.68037383177568 L 402.7523364485981 151.68037383177568 L 412.7523364485981 151.68037383177568' ||
            group.getAttribute('d') ==
              'M 361.2523364485981 150.99158878504673 L 402.7523364485981 150.99158878504673 L 412.7523364485981 150.99158878504673' ||
            group.getAttribute('d') ==
              'M 361.2523364485981 150.99158878504673 L 403.7523364485981 150.99158878504673 L 413.7523364485981 150.99158878504673'
        ).toBe(true);
        done();
    ...
    it('Checking smart labels for inside position', (done: Function) => {
      chart.loaded = () => {
        ...
        expect(
          group.getAttribute('y') == '221.19147286821703' ||
            group.getAttribute('y') == '220.44147286821703'
        ).toBe(true);
        done();
      };
    ...
    it('Checking smart labels for outside position', (done: Function) => {
      chart.loaded = () => {
        ...
        expect(group.getAttribute('x')).toBe('545');
        expect(
          group.getAttribute('y') == '186.14003215434082' ||
            group.getAttribute('y') == '182.39003215434082'
        ).toBe(true);
        done();
      };
    ...
    it('Checking overlapped labels for inside position', (done: Function) => {
      chart.loaded = () => {
        ...
        expect(
          group.getAttribute('y') == '177.066077170418' ||
            group.getAttribute('y') == '176.316077170418'
        ).toBe(true);
        done();
      };
      //fourth label should be outside
    ...
    it('Checking overlapped labels for outside position', (done: Function) => {
      chart.loaded = () => {
        ...
        expect(group.getAttribute('x')).toBe('545');
        expect(
          group.getAttribute('y') == '176.066077170418' ||
            group.getAttribute('y') == '175.316077170418'
        ).toBe(true);
        done();
      };
      //a label will be hidden
    ...
    it('Pyramid series with surface mode', (done: Function) => {
      chart.loaded = () => {
        ...
        expect(
          group.getBoundingClientRect().height == 70.29558563232422 ||
    ...
    it('Pyramid series with surface mode with empty points', (done: Function) => {
      chart.loaded = () => {
        let group: Element = getElement('ej2container_Series_0_Point_0');
        expect(
          group.getBoundingClientRect().height == 64.05076599121094 ||
  ...
  describe('Corner Radius', () => {
    ...
    it('OnePoint', (done: Function) => {
      chart.loaded = () => {
        let group: Element = getElement('ej2container_Series_0_Point_0');
        expect(group.getAttribute('d')).toBe(
          'M 281.79980041949426 71.84853738135232 Q300 48 318.20019958050574 71.84853738135232 L318.20019958050574 71.84853738135232 L513.7998004194943 328.1514626186476 Q532 351.99999999999994 502 351.99999999999994 L98.00000000000003 351.99999999999994 Q68.00000000000003 351.99999999999994 86.20019958050575 328.1514626186476 Z '
        );
        done();
      };
    ...
    it('Bottom', (done: Function) => {
      chart.loaded = () => {
        ...
        expect(group.getAttribute('d')).toBe(
          'M 230.76703910904186 138.71905220194515 Q248.96723868954757 114.87051482059282 248.96723868954757 114.87051482059282 L351.03276131045243 114.87051482059282 L513.7998004194943 328.15146261864766 Q532 352 502 352 L98 352 Q68 352 86.20019958050571 328.15146261864766 Z '
        );
        done();
      };
      chart.series[0].dataSource = data;
