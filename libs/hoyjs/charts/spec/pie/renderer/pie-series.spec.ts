...
describe('Accumulation Chart Control', () => {
  ...
  describe('Pie Series checking', () => {
    ...
    it('checking  doughnut border with mousemove', (done: Function) => {
      ...
      pie.loaded = (args: IAccLoadedEventArgs) => {
        ...
        expect(
          seriousGroup.lastElementChild.getAttribute('opacity') === '1'
        ).toBe(true);
        expect(
          seriousGroup.lastElementChild.getAttribute('id') === borderId
        ).toBe(true);
        done();
      };
      pie.refresh();
    ...
    it('checking  doughnut border with mouseclick', (done: Function) => {
      pie.loaded = (args: IAccLoadedEventArgs) => {
        ...
        let seriousGroup: Element = getElement(pie.element.id + '_Series_' + 0);
        expect(
          seriousGroup.lastElementChild.getAttribute('id') ===
            pie.element.id + 'PointHover_Border'
        ).toBe(true);
        done();
      };
      pie.refresh();
    ...
    it('checking  doughnut border with explode', (done: Function) => {
      pie.loaded = (args: IAccLoadedEventArgs) => {
        ...
        expect(
          seriousGroup.lastElementChild.getAttribute('id') ===
            sliceid + (args.accumulation.visibleSeries[0].points.length - 1)
        ).toBe(true);
        done();
      };
    ...
    it('checking pie explode all', (done: Function) => {
      ...
      pie.loaded = (args: IAccLoadedEventArgs) => {
        ...
        expect(slice.getAttribute('transform')).not.toBe(null);
        slice = getElement(sliceid + 2);
        expect(slice.getAttribute('transform').indexOf('translate(') > -1).toBe(
          true
        );
        slice = getElement(sliceid + 5);
    ...
    it('checking pie empty points mode zero', (done: Function) => {
      ...
      pie.loaded = (args: IAccLoadedEventArgs) => {
        ...
        expect(
          getElement('ej2container_datalabel_Series_0_text_1').textContent
        ).toBe('0');
        expect(
          getElement('ej2container_datalabel_Series_0_text_4').textContent
        ).toBe('0');
        expect(
          getElement('ej2container_datalabel_Series_0_text_6').textContent
        ).toBe('0');
        done();
      };
      pie.series[0].dataSource = [
    ...
    it('checking pie empty points mode Drop', (done: Function) => {
      ...
      pie.loaded = (args: IAccLoadedEventArgs) => {
        ...
        expect(
          getElement('ej2container_datalabel_Series_0_text_3').textContent
        ).toBe('40');
        done();
      };
    ...
    it('checking pie point changes for club point while explode', (done: Function) => {
      ...
      pie.loaded = (args: IAccLoadedEventArgs) => {
        if (execute === false) {
          ...
          execute = true;
          trigger.clickEvent(slice);
          let legendEle: Element = getElement(
            'ej2container_chart_legend_text_0'
          );
  ...
  describe('Pie Series Corner Radius Feature  checking', () => {
    ...
    it('checking pie series with corner radius', (done: Function) => {
      pie.loaded = () => {
        slice = getElement(sliceid + 0);
        expect(slice.getAttribute('d')).toBe(
          'M 300 200 L 300 52.668929010238884 A 4.668929010238883 4.668929010238883 0 0 1 304.66892901023886 48 A 152 152 0 0 1 324.5717233643358 49.9265869348964 A 4.668929010238883 4.668929010238883 0 0 1 328.2584551301858 55.404342414285104 Z'
        );
        done();
      };
      pie.refresh();
    ...
    it('checking pie series with corner radius for single slice', (done: Function) => {
      ...
      pie.loaded = () => {
        slice = getElement(sliceid + 0);
        expect(slice.getAttribute('d')).toBe(
          'M 300 200 L 300 48 A 0 0 0 0 1 300 48 A 152 152 0 1 1 299.99734709953714 48.00000002315093 A 0 0 0 0 1 299.99734709953714 48.00000002315093 Z'
        );
        done();
      };
      pie.series[0].dataSource = [
    ...
    it('checking doughnut series with corner radius for single slice', (done: Function) => {
      pie.loaded = () => {
        slice = getElement(sliceid + 0);
        expect(slice.getAttribute('d')).toBe(
          'M 300 48 A 0 0 0 0 1 300 48 A 152 152 0 1 1 299.99734709953714 48.00000002315093 A 0 0 0 0 1 299.99734709953714 48.00000002315093 L 299.99893883981485 139.20000000926038 A 0 0 0 0 1 299.99893883981485 139.20000000926038 A 60.8 60.8 0 1 0 300 139.2 A 0 0 0 0 1 300 139.2 Z'
        );
        done();
      };
      pie.series[0].dataSource = [
    ...
    it('checking pie series border with corner radius', (done: Function) => {
      pie.loaded = (args: IAccLoadedEventArgs) => {
        ...
        expect(seriousGroup.lastElementChild.getAttribute('d')).toBe(
          'M 304.82251220136516 45 A 155 155 0 0 1 324.99639890938687 46.95282862628556 L 325.3800037381626 44.989961505123254 A 157 157 0 0 0 304.82251220136516 43 Z'
        );
    ...
    it('checking pie series border with corner radius for one slice', (done: Function) => {
      pie.loaded = (args: IAccLoadedEventArgs) => {
        ...
        expect(seriousGroup.lastElementChild.getAttribute('d')).toBe(
          'M 299.99999999999994 45 A 155 155 0 1 1 299.99729473965954 45.00000002360784 L 299.9972598330745 43.00000002391246 A 157 157 0 1 0 299.99999999999994 43 Z'
        );
        done();
      };
      pie.series[0].dataSource = [
    ...
    it('checking doughnut series border with corner radius', (done: Function) => {
      pie.loaded = (args: IAccLoadedEventArgs) => {
        ...
        expect(seriousGroup.lastElementChild.getAttribute('d')).toBe(
          'M 301.7139884129693 142.2 A 57.8 57.8 0 0 1 309.4040138006832 142.9443930825694 L 309.02040897190744 144.90726020373168 A 55.8 55.8 0 0 0 301.7139884129693 144.2 Z'
        );
        done();
      };
      pie.series[0].dataSource = piedata;
    ...
    it('checking doughnut series border with corner radius for one slice', (done: Function) => {
      pie.loaded = (args: IAccLoadedEventArgs) => {
        ...
        expect(seriousGroup.lastElementChild.getAttribute('d')).toBe(
          'M 300 142.2 A 57.8 57.8 0 1 1 299.9989911996924 142.20000000880344 L 299.9990261062774 144.20000000849882 A 55.8 55.8 0 1 0 300 144.2 Z'
        );
        done();
      };
      pie.series[0].dataSource = [
  ...
  describe('Pie Series - Checking animation on data changes.', () => {
    ...
    it('checking pie series with long dataLabel', (done: Function) => {
      ...
      pie.refresh();
      (pie.series[0] as AccumulationSeries).addPoint(
        { x: 'chrysanthemum', y: 16, text: 'Ant: chrysanthemum: 15%' },
        600
      );
    });
  });
