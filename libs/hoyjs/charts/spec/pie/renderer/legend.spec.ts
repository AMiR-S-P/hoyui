...
} from '../../../src/accumulation-chart/model/pie-interface';
  ...
  describe('Legend checking for the pie series', () => {
    ...
    it('Pie Legend visibility visible checking', (done: Function) => {
      accumulation.loaded = (args: IAccLoadedEventArgs) => {
        ...
        expect(legendEle.childNodes.length).toBe(
          accumulation.visibleSeries[0].points.length
        );
        done();
      };
    ...
    it('Pie Legend auto position chekcing width is greater than height', () => {
      ...
      expect(
        legendEle.getAttribute('x') == '484.75' ||
          legendEle.getAttribute('x') == '485.5'
      ).toBe(true);
      expect(
        legendEle.getAttribute('width') == '48' ||
          legendEle.getAttribute('width') == '47'
      ).toBe(true);
      expect(
        legendEle.getAttribute('y') === '71' ||
          legendEle.getAttribute('y') === '76'
      ).toBe(true);
      expect(
        legendEle.getAttribute('height') === '258' ||
          legendEle.getAttribute('height') === '248'
      ).toBe(true);
    });
    it('Pie Legend auto position chekcing while width is less than height', (done: Function) => {
      accumulation.loaded = (args: IAccLoadedEventArgs) => {
        ...
        expect(
          legendEle.getAttribute('y') === '475.75' ||
            legendEle.getAttribute('y') === '478.75'
        ).toBe(true);

        expect(
          legendEle.getAttribute('height') === '60' ||
            legendEle.getAttribute('height') === '56'
        ).toBe(true);
    ...
    it('Pie Legend left position chekcing', (done: Function) => {
      accumulation.loaded = (args: IAccLoadedEventArgs) => {
        legendEle = getElement(legendId + '_element');
        expect(
          legendEle.getAttribute('x') == '67.25' ||
            legendEle.getAttribute('x') == '67.5'
        ).toBe(true);
    ...
    it('Pie Legend Top position chekcing', (done: Function) => {
      accumulation.loaded = (args: IAccLoadedEventArgs) => {
        legendEle = getElement(legendId + '_element');
        expect(
          legendEle.getAttribute('x') == '73.5' ||
            legendEle.getAttribute('x') == '74'
        ).toBe(true);

        expect(
          legendEle.getAttribute('y') === '27.80000000000001' ||
            legendEle.getAttribute('y') === '27.849999999999994'
        ).toBe(true);

        expect(
          legendEle.getAttribute('height') === '33' ||
            legendEle.getAttribute('height') === '32'
        ).toBe(true);

        expect(
          legendEle.getAttribute('width') == '453' ||
            legendEle.getAttribute('width') == '452'
        ).toBe(true);
        done();
      };
    ...
    it('Pie Legend Bottom position chekcing', (done: Function) => {
      accumulation.loaded = (args: IAccLoadedEventArgs) => {
        ...
        expect(
          legendEle.getAttribute('y') === '339.20000000000005' ||
            legendEle.getAttribute('y') === '340.15'
        ).toBe(true);
    ...
    it('Smart Legend placing datalabel Inside, legend position right, exploding length greater than chart width', (done: Function) => {
      accumulation.loaded = (args: IAccLoadedEventArgs) => {
        legendEle = getElement(legendId + '_element');
        expect(
          legendEle.getAttribute('x') == '515.1500000000001' ||
            legendEle.getAttribute('x') == '515.9000000000001'
        ).toBe(true);
    ...
    it('Smart Legend placing datalabel Inside, legend position right, exploding length less than chart width', (done: Function) => {
      accumulation.loaded = (args: IAccLoadedEventArgs) => {
        legendEle = getElement(legendId + '_element');
        expect(
          legendEle.getAttribute('x') == '665.15' ||
            legendEle.getAttribute('x') == '665.9' ||
            legendEle.getAttribute('x') == '642.65'
        ).toBe(true);
    ...
    it('Smart Legend placing datalabel Inside, legend position left, exploding length less than chart width', (done: Function) => {
      accumulation.loaded = (args: IAccLoadedEventArgs) => {
        legendEle = getElement(legendId + '_element');
        expect(
          legendEle.getAttribute('x') == '86.85' ||
            legendEle.getAttribute('x') == '87.1' ||
            legendEle.getAttribute('x') == '79.35'
        ).toBe(true);
    ...
    it('Smart Legend placing datalabel Inside, legend position left, exploding length greater than chart width', (done: Function) => {
      accumulation.loaded = (args: IAccLoadedEventArgs) => {
        legendEle = getElement(legendId + '_element');
        expect(
          legendEle.getAttribute('x') == '36.85' ||
            legendEle.getAttribute('x') == '37.1'
        ).toBe(true);
    ...
    it('Pie Legend paging feature checking for position right with default height, width', (done: Function) => {
      accumulation.loaded = (args: IAccLoadedEventArgs) => {
        ...
        expect(
          legendEle.getAttribute('x') == '318' ||
            legendEle.getAttribute('x') == '302'
        ).toBe(true);

        expect(legendEle.getAttribute('y')).toBe('10');
        expect(
          legendEle.getAttribute('width') == '80' ||
            legendEle.getAttribute('width') == '78'
        ).toBe(true);

        expect(
          legendEle.getAttribute('height') === '360' ||
            legendEle.getAttribute('height') === '350'
        ).toBe(true);
        done();
      };
      accumulation.legendSettings.height = null;
    ...
    it('Doughnut Single point Legend', (done: Function) => {
      accumulation.loaded = (args: IAccLoadedEventArgs) => {
        ...
        expect(
          (<HTMLElement>legendEle.childNodes[0]).getAttribute('fill')
        ).toBe('#00bdae');
        expect(
          (<HTMLElement>legendEle.childNodes[1]).getAttribute('fill')
        ).toBe('#FFFFFF');
        expect(
          (<HTMLElement>legendEle.childNodes[2]).textContent.indexOf('...') >
            -1 ||
            (<HTMLElement>legendEle.childNodes[2]).textContent ===
              'Single Point'
        ).toBe(true);
        done();
      };
      accumulation.series[0].dataSource = [
        { x: 'Single Point', text: 'Single point text', y: 10 },
      ];
    ...
    it('Pie Single point Legend', (done: Function) => {
      accumulation.loaded = (args: IAccLoadedEventArgs) => {
        ...
        expect((<HTMLElement>legendEle.childNodes[1]).textContent).toBe(
          'Single Point'
        );
        done();
      };
    ...
    it('Legend long text trimming feature checking', (done: Function) => {
      accumulation.loaded = (args: IAccLoadedEventArgs) => {
        ...
        expect(
          (<HTMLElement>legendEle.childNodes[1]).textContent.indexOf('...') > -1
        ).toBe(true);
        ...
        expect(legendEle.textContent).toBe(
          'Single Point legend long text trimming feature checking'
        );
      ...
      accumulation.series[0].dataSource = [
        {
          x: 'Single Point legend long text trimming feature checking',
  ...
  describe('Legend title checking with pie chart', () => {
    ...
    beforeAll((): void => {
      chartContainer = createElement('div', {
        id: 'container',
        styles: 'width: 800px; height: 450px',
      });
      ...
      pieObj.loaded = (args: IAccLoadedEventArgs) => {
        ...
        expect(
          titleElement.textContent ===
            'It’s important that he dress like an Indian, dance like an Indian, even if it is an act, even if he feels'
        ).toBe(true);
        xValue = titleElement.getAttribute('x');
        expect(xValue === '400').toBe(true);
        yValue = titleElement.getAttribute('y');
    ...
    it('08.legend right: title top', (done: Function) => {
      pieObj.loaded = (args: IAccLoadedEventArgs) => {
        ...
        xValue = titleElement.getAttribute('x');
        expect(
          xValue === '697.4797803156889' ||
            xValue === '692.9797803156889' ||
            xValue === '697.9797803156889'
        ).toBe(true);
        yValue = titleElement.getAttribute('y');
  ...
  describe('Chart Control Legend click check', () => {
    ...
    it('checking with args after cancel  enable', (done: Function) => {
      loaded = (args: Object): void => {
        ...
        let pointElement = getElement(
          'container1_Series_0_Point_0'
        ).getAttribute('fill');
  ...
  describe('Legend new paging support checking with pie chart', () => {
    ...
    it('01.legend bottom: without title', (done: Function) => {
      pieObj.loaded = (args: IAccLoadedEventArgs) => {
        ...
        expect(
          path ===
            'M 48.5 267.71501821018626 L 40.5 271.71501821018626 L 48.5 275.71501821018626 L 48.5 273.71501821018626 L 44.5 271.71501821018626 L48.5 269.71501821018626 Z'
        ).toBe;
        fontArrow = getElement('container_chart_legend_pagedown');
        path = fontArrow.getAttribute('d');
        expect(
          path ===
            'M 251.5 267.71501821018626 L 259.5 271.71501821018626 L 251.5 275.71501821018626 L 251.5 273.71501821018626 L 255.5 271.71501821018626 L251.5 269.71501821018626 Z'
        ).toBe;
        legendGroup = getElement('container_chart_legend_translate_g');
        expect(legendGroup.childElementCount === 7).toBe(true);
    ...
    it('02.legend bottom: title top', (done: Function) => {
      pieObj.loaded = (args: IAccLoadedEventArgs) => {
        ...
        yValue = titleElement.getAttribute('y');
        expect(
          yValue === '254.989169209323' || yValue === '255.98433900949567'
        ).toBe(true);
        backArrow = getElement('container_chart_legend_pageup');
        path = backArrow.getAttribute('d');
        expect(
          path ===
            'M 44 267.489169209323 L 36 271.489169209323 L 44 275.489169209323 L 44 273.489169209323 L 40 271.489169209323 L44 269.489169209323 Z' ||
            path ===
              'M 27 268.48433900949567 L 19 272.48433900949567 L 27 276.48433900949567 L 27 274.48433900949567 L 23 272.48433900949567 L27 270.48433900949567 Z'
        ).toBe;
        fontArrow = getElement('container_chart_legend_pagedown');
        path = fontArrow.getAttribute('d');
        expect(
          path ===
            'M 256 267.489169209323 L 264 271.489169209323 L 256 275.489169209323 L 256 273.489169209323 L 260 271.489169209323 L256 269.489169209323 Z' ||
            path ===
              'M 273 268.48433900949567 L 281 272.48433900949567 L 273 276.48433900949567 L 273 274.48433900949567 L 277 272.48433900949567 L273 270.48433900949567 Z'
        ).toBe;
        legendGroup = getElement('container_chart_legend_translate_g');
        expect(legendGroup.childElementCount === 7).toBe(true);
        done();
    ...
    it('03.legend bottom: title left', (done: Function) => {
      pieObj.loaded = (args: IAccLoadedEventArgs) => {
        ...
        yValue = titleElement.getAttribute('y');
        expect(
          yValue === '276.21622576014306' || yValue === '275.96501821018626'
        ).toBe(true);
        backArrow = getElement('container_chart_legend_pageup');
        path = backArrow.getAttribute('d');
        expect(
          path ===
            'M 88 268.46501821018626 L 80 272.46501821018626 L 88 276.46501821018626 L 88 274.46501821018626 L 84 272.46501821018626 L88 270.46501821018626 Z' ||
            path ===
              'M 98 267.71501821018626 L 90 271.71501821018626 L 98 275.71501821018626 L 98 273.71501821018626 L 94 271.71501821018626 L98 269.71501821018626 Z'
        ).toBe;
        fontArrow = getElement('container_chart_legend_pagedown');
        path = fontArrow.getAttribute('d');
        expect(
          path ===
            'M 271 268.46501821018626 L 279 272.46501821018626 L 271 276.46501821018626 L 271 274.46501821018626 L 275 272.46501821018626 L271 270.46501821018626 Z' ||
            path ===
              'M 256 267.71501821018626 L 264 271.71501821018626 L 256 275.71501821018626 L 256 273.71501821018626 L 260 271.71501821018626 L256 269.71501821018626 Z'
        ).toBe;
        legendGroup = getElement('container_chart_legend_translate_g');
        expect(legendGroup.childElementCount === 7).toBe(true);
        done();
    ...
    it('04.legend bottom: title right', (done: Function) => {
      pieObj.loaded = (args: IAccLoadedEventArgs) => {
        ...
        expect(
          path ===
            'M 38.5 267.46622576014306 L 30.5 271.46622576014306 L 38.5 275.46622576014306 L 38.5 273.46622576014306 L 34.5 271.46622576014306 L38.5 269.46622576014306 Z' ||
            path ===
              'M 29 268.46501821018626 L 21 272.46501821018626 L 29 276.46501821018626 L 29 274.46501821018626 L 25 272.46501821018626 L29 270.46501821018626 Z'
        ).toBe;
        fontArrow = getElement('container_chart_legend_pagedown');
        path = fontArrow.getAttribute('d');
        expect(
          path ===
            'M 197.5 267.46622576014306 L 205.5 271.46622576014306 L 197.5 275.46622576014306 L 197.5 273.46622576014306 L 201.5 271.46622576014306 L197.5 269.46622576014306 Z' ||
            path ===
              'M 207 268.46501821018626 L 215 272.46501821018626 L 207 276.46501821018626 L 207 274.46501821018626 L 211 272.46501821018626 L207 270.46501821018626 Z'
        ).toBe;
        legendGroup = getElement('container_chart_legend_translate_g');
        expect(legendGroup.childElementCount === 7).toBe(true);
        done();
    ...
    it('05.legend top: without title', (done: Function) => {
      pieObj.loaded = (args: IAccLoadedEventArgs) => {
        ...
        expect(
          path ===
            'M 44 28.5 L 36 32.5 L 44 36.5 L 44 34.5 L 40 32.5 L44 30.5 Z' ||
            path ===
              'M 48.5 28.5 L 40.5 32.5 L 48.5 36.5 L 48.5 34.5 L 44.5 32.5 L48.5 30.5 Z'
        ).toBe;
        fontArrow = getElement('container_chart_legend_pagedown');
        path = fontArrow.getAttribute('d');
        expect(
          path ===
            'M 256 28.5 L 264 32.5 L 256 36.5 L 256 34.5 L 260 32.5 L256 30.5 Z' ||
            path ===
              'M 251.5 28.5 L 259.5 32.5 L 251.5 36.5 L 251.5 34.5 L 255.5 32.5 L251.5 30.5 Z'
        ).toBe;
        legendGroup = getElement('container_chart_legend_translate_g');
        expect(legendGroup.childElementCount === 7).toBe(true);
        done();
    ...
    it('06.legend top: title top', (done: Function) => {
      pieObj.loaded = (args: IAccLoadedEventArgs) => {
        ...
        expect(
          path ===
            'M 44 47.5 L 36 51.5 L 44 55.5 L 44 53.5 L 40 51.5 L44 49.5 Z' ||
            path ===
              'M 48.5 44.49999999999999 L 40.5 48.49999999999999 L 48.5 52.49999999999999 L 48.5 50.49999999999999 L 44.5 48.49999999999999 L48.5 46.49999999999999 Z'
        ).toBe;
        fontArrow = getElement('container_chart_legend_pagedown');
        path = fontArrow.getAttribute('d');
        expect(
          path ===
            'M 256 47.5 L 264 51.5 L 256 55.5 L 256 53.5 L 260 51.5 L256 49.5 Z' ||
            path ===
              'M 251.5 44.49999999999999 L 259.5 48.49999999999999 L 251.5 52.49999999999999 L 251.5 50.49999999999999 L 255.5 48.49999999999999 L251.5 46.49999999999999 Z'
        ).toBe;
        legendGroup = getElement('container_chart_legend_translate_g');
        expect(legendGroup.childElementCount === 7).toBe(true);
        done();
    ...
    it('07.legend top: title left', (done: Function) => {
      pieObj.loaded = (args: IAccLoadedEventArgs) => {
        ...
        expect(
          path ===
            'M 97.5 28.5 L 89.5 32.5 L 97.5 36.5 L 97.5 34.5 L 93.5 32.5 L97.5 30.5 Z' ||
            path ===
              'M 88 28.5 L 80 32.5 L 88 36.5 L 88 34.5 L 84 32.5 L88 30.5 Z'
        ).toBe;
        fontArrow = getElement('container_chart_legend_pagedown');
        path = fontArrow.getAttribute('d');
        expect(
          path ===
            'M 261.5 28.5 L 269.5 32.5 L 261.5 36.5 L 261.5 34.5 L 265.5 32.5 L261.5 30.5 Z' ||
            path ===
              'M 271 28.5 L 279 32.5 L 271 36.5 L 271 34.5 L 275 32.5 L271 30.5 Z'
        ).toBe;
        legendGroup = getElement('container_chart_legend_translate_g');
        expect(legendGroup.childElementCount === 7).toBe(true);
        done();
    ...
    it('08.legend top: title right', (done: Function) => {
      pieObj.loaded = (args: IAccLoadedEventArgs) => {
        ...
        expect(
          path ===
            'M 29 28.5 L 21 32.5 L 29 36.5 L 29 34.5 L 25 32.5 L29 30.5 Z' ||
            path ===
              'M 44 28.5 L 36 32.5 L 44 36.5 L 44 34.5 L 40 32.5 L44 30.5 Z'
        ).toBe;
        fontArrow = getElement('container_chart_legend_pagedown');
        ...
        expect(
          path ===
            'M 207 28.5 L 215 32.5 L 207 36.5 L 207 34.5 L 211 32.5 L207 30.5 Z' ||
            path ===
              'M 197 28.5 L 205 32.5 L 197 36.5 L 197 34.5 L 201 32.5 L197 30.5 Z'
        ).toBe;
        legendGroup = getElement('container_chart_legend_translate_g');
        expect(legendGroup.childElementCount === 7).toBe(true);
        done();
    ...
    it('09.legend right: title top', (done: Function) => {
      pieObj.loaded = (args: IAccLoadedEventArgs) => {
        ...
        expect(
          path ===
            'M 335.5 45 L 339.5 37 L 343.5 45L 341.5 45 L 339.5 41L337.5 45 Z' ||
            path ===
              'M 335.5 42 L 339.5 34 L 343.5 42L 341.5 42 L 339.5 38L337.5 42 Z'
        ).toBe;
        fontArrow = getElement('container_chart_legend_pagedown');
        path = fontArrow.getAttribute('d');
        expect(
          path ===
            'M 335.5 174 L 339.5 182 L 343.5 174L 341.5 174 L 339.5 178L337.5 174 Z' ||
            path ===
              'M 335.5 174 L 339.5 182 L 343.5 174L 341.5 174 L 339.5 178L337.5 174 Z'
        ).toBe;
        legendGroup = getElement('container_chart_legend_translate_g');
    ...
    it('10.legend left: title top', (done: Function) => {
      pieObj.loaded = (args: IAccLoadedEventArgs) => {
        ...
        expect(
          path ===
            'M 56.5 45 L 60.5 37 L 64.5 45L 62.5 45 L 60.5 41L58.5 45 Z' ||
            path ===
              'M 56.5 42 L 60.5 34 L 64.5 42L 62.5 42 L 60.5 38L58.5 42 Z'
        ).toBe;
        fontArrow = getElement('container_chart_legend_pagedown');
        path = fontArrow.getAttribute('d');
        expect(
          path ===
            'M 56.5 174 L 60.5 182 L 64.5 174L 62.5 174 L 60.5 178L58.5 174 Z' ||
            path ===
              'M 56.5 174 L 60.5 182 L 64.5 174L 62.5 174 L 60.5 178L58.5 174 Z'
        ).toBe;
        legendGroup = getElement('container_chart_legend_translate_g');
    ...
    it('11.legend with html entities', (done: Function) => {
      ...
      pieObj.series[0].dataSource = [
        { x: 'Net-s', y: 21, text: '21%' },
