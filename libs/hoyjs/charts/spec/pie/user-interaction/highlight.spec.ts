  ...
  describe('Highlight', () => {
    ...
    it('Doughnut - Hightlight Mode Point', (done: Function) => {
      accumulation.loaded = (args: IAccLoadedEventArgs) => {
        ...
        trigger.mousemoveEvent(element, 0, 0, 200, 200);
        expect(
          document.getElementsByClassName(highlight + '0' + '_point_6')
            .length === 3
        ).toBe(true);
        done();
      };
    ...
    it('Doughnut - point highlight while hover the correspoding Datalabel ', (done: Function) => {
      accumulation.loaded = (args: IAccLoadedEventArgs) => {
        ...
        trigger.mousemoveEvent(element, 0, 0, 200, 200);
        expect(
          document.getElementsByClassName(highlight + '0' + '_point_0')
            .length === 2
        ).toBe(true);
        done();
      };
    ...
    it('Pie - point checking highlighted data index ', (done: Function) => {
      accumulation.loaded = (args: IAccLoadedEventArgs) => {
        args.accumulation.accumulationHighlightModule.highlightDataIndexes = [
          { series: 0, point: 1 },
        ] as Indexes[];
        args.accumulation.accumulationHighlightModule.redrawSelection(
          args.accumulation
        );
