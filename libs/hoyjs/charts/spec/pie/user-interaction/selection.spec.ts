  ...
  describe('Selection', () => {
    ...
    it('Doughnut - MultiSelect false Selection Mode Point', (done: Function) => {
      accumulation.loaded = (args: IAccLoadedEventArgs) => {
        ...
        trigger.clickEvent(element);
        expect(
          document.getElementsByClassName(selection + '0' + '_point_6')
            .length === 3
        ).toBe(true);
        done();
      };
      ...
      accumulation.loaded = (args: IAccLoadedEventArgs) => {
        ...
        expect(
          document.getElementsByClassName(selection + '0' + '_point_6').length +
            document.getElementsByClassName(selection + '0' + '_point_3')
              .length ===
            5
        ).toBe(true);
        done();
    ...
    it('Doughnut - Multiple point selection and UnSelection', (done: Function) => {
      accumulation.loaded = (args: IAccLoadedEventArgs) => {
        ...
        for (
          i = 0, length = accumulation.visibleSeries[0].points.length, j = 1;
          i < length;
          i++, j++
        ) {
          ...
          trigger.clickEvent(element);
          selected = document.getElementsByClassName(
            selection + 0 + '_point_' + i
          );
          expect(selected.length === 3).toBe(true);
        }
        selectedLength = selected.length;
        for (
          i = accumulation.visibleSeries[0].points.length - 1, j = 1;
          i > 0;
          i--, j++
        ) {
          element = document.getElementById('pie_Series_0_Point_' + i);
    ...
    it('Doughnut - Selected DataIndexes checking', (done: Function) => {
      accumulation.loaded = (args: IAccLoadedEventArgs) => {
        expect(
          document.getElementsByClassName(selection + '0' + '_point_2')
            .length === 2
        ).toBe(true);
        done();
      };
    ...
    it('Doughnut - Selected Legend toggle visible false', (done: Function) => {
      accumulation.loaded = (args: IAccLoadedEventArgs) => {
        ...
        trigger.clickEvent(element);
        expect(
          document.getElementsByClassName(selection + '0' + '_point_1')
            .length === 2
        ).toBe(true);
        trigger.clickEvent(element);
        expect(
    ...
    it('Doughnut - point selection while click the correspoding Datalabel ', (done: Function) => {
      accumulation.loaded = (args: IAccLoadedEventArgs) => {
        ...
        trigger.clickEvent(element);
        expect(
          document.getElementsByClassName(selection + '0' + '_point_0')
            .length === 2
        ).toBe(true);
        done();
      };
    ...
    it('Pie - Selected Legend click on selected point', (done: Function) => {
      accumulation.loaded = (args: IAccLoadedEventArgs) => {
        ...
        trigger.clickEvent(element);
        expect(
          document.getElementsByClassName(selection + '0' + '_point_4')
            .length === 2
        ).toBe(true);
        element = document.getElementById('pie_chart_legend_shape_4');
        trigger.clickEvent(element);
        expect(
          element.getAttribute('class') === selection + '0' + '_point_4'
        ).toBe(true);
        trigger.clickEvent(element);
        element = document.getElementById('pie_Series_0_Point_4');
    ...
    it('Patterns with DiagonalForward', (done: Function) => {
      accumulation.loaded = (args: IAccLoadedEventArgs) => {
        ...
        expect(
          document.getElementById(id + '_svg').querySelectorAll('pattern')[0]
            .id === 'pie_DiagonalForward_Selection_0'
        ).toBe(true);
        done();
      };
    ...
    it('Patterns with DiagonalBackward', (done: Function) => {
      accumulation.loaded = (args: IAccLoadedEventArgs) => {
        ...
        expect(
          document.getElementById(id + '_svg').querySelectorAll('pattern')[0]
            .id === 'pie_DiagonalBackward_Selection_0'
        ).toBe(true);
        done();
      };
    ...
    it('Patterns with HorizontalDash', (done: Function) => {
      accumulation.loaded = (args: IAccLoadedEventArgs) => {
        ...
        expect(
          document.getElementById(id + '_svg').querySelectorAll('pattern')[0]
            .id === 'pie_HorizontalDash_Selection_0'
        ).toBe(true);
        done();
      };
    ...
    it('Patterns with VerticalDash', (done: Function) => {
      accumulation.loaded = (args: IAccLoadedEventArgs) => {
        ...
        expect(
          document.getElementById(id + '_svg').querySelectorAll('pattern')[0]
            .id === 'pie_VerticalDash_Selection_0'
        ).toBe(true);
        done();
      };
    ...
    it('Patterns with HorizontalStripe', (done: Function) => {
      accumulation.loaded = (args: IAccLoadedEventArgs) => {
        ...
        expect(
          document.getElementById(id + '_svg').querySelectorAll('pattern')[0]
            .id === 'pie_HorizontalStripe_Selection_0'
        ).toBe(true);
        done();
      };
