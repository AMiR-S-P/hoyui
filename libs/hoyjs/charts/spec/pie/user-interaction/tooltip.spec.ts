  ...
  describe('Tooltip checking for the pie series', () => {
    ...
    it('Pie tooltip visibility true checking', (done: Function) => {
      accumulation.loaded = (args: IAccLoadedEventArgs) => {
        ...
        expect(
          text1.textContent.replace('\u200E', '') == 'AnimalsBald Eagle : 18'
        ).toBe(true);
    ...
    it('Pie tooltip visibility true checking', (done: Function) => {
      ...
      accumulation.tooltip.format =
        'Large Tooltip <br/> To Test the <br/> Format <br/> ${point.x} <br/>';
    ...
    it('Touch event', (done: Function) => {
      ...
      accumulation.loaded = (args: Object): void => {
        ...
        accumulation.accumulationMouseEnd(
          <PointerEvent>trigger.onTouchEnd(ele, 0, 0, 200, 200, 200, 200)
        );
    ...
    beforeAll((): void => {
      ...
      accumulation = new AccumulationChart({
        ...
        series: [
          {
            dataSource: [
              { x: 'Cases', y: 177507, text: '37%' },
              { x: 'Layers', y: 137507, text: '17%' },
