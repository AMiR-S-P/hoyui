  ...
  describe('Annotation for Accumulation', () => {
    ...
    it('Checking annotaiton region as series', (done: Function) => {
      chartObj.loaded = (args: Object): void => {
        element = getElement('container_Annotation_0');
        expect(
          (element as HTMLElement).style.left == '221px' ||
            (element as HTMLElement).style.left == '220.2px'
        ).toBe(true);
        expect(
          (element as HTMLElement).style.top == '54px' ||
            (element as HTMLElement).style.top == '52.2px'
        ).toBe(true);
        done();
      };
    ...
    it('Checking annotaiton region as series with near and top', (done: Function) => {
      chartObj.loaded = (args: Object): void => {
        element = getElement('container_Annotation_0');
        expect(
          (element as HTMLElement).style.left == '206px' ||
            (element as HTMLElement).style.left == '205.2px'
        ).toBe(true);
        expect(
          (element as HTMLElement).style.top == '34.3px' ||
            (element as HTMLElement).style.top == '35.2px'
        ).toBe(true);
        done();
      };
    ...
    it('Checking annotaiton region as series with near and middle', (done: Function) => {
      chartObj.loaded = (args: Object): void => {
        ...
        expect(
          (element as HTMLElement).style.top == '51.3px' ||
            (element as HTMLElement).style.top == '52.2px'
        ).toBe(true);
        done();
      };
    ...
    it('Checking annotaiton region as series with near and bottom', (done: Function) => {
      chartObj.loaded = (args: Object): void => {
        ...
        expect(
          (element as HTMLElement).style.top == '71px' ||
            (element as HTMLElement).style.top == '69.2px'
        ).toBe(true);
        done();
      };
      chartObj.annotations[0].horizontalAlignment = 'Near';
    ...
    it('Checking annotaiton region as series with far and top', (done: Function) => {
      chartObj.loaded = (args: Object): void => {
        element = getElement('container_Annotation_0');
        expect(
          (element as HTMLElement).style.left == '234.8px' ||
            (element as HTMLElement).style.left == '235.2px'
        ).toBe(true);
        expect(
          (element as HTMLElement).style.top == '34.3px' ||
            (element as HTMLElement).style.top == '35.2px'
    ...
    it('Checking annotaiton region as series with center and top', (done: Function) => {
      chartObj.loaded = (args: Object): void => {
        element = getElement('container_Annotation_0');
        expect(
          (element as HTMLElement).style.left == '219.8px' ||
            (element as HTMLElement).style.left == '220.2px'
        ).toBe(true);
        expect(
          (element as HTMLElement).style.top == '34.3px' ||
    ...
    it('Checking annotaiton unit as pixel, region as series with percentage', (done: Function) => {
      chartObj.loaded = (args: Object): void => {
        ...
        expect((element as HTMLElement).style.left).toBe('385px');
        expect(
          (element as HTMLElement).style.top == '218px' ||
            (element as HTMLElement).style.top == '217px'
        ).toBe(true);
        done();
      };
      chartObj.annotations[0].region = 'Series';
    ...
    it('Checking annotaiton unit as pixel, region as series with number', (done: Function) => {
      chartObj.loaded = (args: Object): void => {
        element = getElement('container_Annotation_0');
        expect(
          (element as HTMLElement).style.left == '606px' ||
            (element as HTMLElement).style.left == '605.2px'
        ).toBe(true);
        expect(
          (element as HTMLElement).style.top == '262px' ||
            (element as HTMLElement).style.top == '260.2px'
        ).toBe(true);
        done();
      };
    ...
    it('Checking annotaiton unit as point with exact data', (done: Function) => {
      chartObj.loaded = (args: Object): void => {
        element = getElement('container_Annotation_0');
        expect(
          (element as HTMLElement).style.left == '251.218px' ||
            (element as HTMLElement).style.left == '250.719px'
        ).toBe(true);
        expect(
          (element as HTMLElement).style.top == '248.034px' ||
            (element as HTMLElement).style.top == '247.18px'
        ).toBe(true);
    ...
    it('Checking annotaiton unit as point with date time value type', (done: Function) => {
      chartObj.loaded = (args: Object): void => {
        element = getElement('container_Annotation_0');
        expect(
          (element as HTMLElement).style.left == '400.103px' ||
            (element as HTMLElement).style.left == '400.176px'
        ).toBe(true);
        expect(
          (element as HTMLElement).style.top == '112.475px' ||
            (element as HTMLElement).style.top == '110.96px'
        ).toBe(true);
        done();
      };
  ...
  describe('Annotation for Chart', () => {
    ...
    it('Checking annotaiton in series region', (done: Function) => {
      ...
      chartObj.loaded = (args: Object): void => {
        ...
        element = getElement('container_Annotation_0');
        expect(
          (element as HTMLElement).style.left == '715px' ||
            (element as HTMLElement).style.left == '339px'
        ).toBe(true);
        expect(
          (element as HTMLElement).style.top == '218px' ||
            (element as HTMLElement).style.top == '217px'
        ...
        expect(
          (element as HTMLElement).style.left == '690.888px' ||
            (element as HTMLElement).style.left == '314.891px'
        ).toBe(true);
        expect(
          (element as HTMLElement).style.top == '226px' ||
            (element as HTMLElement).style.top == '225px'
        ).toBe(true);
        done();
      };
      chartObj.annotations[0].region = 'Series';
    ...
    it('Checking annotaiton in point units', (done: Function) => {
      ...
      chartObj.loaded = (args: Object): void => {
        element = getElement('container_Annotation_0');
        expect(
          (element as HTMLElement).style.left == '722.281px' ||
            (element as HTMLElement).style.left == '346.317px'
        ).toBe(true);
        expect(
          (element as HTMLElement).style.top == '136.324px' ||
            (element as HTMLElement).style.top == '134.925px'
        ).toBe(true);
        element = getElement('container_Annotation_1');
        expect(
          (element as HTMLElement).style.left == '698.169px' ||
            (element as HTMLElement).style.left == '322.207px'
        ).toBe(true);
        expect(
          (element as HTMLElement).style.top == '144.324px' ||
            (element as HTMLElement).style.top == '142.925px'
        ).toBe(true);
        done();
      };
      chartObj.annotations[0].coordinateUnits = 'Point';
    ...
    it('Checking set Annotation method', (done: Function) => {
      ...
      chartObj.loaded = (args: Object): void => {
        ...
        expect(element).toBe(null);
        element = getElement('container_Annotation_1');
        chartObj.setAnnotationValue(
          1,
          '<div>Annotation has been changed</div>'
        );
        element = getElement('container_Annotation_1');
