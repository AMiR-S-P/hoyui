  ...
  describe('Highlight', () => {
    ...
    it('Doughnut - Hightlight Mode Point', (done: Function) => {
      circular3D.loaded = (args: CircularChart3DLoadedEventArgs) => {
        ...
        trigger.mousemoveEvent(element, 0, 0, 200, 200);
        expect(
          document.getElementsByClassName(highlight + '0' + '_point_6').length
        ).toBe(15);
        done();
      };
    ...
    it('Patterns with Crosshatch', (done: Function) => {
      circular3D.loaded = (args: CircularChart3DLoadedEventArgs) => {
        ...
        expect(
          document.getElementById(id + '_svg').querySelectorAll('pattern')[0].id
        ).toBe('pie_Crosshatch_Selection_0');
        done();
      };
    ...
    it('Patterns with VerticalStripe', (done: Function) => {
      circular3D.loaded = (args: CircularChart3DLoadedEventArgs) => {
        ...
        expect(
          document.getElementById(id + '_svg').querySelectorAll('pattern')[0].id
        ).toBe('pie_VerticalStripe_Selection_0');
        done();
      };
    ...
    it('Doughnut - highlighted in mousemove over Legend', (done: Function) => {
      circular3D.loaded = (args: CircularChart3DLoadedEventArgs) => {
        ...
        trigger.mousemoveEvent(element, 0, 0, 200, 200);
        expect(
          document.getElementsByClassName(highlight + '0' + '_point_1').length
        ).toBe(19);
    ...
    it('Doughnut - point highlight while hover the correspoding Datalabel ', (done: Function) => {
      circular3D.loaded = (args: CircularChart3DLoadedEventArgs) => {
        ...
        trigger.mousemoveEvent(element, 0, 0, 200, 200);
        expect(
          document.getElementsByClassName(highlight + '0' + '_point_0').length
        ).toBe(23);
        done();
      };
      circular3D.highlightMode = 'Point';
    ...
    it('Pie - highlighted in mousemove over Legend', (done: Function) => {
      circular3D.loaded = (args: CircularChart3DLoadedEventArgs) => {
        ...
        expect(element.getAttribute('class')).toBe(
          'pie_ej2_chart_highlight_series_0_point_1'
        );
        done();
      };
      circular3D.legendSettings.toggleVisibility = false;
    ...
    it('Pie - checking legend enable highlight with tooltip.', (done: Function) => {
      circular3D.loaded = (args: CircularChart3DLoadedEventArgs) => {
        ...
        trigger.mousemoveEvent(element, 0, 0, 200, 200);
        expect(
          document.getElementsByClassName(highlight + '0' + '_point_3')
            .length !== 0
        ).toBe(true);
        element = document.getElementById('pie_chart_legend_shape_1');
        trigger.mousemoveEvent(element, 0, 0, 200, 200);
    ...
    it('Pie - checking legend enable highlight with click event.', (done: Function) => {
      circular3D.loaded = (args: CircularChart3DLoadedEventArgs) => {
        ...
        trigger.mousemoveEvent(element, 0, 0, 200, 200);
        expect(
          document.getElementsByClassName(highlight + '0' + '_point_1')
            .length === 0
        ).toBe(true);
        done();
      };
