...
} from '../../../src/circularchart3d/model/pie-interface';
import { MouseEvents } from '../../chart3d/base/events.spec';
import { removeElement } from '@hoyui/svg-base';
...
document.body.appendChild(
  createElement('style', {
    innerHTML:
      ' .selection { stroke-width: 2; fill: lime; stroke: red; opacity: 1; } ',
  })
);
  ...
  describe('Selection', () => {
    ...
    it('Doughnut - MultiSelect false Selection Mode Point', (done: Function) => {
      circular3D.loaded = (args: CircularChart3DLoadedEventArgs) => {
        ...
        trigger.clickEvent(element);
        expect(
          document.getElementsByClassName(selection + '0' + '_point_6').length
        ).toBe(17);
        done();
      };
    ...
    it('Doughnut - MultiSelect true Selection Mode Point', (done: Function) => {
      circular3D.loaded = (args: CircularChart3DLoadedEventArgs) => {
        ...
        expect(
          document.getElementsByClassName(selection + '0' + '_point_6').length +
            document.getElementsByClassName(selection + '0' + '_point_3').length
        ).toBe(41);
        done();
      };
      circular3D.selectionMode = 'Point';
    ...
    it('Doughnut - Selected DataIndexes checking', (done: Function) => {
      circular3D.loaded = (args: CircularChart3DLoadedEventArgs) => {
        expect(
          document.getElementsByClassName(selection + '0' + '_point_2').length
        ).toBe(25);
        done();
      };
      circular3D.selectionMode = 'Point';
    ...
    it('Doughnut - Selected Legend toggle visible false', (done: Function) => {
      circular3D.loaded = (args: CircularChart3DLoadedEventArgs) => {
        ...
        trigger.clickEvent(element);
        expect(
          document.getElementsByClassName(selection + '0' + '_point_1').length
        ).toBe(25);
        trigger.clickEvent(element);
        expect(
          document.getElementsByClassName(selection + '0' + '_point_1').length
    ...
    it('Doughnut - point selection while click the correspoding Datalabel ', (done: Function) => {
      circular3D.loaded = (args: CircularChart3DLoadedEventArgs) => {
        ...
        trigger.clickEvent(element);
        expect(
          document.getElementsByClassName(selection + '0' + '_point_0').length
        ).toBe(29);
        done();
      };
      circular3D.selectionMode = 'Point';
    ...
    it('Pie - MultiSelect true Selection Mode Point', (done: Function) => {
      circular3D.loaded = (args: CircularChart3DLoadedEventArgs) => {
        element = document.getElementById(
          'pie-svg-0-region-series-0-point-' + 3
        );
        trigger.clickEvent(element);
        element = document.getElementById(
          'pie-svg-0-region-series-0-point-' + 6
        );
        trigger.clickEvent(element);
        expect(
          document.getElementsByClassName(selection + '0' + '_point_6').length +
    ...
    it('Pie - Selected Legend click on selected point', (done: Function) => {
      circular3D.loaded = (args: CircularChart3DLoadedEventArgs) => {
        ...
        trigger.clickEvent(element);
        expect(
          document.getElementsByClassName(selection + '0' + '_point_4').length
        ).toBe(26);
    ...
    it('Patterns with Dots', (done: Function) => {
      circular3D.loaded = (args: CircularChart3DLoadedEventArgs) => {
        circular3D.loaded = null;
        expect(
          document.getElementById(id + '_svg').querySelectorAll('pattern')
            .length
        ).toBe(8);
        expect(
          document.getElementById(id + '_svg').querySelectorAll('pattern')[0].id
        ).toBe('pie_Dots_Selection_0');
        done();
      };
    ...
    it('Patterns with DiagonalForward', (done: Function) => {
      circular3D.loaded = (args: CircularChart3DLoadedEventArgs) => {
        ...
        expect(
          document.getElementById(id + '_svg').querySelectorAll('pattern')[0].id
        ).toBe('pie_DiagonalForward_Selection_0');
        done();
      };
    ...
    it('Patterns with DiagonalBackward', (done: Function) => {
      circular3D.loaded = (args: CircularChart3DLoadedEventArgs) => {
        ...
        expect(
          document.getElementById(id + '_svg').querySelectorAll('pattern')[0].id
        ).toBe('pie_DiagonalBackward_Selection_0');
        done();
      };
    ...
    it('Patterns with Turquoise', (done: Function) => {
      circular3D.loaded = (args: CircularChart3DLoadedEventArgs) => {
        ...
        expect(
          document.getElementById(id + '_svg').querySelectorAll('pattern')[1].id
        ).toBe('pie_Turquoise_Selection_1');
        done();
      };
    ...
    it('Patterns with Triangle', (done: Function) => {
      circular3D.loaded = (args: CircularChart3DLoadedEventArgs) => {
        ...
        expect(
          document.getElementById(id + '_svg').querySelectorAll('pattern')[2].id
        ).toBe('pie_Triangle_Selection_2');
        done();
      };
    ...
    it('Patterns with Chessboard', (done: Function) => {
      circular3D.loaded = (args: CircularChart3DLoadedEventArgs) => {
        ...
        expect(
          document.getElementById(id + '_svg').querySelectorAll('pattern')[2].id
        ).toBe('pie_Chessboard_Selection_2');
        done();
      };
    ...
    it('Patterns with HorizontalDash', (done: Function) => {
      circular3D.loaded = (args: CircularChart3DLoadedEventArgs) => {
        ...
        expect(
          document.getElementById(id + '_svg').querySelectorAll('pattern')[0].id
        ).toBe('pie_HorizontalDash_Selection_0');
        done();
      };
    ...
    it('Patterns with VerticalDash', (done: Function) => {
      circular3D.loaded = (args: CircularChart3DLoadedEventArgs) => {
        ...
        expect(
          document.getElementById(id + '_svg').querySelectorAll('pattern')[0].id
        ).toBe('pie_VerticalDash_Selection_0');
        done();
      };
    ...
    it('Patterns with Rectangle', (done: Function) => {
      circular3D.loaded = (args: CircularChart3DLoadedEventArgs) => {
        ...
        expect(
          document.getElementById(id + '_svg').querySelectorAll('pattern')[0].id
        ).toBe('pie_Rectangle_Selection_0');
        done();
      };
    ...
    it('Patterns with VerticalStripe', (done: Function) => {
      circular3D.loaded = (args: CircularChart3DLoadedEventArgs) => {
        ...
        expect(
          document.getElementById(id + '_svg').querySelectorAll('pattern')[0]
            .id === 'pie_VerticalStripe_Selection_0'
        ).toBe(true);
        done();
      };
    ...
    it('Patterns with HorizontalStripe', (done: Function) => {
      circular3D.loaded = (args: CircularChart3DLoadedEventArgs) => {
        ...
        expect(
          document.getElementById(id + '_svg').querySelectorAll('pattern')[0].id
        ).toBe('pie_HorizontalStripe_Selection_0');
        done();
      };
    ...
    it('checking the selectionComplete event', (done: Function) => {
      circular3D.loaded = (args: CircularChart3DLoadedEventArgs) => {
        ...
        trigger.clickEvent(element);
        expect(
          document.getElementsByClassName(selection + '0').length >= 0
        ).toBe(true);
        done();
      };
      circular3D.selectionComplete = (
        arg: CircularChart3DSelectionCompleteEventArgs
      ) => {
    ...
    it('checking the selection with explode', (done: Function) => {
      circular3D.loaded = (args: CircularChart3DLoadedEventArgs) => {
        ...
        trigger.clickEvent(element);
        expect(
          document.getElementsByClassName(selection + '0_point_3').length >= 0
        ).toBe(true);
        done();
      };
      circular3D.selectionMode = 'Point';
    ...
    it('checking the selection with Rotation', (done: Function) => {
      circular3D.loaded = (args: CircularChart3DLoadedEventArgs) => {
        ...
        expect(element.getAttribute('d')).toBe(
          'M 193.09063572445072 101.37814288466589 L 193.09063572445072 101.37814288466589 L 193.09063572445072 101.37814288466589 L 204.65066565182906 91.50540251210519 L 204.65066565182906 91.50540251210519 '
        );
        done();
      };
