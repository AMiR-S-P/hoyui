  ...
  describe('Checking Onproerty change', () => {
    ...
    it('checking series fill', (done: Function) => {
      pie.loaded = (args: CircularChart3DLoadedEventArgs) => {
        element = document.getElementById(
          'ej2container-svg-0-region-series-0-point-0'
        );
    ...
    it('change tilt', (done: Function) => {
      loaded = (args: CircularChart3DLoadedEventArgs) => {
        ...
        expect(seriesElement.getAttribute('d')).toBe(
          'M 437.00800000000004 227.22243186433545 L 437.00800000000004 227.22243186433545 L 437.00800000000004 202.22243186433545 L 436.3473137094999 214.07176637439036 L 436.3473137094999 239.07176637439036 '
        );
        done();
      };
      pie.tilt = 30;
    ...
    it('change rotation', (done: Function) => {
      loaded = (args: CircularChart3DLoadedEventArgs) => {
        ...
        expect(seriesElement.getAttribute('d')).toBe(
          'M 406.15240852169836 217 L 406.15240852169836 217 L 431.15240852169836 217 L 430.5802374101932 230.6824329381963 L 405.5802374101932 230.6824329381963 '
        );
        done();
      };
      pie.tilt = 0;
    ...
    it('change depth', (done: Function) => {
      loaded = (args: CircularChart3DLoadedEventArgs) => {
        ...
        expect(seriesElement.getAttribute('d')).toBe(
          'M 437.00800000000004 217 L 437.00800000000004 217 L 437.00800000000004 217 L 436.3473137094999 230.6824329381963 L 436.3473137094999 230.6824329381963 '
        );
        done();
      };
      pie.rotation = 0;
    ...
    it('change series explode and selection', (done: Function) => {
      loaded = (args: CircularChart3DLoadedEventArgs) => {
        element = document.getElementById(
          'ej2container-svg-3-region-series-0-point-3'
        );
