...
describe('3DChart Control', () => {
  ...
  describe('Circular 3D event checking', () => {
    ...
    const elem: HTMLElement = createElement('div', {
      id: 'circularChart3DchartContainer',
    });
    ...
    it('Load event', (done: Function) => {
      loaded = (args: Object): void => {
        expect(
          document
            .getElementById(
              'circularChart3DchartContainer-svg-10-region-series-0-point-7'
            )
    ...
    it('Point render event', (done: Function) => {
      loaded = (args: Object): void => {
        expect(
          document
            .getElementById(
              'circularChart3DchartContainer-svg-10-region-series-0-point-0'
            )
            .getAttribute('fill')
        ).toBe('#ff0000');
        done();
  ...
  describe('Circular3D Events Checking', () => {
    let chartObj: CircularChart3D;
    const chartElement: HTMLElement = createElement('div', {
      id: 'circularChart3DchartContainer',
    });
    let targetElement: HTMLElement;
    let loaded: EmitType<CircularChart3DEventArgs>;
    ...
    it('Tooltip render event', (done: Function) => {
      loaded = (args: Object): void => {
        targetElement = chartObj.element.querySelector(
          '#circularChart3DchartContainer-svg-0-region-series-0-point-1'
        ) as HTMLElement;
        ...
        expect(
          document.getElementById('circularChart3DchartContainer_tooltip') !==
            null
        ).toBe(true);
        expect(
          document.getElementById('circularChart3DchartContainer_tooltip_text')
    ...
    it('Check tooltip in mobile mode', (done: Function) => {
      loaded = (args: Object): void => {
        targetElement = chartObj.element.querySelector(
          '#circularChart3DchartContainer-border'
        ) as HTMLElement;
        rect = targetElement.getBoundingClientRect();
        x = window.scrollX + rect.left + rect.width / 2;
        y = window.scrollY + rect.top;
    ...
    it('Check circular 3D rotate elements', (done: Function) => {
      loaded = (args: CircularChart3DLoadedEventArgs): void => {
        ...
        expect(
          document.getElementById('circularChart3DchartContainer') !== null
        ).toBe(true);
        done();
      };
      chartObj.loaded = loaded;
    ...
    it('Check circular 3D rotate elements poly line', (done: Function) => {
      loaded = (args: CircularChart3DLoadedEventArgs): void => {
        let points: any = [
          args.chart.circular3DPolygon[0].vectorPoints[0],
          args.chart.circular3DPolygon[0].vectorPoints[1],
        ];
        args.chart.polygon.createPolyline(
          points,
          args.chart.circular3DPolygon[0].element
        );
        expect(
          document.getElementById('circularChart3DchartContainer') !== null
        ).toBe(true);
    ...
    it('Check circular 3D rotate elements calculate normal', (done: Function) => {
      loaded = (args: CircularChart3DLoadedEventArgs): void => {
        args.chart.polygon.calculateNormal(
          args.chart.circular3DPolygon[0].vectorPoints[0],
          args.chart.circular3DPolygon[0].vectorPoints[1],
          args.chart.circular3DPolygon[0].vectorPoints[2],
          args.chart.circular3DPolygon[0]
        );
        expect(
          document.getElementById('circularChart3DchartContainer') !== null
        ).toBe(true);
      ...
      loaded = (args: CircularChart3DLoadedEventArgs): void => {
        if (
          document.getElementById(
            'circularChart3DchartContainer_Secondary_Element'
          )
        ) {
          document
            .getElementById('circularChart3DchartContainer_Secondary_Element')
            .remove();
        }
    ...
    it('Checking circular 3D highlight animation method', (done: Function) => {
      loaded = (args: CircularChart3DLoadedEventArgs): void => {
        ...
        args.chart.highlightAnimation(
          document.getElementById('circularChart3DchartContainer'),
          0,
          0
        );
        expect(
    ...
    it('Checking circular 3D chartMouseDown event', (done: Function) => {
      loaded = (args: CircularChart3DLoadedEventArgs): void => {
        let element: HTMLElement = document.getElementById(
          'circularChart3DchartContainer'
        );
        args.chart.chartMouseDown(
          <PointerEvent>(
