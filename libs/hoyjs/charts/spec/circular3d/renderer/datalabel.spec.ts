...
describe('Accumulation Chart Control', () => {
  ...
  describe('Checking Circular 3D Pie series and Donut Datalabel', () => {
    ...
    it('Datalabel common options', (done: Function) => {
      pie.loaded = (args: CircularChart3DLoadedEventArgs) => {
        ...
        datalabel = document.getElementById(
          id + '-svg-data-label-series-0-shape-2'
        );
    ...
    it('Datalabel Outside connector line length', (done: Function) => {
      pie.loaded = (args: CircularChart3DLoadedEventArgs) => {
        datalabel = document.getElementById(
          id + '-datalabel-series-0-connector-1'
        );
        expect(datalabel.getAttribute('d')).toBe(
          'M 447.500786277918 248.2758536682261 L 466.5086195611548 254.4969688316573 M 466.5086195611548 254.4969688316573 L 476.5086195611548 254.4969688316573 '
        );
        done();
      };
    ...
    it('Datalabel Outside connector with and fill', (done: Function) => {
      pie.loaded = (args: CircularChart3DLoadedEventArgs) => {
        ...
        datalabel = document.getElementById(
          id + '-datalabel-series-0-connector-3'
        );
        expect(datalabel.getAttribute('d')).toBe(
          'M 384.22536733858567 330.3576905927698 L 395.0791517894344 347.1563620609103 M 395.0791517894344 347.1563620609103 L 405.0791517894344 347.1563620609103 '
        );
        expect(datalabel.getAttribute('stroke')).toBe('brown');
        expect(datalabel.getAttribute('stroke-width')).toBe('3');
        done();
    ...
    it('Datalabel angle checking', (done: Function) => {
      pie.loaded = (args: CircularChart3DLoadedEventArgs) => {
        ...
        expect(datalabel.getAttribute('transform')).toBe(
          'rotate(45,581.3848893154216,225.38047328863155)'
        );
        done();
      };
