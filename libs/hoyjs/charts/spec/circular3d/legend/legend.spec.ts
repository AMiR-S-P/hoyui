...
export const piedata: Object[] = [
  { y: 18, x: 'Bald Eagle', text: 'Bald Eagle : 18' },
  { y: 23, x: 'Bison', text: 'Bison : 23' },
  { y: 30, x: 'Brown Bear', text: 'Brown Bear : 30' },
  { y: 44, x: 'Elk', text: 'Elk : 44' },
  { y: 52, x: 'Pronghorn', text: 'Pronghorn : 52' },
  { y: 62, x: 'Turkey', text: 'Turkey : 62' },
];
  ...
  describe('Pie Legend checking', () => {
    ...
    it('Pie Legend visibility visible checking', (done: Function) => {
      pie.loaded = () => {
        ...
        expect(legendEle.childNodes.length).toBe(
          pie.visibleSeries[0].points.length
        );
        done();
      };
    ...
    it('Pie Legend chekcing with padding', (done: Function) => {
      pie.loaded = () => {
        ...
        const legendShapeX: number = parseInt(
          legendEle.getAttribute('d').split(' ')[1],
          10
        );
    ...
    it('Pie Legend chekcing with shape height', (done: Function) => {
      pie.loaded = () => {
        legendEle = getElement(legendId + '_shape_0');
        expect(legendEle.getAttribute('d')).toBe(
          'M 113 116 L 118 116 A 5 5 0 1 1 113 111 Z M 114 114.8 L118 114.8 A 5 5 0 0 0 114 111 Z'
        );
        done();
      };
    ...
    it('Pie Legend chekcing with shape width', (done: Function) => {
      pie.loaded = () => {
        ...
        expect(legendEle.getAttribute('d')).toBe(
          'M 114 140 L 119 140 A 5 5 0 1 1 114 135 Z M 115.2 139 L119 139 A 5 5 0 0 0 115.2 135 Z'
        );
        done();
      };
    ...
    it('Pie Legend chekcing with shapePadding', (done: Function) => {
      pie.loaded = () => {
        legendEle = getElement(legendId + '_shape_1');
        expect(legendEle.getAttribute('d')).toBe(
          'M 113 140 L 118 140 A 5 5 0 1 1 113 135 Z M 114 139 L118 139 A 5 5 0 0 0 114 135 Z'
        );
        done();
      };
    ...
    it('Pie Legend chekcing with description', (done: Function) => {
      pie.loaded = () => {
        ...
        expect(legendEle.getAttribute('aria-label')).toBe(
          'Pie Legend chekcing with description'
        );
        done();
      };
  ...
  describe('Checking Pie Legend Events', () => {
    ...
    it('Check Legend Render event with HTML Entity', (done: Function) => {
      pie.loaded = () => {
        ...
        expect(legendEle.textContent).toBe(
          'Legend Text changed Using Legend Render & added the HTML Entity'
        );
        done();
      };
    ...
    it('Legend long text trimming feature checking textover flow as Clip', (done: Function) => {
      pie.loaded = () => {
        legendEle = getElement(legendId + '_g_0');
        expect(
          (<HTMLElement>legendEle.childNodes[1]).textContent.indexOf('...') ===
            -1
        ).toBe(true);
        done();
      };
