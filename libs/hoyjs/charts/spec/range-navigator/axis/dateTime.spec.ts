...
dateTime = [
  { x: new Date(2000, 3), y: 34 },
  { x: new Date(2000, 6), y: 32 },
  { x: new Date(2000, 11), y: 23 },
  { x: new Date(2001, 3), y: 12 },
  { x: new Date(2001, 6), y: 83 },
  { x: new Date(2001, 11), y: 76 },
  { x: new Date(2002, 3), y: 34 },
  { x: new Date(2002, 6), y: 32 },
  { x: new Date(2002, 11), y: 65 },
  { x: new Date(2003, 3), y: 98 },
  { x: new Date(2003, 6), y: 10 },
  { x: new Date(2003, 11), y: 34 },
];
  ...
  describe('with default case', () => {
    ...
    it('checking with minimum only', (done: Function) => {
      range.loaded = (args: Object): void => {
        ...
        expect(
          element.childNodes[0].childNodes[0].firstChild.textContent
        ).toEqual('Dec');
        done();
      };
    ...
    it('checking with label position inside, tick position outside', (done: Function) => {
      range.loaded = (args: Object): void => {
        ...
        expect(
          +element.getAttribute('x') >= 43 && +element.getAttribute('x') <= 65
        ).toBe(true);
        done();
      };
      range.labelPosition = 'Inside';
    ...
    it('checking with label position outside, tick position inside', (done: Function) => {
      range.loaded = (args: Object): void => {
        let element: Element = document.getElementById('container_AxisLabel_0');
        expect(
          +element.getAttribute('y') > 100 && +element.getAttribute('y') < 115
        ).toBe(true);
        done();
      };
    ...
    it('checking with default grouping', (done: Function) => {
      range.loaded = (args: object): void => {
        ...
        expect(axisLabel.childNodes[1].lastChild.textContent).toBe(
          'Quarter2 2003'
        );
        done();
      };
    ...
    it('checking with grouped label position inside, tick position outside', (done: Function) => {
      range.loaded = (args: Object): void => {
        element = document.getElementById('container_AxisLabel_0');
        expect(
          element.getAttribute('y') === '82' ||
            element.getAttribute('y') === '77'
        ).toBe(true);
        done();
      };
      range.labelPosition = 'Inside';
    ...
    it('checking with grouped labels, label position outside, tickposition outside', (done: Function) => {
      range.loaded = (args: Object): void => {
        element = document.getElementById('container_AxisLabel_0');
        expect(
          element.getAttribute('y') === '83' ||
            element.getAttribute('y') === '84.25'
        ).toEqual(true);
        done();
      };
      range.labelPosition = 'Outside';
    ...
    it('checked with quarter as label type', (done: Function) => {
      ...
      range.series[0].dataSource = [
        { x: new Date(2018, 0, 1), y: 23 },
        { x: new Date(2018, 4, 12), y: 34 },
        { x: new Date(2018, 8, 23), y: 32 },
        { x: new Date(2018, 10, 45), y: 56 },
      ];
    ...
    it('checked with quarter as label type started Quarter3', (done: Function) => {
      ...
      range.series[0].dataSource = [
        { x: new Date(2018, 7, 1), y: 23 },
        { x: new Date(2018, 8, 12), y: 34 },
        { x: new Date(2018, 8, 23), y: 32 },
        { x: new Date(2018, 10, 45), y: 56 },
      ];
      range.intervalType = 'Quarter';
    ...
    it('checked with quarter as label type started as quarter4', (done: Function) => {
      ...
      range.series[0].dataSource = [
        { x: new Date(2018, 10, 1), y: 23 },
        { x: new Date(2018, 10, 12), y: 34 },
        { x: new Date(2019, 1, 23), y: 32 },
        { x: new Date(2019, 10, 45), y: 56 },
      ];
      range.intervalType = 'Quarter';
      range.refresh();
    });
    it('checked with secondary axis label alignment far', (done: Function) => {
      ...
      range.series[0].dataSource = [
        { x: new Date(2018, 10, 1), y: 23 },
        { x: new Date(2018, 10, 12), y: 34 },
        { x: new Date(2018, 11, 23), y: 32 },
        { x: new Date(2018, 11, 45), y: 56 },
      ];
      range.intervalType = 'Quarter';
    ...
    it('checked with month as label type', (done: Function) => {
      ...
      range.series[0].dataSource = [
        { x: new Date(2018, 0, 1), y: 23 },
        { x: new Date(2018, 2, 12), y: 34 },
        { x: new Date(2018, 4, 23), y: 32 },
        { x: new Date(2018, 6, 45), y: 56 },
      ];
    ...
    it('checked with weeks as label type', (done: Function) => {
      ...
      range.series[0].dataSource = [
        { x: new Date(2018, 0, 12), y: 23 },
        { x: new Date(2018, 0, 23), y: 34 },
        { x: new Date(2018, 1, 23), y: 32 },
        { x: new Date(2018, 1, 25), y: 56 },
      ];
    ...
    it('checked with days as label type', (done: Function) => {
      ...
      range.series[0].dataSource = [
        { x: new Date(2018, 0, 1), y: 23 },
        { x: new Date(2018, 0, 2), y: 34 },
        { x: new Date(2018, 1, 3), y: 32 },
        { x: new Date(2018, 1, 10), y: 56 },
      ];
    ...
    it('checked with hours as label type', (done: Function) => {
      ...
      range.series[0].dataSource = [
        { x: new Date(2018, 0, 1, 4), y: 23 },
        { x: new Date(2018, 0, 1, 5), y: 34 },
        { x: new Date(2018, 0, 1, 8), y: 32 },
        { x: new Date(2018, 0, 1, 9), y: 56 },
      ];
    ...
    it('checked with Minutes as label type', (done: Function) => {
      ...
      range.series[0].dataSource = [
        { x: new Date(2018, 0, 1, 10, 12), y: 23 },
        { x: new Date(2018, 0, 1, 10, 22), y: 34 },
        { x: new Date(2018, 0, 1, 10, 33), y: 32 },
        { x: new Date(2018, 0, 1, 10, 42), y: 56 },
      ];
    ...
    it('checked with seconds as label type', (done: Function) => {
      range.loaded = (args: Object): void => {
        axisLabel = document.getElementById('container_AxisLabels');
        expect(axisLabel.childNodes[0].lastChild.textContent).toBe(
          '10:12:40 AM'
        );
      ...
      range.series[0].dataSource = [
        { x: new Date(2018, 0, 1, 10, 12, 10), y: 23 },
        { x: new Date(2018, 0, 1, 10, 12, 20), y: 34 },
        { x: new Date(2018, 0, 1, 10, 12, 30), y: 32 },
        { x: new Date(2018, 0, 1, 10, 12, 40), y: 56 },
      ];
    ...
    it('checcking with Years and enable grouping', (done: Function) => {
      ...
      range.dataSource = [
        { x: new Date(2000, 2), y: 23 },
        { x: new Date(2002, 4), y: 45 },
        { x: new Date(2010, 3), y: 12 },
      ];
    ...
    it('checking with lightweight interval type as Auto(year)', (done: Function) => {
      ...
      range.dataSource = [
        { x: new Date(2000, 0), y: 23 },
        { x: new Date(2005, 0), y: 34 },
        { x: new Date(2006, 0), y: 45 },
        { x: new Date(2010, 0), y: 23 },
      ];
      range.series = [];
    ...
    it('checking with lightweight interval type as quarter', (done: Function) => {
      range.loaded = (args: Object) => {
        axisLabel = document.getElementById('container_AxisLabels');
        expect(
          axisLabel.childNodes[0].firstChild.textContent.indexOf('Q') > -1
        ).toBe(true);
        done();
      };
      range.intervalType = 'Quarter';
    ...
    it('checking with lightweight interval type as Auto(Days)', (done: Function) => {
      ...
      range.dataSource = [
        { x: new Date(2000, 0, 23), y: 23 },
        { x: new Date(2000, 0, 25), y: 34 },
      ];
      range.series = [];
      range.intervalType = 'Auto';
      range.xName = 'x';
    ...
    it('checking with lightweight interval type as days', (done: Function) => {
      range.loaded = (args: Object) => {
        axisLabel = document.getElementById('container_AxisLabels');
        expect(axisLabel.childNodes[0].firstChild.textContent).toEqual(
          'Jan 23'
        );
        done();
      };
    ...
    it('checking with lightweight interval type as Auto(Hours)', (done: Function) => {
      ...
      range.dataSource = [
        { x: new Date(2000, 0, 23, 1), y: 23 },
        { x: new Date(2000, 0, 23, 20), y: 34 },
      ];
      range.series = [];
      range.intervalType = 'Auto';
      range.xName = 'x';
    ...
    it('checking with lightweight interval type as Auto(Minutes)', (done: Function) => {
      ...
      range.dataSource = [
        { x: new Date(2000, 0, 23, 1, 20), y: 23 },
        { x: new Date(2000, 0, 23, 1, 30), y: 34 },
      ];
      range.series = [];
      range.intervalType = 'Auto';
      range.xName = 'x';
    ...
    it('checking with lightweight interval type as Auto(Seconds)', (done: Function) => {
      ...
      range.dataSource = [
        { x: new Date(2000, 0, 23, 1, 20, 10), y: 23 },
        { x: new Date(2000, 0, 23, 1, 20, 40), y: 34 },
      ];
      range.series = [];
      range.intervalType = 'Auto';
      range.xName = 'x';
    ...
    it('checking with label styles', (done: Function) => {
      range.loaded = (args: Object) => {
        axisLabel = document.getElementById('container_AxisLabels');
        expect(
          (<Element>axisLabel.childNodes[0].firstChild).getAttribute('fill')
        ).toEqual('red');
        done();
      };
      range.skeleton = '';
    ...
    it('checking with font family', () => {
      axisLabel = document.getElementById('container_AxisLabels');
      expect(
        (<Element>axisLabel.childNodes[0].firstChild).getAttribute(
          'font-family'
        )
      ).toEqual('Calibri');
    });
    ...
    it('checking with opacity', () => {
      axisLabel = document.getElementById('container_AxisLabels');
      expect(
        (<Element>axisLabel.childNodes[0].firstChild).getAttribute('font-style')
      ).toEqual('italic');
    });
    ...
    it('checking light weight without grouping Year', (done: Function) => {
      ...
      range.dataSource = [
        { x: new Date(2000, 2, 4), y: 23 },
        { x: new Date(2010, 2, 4), y: 23 },
      ];
    ...
    it('checking light weight without grouping Weeks', (done: Function) => {
      range.loaded = (args: Object) => {
        ...
        expect(axisLabel.childNodes[0].firstChild.textContent).toEqual('Week1');
        expect(
          axisLabel.childNodes[0].lastChild.textContent === 'W36' ||
            axisLabel.childNodes[0].lastChild.textContent === 'W35' ||
            axisLabel.childNodes[0].lastChild.textContent === 'Week8'
        ).toBe(true);
        done();
      };
      range.dataSource = [
    ...
    it('checking light weight without grouping Days', (done: Function) => {
      range.loaded = (args: Object) => {
        ...
        expect(
          axisLabel.childNodes[0].lastChild.textContent === 'Nov 6' ||
            axisLabel.childNodes[0].lastChild.textContent === 'Nov 1' ||
            axisLabel.childNodes[0].lastChild.textContent === 'Nov 2' ||
            axisLabel.childNodes[0].lastChild.textContent === 'Nov 9'
        ).toBe(true);
        done();
      };
      range.dataSource = [
        { x: new Date(2000, 2, 4), y: 23 },
        { x: new Date(2000, 10, 10), y: 23 },
      ];
      range.intervalType = 'Days';
      range.refresh();
    });
    it('checking with area series', (done: Function) => {
      ...
      range.intervalType = 'Auto';
      range.series = [
        { dataSource: data, xName: 'x', yName: 'y', type: 'Area' },
      ];
      range.refresh();
    });
    ...
    it('checking with date value as string', (done: Function) => {
      ...
      range.series[0].dataSource = [
        { x: '2018/01/01 00:00:00', y: 21 },
        { x: '2018/02/01 00:00:00', y: 70 },
        { x: '2019/02/01 00:00:00', y: 70 },
      ];
    ...
    it('checking with date value as interval type quarter', (done: Function) => {
      ...
      (range.intervalType = 'Quarter'), (range.interval = 1);
      range.refresh();
    });
    it('checking with date value as interval type weeks', (done: Function) => {
      range.loaded = (args: Object) => {
        axisLabel = document.getElementById('container_AxisLabels');
        expect(
          axisLabel.childNodes[0].firstChild.textContent.indexOf('W') > -1
        ).toBe(true);
        done();
      };
      done();
      range.series = [{ dataSource: data, xName: 'x', yName: 'y' }];
      (range.intervalType = 'Weeks'), (range.interval = 1);
      range.refresh();
    });
    it('checking with same y value', (done: Function) => {
      range.loaded = (args: Object) => {
        axisLabel = document.getElementById('container_AxisLabels');
        expect(axisLabel.childNodes[0].firstChild.textContent === '12 AM').toBe(
          true
        );
        done();
      };
      ...
      range.series[0].dataSource = [
        { x: new Date('2023-09-04T00:00:00Z'), y: 1 },
        { x: new Date('2023-09-08T00:00:00Z'), y: 1 },
      ];
      (range.intervalType = 'Auto'), (range.interval = null);
      range.refresh();
    });
  });
  it('memory leak', () => {
