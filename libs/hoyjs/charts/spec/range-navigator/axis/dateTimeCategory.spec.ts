...
dateTimeCat = [
  { x: new Date(2000, 3), y: 36 },
  { x: new Date(2000, 6), y: 34 },
  { x: new Date(2000, 11), y: 25 },
  { x: new Date(2001, 3), y: 14 },
  { x: new Date(2001, 6), y: 85 },
  { x: new Date(2001, 11), y: 78 },
  { x: new Date(2002, 3), y: 36 },
  { x: new Date(2002, 6), y: 34 },
  { x: new Date(2002, 11), y: 67 },
  { x: new Date(2003, 3), y: 100 },
  { x: new Date(2003, 6), y: 12 },
  { x: new Date(2003, 11), y: 36 },
];
let unorderedData: object[] = [];
unorderedData = [
  { x: new Date(2000, 11), y: 36 },
  { x: new Date(2000, 6), y: 34 },
  { x: new Date(2000, 3), y: 25 },
  { x: new Date(2001, 3), y: 14 },
  { x: new Date(2001, 6), y: 85 },
  { x: new Date(2001, 11), y: 78 },
  { x: new Date(2002, 3), y: 36 },
  { x: new Date(2002, 6), y: 34 },
  { x: new Date(2002, 11), y: 67 },
  { x: new Date(2003, 11), y: 100 },
  { x: new Date(2003, 3), y: 12 },
  { x: new Date(2003, 6), y: 36 },
];
  ...
  describe('with default case', () => {
    ...
    it('checked with quarter as label type', (done: Function) => {
      range.loaded = (args: Object): void => {
        ...
        expect(axisLabel.firstChild.childNodes[2].textContent).toBe(
          'Quarter3 2018'
        );
        done();
      };
    ...
    it('checking with default grouping', (done: Function) => {
      range.loaded = (args: object): void => {
        axisLabel = document.getElementById('container_AxisLabels');
        expect(axisLabel.childNodes[0].lastChild.textContent).toEqual(
          'Quarter3'
        );
