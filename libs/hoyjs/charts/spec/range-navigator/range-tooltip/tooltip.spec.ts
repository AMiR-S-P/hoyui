...
describe('Range navigator Tooltip', () => {
  ...
  describe('with Sliders double axis', () => {
    ...
    let rangeElement: HTMLElement = createElement('div', {
    ...
    it('checking with left slider moving', (done: Function) => {
      range.loaded = (args: object) => {
        ...
        expect(getElement('tooltip_container_Secondary_Element') !== null).toBe(
          true
        );
        expect(
          getElement('tooltip_container_Secondary_Element').childElementCount
        ).toBe(2);
        done();
      };
      range.refresh();
    ...
    it('checking with right slider moving', (done: Function) => {
      range.loaded = (args: object) => {
        ...
        expect(
          getElement('tooltip_container_leftTooltip_text').textContent
        ).not.toEqual('');
        expect(
          getElement('tooltip_container_rightTooltip_text').textContent
        ).not.toEqual('');
        done();
      };
      range.refresh();
    ...
    it('checking with left slider moving over right slider', (done: Function) => {
      range.loaded = (args: object) => {
        ...
        let leftValue: number = +getElement(
          'tooltip_container_leftTooltip_text'
        ).textContent;
        let rightValue: number = +getElement(
          'tooltip_container_rightTooltip_text'
        ).textContent;
    ...
    it('checking with tooltip cancel', (done: Function) => {
      range.loaded = (args: object) => {
        ...
        expect(getElement('tooltip_container_leftTooltip_text') === null).toBe(
          true
        );
        done();
      };
    ...
    it('checking with tooltip format', (done: Function) => {
      range.loaded = (args: object) => {
        ...
        let leftValue: string = getElement(
          'tooltip_container_leftTooltip_text'
        ).textContent;
        let rightValue: string = getElement(
          'tooltip_container_rightTooltip_text'
        ).textContent;
    ...
    it('checking with tooltip template', (done: Function) => {
      range.loaded = (args: object) => {
        ...
        let leftValue: string = getElement(
          'tooltip_container_leftTooltipparent_template'
        ).innerHTML;
  ...
  describe('with Sliders date time axis  with leight weight', () => {
    ...
    it('checking tooltip with fluent2 RTL', (done: Function) => {
      range.loaded = (args: object) => {
        ...
        let leftValue: string = getElement(
          'tooltip_container_leftTooltip_path'
        ).getAttribute('fill');
        let rightValue: string = getElement(
          'tooltip_container_rightTooltip_path'
        ).getAttribute('fill');
