  ...
  describe('RTL with numeric axis', () => {
    ...
    it('checking with rtl slider mouse event', (done: Function) => {
      range.loaded = (args: Object): void => {
        ...
        let leftthumbTransform: string = document
          .getElementById('container_LeftSlider')
          .getAttribute('transform');
        expect(
          thumbTransform === 'translate(386.00000000000006, 0)' ||
            thumbTransform === 'translate(381, 0)' ||
            thumbTransform === 'translate(386, 0)' ||
            thumbTransform === 'translate(385.99999999999994, 0)'
        ).toBe(true);
