...
describe('Diagram Control', () => {
    ...
    beforeAll((): void => {
      ...
      let node7: NodeModel = {
        ...
        annotations: [
          {
            id: 'label7',
            content: 'Reject and write report',
            offset: { x: 0.5, y: 0.5 },
          },
        ],
      };
      ...
      diagram = new Diagram({
        width: 600,
        height: 500,
        nodes: [node1, node2, node3, node4, node5, node7, node8],
        connectors: [
          connector1,
          connector2,
          connector3,
      ...
      function getcontent(): HTMLElement {
        ...
        tooltipContent.innerHTML =
          '<div style="background-color: #f4f4f4; color: black; border-width:1px;border-style: solid;' +
  ...
  describe('Checking Swimlane', () => {
    ...
    it('Child after loading', (done: Function) => {
      ...
      console.log(
        'swimlane lane childs = ' +
          (diagram2.nodes[0].shape as SwimLane).lanes[0].children.length
      );
      expect(
        (diagram2.nodes[0].shape as SwimLane).lanes[0].children.length === 1
      ).toBe(true);
      done();
    });
  });
  ...
  describe('addport and label', () => {
    ...
    it('Checking label add', (done: Function) => {
      ...
      let label: ShapeAnnotationModel[] = [
        { id: '123', content: 'Default Shape', offset: { y: 0.2 } },
        { id: '789', content: 'Default Shape', offset: { y: 0.4 } },
      ];
          ...
          commands: [
            {
              ...
              canExecute: function () {
                if (
                  diagram2.selectedItems.nodes.length > 0 ||
                  diagram2.selectedItems.connectors.length > 0
                ) {
                  return true;
                }
                return false;
