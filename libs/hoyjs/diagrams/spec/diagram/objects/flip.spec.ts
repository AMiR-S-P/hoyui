...
describe('Diagram Control', () => {
  describe('Flip Operation for node', () => {
    ...
    it('Checking flip horizontal after changing node offsetX', (done: Function) => {
      ...
      diagram.nodes[0].flip = 'Horizontal';
      expect(
        diagram.nodes[0].offsetX === 400 && diagram.nodes[0].offsetY === 100
      ).toBe(true);
      done();
    });
    it('Checking flip horizontal after changing node offsetY', (done: Function) => {
      ...
      diagram.nodes[0].flip = 'Horizontal';
      expect(
        diagram.nodes[0].offsetX === 400 && diagram.nodes[0].offsetY === 400
      ).toBe(true);
      done();
    });
  ...
  describe('Flip Operation for connector', () => {
    ...
    it('Checking flip vertical to connector', (done: Function) => {
      expect(
        diagram.connectors[0].sourcePoint.x === 400 &&
          diagram.connectors[0].sourcePoint.y === 200 &&
          diagram.connectors[0].targetPoint.x === 200 &&
          diagram.connectors[0].targetPoint.y === 400
      ).toBe(true);
      let diagramCanvas: HTMLElement = document.getElementById(
        diagram.element.id + 'content'
      );
    ...
    it('Checking flip vertical for connector source point change', (done: Function) => {
      expect(
        (diagram.connectors[0].wrapper.children[0] as PathElement)
          .absolutePath === 'M 200 200 L 200 180 L 0 180 L 0 0.5'
      ).toBe(true);
      let diagramCanvas: HTMLElement = document.getElementById(
        diagram.element.id + 'content'
      );
    ...
    it('Checking flip vertical for connector target  point change', (done: Function) => {
      expect(
        (diagram.connectors[0].wrapper.children[0] as PathElement)
          .absolutePath === 'M 100 0 L 100 20 L 0 20 L 0 99.5'
      ).toBe(true);
      let diagramCanvas: HTMLElement = document.getElementById(
        diagram.element.id + 'content'
      );
    ...
    it('Checking flip both for connector target  point change', (done: Function) => {
      expect(
        (diagram.connectors[0].wrapper.children[0] as PathElement)
          .absolutePath === 'M 0 0 L 0 20 L 100 20 L 100 249.5'
      ).toBe(true);
      let diagramCanvas: HTMLElement = document.getElementById(
        diagram.element.id + 'content'
      );
    ...
    it('Checking flip both for connector target  point change', (done: Function) => {
      expect(
        (diagram.connectors[0].wrapper.children[0] as PathElement)
          .absolutePath === 'M 100 250 L 100 230 L 0 230 L 0 0.5'
      ).toBe(true);
      done();
    });
  });
    ...
    it('Checking without flip', (done: Function) => {
      ...
      expect(
        diagram.nodes[0].offsetX === 100 &&
          ...
          diagram.nodes[0].ports[0].offset.x === 0 &&
          diagram.nodes[0].ports[0].offset.y === 0.5
      ).toBe(true);
      done();
    });
  ...
  describe('Flip Operation for Bpmn Shapes', () => {
    ...
    it('Drag the bpmn shapes with flip', (done: Function) => {
      ...
      expect(
        diagram.nodes[0].offsetX === 130 &&
          diagram.nodes[0].offsetY === 130 &&
          diagram.nodes[0].ports[0].offset.x === 0 &&
          diagram.nodes[0].ports[0].offset.y === 0.5
      ).toBe(true);
      done();
  ...
  describe('Connectors-Flip change and Testing ', () => {
    ...
    it('Changing the flip and checking functionality', function (done) {
      expect(
        (diagram.connectors[0].wrapper.children[0] as any).pathData ===
          'M100 100 L146.46446609406726 146.46446609406726A 5 5 -135 , 1 1 153.53553390593274,153.53553390593274 L199.65 199.65'
      );
      expect(
        (diagram.connectors[1].wrapper.children[0] as any).pathData ===
          'M200 100 L153.53553390593274 146.46446609406726A 5 5 -45 , 1 0 146.46446609406726,153.53553390593274 L100.35 199.65'
      );
      expect(
        (diagram.connectors[2].wrapper.children[0] as any).pathData ===
          'M400 100 L499.65 199.65'
      );
      expect(
        (diagram.connectors[3].wrapper.children[0] as any).pathData ===
          'M400 200 L499.65 299.65'
      );
      diagram.connectors[0].flip = 'Both';
    ...
    it('After changing flip in runtime and checking functionality', function (done) {
      expect(
        (diagram.connectors[0].wrapper.children[0] as any).pathData ===
          'M200 200 L153.5355339059327 153.53553390593274A 5 5 45 , 1 0 146.46446609406723,146.46446609406726 L100.35 100.35'
      );
      expect(
        (diagram.connectors[1].wrapper.children[0] as any).pathData ===
          'M100 200 L146.46446609406726 153.5355339059327A 5 5 135 , 1 1 153.5355339059327,146.46446609406723 L199.65 100.35'
      );
      expect(
        (diagram.connectors[2].wrapper.children[0] as any).pathData ===
          'M500 100 L400.35 199.65'
      );
      expect(
        (diagram.connectors[3].wrapper.children[0] as any).pathData ===
          'M500 200 L400.35 299.65'
      );
      done();
    });
  });
