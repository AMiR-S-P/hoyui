...
describe('Diagram Control', () => {
  describe('BPMN Events', () => {
    ...
    it('Checking event as Start and trigger as None', (done: Function) => {
      ...
      expect(
        value === 'url(#node7_0_event_linear)' &&
          wrapper.style.fill == 'transparent'
      ).toBe(true);
    ...
    it('Checking event as NonInterruptingStart and trigger as None ', (done: Function) => {
      ...
      expect(
        wrapper.children[0].actualSize.width === 100 &&
          ...
          wrapper.children[1].actualSize.width === 85 &&
          wrapper.children[1].actualSize.height === 85 &&
          wrapper.children[1].offsetX === 300 &&
          wrapper.children[1].offsetY === 100 &&
          //third node
          wrapper.children[2].actualSize.width === 54 &&
          wrapper.children[2].actualSize.height === 40 &&
    ...
    it('Checking event as Intermediate and trigger as None ', (done: Function) => {
      ...
      expect(
        wrapper.children[0].actualSize.width === 100 &&
          ...
          wrapper.children[1].actualSize.width === 85 &&
          wrapper.children[1].actualSize.height === 85 &&
          wrapper.children[1].offsetX === 500 &&
          wrapper.children[1].offsetY === 100 &&
          //third node
          wrapper.children[2].actualSize.width === 54 &&
          wrapper.children[2].actualSize.height === 40 &&
    ...
    it('Checking event as NonInterruptingIntermediate and trigger as None ', (done: Function) => {
      ...
      expect(
        wrapper.children[0].actualSize.width === 100 &&
          ...
          wrapper.children[1].actualSize.width === 85 &&
          wrapper.children[1].actualSize.height === 85 &&
          wrapper.children[1].offsetX === 700 &&
          wrapper.children[1].offsetY === 100 &&
          //third node
    ...
    it('Checking event as ThrowingIntermediate and trigger as None ', (done: Function) => {
      ...
      expect(
        wrapper.children[0].actualSize.width === 100 &&
          ...
          wrapper.children[1].actualSize.width === 85 &&
          wrapper.children[1].actualSize.height === 85 &&
          wrapper.children[1].offsetX === 900 &&
          wrapper.children[1].offsetY === 100 &&
          //third node
          wrapper.children[2].actualSize.width === 50 &&
          wrapper.children[2].actualSize.height === 50 &&
    ...
    it('Checking event as End and trigger as None', (done: Function) => {
      ...
      expect(
        wrapper.children[0].actualSize.width === 100 &&
          wrapper.children[0].actualSize.height === 100 &&
          wrapper.children[0].offsetX === 1100 &&
          wrapper.children[0].offsetY === 100 &&
          //second node
          wrapper.children[1].actualSize.width === 85 &&
          wrapper.children[1].actualSize.height === 85 &&
          wrapper.children[1].offsetX === 1100 &&
          wrapper.children[1].offsetY === 100 &&
          //third node
          wrapper.children[2].actualSize.width === 50 &&
          wrapper.children[2].actualSize.height === 50 &&
          wrapper.children[2].offsetX === 1100 &&
          wrapper.children[2].offsetY === 100
      ).toBe(true);
      done();
    });
    ...
    it('Checking event as Start and trigger as Message', (done: Function) => {
      let wrapper: Canvas = (diagram.nodes[6] as NodeModel).wrapper
        .children[0] as Canvas;
      expect(
        wrapper.children[0].actualSize.width === 100 &&
          wrapper.children[0].actualSize.height === 100 &&
          ...
          wrapper.children[1].actualSize.height === 85 &&
          wrapper.children[1].offsetX === 100 &&
          wrapper.children[1].offsetY === 300 &&
          //third node
          wrapper.children[2].actualSize.width === 54 &&
          wrapper.children[2].actualSize.height === 40 &&
          wrapper.children[2].offsetX === 100 &&
          wrapper.children[2].offsetY === 300
      ).toBe(true);
      done();
    });

    it('Checking event as NonInterruptingStart and trigger as Multiple', (done: Function) => {
      let wrapper: Canvas = (diagram.nodes[7] as NodeModel).wrapper
        .children[0] as Canvas;
      expect(
        wrapper.children[0].actualSize.width === 100 &&
          wrapper.children[0].actualSize.height === 100 &&
    ...
    it('Checking event as Start and trigger as cancel ', (done: Function) => {
      ...
      expect(
        wrapper.children[0].actualSize.width === 100 &&
          wrapper.children[0].actualSize.height === 100 &&
          wrapper.children[0].offsetX === 100 &&
          wrapper.children[0].offsetY === 500 &&
          //second node
          wrapper.children[1].actualSize.width === 85 &&
          wrapper.children[1].actualSize.height === 85 &&
          wrapper.children[1].offsetX === 100 &&
          wrapper.children[1].offsetY === 500 &&
          //third node
          wrapper.children[2].actualSize.width === 50 &&
          wrapper.children[2].actualSize.height === 50 &&
          wrapper.children[2].offsetX === 100 &&
          wrapper.children[2].offsetY === 500
      ).toBe(true);
      done();
    });
      ...
      let nodes: NodeModel[] = [
        ...
        },
        {
          ...
          shape: {
            type: 'Bpmn',
            shape: 'Group',
            group: { type: 'group', children: ['start'] },
          } as any,
        },
        {
          ...
          shape: {
            type: 'Bpmn',
            shape: 'Event',
            event: { event: 'NonInterruptingStart' },
          },
          width: 100,
          height: 100,
        ...
        },
        {
          ...
          shape: {
            ...
            activity: {
              ...
              subProcess: {
                collapsed: false,
                processes: ['nonInterruptingStart'],
              },
            },
          },
        },
