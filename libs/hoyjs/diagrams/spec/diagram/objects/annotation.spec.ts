...
} from '../../../src/diagram/objects/annotation-model';
...
describe('Diagram Control', () => {
  describe('Annotation alignment- horizontal center', () => {
    ...
    it('Checking horizontal center annotation alignment', (done: Function) => {
      expect(
        (diagram.nodes[0] as Node).wrapper.children[1].offsetX === 100 &&
          ...
          (diagram.nodes[3] as Node).wrapper.children[1].offsetY === 100
      ).toBe(true);
    ...
    it('Checking horizontal left annotation alignment', (done: Function) => {
      (diagram.nodes[0] as NodeModel).annotations[0].horizontalAlignment =
        'Left';
      (diagram.nodes[1] as NodeModel).annotations[0].horizontalAlignment =
        'Left';
      (diagram.nodes[2] as NodeModel).annotations[0].horizontalAlignment =
        'Left';
      (diagram.nodes[3] as NodeModel).annotations[0].horizontalAlignment =
        'Left';
      diagram.dataBind();
      expect(
        (diagram.nodes[0] as Node).wrapper.children[1].offsetX === 150 &&
          (diagram.nodes[0] as Node).wrapper.children[1].offsetY === 100 &&
    ...
    it('Checking horizontal right annotation alignment', (done: Function) => {
      ...
      diagram.dataBind();
      expect(
        (diagram.nodes[0] as Node).wrapper.children[1].offsetX === 50 &&
          (diagram.nodes[0] as Node).wrapper.children[1].offsetY === 100 &&
    ...
    it('Checking annotation bold at the run time', (done: Function) => {
      ...
      diagram.dataBind();
      let value: HTMLElement = document.getElementById(
        diagram.nodes[0].wrapper.children[1].id + '_text'
      );
    ...
    it('checking hyperlink', (done: Function) => {
      ...
      (diagram.nodes[4] as NodeModel).annotations[0].hyperlink.link =
        'https://gitlab.syncfusion.com';
      diagram.dataBind();
      ...
      expect(
        (link as AnnotationModel).hyperlink.link ===
          'https://gitlab.syncfusion.com'
      ).toBe(true);
      done();
    });
    it('checking annotation hyperlink data bind', (done: Function) => {
      ...
      (diagram.nodes[5] as NodeModel).annotations[0].hyperlink.textDecoration =
        'Overline';
      ...
      expect(
        (element as AnnotationModel).hyperlink.link ===
          'https://gitlab.syncfusion.com' &&
          (element as AnnotationModel).hyperlink.content === 'git' &&
          (element as AnnotationModel).hyperlink.textDecoration ===
            'Overline' &&
    ...
    it('changing annotation content url not changing', (done: Function) => {
      let node: NodeModel = diagram.nodes[5];
      diagram.nodes[5].annotations[0].hyperlink.link =
        'https://gitlab.syncfusion.com/essential-studio/ej2-diagram-components';
      diagram.dataBind();
      let element: HyperlinkModel = node.wrapper.children[1] as HyperlinkModel;
      expect(
        (element as AnnotationModel).hyperlink.link ===
    ...
    it('checking annotation hyperlink data bind coverage', (done: Function) => {
      ...
      let element: HyperlinkModel = node.wrapper.children[1] as HyperlinkModel;
      expect(
        (element as AnnotationModel).style.textDecoration === 'None' &&
    ...
    it('Checking annotation alinments and positions in SVG rendering Mode on propertychange', (done: Function) => {
      ...
      diagram.dataBind();
      let node: HTMLElement = document.getElementById(
        diagram.nodes[0].id + '_' + diagram.nodes[0].annotations[0].id + '_text'
      );
      let valueX: string = (node.childNodes[0] as HTMLElement).getAttribute(
        'x'
      );
      let valueY: string = (node.childNodes[0] as HTMLElement).getAttribute(
        'y'
      );
      expect(
        valueX === '0' && (valueY === '28.6' || valueY === '27.400000000000002')
      ).toBe(true);
      done();
    });
  });
  ...
  describe('Annotation new line rendering', () => {
    ...
    it('Checking without label', (done: Function) => {
      expect(
        diagram.nameTable['node1'].wrapper.children[1].childNodes.length === 3
      ).toBe(true);
      done();
    });
  });
  describe('Annotation style update SVG mode', () => {
    ...
    beforeAll((): void => {
      ...
      let shape1: PathModel = {
        type: 'Path',
        data: 'M 0,0 L 100,0 L100,100 L0,100 Z',
      };
      let node1: NodeModel = {
        id: 'node1',
        width: 100,
    ...
    it('Testing label style in SVG mode', (done: Function) => {
      ...
      diagram.dataBind();
      expect(
        document.getElementById('node1_label1_text').style.fontWeight === 'bold'
      ).toBe(true);
      expect(
        document.getElementById('node1_label1_text').style.fontStyle ===
          'italic'
      ).toBe(true);
      ...
      diagram.dataBind();
      expect(
        document.getElementById('node1_label1_text').style.fontWeight ===
          'normal'
      ).toBe(true);
      expect(
        document.getElementById('node1_label1_text').style.fontStyle ===
    ...
    it('Testing label line height in SVG mode', (done: Function) => {
      ...
      diagram.dataBind();
      let textElement: HTMLElement = document.getElementById(
        diagram.nodes[0].id + '_' + diagram.nodes[0].annotations[0].id + '_text'
      );
      ...
      expect(
        (getAttributeX(0) === '0' || getAttributeX(0) === '1.6640625') &&
          getAttributeY(0) === '10.800000000000004'
      ).toBe(true);
      expect(
        (getAttributeX(1) === '3' || getAttributeX(1) === '4.6640625') &&
          getAttributeY(1) === '25.200000000000003'
      ).toBe(true);
      expect(
        (getAttributeX(2) === '3' || getAttributeX(2) === '4.6640625') &&
          getAttributeY(2) === '39.6'
      ).toBe(true);
      expect(
        (getAttributeX(3) === '3' || getAttributeX(3) === '4.6640625') &&
          getAttributeY(3) === '54'
      ).toBe(true);
      expect(
        (getAttributeX(4) === '3' || getAttributeX(4) === '4.6640625') &&
          getAttributeY(4) === '68.4'
      ).toBe(true);
      expect(
        getAttributeX(5) === '0' && getAttributeY(5) === '82.80000000000001'
      ).toBe(true);
      done();
    });
  });
  ...
  describe('Annotation Position Issue', () => {
    ...
    it('Testing label style in SVG mode', (done: Function) => {
      let transform: string = document
        .getElementById('node1_label1_text')
        .getAttribute('transform');
      let transform2: string = document
        .getElementById('node2_label1_text')
        .getAttribute('transform');
      console.log('transform' + transform);
      console.log('transform2' + transform2);
      expect(
        transform === 'rotate(0,100,137.2)translate(72.8193359375,130)'
      ).toBe(true);
      expect(
        transform2 === 'rotate(0,100,137.2)translate(82.162109375,130)'
      ).toBe(true);
      done();
    });
  });
  ...
  describe('Annotation Template', () => {
    ...
    beforeAll((): void => {
      ...
      htmlElement = createElement('div', {
        ...
        styles: 'background:red; height:100%;width:100%;',
      });
    ...
    it('Label temlpate rendering', function (done) {
      let html: HTMLElement = document.getElementById(
        'node1_label1_html_element'
      );
      let background = (html.children[0].children[0] as HTMLElement).style
        .background;
    ...
    it('Label temlpate rendering connector', function (done) {
      let html: HTMLElement = document.getElementById(
        'connector1_label1_html_element'
      );
      let background = (html.children[0].children[0] as HTMLElement).style
        .background;
      expect(html && background === 'red').toBe(true);
  ...
  describe('Annotation Template dragging support ', () => {
    ...
    it('Annotation template change during run time', (done: Function) => {
      diagram.nodes[0].annotations[0].template =
        '<div style="background:red; height:100%;width:100%;"><div/>';
      diagram.dataBind();
      let mouseEvents: MouseEvents = new MouseEvents();
      let diagramCanvas: HTMLElement = document.getElementById(
      ...
      expect(
        diagram.nodes[0].annotations[0].offset.x !== 0.5 &&
          diagram.nodes[0].annotations[0].offset.y !== 0.5
      ).toBe(true);
      diagram.clearSelection();
      done();
      diagram.connectors[0].annotations[0].template =
        '<div id="test-case" style="height:100%;width:100%;background:red;">';
      diagram.dataBind();
  ...
  describe('Annotation in BPMN Node', () => {
    ...
    it('By Enabling Virtualization', (done: Function) => {
      expect(diagram.nodes[1].annotations[0].content === 'Book hotel').toBe(
        true
      );
      done();
    });
  ...
  describe('Undo/redo not working for node annotation fontSize changed at runtime', () => {
    ...
    it('Undo/redo not working for node annotation fontSize changed at runtime', (done: Function) => {
      ...
      expect(
        e.children[2].children[1].getAttribute('style') ===
          'font-style: normal; font-weight: normal; font-size: 20px; font-family: Arial;'
      ).toBe(true);

      diagram.undo();
      expect(
        e.children[2].children[1].getAttribute('style') ===
          'font-style: normal; font-weight: normal; font-size: 12px; font-family: Arial;'
      ).toBe(true);
  ...
  describe('Undo/redo not working for node annotation fontSize changed at runtime -update fix', () => {
    ...
    var nodes: NodeModel[] = [
      ...
      },
      {
        ...
        offsetY: 330,
        shape: { type: 'Flow', shape: 'Process' },
        annotations: [{ content: 'Enter payment method' }],
      },
      {
        ...
        offsetY: 630,
        shape: { type: 'Flow', shape: 'Terminator' },
        annotations: [{ content: 'Log transaction' }],
      },
      {
        id: 'node12',
        height: 60,
        ...
        offsetY: 630,
        shape: { type: 'Flow', shape: 'Process' },
        annotations: [{ content: 'Reconcile the entries' }],
      },
      {
        ...
        offsetY: 530,
        shape: { type: 'Flow', shape: 'Process' },
        annotations: [{ content: 'Complete Transaction' }],
      },
      {
        id: 'Data',
        height: 45,
  ...
  describe('Text element With text overflow', () => {
            ...
            annotations: [
              {
                id: 'label1',
                content:
                  'The text element given with property of overflow as clip and wrapping as wrap, so pls refer the content',
            ...
            annotations: [
              {
                id: 'label2',
                content:
                  'The text element given with property of overflow as Ellipsis and wrapping as wrap so that element to be clipped',
            ...
            annotations: [
              {
                id: 'label3',
                content:
                  'The text element given with property of overflow as Wrap and wrapping as wrap so that element not to be Wrapped',
            ...
            annotations: [
              {
                id: 'label4',
                content:
                  "The text element's wrapping as WrapWithOverflow and overflow is Clip",
                style: {
                  textOverflow: 'Clip',
            ...
            annotations: [
              {
                id: 'label5',
                content:
                  "The text element's wrapping as WrapWithOverflow and overflow is Ellipsis",
                style: {
            ...
            annotations: [
              {
                id: 'label6',
                content:
                  "The text element's wrapping as WrapWithOverflow and overflow is Wrap",
                style: {
                  textOverflow: 'Wrap',
                  textWrapping: 'WrapWithOverflow',
                },
            ...
            annotations: [
              {
                id: 'label7',
                content:
                  "The text element's wrapping as NoWrap and overflow is Clip",
            ...
            annotations: [
              {
                id: 'label8',
                content:
                  "The text element's wrapping as NoWrap and overflow is Ellipsis",
            ...
            annotations: [
              {
                id: 'label9',
                content:
                  "The text element's wrapping as NoWrap and overflow is Wrap",
    ...
    it('Checking Text overflow - Clip and TextWrapping - Wrap', (done: Function) => {
      for (var j = 1; j < diagram.nodes.length + 1; j++) {
        for (
          var i = 0;
          i <
          document.getElementById('node' + j + '_label' + j + '_groupElement')
            .childNodes[1].childNodes.length;
          i++
        ) {
          console.log(
            'expect((document.getElementById("node' +
              j +
              '_label' +
              j +
              '_groupElement").childNodes[1].childNodes[' +
              i +
              '] as HTMLElement).getAttribute("x") == "' +
              (
                document.getElementById(
                  'node' + j + '_label' + j + '_groupElement'
                ).childNodes[1].childNodes[i] as HTMLElement
              ).getAttribute('x') +
              '").toBe(true);'
          );
          console.log(
      ...
      expect(
        (
          document.getElementById('node1_label1_groupElement').childNodes[1]
            .childNodes[0] as HTMLElement
        ).getAttribute('x') == '1.1484375'
      ).toBe(true);
      expect(
        (
          document.getElementById('node1_label1_groupElement').childNodes[1]
            .childNodes[0] as HTMLElement
        ).getAttribute('y') == '10.800000000000004'
      ).toBe(true);
      expect(
        (
          document.getElementById('node1_label1_groupElement').childNodes[1]
            .childNodes[0] as HTMLElement
        ).textContent == 'The text elem'
      ).toBe(true);
      expect(
        (
          document.getElementById('node1_label1_groupElement').childNodes[1]
            .childNodes[1] as HTMLElement
        ).getAttribute('x') == '0.6484375'
      ).toBe(false);
      expect(
        (
          document.getElementById('node1_label1_groupElement').childNodes[1]
            .childNodes[1] as HTMLElement
        ).getAttribute('y') == '25.200000000000003'
      ).toBe(true);
      expect(
        (
          document.getElementById('node1_label1_groupElement').childNodes[1]
            .childNodes[1] as HTMLElement
        ).textContent == 'ent given with'
      ).toBe(true);
      expect(
        (
          document.getElementById('node1_label1_groupElement').childNodes[1]
      ...
      expect(
        (
          document.getElementById('node1_label1_groupElement').childNodes[1]
            .childNodes[3] as HTMLElement
        ).textContent == 'erflow as clip '
      ).toBe(true);
      expect(
        (
          document.getElementById('node1_label1_groupElement').childNodes[1]
            .childNodes[4] as HTMLElement
        ).getAttribute('x') == '1.310546875'
      ).toBe(false);
      expect(
        (
          document.getElementById('node1_label1_groupElement').childNodes[1]
    ...
    it('Checking Text overflow - Ellipsis and TextWrapping - Wrap', (done: Function) => {
      expect(
        (
          document.getElementById('node2_label2_groupElement').childNodes[1]
            .childNodes[0] as HTMLElement
        ).getAttribute('x') == '1.1484375'
      ).toBe(true);
      expect(
      ...
      expect(
        (
          document.getElementById('node2_label2_groupElement').childNodes[1]
            .childNodes[3] as HTMLElement
        ).getAttribute('x') == '0.3203125' ||
          (
            document.getElementById('node2_label2_groupElement').childNodes[1]
              .childNodes[3] as HTMLElement
          ).getAttribute('x') == '0.3232421875'
      ).toBe(true);
      expect(
        (
          document.getElementById('node2_label2_groupElement').childNodes[1]
      ...
      expect(
        (
          document.getElementById('node2_label2_groupElement').childNodes[1]
            .childNodes[3] as HTMLElement
        ).textContent == 'erflow as Ellip'
      ).toBe(true);
      expect(
        (
          document.getElementById('node2_label2_groupElement').childNodes[1]
            .childNodes[4] as HTMLElement
        ).getAttribute('x') == '0.3125' ||
          (
            document.getElementById('node2_label2_groupElement').childNodes[1]
              .childNodes[4] as HTMLElement
          ).getAttribute('x') == '0.3173828125'
      ).toBe(true);
      expect(
        (
          document.getElementById('node2_label2_groupElement').childNodes[1]
    ...
    it('Checking Text overflow - Wrap and TextWrapping - Wrap', (done: Function) => {
      expect(
        (
          document.getElementById('node3_label3_groupElement').childNodes[1]
            .childNodes[0] as HTMLElement
        ).getAttribute('x') == '2.5009765625'
      ).toBe(false);
      expect(
        (
          document.getElementById('node3_label3_groupElement').childNodes[1]
      ...
      expect(
        (
          document.getElementById('node3_label3_groupElement').childNodes[1]
            .childNodes[3] as HTMLElement
        ).getAttribute('x') == '2.1240234375' ||
          (
            document.getElementById('node3_label3_groupElement').childNodes[1]
              .childNodes[3] as HTMLElement
          ).getAttribute('x') == '1.630859375'
      ).toBe(true);
      expect(
        (
          document.getElementById('node3_label3_groupElement').childNodes[1]
      ...
      expect(
        (
          document.getElementById('node3_label3_groupElement').childNodes[1]
            .childNodes[3] as HTMLElement
        ).textContent == 'erflow as Wra'
      ).toBe(true);
      expect(
        (
          document.getElementById('node3_label3_groupElement').childNodes[1]
            .childNodes[4] as HTMLElement
        ).getAttribute('x') == '0.99609375'
      ).toBe(false);
      expect(
        (
          document.getElementById('node3_label3_groupElement').childNodes[1]
      ...
      expect(
        (
          document.getElementById('node3_label3_groupElement').childNodes[1]
            .childNodes[4] as HTMLElement
        ).textContent == 'p and wrappin'
      ).toBe(true);
      expect(
        (
          document.getElementById('node3_label3_groupElement').childNodes[1]
            .childNodes[5] as HTMLElement
        ).getAttribute('x') == '1.1689453125' ||
          (
            document.getElementById('node3_label3_groupElement').childNodes[1]
              .childNodes[5] as HTMLElement
          ).getAttribute('x') == '0.67578125'
      ).toBe(true);
      expect(
        (
          document.getElementById('node3_label3_groupElement').childNodes[1]
            .childNodes[5] as HTMLElement
        ).getAttribute('y') == '82.80000000000001'
      ).toBe(true);
      expect(
        (
          document.getElementById('node3_label3_groupElement').childNodes[1]
            .childNodes[5] as HTMLElement
        ).textContent == 'g as wrap so t'
      ).toBe(true);
      expect(
        (
          document.getElementById('node3_label3_groupElement').childNodes[1]
            .childNodes[6] as HTMLElement
        ).getAttribute('x') == '2.33203125'
      ).toBe(false);
      expect(
        (
          document.getElementById('node3_label3_groupElement').childNodes[1]
            .childNodes[6] as HTMLElement
        ).getAttribute('y') == '97.19999999999999'
      ).toBe(true);
      expect(
        (
          document.getElementById('node3_label3_groupElement').childNodes[1]
            .childNodes[6] as HTMLElement
        ).textContent == 'hat element n'
      ).toBe(true);
      expect(
        (
          document.getElementById('node3_label3_groupElement').childNodes[1]
            .childNodes[7] as HTMLElement
        ).getAttribute('x') == '2.7802734375' ||
          (
            document.getElementById('node3_label3_groupElement').childNodes[1]
              .childNodes[7] as HTMLElement
          ).getAttribute('x') == '2.287109375'
      ).toBe(true);
      expect(
        (
          document.getElementById('node3_label3_groupElement').childNodes[1]
            .childNodes[7] as HTMLElement
        ).getAttribute('y') == '111.6'
      ).toBe(true);
      expect(
        (
          document.getElementById('node3_label3_groupElement').childNodes[1]
            .childNodes[7] as HTMLElement
        ).textContent == 'ot to be Wrap'
      ).toBe(true);
      expect(
        (
          document.getElementById('node3_label3_groupElement').childNodes[1]
            .childNodes[8] as HTMLElement
        ).getAttribute('x') == '28.6787109375'
      ).toBe(false);
      expect(
        (
          document.getElementById('node3_label3_groupElement').childNodes[1]
    ...
    it('Checking Text overflow - Clip and TextWrapping - WrapWithOverflow', (done: Function) => {
      expect(
        (
          document.getElementById('node4_label4_groupElement').childNodes[1]
            .childNodes[0] as HTMLElement
        ).getAttribute('x') == '15.484375' ||
          (
            document.getElementById('node4_label4_groupElement').childNodes[1]
              .childNodes[0] as HTMLElement
          ).getAttribute('x') == '15.490234375'
      ).toBe(true);
      expect(
        (
          document.getElementById('node4_label4_groupElement').childNodes[1]
      ...
      expect(
        (
          document.getElementById('node4_label4_groupElement').childNodes[1]
            .childNodes[1] as HTMLElement
        ).textContent == "element's"
      ).toBe(true);

      console.log(
        'document.getElementById("node4_label4_groupElement").childNodes[1].childNodes[2].getAttribute("x") ' +
          (
            document.getElementById('node4_label4_groupElement').childNodes[1]
              .childNodes[2] as any
          ).getAttribute('x')
      ...
      expect(
        (
          document.getElementById('node4_label4_groupElement').childNodes[1]
            .childNodes[2] as HTMLElement
        ).getAttribute('x') == '5.140625' ||
          (
            document.getElementById('node4_label4_groupElement').childNodes[1]
              .childNodes[2] as HTMLElement
          ).getAttribute('x') == '4.640625'
      ).toBe(true);
      expect(
        (
          document.getElementById('node4_label4_groupElement').childNodes[1]
      ...
      expect(
        (
          document.getElementById('node4_label4_groupElement').childNodes[1]
            .childNodes[2] as HTMLElement
        ).textContent == 'wrapping as'
      ).toBe(true);

      console.log(
        'document.getElementById("node4_label4_groupElement").childNodes[1].childNodes[3].getAttribute("x") ' +
          (
            document.getElementById('node4_label4_groupElement').childNodes[1]
              .childNodes[3] as any
          ).getAttribute('x')
      ...
      expect(
        (
          document.getElementById('node4_label4_groupElement').childNodes[1]
            .childNodes[3] as HTMLElement
        ).textContent == 'WrapWithOverflow'
      ).toBe(true);
      expect(
        (
          document.getElementById('node4_label4_groupElement').childNodes[1]
            .childNodes[4] as HTMLElement
        ).getAttribute('x') == '3.3125' ||
          (
            document.getElementById('node4_label4_groupElement').childNodes[1]
              .childNodes[4] as HTMLElement
          ).getAttribute('x') == '3.3134765625'
      ).toBe(true);
      expect(
        (
          document.getElementById('node4_label4_groupElement').childNodes[1]
    ...
    it('Checking Text overflow - Ellipsis and TextWrapping - WrapWithOverflow', (done: Function) => {
      expect(
        (
          document.getElementById('node5_label5_groupElement').childNodes[1]
            .childNodes[0] as HTMLElement
        ).getAttribute('x') == '15.484375' ||
          (
            document.getElementById('node5_label5_groupElement').childNodes[1]
      ...
      console.log(
        'document.getElementById("node5_label5_groupElement").childNodes[1].childNodes[2].getAttribute("x") ' +
          (
            document.getElementById('node5_label5_groupElement').childNodes[1]
              .childNodes[2] as any
          ).getAttribute('x')
      ...
      console.log(
        'document.getElementById("node5_label5_groupElement").childNodes[1].childNodes[3].getAttribute("x") ' +
          (
            document.getElementById('node5_label5_groupElement').childNodes[1]
              .childNodes[3] as any
          ).getAttribute('x')
    ...
    it('Checking Text overflow - Wrap and TextWrapping - WrapWithOverflow', (done: Function) => {
      expect(
        (
          document.getElementById('node6_label6_groupElement').childNodes[1]
            .childNodes[0] as HTMLElement
        ).getAttribute('x') == '28.5556640625' ||
          (
            document.getElementById('node6_label6_groupElement').childNodes[1]
              .childNodes[0] as HTMLElement
          ).getAttribute('x') == '28.0556640625'
      ).toBe(true);
      expect(
        (
          document.getElementById('node6_label6_groupElement').childNodes[1]
      ...
      expect(
        (
          document.getElementById('node6_label6_groupElement').childNodes[1]
            .childNodes[1] as HTMLElement
        ).getAttribute('x') == '25.0732421875' ||
          (
            document.getElementById('node6_label6_groupElement').childNodes[1]
              .childNodes[1] as HTMLElement
          ).getAttribute('x') == '24.5732421875'
      ).toBe(true);
      expect(
        (
          document.getElementById('node6_label6_groupElement').childNodes[1]
      ...
      console.log(
        'document.getElementById("node6_label6_groupElement").childNodes[1].childNodes[2].getAttribute("x") ' +
          (
            document.getElementById('node6_label6_groupElement').childNodes[1]
              .childNodes[2] as any
          ).getAttribute('x')
      ...
      expect(
        (
          document.getElementById('node6_label6_groupElement').childNodes[1]
            .childNodes[2] as HTMLElement
        ).getAttribute('x') == '17.7060546875' ||
          (
            document.getElementById('node6_label6_groupElement').childNodes[1]
              .childNodes[2] as HTMLElement
          ).getAttribute('x') == '17.2109375' ||
          (
            document.getElementById('node6_label6_groupElement').childNodes[1]
              .childNodes[2] as HTMLElement
          ).getAttribute('x') == '17.2060546875'
      ).toBe(true);
      expect(
        (
          document.getElementById('node6_label6_groupElement').childNodes[1]
      ...
      expect(
        (
          document.getElementById('node6_label6_groupElement').childNodes[1]
            .childNodes[4] as HTMLElement
        ).getAttribute('x') == '16.37890625' ||
          (
            document.getElementById('node6_label6_groupElement').childNodes[1]
              .childNodes[4] as HTMLElement
          ).getAttribute('x') == '15.87890625'
      ).toBe(true);
      expect(
        (
          document.getElementById('node6_label6_groupElement').childNodes[1]
      ...
      expect(
        (
          document.getElementById('node6_label6_groupElement').childNodes[1]
            .childNodes[5] as HTMLElement
        ).getAttribute('x') == '28.6669921875' ||
          (
            document.getElementById('node6_label6_groupElement').childNodes[1]
              .childNodes[5] as HTMLElement
          ).getAttribute('x') == '28.1669921875' ||
          (
            document.getElementById('node6_label6_groupElement').childNodes[1]
              .childNodes[5] as HTMLElement
          ).getAttribute('x') === '29.67578125'
      ).toBe(true);
      expect(
        (
          document.getElementById('node6_label6_groupElement').childNodes[1]
    ...
    it('Checking Text overflow - Clip and TextWrapping - NoWrap', (done: Function) => {
      expect(
        (
          document.getElementById('node7_label7_groupElement').childNodes[1]
            .childNodes[0] as HTMLElement
        ).getAttribute('x') == '0'
      ).toBe(true);
      expect(
    ...
    it('Checking Text overflow - Ellipsis and TextWrapping - NoWrap', (done: Function) => {
      expect(
        (
          document.getElementById('node8_label8_groupElement').childNodes[1]
            .childNodes[0] as HTMLElement
        ).getAttribute('x') == '0'
      ).toBe(true);
      expect(
    ...
    it('Checking Text overflow - Wrap and TextWrapping - NoWrap', (done: Function) => {
      expect(
        (
          document.getElementById('node9_label9_groupElement').childNodes[1]
            .childNodes[0] as HTMLElement
        ).getAttribute('x') == '0'
      ).toBe(true);
      expect(
...
describe('Annotation Alignment Issue in virtualisation', () => {
  ...
  it('Testing Annotation alignment in initial rendering', (done: Function) => {
    expect(
      diagram.nodes[0].annotations[0].horizontalAlignment == 'Center'
    ).toBe(true);
    expect(diagram.nodes[0].annotations[0].verticalAlignment == 'Bottom').toBe(
      true
    );
    expect(
      Math.round(diagram.nodes[0].wrapper.children[1].bounds.x) == 249
    ).toBe(true);
    expect(
      Math.round(diagram.nodes[0].wrapper.children[1].bounds.y) == 46
    ).toBe(true);
    expect(
      diagram.nodes[1].annotations[0].horizontalAlignment == 'Center'
    ).toBe(true);
    expect(diagram.nodes[1].annotations[0].verticalAlignment == 'Center').toBe(
      true
    );
    expect(
      Math.round(diagram.nodes[1].wrapper.children[1].bounds.x) == 280
    ).toBe(true);
    expect(
      Math.round(diagram.nodes[1].wrapper.children[1].bounds.y) == 153
    ).toBe(true);
    done();
  });
  it('Testing Annotation alignment update at run time and save and load', (done: Function) => {
    ...
    expect(
      Math.round(diagram.nodes[1].wrapper.children[1].bounds.y) == 146
    ).toBe(true);
    let savedata: string;
    ...
    let nodes: NodeModel[] = [
      {
        ...
        annotations: [
          {
            content:
              'Ellipsis WrapWithOverflow CollapseSpace Justify annotation',
            style: {
              textOverflow: 'Ellipsis',
              textWrapping: 'WrapWithOverflow',
...
describe('Bug 885842: Position of annotation inside the node is not aligned center', () => {
  ...
  it('Checking single annotation character rendered at center', (done: Function) => {
    ...
    expect(
      Math.round(textBounds.x) === 96 || Math.round(textBounds.x) === 97
    ).toBe(true);
    done();
  });
});
