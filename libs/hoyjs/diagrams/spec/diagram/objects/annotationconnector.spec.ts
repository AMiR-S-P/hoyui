...
describe('Diagram Control', () => {
  describe('Bezier Annotation', () => {
    ...
    it('checking the annotation of the connector connected with port', (done: Function) => {
      ...
      expect(diagram.connectors[0].wrapper.offsetX === 150.0040653475979).toBe(
        true
      );
      expect(diagram.connectors[0].wrapper.offsetY === 298.1750979283321).toBe(
        true
      );
      done();
    });
    it('checking the annotation of the connector connected with node', (done: Function) => {
      ...
      expect(diagram.connectors[1].wrapper.offsetX === 524.9993721424139).toBe(
        true
      );
      expect(diagram.connectors[1].wrapper.offsetY === 404.20599065085884).toBe(
        true
      );
      done();
    });
    it('checking the annotation of the connector ', (done: Function) => {
      ...
      diagram.dataBind();
      expect(diagram.connectors[2].wrapper.offsetX === 824.993538899347).toBe(
        true
      );
  ...
  describe('Straight segment annotation with offset 0', () => {
    ...
    it('Checking annotation alignment with offset 0', (done: Function) => {
      ...
      expect(
        (Math.round(element1.offsetX) === 113 ||
          Math.round(element1.offsetX) >= 111 ||
          Math.round(element1.offsetX) <= 116) &&
          Math.round(element1.offsetY) === 100 &&
          (Math.round(element2.offsetX) === 313 ||
            Math.round(element2.offsetX) >= 311 ||
            Math.round(element2.offsetX) <= 316) &&
          Math.round(element2.offsetY) === 93 &&
          (Math.round(element3.offsetX) === 513 ||
            Math.round(element3.offsetX) >= 511 ||
            Math.round(element3.offsetX) <= 516) &&
          Math.round(element3.offsetY) === 107
      ).toBe(true);
      done();
    });
    ...
    it('Checking annotation alignment with offset 0.5', (done: Function) => {
      ...
      let element3: DiagramElement = diagram.connectors[2].wrapper.children[3];
      expect(
        Math.round(element1.offsetX) === 150 &&
          Math.round(element1.offsetY) === 100 &&
          Math.round(element2.offsetX) === 350 &&
          Math.round(element2.offsetY) === 93 &&
          Math.round(element3.offsetX) === 550 &&
          Math.round(element3.offsetY) === 107
      ).toBe(true);
      done();
    });
    ...
    it('Checking annotation alignment with offset 1', (done: Function) => {
      ...
      let element3: DiagramElement = diagram.connectors[2].wrapper.children[3];
      expect(
        (Math.round(element1.offsetX) === 187 ||
          Math.round(element1.offsetX) >= 185 ||
          Math.round(element1.offsetX) <= 189) &&
          Math.round(element1.offsetY) === 100 &&
          (Math.round(element2.offsetX) === 387 ||
            Math.round(element2.offsetX) >= 385 ||
            Math.round(element2.offsetX) <= 389) &&
          Math.round(element2.offsetY) === 93 &&
          (Math.round(element3.offsetX) === 587 ||
            Math.round(element3.offsetX) >= 585 ||
            Math.round(element3.offsetX) <= 589) &&
          Math.round(element3.offsetY) === 107
      ).toBe(true);
      done();
    });
    ...
    it('Checking alignment, offset 0, for slanting connector', (done: Function) => {
      ...
      expect(
        Math.round(element1.offsetX) === 100 &&
          Math.round(element1.offsetY) === 107 &&
          (Math.round(element2.offsetX) === 287 ||
            Math.round(element2.offsetX) >= 285 ||
            Math.round(element2.offsetX) <= 289) &&
          Math.round(element2.offsetY) === 107 &&
          (Math.round(element3.offsetX) === 513 ||
            Math.round(element3.offsetX) >= 511 ||
            Math.round(element3.offsetX) <= 515) &&
          Math.round(element3.offsetY) === 107
      ).toBe(true);
      done();
    });
    ...
    it('Checking alignment, offset 0.5, for slanting connector', (done: Function) => {
      ...
      expect(
        Math.round(element1.offsetX) === 150 &&
          Math.round(element1.offsetY) === 150 &&
          (Math.round(element2.offsetX) === 337 ||
            Math.round(element2.offsetX) >= 335 ||
            Math.round(element2.offsetX) <= 339) &&
          Math.round(element2.offsetY) === 150 &&
          (Math.round(element3.offsetX) === 563 ||
            Math.round(element3.offsetX) >= 561 ||
            Math.round(element3.offsetX) <= 566) &&
          Math.round(element3.offsetY) === 150
      ).toBe(true);
      done();
    });
    ...
    it('Checking alignment, offset 1, for slanting connector', (done: Function) => {
      ...
      expect(
        element1.offsetX === 200 &&
          element1.offsetY === 192.79999999999998 &&
          Math.round(element2.offsetX) === 387 &&
          element2.offsetY === 192.79999999999998 &&
          Math.round(element3.offsetX) === 613 &&
          element3.offsetY === 192.79999999999998
      ).toBe(true);
      done();
    });
    ...
    it('Checking alignment, offset 0.5, for orthogonal connector', (done: Function) => {
      ...
      let element3: DiagramElement = diagram.connectors[2].wrapper.children[3];
      expect(
        Math.round(element1.offsetX) === 180 &&
          Math.round(element1.offsetY) === 120 &&
          Math.round(element2.offsetX) === 380 &&
          Math.round(element2.offsetY) === 113 &&
          Math.round(element3.offsetX) === 580 &&
          Math.round(element3.offsetY) === 127
      ).toBe(true);
      done();
    });
    ...
    it('Checking alignment, offset 0, for reverse straight connector', (done: Function) => {
      ...
      expect(
        (Math.round(element1.offsetX) === 187 ||
          Math.round(element1.offsetX) >= 185 ||
          Math.round(element1.offsetX) <= 188) &&
          Math.round(element1.offsetY) === 100 &&
          (Math.round(element2.offsetX) === 387 ||
            Math.round(element2.offsetX) >= 385 ||
            Math.round(element2.offsetX) <= 388) &&
          Math.round(element2.offsetY) === 107 &&
          (Math.round(element3.offsetX) === 587 ||
            Math.round(element3.offsetX) >= 585 ||
            Math.round(element3.offsetX) <= 588) &&
          Math.round(element3.offsetY) === 93
      ).toBe(true);
      done();
    });
      ...
      expect(
        Math.round(element1.offsetX) === 113 ||
          (112.671875 &&
            Math.round(element1.offsetY) === 100 &&
            Math.round(element2.offsetX) === 313) ||
          (312.671875 && Math.round(element2.offsetY) === 106) ||
          (107.2 && Math.round(element3.offsetX) === 513) ||
          (512.671875 && Math.round(element3.offsetY) === 93) ||
          92.8
      ).toBe(true);
      done();
    });
    ...
    it('Checking alignment, offset 0, for reverse slanting connector', (done: Function) => {
      ...
      let element3: DiagramElement = diagram.connectors[2].wrapper.children[3];
      expect(
        Math.round(element1.offsetX) === 200 &&
          Math.round(element1.offsetY) === 193 &&
          (Math.round(element2.offsetX) === 413 ||
            Math.round(element2.offsetX) >= 412 ||
            Math.round(element2.offsetX) <= 416) &&
          Math.round(element2.offsetY) === 193 &&
          (Math.round(element3.offsetX) === 587 ||
            Math.round(element3.offsetX) >= 585 ||
            Math.round(element3.offsetX) <= 589) &&
          Math.round(element3.offsetY) === 193
      ).toBe(true);
      done();
    });
    ...
    it('Checking alignment, offset 0.5, for reverse slanting connector', (done: Function) => {
      ...
      expect(
        Math.round(element1.offsetX) === 150 &&
          Math.round(element1.offsetY) === 150 &&
          (Math.round(element2.offsetX) === 363 ||
            Math.round(element2.offsetX) >= 362 ||
            Math.round(element2.offsetX) <= 366) &&
          Math.round(element2.offsetY) === 150 &&
          (Math.round(element3.offsetX) === 537 ||
            Math.round(element3.offsetX) >= 535 ||
            Math.round(element3.offsetX) <= 538) &&
          Math.round(element3.offsetY) === 150
      ).toBe(true);
      done();
    });
    ...
    it('Checking alignment, offset 1, for reverse slanting connector', (done: Function) => {
      ...
      console.log(element3.offsetX, element3.offsetY);
      expect(
        element1.offsetX === 100 &&
          element1.offsetY === 107.2 &&
          Math.round(element2.offsetX) === 313 &&
          element2.offsetY === 107.2 &&
          Math.round(element3.offsetX) === 487 &&
          element3.offsetY === 107.2
      ).toBe(true);
      done();
    });
    ...
    it('checking the displacement of the connector', (done: Function) => {
      ...
      expect(
        diagram.connectors[0].wrapper.children[3].offsetX === 100 &&
          diagram.connectors[0].wrapper.children[3].offsetY === 122.2
      ).toBe(true);
      done();
    });
    it('memory leak', () => {
