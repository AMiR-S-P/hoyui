...
describe('Diagram Control', () => {
  describe('BPMN Tasks', () => {
    ...
    it('Changing BPMN shape as Activity task type at runtime from Send to Receive', (done: Function) => {
      ...
      diagram.dataBind();
      let node = (diagram.nodes[5].wrapper.children[0] as Canvas)
        .children[0] as Canvas;
      expect(
        node.children[1].width === 18 &&
          node.children[1].height === 16 &&
          shape.activity.task.type === 'Receive'
      ).toBe(true);
    ...
    it('Changing BPMN shape as Activity task type at runtime from Send to Manual', (done: Function) => {
      ...
      console.log(
        ...
        shape.activity.task.type
      );
      expect(
        node.children[1].width === 16 &&
          node.children[1].height === 11 &&
          shape.activity.task.type === 'Manual'
      ).toBe(true);
      done();
    });
    it('Checking before, after,  BPMN shape as Activity with Task and task Type as None', (done: Function) => {
      let wrapper: Canvas = (
        (diagram.nodes[0] as NodeModel).wrapper.children[0] as Canvas
      ).children[0] as Canvas;
      expect(
    ...
    it('Checking before, after,   BPMN shape as Activity with Task and task Type as Service ', (done: Function) => {
      let wrapper: Canvas = (
        (diagram.nodes[1] as NodeModel).wrapper.children[0] as Canvas
      ).children[0] as Canvas;
      expect(
        wrapper.children[0].actualSize.width === 100 &&
          wrapper.children[0].actualSize.height === 100 &&
          ...
          wrapper.children[1].actualSize.width === 20 &&
          wrapper.children[1].actualSize.height === 20 &&
          wrapper.children[1].offsetX === 265 &&
          wrapper.children[1].offsetY === 65 &&
          //third node
          Math.round(wrapper.children[2].actualSize.width) === 20 &&
          Math.round(wrapper.children[2].actualSize.height) === 20
      ).toBe(true);
      done();
    });
    ...
    it('Checking before, after,   BPMN shape as Activity with Task and task Type as BusinessRule ', (done: Function) => {
      let wrapper: Canvas = (
        (diagram.nodes[2] as NodeModel).wrapper.children[0] as Canvas
      ).children[0] as Canvas;
      expect(
        wrapper.children[0].actualSize.width === 100 &&
          wrapper.children[0].actualSize.height === 100 &&
          ...
          wrapper.children[1].actualSize.width === 20 &&
          wrapper.children[1].actualSize.height === 20 &&
          wrapper.children[1].offsetX === 465 &&
          wrapper.children[1].offsetY === 65
      ).toBe(true);
      done();
    });
    ...
    it('Checking before, after, BPMN shape as Activity with Task and task Type as InstantiatingReceive ', (done: Function) => {
      let wrapper: Canvas = (
        (diagram.nodes[3] as NodeModel).wrapper.children[0] as Canvas
      ).children[0] as Canvas;
      expect(
        wrapper.children[0].actualSize.width === 100 &&
          wrapper.children[0].actualSize.height === 100 &&
          ...
          wrapper.children[1].actualSize.width === 20 &&
          wrapper.children[1].actualSize.height === 20 &&
          wrapper.children[1].offsetX === 665 &&
          wrapper.children[1].offsetY === 65
      ).toBe(true);
      done();
    });
    ...
    it('Checking before, after, BPMN shape as Activity with Task and task Type as Receive ', (done: Function) => {
      ...
      expect(
        wrapper.children[0].actualSize.width === 100 &&
          ...
          wrapper.children[1].offsetY === 263 &&
          wrapper.children[1].offsetX === 64
      ).toBe(true);
      done();
    });
  });
    ...
    it('Checking before, after,  BPMN shape as Activity with Task and task Type as None and loop as Standard', (done: Function) => {
      ...
      expect(
        wrapper.children[0].actualSize.width === 100 &&
          ...
          (wrapper.children[2].offsetX === 103 ||
            wrapper.children[2].offsetX === 100) &&
          wrapper.children[2].offsetY === 139
      ).toBe(true);
      done();
    });
  });
    ...
    it('Checking before, after, task Type Receive and loop as SequenceMultiInstance', (done: Function) => {
      ...
      expect(
        wrapper.children[0].actualSize.width === 100 &&
          ...
          (wrapper.children[2].offsetX === 103 ||
            wrapper.children[2].offsetX === 100) &&
          wrapper.children[2].offsetY === 339
      ).toBe(true);
      done();
    });
    ...
    it('Checking before, after,  type - Service and loop - ParallelMultiInstance and call - true', (done: Function) => {
      ...
      expect(
        wrapper.children[0].actualSize.width === 100 &&
          ...
          (wrapper.children[3].offsetX === 303 ||
            wrapper.children[3].offsetX === 300) &&
          wrapper.children[3].offsetY === 339
      ).toBe(true);
      done();
    });
    ...
    it('Checking before, after,call-true and compensation-false and type-Service and loop-ParallelMultiInstance', (done: Function) => {
      ...
      expect(
        wrapper.children[0].actualSize.width === 100 &&
          ...
          wrapper.children[3].actualSize.width === 12 &&
          wrapper.children[3].actualSize.height === 12 &&
          (wrapper.children[3].offsetX === 503 ||
            wrapper.children[3].offsetX === 500) &&
          wrapper.children[3].offsetY === 339 &&
          //fourth node
          wrapper.children[4].actualSize.width === 12 &&
          wrapper.children[4].actualSize.height === 12 &&
          wrapper.children[4].offsetX === 500 &&
          wrapper.children[4].offsetY === 339 &&
    ...
    it('Checking before, after,call-true and compensation-true and type-Service and loop-ParallelMultiInstance', (done: Function) => {
      ...
      expect(
        wrapper.children[0].actualSize.width === 100 &&
          ...
          wrapper.children[3].actualSize.width === 12 &&
          wrapper.children[3].actualSize.height === 12 &&
          (wrapper.children[3].offsetX === 687 ||
            wrapper.children[3].offsetX === 700) &&
          wrapper.children[3].offsetY === 339 &&
          //fourth node
          wrapper.children[4].actualSize.width === 12 &&
          wrapper.children[4].actualSize.height === 12 &&
          wrapper.children[4].offsetX === 707 &&
          wrapper.children[4].offsetY === 339 &&
