...
describe('Diagram Control', () => {
  describe('Diagram Element', () => {
    ...
    it('Checking before, after,  BPMN  dataObject with collection as false and type as Input ', (done: Function) => {
      let wrapper: Canvas = (diagram.nodes[0] as NodeModel).wrapper
        .children[0] as Canvas;
      expect(
        wrapper.children[0].actualSize.width === 100 &&
          wrapper.children[0].actualSize.height === 100 &&
          wrapper.children[0].offsetX === 100 &&
          wrapper.children[0].offsetY === 100 &&
          //second node
          wrapper.children[1].actualSize.width === 25 &&
          wrapper.children[1].actualSize.height === 20 &&
          wrapper.children[1].offsetX === 67.5 &&
          wrapper.children[1].offsetY === 65 &&
          //third node
          wrapper.children[2].actualSize.width === 7.5 &&
          wrapper.children[2].actualSize.height === 15 &&
          wrapper.children[2].offsetX === 100 &&
          wrapper.children[2].offsetY === 142.5
      ).toBe(true);
      done();
    });

    it('Checking before, after,  BPMN  dataObject with collection as false  and  type as output ', (done: Function) => {
      let wrapper: Canvas = (diagram.nodes[1] as NodeModel).wrapper
        .children[0] as Canvas;
      expect(
        wrapper.children[0].actualSize.width === 100 &&
          wrapper.children[0].actualSize.height === 100 &&
          wrapper.children[0].offsetX === 300 &&
          wrapper.children[0].offsetY === 100 &&
          //second node
          wrapper.children[1].actualSize.width === 25 &&
          wrapper.children[1].actualSize.height === 20 &&
          wrapper.children[1].offsetX === 267.5 &&
          wrapper.children[1].offsetY === 65 &&
          //third node
          wrapper.children[2].actualSize.width === 7.5 &&
          wrapper.children[2].actualSize.height === 15 &&
          wrapper.children[2].offsetX === 300 &&
          wrapper.children[2].offsetY === 142.5
      ).toBe(true);
      done();
    });
    ...
    it('Checking before, after,  BPMN  dataObject with collection as false  and  type as none ', (done: Function) => {
      let wrapper: Canvas = (diagram.nodes[2] as NodeModel).wrapper
        .children[0] as Canvas;
      expect(
        wrapper.children[0].actualSize.width === 100 &&
          wrapper.children[0].actualSize.height === 100 &&
          wrapper.children[0].offsetX === 500 &&
          wrapper.children[0].offsetY === 100 &&
          //second node
          wrapper.children[1].actualSize.width === 25 &&
          wrapper.children[1].actualSize.height === 20 &&
          wrapper.children[1].offsetX === 467.5 &&
          wrapper.children[1].offsetY === 65 &&
          //third node
          wrapper.children[2].actualSize.width === 7.5 &&
          wrapper.children[2].actualSize.height === 15 &&
          wrapper.children[2].offsetX === 500 &&
          wrapper.children[2].offsetY === 142.5
      ).toBe(true);
      done();
    });
    ...
    it('Checking before, after,  BPMN  dataObject with collection as true  and  type as Input ', (done: Function) => {
      let wrapper: Canvas = (diagram.nodes[3] as NodeModel).wrapper
        .children[0] as Canvas;
      expect(
        wrapper.children[0].actualSize.width === 100 &&
          wrapper.children[0].actualSize.height === 100 &&
          wrapper.children[0].offsetX === 700 &&
          wrapper.children[0].offsetY === 100 &&
          //second node
          wrapper.children[1].actualSize.width === 25 &&
          wrapper.children[1].actualSize.height === 20 &&
          wrapper.children[1].offsetX === 667.5 &&
          wrapper.children[1].offsetY === 65 &&
          //third node
          wrapper.children[2].actualSize.width === 7.5 &&
          wrapper.children[2].actualSize.height === 15 &&
          wrapper.children[2].offsetX === 700 &&
          wrapper.children[2].offsetY === 142.5
      ).toBe(true);
      done();
    });
    ...
    it('Checking before, after,  BPMN  dataObject with collection as true  and  type as output ', (done: Function) => {
      let wrapper: Canvas = (diagram.nodes[4] as NodeModel).wrapper
        .children[0] as Canvas;
      expect(
        wrapper.children[0].actualSize.width === 100 &&
          wrapper.children[0].actualSize.height === 100 &&
          wrapper.children[0].offsetX === 900 &&
          wrapper.children[0].offsetY === 100 &&
          //second node
          wrapper.children[1].actualSize.width === 25 &&
          wrapper.children[1].actualSize.height === 20 &&
          wrapper.children[1].offsetX === 867.5 &&
          wrapper.children[1].offsetY === 65 &&
          //third node
          wrapper.children[2].actualSize.width === 7.5 &&
          wrapper.children[2].actualSize.height === 15 &&
          wrapper.children[2].offsetX === 900 &&
          wrapper.children[2].offsetY === 142.5
      ).toBe(true);
      done();
    });
    ...
    it('Checking before, after,  BPMN  dataObject with collection as true  and  type as none ', (done: Function) => {
      let wrapper: Canvas = (diagram.nodes[5] as NodeModel).wrapper
        .children[0] as Canvas;
      expect(
        wrapper.children[0].actualSize.width === 100 &&
          wrapper.children[0].actualSize.height === 100 &&
          wrapper.children[0].offsetX === 100 &&
          wrapper.children[0].offsetY === 300 &&
          //second node
          wrapper.children[1].actualSize.width === 25 &&
          wrapper.children[1].actualSize.height === 20 &&
          wrapper.children[1].offsetX === 67.5 &&
          wrapper.children[1].offsetY === 265 &&
          //third node
          wrapper.children[2].actualSize.width === 7.5 &&
          wrapper.children[2].actualSize.height === 15 &&
          wrapper.children[2].offsetX === 100 &&
          wrapper.children[2].offsetY === 342.5
      ).toBe(true);
      done();
    });
    it('memory leak', () => {
...
describe('BPMN dataobject node visibility issue', () => {
  ...
  it('BPMN dataObject after visibility true and false', (done: Function) => {
    ...
    diagram.dataBind();
    expect(
      (diagram.nodes[0].wrapper.children[0] as Container).children[2]
        .visible === false
    ).toBe(true);
    expect(
      (diagram.nodes[0].wrapper.children[0] as Container).children[1]
        .visible === false
    ).toBe(true);
    (diagram.nodes[0].shape as BpmnShape).dataObject = {
      type: 'Input',
      collection: false,
    };
    diagram.dataBind();
...
describe('860251-Bpmn message flow and sequence flow connector child path is not rendered properly.', () => {
  ...
  beforeAll((): void => {
    ...
    let node1: NodeModel = {
      ...
      shape: {
        type: 'Bpmn',
        shape: 'Gateway',
        gateway: { type: 'Complex' } as BpmnGatewayModel,
      },
    };
    let node3: NodeModel = {
      id: 'node3',
      ...
      shape: {
        type: 'Bpmn',
        shape: 'Gateway',
        gateway: { type: 'ExclusiveEventBased' } as BpmnGatewayModel,
      },
    };
    let node4: NodeModel = {
      id: 'node4',
      ...
      shape: {
        type: 'Bpmn',
        shape: 'Gateway',
        gateway: { type: 'Inclusive' } as BpmnGatewayModel,
      },
    };
    let node6: NodeModel = {
      id: 'node6',
      ...
      shape: {
        type: 'Bpmn',
        shape: 'Gateway',
        gateway: { type: 'ParallelEventBased' } as BpmnGatewayModel,
      },
    };
  ...
  it('Checking bpmn flow connector message and sequence path', (done: Function) => {
    ...
    expect(
      Math.round(messageChild.offsetX) === 476 &&
        Math.round(messageChild.offsetY) === 100 &&
        (Math.round(seqChild.offsetX) === 842 ||
          Math.round(seqChild.offsetX) === 841) &&
        Math.round(seqChild.offsetY) === 200
    ).toBe(true);
    done();
  });
});
