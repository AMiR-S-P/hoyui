...
describe('Diagram Control', () => {
  ...
  describe('Connector with bridging', () => {
    ...
    it('Checking Straight Line with bridge direction as top', (done: Function) => {
      ...
      expect((element as PathElement).data == 'M220 55 L294.74 179.57').toBe(
        true
      );
      let element1: DiagramElement = diagram.connectors[1].wrapper.children[0];
      expect((element1 as PathElement).data == 'M290 40 L364.74 159.58').toBe(
        true
      );
      let element2: DiagramElement = diagram.connectors[2].wrapper.children[0];
      expect(
        (element2 as PathElement).data ==
          'M185 130 L249.33484596884284 113.21699670378008A 5 5 165.37912601136836 , 1 1 259.01101869281126,110.69277773231005 L318.80677345109984 95.0938851866695A 5 5 165.37912601136836 , 1 1 328.4829461750683,92.56966621519948 L414.52 70.13'
      ).toBe(true);
      done();
    });
    ...
    it('Checking Straight Line with bridge direction as left', (done: Function) => {
      ...
      let element: DiagramElement = diagram.connectors[0].wrapper.children[0];
      expect(
        (element as PathElement).data ==
          'M220 55 L251.60045355368942 107.66742258948238A 5 5 -120.96375653207352 , 1 0 256.7454111079647,116.24235184660783 L294.74 179.57'
      ).toBe(true);
      let element1: PathElement = diagram.connectors[1].wrapper
        .children[0] as PathElement;
      expect(
        element1.data ==
          'M290 40 L290 60 L365 60 L365 65A 5 5 -122.00538320808352 , 1 0 365,75 L365 159.5' ||
          element1.data ==
            'M290 40 L320.9948651130682 89.59178418090912A 5 5 -122.00538320808352 , 1 0 326.2948545131,98.07176722096 L364.74 159.58'
      ).toBe(true);
      let element2: DiagramElement = diagram.connectors[2].wrapper.children[0];
      expect((element2 as PathElement).data == 'M185 130 L414.52 70.13').toBe(
        true
      );
      done();
    });
    ...
    it('Checking Orthogonal Line with bridgr direction left', (done: Function) => {
      ...
      expect(
        (element as PathElement).data ==
          'M220 55 L220 65A 5 5 -90 , 1 0 220,75 L220 75 L295 75 L295 179.5'
      ).toBe(true);
      let element1: DiagramElement = diagram.connectors[1].wrapper.children[0];
      expect(
        (element1 as PathElement).data ==
          'M290 40 L290 60 L365 60 L365 65A 5 5 -122.00538320808352 , 1 0 365,75 L365 159.5' ||
          (element1 as PathElement).data ==
            'M290 40 L290 60 L365 60 L365 65A 5 5 -122.11300099946992 , 1 0 365,75 L365 159.5'
      ).toBe(true);
      let element2: DiagramElement = diagram.connectors[2].wrapper.children[0];
      expect(
        (element2 as PathElement).data == 'M185 130 L205 130 L205 70 L414.5 70'
      ).toBe(true);
      done();
    });
    ...
    it('Checking Orthogonal Line with bridge direction right', (done: Function) => {
      ...
      expect(
        (element as PathElement).data ==
          'M220 55 L220 65A 5 5 -90 , 1 1 220,75 L220 75 L295 75 L295 179.5'
      ).toBe(true);
      let element1: DiagramElement = diagram.connectors[1].wrapper.children[0];
      expect(
        (element1 as PathElement).data ==
          'M290 40 L290 60 L365 60 L365 65A 5 5 -122.00538320808352 , 1 1 365,75 L365 159.5'
      ).toBe(true);
      let element2: DiagramElement = diagram.connectors[2].wrapper.children[0];
      expect(
        (element2 as PathElement).data == 'M185 130 L205 130 L205 70 L414.5 70'
    ...
    it('Checking Orthogonal Line with bridge direction bottom', (done: Function) => {
      ...
      let element: DiagramElement = diagram.connectors[0].wrapper.children[0];
      expect(
        (element as PathElement).data == 'M220 55 L220 75 L295 75 L295 179.5'
      ).toBe(true);
      let element1: DiagramElement = diagram.connectors[1].wrapper.children[0];
      expect(
        (element1 as PathElement).data == 'M290 40 L290 60 L365 60 L365 159.5'
      ).toBe(true);
      let element2: DiagramElement = diagram.connectors[2].wrapper.children[0];
      expect(
        (element2 as PathElement).data ==
          'M185 130 L205 130 L205 70 L215 70A 5 5 165.37912601136836 , 1 0 225,70 L360 70A 5 5 165.37912601136836 , 1 0 370,70 L414.5 70'
      ).toBe(true);
      done();
    });

    it('Checking Orthogonal Line without inherit Bridging', (done: Function) => {
      diagram.connectors[2].constraints =
  ...
  describe('Bridging based on connector without inherit', () => {
    ...
    it('Checking Bridging based on connector without inherit', (done: Function) => {
      ...
      expect(
        (element1 as PathElement).data ==
          'M300 100 L300 120 L400 120 L400 199.5'
      ).toBe(true);
      done();
    });
    it('Merging bridge segments', (done: Function) => {
      ...
      expect(
        (element1 as PathElement).data ==
          'M300 100 L300 120 L388 120A 5 5 -168.6900675259798 , 1 1 400,121 L400 120 L400 199.5'
      ).toBe(true);
  ...
  describe('Bridging based on diagram with inherit', () => {
    ...
    it('Checking Bridging based on diagram with inherit', (done: Function) => {
      let element: DiagramElement = diagram.connectors[0].wrapper.children[0];
      expect((element as PathElement).data == 'M300 80 L399.71 219.59').toBe(
        true
      );
      let element1: DiagramElement = diagram.connectors[1].wrapper.children[0];
      expect(
        (element1 as PathElement).data ==
          'M300 100 L300 120 L323.57142857142856 120A 5 5 -168.6900675259798 , 1 1 333.57142857142856,120 L400 120 L400 199.5'
      ).toBe(true);
      done();
    });
  });
  ...
  describe('Bridging With Corner Radius Straight', () => {
    ...
    it('Checking Bridging corner radius straight', (done: Function) => {
      ...
      expect(
        (element1 as PathElement).data ==
          'M300 100 L346.4644660940673 146.46446609406726A 5 5 -135 , 1 1 353.53553390593277,153.53553390593274 L399.65 199.65'
      ).toBe(true);
      done();
    });
  });
  describe('Bridging With Corner Radius Orthogonal', () => {
    ...
    it('Checking Bridging corner radius Orthogonal', (done: Function) => {
      ...
      expect(
        (element as PathElement).data ==
          'M300 300 L300 310Q300 320 310 320 L390 320Q400 320 400 330 L400 399.5'
      ).toBe(true);
      let element1: DiagramElement = diagram.connectors[1].wrapper.children[0];
      expect(
        (element1 as PathElement).data ==
          'M350 350 L350 360Q350 370 360 370 L395 370A 5 5 -168.6900675259798 , 1 1 405,370 L440 370Q450 370 450 380 L450 449.5'
      ).toBe(true);
      done();
    });
    it('memory leak', () => {
  ...
  describe('Bridging With connector visibility false', () => {
    ...
    it('Checking Bridging is enabled or not for the connector visibility false', (done: Function) => {
      ...
      expect((element1 as PathElement).data == 'M200 100 L499.51 149.92').toBe(
        true
      );
      done();
    });
  ...
  describe('Connector segments not update properly', () => {
    ...
    it('Connector segments not update properly', (done: Function) => {
      expect(
        (diagram.connectors[0].segments[2] as OrthogonalSegment).length ===
          214 &&
          (diagram.connectors[1].segments[2] as OrthogonalSegment).length === 98
      ).toBe(true);
      done();
    });
  });
