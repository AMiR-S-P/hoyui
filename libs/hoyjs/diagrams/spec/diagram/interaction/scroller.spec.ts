...
describe('Diagram Control', () => {
  ...
  describe('Diagram padding left and top', () => {
    ...
    it('checking Diagram padding left and top', (done: Function) => {
      let diagramContent: HTMLElement = document.getElementById(
  ...
  describe('Fit to page is not working for zoom greater than 1', () => {
    ...
    it('Fit to page is not working for zoom greater than 1', (done: Function) => {
      ...
      expect(
        (diagram.scroller.horizontalOffset == 25 ||
          diagram.scroller.horizontalOffset == 484) &&
          (diagram.scroller.verticalOffset == 132.5 ||
            diagram.scroller.verticalOffset == 134.5 ||
            diagram.scroller.verticalOffset == 25)
      ).toBe(true);
  ...
  describe('Scroller issue', () => {
    ...
    it('CR issue(EJ2-42921) - Vertical Scroll bar appears while scroll the diagram', (done: Function) => {
      console.log(
        'CR issue(EJ2-42921) - Vertical Scroll bar appears while scroll the diagram'
      );
      let mouseEvents: MouseEvents = new MouseEvents();
      console.log(
        'diagram.scrollSettings.verticalOffset:' +
          diagram.scrollSettings.verticalOffset
      );
  ...
  describe('Scroller issue after zooming the diagram', () => {
    ...
    it('CR issue(EJ2-43276) - When zoom out the diagram ruler value not update properly', (done: Function) => {
      ...
      expect(Math.abs(diagram.scrollSettings.horizontalOffset) == 156.97).toBe(
        true
      );
      mouseEvents.mouseWheelEvent(diagramCanvas, 300, 300, false, true, false);
      console.log(
      ...
      expect(Math.abs(diagram.scrollSettings.horizontalOffset) == 146.97).toBe(
        true
      );
      mouseEvents.mouseWheelEvent(diagramCanvas, 300, 300, false, true, false);
      ...
      expect(Math.abs(diagram.scrollSettings.horizontalOffset) == 136.97).toBe(
        true
      );
      ...
      expect(Math.abs(diagram.scrollSettings.horizontalOffset) == 176.97).toBe(
        true
      );
  ...
  describe('FitToPage not working when we call it multiple times ', () => {
    ...
    it('Calling fit to page at runtime', (done: Function) => {
      ...
      diagram.fitToPage();
      expect(
        scrollX === diagram.scrollSettings.horizontalOffset &&
          scrollY === diagram.scrollSettings.verticalOffset
      ).toBe(true);
      done();
      console.log(scrollX);
      console.log(scrollY);
  ...
  describe('Scroller is not updated properly when we drag nodes outside viewport', () => {
    ...
    it('Dragging node outside viewport in horizontal direction', (done: Function) => {
      ...
      expect(
        currectPageBounds.width > prevPageBounds.width &&
          currectPageBounds.width >= 550 &&
          currectPageBounds.width > viewPortWidth
      ).toBe(true);
      done();
    });
    it('Dragging node outside viewport in vertical direction', (done: Function) => {
      ...
      let currectPageBounds = diagram.scroller.getPageBounds();
      expect(
        currectPageBounds.height > prevPageBounds.height &&
          currectPageBounds.height >= 650 &&
          currectPageBounds.height > viewPortHeight
      ).toBe(true);
      done();
    });
  });
  ...
  describe('878703 - ZoomIn and ZoomOut not working properly when canZoomOut set to true', () => {
    ...
    beforeAll((): void => {
      ...
      let nodes: NodeModel[] = [
        ...
        },
        {
          ...
          width: 100,
          height: 100,
          annotations: [{ content: 'Preparation' }],
        },
        {
          id: 'node8',
          offsetX: 3500,
    ...
    it('Checking fitToPage with canZoomOut', (done: Function) => {
      ...
      expect(
        diagram.scrollSettings.currentZoom < 0.2 &&
          diagram.scrollSettings.minZoom === 0.2
      ).toBe(true);
      done();
    });
    ...
    it('Checking ZoomIn with mousewheel when currentZoom less than minZoom', (done: Function) => {
      ...
      expect(
        diagram.scrollSettings.currentZoom !== curZoom &&
          curZoom < diagram.scrollSettings.currentZoom
      ).toBe(true);
      done();
    });
    it('Checking fitToPage without canZoomOut', (done: Function) => {
      diagram.fitToPage();
      expect(
        diagram.scrollSettings.currentZoom <= diagram.scrollSettings.maxZoom
      ).toBe(true);
      done();
    });
