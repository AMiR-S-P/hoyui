...
import {
  rotatePoint,
  cloneObject,
} from '../../../src/diagram/utility/base-util';
...
describe('Diagram Control', () => {
  describe('Undo Redo for node and connector drag', () => {
    ...
    it('Checking undo for node and connector  select the rubber band selection', (done: Function) => {
      ...
      expect(
        diagram.selectedItems.connectors.length === 1 &&
          diagram.selectedItems.connectors[0].id === 'connector1' &&
          diagram.selectedItems.nodes.length === 1 &&
          diagram.selectedItems.nodes[0].id === 'node1'
      ).toBe(true);
      mouseEvents.dragAndDropEvent(diagramCanvas, 150, 150, 100, 100);
      diagram.undo();
      expect(
        diagram.selectedItems.nodes[0].offsetX === 100 &&
          diagram.selectedItems.nodes[0].offsetY === 100 &&
          diagram.selectedItems.connectors[0].wrapper.offsetX === 250 &&
          diagram.selectedItems.connectors[0].wrapper.offsetY === 250
      ).toBe(true);
      done();
    });
    ...
    it('Checking redo for node and connector  select the rubber band selection', (done: Function) => {
      diagram.redo();
      expect(
        diagram.selectedItems.nodes[0].offsetX == 50 &&
          diagram.selectedItems.nodes[0].offsetY == 50 &&
          diagram.selectedItems.connectors[0].wrapper.offsetX === 200 &&
          diagram.selectedItems.connectors[0].wrapper.offsetY === 200
      ).toBe(true);
      done();
    });
    ...
    it('Checking redo for single node dragging', (done: Function) => {
      diagram.redo();
      expect(
        diagram.selectedItems.nodes[0].offsetX === 400 &&
          diagram.selectedItems.nodes[0].offsetY === 400
      ).toBe(true);
      done();
    });
  });
  ...
  describe('Testing Undo Redo for Resizing', () => {
    ...
    it('Checking undo after single node resizing', (done: Function) => {
      ...
      //increasing size
      let undoTopLeft1: PointModel = (diagram.nodes[0] as NodeModel).wrapper
        .bounds.topLeft;
      ...
      let redoTopLeft1: PointModel = (diagram.nodes[0] as NodeModel).wrapper
        .bounds.topLeft;

      diagram.undo();
      expect(
        (diagram.nodes[0] as NodeModel).wrapper.bounds.topLeft.x ===
          undoTopLeft1.x &&
          (diagram.nodes[0] as NodeModel).wrapper.bounds.topLeft.y ===
            undoTopLeft1.y
      ).toBe(true);
      done();
    });
    ...
    it('Checking redo  after undo single node resizing', (done: Function) => {
      diagram.redo();
      expect(
        (diagram.nodes[0] as NodeModel).wrapper.bounds.topLeft.x === 250 &&
          (diagram.nodes[0] as NodeModel).wrapper.bounds.topLeft.y === 250
      ).toBe(true);
      done();
    });
  });
  ...
  describe('Testing undo redo after resizing - Multiple selection', () => {
    ...
    it('Checking undo after resizing - multiple selection', (done: Function) => {
      ...
      let topLeft: PointModel =
        diagram.selectedItems.wrapper.bounds.bottomRight;
      ...
      mouseEvents.dragAndDropEvent(
        diagramCanvas,
        topLeft.x + diagram.element.offsetLeft,
        topLeft.y + diagram.element.offsetTop,
        topLeft.x + 20,
        topLeft.y + 20
      );
      let topLeft1: PointModel = (diagram.nodes[0] as NodeModel).wrapper.bounds
        .middleRight;
      diagram.undo();
      diagram.selectAll();
      expect(
        diagram.selectedItems.width == width &&
          diagram.selectedItems.height == height &&
          diagram.selectedItems.offsetX == offsetX &&
          diagram.selectedItems.offsetY == offsetY
      ).toBe(true);
      done();
    });
    it('Checking redo after undo resizing - multiple selection', (done: Function) => {
      ...
      console.log(
        'SelectedItems',
        diagram.selectedItems.width,
        diagram.selectedItems.height,
        diagram.selectedItems.offsetX,
        diagram.selectedItems.offsetY
      );
      expect(
        diagram.selectedItems.width == 262 &&
          diagram.selectedItems.height == 312 &&
          diagram.selectedItems.offsetX == 381 &&
          diagram.selectedItems.offsetY == 406
      ).toBe(true);
      done();
    });
  });
  ...
  describe('Undo Redo for Connector End Dragging - source point', () => {
    ...
    it('Checking undo after sourcePoint dragging', (done: Function) => {
      ...
      expect(
        diagram.selectedItems.connectors.length === 1 &&
          diagram.selectedItems.connectors[0].sourcePoint.x === sPointX &&
          diagram.selectedItems.connectors[0].sourcePoint.y === sPointY &&
          diagram.selectedItems.connectors[0].targetPoint.x === tPointX &&
          diagram.selectedItems.connectors[0].targetPoint.y === tPointY
      ).toBe(true);
      done();
    });
    ...
    it('Checking redo after undo sourcePoint dragging', (done: Function) => {
      ...
      expect(
        diagram.selectedItems.connectors.length === 1 &&
          diagram.selectedItems.connectors[0].sourcePoint.x === 180 &&
          diagram.selectedItems.connectors[0].sourcePoint.y === 180 &&
          diagram.selectedItems.connectors[0].targetPoint.x === 280 &&
          diagram.selectedItems.connectors[0].targetPoint.y === 280
      ).toBe(true);
      done();
    });
  });
  ...
  describe('Undo Redo for Connector End Dragging - target point', () => {
    ...
    it('Checking redo after undo the targetPoint dragging', (done: Function) => {
      ...
      expect(
        diagram.selectedItems.connectors.length === 1 &&
          diagram.selectedItems.connectors[0].sourcePoint.x === 220 &&
          diagram.selectedItems.connectors[0].sourcePoint.y === 220 &&
          diagram.selectedItems.connectors[0].targetPoint.x === 320 &&
          diagram.selectedItems.connectors[0].targetPoint.y === 320
      ).toBe(true);
      done();
    });
  });
  ...
  describe('Undo Redo for node dragging - multiple undo', () => {
    ...
    it('Checking undo after undo and node dragging', (done: Function) => {
      ...
      diagram.undo();
      expect(
        diagram.selectedItems.nodes[0].offsetX == 300 &&
          diagram.selectedItems.nodes[0].offsetY == 100
      ).toBe(true);
      done();
    });
  ...
  describe('Undo Redo - Nodes with alignment left', () => {
    ...
    beforeAll((): void => {
      ...
      let node: NodeModel = {
        ...
        offsetY: 100,
        annotations: [
          { content: 'Node1', style: { strokeColor: 'black', opacity: 1 } },
        ],
      };
      let node2: NodeModel = {
        id: 'node2',
        ...
        offsetY: 200,
        annotations: [
          { content: 'Node2', style: { strokeColor: 'black', opacity: 1 } },
        ],
      };
      let node3: NodeModel = {
        id: 'node3',
        ...
        offsetY: 450,
        annotations: [
          { content: 'Node3', style: { strokeColor: 'black', opacity: 1 } },
        ],
      };
      let node4: NodeModel = {
        id: 'node4',
        ...
        offsetY: 350,
        annotations: [
          { content: 'Node4', style: { strokeColor: 'black', opacity: 1 } },
        ],
      };
      diagram = new Diagram({
        width: '1000px',
    ...
    it('Checking Undo - Nodes with alignment left', (done: Function) => {
      ...
      expect(
        diagram.nodes[0].offsetX === 100 &&
          ...
          diagram.nodes[1].offsetY === 200 &&
          diagram.nodes[2].offsetX === 200 &&
          diagram.nodes[2].offsetY === 450 &&
          diagram.nodes[3].offsetX === 400 &&
          diagram.nodes[3].offsetY === 350 &&
          diagram.connectors[0].sourcePoint.x === 400 &&
          diagram.connectors[0].sourcePoint.y === 500 &&
          diagram.connectors[0].targetPoint.x === 600 &&
          diagram.connectors[0].targetPoint.y === 500
      ).toBe(true);
      done();
    });
    it('Checking Redo - Nodes with alignment left', (done: Function) => {
      ...
      expect(
        diagram.nodes[0].offsetX === 100 &&
          diagram.nodes[0].offsetY === 100 &&
          diagram.nodes[1].offsetX === 85 &&
          diagram.nodes[1].offsetY === 200 &&
          diagram.nodes[2].offsetX === 75 &&
          diagram.nodes[2].offsetY === 450 &&
          diagram.nodes[3].offsetX === 110 &&
          diagram.nodes[3].offsetY === 350 &&
          diagram.connectors[0].sourcePoint.x === 35 &&
          diagram.connectors[0].sourcePoint.y === 500 &&
          diagram.connectors[0].targetPoint.x === 235 &&
          diagram.connectors[0].targetPoint.y === 500
      ).toBe(true);
      done();
    });
  ...
  describe('Undo Redo - Nodes with alignment Right', () => {
    ...
    it('Checking Redo - Nodes with alignment Right', (done: Function) => {
      ...
      expect(
        diagram.nodes[0].offsetX === 100 &&
          diagram.nodes[0].offsetY === 100 &&
          diagram.nodes[1].offsetX === 115 &&
          diagram.nodes[1].offsetY === 200 &&
          diagram.nodes[2].offsetX === 125 &&
          diagram.nodes[2].offsetY === 450 &&
          diagram.nodes[3].offsetX === 90 &&
          diagram.nodes[3].offsetY === 350
      ).toBe(true);
      done();
    });
    ...
    it('Checking Undo Redo - Nodes with alignment Top', (done: Function) => {
      ...
      expect(
        diagram.nodes[0].offsetX === 100 &&
          diagram.nodes[0].offsetY === 100 &&
          diagram.nodes[1].offsetX === 300 &&
          diagram.nodes[1].offsetY === 110 &&
          diagram.nodes[2].offsetX === 200 &&
          diagram.nodes[2].offsetY === 100 &&
          diagram.nodes[3].offsetX === 400 &&
          diagram.nodes[3].offsetY === 85 &&
          diagram.connectors[0].sourcePoint.x === 400 &&
          diagram.connectors[0].sourcePoint.y === 50 &&
          diagram.connectors[0].targetPoint.x === 600 &&
          diagram.connectors[0].targetPoint.y === 50
      ).toBe(true);
      done();
    });
  });
    ...
    it('Checking Undo Redo - Nodes with alignment Bottom', (done: Function) => {
      ...
      expect(
        diagram.nodes[0].offsetX === 100 &&
          diagram.nodes[0].offsetY === 100 &&
          diagram.nodes[1].offsetX === 300 &&
          diagram.nodes[1].offsetY === 90 &&
          diagram.nodes[2].offsetX === 200 &&
          diagram.nodes[2].offsetY === 100 &&
          diagram.nodes[3].offsetX === 400 &&
          diagram.nodes[3].offsetY === 115 &&
          diagram.connectors[0].sourcePoint.x === 400 &&
          diagram.connectors[0].sourcePoint.y === 150 &&
          diagram.connectors[0].targetPoint.x === 600 &&
          diagram.connectors[0].targetPoint.y === 150
      ).toBe(true);
      done();
    });
  });
  describe('Undo Redo - Nodes with alignment Center', () => {
    ...
    it('Checking Undo Redo - Nodes with alignment Center', (done: Function) => {
      ...
      expect(
        diagram.nodes[0].offsetX === 100 &&
          diagram.nodes[0].offsetY === 100 &&
          diagram.nodes[1].offsetX === 100 &&
          diagram.nodes[1].offsetY === 200 &&
          diagram.nodes[2].offsetX === 100 &&
          diagram.nodes[2].offsetY === 450 &&
          diagram.nodes[3].offsetX === 100 &&
          diagram.nodes[3].offsetY === 350 &&
          diagram.connectors[0].sourcePoint.x === 0 &&
          diagram.connectors[0].sourcePoint.y === 500 &&
          diagram.connectors[0].targetPoint.x === 200 &&
          diagram.connectors[0].targetPoint.y === 500
      ).toBe(true);
      done();
    });
    ...
    it('Checking Undo Redo - Nodes with alignment Middle', (done: Function) => {
      ...
      expect(
        diagram.nodes[0].offsetX === 100 &&
          ...
          diagram.nodes[2].offsetY === 100 &&
          diagram.nodes[3].offsetX === 400 &&
          diagram.nodes[3].offsetY === 100 &&
          diagram.connectors[0].sourcePoint.x === 400 &&
          diagram.connectors[0].sourcePoint.y === 100 &&
          diagram.connectors[0].targetPoint.x === 600 &&
          diagram.connectors[0].targetPoint.y === 100
      ).toBe(true);
      done();
    });
  });
    ...
    it('Checking Undo Redo - Nodes with SizingOptions Width', (done: Function) => {
      ...
      expect(
        diagram.nodes[0].width === 150 &&
          diagram.nodes[0].height === 100 &&
          diagram.nodes[1].width === 80 &&
          diagram.nodes[1].height === 130 &&
          diagram.nodes[2].width === 200 &&
          diagram.nodes[2].height === 75 &&
          diagram.connectors[0].wrapper.bounds.width === 100
      ).toBe(true);
      diagram.redo();
      expect(
        diagram.nodes[0].width === 150 &&
          diagram.nodes[0].height === 100 &&
          diagram.nodes[1].width === 150 &&
          diagram.nodes[1].height === 130 &&
          diagram.nodes[2].width === 150 &&
          diagram.nodes[2].height === 75 &&
          diagram.connectors[0].wrapper.bounds.width === 150
      ).toBe(true);
      done();
    });
    ...
    it('Checking Undo Redo - Nodes with SizingOptions Height', (done: Function) => {
      ...
      expect(
        diagram.nodes[0].width === 200 &&
          ...
          diagram.nodes[1].width === 150 &&
          diagram.nodes[1].height === 180 &&
          diagram.nodes[2].width === 80 &&
          diagram.nodes[2].height === 70 &&
          diagram.connectors[0].wrapper.bounds.height === 100
      ).toBe(true);
      diagram.redo();
      expect(
        diagram.nodes[0].width === 200 &&
          diagram.nodes[0].height === 150 &&
          diagram.nodes[1].width === 150 &&
          diagram.nodes[1].height === 150 &&
          diagram.nodes[2].width === 80 &&
          diagram.nodes[2].height === 150 &&
          diagram.connectors[0].wrapper.bounds.height === 150
      ).toBe(true);
      done();
    });
  });
    ...
    it('Checking Undo Redo - Nodes with SizingOptions size', (done: Function) => {
      ...
      expect(
        diagram.nodes[0].width === 150 &&
          ...
          diagram.nodes[1].height === 170 &&
          diagram.nodes[2].width === 200 &&
          diagram.nodes[2].height === 80 &&
          diagram.connectors[0].wrapper.bounds.width === 200 &&
          diagram.connectors[0].wrapper.bounds.height === 100
      ).toBe(true);
    ...
    it('Checking Undo Redo - Nodes with SpacingOptions RightToLeft', (done: Function) => {
      ...
      expect(
        diagram.nodes[0].offsetX === 200 &&
          ...
          diagram.nodes[2].offsetY === 100 &&
          diagram.connectors[0].sourcePoint.x === 600 &&
          diagram.connectors[0].sourcePoint.y === 100 &&
          diagram.connectors[0].targetPoint.x === 800 &&
          diagram.connectors[0].targetPoint.y === 100
      ).toBe(true);
      diagram.redo();
      expect(
    ...
    it('Checking Undo Redo - Nodes with SpacingOptions BottomToTop', (done: Function) => {
      ...
      expect(
        diagram.nodes[1].offsetX === 100 &&
          diagram.nodes[1].offsetY === 100 &&
          diagram.nodes[2].offsetX === 500 &&
          diagram.nodes[2].offsetY === 500 &&
          diagram.nodes[0].offsetX === 200 &&
          diagram.nodes[0].offsetY === 200 &&
          (diagram.connectors[0].sourcePoint.x === 250 &&
            diagram.connectors[0].sourcePoint.y) === 300 &&
          (diagram.connectors[0].targetPoint.x === 400 &&
            diagram.connectors[0].targetPoint.y) === 300
      ).toBe(true);
      diagram.redo();
      expect(
        diagram.nodes[1].offsetX === 100 &&
          ...
          diagram.nodes[2].offsetX === 500 &&
          diagram.nodes[2].offsetY === 500 &&
          Math.round(diagram.nodes[0].offsetX) === 200 &&
          Math.round(diagram.nodes[0].offsetY) === 233 &&
          diagram.connectors[0].sourcePoint.x === 250 &&
          Math.round(diagram.connectors[0].sourcePoint.y) === 367 &&
          diagram.connectors[0].targetPoint.x === 400 &&
          Math.round(diagram.connectors[0].targetPoint.y) === 367
      ).toBe(true);
      done();
    });
  });
  ...
  describe('Check undo and redo with group node and connector', () => {
    ...
    it('Checking undo and redo functionalities of group node with connector', (done: Function) => {
      ...
      expect(
        preRotate_angle === undoRotate_angle &&
          postRotate_angle === redoRotate_angle
      ).toBe(true);
      done();
    });
  });
  ...
  describe('842506 - Check undo and redo with group node with two connector', () => {
    ...
    beforeAll((): void => {
      ...
      let nodes: NodeModel[] = [
        ...
        {
          id: 'group2',
          children: ['connector1', 'connector2'],
          annotations: [{ content: 'Label' }],
        },
      ];
  ...
  describe('Undo Redo - add port and remove port', () => {
    ...
    it('Checking undo redo - add port at runtime', (done: Function) => {
      expect(
        diagram.nodes.length == 1 && diagram.nodes[0].ports.length == 0
      ).toBe(true);
      ...
      expect(
        diagram.nodes.length == 1 && diagram.nodes[0].ports.length == 4
      ).toBe(true);
      diagram.undo();
      expect(
        diagram.nodes.length == 1 && diagram.nodes[0].ports.length == 0
  ...
  describe('Testing undo redo - remove node then undo and check for connection', () => {
    ...
    it('Checking undo redo - remove source node and check for source id', (done: Function) => {
      ...
      diagram.dataBind();
      expect(
        connector1.sourceID === node.id && connector2.sourceID === node.id
      ).toBe(true);
  ...
  describe('Undo Redo - Change port connection in connector', () => {
    ...
    it('Checking undo - connector(source port to point)', (done: Function) => {
      ...
      mouseEvents.clickEvent(
        diagramCanvas,
        diagram.connectors[0].sourcePoint.x + diagram.element.offsetLeft,
        diagram.connectors[0].sourcePoint.y + diagram.element.offsetTop
      );
      mouseEvents.dragAndDropEvent(
        diagramCanvas,
        diagram.connectors[0].sourcePoint.x + diagram.element.offsetLeft,
        diagram.connectors[0].sourcePoint.y + diagram.element.offsetTop,
        diagram.connectors[0].sourcePoint.x + diagram.element.offsetLeft,
        diagram.connectors[0].sourcePoint.y + diagram.element.offsetTop + 100
      );
    ...
    it('Checking undo - connector(target port to point)', (done: Function) => {
      ...
      mouseEvents.dragAndDropEvent(
        diagramCanvas,
        diagram.connectors[0].targetPoint.x + diagram.element.offsetLeft,
        diagram.connectors[0].targetPoint.y + diagram.element.offsetTop,
        diagram.connectors[0].targetPoint.x + diagram.element.offsetLeft,
        diagram.connectors[0].targetPoint.y + diagram.element.offsetTop + 100
      );
