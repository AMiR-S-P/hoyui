...
import {
  BasicShapeModel,
  NodeModel,
} from '../../src/diagram/objects/node-model';
...
import { createSpinner, showSpinner, hideSpinner } from '@hoyui/popups';
...
describe('Overview', () => {
  describe('Overview Tests', () => {
    ...
    beforeAll((): void => {
      ...
      diagram = new Diagram({
        width: '600px',
        height: '500px',
        nodes: [node, node2, node3, node4, node5, node6],
    ...
    it('Click on the overview rect', (done: Function) => {
      let overviewelement: HTMLElement = document.getElementById(
        overview.element.id
      );
      let target: HTMLElement = document.getElementById(
        'overview1_canvas_overviewsvg'
      );
      ...
      expect(
        diagram.scroller.horizontalOffset === 0 &&
          diagram.scroller.verticalOffset === 0
      ).toBe(true);
    ...
    it('Click on the overview rect - Pan with focused area', (done: Function) => {
      ...
      expect(diagram.scroller.currentZoom === 1).toBe(true);
      expect(
        diagram.scroller.horizontalOffset === -168 &&
          diagram.scroller.verticalOffset === -33.6
      ).toBe(true);
      done();
    });
    it('Click on the overview rect - Scale with resizer bottom right', (done: Function) => {
      ...
      console.log(
        'zoom ' +
          diagram.scroller.currentZoom.toFixed(4) +
          ' hOffset ' +
          Math.round(diagram.scroller.horizontalOffset) +
          ' vOffset ' +
          Math.round(diagram.scroller.verticalOffset)
      );
      expect(
        Number(diagram.scroller.currentZoom.toFixed(4)) >= 1.4 &&
          Number(diagram.scroller.currentZoom.toFixed(4)) <= 1.6
      ).toBe(true);
      done();
    });
    it('Click on the overview rect - Scale with resizer bottom right with y greater than X', (done: Function) => {
      ...
      expect(
        Number(diagram.scroller.currentZoom.toFixed(4)) >= 1.8 &&
          Number(diagram.scroller.currentZoom.toFixed(4)) <= 2
      ).toBe(true);
      done();
    });
    ...
    it('Click on the overview rect - Scale with resizer bottom Left', (done: Function) => {
      ...
      expect(
        Number(diagram.scroller.currentZoom.toFixed(4)) >= 3.4 &&
          Number(diagram.scroller.currentZoom.toFixed(4)) <= 3.6
      ).toBe(true);
      done();
    });
    it('Click on the overview rect - Scale with resizer bottom Left with y greater than X', (done: Function) => {
      ...
      expect(
        Number(diagram.scroller.currentZoom.toFixed(4)) >= 6.8 &&
          Number(diagram.scroller.currentZoom.toFixed(4)) <= 8
      ).toBe(true);
      done();
    });
    ...
    it('Click on the overview rect - Scale with resizer Top left', (done: Function) => {
      ...
      expect(
        Number(diagram.scroller.currentZoom.toFixed(4)) >= 2.3 &&
          Number(diagram.scroller.currentZoom.toFixed(4)) <= 2.5
      ).toBe(true);
      done();
    });
    ...
    it('Click on the overview rect - Scale with resizer Top', (done: Function) => {
      ...
      expect(
        Number(diagram.scroller.currentZoom.toFixed(4)) >= 2.1 &&
          Number(diagram.scroller.currentZoom.toFixed(4)) <= 2.3
      ).toBe(true);
      done();
    });
    it('Click on the overview rect - Scale with resizer Top right', (done: Function) => {
      ...
      expect(
        Number(diagram.scroller.currentZoom.toFixed(4)) >= 1.7 &&
          Number(diagram.scroller.currentZoom.toFixed(4)) <= 1.9
      ).toBe(true);
      done();
    });
    ...
    it('Click on the overview rect - Scale with resizer  Right', (done: Function) => {
      ...
      expect(
        Number(diagram.scroller.currentZoom.toFixed(4)) >= 1 &&
          Number(diagram.scroller.currentZoom.toFixed(4)) <= 1.2
      ).toBe(true);
      done();
    });
    it('Click on the overview rect - Pan', (done: Function) => {
      ...
      overview[mouseDown]({ target: target, type: mouseDown });
      mouseEvents.mouseDownEvent(overviewelement, 100, 650);
      mouseEvents.mouseUpEvent(target, 100, 650);
      console.log(
        'zoom ' +
          diagram.scroller.currentZoom.toFixed(4) +
          ' hOffset ' +
    ...
    it('Click on the overview rect - Draw', (done: Function) => {
      ...
      expect(
        Math.round(diagram.scroller.horizontalOffset) === -905 &&
          Math.round(diagram.scroller.verticalOffset) === 79
      ).toBe(true);
      done();
    });
    it('Click on the overview rect - Draw with current point lesser than start point', (done: Function) => {
      ...
      mouseEvents.mouseUpEvent(target, 100, 550);
      overview[mouseup]({ target: target, type: mouseDown });
      expect(diagram.scroller.currentZoom.toFixed(3) === '3.501').toBe(true);
      expect(
        Math.round(diagram.scroller.horizontalOffset) == -1082 &&
          Math.round(diagram.scroller.verticalOffset) == -592
      ).toBe(true);
      done();
    });
    it('Overview - Scrolled Event', (done: Function) => {
      let scroller: HTMLElement = document.getElementById(
      ...
      expect(diagram.scroller.currentZoom.toFixed(3) === '3.501').toBe(true);
      expect(
        Math.round(diagram.scroller.horizontalOffset) === -20 &&
          Math.round(diagram.scroller.verticalOffset) === -10
      ).toBe(true);
      done();
    });
    it('Click on the Resizer bottom right', (done: Function) => {
      ...
      mouseEvents.mouseMoveEvent(
        diagramCanvas,
        178.57142857142858 + 10,
        148.80952380952382 + 10
      );
    ...
    it('Overview - Mouse wheel event', (done: Function) => {
      ...
      expect(
        (Math.round(diagram.scroller.horizontalOffset) == -15 ||
          Math.floor(diagram.scroller.horizontalOffset) === 23) &&
          (Math.round(diagram.scroller.verticalOffset) == -0 ||
            Math.floor(diagram.scroller.verticalOffset) === 73)
      ).toBe(true);
      done();
    });
    it('Overview - Document mouseup', (done: Function) => {
      ...
      console.log(
        'diagram.scroller.currentZoom = ' + diagram.scroller.currentZoom
      );
      console.log(
        'diagram.scroller.horizontalOffset = ' +
          diagram.scroller.horizontalOffset
      );
      console.log(
        'diagram.scroller.verticalOffset =' + diagram.scroller.verticalOffset
      );
      expect(
        (Math.round(diagram.scroller.horizontalOffset) === 23 ||
          Math.round(diagram.scroller.horizontalOffset) === -14 ||
          Math.round(diagram.scroller.horizontalOffset) === -15 ||
          Math.floor(diagram.scroller.horizontalOffset) === 23) &&
          (Math.round(diagram.scroller.verticalOffset) === -0.16 ||
            Math.round(diagram.scroller.verticalOffset) === 0 ||
            Math.floor(diagram.scroller.verticalOffset) === 73)
      ).toBe(true);
      done();
    ...
    it('Overview - Pan with focused area with current and start x points are same', (done: Function) => {
      ...
      mouseEvents.mouseUpEvent(target, 1094, 82);
      console.log(
        'Overview - Pan with focused area with current and start x points are same'
      );
      console.log(
        'diagram.scroller.currentZoom = ' + diagram.scroller.currentZoom
      );
      ...
      expect(diagram.scroller.currentZoom.toFixed(4) === '2.9178').toBe(true);
      expect(
        (Math.round(diagram.scroller.horizontalOffset) === -14.86 ||
          Math.round(diagram.scroller.horizontalOffset) === -14 ||
          Math.round(diagram.scroller.horizontalOffset) === -15 ||
          Math.floor(diagram.scroller.horizontalOffset) === 23) &&
          (Math.round(diagram.scroller.verticalOffset) === -0.16 ||
    ...
    it('Overview - Mouse wheel event', (done: Function) => {
      ...
      expect(
        (Math.round(diagram.scroller.horizontalOffset) === -14 ||
          Math.floor(diagram.scroller.horizontalOffset) === 23) &&
          (Math.round(diagram.scroller.verticalOffset) === 0 ||
            Math.floor(diagram.scroller.verticalOffset) === 63)
      ).toBe(true);
      done();
    });
    ...
    it('Changing the diagram size', (done: Function) => {
      ...
      diagram.dataBind();
      expect(
        overview.contentWidth === 1000 && overview.contentHeight === 2000
      ).toBe(true);
      done();
    });
  });
  ...
  describe('Overview Tests with multiple overview', () => {
    ...
    it('Multiple overview rect - Pan with focused area', (done: Function) => {
      ...
      expect(diagram.scroller.currentZoom === 1).toBe(true);
      expect(
        Math.round(diagram.scroller.horizontalOffset) >= -58 &&
          Math.round(diagram.scroller.horizontalOffset) <= -52 &&
  ...
  describe('Overview Tests', () => {
    ...
    beforeAll((): void => {
      ...
      parentelement1 = createElement('div', {
        id: 'parentelement1',
        styles: 'width:74%;height: 500px; float:left;',
      });
      ...
      overViewElement = createElement('div', {
        id: 'overview4',
        styles:
          'width:25%;height:200px;float:left; border-color:lightgray;border-style:solid;',
      });
        ...
        dataSourceSettings: {
          ...
          doBinding: (nodeModel: NodeModel, diagram: Diagram) => {
            ...
            nodeModel.shape = {
              type: 'HTML',
              content:
                '<div><img src="https://www.w3schools.com/tags/smiley.gif" alt="Smiley face" width="42" height="42"></div>',
            };
  ...
  describe('Exception occurs while changing Overview id and window resize ', () => {
    ...
    it('Checking overview html layer rendering with different id', (done: Function) => {
      expect(
        window['domTable']['overhtml_layer'] !== null &&
          window['domTable']['overviewhtml_layer'] === undefined
      ).toBe(true);
      done();
    });
  });
  ...
  describe('849892-Overview not updated properly when we load the diagram', () => {
    ...
    it('Load customer JSON and check if the overview is updated properly', (done: Function) => {
      let savedata: any = {
        ...
        pageSettings: {
          background: { color: 'rgba(255,255,255,1)', source: '' },
          width: 1500,
          multiplePage: false,
          height: 600,
          margin: { left: 5, top: 5 },
        ...
        scrollSettings: {
          ...
          minZoom: 0.25,
          maxZoom: 30,
          currentZoom: 0.4276620370370373,
          viewPortWidth: 1440,
          viewPortHeight: 854,
          horizontalOffset: -19.93,
          verticalOffset: -250.67,
        ...
        snapSettings: {
          horizontalGridlines: {
            lineColor: '#e0e0e0',
            lineIntervals: [
              1, 9, 0.25, 9.75, 0.25, 9.75, 0.25, 9.75, 0.25, 9.75, 0.25, 9.75,
            ...
            },
            {
              ...
              items: [
                ...
                },
                {
                  ...
                  iconCss:
                    'e-gate e-bpmn-icons e-ParallelEventBasedGatewaytostart',
        ...
        layers: [
          {
            objects: [
              ...
              'Data_ObjectqIZuM',
              'Tasku4sokLHKk2HrSrL',
              'Data_ObjectcZ5fTGKCXTa652oiybxn',
              'End_EventS9ib1QEEfC',
              'Data_ObjectZDkTR',
              'Intermediate_EventFkC0k',
              'Gatewayi1iQr',
              'Data_ObjectcZ5fTKOX8B',
              'TaskqKla4',
              'Data_ObjectcZ5fT',
              'TaskqKla4TfIVX',
              'TaskqKla4TfIVXw1p5k',
              'Data_ObjectcZ5fTKk3hQ',
              'Tasku4sokLHKk2HrSrLSvLov',
              'connectorss71m',
              'connectory739V',
              'connectorf9nfT',
              'connectorQJUgB',
        ...
        nodes: [
          {
            shape: {
              ...
              annotations: [],
              activity: { subProcess: {}, activity: 'Task' },
            },
            ports: [
              {
                inEdges: [],
            ...
            annotations: [
              {
                id: 'FTVvJ',
                content:
                  'Request for Liquefaction Impact Assessment to Cable Burial Received',
          ...
          },
          {
            shape: {
              ...
              activity: {
                activity: 'Task',
                subProcess: { type: 'None', collapsed: true },
                task: {
                  call: false,
                  compensation: false,
                  loop: 'None',
            ...
            flip: 'None',
            wrapper: {
              actualSize: { width: 140, height: 100 },
              offsetX: 350,
              offsetY: 501,
            },
            style: {
            ...
            addInfo: {
              ...
              status: 'new',
              unconnected_name:
                'Evaluate if Soil Conditions are subject to liquefaction',
              ctx_id: null,
              eicore_id: null,
              guid: '5648144a-aa56-4c1e-aa17-90905347399e',
              userhandle_conceptual_isvalid: false,
              userhandle_logical_isvalid: false,
            },
            fixedUserHandles: [
              {
                pathData:
                  'M8 15A7 7 0 1 1 8 1a7 7 0 0 1 0 14zm0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16z M10.97 4.97a.235.235 0 0 0-.02.022L7.477 9.417 5.384 7.323a.75.75 0 0 0-1.06 1.06L6.97 11.03a.75.75 0 0 0 1.079-.02l3.992-4.99a.75.75 0 0 0-1.071-1.05z',
                visibility: false,
                iconStrokeColor: 'green',
                margin: { right: -5, top: -15, left: 0, bottom: 0 },
                width: 16,
                height: 16,
                id: 'FDcxD',
              ...
              },
              {
                ...
                visibility: false,
                iconStrokeColor: 'green',
                margin: { right: -25, top: -15, left: 0, bottom: 0 },
                width: 16,
                height: 16,
                id: 'heueG',
                handleStrokeColor: 'transparent',
            ...
            isExpanded: true,
            expandIcon: { shape: 'None' },
            inEdges: ['connectorss71m', 'connectorH70v1'],
            outEdges: ['connectory739V'],
            parentId: '',
            processId: '',
            umlIndex: -1,
            isPhase: false,
          ...
          },
          {
            shape: {
              ...
              annotations: [],
              activity: { subProcess: { collapsed: true } },
            },
            ports: [
              {
                inEdges: [],
            ...
            annotations: [
              {
                id: 'chTnX',
                content: 'Are Soil Conditions Liquefable?',
                annotationType: 'String',
                style: {
                  strokeWidth: 0,
                  strokeColor: 'transparent',
            ...
            expandIcon: { shape: 'None' },
            fixedUserHandles: [],
            inEdges: ['connectory739V'],
            outEdges: ['connectorf9nfT', 'connectorQJUgB'],
            parentId: '',
            processId: '',
            umlIndex: -1,
            isPhase: false,
          ...
          },
          {
            ...
            addInfo: {
              ...
              status: 'new',
              unconnected_name:
                'Inform SI PM Liquefaction Impact Assessment to Cable Burial is not required',
              ctx_id: null,
              eicore_id: null,
              guid: '870c0a90-4633-4072-950e-fd3fe2bbb56b',
              userhandle_conceptual_isvalid: false,
              userhandle_logical_isvalid: false,
            },
            fixedUserHandles: [
            ...
            isExpanded: true,
            expandIcon: { shape: 'None' },
            inEdges: ['connectorf9nfT'],
            outEdges: ['connectorDJWT5'],
            parentId: '',
            processId: '',
            umlIndex: -1,
            isPhase: false,
          ...
          },
          {
            ...
            flip: 'None',
            wrapper: {
              actualSize: { width: 140, height: 90.00000000000001 },
              offsetX: 960,
              offsetY: 355,
            },
            style: {
            ...
            addInfo: {
              ...
              status: 'new',
              unconnected_name:
                'Prepare Liquefaction Impact Assessment to Cable Burial SoW',
              ctx_id: null,
              eicore_id: null,
              guid: 'c92ec40c-b412-44f8-8353-dd5fa1233281',
              userhandle_conceptual_isvalid: false,
              userhandle_logical_isvalid: false,
            },
            fixedUserHandles: [
            ...
            outEdges: ['connectorHxn1I', 'connectorJdaD6'],
            parentId: '',
            processId: '',
            umlIndex: -1,
            isPhase: false,
          ...
          },
          {
            shape: {
              ...
              annotations: [],
              activity: { subProcess: { collapsed: true }, activity: 'Task' },
            },
            ports: [
              {
                inEdges: [],
            ...
            flip: 'None',
            wrapper: {
              actualSize: { width: 100, height: 120 },
              offsetX: 310,
              offsetY: 140,
            },
            style: {
            ...
            addInfo: {
              ...
              type: 'Information',
              status: 'new',
              unconnected_name: 'Geophysical Surfaces',
              ctx_id: null,
              eicore_id: null,
              guid: '1e5cfc98-8766-434e-95dc-fc591266d258',
              userhandle_conceptual_isvalid: false,
              userhandle_logical_isvalid: false,
            },
            fixedUserHandles: [
          ...
          },
          {
            ...
            addInfo: {
              ...
              type: 'Information',
              status: 'new',
              unconnected_name: 'Soil Properties',
              ctx_id: null,
              eicore_id: null,
              guid: '84358d82-f251-4250-a79b-1867dbcfbad9',
              userhandle_conceptual_isvalid: false,
              userhandle_logical_isvalid: false,
            },
            fixedUserHandles: [
          ...
          },
          {
            ...
            addInfo: {
              ...
              type: 'Information',
              status: 'new',
              unconnected_name: 'Seabed Mobility',
              ctx_id: null,
              eicore_id: null,
              guid: '3d9ba18d-a3d2-42ad-a143-19e8af6851ce',
              userhandle_conceptual_isvalid: false,
              userhandle_logical_isvalid: false,
            },
            fixedUserHandles: [
          ...
          },
          {
            ...
            addInfo: {
              ...
              type: 'Information',
              status: 'new',
              unconnected_name: 'Cable Properties',
              ctx_id: null,
              eicore_id: null,
              guid: '9dbf7535-ae80-4ebf-b708-6c2c8b69431c',
              userhandle_conceptual_isvalid: false,
              userhandle_logical_isvalid: false,
            },
            fixedUserHandles: [
          ...
          },
          {
            ...
            addInfo: {
              ...
              type: 'Process',
              status: 'new',
              unconnected_name: 'Prepare Results for Stakeholders',
              ctx_id: null,
              eicore_id: null,
              guid: '108f3e3a-0eb1-4ea6-ab20-a8dca93ce73f',
              userhandle_conceptual_isvalid: false,
              userhandle_logical_isvalid: false,
            },
            fixedUserHandles: [
            ...
            annotations: [
              {
                id: 'hxUwv',
                content: 'Prepare Results for Stakeholders',
                annotationType: 'String',
                style: {
                  strokeWidth: 0,
                  strokeColor: 'transparent',
            ...
            isExpanded: true,
            expandIcon: { shape: 'None' },
            inEdges: ['connectorkB4mc'],
            outEdges: ['connectorNgT5p', 'connectorReDDb'],
            parentId: '',
            processId: '',
            umlIndex: -1,
            isPhase: false,
          ...
          },
          {
            ...
            id: 'Data_ObjectcZ5fTGKCXTa652oiybxn',
            width: 100,
            height: 120,
            constraints: 5242862,
            container: null,
            ...
            addInfo: {
              ...
              type: 'Information',
              status: 'new',
              unconnected_name: 'Liquefaction Summary Report',
              ctx_id: null,
              eicore_id: null,
              guid: '0c1c094e-28dd-4e44-8367-8a57d374ab0e',
              userhandle_conceptual_isvalid: false,
              userhandle_logical_isvalid: false,
            },
            fixedUserHandles: [
            ...
            annotations: [
              {
                id: 'hUZxy',
                content: 'Liquefaction Summary Report',
                annotationType: 'String',
                style: {
                  strokeWidth: 0,
                  strokeColor: 'transparent',
            ...
            isExpanded: true,
            expandIcon: { shape: 'None' },
            inEdges: ['connectorNgT5p'],
            outEdges: ['connectoriTJsS'],
            parentId: '',
            processId: '',
            umlIndex: -1,
            isPhase: false,
            ...
            annotations: [
              {
                id: 'WZwNT',
                content:
                  'Liquefaction Impact Assessment Report Request Managed',
                annotationType: 'String',
                style: {
                  strokeWidth: 0,
                  strokeColor: 'transparent',
          ...
          },
          {
            ...
            addInfo: {
              ...
              type: 'Information',
              status: 'new',
              unconnected_name: 'GA Deliverable - Confirm Name',
              ctx_id: null,
              eicore_id: null,
              guid: '3c3a6b8e-8eff-4789-94c6-680926fb4d4e',
              userhandle_conceptual_isvalid: false,
              userhandle_logical_isvalid: false,
            },
            fixedUserHandles: [
            ...
            annotations: [
              {
                id: 'aTyXv',
                content: 'GA Deliverable - Confirm Name',
                annotationType: 'String',
                style: {
                  strokeWidth: 0,
                  strokeColor: 'transparent',
          ...
          },
          {
            ...
            annotations: [
              {
                id: 'DQSOS',
                content:
                  'Liquefaction Impact Assessment to Cable Burial Report Received',
                annotationType: 'String',
                style: {
                  strokeWidth: 0,
                  strokeColor: 'transparent',
            ...
            expandIcon: { shape: 'None' },
            fixedUserHandles: [],
            inEdges: ['connectorlBFvm'],
            outEdges: ['connectorm58Hf', 'connectorkpMtb'],
            parentId: '',
            processId: '',
            umlIndex: -1,
            isPhase: false,
          ...
          },
          {
            ...
            expandIcon: { shape: 'None' },
            fixedUserHandles: [],
            inEdges: ['connectoryEKZw', 'connectorDJWT5'],
            outEdges: ['connectoraasqK'],
            parentId: '',
            processId: '',
            umlIndex: -1,
            isPhase: false,
          ...
          },
          {
            ...
            addInfo: {
              ...
              status: 'new',
              unconnected_name:
                'Liquefaction Impact Assessment to Cable Burial SoW Template',
              ctx_id: null,
              eicore_id: null,
              guid: '0c1c094e-28dd-4e44-8367-8a57d374ab0e',
              userhandle_conceptual_isvalid: false,
          ...
          },
          {
            ...
            addInfo: {
              ...
              status: 'new',
              unconnected_name:
                'Procure Liquefaction Impact Assessment to Cable Burial SoW',
              ctx_id: null,
              eicore_id: null,
              guid: 'a13db966-ef24-4098-9f6a-dfd9e867a360',
              userhandle_conceptual_isvalid: false,
              userhandle_logical_isvalid: false,
            },
            fixedUserHandles: [
            ...
            isExpanded: true,
            expandIcon: { shape: 'None' },
            inEdges: ['connectorHxn1I', 'connectorZNFg8'],
            outEdges: ['connectorxyoW9'],
            parentId: '',
            processId: '',
            umlIndex: -1,
            isPhase: false,
          ...
          },
          {
            ...
            addInfo: {
              ...
              status: 'new',
              unconnected_name:
                'Liquefaction Impact Assessment to Cable Burial SoW',
              ctx_id: null,
              eicore_id: null,
              guid: '0c1c094e-28dd-4e44-8367-8a57d374ab0e',
              userhandle_conceptual_isvalid: false,
            ...
            annotations: [
              {
                id: 'hUZxy',
                content: 'Liquefaction Impact Assessment to Cable Burial SoW',
                annotationType: 'String',
                style: {
                  strokeWidth: 0,
                  strokeColor: 'transparent',
            ...
            isExpanded: true,
            expandIcon: { shape: 'None' },
            inEdges: ['connectorJdaD6'],
            outEdges: ['connectorZNFg8'],
            parentId: '',
            processId: '',
            umlIndex: -1,
            isPhase: false,
          ...
          },
          {
            ...
            addInfo: {
              ...
              status: 'new',
              unconnected_name:
                'Execution Liquefaction Impact Assessment to Cable Burial',
              ctx_id: null,
              eicore_id: null,
              guid: 'a13db966-ef24-4098-9f6a-dfd9e867a360',
              userhandle_conceptual_isvalid: false,
            ...
            isExpanded: true,
            expandIcon: { shape: 'None' },
            inEdges: ['connectorxyoW9'],
            outEdges: ['connectorlBFvm'],
            parentId: '',
            processId: '',
            umlIndex: -1,
            isPhase: false,
          ...
          },
          {
            ...
            addInfo: {
              ...
              status: 'new',
              unconnected_name:
                'Review and Approve Liquefaction Impact Assessment to Cable Burial Deliverable',
              ctx_id: null,
              eicore_id: null,
              guid: 'a13db966-ef24-4098-9f6a-dfd9e867a360',
              userhandle_conceptual_isvalid: false,
            ...
            isExpanded: true,
            expandIcon: { shape: 'None' },
            inEdges: ['connectorm58Hf', 'connectorhsOpM'],
            outEdges: ['connectorkB4mc'],
            parentId: '',
            processId: '',
            umlIndex: -1,
            isPhase: false,
          ...
          },
          {
            ...
            addInfo: {
              ...
              status: 'new',
              unconnected_name:
                'Liquefaction Impact Assessment to Cable Burial Report',
              ctx_id: null,
              eicore_id: null,
              guid: '0c1c094e-28dd-4e44-8367-8a57d374ab0e',
              userhandle_conceptual_isvalid: false,
            ...
            isExpanded: true,
            expandIcon: { shape: 'None' },
            inEdges: ['connectorkpMtb'],
            outEdges: ['connectorhsOpM'],
            parentId: '',
            processId: '',
            umlIndex: -1,
            isPhase: false,
          ...
          },
          {
            ...
            addInfo: {
              ...
              status: 'new',
              unconnected_name:
                'Upload Liquefaction Summary Report to DORECO and inform Stakeholders',
              ctx_id: null,
              eicore_id: null,
              guid: '108f3e3a-0eb1-4ea6-ab20-a8dca93ce73f',
              userhandle_conceptual_isvalid: false,
            ...
            isExpanded: true,
            expandIcon: { shape: 'None' },
            inEdges: ['connectorReDDb', 'connectoriTJsS'],
            outEdges: ['connectoryEKZw'],
            parentId: '',
            processId: '',
            umlIndex: -1,
            isPhase: false,
        ...
        connectors: [
          {
            shape: { type: 'Bpmn', sequence: 'Normal', flow: 'Sequence' },
            type: 'Orthogonal',
            sourceID: 'Start_Eventp3v58',
            sourcePoint: { x: 149.66, y: 501 },
            targetPoint: { x: 280, y: 501 },
            id: 'connectorss71m',
            targetID: 'Taskn4NDV',
            zIndex: 2,
            style: {
            ...
            cornerRadius: 0,
            wrapper: {
              actualSize: { width: 130.34, height: 0 },
              offsetX: 214.82999999999998,
              offsetY: 501,
            },
            fixedUserHandles: [],
            visible: true,
            flipMode: 'All',
            tooltip: { openOn: 'Auto', content: '' },
            connectionPadding: 0,
            bridgeSpace: 10,
            maxSegmentThumb: null,
            hitPadding: 10,
            parentId: '',
          },
          {
            ...
            type: 'Orthogonal',
            sourceID: 'Taskn4NDV',
            sourcePoint: { x: 420, y: 501 },
            targetPoint: { x: 603.53, y: 501 },
            id: 'connectory739V',
            targetID: 'Gatewayo4Msl',
            zIndex: 4,
            style: {
              strokeWidth: 2,
              strokeColor: '#000000',
            ...
            cornerRadius: 0,
            wrapper: {
              actualSize: { width: 183.52999999999997, height: 0 },
              offsetX: 511.765,
              offsetY: 501,
            },
            fixedUserHandles: [],
          ...
          },
          {
            shape: { type: 'Bpmn', sequence: 'Normal', flow: 'Sequence' },
            type: 'Orthogonal',
            sourceID: 'Gatewayo4Msl',
            sourcePoint: { x: 630, y: 528.4 },
            targetPoint: { x: 891, y: 640 },
            id: 'connectorf9nfT',
            targetID: 'TaskP0QPy',
            zIndex: 8,
            style: {
            ...
            cornerRadius: 0,
            wrapper: {
              actualSize: { width: 261, height: 111.60000000000002 },
              offsetX: 760.5,
              offsetY: 584.2,
            },
            fixedUserHandles: [],
          ...
          },
          {
            ...
            type: 'Orthogonal',
            sourceID: 'Gatewayo4Msl',
            sourcePoint: { x: 630, y: 473.8 },
            targetPoint: { x: 890, y: 355 },
            id: 'connectorQJUgB',
            targetID: 'TaskeW8VJ',
            zIndex: 10,
            style: {
            ...
            cornerRadius: 0,
            wrapper: {
              actualSize: { width: 260, height: 118.80000000000001 },
              offsetX: 760,
              offsetY: 414.4,
            },
            fixedUserHandles: [],
          ...
          },
          {
            ...
            type: 'Orthogonal',
            sourceID: 'Data_ObjectGtkuS',
            sourcePoint: { x: 310, y: 200 },
            targetPoint: { x: 960, y: 310 },
            id: 'connectornBcq8',
            targetID: 'TaskeW8VJ',
            zIndex: 15,
            style: {
            ...
            cornerRadius: 0,
            wrapper: {
              actualSize: { width: 650, height: 110 },
              offsetX: 635,
              offsetY: 255,
            },
            fixedUserHandles: [],
          ...
          },
          {
            ...
            type: 'Orthogonal',
            sourceID: 'Data_ObjectqGT5F',
            sourcePoint: { x: 470, y: 200 },
            targetPoint: { x: 960, y: 310 },
            id: 'connectorfuEWe',
            targetID: 'TaskeW8VJ',
            zIndex: 16,
            ...
            cornerRadius: 0,
            wrapper: {
              actualSize: { width: 490, height: 110 },
              offsetX: 715,
              offsetY: 255,
            },
            fixedUserHandles: [],
          ...
          },
          {
            ...
            type: 'Orthogonal',
            sourceID: 'Data_Objectb7Wo2',
            sourcePoint: { x: 630, y: 200 },
            targetPoint: { x: 960, y: 310 },
            id: 'connectorm3QrF',
            targetID: 'TaskeW8VJ',
            zIndex: 17,
            ...
            cornerRadius: 0,
            wrapper: {
              actualSize: { width: 330, height: 110 },
              offsetX: 795,
              offsetY: 255,
            },
            fixedUserHandles: [],
          ...
          },
          {
            ...
            type: 'Orthogonal',
            sourceID: 'Data_ObjectqIZuM',
            sourcePoint: { x: 790, y: 200 },
            targetPoint: { x: 960, y: 310 },
            id: 'connectorunMD0',
            targetID: 'TaskeW8VJ',
            zIndex: 18,
            ...
            cornerRadius: 0,
            wrapper: {
              actualSize: { width: 170, height: 110 },
              offsetX: 875,
              offsetY: 255,
            },
            fixedUserHandles: [],
          ...
          },
          {
            ...
            type: 'Orthogonal',
            sourceID: 'Tasku4sokLHKk2HrSrL',
            sourcePoint: { x: 2430, y: 305 },
            targetPoint: { x: 2550, y: 200 },
            id: 'connectorNgT5p',
            targetID: 'Data_ObjectcZ5fTGKCXTa652oiybxn',
            zIndex: 36,
            style: {
              strokeWidth: 2,
              strokeColor: '#000000',
            ...
            cornerRadius: 0,
            wrapper: {
              actualSize: { width: 120, height: 105 },
              offsetX: 2490,
              offsetY: 252.5,
            },
            fixedUserHandles: [],
          ...
          },
          {
            ...
            type: 'Orthogonal',
            sourceID: 'Data_ObjectZDkTR',
            sourcePoint: { x: 210, y: 400 },
            targetPoint: { x: 350, y: 451 },
            id: 'connectorH70v1',
            targetID: 'Taskn4NDV',
            zIndex: 45,
            style: {
            ...
            cornerRadius: 0,
            wrapper: {
              actualSize: { width: 140, height: 51 },
              offsetX: 280,
              offsetY: 425.5,
            },
            fixedUserHandles: [],
          ...
          },
          {
            ...
            type: 'Orthogonal',
            sourceID: 'TaskP0QPy',
            sourcePoint: { x: 1031, y: 640 },
            targetPoint: { x: 2870, y: 507.4 },
            id: 'connectorDJWT5',
            targetID: 'Gatewayi1iQr',
            zIndex: 54,
            style: {
              strokeWidth: 2,
              strokeColor: '#000000',
            ...
            cornerRadius: 0,
            wrapper: {
              actualSize: { width: 1839, height: 132.60000000000002 },
              offsetX: 1950.5,
              offsetY: 573.7,
            },
            fixedUserHandles: [],
          ...
          },
          {
            shape: { type: 'Bpmn', sequence: 'Normal', flow: 'Sequence' },
            type: 'Orthogonal',
            sourceID: 'Gatewayi1iQr',
            sourcePoint: { x: 2900, y: 480 },
            targetPoint: { x: 3010.14, y: 480 },
            id: 'connectoraasqK',
            targetID: 'End_EventS9ib1QEEfC',
            zIndex: 55,
            style: {
              strokeWidth: 2,
              strokeColor: '#000000',
            ...
            cornerRadius: 0,
            wrapper: {
              actualSize: { width: 110.13999999999987, height: 0 },
              offsetX: 2955.0699999999997,
              offsetY: 480,
            },
            fixedUserHandles: [],
            visible: true,
          ...
          },
          {
            ...
            type: 'Orthogonal',
            sourceID: 'Data_ObjectcZ5fTKOX8B',
            sourcePoint: { x: 960, y: 200 },
            targetPoint: { x: 960, y: 310 },
            id: 'connectorK0AHO',
            targetID: 'TaskeW8VJ',
            zIndex: 60,
          ...
          },
          {
            ...
            type: 'Orthogonal',
            sourceID: 'TaskeW8VJ',
            sourcePoint: { x: 1030, y: 355 },
            targetPoint: { x: 1240, y: 355 },
            id: 'connectorHxn1I',
            targetID: 'TaskqKla4',
            zIndex: 63,
            style: {
          ...
          },
          {
            ...
            type: 'Orthogonal',
            sourceID: 'Data_ObjectcZ5fT',
            sourcePoint: { x: 1130, y: 200 },
            targetPoint: { x: 1310, y: 305 },
            id: 'connectorZNFg8',
            targetID: 'TaskqKla4',
            zIndex: 65,
            style: {
            ...
            cornerRadius: 0,
            wrapper: {
              actualSize: { width: 180, height: 105 },
              offsetX: 1220,
              offsetY: 252.5,
            },
            fixedUserHandles: [],
          ...
          },
          {
            ...
            type: 'Orthogonal',
            sourceID: 'TaskeW8VJ',
            sourcePoint: { x: 960, y: 310 },
            targetPoint: { x: 1130, y: 200 },
            id: 'connectorJdaD6',
            targetID: 'Data_ObjectcZ5fT',
            zIndex: 22,
            style: {
              strokeWidth: 2,
              strokeColor: '#000000',
          ...
          },
          {
            ...
            type: 'Orthogonal',
            sourceID: 'TaskqKla4',
            sourcePoint: { x: 1380, y: 355 },
            targetPoint: { x: 1440, y: 355 },
            id: 'connectorxyoW9',
            targetID: 'TaskqKla4TfIVX',
            zIndex: 69,
            style: {
              strokeWidth: 2,
              strokeColor: '#000000',
          ...
          },
          {
            shape: { type: 'Bpmn', sequence: 'Normal', flow: 'Sequence' },
            type: 'Orthogonal',
            sourceID: 'TaskqKla4TfIVX',
            sourcePoint: { x: 1580, y: 355 },
            targetPoint: { x: 1760.14, y: 355 },
            id: 'connectorlBFvm',
            targetID: 'Intermediate_EventFkC0k',
            zIndex: 71,
            style: {
              strokeWidth: 2,
              strokeColor: '#000000',
            ...
            cornerRadius: 0,
            wrapper: {
              actualSize: { width: 180.1400000000001, height: 0 },
              offsetX: 1670.0700000000002,
              offsetY: 355,
            },
            fixedUserHandles: [],
            visible: true,
          ...
          },
          {
            shape: { type: 'Bpmn', sequence: 'Normal', flow: 'Sequence' },
            type: 'Orthogonal',
            sourceID: 'Intermediate_EventFkC0k',
            sourcePoint: { x: 1809.66, y: 355 },
            targetPoint: { x: 2020, y: 355 },
            id: 'connectorm58Hf',
            targetID: 'TaskqKla4TfIVXw1p5k',
            zIndex: 72,
            style: {
              strokeWidth: 2,
              strokeColor: '#000000',
            ...
            cornerRadius: 0,
            wrapper: {
              actualSize: { width: 210.33999999999992, height: 0 },
              offsetX: 1914.83,
              offsetY: 355,
            },
            fixedUserHandles: [],
          ...
          },
          {
            ...
            type: 'Orthogonal',
            sourceID: 'Intermediate_EventFkC0k',
            sourcePoint: { x: 1785, y: 330.25 },
            targetPoint: { x: 1950, y: 200 },
            id: 'connectorkpMtb',
            targetID: 'Data_ObjectcZ5fTKk3hQ',
            zIndex: 75,
            style: {
              strokeWidth: 2,
              strokeColor: '#000000',
            ...
            cornerRadius: 0,
            wrapper: {
              actualSize: { width: 165, height: 130.25 },
              offsetX: 1867.5,
              offsetY: 265.125,
            },
            fixedUserHandles: [],
          ...
          },
          {
            ...
            type: 'Orthogonal',
            sourceID: 'Data_ObjectcZ5fTKk3hQ',
            sourcePoint: { x: 1950, y: 200 },
            targetPoint: { x: 2090, y: 305 },
            id: 'connectorhsOpM',
            targetID: 'TaskqKla4TfIVXw1p5k',
            zIndex: 76,
            style: {
            ...
            cornerRadius: 0,
            wrapper: {
              actualSize: { width: 140, height: 105 },
              offsetX: 2020,
              offsetY: 252.5,
            },
            fixedUserHandles: [],
          ...
          },
          {
            shape: { type: 'Bpmn', sequence: 'Normal', flow: 'Sequence' },
            type: 'Orthogonal',
            sourceID: 'TaskqKla4TfIVXw1p5k',
            sourcePoint: { x: 2160, y: 355 },
            targetPoint: { x: 2360, y: 355 },
            id: 'connectorkB4mc',
            targetID: 'Tasku4sokLHKk2HrSrL',
            zIndex: 77,
            style: {
              strokeWidth: 2,
              strokeColor: '#000000',
          ...
          },
          {
            ...
            type: 'Orthogonal',
            sourceID: 'Tasku4sokLHKk2HrSrL',
            sourcePoint: { x: 2500, y: 355 },
            targetPoint: { x: 2600, y: 355 },
            id: 'connectorReDDb',
            targetID: 'Tasku4sokLHKk2HrSrLSvLov',
            zIndex: 79,
            style: {
              strokeWidth: 2,
              strokeColor: '#000000',
          ...
          },
          {
            ...
            type: 'Orthogonal',
            sourceID: 'Data_ObjectcZ5fTGKCXTa652oiybxn',
            sourcePoint: { x: 2550, y: 200 },
            targetPoint: { x: 2670, y: 305 },
            id: 'connectoriTJsS',
            targetID: 'Tasku4sokLHKk2HrSrLSvLov',
            zIndex: 80,
            style: {
          ...
          },
          {
            shape: { type: 'Bpmn', sequence: 'Normal', flow: 'Sequence' },
            type: 'Orthogonal',
            sourceID: 'Tasku4sokLHKk2HrSrLSvLov',
            sourcePoint: { x: 2740, y: 355 },
            targetPoint: { x: 2870, y: 452.8 },
            id: 'connectoryEKZw',
            targetID: 'Gatewayi1iQr',
            zIndex: 82,
            style: {
            ...
            cornerRadius: 0,
            wrapper: {
              actualSize: { width: 130, height: 97.80000000000001 },
              offsetX: 2805,
              offsetY: 403.9,
            },
            fixedUserHandles: [],
      ...
      console.log(y);
      expect(
        (element && Number(x) === 10.915472182485976) ||
          Number(y) === 173.44462679296336
      ).toBe(true);
      done();
    });
  });
  ...
  describe('863516-Overview is not synced with diagram content while zoom-out the diagram.', () => {
    ...
    it('Zoom-out diagram and checking the overview rect size', (done: Function) => {
      ...
      diagram.zoomTo(zoomOptions);
      let overviewRect = document.getElementById(
        'overview13_canvasoverviewrect'
      );
  ...
  describe('872140-Dragging HTML nodes in a diagram leaves shadows on the overview', () => {
    ...
    it('Drag the html node in diagram', (done: Function) => {
      ...
      let overview = (document.getElementById('overview14') as any)
        .ej2_instances[0];
      let overviewRect = document.getElementById(
        overview.canvas.id + 'overviewrect'
      );
      ...
      expect(
        x === curX && y === curY && width === curWidth && height === curHeight
      ).toBe(true);
      done();
    });
  });
