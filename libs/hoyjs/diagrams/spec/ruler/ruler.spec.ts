...
describe('Ruler component', () => {
  describe('Testing Ruler Component', () => {
    ...
    it('Checking default Ruler component', (done: Function) => {
      let rulerObj: HTMLElement = document.getElementById(
        ruler.element.id + '_ruler_space'
      );
...
describe('Ruler', () => {
  describe('Testing Ruler', () => {
    ...
    it('Checking default Ruler', (done: Function) => {
      let overlapRuler = document.getElementById(
        diagram.element.id + '_overlapRuler'
      );
    ...
    it('Checking custome Ruler', (done: Function) => {
      ...
      expect(
        overlapRuler !== undefined &&
          hRulerobj !== undefined &&
          vRulerobj !== undefined &&
          hruler.thickness === 30 &&
          vRuler.thickness === 20 &&
          hruler.tickAlignment === 'RightOrBottom' &&
          vRuler.tickAlignment === 'LeftOrTop' &&
          hruler.segmentWidth === 50 &&
          vRuler.segmentWidth === 50 &&
          vRuler.markerColor === 'red' &&
          hruler.markerColor === 'blue'
      ).toBe(true);
      done();
    });
    ...
    it('Checking Ruler zoom', (done: Function) => {
      ...
      diagram.zoom(1.2);
      expect(
        (diagram.scroller.horizontalOffset === -117.5 ||
          diagram.scroller.horizontalOffset === -120) &&
          (diagram.scroller.verticalOffset === -97.5 ||
            diagram.scroller.verticalOffset === -100)
      ).toBe(true);
      diagram.zoom(0.8);
      expect(
        (diagram.scroller.horizontalOffset === 23.5 ||
          diagram.scroller.horizontalOffset === 24) &&
          (diagram.scroller.verticalOffset == 19.5 ||
            diagram.scroller.verticalOffset === 20)
      ).toBe(true);
      diagram.zoom(0.7);
      diagram.zoom(0.33);
      diagram.zoom(6.9);
    ...
    it('Checking without Ruler', (done: Function) => {
      ...
      let hRuler = document.getElementById(diagram.element.id + '_hRuler');
      let vRuler = document.getElementById(diagram.element.id + '_vRuler');
      expect(overlapRuler === null && hRuler === null && vRuler === null).toBe(
        true
      );
      done();
    });
...
describe('Ruler', () => {
  describe('Testing Ruler', () => {
    ...
    it('checking the ruler marker', (done: Function) => {
      ...
      let hMarker = document.getElementById(
        diagram.element.id + '_hRuler_marker'
      );
      let vMarker = document.getElementById(
        diagram.element.id + '_vRuler_marker'
      );
  ...
  describe('Code coverage Ruler update at runtime', () => {
    ...
    it('Updating ruler at runtime', (done: Function) => {
      ...
      diagram.dataBind();
      expect(diagram.rulerSettings.verticalRuler.markerColor === 'yellow').toBe(
        true
      );
      done();
    });
    ...
    it('Apply font style at runtime for connector annotation', (done: Function) => {
      ...
      let textNode2: NodeModel = {
        id: 'text2',
        width: 100,
        height: 50,
        offsetX: 300,
        offsetY: 400,
        shape: { type: 'Text', content: 'textNode2' },
      };
