...
describe('Symbol Palette', () => {
  describe('Testing symbol palette', () => {
    ...
    let bpmnShapes: NodeModel[] = [
      ...
      },
      {
        ...
        shape: {
          ...
          annotation: { angle: 280, length: 150, text: 'textAnnotation4' },
        },
      },
    ];
    ...
    let htmlNodes: NodeModel[] = [
      {
        ...
        shape: {
          type: 'HTML',
          content:
            '<div style="background:red;height:100%;width:100%;"><input type="button" value="{{:value}}" /></div>',
        } as NodeModel,
      },
    ];
      ...
      let nodes: NodeModel[] = [
        ...
        },
        {
          ...
          shape: {
            type: 'Path',
            data:
              'M540.3643,137.9336L546.7973,159.7016L570.3633,159.7296L550.7723,171.9366' +
    ...
    it('Checking default palette rendering', (done: Function) => {
      setTimeout(() => {
        ...
        expect(start.offsetWidth == 284 && start.offsetHeight == 114).toBe(
          true
        );
        done();
      }, 10);
    ...
    it('Checking symbol size', (done: Function) => {
      ...
      setTimeout(() => {
        ...
        let start: HTMLElement = document.getElementById('start');
        expect(start.offsetWidth == 147 && start.offsetHeight == 147).toBe(
          true
        );
        done();
      }, 10);
    ...
    it('Checking connectors', (done: Function) => {
      let decorator =
        palette.symbolTable['connectordec1'].wrapper.children[0].children[0]
          .children[2];
      expect(decorator.offsetX == 71.245 && decorator.offsetY == 71.245).toBe(
        true
      );
      decorator =
        palette.symbolTable['connectordec2'].wrapper.children[0].children[0]
          .children[2];
      expect(
        Math.round(decorator.offsetX) == 69 && decorator.offsetY == 68.5
      ).toBe(true);
      decorator =
        palette.symbolTable['connectordec3'].wrapper.children[0].children[0]
          .children[2];
      expect(
        decorator.offsetX == 69.9966501567237 &&
          decorator.offsetY == 68.92401316056798
      ).toBe(true);
      decorator =
        palette.symbolTable['connectordec1'].wrapper.children[0].children[0]
          .children[0];
      ...
      expect(decorator.offsetX == 36.5 && decorator.offsetY == 36.5).toBe(true);
      decorator =
        palette.symbolTable['link2'].wrapper.children[0].children[0]
          .children[0];
      expect(decorator.offsetX == 36.5 && decorator.offsetY == 36.5).toBe(true);
      done();
    });
    ...
    it('Checking description', (done: Function) => {
      palette.getSymbolInfo = (symbol: Node | Connector): SymbolInfo => {
        if (symbol['text'] !== undefined) {
          return {
            width: 75,
            height: 40,
            description: { text: symbol['text'], overflow: 'Wrap' },
          };
        }
        if (symbol.shape.type === 'Bpmn') {
          return {
            width: 50,
            height: 50,
            description: { text: symbol.shape['shape'] },
          };
        }
        if (
          symbol.id === 'decision' ||
      ...
      setTimeout(() => {
        ...
        let start: HTMLElement = document.getElementById('start');
        expect(start.offsetWidth == 147 && start.offsetHeight == 157).toBe(
          true
        );
        done();
      }, 10);
    ...
    it('Checking dragging connector', (done: Function) => {
      palette.element['ej2_instances'][1]['helper'] = (e: {
        target: HTMLElement;
    ...
    it('checking search palette items length', (done: Function) => {
      ...
      setTimeout(() => {
        ...
        expect(
          document.getElementById('SearchPalette').children.length === 1
        ).toBe(true);
        done();
      }, 500);
    });
    ...
    it('checking search palette with no items', (done: Function) => {
      ...
      setTimeout(() => {
        ...
        expect(
          document.getElementById('SearchPalette').children[0].id == 'EmptyDiv'
        ).toBe(true);
        done();
      }, 500);
    });
    ...
    it('Remove search palette', (done: Function) => {
      palette.enableSearch = false;
      palette.dataBind();
      expect(document.getElementById('symbolpalette_search') === null).toBe(
        true
      );
      done();
    });
    ...
    it('Themes TestCases resize andd rotate', (done: Function) => {
      ...
      expect(
        resizeelemstyle.fill === 'rgb(63, 81, 181)' ||
          resizeelemstyle.fill === 'rgb(227, 22, 91)' ||
          resizeelemstyle.fill === 'rgb(255, 255, 255)'
      ).toBe(true);
    ...
    it('Checking custom size without size using string function', (done: Function) => {
      window['getSymbolInfo'] = function (
        symbol: Node | Connector
      ): SymbolInfo {
        if (symbol.shape.type === 'Bpmn') {
          return { width: 50, height: 50 };
        }
  ...
  describe('Testing symbol palette', () => {
    ...
    beforeAll((): void => {
      ...
      ele.appendChild(
        createElement('div', {
          id: 'symbolpaletteGroupIssue',
          styles: 'width:25%;float:left;',
        })
      );
      ele.appendChild(
        createElement('div', {
          id: 'diagramGroupIssue',
          styles: 'width:74%;height:500px;float:left;',
        })
      );
      document.body.appendChild(ele);
    ...
    it('Checking default palette rendering', (done: Function) => {
      setTimeout(function () {
        ...
        let element = document
          .getElementById('group_container')
          .getBoundingClientRect();
        let targetNode: NodeModel = diagram.nodes[2];
        events.mouseDownEvent(
          palette.element,
          element.left + palette.element.offsetLeft,
          element.top + palette.element.offsetTop,
          false,
          false
        );
        events.mouseMoveEvent(
          palette.element,
          element.left + 40 + palette.element.offsetLeft,
          element.top + palette.element.offsetLeft,
          false,
          false
        );
        events.mouseMoveEvent(
        ...
        events.mouseMoveEvent(
          diagram.element,
          400,
          50 - 5 - diagram.element.offsetTop,
          false,
          false
        );
        events.mouseUpEvent(
          diagram.element,
          400,
          50 - 10 - diagram.element.offsetTop,
          false,
          false
        );
  ...
  describe('Testing Bpmn shape color after changing the event in runtime', () => {
    ...
    beforeAll((): void => {
      ...
      ele.appendChild(
        createElement('div', {
          id: 'diagramBpmnIssue',
          styles: 'width:50%;height:500px;float:left;',
        })
      );
      document.body.appendChild(ele);
      diagram = new Diagram({
    ...
    it('Check Bpmn event shape fill color ', (done: Function) => {
      setTimeout(function () {
        ...
        let events = new MouseEvents();
        let element = document
          .getElementById('BPMNnode1_container')
          .getBoundingClientRect();
        events.mouseDownEvent(
          palette.element,
          element.left + palette.element.offsetLeft,
        ...
        events.mouseMoveEvent(
          diagram.element,
          600,
          100 - 5 - diagram.element.offsetTop,
          false,
          false
        );
        events.mouseUpEvent(
          diagram.element,
          600,
          100 - 10 - diagram.element.offsetTop,
          false,
          false
        );
        events.clickEvent(
  ...
  describe('Adding lane at runtime from palette', () => {
    ...
    let swimlaneShapes: NodeModel[] = [
      {
        ...
        height: 140,
        previewSize: { height: 200, width: 200 },
        dragSize: { height: 200, width: 200 },
        width: 60,
        // style: { fill: '#f5f5f5' },
        offsetX: 300,
        offsetY: 300,
    ...
    it('Checking lanes length after adding it from palette', (done: Function) => {
      setTimeout(function () {
        ...
        let events = new MouseEvents();
        let element = document
          .getElementById('stackCanvas2_container')
          .getBoundingClientRect();
        events.mouseDownEvent(
          palette.element,
          element.left + palette.element.offsetLeft,
        ...
        events.mouseMoveEvent(
          diagram.element,
          250,
          270 - 5 - diagram.element.offsetTop,
          false,
          false
        );
        events.mouseUpEvent(
          diagram.element,
          250,
          270 - 10 - diagram.element.offsetTop,
          false,
          false
        );
        events.clickEvent(
  ...
  describe('Testing symbol palette with connector source and target point as same', () => {
    ...
    it('Check connector rendering in the palette', (done: Function) => {
      setTimeout(function () {
        ...
        let events = new MouseEvents();
        let element = document
          .getElementById('Link1_container')
          .getBoundingClientRect();
        events.mouseDownEvent(
          palette.element,
          element.left + palette.element.offsetLeft,
  ...
  describe('Testing symbol palette drag stop on escape', () => {
    ...
    beforeAll((): void => {
      ...
      ele.appendChild(
        createElement('div', {
          id: 'symbolPaletteEscape',
          styles: 'width:25%;height:500px;float:left;',
        })
      );
      ele.appendChild(
        createElement('div', {
    ...
    it('Checking Esc key pressing inside symbol palette', (done: Function) => {
      ...
      diagram.drop = (arg) => {
        expect((arg.element as NodeModel).id === diagram.currentSymbol.id).toBe(
          true
        );
        done();
      };
  ...
  describe('Node default connector default test cases', () => {
    ...
    beforeAll((): void => {
      ...
      palette = new SymbolPalette({
        ...
        nodeDefaults: {
          width: 200,
          ports: [
            { style: { fill: 'gray' }, constraints: PortConstraints.Drag },
          ],
          height: 200,
          style: { fill: 'red' },
          annotations: [{ content: 'ss', style: { fill: 'red' } }],
        },
        symbolMargin: { left: 12, right: 12, top: 12, bottom: 12 },
        getSymbolInfo: (symbol: NodeModel): SymbolInfo => {
          return { fit: true };
    ...
    it('Node default connector default test cases', (done: Function) => {
      ...
      expect(
        (palette.palettes[0].symbols[0].wrapper.children[0] as any).children[0]
          .style.strokeWidth === 2 &&
          (palette.palettes[0].symbols[0].wrapper.children[0] as any)
            .children[0].style.fill === 'red' &&
          (palette.palettes[1].symbols[0].wrapper.children[0] as any)
            .children[0].children[0].style.strokeColor === 'red' &&
          (palette.palettes[1].symbols[0].wrapper.children[0] as any)
            .children[0].children[2].style.fill === 'blue'
      ).toBe(true);
      shape = {
        id: 'newflow' + randomId(),
        shape: { type: 'Flow', shape: 'Process' },
      ...
      palette.dataBind();
      expect(
        (palette.palettes[0].symbols[1].wrapper.children[0] as any).children[0]
          .style.fill === 'red' &&
          (palette.palettes[0].symbols[2].wrapper.children[0] as any)
            .children[0].children[0].style.strokeColor === 'red'
      ).toBe(true);
      done();
    });
  ...
  describe('Adding groupnode into palette', () => {
    ...
    it('Adding group node into palette test cases', (done: Function) => {
      ...
      groupnode();
      expect(document.getElementById('basic').childNodes.length == 1).toBe(
        true
      );
      done();
    });
...
describe('Mouse cursor inside the preview shape', () => {
  ...
  it('Mouse cursor inside the preview shape- with palette and shape preview size', (done: Function) => {
    setTimeout(function () {
      ...
      events.mouseUpEvent(
        diagramCanvas,
        300 + diagram.element.offsetLeft,
        300 + diagram.element.offsetTop,
        false,
        false
      );
      diagram.undo();
      ...
      events.mouseMoveEvent(
        diagramCanvas,
        200 + diagram.element.offsetLeft,
      ...
      events.mouseMoveEvent(
        diagramCanvas,
        250 + diagram.element.offsetLeft,
        250 + diagram.element.offsetTop,
        false,
        false
      );
      events.mouseMoveEvent(
  ...
  it('Mouse cursor inside the preview shape- with palette preview size alone', (done: Function) => {
    setTimeout(function () {
      ...
      // expect(diagram.nodes[0].offsetY === 356).toBe(true);
      diagram.undo();
      palette.symbolPreview.width = 200;
      palette.symbolPreview.height = 200;
    ...
    palette = new SymbolPalette({
      ...
      getSymbolInfo: (symbol: NodeModel | ConnectorModel): SymbolInfo => {
        return {
          fit: true,
          description: {
            text: (symbol.addInfo as any).text,
            color: 'black',
            fill: 'yellow',
            fontFamily: 'Calibri',
            fontSize: 5,
...
describe('Add and Remove palette', () => {
  ...
  beforeAll((): void => {
    ...
    function setPaletteConnectorDefaults(
...
describe('892454: Check BPMN Activity shapes Fill color for smaller size ', () => {
  ...
  it('Checking BPMN Activity shapes fill color applied properly', (done: Function) => {
    expect(
      (palette.palettes[0].symbols[0].wrapper.children[0] as any).children[0]
        .children[0].children[0].style.fill == 'red'
    ).toBe(true);
    done();
  });
});
