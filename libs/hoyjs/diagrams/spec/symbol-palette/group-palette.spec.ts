...
import { SymbolInfo, SymbolPalette } from '../../src/symbol-palette/index';
  ...
  describe('Testing symbol palette with group Symbols', () => {
    ...
    beforeAll((): void => {
      ...
      ele.appendChild(
        createElement('div', {
          id: 'symbolPalette',
          styles: 'width:250px;height:550px;float:left;',
        })
      );
      ele.appendChild(
        createElement('div', {
          id: 'diagram',
          styles: 'width:500px;height:550px;float:right;',
        })
      );
    ...
    it('Remove Palette Item', (done: Function) => {
      ...
      palette.removePaletteItem(
        'basic',
        cpalette.symbols[cpalette.symbols.length - 1].id
      );
      palette.dataBind();
  ...
  describe('873843-Issue with node height and width in the symbol palette', () => {
    ...
    it('Checking bpmn event shape size ', (done: Function) => {
      let element = document
        .getElementById('Event_container')
