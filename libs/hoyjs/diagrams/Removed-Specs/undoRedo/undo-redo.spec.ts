...
//             diagram.redo();
//             expect(diagram.nodes[0].rotateAngle == 318.2572219406669).toBe(true);
//             done();
//         });
//     });
...
//             diagram.redo();
//             expect(diagram.selectedItems.width == 250 && diagram.selectedItems.height == 300 &&
//                 diagram.selectedItems.offsetX == 375 && diagram.selectedItems.offsetY == 400).toBe(true);
//             done();
//         });
//     });
