...
//             diagram.clearSelectorLayer();
//             expect(diagram.connectors[1].targetID === '').toBe(false);
//             done();
...
//             expect(diagram.selectedItems.connectors[0].wrapper.width === 45 && diagram.selectedItems.connectors[0].wrapper.height === 90).toBe(false);
//             done();
//         });
...
//             expect(diagram.selectedItems.connectors[0].wrapper.width === 25 && diagram.selectedItems.connectors[0].wrapper.height === 2).toBe(true);
//             done();
//         });
...
//             expect(diagram.selectedItems.connectors[0].wrapper.width === 50 && diagram.selectedItems.connectors[0].wrapper.height === 0).toBe(false);
//             done();
//         });
