 ...
 */
import { Ajax, isRippleEnabled, enableRipple, rippleEffect } from '@hoyui/base';
...
import { cldrData, loadCldr, Touch, SwipeEventArgs } from '@hoyui/base';
import {
  createElement,
  removeClass,
  remove,
...
import { Animation, AnimationOptions, Effect } from '@hoyui/base';
import { calculatePosition } from '@hoyui/popups';
import { getFieldValues } from '@hoyui/lists';
...
describe('Calendar', () => {
  ...
  describe('Calendar', () => {
    ...
    describe('Daycell ', () => {
      ...
      afterEach(() => {
        if (calendar) {
          calendar.destroy();
          expect(
            document.getElementById('calendar').classList.contains('e-control')
          ).toBe(false);
          expect(
            document.getElementById('calendar').classList.contains('e-calendar')
          ).toBe(false);
          expect(
            document.getElementById('calendar').getAttribute('class')
          ).toBe('');
      ...
      it(' other month element count test case', () => {
        expect(
          cal.tableBodyElement.querySelectorAll('tr td.e-other-month').length
        ).toBe(14);
      });
      it('element count for the month (February 2017) test case', () => {
        expect(
          cal.tableBodyElement.querySelectorAll('tr td:not(.e-other-month)')
            .length
        ).toBe(28);
      });
      ...
      it(' cell value test case ', () => {
        ...
        expect(
          getIdValue(
            cal.tableBodyElement.querySelectorAll(
              'tr td:not(.e-other-month)'
            )[0]
          )
        ).toBe(new Date('3/1/2016').valueOf());
      });
      ...
      it(' last date in a last row of calendar for the month (March)  test case ', () => {
        ...
        ).toBe(new Date('3/31/2016').valueOf());
      });
      it(' first date in a first row of calendar for the month (April) test case ', () => {
        ...
        ).toBe(new Date('4/1/2016').valueOf());
      });
      it('   last date in a last row of calendar for the month (March) test case ', () => {
        cal = new Calendar({ value: new Date('4/3/2016') });
        cal.appendTo('#calendar');
        ...
        ).toBe(new Date('4/30/2016').valueOf());
      });
    });
    describe('Element render', () => {
      ...
      it('Jan month element test case ', () => {
        Cal = new Calendar({
          min: new Date('1/2/2016'),
          max: new Date('1/31/2016'),
        });
        Cal.appendTo('#calendar');
        let tds: any = document.querySelectorAll('.e-cell:not(.e-disabled)');
        expect(
          document.querySelectorAll('.e-cell:not(.e-disabled)')[0].children[0]
            .textContent
        ).toBe('2');
        expect(
          document.querySelectorAll('.e-cell:not(.e-disabled)')[tds.length - 1]
            .children[0].textContent
        ).toBe('31');
      });
      it(' Feb month element in leap year test case', () => {
        Cal = new Calendar({
          min: new Date('2/2/2016'),
          max: new Date('2/29/2016'),
        });
        Cal.appendTo('#calendar');
        let tds: any = document.querySelectorAll('.e-cell:not(.e-disabled)');
        expect(
      ...
      it(' March month element test case', () => {
        Cal = new Calendar({
          min: new Date('3/2/2016'),
          max: new Date('3/31/2016'),
        });
        Cal.appendTo('#calendar');
        let tds: any = document.querySelectorAll('.e-cell:not(.e-disabled)');
        expect(
      ...
      it(' April month element test case', () => {
        Cal = new Calendar({
          min: new Date('4/2/2016'),
          max: new Date('4/30/2016'),
        });
        Cal.appendTo('#calendar');
        let tds: any = document.querySelectorAll('.e-cell:not(.e-disabled)');
        expect(
      ...
      it(' May month element test case', () => {
        Cal = new Calendar({
          min: new Date('5/2/2016'),
          max: new Date('5/31/2016'),
        });
        Cal.appendTo('#calendar');
        let tds: any = document.querySelectorAll('.e-cell:not(.e-disabled)');
        expect(
      ...
      it(' June month element test case', () => {
        Cal = new Calendar({
          min: new Date('6/2/2016'),
          max: new Date('6/30/2016'),
        });
        Cal.appendTo('#calendar');
        let tds: any = document.querySelectorAll('.e-cell:not(.e-disabled)');
        expect(
      ...
      it(' July month element test case', () => {
        Cal = new Calendar({
          min: new Date('7/2/2016'),
          max: new Date('7/31/2016'),
        });
        Cal.appendTo('#calendar');
        let tds: any = document.querySelectorAll('.e-cell:not(.e-disabled)');
        expect(
      ...
      it(' Auguest  month element test case', () => {
        Cal = new Calendar({
          min: new Date('8/2/2016'),
          max: new Date('8/31/2016'),
        });
        Cal.appendTo('#calendar');
        let tds: any = document.querySelectorAll('.e-cell:not(.e-disabled)');
        expect(
      ...
      it(' September  month element test case', () => {
        Cal = new Calendar({
          min: new Date('9/2/2016'),
          max: new Date('9/30/2016'),
        });
        Cal.appendTo('#calendar');
        let tds: any = document.querySelectorAll('.e-cell:not(.e-disabled)');
        expect(
      ...
      it(' October  month element test case', () => {
        Cal = new Calendar({
          min: new Date('10/2/2016'),
          max: new Date('10/31/2016'),
        });
        Cal.appendTo('#calendar');
        let tds: any = document.querySelectorAll('.e-cell:not(.e-disabled)');
        expect(
      ...
      it(' November  month element test case', () => {
        Cal = new Calendar({
          min: new Date('11/2/2016'),
          max: new Date('11/30/2016'),
        });
        Cal.appendTo('#calendar');
        let tds: any = document.querySelectorAll('.e-cell:not(.e-disabled)');
        expect(
      ...
      it(' December  month element test case', () => {
        Cal = new Calendar({
          min: new Date('12/2/2016'),
          max: new Date('12/31/2016'),
        });
        Cal.appendTo('#calendar');
        let tds: any = document.querySelectorAll('.e-cell:not(.e-disabled)');
        expect(
      ...
      it('Weeknumber with e-month-hide  class test case', () => {
        ...
        Cal.appendTo('#calendar');
        expect(
          Cal.tableBodyElement.firstElementChild.classList.contains(
            'e-month-hide'
          )
        ).toBe(true);
      });
    ...
    describe('DOM ', () => {
      ...
      it(' header element icon container class testing ', () => {
        ...
        expect(
          document
            ...
            .querySelector(
              '.e-header .e-icon-container .e-prev .e-date-icon-prev'
            )
            .classList.contains('e-date-icon-prev')
        ).toBe(true);
      });
      it(' header next span element  testing ', () => {
        ...
        expect(
          document
            .getElementById('calendar')
            .querySelector('.e-header .e-icon-container')
            .classList.contains('e-icon-container')
        ).toBe(true);
      });
      it(' header  span element e-date-icon-next class testing ', () => {
        ...
        expect(
          document
            .getElementById('calendar')
            .querySelector(
              '.e-header .e-icon-container .e-next .e-date-icon-next'
            )
            .classList.contains('e-date-icon-next')
        ).toBe(true);
      });
      it(' week-header element  testing ', () => {
        ...
        Cal.appendTo('#calendar');
        expect(
          document.getElementById('calendar').getElementsByTagName('tr')[0]
      ...
      it(' tr element count  testing ', () => {
        ...
        Cal.appendTo('#calendar');
        expect(
          document.getElementById('calendar').getElementsByTagName('tr').length
        ).toBe(7);
      });
      it(' tr element count testing ', () => {
        Cal = new Calendar({ value: new Date('4/4/2017') });
      ...
      it('year view textContent test case', () => {
        ...
        Cal.appendTo('#calendar');
        expect(
          Cal.tableBodyElement.querySelector('tr td span').textContent
        ).toBe('Jan');
      });
      ...
      it(' week number  "e-week-number" class test case   ', () => {
        ...
        Cal.appendTo('#calendar');
        expect(
          Cal.tableBodyElement.children[0].children[0].classList.contains(
            'e-week-number'
          )
        ).toBe(true);
      });
      it('calendar  start week number test case   ', () => {
        ...
        Cal.appendTo('#calendar');
        expect(
          Cal.tableBodyElement.querySelectorAll('tr .e-week-number')[0]
            .textContent
        ).toBe('' + Cal.getWeek(new Date('1/29/2017')));
      });
      it('  calendar last month week number test case   ', () => {
        Cal = new Calendar({ weekNumber: true, value: new Date('2/2/2015') });
        Cal.appendTo('#calendar');
        expect(
          Cal.tableBodyElement.querySelectorAll('tr .e-week-number')[5]
            .textContent
        ).toBe('' + Cal.getWeek(new Date('3/10/2017')));
      });
      it('calendar e-today class test case ', () => {
        Cal = new Calendar({ value: new Date() });
        Cal.appendTo('#calendar');
        expect(document.querySelectorAll('.e-today span')[0].textContent).toBe(
          '' + new Date().getDate()
        );
      });
    });
    describe('Property', () => {
      ...
      it('  selected date with previous and next icon navigation test case in month view ', () => {
        ...
        (<HTMLElement>(
          document.getElementsByClassName('e-date-icon-next')[0]
        )).click();
        (<HTMLElement>(
          document.getElementsByClassName('e-date-icon-prev')[0]
        )).click();
        expect(
          new Date(
            getIdValue(
              calendar.tableBodyElement.querySelector('tr td.e-selected')
            )
          ).toDateString()
      ...
      it(' selected date with previous and next icon navigation test case in year view ', () => {
        ...
        ).toBe(new Date(new Date().setDate(1)).toDateString());
        expect(calendar.value.toDateString()).toBe(new Date().toDateString());
      });
      it('  selected date with previous and next icon navigation test case in decade view ', () => {
        ...
        ).toBe(new Date(dateMon).toDateString());
        expect(calendar.value.toDateString()).toBe(new Date().toDateString());
      });
      ...
      it('selected date with other year navigation in Decade view test case', () => {
        ...
        (<HTMLElement>(
          document.getElementsByClassName('e-other-year')[0]
        )).click();
      ...
      it(' value with out of min range  test  case', () => {
        ...
        ).toBe(new Date(1900, 0, 1).valueOf());
      ...
      it(' value with out of max range  test  case', () => {
        ...
        ).toBe(new Date(2099, 11, 31).valueOf());
      ...
      it(' value test case', () => {
        ...
        expect(calendar.value.valueOf()).toBe(
          dateObjToNum(new Date('2/2/2017'))
        );
      });
      ...
      it('value with min setmodel test case  ', () => {
        ...
        calendar.dataBind();
        expect(calendar.value.valueOf()).toBe(
          dateObjToNum(new Date('3/3/2017'))
        );
        calendar.min = new Date('3/4/2017');
        calendar.dataBind();
        expect(calendar.min.valueOf()).toBe(dateObjToNum(new Date('3/4/2017')));
        expect(calendar.value.valueOf()).toBe(
          dateObjToNum(new Date('3/4/2017'))
        );
        expect(
          getIdValue(
            calendar.tableBodyElement.querySelector('tr td.e-selected')
          )
        ).toBe(dateObjToNum(new Date('3/4/2017')));
      });
      it('value with max setmodel test case  ', () => {
        ...
        ).toBe(new Date('3/2/2017').valueOf());
      });
      it(' value with null type test case', () => {
        calendar = new Calendar({});
        calendar.appendTo('#calendar');
      ...
      it('Tab index checking while destroy the component', () => {
        let inputEle: HTMLElement = createElement('div', {
          id: 'calendar',
          attrs: { tabindex: '1' },
        });
      ...
      it('min and max  with undefined type test case', () => {
        ...
        calendar.appendTo('#calendar');
        expect(!calendar.previousIcon.classList.contains('e-disabled')).toBe(
          true
        );
      ...
      it(' value with decade  view  test case', () => {
        ...
        ).toBe(new Date('1/1/2018').valueOf());
      ...
      it('  month view  test case', () => {
        ...
        calendar.appendTo('#calendar');
        expect(calendar.contentElement.classList.contains('e-month')).toBe(
          true
        );
      });
      ...
      it('decade view  test case', () => {
        ...
        calendar.appendTo('#calendar');
        expect(calendar.contentElement.classList.contains('e-decade')).toBe(
          true
        );
      });
      it('  month view  test case', () => {
      ...
      it('min and max with  invalid value property test case', () => {
        ...
        expect(calendar.nextIcon.classList.contains('e-disabled')).toBe(true);
        expect(
          calendar.tableBodyElement
            .querySelector('tr td.e-selected')
      ...
      it('focused date with value test  case', () => {
        ...
        expect(
          getIdValue(
            calendar.tableBodyElement.querySelector('tr td.e-focused-date')
          )
        ).toBe(new Date('2/1/2017').valueOf());
        ...
        expect(dateObjToNum(calendar.value)).toBe(
          new Date('1/1/2017').valueOf()
        );
      });
      ...
      it(' min date as focused date case', () => {
        ...
        ).toBe(new Date('1/30/2017').valueOf());
        expect(dateObjToNum(calendar.min)).toBe(
          new Date('1/30/2017').valueOf()
        );
      ...
      it('destroy method test  case', () => {
        ...
        calendar.dataBind();
        expect(
          (<any>document.getElementById('calendar')).ej2_instances[0]
        ).toBe(undefined);
      ...
      it('value with min test  case', () => {
        ...
        calendar.appendTo('#calendar');
        expect(
          calendar.tableBodyElement.querySelectorAll('tr td.e-focused-date')
            .length
        ).toBe(1);
        calendar.navigateTo('Month', new Date('2/2/2017'));
        expect(
      ...
      it('focused date as min date test case', () => {
        ...
        ).toBe(dateValue('2/1/2017'));
        calendar.navigateTo('Month', new Date('4/10/2017'));
        expect(
          getIdValue(
            calendar.tableBodyElement.querySelector('tr td.e-focused-date')
          )
        ).toBe(dateValue('3/10/2017'));
        expect(calendar.value.valueOf()).toBe(new Date('2/1/2017').valueOf());
      });
      ...
      it(' firstDayOfWeek based on the culture "ar" test case', () => {
        ...
        expect(parseInt(instance[0].id, 0)).toBe(
          new Date('1/29/2017').valueOf()
        );
      });
      ...
      it(' firstDayOfWeek with 0 test case', () => {
        ...
        let instance = calendar.tableBodyElement.querySelectorAll('tr td');
        expect(parseInt(instance[instance.length - 1].id, 0)).toBe(
          new Date('3/11/2017').valueOf()
        );
      });
      ...
      it(' firstDayOfWeek with value 3 test case', () => {
        ...
        let instance = calendar.tableBodyElement.querySelectorAll('tr td');
        expect(parseInt(instance[0].id, 0)).toBe(
          new Date('1/25/2017').valueOf()
        );
        expect(parseInt(instance[instance.length - 1].id, 0)).toBe(
          new Date('3/7/2017').valueOf()
        );
      });
      it(' firstDayOfWeek with value 4 test case', () => {
        ...
        let instance = calendar.tableBodyElement.querySelectorAll('tr td');
        expect(parseInt(instance[0].id, 0)).toBe(
          new Date('1/26/2017').valueOf()
        );
        expect(parseInt(instance[instance.length - 1].id, 0)).toBe(
          new Date('3/8/2017').valueOf()
        );
      });
      it(' firstDayOfWeek with value 5  test case', () => {
        ...
        let instance = calendar.tableBodyElement.querySelectorAll('tr td');
        expect(parseInt(instance[0].id, 0)).toBe(
          new Date('1/27/2017').valueOf()
        );
        expect(parseInt(instance[instance.length - 1].id, 0)).toBe(
          new Date('3/9/2017').valueOf()
        );
      });
      it(' firstDayOfWeek with value 6 test case', () => {
        ...
        let instance = calendar.tableBodyElement.querySelectorAll('tr td');
        expect(parseInt(instance[0].id, 0)).toBe(
          new Date('1/28/2017').valueOf()
        );
        expect(parseInt(instance[instance.length - 1].id, 0)).toBe(
          new Date('3/10/2017').valueOf()
        );
      });
      it(' firstDayOfWeek with value 1 test case', () => {
        calendar = new Calendar({
      ...
      it(' enableRtl with true test case', () => {
        ...
        calendar.appendTo('#calendar');
        expect(
          document.getElementById('calendar').classList.contains('e-rtl')
        ).toEqual(true);
      });
      ...
      it(' Without value property  in year view test case', function () {
        ...
        expect(calendar.currentView()).toBe('Year');
        expect(
          document.getElementById('calendar').querySelectorAll('tr td span')[0]
            .textContent
        ).toBe('Jan');
        expect(
          document.getElementById('calendar').querySelectorAll('tr td span')[11]
            .textContent
        ).toBe('Dec');
      });
      ...
      it('maximum value in year view test case', function () {
        ...
        expect(calendar.value.toDateString()).toBe(
          new Date('1/30/2017').toDateString()
        );
        let clickEvent: MouseEvent = document.createEvent('MouseEvents');
        clickEvent.initEvent('mousedown', true, true);
        calendar.tableBodyElement.querySelectorAll('tr td')[1].click();
        expect(calendar.value.toDateString()).toBe(
          new Date('2/28/2017').toDateString()
        );
      });
      it(' min, max and value in year view test case', function () {
        calendar = new Calendar({
          ...
          min: new Date('5/1/2017'),
          max: new Date('5/10/2017'),
        });
        calendar.appendTo('#calendar');
        expect(calendar.contentElement.classList.contains('e-year')).toBe(true);
        expect(calendar.currentView()).toBe('Year');
        ...
        expect(calendar.value.toDateString()).toBe(
          new Date('5/5/2017').toDateString()
        );
      });
      it('min, max property with value minimum than min in year view test case', function () {
        ...
        calendar = new Calendar({
          start: 'Year',
          depth: 'Year',
          value: new Date('5/1/2017'),
          min: new Date('5/3/2017'),
          max: new Date('5/10/2017'),
        });
        calendar.appendTo('#calendar');
        expect(calendar.contentElement.classList.contains('e-year')).toBe(true);
        ...
        expect(calendar.value.toDateString()).toBe(
          new Date('5/3/2017').toDateString()
        );
      });
      ...
      it(' value property  in decade view test case', function () {
        ...
        expect(calendar.value.toDateString()).toBe(
          new Date('3/3/2017').toDateString()
        );
      });
      it('maximum value in decade view test case', function () {
        ...
        calendar.tableBodyElement.querySelectorAll('tr td')[1].click();
        expect(calendar.value.toDateString()).toBe(
          new Date('1/30/2010').toDateString()
        );
      });
      ...
      it('enabled test case ', function () {
        ...
        expect(
          document.getElementById('calendar').classList.contains('e-disabled')
        ).toBe(true);
      ...
      it('cssClass test case ', function () {
        ...
        expect(
          document.getElementById('calendar').classList.contains('e-testClass')
        ).toBe(true);
      });
      ...
      it(' start with  "Month" test case', function () {
        ...
        expect(document.querySelector('.e-title').textContent).toBe(
          'March 2017'
        );
        expect(calendar.currentView()).toBe('Month');
      });
      ...
      it(' start value higher than decade value test case', function () {
        ...
        mouseEventArgs.currentTarget =
          calendar.tableBodyElement.querySelectorAll('tr td')[1];
      ...
      it('min and max with value higher during intialization test case', function () {
        calendar = new Calendar({
          min: new Date('5/5/2017'),
          max: new Date('6/6/2017'),
          value: new Date('7/7/2017'),
        });
        calendar.appendTo('#calendar');
        ...
        ).toBe(new Date('6/6/2017').valueOf());
      });
      it('min and max with value higher than the min test case', function () {
        ...
        ).toBe(new Date('5/5/2017').valueOf());
      });
      ...
      it('value with invalid min and max contradiction date test case', function () {
        calendar = new Calendar({
          min: new Date('6/6/2017'),
          max: new Date('5/5/2017'),
          value: new Date('3/7/2017'),
        });
        calendar.appendTo('#calendar');
    ...
    describe('Header Format testing at initial rendering', () => {
      ...
      it('Header short format testing', () => {
        ...
        expect(
          Cal.element.classList.contains('e-calendar-day-header-lg')
        ).not.toBe(true);
      });
      ...
      it('Header abbreviated format testing', () => {
        ...
        Cal.appendTo('#calendar');
        Cal.getCultureValues();
        expect(Cal.tableHeadElement.querySelector('th').textContent).toBe(
          'Sun'
        );
        expect(
          Cal.element.classList.contains('e-calendar-day-header-lg')
      ...
      it('Header wide format testing', () => {
        ...
        expect(Cal.element.classList.contains('e-calendar-day-header-lg')).toBe(
          true
        );
      });
    });
    ...
    describe(' notify property changes of', () => {
      ...
      it(' value test case', () => {
        ...
        ).toBe(new Date('1/10/2017').valueOf());
        expect(calendar.value.valueOf()).toBe(new Date('1/10/2017').valueOf());
        ...
        ).toBe(new Date('1/12/2017').valueOf());
      ...
      it(' min  and max test case', () => {
        ...
        expect(calendar.max.valueOf()).toBe(new Date('2/2/2017').valueOf());
        mouseEventArgs.currentTarget =
          calendar.tableBodyElement.querySelectorAll('tr td')[8];
        expect(
          getIdValue(
            calendar.tableBodyElement.querySelector('tr td.e-selected')
          )
      ...
      it(' value test case', () => {
        ...
        expect(
          !calendar.nextIcon.children[0].classList.contains('e-disabled')
        ).toBe(true);
        expect(calendar.value.valueOf()).toBe(new Date('1/1/2017').valueOf());
        expect(
          getIdValue(
        ...
        ).toBe(new Date('12/1/2016').valueOf());
        mouseEventArgs.target = calendar.previousIcon;
        calendar.navigatePrevious(mouseEventArgs);
      });
      ...
      it(' week weekNumber test case', () => {
        ...
        calendar.dataBind();
        expect(calendar.tableBodyElement.querySelectorAll('tr td').length).toBe(
          48
        );
        expect(calendar.tableHeadElement.querySelectorAll('th').length).toBe(8);
        expect(
          calendar.tableBodyElement.querySelector('tr td.e-week-number')
            .textContent
        ).toBe('9');
        calendar.appendTo('#calendar');
        ...
        expect(
          calendar.tableHeadElement.querySelectorAll('th.e-week-number').length
        ).toBe(0);
        expect(
          !calendar.tableHeadElement.querySelectorAll('th.e-week-number')
        ).toBe(false);
      });
      ...
      it('multiple cssClass  test case', () => {
        ...
        calendar.appendTo('#calendar');
        expect(
          document.getElementById('calendar').classList.contains('e-custom')
        ).toBe(true);
        expect(
          document
            .getElementById('calendar')
            .classList.contains('e-secondary-class')
        ).toBe(true);
        ...
        expect(
          document.getElementById('calendar').classList.contains('e-ternary')
        ).toBe(true);
        expect(
          document.getElementById('calendar').classList.contains('e-cssClass')
        ).toBe(true);
      });
      ...
      it('cssClass property dynamic test case', () => {
        ...
        expect(
          document
            .getElementById('calendar')
            .classList.contains('e-testSecondClass')
        ).toBe(true);
      });
    });
    describe('events', () => {
      ...
      it(' min and max  with current date  test case ', () => {
        cal = new Calendar({
          min: new Date('3/4/2018'),
          max: new Date('4/4/2018'),
        });
        cal.appendTo('#calendar');
      ...
      it('focused date with next icon click test case   ', () => {
        ...
        expect(cal.tableBodyElement.querySelector('tr td.e-focused-date')).toBe(
          null
        );
      });
      it('focused date with min and max test case  ', () => {
        ...
        expect(
          getIdValue(cal.tableBodyElement.querySelector('tr td.e-focused-date'))
        ).toBe(dateValue('2/3/2017'));
        mouseEventArgs.target = cal.previousIcon;
        cal.navigatePrevious(mouseEventArgs);
        expect(
          getIdValue(cal.tableBodyElement.querySelector('tr td.e-focused-date'))
        ).toBe(dateValue('1/10/2017'));
      });
      ...
      it('other month element(td) clik  test case ', () => {
        cal = new Calendar({
          value: new Date('3/29/2017'),
          start: 'Year',
        });
        cal.appendTo('#calendar');
        mouseEventArgs.currentTarget =
          cal.tableBodyElement.querySelectorAll('tr td')[1];
    ...
    describe('methods', () => {
      ...
      it('navigate to month  view test case ', () => {
        ...
        ).toBe(new Date('10/2/2017').valueOf());
        expect(calendar.currentView()).toBe('Month');
      });
      it('navigate to year view from month test case ', () => {
        ...
        ).toBe(new Date('10/1/2016').valueOf());
        expect(calendar.currentView()).toBe('Year');
      });
      it('navigate to year view from month test case ', () => {
    ...
    describe(' event argument', () => {
      ...
      describe('Keyboard interaction ', () => {
        ...
        it('keyConfigs as null test case', () => {
          ...
          calendar.keyActionHandle(keyEventArgs);
          expect(document.querySelector('.e-focused-date').textContent).toBe(
            'Jan'
          );
        ...
        it(' up arrow with min and max  on month view test case ', () => {
          ...
          calendar.appendTo('#calendar');
          keyEventArgs.target = document.querySelector(
        ...
        it('keyboard focused date on year view test case ', () => {
          ...
          calendar.appendTo('#calendar');
          (<HTMLElement>(
            calendar.tableBodyElement.querySelectorAll('tr td')[10]
          )).click();
          keyEventArgs.target = document.querySelector(
            '.e-calendar-content-table'
          ) as HTMLElement;
        ...
        it(' enter key on  month view of slected element test case ', () => {
          calendar = new Calendar({
            start: 'Month',
            value: new Date('3/2/2017'),
            min: new Date('3/1/2017'),
            max: new Date('3/2/2017'),
          });
          calendar.appendTo('#calendar');
          expect(
            calendar.tableBodyElement.querySelector('tr td.e-selected')
    ...
    describe('Class name', () => {
      ...
      it('e-day test case', () => {
        ...
        expect(
          document
            .querySelectorAll('.e-content table tbody tr td span.e-day')[0]
            .classList.contains('e-day')
        ).toBe(true);
      });
      /**
      ...
      it('e-focused-date test case', () => {
        ...
        expect(
          document
            .querySelectorAll('.e-content table tbody tr td.e-selected')[0]
            .classList.contains('e-selected')
        ).toBe(true);
        keyEventArgs.target = document.querySelector(
          '.e-calendar-content-table'
        ...
        ).toBe(new Date('4/5/2017').toDateString());
      });
      /**
      ...
      it('e-ripple test case', () => {
        ...
        expect(
          document
            .querySelector('.e-content table tbody tr td span.e-day')
            .getAttribute('data-ripple')
        ).toBe('true');
        expect(
          document
            .querySelectorAll('.e-content table tbody tr td span.e-day')[0]
    ...
    describe('testing issue', () => {
      ...
      it(' EJ2-1535 selected value is not maintained properly in year view using keyboard ', () => {
        ...
        ).toBe(new Date('4/1/2017').valueOf());
        expect(
          getIdValue(
            calendar.tableBodyElement.querySelector('tr td.e-focused-date')
          )
        ).toBe(new Date('3/1/2017').valueOf());
      });
    });
    describe('Date with time options', () => {
      ...
      it('value with time', () => {
        ...
        expect(calendarObj.value.toLocaleString()).toBe(
          new Date('4/4/2017 4:00 AM').toLocaleString()
        );
      });
      ...
      it('min value with time (error case)', () => {
        calendarObj = new Calendar({
          value: new Date('11/1/2017 14:00'),
          min: new Date('11/1/2017 16:00'),
        });
        calendarObj.appendTo('#calendar');
        expect(calendarObj.value.valueOf()).toBe(
          new Date('11/1/2017 16:00').valueOf()
        );
      });
      it('min value with time (lesser than current time)', () => {
        calendarObj = new Calendar({
          value: new Date('11/3/2017 14:00'),
          min: new Date('11/1/2017 16:00'),
        });
        calendarObj.appendTo('#calendar');
        (<HTMLElement>(
          calendarObj.tableBodyElement.querySelectorAll('tr td')[3]
        )).click();
        expect(calendarObj.value.valueOf()).toBe(
          new Date('11/1/2017 16:00').valueOf()
        );
      ...
      it('max value with time (greater than current time)', () => {
        calendarObj = new Calendar({
          value: new Date('11/3/2017 23:00'),
          max: new Date('11/5/2017 16:00'),
        });
        calendarObj.appendTo('#calendar');
        (<HTMLElement>(
          calendarObj.tableBodyElement.querySelectorAll('tr td')[7]
        )).click();
        expect(calendarObj.value.valueOf()).toBe(
          new Date('11/5/2017 16:00').valueOf()
        );
      });
    });
    describe('today button property', () => {
      ...
      it('min value with today button', () => {
        ...
        calendarObj = new Calendar({
          value: new Date(),
          min: new Date(currentDate.toDateString()),
        });
        calendarObj.appendTo('#calendar');
        expect(
          calendarObj.element.lastChild.lastElementChild.classList.contains(
            'e-disabled'
          )
        ).toBe(true);
      });
      it('max value with today button', () => {
        ...
        calendarObj = new Calendar({
          value: new Date(),
          max: new Date(currentDate.toDateString()),
        });
        calendarObj.appendTo('#calendar');
        expect(
          calendarObj.element.lastChild.lastElementChild.classList.contains(
      ...
      it('today button set model test case', () => {
        calendarObj = new Calendar({});
        calendarObj.appendTo('#calendar');
        expect(calendarObj.todayElement.classList.contains('e-today')).toBe(
          true
        );
        calendarObj.showTodayButton = false;
        calendarObj.dataBind();
    ...
    describe('MultipleSelection property', () => {
      ...
      it('values initialization Property', () => {
        ...
        expect(calendarObj.values.length).toBe(
          calendarObj.element.querySelectorAll('.e-selected').length
        );
        expect(+calendarObj.values[0]).toBe(
          getIdValue(calendarObj.element.querySelectorAll('.e-selected')[1])
        );
        expect(+calendarObj.values[1]).toBe(
          getIdValue(calendarObj.element.querySelectorAll('.e-selected')[2])
        );
        expect(+calendarObj.values[2]).toBe(
          getIdValue(calendarObj.element.querySelectorAll('.e-selected')[3])
        );
        expect(+calendarObj.values[3]).toBe(
          getIdValue(calendarObj.element.querySelectorAll('.e-selected')[0])
        );
      });
      it('Check focus date class is present in last value of multiselection', () => {
        ...
        expect(
          calendarObj.element
            .querySelectorAll('.e-selected')
            [length].classList.contains('.e-focused-date')
        ).toBe(false);
      });
      ...
      it('select behavior of multiSelection Property', () => {
        ...
        expect(calendarObj.values).toBe(null);
        (<HTMLElement>(
          calendarObj.tableBodyElement.querySelectorAll('tr td')[5]
        )).click();
        expect(calendarObj.values.length).toBe(1);
        expect(calendarObj.values.length).toBe(
          calendarObj.element.querySelectorAll('.e-selected').length
      ...
      it('select otherMonth behavior of multiSelection Property', () => {
        ...
        (<HTMLElement>(
          calendarObj.tableBodyElement.querySelectorAll('tr td')[1]
        )).click();
        expect(calendarObj.values.length).toBe(5);
        expect(calendarObj.element.querySelectorAll('.e-selected').length).toBe(
          2
        );
      });
    ...
    describe('Form element', () => {
      let calendarObj: any;
      beforeEach(() => {
        let formEle: HTMLElement = createElement('form', {
          id: 'form-element',
        });
        let Ele: HTMLElement = createElement('div', { id: 'calendar' });
  ...
  describe(' Islamic Calendar', () => {
    ...
    describe('property ', () => {
      ...
      it('selected date with previous and next icon navigation test case in month view ', () => {
        ...
        expect(
          calendar.globalize.formatDate(new Date('12/11/2018'), {
            format: 'MMMMy',
            type: 'dateTime',
            calendar: 'islamic',
          })
      ...
      it('decade view based on the culture "ar" test case', () => {
        ...
        /* month view */
        expect(
          (<HTMLElement>document.getElementsByClassName('e-day e-title')[0])
            .innerHTML
        ).toBe('جمادى الأولى١٤٤٣');
        expect(
          calendar.tableBodyElement.querySelectorAll('tr td.e-selected').length
        ).toBe(1);
        expect(
          calendar.tableBodyElement.querySelector('tr td.e-selected').innerText
        ).toBe('٢٨');
        (<HTMLElement>(
          document.getElementsByClassName('e-day e-title')[0]
        )).click();
        /* year view */
        expect(
          (<HTMLElement>document.getElementsByClassName('e-day e-title')[0])
      ...
      it(' renderdaycell  test case  ', () => {
        ...
        expect(calendar.isMultiSelection).toBe(true);
        expect(
          document.querySelectorAll('.e-disabled.e-overlay')[0].textContent
        ).toBe('21');
      });
    ...
    describe('multiselection ', () => {
      ...
      it('initialization testcase', () => {
        ...
        calendar = new Calendar({
          isMultiSelection: true,
          values: [new Date('1/1/2020'), new Date('1/2/2020')],
          calendarMode: 'Islamic',
        });
        calendar.appendTo('#calendar');
        expect(
        ...
        expect(calendar.values.length).toBe(
          calendar.element.querySelectorAll('.e-selected').length
        );
        expect(
          calendar.tableBodyElement.querySelectorAll('tr td.e-selected').length
        ).toBe(2);
        expect(
          calendar.tableBodyElement.querySelectorAll('tr td.e-selected')[0]
            .innerText
        ).toBe('6');
        expect(
          calendar.tableBodyElement.querySelectorAll('tr td.e-selected')[1]
            .innerText
        ).toBe('7');
      });
      it('setmodel values Property', () => {
        ...
        expect(
          calendar.tableBodyElement.querySelectorAll('tr td.e-selected')[2]
            .innerText
        ).toBe('8');
        expect(
          calendar.tableBodyElement.querySelectorAll('tr td.e-selected')[3]
            .innerText
        ).toBe('9');
      });
      // issue
      ...
      it('Islamic calendar-compare month', function () {
        ...
        calendar = new Calendar({
          start: 'Year',
          min: new Date('9/14/2018'),
          max: new Date('9/15/2018'),
          calendarMode: 'Islamic',
        });
        calendar.appendTo('#calendar');
        (<HTMLElement>(
          document.getElementsByClassName('e-cell e-focused-date')[0]
        )).click();
        expect(
          (<HTMLElement>document.getElementsByClassName('e-day e-title')[0])
            .innerHTML
      ...
      it('islamic calndar min value with today button', () => {
        ...
        calendar.appendTo('#calendar');
        expect(
          calendar.element.lastChild.lastElementChild.classList.contains(
            'e-disabled'
          )
        ).toBe(true);
      });
      ...
      it('islamic calendar - year view textContent test case', () => {
        ...
        calendar.appendTo('#calendar');
        expect(
          calendar.tableBodyElement.querySelector('tr td span').textContent
        ).toBe('Muh.');
      });
  ...
  describe('EJ2-45081 : Need to provide support for handling the week number based on the year starts', () => {
    ...
    it(' weekRule as FirstDay  ', () => {
      ...
      expect(
        cal.tableBodyElement.querySelectorAll('tr .e-week-number')[1]
          .textContent
      ).toBe('' + 2);
      cal.value = new Date('12/31/2020');
      cal.dataBind();
      expect(
        cal.tableBodyElement.querySelectorAll('tr .e-week-number')[3]
          .textContent
      ).toBe('' + 52);
      expect(
        cal.tableBodyElement.querySelectorAll('tr .e-week-number')[4]
          .textContent
      ).toBe('' + 1);
      ...
      expect(
        cal.tableBodyElement.querySelectorAll('tr .e-week-number')[2]
          .textContent
      ).toBe('' + 2);
      cal.value = new Date('12/31/2020');
      cal.dataBind();
