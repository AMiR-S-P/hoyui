...
describe('TimePicker', () => {
  ...
  describe('DOM Wrapper Testing without default value', () => {
    ...
    it('element aria-owns testing', (done) => {
      ...
      setTimeout(function () {
        expect(timeObj.popupWrapper.getAttribute('id')).toBe(
          timeObj.element.id + '_popup'
        );
        expect(timeObj.listTag.getAttribute('id')).toBe(
          timeObj.element.id + '_options'
        );
        done();
      }, 450);
    });
    ...
    it('wrapper class testing', () => {
      expect(
        timeObj.inputWrapper.container.classList.contains('e-time-wrapper')
      ).toBe(true);
    });
    it('icon class e-time-icon testing', () => {
      expect(
        timeObj.inputWrapper.buttons[0].classList.contains('e-time-icon')
      ).toBe(true);
    });
    it('popup button class e-input-group-icon testing', () => {
      expect(
        timeObj.inputWrapper.buttons[0].classList.contains('e-input-group-icon')
      ).toBe(true);
    });
    ...
    it('popup element class e-timepicker testing', () => {
      ...
      expect(timeObj.popupWrapper.classList.contains('e-timepicker')).toBe(
        true
      );
    });
    ...
    it('popup element id testing', () => {
      ...
      expect(timeObj.popupWrapper.getAttribute('id')).toBe(
        timeObj.inputElement.getAttribute('id') + '_popup'
      );
    });
    ...
    it('popup element width testing', () => {
      ...
      expect(parseInt(timeObj.popupWrapper.style.width)).toEqual(
        parseInt(timeObj.inputWrapper.container.getBoundingClientRect().width)
      );
    });
    ...
    it('popup li element ARIA role testing', () => {
      ...
      expect(
        (<HTMLElement>timeObj.listWrapper.querySelector('li')).getAttribute(
          'role'
        )
      ).toEqual('option');
    });
    it('popup li element class testing', () => {
      ...
      expect(
        (<HTMLElement>(
          timeObj.listWrapper.querySelector('li')
        )).classList.contains('e-list-item')
      ).toBe(true);
    });
    it('wrapper focus on popup open time testing', () => {
      ...
      expect(
        timeObj.inputWrapper.container.classList.contains('e-input-focus')
      ).toBe(true);
    });
    ...
    it('popup element selection testing', () => {
      ...
      element = <HTMLElement>(
        timeObj.popupWrapper.querySelectorAll('.e-list-item')[0]
      );
      element.click();
  ...
  describe('DOM Wrapper Testing with default value ', () => {
    ...
    it('value testing in input box', () => {
      ...
      TimePickerBase.createListItems(
        timeObj.createElement,
        new Date('12/12/2016 10:00 AM'),
        new Date('12/12/2016 10:00 PM'),
        timeObj.globalize,
        timeObj.cldrTimeFormat(),
        timeObj.step
      );
    });
    it('cssClass testing', (done) => {
      expect(
        timeObj.inputWrapper.container.classList.contains('e-custom')
      ).toBe(true);
      if (!timeObj.isPopupOpen()) {
        (<HTMLElement>(
          document.getElementsByClassName(
    ...
    it('wrapper ARIA-ACTIVEDESCENDANT testing', (done) => {
      ...
      setTimeout(function () {
        ...
        expect(timeObj.element.getAttribute('aria-activedescendant')).toBe(
    ...
    it('popup active class element value equal to model value testing', () => {
      ...
      expect(
        timeObj.popupWrapper
          .querySelectorAll('.e-active')[0]
          .getAttribute('data-value')
      ).toEqual(timeObj.element.value);
    });
    ...
    it('Set hover testing ', () => {
      ...
      let li: Element = <HTMLLIElement>(
        timeObj.popupWrapper.querySelectorAll('li')[3]
      );
    ...
    it('Set hover to new element testing ', () => {
      ...
      let newLi: Element = <HTMLLIElement>(
        timeObj.popupWrapper.querySelectorAll('li')[4]
      );
    ...
    it('select the value using mouse click testing ', () => {
      ...
      let li: Element = <HTMLLIElement>(
        timeObj.popupWrapper.querySelectorAll('li')[0]
      );
  ...
  describe('DOM Wrapper Testing with min & max value', () => {
    beforeEach(() => {
      ...
      document.body.appendChild(ele);
      timeObj = new TimePicker({
        min: new Date('12/12/2016 10:00'),
        max: new Date('12/12/2016 14:00'),
        step: 15,
        value: new Date('12/12/2016 11:00'),
        strictMode: true,
      });
    ...
    it('popup first element value start with min value', () => {
      ...
      let liVal: string = timeObj.popupWrapper
        .querySelector('.e-list-item')
        .getAttribute('data-value');
      expect(
        timeObj.globalize.formatDate(timeObj.createDateObj(timeObj.min), {
          format: timeObj.cldrTimeFormat(),
          type: 'time',
        })
      ).toEqual(liVal);
    });
    it('value exceeds the max value testing', () => {
      ...
      timeObj.appendTo('#timepicker2');
      expect(timeObj.getValue(timeObj.value)).toEqual(
        timeObj.getValue(timeObj.max)
      );
    });
    ...
    it('disable time icon testing', () => {
      timeObj = new TimePicker({
        min: new Date('12/12/2016 16:00'),
        max: new Date('12/12/2016 14:00'),
        value: null,
      });
      timeObj.appendTo('#timepicker2');
      expect(
        timeObj.inputWrapper.buttons[0].classList.contains('e-disabled')
      ).toBe(true);
    });
    it('max value as empty testing', () => {
      timeObj = new TimePicker({
        max: null,
        min: new Date('12/12/2016 2:00'),
        step: 15,
        value: new Date('12/12/2016 15:00'),
        strictMode: true,
      });
    ...
    it('max value is less then min value testing', () => {
      timeObj = new TimePicker({
        max: new Date('12/12/2016 6:00'),
        min: new Date('12/12/2016 8:00'),
        step: 15,
        value: new Date('12/12/2016 15:00'),
        strictMode: true,
      });
    ...
    it('value less than the min value testing', () => {
      timeObj = new TimePicker({
        ...
        max: new Date('12/12/2016 14:00'),
        step: 15,
        value: new Date('12/12/2016 8:00'),
        strictMode: true,
      });
      timeObj.appendTo('#timepicker2');
    ...
    it('Error Class for start value before 1905-Chrome testing', () => {
      ...
      expect(
        (<HTMLElement>(
          document.getElementsByClassName('e-time-wrapper')[0]
    ...
    it('popup last element value end with max value', () => {
      ...
      let liVal: string = timeObj.popupWrapper
        ...
        [
          timeObj.popupWrapper.querySelectorAll('.e-list-item').length - 1
        ].getAttribute('data-value');
      expect(
        timeObj.globalize.formatDate(timeObj.createDateObj(timeObj.max), {
          format: timeObj.cldrTimeFormat(),
          type: 'time',
        })
      ).toEqual('2:00 PM');
    ...
    it('element placeholder testing', () => {
      ...
      timeObj.appendTo('#timepicker2');
      expect(timeObj.element.getAttribute('placeholder')).toEqual(
        'Select Time'
      );
    });
    it('Element created with floatLabelType property with Auto type', () => {
      ...
      expect(
        timeObj.inputWrapper.container.classList.contains('e-float-input')
      ).toBe(true);
      expect(
        timeObj.inputWrapper.container.children[1].classList.contains(
          'e-float-line'
        )
      ).toBe(true);
      expect(
        timeObj.inputWrapper.container.children[2].classList.contains(
          'e-float-text'
        )
      ).toBe(true);
      expect(
      ...
      expect(timeObj.inputWrapper.container.children[2].innerText).toBe(
        'Select Time'
      );
    ...
    it('Element created with floatLabelType property with Never type', () => {
      ...
      expect(timeObj.inputElement.getAttribute('placeholder')).toBe(
        'Select Time'
      );
      expect(
        timeObj.inputWrapper.container.children[2].classList.contains(
    ...
    it('autocapitalize attribute test case', () => {
      timeObj = new TimePicker();
      timeObj.appendTo('#timepicker2');
      expect(timeObj.element.getAttribute('autocapitalize') == 'off').toBe(
        true
      );
    });
  ...
  describe('DOM Wrapper Testing with basic properites', () => {
    ...
    it('tab index of focus element in disable state ', () => {
      expect(timeObj.inputWrapper.container.children[0].tabIndex === -1).toBe(
        true
      );
  ...
  describe('DOM Wrapper Testing FloatLabel properites', () => {
    ...
    it('tab index of focus element', () => {
      expect(
        timeObj.inputWrapper.container.children[0].getAttribute('tabindex') ===
          '0'
      ).toBe(true);
    });
  ...
  describe('DOM Wrapper Testing enableRtl properites', () => {
    ...
    it('enableRtl wrapper class testing', () => {
      expect(timeObj.inputWrapper.container.classList.contains('e-rtl')).toBe(
        true
      );
    });
  ...
  describe('Public method testing', () => {
    ...
    it('show popup testing', () => {
      ...
      expect(timeObj.isPopupOpen()).toBe(true);
      expect(
        timeObj.element.parentElement.classList.contains('e-input-focus')
      ).toBe(true);
    });
    it('focus in testing', () => {
      timeObj.focusIn();
  ...
  describe('Internal method testing', () => {
    ...
    it('get formated value testing', () => {
      expect(timeObj.getFormattedValue(new Date('12/12/2016 10:00 AM'))).toBe(
        '10:00:00 AM'
      );
    });
  ...
  describe('Set model testing', () => {
    ...
    it('cssClass testing', () => {
      ...
      timeObj.dataBind();
      expect(
        timeObj.inputWrapper.container.classList.contains(timeObj.cssClass)
      ).toBe(true);
      expect(timeObj.popupWrapper.classList.contains(timeObj.cssClass)).toBe(
        true
      );
      timeObj.cssClass = 'e-ternary e-cssClass';
      timeObj.dataBind();
      expect(
        timeObj.inputWrapper.container.classList.contains('e-ternary')
      ).toBe(true);
      expect(
        timeObj.inputWrapper.container.classList.contains('e-cssClass')
      ).toBe(true);
      if (!timeObj.isPopupOpen()) {
        (<HTMLElement>(
          document.getElementsByClassName(
    ...
    it('placeholder testing', () => {
      ...
      timeObj.dataBind();
      expect(timeObj.element.getAttribute('placeholder')).toBe(
        timeObj.placeholder
      );
    });
    it('min testing', () => {
    ...
    it('strict Mode false testing', () => {
      ...
      expect(timeObj.inputWrapper.container.classList.contains('e-error')).toBe(
        true
      );
    });
  ...
  describe('Initial time input attribute testing', () => {
    ...
    it('allowedit property with true test case ', () => {
      ...
      expect(
        document
          .querySelector('.e-timepicker.e-popup')
    ...
    it('allowedit property with e-non-edit calss ', () => {
      ...
      expect(timeObj.element.getAttribute('readonly')).toBe(null);
      expect(
        timeObj.inputWrapper.container.classList.contains('e-non-edit')
      ).toBe(false);
      timeObj.allowEdit = false;
      timeObj.dataBind();
      expect(timeObj.element.getAttribute('readonly')).toBe('');
    ...
    it('style attribute testing', () => {
      ...
      timeObj = new TimePicker({ value: new Date('12/12/2016 14:00') });
      timeObj.appendTo('#timepicker6');
      expect(timeObj.element.getAttribute('style')).toEqual(
  ...
  describe('clear button related testing', () => {
    ...
    it('clear icon', () => {
      expect(
        timeObj.inputWrapper.clearButton.classList.contains('e-clear-icon')
      ).toBe(true);
    });
    ...
    it('clear button default state', () => {
      expect(timeObj.value.valueOf()).toBe(
        new Date('12/12/2016 10:00').valueOf()
      );
      expect(
        timeObj.inputWrapper.clearButton.classList.contains('e-clear-icon-hide')
      ).toBe(true);
    });
    ...
    it('showclearbutton with false test case', () => {
      ...
      expect(
        document
          ...
          .classList.contains('e-clear-icon-hide')
      ).toBe(true);
    });
  });
  ...
  describe('strict mode true testing', () => {
    ...
    it('ISO string type with value test case', () => {
      timeObj = new TimePicker({
        value: <any>'2019-01-02T08:06:13.3426049+00:00',
      });
      timeObj.appendTo('#timepicker10');
      expect(timeObj.element.value != '').toBe(true);
      expect(timeObj.value !== null).toBe(true);
    ...
    it('e-error added and removed with empty testing', () => {
      timeObj = new TimePicker({
        value: new Date('12/12/2016 12:00'),
        max: new Date('12/12/2016 11:00'),
      });
      timeObj.appendTo('#timepicker10');
      expect(timeObj.element.value).toBe('12:00 PM');
    ...
    it('prevent blur testing', (done) => {
      timeObj = new TimePicker({
        value: new Date('12/12/2016 13:00'),
        max: new Date('12/12/2016 15:00'),
      });
      timeObj.appendTo('#timepicker10');
      timeObj.show();
  ...
  describe('HTML attributes at inline element testing', () => {
    ...
    it('Inline and API testing', () => {
      timeObj = new TimePicker({
        ...
        readonly: false,
        enabled: true,
        value: new Date('7/4/2016 6:00 AM'),
        min: new Date('7/4/2016 2:00 AM'),
        max: new Date('7/4/2016 9:00 AM'),
      });
      timeObj.appendTo('#time');
  ...
  describe('HTML attribute API testing', () => {
    ...
    it('API testing', () => {
      timeObj = new TimePicker({
        ...
        readonly: false,
        enabled: true,
        value: new Date('7/4/2016 3:00 AM'),
      });
      timeObj.appendTo('#time');
      expect(timeObj.placeholder).toBe('Select a date');
      expect(timeObj.element.hasAttribute('readonly')).toBe(false);
    ...
    it('Other attribute testing with htmlAttributes API', () => {
      timeObj = new TimePicker({
        htmlAttributes: { name: 'picker', title: 'sample' },
      });
      timeObj.appendTo('#time');
      expect(timeObj.element.getAttribute('name')).toBe('picker');
      expect(timeObj.inputWrapper.container.getAttribute('title')).toBe(
        'sample'
      );
    });
  });
    ...
    it('Dynamically change attributes with htmlAttributes API', () => {
      timeObj = new TimePicker({
        htmlAttributes: {
          ...
          readonly: 'true',
          disabled: 'true',
          value: '2/2/2018 6:00 AM',
          max: ' 2/2/2018 9:00 AM',
          min: '2/2/2018 2:00 AM',
          title: 'sample',
      ...
      expect(timeObj.inputWrapper.container.getAttribute('style')).toBe(
      ...
      timeObj.htmlAttributes = {
        ...
        readonly: 'false',
        disabled: 'false',
        value: '2/2/2018 7:00 AM',
        max: '2/2/2018 10:00 AM',
        min: '2/2/2018 3:00 AM',
        title: 'heading',
      };
      timeObj.dataBind();
  ...
  describe('HTML attribute API at inital rendering and dynamic rendering', () => {
    ...
    it('Html attributes at initial rendering', () => {
      timeObj = new TimePicker({
        htmlAttributes: { placeholder: 'Choose a time', class: 'sample' },
      });
      timeObj.appendTo('#time');
      expect(timeObj.element.getAttribute('placeholder')).toBe('Choose a time');
      expect(timeObj.inputWrapper.container.classList.contains('sample')).toBe(
        true
      );
    });
  ...
  describe('document click testing', () => {
    ...
    it('document popup click (close) testing', (done) => {
      ...
      timeObj2.show();
      setTimeout(() => {
        clickEventArgs.currentTarget = <HTMLElement>(
          document.getElementsByClassName(
            ' e-input-group-icon e-time-icon e-icons'
          )[0]
        );
        clickEventArgs.target = <HTMLElement>(
          document.getElementsByClassName(
            ' e-input-group-icon e-time-icon e-icons'
          )[0]
        );
  ...
  describe('document click testing', () => {
    ...
    it('document popup click (open) testing', (done) => {
      ...
      setTimeout(() => {
        clickEventArgs.currentTarget = <HTMLElement>(
          document.getElementsByClassName(' e-content')[0]
        );
        clickEventArgs.target = <HTMLLIElement>(
          document.getElementsByClassName('e-list-item')[2]
        );
  ...
  describe('Angular tag testing ', () => {
    ...
    it('Wrapper testing with ID', () => {
      ...
      expect(timeObj.inputWrapper.container.parentElement.tagName).toBe(
        timeObj.element.tagName
      );
  ...
  describe('Step value testing ', () => {
    ...
    it('step value 0.5 testing ', () => {
      timeObj = new TimePicker({ step: 0.5 });
      timeObj.appendTo(element);
      timeObj.focusIn(e);
      timeObj.show();
      KeyboardEventArgs.keyCode = 40;
  ...
  describe('before item render event', () => {
    ...
    it('Item render event testing', () => {
      ...
      ItemEventArgs.element = <HTMLElement>(
        document.getElementsByClassName('e-list-item')[2]
      );
      expect(ItemEventArgs.element.classList.contains('e-list-item')).toBe(
        true
      );
      ItemEventArgs.element.classList.add('e-class');
      expect(
        document
          .getElementsByClassName('e-list-item')[2]
          .classList.contains('e-class')
      ).toBe(true);
    });
    it('disable value testing', () => {
      ...
      expect(
        timeObj1.inputWrapper.container.classList.contains('e-error')
      ).toBe(true);
    ...
    it('disable value testing from last Index to first index', (done) => {
      ...
      if (!timeObj1.isPopupOpen()) {
        ...
        (<HTMLElement>document.querySelector('.e-timepicker')).dispatchEvent(
          clickEvent
        );
      }
      setTimeout(function () {
  ...
  describe('Form element', () => {
    ...
    it('Form destroy event test case (initialized)', () => {
      ...
      timepicker.appendTo('#timepicker');
      expect(
        document.getElementById('timepicker').classList.contains('e-timepicker')
      ).toBe(true);
  ...
  describe('Model dialog', function () {
    ...
    it(' desktop test case', function () {
      ...
      expect(document.getElementsByClassName('e-time-modal').length === 0).toBe(
        true
      );
      expect(timepicker.popupObj.position.X).toBe('left');
      expect(timepicker.popupObj.position.Y).toBe('bottom');
      expect(timepicker.popupObj.relateTo).toBe(
        timepicker.inputWrapper.container
      );
    });
  ...
  describe('Model full screen layout dialog', function () {
    ...
    it(' mobile test case', function () {
      ...
      expect(document.getElementsByClassName('e-time-modal').length === 1).toBe(
        true
      );
      expect(
        timepicker.popupObj.element.classList.contains('e-popup-expand')
      ).toBe(true);
    });
  ...
  describe('Timepicker', function () {
    ...
    it('focus event checking on document click when the calendar is open test case', function () {
      ...
      expect(
        timePicker.inputWrapper.container.classList.contains('e-input-focus')
      ).toBe(false);
    });
  });
  describe('Dynamic CssClass testcase', function () {
    ...
    it('single css class', function () {
      ...
      timepicker.appendTo('#timepicker');
      expect(
        timepicker.inputWrapper.container.classList.contains('e-custom')
      ).toBe(true);
      timepicker.cssClass = 'e-test';
      timepicker.dataBind();
      expect(
        timepicker.inputWrapper.container.classList.contains('e-test')
      ).toBe(true);
    });
    it('more than one css class', function () {
      ...
      expect(
        timepicker.inputWrapper.container.classList.contains('e-secondary')
      ).toBe(true);
  ...
  describe('Cleared event test case', function () {
    ...
    it('check value after button click', function () {
      ...
      timepicker.appendTo('#date');
      timepicker.element.parentElement
  ...
  describe('EJ2-36604 - While giving the class name with empty space for HtmlAttributes, console error is produced.', function () {
    ...
    it('Entering the class name without any empty space', function () {
      ...
      timepicker.appendTo('#timepicker');
      expect(
        timepicker.inputWrapper.container.classList.contains('custom-class')
      ).toBe(true);
    });
    ...
    it('Giving more than one empty space between two class names', function () {
      ...
      timepicker.appendTo('#timepicker');
      expect(
        timepicker.inputWrapper.container.classList.contains('custom-class-one')
      ).toBe(true);
      expect(
        timepicker.inputWrapper.container.classList.contains('custom-class-two')
      ).toBe(true);
    });
    ...
    it('Giving class name with underscore in the beginning', function () {
      ...
      timepicker.appendTo('#timepicker');
      expect(
        timepicker.inputWrapper.container.classList.contains(
          '_custom-class-one'
        )
      ).toBe(true);
      expect(
  ...
  describe('EJ2-53323', function () {
    ...
    it('clear the full selected value on input', function () {
      ...
      expect(timepicker.inputElement.value === '').toBe(true);
      timepicker.liCollections[0].click();
      expect(timepicker.liCollections[0].classList.contains('e-active')).toBe(
        true
      );
      expect(timepicker.inputElement.value === '').toBe(false);
  ...
  describe('Null or undefined value testing', () => {
    ...
    it('maskPlaceholder', () => {
      ...
      expect(JSON.stringify(timepickerObj.maskPlaceholder)).toBe(
