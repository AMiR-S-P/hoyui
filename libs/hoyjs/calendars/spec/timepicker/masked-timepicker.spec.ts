...
import { createElement, L10n, Ajax, loadCldr } from '@hoyui/base';
...
describe('Timepicker', () => {
  ...
  describe('Masked TimePicker', () => {
    ...
    it('Value property', () => {
      ...
      expect(
        (timepicker.value.getHours() % 12).toString() +
          ':' +
          timepicker.value.getMinutes().toString() +
          ':' +
          timepicker.value.getSeconds().toString()
      ).toBe('1:2:9');
    });
