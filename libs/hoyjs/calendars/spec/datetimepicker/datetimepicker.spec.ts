...
describe('DateTimePicker', () => {
  ...
  describe('DateTimepicker', () => {
    describe('DOM Wrapper Testing without default value', () => {
      ...
      it('element class e-datetimpicker testing', () => {
        expect(
          datetimepicker.element.classList.contains('e-datetimepicker')
        ).toBe(true);
      });
      it('element class e-control testing', () => {
        expect(datetimepicker.element.classList.contains('e-control')).toBe(
          true
        );
      });
      it('name and min attribute testing', () => {
        expect(datetimepicker.element.getAttribute('name')).toBe(
          datetimepicker.element.getAttribute('id')
        );
        ele.setAttribute('min', '10/10/2010 06:00 AM');
        datetimepicker = new DateTimePicker();
        datetimepicker.appendTo('#dateTime');
        expect(datetimepicker.min.valueOf()).toEqual(
          new Date('10/10/2010 06:00 AM').valueOf()
        );
      });
      ...
      it('max element attribute testing', () => {
        ...
        datetimepicker = new DateTimePicker();
        datetimepicker.appendTo('#dateTime');
        expect(datetimepicker.max.valueOf()).toEqual(
          new Date('10/10/2013 04:00 PM').valueOf()
        );
      });
      it('max element attribute testing', () => {
      ...
      it('wrapper class testing', () => {
        expect(
          datetimepicker.inputWrapper.container.classList.contains(
            'e-datetime-wrapper'
          )
        ).toBe(true);
      });
      it('icon class e-date-icon and e-time-icon testing', () => {
        expect(
          datetimepicker.inputWrapper.buttons[0].classList.contains(
            'e-date-icon'
          )
        ).toBe(true);
        expect(
          datetimepicker.inputWrapper.container.children[3].classList.contains(
            'e-time-icon'
          )
        ).toBe(true);
      });
      ...
      it('popup button DOM testing', () => {
        expect(datetimepicker.inputWrapper.buttons[0].tagName === 'SPAN').toBe(
          true
        );
      });
      it('wrapper DOM testing', () => {
        expect(datetimepicker.inputWrapper.container.tagName === 'SPAN').toBe(
          true
        );
      });
      it('wrapper ARIA expanded attribute testing', () => {
        expect(datetimepicker.element.getAttribute('aria-expanded')).toEqual(
          'false'
        );
      });
      ...
      it('wrapper ARIA expanded attribute popup testing', () => {
        if (
          !datetimepicker.isDatePopupOpen() &&
          !datetimepicker.isTimePopupOpen()
        ) {
          (<HTMLElement>(
        ...
        expect(datetimepicker.element.getAttribute('aria-expanded')).toBe(
          'true'
        );
      });
      it('element placeholder testing', () => {
        expect(datetimepicker.element.getAttribute('placeholder')).toEqual(
          null
        );
      });
      it('popup element class popup testing', () => {
        ...
        expect(datetimepicker.popupWrapper.classList.contains('e-popup')).toBe(
          true
        );
      });
      it('popup element class control testing', () => {
        ...
        expect(
          datetimepicker.popupWrapper.classList.contains('e-control')
        ).toBe(true);
      });
      it('popup element class e-DateTimePicker testing', () => {
        ...
        expect(
          datetimepicker.dateTimeWrapper.classList.contains('e-datetimepicker')
        ).toBe(true);
      });
      ...
      it('previous value reset testing', () => {
        ...
        let tableRow =
          datetimepicker.popupWrapper.getElementsByTagName('tr')[3];
      ...
      it('previous value reset testing', () => {
        ...
        let tableRow =
          datetimepicker.dateTimeWrapper.getElementsByTagName('li')[3];
        tableRow.click();
      ...
      it('allowedit property with e-non-edit calss ', () => {
        datetimepicker = new DateTimePicker({
          value: new Date('3/3/2017 10:00 AM'),
        });
        datetimepicker.appendTo('#dateTime');
        expect(datetimepicker.element.getAttribute('readonly')).toBe(null);
        expect(
          datetimepicker.inputWrapper.container.classList.contains('e-non-edit')
        ).toBe(false);
        datetimepicker.allowEdit = false;
        datetimepicker.dataBind();
        expect(datetimepicker.element.getAttribute('readonly')).toBe('');
      ...
      it('Error Class for start value before 1905-Chrome testing', () => {
        ...
        expect(
          (<HTMLElement>(
            document.getElementsByClassName('e-datetime-wrapper')[0]
      ...
      it('IOS string type with value test case ', () => {
        datetimepicker = new DateTimePicker({
          value: <any>'2017-02-01T18:30:00.000Z',
        });
        datetimepicker.appendTo('#dateTime');
      ...
      it('popup element id testing', () => {
        ...
        expect(datetimepicker.popupWrapper.getAttribute('id')).toBe(
          datetimepicker.inputElement.getAttribute('id') + '_options'
        );
      });
      ...
      it('popup element selection testing', () => {
        ...
        element = <HTMLElement>(
          datetimepicker.dateTimeWrapper.querySelectorAll('.e-list-item')[0]
        );
        element.click();
    ...
    describe('DOM Element Testing', () => {
      describe('Input Element Testing', () => {
        ...
        it('Element created with cssClass property', () => {
          ...
          datetimepicker.appendTo('#dateTime');
          expect(
            datetimepicker.inputWrapper.container.classList.contains('e-custom')
          ).toBe(true);
        });
        it('multiple cssClass  test case', () => {
          ...
          datetimepicker.show();
          expect(
            datetimepicker.popupWrapper.classList.contains('e-custom')
          ).toBe(true);
          expect(
            datetimepicker.popupWrapper.classList.contains('e-secondary-class')
          ).toBe(true);
          datetimepicker.dataBind();
          ...
          datetimepicker.show();
          expect(
            datetimepicker.popupWrapper.classList.contains('e-ternary')
          ).toBe(true);
          expect(
            datetimepicker.popupWrapper.classList.contains('e-cssClass')
          ).toBe(true);
        });
        ...
        it('Element created with enableRtl property', () => {
          ...
          datetimepicker.appendTo('#dateTime');
          expect(
            datetimepicker.inputWrapper.container.classList.contains('e-rtl')
          ).toBe(true);
        });
        ...
        it('Element created with string Format property', () => {
          datetimepicker = new DateTimePicker({
            ...
            value: new Date('04/06/2018 10:30 AM'),
          });
          datetimepicker.appendTo('#dateTime');
          expect(
            datetimepicker.inputElement.value == '04/06/2018 10:30 AM'
          ).toBe(true);
        });
        it('Element created with object Format property', () => {
          ...
          datetimepicker.appendTo('#dateTime');
          expect(
            datetimepicker.inputElement.value == '12/12/16, 10:15 AM'
          ).toBe(true);
        });
        ...
        it('Element created with placeholder property', () => {
          ...
          expect(datetimepicker.inputElement.getAttribute('placeholder')).toBe(
            'Select a DateTime'
          );
        });
        it('Element created with floatLabelType property with Auto type', () => {
          ...
          expect(datetimepicker.inputWrapper.container.tagName == 'DIV').toBe(
            true
          );
          expect(
            datetimepicker.inputWrapper.container.classList.contains(
          ...
          expect(
            datetimepicker.inputWrapper.container.children[1].classList.contains(
              'e-float-line'
            )
          ).toBe(true);
          expect(
            datetimepicker.inputWrapper.container.children[2].classList.contains(
              'e-float-text'
            )
          ).toBe(true);
          expect(
          ...
          expect(
            datetimepicker.inputWrapper.container.children[2].innerText
          ).toBe('Select a DateTime');
        ...
        it('autocorrect attribute test case', () => {
          ...
          datetimepicker.appendTo('#dateTime');
          expect(
            datetimepicker.element.getAttribute('autocorrect') == 'off'
          ).toBe(true);
        });
        it('autocapitalize attribute test case', () => {
          ...
          datetimepicker.appendTo('#dateTime');
          expect(
            datetimepicker.element.getAttribute('autocapitalize') == 'off'
          ).toBe(true);
        });
        it('spellcheck attribute test case', () => {
          ...
          datetimepicker.appendTo('#dateTime');
          expect(
            datetimepicker.element.getAttribute('spellcheck') == 'false'
          ).toBe(true);
        });
        it('autocomplete attribute test case', () => {
          ...
          datetimepicker.appendTo('#dateTime');
          expect(
            datetimepicker.element.getAttribute('autocomplete') == 'off'
          ).toBe(true);
        });
        /**
         * tabIndex
        ...
        it('tab index of focus element', () => {
          ...
          datetimepicker.appendTo('#dateTime');
          expect(
            datetimepicker.inputWrapper.container.children[0].getAttribute(
              'tabindex'
            ) === '0'
          ).toBe(true);
        });
        ...
        it('tab index of focus element in disable state ', () => {
          ...
          datetimepicker.appendTo('#dateTime');
          expect(
            datetimepicker.inputWrapper.container.children[0].tabIndex === -1
          ).toBe(true);
        ...
        it('Tab index checking while destroy the Angular component', () => {
          let element: any = createElement('ejs-datetimepicker', {
            id: 'datetime',
          });
  ...
  describe('DOM Wrapper Testing with default value ', () => {
    ...
    beforeEach(() => {
      ...
      document.body.appendChild(ele);
      datetimepicker = new DateTimePicker({
        value: new Date('10/10/2017 10:30 PM'),
      });
      datetimepicker.appendTo('#dateTime');
    });
    afterEach(() => {
    ...
    it('popup active class element value equal to model value testing', () => {
      ...
      expect(
        datetimepicker.dateTimeWrapper
          .querySelectorAll('.e-active')[0]
    ...
    it('step value 30 testing ', () => {
      ...
      expect(
        datetimepicker.dateTimeWrapper
          .querySelectorAll('.e-list-item')[1]
          .getAttribute('data-value')
      ).toEqual('12:30 AM');
    });
    it('toggle method testing', () => {
      datetimepicker = new DateTimePicker({
        value: new Date('4/4/2017 10:30 PM'),
    ...
    it('Set hover testing ', () => {
      ...
      let li: Element = <HTMLLIElement>(
        datetimepicker.dateTimeWrapper.querySelectorAll('li')[3]
      );
    ...
    it('Set hover to new element testing ', () => {
      ...
      datetimepicker.setTimeHover(li, 'e-hover');
      let newLi: Element = <HTMLLIElement>(
        datetimepicker.dateTimeWrapper.querySelectorAll('li')[4]
      );
    ...
    it('valid value entering when popup is in the open state', function () {
      ...
      expect(
        datetimepicker.inputWrapper.container.classList.contains('e-error')
      ).toBe(false);
    });
  });
  describe('DOM Wrapper Testing with basic properites', () => {
    ...
    it('Empty value testing', () => {
      datetimepicker = new DateTimePicker({
        ...
        renderDayCell: onRender,
        value: new Date('2/1/2018 12:00 PM'),
      });
      datetimepicker.appendTo('#dateTime');
    ...
    it('enabled false input element ARIA-DISABELD testing', () => {
      expect(datetimepicker.inputElement.getAttribute('aria-disabled')).toEqual(
        'true'
      );
    });
    it('placeholder attribute testing', () => {
      expect(datetimepicker.inputElement.getAttribute('placeholder')).toEqual(
        null
      );
    });
    it('value checking within min and max range testing', () => {
      datetimepicker = new DateTimePicker({
        value: new Date('2/3/2017 10:30 PM'),
        min: new Date('12/12/2016 10:00 AM'),
        max: new Date('3/3/2017 11:00 AM'),
      });
      datetimepicker.appendTo('#dateTime');
    ...
    it('show method with input focus related test case', () => {
      ...
      datetimepicker.show('time');
      expect(
        datetimepicker.element.parentElement.classList.contains('e-input-focus')
      ).toBe(false);
    ...
    it('show Hide public method testing', () => {
      ...
      (<HTMLElement>(
        document.getElementsByClassName('e-time-icon')[0]
      )).dispatchEvent(clickEvent);
      expect(
        datetimepicker.element.parentElement.classList.contains('e-input-focus')
      ).toBe(true);
  ...
  describe('class', () => {
    ...
    it('Without error class', () => {
      ...
      expect(datetimepicker.value.valueOf()).toBe(
        +new Date('11/12/2017 12:00 AM')
      );
    });
  ...
  describe('document strict mode testing', () => {
    ...
    it('enable strict mode with range value', () => {
      ...
      datetimepicker.appendTo('#dateTime');
      expect(datetimepicker.min.valueOf()).toEqual(
        new Date('4/4/2016 10:00 AM').valueOf()
      );
      expect(datetimepicker.max.valueOf()).toEqual(
        new Date('3/3/2017 11:00 AM').valueOf()
      );
      expect(datetimepicker.value.valueOf()).toEqual(
        new Date('10/12/2016 10:00 AM').valueOf()
      );
      (<HTMLElement>(
        document.getElementsByClassName(
          ' e-input-group-icon e-date-icon e-icons'
    ...
    it('strictMode false with out of range test case ', () => {
      datetimepicker = new DateTimePicker({
        value: new Date('3/3/9999 10:00 AM'),
        min: new Date('3/3/2017 10:00 AM'),
        max: new Date('3/30/2017 10:00 AM'),
    ...
    it('enable strict mode with exeeding the max value range', () => {
      ...
      datetimepicker.toggle();
      let index =
        datetimepicker.dateTimeWrapper.querySelectorAll('.e-list-item').length;
      expect(
        datetimepicker.dateTimeWrapper
          .querySelectorAll('.e-list-item')
          [index - 1].getAttribute('data-value')
      ).toEqual('11:00 AM');
    });
    ...
    it('onproperty change cssClass during time popup open time testing', (done) => {
      ...
      setTimeout(function () {
        ...
        datetimepicker.dataBind();
        expect(
          datetimepicker.dateTimeWrapper.classList.contains('e-main')
        ).toBe(true);
        done();
      }, 450);
    });
    it('onproperty change cssClass during popup open time testing', (done) => {
      ...
      datetimepicker.dataBind();
      setTimeout(function () {
        expect(datetimepicker.popupWrapper.classList.contains('e-main')).toBe(
          true
        );
        done();
      }, 450);
  ...
  describe('document layout testing', () => {
    ...
    it('wrapper ARIA-ACTIVEDESCENDANT testing', (done) => {
      ...
      expect(
        datetimepicker.inputElement.getAttribute('aria-activedescendant')
      ).toBe(element.getAttribute('id'));
      done();
    });
  });
  describe('ShowTodayButton set as false', () => {
    ...
    it('Dynamically change ShowTodayButton as false', () => {
      datetimepicker = new DateTimePicker({
        value: new Date('10/15/2019 10:30 PM'),
      });
      datetimepicker.appendTo('#dateTime');
  ...
  describe('Localization testing', () => {
    ...
    it('english culture initial time testing', () => {
      datetimepicker = new DateTimePicker({
        value: new Date('12/12/2016 5:00'),
      });
      datetimepicker.appendTo('#dateTime');
      expect(datetimepicker.cldrDateTimeFormat()).toEqual('M/d/y h:mm a');
      expect((<HTMLInputElement>datetimepicker.element).value).toEqual(
        '12/12/2016 5:00 AM'
      );
    });
    ...
    it('Jakarta culture (ja) testing', () => {
      loadCultureFiles('ja');
      datetimepicker = new DateTimePicker({
        value: new Date('12/12/2016 15:00'),
      });
      datetimepicker.appendTo('#dateTime');
    ...
    it('firstDayOfWeek based on the culture "de" test case', () => {
      ...
      expect(
        datetimepicker.tableHeadElement.querySelector('th').textContent
      ).toBe('Mo.');
    });
  ...
  describe('HTML attributes at inline element testing', () => {
    ...
    beforeEach((): void => {
      ...
      let ele: HTMLInputElement = <HTMLInputElement>(
        createElement('input', { id: 'datetime' })
      );
    ...
    it('Inline and html attributes API testing', () => {
      datetimepicker = new DateTimePicker({
        htmlAttributes: { placeholder: 'Choose a date' },
      });
      datetimepicker.appendTo('#datetime');
  ...
  describe('HTML attribute API testing', () => {
    ...
    it('HTML attributes API testing', () => {
      datetimepicker = new DateTimePicker({
        htmlAttributes: { placeholder: 'Choose a date', readonly: 'false' },
      });
      datetimepicker.appendTo('#datetime');
      expect(datetimepicker.placeholder).toBe('Choose a date');
      expect(datetimepicker.element.hasAttribute('readonly')).toBe(false);
    ...
    it('Other attribute testing with htmlAttributes API', () => {
      ...
      expect(datetimepicker.inputWrapper.container.getAttribute('title')).toBe(
        'sample'
      );
      expect(
        datetimepicker.inputWrapper.container.classList.contains('test')
      ).toBe(true);
    });
  });
  ...
  describe('HTML attribute API dynamic testing', () => {
    ...
    it('Dynamically change attributes with htmlAttributes API', () => {
      ...
      datetimepicker.appendTo('#datetime');
      expect(datetimepicker.element.getAttribute('placeholder')).toBe(
        'Enter a date'
      );
      expect(datetimepicker.element.hasAttribute('readonly')).toBe(true);
  ...
  describe('HTML attribute API at inital rendering and dynamic rendering', () => {
    ...
    it('Html attributes at initial rendering', () => {
      ...
      expect(
        datetimepicker.inputWrapper.container.classList.contains('sample')
      ).toBe(true);
    });
    it('Pass multiple attributes dynamically', () => {
      datetimepicker = new DateTimePicker({
        value: new Date('12/12/2016 10:00'),
      });
      datetimepicker.appendTo('#datetime');
      datetimepicker.htmlAttributes = {
        class: 'sample',
    ...
    it('Dynamically change multiple attributes through htmlAttributes API', () => {
      ...
      datetimepicker.htmlAttributes = {
        class: 'sample',
        max: '10/5/2016 10:00',
        min: '10/20/2016 10:00',
      };
      datetimepicker.dataBind();
      expect(datetimepicker.element.value).toBe('12/12/2016 10:00 AM');
      expect(datetimepicker.element.getAttribute('max')).toBe(
        '10/5/2016 10:00'
      );
      expect(datetimepicker.element.getAttribute('min')).toBe(
        '10/20/2016 10:00'
      );
    });
  ...
  describe('keyboard events', () => {
    ...
    it('previous element value navigation testing', () => {
      ...
      expect(
        datetimepicker.dateTimeWrapper
          .querySelectorAll('.e-navigation')[0]
          .getAttribute('data-value')
      ).toBe('9:30 AM');
    });
    ...
    it('first element to last element navigation testing', () => {
      datetimepicker = new DateTimePicker({
        value: new Date('12/12/2016 00:00'),
      });
      datetimepicker.appendTo('#dateTime');
      datetimepicker.element.focus();
      keyEventArgs.action = 'altDownArrow';
    ...
    it('last element to first element navigation testing', () => {
      datetimepicker = new DateTimePicker({
        value: new Date('12/12/2016 23:30'),
      });
      datetimepicker.appendTo('#dateTime');
      datetimepicker.element.focus();
      keyEventArgs.action = 'altDownArrow';
    ...
    it('last element to previous element navigation testing', () => {
      datetimepicker = new DateTimePicker({
        value: new Date('12/12/2016 23:20'),
      });
      datetimepicker.appendTo('#dateTime');
      datetimepicker.element.focus();
      keyEventArgs.action = 'altDownArrow';
    ...
    it('inbetween value to first element navigation testing', () => {
      datetimepicker = new DateTimePicker({
        value: new Date('12/12/2016 00:10'),
      });
      datetimepicker.appendTo('#dateTime');
      if (!datetimepicker.isTimePopupOpen()) {
        (<HTMLElement>(
    ...
    it('disable timeicon testing', () => {
      datetimepicker = new DateTimePicker({
        min: new Date('12/12/2016 23:30'),
        max: new Date('12/12/2016 13:30'),
        strictMode: true,
      });
      datetimepicker.appendTo('#dateTime');
      expect(
        datetimepicker.inputWrapper.buttons[0].classList.contains('e-disabled')
      ).toBe(true);
    });
    ...
    it('Escape key testing', () => {
      datetimepicker = new DateTimePicker({
        value: new Date('12/12/2016 12:30'),
      });
      datetimepicker.appendTo('#dateTime');
      datetimepicker.element.focus();
      keyEventArgs.action = 'escape';
    ...
    it('last element to previous element navigation testing', () => {
      datetimepicker = new DateTimePicker({
        value: new Date('12/12/2016 23:00'),
      });
      datetimepicker.appendTo('#dateTime');
      datetimepicker.element.focus();
      datetimepicker.show('time');
  ...
  describe('Mobile testing for readonly attribute', function () {
    ...
    it('Add and remove readonly attribute for angular platform', () => {
      let ele: HTMLElement = createElement('EJS-DATETIMEPICKER', {
        id: 'datetime',
      });
      document.body.appendChild(ele);
      datetimepicker = new DateTimePicker();
  ...
  describe('Angular tag testing ', () => {
    ...
    it('Wrapper testing ', () => {
      ...
      expect(
        datetimepicker.inputWrapper.container.children[0].classList.contains(
          'e-datetimepicker'
        )
      ).toEqual(true);
    });
  ...
  describe('Form element', () => {
    ...
    it('Input value reset in destroy case (initialized)', () => {
      ...
      (<any>document.getElementById('form-element')).reset();
      expect(
        (<any>document.getElementById('datetimepicker')).value !==
          '2/2/2017 12:00 AM'
      ).toBe(true);
      datetime = null;
    });
  ...
  describe('Islamic ', () => {
    ...
    it(' calendar test case', () => {
      ...
      datetimepicker = new DateTimePicker({
        ...
        value: new Date(),
        open: function (args: PopupEventArgs) {},
      });
      datetimepicker.appendTo('#datetimepicker');
      (<HTMLElement>(
        document.getElementsByClassName(
  ...
  describe('SetScrollTo testing', () => {
    let datetimepicker: any;
    beforeEach(() => {
      let ele: HTMLElement = createElement('input', {
        id: 'datetimepickerscroll',
      });
      document.body.appendChild(ele);
      datetimepicker = new DateTimePicker();
  ...
  describe('Datetimepicker', function () {
    ...
    it('focus event checking on document click when the calendar is open test case', function () {
      ...
      document
        .getElementsByClassName(' e-input-group-icon e-time-icon e-icons')[0]
        .dispatchEvent(clickEvent);
      expect(isNullOrUndefined(datetimepicker.popupWrapper)).toBe(true);
  ...
  describe('Dynamic CssClass testcase', function () {
    ...
    it('single css class', function () {
      ...
      expect(
        datetimepicker.inputWrapper.container.classList.contains('e-test')
      ).toBe(true);
    });
    it('more than one css class', function () {
      ...
      expect(
        datetimepicker.inputWrapper.container.classList.contains('e-secondary')
      ).toBe(true);
      ...
      expect(
        datetimepicker.inputWrapper.container.classList.contains('e-ternary')
      ).toBe(true);
    });
  });
  ...
  describe('Cleared event test case', function () {
    ...
    it('check value after button click', function () {
      ...
      datetimepicker.appendTo('#date');
      datetimepicker.element.parentElement
  ...
  describe('EJ2-36604 - While giving the class name with empty space for HtmlAttributes, console error is produced.', function () {
    ...
    it('Entering the class name without any empty space', function () {
      ...
      datetimepicker.appendTo('#datetimepicker');
      expect(
        datetimepicker.inputWrapper.container.classList.contains('custom-class')
      ).toBe(true);
    });
    ...
    it('Giving only empty space  without entering any class Name', function () {
      ...
      datetimepicker.appendTo('#datetimepicker');
      let beforeAddClass =
        datetimepicker.inputWrapper.container.classList.length;
  ...
  describe('EJ2-45532 - DateTimePicker popup closing when updating value dynamically', function () {
    ...
    it('check the popup open', function () {
      ...
      dateTimePicker.dataBind();
      expect(dateTimePicker.popupObj !== null).toBe(true);
      expect(dateTimePicker.inputElement.value === '1/1/2020 12:00 AM').toBe(
        true
      );
    });
  });
...
describe('Datetimepicker', () => {
  ...
  describe('Masked DateTimePicker', () => {
    ...
    it('Value property', () => {
      ...
      datetimepicker.inputHandler();
      expect(datetimepicker.element.value).toBe(
        '01/month/year hour:minute:second'
      );
      expect(datetimepicker.value).toBe(null);
  ...
  describe('Null or undefined value testing', () => {
    ...
    it('maskPlaceholder', () => {
      ...
      expect(JSON.stringify(datetimepickerObj.maskPlaceholder)).toBe(
    ...
    it('max', () => {
      ...
      expect(datetimepickerObj.max.valueOf()).toBe(
    ...
    it('min', () => {
      ...
      expect(datetimepickerObj.min.valueOf()).toBe(
