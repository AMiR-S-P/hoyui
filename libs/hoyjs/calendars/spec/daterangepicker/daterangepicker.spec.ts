import {
  ...
  RangeEventArgs,
  RangePopupEventArgs,
} from '../../src/daterangepicker/daterangepicker';
...
function getCalendarElement(ele: HTMLElement): CalendarElement {
  let elements: CalendarElement = {
    ...
    leftCalpreviousIcon: <HTMLElement>(
      ele.querySelector('.e-left-calendar .e-prev')
    ),
    rightCalNexticon: <HTMLElement>(
      ele.querySelector('.e-right-calendar .e-next')
    ),
    rightCalpreviousIcon: <HTMLElement>(
      ele.querySelector('.e-right-calendar .e-prev')
    ),
  };
  return elements;
}
...
function loadCultureFiles(name: string, base?: boolean): void {
  let files: string[] = !base
    ...
    : ['numberingSystems.json', 'weekData.json'];
...
describe('DateRangePicker', () => {
  ...
  describe('DOM Element Testing', () => {
    describe('Input Element Testing', () => {
      ...
      it('Element class e-daterangepicker testing', () => {
        expect(
          daterangepicker.element.classList.contains('e-daterangepicker')
        ).toBe(true);
      });
      it('Element class e-control testing', () => {
        expect(daterangepicker.element.classList.contains('e-control')).toBe(
          true
        );
      });
      ...
      it('Input Element DOM tag ', () => {
        expect(daterangepicker.inputWrapper.container.tagName == 'SPAN').toBe(
          true
        );
      });
      it('Popup button DOM tag ', () => {
        expect(daterangepicker.inputWrapper.buttons[0].tagName == 'SPAN').toBe(
          true
        );
      });
      it('Input Element focus ', () => {
        ...
        expect(
          daterangepicker.inputWrapper.container.classList.contains(
            'e-input-focus'
          )
        ).toBe(true);
      ...
      it('width string type test case ', () => {
        ...
        expect(daterangepicker.inputWrapper.container.style.width).toBe(
          '200px'
        );
      });
      ...
      it('Element role testing ', () => {
        expect(daterangepicker.element.getAttribute('role') == 'combobox').toBe(
          true
        );
      });
      it('Element name attribute testing', () => {
        expect(
          daterangepicker.firstHiddenChild.hasAttribute('name') &&
            daterangepicker.firstHiddenChild.getAttribute('name') ===
              daterangepicker.element.id
        ).toBe(true);
      });
      it('Element disabled ARIA attribute default values', () => {
        expect(
          daterangepicker.element.getAttribute('aria-disabled') == 'false'
        ).toBe(true);
      });
      it('Element Expanded ARIA attribute default values', () => {
        expect(
          daterangepicker.element.getAttribute('aria-expanded') == 'false'
        ).toBe(true);
      });
      it('Element placeholder testing ', () => {
        ...
        expect(daterangepicker.element.getAttribute('placeholder')).toBe(
      ...
      it('Element cssClass testing', () => {
        ...
        expect(
          daterangepicker.inputWrapper.container.classList.contains('e-custom')
        ).toBe(true);
      });
      ...
      it('Element readonly property testing', () => {
        ...
        expect(daterangepicker.element.hasAttribute('readonly') == true).toBe(
          true
        );
      });
      it('placeholder maintained after empty value testing ', () => {
        daterangepicker = createControl({
          placeholder: 'Select the Date Range',
          startDate: new Date('05/24/2017'),
          endDate: new Date('08/10/2017'),
        });
        daterangepicker.element.value = '';
        daterangepicker.preventBlur = false;
        daterangepicker.inputBlurHandler();
        expect(
          daterangepicker.startDate === null && daterangepicker.endDate === null
        ).toBe(true);
        expect(
          daterangepicker.inputWrapper.container.classList.contains('e-error')
        ).toBe(false);
        expect(daterangepicker.element.getAttribute('placeholder')).toBe(
          'Select the Date Range'
        );
      ...
      describe('DOM Element Testing', () => {
        describe('Input Element Testing', () => {
          ...
          it('allowedit property with true test case ', () => {
            ...
            expect(
              document
                .querySelector('.e-daterangepicker.e-popup')
                .classList.contains('e-popup')
            ).toBe(true);
          });
          ...
          it('Element created with enableRtl property', () => {
            ...
            daterangepicker.appendTo('#date');
            expect(
              daterangepicker.inputWrapper.container.classList.contains('e-rtl')
            ).toBe(true);
          });
          it('Element created with enabled property', () => {
            ...
            expect(
              daterangepicker.enabled === false &&
                daterangepicker.element.hasAttribute('disabled')
            ).toBe(true);
          ...
          it('show method with readonly property ', () => {
            ...
            expect(
              daterangepicker.readonly === true &&
                daterangepicker.element.hasAttribute('readonly')
            ).toBe(true);
            <HTMLElement>daterangepicker.inputWrapper.buttons[0].click();
            expect(daterangepicker.isPopupOpen()).toBe(false);
          });
          ...
          it('Element created with firstDayofWeek property', () => {
            ...
            daterangepicker.show();
            expect(
              document.querySelectorAll('.e-content th')[0].textContent
            ).toBe('Tu');
            expect(
              document.querySelectorAll('.e-left-calendar .e-content th')[0]
                .textContent == 'Tu' &&
                document.querySelectorAll('.e-right-calendar .e-content th')[0]
                  .textContent == 'Tu'
            ).toBe(true);
          });
          it('Element created with Format property', () => {
            ...
            daterangepicker = new DateRangePicker({
              ...
              startDate: date,
              endDate: new Date(
                new Date('04/06/2018 10:30 AM').setDate(date.getDate() + 10)
              ),
            });
            daterangepicker.appendTo('#date');
            expect(
              daterangepicker.inputElement.value ==
                '04/06/2018 10:30 AM - 04/16/2018 10:30 AM'
            ).toBe(true);
          });
          it('Element created with object type Format property', () => {
            ...
            daterangepicker.appendTo('#date');
            expect(
              daterangepicker.inputElement.value == '4/6/18 - 4/16/18'
            ).toBe(true);
          });
          ...
          it('Element created with placeholder property', () => {
            ...
            expect(
              daterangepicker.inputWrapper.container.tagName == 'SPAN'
            ).toBe(true);
            expect(
              daterangepicker.inputElement.getAttribute('placeholder')
            ).toBe('Select a range');
          });
          ...
          it('Element created with floatLabelType property with Auto type', () => {
            ...
            expect(
              daterangepicker.inputWrapper.container.tagName == 'DIV'
            ).toBe(true);
            expect(
              daterangepicker.inputWrapper.container.classList.contains(
                'e-float-input'
            ...
            expect(
              daterangepicker.inputWrapper.container.children[1].classList.contains(
                'e-float-line'
              )
            ).toBe(true);
            expect(
              daterangepicker.inputWrapper.container.children[2].classList.contains(
                'e-float-text'
              )
            ).toBe(true);
            expect(
            ...
            expect(
              daterangepicker.inputWrapper.container.children[2].innerText
            ).toBe('Select a range');
          ...
          it('disabled property with popup prevent test case', () => {
            ...
            daterangepicker.appendTo('#date');
            daterangepicker.show();
            expect(document.querySelector('.e-daterangepicker.e-popup')).toBe(
              null
            );
          });
          it('Readonly property with popup prevent test case', () => {
            ...
            daterangepicker.appendTo('#date');
            expect(
              daterangepicker.element.hasAttribute('readonly') == true
            ).toBe(true);
            daterangepicker.show();
            expect(document.querySelector('.e-daterangepicker.e-popup')).toBe(
              null
          ...
          it('autocorrect attribute test case', () => {
            ...
            daterangepicker.appendTo('#date');
            expect(
              daterangepicker.element.getAttribute('autocorrect') == 'off'
            ).toBe(true);
          });
          it('autocapitalize attribute test case', () => {
            ...
            daterangepicker.appendTo('#date');
            expect(
              daterangepicker.element.getAttribute('autocapitalize') == 'off'
            ).toBe(true);
          });
          it('spellcheck attribute test case', () => {
            ...
            daterangepicker.appendTo('#date');
            expect(
              daterangepicker.element.getAttribute('spellcheck') == 'false'
            ).toBe(true);
          });
          it('autocomplete attribute test case', () => {
            ...
            daterangepicker.appendTo('#date');
            expect(
              daterangepicker.element.getAttribute('autocomplete') == 'off'
            ).toBe(true);
          });
          /**
           * tabIndex
          ...
          it('tab index of focus element', () => {
            ...
            daterangepicker.appendTo('#date');
            expect(
              daterangepicker.inputWrapper.container.children[0].getAttribute(
                'tabindex'
              ) === '0'
            ).toBe(true);
          });
          ...
          it('tab index of focus element in disable state ', () => {
            ...
            daterangepicker.appendTo('#date');
            expect(
              daterangepicker.inputWrapper.container.children[0].tabIndex === -1
            ).toBe(true);
          ...
          it('Tab index checking while destroy the Angular component', () => {
            let element: any = createElement('ejs-daterangepicker', {
              id: 'daterange',
            });
    ...
    describe('clear button related testing', () => {
      ...
      let daterangepicker: any;
      beforeEach(() => {
        let ele: HTMLElement = <HTMLElement>(
          createElement('input', { id: 'date' })
        );
        document.body.appendChild(ele);
        daterangepicker = new DateRangePicker({
          startDate: new Date('07/05/2017'),
          endDate: new Date('05/05/2018'),
      ...
      it('clear icon', () => {
        expect(
          daterangepicker.inputWrapper.clearButton.classList.contains(
            'e-clear-icon'
          )
        ).toBe(true);
      });
      ...
      it('clear button default state', () => {
        expect(daterangepicker.startDate.valueOf()).toBe(
          new Date('07/05/2017').valueOf()
        );
        expect(daterangepicker.endDate.valueOf()).toBe(
          new Date('05/05/2018').valueOf()
        );
      ...
      it('click on clear button', () => {
        ...
        (<HTMLInputElement>(
          document.getElementsByClassName('e-clear-icon')[0]
        )).dispatchEvent(clickEvent);
    ...
    describe('Popup Element Testing', () => {
      ...
      it('Popup class testing', () => {
        expect(daterangepicker.popupWrapper.classList.contains('e-popup')).toBe(
          true
        );
      });
      it('Popup Element cssClass', () => {
        expect(
          daterangepicker.popupWrapper.classList.contains(
      ...
      it('Popup Control class testing', () => {
        expect(
          daterangepicker.popupWrapper.classList.contains('e-control')
        ).toBe(true);
      });
      it('Popup class e-daterangepicker testing', () => {
        expect(
          daterangepicker.popupWrapper.classList.contains('e-daterangepicker')
        ).toBe(true);
      });
      it('Element Expanded ARIA attribute default values', () => {
        expect(
          daterangepicker.element.getAttribute('aria-expanded') == 'true'
        ).toBe(true);
      });
      it('is Popup Element open class', () => {
        expect(
          daterangepicker.popupWrapper.classList.contains('e-popup-open')
        ).toBe(true);
      });
      ...
      it('active class added for button while Popup Element open', () => {
        expect(
          daterangepicker.inputWrapper.buttons[0].classList.contains('e-active')
        ).toBe(true);
      });
      ...
      it('is Popup Element created with ID', () => {
        expect(
          daterangepicker.popupWrapper.id ===
            daterangepicker.element.id + '_popup'
        ).toBe(true);
      });
      ...
      it('Element target testing', () => {
        let element: HTMLElement = <HTMLElement>(
          createElement('input', { id: 'daterange', attrs: { type: 'hidden' } })
        );
        document.body.appendChild(element);
        daterangepicker = new DateRangePicker({ cssClass: 'e-custom' });
        daterangepicker.appendTo('#daterange');
        let target: HTMLElement = <HTMLElement>(
          createElement('input', { id: 'target' })
        );
        ...
        expect(
          daterangepicker.targetElement === target &&
            daterangepicker.popupObj.relateTo === target
        ).toBe(true);
        let e: any = {
          preventDefault: (): void => {
            /** NO Code */
    ...
    describe('Set Model testing', () => {
      ...
      it('multiple cssClass  test case', () => {
        ...
        daterangepicker.dataBind();
        expect(
          daterangepicker.inputWrapper.container.classList.contains('e-ternary')
        ).toBe(true);
        expect(
          daterangepicker.inputWrapper.container.classList.contains(
            'e-cssClass'
        ...
        daterangepicker.show();
        expect(
          daterangepicker.popupWrapper.classList.contains('e-ternary')
        ).toBe(true);
        expect(
          daterangepicker.popupWrapper.classList.contains('e-cssClass')
        ).toBe(true);
      });
      it('Element disable testing', () => {
        daterangepicker.enabled = false;
        ...
        expect(
          daterangepicker.enabled === false &&
            daterangepicker.element.hasAttribute('disabled') &&
            daterangepicker.element.getAttribute('aria-disabled') == 'true'
        ).toBe(true);
      });
      it('Element readonly property testing', () => {
        daterangepicker.readonly = true;
      ...
      it('Element Value testing ', () => {
        ...
        expect(
          +daterangepicker.startDate === +new Date('02/11/2001') &&
            daterangepicker.isPopupOpen() == false
        ).toBe(true);
        expect(
          +daterangepicker.startDate === +new Date('02/11/2001') &&
            daterangepicker.isPopupOpen() == false
      ...
      it('range separator testing', () => {
        ...
        expect(
          daterangepicker.separator === '+' &&
            daterangepicker.element.value.indexOf('+') > -1
        ).toBe(true);
      });
      it('Element format testing', () => {
        daterangepicker = createControl({
          startDate: new Date('05/24/2017'),
          endDate: new Date('08/10/2018'),
        });
        daterangepicker.format = 'y';
        daterangepicker.dataBind();
        expect(
          daterangepicker.format === 'y' &&
            daterangepicker.element.value === '2017 - 2018' &&
            daterangepicker.isPopupOpen() == false
        ).toBe(true);
      });
      ...
      it('zIndex default value ', () => {
        ...
        document
          .querySelector('.e-left-calendar .e-header .e-date-icon-prev')
          .dispatchEvent(clickEvent);
      });
      ...
      it('Firstdayofweek property testing', () => {
        ...
        expect(document.querySelectorAll('.e-content th')[0].textContent).toBe(
          'Mo'
        );
        expect(
          document.querySelectorAll('.e-left-calendar .e-content th')[0]
      ...
      it('Floatlabeltype property with Auto type', () => {
        ...
        daterangepicker.appendTo('#date');
        expect(daterangepicker.floatLabelType).toBe('Auto');
        expect(daterangepicker.inputWrapper.container.tagName == 'DIV').toBe(
          true
        );
        expect(
          daterangepicker.inputWrapper.container.classList.contains(
      ...
      it('Floatlabeltype with Never type', () => {
        ...
        expect(daterangepicker.inputElement.getAttribute('placeholder')).toBe(
          'Select a range'
        );
        expect(
          daterangepicker.inputWrapper.container.children[2].classList.contains(
      ...
      it('Weeknumber prooperty testing', () => {
        ...
        expect(
          daterangepicker.popupObj.element.querySelectorAll('.e-week-number')
            .length > 0
        ).toBe(true);
      });
      it('Presets testing', () => {
        ...
        <HTMLElement>(
          daterangepicker.popupObj.element
            .querySelector('.e-presets li:first-child')
            .click()
        );
        let startDate: string = daterangepicker.globalize.formatDate(
          daterangepicker.startDate,
          { format: daterangepicker.format, type: 'date', skeleton: 'yMd' }
        );
        let endDate: string = daterangepicker.globalize.formatDate(
          daterangepicker.endDate,
          { format: daterangepicker.format, type: 'date', skeleton: 'yMd' }
        );
        expect(
          daterangepicker.element.value === startDate + ' - ' + endDate
        ).toBe(true);
      });
      it('Error Class for start value before 1905-Chrome testing', () => {
        ...
        expect(
          (<HTMLElement>(
            document.getElementsByClassName('e-date-range-wrapper')[0]
          )).classList.contains('e-error')
        ).toBe(false);
    ...
    describe('Input via attribute testing', () => {
      ...
      it('name attribute testing', () => {
        ...
        daterangepicker = new DateRangePicker();
        daterangepicker.appendTo('#date');
        expect(daterangepicker.firstHiddenChild.getAttribute('name')).toEqual(
          'dateRangePicker1'
        );
      });
      ...
      it('style attribute testing', () => {
        ...
        daterangepicker = new DateRangePicker();
        daterangepicker.appendTo('#date');
        expect(daterangepicker.element.getAttribute('style')).toEqual(
      ...
      it('Element placeholder testing ', () => {
        ...
        expect(
          daterangepicker.placeholder === 'Select the Date Range' &&
            daterangepicker.element.getAttribute('placeholder') ===
              'Select the Date Range'
        ).toBe(true);
      });
      ...
      it('Element startDate testing ', () => {
        ...
        daterangepicker.appendTo('#date');
        expect(
          daterangepicker.startDate.toDateString() ===
            new Date('02/11/2001').toDateString()
        ).toBe(true);
      });
      it('Element Model startDate testing ', () => {
        ele.setAttribute('startDate', '02/11/2001');
        daterangepicker = new DateRangePicker({
          startDate: new Date('5/24/2017'),
        });
        daterangepicker.appendTo('#date');
        expect(
          daterangepicker.startDate.toDateString() ===
            new Date('5/24/2017').toDateString()
        ).toBe(true);
      });
      it('Element endDate testing ', () => {
        ...
        daterangepicker.appendTo('#date');
        expect(
          daterangepicker.endDate.toDateString() ===
            new Date('03/11/2001').toDateString()
        ).toBe(true);
      });
      it('Element minDays property testing', () => {
      ...
      it('Element min property testing', () => {
        ...
        daterangepicker.appendTo('#date');
        expect(
          daterangepicker.min.toDateString() ===
            new Date('1/1/2017').toDateString()
        ).toBe(true);
      });
      ...
      it('Element max property testing', () => {
        ...
        daterangepicker.appendTo('#date');
        expect(
          daterangepicker.max.toDateString() ===
            new Date('12/1/2017').toDateString()
        ).toBe(true);
      });
    });
    describe('PopUp Element Structure(Desktop)', () => {
      ...
      it('DateRange container is added', () => {
        expect(
          daterangepicker.popupWrapper.querySelector(
      ...
      it('Footer Element added', () => {
        expect(
          daterangepicker.popupWrapper.querySelector('.e-footer') !== null
        ).toBe(true);
      });
      it('Footer Element added after DateRange container', () => {
        expect(
          daterangepicker.popupWrapper
            .querySelector('.e-date-range-container')
            .nextSibling.classList.contains('e-footer')
        ).toBe(true);
      });
      it('Action Buttons(Apply and cancel) created', () => {
        expect(
          daterangepicker.popupWrapper
            .querySelector('.e-footer')
            .getElementsByClassName('e-cancel').length > 0 &&
            daterangepicker.popupWrapper
              .querySelector('.e-footer')
              .getElementsByClassName('e-apply').length > 0
        ).toBe(true);
      });
      it('Start and end label created', () => {
        expect(
          daterangepicker.popupWrapper
            .querySelector('.e-start-end')
            .getElementsByClassName('e-start-label').length > 0 &&
            daterangepicker.popupWrapper
              .querySelector('.e-start-end')
              .getElementsByClassName('e-end-label').length > 0
        ).toBe(true);
      });
      it('Seperator element created', () => {
        expect(
          daterangepicker.popupWrapper.querySelector('.e-separator') !== null
        ).toBe(true);
      });
      it('Seperator element added after range header', () => {
        expect(
          daterangepicker.popupWrapper
            .querySelector('.e-separator')
            .previousElementSibling.classList.contains('e-range-header') !==
            null
        ).toBe(true);
      });
      it('Range Indicator created', () => {
        expect(
          daterangepicker.popupWrapper.querySelector('.e-day-span') !== null
        ).toBe(true);
      });
      it('Range Indicator created after start and end header', () => {
        expect(
          daterangepicker.popupWrapper
            .querySelector('.e-start-end')
            .nextElementSibling.classList.contains('e-day-span') !== null
        ).toBe(true);
      });
      it('two Calendars created', () => {
        expect(
          daterangepicker.popupWrapper.querySelectorAll('.e-calendar').length ==
            2
        ).toBe(true);
      });
      it('first Calendar class added', () => {
        expect(
          daterangepicker.popupWrapper
            .querySelectorAll('.e-calendar')[0]
            .classList.contains('e-left-calendar')
        ).toBe(true);
      });
      it('Second Calendar class added', () => {
        expect(
          daterangepicker.popupWrapper
            .querySelectorAll('.e-calendar')[1]
            .classList.contains('e-right-calendar')
        ).toBe(true);
      });
      it('Left Calendar created inside left container', () => {
        expect(
          daterangepicker.popupWrapper
            .querySelector('.e-left-container')
            .firstChild.classList.contains('e-left-calendar')
        ).toBe(true);
      });
      it('Right Calendar created inside right container', () => {
        expect(
          daterangepicker.popupWrapper
            .querySelector('.e-right-container')
            .firstChild.classList.contains('e-right-calendar')
        ).toBe(true);
      });
      it('is Successive months generated ?', () => {
        expect(
          daterangepicker.popupObj.element
            .querySelector('.e-left-calendar .e-title')
            .textContent.indexOf(months[new Date().getMonth()]) > -1 &&
            daterangepicker.popupObj.element
              .querySelector('.e-right-calendar .e-title')
              .textContent.indexOf(months[new Date().getMonth() + 1]) > -1
        ).toBe(true);
      });
      it('is icons disabled correctly in successive months?', () => {
        expect(
          daterangepicker.popupObj.element
            .querySelector('.e-left-calendar .e-next')
            .classList.contains('e-disabled') &&
            daterangepicker.popupObj.element
              .querySelector('.e-right-calendar .e-prev')
              .classList.contains('e-disabled')
        ).toBe(false);
      });
      it('Left calendar Date Selection in calendar', () => {
        let tdCell: HTMLElement =
          daterangepicker.popupObj.element.querySelectorAll(
            '.e-left-calendar .e-content td'
          )[10];
        tdCell.dispatchEvent(clickEvent);
        let date: Date = daterangepicker.getIdValue(null, tdCell);
        expect(
          daterangepicker.popupObj.element.querySelector('.e-start-date') !==
            null &&
            daterangepicker.globalize.formatDate(date, {
              type: 'date',
              skeleton: 'yMMMd',
            }) ===
              daterangepicker.popupObj.element.querySelector('.e-start-label')
                .text
        ).toBe(true);
      });
        ...
        expect(
          daterangepicker.popupObj.element.querySelector('.e-start-date') !==
            ...
            daterangepicker.globalize.formatDate(date, {
              ...
              daterangepicker.popupObj.element.querySelector('.e-end-label')
                .text
        ).toBe(true);
      });
      it('is header navigation disabled ?', () => {
        let elements: CalendarElement = getCalendarElement(
          daterangepicker.popupObj.element
        );
        ...
        expect(
          daterangepicker.popupObj.element
            .querySelector('.e-left-calendar .e-content')
            .classList.contains('e-month') &&
            daterangepicker.popupObj.element
              .querySelector('.e-right-calendar .e-content')
              .classList.contains('e-month')
        ).toBe(false);
      });
      it('Right Calendar Navigated next month?', () => {
        ...
        expect(
          daterangepicker.popupObj.element.querySelector(
            '.e-right-calendar .e-title'
          ).text !== value
        ).toBe(true);
      });
      ...
      it('is calendar rendered with given value ?', () => {
        ...
        expect(
          daterangepicker.popupObj.element
            .querySelector('.e-left-calendar .e-title')
            .textContent.indexOf('July') > -1 &&
            daterangepicker.popupObj.element
              .querySelector('.e-right-calendar .e-title')
              .textContent.indexOf('May 2018') > -1
        ).toBe(true);
      });
      it('Setting min range to be selected ?', () => {
        daterangepicker.destroy();
        daterangepicker = createControl({
          startDate: new Date('07/06/2017'),
          endDate: new Date('08/06/2017'),
        ...
        expect(
          daterangepicker.popupObj.element
            .querySelector('.e-left-calendar .e-prev')
            .classList.contains('e-disabled')
        ).toBe(true);
      });
      it('Setting max range to be selected ?', () => {
        ...
        daterangepicker = createControl({
          startDate: new Date('07/06/2017'),
          endDate: new Date('08/06/2017'),
          max: new Date('10/05/2017'),
        });
        let elements: CalendarElement = getCalendarElement(
          daterangepicker.popupObj.element
        );
        document
          .querySelector('.e-right-calendar .e-header .e-date-icon-next')
          .dispatchEvent(clickEvent);
        document
          .querySelector('.e-right-calendar .e-header .e-date-icon-next')
          .dispatchEvent(clickEvent);
        expect(
          daterangepicker.popupObj.element
            .querySelector('.e-right-calendar .e-next')
            .classList.contains('e-disabled')
        ).toBe(true);
      });
      it('range restricted while navigating next left calendar ?', () => {
        daterangepicker = createControl({
          startDate: new Date('07/06/2017'),
          endDate: new Date('10/05/2017'),
        });
        let elements: CalendarElement = getCalendarElement(
          daterangepicker.popupObj.element
        );
        document
          .querySelector('.e-left-calendar .e-header .e-date-icon-next')
          .dispatchEvent(clickEvent);
        document
          .querySelector('.e-left-calendar .e-header .e-date-icon-next')
          .dispatchEvent(clickEvent);
      ...
      it('range restricted while navigating previous left calendar ?', () => {
        daterangepicker = createControl({
          startDate: new Date('06/06/2017'),
          endDate: new Date('08/05/2017'),
          min: new Date('04/05/2017'),
        });
        let elements: CalendarElement = getCalendarElement(
          daterangepicker.popupObj.element
        );
      ...
      it('Apply button disabled after clear the range selection', () => {
        ...
        expect(daterangepicker.applyButton.disabled === false).toBe(true);
        daterangepicker.element.focus();
        let clearCell: HTMLElement =
          daterangepicker.inputWrapper.container.querySelectorAll(
            '.e-clear-icon'
          )[0];
      ...
      it('Rtl enabled ?', () => {
        ...
        expect(
          daterangepicker.popupObj.element.classList.contains('e-rtl')
        ).toBe(true);
      });
      ...
      it('Header title with out of range test case', () => {
        ...
        expect(
          daterangepicker.popupObj.element.querySelector('.e-day-span')
            .textContent
        ).toBe('Selected Days');
      });
      it('StartDate and endDate in out of range test case', () => {
        ...
        expect(
          daterangepicker.startDate.toDateString() ===
            new Date('07/06/2017').toDateString()
        ).toBe(true);
        expect(
          daterangepicker.endDate.toDateString() ===
            new Date('08/06/9999').toDateString()
        ).toBe(true);
        expect(
          daterangepicker.inputWrapper.container.classList.contains('e-error')
        ).toBe(true);
    ...
    describe('PopUp Presets Element Structure(Desktop)', () => {
      ...
      it('preset class Element created', () => {
        expect(
          daterangepicker.popupObj.element.querySelector('.e-presets') !== null
        ).toBe(true);
      });
      it('list item class Element added', () => {
        expect(
          daterangepicker.popupObj.element.querySelectorAll('.e-list-item')
            .length === 3
        ).toBe(true);
      });
      ...
      it('preset list li Element created', () => {
        expect(
          daterangepicker.popupObj.element
            ...
            .getElementsByTagName('li').length == 3
        ).toBe(true);
      });
      it('preset list Custom LI Element created', () => {
        expect(
          daterangepicker.popupObj.element
            .querySelector('.e-presets  li:last-child')
            .textContent.indexOf('Custom') > -1
        ).toBe(true);
      });
      it('Presets custom ranges selection', () => {
        ...
        expect(
          daterangepicker.popupObj.element.querySelector(
            ...
            daterangepicker.popupObj.element.querySelectorAll('.e-calendar')
              .length > 0
        ).toBe(true);
      });
      ...
      it('Preset range selection', () => {
        ...
        expect(
          daterangepicker.isPopupOpen() === true &&
            daterangepicker.element.value === startDate + ' - ' + endDate
        ).toBe(true);
      });
      it('is preset only created while opening again', () => {
        ...
        expect(
          daterangepicker.popupObj.element.querySelector(
            ...
            daterangepicker.popupObj.element.querySelector('.e-presets') !==
              null
        ).toBe(true);
        expect(
          daterangepicker.popupObj.element
    ...
    describe('Preset', () => {
      ...
      beforeEach(() => {
        ...
        daterangepicker = new DateRangePicker({
          ...
          presets: [
            ...
            {
              label: 'Test',
              start: new Date('03/03/2017 2:00'),
              end: new Date('04/03/2017 2:00'),
            },
          ],
        });
        daterangepicker.appendTo('#date');
      ...
      it('selection with datetime support in higher resolution', () => {
        expect(
          daterangepicker.popupObj.element
            .querySelector('.e-presets li.e-active')
            .classList.contains('e-active')
        ).toBe(true);
        expect(
          document.querySelector('.e-presets li:first-child').textContent
        ).toBe('Today');
        daterangepicker.hide();
        ...
        expect(
          document.querySelector('.e-presets li.e-active').textContent
        ).toBe('Test');
        <HTMLElement>daterangepicker.inputWrapper.buttons[0].click();
    ...
    describe('PopUp Element Structure(Device)', () => {
      ...
      it('Device class added', () => {
        expect(
          daterangepicker.popupWrapper.classList.contains('.e-device') !== null
        ).toBe(true);
      });
      it('DateRange container is added', () => {
        expect(
          daterangepicker.popupWrapper.querySelector(
            '.e-device .e-date-range-container'
          ) !== null
        ).toBe(true);
      });
      it('Footer Element added', () => {
        expect(
          daterangepicker.popupWrapper.querySelector('.e-device .e-footer') !==
            null
        ).toBe(true);
      });
      it('Footer Element added after DateRange container', () => {
        expect(
          daterangepicker.popupWrapper
            .querySelector('.e-device .e-date-range-container')
            .nextElementSibling.classList.contains('e-footer')
        ).toBe(true);
      });
      it('Action Buttons(Apply and cancel) created', () => {
        expect(
          daterangepicker.popupWrapper
            .querySelector('.e-device .e-footer')
            .getElementsByClassName('e-cancel').length > 0 &&
            daterangepicker.popupWrapper
              .querySelector('.e-footer')
              .getElementsByClassName('e-apply').length > 0
      ...
      it('Buttons(start and and) created', () => {
        expect(
          daterangepicker.popupWrapper.querySelector(
            '.e-device .e-start-btn'
          ) !== null &&
            daterangepicker.popupWrapper.querySelector('.e-end-btn') !== null
        ).toBe(true);
        expect(
          daterangepicker.popupObj.element
            .querySelector('.e-start-btn')
            .classList.contains('e-active') &&
            !daterangepicker.popupObj.element
              .querySelector('.e-end-btn')
              .classList.contains('e-active')
        ).toBe(true);
      });
      it('Seperator element created', () => {
      ...
      it('Seperator element added after range header', () => {
        expect(
          daterangepicker.popupWrapper
            .querySelector('.e-device .e-separator')
            .previousSibling.classList.contains('e-range-header') !== null
        ).toBe(true);
      });
      it('Range Indicator created', () => {
        expect(
      ...
      it('Only one calendar created ?', () => {
        expect(
          daterangepicker.popupWrapper.querySelectorAll('.e-device .e-calendar')
            .length == 1
        ).toBe(true);
      });
      it('is header navigation disabled ?', () => {
        <HTMLElement>(
          daterangepicker.popupWrapper
            .querySelector('.e-device .e-calendar .e-title')
            .click()
        );
        expect(
          daterangepicker.popupObj.element
            .querySelector('.e-device .e-calendar .e-content')
            .classList.contains('e-month')
        ).toBe(false);
      });
      it('Calendar Navigated next month?', () => {
        let value: string = daterangepicker.popupWrapper.querySelector(
          '.e-device .e-calendar .e-title'
        ).text;
        <HTMLElement>(
          daterangepicker.popupWrapper
            .querySelector('.e-device .e-calendar .e-next')
            .dispatchEvent(clickEvent)
        );
        expect(
          daterangepicker.popupObj.element.querySelector(
      ...
      it('Calendar Navigated previous month?', () => {
        ...
        <HTMLElement>(
          daterangepicker.popupWrapper
            .querySelector('.e-device .e-calendar .e-prev')
            .dispatchEvent(clickEvent)
        );
        expect(
          daterangepicker.popupObj.element.querySelector(
      ...
      it('Setting min range to be selected ?', () => {
        ...
        let elements: DeviceCalendarElement = getDeviceCalendarElement(
          daterangepicker.popupObj.element
        );
      ...
      it('Apply button enabled after range selection', () => {
        ...
        expect(
          daterangepicker.popupObj.element.querySelector('.e-start-date') !==
            null && daterangepicker.applyButton.disabled === true
        ).toBe(true);
        let tdCell: HTMLElement =
          daterangepicker.popupObj.element.querySelectorAll(
            '.e-calendar .e-content td'
        ...
        tdCell.dispatchEvent(clickEvent);
        expect(
          daterangepicker.popupObj.element.querySelector('.e-end-date') !==
            null && daterangepicker.applyButton.disabled === false
        ).toBe(true);
      });
      it('Header Button state - end disabled', () => {
        ...
        expect(
          daterangepicker.popupObj.element
            .querySelector('.e-device .e-end-btn')
      ...
      it('Device end header click', () => {
        ...
        expect(
          daterangepicker.popupObj.element.querySelector(
            ...
            daterangepicker.popupObj.element.querySelector(
              '.e-device .e-calendar .e-start-date'
            ) === null
        ).toBe(true);
      });
      it('Device start header click', () => {
        ...
        expect(
          daterangepicker.popupObj.element.querySelector(
            '.e-device .e-calendar .e-end-date'
          ) !== null &&
            daterangepicker.popupObj.element.querySelector(
              '.e-device .e-calendar .e-start-date'
            ) === null
        ...
        <HTMLElement>(
          daterangepicker.popupWrapper
            .querySelector('.e-device .e-start-btn')
            .click()
        );
        expect(
          daterangepicker.popupObj.element.querySelector(
      ...
      it('Modal element added?', () => {
        expect(document.body.querySelector('.e-range-modal') !== null).toBe(
          true
        );
      });
    ...
    describe('PopUp full-screen Element Structure(Device)', () => {
      ...
      it('e-popup-expand class added', () => {
        expect(
          daterangepicker.popupWrapper.classList.contains('.e-popup-expand') !==
            null
        ).toBe(true);
      });
    });
    ...
    describe('Model full screen layout input element', function () {
      let daterangepicker: any;
      beforeEach(() => {
        let androidPhoneUa: string =
          'Mozilla/5.0 (Linux; Android 4.3; Nexus 7 Build/JWR66Y) ' +
    ...
    describe('Header Element (Device)', () => {
      ...
      it('Disabled Date in range with header update in endDate disabled test case', function () {
        ...
        expect(
          daterangepicker.popupObj.element.querySelector('.e-start-btn')
            .textContent
        ).toBe('Start Date');
        expect(
          daterangepicker.popupObj.element.querySelector('.e-end-btn')
            .textContent
        ).toBe('End Date');
        expect(
          daterangepicker.popupObj.element.querySelector('.e-day-span')
    ...
    describe('PopUp Presets Element Structure(Device)', () => {
      ...
      it('device class Element created', () => {
        expect(
          daterangepicker.popupObj.element.classList.contains('e-device')
        ).toBe(true);
      });
      it('preset class Element created', () => {
        expect(
  ...
  describe('multiple attributes testing', () => {
    ...
    it('mindays and startdate desktop test case ', () => {
      ...
      let selectedCell: HTMLElement = <HTMLElement>(
        daterangepicker.popupObj.element.querySelectorAll('.e-selected')[0]
      );
    ...
    it('mindays and startdate mobile test case ', () => {
      ...
      let previousCell: HTMLElement = <HTMLElement>(
        selectedCell.previousElementSibling
      );
      let nextCell: HTMLElement = <HTMLElement>selectedCell.nextElementSibling;
      ...
      let startButtonelement = <HTMLElement>(
        document.getElementsByClassName(' e-start-btn ')[0]
      );
      let endButtonelement = <HTMLElement>(
        document.getElementsByClassName(' e-end-btn ')[0]
      );
  ...
  describe('Range Selection - Model', () => {
    ...
    it('Selection maintained while navigating(end)', () => {
      let nextEventArgs: any = {
        ...
        currentTarget: document.querySelector(
          '.e-right-calendar .e-header .e-next'
        ),
      ...
      let prevEventArgs: any = {
        ...
        currentTarget: document.querySelector(
          '.e-right-calendar .e-header .e-prev'
        ),
      ...
      expect(
        daterangepicker.popupObj.element.querySelectorAll('.e-end-date')
          .length > 0
      ).toBe(true);
    });
    ...
    it('Selection through model', () => {
      ...
      expect(
        daterangepicker.inputElement.value ===
          startDate + ' ' + daterangepicker.separator + ' ' + endDate
      ).toBe(true);
    });
    it('Start Date Selected correctly', () => {
      let startValue: Date = daterangepicker.getIdValue(
        null,
        daterangepicker.popupObj.element.querySelector('.e-start-date')
      );
    ...
    it('End Date Selected correctly', () => {
      let endValue: Date = daterangepicker.getIdValue(
        null,
        daterangepicker.popupObj.element.querySelector('.e-end-date')
      );
    ...
    it('Start and End header', () => {
      ...
      expect(
        daterangepicker.popupObj.element.querySelector('.e-start-label')
          .text ===
          daterangepicker.globalize.formatDate(startValue, {
            type: 'date',
            skeleton: 'yMMMd',
          }) &&
          daterangepicker.popupObj.element.querySelector('.e-end-label')
            .text ===
            daterangepicker.globalize.formatDate(endValue, {
              type: 'date',
              skeleton: 'yMMMd',
            })
      ).toBe(true);
    ...
    it('hover Class added', () => {
      let cells: HTMLElement[] =
        daterangepicker.popupObj.element.querySelectorAll('.e-range-hover');
    ...
    it('Selection maintained while navigating(start)', () => {
      ...
      expect(
        daterangepicker.popupObj.element.querySelectorAll('.e-start-date')
          .length > 0
      ).toBe(true);
    });
    ...
    it('Selection Cleared', () => {
      <HTMLElement>(
        daterangepicker.popupObj.element
          .querySelectorAll('.e-calendar td')[10]
          .dispatchEvent(clickEvent)
      );
      expect(daterangepicker.applyButton.disabled == true).toBe(true);
      expect(
        daterangepicker.popupObj.element.querySelectorAll('.e-range-hover')
          .length == 0 &&
          daterangepicker.popupObj.element.querySelector('.e-end-date') === null
      ).toBe(true);
    });
    it('Range indicator', () => {
      expect(
    ...
    it('seperator value updated', () => {
      ...
      expect(
        daterangepicker.element.value.indexOf(daterangepicker.separator) > -1
      ).toBe(true);
    });
    it('start date only - start Month Opened', () => {
      ...
      expect(
        daterangepicker.popupObj.element
          .querySelector('.e-left-calendar .e-title')
          .textContent.indexOf('May') > -1 &&
          daterangepicker.popupObj.element.querySelector(
            '.e-left-calendar .e-start-date'
          ) !== null
      ).toBe(true);
      expect(daterangepicker.inputElement.value === '').toBe(true);
      expect(
        daterangepicker.endDate === null &&
          +daterangepicker.startDate === +new Date('05/24/2017')
      ).toBe(true);
    });
    it('end Date only', () => {
      daterangepicker.element.value = '';
    ...
    it('Range updated in input', () => {
      ...
      daterangepicker.inputBlurHandler();
      expect(
        +new Date('1/3/2017') === +daterangepicker.startDate &&
          +new Date('11/3/2017') === +daterangepicker.endDate
      ).toBe(true);
      expect(
        daterangepicker.globalize.formatDate(daterangepicker.startDate, {
          format: daterangepicker.format,
          type: 'date',
          skeleton: 'yMd',
        }) === '1/3/2017'
      ).toBe(true);
    ...
    it('Range updated in calendar', () => {
      ...
      let startDate: Date = daterangepicker.getIdValue(
        null,
        daterangepicker.popupObj.element.querySelector('.e-start-date')
      );
      let endDate: Date = daterangepicker.getIdValue(
        null,
        daterangepicker.popupObj.element.querySelector('.e-end-date')
      );
      expect(
        daterangepicker.globalize.formatDate(startDate, {
          format: daterangepicker.format,
          type: 'date',
          skeleton: 'yMd',
        }) === '1/3/2017' &&
          daterangepicker.globalize.formatDate(endDate, {
            format: daterangepicker.format,
            type: 'date',
            skeleton: 'yMd',
          }) === '11/3/2017'
    ...
    it('error class for invalid date(Date)', () => {
      ...
      expect(
        daterangepicker.endDate === null && daterangepicker.startDate === null
      ).toBe(true);
    });
    ...
    it('error class for startDate greater than end date', () => {
      ...
      expect(
        +daterangepicker.endDate === +new Date('08/10/2017') &&
          +daterangepicker.startDate === +new Date('09/24/2017')
      ).toBe(true);
      expect(daterangepicker.element.value === '9/24/2017 - 8/10/2017').toBe(
        true
      );
    });
    it('Same date for start and end', () => {
      ...
      daterangepicker = createControl({
        startDate: new Date('09/24/2017'),
        endDate: new Date('09/24/2017'),
      });
      expect(+daterangepicker.startDate === +daterangepicker.endDate).toBe(
        true
      );
      expect(
        daterangepicker.popupObj.element
          .querySelector('.e-end-date')
          .classList.contains('e-start-date')
      ).toBe(true);
    });
    ...
    it('error class for startDate greater than end date(enter)', () => {
      ...
      expect(
        +daterangepicker.endDate === +new Date('1/3/2017') &&
          +daterangepicker.startDate === +new Date('3/3/2017')
      ).toBe(true);
    });
    it('error class for startDate greater than end date(Set Model)', () => {
      ...
      expect(daterangepicker.element.value === '5/24/2017 - 1/1/2017').toBe(
        true
      );
    });
    it('icon disabled in last and first month', () => {
      ...
      daterangepicker.destroy();
      daterangepicker = createControl({
        startDate: new Date('12/24/2017'),
        endDate: new Date('1/24/2018'),
      });
      expect(
        daterangepicker.popupObj.element
          .querySelector('.e-left-calendar .e-next')
  ...
  describe('Range Selection - Interaction', () => {
    ...
    beforeEach(() => {
      ...
      startEle = daterangepicker.popupObj.element.querySelectorAll(
        '.e-left-calendar.e-calendar td'
      )[10];
      startValue = daterangepicker.getIdValue(null, startEle);
      endEle = daterangepicker.popupObj.element.querySelectorAll(
        '.e-right-calendar.e-calendar td'
      )[10];
    ...
    it('Added hover class inbetween start and end', () => {
      startEle.dispatchEvent(clickEvent);
      mouseEventArgs.currentTarget =
        startEle.nextElementSibling.nextElementSibling;
    ...
    it('Start date updated', () => {
      ...
      <HTMLElement>(
        daterangepicker.popupObj.element
          .querySelectorAll('.e-left-calendar.e-calendar td')[5]
          .click()
      );
      expect(
        daterangepicker.popupObj.element.querySelectorAll('.e-start-date')
    ...
    it('end date selected selecting start date again', () => {
      ...
      expect(
        daterangepicker.popupObj.element
          .querySelector('.e-start-date')
          .classList.contains('e-end-date')
      ).toBe(true);
    ...
    it('selected date after navigating', () => {
      ...
      <HTMLElement>(
        daterangepicker.popupObj.element
          .querySelectorAll('.e-right-calendar.e-calendar td')[10]
          .dispatchEvent(clickEvent)
      );
      expect(
        daterangepicker.popupObj.element.querySelectorAll('.e-start-date')
    ...
    it('Selection Cleared', () => {
      ...
      <HTMLElement>(
        daterangepicker.popupObj.element
          .querySelectorAll('.e-right-calendar.e-calendar td')[15]
          .dispatchEvent(clickEvent)
      );
      expect(daterangepicker.applyButton.disabled == true).toBe(true);
      expect(
      ...
      expect(
        daterangepicker.popupObj.element.querySelector('.e-day-span')
          ...
          (
            Math.round(
              Math.abs(
                (daterangepicker.startValue.getTime() -
                  daterangepicker.endValue.getTime()) /
                  (1000 * 60 * 60 * 24)
              )
            ) + 1
          ).toString() +
      ...
      expect(
        daterangepicker.popupObj.element.querySelector('.e-day-span')
          ...
          (
            Math.round(
              Math.abs(
                (daterangepicker.startDate.getTime() -
                  daterangepicker.endDate.getTime()) /
                  (1000 * 60 * 60 * 24)
              )
            ) + 1
          ).toString() +
    ...
    it('is calendar moved to left when range in right calendar', () => {
      let startEle: HTMLElement = <HTMLElement>(
        daterangepicker.popupObj.element.querySelectorAll(
          '.e-right-calendar.e-calendar td'
        )[10]
      );
      let endEle: HTMLElement = <HTMLElement>(
        daterangepicker.popupObj.element.querySelectorAll(
          '.e-right-calendar.e-calendar td'
        )[15]
      );
      ...
      expect(
        daterangepicker.popupObj.element
          .querySelector('.e-left-calendar')
          .querySelector('.e-start-date') !== null &&
          daterangepicker.popupObj.element
            .querySelector('.e-left-calendar')
            .querySelector('.e-end-date') !== null
      ).toBe(true);
    });
    it('previous value maintained while cancel', () => {
      ...
      expect(
        +startValue !== +daterangepicker.startDate &&
          +endValue !== +daterangepicker.endDate
      ).toBe(true);
    });
    it('WeekNumber not selected', () => {
      ...
      let ele: HTMLElement = <HTMLElement>(
        daterangepicker.popupObj.element.querySelectorAll(
          '.e-left-calendar.e-calendar .e-week-number'
        )[1]
      );
  ...
  describe('Device Range Selection - Model', () => {
    ...
    beforeEach(() => {
      ...
      document.body.appendChild(ele);
      daterangepicker = createControl(
        { startDate: new Date('05/04/2017'), endDate: new Date('05/24/2017') },
        true
      );
    });
    afterEach(() => {
    ...
    it('start date only - start month opened', () => {
      ...
      expect(
        daterangepicker.popupObj.element
          .querySelector('.e-calendar .e-title')
          .textContent.indexOf('May') > -1 &&
          daterangepicker.popupObj.element.querySelector(
            '.e-calendar .e-start-date'
          ) !== null
      ).toBe(true);
      expect(daterangepicker.inputElement.value === '').toBe(true);
      expect(
    ...
    it('previous value maintained while cancel', () => {
      let startEle: HTMLElement = <HTMLElement>(
        daterangepicker.popupObj.element.querySelectorAll('.e-calendar td')[10]
      );
      let endEle: HTMLElement = <HTMLElement>(
        daterangepicker.popupObj.element.querySelectorAll('.e-calendar td')[19]
      );
      let startValue: Date = daterangepicker.getIdValue(null, startEle);
      let endValue: Date = daterangepicker.getIdValue(null, endEle);
      startEle.dispatchEvent(clickEvent);
    ...
    it('Invalid Date Set Model', () => {
      ...
      expect(
        daterangepicker.endDate === null &&
          +daterangepicker.startDate === +new Date('07/10/2017')
      ).toBe(true);
    ...
    it('endDate repicked ?', () => {
      ...
      daterangepicker.popupObj.element
        .querySelectorAll('.e-calendar td')[16]
        .dispatchEvent(clickEvent);
      expect(+daterangepicker.endValue !== +new Date('05/24/2017')).toBe(true);
      <HTMLElement>(
        daterangepicker.applyButton.element.dispatchEvent(clickEvent)
      );
      if (!daterangepicker.isPopupOpen()) {
        <HTMLElement>(
          daterangepicker.inputWrapper.buttons[0].dispatchEvent(clickEvent)
  ...
  describe('Device Range Selection-Interaction', () => {
    ...
    beforeEach(() => {
      ...
      startValue = daterangepicker.getIdValue(null, startEle);
      endEle =
        daterangepicker.popupObj.element.querySelectorAll('.e-calendar td')[15];
      endValue = daterangepicker.getIdValue(null, endEle);
    });
    afterEach(() => {
      if (daterangepicker) {
    ...
    it('Start date updated', () => {
      ...
      <HTMLElement>(
        daterangepicker.popupObj.element
          .querySelectorAll('.e-calendar td')[7]
          .dispatchEvent(clickEvent)
      );
      expect(
        daterangepicker.popupObj.element.querySelectorAll('.e-start-date')
    ...
    it('Selection Cleared(startBtn)', () => {
      ...
      <HTMLElement>(
        daterangepicker.popupObj.element
          .querySelectorAll('.e-calendar td')[15]
          .dispatchEvent(clickEvent)
      );
      expect(daterangepicker.applyButton.disabled == true).toBe(true);
      expect(
    ...
    it('endDate repicked ?', () => {
      ...
      expect(
        +daterangepicker.endDate === endValue.setDate(endValue.getDate() + 1)
      ).toBe(true);
    });
    ...
    it('date disabled before startDate ?', () => {
      ...
      startEle =
        daterangepicker.popupObj.element.querySelectorAll('.e-calendar td')[9];
    ...
    it('date disabled removed start header click ?', () => {
      ...
      expect(elements.previousIcon.classList.contains('e-disabled')).toBe(
        false
      );
      startEle =
        daterangepicker.popupObj.element.querySelectorAll('.e-calendar td')[9];
  ...
  describe('Min/Max test case -  Desktop', () => {
    ...
    it('min and max null value', () => {
      ...
      expect(
        +daterangepicker.min === +new Date(1900, 0, 1) &&
          +daterangepicker.max === +new Date(2099, 11, 31)
      ).toBe(true);
    });
    it('min value greater than max', () => {
      daterangepicker = createControl({
        startDate: new Date('6/2/2017'),
        endDate: new Date('6/12/2017'),
        min: new Date('05/10/2018'),
        max: new Date('12/24/2017'),
      });
      expect(
        daterangepicker.element.hasAttribute('disabled') &&
          daterangepicker.enabled === false &&
      ...
      expect(
        daterangepicker.inputElement.value === '6/2/2017 - 6/12/2017' &&
          daterangepicker.inputWrapper.container.classList.contains('e-error')
      ).toBe(true);
    });
    it('min and max in same month', () => {
      daterangepicker = createControl({
        min: new Date('05/10/2017'),
        max: new Date('05/24/2017'),
      });
      expect(
        daterangepicker.popupObj.element
          .querySelector('.e-left-calendar .e-title')
          .textContent.indexOf(months[daterangepicker.min.getMonth() - 1]) > -1
      ).toBe(true);
      expect(
        daterangepicker.popupObj.element
          .querySelector('.e-right-calendar .e-title')
          .textContent.indexOf(months[daterangepicker.min.getMonth()]) > -1
      ).toBe(true);
    });
    it('Same min and max range', () => {
      daterangepicker = createControl({
        ...
        endDate: new Date('08/10/2017'),
        min: new Date('08/10/2017'),
        max: new Date('08/10/2017'),
      });
      let endValue: Date = daterangepicker.getIdValue(
        null,
        daterangepicker.popupObj.element.querySelector('.e-end-date')
      ...
      expect(
        +daterangepicker.startDate === +daterangepicker.min &&
          +daterangepicker.startDate === +startValue
      ).toBe(true);
      expect(
        +daterangepicker.endDate === +daterangepicker.max &&
          +daterangepicker.endDate === +endValue
      ).toBe(true);
    ...
    it('max value lesser than current date', () => {
      ...
      expect(
        daterangepicker.popupObj.element
          .querySelector('.e-left-calendar .e-title')
          .textContent.indexOf(months[daterangepicker.max.getMonth() - 1]) > -1
      ).toBe(true);
      expect(
        daterangepicker.popupObj.element
          .querySelector('.e-right-calendar .e-title')
          .textContent.indexOf(months[daterangepicker.max.getMonth()]) > -1
      ).toBe(true);
    });
    it('Range inbetween min and max', () => {
      daterangepicker = createControl({
        startDate: new Date('05/24/2017'),
        endDate: new Date('08/10/2017'),
        min: new Date('01/10/2017'),
        max: new Date('12/24/2017'),
      });
      expect(
        +daterangepicker.startDate <= +daterangepicker.max &&
          +daterangepicker.startDate >= +daterangepicker.min &&
          +daterangepicker.endDate <= +daterangepicker.max &&
          +daterangepicker.endDate >= +daterangepicker.min
      ).toBe(true);
      expect(
        !daterangepicker.inputWrapper.container.classList.contains('e-error') &&
          daterangepicker.popupObj.element.querySelectorAll('.e-start-date')
    ...
    it('Range on min and max', () => {
      daterangepicker = createControl({
        startDate: new Date('01/10/2017'),
        endDate: new Date('12/24/2017'),
        min: new Date('01/10/2017'),
        max: new Date('12/24/2017'),
      });
      expect(
    ...
    it('startDate out of min range(month)', () => {
      daterangepicker = createControl({
        startDate: new Date('04/24/2017'),
        endDate: new Date('08/10/2017'),
        min: new Date('05/10/2017'),
        max: new Date('12/24/2017'),
      });
      expect(
        daterangepicker.popupObj.element.querySelector('.e-start-date') === null
      ).toBe(true);
      expect(
    ...
    it('Start and end value in max month', () => {
      daterangepicker = createControl({
        startDate: new Date('04/10/2017'),
        endDate: new Date('04/24/2017'),
        min: new Date('02/10/2017'),
        max: new Date('04/29/2017'),
      });
      expect(
        daterangepicker.popupObj.element
          .querySelector('.e-left-calendar .e-title')
          .textContent.indexOf(months[daterangepicker.endDate.getMonth() - 1]) >
          -1
      ).toBe(true);
      expect(
        daterangepicker.popupObj.element
    ...
    it('Start and end value in min month', () => {
      daterangepicker = createControl({
        startDate: new Date('04/10/2017'),
        endDate: new Date('04/24/2017'),
        min: new Date('04/01/2017'),
        max: new Date('04/29/2018'),
      });
      expect(
        daterangepicker.popupObj.element
          .querySelector('.e-left-calendar .e-title')
    ...
    it('Min/max range updated through keyboard', () => {
      ...
      expect(
        +daterangepicker.startDate === +new Date('1/3/2017') &&
          +daterangepicker.endDate === +new Date('11/3/2018') &&
          daterangepicker.inputWrapper.container.classList.contains('e-error')
      ).toBe(true);
      let startDate: string = daterangepicker.globalize.formatDate(
        new Date('1/3/2017'),
    ...
    it('strict mode min > max', () => {
      ...
      daterangepicker.dataBind();
      expect(
        daterangepicker.inputElement.value === '4/10/2017 - 4/24/2017'
      ).toBe(true);
    });
  });
  describe('KeyBoard action - DateRangePicker element', () => {
    ...
    it('drill up to year view', function () {
      ...
      expect(
        (<HTMLElement>(
          document.querySelector('.e-left-calendar .e-header .e-day.e-title')
        )).textContent
      ).toBe('2019');
      daterangepicker.keyInputHandler(keyEventArgs);
      expect(
    ...
    it('move focus from left to right calendar', function () {
      ...
      expect(
        document.activeElement ===
          daterangepicker.rightCalendar.children[1].firstElementChild
      ).toBe(true);
      keyEventArgs.target =
        daterangepicker.rightCalendar.querySelector('table');
      keyEventArgs.action = 'controlUp';
      daterangepicker.keyInputHandler(keyEventArgs);
      expect(
        (<HTMLElement>(
          document.querySelector('.e-right-calendar .e-header .e-day.e-title')
        )).textContent
      ).toBe('2020');
      daterangepicker.keyInputHandler(keyEventArgs);
      expect(
    ...
    it('move focus from on td to other td cell', function () {
      ...
      daterangepicker.keyInputHandler(keyEventArgs);
      expect(
        (<HTMLElement>document.querySelectorAll('.e-focused-date')[0])
          .textContent
      ).toBe('Feb');
    ...
    it('move focus from right to cancel button', function () {
      ...
      daterangepicker.keyInputHandler(keyEventArgs);
      expect(
        document.activeElement === daterangepicker.cancelButton.element
      ).toBe(true);
    });
    ...
    it('select td from month view to day view', function () {
      ...
      daterangepicker.keyInputHandler(keyEventArgs);
      expect(
        (<HTMLElement>document.querySelectorAll('.e-selected')[0]).textContent
      ).toBe('1');
    });
    ...
    it('move focus from cancel to apply button', function () {
      ...
      expect(
        document.activeElement === daterangepicker.applyButton.element
      ).toBe(true);
    });
    it('move focus from cancel to left Calendar with apply button disabled', function () {
      ...
      expect(
        document.activeElement ===
          daterangepicker.leftCalendar.children[1].firstElementChild
      ).toBe(true);
    });
    ...
    it('move focus from right Calendar to preset element', function () {
      ...
      expect(document.activeElement === daterangepicker.presetElement).toBe(
        true
      );
    });
  ...
  describe('Min/Max test case - Device', () => {
    ...
    it('min value greater than max', () => {
      daterangepicker = createControl(
        { min: new Date('05/10/2018'), max: new Date('12/24/2017') },
        true
      );
      expect(
        daterangepicker.element.hasAttribute('disabled') &&
    ...
    it('min and max in same month', () => {
      ...
      expect(
        daterangepicker.popupObj.element
          .querySelector('.e-calendar .e-prev')
          .classList.contains('e-disabled') &&
          daterangepicker.popupObj.element
            .querySelector('.e-calendar .e-next')
            .classList.contains('e-disabled')
      ).toBe(false);
      expect(
        daterangepicker.popupObj.element.querySelectorAll(
    ...
    it(' min onproperty change test case ', () => {
      daterangepicker = createControl({
        min: new Date('05/1/2017'),
        max: new Date('04/24/2017'),
      });
      expect(
        daterangepicker.element.hasAttribute('disabled') &&
          daterangepicker.enabled === false
      ...
      daterangepicker.dataBind();
      expect(
        daterangepicker.element.hasAttribute('disabled') == false &&
          daterangepicker.enabled === true
      ).toBe(true);
    });
    it('Same min and max range', () => {
    ...
    it('max value lesser than current date', () => {
      daterangepicker = createControl(
        { min: new Date('03/10/2017'), max: new Date('04/24/2017') },
        true
      );
      expect(
        daterangepicker.popupObj.element
    ...
    it('endDate out of min range(month)', () => {
      ...
      expect(
        +daterangepicker.startDate === +new Date('08/01/2017') &&
          +daterangepicker.endDate === +new Date('08/10/2017') &&
          daterangepicker.inputWrapper.container.classList.contains('e-error')
      ).toBe(true);
      expect(daterangepicker.inputElement.value !== '').toBe(true);
  ...
  describe('Min/Max interaction - Desktop', () => {
    ...
    it('Min range restricted(date)', () => {
      ...
      expect(
        daterangepicker.popupObj.element
          .querySelectorAll('.e-left-calendar.e-calendar td')[10]
          .classList.contains('e-disabled')
      ).toBe(true);
    });
    ...
    it('Disabled date selection', () => {
      ...
      <HTMLElement>(
        daterangepicker.popupObj.element
          .querySelectorAll('.e-right-calendar.e-calendar td')[1]
          .click()
      );
      <HTMLElement>(
        daterangepicker.popupObj.element
      ...
      daterangepicker = createControl(
        {
          ...
          min: new Date('02/15/2017'),
          max: new Date('04/05/2017'),
        },
        true
      );
    });
  ...
  describe('KeyBoard events', () => {
    ...
    beforeEach(() => {
      ...
      document.body.appendChild(ele);
      daterangepicker = createControl({
        startDate: new Date('05/04/2017'),
        endDate: new Date('05/24/2017'),
      });
      daterangepicker.appendTo('#date');
      if (!daterangepicker.isPopupOpen()) {
        <HTMLElement>(
      ...
      expect(
        daterangepicker.inputElement.value ===
          daterangepicker.globalize.formatDate(daterangepicker.startDate, {
            ...
            daterangepicker.separator +
            ' ' +
            daterangepicker.globalize.formatDate(daterangepicker.endDate, {
              format: daterangepicker.format,
              type: 'date',
              skeleton: 'yMd',
            })
    ...
    it(' enter key test case(Correct Value) - strictMode', function () {
      ...
      expect(
        daterangepicker.inputElement.value ===
          daterangepicker.globalize.formatDate(new Date('3/3/2017'), {
            format: daterangepicker.format,
            type: 'date',
            skeleton: 'yMd',
          }) +
            ...
            daterangepicker.separator +
            ' ' +
            daterangepicker.globalize.formatDate(new Date('12/3/2017'), {
              format: daterangepicker.format,
              type: 'date',
              skeleton: 'yMd',
            })
    ...
    it(' enter key test case(Wrong Value) - strictMode', function () {
      ...
      expect(
        daterangepicker.inputElement.value ===
          daterangepicker.globalize.formatDate(new Date('05/04/2017'), {
            format: daterangepicker.format,
            type: 'date',
            skeleton: 'yMd',
          }) +
            ...
            daterangepicker.separator +
            ' ' +
            daterangepicker.globalize.formatDate(new Date('05/24/2017'), {
              format: daterangepicker.format,
              type: 'date',
              skeleton: 'yMd',
            })
  ...
  describe('KeyBoard action - Calendar element', () => {
    ...
    it('move left key test case', function () {
      keyEventArgs.action = 'moveLeft';
      keyEventArgs.target = daterangepicker.leftCalendar.querySelector('table');
      let focusedDate: Date = daterangepicker.getIdValue(
        null,
        daterangepicker.popupObj.element.querySelector('.e-focused-date')
      );
      daterangepicker.keyInputHandler(keyEventArgs);
      let currentDate: Date = daterangepicker.getIdValue(
        null,
        daterangepicker.popupObj.element.querySelector(
          '.e-focused-date:not(.e-today)'
        )
      );
      expect(
        focusedDate.setDate(focusedDate.getDate() - 1) === +currentDate
      ).toBe(true);
    });
    ...
    it('move left key test case - switch calendar', function () {
      daterangepicker.destroy();
      daterangepicker = createControl({
        startDate: new Date('9/21/2017'),
        endDate: new Date('10/1/2017'),
      });
      (<HTMLElement>daterangepicker.inputWrapper.buttons[0]).dispatchEvent(
        clickEvent
      );
      daterangepicker.show();
      keyEventArgs.action = 'moveLeft';
    ...
    it('move up key test case', function () {
      ...
      expect(
        focusedDate.setDate(focusedDate.getDate() - 7) === +currentDate
      ).toBe(true);
    });
    ...
    it('end key test case', function () {
      ...
      expect(
        +new Date(
          ...
          0,
          focusedDate.getHours(),
          focusedDate.getMinutes(),
          focusedDate.getMilliseconds()
    ...
    it('control Home key test case', function () {
      ...
      let focusedDateLength =
        daterangepicker.popupObj.element.querySelectorAll(
          '.e-focused-date'
        ).length;
      if (focusedDateLength === 2) {
        currentDate = daterangepicker.getIdValue(
          null,
          daterangepicker.popupObj.element.querySelectorAll(
            '.e-focused-date'
          )[1]
      ...
      expect(+new Date(focusedDate.getFullYear(), 0, 1) === +currentDate).toBe(
        true
      );
    });
    it('control end test case', function () {
      ...
      let focusedDate: Date = daterangepicker.getIdValue(
        null,
        daterangepicker.rightCalendar.querySelectorAll('td')[10]
      );
      daterangepicker.keyInputHandler(keyEventArgs);
      let currentDate: Date = daterangepicker.getIdValue(
        null,
        daterangepicker.rightCalendar.querySelector('.e-focused-date')
      );
      expect(
        +new Date(focusedDate.getFullYear(), 11, 31) === +currentDate
      ).toBe(true);
    });
    ...
    it('page down test case', function () {
      ...
      let focusedDate: Date = daterangepicker.getIdValue(
        null,
        daterangepicker.leftCalendar.querySelector('.e-focused-date')
      );
      daterangepicker.keyInputHandler(keyEventArgs);
      let currentDate: Date = daterangepicker.getIdValue(
        null,
    ...
    it('control end test case - left Calendar restricted', function () {
      ...
      let currentDate: Date;
      if (
        daterangepicker.rightCalendar.querySelector('.e-focused-date') !== null
      ) {
        currentDate = daterangepicker.getIdValue(
          null,
          daterangepicker.rightCalendar.querySelector('.e-focused-date')
  ...
  describe('KeyBoard action - presets element', () => {
    ...
    it('First presets element selected', function () {
      ...
      keyEventArgs.action = 'moveDown';
      expect(
        daterangepicker.presetElement.querySelector('.e-hover') === null
      ).toBe(true);
    ...
    it('next presets element selected', function () {
      ...
      daterangepicker.presetKeyActionHandler(keyEventArgs);
      expect(
        daterangepicker.presetElement
          .querySelectorAll('li')[1]
          .classList.contains('e-hover')
      ).toBe(false);
      expect(
        daterangepicker.presetElement
    ...
    it('Active preset element', function () {
      ...
      expect(
        daterangepicker.presetElement.querySelector('.e-active') !== null
      ).toBe(true);
    });
    it('Active hover element - down', function () {
      ...
      let nextElement: HTMLElement =
        daterangepicker.presetElement.querySelector(
          '.e-active'
        ).nextElementSibling;
  ...
  describe('format testing - Desktop', () => {
    ...
    it('Default format test case', function () {
      ...
      expect(
        daterangepicker.format === null &&
          daterangepicker.inputElement.value === '2/24/2017 - 8/10/2017'
      ).toBe(true);
    });
    it('format(y) test case', function () {
      ...
      expect(
        daterangepicker.format === 'y' &&
          daterangepicker.inputElement.value === '2017 - 2017'
      ).toBe(true);
    });
    it('format(dddd/MMMM/yyyy) test case ', () => {
      ...
      expect(daterangepicker.element.value).toBe(
        '24/February/2017 - 10/August/2017'
      );
    });
    it('custom format test case ', () => {
      daterangepicker = createControl({
        startDate: new Date('02/24/2017'),
        endDate: new Date('08/10/2017'),
        format: 'ddd/MMMMTet/y',
      });
      expect(daterangepicker.element.value).toBe(
        '24/FebruaryTet/2017 - 10/AugustTet/2017'
      );
    });
    ...
    it(' Interaction format(MMMM) test case ', () => {
      daterangepicker = createControl({
        startDate: new Date('02/2/2017'),
        endDate: new Date('2/10/2017'),
        format: 'MMMM',
      });
      let elements: CalendarElement = getCalendarElement(
        daterangepicker.popupObj.element
      ...
      <HTMLElement>(
        daterangepicker.popupObj.element
          .querySelectorAll('.e-left-calendar td')[10]
          .click()
      );
      <HTMLElement>(
        daterangepicker.popupObj.element
          .querySelectorAll('.e-left-calendar td')[15]
          .click()
      );
      <HTMLElement>daterangepicker.applyButton.element.click();
  ...
  describe('format testing - Device', () => {
    ...
    it('Default format test case', function () {
      daterangepicker = createControl(
        { startDate: new Date('02/24/2017'), endDate: new Date('08/10/2017') },
        true
      );
      expect(
        daterangepicker.format === null &&
  ...
  describe('Internationalization', function () {
    ...
    it('Update Locale range test case', function () {
      ...
      expect(daterangepicker.locale === 'de').toBe(true);
      expect(
        daterangepicker.inputElement.value === '24.2.2017 - 10.8.2017'
      ).toBe(true);
    });
    ...
    it('Update Locale range test case(ja)', function () {
      ...
      expect(daterangepicker.locale === 'ja').toBe(true);
      expect(
        daterangepicker.inputElement.value === '2017/2/24 - 2017/8/10'
      ).toBe(true);
    });
    ...
    it('Locale label test case(de)', function () {
      ...
      expect(daterangepicker.locale === 'de').toBe(true);
      expect(
        daterangepicker.l10n.getConstant('startLabel') ===
          daterangepicker.popupObj.element.querySelector('.e-start-label').text
      ).toBe(true);
      expect(
        daterangepicker.l10n.getConstant('endLabel') ===
          daterangepicker.popupObj.element.querySelector('.e-end-label').text
      ).toBe(true);
    });
  ...
  describe('Locale with hidden input testing', function () {
    ...
    it('Hidden input value test case with de culture', function () {
      daterangepicker = null;
      daterangepicker = createControl({
        value: [new Date('1/1/2019'), new Date('1/20/2019')],
      });
      daterangepicker.locale = 'de';
      expect(
        daterangepicker.firstHiddenChild.value ===
          daterangepicker.globalize.formatDate(daterangepicker.startDate, {
            type: 'date',
            skeleton: 'yMd',
          })
      ...
      expect(
        daterangepicker.secondHiddenChild.value ===
          daterangepicker.globalize.formatDate(daterangepicker.endDate, {
            type: 'date',
            skeleton: 'yMd',
          })
  ...
  describe('Check placeholder after load culture', () => {
    ...
    beforeEach((): void => {
      ...
      let ele: HTMLInputElement = <HTMLInputElement>(
        createElement('input', { id: 'daterange' })
      );
      document.body.appendChild(ele);
    });
    afterEach((): void => {
  ...
  describe('Special Dates,weekNumber, disabled Dates and firstDayofWeek - Desktop', () => {
    ...
    it('Special Date created', function () {
      ...
      expect(
        daterangepicker.popupObj.element.querySelectorAll('.highlight').length >
          0
      ).toBe(true);
    });
    ...
    it('Week number not selected in range test case', function () {
      ...
      expect(
        daterangepicker.popupObj.element
          .querySelector('.e-week-number')
          .classList.contains('.e-range-hover')
      ).toBe(false);
    });
    it('Week number not selected in interaction range test case', function () {
      ...
      <HTMLElement>(
        daterangepicker.popupObj.element
          .querySelectorAll('.e-right-calendar td')[19]
          .click()
      );
      expect(
        daterangepicker.popupObj.element
    ...
    it('Week number not selected  test case', function () {
      daterangepicker = createControl({ weekNumber: true });
      <HTMLElement>(
        daterangepicker.popupObj.element.querySelector('.e-week-number').click()
      );
      expect(
        daterangepicker.popupObj.element
          .querySelector('.e-week-number')
    ...
    it('Disabled Date test case', function () {
      ...
      expect(
        daterangepicker.popupObj.element.querySelectorAll('.e-disabled')
          .length > 0
      ).toBe(true);
    });
    it('Min and Max Disabled Date test case', function () {
      daterangepicker = createControl({
        ...
        endDate: new Date('10/15/2017'),
        min: new Date('10/10/2017'),
        max: new Date('10/15/2017'),
        renderDayCell: function (args: any): void {
          if (
            +args.date === +new Date('10/10/2017') ||
            +args.date === +new Date('10/15/2017')
          ) {
            args.isDisabled = true;
          }
        },
      ...
      expect(
        daterangepicker.inputWrapper.container.classList.contains('e-error') &&
          +daterangepicker.startDate === +new Date('10/11/2017') &&
          +daterangepicker.endDate === +new Date('10/15/2017')
      ).toBe(true);
      expect(
        daterangepicker.popupObj.element
          .querySelector(
            '*[id^="/id"]'.replace('/id', '' + +new Date('10/10/2017'))
          )
          .classList.contains('e-disabled') &&
          daterangepicker.popupObj.element
            .querySelector(
              '*[id^="/id"]'.replace('/id', '' + +new Date('10/15/2017'))
            )
            .classList.contains('e-disabled')
      ).toBe(true);
    });
    ...
    it('Disabled Date not selected interaction', function () {
      ...
      <HTMLElement>(
        daterangepicker.popupObj.element.querySelector('.e-disabled').click()
      );
      expect(
        daterangepicker.popupObj.element
          .querySelector('.e-disabled')
          .classList.contains('.e-start-date')
      ).toBe(false);
    });
  });
  describe('Special Dates,weekNumber, disabled Dates and firstDayofWeek - Device', () => {
    ...
    it('firstDayOfWeek test case', function () {
      ...
      expect(
        document.querySelectorAll('.e-calendar .e-content th')[0].textContent ==
          'Tu'
      ).toBe(true);
    });
    it('Week number test case', function () {
    ...
    it('Week number not selected in interaction range test case', function () {
      ...
      <HTMLElement>(
        daterangepicker.popupObj.element
          .querySelectorAll('.e-calendar td')[19]
          .dispatchEvent(clickEvent)
      );
      expect(
        daterangepicker.popupObj.element
  ...
  describe('HTML attribute API testing', () => {
    ...
    it('Other attribute testing with htmlAttributes API', () => {
      daterangepicker = new DateRangePicker({
        htmlAttributes: { class: 'test', title: 'sample' },
      });
      daterangepicker.appendTo('#daterange');
      expect(daterangepicker.inputWrapper.container.getAttribute('title')).toBe(
        'sample'
      );
      expect(
        daterangepicker.inputWrapper.container.classList.contains('test')
      ).toBe(true);
    });
  });
  describe('HTML attribute API dynamic testing', () => {
    ...
    it('Dynamically change attributes with htmlAttributes API', () => {
      ...
      expect(daterangepicker.inputWrapper.container.getAttribute('style')).toBe(
        'background-color:yellow'
      );
    ...
    it('Placeholder testing in auto case', () => {
      daterangepicker = new DateRangePicker({
        floatLabelType: 'Auto',
        htmlAttributes: { placeholder: 'Enter a name' },
      });
      daterangepicker.appendTo('#daterange');
      expect(daterangepicker.element.getAttribute('placeholder')).toBe(null);
      expect(document.querySelector('.e-float-text').innerHTML).toBe(
        'Enter a name'
      );
  ...
  describe('HTML attribute API at inital rendering and dynamic rendering', () => {
    ...
    it('Html attributes at initial rendering', () => {
      daterangepicker = new DateRangePicker({
        htmlAttributes: { placeholder: 'Choose a date', class: 'sample' },
      });
      daterangepicker.appendTo('#daterange');
      expect(daterangepicker.element.getAttribute('placeholder')).toBe(
        'Choose a date'
      ...
      expect(
        daterangepicker.inputWrapper.container.classList.contains('sample')
      ).toBe(true);
    });
    it('Pass multiple attributes dynamically', () => {
      daterangepicker = new DateRangePicker({
        startDate: new Date('4/24/2017'),
        endDate: new Date('8/10/2017'),
      });
      daterangepicker.appendTo('#daterange');
      daterangepicker.htmlAttributes = {
        class: 'sample',
  ...
  describe('MinDays and MaxDays - Desktop', () => {
    ...
    it('minDays > maxDays', function () {
      ...
      expect(
        daterangepicker.minDays === 10 && daterangepicker.maxDays === null
      ).toBe(true);
    });
    it('minDays < 0 ', function () {
      daterangepicker = createControl({ minDays: -1, maxDays: 5 });
      expect(
        daterangepicker.minDays === null && daterangepicker.maxDays === 5
      ).toBe(true);
    });
    it('maxDays < 0 ', function () {
      daterangepicker = createControl({ maxDays: -1, minDays: 5 });
      expect(
        daterangepicker.maxDays === null && daterangepicker.minDays === 5
      ).toBe(true);
    });
    it('Selecting range of 5 mindays', function () {
      ...
      expect(
        selectedCell.nextElementSibling.classList.contains('e-date-disabled')
      ).toBe(true);
      expect(
        daterangepicker.popupObj.element
          .querySelectorAll('.e-left-calendar td')[12]
          .classList.contains('e-date-disabled')
      ).toBe(true);
      expect(
        daterangepicker.popupObj.element
          .querySelectorAll('.e-left-calendar td')[13]
          .classList.contains('e-date-disabled')
      ).toBe(true);
      expect(
        daterangepicker.popupObj.element
          .querySelectorAll('.e-left-calendar td')[14]
          .classList.contains('e-date-disabled')
      ).toBe(false);
    });
    ...
    it('Selecting range of 10 maxdays', function () {
      ...
      expect(
        daterangepicker.popupObj.element
          .querySelectorAll('.e-left-calendar td')[19]
          .classList.contains('e-date-disabled')
      ).toBe(false);
      expect(
        daterangepicker.popupObj.element
          .querySelectorAll('.e-left-calendar td')[20]
          .classList.contains('e-date-disabled')
      ).toBe(true);
    });
    it('Minimum days need to be selected is greater than available date', function () {
      ...
      expect(
        daterangepicker.popupObj.element
          .querySelectorAll('.e-right-calendar td')[30]
          .classList.contains('e-disabled')
      ).toBe(true);
    });
    ...
    it('is Days are not selectable in next month when maxDays', function () {
      ...
      <HTMLElement>(
        daterangepicker.popupObj.element
          .querySelectorAll('.e-right-calendar td')[12]
          .click()
      );
      //expect(daterangepicker.popupObj.element.querySelectorAll('.e-right-calendar td')[23].classList.contains('e-date-disabled')).toBe(true);
      expect(
    ...
    it('Cells not selected before minDays range', function () {
      ...
      <HTMLElement>(
        daterangepicker.popupObj.element
          .querySelectorAll('.e-left-calendar td')[11]
          .click()
      );
      expect(
        daterangepicker.popupObj.element.querySelector('.e-end-date') === null
    ...
    it('previous cells are enabled', function () {
      ...
      expect(
        daterangepicker.popupObj.element
          .querySelectorAll('.e-left-calendar td')[9]
          .classList.contains('e-date-disabled')
      ).toBe(false);
    });
    ...
    it('Disabled Date maintained during minDays and maxDays', function () {
      daterangepicker = createControl({
        startDate: new Date('9/1/2017'),
        endDate: new Date('9/12/2017'),
        renderDayCell: function (args: any): void {
          if (
            +args.date === +new Date('9/10/2017') ||
            +args.date === +new Date('9/15/2017')
          ) {
            args.isDisabled = true;
          }
        },
      ...
      expect(
        daterangepicker.popupObj.element
          .querySelectorAll('.e-right-calendar td')[11]
          .classList.contains('e-date-disabled')
      ).toBe(true);
      <HTMLElement>(
        daterangepicker.popupObj.element
    ...
    it('Week Number not included in minDays', function () {
      daterangepicker = createControl({
        minDays: 5,
        weekNumber: true,
        startDate: new Date('8/10/2017'),
        endDate: new Date('8/18/2017'),
      });
      let selectedCell: HTMLElement = <HTMLElement>(
        daterangepicker.popupObj.element.querySelectorAll(
          '.e-left-calendar td'
      ...
      expect(
        daterangepicker.popupObj.element
          .querySelectorAll('.e-left-calendar td')[24]
          .classList.contains('e-week-number') &&
          !daterangepicker.popupObj.element
            .querySelectorAll('.e-left-calendar td')[24]
            .classList.contains('e-date-disabled')
      ).toBe(true);
      expect(
        daterangepicker.popupObj.element
          .querySelectorAll('.e-left-calendar td')[26]
          .classList.contains('e-date-disabled')
      ).toBe(true);
      expect(
        daterangepicker.popupObj.element
          .querySelectorAll('.e-left-calendar td')[27]
          .classList.contains('e-date-disabled')
      ).toBe(false);
    });
    ...
    it('Disabled Date excluded in range count', function () {
      ...
      expect(
        daterangepicker.popupObj.element
          .querySelector('.e-day-span')
          .textContent.indexOf('6') > -1
      ).toBe(true);
    ...
    it('Icon Disabled in right calendar', function () {
      ...
      selectedCell.dispatchEvent(clickEvent);
      expect(
        daterangepicker.rightCalNextIcon.classList.contains('e-icon-disabled')
      ).toBe(true);
    });
    it('Icon Disabled in both calendar', function () {
      ...
      selectedCell.dispatchEvent(clickEvent);
      expect(
        daterangepicker.rightCalNextIcon.classList.contains(
          'e-icon-disabled'
        ) &&
          daterangepicker.rightCalPrevIcon.classList.contains(
            'e-icon-disabled'
          ) &&
          daterangepicker.leftCalNextIcon.classList.contains('e-icon-disabled')
      ).toBe(true);
    });
    it('Icon Disabled class removed in both calendar', function () {
      ...
      expect(
        daterangepicker.rightCalPrevIcon.classList.contains('e-icon-disabled')
      ).toBe(false);
      expect(
        daterangepicker.leftCalNextIcon.classList.contains('e-icon-disabled')
      ).toBe(false);
  ...
  describe('MinDays and MaxDays - Device', () => {
    ...
    it('Selecting range of 5 mindays', function () {
      ...
      expect(
        daterangepicker.popupObj.element
          .querySelectorAll('.e-calendar td')[12]
          .classList.contains('e-date-disabled')
      ).toBe(true);
      expect(
        daterangepicker.popupObj.element
          .querySelectorAll('.e-calendar td')[13]
          .classList.contains('e-date-disabled')
      ).toBe(true);
      expect(
        daterangepicker.popupObj.element
          .querySelectorAll('.e-calendar td')[14]
          .classList.contains('e-date-disabled')
      ).toBe(false);
    });
    it('Selecting range of 10 maxdays', function () {
      ...
      expect(
        daterangepicker.popupObj.element
          .querySelectorAll('.e-calendar td')[20]
          .classList.contains('e-date-disabled')
      ).toBe(true);
    });
    it('Minimum days need to be selected is greater than available date', function () {
      daterangepicker = createControl(
        { minDays: 5, max: new Date('8/20/2017') },
        true
      );
      let selectedCell: HTMLElement = <HTMLElement>(
        daterangepicker.popupObj.element.querySelectorAll('.e-calendar td')[15]
      ...
      expect(
        daterangepicker.popupObj.element
          .querySelectorAll('.e-calendar td')[17]
          .classList.contains('e-date-disabled')
      ).toBe(true);
      expect(
        daterangepicker.popupObj.element
          .querySelectorAll('.e-calendar td')[30]
          .classList.contains('e-disabled')
      ).toBe(true);
    });
    it('is Days are disabled in next month when maxDays', function () {
      ...
      let selectedCell: HTMLElement = <HTMLElement>(
        daterangepicker.popupObj.element.querySelectorAll('.e-calendar td')[22]
      );
      selectedCell.dispatchEvent(clickEvent);
      let elements: DeviceCalendarElement = getDeviceCalendarElement(
        daterangepicker.popupObj.element
    ...
    it('minDays > (min-max)', function () {
      daterangepicker = createControl(
        { minDays: 15, min: new Date('9/10/2017'), max: new Date('9/20/2017') },
        true
      );
      let selectedCell: HTMLElement = <HTMLElement>(
        daterangepicker.popupObj.element.querySelectorAll('.e-calendar td')[16]
      );
      selectedCell.dispatchEvent(clickEvent);
      expect(
        selectedCell.nextElementSibling.classList.contains('e-date-disabled')
    ...
    it('Cells not selected before minDays', function () {
      ...
      <HTMLElement>(
        daterangepicker.popupObj.element
          .querySelectorAll('.e-calendar td')[11]
          .click()
      );
      expect(
        daterangepicker.popupObj.element.querySelector('.e-end-date') === null
    ...
    it('previous cells are enabled', function () {
      ...
      expect(
        daterangepicker.popupObj.element
          .querySelectorAll('.e-calendar td')[9]
          .classList.contains('e-date-disabled')
      ).toBe(true);
    });
    it('Same minDays and maxDays', function () {
    ...
    it('Week Number not included in minDays', function () {
      ...
      expect(
        daterangepicker.popupObj.element
          .querySelectorAll('.e-calendar td')[24]
          .classList.contains('e-week-number') &&
          !daterangepicker.popupObj.element
            .querySelectorAll('.e-calendar td')[24]
            .classList.contains('e-date-disabled')
      ...
      expect(
        daterangepicker.popupObj.element
          .querySelectorAll('.e-calendar td')[26]
          .classList.contains('e-date-disabled')
      ).toBe(true);
      expect(
        daterangepicker.popupObj.element
          .querySelectorAll('.e-calendar td')[27]
          .classList.contains('e-date-disabled')
      ).toBe(false);
    });
    it('Selected range lesser minDays(input)', function () {
    ...
    it('Selected range lesser minDays(dataBind)', function () {
      daterangepicker = createControl(
        { startDate: new Date('8/10/2017'), endDate: new Date('8/11/2017') },
        true
      );
      daterangepicker.minDays = 5;
      daterangepicker.dataBind();
    ...
    it('Selected range greater maxDays(dataBind)', function () {
      daterangepicker = createControl(
        { startDate: new Date('8/10/2017'), endDate: new Date('8/19/2017') },
        true
      );
      daterangepicker.maxDays = 5;
      daterangepicker.dataBind();
    ...
    it('Icon Disabled in calendar', function () {
      ...
      selectedCell.dispatchEvent(clickEvent);
      expect(
        daterangepicker.nextIcon.classList.contains('e-icon-disabled')
      ).toBe(true);
    });
    it('Cell disabled after enddate in calendar', function () {
      ...
      selectedCell.dispatchEvent(clickEvent);
      selectedCell = <HTMLElement>(
        daterangepicker.popupObj.element.querySelectorAll('.e-calendar td')[11]
      );
      selectedCell.dispatchEvent(clickEvent);
      expect(
        daterangepicker.popupObj.element.querySelectorAll('.e-date-disabled')
          .length > 0
      ).toBe(true);
    });
  ...
  describe('StrictMode -  Desktop', () => {
    ...
    it('startDate out of min range(month)', () => {
      ...
      expect(
        +daterangepicker.startDate === +new Date('05/10/2017') &&
          !daterangepicker.inputWrapper.container.classList.contains('e-error')
      ).toBe(true);
      expect(daterangepicker.inputElement.value !== '').toBe(true);
    });
    it('startDate out of min range(min:default)', () => {
      ...
      expect(
        +daterangepicker.startDate === +new Date('1/1/1900') &&
          !daterangepicker.inputWrapper.container.classList.contains('e-error')
      ).toBe(true);
      expect(daterangepicker.inputElement.value !== '').toBe(true);
      expect(
        daterangepicker.popupObj.element
          .querySelector('.e-start-date')
          .nextElementSibling.classList.contains('e-range-hover')
      ).toBe(true);
    });
    ...
    it('endDate out of max range(month)', () => {
      ...
      expect(
        +daterangepicker.endDate === +new Date('7/24/2017') &&
          !daterangepicker.inputWrapper.container.classList.contains('e-error')
      ).toBe(true);
      expect(daterangepicker.inputElement.value !== '').toBe(true);
    });
    it('start and end date out of min and max range(month)', () => {
      ...
      expect(
        +daterangepicker.startDate === +new Date('5/10/2017') &&
          +daterangepicker.endDate === +new Date('7/24/2017') &&
          !daterangepicker.inputWrapper.container.classList.contains('e-error')
      ).toBe(true);
      expect(daterangepicker.inputElement.value !== '').toBe(true);
    ...
    it('range value less than minDays', () => {
      ...
      expect(
        +daterangepicker.endDate === +new Date('4/28/2017') &&
          !daterangepicker.inputWrapper.container.classList.contains('e-error')
      ).toBe(true);
      expect(
        daterangepicker.inputElement.value === '4/24/2017 - 4/28/2017'
      ).toBe(true);
    });
    ...
    it('minDays not available(max)', () => {
      ...
      expect(
        +daterangepicker.endDate === +new Date('4/26/2017') &&
          !daterangepicker.inputWrapper.container.classList.contains('e-error')
      ).toBe(true);
      expect(
        daterangepicker.inputElement.value === '4/24/2017 - 4/26/2017'
      ).toBe(true);
    });
    ...
    it('range updated through enter', () => {
      daterangepicker = createControl({
        strictMode: true,
        min: new Date('04/15/2017'),
        max: new Date('05/20/2017'),
      });
      daterangepicker.element.value = '1/3/2017 - 11/3/2018';
      daterangepicker.preventBlur = false;
      daterangepicker.inputBlurHandler();
      ...
      expect(
        +daterangepicker.startDate === +new Date('04/15/2017') &&
          +daterangepicker.endDate === +new Date('05/20/2017') &&
          !daterangepicker.inputWrapper.container.classList.contains('e-error')
      ).toBe(true);
      let startDate: string = daterangepicker.globalize.formatDate(
        new Date('04/15/2017'),
    ...
    it('minDays alerted ', () => {
      ...
      expect(
        +daterangepicker.startDate === +new Date('04/24/2017') &&
          +daterangepicker.endDate === +new Date('04/28/2017') &&
          !daterangepicker.inputWrapper.container.classList.contains('e-error')
      ).toBe(true);
      let startDate: string = daterangepicker.globalize.formatDate(
        new Date('04/24/2017'),
    ...
    it('Disabled Date - previous value maintained', () => {
      ...
      expect(
        +daterangepicker.startDate === +new Date('04/24/2017') &&
          +daterangepicker.endDate == +new Date('04/26/2017') &&
          !daterangepicker.inputWrapper.container.classList.contains('e-error')
      ).toBe(true);
      expect(
        daterangepicker.inputElement.value === '4/24/2017 - 4/26/2017'
    ...
    it('Same min and max range(month)', () => {
      ...
      expect(
        +daterangepicker.startDate === +new Date('5/24/2017') &&
          +daterangepicker.endDate === +new Date('5/24/2017') &&
          !daterangepicker.inputWrapper.container.classList.contains('e-error')
      ).toBe(true);
      expect(daterangepicker.inputElement.value !== '').toBe(true);
      let startDate: string = daterangepicker.globalize.formatDate(
  ...
  describe('Presets Range Desktop)', () => {
    ...
    it('Mouse hover class added', () => {
      mouseEventArgs.target = daterangepicker.popupObj.element.querySelector(
        '.e-presets li:first-child'
      );
    ...
    it('Custom range at model', () => {
      ...
      expect(daterangepicker.element.value === '1/1/2017 - 5/24/2017').toBe(
        true
      );
    });
    ...
    it('Locale label test case(de)', function () {
      ...
      expect(daterangepicker.locale === 'de').toBe(true);
      expect(
        daterangepicker.l10n.getConstant('customRange') ===
          daterangepicker.popupObj.element.querySelector(
            '.e-presets li:last-child'
          ).textContent
      ).toBe(true);
    });
  });
  ...
  describe('Presets custom label test case', () => {
    ...
    it('presets label  without selection test case', () => {
        ...
        presets: [
          {
            label: 'Presets01',
            start: new Date('1/1/2017'),
            end: new Date('2/1/2017'),
          },
          {
            label: 'Presets02',
            start: new Date('3/1/2017'),
            end: new Date('4/1/2017'),
          },
        ],
      });
      daterangepicker.appendTo('#date');
      ...
      expect(document.querySelector('.e-list-item.e-active').textContent).toBe(
        'Custom Range'
      );
    });
    it('presets label  with selection test case', () => {
      daterangepicker = new DateRangePicker({
        startDate: new Date('3/1/2017'),
        endDate: new Date('4/1/2017'),
        presets: [
          {
            label: 'Presets01',
            start: new Date('1/1/2017'),
    ...
    it('Custom range at model', () => {
      ...
      expect(
        daterangepicker.popupObj.element
          .querySelector('.e-calendar')
          .classList.contains('e-calendar')
      ).toBe(true);
      expect(
        daterangepicker.popupObj.element.querySelector('.e-start-date') !== null
      ).toBe(true);
  ...
  describe('Public Method Testing', () => {
    ...
    it('focusIn method test case ', function () {
      ...
      expect(
        daterangepicker.element.parentElement.classList.contains(
          'e-input-focus'
        )
      ).toBe(true);
    ...
    it('destroy method', () => {
      ...
      expect(
        document
          .getElementById('date')
          .parentElement.classList.contains('e-input-group')
      ).toBe(false);
      daterangepicker = null;
    });
  });
  describe('Angular tag testing ', () => {
    ...
    it('Wrapper testing with ID', () => {
      ...
      expect(daterangepicker.firstHiddenChild.getAttribute('name')).toBe(
        'angular'
      );
      ...
      expect(daterangepicker.inputWrapper.container.parentElement.tagName).toBe(
        daterangepicker.element.tagName
      );
  ...
  describe('Mobile testing for readonly attribute', function () {
    ...
    it('Add and remove readonly attribute for angular platform', () => {
      let ele: HTMLElement = <HTMLElement>(
        createElement('EJS-DATERANGEPICKER', { id: 'range' })
      );
      document.body.appendChild(ele);
      daterangepicker = new DateRangePicker();
  ...
  describe('events Testing', () => {
    ...
    it('Created event', function () {
      let func = {
        created: function (args: any): void {
      ...
      daterangepicker.appendTo('#date');
      if (
        daterangepicker.element.classList.contains('e-daterangepicker') == true
      )
        count++;
      expect(count).toBe(1);
  ...
  describe('Datetime support', () => {
    ...
    it('startDate and endDate property with time test case', function () {
      daterangepicker = new DateRangePicker({
        startDate: new Date('3/3/2017 03:40'),
        endDate: new Date('4/3/2017 03:40'),
      ...
      expect(daterangepicker.element.value).toBe(
        '03/03/2017 03:40 - 03/04/2017 03:40'
      );
    ...
    it('startDate and endDate property with format test case', function () {
      ...
      daterangepicker.dataBind();
      expect(daterangepicker.element.value).toBe(
        '03/03/2017 03:40 AM - 04/03/2017 03:40 AM'
      );
      expect(+daterangepicker.startDate).toBe(+new Date('03/03/2017 03:40'));
      expect(+daterangepicker.endDate).toBe(+new Date('04/03/2017 03:40'));
    });
    it('startDate and endDate property with time options', function () {
      daterangepicker = new DateRangePicker({
        startDate: new Date('1/3/2017 03:40'),
        endDate: new Date('2/3/2017 03:40'),
      });
      daterangepicker.appendTo('#date');
    ...
    it('startDate and endDate property with  different time value test case', function () {
      daterangepicker = new DateRangePicker({
        startDate: new Date('1/3/2017 01:00'),
        endDate: new Date('2/3/2017 3:00'),
      });
      daterangepicker.appendTo('#date');
    ...
    it('startDate and endDate property with  different time value with format(dd/MM/yyy hh) test case', function () {
      ...
      expect(+daterangepicker.endDate).toBe(+new Date('2/5/2017 04:00'));
      expect(daterangepicker.element.value).toBe(
        '05/01/2017 06 - 05/02/2017 04'
      );
    });
    it('range selection with different time value test case', function () {
      daterangepicker = new DateRangePicker({
        startDate: new Date('3/3/2017 01:00'),
        endDate: new Date('4/3/2017 05:00'),
        format: 'dd/MM/yyyy hh:mm',
      });
      daterangepicker.appendTo('#date');
      daterangepicker.inputWrapper.buttons[0].dispatchEvent(clickEvent);
      let tdLeftCell: any = daterangepicker.popupObj.element.querySelectorAll(
        '.e-left-calendar .e-content td'
      )[10];
      tdLeftCell.dispatchEvent(clickEvent);
      let tdRightCell = daterangepicker.popupObj.element.querySelectorAll(
        '.e-right-calendar .e-content td'
      )[10];
      tdRightCell.dispatchEvent(clickEvent);
      (<HTMLElement>document.getElementsByClassName('e-apply')[0]).click();
      daterangepicker.dataBind();
      expect(+daterangepicker.startDate).toBe(
        +new Date(parseInt(tdLeftCell.getAttribute('id').split('_')[0]))
      );
      expect(+daterangepicker.endDate).toBe(
        +new Date(parseInt(tdRightCell.getAttribute('id').split('_')[0]))
      );
      expect(daterangepicker.element.value).toBe(
        '08/03/2017 01:00 - 05/04/2017 05:00'
      );
    });
    it('startDate and endDate property with time options on onproperty change test case with format', function () {
      ...
      expect(daterangepicker.element.value).toBe(
        '08/03/2017 03:40 - 05/04/2017 03:40'
      );
    });
  });
  ...
  describe('strictMode', () => {
    ...
    it('strictMode false with startDate and endDate date value', function () {
      daterangepicker = new DateRangePicker({
        startDate: new Date('3/3/9999'),
        endDate: new Date('4/3/9999'),
      });
      daterangepicker.appendTo('#date');
  ...
  describe('Drill down navigation support for Desktop', () => {
    ...
    function monthIconDisabled(): void {
      expect(
        document
          .querySelector('.e-left-calendar .e-header .e-next')
          .classList.contains('e-disabled')
      ).toBe(true);
      expect(
        document
          .querySelector('.e-right-calendar .e-header .e-prev')
          .classList.contains('e-disabled')
      ).toBe(true);
    }
    let clickEvent: MouseEvent = document.createEvent('MouseEvents');
    ...
    it('navigation to decade view in  left calendar test case ', function () {
      daterangepicker = new DateRangePicker({
        startDate: new Date('1/3/2018'),
        endDate: new Date('2/1/2018'),
      });
      daterangepicker.appendTo('#date');
      if (!daterangepicker.isPopupOpen()) {
        <HTMLElement>(
      ...
      (<HTMLElement>(
        document.querySelector('.e-focused-date').nextElementSibling
      )).click();
      (<HTMLElement>(
        document.querySelector('.e-focused-date').nextElementSibling
      )).click();
    ...
    it('navigation to decade view in  right calendar test case ', function () {
      ...
      expect(+daterangepicker.endDate).toBe(+new Date('2/1/2018'));
      (<HTMLElement>(
        document.querySelectorAll('.e-focused-date')[1].nextElementSibling
      )).click();
      (<HTMLElement>(
        document.querySelectorAll('.e-focused-date')[1].nextElementSibling
      )).click();
    ...
    it('Icon disabled in left calendar after drill down test case ', function () {
      ...
      (<HTMLElement>(
        document.querySelector('.e-left-calendar .e-header .e-date-icon-prev')
      )).dispatchEvent(clickEvent);
      expect(
        (<HTMLElement>(
          document.querySelector('.e-left-calendar .e-header .e-day.e-title')
      ...
      expect(
        document
          .querySelector('.e-left-calendar .e-header .e-prev')
          .classList.contains('e-disabled')
      ).toBe(false);
      (<HTMLElement>(
        document.querySelector('.e-left-calendar .e-header .e-date-icon-next')
      )).dispatchEvent(clickEvent);
      expect(
        (<HTMLElement>(
          document.querySelector('.e-left-calendar .e-header .e-day.e-title')
    ...
    it('Icon disabled in right calendar after drill down test case ', function () {
      ...
      (<HTMLElement>document.querySelectorAll('.e-focused-date')[1]).click();
      (<HTMLElement>(
        document.querySelector('.e-right-calendar .e-header .e-date-icon-next')
      )).dispatchEvent(clickEvent);
      expect(
        (<HTMLElement>(
          document.querySelector('.e-right-calendar .e-header .e-day.e-title')
      ...
      expect(
        document
          .querySelector('.e-right-calendar .e-header .e-next')
          .classList.contains('e-disabled')
      ).toBe(false);
      expect(
        document
      ...
      (<HTMLElement>(
        document.querySelector('.e-right-calendar .e-header .e-date-icon-prev')
      )).dispatchEvent(clickEvent);
      expect(
        (<HTMLElement>(
          document.querySelector('.e-right-calendar .e-header .e-day.e-title')
    ...
    it('right  calendar drill down with min and max test case ', function () {
      ...
      expect(
        document.querySelector('.e-start-date').children[0].textContent
      ).toBe('4');
      expect(
        document.querySelector('.e-end-date').children[0].textContent
      ).toBe('28');
    });
    ...
    it('Mobile navigation test case ', function () {
      ...
      (<HTMLElement>(
        document.querySelector('.e-calendar .e-header .e-day.e-title')
      )).click();
      expect(
        document
          .querySelector('.e-calendar .e-content')
          .classList.contains('e-year')
      ).toBe(true);
      (<HTMLElement>(
        document.querySelector('.e-calendar .e-header .e-day.e-title')
      )).click();
    ...
    it('Mobile navigation with selection  test case ', function () {
      ...
      (<HTMLElement>document.querySelector('.e-focused-date')).dispatchEvent(
        clickEvent
      );
      expect(
        document
      ...
      // expect(document.querySelector('.e-end-date').children[0].textContent).toBe('' + new Date((new Date().setDate(new Date().getDate() + 1))).getDate());
      expect(+daterangepicker.startValue).toBe(
    ...
    it('Icon navigation in mobile test case ', function () {
      ...
      (<HTMLElement>(
        document.querySelector('.e-calendar .e-header .e-date-icon-prev')
      )).dispatchEvent(clickEvent);
      (<HTMLElement>(
        document.querySelector('.e-calendar .e-header .e-date-icon-prev')
      )).dispatchEvent(clickEvent);
      (<HTMLElement>(
        document.querySelector('.e-calendar .e-header .e-date-icon-next')
      )).dispatchEvent(clickEvent);
      (<HTMLElement>(
        document.querySelector('.e-calendar .e-header .e-date-icon-next')
      )).dispatchEvent(clickEvent);
    ...
    it('Drill down selection within the same month issue test case ', function () {
      ...
      (<HTMLElement>document.querySelectorAll('.e-focused-date')[0]).click();
      (<HTMLElement>(
        document.querySelectorAll('.e-focused-date')[0]
      )).dispatchEvent(clickEvent);
      rightCalendarTitleClick();
      if (
        <HTMLElement>(
          document.querySelector('.e-right-calendar .e-focused-date')
            .previousElementSibling
        )
      ) {
        (
      ...
      expect(
        (<HTMLElement>document.querySelector('.e-start-date')).textContent
      ).toBe('' + new Date().getDate());
    });
  ...
  describe('Value Property test case', () => {
    ...
    it('value property with array type test case ', function () {
      daterangepicker = new DateRangePicker({
        value: [new Date('4/3/2018'), new Date('5/1/2018')],
      });
      daterangepicker.appendTo('#date');
    ...
    it('value property with object type test case ', function () {
      daterangepicker = new DateRangePicker({
        value: { start: new Date('4/3/2018'), end: new Date('5/1/2018') },
      });
      daterangepicker.appendTo('#date');
      expect(daterangepicker.element.value).toBe('4/3/2018 - 5/1/2018');
    ...
    it('value property with custom object with string type test case ', function () {
      daterangepicker = new DateRangePicker({
        value: { start: <any>'4/3/2018', end: <any>'5/1/2018' },
      });
      daterangepicker.appendTo('#date');
      expect(daterangepicker.element.value).toBe('4/3/2018 - 5/1/2018');
      expect(+daterangepicker.value.start).toBe(+new Date('4/3/2018'));
    ...
    it(' value onproperty with null  test case ', function () {
      daterangepicker = new DateRangePicker({
        value: [new Date('12/12/2016'), new Date('3/3/2017')],
      });
      daterangepicker.appendTo('#date');
      daterangepicker.value = null;
      daterangepicker.dataBind();
    ...
    it('Initial rendering of start and endDate with string type value test case ', function () {
      daterangepicker = new DateRangePicker({
        startDate: <any>'4/3/2018',
        endDate: <any>'5/1/2018',
      });
      daterangepicker.appendTo('#date');
      expect(daterangepicker.element.value).toBe('4/3/2018 - 5/1/2018');
      expect(+daterangepicker.startDate).toBe(+new Date('4/3/2018'));
  ...
  describe('Form element', () => {
    ...
    it('Input element value reset test case (initialized)', () => {
      range = new DateRangePicker({
        value: [new Date('2/2/2018'), new Date('4/4/2018')],
      });
    ...
    it('Form reset with floatLabeltype("Auto") property test case (initialized)', () => {
      ...
      expect(
        document
          ...
          .classList.contains('e-label-top')
      ).toBe(true);
      (<any>document.getElementById('form-element')).reset();
      range.dataBind();
      expect(
    ...
    it('Input value reset in destroy case (initialized) ', () => {
      range = new DateRangePicker({
        value: [new Date('02/02/2017'), new Date('4/4/2018')],
      });
      range.appendTo('#range');
      range.destroy();
      (<any>document.getElementById('form-element')).reset();
      expect(
        (<any>document.getElementById('range')).value !== '2/2/2017 - 4/4/2018'
      ).toBe(true);
      range = null;
    });
  ...
  describe('Hidden input testing', () => {
    ...
    it('Hidden value testing', () => {
      ...
      daterangepicker.dataBind();
      expect(daterangepicker.inputWrapper.container.childElementCount).toBe(5);
      expect(daterangepicker.inputWrapper.container.children[3].name).toBe(
        'date'
      );
      expect(daterangepicker.inputWrapper.container.children[3].type).toBe(
        'text'
      );
      expect(daterangepicker.inputWrapper.container.children[4].name).toBe(
        'date'
      );
      expect(daterangepicker.inputWrapper.container.children[4].type).toBe(
        'text'
      );
    });
  });
  ...
  describe('open event customization ', () => {
    ...
    it('PopupCreated event appendTo input container test case ', () => {
      ...
      expect(range.popupObj.element.parentElement).toBe(
        range.inputWrapper.container
      );
    });
  ...
  describe('Data attribue testing', () => {
    ...
    it('Data attribute at hidden element testing', () => {
      ...
      expect(daterangepicker.inputWrapper.container.childElementCount).toBe(5);
      expect(
        daterangepicker.inputWrapper.container.children[3].getAttribute(
          'data-value'
        )
      ).toBe('true');
      expect(
        daterangepicker.inputWrapper.container.children[4].getAttribute(
          'data-value'
        )
      ).toBe('true');
      expect(
        daterangepicker.inputWrapper.container.children[3].classList.contains(
          'e-daterange-hidden'
        )
      ).toBe(true);
      expect(
        daterangepicker.inputWrapper.container.children[4].classList.contains(
          'e-daterange-hidden'
        )
      ).toBe(true);
    });
    it('Data attribute at hidden element testing', () => {
      daterangepicker = new DateRangePicker({
        htmlAttributes: { 'data-valmsg-replace': 'true' },
      });
      daterangepicker.appendTo('#date');
      expect(daterangepicker.inputWrapper.container.childElementCount).toBe(5);
      expect(
  ...
  describe('invalid String', () => {
    ...
    it('valid string array Value Test Case', () => {
      daterangepicker = new DateRangePicker({
        value: [<any>'1/9/2018', <any>'4/10/2019'],
      });
      daterangepicker.appendTo('#range');
    ...
    it('valid string object Value Test Case', () => {
      daterangepicker = new DateRangePicker({
        value: { start: <any>'1/9/2018', end: <any>'4/10/2019' },
      });
      daterangepicker.appendTo('#range');
      expect(daterangepicker.element.value).toBe('1/9/2018 - 4/10/2019');
    ...
    it('invalid string Array type with value test case', () => {
      daterangepicker = new DateRangePicker({
        value: [<any>'dfgggdf', <any>'4/10/2019'],
      });
      daterangepicker.appendTo('#range');
      expect(daterangepicker.element.value).toBe('dfgggdf - 4/10/2019');
      expect(
    ...
    it('invalid string type with value test case and strictMode true ', () => {
      daterangepicker = new DateRangePicker({
        value: { start: new Date('4/10/2019'), end: <any>'123werf4' },
        strictMode: true,
      });
      daterangepicker.appendTo('#range');
      expect(daterangepicker.element.value).toBe('');
    ...
    it('ISO string type with value test case ', () => {
      daterangepicker = new DateRangePicker({
        value: [
          <any>'2017-02-02T12:30:00.000Z',
          <any>'2019-01-02T08:06:13.3426049+00:00',
        ],
      });
      daterangepicker.appendTo('#range');
      expect(daterangepicker.element.value != '').toBe(true);
    ...
    it('invalid object type with value test case  ', () => {
      daterangepicker = new DateRangePicker({
        value: { start: new Date('4/10/2019'), end: <any>{ a: 'b' } },
      });
      daterangepicker.appendTo('#range');
      expect(daterangepicker.element.value).toBe('');
      expect(
  ...
  describe('Start and Depth-Desktop', () => {
    ...
    it('default value testing', () => {
      daterangepicker = createControl({
        value: [new Date('1/8/2019'), new Date('1/10/2019')],
      });
    ...
    it('start and Depth as year', () => {
      daterangepicker = createControl({
        value: [new Date('1/8/2018'), new Date('1/10/2018')],
        start: 'Year',
        depth: 'Year',
      });
      ...
      (<HTMLElement>(
        document.querySelectorAll('.e-left-calendar .e-content td')[2]
      )).dispatchEvent(clickEvent);
      (<HTMLElement>(
        document.querySelectorAll('.e-right-calendar .e-content td')[2]
      )).dispatchEvent(clickEvent);
      expect(
        document
          .querySelector('.e-left-calendar .e-content')
      ...
      expect(document.querySelector('.e-start-label').innerHTML).toBe(
        'Mar 1, 2019'
      );
      expect(document.querySelector('.e-end-label').innerHTML).toBe(
        'Mar 31, 2019'
      );
      (<HTMLElement>(
        document.querySelector('.e-right-calendar .e-header .e-next')
      )).dispatchEvent(clickEvent);
      expect(document.querySelectorAll('.e-end-date').length).toBe(0);
      (<HTMLElement>(
        document.querySelector('.e-right-calendar .e-header .e-prev')
      )).dispatchEvent(clickEvent);
    ...
    it('start as Decade and Depth as Year', () => {
      daterangepicker = createControl({
        value: [new Date('1/8/2019'), new Date('1/10/2039')],
        start: 'Decade',
        depth: 'Year',
      });
      ...
      (<HTMLElement>(
        document.querySelectorAll('.e-right-calendar .e-content td')[5]
      )).dispatchEvent(clickEvent);
      expect(
        document
          .querySelector('.e-left-calendar .e-content')
    ...
    it('start and Depth as year on property', () => {
      daterangepicker = createControl({
        value: [new Date('1/8/2018'), new Date('1/10/2020')],
      });
      expect(daterangepicker.start).toBe('Month');
      expect(daterangepicker.depth).toBe('Month');
      daterangepicker.depth = 'Year';
    ...
    it('start and Depth as year and end Exceding max', () => {
      daterangepicker = createControl({
        value: [new Date('1/8/2018'), new Date('1/10/2118')],
        start: 'Year',
        depth: 'Year',
      });
      expect(daterangepicker.start).toBe('Year');
      ...
      ).toBe((new Date().getFullYear() + 1).toString());
    });
    it('start and Depth as Decade and end Exceding max', () => {
      daterangepicker = createControl({
        value: [new Date('1/8/2019'), new Date('1/10/2119')],
        start: 'Decade',
        depth: 'Decade',
      });
      expect(daterangepicker.start).toBe('Decade');
    ...
    it('start and Depth as year with mindays and maxdays', () => {
      daterangepicker = createControl({
        value: [new Date('2/1/2018'), new Date('5/31/2018')],
        start: 'Year',
        depth: 'Year',
        minDays: 65,
        maxDays: 159,
      ...
      expect(
        (<HTMLElement>(
          document.querySelector('.e-start-date')
        )).previousElementSibling.classList.contains('e-disabled')
      ).toBe(false);
      expect(
        (<HTMLElement>(
          document.querySelector('.e-start-date')
        )).nextElementSibling.classList.contains('e-disabled')
      ).toBe(false);
      expect(
        (<HTMLElement>(
          document.querySelector('.e-end-date')
        )).nextElementSibling.classList.contains('e-disabled')
      ).toBe(false);
      (<HTMLElement>(
        document.querySelectorAll('.e-left-calendar .e-content td')[5]
      )).dispatchEvent(clickEvent);
      expect(document.querySelectorAll('.e-end-date').length).toBe(0);
      expect(
        (<HTMLElement>(
      ...
      expect(
        (<HTMLElement>(
          document.querySelectorAll('.e-right-calendar .e-content td')[3]
        )).classList.contains('e-disabled')
      ).toBe(true);
    });
    it('start and Depth as year Selection maintained on navigation', () => {
      ...
      expect(
        (<HTMLElement>document.querySelector('.e-start-date')).innerText
      ).toBe('Jun');
      expect(document.querySelectorAll('.e-end-date').length).toBe(0);
      expect(
        (<HTMLElement>(
      ...
      (<HTMLElement>(
        document.querySelector('.e-left-calendar .e-header .e-prev')
      )).dispatchEvent(clickEvent);
      (<HTMLElement>(
        document.querySelector('.e-left-calendar .e-header .e-next')
      )).dispatchEvent(clickEvent);
      expect(
        (<HTMLElement>document.querySelector('.e-start-date')).innerText
      ).toBe('Jun');
    ...
    it('start and Depth as Decade Selection maintained on navigation', () => {
      daterangepicker = createControl({
        value: [new Date('1/1/2015'), new Date('12/31/2018')],
        start: 'Decade',
        depth: 'Decade',
        minDays: 864,
      });
    ...
    it('start and Depth as Decade ,no rangehover for same start and end date', () => {
      daterangepicker = createControl({
        value: [new Date('1/1/2016'), new Date('12/31/2018')],
        start: 'Decade',
        depth: 'Decade',
      });
      expect(daterangepicker.start).toBe('Decade');
      ...
      expect(
        (<HTMLElement>document.querySelector('.e-end-date')).classList.contains(
          'e-range-hover'
        )
      ).toBe(true);
      (<HTMLElement>(
      ...
      expect(
        (<HTMLElement>document.querySelector('.e-end-date')).innerText
      ).toBe('2014');
      expect(
        (<HTMLElement>(
          document.querySelector('.e-start-date')
  ...
  describe('Start and Depth-Mobile', () => {
    ...
    it('start and Depth as year', () => {
      daterangepicker = createControl(
        {
          value: [new Date('1/8/2018'), new Date('2/10/2018')],
          start: 'Year',
          depth: 'Year',
        },
        true
      ...
      expect(daterangepicker.depth).toBe('Year');
      expect(
        (<HTMLElement>document.querySelector('.e-day.e-title')).textContent
      ).toBe('2018');
      (<HTMLElement>(
        document.querySelectorAll('.e-content td')[2]
      )).dispatchEvent(clickEvent);
      /*next Button*/
      (<HTMLElement>document.querySelector('.e-next')).dispatchEvent(
        clickEvent
      );
      expect(
        (<HTMLElement>document.querySelector('.e-day.e-title')).textContent
      ...
      (<HTMLElement>(
        document.querySelectorAll('.e-content td')[6]
      )).dispatchEvent(clickEvent);
      expect(
        document.querySelector('.e-content').classList.contains('e-year')
      ).toBe(true);
      /*next Button*/
      (<HTMLElement>document.querySelector('.e-next')).dispatchEvent(
        clickEvent
      ...
      /*prev Button*/
      (<HTMLElement>document.querySelector('.e-prev')).dispatchEvent(
        clickEvent
      );
      expect(
        (<HTMLElement>document.querySelector('.e-day.e-title')).textContent
      ...
      (<HTMLElement>(
        document.querySelector('.e-start-date')
      )).nextElementSibling.dispatchEvent(clickEvent);
      expect(document.querySelectorAll('.e-end-date').length).toBe(1);
      expect(document.querySelectorAll('.e-start-date').length).toBe(1);
    });
    it('start and Depth as year, navigation with start alone', () => {
      ...
      expect(
        (<HTMLButtonElement>document.querySelector('.e-end-btn.e-btn')).disabled
      ).toBe(false);
      expect(
        document
          .querySelector('.e-start-btn.e-btn')
          .classList.contains('e-active')
      ).toBe(false);
      expect(
        document
          .querySelector('.e-end-btn.e-btn')
          .classList.contains('e-active')
      ).toBe(true);
      expect(
        (<HTMLElement>(
    ...
    it('start and Depth as Decade', () => {
      ...
      expect(
        document.querySelector('.e-content').classList.contains('e-decade')
      ).toBe(true);
      /*next Button*/
      (<HTMLElement>document.querySelector('.e-next')).dispatchEvent(
        clickEvent
    ...
    it('start and Depth as Decade and navigation', () => {
      daterangepicker = createControl(
        {
          value: [new Date('1/1/2018'), new Date('12/31/2018')],
          start: 'Decade',
          depth: 'Decade',
        },
        true
    ...
    it('start and Depth as Decade on property', () => {
      daterangepicker = createControl(
        { value: [new Date('1/1/2017'), new Date('12/31/2037')] },
        true
      );
      expect(daterangepicker.start).toBe('Month');
      expect(daterangepicker.depth).toBe('Month');
      ...
      expect(document.querySelector('.e-start-btn').innerHTML).toBe(
        'Jan 1, 2017'
      );
      expect(document.querySelector('.e-end-btn').innerHTML).toBe(
        'Dec 31, 2037'
      );
    });
    it('start as Decade and Depth as Year on property', () => {
      daterangepicker = createControl(
        { value: [new Date('1/1/2019'), new Date('1/31/2039')] },
        true
      );
      expect(daterangepicker.start).toBe('Month');
      expect(daterangepicker.depth).toBe('Month');
      ...
      (<HTMLElement>(
        document.querySelectorAll('.e-content td')[5]
      )).dispatchEvent(clickEvent);
      expect(document.querySelector('.e-start-btn').innerHTML).toBe(
        'Mar 1, 2011'
      );
    ...
    it('start and Depth as year on property', () => {
      ...
      expect(daterangepicker.depth).toBe('Month');
      expect(
        document.querySelector('.e-content').classList.contains('e-month')
      ).toBe(true);
      daterangepicker.depth = 'Year';
      daterangepicker.start = 'Year';
      daterangepicker.dataBind();
  ...
  describe('Navigated event trigger testing', () => {
    ...
    it('Navigated events in desktop mode test case', () => {
      ...
      expect(
        daterangepicker.popupObj.element.querySelector(
          '.e-left-calendar .e-day.e-title'
        ).textContent === 'February 2019'
      ).toBe(true);
      expect(
        daterangepicker.popupObj.element.querySelector(
          '.e-right-calendar .e-day.e-title'
      ...
      expect(
        daterangepicker.popupObj.element.querySelector(
          '.e-left-calendar .e-day.e-title'
        ).textContent === '2050 - 2059'
      ).toBe(true);
      expect(
        daterangepicker.popupObj.element.querySelector(
          '.e-right-calendar .e-day.e-title'
        ).textContent === '2060 - 2069'
      ).toBe(true);
      expect(
        daterangepicker.popupObj.element
          .querySelector('.e-left-calendar .e-prev')
    ...
    it('Navigated events in mobile mode for empty date', function () {
      ...
      expect(
        daterangepicker.popupObj.element.querySelector('.e-day.e-title')
    ...
    it('current date is less then min value', () => {
      ...
      expect(
        daterangepicker.popupObj.element.querySelector(
          '.e-left-calendar .e-day.e-title'
        ).textContent === 'January 1900'
      ).toBe(true);
      expect(
        daterangepicker.popupObj.element.querySelector(
          '.e-right-calendar .e-day.e-title'
        ).textContent === 'February 1900'
      ).toBe(true);
      expect(
        daterangepicker.popupObj.element
          .querySelector('.e-left-calendar .e-prev')
      ...
      expect(
        daterangepicker.popupObj.element.querySelector(
          '.e-left-calendar .e-day.e-title'
        ).textContent === '1900 - 1909'
      ).toBe(true);
      expect(
        daterangepicker.popupObj.element.querySelector(
          '.e-right-calendar .e-day.e-title'
        ).textContent === '1910 - 1919'
      ).toBe(true);
      expect(
        daterangepicker.popupObj.element
          .querySelector('.e-left-calendar .e-prev')
    ...
    it('current date is greater then max value', () => {
      ...
      expect(
        daterangepicker.popupObj.element.querySelector(
          '.e-left-calendar .e-day.e-title'
        ).textContent === 'November 2099'
      ).toBe(true);
      expect(
        daterangepicker.popupObj.element.querySelector(
          '.e-right-calendar .e-day.e-title'
        ).textContent === 'December 2099'
      ).toBe(true);
      expect(
        daterangepicker.popupObj.element
          .querySelector('.e-left-calendar .e-prev')
      ...
      expect(
        daterangepicker.popupObj.element.querySelector(
          '.e-left-calendar .e-day.e-title'
        ).textContent === '2080 - 2089'
      ).toBe(true);
      expect(
        daterangepicker.popupObj.element.querySelector(
          '.e-right-calendar .e-day.e-title'
        ).textContent === '2090 - 2099'
      ).toBe(true);
      expect(
        daterangepicker.popupObj.element
          .querySelector('.e-left-calendar .e-prev')
  ...
  describe('DateRangePicker', function () {
    ...
    it('focus event checking on document click when the calendar is open test case', function () {
      ...
      document
        .getElementsByClassName(' e-input-group-icon e-range-icon e-icons')[0]
        .dispatchEvent(clickEvent);
  ...
  describe('Dynamic CssClass testcase', function () {
    ...
    it('single css class', function () {
      ...
      expect(
        daterangepicker.inputWrapper.container.classList.contains('e-test')
      ).toBe(true);
    });
    it('more than one css class', function () {
      ...
      expect(
        daterangepicker.inputWrapper.container.classList.contains('e-secondary')
      ).toBe(true);
  ...
  describe('Cleared event test case', function () {
    ...
    it('check value after button click', function () {
      ...
      dateRangePicker.appendTo('#date');
      dateRangePicker.element.parentElement
        .querySelectorAll('.e-clear-icon')[0]
        .click();
      expect(dateRangePicker.inputElement.value === '').toBe(true);
    });
  });
  ...
  describe('EJ2-36604 - While giving the class name with empty space for HtmlAttributes, console error is produced.', function () {
    ...
    it('Giving only empty space  without entering any class Name', function () {
      ...
      daterangepicker.appendTo('#daterangepicker');
      let beforeAddClass =
        daterangepicker.inputWrapper.container.classList.length;
  ...
  describe('EJ2-42298- cannot select end date when dynamically changing property through select event', function () {
    ...
    it('dynamically change property on select event- minDays & maxDays', function () {
      ...
      expect(daterangepicker.isPopupOpen()).toBe(true);
      <HTMLElement>(
        daterangepicker.tableBodyElement
  ...
  describe('EJ2-45532 - DateRangepicker popup closing when updating value dynamically', function () {
    ...
    it('check the popup open', function () {
      ...
      daterangePicker.dataBind();
      expect(daterangePicker.popupObj !== null).toBe(true);
      expect(daterangePicker.inputElement.value === '1/1/2020 - 2/2/2020').toBe(
        true
      );
    });
  });
  describe('EJ2-47722 - If openOnFocus property is enabled then DateRangePicker popup does not closed properly', function () {
    ...
    it('check the popup open by focus the control', function () {
      ...
      expect(
        dateRangePicker.popupObj.element
          .querySelector('.e-presets li:first-child')
          .nextElementSibling.classList.contains('e-active')
      ).toBe(true);
      <HTMLElement>(
        dateRangePicker.popupObj.element
          .querySelector('.e-presets li:first-child')
  ...
  describe('EJ2-48804- Preset ranges with time value', function () {
    ...
    it('Checking preset item is selected when popup is opened', function () {
      dateRangePicker = new DateRangePicker({
        presets: [
          {
            label: 'Custom Date',
            start: new Date(2020, 1, 1, 10, 10, 50),
            end: new Date(2020, 3, 1, 9, 30, 40),
          },
          {
            label: 'Last week',
            start: new Date(new Date().setDate(new Date().getDate() - 7)),
    ...
    it('Checking preset item is selected when popup is opened with predefined value', function () {
      dateRangePicker = new DateRangePicker({
        value: [
          new Date(2020, 1, 1, 10, 10, 50),
          new Date(2020, 3, 1, 9, 30, 40),
        ],
        presets: [
          {
            label: 'Custom Date',
  ...
  describe('EJ2-56196 - Component get freeze if we enter invalid value', function () {
    ...
    it('Check the performance issue while entering invalid start or end date', function () {
      ...
      expect(daterangePicker.popupObj !== null).toBe(true);
      expect(
        daterangePicker.inputElement.value === '1/1/2020 - 2/2/20201'
      ).toBe(true);
    });
  });
  describe('EJ2-68040', () => {
  ...
  describe('EJ2-67265', () => {
    ...
    it('Browser hangs when difference between start and end date value is high', function () {
      ...
      daterangepicker = new DateRangePicker({
        renderDayCell: function (args: any): void {
          if (args.date.getDay() === 0 || args.date.getDay() === 6) {
            ...
            if (
              !startWeekDay &&
              args.date.getMonth() == new Date().getMonth()
            ) {
      ...
      let tdElement = daterangepicker.popupObj.element.querySelectorAll(
        '.e-calendar.e-left-calendar td:not(.e-other-month):not(.e-disabled)'
      );
  ...
  describe('Null or undefined value testing', () => {
    ...
    it('max', () => {
      ...
      expect(daterangepickerObj.max.valueOf()).toBe(
        new Date(2099, 11, 31).valueOf()
      );
      daterangepickerObj.destroy();
      daterangepickerObj = new DateRangePicker(
        {
    ...
    it('min', () => {
      ...
      expect(daterangepickerObj.min.valueOf()).toBe(
        new Date(1900, 0, 1).valueOf()
      );
      daterangepickerObj.destroy();
      daterangepickerObj = new DateRangePicker(
        {
