...
describe('Datepicker', () => {
  ...
  describe('property', () => {
    ...
    it('Input element value attributes test case', () => {
      ...
      expect(getIdValue(document.querySelector('tr td.e-selected'))).toBe(
        new Date('3/3/17').valueOf()
      );
    });
    ...
    it('Input element value attributes test case', () => {
      ...
      expect(
        document
          .getElementsByClassName(' e-input-group')[0]
    ...
    it('Input element max attributes test case', () => {
      ...
      datepicker.appendTo('#datepicker');
      expect(datepicker.max.toDateString()).toBe(
        new Date('3/3/17').toDateString()
      );
    });
    it('Input element min attributes test case', () => {
      ...
      datepicker = new DatePicker({ format: 'd/M/yy' });
      datepicker.appendTo('#datepicker');
      expect(datepicker.min.toDateString()).toBe(
        new Date('3/3/17').toDateString()
      );
    });
    ...
    it('width string type with value in px test case ', () => {
      ...
      expect(
        (<HTMLElement>document.querySelector('.e-date-wrapper')).style.width
      ).toBe('200px');
    });
    ...
    it('allowedit property with true test case ', () => {
      ...
      expect(
        document
          .querySelector('.e-datepicker.e-popup-wrapper')
          .classList.contains('e-popup-wrapper')
      ).toBe(true);
    });
    it('allowedit property with e-non-edit calss ', () => {
      ...
      expect(datepicker.element.getAttribute('readonly')).toBe(null);
      expect(
        datepicker.inputWrapper.container.classList.contains('e-non-edit')
      ).toBe(false);
      (<HTMLElement>(
        document.getElementsByClassName(
          ' e-input-group-icon e-date-icon e-icons'
    ...
    it('cssClass  test case', () => {
      ...
      datepicker.appendTo('#date');
      expect(
        datepicker.inputWrapper.container.classList.contains('e-custom')
      ).toBe(true);
      datepicker.dataBind();
    });
    it('multiple cssClass  test case', () => {
      ...
      expect(
        datepicker.inputWrapper.container.classList.contains(
          'e-secondary-class'
        )
      ).toBe(true);
      datepicker.show();
      ...
      expect(
        datepicker.popupWrapper.classList.contains('e-secondary-class')
      ).toBe(true);
      datepicker.cssClass = 'e-ternary e-cssClass';
      datepicker.dataBind();
      expect(
        datepicker.inputWrapper.container.classList.contains('e-ternary')
      ).toBe(true);
      expect(
        datepicker.inputWrapper.container.classList.contains('e-cssClass')
      ).toBe(true);
      datepicker.show();
      expect(datepicker.popupWrapper.classList.contains('e-ternary')).toBe(
        true
      );
      expect(datepicker.popupWrapper.classList.contains('e-cssClass')).toBe(
        true
      );
    });
    ...
    it('enabled test case ', function () {
      ...
      expect(datepicker.enabled).toBe(false);
      expect(
        document.getElementById('date').getAttribute('aria-disabled')
      ).toBe('true');
    });
    /**
     * tabIndex
    ...
    it('tab index of focus element', () => {
      ...
      datepicker.appendTo('#date');
      expect(
        datepicker.inputWrapper.container.children[0].getAttribute(
          'tabindex'
        ) === '0'
      ).toBe(true);
    });
    ...
    it('tab index of focus element in disable state ', () => {
      ...
      datepicker.appendTo('#date');
      expect(
        datepicker.inputWrapper.container.children[0].tabIndex === -1
      ).toBe(true);
    ...
    it('object type format test case', () => {
      datepicker = new DatePicker({
        format: { skeleton: 'full' },
        value: new Date('12/12/2016'),
      });
      datepicker.appendTo('#date');
      expect(datepicker.element.value == 'Monday, December 12, 2016').toBe(
        true
      );
    });
    ...
    it('Error Class for start value before 1905-Chrome testing', () => {
      ...
      expect(
        (<HTMLElement>(
          document.getElementsByClassName('e-date-wrapper')[0]
        )).classList.contains('e-error')
      ).toBe(false);
    ...
    it(' enableRtl  true test case', () => {
      ...
      datepicker.appendTo('#date');
      expect(
        document.querySelector('.e-input-group').classList.contains('e-rtl')
      ).toEqual(true);
    });
    ...
    it('strictMode false with out of range test case ', () => {
      ...
      datepicker.appendTo('#date');
      expect(
        document.querySelector('.e-input-group').classList.contains('e-error')
      ).toEqual(true);
    ...
    it('enableRtl test case', function () {
      ...
      expect(
        document.querySelector('.e-date-wrapper').classList.contains('e-rtl')
      ).toBe(true);
      (<HTMLElement>(
        document.getElementsByClassName(
          ' e-input-group-icon e-date-icon e-icons'
      ...
      expect(
        document.querySelector('.e-calendar').classList.contains('e-rtl')
      ).toEqual(true);
    });
    /**
     * Input test case
    ...
    it('Element created with floatLabelType property with Auto type', () => {
      ...
      expect(
        datepicker.inputWrapper.container.classList.contains('e-float-input')
      ).toBe(true);
      expect(
        datepicker.inputWrapper.container.children[1].classList.contains(
          'e-float-line'
        )
      ).toBe(true);
      expect(
        datepicker.inputWrapper.container.children[2].classList.contains(
          'e-float-text'
        )
      ).toBe(true);
      expect(
      ...
      expect(datepicker.inputWrapper.container.children[2].innerText).toBe(
        'Select a date'
      );
    ...
    it('Element created with floatLabelType property with Never type', () => {
      ...
      expect(datepicker.inputElement.getAttribute('placeholder')).toBe(
        'Select a date'
      );
      expect(
        datepicker.inputWrapper.container.children[2].classList.contains(
    ...
    it('autocorrect attribute test case', () => {
      ...
      datepicker = new DatePicker();
      datepicker.appendTo('#date');
      expect(datepicker.element.getAttribute('autocorrect') == 'off').toBe(
        true
      );
    });
    it('autocapitalize attribute test case', () => {
      ...
      datepicker = new DatePicker();
      datepicker.appendTo('#date');
      expect(datepicker.element.getAttribute('autocapitalize') == 'off').toBe(
        true
      );
    });
    it('spellcheck attribute test case', () => {
      ...
      datepicker = new DatePicker();
      datepicker.appendTo('#date');
      expect(datepicker.element.getAttribute('spellcheck') == 'false').toBe(
        true
      );
    });
    it('autocomplete attribute test case', () => {
      ...
      datepicker = new DatePicker();
      datepicker.appendTo('#date');
      expect(datepicker.element.getAttribute('autocomplete') == 'off').toBe(
        true
      );
    });
    /**
  ...
  describe('Angular tag testing ', () => {
    ...
    it('Wrapper testing ', () => {
      ...
      expect(datepicker.element.classList.contains('e-datepicker')).toEqual(
        true
      );
      ...
      expect(
        datepicker.inputWrapper.container.classList.contains('e-date-wrapper')
      ).toEqual(true);
      expect(
        datepicker.inputWrapper.container.children[0].classList.contains(
          'e-lib'
        )
      ).toEqual(true);
      expect(datepicker.inputElement.id).toEqual(
        datepicker.element.id + '_input'
      );
    });
  });
  describe('notify property changes', () => {
    ...
    it('strictMode true test case', function () {
      ...
      datepicker.inputBlurHandler();
      dateString(datepicker, '12/31/2099');
      expect(datepicker.value.toDateString()).toBe(
        new Date('12/31/2099').toDateString()
      );
    });
    ...
    it('enabled  test case', () => {
      ...
      datepicker.enabled = true;
      datepicker.dataBind();
      expect(document.getElementById('date').getAttribute('disabled')).toBe(
        null
      );
    ...
    it('cssClass  test case', () => {
      ...
      datepicker.dataBind();
      expect(
        datepicker.inputWrapper.container.classList.contains('e-custom-date')
      ).toBe(true);
    });
    it('width  test case', () => {
      datepicker = new DatePicker({
  ...
  describe('public method', () => {
    ...
    it('focusIn method test case ', function () {
      ...
      datepicker.focusIn();
      expect(
        datepicker.element.parentElement.classList.contains('e-input-focus')
      ).toBe(true);
  ...
  describe('clear button related testing', () => {
    ...
    it('clear icon', () => {
      expect(
        datepicker.inputWrapper.clearButton.classList.contains('e-clear-icon')
      ).toBe(true);
    });
    it('clear button default state', () => {
      expect(datepicker.value.valueOf()).toBe(new Date('12/12/2016').valueOf());
      expect(
        datepicker.inputWrapper.clearButton.classList.contains(
          'e-clear-icon-hide'
        )
      ).toBe(true);
    });
  ...
  describe('Remove selected date while cleared using backspace key', () => {
    ...
    it('Remove selected date', function () {
      ...
      expect(
        getIdValue(
          datePicker.tableBodyElement.querySelector('tr td.e-focused-date')
        )
      ).toBe(new Date('2/2/2017').valueOf());
      expect(
        datePicker.tableBodyElement
          .querySelector('td.e-focused-date')
          .classList.contains('e-selected-date')
      ).toBe(false);
    });
    it('Check Start and Depth as Year', function () {
      ...
      document
        .getElementsByClassName(' e-input-group-icon e-date-icon e-icons')[0]
        .dispatchEvent(clickEvent);
      expect(datePicker.popupObj != null).toBe(true);
      document.getElementsByClassName('e-day')[3].dispatchEvent(clickEvent);
      expect(
        datePicker.inputWrapper.container.classList.contains('e-input-focus')
      ).toBe(true);
  ...
  describe('close prevented events', () => {
    ...
    it('enter key after new value when popup open test case', function () {
      ...
      expect(
        getIdValue(
          datePicker.tableBodyElement.querySelector('tr td.e-selected')
        )
      ).toBe(new Date('12/12/2016').valueOf());
      expect(datePicker.popupObj !== null).toBe(true);
      ...
      ).toBe(new Date('12/11/2016').valueOf());
    });
  ...
  describe('Check placeholder after load culture', () => {
    ...
    it('Set placeholder through API', () => {
      datePicker = new DatePicker(
        { floatLabelType: 'Auto', locale: 'zh', placeholder: 'Testo date' },
        '#date'
      );
  ...
  describe('HTML attributes at inline element testing', () => {
    ...
    it('Inline and API testing', () => {
      datePicker = new DatePicker({
        ...
        readonly: false,
        enabled: true,
        value: new Date('7/4/2017'),
        min: new Date('2/2/2019'),
        max: new Date('9/9/2019'),
      });
      datePicker.appendTo('#date');
      expect(datePicker.placeholder).toBe('Select a date');
      ...
      expect(datePicker.min.toDateString()).toBe(
        new Date('2/2/2019').toDateString()
      );
      expect(datePicker.max.toDateString()).toBe(
        new Date('9/9/2019').toDateString()
      );
    });
  ...
  describe('HTML attribute API testing', () => {
    ...
    it('Other attribute testing with htmlAttributes API', () => {
      datePicker = new DatePicker({
        htmlAttributes: { name: 'picker', class: 'test', title: 'sample' },
      });
      datePicker.appendTo('#date');
      expect(datePicker.element.getAttribute('name')).toBe('picker');
      expect(datePicker.inputWrapper.container.getAttribute('title')).toBe(
        'sample'
      );
      expect(datePicker.inputWrapper.container.classList.contains('test')).toBe(
        true
      );
    });
  });
  ...
  describe('HTML attribute API dynamic testing', () => {
    ...
    it('Dynamically change attributes with htmlAttributes API', () => {
      ...
      datePicker.appendTo('#date');
      expect(datePicker.element.getAttribute('placeholder')).toBe(
        'Enter a date'
      );
      expect(datePicker.element.hasAttribute('readonly')).toBe(true);
      ...
      expect(datePicker.inputWrapper.container.getAttribute('style')).toBe(
      ...
      expect(
        datePicker.inputWrapper.container.classList.contains('multiple')
      ).toBe(true);
    });
  ...
  describe('today button', () => {
    ...
    it('click test case', () => {
      ...
      expect(datepicker.value.valueOf()).toBe(
  ...
  describe('class', () => {
    ...
    it('Without error class', () => {
      datepicker = new DatePicker({
        value: new Date('11/12/2017'),
        min: new Date('1/12/2017'),
        max: new Date('12/12/2017'),
      });
      datepicker.appendTo('#date');
      expect(
        datepicker.inputWrapper.container.classList.contains('e-error')
      ).toBe(false);
      (<HTMLElement>(
        document.getElementsByClassName(
          ' e-input-group-icon e-date-icon e-icons'
      ...
      expect(datepicker.element.value).toBe(
        new Date('11/12/2017').toLocaleDateString()
      );
    ...
    it('value out of range with error class', () => {
      ...
      expect(datepicker.element.value).toBe(
        new Date('11/12/2018').toLocaleDateString()
      );
    ...
    it(' min with value out of range with error class', () => {
      ...
      expect(datepicker.element.value).toBe(
        new Date('1/10/2017').toLocaleDateString()
      );
    ...
    it('max with value out of range with error class', () => {
      ...
      expect(datepicker.element.value).toBe(
        new Date('1/15/2017').toLocaleDateString()
      );
    ...
    it('onproperty changes with error class test case', () => {
      datepicker = new DatePicker({
        min: new Date('1/11/2017'),
        max: new Date('1/15/2017'),
      });
      datepicker.appendTo('#date');
      expect(
        datepicker.inputWrapper.container.classList.contains('e-error')
      ...
      expect(datepicker.element.value).toBe(
        new Date('1/17/2017').toLocaleDateString()
      );
  ...
  describe('HTML attribute API at inital rendering and dynamic rendering', () => {
    ...
    it('Html attributes at initial rendering', () => {
      datePicker = new DatePicker({
        htmlAttributes: { placeholder: 'Choose the date', class: 'sample' },
      });
      datePicker.appendTo('#date');
      expect(datePicker.element.getAttribute('placeholder')).toBe(
        'Choose the date'
      ...
      expect(
        datePicker.inputWrapper.container.classList.contains('sample')
      ).toBe(true);
    });
  ...
  describe('keyboard events', () => {
    ...
    it('alt+DownArrow key test case', function () {
      ...
      expect(
        document
          .getElementsByClassName('e-calendar')[0]
  ...
  describe('events', () => {
    ...
    it('DatePicker icon click test case', function () {
      ...
      datePicker.appendTo('#date');
      (<HTMLElement>(
        document.getElementsByClassName('e-date-icon')[0]
      )).dispatchEvent(clickEvent);
      expect(
        document
          .getElementsByClassName('e-calendar')[0]
    ...
    it('open event with preventing the popup test case', function () {
      ...
      expect(
        isNullOrUndefined(document.getElementsByClassName('e-popup')[0])
      ).toBe(true);
    });
  ...
  describe('Model dialog', function () {
    ...
    it(' mobile test case', function () {
      ...
      expect(
        document
          .getElementsByClassName('e-date-modal')[0]
          .classList.contains('e-date-modal')
      ).toBe(true);
    });
  ...
  describe('Model full screen layout dialog', function () {
    ...
    it(' mobile test case', function () {
      ...
      expect(
        document
          .getElementsByClassName(' e-datepicker e-popup-wrapper')[0]
          .classList.contains('e-popup-expand')
      ).toBe(true);
    });
  ...
  describe('method', function () {
    ...
    it('currentView month test case  ', function () {
      ...
      expect(
        document
          .getElementsByClassName('e-content e-month')[0]
  ...
  describe('Popup', function () {
    ...
    it('popup element visiblity test case', () => {
      ...
      expect(
        datepicker.popupObj.element.classList.contains('e-popup-wrapper')
      ).toBe(true);
      expect(
        document
          .getElementsByClassName('e-popup-wrapper')[0]
          .classList.contains('e-popup-wrapper')
      ).toBe(true);
      datepicker.destroy();
      expect(
        isNullOrUndefined(document.getElementsByClassName('e-popup-wrapper')[0])
      ).toBe(true);
  ...
  describe('Internationalization', function () {
    ...
    it('firstDayOfWeek based on the culture "de" test case ', () => {
      ...
      expect(datepicker.tableHeadElement.querySelector('th').textContent).toBe(
        'Mo.'
      );
    });
  ...
  describe('Date with time options', () => {
    ...
    it('value with time', () => {
      datepicker = new DatePicker({
        ...
        value: new Date('4/4/2017 4:00'),
      });
      datepicker.appendTo('#date');
      expect(datepicker.value.toLocaleString()).toBe(
    ...
    it('value with time onproperty change test case ', () => {
      ...
      datepicker.dataBind();
      expect(datepicker.value.toLocaleString()).toBe(
        new Date('3/4/2017 3:00 AM').toLocaleString()
      );
    ...
    it('enabled onproperty change test case ', () => {
      ...
      datepicker.enabled = false;
      datepicker.dataBind();
      expect(datepicker.inputElement.getAttribute('aria-disabled')).toBe(
        'true'
      );
      datepicker.enabled = true;
      datepicker.dataBind();
    ...
    it('value with format test case', () => {
      ...
      datepicker.appendTo('#date');
      expect(datepicker.value.toLocaleString()).toBe(
        new Date('4/4/2017 0:00 AM').toLocaleString()
      );
    ...
    it('value without time', () => {
      ...
      datepicker.appendTo('#date');
      expect(datepicker.value.toLocaleString()).toBe(
        new Date('4/4/2017').toLocaleString()
      );
    ...
    it(' min and max  with current date  test case ', () => {
      ...
      expect(datepicker.contentElement.classList.contains('e-month')).toBe(
        true
      );
      expect(
        document.querySelector('.e-datepicker .e-calendar .e-title').textContent
      ).toBe('April 2018');
      expect(datepicker.previousIcon.classList.contains('e-disabled')).toBe(
        false
      );
      expect(datepicker.nextIcon.classList.contains('e-disabled')).toBe(true);
      (<HTMLElement>(
        document.querySelector('.e-datepicker .e-prev span')
      )).click();
    ...
    it('value with format (MM/dd/yyyy H:mm a) test case ', () => {
      ...
      expect(datepicker.value.toLocaleString()).toBe(
        new Date('03/29/2017 9:00 PM').toLocaleString()
      );
      expect(
        document
          .getElementsByClassName(' e-input-group')[0]
    ...
    it(' Unmatched value with format (MM/dd/yyyy hh:mm) test case ', () => {
      ...
      datepicker.appendTo('#date');
      expect(datepicker.value.toLocaleString()).toBe(
        new Date('04/05/2017 9:00 AM').toLocaleString()
      );
    ...
    it('min value with time (error case)', () => {
      ...
      datepicker.appendTo('#date');
      expect(datepicker.value.valueOf()).toBe(
        new Date('11/1/2017 14:00').valueOf()
      );
    });
    ...
    it('Calendar view after setting the value as null through onproperty changes', () => {
      ...
      expect(
        document.querySelector('.e-focused-date').classList.contains('e-today')
      ).toBe(true);
    });
  });
  describe('Form element', () => {
    ...
    it('Input value reset in destroy case (initialized)', () => {
      ...
      (<any>document.getElementById('form-element')).reset();
      expect(
        (<any>document.getElementById('datepicker')).value !== '2/2/2017'
      ).toBe(true);
      datepicker = null;
    });
    ...
    it('Input value reset in destroy case ', () => {
      ...
      datepicker.destroy();
      (<any>document.getElementById('form-element')).reset();
      expect((<any>document.getElementById('datepicker')).value === '').toBe(
        true
      );
      datepicker = null;
    });
  ...
  describe('open event customization ', () => {
    ...
    it('PopupCreated event appendTo input container test case ', () => {
      datepicker = new DatePicker({
        value: new Date(),
        open: function (args: PopupObjectArgs) {
      ...
      expect(datepicker.popupObj.element.parentElement).toBe(
        datepicker.inputWrapper.container
      );
    });
  ...
  describe('Dynamic CssClass testcase', function () {
    ...
    it('single css class', function () {
      ...
      expect(
        datePicker.inputWrapper.container.classList.contains('e-test')
      ).toBe(true);
    });
    it('more than one css class', function () {
      ...
      expect(
        datePicker.inputWrapper.container.classList.contains('e-secondary')
      ).toBe(true);
  ...
  describe('Cleared event test case', function () {
    ...
    it('check value after button click', function () {
      ...
      datePicker.appendTo('#date');
      datePicker.element.parentElement
  ...
  describe('EJ2-35061 - change event triggered twice with strict mode and format', function () {
    ...
    it('Checking whether the change is called after inputblur', function (done) {
      ...
      setTimeout(() => {
        (<HTMLSpanElement>(
          document
            .getElementsByClassName('e-month-hide')[0]
            .nextElementSibling.querySelectorAll('.e-day')[4]
        )).dispatchEvent(clickEvent);
        setTimeout(() => {
  ...
  describe('EJ2-36108', function () {
    ...
    it('Timezone issue on selecting 1/1/1970', function () {
      ...
      (
        document.getElementsByClassName('e-focused-date')[0] as HTMLElement
      ).click();
      expect(datePicker.currentView()).toBe('Year');
      (
        document.getElementsByClassName('e-focused-date')[0] as HTMLElement
  ...
  describe('EJ2-36604 - While giving the class name with empty space for HtmlAttributes, console error is produced.', function () {
    ...
    it('Entering the class name without any empty space', function () {
      ...
      datePicker.appendTo('#datepicker');
      expect(
        datePicker.inputWrapper.container.classList.contains('custom-class')
      ).toBe(true);
    });
    ...
    it('Giving more than one empty space between two class names', function () {
      ...
      datePicker.appendTo('#datepicker');
      expect(
        datePicker.inputWrapper.container.classList.contains('custom-class1')
      ).toBe(true);
      expect(
        datePicker.inputWrapper.container.classList.contains('custom-class2')
      ).toBe(true);
    });
    ...
    it('Giving more than one empty space between two class names', function () {
      ...
      datePicker.appendTo('#datepicker');
      expect(
        datePicker.inputWrapper.container.classList.contains('custom-class-one')
      ).toBe(true);
      expect(
        datePicker.inputWrapper.container.classList.contains('custom-class-two')
      ).toBe(true);
    });
    it('Giving more than one empty space between two class names as well as before and after the class names', function () {
      datePicker = new DatePicker({
  ...
  describe('EJ2-49003 - Datepicker focus class not added for selected date', function () {
    ...
    it('check the focus class added for selected date', function () {
      ...
      datePicker.inputKeyActionHandle(keyEventArgs);
      expect(
        datePicker.tableBodyElement.querySelectorAll('.e-focused-date').length
      ).toEqual(1);
      keyEventArgs.action = 'moveLeft';
      datePicker.inputKeyActionHandle(keyEventArgs);
      expect(
      ...
      var selectedCell =
        datePicker.tableBodyElement.querySelector('.e-selected');
...
describe('Masked DatePicker', () => {
  ...
  describe('property', () => {
    ...
    it('Validation', () => {
      ...
      let date: Date = new Date();
      expect(datepicker.element.value).toBe(
        new Date(date.getFullYear(), 1 + 1, 0).getDate().toString() + '/02/year'
      );
      expect(datepicker.value).toBe(null);
  ...
  describe('Null or undefined value testing', () => {
    ...
    it('maskPlaceholder', () => {
      ...
      expect(JSON.stringify(datepickerObj.maskPlaceholder)).toBe(
    ...
    it('max', () => {
      ...
      expect(datepickerObj.max.valueOf()).toBe(
