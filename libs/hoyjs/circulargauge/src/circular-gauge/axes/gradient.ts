...
import { Property, ChildProperty, Complex, Collection, isNullOrUndefined } from '@hoyui/base';
import { GradientColor, LinearGradient as Linear, RadialGradient as Radial } from '@hoyui/svg-base';
