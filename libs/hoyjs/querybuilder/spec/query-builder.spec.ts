...
import { NumericTextBox, TextBox } from '@hoyui/inputs';
import { CheckBox } from '@hoyui/buttons';
import { DropDownButton, ItemModel } from '@hoyui/splitbuttons';
import {
  DropDownList,
  MultiSelect,
  CheckBoxSelection,
...
import { Slider } from '@hoyui/inputs';
import { DatePicker, DateRangePicker, TimePicker } from '@hoyui/calendars';
import { profile, inMB, getMemoryProfile } from './common.spec';
import { DataManager, WebApiAdaptor } from '@hoyui/data';
...
describe('QueryBuilder', () => {
  ...
  const columnData2: ColumnsModel[] = [
    ...
    { field: 'Status', label: 'Status', type: 'string' },
    {
      ...
      label: 'Date',
      type: 'date',
      operators: [{ key: 'between', value: 'between' }],
    },
      ...
      template: {
        ...
        destroy: (args: { elements: NodeListOf<Element> }) => {
          for (let i = 0, len = args.elements.length; i < len; i++) {
            const date: TimePicker = getComponent(
              args.elements[i] as HTMLElement,
              'timepicker'
            ) as TimePicker;
            if (date) {
              date.destroy();
  ...
  describe('DOM', () => {
    ...
    it('Default testing', () => {
      ...
      expect(
        queryBuilder.element.classList.contains('e-query-builder')
      ).toBeTruthy();
      expect(
        queryBuilder.element.firstElementChild.classList.contains(
          'e-group-container'
        )
      ).toBeTruthy();
      let childContent: Element =
        queryBuilder.element.firstElementChild.children[0];
      expect(childContent.classList.contains('e-group-header')).toBeTruthy();
      expect(
        childContent.children[0].classList.contains('e-drag-qb-rule')
      ).toBeTruthy();
      expect(
        childContent.children[1].classList.contains('e-btn-group')
      ).toBeTruthy();
      expect(
        childContent.children[2].classList.contains('e-group-action')
      ).toBeTruthy();
      ...
      expect(
        childContent.firstElementChild.classList.contains('e-rule-list')
      ).toBeTruthy();
      expect(
        childContent.firstElementChild.children[0].classList.contains(
          'e-rule-container'
        )
      ).toBeTruthy();
    });
    ...
    it('Add Group / condition testing', () => {
      ...
      let childContent: Element =
        queryBuilder.element.firstElementChild.children[0];
      expect(childContent.classList.contains('e-group-header')).toBeTruthy();
      const addBtn: HTMLElement = select(
        '.e-add-btn',
        childContent
      ) as HTMLElement;
      addBtn.click();
      ...
      (
        selectAll(
          '.e-item',
          queryBuilder.element.nextElementSibling
        )[0] as HTMLElement
      ).click();
      childContent =
        queryBuilder.element.firstElementChild.children[1].children[0];
      expect(childContent.classList.contains('e-rule-list')).toBeTruthy();
      expect(
        childContent.firstElementChild.classList.contains('e-rule-container')
      ).toBeTruthy();
      expect(
        childContent.firstElementChild.nextElementSibling.children[0].classList.contains(
          'e-group-header'
        )
      ).toBeTruthy();
      expect(
        childContent.firstElementChild.nextElementSibling.children[1].classList.contains(
          'e-group-body'
        )
      ).toBeTruthy();
      addBtn.click();
      ...
      expect(
        childContent.children[1].classList.contains('e-group-container')
      ).toBeTruthy();
      const cloneBtn: HTMLElement = document.getElementsByClassName(
        'e-clone-grp-btn'
      )[0] as HTMLElement;
      cloneBtn.click();
    ...
    it('QueryBuilder with cloneGroup', () => {
      ...
      cloneBtn.click();
      const lockRule: HTMLElement = document.getElementsByClassName(
        'e-lock-rule-btn'
      )[0] as HTMLElement;
      lockRule.click();
      lockRule.click();
      lockRule.click();
      const lockGroup: HTMLElement = document.getElementsByClassName(
        'e-lock-grp-btn'
      )[0] as HTMLElement;
      const childLockGroup: HTMLElement = document.getElementsByClassName(
        'e-lock-grp-btn'
      )[1] as HTMLElement;
  ...
  describe('Property', () => {
    ...
    it('displayMode testing Vertical', () => {
      ...
      let ruleElem: HTMLElement =
        queryBuilder.element.querySelector('.e-rule-container');
      expect(ruleElem.classList.contains('e-vertical-mode')).toBeTruthy();
      ruleElem = queryBuilder.element.querySelector('.e-rule-filter');
      expect(
        queryBuilder.element.querySelector('.e-rule-filter').style.display
      ).toEqual('');
    });
    ...
    it('cssClass testing', () => {
      ...
      expect(
        queryBuilder.element.classList.contains('e-custom-rule')
      ).toBeTruthy();
      queryBuilder.cssClass = 'e-cust-rule';
      queryBuilder.dataBind();
      expect(queryBuilder.cssClass).toEqual('e-cust-rule');
      expect(
        queryBuilder.element.classList.contains('e-cust-rule')
      ).toBeTruthy();
    });
    ...
    it('enable summaryView testing', () => {
      ...
      queryBuilder.dataBind();
      expect(
        queryBuilder.element.querySelector('.e-summary-content').style.display
      ).toEqual('block');
    ...
    it('disable summaryView testing', () => {
      ...
      expect(
        queryBuilder.element.querySelectorAll('.e-collapse-rule').length
      ).toBe(0);
      queryBuilder.addRules(
        [
          {
      ...
      const multiObj: MultiSelect = queryBuilder.element.querySelector(
        '.e-control.e-multiselect'
      ).ej2_instances;
      multiObj[0].value = ['A', 'B'];
      multiObj[0].dataBind();
      (<HTMLElement>(
        queryBuilder.element.querySelector('.e-control.e-multiselect')
      )).click();
    });
    it('disable Button testing', () => {
      ...
      expect(
        queryBuilder.element
          .querySelector('.e-rule-delete')
          .classList.contains('e-button-hide')
      ).toBeTruthy();
      expect(
        queryBuilder.element
          .querySelector('.e-deletegroup')
          .classList.contains('e-button-hide')
      ).toBeTruthy();
      (
        document.getElementsByClassName('e-dropdown-btn')[0] as HTMLElement
      ).click();
      expect(
        document
          .getElementsByClassName('e-addgroup')[0]
          .parentElement.classList.contains('e-button-hide')
      ).toBeTruthy();
    });
    ...
    it('columns testing', () => {
      ...
      queryBuilder.element
        .querySelector('.e-rule-operator.e-operator span')
        .click();
      const filterElem: DropDownList = queryBuilder.element.querySelector(
        '.e-rule-filter .e-control'
      ).ej2_instances[0];
      ...
      let operatorElem: DropDownList = queryBuilder.element.querySelector(
        '.e-rule-operator .e-control'
      ).ej2_instances;
      expect(operatorElem[0].value).toEqual('equal');
      let valueElem: NumericTextBox = queryBuilder.element.querySelector(
      ...
      let items: NodeListOf<HTMLElement> = document
        .getElementById('querybuilder_group0_rule0_operatorkey_options')
        .querySelectorAll('li');
      items[3].click();
      expect(operatorElem[0].value).toEqual('between');
      expect(queryBuilder.rule.rules[0].operator).toEqual('between');
      expect(
        queryBuilder.element.querySelectorAll('.e-rule-value .e-control').length
      ).toBe(3);
      //Change the numeric textbox value
      valueElem = queryBuilder.element.querySelectorAll(
        '.e-rule-value .e-control'
      )[0].ej2_instances;
      ...
      //Change the operator
      operatorElem = queryBuilder.element.querySelector(
        '.e-rule-operator .e-control'
      ).ej2_instances;
      operatorElem[0].showPopup();
      items = document
      ...
      expect(
        queryBuilder.element
          .querySelector('.e-rule-value .e-control')
          .classList.contains('e-multiselect')
      ).toBeTruthy();
      ...
      items = document
        .getElementById('querybuilder_group0_rule0_filterkey_options')
        .querySelectorAll('li');
      items[1].click();
  ...
  describe('set Models', () => {
    ...
    it('Set Models', () => {
      ...
      queryBuilder.dataBind();
      expect(
        queryBuilder.element.classList.contains('e-queryrender')
      ).toBeTruthy();
      ...
      queryBuilder.summaryView = true;
      queryBuilder.dataBind();
      expect(selectAll('.e-summary-content', queryBuilder.element).length).toBe(
        1
      );
      ...
      (
        document.getElementsByClassName('e-dropdown-btn')[1] as HTMLElement
      ).click();
      expect(
        document
          .getElementsByClassName('e-addgroup')[1]
          .parentElement.classList.contains('e-button-hide')
      ).toBeFalsy();
      queryBuilder.showButtons = {
        lockGroup: true,
  ...
  describe('Button Clicks', () => {
    ...
    it('Button changes', () => {
      ...
      (
        document.getElementsByClassName('e-btngroup-or-lbl')[0] as HTMLElement
      ).click();
      ...
      expect(
        document
          .getElementsByClassName('e-summary-content')[0]
          .querySelector('textarea').value
      ).toEqual("EmployeeID = 1 OR Title = 'Sales Manager'");
      (
        document.getElementsByClassName('e-edit-rule')[0] as HTMLElement
      ).click();
      expect(
        queryBuilder.element.querySelector('.e-summary-content').style.display
      ).toEqual('none');
      ...
      expect(selectAll('.e-group-container', queryBuilder.element).length).toBe(
        2
      );
      expect(selectAll('.e-rule-container', queryBuilder.element).length).toBe(
        4
      );
      // Delete Group button
      (
        document.getElementsByClassName('e-deletegroup')[0] as HTMLElement
      ).click();
      expect(selectAll('.e-group-container', queryBuilder.element).length).toBe(
        1
      );
      ...
      // Delete rule
      (
        document.getElementsByClassName('e-removerule')[0] as HTMLElement
      ).click();
      expect(selectAll('.e-rule-container', queryBuilder.element).length).toBe(
        1
      );
      ...
      (
        document.getElementsByClassName('e-collapse-rule')[0] as HTMLElement
      ).click();
      expect(selectAll('.e-summary-content', queryBuilder.element).length).toBe(
        1
      );
    ...
    it('Button changes - Separate Connector', () => {
      ...
      (queryBuilder as any).beforeSuccessCallBack(
        args,
        queryBuilder.element.querySelector('.e-rule-filter .e-input-group')
      );
      args = {
        groupID: 'group0',
        cancel: false,
      ...
      (queryBuilder as any).beforeSuccessCallBack(
        args,
        queryBuilder.element.querySelector('.e-add-condition-btn')
      );
      args = {
        groupID: 'group0',
        cancel: false,
      ...
      (queryBuilder as any).beforeSuccessCallBack(
        args,
        queryBuilder.element.querySelector('.e-qb-toggle-btn')
      );
    });
  ...
  describe('Template support', () => {
    ...
    it('Template sample', () => {
      ...
      (
        document.getElementsByClassName('e-TransactionType')[0] as HTMLElement
      ).click();
      expect(queryBuilder.rule.rules[1].rules[0].value).toEqual('income');

      // Field change
      let filterElem: DropDownList = queryBuilder.element.querySelector(
        '.e-rule-filter .e-control'
      ).ej2_instances;
      filterElem[0].showPopup();
      let itemsCln: NodeListOf<HTMLElement> = document
        .getElementById('querybuilder_group0_rule0_filterkey_options')
        .querySelectorAll('li');
      itemsCln[4].click();
      expect(filterElem[0].value).toEqual('Date');
      expect(filterElem[0].dataSource[filterElem[0].index].type).toEqual(
        'date'
      );
      expect(
        queryBuilder.element
          .querySelectorAll('.e-rule-value .e-control')[0]
          .classList.contains('e-timepicker')
      ).toBeTruthy();
      ...
      expect(
        queryBuilder.element
          .querySelectorAll('.e-rule-value .e-control')[0]
          .classList.contains('e-dropdownlist')
      ).toBeTruthy();
      ...
      expect(
        queryBuilder.element
          .querySelectorAll('.e-rule-value .e-control')[0]
          .classList.contains('e-textbox')
      ).toBeTruthy();

      //Operator change
      const operatorElem: DropDownList = queryBuilder.element.querySelector(
        '.e-rule-operator .e-control'
      ).ej2_instances;
      operatorElem[0].showPopup();
      itemsCln = document
      ...
      //Multiple select
      filterElem = queryBuilder.element.querySelector(
        '.e-rule-operator input.e-control'
      ).ej2_instances;
      filterElem[0].showPopup();
      itemsCln = document
        .getElementById('querybuilder_group0_rule0_operatorkey_options')
      ...
      expect(
        document.getElementsByClassName('e-querybuilder-error').length
      ).toBe(1);
      const msObj: MultiSelect = queryBuilder.element.querySelector(
      ...
      filterElem = queryBuilder.element.querySelectorAll(
        '.e-rule-filter .e-control'
      )[3].ej2_instances;
      filterElem[0].showPopup();
      itemsCln = document
        .getElementById('querybuilder_group0_rule3_filterkey_options')
        .querySelectorAll('li');
      itemsCln[0].click();
      filterElem = queryBuilder.element.querySelectorAll(
        '.e-rule-filter .e-control'
  ...
  describe('Public Methods', () => {
    ...
    it('getsql from rules testing', () => {
      ...
      const fieldElem: DropDownList = queryBuilder.element.querySelector(
        '.e-filter-input.e-control'
      ).ej2_instances;
      fieldElem[0].showPopup();
      const itemsCln = document
        .getElementById('querybuilder_group0_rule0_filterkey_options')
        .querySelectorAll('li');
      itemsCln[6].click();
      ...
      expect(queryBuilder.getSqlFromRules()).toEqual(
        "NOT (Category LIKE ('%Laptop') OR Category LIKE ('%Lap%'))"
      );
      expect(selectAll('.e-group-container', queryBuilder.element).length).toBe(
        1
      );
      ...
      const sqlString: string =
        "NOT (Category LIKE ('%Laptop') OR Category LIKE ('%Lap%') OR ( NOT (Category LIKE ('%Laptop') OR Category LIKE ('%Lap%'))))";
      expect(queryBuilder.getSqlFromRules()).toEqual(sqlString);
      queryBuilder.setRules(simpleRule);
      expect(queryBuilder.getSqlFromRules(simpleRule, true)).toEqual(
        "`Category` LIKE ('%Laptop')"
      );
      queryBuilder.setRules(simpleRule1);
      expect(queryBuilder.getSqlFromRules(simpleRule1, true)).toEqual(
        '`Category` IS NULL'
      );
      queryBuilder.setRules(simpleRule2);
      expect(queryBuilder.getSqlFromRules(simpleRule2)).toEqual(
        "Category IN ('a','b') OR TaskID IN (1,2)"
      );
    ...
    it('setRules from sql rule testing', () => {
      ...
      queryBuilder.setRules(
        queryBuilder.getRulesFromSql("Category LIKE ('%Laptop')")
      );
      expect(selectAll('.e-group-container', queryBuilder.element).length).toBe(
        1
      );
      ...
      queryBuilder.setRules(
        queryBuilder.getRulesFromSql("Category LIKE ('%Nancy%')")
      );
      expect(selectAll('.e-group-container', queryBuilder.element).length).toBe(
        1
      );
      ...
      queryBuilder.setRules(
        queryBuilder.getRulesFromSql("Category IN ('a', 'b')")
      );
      expect(selectAll('.e-group-container', queryBuilder.element).length).toBe(
        1
      );
      ...
      queryBuilder.setRules(
        queryBuilder.getRulesFromSql("Category NOT LIKE ('')")
      );
      expect(selectAll('.e-group-container', queryBuilder.element).length).toBe(
        1
      );
      queryBuilder.setRules(
        queryBuilder.getRulesFromSql(
          "Category LIKE ('%Laptop') AND (NOT (Category LIKE ('%L')))"
        )
      );
      queryBuilder.setRules(
        queryBuilder.getRulesFromSql("Date BETWEEN '1/6/2020' AND '1/8/2020'")
      );
      queryBuilder.setRules(
        queryBuilder.getRulesFromSql(
          "Category LIKE ('%Laptop') AND (NOT (Category IS NULL))"
        )
      );
    });
    ...
    it('getDataManagerQuery', () => {
      ...
      expect(
        queryBuilder.getDataManagerQuery(queryBuilder.rule).queries.length
      ).toBe(1);
    ...
    it('getFilteredRecords', () => {
      ...
      (
        document.getElementsByClassName('e-removerule')[1] as HTMLElement
      ).click();
    ...
    it('Validation', () => {
      ...
      queryBuilder.validateFields();
      let filterElem: DropDownList = queryBuilder.element.querySelector(
        '.e-rule-filter input.e-control'
      ).ej2_instances;
      expect(
        filterElem[0].element.parentElement.classList.contains('e-tooltip')
      ).toBeTruthy();
      expect(
        document.getElementsByClassName('e-querybuilder-error').length
      ).toBe(1);
      ...
      items[9].click();
      queryBuilder.validateFields();
      const textBoxObj: TextBox = queryBuilder.element.querySelector(
        '.e-rule-value input.e-control'
      ).ej2_instances;
      textBoxObj[0].element.dispatchEvent(new Event('focus'));
      textBoxObj[0].element.dispatchEvent(
        new KeyboardEvent('keypress', { key: 'c' })
      );
      textBoxObj[0].dataBind();
      queryBuilder.updateRules(textBoxObj[0].element, 'US', 0);
      expect(
        textBoxObj[0].element.parentElement.classList.contains('e-tooltip')
      ).toBeFalsy();
      expect(
        document.getElementsByClassName('e-querybuilder-error').length
      ).toBe(0);
    ...
    it('Validation - Empty Operator', () => {
      ...
      queryBuilder.setRules({
        condition: 'and',
        rules: [{ field: 'EmployeeName', operator: 'equal', value: 'a' }],
      });
    ...
    it('Date Value changes', () => {
      ...
      const cObj: DatePicker = queryBuilder.element.querySelector(
        '.e-rule-value input.e-control'
      ).ej2_instances;
      ...
      expect(
        queryBuilder
          .getPredicate(queryBuilder.rule)
          .predicates[0].value.toDateString()
      ).toEqual('Wed Feb 10 2021');
      ...
      expect(
        queryBuilder.getPredicate(queryBuilder.rule).value.toDateString()
      ).toEqual('Wed Feb 10 2021');
      queryBuilder.element.querySelector('.e-rule-delete').click();
      queryBuilder.addRules(
        [
      ...
      const datePObj: DatePicker = queryBuilder.element.querySelectorAll(
        '.e-rule-value .e-control'
      )[0].ej2_instances;
      datePObj[0].show();
      (<HTMLElement>(
        document.querySelectorAll('.e-datepicker.e-popup .e-cell')[5]
      )).click();
    });
    ...
    it(' in Operator Checking', () => {
      ...
      expect(queryBuilder.getSqlFromRules(queryBuilder.rule)).toEqual(
        "EmployeeID BETWEEN 4 AND 5 AND Title IN ('Sales Manager') AND City LIKE ('u%')"
      );
      queryBuilder.getOperator(
        queryBuilder.getSqlFromRules(queryBuilder.rule),
        'NOT LIKE',
        true
      );
      queryBuilder.getRulesFromSql(
      ...
      operatorElem = queryBuilder.element.querySelectorAll(
        '.e-rule-operator .e-control'
      )[1].ej2_instances;
      operatorElem[0].showPopup();
      itemsCln = document
        .getElementById('querybuilder_group0_rule1_operatorkey_options')
        .querySelectorAll('li');
      itemsCln[9].click();
      expect(operatorElem[0].value).toEqual('notin');
      queryBuilder.getFilteredRecords(queryBuilder.rule);
      expect(queryBuilder.getSqlFromRules(queryBuilder.rule)).toEqual(
        "EmployeeID NOT BETWEEN 0 AND 0 AND Title NOT IN ('Sales Manager') AND City LIKE ('u%')"
      );
      queryBuilder.reset();
      expect(selectAll('.e-group-container', queryBuilder.element).length).toBe(
        1
      ...
      queryBuilder.setRulesFromSql(
        "EmployeeID BETWEEN 0 AND 0 and Title IN ('Sales Manager') and City LIKE ('u%')"
      );
      expect(
        JSON.stringify(
          queryBuilder.getRulesFromSql(
        ...
        '[{"label":"Employee ID","field":"EmployeeID","operator":"between","type":"number","value":[0,0]},{"label":"Title","field":"Title","operator":"in","type":"string","value":["Sales Manager"]},{"label":"City","field":"City","operator":"startswith","value":"u","type":"string"}]'
      );
    });
    it(' Multiple value in textbox  Checking', () => {
      ...
      queryBuilder.updateRules(
        queryBuilder.element.querySelectorAll('.e-rule-value .e-control')[0],
        'US,45,45,4',
        0
      );
    });
    it('Custom Operator Checking', () => {
      ...
      expect(queryBuilder.getSqlFromRules(valRule)).toEqual(
        "FirstName <> 'Nancy'"
      );
    });
    it('Not Condition Checking', () => {
      ...
      expect(
        queryBuilder.element
          .querySelector('.e-qb-toggle.e-control')
          .classList.contains('e-active-toggle')
      ).toBeTruthy();
      ...
      (<HTMLElement>queryBuilder.element.querySelector('.e-qb-toggle')).click();
      (<HTMLElement>(
        queryBuilder.element.querySelector('.e-btngroup-and-lbl')
      )).click();
    });
    it('Readonly Checking', () => {
      ...
      expect(
        queryBuilder.element
          .querySelector('.e-btngroup-or-lbl')
          .classList.contains('e-readonly')
      ).toBeTruthy();
      ...
      queryBuilder.dataBind();
      const inputObj: any =
        queryBuilder.element.querySelector('.e-filter-input');
    ...
    it('Value Checking', () => {
      ...
      expect(
        queryBuilder.element
          .querySelector('.e-rule-value .e-control.e-input')
          .classList.contains('e-textbox')
      ).toBeTruthy();
      let inputObj: any = queryBuilder.element.querySelector(
        '.e-rule-value input.e-control'
      ).ej2_instances[0];
      ...
      expect(
        queryBuilder.element
          .querySelectorAll('.e-rule-value .e-control.e-input')[1]
          .classList.contains('e-textbox')
      ).toBeTruthy();
      inputObj = queryBuilder.element.querySelectorAll(
        '.e-rule-value input.e-control'
      )[1].ej2_instances[0];
      ...
      (<HTMLElement>(
        queryBuilder.element.querySelectorAll('.e-control.e-radio')[1]
      )).click();
      let operatorElem: DropDownList = queryBuilder.element.querySelectorAll(
        '.e-rule-operator .e-control'
      )[2].ej2_instances;
      operatorElem[0].showPopup();
      let items: NodeListOf<HTMLElement> = document
        .getElementById('querybuilder_group0_rule2_operatorkey_options')
        .querySelectorAll('li');
      items[1].click();
      queryBuilder.addRules(
        [
      ...
      operatorElem[0].showPopup();
      items = document
        .getElementById('querybuilder_group0_rule4_filterkey_options')
        .querySelectorAll('li');
      items[0].click();
    });
    it('Multiselect Checking', (done: Function) => {
      ...
      const listObj: any = queryBuilder.element.querySelector(
        '.e-rule-value input.e-control'
      ).ej2_instances[0];
      ...
      if (listWarapper) {
        const items: NodeListOf<HTMLElement> = document
          .getElementById('querybuilder_group0_rule0_valuekey0_popup')
          .querySelectorAll('li');
        items[1].click();
    ...
    it('In operator with textbox Checking', () => {
      ...
      const inputObj: any = queryBuilder.element.querySelectorAll(
        '.e-rule-value input.e-control'
      )[0].ej2_instances[0];
    ...
    it('Date value Checking', () => {
      ...
      const inputObj: DatePicker = queryBuilder.element.querySelector(
        '.e-rule-value .e-control'
      ).ej2_instances;
    ...
    it('Date with Format Checking', () => {
      ...
      let fieldElem: DropDownList = queryBuilder.element.querySelector(
        '.e-filter-input.e-control'
      ).ej2_instances;
      fieldElem[0].showPopup();
      let itemsCln: NodeListOf<HTMLElement> = document
      ...
      fieldElem = queryBuilder.element.querySelector(
        '.e-rule-operator input.e-control'
      ).ej2_instances;
      fieldElem[0].showPopup();
      itemsCln = document
    ...
    it('Predicate Checking', () => {
      ...
      expect(queryBuilder.getPredicate(queryBuilder.rule).operator).toEqual(
        'isnull'
      );
      let operatorElem: DropDownList = queryBuilder.element.querySelector(
        '.e-rule-operator .e-control'
      ...
      expect(
        queryBuilder.getPredicate(queryBuilder.rule).predicates[0].operator
      ).toEqual('greaterthanorequal');
      queryBuilder.setRulesFromSql(
        "Date NOT BETWEEN '1/12/2021' AND '2/12/2021'"
      );
      expect(
        queryBuilder.getPredicate(queryBuilder.rule).predicates[0].operator
      ).toEqual('lessthan');
      ...
      queryBuilder.setRulesFromSql(
        "Date BETWEEN '1/12/2021' AND '2/12/2021' OR Date = '1/12/2021'"
      );
      expect(
        queryBuilder.getPredicate(queryBuilder.rule).predicates[0].predicates[0]
          .operator
      ).toEqual('greaterthanorequal');
      queryBuilder.setRulesFromSql(
        "Category IN('S', 'R') OR Category IN('S', 'R')"
      );
      expect(
        queryBuilder.getPredicate(queryBuilder.rule).predicates[0].predicates[0]
          .operator
      ...
      queryBuilder.setRulesFromSql(
        "TaskID IN (4,5) OR (Category LIKE ('ALFKI%'))"
      );
      expect(
        queryBuilder.getPredicate(queryBuilder.rule).predicates[1].operator
      ).toEqual('startswith');
      queryBuilder.setRulesFromSql(
        "(Category LIKE ('ALFKI%')) OR (TaskID = 0)"
      );
      expect(
        queryBuilder.getPredicate(queryBuilder.rule).predicates[0].operator
      ).toEqual('startswith');
      ...
      queryBuilder.setRulesFromSql(
        "Category NOT LIKE ('%ALFKI%') OR Category NOT LIKE ('%ALFKI%')"
      );
      expect(
        queryBuilder.getPredicate(queryBuilder.rule).predicates[0].operator
      ).toEqual('doesnotcontain');
    ...
    it('Default Value Checking', () => {
      ...
      let filterElem: DropDownList = queryBuilder.element.querySelectorAll(
        '.e-rule-filter .e-control'
      )[1].ej2_instances;
      filterElem[0].showPopup();
      let itemsCln: NodeListOf<HTMLElement> = document
        .getElementById('querybuilder_group0_rule1_filterkey_options')
        .querySelectorAll('li');
      itemsCln[0].click();
      filterElem = queryBuilder.element.querySelectorAll(
        '.e-rule-filter .e-control'
      ...
      filterElem[0].showPopup();
      itemsCln = document
        .getElementById('querybuilder_group0_rule2_filterkey_options')
        .querySelectorAll('li');
      itemsCln[2].click();
      filterElem = queryBuilder.element.querySelectorAll(
        '.e-rule-filter .e-control'
    ...
    it('Is Empty Checking', () => {
      ...
      const filterElem: DropDownList = queryBuilder.element.querySelectorAll(
        '.e-rule-filter .e-control'
      )[0].ej2_instances;
      filterElem[0].showPopup();
      const itemsCln: NodeListOf<HTMLElement> = document
        .getElementById('querybuilder_group0_rule0_filterkey_options')
        .querySelectorAll('li');
      itemsCln[2].click();
    });
  ...
  describe('Platform Specific Column Template', () => {
    beforeEach((): void => {
      ...
      template.innerHTML =
        '<div class="e-slider-value"><div id = ${ruleID}_valuekey0 class="ticks_slider e-template"></div></div>';
      document.body.appendChild(template);
      const boolTemplate: Element = createElement('script', {
        id: 'boolTemplate',
      });
      boolTemplate.setAttribute('type', 'text/x-template');
      boolTemplate.innerHTML =
        '<div class="e-booean-value"><input id = ${ruleID}_valuekey0 class="e-template"></div></div>';
    ...
    it('Template Checking', () => {
      ...
      queryBuilder.lockGroup('group0');
      const slider: Slider = queryBuilder.element.querySelector(
        '.e-control.e-slider'
      ).ej2_instances[0];
      slider.value = 30;
      slider.dataBind();
  ...
  describe('Platform Specific Date Column Template', () => {
    beforeEach((): void => {
      ...
      template.setAttribute('type', 'text/x-template');
      template.innerHTML =
        '<div class="e-date-value"><input id = ${ruleID}_valuekey0 class="e-date1 e-template"/></div>';
      document.body.appendChild(template);
      template = createElement('script', { id: 'betweentemplate' });
      template.setAttribute('type', 'text/x-template');
      template.innerHTML =
        '<div class="e-date-value"><input id = ${ruleID}_valuekey0 class="e-date1 e-template"/><input id = ${ruleID}_valuekey1 class="e-date1 e-template"/></div>';
      document.body.appendChild(template);
    });
    afterEach(() => {
      remove(queryBuilder.element.nextElementSibling);
    ...
    it('Template Checking', () => {
              ...
              if (args.rule.field === 'Date') {
                ...
                dateObj = new DatePicker({
                  ...
                  change: (e: any) => {
                    const elem: HTMLElement = dateObj.element;
                    dateArr = [];
                    dateArr.push(e.value);
                    dateArr.push(dateObj2.value);
      ...
      let datePObj: DatePicker = queryBuilder.element.querySelectorAll(
        '.e-rule-value .e-control'
      )[1].ej2_instances;
      datePObj[0].value = new Date('02/10/2021');
      datePObj[0].dataBind();
      const dateRngObj: DateRangePicker = queryBuilder.element.querySelectorAll(
        '.e-rule-value .e-control'
      )[2].ej2_instances;
      dateRngObj[0].value = [new Date('02/10/2021'), new Date('02/11/2021')];
      dateRngObj[0].dataBind();
      datePObj = queryBuilder.element.querySelectorAll(
        '.e-rule-value .e-control'
      )[3].ej2_instances;
      datePObj[0].value = new Date('02/10/2021');
      datePObj[0].dataBind();
  ...
  describe('Platform Specific Rule Template', () => {
    ...
    it('Rule Template Checking', () => {
              ...
              valueObj = new Slider({
                ...
                change: (e: any) => {
                  const elem: HTMLElement = document.querySelector(
                    '.e-rule-value .e-control.e-slider'
                  );
                  queryBuilder.notifyChange(e.value, elem, 'value');
                },
              });
      ...
      expect(
        queryBuilder.getRule(
          document.getElementById('querybuilder_group0_rule0')
        ).field
      ).toEqual('EmployeeID');
      expect(
        queryBuilder.getGroup(document.getElementById('querybuilder_group0'))
          .condition
      ).toEqual('and');
      const slider: Slider = queryBuilder.element.querySelector(
        '.e-control.e-slider'
      ...
      expect(queryBuilder.getValues('Address.City')[0].Address.City).toEqual(
        'Seattle'
      );
      expect(
        queryBuilder.getValues('Address.PostalCode')[0].Address.PostalCode
      ).toEqual('98.122');
      fieldElem = queryBuilder.element.querySelectorAll(
        '.e-filter-input.e-control'
      )[1].ej2_instances;
      fieldElem[0].showPopup();
      itemsCln = document
      ...
      fieldElem[0].showPopup();
      itemsCln = document
        .getElementById('querybuilder_group0_rule5_filterkey_options')
        .querySelectorAll('li');
      itemsCln[0].click();
      fieldElem = queryBuilder.element.querySelectorAll(
        '.e-filter-input.e-control'
      ...
      fieldElem[0].showPopup();
      itemsCln = document
        .getElementById('querybuilder_group1_rule2_filterkey_options')
        .querySelectorAll('li');
      queryBuilder.isReact = false;
      queryBuilder.isAngular = false;
  ...
  describe('Platform Specific Header Template', () => {
    beforeEach((): void => {
      document.body.appendChild(createElement('div', { id: 'querybuilder' }));
      const template: Element = createElement('script', {
        id: 'headerTemplate',
      });
      template.setAttribute('type', 'text/x-template');
      template.innerHTML =
    ...
    it('Template Checking', () => {
            ...
            if (args.requestType === 'header-template-create') {
              ...
              const addbtn: DropDownButton = new DropDownButton({
                ...
                select: function (event: any) {
                  const addbtn: Element = closest(
                    event.element,
                    '.e-dropdown-popup'
                  );
                  const ddb: string[] = addbtn.id.split('_');
                  if (event.item.text === 'AddGroup') {
                    queryBuilder.addGroups(
                      [{ condition: 'and', rules: [{}], not: false }],
                      ddb[1]
                    );
              ...
              const deleteGroup: Element = document
                .getElementById(args.ruleID)
                .querySelector('.e-delete-btn');
              if (deleteGroup) {
      ...
      let itemCln: NodeListOf<HTMLElement> = document
        .getElementById('querybuilder_group0_addbtn-popup')
        .querySelectorAll('li');
      itemCln[0].click();
      (<HTMLElement>(
        document.querySelector('#querybuilder_group0_notoption')
      )).click();
      const condtion: DropDownList = queryBuilder.element.querySelector(
        '#querybuilder_group0_cndtnbtn'
      ).ej2_instances[0];
      condtion.showPopup();
      itemCln = document
        .getElementById('querybuilder_group0_cndtnbtn_popup')
        .querySelectorAll('li');
      itemCln[1].click();
    });
  ...
  describe('model binding support', () => {
    ...
    it('Complex Databinding Support with datasource', () => {
      ...
      const filter: DropDownList = queryBuilder.element.querySelector(
        '.e-filter-input.e-control'
      ).ej2_instances[0];
      filter.showPopup();
      const itemCln: NodeListOf<HTMLElement> = document
        .getElementById('querybuilder_group0_rule0_filterkey_options')
        .querySelectorAll('li');
      itemCln[1].click();
      queryBuilder.reset();
      queryBuilder.setRulesFromSql(
        "Employee.ID = 0 AND Name.LastName LIKE ('%malan%') AND (Country.State.City LIKE ('U%') AND Country.Region LIKE ('%c') AND Country.Name IS NOT EMPTY)"
      );
      queryBuilder.reset();
      queryBuilder.setRules(importRules);
    });
    ...
    it('Complex Databinding Support - Dropdown Tree', () => {
      ...
      const inpElem: HTMLElement = document.getElementById(
        'querybuilder_group0_rule0_filterkey'
      );
      (queryBuilder as any).changeField({
        element: inpElem,
        e: null,
        isInteracted: true,
        name: 'change',
    ...
    it('Complex Databinding Support - Dropdown Tree with angular template', () => {
      ...
      const input: HTMLElement = document.querySelector(
        '.e-qb-ddt.e-popup-open .e-textbox'
      );
  ...
  describe('Customer_Bugs', () => {
    beforeEach((): void => {
      ...
      template.innerHTML =
        '<div class="e-groupheader">${if(notCondition !== undefined)}<input type="checkbox" class="e-not" id="${ruleID}_notoption">${/if}<input type="text" class= "e-custom-group-btn" id="${ruleID}_cndtnbtn"><button id = "${ruleID}_addbtn" class="e-add-btn"></button>${if(ruleID !== "querybuilder_group0")}<button id="dltbtn" class="e-btn e-delete-btn e-small e-round e-icon-btn"><span class = "e-btn-icon e-icons e-delete-icon"></span></button>${/if}</div>';
      document.body.appendChild(template);
      const ageTemplate: Element = createElement('script', {
        id: 'ageTemplate',
      });
      ageTemplate.setAttribute('type', 'text/x-template');
      ageTemplate.innerHTML =
    ...
    it('EJ2-26551-Selected value not maintained properly for field checkbox in querybuilder', () => {
      ...
      expect(queryBuilder.rule.rules[0].value).toEqual('Mr.');
      const radioBtnCln: NodeListOf<HTMLElement> =
        document.querySelectorAll('.e-radio');
      radioBtnCln[1].click();
    ...
    it('EJ2-50725 - setRules not works for header template', () => {
      ...
      expect(
        document
          .querySelector('#querybuilder_group0_notoption')
          .nextElementSibling.classList.contains('e-check')
      ).toEqual(true);
      expect(
        queryBuilder.element.querySelector('#querybuilder_group0_cndtnbtn')
          .value
      ).toEqual('OR');
      queryBuilder.enableSeparateConnector = true;
      queryBuilder.isReact = true;
    ...
    it('EJ2-50550 - Rtl class not added for dropdown button popup', () => {
      ...
      expect(
        document
          .getElementsByClassName('e-item')[0]
          .parentElement.classList.contains('e-rtl')
      ).toBeTruthy();
      (
        document.getElementsByClassName('e-dropdown-btn')[0] as HTMLElement
      ).click();
      ...
      filterElem.showPopup();
      const ddlItems = document.getElementById(
        'querybuilder_group0_rule0_filterkey_options'
      ).parentElement;
      ...
      multiObj.showPopup();
      const msItems = document.getElementById(
        'querybuilder_group0_rule0_valuekey0_options'
      ).parentElement;
    ...
    it('EJ2-62285 - Date type Between value not render properly while use setRulesFromSql method', () => {
      ...
      queryBuilder.setRulesFromSql(
        "FirstName = 'Keerthi' AND HireDate BETWEEN '01/08/2022' AND '05/08/2022' AND Country = 'Erode'"
      );
      expect(queryBuilder.rule.rules[1].value).toEqual([
        '01/08/2022',
        '05/08/2022',
      ]);
    });
    ...
    it('EJ2-62916 - Custom operator not set properly when we set one field is a prefix of other field as number', () => {
      ...
      const filterElem = queryBuilder.element.querySelector(
        '.e-rule-filter .e-control'
      ).ej2_instances[0];
      filterElem.showPopup();
      const items = document
        ...
        .querySelectorAll('li');
      items[1].click();
      const filterElem1 = queryBuilder.element.querySelector(
        '.e-rule-operator .e-control'
      ).ej2_instances[0];
      filterElem1.showPopup();
      const items1 = document
        .getElementById('querybuilder_group0_rule0_operatorkey_options')
        .querySelectorAll('li');
    ...
    it('EJ2-68596 - Value template issue with complex data binding of query builder', () => {
      ...
      const filter1: DropDownList = queryBuilder.element.querySelector(
        '.e-filter-input.e-control'
      ).ej2_instances[0];
      filter1.showPopup();
      const itemCln1: NodeListOf<HTMLElement> = document
        .getElementById('querybuilder_group0_rule0_filterkey_options')
        .querySelectorAll('li');
      itemCln1[1].click();
    ...
    it('EJ2-68260 - Provided special character in SQL string support to query builder', () => {
      ...
      queryBuilder.setRulesFromSql(
        "Name.FirstName LIKE ('Date.parse('yyyy-MM-dd','1980-05-24')%')"
      );
      expect(queryBuilder.rule.rules[0].value).toEqual(
        "Date.parse('yyyy-MM-dd','1980-05-24')"
      );
    });
    ...
    it("EJ2-876239 - SetRulesFromSql method is not working while using a field name like Name = '|_fn { keyword ' kFinishedProduct '}_|'", () => {
      ...
      queryBuilder.setRulesFromSql(
        "Name = '|_fn { keyword ' kFinishedProduct '}_|' OR ID = 8"
      );
      expect(queryBuilder.getSqlFromRules(queryBuilder.rule)).toEqual(
        "Name = '|_fn { keyword ' kFinishedProduct '}_|' OR ID = 8"
      );
  ...
  describe('Coverge Improvement', () => {
    ...
    it('QueryBuilder with allowDragAndDrop dragstart', () => {
      queryBuilder = new QueryBuilder(
        { allowDragAndDrop: true, columns: columnData, rule: rules },
        '#querybuilder'
      );
      const dragSpan: Element = queryBuilder.element.querySelector(
        '.e-rule-field .e-drag-qb-rule'
      );
      queryBuilder.draggable.currentStateTarget = dragSpan;
      const cloneElem: Element = createElement('div', {
        id: 'querybuilder',
        className: 'e-cloneproperties e-draganddrop e-dragclone e-group-body',
      });
    ...
    it('QueryBuilder with allowDragAndDrop draghandler', () => {
      ...
      queryBuilder.dragHandler({
        target: dragSpan,
        event: { clientY: 300 },
        dragElement: cloneElem,
      });
      let ruleElem: Element[] =
        queryBuilder.element.querySelectorAll('.e-rule-container');
      let eventObj: any = {
        event: { clientY: 100 },
        target: ruleElem[1],
        dragElement: cloneElem,
      ...
      queryBuilder = new QueryBuilder(
        {
          columns: customFieldData,
          showButtons: {
            ruleDelete: undefined,
            groupInsert: undefined,
  ...
  describe('Get Sql From Rules and Set sql from rules', () => {
    ...
    it('QueryBuilder get and set sql methods', () => {
      ...
      let actualSql: string =
        "EmployeeID = 1 AND Title = 'Sales Manager' AND (FirstName LIKE ('ewfew%') OR TitleOfCourtesy = 'Mr.' OR (FirstName LIKE ('ewfew%') AND HireDate = '12/06/2024') OR (FirstName LIKE ('reer%') OR Title LIKE ('erer%'))) AND Title LIKE ('ewfew%')";
      ...
      actualSql =
        "EmployeeID = 1001 AND (Title LIKE ('%Sales Manager%') OR (City = 'Kirkland' AND (FirstName LIKE ('fewfew%') OR FirstName LIKE ('efew%'))) OR LastName LIKE ('erer%')) AND (FirstName LIKE ('ewfew%') AND Title LIKE ('efweew%'))";
      queryBuilder.setRulesFromSql(actualSql);
      expectedSql = queryBuilder.getSqlFromRules();
      expect(expectedSql).toEqual(actualSql);
      actualSql =
        "(EmployeeID = 1 AND LastName LIKE ('rgerger%') AND (FirstName LIKE ('erger%') OR Title LIKE ('asawd%')) AND (Title LIKE ('reger%') AND FirstName LIKE ('aefwaw%')) AND (Title LIKE ('ewrew%') OR LastName LIKE ('ewfew%')))";
      queryBuilder.setRulesFromSql(actualSql);
      expectedSql = queryBuilder.getSqlFromRules();
      expect(expectedSql).toEqual(actualSql);
    });
  ...
  describe('clone, lock group covergae improvement', () => {
    ...
    it('QueryBuilder methods cloneGroup, lockGroup', () => {
      ...
      queryBuilder.cloneRule(
        'querybuilder_group0_rule0',
        'querybuilder_group0',
        1
      );
  ...
  describe('Coverage Improvement', () => {
    ...
    it('QueryBuilder with complex data binding filtering', () => {
      ...
      const filterElem: DropDownTree = queryBuilder.element.querySelector(
        '.e-rule-filter .e-control.e-dropdowntree'
      ).ej2_instances[0];
      filterElem.showPopup();
      let filterInp: Element = document.querySelector(
        '.e-qb-ddt .e-filter-wrap .e-textbox'
      );
      queryBuilder.dropdownTreeFiltering({
        cancel: false,
        text: 'em',
      ...
      filterInp = document.querySelector(
        '.e-qb-ddt .e-filter-wrap .e-clear-icon'
      );
      queryBuilder.dropdownTreeFiltering({
        cancel: false,
        text: '',
  ...
  describe('Coverage Improvement - number literal', () => {
    ...
    it('QueryBuilder with number literal', () => {
      queryBuilder = new QueryBuilder(
        { columns: numberLiteralData, rule: rules },
        '#querybuilder'
      );
      ...
      let operator: string = (queryBuilder as any).getOperator(
        '%sgsdg%',
        'not like',
        true
      );
  ...
  describe('Coverage Improvement', () => {
    ...
    it('QueryBuilder with allowDragAndDrop helper', () => {
      ...
      let dragSpan: Element = queryBuilder.element.querySelector(
        '.e-rule-field .e-drag-qb-rule'
      );
      queryBuilder.draggable.currentStateTarget = dragSpan;
      queryBuilder.helper();
      dragSpan = queryBuilder.element.querySelector(
        '.e-group-header .e-drag-qb-rule'
      );
      queryBuilder.draggable.currentStateTarget = dragSpan;
      queryBuilder.helper();
      queryBuilder.isFieldChange = false;
      queryBuilder.isDestroy = false;
  ...
  describe('drag stop covergae improvement - Drag and drop rule', () => {
    ...
    it('QueryBuilder with allowDragAndDrop dragStop - enable separator', (done: Function) => {
      ...
      const eventObj: any = { target: dragSpan, dragElement: cloneElem };
      queryBuilder.dragStartHandler(eventObj);
      queryBuilder.draggedRule =
        queryBuilder.element.querySelectorAll('.e-drag-qb-rule')[1];
      dragSpan = queryBuilder.element.querySelectorAll('.e-rule-field')[1];
      queryBuilder.dragStopHandler({
        target: dragSpan,
        event: { clientX: 100 },
  ...
  describe('drag stop covergae improvement - Drag and drop group', () => {
    ...
    it('QueryBuilder with allowDragAndDrop dragStop - group', (done: Function) => {
      ...
      const dragSpan: Element = document
        .querySelectorAll('.e-group-header')[2]
        .querySelector('.e-drag-qb-rule');
      queryBuilder.draggable.currentStateTarget = dragSpan;
      const cloneElem: Element = createElement('div', {
        id: 'querybuilder',
        className: 'e-cloneproperties e-draganddrop e-dragclone e-group-body',
    ...
    it('QueryBuilder coverage - code coverage', (done: Function) => {
      ...
      const predicate: any = (queryBuilder as any).getPredicate(
        (queryBuilder as any).getValidRules()
      );
      queryBuilder.rule.isLocked = true;
      queryBuilder.rule.custom = { value: 'sgsdgsg' };
      const rule: any = queryBuilder.getRules();
      (queryBuilder as any).disableRuleCondition(
        (queryBuilder as any).element.querySelectorAll('.e-group-container')[1]
      );
      done();
    });
    ...
    it('QueryBuilder with allowDragAndDrop dragStop - grop drag and drop', (done: Function) => {
      ...
      queryBuilder = new QueryBuilder(
        { allowDragAndDrop: true, columns: columnData, rule: dRules },
        '#querybuilder'
      );
      const dragSpan: Element =
        queryBuilder.element.querySelector('.e-rule-list');
      queryBuilder.draggable.currentStateTarget =
        queryBuilder.element.querySelectorAll('.e-drag-qb-rule')[1];
      const cloneElem: Element = createElement('div', {
        id: 'querybuilder',
        className: 'e-cloneproperties e-draganddrop e-dragclone e-group-body',
      ...
      queryBuilder.dragElement = cloneElem;
      queryBuilder.draggedRule =
        queryBuilder.element.querySelectorAll('.e-drag-qb-rule')[6];
      const eventObj: any = { target: dragSpan, dragElement: cloneElem };
      queryBuilder.dragStartHandler(eventObj);
      eventObj.event = {
        clientX: 100,
    ...
    it('QueryBuilder with allowDragAndDrop dragStop - grop drag and drop to empty group', (done: Function) => {
      ...
      queryBuilder.dragElement = cloneElem;
      queryBuilder.draggedRule =
        queryBuilder.element.querySelectorAll('.e-drag-qb-rule')[5];
      const eventObj: any = { target: dragSpan, dragElement: cloneElem };
      queryBuilder.dragStartHandler(eventObj);
      eventObj.event = {
        clientX: 100,
    ...
    it('QueryBuilder with allowDragAndDrop dragStop - querybuilder as target', (done: Function) => {
      ...
      queryBuilder.dragElement = cloneElem;
      queryBuilder.draggedRule =
        queryBuilder.element.querySelectorAll('.e-drag-qb-rule')[4];
      const eventObj: any = { target: dragSpan, dragElement: cloneElem };
      queryBuilder.dragStartHandler(eventObj);
      eventObj.event = {
        clientX: 100,
    ...
    it('QueryBuilder with allowDragAndDrop dragStop - querybuilder as target', (done: Function) => {
      ...
      const dragSpan: Element =
        queryBuilder.element.querySelectorAll('.e-rule-list')[1];
      queryBuilder.draggable.currentStateTarget = dragSpan;
      const cloneElem: Element = createElement('div', {
        id: 'querybuilder',
        className: 'e-cloneproperties e-draganddrop e-dragclone e-group-body',
      ...
      queryBuilder.dragElement = cloneElem;
      queryBuilder.draggedRule =
        queryBuilder.element.querySelectorAll('.e-drag-qb-rule')[2];
      const eventObj: any = { target: dragSpan, dragElement: cloneElem };
      queryBuilder.dragStartHandler(eventObj);
      queryBuilder.element.querySelector('.e-removerule').click();
      eventObj.event = {
    ...
    it('QueryBuilder with allowDragAndDrop dragStop - group0 as target', (done: Function) => {
      ...
      const dragSpan: Element =
        queryBuilder.element.querySelector('.e-group-container');
      queryBuilder.draggable.currentStateTarget = dragSpan;
      const cloneElem: Element = createElement('div', {
        id: 'querybuilder',
        className: 'e-cloneproperties e-draganddrop e-dragclone e-group-body',
    ...
    it('QueryBuilder with allowDragAndDrop dragStop - header as target separate connector', (done: Function) => {
      ...
      const dragSpan: Element =
        queryBuilder.element.querySelector('.e-add-group-btn');
      queryBuilder.draggable.currentStateTarget = dragSpan;
      const cloneElem: Element = createElement('div', {
        id: 'querybuilder',
        className: 'e-cloneproperties e-draganddrop e-dragclone e-group-body',
  ...
  describe('Data Manager', () => {
    ...
    it('Remote Data Checking', (done: Function) => {
      const msObj: TextBox = queryBuilder.element.querySelector(
        '.e-rule-value input.e-control'
      ).ej2_instances[0];
