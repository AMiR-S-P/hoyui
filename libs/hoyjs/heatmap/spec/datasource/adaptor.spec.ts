...
describe('Heatmap Control', () => {
  ...
  describe('Heatmap Adaptor properties and its behavior', () => {
    ...
    it('Check cell dataSource with x-axis as DateTime & y-axis as DateTime', () => {
      let cellDateData = [
        [new Date(2018, 1, 1), new Date(2018, 2, 1), 10],
        [new Date(2018, 1, 1), new Date(2018, 2, 2), null],
        [new Date(2018, 1, 1), new Date(2018, 2, 3), 8],
        [new Date(2018, 1, 1), new Date(2018, 2, 4), 24],
        [new Date(2018, 1, 1), new Date(2018, 2, 5), 67],
        [new Date(2018, 1, 2), new Date(2018, 2, 1), 92],
        [new Date(2018, 1, 2), new Date(2018, 2, 2), 58],
        [new Date(2018, 1, 2), new Date(2018, 2, 3), 78],
        [new Date(2018, 1, 2), new Date(2018, 2, 4), 117],
        [new Date(2018, 1, 2), new Date(2018, 2, 5), 48],
      ];
    ...
    it('Check json cell complex dataSource behaviour', () => {
      let jsonCellComplexData: Object = [
        {
          rowid: { row1: 'France' },
          columnid: { col1: { col2: '2010' } },
          Men: { son1: '77.6' },
          Women: { women1: { son1: '34' } },
        },
        {
          rowid: { row1: 'France' },
          columnid: { col1: { col2: '2011' } },
          Men: { son1: '79.4' },
          Women: { women1: { son1: '54' } },
        },
        {
          rowid: { row1: 'France' },
          columnid: { col1: { col2: '2012' } },
          Men: { son1: '80.8' },
          Women: { women1: { son1: '23' } },
        },
        {
          rowid: { row1: 'France' },
          columnid: { col1: { col2: '2013' } },
          Men: { son1: '86.6' },
          Women: { women1: { son1: '65' } },
        },
        {
          rowid: { row2: 'France' },
          columnid: { col1: { col2: '2014' } },
          Men: { son1: '83.7' },
          Women: { women1: { son1: '12' } },
        },
        {
          rowid: { row1: 'France' },
          columnid: { col1: { col2: '2015' } },
          Men: { son1: '84.5' },
          Women: { women1: { son1: '0' } },
        },
        {
          rowid: { row1: 'France' },
          columnid: { col1: { col2: '2016' } },
          Men: { son1: '82.6' },
          Women: { women1: { son1: '34' } },
        },
        {
        ...
        },
        {
          ...
          columnid: { col1: { col2: '2011' } },
          Men: { son1: '' },
          Women: { women1: { son1: '87' } },
        },
        {
          rowid: { row1: 'USA' },
          columnid: { col1: { col1: '2012' } },
          Men: { son1: '70.8' },
          Women: { women1: { son1: '23' } },
        },
        {
        ...
        },
        {
          ...
          columnid: { col1: { col2: '2010' } },
          Men: { son1: '55.6' },
          Women: { women1: { son1: '53' } },
        },
        {
          rowid: { row1: 'China' },
          columnid: { col1: { col2: '2011' } },
          Men: { son1: '52.3' },
          Women: { women1: { son1: '13' } },
        },
        {
          rowid: { row1: 'China' },
          columnid: { col1: { col2: '2012' } },
        ...
        },
        {
          ...
          columnid: { col1: { col2: '2012' } },
          Men: { son1: 55.8 },
          Women: { women1: { son1: '45' } },
        },
        {
          rowid: { row1: 'Italy' },
          columnid: { col1: { col2: '2013' } },
          Men: { son1: '50.1' },
          Women: { women1: { son1: '76' } },
        },
        {
          rowid: { row1: 'Italy' },
          columnid: { col1: { col2: '2014' } },
        ...
        },
        {
          ...
          columnid: { col1: { col2: '2015' } },
          Men: { son1: '34.4' },
          Women: { women1: { son3: '22' } },
        },
        {
          rowid: 'UK',
          columnid: { col1: { col2: '2016' } },
          Men: { son1: '35.8' },
          Women: { women1: { son1: '55' } },
        },
        {
          rowid: { row1: 'Germany' },
          columnid: { col1: { col2: '2010' } },
        ...
        },
        {
          ...
          columnid: { col1: { col2: '2014' } },
          Men: { son1: '33' },
          Women: { women1: { son1: '42' } },
        },
        {
          rowid: { row1: 'Germany' },
          columnid: { col1: { col2: '2015' } },
          Men: { son1: '35' },
          Women: { women1: { son1: '62' } },
        },
        {
          rowid: { row1: 'Germany' },
          columnid: { col1: { col2: '2016' } },
          Men: { son1: '35.6' },
          Women: { women1: { son1: '25' } },
        },
        {
          rowid: { row1: 'Mexico' },
          columnid: { col1: { col2: '2010' } },
          Men: { son1: '23.2' },
          Women: { women1: { son1: '29' } },
        },
        {
          rowid: { row1: 'Mexico' },
          columnid: { col1: { col2: '2011' } },
          Men: { son1: '24.9' },
          Women: { women1: { son1: '43' } },
        },
        {
          rowid: { row1: 'Mexico' },
          columnid: { col1: { col2: '2012' } },
          Men: { son1: '30.1' },
          Women: { women1: { son1: '11' } },
        },
        {
          rowid: { row1: 'Mexico' },
          columnid: { col1: { col2: '2013' } },
        ...
        },
        {
          ...
          columnid: { col1: { col2: '2010' } },
          Men: { son1: '22' },
          Women: { women1: { son1: '28' } },
        },
        {
          rowid: { row1: 'Austria' },
          columnid: { col1: { col2: '2011' } },
          Men: { son1: '21.3' },
          Women: { women1: { son1: '97' } },
        },
        {
          rowid: { row1: 'Austria' },
          columnid: { col1: { col2: '2012' } },
        ...
        },
        {
          ...
          columnid: { col1: { col2: '2015' } },
          Men: { son1: '26.7' },
          Women: { women1: { son1: '98' } },
        },
        {
          rowid: { row1: 'Austria' },
          columnid: { col1: { col2: '2016' } },
          Men: { son1: '28.1' },
          Women: { women1: { son1: '100' } },
        },
      ];
      adaptorData = {
        isJsonData: true,
