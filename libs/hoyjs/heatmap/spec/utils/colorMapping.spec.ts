...
describe('Heatmap Control', () => {
  ...
  describe('Heatmap series properties and its behavior', () => {
    ...
    it('Check paletteSettings type property', () => {
      ...
      heatmap.refresh();
      tempElement = document.getElementById('container_HeatMapRect_0');
      expect(tempElement.getAttribute('fill') == 'rgb(255, 255, 153)').toBe(
        true
      );
    });
    it('Check paletteSettings palette property', () => {
      ...
      heatmap.dataBind();
      tempElement = document.getElementById('container_HeatMapRect_0');
      expect(tempElement.getAttribute('fill') == 'rgb(153, 153, 255)').toBe(
        true
      );
    ...
    it('Check paletteSettings palette property', () => {
      heatmap.paletteSettings.palette = [
        { value: 80, color: 'rgb(255, 255, 153)' },
        { value: 50, color: 'rgb(153, 255, 187)' },
      ...
      expect(tempElement.getAttribute('fill') == 'rgb(255, 159, 128)').toBe(
        true
      );
      heatmap.paletteSettings.type = 'Gradient';
      heatmap.refresh();
    ...
    it('Overall color Range support', function () {
      ...
      tempElement = document.getElementById('container_HeatMapRect_0');
      expect(
        tempElement.getAttribute('fill') ==
          heatmap.paletteSettings.fillColor.maxColor
      ).toBe(true);
    ...
    it('color Range support testing for fixed type', () => {
      ...
      expect(
        tempElement.getAttribute('fill') ==
          heatmap.paletteSettings.fillColor.minColor
      ).toBe(true);
