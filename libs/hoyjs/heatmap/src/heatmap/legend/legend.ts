import { Property, ChildProperty, Complex, Browser, createElement, isNullOrUndefined } from '@hoyui/base';
import { LinearGradient, TooltipTheme } from '@hoyui/svg-base';
...
import { Tooltip as tool } from '@hoyui/svg-base';
