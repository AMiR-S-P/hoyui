...
describe('Numerictextbox Control', () => {
  ...
  describe('NumericTextBox creation', () => {
    ...
    it('Control rendering test with other than input element', () => {
      ...
      expect(
        document.getElementById('divElement').classList.contains('e-input')
      ).toEqual(false);
    });
    it('Control rendering test with other (EJS-NUMERICTEXTBOX) than input element', () => {
      let divElement: HTMLElement = createElement('EJS-NUMERICTEXTBOX', {
        id: 'divElement',
      });
      document.body.appendChild(divElement);
      numerictextbox1 = new NumericTextBox({ floatLabelType: 'Never' });
      numerictextbox1.appendTo('#divElement');
      expect(numerictextbox1.element.classList.contains('e-input')).toEqual(
        true
      );
    });
    ...
    it('Control rendering test with obj as option', () => {
      let inptElement: HTMLInputElement = <HTMLInputElement>(
        createElement('input', { id: 'tsNumeric1' })
      );
      document.body.appendChild(inptElement);
      numerictextbox = new NumericTextBox({ enabled: true }, inptElement);
      expect(
        document
          .getElementById('tsNumeric1')
          .classList.contains('e-numerictextbox')
      ).toEqual(true);
    });
    ...
    it('Destroy method testing', () => {
      let numerictextbox1: NumericTextBox = new NumericTextBox(
        { value: 10 },
        '#tsNumeric'
      );
      numerictextbox1.destroy();
      expect(
        document.getElementById('tsNumeric').classList.contains('e-input')
      ).toEqual(false);
  ...
  describe('Render numeric textbox with basic values', () => {
    ...
    beforeEach((): void => {
      ...
      let ele: HTMLInputElement = <HTMLInputElement>(
        createElement('input', { id: 'tsNumeric' })
      );
      document.body.appendChild(ele);
    });
    afterEach((): void => {
    ...
    it('Render numeric textbox with value as 5', () => {
      ...
      expect(
        numerictextbox.hiddenInput.classList.contains('e-numeric-hidden')
      ).toEqual(true);
      expect(numerictextbox.hiddenInput.value).toEqual('5');
      expect(
        document.getElementById('tsNumeric').getAttribute('value')
      ).not.toBe('5');
      expect(numerictextbox.hiddenInput.getAttribute('name')).toEqual(
        'tsNumeric'
      );
      expect(
        numerictextbox.element.classList.contains('e-numerictextbox')
      ).toEqual(true);
      expect(
        document.getElementById('tsNumeric').getAttribute('aria-valuenow')
      ).toBe('5');
      expect(document.getElementById('tsNumeric').getAttribute('role')).toBe(
        'spinbutton'
      );
    });
    ...
    it('Disable the numeric textbox control', () => {
      numerictextbox = new NumericTextBox(
        { enabled: false, floatLabelType: 'Never' },
        '#tsNumeric'
      );
      expect(
        document
          .getElementById('tsNumeric')
          .parentElement.classList.contains('e-disabled')
      ).toEqual(true);
      expect(
        document.getElementById('tsNumeric').classList.contains('e-disabled')
      ).toEqual(true);
      expect(
        document.getElementById('tsNumeric').getAttribute('aria-disabled')
      ).toEqual('true');
    ...
    it('Enable the spin button option in numerictextbox', () => {
      ...
      expect(
        document
          .getElementById('tsNumeric')
          .parentElement.querySelector('.e-spin-up') !== undefined
      );
    });
    ...
    it('Spin button disabled alignment testing', () => {
      numerictextbox = new NumericTextBox(
        { showSpinButton: false, floatLabelType: 'Auto' },
        '#tsNumeric'
      );
      expect(
        document.getElementById('tsNumeric').classList.contains('e-input-group')
      ).toEqual(false);
    });
    ...
    it('Add custom css class to numerictextbox', () => {
      ...
      expect(
        document
          .getElementById('tsNumeric')
          .parentElement.classList.contains('custom-css')
      ).toEqual(true);
    });
    ...
    it('Set the readonly to numerictextbox', () => {
      ...
      expect(
        (<HTMLInputElement>document.getElementById('tsNumeric')).readOnly
      ).toBe(true);
      numerictextbox.focusHandler();
    });
    ...
    it('Set the custom width to numerictextbox', () => {
      ...
      expect(
        document.getElementById('tsNumeric').parentElement.getAttribute('style')
      ).toEqual('width: 400px;');
    });

    it('Set the watermarkText to numerictextbox', () => {
      numerictextbox = new NumericTextBox(
        { placeholder: 'Enter the numeric value', floatLabelType: 'Never' },
        '#tsNumeric'
      );
      expect(
        (<HTMLInputElement>document.getElementById('tsNumeric')).getAttribute(
          'placeholder'
        )
      ).toEqual('Enter the numeric value');
    });
    ...
    it('Set the custom currency symbol', () => {
      numerictextbox = new NumericTextBox(
        { format: 'c2', value: 10, currency: 'EUR' },
        '#tsNumeric'
      );
      expect(
        (<HTMLInputElement>document.getElementById('tsNumeric')).value
    ...
    it('Set the decimals value as 3 in numeric', () => {
      numerictextbox = new NumericTextBox(
        { format: 'n4', value: 10.88888, decimals: 3 },
        '#tsNumeric'
      );
      expect(
        (<HTMLInputElement>document.getElementById('tsNumeric')).value
    ...
    it('Set the decimals value as 7 in numeric', () => {
      numerictextbox = new NumericTextBox(
        { format: 'n7', value: 0.0000008, decimals: 7 },
        '#tsNumeric'
      );
      expect(
        (<HTMLInputElement>document.getElementById('tsNumeric')).value
    ...
    it('Set the decimals value as null in numeric', () => {
      numerictextbox = new NumericTextBox(
        { format: 'n4', value: 10.88888, decimals: null },
        '#tsNumeric'
      );
      expect(
        (<HTMLInputElement>document.getElementById('tsNumeric')).value
    ...
    it('Set the decimals value as 3 in currency', () => {
      numerictextbox = new NumericTextBox(
        { format: 'c4', value: 15.88888, decimals: 3 },
        '#tsNumeric'
      );
      expect(
        (<HTMLInputElement>document.getElementById('tsNumeric')).value
    ...
    it('Set the decimals value as null in currency', () => {
      numerictextbox = new NumericTextBox(
        { format: 'c4', value: 15.88888, decimals: null },
        '#tsNumeric'
      );
      expect(
        (<HTMLInputElement>document.getElementById('tsNumeric')).value
    ...
    it('Set the validateonDecimal in numeric', () => {
      ...
      let result: boolean = numerictextbox.keyPressHandler(
        extend({}, {}, eventArgs)
      );
      ...
      let result1: boolean = numerictextbox.keyPressHandler(
        extend({}, {}, eventArgs)
      );
  ...
  describe('Name attribute removed in wrapper for angular platform', () => {
    ...
    beforeEach((): void => {
      numerictextbox = undefined;
      let ele: HTMLInputElement = <HTMLInputElement>(
        createElement('EJS-NUMERICTEXTBOX', { id: 'Numeric' })
      );
    ...
    it('Check name attribute in wrapper and element', () => {
      ...
      expect(
        numerictextbox.inputWrapper.container.parentElement.hasAttribute('name')
      ).toBe(false);
  ...
  describe('Error message validation', () => {
    ...
    it('Data attribute at hidden element testing at dynamic rendering', () => {
      ...
      numerictextbox.appendTo('#Numeric');
      expect(
        numerictextbox.hiddenInput.hasAttribute('data-valmsg-replace')
      ).toBe(true);
      expect(numerictextbox.hiddenInput.getAttribute('type')).toBe('text');
      expect(
        numerictextbox.hiddenInput.classList.contains('e-numeric-hidden')
  ...
  describe('Checking ID attribute in wrapper for angular platform', () => {
    ...
    it('Check id attribute in wrapper and element', () => {
      ...
      numerictextbox.appendTo('#Numeric');
      expect(
        numerictextbox.inputWrapper.container.parentElement.getAttribute('id')
      ).toBe('Numeric');
  ...
  describe('Element Structure testing', () => {
    ...
    it('inner elements', () => {
      expect(
        numeric.inputWrapper.container.classList.contains('e-input-group')
      ).toBe(true);
      expect(numeric.container.nodeName).toBe('SPAN');
      expect(numeric.container.classList.contains('e-control-wrapper')).toBe(
        true
      );
      expect(
        numeric.container.classList.contains('e-numeric') &&
          numeric.container.classList.contains('e-input-group')
      ).toBe(true);
      expect(numeric.container.children[0].nodeName).toBe('INPUT');
      expect(numeric.container.children[0].getAttribute('name')).toBeNull();
      expect(
        numeric.container.children[0].classList.contains('e-numerictextbox')
      ).toBe(true);
      expect(numeric.container.children[1].nodeName).toBe('INPUT');
      expect(numeric.container.children[1].getAttribute('type')).toBe('text');
      expect(
        numeric.container.children[1].classList.contains('e-numeric-hidden')
      ).toEqual(true);
      expect(
        numeric.container.children[2].classList.contains('e-spin-down')
      ).toEqual(true);
      expect(
        numeric.container.children[3].classList.contains('e-spin-up')
      ).toEqual(true);
      expect(
        numeric.container.children[2].nodeName &&
          numeric.container.children[3].nodeName
      ).toBe('SPAN');
    });
    it('parent root element', () => {
      ...
      expect(
        numeric.inputWrapper.container.classList.contains('e-numeric') &&
          numeric.inputWrapper.container.classList.contains('e-control-wrapper')
      ).toBe(true);
    });
  });
  ...
  describe('Change Event testing', () => {
    ...
    function focusFn(args: NumericFocusEventArgs): void {
      ...
      if (
        args.container.classList.contains('e-input-group') &&
        args.container.classList.contains('e-numeric')
      ) {
        containerValue = 1;
      }
    }
    ...
    it('Change event testing', () => {
      ...
      let ele = document
        .getElementById('tsNumeric')
        .parentElement.querySelector('.e-spin-up');
      ...
      let ele1 = document
        .getElementById('tsNumeric')
        .parentElement.querySelector('.e-spin-down');
      mouseEvent.initEvent('mousedown', true, true);
  ...
  describe('Numeric textbox with element attribute', () => {
    ...
    it('Add the html attribute (value) to input element', () => {
      let ele: HTMLInputElement = <HTMLInputElement>(
        createElement('input', { id: 'tsNumeric', attrs: { value: '20' } })
      );
      document.body.appendChild(ele);
    ...
    it('Add the html attribute (value) to input element', () => {
      let ele: HTMLInputElement = <HTMLInputElement>(
        createElement('input', { id: 'tsNumeric', attrs: { value: 'hello' } })
      );
      document.body.appendChild(ele);
      numerictextbox = new NumericTextBox({}, ele);
    ...
    it('Add the html attribute (value) and also set the value API in input element', () => {
      let ele: HTMLInputElement = <HTMLInputElement>(
        createElement('input', { id: 'tsNumeric', attrs: { value: '' } })
      );
      document.body.appendChild(ele);
      numerictextbox = new NumericTextBox({ value: 40 }, ele);
      expect(numerictextbox.value).toBeNull();
    ...
    it('Add the html attribute (value) to percentage input element', () => {
      let ele: HTMLInputElement = <HTMLInputElement>(
        createElement('input', { id: 'tsNumeric', attrs: { value: '0.5' } })
      );
      document.body.appendChild(ele);
    ...
    it('Add the html attribute (min & max) to input element', () => {
      let ele: HTMLInputElement = <HTMLInputElement>(
        createElement('input', {
          id: 'tsNumeric',
          attrs: { value: '20', min: 'hello', max: 'world' },
        })
      );
      document.body.appendChild(ele);
      numerictextbox = new NumericTextBox({}, ele);
    ...
    it('Add the html attribute (step) in the input element', () => {
      let ele: HTMLInputElement = <HTMLInputElement>(
        createElement('input', { id: 'tsNumeric', attrs: { step: '5' } })
      );
      document.body.appendChild(ele);
    ...
    it('Add the html attribute (step) in the input element', () => {
      let ele: HTMLInputElement = <HTMLInputElement>(
        createElement('input', { id: 'tsNumeric', attrs: { step: 'hello' } })
      );
      document.body.appendChild(ele);
      numerictextbox = new NumericTextBox({ value: 10 }, ele);
      expect(
    ...
    it('Add the html attribute (disabled) value as true in the input element', () => {
      let ele: HTMLInputElement = <HTMLInputElement>(
        createElement('input', { id: 'tsNumeric', attrs: { disabled: 'true' } })
      );
      document.body.appendChild(ele);
      numerictextbox = new NumericTextBox({ floatLabelType: 'Never' }, ele);
      expect(
    ...
    it('Add the html attribute (disabled) value as false in the input element', () => {
      let ele: HTMLInputElement = <HTMLInputElement>(
        createElement('input', {
          id: 'tsNumeric',
          attrs: { disabled: 'false', floatLabelType: 'Never' },
        })
      );
      document.body.appendChild(ele);
      numerictextbox = new NumericTextBox({}, ele);
    ...
    it('Add the html attribute (readonly) value as true in the input element', () => {
      let ele: HTMLInputElement = <HTMLInputElement>(
        createElement('input', { id: 'tsNumeric', attrs: { readonly: 'true' } })
      );
      document.body.appendChild(ele);
      numerictextbox = new NumericTextBox({}, ele);
      expect(
    ...
    it('Add the html attribute (name) in the input element', () => {
      let ele: HTMLInputElement = <HTMLInputElement>(
        createElement('input', { id: 'tsNumeric', attrs: { name: 'custom' } })
      );
      document.body.appendChild(ele);
      numerictextbox = new NumericTextBox({}, ele);
      expect((numerictextbox as any).hiddenInput.getAttribute('name')).toEqual(
        'custom'
      );
      expect(
        (numerictextbox as any).hiddenInput.classList.contains(
          'e-numeric-hidden'
        )
      ).toBe(true);
    });
  ...
  describe('NumericTextBox control with value min,max and strictMode combination', () => {
    ...
    it('Render numeric textbox with value as undefined and strict mode combination', () => {
      numerictextbox = new NumericTextBox(
        { value: undefined, strictMode: false },
        '#tsNumeric'
      );
      expect(
        (<HTMLInputElement>document.getElementById('tsNumeric')).value
    ...
    it('Render strict mode numeric textbox with min and max value', () => {
      numerictextbox = new NumericTextBox(
        { value: 6, min: 5, max: 20, strictMode: false },
        '#tsNumeric'
      );
      expect(
        (<HTMLInputElement>document.getElementById('tsNumeric')).value
    ...
    it('Value less than min value with strict mode', () => {
      ...
      expect(
        document
          .getElementById('tsNumeric')
          .parentElement.classList.contains('e-error')
      ).toEqual(true);
      expect(numerictextbox.value).toEqual(-6);
    ...
    it('Value greater than max value with strict mode', () => {
      numerictextbox = new NumericTextBox(
        { value: 50, min: 5, max: 20, strictMode: false },
        '#tsNumeric'
      );
      expect(
        (<HTMLInputElement>document.getElementById('tsNumeric')).value
    ...
    it('Min value greater than max value with numeric value and strict mode ', () => {
      numerictextbox = new NumericTextBox(
        { value: 50, min: 15, max: 10, strictMode: false },
        '#tsNumeric'
      );
      expect(
        (<HTMLInputElement>document.getElementById('tsNumeric')).value
    ...
    it('Max value less than min value with numeric value and strict mode', () => {
      numerictextbox = new NumericTextBox(
        { value: 50, min: 20, max: 5, strictMode: false },
        '#tsNumeric'
      );
      expect(
        (<HTMLInputElement>document.getElementById('tsNumeric')).value
    ...
    it('Render strict mode numeric textbox with negative min and max value ', () => {
      numerictextbox = new NumericTextBox(
        { value: -10, min: -20, max: -5, strictMode: false },
        '#tsNumeric'
      );
      expect(
        (<HTMLInputElement>document.getElementById('tsNumeric')).value
    ...
    it('Negative numeric value less than min value with strict mode ', () => {
      numerictextbox = new NumericTextBox(
        { value: -30, min: -20, max: -10, strictMode: false },
        '#tsNumeric'
      );
      expect(
        (<HTMLInputElement>document.getElementById('tsNumeric')).value
    ...
    it('Negative numeric value greater than max value with strict mode ', () => {
      numerictextbox = new NumericTextBox(
        { value: -5, min: -20, max: -10, strictMode: false },
        '#tsNumeric'
      );
      expect(
        (<HTMLInputElement>document.getElementById('tsNumeric')).value
    ...
    it('Min value greater than max value with negative numeric value and strict mode ', () => {
      numerictextbox = new NumericTextBox(
        { value: -50, min: -15, max: -20, strictMode: false },
        '#tsNumeric'
      );
      expect(
        (<HTMLInputElement>document.getElementById('tsNumeric')).value
    ...
    it('Max value less than min value with numeric value and strict mode', () => {
      numerictextbox = new NumericTextBox(
        { value: -50, min: -10, max: -15, strictMode: false },
        '#tsNumeric'
      );
      expect(
        (<HTMLInputElement>document.getElementById('tsNumeric')).value
    ...
    it('Render percentage textbox with min and max value', () => {
      numerictextbox = new NumericTextBox(
        { value: 0.6, min: 0.5, max: 1, format: 'p2' },
        '#tsNumeric'
      );
      expect(
        (<HTMLInputElement>document.getElementById('tsNumeric')).value
    ...
    it('Render percentage textbox with value greater than max value', () => {
      numerictextbox = new NumericTextBox(
        { value: 50, min: 0.5, max: 1, format: 'p2' },
        '#tsNumeric'
      );
      expect(
        (<HTMLInputElement>document.getElementById('tsNumeric')).value
    ...
    it('Render percentage textbox with min value greater than max value', () => {
      numerictextbox = new NumericTextBox(
        { value: 50, min: 1.5, max: 1, format: 'p2' },
        '#tsNumeric'
      );
      expect(
        (<HTMLInputElement>document.getElementById('tsNumeric')).value
    ...
    it('Render percentage textbox with max value less than min value', () => {
      numerictextbox = new NumericTextBox(
        { value: 50, min: 20, max: 1, format: 'p2' },
        '#tsNumeric'
      );
      expect(
        (<HTMLInputElement>document.getElementById('tsNumeric')).value
    ...
    it('Render percentage textbox with negative min and max value ', () => {
      numerictextbox = new NumericTextBox(
        { value: -0.6, min: -1, max: -0.5, format: 'p2' },
        '#tsNumeric'
      );
      expect(
        (<HTMLInputElement>document.getElementById('tsNumeric')).value
    ...
    it('Render percentage textbox with negative numeric value less than min value ', () => {
      numerictextbox = new NumericTextBox(
        { value: -2, min: -1, max: -0.5, format: 'p2' },
        '#tsNumeric'
      );
      expect(
        (<HTMLInputElement>document.getElementById('tsNumeric')).value
    ...
    it('Render percentage textbox with negative numeric value greater than max value ', () => {
      numerictextbox = new NumericTextBox(
        { value: -0.2, min: -1, max: -0.5, format: 'p2' },
        '#tsNumeric'
      );
      expect(
        (<HTMLInputElement>document.getElementById('tsNumeric')).value
    ...
    it('Render percentage textbox with value as null and strict mode combination', () => {
      numerictextbox = new NumericTextBox(
        { value: null, strictMode: false, format: 'p2' },
        '#tsNumeric'
      );
      expect(
        (<HTMLInputElement>document.getElementById('tsNumeric')).value
    ...
    it('Render percentage textbox with value as undefined and strict mode combination', () => {
      numerictextbox = new NumericTextBox(
        { value: undefined, strictMode: false, format: 'p2' },
        '#tsNumeric'
      );
      expect(
        (<HTMLInputElement>document.getElementById('tsNumeric')).value
    ...
    it('Render percentage textbox with value as NaN and strict mode combination', () => {
      numerictextbox = new NumericTextBox(
        { value: NaN, strictMode: false, format: 'p2' },
        '#tsNumeric'
      );
      expect(
        (<HTMLInputElement>document.getElementById('tsNumeric')).value
    ...
    it('Render percentage textbox with numeric value and strict mode combination', () => {
      numerictextbox = new NumericTextBox(
        { value: 0.5, strictMode: false, format: 'p2' },
        '#tsNumeric'
      );
      expect(
        (<HTMLInputElement>document.getElementById('tsNumeric')).value
    ...
    it('Render strict mode percentage textbox with min and max value', () => {
      numerictextbox = new NumericTextBox(
        { value: 0.6, min: 0.5, max: 1, strictMode: false, format: 'p2' },
        '#tsNumeric'
      );
      expect(
        (<HTMLInputElement>document.getElementById('tsNumeric')).value
    ...
    it('Value greater than max value with strict mode', () => {
      numerictextbox = new NumericTextBox(
        { value: 2, min: 0.5, max: 1, strictMode: false, format: 'p2' },
        '#tsNumeric'
      );
      expect(
        (<HTMLInputElement>document.getElementById('tsNumeric')).value
    ...
    it('Min value greater than max value with numeric value and strict mode ', () => {
      numerictextbox = new NumericTextBox(
        { value: 3, min: 1, max: 0.5, strictMode: false, format: 'p2' },
        '#tsNumeric'
      );
      expect(
        (<HTMLInputElement>document.getElementById('tsNumeric')).value
    ...
    it('Max value less than min value with numeric value and strict mode', () => {
      numerictextbox = new NumericTextBox(
        { value: 4, min: 1, max: 0.5, strictMode: false, format: 'p2' },
        '#tsNumeric'
      );
      expect(
        (<HTMLInputElement>document.getElementById('tsNumeric')).value
    ...
    it('Render strict mode percentage textbox with negative min and max value ', () => {
      numerictextbox = new NumericTextBox(
        { value: -0.6, min: -1, max: -0.5, strictMode: false, format: 'p2' },
        '#tsNumeric'
      );
      expect(
        (<HTMLInputElement>document.getElementById('tsNumeric')).value
    ...
    it('Negative numeric value less than min value with strict mode ', () => {
      numerictextbox = new NumericTextBox(
        { value: -2, min: -1, max: -0.5, strictMode: false, format: 'p2' },
        '#tsNumeric'
      );
      expect(
        (<HTMLInputElement>document.getElementById('tsNumeric')).value
    ...
    it('Negative numeric value greater than max value with strict mode ', () => {
      numerictextbox = new NumericTextBox(
        { value: -0.2, min: -1, max: -0.5, strictMode: false, format: 'p2' },
        '#tsNumeric'
      );
      expect(
        (<HTMLInputElement>document.getElementById('tsNumeric')).value
    ...
    it('Min value greater than max value with negative numeric value and strict mode ', () => {
      numerictextbox = new NumericTextBox(
        { value: -3, min: -0.5, max: -1, strictMode: false, format: 'p2' },
        '#tsNumeric'
      );
      expect(
        (<HTMLInputElement>document.getElementById('tsNumeric')).value
    ...
    it('Render currency textbox with min and max value', () => {
      numerictextbox = new NumericTextBox(
        { value: 6, min: 5, max: 20, format: 'c2' },
        '#tsNumeric'
      );
      expect(
        (<HTMLInputElement>document.getElementById('tsNumeric')).value
    ...
    it('Render currency textbox with value greater than max value', () => {
      numerictextbox = new NumericTextBox(
        { value: 50, min: 5, max: 20, format: 'c2' },
        '#tsNumeric'
      );
      expect(
        (<HTMLInputElement>document.getElementById('tsNumeric')).value
    ...
    it('Render currency textbox with min value greater than max value', () => {
      numerictextbox = new NumericTextBox(
        { value: 50, min: 15, max: 10, format: 'c2' },
        '#tsNumeric'
      );
      expect(
        (<HTMLInputElement>document.getElementById('tsNumeric')).value
    ...
    it('Render currency textbox with max value less than min value', () => {
      numerictextbox = new NumericTextBox(
        { value: 50, min: 20, max: 5, format: 'c2' },
        '#tsNumeric'
      );
      expect(
        (<HTMLInputElement>document.getElementById('tsNumeric')).value
    ...
    it('Render currency textbox with negative min and max value ', () => {
      numerictextbox = new NumericTextBox(
        { value: -10, min: -20, max: -5, format: 'c2' },
        '#tsNumeric'
      );
      expect(
        (<HTMLInputElement>document.getElementById('tsNumeric')).value
    ...
    it('Render currency textbox with negative numeric value less than min value ', () => {
      numerictextbox = new NumericTextBox(
        { value: -30, min: -20, max: -10, format: 'c2' },
        '#tsNumeric'
      );
      expect(
        (<HTMLInputElement>document.getElementById('tsNumeric')).value
    ...
    it('Render currency textbox with negative numeric value greater than max value ', () => {
      numerictextbox = new NumericTextBox(
        { value: -5, min: -20, max: -10, format: 'c2' },
        '#tsNumeric'
      );
      expect(
        (<HTMLInputElement>document.getElementById('tsNumeric')).value
    ...
    it('Min value greater than max value with negative numeric value ', () => {
      numerictextbox = new NumericTextBox(
        { value: -50, min: -15, max: -20, format: 'c2' },
        '#tsNumeric'
      );
      expect(
        (<HTMLInputElement>document.getElementById('tsNumeric')).value
    ...
    it('Max value less than min value with negative numeric value ', () => {
      numerictextbox = new NumericTextBox(
        { value: -50, min: -10, max: -15, format: 'c2' },
        '#tsNumeric'
      );
      expect(
        (<HTMLInputElement>document.getElementById('tsNumeric')).value
    ...
    it('Render currency textbox with value as null and strict mode combination', () => {
      numerictextbox = new NumericTextBox(
        { value: null, strictMode: false, format: 'c2' },
        '#tsNumeric'
      );
      expect(
        (<HTMLInputElement>document.getElementById('tsNumeric')).value
    ...
    it('Render currency textbox with value as undefined and strict mode combination', () => {
      numerictextbox = new NumericTextBox(
        { value: undefined, strictMode: false, format: 'c2' },
        '#tsNumeric'
      );
      expect(
        (<HTMLInputElement>document.getElementById('tsNumeric')).value
    ...
    it('Render currency textbox with value as NaN and strict mode combination', () => {
      numerictextbox = new NumericTextBox(
        { value: NaN, strictMode: false, format: 'c2' },
        '#tsNumeric'
      );
      expect(
        (<HTMLInputElement>document.getElementById('tsNumeric')).value
    ...
    it('Render currency textbox with numeric value and strict mode combination', () => {
      numerictextbox = new NumericTextBox(
        { value: 5, strictMode: false, format: 'c2' },
        '#tsNumeric'
      );
      expect(
        (<HTMLInputElement>document.getElementById('tsNumeric')).value
    ...
    it('Render strict mode currency textbox with min and max value', () => {
      numerictextbox = new NumericTextBox(
        { value: 6, min: 5, max: 20, strictMode: false, format: 'c2' },
        '#tsNumeric'
      );
      expect(
        (<HTMLInputElement>document.getElementById('tsNumeric')).value
    ...
    it('Value greater than max value with strict mode', () => {
      numerictextbox = new NumericTextBox(
        { value: 50, min: 5, max: 20, strictMode: false, format: 'c2' },
        '#tsNumeric'
      );
      expect(
        (<HTMLInputElement>document.getElementById('tsNumeric')).value
    ...
    it('Min value greater than max value with numeric value and strict mode ', () => {
      numerictextbox = new NumericTextBox(
        { value: 50, min: 15, max: 10, strictMode: false, format: 'c2' },
        '#tsNumeric'
      );
      expect(
        (<HTMLInputElement>document.getElementById('tsNumeric')).value
    ...
    it('Max value less than min value with numeric value and strict mode', () => {
      numerictextbox = new NumericTextBox(
        { value: 50, min: 20, max: 5, strictMode: false, format: 'c2' },
        '#tsNumeric'
      );
      expect(
        (<HTMLInputElement>document.getElementById('tsNumeric')).value
    ...
    it('Render strict mode currency textbox with negative min and max value ', () => {
      numerictextbox = new NumericTextBox(
        { value: -10, min: -20, max: -5, strictMode: false, format: 'c2' },
        '#tsNumeric'
      );
      expect(
        (<HTMLInputElement>document.getElementById('tsNumeric')).value
    ...
    it('Negative numeric value less than min value with strict mode ', () => {
      numerictextbox = new NumericTextBox(
        { value: -30, min: -20, max: -10, strictMode: false, format: 'c2' },
        '#tsNumeric'
      );
      expect(
        (<HTMLInputElement>document.getElementById('tsNumeric')).value
    ...
    it('Negative numeric value greater than max value with strict mode ', () => {
      numerictextbox = new NumericTextBox(
        { value: -5, min: -20, max: -10, strictMode: false, format: 'c2' },
        '#tsNumeric'
      );
      expect(
        (<HTMLInputElement>document.getElementById('tsNumeric')).value
    ...
    it('Min value greater than max value with negative numeric value and strict mode ', () => {
      numerictextbox = new NumericTextBox(
        { value: -50, min: -15, max: -20, strictMode: false, format: 'c2' },
        '#tsNumeric'
      );
      expect(
        (<HTMLInputElement>document.getElementById('tsNumeric')).value
    ...
    it('Max value less than min value with numeric value and strict mode', () => {
      numerictextbox = new NumericTextBox(
        { value: -50, min: -10, max: -15, strictMode: false, format: 'c2' },
        '#tsNumeric'
      );
      expect(
        (<HTMLInputElement>document.getElementById('tsNumeric')).value
  ...
  describe('Increment,Decrement operation with spinner', () => {
    ...
    it('Increment numeric value with strict mode', () => {
      numerictextbox = new NumericTextBox(
        { value: 30, min: 5, max: 10, strictMode: false },
        '#tsNumeric'
      );
      expect(
        (<HTMLInputElement>document.getElementById('tsNumeric')).value
    ...
    it('Decrement numeric value with strict mode', () => {
      numerictextbox = new NumericTextBox(
        { value: 3, min: 5, max: 10, strictMode: false },
        '#tsNumeric'
      );
      expect(
        (<HTMLInputElement>document.getElementById('tsNumeric')).value
    ...
    it('Increment currency value (max) with spin up button', () => {
      numerictextbox = new NumericTextBox(
        { value: 10, min: 5, max: 10, format: 'c2' },
        '#tsNumeric'
      );
      let ele = document
        .getElementById('tsNumeric')
    ...
    it('Decrement currency value(min) with spin down button', () => {
      numerictextbox = new NumericTextBox(
        { value: 5, min: 5, max: 10, format: 'c2' },
        '#tsNumeric'
      );
      let ele = document
        .getElementById('tsNumeric')
    ...
    it('Increment negative currency value (max) with spin up button', () => {
      numerictextbox = new NumericTextBox(
        { value: -10, min: -15, max: -10, format: 'c2' },
        '#tsNumeric'
      );
      let ele = document
        .getElementById('tsNumeric')
    ...
    it('Decrement negative currency value(min) with spin down button', () => {
      numerictextbox = new NumericTextBox(
        { value: -15, min: -15, max: -10, format: 'c2' },
        '#tsNumeric'
      );
      let ele = document
        .getElementById('tsNumeric')
    ...
    it('Increment currency value with strict mode', () => {
      numerictextbox = new NumericTextBox(
        { value: 30, min: 5, max: 10, strictMode: false, format: 'c2' },
        '#tsNumeric'
      );
      expect(
        (<HTMLInputElement>document.getElementById('tsNumeric')).value
    ...
    it('Decrement currency value with strict mode', () => {
      numerictextbox = new NumericTextBox(
        { value: 3, min: 5, max: 10, strictMode: false, format: 'c2' },
        '#tsNumeric'
      );
      expect(
        (<HTMLInputElement>document.getElementById('tsNumeric')).value
    ...
    it('Increment currency value (near max) by step using spin up button', () => {
      numerictextbox = new NumericTextBox(
        { value: 8, min: 5, max: 10, step: 4, format: 'c2' },
        '#tsNumeric'
      );
      expect(
        (<HTMLInputElement>document.getElementById('tsNumeric')).value
    ...
    it('Decrement currency value (near min) by step using spin down button', () => {
      numerictextbox = new NumericTextBox(
        { value: 6, min: 5, max: 10, step: 4, format: 'c2' },
        '#tsNumeric'
      );
      expect(
        (<HTMLInputElement>document.getElementById('tsNumeric')).value
    ...
    it('Increment percentage value with empty textbox', () => {
      numerictextbox = new NumericTextBox(
        { min: 0.5, max: 1, step: 0.1, format: 'p2' },
        '#tsNumeric'
      );
      let ele = document
        .getElementById('tsNumeric')
    ...
    it('Increment percentage value with strict mode', () => {
      numerictextbox = new NumericTextBox(
        { value: 1.5, min: 0.5, max: 1, strictMode: false, format: 'p2' },
        '#tsNumeric'
      );
      expect(
        (<HTMLInputElement>document.getElementById('tsNumeric')).value
    ...
    it('Decrement percentage value with strict mode', () => {
      numerictextbox = new NumericTextBox(
        { value: 0.3, min: 0.5, max: 1, strictMode: false, format: 'p2' },
        '#tsNumeric'
      );
      expect(
        (<HTMLInputElement>document.getElementById('tsNumeric')).value
    ...
    it('Mousemove on the spin button', () => {
      ...
      let eventArgs: any = {
        ...
        preventDefault: function () {},
        clientX: document
          .getElementsByClassName('e-spin-up')[0]
  ...
  describe('Set model combination', () => {
    ...
    it('notify enabled property change testing', () => {
      numerictextbox = new NumericTextBox(
        { enabled: true, floatLabelType: 'Never' },
        '#tsNumeric'
      );
      expect(
        document
    ...
    it('notify cssClass property change testing', () => {
      ...
      expect(
        document
          .getElementById('tsNumeric')
          .parentElement.classList.contains('customClass')
      ).toEqual(true);
    });
    ...
    it('notify watermarkText property change testing', () => {
      ...
      ).toEqual('Enter the number');
    });

    it('notify step property change testing', () => {
      numerictextbox = new NumericTextBox(
        { value: 15, min: 10, max: 100, step: 2 },
        '#tsNumeric'
      );
      let ele = document
        .getElementById('tsNumeric')
    ...
    it('Set the deciaml value as null dynamically', () => {
      numerictextbox = new NumericTextBox(
        { value: 10.8888888, format: 'n3', decimals: 4 },
        '#tsNumeric'
      );
      expect(
        (<HTMLInputElement>document.getElementById('tsNumeric')).value
    ...
    it('Set the deciaml value as null dynamically in currency textbox', () => {
      numerictextbox = new NumericTextBox(
        { value: 10.8888888, format: 'c3', decimals: 4 },
        '#tsNumeric'
      );
      expect(
        (<HTMLInputElement>document.getElementById('tsNumeric')).value
    ...
    it('Set the locale value dynamically in currency textbox', () => {
      numerictextbox = new NumericTextBox(
        { value: 12.34, format: 'c2', locale: 'de' },
        '#tsNumeric'
      );
      expect(
        (<HTMLInputElement>document.getElementById('tsNumeric')).value
    ...
    it('Set the value as number dynamically', () => {
      numerictextbox = new NumericTextBox(
        { value: 15, min: 10, max: 20, strictMode: false },
        '#tsNumeric'
      );
      expect(
        (<HTMLInputElement>document.getElementById('tsNumeric')).value
    ...
    it('Set the negative numeric value as number dynamically with strict mode', () => {
      numerictextbox = new NumericTextBox(
        { value: -15, min: -20, max: -10, strictMode: false },
        '#tsNumeric'
      );
      expect(
        (<HTMLInputElement>document.getElementById('tsNumeric')).value
    ...
    it('Set the value as number dynamically', () => {
      numerictextbox = new NumericTextBox(
        { value: 15, min: 10, max: 20, format: 'c2' },
        '#tsNumeric'
      );
      expect(
        (<HTMLInputElement>document.getElementById('tsNumeric')).value
    ...
    it('Set the negative numeric value as number dynamically', () => {
      numerictextbox = new NumericTextBox(
        { value: -15, min: -20, max: -10, format: 'c2' },
        '#tsNumeric'
      );
      expect(
        (<HTMLInputElement>document.getElementById('tsNumeric')).value
    ...
    it('Set the value as number dynamically', () => {
      numerictextbox = new NumericTextBox(
        { value: 15, min: 10, max: 20, strictMode: false, format: 'c2' },
        '#tsNumeric'
      );
      expect(
        (<HTMLInputElement>document.getElementById('tsNumeric')).value
    ...
    it('Set the negative numeric value as number dynamically with strict mode', () => {
      numerictextbox = new NumericTextBox(
        { value: -15, min: -20, max: -10, strictMode: false, format: 'c2' },
        '#tsNumeric'
      );
      expect(
        (<HTMLInputElement>document.getElementById('tsNumeric')).value
    ...
    it('Set the value as number dynamically', () => {
      numerictextbox = new NumericTextBox(
        { value: 0.5, min: 0.1, max: 1, format: 'p2' },
        '#tsNumeric'
      );
      expect(
        (<HTMLInputElement>document.getElementById('tsNumeric')).value
    ...
    it('Set the value less than min value dynamically', () => {
      numerictextbox = new NumericTextBox(
        { value: 0.5, min: 0.3, max: 1, format: 'p2' },
        '#tsNumeric'
      );
      expect(
        (<HTMLInputElement>document.getElementById('tsNumeric')).value
    ...
    it('Set the negative numeric value as number dynamically', () => {
      numerictextbox = new NumericTextBox(
        { value: -1.5, min: -2, max: -1, format: 'p2' },
        '#tsNumeric'
      );
      expect(
        (<HTMLInputElement>document.getElementById('tsNumeric')).value
    ...
    it('Set the value as number dynamically', () => {
      numerictextbox = new NumericTextBox(
        { value: 0.5, min: 0.1, max: 1, strictMode: false, format: 'p2' },
        '#tsNumeric'
      );
      expect(
        (<HTMLInputElement>document.getElementById('tsNumeric')).value
    ...
    it('Set the value less than min value dynamically with strict mode', () => {
      numerictextbox = new NumericTextBox(
        { value: 0.5, min: 0.4, max: 1, strictMode: false, format: 'p2' },
        '#tsNumeric'
      );
      expect(
        (<HTMLInputElement>document.getElementById('tsNumeric')).value
    ...
    it('Set the negative numeric value as number dynamically with strict mode', () => {
      numerictextbox = new NumericTextBox(
        { value: -1.5, min: -2, max: -1, strictMode: false, format: 'p2' },
        '#tsNumeric'
      );
      expect(
        (<HTMLInputElement>document.getElementById('tsNumeric')).value
    ...
    it('Dynamically update the strict mode value', () => {
      numerictextbox = new NumericTextBox(
        { value: 25, min: 10, max: 20, strictMode: false },
        '#tsNumeric'
      );
      expect(
        (<HTMLInputElement>document.getElementById('tsNumeric')).value
    ...
    it('Dynamically update the strict mode value', () => {
      numerictextbox = new NumericTextBox(
        { value: 5, min: 10, max: 20, strictMode: false },
        '#tsNumeric'
      );
      expect(
        (<HTMLInputElement>document.getElementById('tsNumeric')).value
    ...
    it('Dynamically update the strict mode value in currency textbox', () => {
      numerictextbox = new NumericTextBox(
        { value: 25, min: 10, max: 20, strictMode: false, format: 'c2' },
        '#tsNumeric'
      );
      expect(
        (<HTMLInputElement>document.getElementById('tsNumeric')).value
    ...
    it('Dynamically update the strict mode value in currency textbox', () => {
      numerictextbox = new NumericTextBox(
        { value: 5, min: 10, max: 20, strictMode: false, format: 'c2' },
        '#tsNumeric'
      );
      expect(
        (<HTMLInputElement>document.getElementById('tsNumeric')).value
    ...
    it('Dynamically update the strict mode value in percentage textbox', () => {
      numerictextbox = new NumericTextBox(
        { value: 2.5, min: 1, max: 2, strictMode: false, format: 'p2' },
        '#tsNumeric'
      );
      expect(
        (<HTMLInputElement>document.getElementById('tsNumeric')).value
    ...
    it('Dynamically update the strict mode value in percentage textbox', () => {
      numerictextbox = new NumericTextBox(
        { value: 0.5, min: 1, max: 2, strictMode: false, format: 'p2' },
        '#tsNumeric'
      );
      expect(
        (<HTMLInputElement>document.getElementById('tsNumeric')).value
    ...
    it('Dynamically update the strict mode value and value of the percentage textbox', () => {
      numerictextbox = new NumericTextBox(
        { value: 1.5, min: 1, max: 2, format: 'p2' },
        '#tsNumeric'
      );
      expect(
        (<HTMLInputElement>document.getElementById('tsNumeric')).value
    ...
    it('Set the min value dynamically with strict mode', () => {
      numerictextbox = new NumericTextBox(
        { value: 11, min: 10, max: 20, strictMode: false },
        '#tsNumeric'
      );
      expect(
        (<HTMLInputElement>document.getElementById('tsNumeric')).value
    ...
    it('Set the min value dynamically with strict mode', () => {
      numerictextbox = new NumericTextBox(
        { value: 8, min: 10, max: 20, strictMode: false },
        '#tsNumeric'
      );
      expect(
        (<HTMLInputElement>document.getElementById('tsNumeric')).value
    ...
    it('Set the max value dynamically with strict mode', () => {
      numerictextbox = new NumericTextBox(
        { value: 18, min: 10, max: 20, strictMode: false },
        '#tsNumeric'
      );
      expect(
        (<HTMLInputElement>document.getElementById('tsNumeric')).value
    ...
    it('Set the max value dynamically with strict mode', () => {
      numerictextbox = new NumericTextBox(
        { value: 28, min: 10, max: 20, strictMode: false },
        '#tsNumeric'
      );
      expect(
        (<HTMLInputElement>document.getElementById('tsNumeric')).value
    ...
    it('Set the min value dynamically', () => {
      numerictextbox = new NumericTextBox(
        { value: 16, min: 10, max: 20, format: 'c2' },
        '#tsNumeric'
      );
      expect(
        (<HTMLInputElement>document.getElementById('tsNumeric')).value
    ...
    it('Set the min value dynamically', () => {
      numerictextbox = new NumericTextBox(
        { value: 11, min: 10, max: 20, format: 'c2' },
        '#tsNumeric'
      );
      expect(
        (<HTMLInputElement>document.getElementById('tsNumeric')).value
    ...
    it('Set the min value dynamically with strict mode', () => {
      numerictextbox = new NumericTextBox(
        { value: 11, min: 10, max: 20, strictMode: false, format: 'c2' },
        '#tsNumeric'
      );
      expect(
        (<HTMLInputElement>document.getElementById('tsNumeric')).value
    ...
    it('Set the min value dynamically with strict mode', () => {
      numerictextbox = new NumericTextBox(
        { value: 8, min: 10, max: 20, strictMode: false, format: 'c2' },
        '#tsNumeric'
      );
      expect(
        (<HTMLInputElement>document.getElementById('tsNumeric')).value
    ...
    it('Set the max value dynamically', () => {
      numerictextbox = new NumericTextBox(
        { value: 14, min: 10, max: 20, format: 'c2' },
        '#tsNumeric'
      );
      expect(
        (<HTMLInputElement>document.getElementById('tsNumeric')).value
    ...
    it('Set the max value dynamically', () => {
      numerictextbox = new NumericTextBox(
        { value: 18, min: 10, max: 20, format: 'c2' },
        '#tsNumeric'
      );
      expect(
        (<HTMLInputElement>document.getElementById('tsNumeric')).value
    ...
    it('Set the max value dynamically with strict mode', () => {
      numerictextbox = new NumericTextBox(
        { value: 18, min: 10, max: 20, strictMode: false, format: 'c2' },
        '#tsNumeric'
      );
      expect(
        (<HTMLInputElement>document.getElementById('tsNumeric')).value
    ...
    it('Set the max value dynamically with strict mode', () => {
      numerictextbox = new NumericTextBox(
        { value: 28, min: 10, max: 20, strictMode: false, format: 'c2' },
        '#tsNumeric'
      );
      expect(
        (<HTMLInputElement>document.getElementById('tsNumeric')).value
    ...
    it('Set the min value dynamically', () => {
      numerictextbox = new NumericTextBox(
        { value: 1.6, min: 1, max: 2, format: 'p2' },
        '#tsNumeric'
      );
      expect(
        (<HTMLInputElement>document.getElementById('tsNumeric')).value
    ...
    it('Set the min value dynamically', () => {
      numerictextbox = new NumericTextBox(
        { value: 1.1, min: 1, max: 2, format: 'p2' },
        '#tsNumeric'
      );
      expect(
        (<HTMLInputElement>document.getElementById('tsNumeric')).value
    ...
    it('Set the min value dynamically with strict mode', () => {
      numerictextbox = new NumericTextBox(
        { value: 1.1, min: 1, max: 2, strictMode: false, format: 'p2' },
        '#tsNumeric'
      );
      expect(
        (<HTMLInputElement>document.getElementById('tsNumeric')).value
    ...
    it('Set the min value dynamically with strict mode', () => {
      numerictextbox = new NumericTextBox(
        { value: 0.8, min: 1, max: 2, strictMode: false, format: 'p2' },
        '#tsNumeric'
      );
      expect(
        (<HTMLInputElement>document.getElementById('tsNumeric')).value
    ...
    it('Set the max value dynamically', () => {
      numerictextbox = new NumericTextBox(
        { value: 1.4, min: 1, max: 2, format: 'p2' },
        '#tsNumeric'
      );
      expect(
        (<HTMLInputElement>document.getElementById('tsNumeric')).value
    ...
    it('Set the max value dynamically', () => {
      numerictextbox = new NumericTextBox(
        { value: 1.8, min: 1, max: 2, format: 'p2' },
        '#tsNumeric'
      );
      expect(
        (<HTMLInputElement>document.getElementById('tsNumeric')).value
    ...
    it('Set the max value dynamically with strict mode', () => {
      numerictextbox = new NumericTextBox(
        { value: 1.8, min: 1, max: 2, strictMode: false, format: 'p2' },
        '#tsNumeric'
      );
      expect(
        (<HTMLInputElement>document.getElementById('tsNumeric')).value
    ...
    it('Set the max value dynamically with strict mode', () => {
      numerictextbox = new NumericTextBox(
        { value: 2.8, min: 1, max: 2, strictMode: false, format: 'p2' },
        '#tsNumeric'
      );
      expect(
        (<HTMLInputElement>document.getElementById('tsNumeric')).value
  ...
  describe('Check placeholder after load culture', () => {
    ...
    it('Set placeholder through API', () => {
      numerictextbox = new NumericTextBox(
        { floatLabelType: 'Auto', locale: 'en', placeholder: 'Testo numeric' },
        '#tsNumeric'
      );
  ...
  describe('Keyboard navigation up/down and enter key press', () => {
    ...
    it('up arrow keypress in Currency textbox with value as max', () => {
      ...
      numerictextbox = new NumericTextBox(
        { value: 20, min: 10, max: 20, format: 'c2' },
        '#tsNumeric'
      );
      expect(
        (<HTMLInputElement>document.getElementById('tsNumeric')).value
    ...
    it('down arrow keypress in Currency textbox with value as min', () => {
      ...
      numerictextbox = new NumericTextBox(
        { value: 10, min: 10, max: 20, format: 'c2' },
        '#tsNumeric'
      );
      expect(
        (<HTMLInputElement>document.getElementById('tsNumeric')).value
    ...
    it('up arrow keypress in currency textbox after typing the value in textbox', () => {
      ...
      numerictextbox = new NumericTextBox(
        { value: 20, min: 5, max: 25, format: 'c2' },
        '#tsNumeric'
      );
      expect(
        (<HTMLInputElement>document.getElementById('tsNumeric')).value
    ...
    it('down arrow keypress in currency textbox after typing the value in textbox', () => {
      ...
      numerictextbox = new NumericTextBox(
        { value: 20, min: 10, max: 25, format: 'c2' },
        '#tsNumeric'
      );
      expect(
        (<HTMLInputElement>document.getElementById('tsNumeric')).value
    ...
    it('up arrow keypress after empty the currency textbox', () => {
      ...
      numerictextbox = new NumericTextBox(
        { value: 20, min: 10, max: 30, format: 'c2' },
        '#tsNumeric'
      );
      expect(
        (<HTMLInputElement>document.getElementById('tsNumeric')).value
    ...
    it('Press enter key after typing the value in the numeric textbox with strictmode', () => {
      ...
      numerictextbox = new NumericTextBox(
        { min: 10, max: 30, strictMode: false },
        '#tsNumeric'
      );
      expect(numerictextbox.value).toBeNull();
      (<HTMLInputElement>document.getElementById('tsNumeric')).value = '35';
    ...
    it('Press enter key after typing the value in the percentage textbox with strictmode', () => {
      ...
      numerictextbox = new NumericTextBox(
        { min: 1, max: 3, strictMode: false, format: 'p2' },
        '#tsNumeric'
      );
      expect(numerictextbox.value).toBeNull();
      (<HTMLInputElement>document.getElementById('tsNumeric')).value = '3.5';
    ...
    it('Press enter key after typing the value in the currency textbox with strictmode', () => {
      ...
      numerictextbox = new NumericTextBox(
        { min: 10, max: 30, strictMode: false, format: 'c2' },
        '#tsNumeric'
      );
      expect(numerictextbox.value).toBeNull();
      (<HTMLInputElement>document.getElementById('tsNumeric')).value = '35';
    ...
    it('Press enter key after removing the value in the textbox', () => {
      ...
      numerictextbox = new NumericTextBox(
        { min: 10, max: 30, value: 25, format: 'n2' },
        '#tsNumeric'
      );
      expect(numerictextbox.value).toEqual(25);
      (<HTMLInputElement>document.getElementById('tsNumeric')).value = '';
    ...
    it('Press enter key after removing the value in the percentage textbox', () => {
      ...
      numerictextbox = new NumericTextBox(
        { min: 1, max: 2, value: 1.5, format: 'p2' },
        '#tsNumeric'
      );
      expect(numerictextbox.value).toEqual(1.5);
      (<HTMLInputElement>document.getElementById('tsNumeric')).value = '';
    ...
    it('Press enter key after removing the value in the currency textbox', () => {
      ...
      numerictextbox = new NumericTextBox(
        { min: 10, max: 30, value: 25, format: 'c2' },
        '#tsNumeric'
      );
      expect(numerictextbox.value).toEqual(25);
      (<HTMLInputElement>document.getElementById('tsNumeric')).value = '';
    ...
    it('Press enter key after removing the value in the strict mode textbox', () => {
      ...
      numerictextbox = new NumericTextBox(
        { min: 10, max: 30, value: 35, strictMode: false, format: 'n2' },
        '#tsNumeric'
      );
      expect(numerictextbox.value).toEqual(35);
      (<HTMLInputElement>document.getElementById('tsNumeric')).value = '';
    ...
    it('Press enter key after removing the value in the strict mode percentage textbox', () => {
      ...
      numerictextbox = new NumericTextBox(
        { min: 1, max: 2, value: 3.5, strictMode: false, format: 'p2' },
        '#tsNumeric'
      );
      expect(numerictextbox.value).toEqual(3.5);
      (<HTMLInputElement>document.getElementById('tsNumeric')).value = '';
    ...
    it('Press enter key after removing the value in the strict mode currency textbox', () => {
      ...
      numerictextbox = new NumericTextBox(
        { min: 10, max: 30, value: 35, strictMode: false, format: 'c2' },
        '#tsNumeric'
      );
      expect(numerictextbox.value).toEqual(35);
      (<HTMLInputElement>document.getElementById('tsNumeric')).value = '';
  ...
  describe('HTML attribute API testing', () => {
    ...
    it('Other attribute testing with htmlAttributes API', () => {
      numerictextbox = new NumericTextBox({
        htmlAttributes: { class: 'test', name: 'numeric', title: 'sample' },
      });
      numerictextbox.appendTo('#tsNumeric');
      numerictextbox.updateHTMLAttrToWrapper();
      expect(numerictextbox.hiddenInput.getAttribute('name')).toBe('numeric');
      expect(numerictextbox.inputWrapper.container.getAttribute('title')).toBe(
        'sample'
      );
      expect(
        numerictextbox.inputWrapper.container.classList.contains('test')
      ).toBe(true);
    });
    it('Dynamically change attributes with htmlAttributes API', () => {
      ...
      numerictextbox.updateHTMLAttrToWrapper();
      expect(numerictextbox.element.getAttribute('placeholder')).toBe(
        'Number of states'
      );
      expect(numerictextbox.element.hasAttribute('readonly')).toBe(true);
  ...
  describe('HTML attribute API dynamic testing', () => {
    ...
    it('Dynamically change attributes with htmlAttributes API', () => {
      ...
      expect(
        numerictextbox.inputWrapper.container.classList.contains('multiple')
      ).toBe(true);
    });
  ...
  describe('HTML attribute API at inital rendering and dynamic rendering', () => {
    ...
    beforeEach((): void => {
      numerictextbox = undefined;
      let ele: HTMLInputElement = <HTMLInputElement>(
        createElement('input', { id: 'numeric' })
      );
      document.body.appendChild(ele);
    });
    afterEach((): void => {
    ...
    it('Html attributes at initial rendering', () => {
      numerictextbox = new NumericTextBox({
        htmlAttributes: { placeholder: 'Enter a number', class: 'sample' },
      });
      numerictextbox.appendTo('#numeric');
      expect(numerictextbox.element.getAttribute('placeholder')).toBe(
        'Enter a number'
      ...
      expect(
        numerictextbox.inputWrapper.container.classList.contains('sample')
      ).toBe(true);
    });
  ...
  describe('Keyboard navigation key validation', () => {
    ...
    it('Trying to enter dot characters in the numeric textbox with en-US culture when decimal value as 0', () => {
      ...
      document.body.appendChild(ele);
      numerictextbox = new NumericTextBox(
        { value: 5, decimals: 0, validateDecimalOnType: true },
        ele
      );
      expect(
        (<HTMLInputElement>document.getElementById('tsNumeric')).value
    ...
    it('Trying to enter dot characters in the numeric textbox when decimal value as 0 and validateDecimalOnType as false', () => {
      ...
      document.body.appendChild(ele);
      numerictextbox = new NumericTextBox(
        { value: 5, decimals: 0, validateDecimalOnType: false },
        ele
      );
      expect(
        (<HTMLInputElement>document.getElementById('tsNumeric')).value
    ...
    it('Enter the value after reaching the maximum decimal value', () => {
      ...
      document.body.appendChild(ele);
      numerictextbox = new NumericTextBox(
        { value: 5.56, decimals: 3, validateDecimalOnType: true },
        ele
      );
      expect(
        (<HTMLInputElement>document.getElementById('tsNumeric')).value
  ...
  describe('Focus In and Focus Out handler', () => {
    ...
    it('type the value out of min & max range and focus out the control', () => {
      numerictextbox = new NumericTextBox(
        { value: 20, min: 10, max: 30, strictMode: false },
        '#tsNumeric'
      );
      numerictextbox.focusHandler();
      expect(
    ...
    it('type the value out of min & max range and focus out the currency control', () => {
      numerictextbox = new NumericTextBox(
        { value: 20, min: 10, max: 30, strictMode: false, format: 'c2' },
        '#tsNumeric'
      );
      numerictextbox.focusHandler();
      expect(
    ...
    it('type the value within the min & max range and focus out the control', () => {
      numerictextbox = new NumericTextBox(
        { value: 55, min: 10, max: 30, strictMode: false },
        '#tsNumeric'
      );
      expect(
        (<HTMLInputElement>document.getElementById('tsNumeric')).value
    ...
    it('type the value within the min & max range and focus out the control', () => {
      numerictextbox = new NumericTextBox(
        { value: 55, min: 10, max: 30, strictMode: false, format: 'c2' },
        '#tsNumeric'
      );
      expect(
        (<HTMLInputElement>document.getElementById('tsNumeric')).value
    ...
    it('floating label-functionality:Auto', () => {
      ...
      setInterval(function () {
        expect(
          document
            .querySelector('.e-float-input')
            .children[3].classList.contains('e-label-top')
        ).toEqual(true);
      }, 300);
      numerictextbox.focusOutHandler();
      setInterval(function () {
        expect(
          document
            .querySelector('.e-float-input')
            .children[3].classList.contains('e-label-bottom')
        ).toEqual(true);
      }, 300);
    });
    ...
    it('floating label-functionality:Never', () => {
      ...
      expect(
        document
          .getElementById('tsNumeric')
          .parentElement.classList.contains('e-float-input')
      ).toEqual(false);
    });
    ...
    it('code coverage for roundNumber method', () => {
      ...
      numerictextbox.roundNumber(2.7572425275725724e26, 4);
      numerictextbox.roundValue(2.7572425275725724e26);
    });
  });
  ...
  describe('enable persistance testing', () => {
    ...
    beforeEach((): void => {
      document.body.appendChild(ele);
      numerictextbox = new NumericTextBox(
        { value: 25, min: 10, max: 30, format: 'n2', enablePersistence: true },
        ele
      );
    });
    afterAll(() => {
    ...
    it('property localStorage updated test', () => {
      numerictextbox.destroy();
      expect(
        JSON.parse(window.localStorage.getItem('numerictextboxtsNumeric')).value
      ).toEqual(25);
      detach(ele);
    });
  ...
  describe('Enable Clear Icon', () => {
    ...
    beforeEach((): void => {
      let ele: HTMLInputElement = <HTMLInputElement>(
        createElement('input', { id: 'clrNumeric' })
      );
      document.body.appendChild(ele);
      numeric = new NumericTextBox({
        value: 25,
    ...
    it('clear icon', () => {
      expect(
        numeric.inputWrapper.clearButton.classList.contains('e-clear-icon-hide')
      ).toBe(true);
    ...
    it('clear button default state', () => {
      let input: HTMLInputElement = <HTMLInputElement>(
        document.getElementById('clrNumeric')
      );
      input.value = '123456';
      expect(
        numeric.inputWrapper.clearButton.classList.contains('e-clear-icon-hide')
      ...
      document.getElementById('clrNumeric').focus();
      expect(
        numeric.inputWrapper.clearButton.classList.contains('e-clear-icon')
      ).toBe(true);
    });
  ...
  describe('Disabled attribute as inline', () => {
    ...
    it('Check e-disabled class in input element', () => {
      expect(numerictextbox.element.classList.contains('e-disabled')).toBe(
        true
      );
      expect(
        numerictextbox.element.parentElement.classList.contains('e-disabled')
      ).toBe(true);
  ...
  it('memory leak testing', () => {
    ...
    expect(memory).toBeLessThan(
      inMB(profile.samples[profile.samples.length - 1]) + 0.25
    );
  });
  ...
  describe('Dynamic CssClass testcase', function () {
    ...
    it('single css class', function () {
      ...
      numeric.appendTo('#numeric');
      expect(
        numeric.inputWrapper.container.classList.contains('e-custom')
      ).toBe(true);
      ...
      expect(numeric.inputWrapper.container.classList.contains('e-test')).toBe(
        true
      );
    });
    it('more than one css class', function () {
      ...
      expect(
        numeric.inputWrapper.container.classList.contains('e-secondary')
      ).toBe(true);
      ...
      expect(
        numeric.inputWrapper.container.classList.contains('e-ternary')
      ).toBe(true);
    });
  });
  ...
  describe('EJ2-36604 - While giving the class name with empty space for HtmlAttributes, console error is produced.', function () {
    ...
    it('Entering the class name without any empty space', function () {
      ...
      expect(numericTextBox.container.classList.contains('custom-class')).toBe(
        true
      );
    });
    ...
    it('Giving more than one empty space between two class names', function () {
      ...
      numericTextBox.appendTo('#numerictextbox');
      expect(
        numericTextBox.container.classList.contains('custom-class-one')
      ).toBe(true);
      expect(
        numericTextBox.container.classList.contains('custom-class-two')
      ).toBe(true);
    });
    ...
    it('Giving class name with underscore in the beginning', function () {
      ...
      numericTextBox.appendTo('#numerictextbox');
      expect(
        numericTextBox.container.classList.contains('_custom-class-one')
      ).toBe(true);
      expect(
        numericTextBox.container.classList.contains('_custom-class-two')
      ).toBe(true);
    });
  ...
  describe('EJ2-54142-Using Static Clear Button to reset value does not reset the model value', () => {
    ...
    it('change event and blur event value testing ', () => {
      ...
      numeric.appendTo('#Numeric');
      expect(
        numeric.inputWrapper.container.classList.contains('e-static-clear')
      ).toBe(true);
      expect(
        numeric.inputWrapper.clearButton.classList.contains('e-clear-icon-hide')
      ).toBe(true);
      let clearBtn = document
        .getElementById('Numeric')
        .parentElement.querySelector('.e-clear-icon-hide');
      clearBtn.dispatchEvent(clickEvent);
  ...
  describe('Null or undefined value testing', function () {
    ...
    it('max', function () {
      ...
      expect(numericObj.max).toBe(1.7976931348623157e308);
      numericObj.destroy();
      numericObj = new NumericTextBox(
        {
          max: undefined,
    ...
    it('min', function () {
      ...
      expect(numericObj.min).toBe(-1.7976931348623157e308);
      numericObj.destroy();
      numericObj = new NumericTextBox(
        {
          min: undefined,
