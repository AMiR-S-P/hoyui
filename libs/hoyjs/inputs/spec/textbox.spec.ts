...
describe('TextBox ', () => {
  ...
  describe('Basics', () => {
    ...
    it('element structure testing', () => {
      expect(
        inputObj.element.parentElement.classList.contains('e-input-group')
      ).toBe(true);
    });
  });
  describe('Initial rendering testing - ', () => {
    ...
    it('name attribute ', () => {
      expect(inputObj.element.getAttribute('name')).toBe(
        inputObj.element.getAttribute('id')
      );
    });
  ...
  describe('Duplicate ID and name attribute testing in angular platform - ', () => {
    let inputObj: any;
    beforeAll((): void => {
      let element: HTMLElement = createElement('EJS-TEXTBOX', {
        id: 'textbox',
      });
    ...
    it('Check ID and name attribute- ', () => {
      ...
      inputObj.appendTo('#textbox');
      expect(
        inputObj.textboxWrapper.container.parentElement.getAttribute('id')
      ).toBe('textbox');
      expect(inputObj.element.getAttribute('id')).not.toBe('textbox');
      expect(
        inputObj.textboxWrapper.container.parentElement.hasAttribute('name')
      ).toBe(false);
  ...
  describe('Role attribute testing- ', () => {
    ...
    it('Attribute testing for textbox', () => {
      ...
      expect(inputObj.textboxWrapper.clearButton.getAttribute('role')).toBe(
        'button'
      );
    });
  ...
  describe('MultiLine structure testing with textarea element- ', () => {
    ...
    it('Structure testing for input type', () => {
      ...
      expect(
        inputObj.textboxWrapper.container.classList.contains('e-input-group')
      ).toBe(true);
    ...
    it('Structure testing for floatInput auto', () => {
      ...
      expect(
        childElements[1].tagName === 'SPAN' &&
          childElements[1].classList.contains('e-float-line')
      ).toBe(true);
      expect(
        childElements[2].tagName === 'LABEL' &&
          childElements[2].classList.contains('e-float-text')
      ).toBe(true);
    });
    ...
    it('Check appendsapn method not to set -', () => {
      ...
      inputObj.appendTo('#textbox');
      expect(
        inputObj.textboxWrapper.container.classList.contains(
          'e-input-group-icon'
        )
      ).toBe(false);
    });
    it('Check showClearButton api is set -', () => {
      ...
      expect(
        !isNullOrUndefined(
          inputObj.element.parentElement.querySelector('.e-clear-icon')
        )
      ).toBe(true);
  ...
  describe('Initially render multiline testing with textarea element- ', () => {
    ...
    it('Render multiLine textbox initially with floatLabelType auto', () => {
      ...
      expect(inputObj.element.tagName === 'TEXTAREA').toBe(true);
      expect(
        inputObj.textboxWrapper.container.classList.contains('e-float-input')
      ).toBe(true);
  ...
  describe('Initially render other properties with textarea element- ', () => {
    ...
    it('Render multiLine textbox initially with enableRtl state', () => {
      ...
      expect(inputObj.element.tagName === 'TEXTAREA').toBe(true);
      expect(
        inputObj.textboxWrapper.container.classList.contains('e-rtl')
      ).toBe(true);
    });
    ...
    it('Render multiLine textbox initially with enabled state', () => {
      ...
      expect(
        inputObj.textboxWrapper.container.classList.contains('e-disabled')
      ).toBe(true);
    });
  ...
  describe('MultiLine structure testing with input element- ', () => {
    ...
    it('Structure testing for floatInput auto', () => {
      ...
      expect(childElements[1].tagName === 'TEXTAREA').toBe(true);
      expect(
        childElements[2].tagName === 'SPAN' &&
          childElements[2].classList.contains('e-float-line')
      ).toBe(true);
      expect(
        childElements[3].tagName === 'LABEL' &&
          childElements[3].classList.contains('e-float-text')
      ).toBe(true);
    });
    it('Structure testing for floatInput always', () => {
    ...
    it('Check showClearButton api is set -', () => {
      ...
      expect(
        !isNullOrUndefined(
          inputObj.textarea.parentElement.querySelector('.e-clear-icon')
        )
      ).toBe(true);
      inputObj.showClearButton = true;
      inputObj.dataBind();
  ...
  describe('Onproperty changes testing - ', () => {
    ...
    it('floatLabelType api', () => {
      expect(
        inputObj.element.parentElement.classList.contains('e-float-input')
      ).toBe(false);
      inputObj.floatLabelType = 'Auto';
      inputObj.dataBind();
      expect(
    ...
    it('enableRtl api', () => {
      expect(inputObj.element.parentElement.classList.contains('e-rtl')).toBe(
        false
      );
      inputObj.enableRtl = true;
      inputObj.dataBind();
    ...
    it('cssClass api', () => {
      expect(
        inputObj.element.parentElement.classList.contains('new-class')
      ).toBe(false);
      ...
      expect(
        inputObj.element.parentElement.classList.contains('new-class2')
      ).toBe(true);
    });
    it('placeholder api', () => {
      expect(inputObj.placeholder).toBe(null);
  ...
  describe('HTML attributes at inline element testing', () => {
    ...
    beforeEach((): void => {
      ...
      let ele: HTMLInputElement = <HTMLInputElement>(
        createElement('input', { id: 'textbox' })
      );
  ...
  describe('HTML attribute API testing', () => {
    ...
    it('Other attribute testing with htmlAttributes API', () => {
      ...
      expect(inputObj.textboxWrapper.container.getAttribute('title')).toBe(
        'sample'
      );
      expect(inputObj.textboxWrapper.container.classList.contains('test')).toBe(
        true
      );
    });
    it('Dynamically change attributes with htmlAttributes API', () => {
      ...
      expect(inputObj.element.getAttribute('placeholder')).toBe(
        'Number of states'
      );
    });
  });
  describe('HTML attribute API dynamic testing', () => {
    ...
    it('Dynamically change attributes with htmlAttributes API', () => {
      ...
      expect(inputObj.textboxWrapper.container.getAttribute('style')).toBe(
      ...
      expect(
        inputObj.textboxWrapper.container.classList.contains('multiple')
      ).toBe(true);
    });
  ...
  describe('HTML attribute API at inital rendering and dynamic rendering', () => {
    ...
    it('Html attributes at initial rendering', () => {
      inputObj = new TextBox({
        htmlAttributes: { placeholder: 'Enter a name', class: 'sample' },
      });
      inputObj.appendTo('#textbox');
      expect(inputObj.element.getAttribute('placeholder')).toBe('Enter a name');
      expect(
        inputObj.textboxWrapper.container.classList.contains('sample')
      ).toBe(true);
    });
  ...
  describe('Reset form with initial value', () => {
    ...
    it('Check element value ', () => {
      ...
      expect(
        isNullOrUndefined(
          inputObj.textboxWrapper.container.querySelector('.e-label-top')
        )
      ).toBe(false);
      expect(
        isNullOrUndefined(
          inputObj.textboxWrapper.container.querySelector('.e-label-bottom')
        )
      ).toBe(true);
    });
  });
  ...
  describe('Dynamic CssClass testcase', function () {
    ...
    it('single css class', function () {
      ...
      expect(
        textbox.textboxWrapper.container.classList.contains('e-custom')
      ).toBe(true);
      ...
      expect(
        textbox.textboxWrapper.container.classList.contains('e-test')
      ).toBe(true);
    });
    it('more than one css class', function () {
      ...
      expect(
        textbox.textboxWrapper.container.classList.contains('e-secondary')
      ).toBe(true);
      ...
      expect(
        textbox.textboxWrapper.container.classList.contains('e-ternary')
      ).toBe(true);
    });
  });
  describe('EJ2-26470', function () {
    ...
    it('Change event in Vue platform', function () {
      textbox = new TextBox({
        value: 'Syncfusion',
        change: function (e: ChangedEventArgs) {
          changeCount++;
        },
      });
      textbox.appendTo('#textbox');
  ...
  describe('addIcon public method testing', () => {
    ...
    it('Ensure the DOM changes after adding icons', () => {
      ...
      expect(
        inputObj.textboxWrapper.container.querySelectorAll('*').length === 7
      ).toBe(true);

      let wrapper: HTMLElement =
        inputObj.textboxWrapper.container.querySelector('.e-input-in-wrap');
  ...
  describe('EJ2-36604 - While giving the class name with empty space for HtmlAttributes, console error is produced.', function () {
    ...
    it('Entering the class name without any empty space', function () {
      ...
      inputObj.appendTo('#textbox');
      expect(
        inputObj.textboxWrapper.container.classList.contains('custom-class')
      ).toBe(true);
    });
    ...
    it('Giving more than one empty space between two class names', function () {
      ...
      inputObj.appendTo('#textbox');
      expect(
        inputObj.textboxWrapper.container.classList.contains('custom-class-one')
      ).toBe(true);
      expect(
        inputObj.textboxWrapper.container.classList.contains('custom-class-two')
      ).toBe(true);
    });
  ...
  describe('EJ2-41857 - Outlined TextBox not supported Google Chrome autocompletes the input with the saved password', function () {
    ...
    it('Autofilled element wrapper class list', function () {
      ...
      expect(
        inputObj.textboxWrapper.container.classList.contains('e-valid-input')
      ).toBe(true);
    });
  });
  describe('EJ2-42714 - When hidden type textbox is rendered, wrapper is visible', function () {
    ...
    it('htmlAttribute type as hidden', () => {
      ...
      expect(inputObj.element.getAttribute('type')).toBe('hidden');
      expect(
        inputObj.textboxWrapper.container.classList.contains('e-hidden')
      ).toBe(true);
    });
  ...
  describe('EJ2-45520', function () {
    let inputObj: any;
    let inputObject: any;
    let textareaElement: HTMLElement = createElement('textarea', {
      id: 'textarea',
    });
    let secondInputElement: HTMLElement = createElement('input', {
      id: 'secondTextbox',
    });
    beforeEach(function () {
      let firstInputElement: HTMLElement = createElement('input', {
        id: 'firstTextbox',
      });
    ...
    it('render with single input element with multiline as true', () => {
      ...
      expect(childElements[3].id).toBe(
        inputObj.textarea.getAttribute('aria-labelledby')
      );
    });
    it('render with two input element with multiline as true for both', () => {
      ...
      expect(inputObj.textarea.hasAttribute('aria-labelledby')).toBe(true);
      expect(inputObj.textarea.hasAttribute('id')).toBe(true);
      expect(firstChildElements[3].id).toBe(
        inputObj.textarea.getAttribute('aria-labelledby')
      );
      expect(inputObject.textarea.hasAttribute('aria-labelledby')).toBe(true);
      expect(inputObject.textarea.hasAttribute('id')).toBe(true);
      expect(secondChildElements[3].id).toBe(
        inputObject.textarea.getAttribute('aria-labelledby')
      );
      inputObject.destroy();
    });
    it('render with two input element one with multiline as true', () => {
      ...
      expect(inputObj.element.hasAttribute('id')).toBe(true);
      expect(firstChildElements[2].id).toBe(
        inputObj.element.getAttribute('aria-labelledby')
      );
      expect(inputObject.textarea.hasAttribute('aria-labelledby')).toBe(true);
      expect(inputObject.textarea.hasAttribute('id')).toBe(true);
      expect(secondChildElements[3].id).toBe(
  ...
  describe('EJ2CORE-495 - The rows attribute not added to the textarea element.', function () {
    ...
    it('htmlAttribute addition inspection in multiline input for disabled, readonly and placeholder attributes', () => {
      ...
      expect(inputObj.textarea.getAttribute('placeholder')).toBe(
        'Enter your address'
      );
  ...
  describe('EJ2-54142', function () {
    ...
    it('Using static clear button ', function () {
      ...
      textbox.appendTo('#textbox');
      expect(
        textbox.textboxWrapper.container.classList.contains('e-static-clear')
      ).toBe(true);
      let mouseEvent = document.createEvent('MouseEvents');
      expect(
        textbox.textboxWrapper.clearButton.classList.contains(
          'e-clear-icon-hide'
        )
      ).toBe(true);
  ...
  describe('Check float label type', function () {
    ...
    it('Using long placeholder ', function () {
      ...
      expect(
        textbox.element.parentElement.classList.contains('e-input-group')
      ).toBe(true);
