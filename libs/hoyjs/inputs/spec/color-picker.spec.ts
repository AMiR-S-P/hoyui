...
} from '../src/color-picker/color-picker';
import {
  OpenEventArgs,
...
function setStyles(element: HTMLElement) {
  ...
  setStyleAttribute(element.querySelector('.e-hsv-color'), {
    width: '200px',
    height: '150px',
  });
}
...
describe('ColorPicker', () => {
  ...
  describe('Dom', () => {
    ...
    it('Default Testing', () => {
      ...
      expect(
        element.parentElement.classList.contains('e-colorpicker-wrapper')
      ).toBeTruthy();
      expect(
        element.parentElement
          .querySelector('.e-split-btn')
          .classList.contains('e-split-colorpicker')
      ).toBeTruthy();
      expect(
        element.parentElement
          .querySelector('.e-btn-icon')
          .classList.contains('e-selected-color')
      ).toBeTruthy();
      ...
      expect(
        ele.children[0].classList.contains('e-hsv-container')
      ).toBeTruthy();
      expect(
        ele.children[1].classList.contains('e-slider-preview')
      ).toBeTruthy();
      expect(
        ele.children[2].classList.contains('e-selected-value')
      ).toBeTruthy();
      expect(ele.children[2].querySelector('e-hex-value')).toBeDefined();
      expect(
        ele.children[3].classList.contains('e-switch-ctrl-btn')
      ).toBeTruthy();
      expect(
        ele.children[3].children[0].classList.contains('e-mode-switch-btn')
      ).toBeTruthy();
      expect(
        ele.children[3].children[1].classList.contains('e-ctrl-btn')
      ).toBeTruthy();
      expect(
        ele.children[3].children[1].children[0].classList.contains('e-apply')
      ).toBeTruthy();
      expect(
        ele.children[3].children[1].children[1].classList.contains('e-cancel')
      ).toBeTruthy();
    });
    ...
    it('Flat Picker', () => {
      ...
      expect(
        ele.children[0].children[0].classList.contains('e-hsv-color')
      ).toBeTruthy();
      expect(
        ele.children[0].children[1].classList.contains('e-handler')
      ).toBeTruthy();
      expect(
        ele.children[1].classList.contains('e-slider-preview')
      ).toBeTruthy();
      expect(
        ele.children[1].children[0].children[0].children[0].classList.contains(
          'e-hue-slider'
        )
      ).toBeTruthy();
      expect(
        ele.children[1].children[0].children[1].children[0].classList.contains(
          'e-opacity-slider'
        )
      ).toBeTruthy();
    ...
    it('Flat Palette', () => {
      ...
      expect(
        ele.children[0].children[0].classList.contains('e-row')
      ).toBeTruthy();
      expect(
        ele.children[0].children[0].children[0].classList.contains('e-tile')
      ).toBeTruthy();
    });
  });
  ...
  describe('Property', () => {
    ...
    it('presetColors testing', () => {
      colorPicker = new ColorPicker(
        { mode: 'Palette', presetColors: { custom: ['#EF5350', '#D81B60'] } },
        '#color-picker'
      );
      expect(colorPicker.presetColors).toEqual({
        custom: ['#EF5350', '#D81B60'],
      });
      (colorPicker.splitBtn.element.nextElementSibling as HTMLElement).click();
      expect(
        colorPicker.container
          .querySelectorAll('.e-palette')[0]
          .children[0].children[0].getAttribute('aria-label')
      ).toBe('#ef5350ff');
      colorPicker.destroy();
    ...
    it('Disabled testing', () => {
      ...
      expect(
        element.parentElement.classList.contains('e-disabled')
      ).toBeTruthy();
      (
        [].slice.call(
          element.nextElementSibling.querySelectorAll(
            '.e-switch-ctrl-btn button'
          )
        ) as Element[]
      ).forEach((ele) => {
    ...
    it('Rtl testing', () => {
      ...
      expect(
        element.nextElementSibling.classList.contains('e-rtl')
      ).toBeTruthy();
      expect(
        colorPicker.container.parentElement.classList.contains('e-rtl')
      ).toBeTruthy();
    });
    ...
    it('modeSwitcher Testing', () => {
      ...
      expect(
        colorPicker.container.querySelector('e-mode-switch-btn')
      ).toBeNull();
    });

    it('noColor Testing', () => {
      colorPicker = new ColorPicker(
        { mode: 'Palette', modeSwitcher: false, noColor: true },
        '#color-picker'
      );
      colorPicker.toggle();
    ...
    it('enableOpacity Property changes', () => {
      ...
      expect(
        colorPicker.container.parentElement.classList.contains('e-hide-opacity')
      ).toBeTruthy();
    });
  });
  ...
  describe('Methods', () => {
    ...
    it('Get value', () => {
      colorPicker = new ColorPicker({}, '#color-picker');
      expect(colorPicker.getValue('rgba(225, 76, 20, 0.5)', 'hexa')).toEqual(
        '#e14c1480'
      );
      expect(colorPicker.getValue('rgb(225, 76, 20)', 'HEX')).toEqual(
        '#e14c14'
      );
      expect(colorPicker.getValue('rgb(225, 76, 20)', 'HSV')).toEqual(
        'hsv(16,91.1,88.2)'
      );
      expect(colorPicker.getValue('rgb(225, 76, 20, 0.5)', 'HSVA')).toEqual(
        'hsva(16,91.1,88.2,0.5)'
      );
      expect(colorPicker.getValue('rgb(225, 76, 20, 0.5)', 'HSL')).toEqual(
        'null'
      );
      expect(colorPicker.getValue('hsva(302, 76, 20, 0.5)', 'HEXA')).toEqual(
        '#330c3280'
      );
      expect(colorPicker.getValue('hsv(302, 76, 20)', 'HEX')).toEqual(
        '#330c32'
      );
      expect(colorPicker.getValue('hsv(302, 76, 20)', 'RGB')).toEqual(
        'rgb(51,12,50)'
      );
      expect(colorPicker.getValue('hsva(302, 76, 20)', 'RGB')).toEqual(
        'rgb(51,12,50)'
      );
      expect(colorPicker.getValue('hsva(302, 76, 20, 0.5)', 'RGBA')).toEqual(
        'rgba(51,12,50,0.5)'
      );
      expect(colorPicker.getValue('hsv(302, 76, 20, 0.5)', 'HSL')).toEqual(
        'null'
      );
      expect(colorPicker.getValue('a207f580', 'HSVA')).toEqual(
        'hsva(279,97.1,96.1,0.5)'
      );
      expect(colorPicker.getValue('#a207f580', 'HSV')).toEqual(
        'hsv(279,97.1,96.1)'
      );
      expect(colorPicker.getValue('#ff39a5', 'RGB')).toEqual('rgb(255,57,165)');
      expect(colorPicker.getValue('#ff39a532', 'RGBA')).toEqual(
        'rgba(255,57,165,0.2)'
      );
    ...
    it('Toggle', () => {
      colorPicker = new ColorPicker({}, '#color-picker');
      expect(
        colorPicker.container.parentElement.classList.contains('e-popup-close')
      ).toBeTruthy();
      colorPicker.toggle();
      expect(
        colorPicker.container.parentElement.classList.contains('e-popup-open')
      ).toBeTruthy();
    });
    ...
    it('Localization Testing', () => {
      ...
      colorPicker.toggle();
      expect(colorPicker.container.querySelector('.e-apply').innerHTML).toEqual(
        'Sich bewerben'
      );
      expect(
        colorPicker.container.querySelector('.e-cancel').innerHTML
      ).toEqual('Stornieren');
    });
  ...
  describe('On property changes', () => {
    ...
    it('mode property changes', () => {
      ...
      expect(
        colorPicker.container.classList.contains('e-color-picker')
      ).toBeTruthy();
      colorPicker.mode = 'Palette';
      colorPicker.dataBind();
      expect(
        colorPicker.container.classList.contains('e-color-palette')
      ).toBeTruthy();
    ...
    it('Inline property changes', () => {
      colorPicker = new ColorPicker({}, '#color-picker');
      expect(
        element.nextElementSibling.classList.contains('e-split-btn-wrapper')
      ).toBeTruthy();
      colorPicker.inline = true;
      colorPicker.dataBind();
      expect(
        element.nextElementSibling.classList.contains('e-container')
      ).toBeTruthy();
    ...
    it('cssClass property changes', () => {
      colorPicker = new ColorPicker({ inline: true }, '#color-picker');
      expect(
        colorPicker.container.children[2].classList.contains('e-selected-value')
      ).toBeTruthy();
      colorPicker.cssClass = 'e-hide-value';
      colorPicker.dataBind();
      expect(
        element.parentElement.classList.contains('e-hide-value')
      ).toBeTruthy();
      expect(
        colorPicker.container.querySelector('.e-selected-value')
      ).toBeNull();
      ...
      colorPicker.toggle();
      expect(
        colorPicker.container.parentElement.classList.contains('e-show-value')
      ).toBeTruthy();
      (
        colorPicker.container.querySelector('.e-mode-switch-btn') as HTMLElement
      ).click();
      expect(
        colorPicker.container.querySelector('.e-selected-value')
      ).toBeDefined();
      ...
      colorPicker.dataBind();
      expect(
        colorPicker.container.children[1].classList.contains('e-selected-value')
      ).toBeTruthy();
      ...
      colorPicker.toggle();
      expect(
        colorPicker.container.querySelector('.e-selected-value .e-hex')
      ).toBeNull();
      colorPicker.cssClass = 'e-hide-switchable-value';
      colorPicker.dataBind();
      expect(
        colorPicker.container.querySelector('.e-selected-value .e-numeric')
      ).toBeNull();
    });
    ...
    it('enableRtl property changes', () => {
      ...
      expect(element.parentElement.classList.contains('e-rtl')).toBeTruthy();
      expect(
        colorPicker.getPopupEle().classList.contains('e-rtl')
      ).toBeTruthy();
    ...
    it('modeSwitcher Testing', () => {
      ...
      colorPicker.dataBind();
      expect(
        colorPicker.container.querySelector('e-switch-ctrl-btn')
      ).toBeNull();
      colorPicker.modeSwitcher = true;
      colorPicker.showButtons = true;
      colorPicker.dataBind();
    ...
    it('columns, and prestColors property changes', () => {
      ...
      expect((target.children[0] as HTMLElement).style.backgroundColor).toEqual(
        'rgb(255, 255, 255)'
      );
      colorPicker.mode = 'Picker';
      ...
      expect(
        colorPicker.container
          .querySelector('.e-custom-palette')
          .classList.contains('e-palette-group')
      ).toBeTruthy();
    });
    ...
    it('enableOpacity Property changes', () => {
      ...
      colorPicker.toggle();
      expect(
        colorPicker.container.querySelector('.e-opacity-slider')
      ).toBeDefined();
      expect(
        colorPicker.container.querySelector('.e-opacity-value')
      ).toBeDefined();
  ...
  describe('Click Events', () => {
    describe('For Palette type', () => {
      ...
      it('noColor Testing', () => {
        ...
        colorPicker.toggle();
        target = colorPicker.container.querySelectorAll('.e-row')[0]
      ...
      it('Tiles with no selected value', () => {
        colorPicker = new ColorPicker(
          { mode: 'Palette', inline: true, showButtons: false },
          '#color-picker'
        );
        target = colorPicker.container.children[0].children[0]
      ...
      it('Apply button click', () => {
        ...
        target.click();
        (
          colorPicker.container.querySelector('.e-apply') as HTMLElement
        ).click();
        colorPicker.toggle();
        target = colorPicker.container.children[0].children[0]
          .children[3] as HTMLElement;
        expect(target.classList.contains('e-selected')).toBeTruthy();
        expect(target.getAttribute('aria-selected')).toEqual('true');
        expect(target.getAttribute('aria-label').toLowerCase()).toBe(
          colorPicker.value
        );
      });
      ...
      it('Cancel button click', () => {
        ...
        colorPicker.paletteClickHandler({
          ...
          target: colorPicker.container.querySelector(
            '.e-switch-ctrl-btn'
          ) as HTMLElement,
        });
        (
          colorPicker.container.querySelector('.e-cancel') as HTMLElement
        ).click();
        colorPicker.toggle();
        target = colorPicker.container.children[0].children[0]
          .children[3] as HTMLElement;
        ...
        expect(
          colorPicker.container.parentElement.classList.contains(
            'e-popup-close'
          )
        ).toBeTruthy();
      });
    ...
    describe('For Picker type', () => {
      ...
      it('Mouse down in hsvArea', () => {
        colorPicker = new ColorPicker(
          { mode: 'Picker', showButtons: false, value: '#7B1FA2' },
          '#color-picker'
        );
        colorPicker.toggle();
      ...
      it('Device mode Touch start and move in hsvArea', () => {
        ...
        colorPicker = new ColorPicker(
          { value: '#4391a6', showButtons: false },
          '#color-picker'
        );
        colorPicker.toggle();
        target = colorPicker.container.querySelector(
      ...
      it('Apply button click', () => {
        ...
        triggerMouseEvent(target, 'mouseup');
        (
          colorPicker.container.querySelector(
            '.e-switch-ctrl-btn'
          ) as HTMLElement
        ).click();
        (
        ...
        expect(
          colorPicker.getPopupEle().classList.contains('e-popup-close')
        ).toBeTruthy();
      });

      it('Cancel button click', () => {
        colorPicker = new ColorPicker(
          { mode: 'Picker', value: '#a273f1' },
          '#color-picker'
        );
        colorPicker.toggle();
      ...
      it('Preview without opacity testing', () => {
        colorPicker = new ColorPicker(
          { value: '#8321a4', enableOpacity: false },
          '#color-picker'
        );
        colorPicker.toggle();
        target = colorPicker.container.querySelector(
    ...
    describe('For Both type', () => {
      ...
      it('Device mode Popup open/close Testing', () => {
        ...
        expect(
          document.body.classList.contains('e-colorpicker-overflow')
        ).toBeTruthy();
      ...
      it('Type Switching', () => {
        ...
        expect(
          colorPicker.container.children[0].classList.contains('e-palette')
        ).toBeTruthy();
        (
          colorPicker.container.querySelector(
            '.e-mode-switch-btn'
        ...
        expect(
          colorPicker.container.children[0].classList.contains(
            'e-hsv-container'
          )
        ).toBeTruthy();
        expect(
          colorPicker.container.children[1].classList.contains(
            'e-slider-preview'
          )
        ).toBeTruthy();
      });
      ...
      it('Without showButtons closing', () => {
        ...
        (
          colorPicker.container.querySelectorAll('.e-row')[0]
            .children[0] as HTMLElement
        ).click();
        expect(
          colorPicker.container.parentElement.classList.contains(
      ...
      it('Device mode close Testing', () => {
        ...
        colorPicker.splitBtn.element.nextElementSibling.click();
        triggerTouchEvent(
          document.body.querySelector('.e-modal') as HTMLElement,
          'touchstart'
        );
        expect(
          colorPicker.container.parentElement.classList.contains('e-popup-open')
      ...
      colorPicker = new ColorPicker(
        {
          ...
          beforeTileRender: (args: PaletteTileEventArgs) => {
            ...
            expect(args.element.getAttribute('aria-label')).toBe(
              presets.custom[count] + 'ff'
            );
  ...
  describe('Input area customization using cssClass property', () => {
    ...
    it('Hide inputs', () => {
      colorPicker = new ColorPicker(
        { cssClass: 'e-hide-value', showButtons: false },
        '#color-picker'
      );
      colorPicker.toggle();
      setStyles(colorPicker.container);
    ...
    it('Hide value switcher', () => {
      colorPicker = new ColorPicker(
        { cssClass: 'e-hide-valueswitcher', inline: true },
        '#color-picker'
      );
      expect(
        colorPicker.container.querySelector('.e-value-switch-btn')
      ).toBeNull();
  ...
  describe('Input Change Events', () => {
    ...
    it('HEX value', () => {
      colorPicker = new ColorPicker(
        { value: '#1cbc51', showButtons: false },
        '#color-picker'
      );
      colorPicker.splitBtn.toggle();
    ...
    it('Opacity value change', () => {
      ...
      colorPicker.inputHandler(EventArgs);
      colorPicker.opacitySlider.dataBind();
      expect(colorPicker.rgb[3]).toBe(0.5);
      (EventArgs.target as HTMLInputElement).value = '20';
      (colorPicker.container.querySelector('.e-apply') as HTMLElement).click();
    });
  });
  ...
  describe('Keyboard Events', () => {
    describe('For Picker', () => {
      ...
      it('Right arrow Testing', () => {
        ...
        EventArgs.target =
          element.nextElementSibling.querySelector('.e-handler');
        expect(colorPicker.value).toBe('#1cbc51ff');
      ...
      it('Left arrow Testing', () => {
        colorPicker = new ColorPicker(
          { mode: 'Picker', showButtons: false, value: '#1cbc51ff' },
          '#color-picker'
        );
        colorPicker.splitBtn.toggle();
        expect(colorPicker.value).toBe('#1cbc51ff');
      ...
      it('Left arrow from start Testing', () => {
        colorPicker = new ColorPicker(
          { mode: 'Picker', showButtons: false, value: '#000000' },
          '#color-picker'
        );
        colorPicker.splitBtn.toggle();
    ...
    describe('For Palette', () => {
      ...
      it('Left Arrow navigation', () => {
        ...
        EventArgs.keyCode = 37;
        colorPicker.paletteKeyDown(EventArgs);
        selectedEle = (EventArgs.target as HTMLElement).querySelectorAll(
          '.e-row'
        )[9].children[9];
      ...
      it('Left Arrow navigation RTL', () => {
        colorPicker = new ColorPicker(
          { mode: 'Palette', inline: true, enableRtl: true },
          '#color-picker'
        );
        EventArgs.target = colorPicker.container.querySelector('.e-palette');
        colorPicker.paletteKeyDown(EventArgs);
      ...
      it('Right Arrow navigation with RTL', () => {
        colorPicker = new ColorPicker(
          { mode: 'Palette', inline: true, enableRtl: true, value: '#009688' },
          '#color-picker'
        );
        EventArgs.target = colorPicker.container.querySelector('.e-palette');
        selectedEle = (EventArgs.target as HTMLElement).querySelectorAll(
      ...
      it('Down Arrow navigation', () => {
        colorPicker = new ColorPicker(
          { mode: 'Palette', inline: true, value: '#009688' },
          '#color-picker'
        );
        EventArgs.target = colorPicker.container.querySelector('.e-palette');
        selectedEle = (EventArgs.target as HTMLElement).querySelectorAll(
      ...
      it('Enter key action', () => {
        colorPicker = new ColorPicker(
          { mode: 'Palette', value: '#009688', showButtons: false },
          '#color-picker'
        );
        colorPicker.toggle();
        EventArgs.target = colorPicker.container.querySelector('.e-palette');
  ...
  describe('Customer Reported issues', () => {
    ...
    it('Device mode with createPopupOnClick property Popup open/close Testing', () => {
      ...
      Browser.userAgent = androidUserAgent;
      colorPicker = new ColorPicker(
        { value: '#7B1FA2', createPopupOnClick: true },
        '#color-picker'
      );
      colorPicker.splitBtn.element.nextElementSibling.click();
      expect(
