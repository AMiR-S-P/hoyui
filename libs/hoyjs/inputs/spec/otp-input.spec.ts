...
describe('OtpInput', () => {
  ...
  describe('DOM', () => {
    ...
    it('Default otpInput testing', () => {
      ...
      expect(otpInputElement.classList.contains('e-otpinput') != null).toEqual(
        true
      );
      expect(otpInputElement.classList.contains('e-outline') != null).toEqual(
        true
      );
      expect(otpInputElement.querySelector('#otpInput_hidden') != null).toEqual(
        true
      );
      expect(
        otpInputElement.querySelectorAll('.e-otp-input-field').length
      ).toBe(4);
      const inputElementArray: any =
        otpInputElement.querySelectorAll('.e-otp-input-field');
      for (let i = 0; i < inputElementArray.length; i++) {
        const inputElement: HTMLInputElement = inputElementArray[
          i
        ] as HTMLInputElement;
    ...
    it('Generic div Element ID generation', () => {
      ...
      expect(
        otpInputElement1.getAttribute('id') !=
          otpInputElement.getAttribute('id')
      ).toEqual(true);
  ...
  describe('DOM Properties', () => {
    ...
    it('Auto Focus', () => {
      ...
      otpInput.appendTo('#otp-input');
      expect(
        (otpInput as any).inputs[2].classList.contains('e-otp-input-focus')
      ).toEqual(true);
      otpInput.value = 123;
      ...
      expect(
        (otpInput as any).inputs[3].classList.contains('e-otp-input-focus')
      ).toEqual(true);
    });
    ...
    it('TextTransform', () => {
      ...
      otpInput.appendTo('#otp-input');
      const hiddenInputEle: HTMLInputElement =
        otpInputElement.querySelector('#otpInput_hidden');
    ...
    it('Value with fewer characters than length', () => {
      ...
      for (let i = 0; i < inputElementArray.length; i++) {
        ...
        expect(inputElement.value).toBe(
          otpValue.charAt(i) ? otpValue.charAt(i) : ''
        );
      }
    });
    ...
    it('Separator with default length property', () => {
      ...
      expect(otpInputElement.querySelectorAll('.e-otp-separator').length).toBe(
        3
      );
      const inputElementArray: any =
        otpInputElement.querySelectorAll('.e-otp-input-field');
      const separatorElementArray: any =
        otpInputElement.querySelectorAll('.e-otp-separator');
      for (let i = 0; i < inputElementArray.length; i++) {
        const inputElement: HTMLInputElement = inputElementArray[
          i
        ] as HTMLInputElement;
      ...
      for (let i = 0; i < inputElementArray.length - 1; i++) {
        const separatorElement: HTMLSpanElement = separatorElementArray[
          i
        ] as HTMLSpanElement;
    ...
    it('Placeholder with multiple text', () => {
      ...
      for (let i = 0; i < inputElementArray.length; i++) {
        ...
        expect(inputElement.placeholder).toBe(
          placeHolder.charAt(i) ? placeHolder.charAt(i) : ''
        );
      }
    });
    ...
    it('Dynamically updating separator in otpInput testing', () => {
      ...
      let newSeparatorElementArray: any =
        otpInputElement.querySelectorAll('.e-otp-separator');
      for (let i = 0; i < newSeparatorElementArray.length; i++) {
        const separatorElement: HTMLSpanElement = newSeparatorElementArray[
          i
        ] as HTMLSpanElement;
        expect(separatorElement.textContent).toBe(separatortext);
      }
    ...
    it('Dynamically adding arialabel', () => {
      ...
      for (let i = 0; i < inputElementArray.length; i++) {
        ...
        expect(inputElement.getAttribute('aria-label')).toBe(
          `Enter Otp Character ${i + 1}`
        );
      }
      ...
      expect(inputElementArray[3].getAttribute('aria-label')).toBe(
        'Enter Otp Character 4'
      );
    });
    ...
    it('Inputmode with type property', () => {
      ...
      expect((otpInput as any).inputs[2].getAttribute('inputmode')).toBe(
        'numeric'
      );
    });
    ...
    it('Inputmode with type property remaining values', () => {
      ...
      expect((otpInput as any).inputs[0].getAttribute('inputmode')).toBe(
        'text'
      );
    ...
    it('FocusIn and FocusOut method', () => {
      ...
      const inputElementArray: any =
        otpInputElement.querySelectorAll('.e-otp-input-field');
      expect(
        otpInputElement.querySelectorAll('.e-otp-input-focus').length
      ).toBe(0);
      otpInput.focusIn();
      expect(
        otpInputElement.querySelectorAll('.e-otp-input-focus').length
      ...
      expect(
        inputElementArray[3].classList.contains('e-otp-input-focus')
      ).toEqual(true);
      otpInput.focusOut();
      expect(
        otpInputElement.querySelectorAll('.e-otp-input-focus').length
    ...
    it('select value', () => {
      ...
      expect(
        inputElementArray[0].classList.contains('e-otp-input-focus')
      ).toEqual(true);
    });
    ...
    it('paste values', () => {
      ...
      inputElementArray[0].dispatchEvent(
  ...
  describe('Keyboard Events', () => {
    ...
    it('Arrow Key comibinations otpInput', () => {
      ...
      expect(
        inputElementArray[1].classList.contains('e-otp-input-focus')
      ).toEqual(true);
