...
describe('Rating', () => {
  ...
  describe('DOM', () => {
    ...
    beforeEach(() => {
      ratingElement = createElement('input', {
        id: 'rating',
        styles: 'display: none',
      });
    ...
    it('Default rating testing', () => {
      ...
      expect(
        ratingElement.parentElement.classList.contains('.e-rating-container') !=
          null
      ).toEqual(true);
      expect(
        ratingElement.parentElement.querySelector('.e-rating-item-list') != null
      ).toEqual(true);
      expect(
        ratingElement.parentElement
          .querySelector('.e-rating-item-list')
          .getAttribute('tabindex')
      ).toBe('0');
      expect(
        ratingElement.parentElement.querySelectorAll('.e-rating-item-container')
          .length
      ).toBe(5);
      expect(
        ratingElement.parentElement.querySelectorAll('.e-rating-item').length
      ).toBe(5);
      expect(
        ratingElement.parentElement.querySelectorAll('.e-rating-icon').length
      ).toBe(5);
      expect(
        ratingElement.parentElement.querySelectorAll('.e-rating-selected')
          .length
      ).toBe(0);
    });
    ...
    it('Generic input Element ID generation', () => {
      ...
      expect(
        ratingEle1.getAttribute('id') != ratingElement.getAttribute('id')
      ).toEqual(true);
    ...
    it('Generic input Element Name generation', () => {
      ...
      rating.appendTo(ratingEle1);
      expect(
        ratingEle1.getAttribute('name') != ratingElement.getAttribute('id')
      ).toEqual(true);
    ...
    it('Show Label rating testing', () => {
      ...
      rating.appendTo('#rating');
      expect(
        ratingElement.parentElement.querySelector('.e-rating-label') != null
      ).toEqual(true);
    });
  ...
  describe('DOM Properties', () => {
    ...
    it('Disabled', () => {
      ...
      rating.appendTo('#rating');
      expect(
        ratingElement.parentElement.classList.contains('e-disabled')
      ).toEqual(true);
    ...
    it('Visible', () => {
      ...
      rating.appendTo('#rating');
      expect(
        ratingElement.parentElement.classList.contains('e-rating-hidden')
      ).toEqual(true);
      rating.visible = true;
      rating.dataBind();
      expect(
    ...
    it('Read Only', () => {
      ...
      rating.appendTo('#rating');
      expect(
        ratingElement.parentElement.classList.contains('e-rating-readonly')
      ).toEqual(true);
    ...
    it('RTL', () => {
      ...
      rating.appendTo('#rating');
      expect(ratingElement.parentElement.classList.contains('e-rtl')).toEqual(
        true
      );
    ...
    it('Reset ', () => {
      ...
      rating.appendTo('#rating');
      expect(
        ratingElement.parentElement.querySelector('.e-reset') != null
      ).toEqual(true);
      expect(
        ratingElement.parentElement.querySelector('.e-reset').classList
    ...
    it('cssClass', () => {
      ...
      expect(ratingElement.parentElement.classList.contains('testClass')).toBe(
        false
      );
    });
    ...
    it('Label Position', () => {
      ...
      rating.appendTo('#rating');
      expect(
        ratingElement.parentElement.querySelector('.e-rating-label').classList
      ).toContain('e-label-right');
      rating.labelPosition = 'Bottom';
      rating.dataBind();
      expect(
        ratingElement.parentElement.querySelector('.e-rating-label').classList
      ).toContain('e-label-bottom');
      rating.labelPosition = 'Left';
      rating.dataBind();
      expect(
        ratingElement.parentElement.querySelector('.e-rating-label').classList
      ).toContain('e-label-left');
      rating.labelPosition = 'Top';
      rating.dataBind();
      expect(
        ratingElement.parentElement.querySelector('.e-rating-label').classList
      ).toContain('e-label-top');
    });
    ...
    it('Enable Animation ', () => {
      ...
      rating.appendTo('#rating');
      expect(
        ratingElement.parentElement.classList.contains('e-rating-animation')
      ).toBe(false);
      rating.enableAnimation = true;
      rating.dataBind();
      expect(ratingElement.parentElement.classList).toContain(
        'e-rating-animation'
      );
    ...
    it('Custom Label template', () => {
      ...
      expect(
        ratingElement.parentElement.querySelector('.e-rating-label').innerHTML
    ...
    it('Label Template as js renderer ', () => {
      ...
      rating.appendTo('#rating');
      expect(
        ratingElement.parentElement.querySelector('.e-rating-label')
    ...
    it('Item list Aria', () => {
      ...
      let itemList = ratingElement.parentElement.querySelector(
        '.e-rating-item-list'
      );
  ...
  describe('Rating Precision', () => {
    ...
    it('Full Precision with Value(3.4)', () => {
      ...
      expect(
        ratingElement.parentElement.querySelectorAll('.e-rating-intermediate')
          .length
      ).toBe(0);
      expect(rating.value).toBe(3);
    });
  ...
  describe('Mouse Events', () => {
    ...
    it('Click event rating testing', () => {
      ...
      let liElementArray: any = ratingElement.parentElement.querySelectorAll(
    ...
    it('Reset Click event with Value rating testing', () => {
      ...
      let resetElement: HTMLElement =
        ratingElement.parentElement.querySelector('.e-reset');
      mouseEventArs.target =
        ratingElement.parentElement.querySelector('.e-reset');
    ...
    it('Tooltip with default template', () => {
      ...
      (rating as any).tooltipObj.animation = {
        open: { effect: 'None' },
        close: { effect: 'None' },
      };
    ...
    it('Tooltip with template', () => {
      ...
      (rating as any).tooltipObj.open(liElementArray[1]);
      expect(
        document.body.querySelector('.e-rating-tooltip-content') != null
      ).toEqual(true);
      expect(
        document.body.querySelector('.e-rating-tooltip-content').innerHTML
      ).toEqual('<span>testTemplate</span>');
    });

    it('Tooltip with dynamic template', (done) => {
      let template =
        '${if(value==1)}<b>Angry</b> ${else if(value==2)}<b>Sad</b> ${else if(value==3)}<b>Neutral</b> ${else if(value==4)}<b>Good</b> ${else}<b>Happy</b>${/if}';
      let renderer = createElement('script', {
        id: 'tooltipTemplate',
        innerHTML: template,
      });
    ...
    it('Custom tooltip using cssClass', () => {
      ...
      expect(
        document.body
          .querySelector('.e-rating-tooltip')
    ...
    it('Empty template', () => {
      ...
      expect(
        ratingElement.parentElement.querySelectorAll('.emptyTemplate').length
      ).toBe(5);
      expect(
        ratingElement.parentElement.querySelectorAll('.e-rating-empty').length
      ).toBe(5);
    ...
    it('Full template', () => {
      ...
      expect(
        ratingElement.parentElement.querySelectorAll('.e-rating-full').length
      ).toBe(1);
      mouseEventArs.target = liElementArray[1];
      EventHandler.trigger(liElementArray[1], 'mousemove');
      expect(
        ratingElement.parentElement.querySelectorAll('.fullTemplate').length
      ).toBe(2);
      expect(
        ratingElement.parentElement.querySelectorAll('.e-rating-full').length
      ).toBe(2);
    ...
    it('Spec coverage for isReact', () => {
      ...
      expect(
        ratingElement.parentElement.querySelector('.e-rating-label').innerHTML
      ).toEqual('<span class="labelTemplate">testTemplate</span>');
      expect(
        ratingElement.parentElement.querySelectorAll('.emptyTemplate').length
      ).toBe(4);
      expect(
      ...
      expect(
        ratingElement.parentElement.querySelectorAll('.labelTemplate').length
      ).toBe(1);
      expect(
        ratingElement.parentElement.querySelectorAll('.fullTemplate').length
      ).toBe(1);
      ...
      expect(
        document.body.querySelector('.e-rating-tooltip-content').innerHTML
      ).toEqual('<span class="tooltipTemplate">tooltipTemplate</span>');
    ...
    describe('Methods and Events', () => {
      it('beforeItemRender Property', () => {
        ...
        rating.appendTo('#rating');
        expect(
          ratingElement.parentElement.querySelectorAll(
            '.e-rating-item-container'
          ).length
        ).toBe(5);
        expect(count).toBe(5);
  ...
  describe('Touch Events', () => {
    ...
    it('Full Precision', () => {
      rating = new Rating();
      rating.appendTo('#rating');
      let ulElement: any = ratingElement.parentElement.querySelector(
        '.e-rating-item-list'
      );
  ...
  describe('Keyboard Events', () => {
    ...
    it('Keyboard Combination event rating testing', () => {
      ...
      keyboardEventArgs.target = ratingElement.parentElement.querySelector(
        '.e-rating-item-list'
      );
