 ...
 */
import { createElement, attributes, Browser, L10n } from '@hoyui/base';
...
describe('Slider Control', () => {
  describe('Slider element', () => {
    ...
    it('Control class testing', () => {
      ...
      expect(
        document.getElementById('slider').classList.contains('e-slider')
      ).toEqual(true);
    });
    it('cssClass testing', () => {
      ...
      slider.appendTo('#slider');
      expect(
        document.getElementById('slider').classList.contains('class1')
      ).toEqual(true);
    });
    it('multiple cssClass testing', () => {
      ...
      expect(
        document.getElementById('slider').classList.contains('class2')
      ).toEqual(true);
    });
    ...
    it('Hidden input value testing', () => {
      ...
      slider.appendTo('#slider');
      expect(
        (document.querySelectorAll('.e-slider-input')[0] as HTMLInputElement)
          .value
      ).toEqual('90');
    });
    it('Slider bar testing', () => {
      ...
      expect(
        document
          .getElementsByClassName('e-slider-container')[0]
          .querySelectorAll('.e-slider').length
      ).toBe(1);
    });
    it('Slider handle testing', () => {
      ...
      slider.appendTo('#slider');
      expect(
        document.getElementById('slider').querySelectorAll('.e-handle').length
      ).toBe(1);
    });
    it('DOM minRange Slider rangebar element testing', () => {
      ...
      slider.appendTo('#slider');
      expect(
        document.getElementById('slider').querySelectorAll('.e-range').length
      ).toBe(1);
    });
    ...
    it('SliderTrack Color With Horizantal Orientation And Enable RTL', () => {
      slider = new Slider({
        colorRange: [{ color: 'red', start: 20, end: 30 }],
      ...
      expect(
        document
          ...
          .querySelectorAll('.e-slider-horizantal-color').length
      ).toBe(1);
    });
    ...
    it('SliderTrack Color With Vertical Orientation', () => {
      ...
      expect(
        document
          .getElementById('slider')
          .querySelectorAll('.e-slider-vertical-color').length
      ).toBe(1);
    });

    it('SliderTrack Color With Custom Value', () => {
      slider = new Slider({
        colorRange: [{ color: 'red', start: 2, end: 3 }],
        customValues: [20, 30, 40, 70, 80],
        enableRtl: true,
      });
      slider.appendTo('#slider');
      expect(
    ...
    it('SliderTrack Color With Minimum Start Value and Maximum End Value', () => {
      slider = new Slider({
        colorRange: [{ color: 'red', start: -10, end: 101 }],
      });
      slider.appendTo('#slider');
      expect(
        document
    ...
    it('Slider with customvalue value testing', () => {
      ...
      slider = new Slider({
        ...
        customValues: [10, 20, 70, 95, 100, 200, 500, 30, 90],
        value: 1,
      });
      slider.appendTo('#slider');
      expect(
        (
          document
            .getElementById('slider')
            .querySelectorAll('.e-large')[1] as HTMLElement
        ).innerText
      ).toBe('20');
      expect(
        (
          document.getElementsByClassName('e-handle')[0] as HTMLElement
      ...
      expect(
        (
          document
            .getElementById('slider')
            .querySelectorAll('.e-large')[3] as HTMLElement
        ).innerText
      ).toBe('excellent');
      slider.dataBind();
      expect(
      ...
      events = new Slider({
        type: 'Range',
        customValues: [10, 20, 25, 30, 40, 45, 60, 80, 70, 35, 90, 100],
        value: [0, 2],
      ...
      eventArgs = {
        ...
        target: document.getElementsByClassName('e-handle')[1] as HTMLElement,
        preventDefault: (): void => {},
      };
      ...
      eventArgs = {
        ...
        target: document.getElementsByClassName('e-handle')[0] as HTMLElement,
        preventDefault: (): void => {},
      };
      events.keyDown(eventArgs);
      expect(document.querySelectorAll('.e-tip-content')[0].textContent).toBe(
        '10 - 25'
      );
      expect(
        (
          document.getElementsByClassName('e-handle')[1] as HTMLElement
        ).getAttribute('aria-valuenow')
      ).toBe('10');
      expect(
        (
          document.getElementsByClassName('e-handle')[2] as HTMLElement
        ).getAttribute('aria-valuenow')
      ).toBe('25');
    ...
    it('Slider Width:number testing', () => {
      ...
      slider.appendTo('#slider');
      expect(
        (<HTMLElement>document.getElementsByClassName('e-slider-container')[0])
          .offsetWidth
      ).toBe(100);
    });
    ...
    it('Dynamic Slider Orientation testing', () => {
      ...
      expect(
        document
          .getElementsByClassName('e-slider-container')[0]
          .classList.contains('e-horizontal')
      ).toBe(true);
    });
    ...
    it('Dynamic Slider Orientation testing with tick', () => {
      slider = new Slider({
        value: 7,
        ticks: { placement: 'Before', showSmallTicks: true },
        enableRtl: true,
      });
      slider.appendTo('#slider');
      slider.orientation = 'Vertical';
      slider.dataBind();
      expect(
        document.querySelectorAll('.e-scale')[0].children.length
      ).not.toEqual(0);
    });
    ...
    it('Slider showButtons:true testing', () => {
      ...
      expect(
        document
          .getElementsByClassName('e-slider-container')[0]
          .querySelectorAll('.e-first-button').length
      ).toBe(1);
      expect(
        document
          .getElementsByClassName('e-slider-container')[0]
          .querySelectorAll('.e-second-button').length
      ).toBe(1);
    });
    ...
    it('Slider Ticks large step as negative value testing', () => {
      ...
      expect(
        document
          .getElementsByClassName('e-slider-container')[0]
          .querySelectorAll('.e-h-scale').length
      ).toBe(1);
      expect(
        document
          .getElementsByClassName('e-slider-container')[0]
          .querySelectorAll('.e-first-tick').length
      ).toBe(1);
      expect(
        document
          .getElementsByClassName('e-slider-container')[0]
          .querySelectorAll('.e-tick').length
      ).toBe(101);
      expect(
        document
          .getElementsByClassName('e-slider-container')[0]
          .querySelectorAll('.e-last-tick').length
      ).toBe(1);
    });
    ...
    it('Slider Ticks with 1 deciaml values', () => {
      ...
      expect(
        document
          .getElementsByClassName('e-slider-container')[0]
          .querySelectorAll('.e-tick-value')[3].textContent
      ).toBe('0.6');
    });
    ...
    it('Slider Ticks in fractional with 1 deciaml values', () => {
      ...
      expect(
        document
          .getElementsByClassName('e-slider-container')[0]
          .querySelectorAll('.e-tick-value')[4].textContent
      ).toBe('3.5');
    });
    ...
    it('Slider Ticks in negative values with decimal values', () => {
      slider = new Slider({
        ...
        max: 10,
        step: 2.5,
        ticks: { placement: 'After', largeStep: 2.5 },
      });
      slider.appendTo('#slider');
      expect(
        document
          .getElementsByClassName('e-slider-container')[0]
          .querySelectorAll('.e-tick-value')[5].textContent
      ).toBe('-7.5');
    });
    ...
    it('Slider aria attributes checking', () => {
      ...
      expect(
        document
          .getElementsByClassName('e-handle')[0]
      ...
      expect(
        (
          document.getElementsByClassName('e-first-button')[0] as HTMLElement
        ).getAttribute('aria-label')
      ).toBe('Decrease');
      expect(
        (
          document.getElementsByClassName('e-second-button')[0] as HTMLElement
        ).getAttribute('aria-label')
      ).toBe('Increase');
    });
    ...
    it('Slider tooltip  material tooltip (default)', () => {
      ...
      slider.appendTo('#slider');
      expect(
        document.body.lastElementChild.classList.contains(
          'e-material-tooltip-open'
        )
      ).toBe(false);
    ...
    it('Slider tooltip  material tooltip with showOn Auto (default)', () => {
      ...
      let ele1: HTMLElement = (<HTMLScriptElement[]>(
        (<any>document.getElementsByClassName('e-handle'))
      ))[0];
      ...
      let ele: HTMLElement = (<HTMLScriptElement[]>(
        (<any>document.getElementsByClassName('e-slider-container'))
      ))[0];
      ele.dispatchEvent(e);
      expect(
        document.body.lastElementChild.classList.contains(
    ...
    it('Slider tooltip  material tooltip with showOn Hover (default)', () => {
      slider = new Slider({
        tooltip: { placement: 'After', isVisible: true, showOn: 'Hover' },
      });
      slider.getTheme = () => 'material';
      slider.appendTo('#slider');
      expect(
    ...
    it('Slider tooltip  material tooltip (range)', () => {
      ...
      slider.appendTo('#slider');
      expect(
        document.body.lastElementChild.classList.contains('e-tooltip-wrap')
      ).toBe(false);
      expect(
        document.body.lastElementChild.classList.contains('e-popup-open')
      ).toBe(false);
      slider.tooltipToggle(slider.getHandle());
      slider.tooltipToggle(slider.getHandle());
      expect(
    ...
    it('Slider tooltip testing without isVisible', () => {
      slider = new Slider({
        showButtons: true,
        tooltip: { placement: 'After', showOn: 'Auto' },
      });
      slider.appendTo('#slider');
      expect(document.body.querySelectorAll('.e-tooltip-wrap').length).toEqual(
        0
      );
      slider.destroy();
    });
    ...
    it('notify property changes testing-cssClass property', () => {
      ...
      slider.dataBind();
      expect(
        document.getElementById('slider').classList.contains('css-classname')
      ).toEqual(true);
    });
    it('mousedown on sliderbar container related test case', () => {
      ...
      let event: object = {
        ...
        currentTarget: document.querySelectorAll(
          '.e-slider-container'
        )[0] as HTMLElement,
        preventDefault: function () {},
      };
      (<HTMLElement>document.querySelectorAll('.e-handle')[0]).style.left =
        '10%';
    });
    ...
    it('notify property changes testing-enabled property', () => {
      ...
      slider.enabled = true;
      slider.dataBind();
      expect(slider.sliderContainer.classList.contains('e-disabled')).toEqual(
        false
      );
    ...
    it('range slider with change Event testing with higher values', () => {
      ...
      slider.appendTo('#slider');
      (
        document.querySelectorAll('.e-slider-container')[0] as HTMLElement
      ).classList.add('e-slider-active');
    ...
    it('notify property changes testing tooltip property', () => {
      slider = new Slider({
        type: 'Range',
        tooltip: { placement: 'After', isVisible: false, showOn: 'Auto' },
      });
      slider.appendTo('#slider');
    ...
    it('notify property changes testing-ticks property', () => {
      ...
      slider.dataBind();
      expect(document.querySelectorAll('.e-scale')[0].children.length).toEqual(
        21
      );
    });
    ...
    it('slider repeat button testing', () => {
      ...
      let eventArgs = {
        type: 'mousedown',
        currentTarget: slider.firstBtn,
        target: slider.firstBtn,
        preventDefault: (): void => {},
      };
    ...
    it('slider repeat button testing with second button', () => {
      ...
      let eventArgs = {
        type: 'mousedown',
        currentTarget: slider.secondBtn,
        target: slider.firstBtn,
        preventDefault: (): void => {},
      };
      slider.repeatHandlerMouse(eventArgs);
    ...
    it('slider repeat button  with span icon as target testing', () => {
      ...
      let eventArgs = {
        type: 'mouseup',
        target: slider.firstBtn.firstElementChild,
        preventDefault: (): void => {},
      };
      slider.repeatButton(eventArgs);
    });
    ...
    it('slider repeat button with span icon as target testing', () => {
      ...
      let eventArgs = {
        type: 'mouseup',
        target: slider.secondBtn.firstElementChild,
        preventDefault: (): void => {},
      };
      slider.repeatButton(eventArgs);
    });
    ...
    it('Default slider key press- testing ', () => {
      ...
      eventArgs = {
        keyCode: 37,
        currentTarget: events.element,
        target: events.element,
        preventDefault: (): void => {},
      };
      events.keyDown(eventArgs);
      expect(
        (document.querySelector('.e-slider-input') as HTMLInputElement).value
      ).toEqual('0');
      eventArgs = {
        keyCode: 38,
        currentTarget: events.element,
    ...
    it('Slider with disabled state ', () => {
      ...
      events.appendTo('#slider');
      expect(events.sliderContainer.classList.contains('e-disabled')).toEqual(
        true
      );
    });
    ...
    it('Range tooltip test case with tooltip after placement (KeyUp Coverage)', () => {
      ...
      eventArgs1 = {
        keyCode: 37,
        currentTarget: events.secondHandle,
        target: events.secondHandle,
        preventDefault: (): void => {},
      };
      events.keyDown(eventArgs);
    ...
    it('Range tooltip test case with tooltip after placement (KeyUp Coverage)', () => {
      ...
      eventArgs1 = {
        keyCode: 9,
        currentTarget: events.firstHandle,
        target: events.firstHandle,
        preventDefault: (): void => {},
      };
      events.keyDown(eventArgs);
    ...
    it('Range tooltip test case with tooltip after placement in vertical slider for activehandle 1', () => {
      ...
      (
        document.getElementsByClassName('e-range')[0] as HTMLElement
      ).classList.add('e-tab-range');
      (
        document.getElementsByClassName('e-slider-track')[0] as HTMLElement
      ).classList.add('e-tab-track');
      events.keyDown(eventArgs);
      expect(document.querySelectorAll('.e-tip-content')[0].textContent).toBe(
        '0 - 100'
      );
  ...
  describe('Slider in HTML5 forms testing:', () => {
    ...
    it(
      'internal form reset value should take min value as its value' +
    ...
    it(
      'internal form reset value should take min and max value as its value' +
  ...
  describe('Slider', () => {
    ...
    it('parent height less than 10px  testing', () => {
      ...
      (<HTMLElement>document.querySelectorAll('.e-handle')[0]).style.left =
        '10%';
      expect(
        (document.getElementsByClassName('e-handle')[0] as HTMLElement).style
          .left
      ).toBe('10%');
    });
  });
  ...
  describe('Slide related events testing with tooltip with mobile useragent', () => {
    ...
    beforeEach(() => {
      ...
      targetEle = createElement('div', {
        id: 'target',
        styles:
          'top: 150px;left: 300px;height: 300px;width: 500px;position: absolute;',
      });
      ...
      mousedown.target = mousedown.currentTarget =
        document.getElementsByClassName('e-slider')[0];
      EventHandler.trigger(
        document.getElementsByClassName('e-slider')[0] as HTMLElement,
        'mousedown',
        mousedown
      );
      mousemove.srcElement =
        mousemove.target =
        mousemove.toElement =
          document.getElementsByClassName('e-handle');
      ...
      mouseUp.srcElement =
        mouseUp.target =
        mouseUp.toElement =
          document.getElementsByClassName('e-handle')[0];
    });
  ...
  describe('Slider slidermove method testing', () => {
    ...
    it('Slide the range slider using sliderbarmove', () => {
      ...
      mousemove.srcElement =
        mousemove.target =
        mousemove.toElement =
          document.getElementsByClassName('e-slider');
      EventHandler.trigger(<any>document, 'mousemove', mousemove);
      mousemove = setMouseCoordinates(mousemove, 319, 148);
      mouseUp = getEventObject('MouseEvents', 'mouseup');
      mouseUp.srcElement =
    ...
    it('Tooltip visibility after dragging the range slider', () => {
      ...
      mousedown = setMouseCoordinates(mousedown, 312, 144);
      mousedown.target = mousedown.currentTarget =
        document.getElementsByClassName('e-handle-second')[0];
      EventHandler.trigger(
        document.getElementsByClassName('e-handle-second')[0] as HTMLElement,
        'mousedown',
        mousedown
      );
      mousemove = getEventObject('MouseEvents', 'mousemove');
      mousemove.srcElement =
        mousemove.target =
        mousemove.toElement =
          document.getElementsByClassName('e-handle-second');
      mouseUp = getEventObject('MouseEvents', 'mouseup');
      mouseUp.srcElement =
        mouseUp.target =
        mouseUp.toElement =
    ...
    it('Slide the range slider using rangebar', () => {
      ...
      let mousedown: any = getEventObject('MouseEvents', 'mousedown');
      mousedown.target = mousedown.currentTarget =
        document.getElementsByClassName('e-range')[0];
      EventHandler.trigger(
        document.getElementsByClassName('e-range')[0] as HTMLElement,
        'mousedown',
        mousedown
      ...
      mousemove.srcElement =
        mousemove.target =
        mousemove.toElement =
          document.getElementsByClassName('e-range');
      mousemove = setMouseCoordinates(mousemove, 519, 148);
      EventHandler.trigger(<any>document, 'mousemove', mousemove);
      mouseUp = getEventObject('MouseEvents', 'mouseup');
      mouseUp.srcElement =
    ...
    it('Slide the default slider using sliderbarmove', () => {
      ...
      let args = {
        changedTouches: [{ clientX: 148, clientY: 349 }],
        preventDefault: function () {},
        type: 'touchstart',
  ...
  describe('Slide related events testing', () => {
    ...
    beforeEach(() => {
      ...
      mousedown = setMouseCoordinates(mousedown, 312, 144);
      mousedown.target = mousedown.currentTarget =
        document.getElementsByClassName('e-handle')[1];
      EventHandler.trigger(
        document.getElementsByClassName('e-handle')[1] as HTMLElement,
        'mousedown',
        mousedown
  ...
  describe('Sliderbar click testing ', () => {
    ...
    beforeAll((done: Function) => {
      ...
      slider.dataBind();
      let ele1: HTMLElement = (<HTMLScriptElement[]>(
        (<any>document.getElementsByClassName('e-slider'))
      ))[0];
      ele1.click();
      setTimeout(() => {
        done();
    ...
    it('click event testing', () => {
      ...
      expect(
        document
          .querySelector('.e-handle-first')
          .classList.contains('e-tab-handle')
      ).toEqual(true);
      var e = new MouseEvent('focusout', {
        view: window,
        bubbles: true,
        cancelable: true,
      });
  ...
  describe('Slider Button click testing ', () => {
    ...
    beforeAll((done: Function) => {
      ...
      slider.dataBind();
      let ele1: HTMLElement = (<HTMLScriptElement[]>(
        (<any>document.getElementsByClassName('e-first-button'))
      ))[0];
      ele1.click();
      setTimeout(() => {
        done();
  ...
  describe('Slider Button click enabled with Range slider with handle position as 100 testing ', () => {
    ...
    beforeAll((done: Function) => {
      ...
      rangeSlider = new Slider(
        { showButtons: true, type: 'Range', enableAnimation: false },
        '#slider'
      );
  ...
  describe('RTL enabled Slider Button click enabled with Range slider testing ', () => {
    ...
    beforeAll((done: Function) => {
      ...
      let clickFn: Function = jasmine.createSpy('click');
      let slider: Slider = new Slider(
        { showButtons: true, type: 'Range', enableRtl: true },
        '#slider'
      );
      slider.dataBind();
      let ele1: HTMLElement = (<HTMLScriptElement[]>(
  ...
  describe('RTL enabled Slider second Button click enabled with Range slider testing ', () => {
    ...
    beforeAll((done: Function) => {
      ...
      let clickFn: Function = jasmine.createSpy('click');
      let slider: Slider = new Slider(
        { value: [10, 20], showButtons: true, type: 'Range', enableRtl: true },
        '#slider'
      );
      slider.dataBind();
      let ele1: HTMLElement = (<HTMLScriptElement[]>(
        (<any>document.getElementsByClassName('e-second-button'))
      ))[0];
      ele1.click();
      setTimeout(() => {
        done();
  ...
  describe('Slider Tooltip format testing', () => {
      ...
      slider = new Slider(
        {
          ...
          min: 0,
          max: 100,
          tooltip: { isVisible: true, placement: 'Before', format: 'C0' },
        },
        '#slider'
      );
      eventArgs = {
      ...
      slider = new Slider(
        {
          ...
          min: 0,
          max: 100,
          ticks: { placement: 'Before', format: 'C0' },
        },
        '#slider'
      );
      eventArgs = {
      ...
      slider = new Slider(
        {
          ...
          min: 0,
          max: 100,
          tooltip: { isVisible: true, placement: 'Before', format: 'P0' },
        },
        '#slider'
      );
      eventArgs = {
    ...
    it('Tooltip Custom formats - Date and enableHtmlSanitizer property value as true', () => {
      ...
      slider = new Slider(
        {
          ...
          tooltipChange: function (args: any) {
            let totalMiliSeconds = Number(args.text.split(' ')[0]);
            let custom = { year: 'numeric', month: 'short', day: 'numeric' };
            var data = new Date(totalMiliSeconds).toLocaleDateString(
              'en-us',
              custom
            );
            args.text =
              '<style>body{background:rgb(0, 0, 255)}</style><div>' +
              data +
              '</div>';
          },
          tooltip: {
      ...
      expect(window.getComputedStyle(ele).backgroundColor).not.toBe(
        'rgb(0, 0, 255)'
      );
      expect(document.querySelectorAll('.e-tip-content')[0].textContent).toBe(
        'Jun 14, 2013'
  ...
  describe('Slider Limits Testing', () => {
    ...
    it('Default slider with limits enabled - minimum side testing', () => {
      slider = new Slider({
        ...
        max: 10,
        value: 5,
        limits: { enabled: true, minStart: 3, minEnd: 7 },
        showButtons: true,
      });
      slider.appendTo('#slider');
    ...
    it('Default slider with limits enabled - minimum side only limited', () => {
      slider = new Slider({
        ...
        max: 10,
        value: 5,
        limits: { enabled: true, minStart: 4 },
        showButtons: true,
      });
      slider.appendTo('#slider');
    ...
    it('Default slider with limits enabled - handle fixed', () => {
      slider = new Slider({
        ...
        max: 10,
        value: 5,
        limits: { enabled: true, minEnd: 7, startHandleFixed: true },
        showButtons: true,
      });
      slider.appendTo('#slider');
    ...
    it('Range slider with limits enabled - only one limits enabled for both handle', () => {
      slider = new Slider({
        ...
        max: 10,
        value: [5, 6],
        limits: { enabled: true, minStart: 4, maxEnd: 7 },
        showButtons: true,
        type: 'Range',
      });
      slider.appendTo('#slider');
    ...
    it('Range slider with limits enabled - only limits enabled for first handle', () => {
      slider = new Slider({
        ...
        max: 10,
        value: [5, 8],
        limits: { enabled: true, minStart: 4, minEnd: 7 },
        showButtons: true,
        type: 'Range',
      });
      slider.appendTo('#slider');
    ...
    it('Range slider with limits enabled - only limits enabled for second handle', () => {
      slider = new Slider({
        ...
        max: 10,
        value: [5, 7],
        limits: { enabled: true, maxStart: 6, maxEnd: 8 },
        showButtons: true,
        type: 'Range',
      });
      slider.appendTo('#slider');
    ...
    it('slider with limits enabled - limitbar element for default slider', () => {
      slider = new Slider({
        ...
        max: 10,
        value: 5,
        limits: { enabled: true, minStart: 2, minEnd: 8 },
        showButtons: true,
      });
      slider.appendTo('#slider');
      ...
      expect(
        sliderElement
          .querySelector('.e-limits')
          .classList.contains('e-limit-bar')
      ).toBe(true);
    });
    ...
    it('slider with limits enabled - limitbar element for range slider', () => {
      ...
      expect(
        sliderElement
          .querySelectorAll('.e-limits')[0]
          .classList.contains('e-limit-first')
      ).toBe(true);
      expect(
        sliderElement
          .querySelectorAll('.e-limits')[1]
          .classList.contains('e-limit-second')
      ).toBe(true);
    });
    ...
    it('slider with limits enabled - feeding wrong limit values in default slider', () => {
      slider = new Slider({
        ...
        max: 5,
        value: 3,
        limits: { enabled: true, minStart: -3, minEnd: 50 },
        showButtons: true,
      });
      slider.appendTo('#slider');
    ...
    it('slider with limits enabled - in vertical orientation default slider', () => {
      ...
      slider = new Slider({
        ...
        max: 10,
        value: 4,
        limits: { enabled: true, minStart: 2, minEnd: 5 },
        showButtons: true,
        orientation: 'Vertical',
        type: 'Default',
      });
  ...
  describe('Slider Interval dragging test cases', () => {
    ...
    it('Sliding the slider to minimum value using range bar with drag interval enabled', () => {
      ...
      let args: any = {
        changedTouches: [{ clientX: 350, clientY: 144 }],
        type: 'touchstart',
        preventDefault: function () {},
        currentTarget: document.getElementsByClassName('e-range')[0],
        target: document.getElementsByClassName('e-range')[0],
      };
      slider.materialTooltipEventCallBack(args);

      args = {
        changedTouches: [{ clientX: 0, clientY: 148 }],
        type: 'touchmove',
        preventDefault: function () {},
    ...
    it('Sliding the slider using range bar with drag interval and RTL enabled', () => {
      ...
      args = {
        changedTouches: [{ clientX: 519, clientY: 148 }],
        type: 'touchmove',
        preventDefault: function () {},
        currentTarget: document.getElementsByClassName('e-slider')[0],
      };
  ...
  describe('Slider Ticks Format Testing', () => {
      ...
      slider = new Slider(
        {
          ...
          min: 0,
          max: 100,
          ticks: { placement: 'After', format: 'C0' },
        },
        '#slider'
      );
      expect(document.querySelectorAll('.e-tick-value')[0].textContent).toBe(
        '$0'
      );
    });
      ...
      slider = new Slider(
        {
          ...
          showButtons: true,
          enableRtl: true,
          ticks: { placement: 'Both', format: 'C0' },
        },
        '#slider'
      );
      expect(document.querySelectorAll('.e-tick-value')[0].textContent).toBe(
      ...
      slider = new Slider(
        {
          ...
          min: 0,
          max: 100,
          ticks: { placement: 'After', format: 'P0' },
        },
        '#slider'
      );
      expect(document.querySelectorAll('.e-tick-value')[0].textContent).toBe(
      ...
      slider = new Slider(
        {
          ...
          min: 0,
          max: 100,
          ticks: { placement: 'After', format: 'N2' },
        },
        '#slider'
      );
      expect(document.querySelectorAll('.e-tick-value')[0].textContent).toBe(
    ...
    it('Ticks with custom formatting - weekdays with XSS and enableHtmlSanitizer property as false', () => {
      ...
      expect(document.querySelectorAll('.e-tick-value')[0].textContent).toBe(
        'body{background:rgb(0, 0, 255)}Sunday'
      );
      var ele = document.body;
      expect(window.getComputedStyle(ele).backgroundColor).toBe(
        'rgb(0, 0, 255)'
      );
    });
  ...
  describe('Localization Testing', () => {
    it('Changing culture into European testing', () => {
      ...
      L10n.load({
        'de-DE': {
          slider: {
            incrementTitle: 'Erh�hen, ansteigen',
      ...
      document.body.appendChild(element);
      slider = new Slider(
        { value: 10, showButtons: true, locale: 'en-US' },
        '#slider'
      );
      slider.locale = 'de-DE';
      slider.dataBind();
      expect(
        document
          .getElementsByClassName('e-slider-button')[1]
          .getAttribute('title')
      ).toBe('Erh�hen, ansteigen');
    });
    afterEach(() => {
      document.body.innerHTML = '';
    });
  ...
  describe('To achive the coverage ', () => {
    ...
    it('setEnabled method specific case test', () => {
      ...
      slider.setEnabled();
      expect(
        document.body.lastElementChild.classList.contains('e-disabled')
      ).toBe(true);
    });
    it('Horizontal Rangebar method specific case test', () => {
      slider = new Slider(
        { value: 10, showButtons: true, type: 'MinRange', enableRtl: true },
        '#slider'
      );
  ...
  describe('To achive coverage', () => {
    ...
    it('positionToValue method testing 2', () => {
      ...
      document.body.appendChild(ele);
      let rangeSlider: any = new Slider(
        { showButtons: true, orientation: 'Vertical' },
        '#slider'
      );
  ...
  describe('Resize Method Testing ', () => {
    ...
    it('Resize method testing', () => {
      ...
      document.body.appendChild(ele);
      let slider: any = new Slider(
        { value: 0, showButtons: true, type: 'MinRange', enableRtl: true },
        '#slider'
      );
      slider.reposition();
    });
    it('Resize method testing', () => {
      ...
      document.body.appendChild(ele);
      let slider: any = new Slider(
        { value: [10, 20], showButtons: true, type: 'Range' },
        '#slider'
      );
      slider.reposition();
    });
    ...
    it('Resize method testing', () => {
      ...
      document.body.appendChild(ele);
      let slider: any = new Slider(
        { type: 'MinRange', orientation: 'Vertical' },
        '#slider'
      );
      slider.reposition();
    });
    ...
    it('Resize method testing', () => {
      ...
      document.body.appendChild(ele);
      let slider: any = new Slider(
        { type: 'MinRange', orientation: 'Horizontal' },
        '#slider'
      );
      slider.handlePos1 = undefined;
      slider.reposition();
      ...
      let slider: any = new Slider(
        {
          type: 'MinRange',
          orientation: 'Horizontal',
          limits: { enabled: true, minStart: 20, minEnd: 40 },
        },
        '#slider'
      );
      slider.isMaterial = true;
  ...
  describe('Slider component value property testing', () => {
    it('When min and max are equal for horizontal slider', () => {
      ...
      document.body.appendChild(ele);
      let slider: any = new Slider(
        { min: 10, max: 10, ticks: { placement: 'Before' } },
        '#slider'
      );
      expect(slider.value).toBe(10);
    });
    ...
    it('When min and max are equal for horizontal slider with rtl', () => {
      ...
      document.body.appendChild(ele);
      let slider: any = new Slider(
        { min: 10, max: 10, enableRtl: true, ticks: { placement: 'Before' } },
        '#slider'
      );
      expect(slider.value).toBe(10);
    });
    it('When min and max are equal for horizontal slider with tick placement(both)', () => {
      ...
      document.body.appendChild(ele);
      let slider: any = new Slider(
        { min: 10, max: 10, enableRtl: true, ticks: { placement: 'Both' } },
        '#slider'
      );
      expect(slider.value).toBe(10);
      slider = new Slider(
    ...
    it('When min is greater than max horizontal slider', () => {
      ...
      document.body.appendChild(ele);
      let slider: any = new Slider(
        { value: 20, min: 10, max: 100, ticks: { placement: 'Before' } },
        '#slider'
      );
  ...
  describe('slider component tooltip events', () => {
    ...
    it('transitionEnd event material - default', () => {
      ...
      let e: any = { propertyName: 'left' };
      expect(
        slider.tooltipElement.style.transition.indexOf('cubic-bezier')
      ).toBe(-1);
      slider.transitionEnd(e);
      expect(
        slider.tooltipElement.style.transition.indexOf('cubic-bezier')
    ...
    it('mousedown event', () => {
      ...
      let slider: any = new Slider(
        {
          type: 'Range',
          tooltip: { placement: 'Before', isVisible: false, showOn: 'Hover' },
        },
        '#slider'
      );
      (
  ...
  describe('read only property testing', () => {
    ...
    describe('initialization', () => {
      ...
      it('control initialization', () => {
        ...
        expect(slider.sliderContainer.classList.contains('e-read-only')).toBe(
          true
        );
      });
...
describe('Slider ticks with decimal values', () => {
  it('Horizontal ticks', () => {
    ...
    let content =
      sliderInstance.element.querySelector('.e-first-tick').children[0]
        .textContent;
    expect(content).toBe('2');
    content =
      sliderInstance.element.querySelector('.e-last-tick').children[0]
        .textContent;
...
describe('Slider showOn property change Testing', () => {
  ...
  it('showOn property change to "Always"', () => {
    ...
    expect(slider.tooltipElement.classList.contains('e-tooltip-wrap')).toBe(
      true
    );
    expect(document.querySelectorAll('.e-tip-content')[0].textContent).toBe(
      '30'
