...
describe('TextArea Component', () => {
  ...
  describe('Basics', () => {
    let textareaObj: any;
    beforeAll((): void => {
      let element: HTMLTextAreaElement = createElement('textarea', {
        id: 'textarea',
    ...
    it('element structure testing', () => {
      expect(
        textareaObj.element.parentElement.classList.contains('e-input-group')
      ).toBe(true);
    });
  });
  describe('Initial rendering testing - ', () => {
    let textareaObj: any;
    beforeAll((): void => {
      let element: HTMLElement = createElement('textarea', {
        className: 'textarea',
      });
    ...
    it('name attribute ', () => {
      expect(textareaObj.element.getAttribute('name')).toBe(
        textareaObj.element.getAttribute('id')
      );
    });
  ...
  describe('Structure testing with textarea element- ', () => {
    ...
    it('Structure testing', () => {
      ...
      expect(
        textareaObj.textareaWrapper.container.classList.contains(
          'e-input-group'
        )
      ).toBe(true);
    ...
    it('Check showClearButton api is set -', () => {
      ...
      expect(
        !isNullOrUndefined(
          textareaObj.element.parentElement.querySelector('.e-clear-icon')
        )
      ).toBe(true);
  ...
  describe('Initially render other properties with textarea element- ', () => {
    ...
    it('Render textarea initially with enableRtl state', () => {
      ...
      expect(textareaObj.element.tagName === 'TEXTAREA').toBe(true);
      expect(
        textareaObj.textareaWrapper.container.classList.contains('e-rtl')
      ).toBe(true);
    });
    ...
    it('Render textarea initially with disabled state', () => {
      ...
      expect(
        textareaObj.textareaWrapper.container.classList.contains('e-disabled')
      ).toBe(true);
    });
  ...
  describe('Onproperty changes testing - ', () => {
    ...
    it('floatLabelType api', () => {
      expect(
        textareaObj.element.parentElement.classList.contains('e-float-input')
      ).toBe(false);
      textareaObj.floatLabelType = 'Auto';
      textareaObj.dataBind();
      expect(
    ...
    it('enableRtl api', () => {
      expect(
        textareaObj.element.parentElement.classList.contains('e-rtl')
      ).toBe(false);
      textareaObj.enableRtl = true;
      textareaObj.dataBind();
      expect(
    ...
    it('cssClass api', () => {
      expect(
        textareaObj.element.parentElement.classList.contains('new-class')
      ).toBe(false);
      ...
      expect(
        textareaObj.element.parentElement.classList.contains('new-class2')
      ).toBe(true);
    });
    it('placeholder api', () => {
      expect(textareaObj.placeholder).toBe(null);
  ...
  describe('Events testing - ', () => {
    ...
    it('reset value by click on clear button', () => {
      let mouseEvent = document.createEvent('MouseEvents');
      textareaObj.textareaWrapper.clearButton.classList.remove(
        'e-clear-icon-hide'
      );
      textareaObj.resetInputHandler(mouseEvent);
      expect(textareaObj.element.value).toBe('');
      textareaObj.textareaWrapper.clearButton.classList.add(
        'e-clear-icon-hide'
      );
      textareaObj.resetInputHandler(mouseEvent);
      expect(textareaObj.element.value).toBe('');
  ...
  describe('HTML attribute API testing', () => {
    ...
    beforeEach((): void => {
      ...
      let ele: HTMLTextAreaElement = <HTMLTextAreaElement>(
    ...
    it('Other attribute testing with htmlAttributes API', () => {
      ...
      expect(textareaObj.textareaWrapper.container.getAttribute('title')).toBe(
        'sample'
      );
      expect(
        textareaObj.textareaWrapper.container.classList.contains('test')
      ).toBe(true);
    });
    it('Dynamically change attributes with htmlAttributes API', () => {
      ...
      expect(textareaObj.element.getAttribute('placeholder')).toBe(
        'Number of states'
      );
  ...
  describe('HTML attribute API dynamic testing', () => {
    ...
    it('Dynamically change attributes with htmlAttributes API', () => {
      ...
      expect(textareaObj.textareaWrapper.container.getAttribute('style')).toBe(
      ...
      expect(
        textareaObj.textareaWrapper.container.classList.contains('multiple')
      ).toBe(true);
    });
  ...
  describe('HTML attribute API at inital rendering and dynamic rendering', () => {
    ...
    it('Html attributes at initial rendering', () => {
      ...
      expect(
        textareaObj.textareaWrapper.container.classList.contains('sample')
      ).toBe(true);
    });
  ...
  describe('Reset form with initial value', () => {
    ...
    it('Check element value ', () => {
      ...
      expect(
        isNullOrUndefined(
          textareaObj.textareaWrapper.container.querySelector('.e-label-top')
        )
      ).toBe(false);
      expect(
        isNullOrUndefined(
          textareaObj.textareaWrapper.container.querySelector('.e-label-bottom')
        )
      ).toBe(true);
    });
  });
  ...
  describe('Dynamic CssClass testcase', function () {
    let textarea: any;
    beforeEach(function () {
      let inputElement: HTMLElement = createElement('textarea', {
        id: 'textarea',
      });
    ...
    it('single css class', function () {
      ...
      expect(
        textarea.textareaWrapper.container.classList.contains('e-custom')
      ).toBe(true);
      ...
      expect(
        textarea.textareaWrapper.container.classList.contains('e-test')
      ).toBe(true);
    });
    it('more than one css class', function () {
      ...
      expect(
        textarea.textareaWrapper.container.classList.contains('e-secondary')
      ).toBe(true);
      ...
      expect(
        textarea.textareaWrapper.container.classList.contains('e-ternary')
      ).toBe(true);
    });
  });
  describe('testing resizeMode in textarea', function () {
    ...
    it('resizeMode None in textarea', function () {
      ...
      textareaObj.appendTo('#textarea');
      expect(textareaObj.element.classList.contains('e-resize-none')).toBe(
        true
      );
    });
  ...
  describe('Testing outlined textarea', () => {
    ...
    it('with focusIn method', () => {
      expect(
        textareaObj.textareaWrapper.container.classList.contains('e-outline')
      ).toBe(true);
      textareaObj.focusIn();
      expect(onFocus).toHaveBeenCalled();
      expect(
  ...
  describe('Testing filled textarea', () => {
    ...
    it('with focusIn method', () => {
      expect(
        textareaObj.textareaWrapper.container.classList.contains('e-filled')
      ).toBe(true);
      textareaObj.focusIn();
      expect(onFocus).toHaveBeenCalled();
      expect(
