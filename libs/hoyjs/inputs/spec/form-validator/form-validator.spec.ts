...
import { EventHandler } from '@hoyui/base';
import { FormValidatorModel } from '../../src/form-validator/form-validator-model';
import { Event, L10n, setCulture } from '@hoyui/base';
import {
  FormValidator,
  ErrorOption,
} from '../../src/form-validator/form-validator';
...
let inputElement1: string =
  '<div>' +
  createElement('input', {
    attrs: { id: 'required', type: 'text', name: 'input1' },
  }).outerHTML +
  '</div>';
let inputElement2: string =
  '<div>' +
  createElement('input', {
    attrs: { id: 'mail', type: 'text', name: 'input2' },
  }).outerHTML +
  '</div>';
let inputElement3: string =
  '<div>' +
  createElement('input', {
    attrs: { id: 'required', type: 'text', name: 'input3', required: 'true' },
  }).outerHTML +
  '</div>';
let inputElement4: string =
  '<div>' +
  createElement('input', {
    attrs: {
      id: 'hidden',
  ...
  '</div>';
let check: string =
  '<div><input type="checkbox" id="check" name="input3" /></div>';
let radio: string =
  '<div><input type="radio" id="radio" name="input4" /></div>';
// tslint:disable-next-line:max-line-length
let intSelect: string =
  '<div><select name="select" id="select"><option value="">Year</option><option value="1">1990</option></select></div>';
let submit: string =
  '<div><input type="submit" id="submit" name="submit" value="Submit" /></div>';

// html5 input elements
let messageElement: string =
  '<div><input type="text" required="true" name="messageElement" data-required-message="this is required field" /></div>';
let rangeLengthElement: string =
  '<div>' +
  createElement('input', {
    attrs: { rangeLength: '[2,5]', name: 'rangeLengthElement' },
  }).outerHTML +
  '</div>';
let rangeElement: string =
  '<div>' +
  createElement('input', { attrs: { range: '[5,10]', name: 'rangeElement' } })
    .outerHTML +
  '</div>';
let minElement: string =
  '<div>' +
  createElement('input', { attrs: { min: '5', name: 'minElement' } })
    .outerHTML +
  '</div>';
let maxElement: string =
  '<div>' +
  createElement('input', { attrs: { max: '5', name: 'maxElement' } })
    .outerHTML +
  '</div>';
let minLengthElement: string =
  '<div>' +
  createElement('input', {
    attrs: { minLength: '5', name: 'minLengthElement' },
  }).outerHTML +
  '</div>';
let maxLengthElement: string =
  '<div>' +
  createElement('input', {
    attrs: { maxLength: '5', name: 'maxLengthElement' },
  }).outerHTML +
  '</div>';
let mailElement: string =
  '<div>' +
  createElement('input', { attrs: { type: 'email', name: 'mailElement' } })
    .outerHTML +
  '</div>';
let inputMailElement: string =
  '<div><input type="text" required="true" name="inputMailElement" data-required-message="Enter your mail address" /></div>';
let urlElement: string =
  '<div>' +
  createElement('input', { attrs: { type: 'url', name: 'urlElement' } })
    .outerHTML +
  '</div>';
let dateElement: string =
  '<div>' +
  createElement('input', { attrs: { type: 'date', name: 'dateElement' } })
    .outerHTML +
  '</div>';
let numberElement: string =
  '<div>' +
  createElement('input', { attrs: { type: 'number', name: 'numberElement' } })
    .outerHTML +
  '</div>';
let regexElement: string =
  '<div>' +
  createElement('input', { attrs: { regex: '^[0-5]*$', name: 'regexElement' } })
    .outerHTML +
  '</div>';
let dateIsoElement: string =
  '<div>' +
  createElement('input', { attrs: { type: 'dateIso', name: 'dateIsoElement' } })
    .outerHTML +
  '</div>';
let html5numberElement: string =
  '<div><input type="text" name="html5numberElement" data-validation="number" /></div>';
let html5dateElement: string =
  '<div><input type="text" name="html5dateElement" data-validation="date" /></div>';
let digitsElement: string =
  '<div><input type="text" name="digitsElement" data-validation="digits" /></div>';
let dataValidation: string =
  '<div><input type="text" name="datavalidation" data-validation="number" /></div>';
let compareToElement: string =
  '<div><input type="text" name="compareTo" id="compareToElement" /></div>';
let comparableElement: string =
  '<div><input type="text" name="comparable" id="comparableElement" equalto="compareToElement" /></div>';
let hiddenElement: string =
  '<div><input type="hidden" name="hiddenElement" required="true"/></div>';
let validateHiddenElement: string =
  '<div><input type="hidden" name="validateHiddenElement" validateHidden="true" required="true"/></div>';

// annotation input elements
let annotationCompareTo: string =
  '<div><input type="text" name="annotationCompareTo" id="annotationCompareTo" /></div>';
let annotationComparable: string =
  '<div><input type="text" name="annotaionComparable" data-val="true" data-val-equalto-other="annotationCompareTo" /></div>';
let annotationCredit: string =
  '<div><input type="text" name="annotationCredit" data-val="true" data-val-creditcard="Please Enter valid Creditcard number" /></div>';
let annotationMinLength: string =
  '<div><input type="text" name="annotationMinLength" data-val="true" data-val-minlength-min="5" /></div>';
let annotationMaxLength: string =
  '<div><input type="text" name="annotationMaxLength" data-val="true" data-val-maxlength-max="5" /></div>';
let annotationRange: string =
  '<div><input type="text" name="annotationRange" data-val="true" data-val-range-min="5" data-val-range-max="10" data-val-range="please enter number between 5 to 10"/></div>';
let annotationPhone: string =
  '<div><input type="text" name="annotationPhone" data-val="true" data-val-phone="Enter valid phone number"</div>';
let annotationRegex: string =
  '<div><input type="text" name="annotationRegex" data-val="true" data-val-regex-pattern="^[a-zA-Z]+$" /></div>';
let annotationRequired: string =
  '<div><input type="text" name="annotationRequired" data-val="true" data-val-required="this is required field" /></div>';
let errorContainer: string =
  '<div><input type="text" name="errorContainer" data-val="true" data-val-required="this is required field" data-msg-containerid="errDiv" /><div id="errDiv"></div></div>';
let mvcErrorContainer: string =
  '<div><input type="text" id="input" name="mvcErrorContainer" data-val="true" data-val-required="this is required field" /><span data-valmsg-for="input"></span></div>';

// form elements initialization
let formElement: HTMLFormElement = <HTMLFormElement>(
  createElement('form', { id: 'formId', innerHTML: inputElement1 })
);
let formElement1: HTMLFormElement = <HTMLFormElement>(
  createElement('form', { id: 'formId1', innerHTML: inputElement1 })
);
let formElement2: HTMLFormElement = <HTMLFormElement>(
  createElement('form', { id: 'formId2', innerHTML: inputElement3 })
);
let formElement3: HTMLFormElement = <HTMLFormElement>(
  createElement('form', { id: 'formId3', innerHTML: inputElement4 })
);
let inputTypeElement: HTMLFormElement = <HTMLFormElement>(
  createElement('form', {
    id: 'formId1',
    innerHTML:
      inputElement1 + inputElement2 + check + radio + intSelect + submit,
  })
);
...
let formElements: HTMLFormElement = <HTMLFormElement>createElement('form', {
  id: 'formId3',
  innerHTML: messageElement + inputMailElement,
});

let formElements1: HTMLFormElement = <HTMLFormElement>createElement('form', {
  id: 'formId4',
  innerHTML: messageElement + inputMailElement + inputElement2,
});
let annotationElements: HTMLFormElement = <HTMLFormElement>(
  createElement('form', {
    id: 'formId1',
    innerHTML:
      annotationCredit +
...
function setInputValue(
  ...
  (<HTMLInputElement>(
    formObj.element.querySelector('[name="' + name + '"]')
  )).value = value;
}
...
describe('FormValidator # ', () => {
  ...
  it('check modified focusout # ', () => {
    let onFocusOut: (args: Object) => void = (args: Object) => {
      return true;
    };
  ...
  it('rules with array value # ', () => {
    let customFn: (args: Object) => boolean = (args: Object) => {
      return true;
    };
    let options: FormValidatorModel = {
      rules: { input1: { range: customFn } },
    };
    formObj.rules = options.rules;
  ...
  it('rules with custom message # ', () => {
    let options: FormValidatorModel = {
      rules: { input1: { required: [true, 'This field must not empty'] } },
    };
    formObj.rules = options.rules;
  ...
  describe('validate method # ', () => {
    beforeAll(() => {
      formObj1 = new FormValidator(inputTypeElement, {
        rules: {
    ...
    describe('with selected name # ', () => {
      it('testing current input with error element # ', () => {
        ...
        let errorElement: HTMLElement = <HTMLElement>(
          formObj1.getInputElement('input1').nextSibling
        );
        expect(
          errorElement !== null && errorElement.classList.contains('e-error')
        ).toEqual(true);
      });

      it('testing next input with error element # ', () => {
        let errorElement: HTMLElement = <HTMLElement>(
          formObj1.getInputElement('input2').nextSibling
        );
        expect(
          errorElement !== null && errorElement.classList.contains('e-error')
        ).toEqual(false);
  ...
  describe('reset method # ', () => {
    ...
    it('testing error element form validate # ', () => {
      let errorElement: HTMLElement = <HTMLElement>(
        formObj.getInputElement('input1').nextSibling
      );
      expect(
        errorElement !== null && errorElement.classList.contains('e-error')
      ).toEqual(true);
    ...
    it('testing input attribute aria-invalid after form validate # ', () => {
      expect(
        formObj.getInputElement('input1').getAttribute('aria-invalid')
      ).toEqual('true');
    });

    it('testing input error class after form validate # ', () => {
      expect(
        formObj.getInputElement('input1').classList.contains(formObj.errorClass)
      ).toEqual(true);
    });
  ...
  describe('recursive error in ie # ', () => {
    beforeAll(() => {
      formObj1 = new FormValidator(formElement, {
        rules: { input1: { required: true, email: true } },
      });
    });
  ...
  describe('default messages # ', () => {
    ...
    it('testing required message # ', () => {
      expect(formObj.defaultMessages['required']).toEqual(
        'This field is required.'
      );
    });

    it('testing email message # ', () => {
      expect(formObj.defaultMessages['email']).toEqual(
        'Please enter a valid email address.'
      );
    });

    it('testing url message # ', () => {
      expect(formObj.defaultMessages['url']).toEqual(
        'Please enter a valid URL.'
      );
    });

    it('testing date message # ', () => {
      expect(formObj.defaultMessages['date']).toEqual(
        'Please enter a valid date.'
      );
    });

    it('testing dateIso message # ', () => {
      expect(formObj.defaultMessages['dateIso']).toEqual(
        'Please enter a valid date ( ISO ).'
      );
    });

    it('testing number message # ', () => {
      expect(formObj.defaultMessages['number']).toEqual(
        'Please enter a valid number.'
      );
    });

    it('testing digits message # ', () => {
      expect(formObj.defaultMessages['digits']).toEqual(
        'Please enter only digits.'
      );
    });

    it('testing maxLength message # ', () => {
      expect(formObj.defaultMessages['maxLength']).toEqual(
        'Please enter no more than {0} characters.'
      );
    });

    it('testing minLength message # ', () => {
      expect(formObj.defaultMessages['minLength']).toEqual(
        'Please enter at least {0} characters.'
      );
    });

    it('testing rangeLength message # ', () => {
      expect(formObj.defaultMessages['rangeLength']).toEqual(
        'Please enter a value between {0} and {1} characters long.'
      );
    });

    it('testing range message # ', () => {
      expect(formObj.defaultMessages['range']).toEqual(
        'Please enter a value between {0} and {1}.'
      );
    });

    it('testing max message # ', () => {
      expect(formObj.defaultMessages['max']).toEqual(
        'Please enter a value less than or equal to {0}.'
      );
    });

    it('testing min message # ', () => {
      expect(formObj.defaultMessages['min']).toEqual(
        'Please enter a value greater than or equal to {0}.'
      );
    });

    it('testing regex message # ', () => {
      expect(formObj.defaultMessages['regex']).toEqual(
  ...
  describe('ignore element #', () => {
    beforeAll(() => {
      formObj1 = new FormValidator(inputTypeElement, {
        rules: { input1: { required: true }, input2: { required: true } },
        ignore: 'ignore',
      });
    ...
    describe('with validate method of no selected name # ', () => {
      it('testing error element # ', () => {
        ...
        expect(
          errorElement !== null &&
            errorElement.classList.contains(formObj1.errorClass)
        ).toEqual(true);
      });
  ...
  describe('required validation # ', () => {
    beforeAll(() => {
      ...
      formObj3 = new FormValidator(formElement2, {
        rules: { input3: { required: [true, 'Field mandatory'] } },
      });
      formObj4 = new FormValidator(formElement3, {
        rules: {
          validateHidden: {
            required: [true, 'Reject the validateHidden rule'],
          },
        },
      });
    });
    ...
    it('testing custom error message # ', () => {
      ...
      let errorMessage: HTMLElement = <HTMLElement>(
        formObj3.getInputElement('input3').nextSibling
      );
    ...
    it('testing custom error message with validate hidden rule # ', () => {
      ...
      let errorMessage: HTMLElement = <HTMLElement>(
        formObj4.getInputElement('validateHidden').nextSibling
      );
  ...
  describe('multiple form validation # ', () => {
    beforeAll(() => {
      ...
      formObj1 = new FormValidator(formElement1, {
        rules: { input1: { email: true } },
      });
    });
  ...
  describe('data-annotation validation # ', () => {
    ...
    describe('annotation messages # ', () => {
      ...
      it('valid required field validation # ', () => {
        expect(formObj.rules.annotationRequired.required[0]).toEqual(
  ...
  describe('errorOption # ', () => {
    ...
    it('with label option # ', () => {
      ...
      expect(
        errorElement.tagName.toLowerCase() === formObj.errorElement
      ).toEqual(true);
      formObj.destroy();
    });
    ...
    it('with message option # ', () => {
      ...
      expect(
        errorElement.tagName.toLowerCase() === formObj.errorContainer
      ).toEqual(true);
      formObj.destroy();
    });
  });
        ...
        expect(
          errorElement !== null &&
            formObj
              ...
              .classList.contains(formObj.errorClass)
        ).toEqual(true);
      });
      ...
      it('testing valid element before destroy # ', () => {
        ...
        expect(
          errorElement !== null &&
            ...
            formObj
              .getInputElement('input1')
              .classList.contains(formObj.validClass)
        ).toEqual(true);
      });
  ...
  describe('checkable elements # ', () => {
    ...
    beforeAll(() => {
      formObj2 = new FormValidator(inputTypeElement, {
        rules: { input3: { required: true }, input4: { required: true } },
      });
    });
    ...
    it('with checkbox invalid # ', () => {
      ...
      errorElement = <HTMLElement>(
        formObj2.getInputElement('input3').nextSibling
      );
      expect(
        errorElement !== null &&
          errorElement.classList.contains(formObj2.errorClass)
      ).toEqual(true);
    });

    it('with checkbox valid # ', () => {
      let check: HTMLInputElement = <HTMLInputElement>(
        select('[name=input3]', formObj2.element)
      );
      check.checked = true;
      formObj2.validate('input3');
      expect(isVisible(errorElement)).toEqual(false);
    ...
    it('with radio invalid # ', () => {
      ...
      errorElement = <HTMLElement>(
        formObj2.getInputElement('input4').nextSibling
      );
      expect(
        errorElement !== null &&
          errorElement.classList.contains(formObj2.errorClass)
    ...
    it('with radio valid # ', () => {
      let radio: HTMLInputElement = <HTMLInputElement>(
        select('[name=input4]', formObj2.element)
      );
      radio.checked = true;
      formObj2.validate('input4');
      expect(isVisible(errorElement)).toEqual(false);
  ...
  describe('custom fuction to rules # ', () => {
    beforeAll(() => {
      ...
      formObj = new FormValidator(formElement, {
        rules: { input1: { minLength: [customFn, 'Need atleast 5 letters'] } },
      });
    });
  ...
  describe('events # ', () => {
    ...
    describe('with focusout event # ', () => {
      it('on not added rule value # ', () => {
        ...
        let errorElement: HTMLElement = <HTMLElement>(
          formObj2.getInputElement('input2').nextSibling
        );
        expect(errorElement === null).toEqual(true);
      });
      ...
      it('on included rule value # ', () => {
        ...
        EventHandler.trigger(input, 'focusout', { target: input });
        let errorElement: HTMLElement = <HTMLElement>(
          formObj2.getInputElement('input1').nextSibling
        );
        expect(
          errorElement !== null &&
            errorElement.classList.contains(formObj2.errorClass)
    ...
    describe('with click event # ', () => {
      ...
      it('validate the checkable element # ', () => {
        ...
        expect(
          errorElement !== null && errorElement.style.display === 'block'
        ).toEqual(true);
      });
    ...
    describe('with change event # ', () => {
      it('on select element #', () => {
        ...
        let errorElement: HTMLElement = <HTMLElement>(
          formObj2.getInputElement('select').nextSibling
        );
        expect(
          errorElement !== null &&
            errorElement.classList.contains(formObj2.errorClass)
    ...
    describe('with submit event # ', () => {
      ...
      it('submit button with formnovalidate # ', () => {
        ...
        EventHandler.trigger(input, 'click', { target: input });
        let errorElements: Element[] = selectAll(
          '.' + formObj2.errorClass + ', .' + formObj2.validClass,
          formObj2.element
        );
      ...
      it('allow submit # ', () => {
        ...
        EventHandler.trigger(formObj2.element, 'submit', {
          preventDefault: () => {
            return false;
          },
        });
  ...
  describe('custom events # ', () => {
    ...
    it('check validationComplete with status as failure # ', (done) => {
      ...
      let validElement: HTMLFormElement = <HTMLFormElement>(
        createElement('form', { id: 'formId2', innerHTML: inputElement1 })
      );
  ...
  describe('EJ2-902: customPlacement not working properly # ', () => {
    ...
    it('check error element from custom placement with error # ', () => {
      let inputElement: HTMLElement = <HTMLElement>(
        formObj.getInputElement('input1')
      );
      let errorElement: HTMLElement = <HTMLElement>(
        select(
          formObj.errorElement + '.' + formObj.errorClass + '[for="input1"]'
        )
      );
  ...
  describe('custom messages for html5 rules # ', () => {
    ...
    it('match with rules message # ', () => {
      expect(formInstance.rules.messageElement.required[1]).toEqual(
        'this is required field'
      );
    });
...
describe('localization support', () => {
  beforeAll(() => {
    let mail: string =
      ...
      '</div>';
    let htmlelement: HTMLFormElement = <HTMLFormElement>(
      createElement('form', { id: 'formId2', innerHTML: mail })
    );
    let options = {
      rules: {
        // User: { required: true},
  ...
  it('ar-br culuture email vaildation #', () => {
    ...
    let element: HTMLElement = <HTMLElement>(
      formObj.getInputElement('Email').nextSibling
    );
...
describe('global localization', () => {
  beforeAll(() => {
    let mail: string =
      ...
      '</div>';
    let submit: string =
      "<button id='btn' class='e-btn e-control'>Change culture</button>";
    let htmlelement: HTMLFormElement = <HTMLFormElement>(
      createElement('form', { id: 'formId2', innerHTML: mail })
    );
    let options = {
...
describe('name attribute with dot sepeartor', () => {
  beforeAll(() => {
    let mail: string =
      '<div>' +
      createElement('input', {
        attrs: { id: 'Email', type: 'text', name: 'User.Email' },
      }).outerHTML +
      '</div>';
    let htmlelement: HTMLFormElement = <HTMLFormElement>(
      createElement('form', { id: 'formId2', innerHTML: mail })
  ...
  it('Validate input element', (done) => {
    ...
    let element: HTMLElement = <HTMLElement>(
      formObj.element.querySelector('[name="User.Email"]').nextSibling
    );
...
describe('Html5 rules data-validation # ', () => {
  ...
  describe('Validate inputs and check', () => {
    it('error messages', () => {
      formObj.validate();
      expect((formObj as any).errorRules[0].message).toEqual(
        'this is required field'
      );
      expect((formObj as any).errorRules[1].message).toEqual(
...
describe('Html5 rules data-validation and script side validation combination# ', () => {
  ...
  describe('Validate inputs and check', () => {
    it('error messages', () => {
      ...
      expect((formObj as any).errorRules[2].message).toEqual(
        'Enter your mail address'
      );
    });
  });
...
describe('Multiple forms with same name fields', () => {
  beforeAll(() => {
    let mail1: string =
      ...
      '</div>';
    let htmlelement1: HTMLFormElement = <HTMLFormElement>(
      createElement('form', { id: 'formId1', innerHTML: mail1 })
    );
    let options = {
      rules: {
    ...
    formObj = new FormValidator(htmlelement1, options);
    ...
    let mail2: string =
      ...
      '</div>';
    let htmlelement2: HTMLFormElement = <HTMLFormElement>(
      createElement('form', { id: 'formId2', innerHTML: mail2 })
    );
  ...
  it('Validate input element', (done) => {
    ...
    let element1: HTMLElement = <HTMLElement>(
      formObj.element.querySelector('[name="Email"]').nextSibling
    );
    ...
    let element2: HTMLElement = <HTMLElement>(
      formObj2.element.querySelector('[name="Email"]').nextSibling
    );
...
describe('Skip the error element to append in DOM using custom placement', () => {
  ...
  it('while validate input', () => {
    formObj.validate();
    expect(
      isNullOrUndefined(formObj.element.querySelector('label.e-error'))
    ).toBe(true);
  });
...
describe('Min and Max validation', () => {
  beforeAll(() => {
    formObj = new FormValidator(formElement, {
      rules: {
        input1: { date: 'dd/MMM/yy', min: '25/May/24', max: '28/May/24' },
      },
    });
  });
  ...
  it('date format support', () => {
    ...
    expect(errorElement.innerText).toEqual(
      'Please enter a value greater than or equal to 25/May/24.'
    );
    formObj.element[0].setAttribute('value', '29/May/24');
    formObj.validate('input1');
    expect(errorElement.innerText).toEqual(
      'Please enter a value less than or equal to 28/May/24.'
    );
