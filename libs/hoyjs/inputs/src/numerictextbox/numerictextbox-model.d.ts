import { Component, EventHandler, Property, Event, Browser, L10n, EmitType, getUniqueID } from '@hoyui/base';import { NotifyPropertyChanges, INotifyPropertyChanged, BaseEventArgs } from '@hoyui/base';import { attributes, addClass, removeClass, detach, closest } from '@hoyui/base';import { isNullOrUndefined, getValue, formatUnit, setValue, merge } from '@hoyui/base';import { Internationalization, NumberFormatOptions, getNumericObject } from '@hoyui/base';import { Input, InputObject, FloatLabelType } from '../input/input';
