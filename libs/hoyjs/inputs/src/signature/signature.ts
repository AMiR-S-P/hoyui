import { Event, EmitType, INotifyPropertyChanged } from '@hoyui/base';
import { NotifyPropertyChanges, Property, addClass } from '@hoyui/base';
import {
  SignatureBase,
  SignatureBeforeSaveEventArgs,
  SignatureChangeEventArgs,
} from '../common/signature-base';
...
export class Signature extends SignatureBase implements INotifyPropertyChanged {
  ...
  public onPropertyChanged(
    newProp: SignatureModel,
    oldProp: SignatureModel
  ): void {
