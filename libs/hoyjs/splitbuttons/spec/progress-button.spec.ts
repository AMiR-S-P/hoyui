...
import { IconPosition } from '@hoyui/buttons';
...
describe('Progress Button', () => {
  ...
  it('Progress and Spinner', () => {
    ...
    expect(
      ele.getElementsByClassName('e-btn-content')[0].childNodes[0].classList
    ).toContain('e-btn-icon');
  });
  ...
  it('Hide Spinner', () => {
    ...
    document.body.appendChild(ele);
    new ProgressButton(
      { content: 'Progress', cssClass: 'e-hide-spinner' },
      '#progressbtn3'
    );
  ...
  it('Spinner Only', () => {
    ...
    setTimeout(() => {
      expect(
        ele.getElementsByClassName('e-spinner-pane')[0].classList
      ).toContain('e-spin-hide');
  ...
  it('Progress methods', () => {
    ...
    document.body.appendChild(ele);
    const button: ProgressButton = new ProgressButton(
      {
        content: 'Progress',
        enableProgress: true,
        duration: 1000,
  ...
  it('Progress percent', () => {
    ...
    new ProgressButton(
      { duration: 1000, enableProgress: true, begin: begin, end: end },
      '#progressbtn8'
    );
    ele.click();
    jasmine.clock().tick(10000);
  ...
  it('Progress stop', () => {
    ...
    document.body.appendChild(ele);
    const button: any = new ProgressButton(
      { content: 'Progress', enableProgress: true, duration: 1000 },
      '#progressbtn9'
    );
    button.start(10);
  ...
  it('content property change', () => {
    ...
    document.body.appendChild(ele);
    const button: ProgressButton = new ProgressButton(
      { content: 'Progress', enableProgress: true },
      '#progressbtn10'
    );
    ...
    expect(ele.getElementsByClassName('e-btn-content')[0].textContent).toBe(
      'Progress2'
    );
    expect(
      ele.getElementsByClassName('e-btn-content')[0].childNodes[0].classList
    ...
    button.dataBind();
    expect(
      ele.getElementsByClassName('e-btn-content')[0].childNodes[1].classList
    ).toContain('e-btn-icon');
  ...
  it('destroy method', () => {
    ...
    document.body.appendChild(ele);
    let button: any = new ProgressButton(
      { content: 'Progress', enableProgress: true },
      '#progressbtn11'
    );
    button.destroy();
    ...
    button = new ProgressButton(
      { cssClass: 'e-hide-spinner', enableProgress: true },
      '#progressbtn11'
    );
    button.destroy();
    expect(ele.innerHTML).toBe('');
  ...
  it('Spin Position', () => {
    ...
    document.body.appendChild(ele);
    let button: any = new ProgressButton(
      { content: 'Spin Right', spinSettings: { position: 'Right' } },
      '#progressbtn13'
    );
    expect(ele.childNodes[1].classList).toContain('e-spinner');
    button.destroy();
    button = new ProgressButton(
      { content: 'Spin Top', spinSettings: { position: 'Top' } },
      '#progressbtn13'
    );
    expect(ele.childNodes[0].classList).toContain('e-spinner');
    button.destroy();
    button = new ProgressButton(
      { content: 'Spin bottom', spinSettings: { position: 'Bottom' } },
      '#progressbtn13'
    );
    expect(ele.childNodes[1].classList).toContain('e-spinner');
  });
  ...
  it('Animation settings - SlideLeft', () => {
    ...
    new ProgressButton(
      {
        ...
        animationSettings: { effect: 'SlideLeft', duration: 400 },
      },
      '#progressbtn14'
    );
    ele.click();
    setTimeout(() => {
      expect(
        ele.getElementsByClassName('e-btn-content')[0].classList
      ).not.toContain('e-cont-animate');
    }, 2000);
    jasmine.clock().tick(20000);
  });
  ...
  it('Animation settings - Center', () => {
    ...
    ele.click();
    expect(ele.getElementsByClassName('e-btn-content')[0].classList).toContain(
      'e-cont-animate'
    );
    jasmine.clock().tick(50000);
    setTimeout(() => {
  ...
  it('Enable Html Sanitizer', () => {
    new ProgressButton(
      { content: 'Progress<style>body{background:rgb(0, 0, 255)}</style>' },
      '#progressbtn17'
    );
  ...
  it('Progress Complete', () => {
    ...
    document.body.appendChild(ele);
    const button: any = new ProgressButton(
      { content: 'ProgressComplete', enableProgress: true, duration: 1000 },
      '#progressbtn9'
    );
    button.start(50);
    button.stop();
  ...
  describe('Null or undefined Property testing', () => {
    ...
    it('ProgressButton with animationSettings', () => {
      ...
      document.body.appendChild(ele);
      let button: any = new ProgressButton(
        { animationSettings: { duration: null, effect: null } },
        '#progressbtn21'
      );
      ...
      button.destroy();
      button = new ProgressButton(
        { animationSettings: { duration: undefined, effect: undefined } },
        '#progressbtn21'
      );
    ...
    it('ProgressButton with spinSettings', () => {
      ...
      document.body.appendChild(ele);
      let button: any = new ProgressButton(
        { spinSettings: { position: null } },
        '#progressbtn25'
      );
      expect(button.spinSettings.position).toEqual(null);
      button.destroy();
      button = new ProgressButton(
        { spinSettings: { position: undefined } },
        '#progressbtn25'
      );
