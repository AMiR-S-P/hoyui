...
import { actionComplete, SaveEventArgs, ActionEventArgs } from '@hoyui/grids';
      ...
      actionComplete = (args?: Object): void => {
        ...
        expect(
          gridObj
            .getRows()[1]
            .getElementsByClassName('e-rowcell')[1]
            .querySelector('div>.e-treecell').innerHTML === 'Plan timeline'
        ).toBe(true);
        done();
      };
    ...
    actionComplete = (args?: Object): void => {
      ...
      expect(
        gridObj
          .getRows()[0]
          .getElementsByClassName('e-rowcell')[1]
          .querySelector('div>.e-treecell').innerHTML === 'Develop prototype'
      ).toBe(true);
      expect(
        gridObj
          .getRows()[1]
          .getElementsByClassName('e-rowcell')[1]
          .querySelector('div>.e-treecell').innerHTML === 'Development Task 1'
      ).toBe(true);
      done();
    };
    gridObj.grid.actionComplete = actionComplete;
    ...
    actionComplete = (args?: Object): void => {
      ...
      expect(
        gridObj
          .getRows()[1]
          .getElementsByClassName('e-rowcell')[1]
          .querySelector('div>.e-treecell').innerHTML ===
    ...
    actionComplete = (args?: Object): void => {
      ...
      expect(
        gridObj
          .getRows()[0]
          .getElementsByClassName('e-rowcell')[1]
          .querySelector('div>.e-treecell').innerHTML === 'Implementation Phase'
      ).toBe(true);
      expect(
        gridObj
          .getRows()[1]
          .getElementsByClassName('e-rowcell')[1]
          .querySelector('div>.e-treecell').innerHTML === 'Phase 1'
      ).toBe(true);
      expect(
        isNullOrUndefined(
          gridObj
    ...
    actionComplete = (args?: Object): void => {
      ...
      expect(
        gridObj
          .getRows()[1]
          .getElementsByClassName('e-rowcell')[1]
          .querySelector('div>.e-treecell').innerHTML === 'Plan budget'
      ).toBe(true);
      done();
    };
    ...
    actionComplete = (args?: Object): void => {
      expect(
        gridObj
          .getRows()[0]
          .getElementsByClassName('e-rowcell')[1]
          .querySelector('.e-treecolumn-container')
          .getAttribute('style') === 'padding-left:0px'
      );
      expect(
        gridObj
          .getRows()[1]
          .getElementsByClassName('e-rowcell')[1]
          .querySelector('.e-treecolumn-container')
          .getAttribute('style') === 'padding-left:25px'
      );
      expect(
        gridObj
          .getRows()[4]
    ...
    actionComplete = (args?: Object): void => {
      ...
      expect(
        gridObj
          ...
          .getElementsByClassName('e-rowcell')[1]
          .querySelector('.e-treecolumn-container')
          .getAttribute('style') === 'padding-left:75px'
      );
      done();
    };
    gridObj.grid.actionComplete = actionComplete;
...
describe('Filtering Propertychange', () => {
  ...
  it('allowFiltering and filterSettings using onproperty', (done: Function) => {
    actionComplete = (args?: Object) => {
      expect(
        document.getElementsByClassName('e-filterbarcell').length > 0
      ).toBe(true);
      done();
    };
    gridObj.grid.actionComplete = actionComplete;
...
describe('Excel Filter Type Testing - Parent', () => {
  ...
  it('Check the count of checkboxes in excel filter ', (done: Function) => {
    actionComplete = (args?: Object): void => {
      expect(
        document.getElementsByClassName('e-label e-checkboxfiltertext')
          .length === 27
      ).toBe(true);
      done();
    };
    ...
    actionComplete = (args: CellSaveEventArgs): void => {
      expect(
        gridObj
          .getRows()[2]
          .getElementsByClassName('e-rowcell')[1]
          .querySelectorAll('.e-treecolumn-container')[0].childNodes.length ===
          5
      ).toBe(true);
      done();
    };
      ...
      if (args.action === 'clear-filter') {
        ...
        expect(
          gridObj
            .getRows()[2]
            .getElementsByClassName('e-rowcell')[1]
            .querySelectorAll('.e-treecolumn-container')[0].childNodes
            .length === 4
        ).toBe(true);
        done();
      }
  ...
  it('Check the AND of custom filter- Mouseover', (done: Function) => {
    actionComplete = (args: CellSaveEventArgs): void => {
      if (args.requestType === 'filterchoicerequest') {
        expect(
          document
            .getElementsByClassName('e-excel-menu')[0]
            .querySelectorAll('.e-menu-item ').length === 10
        ).toBe(true);
        done();
      }
      if (args.requestType === 'filterafteropen') {
        (<HTMLElement>(
          document
            .getElementsByClassName('e-excel-menu')[0]
            .querySelector('.e-menu-item')
        )).click();
        const dd1Obj = (<any>document.getElementById('taskName-xlfl-frstoptr'))
          .ej2_instances[0];
        dd1Obj.value = 'contains';
        const act1Obj = (<any>(
          document.getElementById('taskName-xlfl-frstvalue')
        )).ej2_instances[0];
        act1Obj.value = 'software';
        const dd2Obj = (<any>document.getElementById('taskName-xlfl-secndoptr'))
          .ej2_instances[0];
        dd2Obj.value = 'contains';
        const act2Obj = (<any>(
          document.getElementById('taskName-xlfl-secndvalue')
        )).ej2_instances[0];
    ...
    (<HTMLElement>document.querySelectorAll('.e-filtermenudiv')[1]).click();
    document
      .getElementsByClassName('e-menu-item')[1]
  ...
  it('Check the OR of custom filter- Mouseover', (done: Function) => {
    actionComplete = (args: CellSaveEventArgs): void => {
      ...
      if (args.requestType === 'filterafteropen') {
        ...
        const predicate1Obj = (<any>(
          document.getElementById('taskNamee-xlfl-frstpredicate')
        )).ej2_instances[0];
        predicate1Obj.checked = false;
        const predicate2Obj = (<any>(
          document.getElementById('taskNamee-xlfl-secndpredicate')
        )).ej2_instances[0];
        predicate2Obj.checked = true;
        const ddObj = (<any>document.getElementById('taskName-xlfl-secndoptr'))
          .ej2_instances[0];
      ...
      if (args.requestType === 'filtering') {
        ...
        expect(
          gridObj
            .getRows()[2]
            .getElementsByClassName('e-rowcell')[1]
            .querySelector('div>.e-treecell').innerHTML === 'Design complete'
        ).toBe(true);
        done();
      }
    };
  ...
  it('Check the custom filter of excel filter', (done: Function) => {
    actionComplete = (args: CellSaveEventArgs): void => {
      ...
      if (args.requestType === 'filterafteropen') {
        ...
        const actObj = (<any>document.getElementById('taskName-xlfl-frstvalue'))
          .ej2_instances[0];
        actObj.value = 'design';
        const matchObj = (<any>document.getElementById('taskName-xlflmtcase'))
          .ej2_instances[0];
...
describe('Editing after filtering with summary rows', () => {
  ...
  it('Editing after filtering with summary rows- filtering', (done: Function) => {
    actionComplete = (args?: any): void => {
      if (args.requestType === 'filtering') {
        ...
        expect(gridObj.getRows()[4].classList.contains('e-summaryrow')).toBe(
          true
        );
        done();
      }
  ...
  it('Editing after filtering with summary rows- editing', () => {
    ...
    gridObj.grid.editModule.formObj.element.getElementsByTagName(
      'input'
    )[1].value = 'testing';
    actionComplete = (args?: any): void => {
      if (args.requestType === 'save') {
        ...
        expect(
          gridObj
            .getRows()[0]
            .getElementsByClassName('e-rowcell')[1]
            .querySelector('div>.e-treecell').innerHTML === 'testing'
        ).toBe(true);
        expect(
          gridObj
            .getRows()[1]
...
describe('Hierarchy Filter Mode Testing - Parent with Search Settings Mode as Both', () => {
  ...
  it('Hierarchy Filter Mode Testing - Parent with Search Settings Mode as Both', () => {
    actionComplete = (args: CellSaveEventArgs): void => {
      if (args.requestType === 'filterafteropen') {
        (<HTMLElement>(
          document.querySelectorAll('.e-excelfilter .e-check')[0]
        )).click();
        (<HTMLElement>(
          document.querySelectorAll('.e-excelfilter .e-uncheck')[1]
        )).click();
        expect(
          document.querySelectorAll('.e-excelfilter .e-check')[0]
            .textContent === ''
  ...
  it('Hierarchy Filter Mode Testing - Parent with Search Settings Mode as Both - result', () => {
    ...
    (<HTMLElement>(
      document
        .querySelector('.e-excelfilter .e-footer-content')
        .getElementsByClassName('e-primary')[0]
    )).click();
    gridObj.grid.actionComplete = actionComplete;
  });
  afterAll(() => {
...
describe('EJ2-51733: showCheckbox with filtering', () => {
    ...
    actionComplete = (args?: Object): void => {
      expect(
        gridObj
          .getRows()[0]
          .getElementsByClassName('e-rowcell')[1]
          .querySelector('div>.e-treecell').innerHTML === 'Allocate resources'
      ).toBe(true);
      done();
    };
    gridObj.grid.actionComplete = actionComplete;
  ...
  it('Check header checkbox', () => {
    ...
    expect((<ITreeData>gridObj.getCurrentViewRecords()[0]).checkboxState).toBe(
      'check'
    );
