 ...
 */
import { Browser, formatUnit } from '@hoyui/base';
...
import { BeforeCopyEventArgs } from '@hoyui/grids';
...
describe('TreeGrid clipboard copy testing - => ', () => {
  ...
  it('Check hidden clipboard textarea', () => {
    const clipArea: HTMLElement = gridObj.element.querySelectorAll(
      '.e-clipboard'
    )[0] as HTMLElement;
    expect(
