...
import { DataManager, Query, UrlAdaptor, ODataAdaptor } from '@hoyui/data';
import { createGrid, destroy } from './treegridutil.spec';
import { sampleData, projectDatas as data } from './datasource.spec';
import { PageEventArgs, RowDataBoundEventArgs, Grid } from '@hoyui/grids';
...
describe('DataSource onDemand', () => {
  ...
  describe('datamanager cell collapse', () => {
    ...
    it('promise test', (done: Function) => {
      ...
      gridObj.grid.currentViewData = [
        { taskID: 1, taskName: 'Planning', expanded: true },
        { taskID: 2, ParentID: 1, taskName: 'Plan timeline' },
      ...
      let args: RowDataBoundEventArgs = {
        data: { taskID: 2, ParentID: 1, taskName: 'Plan timeline' },
        row: row,
      };
