...
import { getObject, PdfExport as GridPdf, Grid, BeforeDataBoundArgs, PdfExportProperties} from '@hoyui/grids';
import { PdfQueryCellInfoEventArgs, PdfStyle } from '@hoyui/grids';
import { isRemoteData, isOffline } from '../utils';
import { isNullOrUndefined, setValue, Fetch, extend, getValue } from '@hoyui/base';
import { DataManager, Query, ReturnOption } from '@hoyui/data';
import * as event from '../base/constant';
import { PdfDocument } from '@hoyui/pdf-export';
/**
