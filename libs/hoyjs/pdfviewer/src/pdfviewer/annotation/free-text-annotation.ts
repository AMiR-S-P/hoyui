...
import { isBlazor, isNullOrUndefined, SanitizeHtmlHelper  } from '@hoyui/base';
...
export class FreeTextAnnotation {
    ...
    public saveFreeTextAnnotations(): string {
        let storeObject: string = window.sessionStorage.getItem(this.pdfViewerBase.documentId + '_annotations_freetext');
