import { Browser, createElement, initializeCSPTemplate } from '@hoyui/base';
import { cornersPointsBeforeRotation, DrawingElement, PointModel, Rect, TextAlign, splitArrayCollection, processPathData, randomId } from '@hoyui/drawings';
...
import { isNullOrUndefined, SanitizeHtmlHelper } from '@hoyui/base';
import { FormFieldModel, ItemModel } from '../pdfviewer-model';
import { Dialog, Tooltip } from '@hoyui/popups';
import { Tab } from '@hoyui/navigations';
import { DropDownButton} from '@hoyui/splitbuttons';
import { ColorPicker, Slider, TextBox, NumericTextBox } from '@hoyui/inputs';
...
import { PdfBitmap } from '@hoyui/pdf';
...
export class FormDesigner {
    ...
    public drawHTMLContent(formFieldAnnotationType: string, element: DiagramHtmlElement,
                           ...
                           commandHandler?: PdfViewer, fieldId?: string): HTMLElement {
    ...
    */
     ...
     * @returns {void}
     */
    public drawFormField(obj: PdfFormFieldBaseModel): HTMLElement {
        ...
        const HTMLElement: HTMLElement = this.drawHTMLContent(node.formFieldAnnotationType, node.wrapper.children[0] as DiagramHtmlElement,
                                                              node, obj.pageNumber - 1, this.pdfViewer);
        return HTMLElement;
    }
