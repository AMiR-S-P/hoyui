...
require.config({
  ...
  packages: [
    ...
    {
      name: '@hoyui/pdf',
      location: 'node_modules/@hoyui/pdf/dist',
    ...
    {
      name: '@hoyui/drawings',
      location: 'node_modules/@hoyui/drawings/dist',
      main: 'ej2-drawings.umd.min.js'
    },
    {
      name: '@hoyui/inplace-editor',
      location: 'node_modules/@hoyui/inplace-editor/dist',
    ...
    {
      name: '@hoyui/richtexteditor',
      location: 'node_modules/@hoyui/richtexteditor/dist',
      main: 'ej2-richtexteditor.umd.min.js'
    },
    {
      name: '@hoyui/filemanager',
      location: 'node_modules/@hoyui/filemanager/dist',
      main: 'ej2-filemanager.umd.min.js'
    },
    {
      name: '@hoyui/layouts',
      location: 'node_modules/@hoyui/layouts/dist',
      main: 'ej2-layouts.umd.min.js'
    },
    {
      name: '@hoyui/grids',
      location: 'node_modules/@hoyui/grids/dist',
