...
import { getScrollableParent } from '@hoyui/popups';
...
describe('ContextMenu', () => {
  ...
  const filterDiv: HTMLElement = createElement('div', {
  ...
  describe('DOM', () => {
    ...
    it('Template Checking', () => {
      ...
      expect(contextMenu.element.classList.contains('e-contextmenu')).toBe(
        true
      );
  ...
  describe('Property', () => {
    ...
    it('cssClass Checking', () => {
      ...
      contextMenu = new ContextMenu(
        { items: items, target: '#target', cssClass: 'e-custom' },
        '#contextmenu'
      );
    ...
    it('RTL Checking', () => {
      ...
      document.body.appendChild(ul);
      contextMenu = new ContextMenu(
        { items: items, target: '#target', enableRtl: true },
        '#contextmenu'
      );
      const wrap: HTMLElement = contextMenu.getWrapper();
    ...
    it('showItemOnClick Checking', () => {
      ...
      document.body.appendChild(ul);
      contextMenu = new ContextMenu(
        { items: items, target: '#target', showItemOnClick: true },
        '#contextmenu'
      );
      let contextmenu: any = getEventObject('MouseEvents', 'contextmenu');
      contextmenu = setMouseCoordinates(contextmenu, 5, 5, select('#target'));
    ...
    it('IconCss as empty string Checking', () => {
      ...
      const items: MenuItemModel[] = [
        { text: 'Cut', iconCss: '' },
        { text: 'Copy', iconCss: 'e-cut' },
        { text: 'Paste', iconCss: 'e-cut' },
      ];
      contextMenu = new ContextMenu(
        { items: items, target: '#target' },
        '#contextmenu'
    ...
    it('Filter checking', () => {
      ...
      document.body.appendChild(ul);
      contextMenu = new ContextMenu(
        { target: '#target', items: items, filter: 'e-list-item' },
        '#contextmenu'
      );
      let contextmenu: any = getEventObject('MouseEvents', 'contextmenu');
      contextmenu = setMouseCoordinates(
        contextmenu,
        5,
        10,
        select('.e-list-item')
    ...
    it('Right click on non filter element', () => {
      const nonFilter: HTMLElement = createElement('div', {
        className: 'e-filter',
        styles: 'width: 100px;height: 100px',
      });
      div.appendChild(filterDiv);
      ...
      document.body.appendChild(ul);
      contextMenu = new ContextMenu(
        { target: '#target', items: items, filter: 'e-filter' },
        '#contextmenu'
      );
      let contextmenu: any = getEventObject('MouseEvents', 'contextmenu');
      contextmenu = setMouseCoordinates(
  ...
  describe('Mouse events', () => {
    ...
    it('Mouse Hover on sub items not having sub elements', () => {
      ...
      li = <Element[] & NodeListOf<HTMLLIElement>>(
        childUL.querySelectorAll('li')
      );
      mouseEventArgs.target = li[1];
      mouseEventArgs.type = 'mouseover';
      contextMenu.clickHandler(mouseEventArgs);
    ...
    it('Mouse click on li having child element', () => {
      ...
      document.body.appendChild(ul);
      contextMenu = new ContextMenu(
        { items: items, showItemOnClick: true, target: '#target' },
        '#contextmenu'
      );
      let contextmenu: any = getEventObject('MouseEvents', 'contextmenu');
      contextmenu = setMouseCoordinates(contextmenu, 5, 5, select('#target'));
  ...
  describe('Public Methods Checking', () => {
    ...
    it('enableItems', () => {
      ...
      expect(
        contextMenu.element.children[3].classList.contains('e-disabled')
      ).toBe(true);
      ...
      expect(
        contextMenu.element.children[6].classList.contains('e-disabled')
      ).toBe(true);
    ...
    it('showItems', () => {
      ...
      let wrap: HTMLElement = contextMenu.getWrapper();
      expect(wrap.children[0].children[3].classList).not.toContain(
        'e-menu-hide'
      );
      contextMenu.showItems(['copy-id'], true);
      wrap = contextMenu.getWrapper();
      expect(wrap.children[0].children[6].classList).not.toContain(
        'e-menu-hide'
      );
    });
    it('removeItems', () => {
      ...
      expect(
        contextMenu.getWrapper().children[0].children[3].textContent
      ).not.toContain('Copy');
      contextMenu.removeItems(['copy-id'], true);
      expect(
        contextMenu.getWrapper().children[0].children[4].textContent
      ).not.toContain('Copy');
      let contextmenu: any = getEventObject('MouseEvents', 'contextmenu');
      contextmenu = setMouseCoordinates(contextmenu, 5, 5, select('#target'));
      EventHandler.trigger(div, 'contextmenu', contextmenu);
    ...
    it('insertAfter', () => {
      ...
      expect(
        contextMenu.getWrapper().children[0].children[9].textContent
      ).toContain('Enable1');
    });
    ...
    it('insertBefore', () => {
      ...
      expect(
        contextMenu.getWrapper().children[0].children[8].textContent
      ).toContain('Disable1');
    });
  ...
  describe('notify property changes of', () => {
    ...
    it('RTL', () => {
      ...
      document.body.appendChild(ul);
      contextMenu = new ContextMenu(
        { items: items, target: '#target', enableRtl: false },
        '#contextmenu'
      );
  ...
  describe('Keyboard actions', () => {
    ...
    it('down arrow action with last element selected', () => {
      ...
      contextMenu.keyBoardHandler(downEventArgs);
      expect(
        contextMenu.element.firstElementChild.classList.contains('e-focused')
      ).toBe(true);
    });
    ...
    it('up arrow action with first element selected', () => {
      ...
      contextMenu.keyBoardHandler(upEventArgs);
      expect(
        contextMenu.element.lastElementChild.classList.contains('e-focused')
      ).toBe(true);
    });
  ...
  describe('Methods Checking', () => {
    ...
    it('Prerender Checking', () => {
      ...
      document.body.appendChild(
        createElement('EJS-CONTEXTMENU', { id: 'contextmenu' })
      );
      contextMenu = new ContextMenu(options, '#contextmenu');
      expect(contextMenu.element.parentElement.tagName).toEqual('DIV');
      expect(
        contextMenu.element.parentElement.classList.contains(
          'e-contextmenu-wrapper'
        )
      ).toEqual(true);
    });
    it('Get scrollable parents Checking', () => {
      const targetElement: HTMLElement = createElement('div', {
        id: 'target2',
      });
      ...
      document.body.appendChild(ul);
      contextMenu = new ContextMenu(options, '#contextmenu');
      const parents: HTMLElement[] = getScrollableParent(
  ...
  describe('Null or undefined Property testing', () => {
    ...
    it('ContextMenu with animationSettings', () => {
      ...
      document.body.appendChild(ul);
      contextMenu = new ContextMenu(
        { animationSettings: { duration: null, easing: null, effect: null } },
        '#contextmenu'
      );
      contextMenu.dataBind();
