...
describe('Breadcrumb', () => {
  ...
  const sTag: HTMLElement = createElement('script', {
    id: 'menuTemplate',
  ...
  describe('DOM', () => {
    ...
    it('Architecture Checking', () => {
      ...
      expect(breadcrumb.element.classList.contains('e-breadcrumb')).toEqual(
        true
      );
  ...
  describe('Property', () => {
    ...
    it('activeItem Checking', () => {
      document.body.appendChild(nav);
      breadcrumb = new Breadcrumb(
        { items: items, activeItem: 'Demos' },
        '#breadcrumb'
      );
      expect(
        breadcrumb.element.firstChild.querySelectorAll('.e-breadcrumb-item')
          .length
      ).toEqual(3);
    });
    ...
    it('enableActiveItemNavigation Checking', () => {
      document.body.appendChild(nav);
      breadcrumb = new Breadcrumb(
        { items: items, enableActiveItemNavigation: true },
        '#breadcrumb'
      );
    });
    it('enableNavigation Checking', () => {
      document.body.appendChild(nav);
      breadcrumb = new Breadcrumb(
        { items: items, enableNavigation: false },
        '#breadcrumb'
      );
      ...
      breadcrumb = new Breadcrumb(
        {
          items: items,
          itemTemplate:
            '<div id="chip-default" class="e-lib e-chip-list e-control e-chip-set" role="listbox" aria-multiselectable="false"><div class="e-chip e-primary" tabindex="0" role="option" aria-label="Apple" aria-selected="false"><span class="e-chip-text">${text}</span></div></div>',
        },
        '#breadcrumb'
      );
    });
    it('maxItems Checking', () => {
      document.body.appendChild(nav);
      breadcrumb = new Breadcrumb(
        { items: overflowItems, maxItems: 2 },
        '#breadcrumb'
      );
    ...
    it('overflow Collapsed mode Checking', () => {
      document.body.appendChild(nav);
      breadcrumb = new Breadcrumb(
        { items: overflowItems, maxItems: 3, overflowMode: 'Collapsed' },
        '#breadcrumb'
      );
      let element: HTMLElement = breadcrumb.element.querySelector(
        '.e-breadcrumb-collapsed'
      );
      expect(element.classList.contains('e-breadcrumb-collapsed')).toEqual(
        true
      );
    });
    it('overflow Menu mode Checking', () => {
      document.body.appendChild(nav);
      breadcrumb = new Breadcrumb(
        { items: overflowItems, maxItems: 3, overflowMode: 'Menu' },
        '#breadcrumb'
      );
      let element: HTMLElement =
        breadcrumb.element.querySelector('.e-breadcrumb-menu');
      expect(element.classList.contains('e-breadcrumb-menu')).toEqual(true);
    });
    it('overflow Wrap mode Checking', () => {
      document.body.appendChild(nav);
      breadcrumb = new Breadcrumb(
        { items: overflowItems, maxItems: 3, overflowMode: 'Wrap' },
        '#breadcrumb'
      );
      expect(
        breadcrumb.element.classList.contains('e-breadcrumb-wrap-mode')
      ).toEqual(true);
    });
    it('overflow Scroll mode Checking', () => {
      document.body.appendChild(nav);
      breadcrumb = new Breadcrumb(
        { items: overflowItems, maxItems: 3, overflowMode: 'Scroll' },
        '#breadcrumb'
      );
      expect(
        breadcrumb.element.classList.contains('e-breadcrumb-scroll-mode')
      ).toEqual(true);
    });
    it('overflow Hidden mode Checking', () => {
      document.body.appendChild(nav);
      breadcrumb = new Breadcrumb(
        { items: overflowItems, maxItems: 3, overflowMode: 'Hidden' },
        '#breadcrumb'
      );
      let element: any = breadcrumb.element.querySelectorAll(
        '.e-breadcrumb-item.e-navigable'
      );
      ...
      breadcrumb = new Breadcrumb(
        {
          ...
          created: () => {
            expect(
              breadcrumb.element.classList.contains('e-breadcrumb')
            ).toEqual(true);
          },
        },
        '#breadcrumb'
      ...
      breadcrumb = new Breadcrumb(
        {
          ...
          beforeItemRender: (args: BreadcrumbBeforeItemRenderEventArgs) => {
            if (
              args.item.text === 'Local Disk' ||
              ((args.item as any).nextItem &&
                (args.item as any).nextItem.text === 'Local Disk')
            ) {
              args.element.classList.add('e-icon-right');
            } else if (
              args.item.text === 'User' ||
              ((args.item as any).nextItem &&
                (args.item as any).nextItem.text === 'User')
            ) {
              args.element.classList.add('e-disabled');
              args.item.disabled = true;
            } else if (
              args.item.text === 'Pictures' ||
              ((args.item as any).nextItem &&
                (args.item as any).nextItem.text === 'Pictures')
            ) {
              args.item.iconCss = '';
              args.item.url = '/pic';
              args.item.text = 'pic';
  ...
  describe('notify property changes of', () => {
    ...
    it('disabled Checking', () => {
      ...
      breadcrumb.dataBind();
      expect(breadcrumb.element.classList.contains('e-disabled')).toEqual(
        false
      );
    });
  ...
  describe('Click actions', () => {
      ...
      breadcrumb = new Breadcrumb(
        {
          ...
          beforeItemRender: (args: BreadcrumbBeforeItemRenderEventArgs) => {
            if (
              args.item.text === 'Getting' ||
              ((args.item as any).nextItem &&
                (args.item as any).nextItem.text === 'Getting')
            ) {
              args.item.iconCss = 'e-getting';
            } else if (
              args.item.text === 'Icons' ||
              ((args.item as any).nextItem &&
                (args.item as any).nextItem.text === 'Icons')
            ) {
              args.item.text = 'Iconing';
            } else if (
              args.item.text === 'Navigation' ||
              ((args.item as any).nextItem &&
                (args.item as any).nextItem.text === 'Navigation')
            ) {
              args.item.text = 'e-navigate';
            } else if (
              args.item.text === 'templates' ||
              ((args.item as any).nextItem &&
                (args.item as any).nextItem.text === 'templates')
            ) {
              args.item.url = '/pic';
            }
          },
    ...
    it('document click action', () => {
      document.body.appendChild(nav);
      breadcrumb = new Breadcrumb(
        { items: overflowItems, maxItems: 2, overflowMode: 'Menu' },
        '#breadcrumb'
      );
  ...
  describe('null or undefined property testing', () => {
    ...
    it('cssClass', () => {
      ...
      document.body.appendChild(nav);
      breadcrumb = new Breadcrumb(
        { items: items, cssClass: null },
        '#breadcrumb'
      );
      expect(breadcrumb.cssClass).toEqual(null);
      breadcrumb = new Breadcrumb(
        { items: items, cssClass: undefined },
        '#breadcrumb'
      );
    ...
    it('activeItem', () => {
      ...
      document.body.appendChild(nav);
      breadcrumb = new Breadcrumb(
        { items: items, activeItem: null },
        '#breadcrumb'
      );
      expect(breadcrumb.activeItem).toEqual(null);
      breadcrumb = new Breadcrumb(
        { items: items, activeItem: undefined },
        '#breadcrumb'
      );
    ...
    it('disabled', () => {
      ...
      document.body.appendChild(nav);
      breadcrumb = new Breadcrumb(
        { items: items, disabled: null },
        '#breadcrumb'
      );
      expect(breadcrumb.disabled).toEqual(null);
      breadcrumb = new Breadcrumb(
        { items: items, disabled: undefined },
        '#breadcrumb'
      );
    ...
    it('enableActiveItemNavigation', () => {
      ...
      document.body.appendChild(nav);
      breadcrumb = new Breadcrumb(
        { items: items, enableActiveItemNavigation: null },
        '#breadcrumb'
      );
      expect(breadcrumb.enableActiveItemNavigation).toEqual(null);
      breadcrumb = new Breadcrumb(
        { items: items, enableActiveItemNavigation: undefined },
        '#breadcrumb'
      );
    ...
    it('enableNavigation', () => {
      ...
      document.body.appendChild(nav);
      breadcrumb = new Breadcrumb(
        { items: items, enableNavigation: null },
        '#breadcrumb'
      );
      expect(breadcrumb.enableNavigation).toEqual(null);
      breadcrumb = new Breadcrumb(
        { items: items, enableNavigation: undefined },
        '#breadcrumb'
      );
    ...
    it('enablePersistence', () => {
      ...
      document.body.appendChild(nav);
      breadcrumb = new Breadcrumb(
        { items: items, enablePersistence: null },
        '#breadcrumb'
      );
      expect(breadcrumb.enablePersistence).toEqual(null);
      breadcrumb = new Breadcrumb(
        { items: items, enablePersistence: undefined },
        '#breadcrumb'
      );
    ...
    it('enableRtl', () => {
      ...
      document.body.appendChild(nav);
      breadcrumb = new Breadcrumb(
        { items: items, enableRtl: null },
        '#breadcrumb'
      );
      expect(breadcrumb.enableRtl).toEqual(false);
      breadcrumb = new Breadcrumb(
        { items: items, enableRtl: undefined },
        '#breadcrumb'
      );
      expect(breadcrumb.enableRtl).toEqual(false);
    });
    ...
    it('itemTemplate', () => {
      ...
      document.body.appendChild(nav);
      breadcrumb = new Breadcrumb(
        { items: items, itemTemplate: null },
        '#breadcrumb'
      );
      expect(breadcrumb.itemTemplate).toEqual(null);
      breadcrumb = new Breadcrumb(
        { items: items, itemTemplate: undefined },
        '#breadcrumb'
      );
      expect(breadcrumb.itemTemplate).toEqual(null);
    });
    ...
    it('maxItems', () => {
      ...
      document.body.appendChild(nav);
      breadcrumb = new Breadcrumb(
        { items: [{ text: null }, { url: null }], maxItems: null },
        '#breadcrumb'
      );
      expect(breadcrumb.maxItems).toEqual(null);
      breadcrumb = new Breadcrumb(
        { items: items, maxItems: undefined },
        '#breadcrumb'
      );
    ...
    it('overflowMode', () => {
      ...
      document.body.appendChild(nav);
      breadcrumb = new Breadcrumb(
        { items: items, overflowMode: null },
        '#breadcrumb'
      );
      expect(breadcrumb.overflowMode).toEqual(null);
      breadcrumb = new Breadcrumb(
        { items: items, overflowMode: undefined },
        '#breadcrumb'
      );
    ...
    it('separatorTemplate', () => {
      ...
      document.body.appendChild(nav);
      breadcrumb = new Breadcrumb(
        { items: items, separatorTemplate: null },
        '#breadcrumb'
      );
      expect(breadcrumb.separatorTemplate).toEqual(null);
      breadcrumb = new Breadcrumb(
        { items: items, separatorTemplate: undefined },
        '#breadcrumb'
      );
