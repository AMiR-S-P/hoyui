...
import {
  ...
  StepLabelPosition,
  StepType,
} from '../src/stepper/index';
import {
  StepModel,
  StepperBase,
  StepperOrientation,
} from '../src/stepper-base/index';
...
describe('Stepper', () => {
  ...
  describe('DOM', () => {
    ...
    it('Default stepper testing', () => {
      ...
      expect(stepperElement.classList.contains('.e-stepper') != null).toEqual(
        true
      );
      expect(
        stepperElement.classList.contains('.e-horizontal') != null
      ).toEqual(true);
      expect(stepperElement.querySelector('.e-stepper-steps') != null).toEqual(
        true
      );
      expect(stepperElement.querySelectorAll('.e-step-container').length).toBe(
        4
      );
      expect(stepperElement.querySelectorAll('.e-step').length).toBe(4);
      expect(stepperElement.querySelectorAll('.e-step-inprogress').length).toBe(
        1
      );
      expect(stepperElement.querySelectorAll('.e-step-selected').length).toBe(
        1
      );
      expect(stepperElement.querySelectorAll('.e-step-notstarted').length).toBe(
        3
      );
      expect(stepperElement.querySelectorAll('.e-step-completed').length).toBe(
        0
      );
      const liElementArray: any =
        stepperElement.querySelectorAll('.e-step-container');
    ...
    it('Generic nav Element ID generation', () => {
      ...
      expect(
        stepperEle1.getAttribute('id') != stepperElement.getAttribute('id')
      ).toEqual(true);
  ...
  describe('DOM Properties', () => {
    ...
    it('Disabled', () => {
      ...
      stepper.appendTo('#stepper');
      expect(stepperElement.querySelector('.e-step-disabled') != null).toEqual(
        true
      );
    ...
    it('Read Only', () => {
      ...
      stepper.appendTo('#stepper');
      expect(stepperElement.classList.contains('e-stepper-readonly')).toEqual(
        true
      );
    ...
    it('step with cssClass', () => {
      ...
      stepper.appendTo('#stepper');
      expect(
        stepperElement.querySelector('.e-step-container').classList
      ).toContain('testClass');
    });
    ...
    it('stepper with template support', () => {
      ...
      expect(
        stepperElement.querySelectorAll('.e-step-text-container').length
      ).toBe(0);
    ...
    it('stepper Template as js renderer ', () => {
      ...
      const renderer = createElement('script', {
        id: 'stepTemp',
        innerHTML: template,
      });
      ...
      const liElementArray: any =
        stepperElement.querySelectorAll('.e-step-container');
      expect(
        stepperElement.querySelector('.e-step-container').firstElementChild
          .classList
      ).toContain('tempContent');
      expect((liElementArray[0] as HTMLElement).innerText).toEqual('Step 0');
      expect((liElementArray[1] as HTMLElement).innerText).toEqual('Step 1');
      expect((liElementArray[2] as HTMLElement).innerText).toEqual('Step 2');
      expect((liElementArray[3] as HTMLElement).innerText).toEqual('Step 3');
    ...
    it('default stepper indicator type with valid properties', () => {
      ...
      stepper.appendTo('#stepper');
      expect(stepperElement.classList.contains('e-step-type-indicator')).toBe(
        true
      );
      expect(stepperElement.querySelectorAll('.e-step-container').length).toBe(
        4
    ...
    it('Default Indicator Type', () => {
      ...
      expect(
        stepperElement.querySelectorAll('.e-step-label-container').length
      ).toBe(0);
      expect(stepperElement.querySelectorAll('.e-step-indicator').length).toBe(
        4
      );
    ...
    it('Label Position', () => {
      ...
      stepper.appendTo('#stepper');
      expect(
        stepperElement.querySelector('.e-step-label-container').classList
      ).toContain('e-label-after');
      stepper.labelPosition = 'Top';
      stepper.dataBind();
      expect(
        stepperElement.querySelector('.e-step-label-container').classList
      ).toContain('e-label-before');
    });
    ...
    it('stepper with text only with validation', () => {
      ...
      const liElementArray: any =
        stepperElement.querySelectorAll('.e-step-container');
      expect(
        (liElementArray[1] as HTMLElement).classList.contains('e-step-valid')
      ).toEqual(true);
      expect(
        (liElementArray[2] as HTMLElement).classList.contains('e-step-error')
      ).toEqual(true);
      expect(stepperElement.querySelectorAll('.e-check').length).toBe(1);
      expect(stepperElement.querySelectorAll('.e-circle-info').length).toBe(1);
      stepper.activeStep = 1;
      ...
      expect(
        (
          liElementArray[1].querySelector('.e-indicator') as HTMLElement
      ...
      expect(
        (
          liElementArray[2].querySelector('.e-indicator') as HTMLElement
        ).classList.contains('e-circle-info')
      ).toEqual(true);
    ...
    it('stepper with label only with validation', () => {
      ...
      expect(
        (
          liElementArray[1].querySelector(
            '.e-step-validation-icon'
          ) as HTMLElement
        ).classList.contains('e-circle-check')
      ).toEqual(true);
      stepper.activeStep = 2;
      stepper.dataBind();
      expect(
      ...
      expect(
        (
          liElementArray[2].querySelector(
            '.e-step-validation-icon'
          ) as HTMLElement
        ).classList.contains('e-circle-info')
      ).toEqual(true);
    ...
    it('stepper with optional and valid support', () => {
      ...
      expect(
        stepperElement.querySelectorAll('.e-step-label-optional').length
      ).toBe(1);
      expect(stepperElement.querySelectorAll('.e-check').length).toBe(1);
      expect(stepperElement.querySelectorAll('.e-circle-info').length).toBe(1);
      stepper.activeStep = 1;
    ...
    it('stepper icon with default label position', () => {
      ...
      expect(
        stepperElement
          .querySelector('.e-stepper-steps')
          .querySelectorAll('.e-label-after').length
      ).toBe(5);
    ...
    it('stepper icon with before label position', () => {
      ...
      expect(
        stepperElement
          .querySelector('.e-stepper-steps')
          .querySelectorAll('.e-label-before').length
      ).toBe(5);
    ...
    it('stepper text with start label position', () => {
      ...
      expect(
        stepperElement.classList.contains('.e-label-start') != null
      ).toEqual(true);
      expect(stepperElement.querySelector('.e-stepper-steps') != null).toEqual(
        true
      );
    ...
    it('stepper text with end label position', () => {
      ...
      expect(stepperElement.classList.contains('.e-label-end') != null).toEqual(
        true
      );
      expect(stepperElement.querySelector('.e-stepper-steps') != null).toEqual(
        true
    ...
    it('Vertical stepper rendering', () => {
      ...
      expect(
        stepperElement.classList.contains('.e-steps-vertical') != null
      ).toEqual(true);
      expect(stepperElement.querySelector('.e-stepper-steps') != null).toEqual(
        true
      );
    ...
    it('stepper text with default label position in vertical orientation', () => {
      ...
      expect(
        stepperElement
          .querySelector('.e-stepper-steps')
          .querySelectorAll('.e-label-bottom').length
      ).toBe(0);
      expect(stepperElement.querySelectorAll('.e-label-before').length).toBe(0);
      expect(
        stepperElement.querySelectorAll('.e-step-text-container').length
    ...
    it('stepper text with top label position in vertical orientation', () => {
      ...
      expect(stepperElement.classList.contains('.e-label-top') != null).toEqual(
        true
      );
      expect(stepperElement.querySelector('.e-stepper-steps') != null).toEqual(
        true
    ...
    it('Dynamic stepper orientation testing', () => {
      ...
      expect(stepperElement.classList.contains('.e-vertical') != null).toEqual(
        true
      );
    ...
    it('stepper with completed status', () => {
      ...
      const liElementArray: any =
        stepperElement.querySelectorAll('.e-step-container');
      expect(
        (liElementArray[2] as HTMLElement).classList.contains(
          'e-step-completed'
        )
      ).toEqual(true);
      expect(
        (liElementArray[3] as HTMLElement).classList.contains(
          'e-step-notstarted'
        )
      ).toEqual(true);
      expect(stepperElement.classList.contains('e-stepper')).toEqual(true);
    ...
    it('stepper with default tooltip', () => {
      ...
      stepper.appendTo('#stepper');
      expect(document.body.querySelector('.e-tooltip-wrap') == null).toEqual(
        true
      );
      const liElementArray: any =
        stepperElement.querySelectorAll('.e-step-container');
      ...
      expect(document.body.querySelector('.e-tip-content').innerHTML).toEqual(
        'Step 2'
      );
    ...
    it('stepper with tooltip template', () => {
      ...
      (stepper as any).tooltipObj.open(liElementArray[1]);
      expect(
        document.body.querySelector('.e-stepper-tooltip-content') != null
      ).toEqual(true);
      expect(
        document.body.querySelector('.e-stepper-tooltip-content').innerHTML
      ).toEqual('<span>testTemplate</span>');
    });
    ...
    it('Custom tooltip using cssClass', () => {
      ...
      const liElementArray: any =
        stepperElement.querySelectorAll('.e-step-container');
      (stepper as any).tooltipObj.animation = {
        open: { effect: 'None' },
        close: { effect: 'None' },
      };
      (stepper as any).tooltipObj.open(liElementArray[1]);
      expect(
        document.body
          .querySelector('.e-stepper-tooltip')
    ...
    it('Custom tooltip with icon & text configured type as indicator', () => {
      ...
      expect(
        document.body.querySelector(
          '.e-step-inprogress-tip.e-stepper-tooltip'
        ) != null
      ).toEqual(true);
      expect(document.body.querySelector('.e-tip-content').innerHTML).toEqual(
        'Step 1'
      ...
      EventHandler.trigger(liElementArray[2], 'mouseover');
      (stepper as any).tooltipObj.open(liElementArray[2]);
      expect(document.body.querySelector('.e-stepper-tooltip') != null).toEqual(
        true
      );
      expect(document.body.querySelector('.e-tip-content').innerHTML).toEqual(
        'Step 3'
    ...
    it('Custom tooltip with icon, text & cssClass', () => {
      ...
      (stepper as any).tooltipObj.open(liElementArray[0]);
      expect(
        document.body.querySelector('.e-stepper-tooltip.testClass') != null
      ).toEqual(true);
      expect(document.body.querySelector('.e-tip-content').innerHTML).toEqual(
        'Step 1'
      );
    ...
    it('Custom tooltip with icon, label & cssClass', () => {
      ...
      expect(
        document.body.querySelector(
          '.e-step-inprogress-tip.e-stepper-tooltip.testClass'
        ) != null
      ).toEqual(true);
      expect(document.body.querySelector('.e-tip-content').innerHTML).toEqual(
        'Step 1'
    ...
    it('stepper with Linear mode', () => {
      ...
      expect(
        (liElementArray[0] as HTMLElement).classList.contains(
          'e-step-inprogress'
        )
      ).toEqual(false);
      expect(
    ...
    it('stepper with Linear mode when activeStep is bounded', () => {
      ...
      const liElementArray: any =
        stepperElement.querySelectorAll('.e-step-container');
      expect(
        (liElementArray[0] as HTMLElement).classList.contains('e-previous')
      ).toEqual(false);
      expect(
        (liElementArray[1] as HTMLElement).classList.contains('e-previous')
      ).toEqual(true);
      expect(
        (liElementArray[2] as HTMLElement).classList.contains(
          'e-step-inprogress'
      ...
      expect(
        (liElementArray[3] as HTMLElement).classList.contains('e-next')
      ).toEqual(true);
      expect(
        (liElementArray[3] as HTMLElement).classList.contains(
          'e-step-notstarted'
      ...
      expect(
        (liElementArray[1] as HTMLElement).classList.contains('e-next')
      ).toEqual(true);
      expect(
        (liElementArray[1] as HTMLElement).classList.contains(
          'e-step-notstarted'
        )
      ).toEqual(true);
      expect(
        (liElementArray[2] as HTMLElement).classList.contains('e-next')
      ).toEqual(false);
      expect(
        (liElementArray[3] as HTMLElement).classList.contains('e-next')
      ).toEqual(false);
    ...
    it('stepper with Linear mode with step disabled', () => {
      ...
      expect(
        (liElementArray[2] as HTMLElement).classList.contains('e-step-disabled')
      ).toEqual(true);
      expect(
        (liElementArray[3] as HTMLElement).classList.contains('e-next')
      ).toEqual(false);
      ...
      expect(
        (liElementArray[2] as HTMLElement).classList.contains('e-previous')
      ).toEqual(true);
      expect(
        (liElementArray[3] as HTMLElement).classList.contains(
          'e-step-inprogress'
    ...
    describe('Methods and Events', () => {
      it('stepper with nextStep method', () => {
        ...
        expect(
          stepperElement.querySelector('.e-stepper-steps') != null
        ).toEqual(true);
        expect(
          stepperElement.querySelectorAll('.e-step-container').length
        ).toBe(5);
        expect(
          stepperElement.querySelectorAll('.e-step-inprogress').length
        ).toBe(1);
        expect(stepperElement.querySelectorAll('.e-step-selected').length).toBe(
          1
        );
        expect(
          stepperElement.querySelectorAll('.e-step-notstarted').length
        ).toBe(4);
        expect(
          stepperElement.querySelectorAll('.e-step-completed').length
        ).toBe(0);
        stepper.nextStep();
        expect(
          stepperElement.querySelectorAll('.e-step-completed').length
  ...
  describe('Keyboard Events', () => {
    ...
    it('Keyboard Combination with stepper horizontal mode', () => {
      ...
      const liElementArray: any =
        stepperElement.querySelectorAll('.e-step-container');
      expect(
        (liElementArray[0] as HTMLElement).classList.contains('e-step-selected')
      ).toEqual(true);
      expect(stepperElement.querySelectorAll('.e-step-notstarted').length).toBe(
        3
      );
      keyboardEventArgs.target =
        stepperElement.querySelector('.e-step-container');
      ...
      expect(
        (liElementArray[0] as HTMLElement).classList.contains('e-step-focus')
      ).toEqual(true);
      ...
      expect(
        (liElementArray[1] as HTMLElement).classList.contains('e-step-focus')
      ).toEqual(true);
      expect(stepperElement.querySelectorAll('.e-step-focus').length).toBe(1);
      expect(stepperElement.querySelectorAll('.e-step-notstarted').length).toBe(
        3
      ...
      (stepper as any).keyActionHandler(keyboardEventArgs);
      expect(
        (liElementArray[2] as HTMLElement).classList.contains('e-step-focus')
      ).toEqual(true);
      expect(stepperElement.querySelectorAll('.e-step-focus').length).toBe(1);
      expect(stepperElement.querySelectorAll('.e-step-notstarted').length).toBe(
        3
      ...
      (stepper as any).keyActionHandler(keyboardEventArgs);
      expect(
        (liElementArray[3] as HTMLElement).classList.contains('e-step-focus')
      ).toEqual(true);
      expect(stepperElement.querySelectorAll('.e-step-focus').length).toBe(1);
      expect(stepperElement.querySelectorAll('.e-step-notstarted').length).toBe(
        3
      ...
      expect(
        (liElementArray[3] as HTMLElement).classList.contains('e-step-selected')
      ).toEqual(true);
      keyboardEventArgs.action = 'leftarrow';
      (stepper as any).keyActionHandler(keyboardEventArgs);
      expect(
    ...
    it('Keyboard Interaction with stepper horizontal in rtl mode', () => {
      ...
      keyboardEventArgs.action = 'tab';
      (stepper as any).keyActionHandler(keyboardEventArgs);
      expect(liElementArray[2].classList.contains('e-step-focus')).toEqual(
        true
      );
      expect(stepperElement.querySelectorAll('.e-step-focus').length).toBe(1);
      expect(stepperElement.querySelectorAll('.e-step-notstarted').length).toBe(
      ...
      keyboardEventArgs.action = 'shiftTab';
      (stepper as any).keyActionHandler(keyboardEventArgs);
      expect(liElementArray[1].classList.contains('e-step-focus')).toEqual(
        true
      );
      expect(stepperElement.querySelectorAll('.e-step-focus').length).toBe(1);
      expect(stepperElement.querySelectorAll('.e-step-notstarted').length).toBe(
