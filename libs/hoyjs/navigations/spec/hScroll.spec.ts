...
describe('Horizontal scroll bar Base items', () => {
  ...
  let css: string =
    ' button {font-family:Arial; font-size: 14px; padding: 1px 6px;} .e-rtl { direction: rtl; } ';
  ...
  describe(' Horizontal scroll Base Testing', () => {
    ...
    beforeEach((): void => {
      ...
      ele.id = 'Sample';
      ele.innerHTML =
        "<div id= 'inneritems' style='display: inline-block;'><div id='item' style='display: inline-block;'><button> Btn_style</button></div><div id='item' style='display: inline-block;'><button> Btn_style</button></div><div id='item' style='display: inline-block;'><button> Btn_style</button></div>	</div>";
    ...
    it('Horizontal Touch test', () => {
      ...
      scroll = new HScroll({}, ele);
      expect(
        (<HTMLElement>ele.querySelector('.e-hscroll-content'))
          .childElementCount == 3
      ).toEqual(true);
    });
    it('Horizontal Touch test', () => {
  ...
  describe('Unique id testing', () => {
    ...
    beforeEach((): void => {
      ...
      ele.id = 'Sample';
      ele.innerHTML =
        "<div class= 'inneritems' style='display: inline-block;'><div id='item' style='display: inline-block;'><button> Btn_style</button></div><div id='item' style='display: inline-block;'><button> Btn_style</button></div><div id='item' style='display: inline-block;'><button> Btn_style</button></div></div>";
      setStyleAttribute(ele, { width: '50px', 'white-space': 'nowrap' });
      document.body.appendChild(ele);
    });
    afterEach((): void => {
    ...
    it('Unique id testing', () => {
      let ele: HTMLElement = document.getElementsByClassName(
        'inneritems'
      )[0] as HTMLElement;
      scroll = new HScroll({}, ele);
  ...
  describe(' RTL Testing', () => {
    ...
    beforeEach((): void => {
      ...
      ele.id = 'Sample';
      ele.innerHTML =
        "<div id= 'inneritems' style='display: inline-block;'><div id='item' style='display: inline-block;'><button> Stylllllle</button></div><div id='item' class='e-overlay' style='display: inline-block;'><button> Stylllllle</button></div><div id='item' class='e-overlay' style='display: inline-block;'><button> Stylllllle</button></div></div>";
      setStyleAttribute(ele, { width: '50px', 'white-space': 'nowrap' });
      document.body.appendChild(ele);
    });
    afterEach((): void => {
  ...
  describe('Key long press Testing', () => {
    ...
    it('Key long press Testing with contious moving', () => {
      let scroll: HTMLElement = <HTMLElement>(
        document.getElementById('inneritems').children[1]
      );
  ...
  describe(' Swipe Handling testing', () => {
    ...
    beforeEach((): void => {
      ...
      ele.id = 'Sample';
      ele.innerHTML =
        "<div id= 'inneritems' style='display: inline-block;'><div id='item' style='display: inline-block;'><button> Btn_style</button></div><div id='item' style='display: inline-block;'><button> Btn_style</button></div></div></div>";
      setStyleAttribute(ele, { width: '50px', 'white-space': 'nowrap' });
      document.body.appendChild(ele);
    });
    afterEach((): void => {
  ...
  describe('Device Testing', () => {
    ...
    it('Cross browser Device Arrow and overlay testing', () => {
      ...
      expect(scroll.element.children[0].classList.contains(CLS_OVERLAY)).toBe(
        true
      );
      expect(scroll.element.children[2].classList.contains(CLS_OVERLAY)).toBe(
        true
      );
      expect(
        scroll.element.children[2].classList.contains(CLS_RIGHTOVERLAY)
      ).toBe(true);
      expect(
        scroll.element.children[0].classList.contains(CLS_LEFTOVERLAY)
      ).toBe(true);
