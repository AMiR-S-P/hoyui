 ...
 */
import { ScrollEventArgs, TouchEventArgs, Browser } from '@hoyui/base';
import {
  createElement,
  isVisible,
  setStyleAttribute,
...
describe('Toolbar Control', () => {
  ...
  describe('Main Property with Items Button value', () => {
    ...
    it('Item button property testing', () => {
      ...
      expect(element.getElementsByClassName('e-toolbar-items').length).toEqual(
        1
      );
      expect(element.getElementsByClassName('e-toolbar-item').length).toEqual(
        1
      );
      if (toolbar.items[0].type.toString() === 'Button') {
        expect(
          element
            .getElementsByClassName('e-toolbar-item')[0]
  ...
  describe('Main Property Width Property testing', () => {
    ...
    it('Width property as string testing', () => {
      toolbar = new Toolbar({
        width: '500px',
        items: [{ type: 'Separator', cssClass: 'e-contentItem e-css-class' }],
      });
      toolbar.appendTo('#ej2Toolbar');
      let element: HTMLElement = document.getElementById('ej2Toolbar');
      expect(
        element
          .querySelector('.e-toolbar-items .e-toolbar-item')
          .classList.contains('e-contentItem')
      ).toEqual(true);
      expect(
        element
          .querySelector('.e-toolbar-items .e-toolbar-item')
          .classList.contains('e-css-class')
      ).toEqual(true);
      expect(element.style.width).toEqual('500px');
    });
  });
  ...
  describe('Main Property Height Property testing', () => {
    ...
    it('Height property as string testing', () => {
      toolbar = new Toolbar({
        height: '500px',
        items: [{ type: 'Separator', cssClass: 'e-contentItem' }],
      });
      toolbar.appendTo('#ej2Toolbar');
      let element: HTMLElement = document.getElementById('ej2Toolbar');
      expect(
  ...
  describe('Persistance testing', () => {
    ...
    it('Overflow style as scroll testing', () => {
      window.localStorage.setItem(
        'toolbarej2Toolbar',
        JSON.stringify({ overflowMode: 'Popup' })
      );
      toolbar = new Toolbar({
        width: 20,
      ...
      let element: HTMLElement = document.getElementById('ej2Toolbar');
      expect(
        JSON.parse(window.localStorage.toolbarej2Toolbar).hasOwnProperty()
      ).toEqual(false);
    });
  });
  ...
  describe('Overflow content Testing', () => {
    ...
    it('Overflow style as scroll testing', () => {
      ...
      let innerelement: HTMLElement =
        toolbar.element.querySelector('.e-toolbar-items');
      setStyleAttribute(<HTMLElement>innerelement, { display: 'inline-block' });
      setStyleAttribute(
        <HTMLElement>(
          toolbar.element.getElementsByClassName('e-toolbar-item')[0]
        ),
      ...
      let scrollELe: HTMLElement = <HTMLElement>(
        toolbar.element.firstElementChild
      );
    ...
    it('Overflow navigation testing', () => {
      ...
      expect(scrollELe.classList.contains('e-hscroll')).toEqual(true);
      let innerNavEle: HTMLElement = <HTMLElement>(
        scrollELe.querySelector('.e-scroll-right-nav')
      );
      expect(innerNavEle.classList.contains('e-scroll-nav')).toEqual(true);
      let innerNavElement: HTMLElement = <HTMLElement>(
        innerNavEle.querySelector('.e-icons')
      );
      expect(innerNavElement.classList.contains('e-nav-arrow')).toEqual(true);
      expect(innerNavElement.classList.contains('e-nav-right-arrow')).toEqual(
        true
      );
      let scrollEvent = document.createEvent('MouseEvents');
      scrollEvent.initEvent('scroll', false, false);
  ...
  describe('Overflow content horizontal scrolling  Testing', () => {
    ...
    it('Overflow navigation horizontal scrolling event handler testing', () => {
      ...
      let innerArrowEle: HTMLElement = <HTMLElement>(
        innerNavElement.querySelector('.e-icons')
      );
      expect(innerArrowEle.classList.contains('e-nav-right-arrow')).toEqual(
        true
      );
  ...
  describe('Main property OverflowMode testing', () => {
    ...
    it(' Main property OverflowMode given as string testing', (done: Function) => {
      toolbar = new Toolbar({
        ...
        created: () => {
          let inlineELe: HTMLElement = <HTMLElement>(
            toolbar.element.firstElementChild
          );
          expect(inlineELe.classList.contains('e-toolbar-multirow')).toEqual(
            true
          );
          done();
        },
    ...
    it(' Main property OverflowMode given as string testing', (done: Function) => {
      toolbar = new Toolbar({
        ...
        created: () => {
          expect(
            toolbar.element.classList.contains('e-extended-toolbar')
          ).toEqual(true);
          done();
        },
      });
  ...
  describe('Main property OverflowMode with Align testing', () => {
    ...
    it(' Main property OverflowMode for scrollable with alignment', () => {
      toolbar = new Toolbar({
        overflowMode: 'Scrollable',
        items: [
          { text: 'Today', overflow: 'Hide', align: 'Left' },
  ...
  describe(' Html attributes property testing in items main property', () => {
    ...
    it('Html attributes property giving as role', () => {
      ...
      let ele: HTMLElement = <HTMLElement>(
        element.getElementsByClassName('e-toolbar-item')[0]
      );
        ...
        items: [
          {
            type: 'Button',
            text: 'Underline',
            tooltipText: 'R&#233;f&eacute;rence fournisseur',
          },
        ],
      });
      toolbar.appendTo('#ej2Toolbar');
  ...
  describe('Width property testing in items main property', () => {
    ...
    it('Width property testing', () => {
      ...
      toolbar.appendTo('#ej2Toolbar');
      let ele: HTMLElement = <HTMLElement>(
        element.querySelector('.e-toolbar-item')
      );
  ...
  describe('Prefix Icon property testing in items main property', () => {
    ...
    it('Prefix Icon property testing', () => {
      ...
      expect(
        (<HTMLElement>innerEle.children[0]).classList.contains('e-prefix-icon')
      ).toEqual(true);
      expect(
        (<HTMLElement>innerEle.children[1]).classList.contains(
          'e-tbar-btn-text'
        )
      ).toEqual(true);
    });
  ...
  describe('Disabled property testing for toolbar item', () => {
    ...
    it('when disabled property is set to true', () => {
      ...
      expect(
        element.querySelector('.e-toolbar-item').classList.contains('e-overlay')
      ).toEqual(true);
    });
  ...
  describe('Suffix Icon property testing in items main property', () => {
    ...
    it('Suffix Icon property testing', () => {
      ...
      expect(innerEle.children.length).toEqual(2);
      expect(
        (<HTMLElement>innerEle.children[1]).classList.contains('e-suffix-icon')
      ).toEqual(true);
      expect(
        (<HTMLElement>innerEle.children[0]).classList.contains(
          'e-tbar-btn-text'
        )
      ).toEqual(true);
    });
  ...
  describe('ShowtexOn property testing in items main property', () => {
    ...
    it('showtextOn given as string with Popup', () => {
      ...
      expect(
        toolbar.popObj.element.querySelectorAll('.e-toolbar-text').length > 0
      ).toEqual(true);
    });
    it('showtextOn given as string', () => {
      ...
      expect(element.querySelectorAll('.e-toolbar-text').length > 0).toEqual(
        true
      );
    });
    it('showtextOn given as string with Popup', () => {
      ...
      expect(
        toolbar.popObj.element.querySelectorAll('.e-popup-text').length > 0
      ).toEqual(true);
    });
    it('showtextOn given as string', () => {
      let element: HTMLElement = document.getElementById('ej2Toolbar');
      ...
      expect(element.querySelectorAll('.e-popup-text').length > 0).toEqual(
        true
      );
    });
    it('showtextOn given as string', () => {
      ...
      expect(
        (<HTMLElement>(
          element.querySelectorAll('.e-toolbar-item')[0]
        )).classList.contains('e-toolbar-text')
      ).toEqual(false);
    });
  });
  ...
  describe('Popuped element height testing based on toolbar height', () => {
    ...
    it('Popuped element height testing', () => {
      ...
      toolbar.appendTo('#ej2Toolbar');
      let popupEle: HTMLElement = toolbar.popObj.element.querySelector(
        '.e-toolbar-item'
      ) as HTMLElement;
  ...
  describe('Template property testing in items main property', () => {
    ...
    it('Template text given as string', () => {
      ...
      expect(
        element
          ...
          .parentElement.classList.contains('e-toolbar-item')
      ).toEqual(true);
      ...
      expect(
        element
          .querySelector('#Template')
          .parentElement.classList.contains('e-template')
      ).toEqual(true);
    });
    it('Template text given as string', () => {
      let element: HTMLElement = document.getElementById('ej2Toolbar');
    ...
    it('Template given as Interface', () => {
      ...
      toolbar.appendTo('#ej2Toolbar');
      let template: HTMLElement = <HTMLElement>(
        element.querySelector('.e-template input')
      );
      expect(
        element
          .querySelector('.e-template')
          .classList.contains('e-toolbar-item')
      ).toEqual(true);
  ...
  describe('Overflow property testing in items Prob', () => {
    ...
    it('Overflow priority sets "Show" as string', () => {
      ...
      expect(
        element
          .querySelector('.e-toolbar-item')
          .classList.contains('e-overflow-show')
      ).toEqual(true);
    });
    ...
    it('Overflow property popup control testing div element testing', () => {
      ...
      expect(
        element.querySelector('.e-popup').classList.contains('e-toolbar-pop')
      ).toEqual(true);
    ...
    it('Overflow property popup control testing navigation icon testing', () => {
      ...
      expect(
        element
          .querySelector('#' + element.id + '_nav')
          .classList.contains('e-' + element.id + '_nav')
      ).toEqual(true);
      expect(
        element
          .querySelector('#' + element.id + '_nav')
          .classList.contains('e-hor-nav')
      ).toEqual(true);
      expect(
        element
          .querySelector('.e-hor-nav')
          .querySelector('.e-icons')
          .classList.contains('e-popup-down-icon')
      ).toEqual(true);
    });
    ...
    it('Overflow property popup control testing popup opening and closing Testing', () => {
      ...
      expect(
        isVisible(element.querySelector('.e-popup .e-toolbar-item'))
      ).toEqual(true);
      expect(
        element.querySelectorAll('.e-popup .e-toolbar-item').length == 3
      ).toEqual(true);
      expect(
        element.querySelectorAll('.e-popup .e-toolbar-item.e-toolbar-popup')
          .length == 3
      ).toEqual(true);
    ...
    it('Overflow property popup control testing popup position testing in dynamic open', () => {
      ...
      expect(isVisible(popEle)).toEqual(true);
      expect(
        Math.floor(parseFloat(popEle.style.left)) + 'px' === initialPos
      ).toEqual(true);
    });
    it('Overflow property popup control testing popup priority wise alignment testing', () => {
      ...
      expect(
        element
          .querySelector('.e-popup .e-toolbar-item')
          .classList.contains('e-overflow-show')
      ).toEqual(true);
      expect(
        (<Element>(
          element.querySelectorAll('.e-popup .e-toolbar-item')[1]
        )).classList.contains('e-overflow-show')
      ).toEqual(true);
      expect(
        (<Element>(
          element.querySelectorAll('.e-popup .e-toolbar-item')[2]
        )).classList.contains('e-overflow-show')
      ).toEqual(false);
      expect(
        element.querySelectorAll('.e-popup .e-toolbar-item.e-overflow-show')
          .length == 2
      ).toEqual(true);
    });
    it('Overflow property popup control OverflowOption testing', () => {
      ...
      expect(
        element.querySelectorAll('.e-toolbar-items .e-toolbar-item').length == 1
      ).toEqual(true);
      expect(
        (<Element>(
          element.querySelectorAll('.e-toolbar-items .e-toolbar-item')[0]
        )).classList.contains('e-overflow-show')
      ).toEqual(true);
      expect(
        element.querySelectorAll('.e-popup .e-toolbar-item').length == 2
      ).toEqual(true);
      expect(
        element.querySelectorAll('.e-popup .e-toolbar-item button')[0]
    ...
    it('Overflow property popup control OverflowOption give Hide as string', () => {
      ...
      expect(
        element.querySelectorAll('.e-toolbar-items .e-toolbar-item').length == 3
      ).toEqual(true);
      expect(
        (<Element>(
          element.querySelectorAll('.e-toolbar-items .e-toolbar-item')[0]
      ...
      expect(
        (<Element>(
          element.querySelectorAll('.e-toolbar-items .e-toolbar-item')[1]
        )).classList.contains('e-overflow-show')
      ).toEqual(false);
      expect(
        (<Element>(
          element.querySelectorAll('.e-toolbar-items .e-toolbar-item')[2]
        )).classList.contains('e-overflow-show')
      ).toEqual(true);
      expect(
        element.querySelectorAll('.e-popup .e-toolbar-item').length == 0
      ).toEqual(true);
    });
    it('Overflow property popup control OverflowOption give Hide as string', () => {
      let element: HTMLElement = document.getElementById('ej2Toolbar');
    ...
    it('Overflow property popup control testing popup element refresh with increasing width', () => {
      ...
      (<HTMLElement>element.querySelector('.e-toolbar-items')).classList.add(
        'e-fix-width'
      );
      toolbar.width = 80;
      toolbar.dataBind();
      expect(
        element.querySelectorAll('.e-popup .e-toolbar-item').length == 1
      ).toEqual(true);
      expect(
        element.querySelector('.e-popup .e-toolbar-popup button').children[0]
          .innerHTML
      ).toEqual('Bold');
      toolbar.width = 500;
      toolbar.dataBind();
    ...
    it('Overflow property popup control testing popup element refresh with decreasing width', () => {
      ...
      expect(
        element.querySelectorAll('.e-popup .e-toolbar-popup button')[1]
          .children[0].innerHTML
      ).toEqual('Underline');
      expect(
        element.querySelectorAll('.e-popup .e-toolbar-popup button')[2]
          .children[0].innerHTML
      ).toEqual('Italic');
      toolbar.width = 250;
      toolbar.dataBind();
  ...
  describe(' Text property in items toolbar testing', () => {
    ...
    it(' Text property testing', () => {
      ...
      expect(
        element.querySelector('.e-toolbar-item button').children[0].innerHTML
      ).toEqual('Bold');
    });
  });
  ...
  describe('Visible property testing in toolbar item', () => {
    ...
    it('when visibility property is set to true', () => {
      ...
      expect(toolbar.items[0].visible).toBe(true);
      expect(
        element.querySelector('.e-toolbar-item').classList.contains('e-hidden')
      ).toEqual(false);
    });
  ...
  describe(' Touch event (scroll and swipe) handler testing', () => {
    ...
    it('Touch event scroll testing', () => {
      ...
      let event: ScrollEventArgs = {
        ...
        distanceX: 30,
        distanceY: 0,
        originalEvent: TchEvent,
        startEvents: TchEvent,
        startX: 30,
        startY: 0,
        velocity: 4,
      };
  ...
  describe('Resize testing', () => {
    ...
    it('Resize testing', () => {
      ...
      expect(element.querySelector('.e-toolbar-pop').childNodes.length).toEqual(
        2
      );
      expect(
        element.querySelectorAll('.e-toolbar-items .e-toolbar-item').length == 0
      ).toEqual(true);
    });
    it('Normal rendering after resize with "e-tbar-pos" class testing', () => {
      ...
      expect(
        element.querySelectorAll('.e-toolbar-items.e-tbar-pos').length == 0
      ).toEqual(true);
    });
  ...
  describe('Resize testing with Scrolling and Popup Mode', () => {
    ...
    it('Resize testing', () => {
      ...
      expect(
        (<HTMLElement>(
          element.querySelectorAll('.e-toolbar-items .e-toolbar-item button')[1]
        )).children[0].innerHTML
      ).toEqual('New Chart Button');
      expect(
        (<HTMLElement>(
          element.querySelectorAll('.e-toolbar-items .e-toolbar-item')[2]
      ...
      expect(
        (<HTMLElement>(
          element.querySelectorAll('.e-toolbar-items .e-toolbar-item')[3]
        )).querySelector('button').children[0].innerHTML
      ).toEqual('UnderlineBtn');
    });
  ...
  describe('Resize testing with Popup priority', () => {
    ...
    it('Resize with Priority', () => {
      ...
      expect(
        element.querySelectorAll(
          '.e-toolbar-pop .e-toolbar-item .e-tbar-btn-text'
        )[0].innerHTML
      ).toEqual('Next_Prev_Btn');
      expect(
        element.querySelectorAll(
          '.e-toolbar-pop .e-toolbar-item .e-tbar-btn-text'
        )[1].innerHTML
    ...
    it('Resize with Priority Separator', () => {
      ...
      let itemCollection: NodeList = element.querySelectorAll(
      ...
      element.style.width = '150px';
      toolbar.resize();
      itemCollection = element.querySelectorAll(
        '.e-toolbar-items .e-toolbar-item'
      );
    ...
    it('Resize with Priority Separator with ignore Element', () => {
      ...
      toolbar.element.firstElementChild.insertBefore(
        ele1,
        toolbar.element.firstElementChild.firstChild
      );
      toolbar.element.firstElementChild.insertBefore(
        ele2,
        toolbar.element.firstElementChild.children[1]
      );
      let itemCollection: NodeList = element.querySelectorAll(
        '.e-toolbar-items .e-toolbar-item'
      );
    ...
    it('Resize with popup without text item case', () => {
      ...
      expect(
        toolbar.popObj.element.querySelectorAll('.e-tbtn-align').length > 0
      ).toEqual(true);
      expect(itemCollection.length).toEqual(3);
      element.style.width = '250px';
      toolbar.resize();
    ...
    it('Resize with popup without text and showtexton case', () => {
      ...
      toolbar.resize();
      expect(
        element.querySelectorAll('.e-toolbar-items .e-toolbar-item button')[0]
          .children[0].innerHTML
      ).toEqual('Hii');
      expect(
        element.querySelectorAll('.e-toolbar-items .e-toolbar-item button')[1]
  ...
  describe('Toolbar item alignment with RTL mode', () => {
    ...
    it('Positioning with toolbar alignment item ', () => {
      ...
      toolbar.resize();
      expect(
        toolbar.element.querySelector('.e-toolbar-right').style.left === ''
      ).toBe(false);
      expect(
        toolbar.element.querySelector('.e-toolbar-right').style.right === ''
      ).toBe(true);
  ...
  describe(' Keyboard Interaction testing with alignment', () => {
    ...
    it('allowKeyboardInteraction Property testing ', () => {
      ...
      expect(document.activeElement.children[0].innerHTML).toEqual(
        'Underline Button'
      );
    });
  });
  describe('Horizontal toolbar - Keyboard Interaction testing', () => {
    ...
    it('Right arrow Key  without Element testing', () => {
      ...
      toolbar.keyActionHandler(keyEventArgs);
      expect(
        document.activeElement.children[0].innerHTML === 'Underline'
      ).toEqual(false);
      keyEventArgs = {
        preventDefault: function () {},
        action: 'moveRight',
    ...
    it('Right arrow Key with toolbar element Focusing', () => {
      ...
      toolbar.keyActionHandler(keyEventArgs);
      expect(document.activeElement.children[0].innerHTML === 'New').toEqual(
        true
      );
      keyEventArgs = {
        preventDefault: function () {},
      ...
      element.focus();
      toolbar.keyActionHandler(keyEventArgs);
      expect(document.activeElement.children[0].innerHTML === 'Bold').toEqual(
        false
      );
    });
    ...
    it('Right arrow Key  with multiple Separator testing', () => {
      ...
      element.focus();
      toolbar.keyActionHandler(keyEventArgs);
      expect(document.activeElement.classList.contains('e-toolbar')).toEqual(
        false
      );
    });
    it('Right arrow Key  with multiple Separator testing', () => {
    ...
    it('Tab Key testing with disable item', () => {
      ...
      toolbar.appendTo('#ej2Toolbar');
      toolbar.enableItems(
        toolbar.element.querySelector('.e-toolbar-item'),
        false
      );
      keyEventArgs = {
        preventDefault: function () {},
    ...
    it('Tab Key testing with item Click', () => {
      ...
      let ele: HTMLInputElement = <HTMLInputElement>(
        createElement('input', { id: 'input1' })
      );
      let ele1: HTMLInputElement = <HTMLInputElement>(
        createElement('input', { id: 'input2' })
      );
      ele.type = 'text';
      ele1.type = 'text';
      ...
      toolbar.keyActionHandler(keyEventArgs);
      let el: HTMLElement =
        toolbar.element.querySelectorAll('.e-toolbar-item')[0].firstChild;
      expect(document.activeElement.children[0].innerHTML).toEqual('New');
    ...
    it('Move Left with Focusing Navigation testing without Separator', () => {
      ...
      toolbar.keyActionHandler(keyEventArgs);
      expect(
        document.activeElement === toolbar.element.querySelector('.e-hor-nav')
      ).toEqual(true);
    });
    it('Move Left with Focusing Navigation testing', () => {
      ...
      expect(
        document.activeElement ===
          toolbar.element.querySelectorAll('.e-toolbar-item')[1].children[0]
      ).toEqual(true);
    });
    ...
    it('Left arrow Key  without Element in left side testing', () => {
      ...
      toolbar.enableItems(
        toolbar.element.querySelectorAll('.e-toolbar-item')[1],
        false
      );
    ...
    it('Up arrow Key   testing', () => {
      ...
      expect(
        document.activeElement ===
          toolbar.element.querySelectorAll('.e-toolbar-item')[2].firstChild
      ).toEqual(true);
    });
    ...
    it('Home and End Key testig in VisibleElement checking Popup Mode', () => {
      ...
      toolbar.popObj.show();
      toolbar.keyActionHandler(keyEventArgs);
      expect(document.activeElement.children[0].innerHTML == 'Italic').toEqual(
        true
      );
      toolbar.enableItems(0, false);
      toolbar.enableItems(3, false);
  ...
  describe('Public methods add items Testing', () => {
    ...
    it('Empty items with addItems method testing', () => {
      ...
      expect(
        toolbar.element.querySelectorAll('.e-toolbar-items').length
      ).toEqual(0);
      expect(
        toolbar.element.querySelectorAll('.e-toolbar-item').length
      ).toEqual(0);
      toolbar.addItems(
        [
      ...
      expect(
        toolbar.element.querySelectorAll('.e-toolbar-item button').length
      ).toEqual(2);
      expect(
        toolbar.element.querySelectorAll('.e-toolbar-item button')[0]
          .children[0].innerHTML
      ).toEqual('Underline1');
      expect(
        toolbar.element.querySelectorAll('.e-toolbar-item button')[1]
          .children[0].innerHTML
      ).toEqual('Bold1');
    });
    it('addItem method Testing', () => {
      ...
      expect(
        toolbar.element.querySelectorAll('.e-toolbar-item button')[2]
          .children[0].innerHTML
      ).toEqual('Bold');
      toolbar.addItems(
        [
      ...
      expect(
        toolbar.element.querySelectorAll('.e-toolbar-item button')[3]
          .children[0].innerHTML
      ).toEqual('Bold1');
      toolbar.addItems(
        [
      ...
      toolbar.dataBind();
      expect(
        toolbar.element.querySelector('.e-toolbar-items').childElementCount
      ).toBe(5);
      toolbar.addItems(
      ...
      let leftItem: any = element.querySelector(
        '.e-toolbar-items .e-toolbar-left'
      );
      let centerItem: any = element.querySelector(
        '.e-toolbar-items .e-toolbar-center'
      );
      let rightItem: any = element.querySelector(
    ...
    it('addItem method - adding item to popup element index', () => {
      ...
      expect(
        toolbar.element.querySelectorAll('.e-toolbar-item button')[6]
          .children[0].innerHTML
      ).toEqual('Center');
      toolbar.addItems([{ template: ' <div>Copy</div>' }], 2);
      expect(toolbar.items.length).toEqual(8);
      expect(
        toolbar.element.querySelectorAll('.e-toolbar-item')[2].children[0]
          .innerHTML
      ).toEqual('Copy');
      ...
      expect(
        toolbar.element.querySelectorAll('.e-toolbar-item')[8].children[0]
          .innerHTML
      ).toEqual('Left');
    });
  });
  ...
  describe(' Public methods remove items Testing', () => {
    ...
    it(' removeItems method Testing using index', () => {
      ...
      toolbar.removeItems(
        toolbar.popObj.element.querySelectorAll('.e-toolbar-item')
      );
      expect(toolbar.items.length).toEqual(1);
      expect(
        toolbar.element.querySelectorAll('.e-toolbar-item button')[0]
    ...
    it(' removeItems method Testing using index', () => {
      ...
      toolbar.removeItems([
        toolbar.popObj.element.querySelectorAll('.e-toolbar-item')[0],
      ]);
      expect(toolbar.items.length).toEqual(2);
      expect(
        toolbar.element.querySelectorAll('.e-toolbar-item button')[0]
    ...
    it('Remove all items after addItems method testing', () => {
      ...
      toolbar.removeItems([
        toolbar.element.querySelectorAll('.e-toolbar-item')[0],
      ]);
      expect(toolbar.items.length).toEqual(0);
      expect(
        toolbar.element.querySelectorAll('.e-toolbar-items').length
  ...
  describe(' Public methods enableItems Testing', () => {
    ...
    it(' enableItems method Testing ', () => {
      ...
      toolbar.appendTo('#ej2Toolbar');
      toolbar.enableItems(
        toolbar.element.querySelectorAll('.e-toolbar-item'),
        false
      );
      expect(
        toolbar.element
  ...
  describe('Popup Priority Testing', () => {
    ...
    it('Popup Priority Testing check', () => {
      ...
      expect(
        element.querySelectorAll('.e-popup .e-toolbar-item').length
      ).toEqual(4);
      expect(
        element.querySelectorAll('.e-popup .e-toolbar-item button')[3]
          .children[0].innerHTML
      ).toEqual('Next_Prev_Btn');
    });
  });
  ...
  describe('RTL testing', () => {
    ...
    it('rtl class adding check  with on proerty change ', () => {
      ...
      expect(element.classList.contains('e-rtl')).toEqual(true);
      let innerNavElement: HTMLElement = <HTMLElement>(
        element.querySelector('.e-scroll-nav')
      );
      innerNavElement.click();
      toolbar.enableRtl = false;
      toolbar.dataBind();
  ...
  describe('Template Toolbar Testing with div', () => {
    ...
    beforeEach((): void => {
      ...
      let innerEle_1: HTMLElement = createElement('div', {
    ...
    afterEach((): void => {
      if (toolbar) {
        ...
        expect(toolbar.element.getAttribute('aria-orientation')).toEqual(null);
        expect(toolbar.element.getAttribute('role')).toEqual(null);
        let fstChild: HTMLElement = <HTMLElement>(
          toolbar.element.firstElementChild
        );
        expect(fstChild.classList.contains('e-toolbar-items')).toBe(false);
        let fstItem: HTMLElement = <HTMLElement>(
          toolbar.element.firstElementChild.children[0]
        );
        expect(fstItem.classList.contains('e-toolbar-item')).toBe(false);
        let sndItem: HTMLElement = <HTMLElement>(
          toolbar.element.firstElementChild.children[1]
        );
    ...
    it('Template Toolbar Testing', () => {
      ...
      expect(element.querySelectorAll('.e-toolbar-items').length === 1).toEqual(
        true
      );
      let innerEle = <HTMLElement>element.querySelector('.e-toolbar-items');
      expect(
        (<HTMLElement>innerEle.children[0]).classList.contains('e-toolbar-item')
      ).toEqual(true);
      expect(
        (<HTMLElement>innerEle.children[1]).classList.contains('e-toolbar-item')
      ).toEqual(true);
    });
  });
  ...
  describe('Cross Browser Testing with IE popup icon alignment', () => {
    ...
    it('Cross browser Testing with IE', () => {
      ...
      toolbar.appendTo('#ej2Toolbar');
      let popupNav: HTMLElement = toolbar.element.querySelector(
        '.e-hor-nav'
      ) as HTMLElement;
    ...
    it('Focus moved from popup icon, popup close testing ', (done: Function) => {
      ...
      setTimeout(function () {
        let element: HTMLElement = <HTMLElement>(
          document.getElementById('ej2Toolbar')
        );
        let trg: HTMLElement = <HTMLElement>(
          document.querySelector('.e-hor-nav')
        );
        expect(
          element
  ...
  describe('Popup with more content overflow testing', () => {
    ...
    beforeEach((done: Function) => {
      ...
      toolbar = new Toolbar({
        ...
        overflowMode: 'Popup',
        items: [
          { type: 'Button', text: 'Hii2' },
          { type: 'Button', text: 'Unterline22' },
    ...
    beforeEach((done: Function) => {
      ...
      toolbar = new Toolbar({
        ...
        items: [
          ...
          {
            type: 'Button',
            text: 'UnterlineUnterlineUnterlineUnterlineUnterlineUnterlineUnterlineUnterlineUnterlineUnterlineUnterlineUnterlineUnterlineUnterlineUnterlineUnterlineUnterline',
          },
        ],
      });
      toolbar.appendTo('#ej2Toolbar');
  ...
  describe('Alignment Based toolbar item Rendering', () => {
    ...
    it('Without align type toolbar testing', () => {
      ...
      expect(
        toolbar.element.querySelector('.e-toolbar-items').children.length > 3
      ).toEqual(true);
    });
  });
  describe('Alignment Based toolbar item Rendering', () => {
    ...
    it('Without align type toolbar testing', () => {
      ...
      let tbarAlignEle: HTMLElement = toolbar.element.querySelector(
        '.e-toolbar-items'
      ) as HTMLElement;
      let scrollAlignEle: HTMLCollection =
        tbarAlignEle.querySelector('.e-hscroll-content').children;
      expect(
        scrollAlignEle[0].querySelectorAll('.e-tbar-btn-text')[0].textContent
      ).toEqual('Hii');
      expect(
        scrollAlignEle[0].querySelectorAll('.e-tbar-btn-text')[1].textContent
      ).toEqual('New Chart Button');
      expect(
        scrollAlignEle[1].querySelectorAll('.e-tbar-btn-text')[1].textContent
      ).toEqual('ChartButton');
      expect(
        scrollAlignEle[1].querySelectorAll('.e-tbar-btn-text')[0].textContent
      ).toEqual('UnderlineBtn');
      expect(
        scrollAlignEle[2].querySelectorAll('.e-tbar-btn-text')[0].textContent
      ).toEqual('Next_Prev_Btn');
    });
    it('Without align type with dynamic items updating in toolbar testing', () => {
      ...
      expect(
        toolbar.element.firstElementChild.classList.contains('e-tbar-pos')
      ).toBe(false);
    ...
    it('Without align type toolbar testing', () => {
      ...
      expect(
        scrollAlignEle[0].querySelectorAll('.e-tbar-btn-text')[2].textContent
      ).toEqual('Next_Prev_Btn');
    });
  });
  ...
  describe('Alignment Based toolbar item Rendering', () => {
    ...
    it('Without align type toolbar testing', () => {
      ...
      let tbarAlignEle: any =
        toolbar.element.querySelector('.e-toolbar-items').children;
      expect(tbarAlignEle.length === 3).toEqual(true);
      expect(
        (<HTMLElement>tbarAlignEle[0]).classList.contains('e-toolbar-left')
      ).toEqual(true);
      expect(
        (<HTMLElement>tbarAlignEle[1]).classList.contains('e-toolbar-center')
      ).toEqual(true);
      expect(
        (<HTMLElement>tbarAlignEle[2]).classList.contains('e-toolbar-right')
      ).toEqual(true);
      expect((<HTMLElement>tbarAlignEle[0]).children.length === 2).toEqual(
        true
      );
      expect((<HTMLElement>tbarAlignEle[1]).children.length === 2).toEqual(
        true
      );
      expect((<HTMLElement>tbarAlignEle[2]).children.length === 1).toEqual(
        true
      );
      toolbar.refresh();
  ...
  describe('Alignment Based toolbar item Rendering eith RTL', () => {
    ...
    it('Without align type toolbar testing', () => {
      ...
      expect(tbarAlignEle.length === 3).toEqual(true);
      expect(
        (<HTMLElement>tbarAlignEle[1]).style.marginLeft.length === 0
      ).toEqual(true);
      expect(
        (<HTMLElement>tbarAlignEle[1]).style.marginRight.length > 0
      ).toEqual(true);
    });
  });
  describe('Alignment Based toolbar item Rendering', () => {
    ...
    it('Without align type toolbar testing', () => {
      ...
      expect((<HTMLElement>tbarAlignEle[0]).children.length === 3).toEqual(
        true
      );
      expect((<HTMLElement>tbarAlignEle[1]).children.length === 2).toEqual(
        true
      );
      expect((<HTMLElement>tbarAlignEle[2]).children.length === 0).toEqual(
        true
      );
    });
  });
  ...
  describe('Alignment Based toolbar item Rendering with Separator', () => {
    ...
    it('Toolbar items with separator with resizing', () => {
      ...
      let tbarAlignEle: NodeList =
        toolbar.element.querySelector('.e-toolbar-items').children;
      let scrollAlignEle: HTMLCollection = toolbar.element
        .querySelector('.e-toolbar-items')
        .querySelector('.e-hscroll-content').children;
      expect(
        scrollAlignEle[1].children[1].classList.contains('e-separator')
      ).toEqual(true);
      expect(
        scrollAlignEle[0].children[2].classList.contains('e-separator')
      ).toEqual(true);
      expect(
        toolbar.element
          .querySelector('.e-toolbar-items')
          .classList.contains('e-tbar-pos')
      ).toEqual(false);
      element.style.width = 'auto';
  ...
  describe('Alignment Based toolbar item Rendering', () => {
    ...
    it('Without align type toolbar testing', () => {
      ...
      expect(popupEle[2].querySelector('.e-tbar-btn-text').textContent).toEqual(
        'Next_Prev_Btn'
      );
      expect(popupEle[1].querySelector('.e-tbar-btn-text').textContent).toEqual(
        'ChartButton'
      );
      expect(popupEle[0].querySelector('.e-tbar-btn-text').textContent).toEqual(
        'New Chart Button'
      );
      expect(toolbar.element.classList.contains('e-toolpop')).toEqual(true);
      expect((<HTMLElement>tbarAlignEle[1]).children.length === 0).toEqual(
        true
      );
      expect((<HTMLElement>tbarAlignEle[2]).children.length === 0).toEqual(
        true
      ...
      toolbar.resize();
      expect(
        popupEle[0].querySelector('.e-tbar-btn-text').textContent ===
          'New Chart Button'
      ).toEqual(false);
      expect((<HTMLElement>tbarAlignEle[1]).children.length === 1).toEqual(
        true
      );
      expect(
        (<HTMLElement>tbarAlignEle[1]).querySelector('.e-tbar-btn-text')
          .textContent
      ).toEqual('New Chart Button');
    });
  });
  ...
  describe('Alignment Based toolbar item Rendering', () => {
    ...
    it('1st item coming with margin in popup mode', () => {
      ...
      toolbar.resize();
      expect(
        toolbar.element.querySelector('.e-toolbar-item .e-tbar-btn-text')
          .textContent
      ).toEqual('GridBtn');
    });
    it('Without align type toolbar testing', () => {
  ...
  describe('Alignment Based toolbar item Rendering with public method', () => {
    ...
    it('Add Item Public method testing', () => {
      ...
      expect(
        toolbar.element.querySelectorAll(
          '.e-tbar-pos .e-toolbar-left .e-tbar-btn-text'
        )[1].textContent
      ).toEqual('NewBtn');
      ...
      expect(
        toolbar.element
          .querySelector('.e-toolbar-pop')
          .lastElementChild.querySelector('.e-tbar-btn-text').textContent
      ).toEqual('NewBtn');
    });
    ...
    it('Add Item Public method testing with multiple Items', () => {
      ...
      toolbar.addItems(
        [
          { type: 'Button', text: 'NewBtn' },
          { type: 'Button', text: 'SecondBtn', align: 'Right' },
        ],
        1
      );
      expect(
        toolbar.element.querySelectorAll(
          '.e-tbar-pos .e-toolbar-right .e-tbar-btn-text'
        )[1].textContent
      ).toEqual('NewBtn');
      expect(
        toolbar.element.querySelectorAll(
      ...
      expect(
        toolbar.tbarAlgEle.rights[1].querySelector('.e-tbar-btn-text')
          .textContent
      ).toEqual('NewBtn');
      expect(
        toolbar.tbarAlgEle.rights[2].querySelector('.e-tbar-btn-text')
          .textContent
      ).toEqual('SecondBtn');
      expect(
        toolbar.element.querySelectorAll(
          '.e-tbar-pos .e-toolbar-center .e-tbar-btn-text'
        )[1].textContent
      ).toEqual('Next_Prev_Btn');
      expect(
        toolbar.element.querySelectorAll(
      ...
      toolbar.addItems(
        [
          { type: 'Button', text: 'NewBtnCenter' },
          { type: 'Button', text: 'SecondBtnCenter', align: 'Center' },
        ],
        1
      );
      expect(toolbar.tbarAlgEle.lefts.length).toEqual(1);
      ...
      expect(toolbar.tbarAlgEle.rights.length).toEqual(3);
      expect(
        toolbar.tbarAlgEle.centers[1].querySelector('.e-tbar-btn-text')
          .textContent
      ).toEqual('NewBtnCenter');
      expect(
        toolbar.tbarAlgEle.centers[2].querySelector('.e-tbar-btn-text')
          .textContent
      ).toEqual('SecondBtnCenter');
      expect(
        toolbar.element.querySelectorAll(
          '.e-tbar-pos .e-toolbar-center .e-tbar-btn-text'
        )[2].textContent
    ...
    it('add items and remove items methode combined', () => {
      ...
      expect(
        toolbar.tbarEle[0].querySelector('button .e-tbar-btn-text')
          .textContent === 'GridBtn'
      ).toEqual(false);
      expect(
        toolbar.element.querySelector('.e-toolbar-item button .e-tbar-btn-text')
          .textContent
      ).toEqual('New Chart Button');
      expect(
        toolbar.tbarEle[0].querySelector('button .e-tbar-btn-text')
          .textContent === 'NewBtnCenter'
      ).toEqual(true);
      toolbar.removeItems(toolbar.element.querySelector('.e-toolbar-item'));
      expect(toolbar.tbarAlgEle.lefts.length).toEqual(0);
      expect(
      ...
      expect(ele.querySelector('button .e-tbar-btn-text').textContent).toEqual(
        'NewBtnCenter'
      );
      expect(
        toolbar.tbarEle[0].querySelector('button .e-tbar-btn-text').textContent
      ).toEqual('NewBtnCenter');
    ...
    it('Add Item Public method testing with remove Items', () => {
      ...
      toolbar.removeItems(
        toolbar.element.querySelector('.e-toolbar-item') as HTMLElement
      );
      expect(toolbar.tbarAlgEle.lefts.length).toEqual(0);
      expect(
        toolbar.element.querySelector('.e-tbar-pos .e-toolbar-left').children
          .length
      ).toEqual(0);
      expect(
        toolbar.tbarAlgEle.centers[1].querySelector('.e-tbar-btn-text')
  ...
  describe('Keyboard Interaction testing with alignment based rendering', () => {
    ...
    it('Keyboard Interaction left key testing', () => {
      ...
      (<HTMLElement>(
        toolbar.element.querySelectorAll('.e-toolbar-item')[0].children[0]
      )).click();
      keyEventArgs = {
        preventDefault: function () {},
        action: 'moveLeft',
      ...
      expect(
        document.activeElement ===
          toolbar.element.querySelectorAll('.e-toolbar-item')[4].children[0]
      ).toEqual(false);
    });
    it('Keyboard Interaction left key and right testing', () => {
      ...
      expect(
        document.activeElement ===
          toolbar.element.querySelectorAll('.e-hor-nav')[0]
      ).toEqual(true);
      keyEventArgs = {
        preventDefault: function () {},
        action: 'moveLeft',
  ...
  describe('Left and Right key navigaton testcases', () => {
    ...
    it('Right key testing with popup arrow selection and popup opening', () => {
      ...
      toolbar.appendTo('#ej2Toolbar');
      (<HTMLElement>(
        toolbar.element.querySelector('.e-toolbar-items').lastElementChild
          .children[0]
      )).click();
      keyEventArgs = {
        preventDefault: function () {},
      ...
      toolbar = new Toolbar({
        items: [
          ...
          },
          {
            type: 'Button',
            text: 'Bold',
            htmlAttributes: { role: 'Toolbar', align: 'Right' },
          },
        ],
      });
      toolbar.appendTo('#ej2Toolbar');
      let items: HTMLElement = element.querySelector(
        '.e-toolbar-items'
      ) as HTMLElement;
  ...
  describe('Toolbar resizing with alignment Positioning.', () => {
    ...
    it('alignment positioning remove and adding testing', () => {
      ...
      expect(
        (
          items.children[0].querySelector(
            'button .e-tbar-btn-text'
          ) as HTMLElement
        ).textContent
      ).toBe('btn0');
      ...
      expect(
        (
          items.children[2].querySelector(
            'button .e-tbar-btn-text'
          ) as HTMLElement
        ).textContent
      ).toBe('btn1');
      ...
      expect(
        (
          items.children[5].querySelector(
            'button .e-tbar-btn-text'
          ) as HTMLElement
        ).textContent
      ).toBe('btn2');
      ...
      expect(
        (
          items.children[8].querySelector(
            'button .e-tbar-btn-text'
          ) as HTMLElement
        ).textContent
      ).toBe('btn3');
      ...
      expect(items.children[12].classList.contains('e-toolbar-item')).toBe(
        true
      );
      expect(
        (
          items.children[12].querySelector(
            'button .e-tbar-btn-text'
          ) as HTMLElement
        ).textContent
      ).toBe('btn4');
  ...
  describe('Click Event Args Testing', () => {
    ...
    it('Click Event function argument after Refresh testing', () => {
      ...
      expect(
        toolbar.clickArgs.originalEvent.target.classList.contains(
          'e-toolbar-item'
        )
      ).toBe(true);
      expect(
        toolbar.clickArgs.originalEvent.target.querySelector('.e-tbar-btn-text')
          .textContent
      ).toBe('Hii');
      ...
      toolbar.refresh();
      ele = <HTMLElement>(
        element.querySelectorAll('.e-toolbar-items .e-toolbar-item')[5]
      );
      ele.click();
      ...
      expect(toolbar.clickArgs.item.align).toBe('Left');
      ele = <HTMLElement>(
        element.querySelectorAll('.e-toolbar-items .e-toolbar-item')[6]
      );
      ele.click();
    ...
    it('Click Event function argument testing', () => {
      ...
      ele = <HTMLElement>(
        element.querySelectorAll('.e-toolbar-center .e-toolbar-item')[1]
      );
      ele.click();
      expect(
        toolbar.clickArgs.originalEvent.target.querySelector('.e-tbar-btn-text')
      ...
      ele = <HTMLElement>(
        element.querySelectorAll('.e-toolbar-right .e-toolbar-item')[1]
      );
      ele.click();
      expect(
        toolbar.clickArgs.originalEvent.target.querySelector('.e-tbar-btn-text')
      ...
      ele = <HTMLElement>(
        element.querySelectorAll('.e-toolbar-center .e-toolbar-item')[0]
      );
      ele.click();
      expect(
        toolbar.clickArgs.originalEvent.target.querySelector('.e-tbar-btn-text')
    ...
    it('Prevent focusing in Disabled items in key board', () => {
      ...
      toolbar.enableItems(
        element.querySelectorAll('.e-toolbar-item')[2],
        false
      );
      keyEventArgs = {
        preventDefault: function () {},
      ...
      toolbar.enableItems(
        element.querySelectorAll('.e-toolbar-item')[3],
        false
      );
      expect(
        element
      ...
      toolbar.keyActionHandler(keyEventArgs);
      expect(document.activeElement.children[1].innerHTML).toEqual(
        'LeftButton'
      );
      ...
      toolbar.enableItems(
        element.querySelectorAll('.e-toolbar-item')[5],
        false
      );
      expect(
        element
          .querySelectorAll('.e-toolbar-item')[5]
          .firstElementChild.getAttribute('aria-disabled')
      ).toBe('true');
      keyEventArgs = {
        preventDefault: function () {},
        action: 'moveRight',
        target: toolbar.element.querySelectorAll(
      ...
      toolbar.enableItems(
        element.querySelectorAll('.e-toolbar-item')[4],
        false
      );
      keyEventArgs = {
        preventDefault: function () {},
      ...
      toolbar = new Toolbar(
        {
          ...
          items: [
            ...
            {
              template:
                '<div class="e-input-group"><input placeholder="Search"></input></div>',
            },
            {
              type: 'Button',
              text: 'New RibbonBtn',
      ...
      toolbar = new Toolbar(
        {
          items: [
            ...
            },
            {
              ...
              text: 'New Chart Button',
              overflow: 'Hide',
              template: ' <div id ="e-itemTemplate" tabindex="0" >Hii</div>',
            },
            {
              type: 'Button',
              text: 'Next_Prev_Btn',
      ...
      toolbar = new Toolbar(
        {
          items: [
            ...
            },
            {
              ...
              text: 'UnderlineBtn',
              overflow: 'Show',
              htmlAttributes: { style: 'margin-right:15px ' },
            },
          ],
        },
        '#ej2Toolbar'
  ...
  describe('Popup Priority preference feature testing', () => {
    ...
    it('showAlwaysInPopup property testing with Popup mode with align items', () => {
      ...
      expect(
        (<HTMLElement>(
          element.querySelectorAll('.e-popup .e-tbar-btn')[1].firstElementChild
        )).innerText
      ).toBe('Next_Prev_Btn');
      expect(
        (<HTMLElement>(
          element.querySelectorAll('.e-popup .e-tbar-btn')[0].firstElementChild
        )).innerText
      ).toBe('New Chart Button');
      ...
      expect(
        (<HTMLElement>(
          element.querySelectorAll('.e-toolbar-right .e-tbar-btn')[0]
            .firstElementChild
        )).innerText
      ).toBe('Next_Prev_Btn');
  ...
  describe('Separate items property chaning with onPropertyChange.', () => {
    ...
    it('Items "Text, prefixIcon and suffixIcon property changing in onPropertyChange Testing  ', () => {
      ...
      let tbarBtns: any = element.querySelectorAll(
        '.e-toolbar-items .e-tbar-btn'
      );
      ...
      expect(
        toolbar.tbarEle[1].firstElementChild.firstElementChild.innerText
      ).toBe('2ndButton');
      ...
      expect(
        toolbar.tbarEle[2].firstElementChild.firstElementChild.innerText
      ).toBe('3rdButton');
      ...
      expect(tbarBtns[2].firstElementChild.classList.contains('e-prefix')).toBe(
        true
      );
      expect(toolbar.tbarEle[2].firstElementChild.childElementCount).toBe(2);
      expect(
        toolbar.tbarEle[2].firstElementChild.firstElementChild.classList.contains(
          'e-prefix'
        )
      ).toBe(true);
      expect(toolbar.tbarEle[2] === tbarBtns[2].parentElement).toBe(true);
      ...
      expect(
        toolbar.tbarEle[3].firstElementChild.children[1].classList.contains(
          'e-suffix'
        )
      ).toBe(true);
      ...
      expect(tbarBtns[4].firstElementChild.classList.contains('e-prefix')).toBe(
        true
      );
      expect(toolbar.tbarEle[4].firstElementChild.childElementCount).toBe(2);
      expect(
        toolbar.tbarEle[4].firstElementChild.firstElementChild.classList.contains(
          'e-prefix'
        )
      ).toBe(true);
      ...
      toolbar.dataBind();
      tbarBtns = element.querySelectorAll('.e-toolbar-items .e-tbar-btn');
      expect(tbarBtns[0].parentElement.getAttribute('title')).toBe(
        '1st_toolbarItem'
      );
      ...
      toolbar.dataBind();
      let separator: any = element.querySelectorAll(
        '.e-toolbar-items .e-separator'
      );
      ...
      tbarBtns = element.querySelectorAll('.e-toolbar-items .e-tbar-btn');
      expect(toolbar.tbarEle[2].firstElementChild.getAttribute('id')).toBe(
        'tbarItem'
      );
    ...
    it('Items "Text, prefixIcon and suffixIcon property changing in onPropertyChange Testing  ', () => {
      ...
      expect(element.querySelector('.e-toolbar-items').childElementCount).toBe(
        5
      );
      ...
      let tbarItem: any = element.querySelectorAll(
        '.e-toolbar-items .e-toolbar-item'
      );
      let leftItem: any = element.querySelector(
        '.e-toolbar-items .e-toolbar-left'
      ...
      expect(
        centerItem.querySelectorAll('.e-tbar-btn')[0].firstElementChild
          .innerText
      ).toBe('Next_Prev_Btn');
      ...
      expect(
        rightItem.querySelectorAll('.e-tbar-btn')[0].firstElementChild.innerText
      ).toBe('Next_Prev_Btn');
    ...
    it('Items "Text, prefixIcon and suffixIcon property changing in onPropertyChange Testing  ', () => {
      ...
      let popupChildCount: any =
        element.querySelector('.e-popup').childElementCount;
  ...
  describe('Toolbar keyboard testing when input component render inside the toolbar', () => {
    ...
    it("Accordion content with input element, 'moveRight' keyboard navigation and focus testing", (done: Function) => {
      ...
      toolbar = new Toolbar(
        {
          items: [
            ...
            {
              type: 'Button',
              text: '<input type="text" value="syncfusion" />',
            },
            { type: 'Button', text: 'Bold' },
          ],
        },
      ...
      let elefirst: HTMLInputElement = ele.querySelector(
        '.e-toolbar-item input'
      );
      elefirst.focus();
  ...
  describe('hideItem method testing', () => {
    ...
    it('Items - hideItem as true', () => {
      ...
      toolbar.hideItem(
        toolbar.element.querySelectorAll('.' + CLS_ITEM)[1] as HTMLElement,
        true
      );
      expect(
        element
    ...
    it('Template - hideItem as true', () => {
      let ele: HTMLElement = document.getElementById('ej2Toolbar');
      ele.innerHTML =
        '<div class="e-toolbar-items"><div><button class="e-btn" >File </button></div>' +
  ...
  describe('Onproperty change testing with extended', () => {
    ...
    it('Overflow property Extended toolbar popup opening and closing Testing', () => {
      ...
      let tool: any = toolbar;
      tool.popObj.show();
      expect(element.children[2].classList.contains('e-popup-open')).toEqual(
        true
      );
      expect(nav_icon.classList.contains('e-popup-up-icon')).toEqual(true);
      document.getElementById(element.id + '_nav').click();
      tool.popObj.hide();
      expect(nav_icon.classList.contains('e-popup-down-icon')).toEqual(true);
      expect(element.children[2].classList.contains('e-popup-close')).toEqual(
        true
      );
    });
  });
  ...
  describe('Hscroll module scrollStep change in beforeCreate', () => {
    ...
    it('ScrollStep changing support', () => {
      ...
      expect(
        toolbar.element.firstElementChild.ej2_instances[0].scrollStep
      ).toBe(70);
    });
  });
  ...
  describe('Item public click event testing', () => {
    ...
    it('Item click event argument testing', () => {
      toolbar = new Toolbar({
        width: '500px',
        items: [{ text: 'Cut', click: clickArgs }],
      });
      let element: HTMLElement = document.getElementById('ej2Toolbar');
      toolbar.appendTo('#ej2Toolbar');
      (<HTMLElement>(
        document.querySelectorAll('.e-toolbar .e-toolbar-item')[0].firstChild
      )).click();
    ...
    it('Clicked event testing', () => {
      ...
      expect(i).toEqual(1);
      (<HTMLElement>(
        document.querySelectorAll('.e-toolbar .e-toolbar-item')[1].firstChild
      )).click();
      expect(i).toEqual(2);
      (<HTMLElement>(
        document.querySelectorAll('.e-toolbar .e-toolbar-item')[2].firstChild
      )).click();
      expect(i).toEqual(3);
    });
    ...
    it('Clicked and random item click event testing', () => {
      ...
      expect(i).toEqual(5);
      (<HTMLElement>(
        document.querySelectorAll('.e-toolbar .e-toolbar-item')[3].firstChild
      )).click();
      expect(i).toEqual(6);
    });
  ...
  describe('HTML5 standard issue in toolbar', () => {
    ...
    it('DOM element changed from division to span for toolbar button text', () => {
      ...
      expect(element.querySelectorAll('.e-tbar-btn-text')[0].tagName).toBe(
        'SPAN'
      );
      expect(element.querySelectorAll('.e-tbar-btn-text')[1].tagName).toBe(
        'SPAN'
      );
      expect(element.querySelectorAll('.e-tbar-btn-text')[2].tagName).toBe(
        'SPAN'
      );
      expect(element.querySelectorAll('.e-tbar-btn-text')[3].tagName).toBe(
        'SPAN'
      );
      expect(element.querySelectorAll('.e-tbar-btn-text')[4].tagName).toBe(
        'SPAN'
      );
    });
  });
  ...
  describe('Keyboard functionalities are not navigating', () => {
    ...
    it('When we set the align property “right” for the toolbar items', () => {
      ...
      expect(
        element
          .querySelectorAll('.e-toolbar-item')[4]
          .firstElementChild.getAttribute('aria-disabled')
      ).toBe('true');
      keyEventArgs = {
        preventDefault: function () {},
    ...
    it('Keyboard interaction not working for first hidden item as index', () => {
      ...
      let ele2: HTMLElement =
        toolbar.element.querySelectorAll('.e-toolbar-item')[1].firstChild;
    ...
    it('Keyboard interaction not working when we set focus to hidden item as element', () => {
      ...
      function creatfunction(e: Event) {
        toolbar.hideItem(
          toolbar.element.querySelector('.e-toolbar-item')[1],
          true
        );
        toolbar.hideItem(
          toolbar.element.querySelector('.e-toolbar-item')[2],
          true
        );
      }
      toolbar = new Toolbar({
      ...
      expect(ele1.getAttribute('tabindex') === null).toEqual(true);
      let ele2: HTMLElement =
        toolbar.element.querySelectorAll('.e-toolbar-item')[3].firstChild;
      expect(ele2.getAttribute('tabindex')).toEqual('-1');
      toolbar.hideItem(toolbar.element.querySelector('.e-toolbar-item'), true);
      toolbar.hideItem(
        toolbar.element.querySelector('.e-toolbar-item')[1],
    ...
    it('Keyboard interaction not working when we remove the right aligned hidden item as element', () => {
      ...
      expect(ele1.getAttribute('tabindex') === null).toEqual(true);
      toolbar.hideItem(
        toolbar.element.querySelector('.e-toolbar-item')[6],
        true
      );
      expect(ele1.getAttribute('tabindex') === null).toEqual(true);
    });
  ...
  describe('RTE - Popup gets closed', () => {
    ...
    it('When we update the toolbar items in overflow mode extended', () => {
      ...
      (<HTMLElement>(
        document.querySelectorAll('.e-toolbar .e-toolbar-item')[15].firstChild
      )).click();
      ...
      (<HTMLElement>(
        document.querySelectorAll('.e-toolbar .e-toolbar-item')[16].firstChild
      )).click();
      expect(args.item.text).toEqual('Bullets');
      expect(isVisible(element.querySelector('.e-popup'))).toEqual(true);
      expect(nav_icon.classList.contains('e-popup-up-icon')).toEqual(true);
      ...
      expect(nav_down_icon.classList.contains('e-popup-down-icon')).toEqual(
        true
      );
      expect(isVisible(element.querySelector('.e-popup'))).toEqual(false);
      (<HTMLElement>(
  ...
  describe('Content security issue in toolbar ', () => {
    ...
    it('Check rendered toolbar items', () => {
      ...
      toolbar.appendTo('#ej2Toolbar');
      const toolbarItems: Element =
        toolbar.element.querySelector('.e-toolbar-items');
      expect(toolbarItems.children.length).toEqual(2);
      expect(toolbarItems.children[0].innerHTML).toEqual(
        '<input placeholder="Search" tabindex="-1" data-tabindex="-1">'
      );
      expect(toolbarItems.children[0].textContent).toEqual('');
      expect(toolbarItems.children[1].innerHTML).toEqual(
        '<div id="toolbar-template" tabindex="-1" data-tabindex="-1">toolbar template</div>'
      );
  ...
  describe('ES-837389-Toolbar scrollable buttons are not appears while rendering the Toolbar inside the dialog', () => {
    ...
    const androidUserAgent: string =
      'Mozilla/5.0 (Linux; Android 9; Pixel 2 Build/PPR1.180610.009)' +
    ...
    it('Checking scroll button present in mobile mode', () => {
      ...
      expect(ele.classList.contains('e-scroll-device')).toBe(true);
      const rightOrientation: HTMLElement = ele.querySelector(
        '.e-scroll-right-nav'
      );
    ...
    it('keyboard interaction toolbar template testing ', () => {
      ...
      toolbar = new Toolbar({
        items: [
          { type: 'Button', text: 'new', align: 'Left' },
          {
            template: "<button id='Template1'>Button</button>",
            type: 'Button',
            text: 'Underline',
            tooltipText: 'Underline',
          },
          {
            template: "<button id='Template2'>Button1</button>",
            type: 'Button',
            text: 'Bold',
            tooltipText: 'Bold',
          },
  ...
  describe('keyboard accessibility in toolbar items ', () => {
    ...
    it('tab key accessibility in Popup mode', () => {
      ...
      const popupElement: HTMLElement =
        toolbar.element.querySelector('.e-hor-nav');
  ...
  describe('Extended overflow mode in toolbar items ', () => {
    ...
    it('Extended popup width testing', () => {
      ...
      let extendedToolbar: HTMLElement = element.querySelector(
        '.e-toolbar-extended'
      );
