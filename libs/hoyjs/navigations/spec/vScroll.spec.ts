...
let innerItemsHTMLString: string =
...
describe('Vertical ScrollBar Base', () => {
  ...
  let css: string =
    ' button {font-family:Arial; font-size: 14px; padding: 1px 6px;} .e-rtl { direction: rtl; } .e-vscroll > * { height: inherit; } .e-scroll-nav { height: 3px; } ';
  ...
  describe('Base Testing', () => {
    ...
    it('Content class test', () => {
      expect(
        (<HTMLElement>targetEle.querySelector('.e-vscroll-content'))
          .childElementCount == 6
      ).toEqual(true);
    });
  ...
  describe('RTL with overlay Testing', () => {
    ...
    beforeEach((): void => {
      ...
      ele.id = 'Sample';
      ele.innerHTML =
        "<div id= 'innerItems' style='display: block;'><div id='item' style='display: block;'><button> Btn_style</button></div><div id='item' class='e-overlay' style='display: block;'><button> Stylllllle</button></div><div id='item' class='e-overlay' style='display: block;'><button> Stylllllle</button></div></div>";
      setStyleAttribute(ele, {
        width: '100px',
        height: '50px',
        'white-space': 'nowrap',
    ...
    it('RTL Testing', () => {
      ...
      expect(
        scrollEle.firstElementChild.children[2].classList.contains('e-overlay')
      ).toBe(true);
      expect(
        scrollEle.firstElementChild.children[1].classList.contains('e-overlay')
      ).toBe(true);
      expect(
        scrollEle.firstElementChild.children[0].classList.contains('e-overlay')
      ).toBe(false);
      ...
      navEleDown.click();
      scrollEle.dispatchEvent(scrollEvent);
      expect(navEleDown.parentElement.classList.contains('e-overlay')).toBe(
        false
      );
      expect(navEleDown.parentElement.getAttribute('aria-disabled')).toBe(
        'false'
      );
  ...
  describe('Key long press Testing', () => {
    ...
    it('Key long press Testing with continous moving', () => {
      let scroll: HTMLElement = <HTMLElement>(
        document.querySelector('.e-vscroll-bar')
      );
  ...
  describe('Device Testing', () => {
    ...
    it('Cross browser Device Arrow and overlay testing', () => {
      ...
      expect(
        scroll.element.children[2].classList.contains(CLS_DOWNOVERLAY)
      ).toBe(true);
      expect(scroll.element.children[0].classList.contains(CLS_UPOVERLAY)).toBe(
        true
      );
