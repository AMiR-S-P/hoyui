...
describe('Sidebar', () => {
  ...
  describe('Sidebar DOM class Testing ', () => {
    ...
    it('Sidebar with enableRtl true test case', () => {
      ...
      sidebar.show();
      expect(
        document.getElementById('sidebar').classList.contains('e-rtl')
      ).toBe(true);
    });
    ...
    it('Sidebar with animation disabled test case', () => {
      ...
      expect(
        document
          ...
          .classList.contains('e-disable-animation')
      ).toBe(true);
    });
    ...
    it('Sidebar with e-visibility test case', () => {
      ...
      expect(
        document.getElementById('sidebar').classList.contains('e-visibility')
      ).toBe(true);
      sidebar.show();
      expect(
        document.getElementById('sidebar').classList.contains('e-visibility')
    ...
    it('Sidebar with auto type and mediaQuery test case', () => {
      ...
      let sibling: HTMLElement = <HTMLElement>ele.nextElementSibling;
      sidebar = new Sidebar(
        { type: 'Auto', mediaQuery: '(min-width:1400px)' },
        ele
      );
      expect(
        document.getElementById('sidebar').classList.contains('e-visibility')
      ...
      expect(
        document.getElementById('sidebar').classList.contains('e-close')
      ).toBe(false);
    });
    it('Sidebar with auto type and mediaQuer list test case', () => {
      ...
      let sibling: HTMLElement = <HTMLElement>ele.nextElementSibling;
      sidebar = new Sidebar(
        { type: 'Auto', mediaQuery: window.matchMedia('min-width:1400px') },
        ele
      );
      expect(
        document.getElementById('sidebar').classList.contains('e-visibility')
    ...
    it('Sidebar main content animation class testing', () => {
      ...
      expect(
        (<HTMLElement>(
          document.querySelector('.e-content-section')
        )).classList.contains('e-content-animation')
      ).toBe(true);
    });
    ...
    it('Sidebar push with left position testing', () => {
      ...
      expect(
        (<HTMLElement>document.querySelector('.e-content-section')).style
          .marginRight
      ).toBe('');
      expect(
        (<HTMLElement>document.querySelector('.e-content-section')).style
    ...
    it('Sidebar enableGestures test case', () => {
      ...
      expect(
        document.getElementById('sidebar').classList.contains('e-touch')
      ).toBe(true);
    ...
    it('Sidebar with swipe towards right direction test case', () => {
      ...
      sidebar.show();
      expect(
        document.getElementById('sidebar').classList.contains('e-open')
      ).toBe(true);
    ...
    it('Sidebar Base property Testing', () => {
      ...
      expect(isNullOrUndefined(document.getElementById('sidebar'))).toEqual(
        false
      );
    ...
    it('Sidebar over type with left position test case', () => {
      ...
      sidebar.hide();
      expect(
        document.getElementById('sidebar').classList.contains('e-push')
      ).toBe(true);
      expect(document.getElementById('sidebar').style.width).toEqual('300px');
      expect(document.getElementById('sidebar').style.transform).toEqual('');
      expect(
    ...
    it('Sidebar over type with right position test case', () => {
      ...
      let sibling: HTMLElement = <HTMLElement>ele.nextElementSibling;
      sidebar = new Sidebar(
        { type: 'Auto', width: '300px', position: 'Right' },
        ele
      );
      expect(
        document.getElementById('sidebar').classList.contains('e-open')
    ...
    it('isOpen false against auto in dock mode', () => {
      ...
      let sibling: HTMLElement = <HTMLElement>ele.nextElementSibling;
      sidebar = new Sidebar(
        { isOpen: false, type: 'Auto', enableDock: true, dockSize: '72px' },
        ele
      );
      expect(sidebar.element.classList.contains('e-open')).toBe(true);
      expect(sidebar.isOpen).toBe(true);
    ...
    it('isOpen true against auto in dock mode', () => {
      ...
      let sibling: HTMLElement = <HTMLElement>ele.nextElementSibling;
      sidebar = new Sidebar(
        { isOpen: true, type: 'Auto', enableDock: true, dockSize: '72px' },
        ele
      );
      expect(sidebar.element.classList.contains('e-open')).toBe(true);
      expect(sidebar.isOpen).toBe(true);
    ...
    it('isOpen false against slide in dock mode', () => {
      ...
      let sibling: HTMLElement = <HTMLElement>ele.nextElementSibling;
      sidebar = new Sidebar(
        { isOpen: false, type: 'Slide', enableDock: true, dockSize: '72px' },
        ele
      );
      expect(sidebar.element.classList.contains('e-close')).toBe(true);
      expect(sidebar.isOpen).toBe(false);
    ...
    it('isOpen true against slide in dock mode', () => {
      ...
      let sibling: HTMLElement = <HTMLElement>ele.nextElementSibling;
      sidebar = new Sidebar(
        { isOpen: true, type: 'Slide', enableDock: true, dockSize: '72px' },
        ele
      );
      expect(sidebar.element.classList.contains('e-open')).toBe(true);
      expect(sidebar.isOpen).toBe(true);
    ...
    it('isOpen false against push in dock mode', () => {
      ...
      let sibling: HTMLElement = <HTMLElement>ele.nextElementSibling;
      sidebar = new Sidebar(
        { isOpen: false, type: 'Push', enableDock: true, dockSize: '72px' },
        ele
      );
      expect(sidebar.element.classList.contains('e-close')).toBe(true);
      expect(sidebar.isOpen).toBe(false);
    ...
    it('isOpen true against push in dock mode', () => {
      ...
      let sibling: HTMLElement = <HTMLElement>ele.nextElementSibling;
      sidebar = new Sidebar(
        { isOpen: true, type: 'Push', enableDock: true, dockSize: '72px' },
        ele
      );
      expect(sidebar.element.classList.contains('e-open')).toBe(true);
      expect(sidebar.isOpen).toBe(true);
    ...
    it('Sidebar closeOnDocumentClick onproperty change test', () => {
      ...
      sidebar.dataBind();
      triggerMouseEvent(
        <HTMLElement>document.querySelector('.e-content-section'),
        'mousedown'
      );
      expect(sidebar.element.classList.contains('e-close')).toBe(true);
    });
    ...
    it('Sidebar with dock size(250px) default test case', () => {
      ...
      let sibling: HTMLElement = <HTMLElement>ele.nextElementSibling;
      sidebar = new Sidebar(
        { enableDock: true, dockSize: '250px', width: '500px' },
        ele
      );
      expect(ele.classList.contains('e-dock')).toEqual(true);
      expect(ele.classList.contains('e-open')).toEqual(true);
    ...
    it('Sidebar with dock size default test case', () => {
      ...
      let sibling: HTMLElement = <HTMLElement>ele.nextElementSibling;
      sidebar = new Sidebar(
        { enableDock: true, dockSize: '300', width: '500px' },
        ele
      );
      expect(ele.classList.contains('e-dock')).toEqual(true);
      expect(ele.classList.contains('e-open')).toEqual(true);
    ...
    it('Sidebar with dock size(250px) closed test case', () => {
      ...
      let sibling: HTMLElement = <HTMLElement>ele.nextElementSibling;
      sidebar = new Sidebar(
        { enableDock: true, dockSize: '250px', width: '300px', isOpen: false },
        ele
      );
      expect(ele.classList.contains('e-dock')).toEqual(true);
      expect(ele.classList.contains('e-open')).toEqual(true);
    ...
    it('Sidebar with dock size closed test case', () => {
      ...
      let sibling: HTMLElement = <HTMLElement>ele.nextElementSibling;
      sidebar = new Sidebar(
        { enableDock: true, dockSize: '150', width: '300px', isOpen: false },
        ele
      );
      expect(ele.classList.contains('e-dock')).toEqual(true);
      expect(ele.classList.contains('e-open')).toEqual(true);
    ...
    it('Sidebar with dock size slide test case', () => {
      ...
      let sibling: HTMLElement = <HTMLElement>ele.nextElementSibling;
      sidebar = new Sidebar(
        { enableDock: true, dockSize: '300', type: 'Slide' },
        ele
      );
      expect(ele.classList.contains('e-dock')).toEqual(true);
    ...
    it('Sidebar with dock size push test case', () => {
      ...
      let sibling: HTMLElement = <HTMLElement>ele.nextElementSibling;
      sidebar = new Sidebar(
        { enableDock: true, dockSize: '300', type: 'Push' },
        ele
      );
      expect(ele.classList.contains('e-dock')).toEqual(true);
      expect(ele.classList.contains('e-open')).toEqual(false);
    ...
    it('Sidebar with dock size over test case', () => {
      ...
      let sibling: HTMLElement = <HTMLElement>ele.nextElementSibling;
      sidebar = new Sidebar(
        { enableDock: true, dockSize: '300', type: 'Over' },
        ele
      );
      expect(ele.classList.contains('e-dock')).toEqual(true);
      expect(ele.classList.contains('e-open')).toEqual(false);
    ...
    it('Sidebar  with mediaQuery greater than 700px test case', () => {
      ...
      let sibling: HTMLElement = <HTMLElement>ele.nextElementSibling;
      sidebar = new Sidebar(
        { type: 'Push', mediaQuery: window.matchMedia('(min-width:700px)') },
        ele
      );
      expect(ele.classList.contains('e-open')).toEqual(true);
    });
    ...
    it('Sidebar  with mediaQuery less than 400px test case', () => {
      ...
      let sibling: HTMLElement = <HTMLElement>ele.nextElementSibling;
      sidebar = new Sidebar(
        { type: 'Push', mediaQuery: '(max-width:400px)' },
        ele
      );
      expect(ele.classList.contains('e-close')).toEqual(true);
    });
    it('Sidebar  with mediaQuery less than 400px test case', () => {
      ...
      let sibling: HTMLElement = <HTMLElement>ele.nextElementSibling;
      sidebar = new Sidebar(
        { type: 'Auto', mediaQuery: '(max-width:400px)' },
        ele
      );
      expect(ele.classList.contains('e-close')).toEqual(false);
      ...
      sidebar = new Sidebar(
        {
          type: 'Push',
          position: 'Right',
          target: <HTMLElement>document.querySelector('.e-context-element'),
        },
        ele
      );
      expect(
        document
          .querySelectorAll('.e-context-element .e-sidebar')[0]
          .classList.contains('e-sidebar')
      ).toBe(true);
      expect(
        document
          .querySelectorAll('.e-context-element')[0]
          .classList.contains('e-sidebar-context')
      ).toBe(true);
      expect(
        document
          .querySelectorAll('.e-context-element .e-sidebar')[0]
          .classList.contains('e-sidebar-absolute')
      ).toBe(true);
      expect(
        (<HTMLElement>(
          document.getElementById('sidebar').nextElementSibling
        )).classList.contains('e-content-animation')
      ).toBe(true);
      sidebar.show();
      expect(
        (<HTMLElement>document.getElementById('sidebar').nextElementSibling)
          .style.transform
      ).toBe('translateX(0px)');
      expect(
        (<HTMLElement>document.getElementById('sidebar').nextElementSibling)
    ...
    it('Sidebar context with backdrop propert test case', () => {
      ...
      expect(
        document
          .getElementById('sidebar')
          .nextElementSibling.classList.contains('e-backdrop')
      ).toBe(false);
      sidebar.hide();
      expect(
        (<HTMLElement>document.getElementById('sidebar').nextElementSibling)
    ...
    it('Sidebar backdrop testing', () => {
      ...
      sidebar.show();
      expect(
        (<HTMLElement>document.querySelector('.e-sidebar-overlay')).style
          .display
      ).toEqual('block');
      expect(
        (<HTMLElement>(
          document.querySelector('.e-sidebar-overlay')
        )).classList.contains('e-sidebar-overlay')
      ).toBe(true);
      //onproperty changes
    ...
    it('Sidebar persisitence test case', () => {
      ...
      expect(
        document.getElementById('sidebar').classList.contains('e-over')
      ).toBe(true);
    });
    ...
    it('Sidebar zindex property test case', () => {
      ...
      sidebar = new Sidebar({ type: 'Over', zIndex: '300' }, ele);
      sidebar.show();
      expect(ele.classList.contains('e-open') && sidebar.getState()).toEqual(
        true
      );
    ...
    it('Sidebar hide method testing', () => {
      ...
      sidebar = new Sidebar({}, ele);
      sidebar.hide();
      expect(ele.classList.contains('e-close') && !sidebar.getState()).toEqual(
        true
      );
    });
    ...
    it('Sidebar getState with mediaQuery list 500 to 800 string testing', () => {
      let ele: HTMLElement = document.getElementById('sidebar');
      let sibling: HTMLElement = <HTMLElement>ele.nextElementSibling;
      let ac: MediaQueryList = window.matchMedia(
        '(min-width:500px) and (max-width:1300px)'
      );
      sidebar = new Sidebar({ mediaQuery: ac, type: 'Push' }, ele);
      expect(ele.classList.contains('e-open')).toEqual(true);
    });
    ...
    it('Sidebar push type with dock type test case', () => {
      ...
      let sibling: HTMLElement = <HTMLElement>ele.nextElementSibling;
      sidebar = new Sidebar(
        { type: 'Push', enableDock: true, dockSize: 300 },
        ele
      );
      expect(document.getElementById('sidebar').style.width).toEqual('300px');
      expect(document.getElementById('sidebar').style.transform).toEqual(
        'translateX(-100%) translateX(300px)'
      );
      expect(
        (<HTMLElement>document.querySelector('.e-content-section')).style
          .marginLeft
    ...
    it('without docksize with right position property test case', () => {
      ...
      let sibling: HTMLElement = <HTMLElement>ele.nextElementSibling;
      sidebar = new Sidebar(
        { enableDock: true, width: 'auto', position: 'Right' },
        ele
      );
    ...
    it('Sidebar slide type with dock type test case', () => {
      ...
      let sibling: HTMLElement = <HTMLElement>ele.nextElementSibling;
      sidebar = new Sidebar(
        { type: 'Slide', enableDock: true, dockSize: 300, width: '300px' },
        ele
      );
      expect(document.getElementById('sidebar').style.width).toEqual('300px');
      expect(document.getElementById('sidebar').style.transform).toEqual(
      ...
      expect(
        (<HTMLElement>document.querySelector('.e-content-section')).style
          .transform
      ).toBe('translateX(300px)');
      expect(
        document.getElementById('sidebar').classList.contains('e-slide')
      ).toBe(true);
      expect(
        document.getElementById('sidebar').classList.contains('e-left')
      ).toBe(true);
    });
    ...
    it('Sidebar over type with dock type test case', () => {
      ...
      let sibling: HTMLElement = <HTMLElement>ele.nextElementSibling;
      sidebar = new Sidebar(
        { type: 'Over', enableDock: true, dockSize: 300, width: '300px' },
        ele
      );
      expect(document.getElementById('sidebar').style.width).toEqual('300px');
      expect(document.getElementById('sidebar').style.transform).toEqual(
    ...
    it("Sidebar with 'Push' type , 'Left' position and dock enabled test case", () => {
      ...
      let sibling: HTMLElement = <HTMLElement>ele.nextElementSibling;
      sidebar = new Sidebar(
        { type: 'Push', enableDock: true, dockSize: 200, width: '300px' },
        ele
      );
      sidebar.show();
      expect(document.getElementById('sidebar').style.transform).toEqual('');
      ...
      expect(document.getElementById('sidebar').style.transform).toEqual(
        'translateX(-100%) translateX(200px)'
      );
      expect(
        (<HTMLElement>document.querySelector('.e-content-section')).style
          .marginLeft
    ...
    it("Sidebar with 'Push' type , 'Right' position and dock enabled test case", () => {
      ...
      expect(
        document.getElementById('sidebar').classList.contains('e-right')
      ).toBe(true);
    });
    ...
    it("Sidebar with  'Over' type , 'Left' position and dock enabled test case", () => {
      ...
      let sibling: HTMLElement = <HTMLElement>ele.nextElementSibling;
      sidebar = new Sidebar(
        { type: 'Over', enableDock: true, dockSize: 200, width: '300px' },
        ele
      );
      expect(document.getElementById('sidebar').style.transform).toEqual(
        'translateX(-100%) translateX(200px)'
    ...
    it('Sidebar push type with left position test case', () => {
      ...
      let sibling: HTMLElement = <HTMLElement>ele.nextElementSibling;
      sidebar = new Sidebar(
        { type: 'Push', position: 'Left', width: '300px' },
        ele
      );
      expect(
        document.getElementById('sidebar').classList.contains('e-left')
    ...
    it('Sidebar push type with right position test case', () => {
      ...
      let sibling: HTMLElement = <HTMLElement>ele.nextElementSibling;
      sidebar = new Sidebar(
        { type: 'Push', position: 'Right', width: '300px' },
        ele
      );
      expect(
        document.getElementById('sidebar').classList.contains('e-close')
    ...
    it('Sidebar slide type with left position test case', () => {
      ...
      let sibling: HTMLElement = <HTMLElement>ele.nextElementSibling;
      sidebar = new Sidebar(
        { type: 'Slide', position: 'Left', width: '300px' },
        ele
      );
      expect(
        document.getElementById('sidebar').classList.contains('e-left')
    ...
    it('Sidebar slide type with right position test case', () => {
      ...
      let sibling: HTMLElement = <HTMLElement>ele.nextElementSibling;
      sidebar = new Sidebar(
        { type: 'Slide', position: 'Right', width: '300px' },
        ele
      );
      expect(
        document.getElementById('sidebar').classList.contains('e-close')
    ...
    it('Sidebar over type with left position test case', () => {
      ...
      let sibling: HTMLElement = <HTMLElement>ele.nextElementSibling;
      sidebar = new Sidebar(
        { type: 'Over', position: 'Left', width: '300px' },
        ele
      );
      expect(
        document.getElementById('sidebar').classList.contains('e-left')
    ...
    it('Sidebar over type with right position test case', () => {
      ...
      let sibling: HTMLElement = <HTMLElement>ele.nextElementSibling;
      sidebar = new Sidebar(
        { type: 'Over', position: 'Right', width: '300px' },
        ele
      );
      expect(
        document.getElementById('sidebar').classList.contains('e-right')
    ...
    describe('Sidebar auto type in mobile test case ', () => {
      ...
      it('Sidebar type auto with left position test case', () => {
        ...
        let sibling: HTMLElement = <HTMLElement>ele.nextElementSibling;
        sidebar = new Sidebar(
          { type: 'Auto', position: 'Left', width: '300px' },
          ele
        );
        expect(
          document.getElementById('sidebar').classList.contains('e-over')
      ...
      it('Sidebar type slide with overflow-x hidden class test case', () => {
        ...
        sidebar = new Sidebar({ type: 'Slide' }, ele);
        sidebar.show();
        expect(document.body.classList.contains('e-sidebar-overflow')).toBe(
          true
        );
        sidebar.hide();
        expect(document.body.classList.contains('e-sidebar-overflow')).toBe(
      ...
      it('Sidebar type auto in mobile  test case', () => {
        let ele: HTMLElement = document.getElementById('sidebar');
        sidebar = new Sidebar(
          { type: 'Auto', enableDock: true, dockSize: '300px' },
          ele
        );
        expect(sidebar.position == 'Left').toEqual(true);
        expect(isNullOrUndefined(document.getElementById('sidebar'))).toEqual(
      ...
      it('Sidebar with dock size test case', () => {
        ...
        let sibling: HTMLElement = <HTMLElement>ele.nextElementSibling;
        sidebar = new Sidebar(
          { enableDock: true, dockSize: '300', isOpen: true, width: '500px' },
          ele
        );
        expect(ele.classList.contains('e-dock')).toEqual(true);
        expect(ele.classList.contains('e-open')).toEqual(true);
      ...
      it('Sidebar target property onproperty change test case', () => {
        let ele: HTMLElement = document.getElementById('sidebar');
        sidebar = new Sidebar({}, ele);
        sidebar.target = <HTMLElement>(
          document.querySelector('.e-context-element')
        );
        sidebar.dataBind();
        expect(
          sidebar.element.parentElement.classList.contains('e-sidebar-context')
        ).toBe(true);
        expect(sidebar.element.classList.contains('e-sidebar-absolute')).toBe(
          true
        );
        sidebar.target = null;
        sidebar.dataBind();
...
describe('Sidebar testing ', () => {
  ...
  it('two Sidebar with same target test case', () => {
    let ele: HTMLElement = document.getElementById('sidebar');
    sidebar = new Sidebar(
      { type: 'Push', target: '.maincontent', width: '250px' },
      ele
    );
