...
const triggerSwipeEvent: Function = (
  target: Element,
  x?: number,
  y?: number
): void => {
...
describe('Carousel Testing', () => {
  ...
  const carouselItems: CarouselItemModel[] = [
    ...
    {
      template: 'base/demos/carousel/images/nature.jpg',
      htmlAttributes: { 'data-custom': 'test' },
    },
    { template: 'base/demos/carousel/images/night-view.jpg' },
    { template: 'base/demos/carousel/images/sae-view.jpg' },
    { template: 'base/demos/carousel/images/snowfall.jpg' },
  ...
  const itemTemplate: HTMLElement = createElement('script', {
    id: 'itemTemplate',
    attrs: { type: 'text/x-template' },
  });
  itemTemplate.innerHTML = '<div class="title">${Title}</div>';
  const indicatorTemp: HTMLElement = createElement('script', {
    id: 'indicatorTemplate',
    attrs: { type: 'text/x-template' },
  });
  indicatorTemp.innerHTML = '<div class="indicator"></div>';
  const arrowTemp: HTMLElement = createElement('script', {
    id: 'arrowTemplate',
    attrs: { type: 'text/x-template' },
  });
  arrowTemp.innerHTML =
    '<button class="arrowTemp btn h-100 w-100">${if (type === "Previous")}<i class="bi bi-caret-left"></i>${else}<i class="bi bi-caret-right"></i>${/if}</button>';
  const playButtonTemp: HTMLElement = createElement('script', {
    id: 'playButtonTemplate',
    attrs: { type: 'text/x-template' },
  });
  playButtonTemp.innerHTML =
    '<button class="playTemp btn h-100 w-100"> <i class="bi bi-pause pause"></i></button>';
  ...
  describe('DOM', () => {
    ...
    it('checking component render', () => {
      ...
      expect(
        document.getElementById('carousel').classList.contains('e-carousel')
      ).toBe(true);
    });
  });
  ...
  describe('Carousel Properties', () => {
    ...
    it('test case for cssClass', () => {
      ...
      carousel = new Carousel(
        { items: items, cssClass: 'carousel-custom' },
        carouselElement
      );
      expect(carouselElement.classList.contains('carousel-custom')).toEqual(
        true
      );
    });
    it('test case for htmlAttributes', () => {
      const carouselElement: HTMLElement = document.getElementById('carousel');
      carousel = new Carousel(
        { items: items, htmlAttributes: { 'data-custom': 'test' } },
        carouselElement
      );
    ...
    it('test case for passing class in htmlAttributes', () => {
      const carouselElement: HTMLElement = document.getElementById('carousel');
      carousel = new Carousel(
        { items: items, htmlAttributes: { class: 'test' } },
        carouselElement
      );
    ...
    it('test cases for showIndicators as true', () => {
      const carouselElement: HTMLElement = document.getElementById('carousel');
      carousel = new Carousel(
        { items: items, showIndicators: true },
        carouselElement
      );
      expect(
        carouselElement.querySelector('.e-carousel-indicators') !== null
      ).toBe(true);
      expect(
        carouselElement.querySelectorAll('.e-indicator-bar').length
      ).toEqual(items.length);
      expect(
        carouselElement
          .querySelectorAll('.e-indicator-bar')
          [carousel.selectedIndex].classList.contains('e-active')
      ).toBe(true);
    });
    it('test cases for showIndicators as false', () => {
      const carouselElement: HTMLElement = document.getElementById('carousel');
      carousel = new Carousel(
        { items: items, showIndicators: false },
        carouselElement
      );
      expect(
        carouselElement.querySelector('.e-carousel-indicators') !== null
    ...
    it('test cases for showArrows as Never', () => {
      const carouselElement: HTMLElement = document.getElementById('carousel');
      carousel = new Carousel(
        { items: items, buttonsVisibility: 'Hidden' },
        carouselElement
      );
      expect(
        carouselElement.querySelector('.e-carousel-navigators') !== null
      ).toBe(false);
    ...
    it('test cases for showArrows as Visible', () => {
      const carouselElement: HTMLElement = document.getElementById('carousel');
      carousel = new Carousel(
        { items: items, buttonsVisibility: 'Visible' },
        carouselElement
      );
      expect(
        carouselElement.querySelector('.e-carousel-navigators') !== null
      ).toBe(true);
      expect(carouselElement.querySelector('.e-hover-arrows') === null).toBe(
        true
      );
    });
    it('test cases for showArrows as OnHover', () => {
      const carouselElement: HTMLElement = document.getElementById('carousel');
      carousel = new Carousel(
        { items: items, buttonsVisibility: 'VisibleOnHover' },
        carouselElement
      );
      expect(
        carouselElement.querySelector('.e-carousel-navigators') !== null
    ...
    it('test cases for selectedIndex', () => {
      const carouselElement: HTMLElement = document.getElementById('carousel');
      carousel = new Carousel(
        { items: items, selectedIndex: 2 },
        carouselElement
      );
      expect(
        carouselElement
          .querySelectorAll('.e-carousel-item')
          [carousel.selectedIndex + 1].classList.contains('e-active')
      ).toBe(true);
      expect(
        carouselElement
          .querySelectorAll('.e-indicator-bar')
    ...
    it('test cases for showPlayButton as true', () => {
      const carouselElement: HTMLElement = document.getElementById('carousel');
      carousel = new Carousel(
        { items: items, showPlayButton: true },
        carouselElement
      );
      expect(carouselElement.querySelector('.e-play-pause') !== null).toBe(
        true
      );
      expect(carouselElement.querySelector('.e-pause-icon') !== null).toBe(
        true
      );
    ...
    it('test cases for showPlayButton as true when prev/next arrows hidden', () => {
      const carouselElement: HTMLElement = document.getElementById('carousel');
      carousel = new Carousel(
        { items: items, buttonsVisibility: 'Hidden', showPlayButton: true },
        carouselElement
      );
      expect(carouselElement.querySelector('.e-play-pause') === null).toBe(
        true
    ...
    it('test cases for showPlayButton as false', () => {
      const carouselElement: HTMLElement = document.getElementById('carousel');
      carousel = new Carousel(
        { items: items, showPlayButton: false },
        carouselElement
      );
      expect(carouselElement.querySelector('.e-play-pause') !== null).toBe(
        false
    ...
    it('test cases for autoPlay as true', () => {
      const carouselElement: HTMLElement = document.getElementById('carousel');
      carousel = new Carousel(
        { animationEffect: 'None', items: items, autoPlay: true },
        carouselElement
      );
      ...
      expect(
        carouselElement
          .querySelectorAll('.e-carousel-item')
          [index + 1].classList.contains('e-active')
      ).toBe(true);
      jasmine.clock().tick(carousel.interval + 1500);
    ...
    it('test cases for autoPlay as false', () => {
      const carouselElement: HTMLElement = document.getElementById('carousel');
      carousel = new Carousel(
        { animationEffect: 'None', items: items, autoPlay: false },
        carouselElement
      );
      const index: number = carousel.selectedIndex;
      expect(
      ...
      (
        carouselElement.querySelector('.e-previous-icon') as HTMLElement
      ).click();
      jasmine.clock().tick(carousel.interval + 1500);
      expect(
        carouselElement
          .querySelectorAll('.e-carousel-item')[1]
          .classList.contains('e-active')
      ).toBe(false);
      expect(
        carouselElement
          .querySelectorAll('.e-carousel-item')[5]
          .classList.contains('e-active')
      ).toBe(true);
    ...
    it('test cases for interval', () => {
      const carouselElement: HTMLElement = document.getElementById('carousel');
      carousel = new Carousel(
        { animationEffect: 'None', items: items, interval: 2000 },
        carouselElement
      );
      const index: number = carousel.selectedIndex;
      expect(
    ...
    it('test cases for infinite as true', () => {
      const carouselElement: HTMLElement = document.getElementById('carousel');
      carousel = new Carousel(
        { animationEffect: 'None', items: items, selectedIndex: 4, loop: true },
        carouselElement
      );
      expect(
        carouselElement
    ...
    it('test cases for infinite as false', () => {
      const carouselElement: HTMLElement = document.getElementById('carousel');
      carousel = new Carousel(
        { animationEffect: 'None', items: items, loop: false },
        carouselElement
      );
      jasmine.clock().tick(carousel.interval + 1500);
    ...
    it('enableTouchSwipe - swiping left', () => {
      const carouselElement: HTMLElement = document.getElementById('carousel');
      carousel = new Carousel(
        { animationEffect: 'None', items: items },
        carouselElement
      );
      expect(
        carouselElement
      ...
      expect(
        carouselElement
          .querySelectorAll('.e-carousel-item')[2]
          .classList.contains('e-active')
      ).toBe(false);
      expect(carousel.selectedIndex).toEqual(0);
    ...
    it('enableTouchSwipe - swiping right', () => {
      ...
      expect(
        carouselElement
          .querySelectorAll('.e-carousel-item')[4]
          .classList.contains('e-active')
      ).toBe(true);
      expect(
        carouselElement
  ...
  describe('test case for partialslide with loop', () => {
    ...
    it('test case for partialslide previous arrow', () => {
      const carouselElement: HTMLElement = document.getElementById('carousel');
      carousel = new Carousel(
        { items: items, animationEffect: 'None', partialVisible: true },
        carouselElement
      );
      ...
      expect(
        carouselElement
          .querySelectorAll('.e-carousel-item')[3]
          .classList.contains('e-active')
      ).toBe(false);
      expect(carousel.selectedIndex).toEqual(0);
      (
      ...
      expect(
        carouselElement
          .querySelectorAll('.e-carousel-item')[6]
          .classList.contains('e-active')
      ).toBe(true);
      expect(carousel.selectedIndex).toEqual(4);
    ...
    it('test case for partialslide next arrow', () => {
      const carouselElement: HTMLElement = document.getElementById('carousel');
      carousel = new Carousel(
        { animationEffect: 'None', items: items, partialVisible: true },
        carouselElement
      );
      expect(carouselElement.classList.contains('e-partial')).toBe(true);
      expect(
    ...
    it('test cases for partialslide pause on hover', () => {
      ...
      expect(carouselElement.classList.contains('e-partial')).toBe(true);
      expect(carouselElement.classList.contains('e-carousel-hover')).toBe(
        false
      );
    ...
    it('test cases for partialslide clicking on the indicators for Navigation', () => {
      ...
      expect(
        carouselElement
          .querySelectorAll('.e-indicator-bar')[0]
          .classList.contains('e-active')
      ).toBe(true);
      expect(
        carouselElement
          .querySelectorAll('.e-indicator-bar')[4]
          .classList.contains('e-active')
      ).toBe(false);
      expect(carousel.selectedIndex).toEqual(0);
      (
        carouselElement.querySelectorAll('.e-indicator-bar')[4] as HTMLElement
      ).click();
      jasmine.clock().tick(1500);
      expect(
        carouselElement
      ...
      expect(carousel.selectedIndex).toEqual(4);
      (
        carouselElement.querySelectorAll('.e-indicator-bar')[2] as HTMLElement
      ).click();
      expect(
        carouselElement
          .querySelectorAll('.e-indicator-bar')[2]
          .classList.contains('e-active')
      ).toBe(true);
      expect(
        carouselElement
    ...
    it('test case for partialslide dynamically changing loop', () => {
      ...
      expect(
        carouselElement
          .querySelectorAll('.e-carousel-item')[0]
          .classList.contains('e-active')
      ).toBe(false);
    ...
    it('test case for partialslide dynamically changing partialVisible', () => {
      ...
      expect(carouselElement.classList.contains('e-partial')).toBe(true);
      expect(
        carouselElement.querySelectorAll('.e-carousel-item').length
      ).toEqual(9);
      expect(
        carouselElement
          .querySelectorAll('.e-carousel-item')[2]
    ...
    it('test case for partialslide with datasource', () => {
      ...
      const carouselItem: Element =
        carouselElement.querySelectorAll('.e-carousel-item')[2];
      expect(carouselItem.querySelectorAll('.title').length).toEqual(1);
      const templateElement: HTMLElement = carouselItem.querySelector(
        '.title'
      ) as HTMLElement;
    ...
    it('test case for partialslide item count', () => {
      ...
      const carouselItems: Element =
        carouselElement.querySelector('.e-carousel-items');
      expect(
        getComputedStyle(carouselItems).getPropertyValue(
    ...
    it('test case for partialslide transition property', () => {
      ...
      expect(
        getComputedStyle(carouselItems).getPropertyValue('transition-property')
      ).toBe('none');
      (carouselElement.querySelector('.e-next-icon') as HTMLElement).click();
      jasmine.clock().tick(1500);
      expect(
    ...
    it('test case for partialslide with EnableRtl ', () => {
      ...
      expect(
        carouselElement
          .querySelector('.e-carousel-navigators .e-previous-button')
          .classList.contains('e-rtl')
      ).toBe(false);
      expect(
        carouselElement
          .querySelector('.e-carousel-navigators .e-next-button')
          .classList.contains('e-rtl')
      ).toBe(false);
      expect(
        carouselElement
          .querySelector('.e-carousel-navigators .e-play-button')
          .classList.contains('e-rtl')
      ).toBe(false);
  ...
  describe('test case for arrows and play icons', () => {
    ...
    it('test case for disabled previous arrow', () => {
      ...
      expect(
        carouselElement
          .querySelector('.e-previous-button')
    ...
    it('test case for disabled next arrow', () => {
      ...
      expect(
        carouselElement.querySelector('.e-next-button').getAttribute('disabled')
      ).toEqual('');
      (carouselElement.querySelector('.e-next-icon') as HTMLElement).click();
      expect(carousel.selectedIndex).toEqual(4);
    });
    it('test case for play and pause button', () => {
      const carouselElement: HTMLElement = document.getElementById('carousel');
      carousel = new Carousel(
        { animationEffect: 'None', items: items, showPlayButton: true },
        carouselElement
      );
      expect(
        carouselElement
  ...
  describe('test case for indicators', () => {
    ...
    it('test case for clicking active indicator', () => {
      ...
      expect(carousel.selectedIndex).toEqual(0);
      (
        carouselElement.querySelectorAll('.e-indicator-bar')[0] as HTMLElement
      ).click();
      expect(
        carouselElement
          .querySelectorAll('.e-carousel-item')[1]
  ...
  describe('test case for indicators type', () => {
    ...
    it('test case for dynamic indicator type', () => {
      const carouselElement: HTMLElement = document.getElementById('carousel');
      carousel = new Carousel(
        { animationEffect: 'None', items: items, indicatorsType: 'Dynamic' },
        carouselElement
      );
      expect(
        carouselElement
          .querySelector('.e-carousel-indicators')
          .classList.contains('e-dynamic')
      ).toBe(true);
      expect(
        carouselElement
          .querySelector('.e-carousel-indicators')
          .classList.contains('e-progress')
      ).toBe(false);
      expect(
        carouselElement
          .querySelector('.e-carousel-indicators')
          .classList.contains('e-fraction')
      ).toBe(false);
      expect(
        carouselElement
          .querySelector('.e-carousel-indicators')
          .classList.contains('e-default')
      ).toBe(false);
      expect(
        carouselElement
          .querySelector('.e-indicator-bars .e-indicator-bar')
          .classList.contains('e-active')
      ).toBe(true);
      expect(
        carouselElement
          .querySelector('.e-indicator-bars .e-indicator-bar')
          .nextElementSibling.classList.contains('e-next')
      ).toBe(true);
      (carouselElement.querySelector('.e-next') as HTMLElement).click();
      jasmine.clock().tick(1500);
      expect(
        carouselElement
          .querySelectorAll('.e-indicator-bars .e-indicator-bar')[0]
          .classList.contains('e-active')
      ).toBe(false);
      expect(
        carouselElement
          .querySelectorAll('.e-indicator-bars .e-indicator-bar')[0]
          .classList.contains('e-prev')
      ).toBe(true);
      expect(
        carouselElement
          .querySelectorAll('.e-indicator-bars .e-indicator-bar')[1]
          .classList.contains('e-active')
      ).toBe(true);
      expect(
        carouselElement
          .querySelectorAll('.e-indicator-bars .e-indicator-bar')[2]
          .classList.contains('e-next')
      ).toBe(true);
      ...
      expect(
        carouselElement.querySelector('.e-indicator-bars').hasChildNodes()
      ).toBe(true);
      expect(
        carouselElement.querySelector('.e-indicator-bars').children.length
      ).toEqual(5);
    });
    it('test case for fraction indicator type', () => {
      const carouselElement: HTMLElement = document.getElementById('carousel');
      carousel = new Carousel(
        { animationEffect: 'None', items: items, indicatorsType: 'Fraction' },
        carouselElement
      );
      expect(
        carouselElement
      ...
      expect(
        carouselElement.querySelector('.e-indicator-bars').innerHTML
      ).toEqual('1 / 5');
      (carouselElement.querySelector('.e-next') as HTMLElement).click();
      jasmine.clock().tick(1500);
      expect(
    ...
    it('test case for progress indicator type', () => {
      const carouselElement: HTMLElement = document.getElementById('carousel');
      carousel = new Carousel(
        { animationEffect: 'None', items: items, indicatorsType: 'Progress' },
        carouselElement
      );
      expect(
        carouselElement
      ...
      var cssText = (
        carouselElement.querySelector('.e-indicator-bar') as HTMLElement
      ).style.cssText;
      const updatedString = cssText.replace(/\s/g, '');
      expect(updatedString).toContain(
        '--carousel-items-current:1;--carousel-items-count:5;'
      );
      (carouselElement.querySelector('.e-next') as HTMLElement).click();
      jasmine.clock().tick(1500);
      var cssTextChanged = (
      ...
      expect(updatedChangedString).toContain(
        '--carousel-items-current:2;--carousel-items-count:5;'
      );
      (carouselElement.querySelector('.e-previous') as HTMLElement).click();
      jasmine.clock().tick(1500);
      var cssTextPrev = (
      ...
      expect(updatedPrevString).toContain(
        '--carousel-items-current:1;--carousel-items-count:5;'
      );
      expect(
        carouselElement.querySelector('.e-indicator-bars').hasChildNodes()
  ...
  describe('test case for template indicators type', () => {
    ...
    it('checking indicators template in Dynamic indicator type', () => {
      ...
      const indicatorsEle: HTMLElement =
        carouselElement.querySelector('.e-indicator-bars');
      expect(
        carouselElement
          .querySelector('.e-carousel-indicators')
          .classList.contains('e-default')
  ...
  describe('test case for showing arrows on hover action', () => {
    ...
    it('when entering mouse inside carousel', () => {
      ...
      expect(
        carouselElement
          .querySelector('.e-previous')
          .classList.contains('e-hover-arrows')
      ).toBe(false);
      expect(
        carouselElement
      ...
      expect(
        carouselElement
          .querySelector('.e-play-pause')
          .classList.contains('e-hover-arrows')
      ).toBe(false);
      triggerMouseEvent(carouselElement, 'mouseleave');
      expect(
        carouselElement
          .querySelector('.e-carousel-navigators .e-previous')
          .classList.contains('e-hover-arrows')
      ).toBe(true);
      expect(
        carouselElement
          .querySelector('.e-carousel-navigators .e-play-pause')
          .classList.contains('e-hover-arrows')
      ).toBe(true);
      expect(
        carouselElement
          .querySelector('.e-carousel-navigators .e-next')
          .classList.contains('e-hover-arrows')
      ).toBe(true);
    });
  });
  ...
  describe('test case for animation effect', () => {
    ...
    it('checking slide animation', () => {
      const carouselElement: HTMLElement = document.getElementById('carousel');
      carousel = new Carousel(
        { items: items, showPlayButton: true, animationEffect: 'Slide' },
        carouselElement
      );
      expect(
        carouselElement.classList.contains('e-carousel-slide-animation')
      ).toBe(true);
    });
    it('checking fade animation', () => {
      const carouselElement: HTMLElement = document.getElementById('carousel');
      carousel = new Carousel(
        { items: items, showPlayButton: true, animationEffect: 'Fade' },
        carouselElement
      );
      expect(
        carouselElement.classList.contains('e-carousel-fade-animation')
      ).toBe(true);
    });
    it('checking no animation', () => {
      const carouselElement: HTMLElement = document.getElementById('carousel');
      carousel = new Carousel(
        { items: items, showPlayButton: true, animationEffect: 'None' },
        carouselElement
      );
      expect(
        carouselElement.classList.contains('e-carousel-animation-none')
      ).toBe(true);
      expect(carousel.selectedIndex).toBe(0);
      jasmine.clock().tick(6500);
      expect(carousel.selectedIndex).toBe(1);
  ...
  describe('test case for custom animation', () => {
    ...
    it('checking custom animation', () => {
      ...
      expect(
        carouselElement.classList.contains('e-carousel-custom-animation')
      ).toBe(true);
  ...
  describe('test case for preventing slide transition', () => {
    ...
    it('check slide transition not occurs on clicking pause icon', () => {
      ...
      expect(carousel.selectedIndex).toEqual(0);
      expect(carouselElement.querySelector('.e-play-icon') !== null).toBe(
        false
      );
      (carouselElement.querySelector('.e-pause-icon') as HTMLElement).click();
      jasmine.clock().tick(6500);
  ...
  describe('test case for empty carousel', () => {
    ...
    it('with no items or dataSource', () => {
      ...
      expect(carouselElement.querySelectorAll('.e-carousel-item').length).toBe(
        0
      );
    });
  });
  describe('test case when no active element', () => {
    ...
    it('check slide transition when no active element', () => {
      ...
      removeClass(
        carouselElement.querySelectorAll('.e-carousel-item'),
        'e-active'
      );
      removeClass(
        carouselElement.querySelectorAll('.e-indicator-bar'),
        'e-active'
      );
    ...
    it('check slide transition when no active element for items(this case may happen when we move to next slide continuously)', () => {
      const carouselElement: HTMLElement = document.getElementById('carousel');
      carousel = new Carousel(
        { animationEffect: 'None', items: items, showIndicators: false },
        carouselElement
      );
      removeClass(
        carouselElement.querySelectorAll('.e-carousel-item'),
  ...
  describe('test case for play button template', () => {
    ...
    it('checking play button template availability', () => {
      ...
      const navigatorsEle: HTMLElement = carouselElement.querySelector(
        '.e-carousel-navigators'
      );
      expect(
        navigatorsEle.querySelector('.playTemp').classList.contains('playTemp')
      ).toBe(true);
    });
  ...
  describe('test case for arrow template', () => {
    ...
    it('checking templates', () => {
      ...
      carousel = new Carousel(
        {
          animationEffect: 'None',
          items: items,
          previousButtonTemplate: '#arrowTemplate',
          nextButtonTemplate: '#arrowTemplate',
        },
        carouselElement
      );
      const navigatorsEle: HTMLElement = carouselElement.querySelector(
      ...
      expect(
        navigatorsEle
          .querySelector('.arrowTemp')
          .classList.contains('arrowTemp')
      ).toBe(true);
    });
  ...
  describe('test case for item properties', () => {
    ...
    it('test case for cssClass of items property', () => {
      const carouselElement: HTMLElement = document.getElementById('carousel');
      carousel = new Carousel(
        { animationEffect: 'None', items: carouselItems },
        carouselElement
      );
      expect(
        carouselElement
          .querySelectorAll('.e-carousel-item')[1]
          .classList.contains('item-test')
      ).toBe(true);
      expect(
        carouselElement
          .querySelectorAll('.e-carousel-item')[2]
  ...
  describe('test case for dataSource', () => {
    ...
    it('test case for itemTemplate', () => {
      ...
      const carouselItem: Element =
        carouselElement.querySelectorAll('.e-carousel-item')[1];
      expect(carouselItem.querySelectorAll('.title').length).toEqual(1);
      const templateElement: HTMLElement = carouselItem.querySelector(
        '.title'
      ) as HTMLElement;
  ...
  describe('Carousel Public Methods', () => {
    ...
    it('test case for prev method', () => {
      const carouselElement: HTMLElement = document.getElementById('carousel');
      carousel = new Carousel(
        { items: items, animationEffect: 'Fade' },
        carouselElement
      );
      expect(carousel.selectedIndex).toEqual(0);
      expect(
  ...
  describe('notify property changes of', () => {
    ...
    it('showIndicators', () => {
      const carouselElement: HTMLElement = document.getElementById('carousel');
      carousel = new Carousel(
        { animationEffect: 'None', items: items, showIndicators: true },
        carouselElement
      );
    ...
    it('showPlayButton', () => {
      const carouselElement: HTMLElement = document.getElementById('carousel');
      carousel = new Carousel(
        { animationEffect: 'None', items: items, showPlayButton: false },
        carouselElement
      );
    ...
    it('selectedIndex', () => {
      const carouselElement: HTMLElement = document.getElementById('carousel');
      carousel = new Carousel(
        { animationEffect: 'None', items: items, selectedIndex: 0 },
        carouselElement
      );
    ...
    it('interval', () => {
      const carouselElement: HTMLElement = document.getElementById('carousel');
      carousel = new Carousel(
        { animationEffect: 'None', items: items, interval: 5000 },
        carouselElement
      );
      const index: number = carousel.selectedIndex;
    ...
    it('cssClass', () => {
      const carouselElement: HTMLElement = document.getElementById('carousel');
      carousel = new Carousel(
        { animationEffect: 'None', items: items, cssClass: 'carousel' },
        carouselElement
      );
      ...
      expect(carouselElement.classList.contains('default-carousel')).toEqual(
        true
      );
    });
    it('htmlAttributes', () => {
    ...
    it('enableTouchSwipe', () => {
      const carouselElement: HTMLElement = document.getElementById('carousel');
      carousel = new Carousel(
        { animationEffect: 'None', items: items, enableTouchSwipe: false },
        carouselElement
      );
    ...
    it('width', () => {
      const carouselElement: HTMLElement = document.getElementById('carousel');
      carousel = new Carousel(
        { animationEffect: 'None', items: items, width: '500px' },
        carouselElement
      );
      expect(carouselElement.style.width).toEqual('500px');
    ...
    it('height', () => {
      const carouselElement: HTMLElement = document.getElementById('carousel');
      carousel = new Carousel(
        { animationEffect: 'None', items: items, height: '500px' },
        carouselElement
      );
  ...
  describe('Keyboard actions', () => {
    ...
    it('test case for pressing Space key when indicator is focused', () => {
      ...
      const targetIndicator: HTMLElement = carouselElement.querySelectorAll(
        '.e-indicator'
      )[3] as HTMLElement;
    ...
    it('test case for pressing Space key when previous button is focused', () => {
      ...
      const previousButton: HTMLElement = carouselElement.querySelector(
        '.e-previous-button'
      ) as HTMLElement;
    ...
    it('test case for pressing Space key when next button is focused', () => {
      ...
      const nextButton: HTMLElement = carouselElement.querySelector(
        '.e-next-button'
      ) as HTMLElement;
      nextButton.focus();
      keyEventArgs = {
  ...
  describe('Carousel with single element', () => {
    ...
    it('test case for only one item is rendered', () => {
      ...
      expect(
        carouselElement.querySelector('.e-carousel-items').children.length
      ).toEqual(3);
      expect(
        carouselElement.querySelector('.e-carousel-navigators').childNodes
          .length
      ).toEqual(0);
      expect(
        carouselElement.querySelector('.e-indicator-bars').children.length
  ...
  describe('test case for swiping carousel', () => {
    ...
    it('test case for swipe', () => {
      ...
      carousel = new Carousel(
        {
          items: items,
          animationEffect: 'None',
          swipeMode: CarouselSwipeMode.Mouse,
        },
        carouselElement
      );
      ...
      expect(
        carouselElement.querySelector('.e-carousel-items').childElementCount
      ).toEqual(7);
      carousel.enableTouchSwipe = false;
      carousel.dataBind();
      expect(
  ...
  describe('EJ2-68892 - test case for data-height attribute', () => {
    ...
    it('test case for checking data-height attribute', () => {
      const carouselElement: HTMLElement = document.getElementById('carousel');
      carousel = new Carousel(
        { items: items, animationEffect: 'Slide' },
        carouselElement
      );
      expect(
        carouselElement
      ...
      expect(
        carouselElement
          .querySelector('.e-carousel-items .e-next')
          .getAttribute('data-slide-height')
      ).toBe('18');
    });
  });
  ...
  describe('test case for dynamically changing datasource', () => {
    ...
    it('test case changing index to last element', () => {
      ...
      expect(
        carouselElement
          .querySelectorAll('.e-indicator-bar')[3]
          .classList.contains('e-active')
      ).toBe(true);
    });
  });
  ...
  describe('test case for dynamically changing window size', () => {
    ...
    it('test case for changing width', () => {
      const carouselElement: HTMLElement = document.getElementById('carousel');
      carousel = new Carousel(
        { items: items, animationEffect: 'Slide', autoPlay: false },
        carouselElement
      );
    ...
    it('test case for changing window size when loop set to false', () => {
      const carouselElement: HTMLElement = document.getElementById('carousel');
      carousel = new Carousel(
        { items: items, animationEffect: 'Slide', loop: false },
        carouselElement
      );
      let itemContainer: HTMLElement = carousel.element.querySelector(
        '.e-carousel-items'
      ) as HTMLElement;
      (carousel as any).resizeHandler();
