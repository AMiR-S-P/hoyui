...
describe('Menu', () => {
  ...
  describe('DOM', () => {
    ...
    it('Architecture Checking', () => {
      ...
      expect(
        wrap.children[0].children[0].classList.contains('e-menu-item')
      ).toBeTruthy();
      // Sub menu li
    ...
    it('Menu with scroll enabled', () => {
      appendStyles(
        '#menu { width: 400px; } .e-menu-wrapper { width: 250px; } #cookbooks-ej2menu-menu-popup.e-menu-popup, #book-ej2menu-menu-popup.e-menu-popup{ height: 200px; } #cookbooks-ej2menu-menu-popup.e-menu-popup .e-ul, #book-ej2menu-menu-popup.e-menu-popup .e-ul{ height: 250px; }'
      );
      document.body.appendChild(ul);
      ...
      const popup: HTMLElement = menu.getPopups()[0];
      expect(
        wrap.children[0].classList.contains('e-menu-hscroll')
      ).toBeTruthy();
      expect(
        wrap.children[0].children[0].classList.contains('e-scroll-left-nav')
      ).toBeTruthy();
      expect(
        wrap.children[0].lastElementChild.classList.contains(
          'e-scroll-right-nav'
        )
      ).toBeTruthy();
      expect(
        ul.parentElement.classList.contains('e-hscroll-content')
      ).toBeTruthy();
      expect(
        popup.children[0].classList.contains('e-menu-vscroll')
      ).toBeTruthy();
      expect(
        popup.children[0].children[0].classList.contains('e-scroll-up-nav')
      ).toBeTruthy();
      expect(
        popup.children[0].lastElementChild.classList.contains(
          'e-scroll-down-nav'
        )
      ).toBeTruthy();
      expect(
        select('.e-ul', popup).parentElement.classList.contains(
          'e-vscroll-content'
        )
      ).toBeTruthy();
    ...
    it('Vertical Menu with scroll enabled', () => {
      appendStyles(
        '#menu { height: 250px; } .e-menu-wrapper { height: 200px; }'
      );
      document.body.appendChild(ul);
      menu = new Menu(
        { items: items, orientation: 'Vertical', enableScrolling: true },
        '#menu'
      );
      const wrap: HTMLElement = menu.getWrapper();
      expect(ul.classList.contains('e-vertical')).toBeTruthy();
      expect(
        wrap.children[0].classList.contains('e-menu-vscroll')
      ).toBeTruthy();
      expect(
        wrap.children[0].children[0].classList.contains('e-scroll-up-nav')
      ).toBeTruthy();
      expect(
        wrap.children[0].lastElementChild.classList.contains(
          'e-scroll-down-nav'
      ...
      expect(
        ul.parentElement.classList.contains('e-vscroll-content')
      ).toBeTruthy();
    });
    ...
    it('Hamburger mode with vertical orientation Checking', () => {
      document.body.appendChild(ul);
      menu = new Menu(
        { items: items, orientation: 'Vertical', hamburgerMode: true },
        '#menu'
      );
      const wrap: HTMLElement = menu.getWrapper();
    ...
    it('Hamburger mode with user interaction checking', () => {
      ...
      const wrap: HTMLElement = menu.getWrapper();
      (
        wrap.children[0].getElementsByClassName('e-menu-icon')[0] as HTMLElement
      ).click();
      ...
      const subLi: HTMLElement = li.getElementsByTagName('ul')[0]
      ...
      menu.dataBind();
      expect(
        menu.element.previousElementSibling.classList.contains('e-vertical')
      ).toBeTruthy();
    ...
    it('target with or without hamburger mode checking', () => {
      ...
      menu.destroy();
      menu = new Menu(
        { items: items, hamburgerMode: true, target: '#menuTrgt' },
        '#menu'
      );
      menu.target = '';
      menu.dataBind();
      ...
      menu.destroy();
      menu = new Menu(
        { items: items, orientation: 'Vertical', target: '#menuTrgt' },
        '#menu'
      );
      ...
      expect(wrap.getElementsByClassName('e-menu-title')[0].innerHTML).toBe(
        'Hamburger'
      );
    });
  });
  ...
  describe('Property', () => {
    ...
    it('cssClass Checking', () => {
      document.body.appendChild(ul);
      menu = new Menu(
        { items: items, cssClass: 'e-custom e-custom1' },
        '#menu'
      );
      const wrap: HTMLElement = menu.getWrapper();
    ...
    it('title Checking', () => {
      ...
      menu.dataBind();
      const wrap: HTMLElement = menu.getWrapper();
      expect(wrap.getElementsByClassName('e-menu-title')[0].innerHTML).toEqual(
        'Hamburger Menu'
      );
    });
  ...
  describe('Public Methods Checking', () => {
    ...
    it('Enable and Disable items', () => {
      ...
      expect(
        menu
          .getPopups()[1]
          .firstElementChild.children[1].classList.contains('e-disabled')
      ).toBeFalsy();
      ...
      menu = new Menu(
        {
          ...
          beforeOpen: (args: BeforeOpenCloseMenuEventArgs) => {
            if (args.parentItem.text === 'Book Categories') {
              const position: ClientRect = closest(
  ...
  describe('Device Mode Checking', () => {
    ...
    it('Scrollable mode Checking', () => {
      ...
      document.body.appendChild(ul);
      menu = new Menu({ items: items }, '#menu');
      expect(menu.getWrapper().classList.contains('e-scrollable')).toEqual(
        true
      );
    });
  });
  ...
  describe('notify property changes of', () => {
    ...
    it('hamburger mode with orientation', () => {
      ...
      menu.dataBind();
      expect(
        ul.previousElementSibling.classList.contains('e-vertical')
      ).toBeTruthy();
      menu.orientation = 'Horizontal';
      menu.dataBind();
      expect(
    ...
    it('enableScrolling', () => {
      appendStyles(
        '#menu { height: 400px; } .e-menu-wrapper { height: 250px; } #cookbooks-menu-popup.e-menu-popup{ height: 200px; } #cookbooks-menu-popup.e-menu-popup .e-ul{ height: 250px; }'
      );
      document.body.appendChild(ul);
      menu = new Menu(
        { items: items, animationSettings: { effect: 'None' } },
        '#menu'
      );
      const wrap: HTMLElement = menu.getWrapper();
      const li: HTMLElement = ul.children[1] as HTMLElement;
      ...
      expect(
        ul.parentElement.classList.contains('e-menu-wrapper')
      ).toBeTruthy();
      expect(
        popup.children[0].classList.contains('e-menu-vscroll')
      ).toBeFalsy();
      expect(
        select('.e-ul', popup).parentElement.classList.contains('e-menu-popup')
      ).toBeTruthy();
      triggerMouseEvent(document.body, 'mouseover');
      triggerMouseEvent(li, 'mouseover');
      menu.orientation = 'Vertical';
  ...
  describe('Keyboard actions', () => {
    ...
    it('end arrow action', () => {
      ...
      const li: Element[] = <Element[] & NodeListOf<HTMLLIElement>>(
        ul.querySelectorAll('li')
      );
      expect(
        (li[li.length - 1] as Element).classList.contains('e-focused')
      ).toBe(true);
    });
    ...
    it('rtl - right arrow action', () => {
      document.body.appendChild(ul);
      menu = new Menu(
        { items: items, enableRtl: true, orientation: 'Vertical' },
        '#menu'
      );
      menu.keyBoardHandler(downEventArgs);
      menu.keyBoardHandler(downEventArgs);
    ...
    it('menu wit keyhandler', () => {
      ...
      menu = new Menu({ items: items }, '#menu');
      menu.keyHandler({
        target: menu.element.firstChild,
        keyCode: 40,
        preventDefault: (): void => {
          /** NO Code */
        },
  ...
  describe('Code coverage improvement', () => {
    ...
    it('menu wit react template', () => {
      document.body.appendChild(ul);
      menu = new Menu(
        { items: items, template: '<div>eee</div>', showItemOnClick: true },
        '#menu'
      );
      menu.isReact = true;
    ...
    it('items, orientation and enableScrolling', () => {
      document.body.appendChild(ul);
      menu = new Menu(
        { items: items, enableScrolling: true, orientation: 'Horizontal' },
        '#menu'
      );
    ...
    it('menu Scrolling', () => {
      ...
      menu = new Menu(
        { items: items, enableScrolling: true, cssClass: 'e-custom-scroll' },
        '#menu1'
      );
      menu.element.parentElement.style.width = '400px';
      let ele: any = addScrolling(
        createElement,
        menu.element.parentElement,
        menu.element,
        'hscroll',
        false,
        2
  ...
  describe('CR issues', () => {
    ...
    it('EJ2-49377 - Hamburger mode is not working when items are dynamically added', () => {
      ...
      menu = new Menu(
        { items: menuItems, hamburgerMode: true, showItemOnClick: true },
        '#menu'
      );
      menu.items = [
        {
