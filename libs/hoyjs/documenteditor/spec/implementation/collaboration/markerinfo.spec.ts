...
describe('Insert Marker Info', () => {
  ...
  it('remove hyperlink operation', () => {
    ...
    expect(JSON.parse(argsEle.operations[2].format).fontColor).toBe(
      '#00000000'
    );
    // // Clear format
  ...
  it('insert and remove text form field operation', () => {
    ...
    let bookmarkStartValue: boolean =
      argsEle.operations[1].markerData.bookmarkName === 'Text1' &&
      argsEle.operations[1].markerData.type === 'Bookmark';
    ...
    let bookmarkEndValue: boolean =
      argsEle.operations[6].markerData.bookmarkName === 'Text1' &&
      argsEle.operations[6].markerData.type === 'Bookmark';
  ...
  it('insert and remove checkbox form field operation', () => {
    ...
    expect(argsEle.operations[1].offset).toBe(6);
    let bookmarkStartValue: boolean =
      argsEle.operations[1].markerData.bookmarkName === 'CheckBox1' &&
      argsEle.operations[1].markerData.type === 'Bookmark';
    expect(bookmarkStartValue).toBe(true);
    ...
    expect(argsEle.operations[6].offset).toBe(22);
    let bookmarkEndValue: boolean =
      argsEle.operations[6].markerData.bookmarkName === 'CheckBox1' &&
      argsEle.operations[6].markerData.type === 'Bookmark';
    expect(bookmarkEndValue).toBe(true);
  ...
  it('insert and remove dropdown form field operation', () => {
    ...
    expect(argsEle.operations[1].offset).toBe(6);
    let bookmarkStartValue: boolean =
      argsEle.operations[1].markerData.bookmarkName === 'DropDown1' &&
      argsEle.operations[1].markerData.type === 'Bookmark';
    expect(bookmarkStartValue).toBe(true);
    //insert form check box
    expect(argsEle.operations[2].action).toBe('Insert');
    ...
    let bookmarkEndValue: boolean =
      argsEle.operations[6].markerData.bookmarkName === 'DropDown1' &&
      argsEle.operations[6].markerData.type === 'Bookmark';
    expect(bookmarkEndValue).toBe(true);
  ...
  it('insert value operation of form field', () => {
    ...
    let formFieldInfo = JSON.parse(
      argsEle.operations[1].markerData.formFieldData
    );
...
describe('Insert Marker Info comment', () => {
  ...
  it('insert comment operation', () => {
    ...
    expect(argsEle.operations[2].action).toBe('Format');
    expect(argsEle.operations[2].text).toBe(
      CONTROL_CHARACTERS.Marker_Start + CONTROL_CHARACTERS.Marker_End
    );
  ...
  it('resolve and reopen comment', () => {
    ...
    expect(argsEle.operations[0].text).toBe(
      CONTROL_CHARACTERS.Marker_Start + CONTROL_CHARACTERS.Marker_End
    );
