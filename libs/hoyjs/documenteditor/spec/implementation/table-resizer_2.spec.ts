...
console.log('Resize without selection');
        ...
        expect(((editor.selection.tableFormat.table.childWidgets[0] as TableRowWidget).childWidgets[0] as TableCellWidget).cellFormat.cellWidth).toBe(456.2);
    });
...
describe('Check the cell width when preferredWidthType contain point', () => {
    let editor: DocumentEditor = undefined;
    let documentHelper: DocumentHelper;
    beforeAll((): void => {
        let ele: HTMLElement = createElement('div', {
    ...
    it('Check the cell width when preferredWidthType contain point', () => {
        ...
        editor.editorModule.tableResize.startingPoint = new Point(720, 104);
        editor.editorModule.tableResize.resizeTableCellColumn(30);
        editor.editorModule.tableResize.resizerPosition = 0;
        editor.editorModule.tableResize.startingPoint = new Point(97, 104);
        editor.editorModule.tableResize.resizeTableCellColumn(30);
        expect((((editor.documentHelper.pages[0].bodyWidgets[0].childWidgets[0] as TableWidget).childWidgets[0] as TableRowWidget).childWidgets[1] as TableCellWidget).width).toBe(336.93333);
    });
});