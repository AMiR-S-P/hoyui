...
describe('NumberBullet dialog', () => {
  ...
  it('Select bullet style tab', (done) => {
    ...
    setTimeout(function () {
      expect((numBulletDialog as any).bulletListDiv.style.display).not.toBe(
        'none'
      );
      done();
    }, 10);
  ...
  it('Select number style tab', (done) => {
    ...
    setTimeout(function () {
      expect((numBulletDialog as any).numberListDiv.style.display).not.toBe(
        'none'
      );
      done();
    }, 10);
  ...
  it('numbered-none', () => {
    ...
    editor.documentHelper.onKeyDownInternal(event);
    numBulletDialog.showNumberBulletDialog(undefined, undefined);
    editor.documentHelper.dialog.element
      .getElementsByClassName('e-de-list-numbered-none')
      .item(0)
  ...
  it('e-de-list-numbered-number-dot', () => {
    ...
    numBulletDialog.showNumberBulletDialog(undefined, undefined);
    editor.documentHelper.dialog.element
      .getElementsByClassName('e-de-list-numbered-number-dot')
      .item(0)
      .dispatchEvent(new Event('click'));
    numBulletDialog.onOkButtonClick();
  });
  it('e-de-list-numbered-number-brace', () => {
    ...
    numBulletDialog.showNumberBulletDialog(undefined, undefined);
    editor.documentHelper.dialog.element
      .getElementsByClassName('e-de-list-numbered-number-brace')
      .item(0)
      .dispatchEvent(new Event('click'));
    numBulletDialog.onOkButtonClick();
  });
  it('e-de-list-numbered-up-roman', () => {
    ...
    numBulletDialog.showNumberBulletDialog(undefined, undefined);
    editor.documentHelper.dialog.element
      .getElementsByClassName('e-de-list-numbered-up-roman')
      .item(0)
      .dispatchEvent(new Event('click'));
    numBulletDialog.onOkButtonClick();
  });
  it('e-de-list-numbered-up-letter', () => {
    ...
    numBulletDialog.showNumberBulletDialog(undefined, undefined);
    editor.documentHelper.dialog.element
      .getElementsByClassName('e-de-list-numbered-up-letter')
      .item(0)
      .dispatchEvent(new Event('click'));
    numBulletDialog.onOkButtonClick();
  });
  it('e-de-list-numbered-low-letter-brace', () => {
    ...
    numBulletDialog.showNumberBulletDialog(undefined, undefined);
    editor.documentHelper.dialog.element
      .getElementsByClassName('e-de-list-numbered-low-letter-brace')
      .item(0)
      .dispatchEvent(new Event('click'));
    numBulletDialog.onOkButtonClick();
  });
  it('e-de-numbered-low-letter-dot', () => {
    ...
    numBulletDialog.showNumberBulletDialog(undefined, undefined);
    editor.documentHelper.dialog.element
      .getElementsByClassName('e-de-numbered-low-letter-dot')
      .item(0)
      .dispatchEvent(new Event('click'));
    numBulletDialog.onOkButtonClick();
  });
  it('e-de-list-numbered-low-roman', () => {
    ...
    numBulletDialog.showNumberBulletDialog(undefined, undefined);
    editor.documentHelper.dialog.element
      .getElementsByClassName('e-de-list-numbered-low-roman')
      .item(0)
      .dispatchEvent(new Event('click'));
    numBulletDialog.onOkButtonClick();
  });
  ...
  it('e-de-list-bullet-dot', () => {
    ...
    editor.documentHelper.onKeyDownInternal(event);
    numBulletDialog.showNumberBulletDialog(undefined, undefined);
    numBulletDialog.bulletListDiv
      .getElementsByClassName('e-de-icon-bullet-list-dot')
      .item(0)
      .dispatchEvent(new Event('click'));
    numBulletDialog.onOkButtonClick();
  });
  it('e-de-list-bullet-circle', () => {
    ...
    numBulletDialog.showNumberBulletDialog(undefined, undefined);
    numBulletDialog.bulletListDiv
      .getElementsByClassName('e-de-icon-bullet-list-circle')
      .item(0)
      .dispatchEvent(new Event('click'));
    numBulletDialog.onOkButtonClick();
  });
  it('e-de-list-bullet-square', () => {
    ...
    numBulletDialog.showNumberBulletDialog(undefined, undefined);
    numBulletDialog.bulletListDiv
      .getElementsByClassName('e-de-icon-bullet-list-square')
      .item(0)
      .dispatchEvent(new Event('click'));
    numBulletDialog.onOkButtonClick();
  });
  it('e-de-list-bullet-flower', () => {
    ...
    numBulletDialog.showNumberBulletDialog(undefined, undefined);
    numBulletDialog.bulletListDiv
      .getElementsByClassName('e-de-icon-bullet-list-flower')
      .item(0)
      .dispatchEvent(new Event('click'));
    numBulletDialog.onOkButtonClick();
  });
  it('e-de-list-bullet-arrow', () => {
    ...
    numBulletDialog.showNumberBulletDialog(undefined, undefined);
    numBulletDialog.bulletListDiv
      .getElementsByClassName('e-de-icon-bullet-list-arrow')
      .item(0)
      .dispatchEvent(new Event('click'));
    numBulletDialog.onOkButtonClick();
  });
  it('e-de-icon-bullet-list-tick', () => {
    ...
    numBulletDialog.showNumberBulletDialog(undefined, undefined);
    numBulletDialog.bulletListDiv
      .getElementsByClassName('e-de-icon-bullet-list-tick')
      .item(0)
      .dispatchEvent(new Event('click'));
    numBulletDialog.onOkButtonClick();
  });
