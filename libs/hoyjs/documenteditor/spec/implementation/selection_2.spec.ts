...
describe('Selection Public APi testing ', () => {
  ...
  it('Increase indent and decrease indent', () => {
    ...
    expect(editor.selectionModule.paragraphFormat.leftIndent).toBeGreaterThan(
      0
    );
    editor.selectionModule.decreaseIndent();
    expect(
      editor.selectionModule.paragraphFormat.leftIndent
...
describe('Selection Public APi testing - 2', () => {
  ...
  it('Toggle highlight validation', () => {
    ...
    expect(editor.selectionModule.characterFormat.highlightColor).toBe(
      'Yellow'
    );
    editor.selectionModule.toggleHighlightColor('Yellow');
    expect(editor.selectionModule.characterFormat.highlightColor).toBe(
  ...
  it('Toggle Strike through validation', () => {
    ...
    expect(editor.selectionModule.characterFormat.strikethrough).toBe(
      'SingleStrike'
    );
    editor.selectionModule.toggleStrikethrough();
  ...
  it('Toggle Subscript validation', () => {
    ...
    editor.editorHistory.undo();
    expect(editor.selectionModule.characterFormat.baselineAlignment).toBe(
      'Normal'
    );
    editor.editorHistory.redo();
    expect(editor.selectionModule.characterFormat.baselineAlignment).toBe(
  ...
  it('Get Selected text and Move to previous paragraph end ', () => {
    ...
    end.setPositionForCurrentIndex(
      start.paragraph.getHierarchicalIndex('0;10')
    );
    ...
    editor.selectionModule.selectPosition(
      editor.documentEnd,
      editor.documentEnd
    );

    editor.selectionModule.start.moveToPreviousParagraph(
