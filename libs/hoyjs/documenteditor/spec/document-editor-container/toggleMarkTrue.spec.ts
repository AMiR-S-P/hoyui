...
describe('Document Editor container ParaMark toggling true', () => {
  ...
  beforeAll(() => {
    ...
    container = new DocumentEditorContainer({
      documentEditorSettings: { showHiddenMarks: true },
    });
  ...
  it('showHiddenMark property true', (done) => {
    ...
    setTimeout(() => {
      ...
      expect(
        (ele as HTMLDivElement).classList.contains('e-de-tc-hide-para-mark')
      ).toBe(true);
