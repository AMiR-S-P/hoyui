...
describe('Document Opening cases - Multi-column', () => {
  ...
  beforeAll(() => {
    ...
    container = new DocumentEditor({
      isReadOnly: false,
      documentEditorSettings: { showHiddenMarks: true, showBookmarks: true },
    });
