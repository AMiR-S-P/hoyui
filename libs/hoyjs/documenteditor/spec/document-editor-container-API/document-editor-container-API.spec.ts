...
describe('documentEditorSettingsAPI', () => {
  ...
  it('documentEditorSettingsAPI', () => {
    ...
    container.documentEditorSettings.formFieldSettings.formFillingMode =
      'Inline';
...
describe('Script error throws whenever using refresh API,', () => {
  ...
  beforeAll((): void => {
    ...
    (documentEditor.documentHelper as any).containerCanvasIn =
      TestHelper.containerCanvas;
    (documentEditor.documentHelper as any).selectionCanvasIn =
      TestHelper.selectionCanvas;
    (documentEditor.documentHelper.render as any).pageCanvasIn =
      TestHelper.pageCanvas;
    (documentEditor.documentHelper.render as any).selectionCanvasIn =
      TestHelper.pageSelectionCanvas;
