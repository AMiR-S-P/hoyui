...
describe('Document Editor container properties_1', () => {
  ...
  it('serverActionSettings', () => {
    ...
    container.documentEditor.serviceUrl =
      'https://ej2services.syncfusion.com/production/web-services/api/documenteditor/';
    container.documentEditor.serverActionSettings = {
      systemClipboard: 'SystemClipboard',
      spellCheck: 'SpellCheck',
    };
    expect(container.documentEditor.serviceUrl).toBe(
      'https://ej2services.syncfusion.com/production/web-services/api/documenteditor/'
    );
    expect(container.documentEditor.serverActionSettings.systemClipboard).toBe(
      'SystemClipboard'
    );
    expect(container.documentEditor.serverActionSettings.spellCheck).toBe(
      'SpellCheck'
    );
  });
  it('zIndex', () => {
