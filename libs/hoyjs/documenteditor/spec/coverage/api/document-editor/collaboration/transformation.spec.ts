...
describe('Validate the acknowldgement transformation', () => {
  ...
  it('Validate the transformation of insert and insert', () => {
    ...
    editor1.editorModule.insertText(
    ...
    let para: ParagraphWidget = editor2.documentHelper.pages[0].bodyWidgets[0]
      .childWidgets[0] as ParagraphWidget;
    expect(
      ((para.childWidgets[0] as LineWidget).children[0] as TextElementBox).text
    ).toBe(
      'Adventure Syncfusion Works software Cycles, the fictitious company on which the Adventure Works '
    );
  });
  ...
  it('Validate the transformation of insert and delete', () => {
    ...
    expect(
      ...
      'Adventure Syncfusion Works Cycles, the fictitious company on which the Adventure Works '
    );
  });
});
