...
describe('Open document from URL', () => {
  ...
  it('From URL', () => {
    ...
    documenteditor.open(
      'https://cdn.syncfusion.com/content/document-editor/GiantPanda.docx'
    );
  });
});
