...
describe('Show Dialog documenteditor properties_1 ', () => {
  ...
  it('showDateContentDialog', () => {
    ...
    expect(() =>
      documenteditor.showDialog('DatepickerContentControl')
    ).not.toThrowError();
    documenteditor.documentHelper.hideDialog();
  });
  it('showPicContentControlDialog', () => {
    ...
    expect(() =>
      documenteditor.showDialog('PictureContentControl')
    ).not.toThrowError();
    documenteditor.documentHelper.hideDialog();
  });
  it('showContentPropertiesDialog', () => {
    ...
    expect(() =>
      documenteditor.showDialog('ContentControlProperties')
    ).not.toThrowError();
    documenteditor.documentHelper.hideDialog();
  });
});
describe('Form Field documenteditor properties ', () => {
  ...
  it('TextFormFieldDialog', () => {
    ...
    expect(() =>
      documenteditor.textFormFieldDialogModule.show()
    ).not.toThrowError();
    documenteditor.documentHelper.hideDialog();
  });
  it('CheckBoxFormFieldDialog', () => {
    ...
    expect(() =>
      documenteditor.checkBoxFormFieldDialogModule.show()
    ).not.toThrowError();
    documenteditor.documentHelper.hideDialog();
  });
  it('DropDownFormFieldDialog', () => {
    ...
    expect(() =>
      documenteditor.dropDownFormFieldDialogModule.show()
    ).not.toThrowError();
    documenteditor.documentHelper.hideDialog();
  });
  ...
  it('Import form field', () => {
    ...
    documenteditor.editor.insertFormField('CheckBox');
    documenteditor.editor.insertFormField('DropDown');
    let textformField: FormFieldData = {
      fieldName: 'Text1',
      value: 'Hello World',
    };
...
describe('Save functionality documenteditor properties ', () => {
  ...
  beforeAll((): void => {
    ...
    documenteditor.editor.insertText(
      'Adventure Works Cycles, the fictitious company on which the Adventure Works sample '
    );
  });
  afterAll((done) => {
    documenteditor.destroy();
  ...
  it('Save as Blob - Sfdt', () => {
    ...
    expect(() => {
      documenteditor.saveAsBlob('Sfdt');
    }).not.toThrowError();
  });
});
...
describe('Document Editor enableOptimizedTextMeasuring', () => {
  ...
  it('enable optimized rendering false validation', () => {
    ...
    expect(
      documenteditor.documentEditorSettings.enableOptimizedTextMeasuring
    ).toBe(false);
  });
  it('regular branch coverage', () => {
    console.log('regular branch coverage');
    expect(() => {
      (documenteditor.textMeasureHelper as Regular).applyStyle(
        undefined,
        undefined,
        ''
      );
