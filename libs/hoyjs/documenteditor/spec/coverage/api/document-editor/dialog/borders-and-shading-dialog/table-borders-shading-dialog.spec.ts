...
describe('Borders dialog preview div checkbox validation', () => {
  ...
  it('Remove events', () => {
    ...
    editor.openBlank();
    editor.editor.insertTable(3, 3);
    let tableOptions: BordersAndShadingDialog =
      editor.bordersAndShadingDialogModule;
    tableOptions.show();
...
describe('Border and shading dialog applying testing to table testing with history validation', () => {
  ...
  it('Apply table properties style testing', () => {
    ...
    expect(
      editor.selection.tableFormat.table.tableFormat.shading.backgroundColor
    ).toBe('#000080');
  });
  it('Apply table properties style testing', () => {
    console.log('Apply table properties style testing');
...
describe('Border and shading dialog applying testing to table testing with history validation - 1', () => {
  ...
  it('Apply cell properties line style testing', () => {
    ...
    (dialog as any).applyBordersShadingsProperties();
    expect(
      editor.selection.start.paragraph.associatedCell.cellFormat.shading
        .backgroundColor
    ).toBe('#000080');
  });
  it('Apply cell properties line style testing', () => {
...
describe('Apply borders&shadings checkbox values testing to paragraph', () => {
  ...
  it('Apply Paragraph Preview Boxes value testing', () => {
    ...
    (dialog as any).applyTableCellPreviewBoxes();
    expect(
      (dialog as any).previewDivBottomcenterContainer.style.visibility
    ).toBe('hidden');
  });
  it('Apply Paragraph Preview Boxes value testing', () => {
    console.log('Apply Paragraph Preview Boxes value testing');
    expect((dialog as any).previewDivTopCenterContainer.style.visibility).toBe(
      'hidden'
    );
  });
  it('Apply Paragraph Preview Boxes value testing', () => {
...
describe('Border applying testing with none and box validation in paragraph', () => {
  ...
  it('None div in borders div click validation in paragraph', (done) => {
    ...
    editor.selection.start.paragraph.paragraphFormat.borders.top.hasNoneStyle =
      false;
    editor.selection.start.paragraph.paragraphFormat.borders.bottom.hasNoneStyle =
      false;
    editor.selection.start.paragraph.paragraphFormat.borders.left.hasNoneStyle =
      false;
    editor.selection.start.paragraph.paragraphFormat.borders.right.hasNoneStyle =
      false;
    dialog.show();
    setTimeout(() => {
      expect(
        (dialog as any).noneDiv.classList.contains(
