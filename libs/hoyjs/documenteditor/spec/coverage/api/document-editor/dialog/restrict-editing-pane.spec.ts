...
describe('Restrict editing dialog validation', () => {
  ...
  it('open enforce dialog', () => {
    ...
    (
      editor.documentHelper.restrictEditingPane as any
    ).enforceProtection.click();
  ...
  it('open unprotect document dialog', () => {
    ...
    (
      editor.documentHelper.restrictEditingPane.enforceProtectionDialog as any
    ).passwordTextBox.value = '123';
    (
      editor.documentHelper.restrictEditingPane.enforceProtectionDialog as any
    ).confirmPasswordTextBox.value = '123';
    editor.documentHelper.restrictEditingPane.enforceProtectionDialog.okButtonClick();
    editor.documentHelper.restrictEditingPane.enforceProtectionDialog.hideDialog();
  });
...
describe('Restrict editing dialog protection type validation', () => {
  ...
  it('Tracked changes validation', () => {
    ...
    let args = {
      ...
      previousItemData: { Value: 'Read Only' },
    };
    expect(() => {
      (
        editor.documentHelper.restrictEditingPane as any
...
describe('Add use dialog validation', () => {
  ...
  it('open add user dialog', () => {
    ...
    (
      editor.documentHelper.restrictEditingPane.addUserDialog as any
    ).textBoxInput.value = 'User1@gmail.com';
    ...
    expect(
      (editor.documentHelper.restrictEditingPane.addUserDialog as any).userList
        .dataSource.length
    ).toBe(2);
    //hide dialog
...
describe('Enforce dialog validation', () => {
  ...
  it('open enforce dialog', () => {
    ...
    (
      editor.documentHelper.restrictEditingPane.enforceProtectionDialog as any
    ).confirmPasswordTextBox.value = '12';
    editor.documentHelper.restrictEditingPane.enforceProtectionDialog.okButtonClick();
