import { createElement, L10n, isNullOrUndefined } from '@hoyui/base';
import { CheckBox } from '@hoyui/buttons';
import { DocumentEditor } from '../../document-editor';
import { DocumentHelper } from '../viewer';
import { FieldElementBox, ElementBox, TextFormField } from '../viewer/page';
import { NumericTextBox, NumericFocusEventArgs, NumericBlurEventArgs, ChangeEventArgs as NumericChangeEventArgs, TextBox } from '@hoyui/inputs';
import { DropDownList, ComboBox, ChangeEventArgs } from '@hoyui/dropdowns';
