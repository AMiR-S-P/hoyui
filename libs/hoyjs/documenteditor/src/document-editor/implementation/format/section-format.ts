...
export class WSectionFormat {
  ...
  public hasValue(property: string): boolean {
    if (!isNullOrUndefined(this.uniqueSectionFormat)) {
      const propertyType: number = WUniqueFormat.getPropertyType(
        this.uniqueSectionFormat.uniqueFormatType,
        property
      );
  ...
  public getPropertyValue(property: string): Object {
    ...
    if (hasValue) {
      const propertyType: number = WUniqueFormat.getPropertyType(
        WSectionFormat.uniqueFormatType,
        property
      );
      if (
        !isNullOrUndefined(this.uniqueSectionFormat) &&
        this.uniqueSectionFormat.propertiesHash.containsKey(propertyType)
      ) {
  ...
  private setPropertyValue(property: string, value: Object): void {
    ...
    if (isNullOrUndefined(this.uniqueSectionFormat)) {
      ...
      this.uniqueSectionFormat =
        WSectionFormat.uniqueSectionFormats.updateUniqueFormat(
          this.uniqueSectionFormat,
          property,
          value
        );
  ...
  private initializeUniqueSectionFormat(
    ...
    const uniqueSectionFormatTemp: Dictionary<number, object> = new Dictionary<
      number,
      object
    >();
    this.addUniqueSectionFormat(
      'headerDistance',
      property,
      propValue,
      uniqueSectionFormatTemp
    );
    this.addUniqueSectionFormat(
      'footerDistance',
      property,
    ...
    this.uniqueSectionFormat =
      WSectionFormat.uniqueSectionFormats.addUniqueFormat(
        uniqueSectionFormatTemp,
        WSectionFormat.uniqueFormatType
      );
  }
  ...
  private addUniqueSectionFormat(
    ...
    propValue: Object,
    uniqueSectionFormatTemp: Dictionary<number, object>
  ): void {
    const propertyType: number = WUniqueFormat.getPropertyType(
      WSectionFormat.uniqueFormatType,
      property
    ...
    if (property === modifiedProperty) {
      ...
      uniqueSectionFormatTemp.add(
        propertyType,
        WSectionFormat.getPropertyDefaultValue(property)
      );
    }
  }
  public copyFormat(format: WSectionFormat, history?: EditorHistory): void {
    if (history && (history.isUndoing || history.isRedoing)) {
      ...
      if (!isNullOrUndefined(format)) {
        this.removedHeaderFooters = format.removedHeaderFooters;
        if (
          !isNullOrUndefined(format.uniqueSectionFormat) &&
          format.uniqueSectionFormat.propertiesHash
        ) {
  ...
  public updateUniqueSectionFormat(format: WSectionFormat): void {
    ...
    if (this.uniqueSectionFormat) {
      hash = this.uniqueSectionFormat.mergeProperties(
        format.uniqueSectionFormat
      );
    ...
    this.uniqueSectionFormat = new WUniqueFormat(
      WSectionFormat.uniqueFormatType
    );
...
export class WColumnFormat {
  ...
  private hasValue(property: string): boolean {
    if (!isNullOrUndefined(this.uniqueColumnFormat)) {
      const propertyType: number = WUniqueFormat.getPropertyType(
        this.uniqueColumnFormat.uniqueFormatType,
        property
      );
  ...
  public getPropertyValue(property: string): Object {
    ...
    if (hasValue) {
      const propertyType: number = WUniqueFormat.getPropertyType(
        WColumnFormat.uniqueFormatType,
        property
      );
      if (
        !isNullOrUndefined(this.uniqueColumnFormat) &&
        this.uniqueColumnFormat.propertiesHash.containsKey(propertyType)
      ) {
  ...
  private setPropertyValue(property: string, value: Object): void {
    ...
    if (isNullOrUndefined(this.uniqueColumnFormat)) {
      ...
      this.uniqueColumnFormat =
        WColumnFormat.uniqueColumnFormats.updateUniqueFormat(
          this.uniqueColumnFormat,
          property,
          value
        );
  ...
  private initializeUniqueColumnFormat(
    ...
    const uniqueColumnFormatTemp: Dictionary<number, object> = new Dictionary<
      number,
      object
    >();
    this.addUniqueColumnFormat(
      'width',
      property,
      propValue,
      uniqueColumnFormatTemp
    );
    this.addUniqueColumnFormat(
      'space',
      property,
    ...
    this.uniqueColumnFormat = WColumnFormat.uniqueColumnFormats.addUniqueFormat(
      uniqueColumnFormatTemp,
      WColumnFormat.uniqueFormatType
    );
  }
  private addUniqueColumnFormat(
    ...
    modifiedProperty: string,
    propValue: Object,
    uniqueColumnFormatTemp: Dictionary<number, object>
  ): void {
    const propertyType: number = WUniqueFormat.getPropertyType(
      WColumnFormat.uniqueFormatType,
      property
    ...
    if (property === modifiedProperty) {
      ...
      uniqueColumnFormatTemp.add(
        propertyType,
        WColumnFormat.getPropertyDefaultValue(property)
      );
    }
  }
  ...
  public copyFormat(colFormat: WColumnFormat): void {
    if (
      !isNullOrUndefined(colFormat) &&
      !isNullOrUndefined(colFormat.uniqueColumnFormat)
    ) {
