...
import { StreamWriter } from '@hoyui/file-utils';
...
import { ZipArchive, ZipArchiveItem } from '@hoyui/compression';
import {
  AutoShapeType,
...
import {
  sectionsProperty,
  imagesProperty,
  fontSubstitutionTableProperty,
  paraStyleNameProperty,
  characterFormatProperty,
  paragraphFormatProperty,
  listsProperty,
  abstractListsProperty,
  backgroundProperty,
  stylesProperty,
  commentsProperty,
  revisionsProperty,
  ...
  formattingProperty,
  trackChangesProperty,
  protectionTypeProperty,
  enforcementProperty,
  hashValueProperty,
  saltValueProperty,
  cryptProviderTypeProperty,
  cryptAlgorithmClassProperty,
  cryptAlgorithmTypeProperty,
  cryptAlgorithmSidProperty,
  cryptSpinCountProperty,
  doNotUseHTMLParagraphAutoSpacingProperty,
  alignTablesRowByRowProperty,
  formFieldShadingProperty,
  lastParagraphMarkCopiedProperty,
  footnotesProperty,
  endnotesProperty,
  compatibilityModeProperty,
  themeFontLanguagesProperty,
  themesProperty,
  nameProperty,
  basedOnProperty,
  nextProperty,
  linkProperty,
  localeIdProperty,
  localeIdFarEastProperty,
  localeIdBidiProperty,
  boldProperty,
  italicProperty,
  underlineProperty,
  ...
  fontFamilyBidiProperty,
  boldBidiProperty,
  italicBidiProperty,
  allCapsProperty,
  complexScriptProperty,
  fontFamilyAsciiProperty,
  fontFamilyFarEastProperty,
  fontFamilyNonFarEastProperty,
  revisionIdsProperty,
  listIdProperty,
  ...
  spaceAfterAutoProperty,
  spaceBeforeAutoProperty,
  lineSpacingProperty,
  lineSpacingTypeProperty,
  listFormatProperty,
  keepWithNextProperty,
  widowControlProperty,
  ...
  restartPageNumberingProperty,
  pageStartingNumberProperty,
  endnoteNumberFormatProperty,
  footNoteNumberFormatProperty,
  restartIndexForFootnotesProperty,
  restartIndexForEndnotesProperty,
  initialFootNoteNumberProperty,
  initialEndNoteNumberProperty,
  pageNumberStyleProperty,
  columnsProperty,
  numberOfColumnsProperty,
  equalWidthProperty,
  lineBetweenColumnsProperty,
  breakCodeProperty,
  cellWidthProperty,
  columnSpanProperty,
  rowSpanProperty,
  ...
  afterWidthProperty,
  gridBeforeProperty,
  gridBeforeWidthProperty,
  gridBeforeWidthTypeProperty,
  gridAfterProperty,
  gridAfterWidthProperty,
  gridAfterWidthTypeProperty,
  allowAutoFitProperty,
  cellSpacingProperty,
  shadingProperty,
  tableAlignmentProperty,
  preferredWidthProperty,
  preferredWidthTypeProperty,
  horizontalPositionAbsProperty,
  textureProperty,
  ...
  backwardProperty,
  interceptProperty,
  isDisplayRSquaredProperty,
  isDisplayEquationProperty,
  seriesNameProperty,
  dataLabelProperty,
  errorBarProperty,
  seriesFormatProperty,
  trendLinesProperty,
  dataPointsProperty,
  firstSliceAngleProperty,
  holeSizeProperty,
  isLegendKeyProperty,
  isBubbleSizeProperty,
  isCategoryNameProperty,
  isSeriesNameProperty,
  isValueProperty,
  isPercentageProperty,
  isLeaderLinesProperty,
  showSeriesKeysProperty,
  hasHorizontalBorderProperty,
  hasVerticalBorderProperty,
  hasBordersProperty,
  categoryTypeProperty,
  chartCategoryProperty,
  chartSeriesProperty,
  chartAreaProperty,
  chartTitleAreaProperty,
  plotAreaProperty,
  chartLegendProperty,
  ...
  verticalRelativePercentProperty,
  horizontalRelativePercentProperty,
  heightRelativePercentProperty,
  widthRelativePercentProperty,
  zOrderPositionProperty,
  layoutInCellProperty,
  lockAnchorProperty,
  autoShapeTypeProperty,
  textFrameProperty,
  colorProperty,
  fillProperty,
  textVerticalAlignmentProperty,
  imageStringProperty,
  metaFileImageStringProperty,
  lengthProperty,
  isInlineImageProperty,
  isMetaFileProperty,
  topProperty,
  bottomProperty,
  rightProperty,
  leftProperty,
  getImageHeightProperty,
  getImageWidthProperty,
  hasFieldEndProperty,
  ...
  commentIdProperty,
  commentCharacterTypeProperty,
  authorProperty,
  initialProperty,
  dateProperty,
  doneProperty,
  replyCommentsProperty,
  revisionTypeProperty,
  revisionIdProperty,
  itemIDProperty,
  xmlProperty,
  footnoteTypeProperty,
  symbolCodeProperty,
  symbolFontNameProperty,
  customMarkerProperty,
  inlinesProperty,
  contentControlPropertiesProperty,
  lockContentControlProperty,
  lockContentsProperty,
  tagProperty,
  titleProperty,
  hasPlaceHolderTextProperty,
  multiLineProperty,
  isTemporaryProperty,
  dateCalendarTypeProperty,
  dateStorageFormatProperty,
  dateDisplayLocaleProperty,
  dateDisplayFormatProperty,
  isCheckedProperty,
  uncheckedStateProperty,
  checkedStateProperty,
  contentControlListItemsProperty,
  xmlMappingProperty,
  fontProperty,
  valueProperty,
  displayTextProperty,
  ...
  rowsProperty,
  descriptionProperty,
  wrapTextAroundProperty,
  positioningProperty,
  tableFormatProperty,
  allowOverlapProperty,
  distanceTopProperty,
  distanceRightProperty,
  distanceLeftProperty,
  distanceBottomProperty,
  ...
  firstPageFooterProperty,
  headersFootersProperty,
  ...
  levelsProperty,
  overrideListLevelProperty,
  levelOverridesProperty,
  separatorProperty,
  continuationSeparatorProperty,
  continuationNoticeProperty,
  bookmarkTypeProperty,
  propertiesProperty,
  tabJustificationProperty,
  positionProperty,
  ...
  userProperty,
  groupProperty,
  editableRangeStartProperty,
  spaceProperty,
  fontSchemeProperty,
  fontSchemeNameProperty,
  majorFontSchemeProperty,
  minorFontSchemeProperty,
  fontSchemeListProperty,
  fontTypefaceProperty,
  typefaceProperty,
  panoseProperty,
  typeProperty,
  majorUnitProperty,
  ...
  majorTickMarkProperty,
  minorTickMarkProperty,
  tickLabelPositionProperty,
  rgbProperty,
  appearanceProperty,
  lineFormatTypeProperty,
  allowSpaceOfSameStyleInTableProperty,
  weightProperty,
  inlineFormatProperty,
  fontNameProperty,
  isCompressedProperty,
  columnIndexProperty,
  columnCountProperty,
  gridProperty,
  isAfterParagraphMarkProperty,
  isAfterCellMarkProperty,
  isAfterRowMarkProperty,
  isAfterTableMarkProperty,
  belowTextProperty,
  breakClearTypeProperty,
  nsidProperty,
  isLegalStyleNumberingProperty,
  horizontalRuleProperty,
  isCreatedUsingHtmlSpanTagProperty,
  isAutoMajorProperty,
} from '../../index';
import { FieldSettingsModel } from '@hoyui/navigations';
/**
...
export class SfdtExport {
  ...
  public serialize(): string {
    return this.seralizeInternal(
      this.owner.documentEditorSettings.optimizeSfdt ? 1 : 0
    );
  }
  /**
   * Serialize the data as Syncfusion document text.
  ...
  private updateEditRangeId(): void {
    ...
    for (
      let i: number = 0;
      i < this.documentHelper.editRanges.keys.length;
      i++
    ) {
      const keys: string[] = this.documentHelper.editRanges.keys;
      for (let j: number = 0; j < keys[i].length; j++) {
        const editRangeStart: EditRangeStartElementBox[] =
          this.documentHelper.editRanges.get(keys[i]);
  ...
  public write(
    ...
    if (!isNullOrUndefined(index)) {
      ...
      this.keywordIndex = this.owner.documentEditorSettings.optimizeSfdt
        ? 1
        : 0;
    }
    this.Initialize();
    ...
    if (line instanceof LineWidget && endLine instanceof LineWidget) {
      ...
      let section: any = this.createSection(
        line.paragraph.bodyWidget as BlockContainer
      );
      ...
      let isSameCell: boolean =
        selectionStartCell instanceof TableCellWidget &&
        selectionEndCell instanceof TableCellWidget &&
      ...
      if (isSameCell || isNullOrUndefined(endCell)) {
        ...
        if (startCell instanceof TableCellWidget) {
          ...
          if (startTable.tableFormat === endTable.tableFormat) {
            ...
            if (
              this.endCell.ownerTable !== startCell.ownerTable &&
              startCell.ownerTable.associatedCell &&
              startCell.ownerTable.associatedCell.ownerTable ===
                this.endCell.ownerTable &&
              startCell.ownerTable.associatedCell.childWidgets.indexOf(
            ...
            this.endColumnIndex =
              this.endCell.columnIndex + this.endCell.cellFormat.columnSpan;
      ...
      if (
        (isSameCell && !this.isPartialExport) ||
        isNullOrUndefined(startCell)
      ) {
        ...
        if (this.isPartialExport) {
          ...
          section =
            this.document[sectionsProperty[this.keywordIndex]][
              this.document[sectionsProperty[this.keywordIndex]].length - 1
            ];
        }
        while (nextBlock) {
          const isDifferentSection =
            nextBlock.containerWidget instanceof BodyWidget &&
            lastBlock.containerWidget instanceof BodyWidget &&
            nextBlock.containerWidget.sectionIndex !==
              lastBlock.containerWidget.sectionIndex;
          if (isDifferentSection) {
            section = this.createSection(
              nextBlock.containerWidget as BlockContainer
            );
            this.document[sectionsProperty[this.keywordIndex]].push(section);
            let paragraph: any = this.createParagraph(
              nextBlock as ParagraphWidget
            );
            section[blocksProperty[this.keywordIndex]].push(paragraph);
            lastBlock = nextBlock;
            nextBlock = this.writeParagraph(
              lastBlock as ParagraphWidget,
              paragraph,
              section[blocksProperty[this.keywordIndex]],
              line.indexInOwner,
              startOffset
        ...
        if (isNullOrUndefined(endCell) && startCell.ownerTable.associatedCell) {
          let startTable: TableWidget = startCell.getContainerTable();
          let lastRow: TableRowWidget = startTable.childWidgets[
            startTable.childWidgets.length - 1
          ] as TableRowWidget;
          let endCell: TableCellWidget = lastRow.childWidgets[
            lastRow.childWidgets.length - 1
          ] as TableCellWidget;
          if (
            endCell.ownerTable !== startCell.ownerTable &&
            startCell.ownerTable.associatedCell &&
            startCell.ownerTable.associatedCell.childWidgets.indexOf(
              startCell.ownerTable
            ) === 0
          ...
          this.endColumnIndex =
            endCell.columnIndex + endCell.cellFormat.columnSpan;
          this.startColumnIndex = startCell.columnIndex;
        }
        ...
        nextBlock = this.writeTable(
          startCell.ownerTable,
          table,
          startCell.ownerRow.indexInOwner,
          section[blocksProperty[this.keywordIndex]]
        );
        if (this.isPartialExport) {
          nextBlock = this.getNextBlock(nextBlock, lastBlock);
    ...
    this.document[backgroundProperty[this.keywordIndex]] = {
      [colorProperty[this.keywordIndex]]: this.documentHelper.backgroundColor,
    };
  ...
  private getNextBlock(
    nextBlock: BlockWidget,
    lastBlock: BlockWidget
  ): BlockWidget {
    if (
      isNullOrUndefined(nextBlock) &&
      this.isPartialExport &&
      this.endBlock &&
      !this.endBlock.equals(lastBlock)
    ) {
      nextBlock = lastBlock.getSplitWidgets().pop()
        .nextRenderedWidget as BlockWidget;
      if (
        nextBlock &&
        lastBlock.bodyWidget.index !== nextBlock.bodyWidget.index
      ) {
        let section: any = this.createSection(
          nextBlock.bodyWidget as BlockContainer
        );
        this.document[sectionsProperty[this.keywordIndex]].push(section);
      } else {
        nextBlock = undefined;
  ...
  public Initialize(): void {
    ...
    this.document[sectionsProperty[this.keywordIndex]] = [];
    this.document[characterFormatProperty[this.keywordIndex]] =
      this.writeCharacterFormat(
        this.documentHelper.characterFormat,
        this.keywordIndex
      );
    this.document[paragraphFormatProperty[this.keywordIndex]] =
      this.writeParagraphFormat(
        this.documentHelper.paragraphFormat,
        this.keywordIndex
      );
    if (!isNullOrUndefined(this.documentHelper.fontSubstitutionTable)) {
      this.document[fontSubstitutionTableProperty[this.keywordIndex]] =
        this.writeFontSubsitutionTable(this.documentHelper);
    }
    this.document[themeFontLanguagesProperty[this.keywordIndex]] =
      this.writeCharacterFormat(
        this.documentHelper.themeFontLanguage,
        this.keywordIndex
      );
    this.document[defaultTabWidthProperty[this.keywordIndex]] =
      this.documentHelper.defaultTabWidth;
    this.document[trackChangesProperty[this.keywordIndex]] =
      HelperMethods.getBoolInfo(
        this.owner.enableTrackChanges,
        this.keywordIndex
      );
    this.document[enforcementProperty[this.keywordIndex]] =
      HelperMethods.getBoolInfo(
        this.documentHelper.isDocumentProtected,
        this.keywordIndex
      );
    this.document[hashValueProperty[this.keywordIndex]] =
      this.documentHelper.hashValue;
    this.document[saltValueProperty[this.keywordIndex]] =
      this.documentHelper.saltValue;
    this.document[formattingProperty[this.keywordIndex]] =
      HelperMethods.getBoolInfo(
        this.documentHelper.restrictFormatting,
        this.keywordIndex
      );
    this.document[protectionTypeProperty[this.keywordIndex]] =
      this.keywordIndex == 1
        ? this.getProtectionTypeEnumValue(this.documentHelper.protectionType)
        : this.documentHelper.protectionType;
    this.document[doNotUseHTMLParagraphAutoSpacingProperty[this.keywordIndex]] =
      HelperMethods.getBoolInfo(
        this.documentHelper.dontUseHtmlParagraphAutoSpacing,
        this.keywordIndex
      );
    this.document[formFieldShadingProperty[this.keywordIndex]] =
      HelperMethods.getBoolInfo(
        this.documentHelper.owner.documentEditorSettings.formFieldSettings
          .applyShading,
        this.keywordIndex
      );
    this.document[compatibilityModeProperty[this.keywordIndex]] =
      this.keywordIndex == 1
        ? this.getCompatibilityModeEnumValue(
            this.documentHelper.compatibilityMode
          )
        : this.documentHelper.compatibilityMode;
    this.document[allowSpaceOfSameStyleInTableProperty[this.keywordIndex]] =
      HelperMethods.getBoolInfo(
        this.documentHelper.allowSpaceOfSameStyleInTable,
        this.keywordIndex
      );
    if (this.documentHelper.hasThemes) {
      this.document[themesProperty[this.keywordIndex]] = this.writeThemes(
        this.documentHelper.themes
      );
    }
  }
  private writeFontSubsitutionTable(documentHelper: DocumentHelper): any {
    ...
    for (
      let i: number = 0;
      i < documentHelper.fontSubstitutionTable.length;
      i++
    ) {
      let key: string = documentHelper.fontSubstitutionTable.keys[i];
      fontSubstitutionTable[key] =
        this.documentHelper.fontSubstitutionTable.get(key);
    }
  ...
  private writeBodyWidget(bodyWidget: BodyWidget, index: number): BodyWidget {
    ...
    this.document[sectionsProperty[this.keywordIndex]].push(section);
    this.writeHeaderFooters(
      this.documentHelper.headersFooters[bodyWidget.index],
      section
    );
    ...
    if (isNullOrUndefined(firstBlock) && bodyWidget.nextRenderedWidget) {
      firstBlock = bodyWidget.nextRenderedWidget.childWidgets[
        index
      ] as BlockWidget;
    }
    do {
      firstBlock = this.writeBlock(
        firstBlock as BlockWidget,
        0,
        section[blocksProperty[this.keywordIndex]]
      );
    } while (firstBlock);
    ...
    if (
      !isNullOrUndefined(bodyWidget.lastChild) &&
      bodyWidget.lastChild instanceof ParagraphWidget
    ) {
      islastEmptyParagraph = (
        bodyWidget.lastChild as ParagraphWidget
      ).isEmpty();
      if (
        bodyWidget.lastChild.isSectionBreak &&
        !isNullOrUndefined(bodyWidget.lastChild.previousRenderedWidget) &&
        bodyWidget.lastChild.previousRenderedWidget instanceof TableWidget
      ) {
    ...
    if (
      !isNullOrUndefined(next) &&
      next instanceof BodyWidget &&
      bodyWidget.sectionIndex !== next.sectionIndex &&
      islastEmptyParagraph &&
      !this.isWordExport
    ) {
      var paragraph = {};
  ...
  private writeHeaderFooters(hfs: HeaderFooters, section: any): void {
    ...
    let headersFooters: any =
      section[headersFootersProperty[this.keywordIndex]];
    if (!(isNullOrUndefined(hfs[0]) || hfs[0].isEmpty)) {
      headersFooters[headerProperty[this.keywordIndex]] =
        this.writeHeaderFooter(hfs[0]);
      if (
        JSON.stringify(headersFooters[headerProperty[this.keywordIndex]]) ==
        '{}'
      ) {
    ...
    if (!(isNullOrUndefined(hfs[1]) || hfs[1].isEmpty)) {
      headersFooters[footerProperty[this.keywordIndex]] =
        this.writeHeaderFooter(hfs[1]);
      if (
        JSON.stringify(headersFooters[footerProperty[this.keywordIndex]]) ==
        '{}'
      ) {
    ...
    if (!(isNullOrUndefined(hfs[2]) || hfs[2].isEmpty)) {
      headersFooters[evenHeaderProperty[this.keywordIndex]] =
        this.writeHeaderFooter(hfs[2]);
      if (
        JSON.stringify(headersFooters[evenHeaderProperty[this.keywordIndex]]) ==
        '{}'
      ) {
    ...
    if (!(isNullOrUndefined(hfs[3]) || hfs[3].isEmpty)) {
      headersFooters[evenFooterProperty[this.keywordIndex]] =
        this.writeHeaderFooter(hfs[3]);
      if (
        JSON.stringify(headersFooters[evenFooterProperty[this.keywordIndex]]) ==
        '{}'
      ) {
    ...
    if (!(isNullOrUndefined(hfs[4]) || hfs[4].isEmpty)) {
      headersFooters[firstPageHeaderProperty[this.keywordIndex]] =
        this.writeHeaderFooter(hfs[4]);
      if (
        JSON.stringify(
          headersFooters[firstPageHeaderProperty[this.keywordIndex]]
        ) == '{}'
    ...
    if (!(isNullOrUndefined(hfs[5]) || hfs[5].isEmpty)) {
      headersFooters[firstPageFooterProperty[this.keywordIndex]] =
        this.writeHeaderFooter(hfs[5]);
      if (
        JSON.stringify(
          headersFooters[firstPageFooterProperty[this.keywordIndex]]
        ) == '{}'
  ...
  private createSection(bodyWidget: BlockContainer): any {
    ...
    section[sectionFormatProperty[this.keywordIndex]] = this.writeSectionFormat(
      bodyWidget.sectionFormat,
      section[sectionFormatProperty[this.keywordIndex]],
      this.keywordIndex
    );
    section[blocksProperty[this.keywordIndex]] = [];
  ...
  public writeSectionFormat(
    ...
    section[headerDistanceProperty[keywordIndex]] =
      sectionFormat.headerDistance;
    section[footerDistanceProperty[keywordIndex]] =
      sectionFormat.footerDistance;
    section[differentFirstPageProperty[keywordIndex]] =
      HelperMethods.getBoolInfo(sectionFormat.differentFirstPage, keywordIndex);
    section[differentOddAndEvenPagesProperty[keywordIndex]] =
      HelperMethods.getBoolInfo(
        sectionFormat.differentOddAndEvenPages,
        keywordIndex
      );
    section[bidiProperty[keywordIndex]] = HelperMethods.getBoolInfo(
      sectionFormat.bidi,
      keywordIndex
    );
    ...
    if (sectionFormat.restartPageNumbering) {
      section[restartPageNumberingProperty[keywordIndex]] =
        HelperMethods.getBoolInfo(
          sectionFormat.restartPageNumbering,
          keywordIndex
        );
      section[pageStartingNumberProperty[keywordIndex]] =
        sectionFormat.pageStartingNumber;
    }

    section[endnoteNumberFormatProperty[keywordIndex]] =
      keywordIndex == 1
        ? this.getFootEndNoteNumberFormatEnumValue(
            sectionFormat.endnoteNumberFormat
          )
        : sectionFormat.endnoteNumberFormat;
    section[footNoteNumberFormatProperty[keywordIndex]] =
      keywordIndex == 1
        ? this.getFootEndNoteNumberFormatEnumValue(
            sectionFormat.footNoteNumberFormat
          )
        : sectionFormat.footNoteNumberFormat;
    section[restartIndexForFootnotesProperty[keywordIndex]] =
      keywordIndex == 1
        ? this.getFootnoteRestartIndexEnumValue(
            sectionFormat.restartIndexForFootnotes
          )
        : sectionFormat.restartIndexForFootnotes;
    section[restartIndexForEndnotesProperty[keywordIndex]] =
      keywordIndex == 1
        ? this.getFootnoteRestartIndexEnumValue(
            sectionFormat.restartIndexForEndnotes
          )
        : sectionFormat.restartIndexForEndnotes;
    section[initialFootNoteNumberProperty[keywordIndex]] =
      sectionFormat.initialFootNoteNumber;
    section[initialEndNoteNumberProperty[keywordIndex]] =
      sectionFormat.initialEndNoteNumber;

    if (!isNullOrUndefined(sectionFormat.pageNumberStyle)) {
      section[pageNumberStyleProperty[keywordIndex]] =
        sectionFormat.pageNumberStyle;
    }
    if (
      !isNullOrUndefined(sectionFormat.columns) &&
      !isNullOrUndefined(
        sectionFormat.numberOfColumns && sectionFormat.numberOfColumns > 1
      )
    ) {
      let cols: WColumnFormat[] = sectionFormat.columns;
      section[numberOfColumnsProperty[keywordIndex]] =
        sectionFormat.numberOfColumns;
      section[equalWidthProperty[keywordIndex]] = HelperMethods.getBoolInfo(
        sectionFormat.equalWidth,
        keywordIndex
      );
      section[lineBetweenColumnsProperty[keywordIndex]] =
        HelperMethods.getBoolInfo(
          sectionFormat.lineBetweenColumns,
          keywordIndex
        );
      section[columnsProperty[keywordIndex]] = [];
      for (let i: number = 0; i < cols.length; i++) {
        let newCol: any = {};
        newCol[widthProperty[keywordIndex]] = HelperMethods.convertPixelToPoint(
          cols[i].width as number
        );
        newCol[spaceProperty[keywordIndex]] = HelperMethods.convertPixelToPoint(
          cols[i].space as number
        );
  ...
  private writeBlock(
    ...
    if (widget instanceof ParagraphWidget) {
      if (
        widget.hasOwnProperty('contentControlProperties') &&
        widget.contentControlProperties &&
        widget.contentControlProperties.type !== 'BuildingBlockGallery'
      ) {
        let block: any = this.blockContentControl(widget);
        this.blockContent = false;
        if (
          !isNullOrUndefined(block) &&
          (this.isBlockClosed || !this.nestedBlockContent)
        ) {
      ...
      if (
        tableWidget.hasOwnProperty('contentControlProperties') &&
        tableWidget.contentControlProperties &&
        tableWidget.contentControlProperties.type !== 'BuildingBlockGallery'
      ) {
  ...
  private writeParagraphs(widget: ParagraphWidget): any {
    ...
    if (
      firstElement instanceof ListTextElementBox ||
      secondElement instanceof ListTextElementBox
    ) {
      firstElement = child.children[2];
      secondElement = child.children[3];
    }
    if (
      !isNullOrUndefined(widget.contentControlProperties) &&
      widget.containerWidget instanceof TableCellWidget &&
      !isNullOrUndefined(widget.containerWidget.containerWidget) &&
      !isNullOrUndefined(
        (widget.containerWidget.containerWidget.containerWidget as TableWidget)
          .contentControlProperties
      )
    ) {
      blocks = [];
    ...
    if (
      (firstElement instanceof ContentControl &&
        secondElement instanceof ContentControl &&
        !this.nestedBlockContent) ||
      (this.blockContent &&
        firstElement instanceof ContentControl &&
        !this.nestedBlockContent)
    ) {
      ...
      if (secondElement instanceof ContentControl) {
        if (
          (secondElement as ContentControl).contentControlWidgetType === 'Block'
        ) {
          nestedBlocks = true;
        }
      }
      if (
        ...
        (this.blockContent &&
          firstElement instanceof ContentControl &&
          !this.nestedBlockContent &&
          (firstElement as ContentControl).type === 0 &&
          secondElement instanceof ContentControl &&
          (firstElement as ContentControl).contentControlWidgetType === 'Block')
      ) {
  ...
  private contentControlProperty(
    contentControlPropertie: ContentControlProperties
  ): any {
    let contentControlProperties: any = {};
    let contentControlListItems: any = [];
    contentControlProperties[lockContentControlProperty[this.keywordIndex]] =
      HelperMethods.getBoolInfo(
        contentControlPropertie.lockContentControl,
        this.keywordIndex
      );
    contentControlProperties[lockContentsProperty[this.keywordIndex]] =
      HelperMethods.getBoolInfo(
        contentControlPropertie.lockContents,
        this.keywordIndex
      );
    contentControlProperties[tagProperty[this.keywordIndex]] =
      contentControlPropertie.tag;
    contentControlProperties[colorProperty[this.keywordIndex]] =
      contentControlPropertie.color;
    contentControlProperties[titleProperty[this.keywordIndex]] =
      contentControlPropertie.title;
    if (!isNullOrUndefined(contentControlPropertie.appearance)) {
      contentControlProperties[appearanceProperty[this.keywordIndex]] =
        this.keywordIndex == 1
          ? this.getContentControlAppearanceEnumValue(
              contentControlPropertie.appearance
            )
          : contentControlPropertie.appearance;
    }
    contentControlProperties[typeProperty[this.keywordIndex]] =
      this.keywordIndex == 1
        ? this.getContentControlTypeEnumValue(contentControlPropertie.type)
        : contentControlPropertie.type;
    contentControlProperties[hasPlaceHolderTextProperty[this.keywordIndex]] =
      HelperMethods.getBoolInfo(
        contentControlPropertie.hasPlaceHolderText,
        this.keywordIndex
      );
    contentControlProperties[multiLineProperty[this.keywordIndex]] =
      HelperMethods.getBoolInfo(
        contentControlPropertie.multiline,
        this.keywordIndex
      );
    contentControlProperties[isTemporaryProperty[this.keywordIndex]] =
      HelperMethods.getBoolInfo(
        contentControlPropertie.isTemporary,
        this.keywordIndex
      );
    if (!isNullOrUndefined(contentControlPropertie.isChecked)) {
      contentControlProperties[isCheckedProperty[this.keywordIndex]] =
        HelperMethods.getBoolInfo(
          contentControlPropertie.isChecked,
          this.keywordIndex
        );
    }
    if (!isNullOrUndefined(contentControlPropertie.uncheckedState)) {
      contentControlProperties[uncheckedStateProperty[this.keywordIndex]] =
        this.tounCheckedState(contentControlPropertie.uncheckedState);
    }
    if (!isNullOrUndefined(contentControlPropertie.checkedState)) {
      contentControlProperties[checkedStateProperty[this.keywordIndex]] =
        this.toCheckedState(contentControlPropertie.checkedState);
    }
    if (!isNullOrUndefined(contentControlPropertie.dateCalendarType)) {
      contentControlProperties[dateCalendarTypeProperty[this.keywordIndex]] =
        this.keywordIndex == 1
          ? this.getDateCalendarTypeEnumValue(
              contentControlPropertie.dateCalendarType
            )
          : contentControlPropertie.dateCalendarType;
    }
    if (!isNullOrUndefined(contentControlPropertie.dateStorageFormat)) {
      contentControlProperties[dateStorageFormatProperty[this.keywordIndex]] =
        this.keywordIndex == 1
          ? this.getDateStorageFormatEnumValue(
              contentControlPropertie.dateStorageFormat
            )
          : contentControlPropertie.dateStorageFormat;
    }
    if (!isNullOrUndefined(contentControlPropertie.dateDisplayLocale)) {
      contentControlProperties[dateDisplayLocaleProperty[this.keywordIndex]] =
        contentControlPropertie.dateDisplayLocale;
    }
    if (!isNullOrUndefined(contentControlPropertie.dateDisplayFormat)) {
      contentControlProperties[dateDisplayFormatProperty[this.keywordIndex]] =
        contentControlPropertie.dateDisplayFormat;
    }
    if (!isNullOrUndefined(contentControlPropertie.xmlMapping)) {
      let xmlMapping: any = {};
      let customXmlPart: any = {};
      xmlMapping[isMappedProperty[this.keywordIndex]] =
        HelperMethods.getBoolInfo(
          contentControlPropertie.xmlMapping.isMapped,
          this.keywordIndex
        );
      xmlMapping[isWordMlProperty[this.keywordIndex]] =
        HelperMethods.getBoolInfo(
          contentControlPropertie.xmlMapping.isWordMl,
          this.keywordIndex
        );
      if (
        !isNullOrUndefined(contentControlPropertie.xmlMapping.prefixMapping)
      ) {
        xmlMapping[prefixMappingProperty[this.keywordIndex]] =
          contentControlPropertie.xmlMapping.prefixMapping;
      }
      xmlMapping[xPathProperty[this.keywordIndex]] =
        contentControlPropertie.xmlMapping.xPath;
      xmlMapping[storeItemIdProperty[this.keywordIndex]] =
        contentControlPropertie.xmlMapping.storeItemId;
      if (
        !isNullOrUndefined(contentControlPropertie.xmlMapping.customXmlPart)
      ) {
        customXmlPart[idProperty[this.keywordIndex]] =
          contentControlPropertie.xmlMapping.customXmlPart.id;
        customXmlPart[xmlProperty[this.keywordIndex]] =
          contentControlPropertie.xmlMapping.customXmlPart.xml;
        xmlMapping[customXmlPartProperty[this.keywordIndex]] = customXmlPart;
      }
      contentControlProperties[xmlMappingProperty[this.keywordIndex]] =
        xmlMapping;
    }
    if (!isNullOrUndefined(contentControlPropertie.characterFormat)) {
      contentControlProperties[characterFormatProperty[this.keywordIndex]] =
        this.writeCharacterFormat(
          contentControlPropertie.characterFormat,
          this.keywordIndex
        );
    }
    if (!isNullOrUndefined(contentControlPropertie.contentControlListItems)) {
      for (
        let i: number = 0;
        i < contentControlPropertie.contentControlListItems.length;
        i++
      ) {
        let listItems: any = {};
        listItems[displayTextProperty[this.keywordIndex]] =
          contentControlPropertie.contentControlListItems[i].displayText;
        listItems[valueProperty[this.keywordIndex]] =
          contentControlPropertie.contentControlListItems[i].value;
        contentControlListItems.push(listItems);
      }
    }
    contentControlProperties[
      contentControlListItemsProperty[this.keywordIndex]
  ...
  private blockContentControl(widget: ParagraphWidget): any {
    ...
    if (!isNullOrUndefined(this.nextBlock)) {
      if (
        widget.contentControlProperties ===
        this.nextBlock.contentControlProperties
      ) {
    ...
    if (!isNullOrUndefined(block[blocksProperty[this.keywordIndex]])) {
      ...
      if (
        firstChild instanceof ListTextElementBox ||
      ...
      if (
        (firstChild instanceof ContentControl &&
          secondChild instanceof ContentControl &&
          !this.nestedBlockContent) ||
        (this.blockContent &&
          firstChild instanceof ContentControl &&
          !this.nestedBlockContent)
        ...
        if (!(secondChild instanceof ContentControl)) {
          block[contentControlPropertiesProperty[this.keywordIndex]] =
            this.contentControlProperty(firstChild.contentControlProperties);
          return block;
        } else if (
          (secondChild as ContentControl).contentControlWidgetType === 'Block'
        ) {
          block[contentControlPropertiesProperty[this.keywordIndex]] =
            this.contentControlProperty(secondChild.contentControlProperties);
        } else {
          block[contentControlPropertiesProperty[this.keywordIndex]] =
            this.contentControlProperty(widget.contentControlProperties);
        }
      } else {
        block[contentControlPropertiesProperty[this.keywordIndex]] =
          this.contentControlProperty(widget.contentControlProperties);
  ...
  private tableContentControl(tableWidget: TableWidget): any {
    let block: any = {};
    block[blocksProperty[this.keywordIndex]] =
      this.tableContentControls(tableWidget);
    if (!isNullOrUndefined(this.nextBlock)) {
      if (
        tableWidget.contentControlProperties ===
        this.nextBlock.contentControlProperties
    ...
    block[contentControlPropertiesProperty[this.keywordIndex]] =
      this.contentControlProperty(tableWidget.contentControlProperties);
    return block;
  }
  ...
  private writeParagraph(
    ...
    while (next instanceof ParagraphWidget) {
      if (
        ...
        if (
          this.endLine === next.lastChild &&
          this.endOffset ===
            this.owner.selection.getLineLength(next.lastChild as LineWidget) +
              1 &&
          next.paragraphFormat.listFormat.listId === -1
        ) {
    ...
    if (
      this.documentHelper.owner.layoutType !== 'Continuous' &&
      isNullOrUndefined(next) &&
      paragraphWidget.containerWidget instanceof BodyWidget &&
      !isNullOrUndefined(
        (paragraphWidget.containerWidget as BodyWidget).page
      ) &&
      !isNullOrUndefined(
        (paragraphWidget.containerWidget as BodyWidget).page.nextPage
      ) &&
      !isNullOrUndefined(
        (paragraphWidget.containerWidget as BodyWidget).page.nextPage
          .bodyWidgets
      ...
      next = (paragraphWidget.containerWidget as BodyWidget).page.nextPage
        .bodyWidgets[0].childWidgets[0] as BlockWidget;
    }
    if (this.isExport) {
      return next instanceof BlockWidget &&
        paragraphWidget.containerWidget.index === next.containerWidget.index
        ? next
        : undefined;
    } else {
      return next;
  ...
  private writeInlines(
    ...
    for (let i: number = 0; i < lineWidget.children.length; i++) {
      ...
      if (
        ...
        (this.startContent && !this.blockContent)
      ) {
  ...
  private inlineContentControl(
    ...
    if (!isNullOrUndefined(inlines)) {
      if (this.nestedContent) {
        ...
        // }
        inline = this.inlineContentControls(
          element,
          inlines[inlines.length - 1][inlinesProperty[this.keywordIndex]]
        );
        let nestedContentinline: any = this.nestedContentProperty(
          nextElement,
      ...
      if (this.nestedContent) {
        inline[inlinesProperty[this.keywordIndex]] = this.inlineContentControls(
          element,
          undefined,
          nestedContentInline
        );
        ...
        if (
          !isNullOrUndefined(nestedContentinline) ||
    ...
    if (
      nextElement instanceof ContentControl &&
      nextElement.type === 1 &&
      !this.nestedContent
    ) {
      if (this.multipleLineContent && !isNullOrUndefined(inlines)) {
        inlines[inlines.length - 1][
          contentControlPropertiesProperty[this.keywordIndex]
        ] = this.contentControlProperty(nextElement.contentControlProperties);
        this.multipleLineContent = false;
        return;
      } else {
        inline[contentControlPropertiesProperty[this.keywordIndex]] =
          this.contentControlProperty(nextElement.contentControlProperties);
      }
      return inline;
  ...
  private writeInline(element: ElementBox): any {
    ...
    if (element.removedIds.length > 0) {
      for (let i: number = 0; i < element.removedIds.length; i++) {
        element.revisions[i] = this.documentHelper.revisionsInternal.get(
          element.removedIds[i]
        );
      }
    }
    inline[characterFormatProperty[this.keywordIndex]] =
      this.writeCharacterFormat(element.characterFormat, this.keywordIndex);
    if (element instanceof FieldElementBox) {
      ...
      if (element.fieldType === 0) {
        ...
        if (element.formFieldData) {
          ...
          inline[formFieldDataProperty[this.keywordIndex]][
            nameProperty[this.keywordIndex]
          ] = element.formFieldData.name;
          inline[formFieldDataProperty[this.keywordIndex]][
            enabledProperty[this.keywordIndex]
          ] = HelperMethods.getBoolInfo(
            element.formFieldData.enabled,
            this.keywordIndex
          );
          inline[formFieldDataProperty[this.keywordIndex]][
            helpTextProperty[this.keywordIndex]
          ] = element.formFieldData.helpText;
          inline[formFieldDataProperty[this.keywordIndex]][
            statusTextProperty[this.keywordIndex]
          ] = element.formFieldData.statusText;
          if (element.formFieldData instanceof TextFormField) {
            inline[formFieldDataProperty[this.keywordIndex]][
              textInputProperty[this.keywordIndex]
            ] = {};
            inline[formFieldDataProperty[this.keywordIndex]][
              textInputProperty[this.keywordIndex]
            ][typeProperty[this.keywordIndex]] =
              this.keywordIndex == 1
                ? this.getTextFormFieldTypeEnumValue(
                    (element.formFieldData as TextFormField).type
                  )
                : (element.formFieldData as TextFormField).type;
            inline[formFieldDataProperty[this.keywordIndex]][
              textInputProperty[this.keywordIndex]
            ][maxLengthProperty[this.keywordIndex]] = (
              element.formFieldData as TextFormField
            ).maxLength;
            inline[formFieldDataProperty[this.keywordIndex]][
              textInputProperty[this.keywordIndex]
            ][defaultValueProperty[this.keywordIndex]] = (
              element.formFieldData as TextFormField
            ).defaultValue;
            inline[formFieldDataProperty[this.keywordIndex]][
              textInputProperty[this.keywordIndex]
            ][formatProperty[this.keywordIndex]] =
              this.keywordIndex == 1 &&
              (element.formFieldData as TextFormField).type === 'Text'
                ? this.getTextFormFieldFormatEnumValue(
                    (element.formFieldData as TextFormField).format
                  )
                : (element.formFieldData as TextFormField).format;
          } else if (element.formFieldData instanceof CheckBoxFormField) {
            inline[formFieldDataProperty[this.keywordIndex]][
              checkBoxProperty[this.keywordIndex]
            ] = {};
            this.checkboxOrDropdown = true;
            inline[formFieldDataProperty[this.keywordIndex]][
              checkBoxProperty[this.keywordIndex]
            ][sizeTypeProperty[this.keywordIndex]] =
              this.keywordIndex == 1
                ? this.getCheckBoxSizeTypeEnumValue(
                    (element.formFieldData as CheckBoxFormField).sizeType
                  )
                : (element.formFieldData as CheckBoxFormField).sizeType;
            inline[formFieldDataProperty[this.keywordIndex]][
              checkBoxProperty[this.keywordIndex]
            ][sizeProperty[this.keywordIndex]] = (
              element.formFieldData as CheckBoxFormField
            ).size;
            inline[formFieldDataProperty[this.keywordIndex]][
              checkBoxProperty[this.keywordIndex]
            ][defaultValueProperty[this.keywordIndex]] =
              HelperMethods.getBoolInfo(
                (element.formFieldData as CheckBoxFormField).defaultValue,
                this.keywordIndex
              );
            inline[formFieldDataProperty[this.keywordIndex]][
              checkBoxProperty[this.keywordIndex]
            ][checkedProperty[this.keywordIndex]] = HelperMethods.getBoolInfo(
              (element.formFieldData as CheckBoxFormField).checked,
              this.keywordIndex
            );
          } else {
            inline[formFieldDataProperty[this.keywordIndex]][
              dropDownListProperty[this.keywordIndex]
            ] = {};
            this.checkboxOrDropdown = true;
            inline[formFieldDataProperty[this.keywordIndex]][
              dropDownListProperty[this.keywordIndex]
            ][dropDownItemsProperty[this.keywordIndex]] = (
              element.formFieldData as DropDownFormField
            ).dropdownItems;
            inline[formFieldDataProperty[this.keywordIndex]][
              dropDownListProperty[this.keywordIndex]
            ][selectedIndexProperty[this.keywordIndex]] = (
              element.formFieldData as DropDownFormField
            ).selectedIndex;
          }
        }
      ...
      inline[metaFileImageStringProperty[this.keywordIndex]] =
        element.metaFileImageString;
      inline[isMetaFileProperty[this.keywordIndex]] = HelperMethods.getBoolInfo(
        element.isMetaFile,
        this.keywordIndex
      );
      inline[isCompressedProperty[this.keywordIndex]] = element.isCompressed;
      inline[widthProperty[this.keywordIndex]] =
        HelperMethods.convertPixelToPoint(element.width);
      inline[heightProperty[this.keywordIndex]] =
        HelperMethods.convertPixelToPoint(element.height);
      ...
      if (element.isCrop) {
        ...
        inline[getImageWidthProperty[this.keywordIndex]] =
          element.cropWidthScale;
        inline[getImageHeightProperty[this.keywordIndex]] =
          element.cropHeightScale;
      }
      inline[nameProperty[this.keywordIndex]] = element.name;
      inline[alternativeTextProperty[this.keywordIndex]] =
        element.alternateText;
      inline[titleProperty[this.keywordIndex]] = element.title;
      inline[visibleProperty[this.keywordIndex]] = HelperMethods.getBoolInfo(
        element.visible,
        this.keywordIndex
      );
      ...
      inline[verticalPositionProperty[this.keywordIndex]] =
        HelperMethods.convertPixelToPoint(element.verticalPosition);
      inline[verticalOriginProperty[this.keywordIndex]] =
        this.keywordIndex == 1
          ? this.getVerticalOriginEnumValue(element.verticalOrigin)
          : element.verticalOrigin;
      inline[verticalAlignmentProperty[this.keywordIndex]] =
        this.keywordIndex == 1
          ? this.getShapeVerticalAlignmentEnumValue(element.verticalAlignment)
          : element.verticalAlignment;
      inline[horizontalPositionProperty[this.keywordIndex]] =
        HelperMethods.convertPixelToPoint(element.horizontalPosition);
      inline[horizontalOriginProperty[this.keywordIndex]] =
        this.keywordIndex == 1
          ? this.getHorizontalOriginEnumValue(element.horizontalOrigin)
          : element.horizontalOrigin;
      inline[horizontalAlignmentProperty[this.keywordIndex]] =
        this.keywordIndex == 1
          ? this.getShapeHorizontalAlignmentEnumValue(
              element.horizontalAlignment
            )
          : element.horizontalAlignment;
      inline[allowOverlapProperty[this.keywordIndex]] =
        HelperMethods.getBoolInfo(element.allowOverlap, this.keywordIndex);
      inline[textWrappingStyleProperty[this.keywordIndex]] =
        this.keywordIndex == 1
          ? this.getTextWrappingStyleEnumValue(element.textWrappingStyle)
          : element.textWrappingStyle;
      inline[textWrappingTypeProperty[this.keywordIndex]] =
        this.keywordIndex == 1
          ? this.getTextWrappingTypeEnumValue(element.textWrappingType)
          : element.textWrappingType;
      inline[belowTextProperty[this.keywordIndex]] = HelperMethods.getBoolInfo(
        element.isBelowText,
        this.keywordIndex
      );
      if (!isNullOrUndefined(element.distanceBottom)) {
        inline[distanceBottomProperty[this.keywordIndex]] =
          HelperMethods.convertPixelToPoint(element.distanceBottom);
      }
      if (!isNullOrUndefined(element.distanceLeft)) {
        inline[distanceLeftProperty[this.keywordIndex]] =
          HelperMethods.convertPixelToPoint(element.distanceLeft);
      }
      if (!isNullOrUndefined(element.distanceRight)) {
        inline[distanceRightProperty[this.keywordIndex]] =
          HelperMethods.convertPixelToPoint(element.distanceRight);
      }
      if (!isNullOrUndefined(element.distanceTop)) {
        inline[distanceTopProperty[this.keywordIndex]] =
          HelperMethods.convertPixelToPoint(element.distanceTop);
      }
      inline[layoutInCellProperty[this.keywordIndex]] =
        HelperMethods.getBoolInfo(element.layoutInCell, this.keywordIndex);
      inline[zOrderPositionProperty[this.keywordIndex]] =
        element.zOrderPosition;
      ...
      if (!isNullOrUndefined(element.properties)) {
        ...
        if (!isNullOrUndefined(element.properties['isAfterParagraphMark'])) {
          properties[isAfterParagraphMarkProperty[this.keywordIndex]] =
            HelperMethods.getBoolInfo(
        ...
        if (!isNullOrUndefined(element.properties['isAfterTableMark'])) {
          properties[isAfterTableMarkProperty[this.keywordIndex]] =
            HelperMethods.getBoolInfo(
              element.properties['isAfterTableMark'],
              this.keywordIndex
            );
        }
        if (!isNullOrUndefined(element.properties['isAfterRowMark'])) {
          properties[isAfterRowMarkProperty[this.keywordIndex]] =
            HelperMethods.getBoolInfo(
              element.properties['isAfterRowMark'],
              this.keywordIndex
            );
        }
        if (!isNullOrUndefined(element.properties['isAfterCellMark'])) {
          properties[isAfterCellMarkProperty[this.keywordIndex]] =
            HelperMethods.getBoolInfo(
              element.properties['isAfterCellMark'],
              this.keywordIndex
            );
        }
        if (!isNullOrUndefined(element.properties['columnFirst'])) {
          properties[columnFirstProperty[this.keywordIndex]] =
            element.properties['columnFirst'];
        }
        if (!isNullOrUndefined(element.properties['columnLast'])) {
          properties[columnLastProperty[this.keywordIndex]] =
            element.properties['columnLast'];
        }
        inline[propertiesProperty[this.keywordIndex]] = properties;
      }
    } else if (element instanceof BreakElementBox) {
      inline[breakClearTypeProperty[this.keywordIndex]] =
        this.keywordIndex == 1
          ? HelperMethods.getBreakClearType(element.breakClearType)
          : element.breakClearType;
      ...
      if (elementText.indexOf(String.fromCharCode(30)) !== -1) {
        inline[textProperty[this.keywordIndex]] = elementText.replace(
          /\u001e/g,
          '-'
        );
      ...
      inline[editRangeIdProperty[this.keywordIndex]] =
        element.editRangeId.toString();
    } else if (element instanceof EditRangeEndElementBox) {
      inline[editableRangeStartProperty[this.keywordIndex]] = {};
      inline[editableRangeStartProperty[this.keywordIndex]][
        userProperty[this.keywordIndex]
      ] = element.editRangeStart.user;
      inline[editableRangeStartProperty[this.keywordIndex]][
        groupProperty[this.keywordIndex]
      ] = element.editRangeStart.group;
      inline[editableRangeStartProperty[this.keywordIndex]][
        columnFirstProperty[this.keywordIndex]
      ] = element.editRangeStart.columnFirst;
      inline[editableRangeStartProperty[this.keywordIndex]][
        columnLastProperty[this.keywordIndex]
      ] = element.editRangeStart.columnLast;
      inline[editRangeIdProperty[this.keywordIndex]] =
        element.editRangeId.toString();
      ...
      if (this.iscontentInsert) {
        ...
        inline[commentCharacterTypeProperty[this.keywordIndex]] =
          element.commentType;
  ...
  private writeInlineRevisions(inline: any, element: ElementBox): void {
    if (
      ...
      (this.isExport || (!this.isExport && !this.owner.enableTrackChanges))
    ) {
      inline[revisionIdsProperty[this.keywordIndex]] = [];
      for (let x: number = 0; x < element.revisions.length; x++) {
        //revisionIdes[x] = element.revisions[x];
        if (
          this.selectedRevisionId.indexOf(element.revisions[x].revisionID) ===
          -1
        ) {
          this.selectedRevisionId.push(element.revisions[x].revisionID);
        }
        inline[revisionIdsProperty[this.keywordIndex]].push(
          element.revisions[x].revisionID
        );
  ...
  private writeShape(element: ShapeElementBox, inline: any): void {
    ...
    inline[verticalAlignmentProperty[this.keywordIndex]] =
      this.keywordIndex == 1
        ? this.getShapeVerticalAlignmentEnumValue(element.verticalAlignment)
        : element.verticalAlignment;
    inline[verticalRelativePercentProperty[this.keywordIndex]] =
      element.verticalRelativePercent;
    inline[horizontalPositionProperty[this.keywordIndex]] =
      HelperMethods.convertPixelToPoint(element.horizontalPosition);
    inline[horizontalOriginProperty[this.keywordIndex]] =
      this.keywordIndex == 1
    ...
    inline[horizontalAlignmentProperty[this.keywordIndex]] =
      this.keywordIndex == 1
        ? this.getShapeHorizontalAlignmentEnumValue(element.horizontalAlignment)
        : element.horizontalAlignment;
    inline[horizontalRelativePercentProperty[this.keywordIndex]] =
      element.horizontalRelativePercent;
    inline[heightRelativePercentProperty[this.keywordIndex]] =
      element.heightRelativePercent;
    inline[widthRelativePercentProperty[this.keywordIndex]] =
      element.widthRelativePercent;
    inline[zOrderPositionProperty[this.keywordIndex]] = element.zOrderPosition;
    inline[allowOverlapProperty[this.keywordIndex]] = HelperMethods.getBoolInfo(
    ...
    inline[horizontalRuleProperty[this.keywordIndex]] =
      HelperMethods.getBoolInfo(element.isHorizontalRule, this.keywordIndex);
    if (!isNullOrUndefined(element.distanceBottom)) {
      inline[distanceBottomProperty[this.keywordIndex]] =
        HelperMethods.convertPixelToPoint(element.distanceBottom);
    }
    ...
    inline[layoutInCellProperty[this.keywordIndex]] = HelperMethods.getBoolInfo(
      element.layoutInCell,
      this.keywordIndex
    );
    inline[lockAnchorProperty[this.keywordIndex]] = HelperMethods.getBoolInfo(
      element.lockAnchor,
      this.keywordIndex
    );
    inline[autoShapeTypeProperty[this.keywordIndex]] =
      this.keywordIndex == 1
        ? this.getAutoShapeTypeEnumValue(element.autoShapeType)
        : element.autoShapeType;
    ...
    if (element.fillFormat) {
      ...
      inline[fillFormatProperty[this.keywordIndex]][
        colorProperty[this.keywordIndex]
      ] = element.fillFormat.color;
      inline[fillFormatProperty[this.keywordIndex]][
        fillProperty[this.keywordIndex]
      ] = HelperMethods.getBoolInfo(element.fillFormat.fill, this.keywordIndex);
    }
    if (element.lineFormat) {
      inline[lineFormatProperty[this.keywordIndex]] = {};
      inline[lineFormatProperty[this.keywordIndex]][
        lineFormatTypeProperty[this.keywordIndex]
      ] =
        this.keywordIndex == 1
          ? this.getLineFormatTypeEnumValue(element.lineFormat.lineFormatType)
          : element.lineFormat.lineFormatType;
      inline[lineFormatProperty[this.keywordIndex]][
        colorProperty[this.keywordIndex]
      ] = element.lineFormat.color;
      inline[lineFormatProperty[this.keywordIndex]][
        weightProperty[this.keywordIndex]
      ] = element.lineFormat.weight;
      inline[lineFormatProperty[this.keywordIndex]][
        lineStyleProperty[this.keywordIndex]
      ] =
        this.keywordIndex == 1
          ? this.getLineDashStyleEnumValue(element.lineFormat.dashStyle)
          : element.lineFormat.dashStyle;
      inline[lineFormatProperty[this.keywordIndex]][
        lineProperty[this.keywordIndex]
      ] = HelperMethods.getBoolInfo(element.lineFormat.line, this.keywordIndex);
    }
    if (element.textFrame) {
      inline[textFrameProperty[this.keywordIndex]] = {};
      inline[textFrameProperty[this.keywordIndex]][
        textVerticalAlignmentProperty[this.keywordIndex]
      ] =
        this.keywordIndex == 1
          ? this.getTextVerticalAlignmentEnumValue(
              element.textFrame.textVerticalAlignment
            )
          : element.textFrame.textVerticalAlignment;
      inline[textFrameProperty[this.keywordIndex]][
        leftMarginProperty[this.keywordIndex]
      ] = HelperMethods.convertPixelToPoint(element.textFrame.marginLeft);
      inline[textFrameProperty[this.keywordIndex]][
        rightMarginProperty[this.keywordIndex]
      ] = HelperMethods.convertPixelToPoint(element.textFrame.marginRight);
      inline[textFrameProperty[this.keywordIndex]][
        topMarginProperty[this.keywordIndex]
      ] = HelperMethods.convertPixelToPoint(element.textFrame.marginTop);
      inline[textFrameProperty[this.keywordIndex]][
        bottomMarginProperty[this.keywordIndex]
      ] = HelperMethods.convertPixelToPoint(element.textFrame.marginBottom);
      inline[textFrameProperty[this.keywordIndex]][
        blocksProperty[this.keywordIndex]
      ] = [];
      for (let j: number = 0; j < element.textFrame.childWidgets.length; j++) {
        let textFrameBlock: BlockWidget = element.textFrame.childWidgets[
          j
        ] as BlockWidget;
        if (
          textFrameBlock.hasOwnProperty('contentControlProperties') &&
          !isNullOrUndefined(element.paragraph) &&
          element.paragraph.hasOwnProperty('contentControlProperties')
        ) {
          this.blocks = [];
        }
        this.writeBlock(
  ...
  public writeChart(element: ChartElementBox, inline: any): void {
    ...
    this.writeChartTitleArea(
      element.chartTitleArea,
      inline[chartTitleAreaProperty[this.keywordIndex]]
    );
    this.writeChartArea(
      element.chartArea,
    ...
    this.writeChartArea(
      element.chartPlotArea,
      inline[plotAreaProperty[this.keywordIndex]]
    );
    this.writeChartCategory(
      element,
      inline[chartCategoryProperty[this.keywordIndex]]
    );
    ...
    this.writeChartLegend(
      element.chartLegend,
      inline[chartLegendProperty[this.keywordIndex]]
    );
    this.writeChartCategoryAxis(
      element.chartPrimaryCategoryAxis,
      inline[chartPrimaryCategoryAxisProperty[this.keywordIndex]]
    );
    this.writeChartCategoryAxis(
      element.chartPrimaryValueAxis,
      inline[chartPrimaryValueAxisProperty[this.keywordIndex]]
    );
    if (element.chartDataTable.showSeriesKeys !== undefined) {
      inline[chartDataTableProperty[this.keywordIndex]] = {};
      this.writeChartDataTable(
        element.chartDataTable,
        inline[chartDataTableProperty[this.keywordIndex]]
      );
    }
  ...
  private writeChartTitleArea(
    ...
    chartTitleArea[fontNameProperty[this.keywordIndex]] =
      titleArea.chartfontName;
    chartTitleArea[fontSizeProperty[this.keywordIndex]] =
      titleArea.chartFontSize;
    chartTitleArea[layoutProperty[this.keywordIndex]] = {};
    chartTitleArea[dataFormatProperty[this.keywordIndex]] =
      this.writeChartDataFormat(titleArea.dataFormat);
    this.writeChartLayout(
      titleArea.layout,
      chartTitleArea[layoutProperty[this.keywordIndex]]
    );
  }
  private writeChartDataFormat(format: ChartDataFormat): any {
    ...
    if (!isNullOrUndefined(format.fill.color)) {
      if (format.fill.color.length > 6) {
        chartDataFormat[fillProperty[this.keywordIndex]][
          foreColorProperty[this.keywordIndex]
        ] = format.fill.color.substring(2);
      } else {
        chartDataFormat[fillProperty[this.keywordIndex]][
          foreColorProperty[this.keywordIndex]
        ] = format.fill.color;
  ...
  private writeChartLegend(legend: ChartLegend, chartLegend: any): void {
    chartLegend[positionProperty[this.keywordIndex]] =
      legend.chartLegendPostion;
    chartLegend[chartTitleAreaProperty[this.keywordIndex]] = {};
    this.writeChartTitleArea(
      legend.chartTitleArea,
      chartLegend[chartTitleAreaProperty[this.keywordIndex]]
    );
  }
  private writeChartCategoryAxis(
    categoryAxis: ChartCategoryAxis,
    primaryCategoryAxis: any
  ): void {
    primaryCategoryAxis[chartTitleProperty[this.keywordIndex]] =
      categoryAxis.categoryAxisTitle;
    primaryCategoryAxis[chartTitleAreaProperty[this.keywordIndex]] = {};
    this.writeChartTitleArea(
      categoryAxis.chartTitleArea,
      primaryCategoryAxis[chartTitleAreaProperty[this.keywordIndex]]
    );
    primaryCategoryAxis[categoryTypeProperty[this.keywordIndex]] =
      categoryAxis.categoryAxisType;
    primaryCategoryAxis[fontSizeProperty[this.keywordIndex]] =
      categoryAxis.axisFontSize;
    primaryCategoryAxis[fontNameProperty[this.keywordIndex]] =
      categoryAxis.axisFontName;
    primaryCategoryAxis[numberFormatProperty[this.keywordIndex]] =
      categoryAxis.categoryNumberFormat;
    primaryCategoryAxis[maximumValueProperty[this.keywordIndex]] =
      categoryAxis.max;
    primaryCategoryAxis[minimumValueProperty[this.keywordIndex]] =
      categoryAxis.min;
    primaryCategoryAxis[isAutoMajorProperty[this.keywordIndex]] =
      HelperMethods.getBoolInfo(categoryAxis.isAutoInternal, this.keywordIndex);
    primaryCategoryAxis[majorUnitProperty[this.keywordIndex]] =
      categoryAxis.interval;
    primaryCategoryAxis[hasMajorGridLinesProperty[this.keywordIndex]] =
      HelperMethods.getBoolInfo(categoryAxis.majorGridLines, this.keywordIndex);
    primaryCategoryAxis[hasMinorGridLinesProperty[this.keywordIndex]] =
      HelperMethods.getBoolInfo(categoryAxis.minorGridLines, this.keywordIndex);
    primaryCategoryAxis[majorTickMarkProperty[this.keywordIndex]] =
      categoryAxis.majorTick;
    primaryCategoryAxis[minorTickMarkProperty[this.keywordIndex]] =
      categoryAxis.minorTick;
    primaryCategoryAxis[tickLabelPositionProperty[this.keywordIndex]] =
      categoryAxis.tickPosition;
  }
  private writeChartDataTable(
    chartDataTable: ChartDataTable,
    dataTable: any
  ): void {
    dataTable[showSeriesKeysProperty[this.keywordIndex]] =
      HelperMethods.getBoolInfo(
        chartDataTable.showSeriesKeys,
        this.keywordIndex
      );
    dataTable[hasHorizontalBorderProperty[this.keywordIndex]] =
      HelperMethods.getBoolInfo(
        chartDataTable.hasHorzBorder,
        this.keywordIndex
      );
    dataTable[hasVerticalBorderProperty[this.keywordIndex]] =
      HelperMethods.getBoolInfo(
        chartDataTable.hasVertBorder,
        this.keywordIndex
      );
    dataTable[hasBordersProperty[this.keywordIndex]] =
      HelperMethods.getBoolInfo(chartDataTable.hasBorders, this.keywordIndex);
  }
  ...
  private createChartCategory(data: any, type: string): any {
    ...
    chartCategory[categoryXNameProperty[this.keywordIndex]] =
      data.categoryXName;
  ...
  private writeChartSeries(series: any, type: string): any {
    ...
    if (isPieType) {
      if (!isNullOrUndefined(series.firstSliceAngle)) {
        chartSeries[firstSliceAngleProperty[this.keywordIndex]] =
          series.firstSliceAngle;
      }
      if (type === 'Doughnut') {
        chartSeries[holeSizeProperty[this.keywordIndex]] =
    ...
    if (!isNullOrUndefined(errorBarData.type)) {
      ...
      errorBar[numberValueProperty[this.keywordIndex]] =
        errorBarData.numberValue;
  ...
  private writeChartDataLabels(dataLabels: any): any {
    ...
    dataLabel[fontColorProperty[this.keywordIndex]] =
      HelperMethods.convertArgbToRgb(dataLabels.fontColor);
    dataLabel[fontSizeProperty[this.keywordIndex]] = dataLabels.fontSize;
    dataLabel[isLegendKeyProperty[this.keywordIndex]] =
      HelperMethods.getBoolInfo(dataLabels.isLegendKey, this.keywordIndex);
    dataLabel[isBubbleSizeProperty[this.keywordIndex]] =
      HelperMethods.getBoolInfo(dataLabels.isBubbleSize, this.keywordIndex);
    dataLabel[isCategoryNameProperty[this.keywordIndex]] =
      HelperMethods.getBoolInfo(dataLabels.isCategoryName, this.keywordIndex);
    dataLabel[isSeriesNameProperty[this.keywordIndex]] =
      HelperMethods.getBoolInfo(dataLabels.isSeriesName, this.keywordIndex);
    dataLabel[isValueProperty[this.keywordIndex]] = HelperMethods.getBoolInfo(
      dataLabels.isValue,
      this.keywordIndex
    );
    dataLabel[isPercentageProperty[this.keywordIndex]] =
      HelperMethods.getBoolInfo(dataLabels.isPercentage, this.keywordIndex);
    dataLabel[isLeaderLinesProperty[this.keywordIndex]] =
      HelperMethods.getBoolInfo(dataLabels.isLeaderLines, this.keywordIndex);
    return dataLabel;
  }
  private writeChartTrendLines(trendLines: any): any {
    ...
    trendLine[isDisplayEquationProperty[this.keywordIndex]] =
      HelperMethods.getBoolInfo(
        trendLines.isDisplayEquation,
        this.keywordIndex
      );
    trendLine[isDisplayRSquaredProperty[this.keywordIndex]] =
      HelperMethods.getBoolInfo(
        trendLines.isDisplayRSquared,
        this.keywordIndex
      );
    return trendLine;
  }
  private writeLines(
    ...
    let endParagraph: boolean =
      this.endLine instanceof LineWidget &&
      this.endLine.paragraph === paragraph;
    let endIndex: number = endParagraph
      ? this.endLine.indexInOwner
      : paragraph.childWidgets.length - 1;
    for (let i: number = startIndex; i <= endIndex; i++) {
      let child: LineWidget = paragraph.childWidgets[i] as LineWidget;
      if (this.endLine === child || (lineIndex === i && offset !== 0)) {
        if (
          this.endLine === child &&
          paragraph.paragraphFormat.bidi &&
        ...
        this.writeLine(
          child,
          this.startLine !== this.endLine && child !== this.startLine
            ? 0
            : offset,
          inlines
        );
  ...
  private writeLine(line: LineWidget, offset: number, inlines: any): void {
    ...
    for (let j: number = 0; j < lineWidget.children.length; j++) {
      ...
      if (
        ...
        element.hasOwnProperty('contentControlProperties') &&
        started &&
        !contentControl
      ) {
      ...
      if (!isNullOrUndefined(inline)) {
        ...
        if (length > offset || ended) {
          if (inline.hasOwnProperty(textProperty[this.keywordIndex])) {
            ...
            let endIndex: number = ended
              ? this.endOffset - startIndex
              : element.length;
            inline[textProperty[this.keywordIndex]] = inline[
              textProperty[this.keywordIndex]
            ].substring(indexInInline, endIndex);
          }
          offset = -1;
        }
      }
  ...
  private writeInlinesFootNote(element: any): any {
    ...
    let inline: any = {};
    inline[footnoteTypeProperty[this.keywordIndex]] =
      this.keywordIndex == 1
        ? this.getFootnoteTypeEnumValue(element.footnoteType)
        : element.footnoteType;
    inline[characterFormatProperty[this.keywordIndex]] = {};
    inline[characterFormatProperty[this.keywordIndex]] =
      this.writeCharacterFormat(element.characterFormat, this.keywordIndex);
    ...
    for (let i: number = 0; i < element.bodyWidget.childWidgets.length; i++) {
      this.writeBlock(
        element.bodyWidget.childWidgets[i],
        0,
        inline[blocksProperty[this.keywordIndex]]
      );
    }
  ...
  private writeInlinesContentControl(
    ...
    if (element instanceof ContentControl) {
      if (element.contentControlWidgetType === 'Block') {
        ...
        if (lineWidget.children[i - 1] instanceof ContentControl) {
          if (
            (lineWidget.children[i - 1] as ContentControl)
    ...
    if (element instanceof ContentControl) {
      if (this.startContent && element.type === 0) {
        ...
        if (this.contentInline.length > 0) {
          let nestedContent: any = this.nestedContentProperty(
            lineWidget.children[i + 1],
            inline
          );
    ...
    if (this.startContent && this.contentType === 'Inline') {
      if (this.multipleLineContent) {
        ...
        let contentinline: any = this.inlineContentControl(
          element,
          element.nextNode
        );
  ...
  private createParagraph(paragraphWidget: ParagraphWidget): any {
    ...
    if (
      ...
      !this.documentHelper.selection.isEmpty &&
      !this.isExport
    ) {
      ...
      let lastLine: LineWidget = endPos.paragraph.childWidgets[
        endPos.paragraph.childWidgets.length - 1
      ] as LineWidget;
      isListPara = !isNullOrUndefined(
        paragraphWidget.paragraphFormat.listFormat.list
      );
      isParaSelected =
        this.documentHelper.selection.isParagraphLastLine(lastLine) &&
        endPos.currentWidget === lastLine &&
        (endPos.offset ===
          this.documentHelper.selection.getLineLength(lastLine) + 1 ||
          (!(paragraphWidget.indexInOwner == endPos.paragraph.indexInOwner) &&
            isListPara));
    } else {
      isParaSelected = true;
    }
    paragraph[paragraphFormatProperty[this.keywordIndex]] =
      this.writeParagraphFormat(
        isParaSelected
          ? paragraphWidget.paragraphFormat
          : new WParagraphFormat(paragraphWidget),
        this.keywordIndex
      );
    paragraph[characterFormatProperty[this.keywordIndex]] =
      this.writeCharacterFormat(
        isParaSelected
          ? paragraphWidget.characterFormat
          : new WCharacterFormat(paragraphWidget),
        this.keywordIndex
      );
    paragraph[inlinesProperty[this.keywordIndex]] = [];
    return paragraph;
  ...
  public writeCharacterFormat(
    ...
    characterFormat[boldBidiProperty[keywordIndex]] = isInline
      ? HelperMethods.getBoolInfo(format.boldBidi, keywordIndex)
      : format.getValue('boldBidi');
    characterFormat[italicBidiProperty[keywordIndex]] = isInline
      ? HelperMethods.getBoolInfo(format.italicBidi, keywordIndex)
      : format.getValue('italicBidi');
    if (format.revisions.length > 0) {
      ...
      for (let x: number = 0; x < format.revisions.length; x++) {
        characterFormat[revisionIdsProperty[keywordIndex]].push(
          format.revisions[x].revisionID
        );
      }
    }
    if (this.writeInlineStyles && !isInline) {
      characterFormat[inlineFormatProperty[keywordIndex]] =
        this.writeCharacterFormat(format, keywordIndex, true);
    }
   ...
   * @private
   */
  public writeParagraphFormat(
    format: WParagraphFormat,
    keywordIndex: number,
    isInline?: boolean
  ): any {
    let paragraphFormat: any = {};
    this.keywordIndex = isNullOrUndefined(this.keywordIndex)
      ? 0
      : this.keywordIndex;
    ...
    paragraphFormat[listFormatProperty[keywordIndex]] = this.writeListFormat(
      format.listFormat,
      isInline
    );
    paragraphFormat[tabsProperty[keywordIndex]] = this.writeTabs(format.tabs);
    if (this.writeInlineStyles && !isInline) {
      paragraphFormat[inlineFormatProperty[keywordIndex]] =
        this.writeParagraphFormat(format, keywordIndex, true);
    }
  ...
  private writeThemes(source: Themes): any {
    ...
    themes[fontSchemeProperty[this.keywordIndex]][
      fontSchemeNameProperty[this.keywordIndex]
    ] = source.fontScheme.fontSchemeName;
    themes[fontSchemeProperty[this.keywordIndex]][
      majorFontSchemeProperty[this.keywordIndex]
    ] = this.writeMajorMinorFontScheme(source.fontScheme.majorFontScheme);
    themes[fontSchemeProperty[this.keywordIndex]][
      minorFontSchemeProperty[this.keywordIndex]
    ] = this.writeMajorMinorFontScheme(source.fontScheme.minorFontScheme);
    return themes;
  }
  private writeMajorMinorFontScheme(source: MajorMinorFontScheme): any {
    let majorMinorFontScheme: any = {};
    majorMinorFontScheme[fontSchemeListProperty[this.keywordIndex]] =
      this.writeFontSchemeList(source.fontSchemeList);
    let keys: string[] = source.fontTypeface.keys;
    let fontTypeface: any = {};
    for (let key of keys) {
      fontTypeface[key] = source.fontTypeface.get(key);
    }
    majorMinorFontScheme[fontTypefaceProperty[this.keywordIndex]] =
      fontTypeface;
  ...
  private writeTabs(tabStops: WTabStop[]): any {
    ...
    for (let i: number = 0; i < tabStops.length; i++) {
      ...
      tab[tabJustificationProperty[this.keywordIndex]] =
        this.keywordIndex == 1
          ? this.getTabJustificationEnumValue(tabStop.tabJustification)
          : tabStop.tabJustification;
      tab[tabLeaderProperty[this.keywordIndex]] =
        this.keywordIndex == 1
          ? this.getTabLeaderEnumValue(tabStop.tabLeader)
          : tabStop.tabLeader;
      tabs.push(tab);
    }
    return tabs;
  ...
  private writeTable(
    ...
    return next instanceof BlockWidget &&
      next.containerWidget.index === tableWidget.containerWidget.index
      ? next
      : undefined;
  }
  ...
  private writeRowInternal(
    ...
    for (let i: number = 0; i < rowWidget.childWidgets.length; i++) {
      ...
      if (widget instanceof TableCellWidget) {
        if (
          rowWidget.index === widget.rowIndex &&
          (isNullOrUndefined(this.startColumnIndex) ||
            widget.columnIndex >= this.startColumnIndex) &&
          (isNullOrUndefined(this.endColumnIndex) ||
            widget.columnIndex < this.endColumnIndex)
        ) {
    ...
    do {
      ...
      if (
        !isNullOrUndefined(rowWidget.ownerTable.bodyWidget) &&
        next &&
        ((rowWidget.ownerTable.index !== next.ownerTable.index &&
          rowWidget.ownerTable.bodyWidget.sectionIndex ===
            next.ownerTable.bodyWidget.sectionIndex) ||
          rowWidget.ownerTable.bodyWidget.sectionIndex !==
            next.ownerTable.bodyWidget.sectionIndex)
      ) {
        next = undefined;
      ...
      skip =
        !isNullOrUndefined(rowWidget.nextSplitWidget) &&
        rowWidget.childWidgets.length !== next.childWidgets.length;
    } while (
      next instanceof TableRowWidget &&
      next.index === rowWidget.index &&
      !skip
    );
    return next;
  }
  private writeCell(cellWidget: TableCellWidget, cells: any): boolean {
    ...
    return this.endCell instanceof TableCellWidget
      ? this.endCell.cellFormat === cellWidget.cellFormat
      : false;
  }
  private createTable(tableWidget: TableWidget): any {
    ...
    for (let i: number = 0; i < tableWidget.tableHolder.columns.length; i++) {
      table[gridProperty[this.keywordIndex]][i] =
        tableWidget.tableHolder.columns[i].preferredWidth;
    }
    table[tableFormatProperty[this.keywordIndex]] = this.writeTableFormat(
      tableWidget.tableFormat,
      this.keywordIndex
    );
    table[descriptionProperty[this.keywordIndex]] =
      tableWidget.tableFormat.description;
    table[titleProperty[this.keywordIndex]] = tableWidget.tableFormat.title;
    table[columnCountProperty[this.keywordIndex]] =
      tableWidget.tableHolder.columns.length;
  ...
  private writeTablePositioning(table: any, tableWidget: TableWidget): void {
    if (tableWidget.wrapTextAround) {
      table[wrapTextAroundProperty[this.keywordIndex]] =
        HelperMethods.getBoolInfo(
          tableWidget.wrapTextAround,
          this.keywordIndex
        );
      table[positioningProperty[this.keywordIndex]] = {};
      table[positioningProperty[this.keywordIndex]][
        allowOverlapProperty[this.keywordIndex]
      ] = HelperMethods.getBoolInfo(
        tableWidget.positioning.allowOverlap,
        this.keywordIndex
      );
      if (!isNullOrUndefined(tableWidget.positioning.distanceBottom)) {
        table[positioningProperty[this.keywordIndex]][
          distanceBottomProperty[this.keywordIndex]
        ] = HelperMethods.convertPixelToPoint(
          tableWidget.positioning.distanceBottom
        );
      }
      if (!isNullOrUndefined(tableWidget.positioning.distanceLeft)) {
        table[positioningProperty[this.keywordIndex]][
          distanceLeftProperty[this.keywordIndex]
        ] = HelperMethods.convertPixelToPoint(
          tableWidget.positioning.distanceLeft
        );
      }
      if (!isNullOrUndefined(tableWidget.positioning.distanceRight)) {
        table[positioningProperty[this.keywordIndex]][
          distanceRightProperty[this.keywordIndex]
        ] = HelperMethods.convertPixelToPoint(
          tableWidget.positioning.distanceRight
        );
      }
      if (!isNullOrUndefined(tableWidget.positioning.distanceTop)) {
        table[positioningProperty[this.keywordIndex]][
          distanceTopProperty[this.keywordIndex]
        ] = HelperMethods.convertPixelToPoint(
          tableWidget.positioning.distanceTop
        );
      }
      if (!isNullOrUndefined(tableWidget.positioning.verticalAlignment)) {
        table[positioningProperty[this.keywordIndex]][
          verticalAlignmentProperty[this.keywordIndex]
        ] =
          this.keywordIndex == 1
            ? this.getTableVerticalPositionEnumValue(
                tableWidget.positioning.verticalAlignment
              )
            : tableWidget.positioning.verticalAlignment;
      }
      if (!isNullOrUndefined(tableWidget.positioning.verticalOrigin)) {
        table[positioningProperty[this.keywordIndex]][
          verticalOriginProperty[this.keywordIndex]
        ] =
          this.keywordIndex == 1
            ? this.getTableVerticalRelationEnumValue(
                tableWidget.positioning.verticalOrigin
              )
            : tableWidget.positioning.verticalOrigin;
      }
      table[positioningProperty[this.keywordIndex]][
        verticalPositionProperty[this.keywordIndex]
      ] = tableWidget.positioning.verticalPosition;
      if (!isNullOrUndefined(tableWidget.positioning.horizontalAlignment)) {
        table[positioningProperty[this.keywordIndex]][
          horizontalAlignmentProperty[this.keywordIndex]
        ] =
          this.keywordIndex == 1
            ? this.getTableHorizontalPositionEnumValue(
                tableWidget.positioning.horizontalAlignment
              )
            : tableWidget.positioning.horizontalAlignment;
      }
      if (!isNullOrUndefined(tableWidget.positioning.horizontalOrigin)) {
        table[positioningProperty[this.keywordIndex]][
          horizontalOriginProperty[this.keywordIndex]
        ] =
          this.keywordIndex == 1
            ? this.getTableHorizontalRelationEnumValue(
                tableWidget.positioning.horizontalOrigin
              )
            : tableWidget.positioning.horizontalOrigin;
      }
      table[positioningProperty[this.keywordIndex]][
        horizontalPositionProperty[this.keywordIndex]
      ] = tableWidget.positioning.horizontalPosition;
    }
  }
  private createRow(rowWidget: TableRowWidget): any {
    let row: any = {};
    row[cellsProperty[this.keywordIndex]] = [];
    row[rowFormatProperty[this.keywordIndex]] = this.writeRowFormat(
      rowWidget.rowFormat,
      this.keywordIndex
    );
    if (rowWidget.hasOwnProperty('contentControlProperties')) {
      row[contentControlPropertiesProperty[this.keywordIndex]] =
        this.contentControlProperty(rowWidget.contentControlProperties);
    }
    return row;
  }
  private createCell(cellWidget: TableCellWidget): any {
    let cell: any = {};
    cell[blocksProperty[this.keywordIndex]] = [];
    cell[cellFormatProperty[this.keywordIndex]] = this.writeCellFormat(
      cellWidget.cellFormat,
      this.keywordIndex
    );
    cell[columnIndexProperty[this.keywordIndex]] = cellWidget.columnIndex;
    if (cellWidget.hasOwnProperty('contentControlProperties')) {
      cell[contentControlPropertiesProperty[this.keywordIndex]] =
        this.contentControlProperty(cellWidget.contentControlProperties);
    }
    return cell;
  }
  /**
  ...
  public writeShading(wShading: WShading, keyIndex: number): any {
    let shading: any = {};
    shading[backgroundColorProperty[keyIndex]] = wShading.hasValue(
      'backgroundColor'
    )
      ? wShading.backgroundColor
      : undefined;
    shading[foregroundColorProperty[keyIndex]] = wShading.hasValue(
      'foregroundColor'
    )
      ? wShading.foregroundColor
      : undefined;
    shading[textureProperty[keyIndex]] = wShading.hasValue('textureStyle')
      ? keyIndex == 1
        ? this.getTextureStyleEnumValue(wShading.textureStyle)
  ...
  private writeBorders(wBorders: WBorders, keyIndex: number): any {
    let borders: any = {};
    borders[topProperty[keyIndex]] = HelperMethods.writeBorder(
      wBorders.top,
      keyIndex
    );
    borders[leftProperty[keyIndex]] = HelperMethods.writeBorder(
      wBorders.left,
      keyIndex
    );
    borders[rightProperty[keyIndex]] = HelperMethods.writeBorder(
      wBorders.right,
      keyIndex
    );
    borders[bottomProperty[keyIndex]] = HelperMethods.writeBorder(
      wBorders.bottom,
      keyIndex
    );
    borders[diagonalDownProperty[keyIndex]] = HelperMethods.writeBorder(
      wBorders.diagonalDown,
      keyIndex
    );
    borders[diagonalUpProperty[keyIndex]] = HelperMethods.writeBorder(
      wBorders.diagonalUp,
      keyIndex
    );
    borders[horizontalProperty[keyIndex]] = HelperMethods.writeBorder(
      wBorders.horizontal,
      keyIndex
    );
    borders[verticalProperty[keyIndex]] = HelperMethods.writeBorder(
      wBorders.vertical,
      keyIndex
    );
    return borders;
  ...
  public writeCellFormat(wCellFormat: WCellFormat, keyIndex: number): any {
    let cellFormat: any = {};
    cellFormat[bordersProperty[keyIndex]] = this.writeBorders(
      wCellFormat.borders,
      keyIndex
    );
    cellFormat[shadingProperty[keyIndex]] = this.writeShading(
      wCellFormat.shading,
      keyIndex
    );
    cellFormat[topMarginProperty[keyIndex]] = wCellFormat.hasValue('topMargin')
      ? wCellFormat.topMargin
      : undefined;
    cellFormat[rightMarginProperty[keyIndex]] = wCellFormat.hasValue(
      'rightMargin'
    )
      ? wCellFormat.rightMargin
      : undefined;
    cellFormat[leftMarginProperty[keyIndex]] = wCellFormat.hasValue(
      'leftMargin'
    )
      ? wCellFormat.leftMargin
      : undefined;
    cellFormat[bottomMarginProperty[keyIndex]] = wCellFormat.hasValue(
      'bottomMargin'
    )
      ? wCellFormat.bottomMargin
      : undefined;
    cellFormat[preferredWidthProperty[keyIndex]] = wCellFormat.hasValue(
      'preferredWidth'
    )
      ? wCellFormat.preferredWidth
      : undefined;
    cellFormat[preferredWidthTypeProperty[keyIndex]] = wCellFormat.hasValue(
      'preferredWidthType'
    )
      ? keyIndex == 1
        ? this.getWidthTypeEnumValue(wCellFormat.preferredWidthType)
        : wCellFormat.preferredWidthType
      : undefined;
    cellFormat[cellWidthProperty[keyIndex]] = wCellFormat.hasValue('cellWidth')
      ? wCellFormat.cellWidth
      : undefined;
    cellFormat[columnSpanProperty[keyIndex]] = wCellFormat.columnSpan;
    cellFormat[rowSpanProperty[keyIndex]] = wCellFormat.rowSpan;
    cellFormat[verticalAlignmentProperty[keyIndex]] = wCellFormat.hasValue(
      'verticalAlignment'
    )
      ? keyIndex == 1
        ? this.getCellVerticalAlignmentEnumValue(wCellFormat.verticalAlignment)
        : wCellFormat.verticalAlignment
      : undefined;
    return cellFormat;
  }
  private writeRowFormat(wRowFormat: WRowFormat, keyIndex: number): any {
    ...
    for (let j: number = 0; j < wRowFormat.revisions.length; j++) {
      rowFormat[revisionIdsProperty[keyIndex]] = this.writeRowRevisions(
        wRowFormat.revisions[j],
        revisionIds
      );
    }
    return rowFormat;
   ...
   * @private
   */
  public assignRowFormat(
    rowFormat: any,
    wRowFormat: WRowFormat,
    keyIndex: number
  ): void {
    rowFormat[heightProperty[keyIndex]] = wRowFormat.hasValue('height')
      ? wRowFormat.height
      : undefined;
    rowFormat[allowBreakAcrossPagesProperty[keyIndex]] = wRowFormat.hasValue(
      'allowBreakAcrossPages'
    )
      ? HelperMethods.getBoolInfo(
          wRowFormat.allowBreakAcrossPages,
          this.keywordIndex
        )
      : undefined;
    rowFormat[heightTypeProperty[keyIndex]] = wRowFormat.hasValue('heightType')
      ? this.keywordIndex == 1
        ? this.getHeighTypeEnumValue(wRowFormat.heightType)
        : wRowFormat.heightType
      : undefined;
    rowFormat[isHeaderProperty[keyIndex]] = wRowFormat.hasValue('isHeader')
      ? HelperMethods.getBoolInfo(wRowFormat.isHeader, this.keywordIndex)
      : undefined;
    rowFormat[bordersProperty[keyIndex]] = this.writeBorders(
      wRowFormat.borders,
      keyIndex
    );
    rowFormat[gridBeforeProperty[keyIndex]] = wRowFormat.gridBefore;
    rowFormat[gridBeforeWidthProperty[keyIndex]] = wRowFormat.hasValue(
      'gridBeforeWidth'
    )
      ? wRowFormat.gridBeforeWidth
      : undefined;
    rowFormat[gridBeforeWidthTypeProperty[keyIndex]] = wRowFormat.hasValue(
      'gridBeforeWidthType'
    )
      ? this.keywordIndex == 1
        ? this.getWidthTypeEnumValue(wRowFormat.gridBeforeWidthType)
        : wRowFormat.gridBeforeWidthType
      : undefined;
    rowFormat[gridAfterProperty[keyIndex]] = wRowFormat.gridAfter;
    rowFormat[gridAfterWidthProperty[keyIndex]] = wRowFormat.hasValue(
      'gridAfterWidth'
    )
      ? wRowFormat.gridAfterWidth
      : undefined;
    rowFormat[gridAfterWidthTypeProperty[keyIndex]] = wRowFormat.hasValue(
      'gridAfterWidthType'
    )
      ? this.keywordIndex == 1
        ? this.getWidthTypeEnumValue(wRowFormat.gridAfterWidthType)
        : wRowFormat.gridAfterWidthType
      : undefined;
    rowFormat[leftMarginProperty[keyIndex]] = wRowFormat.hasValue('leftMargin')
      ? wRowFormat.leftMargin
      : undefined;
    rowFormat[topMarginProperty[keyIndex]] = wRowFormat.hasValue('topMargin')
      ? wRowFormat.topMargin
      : undefined;
    rowFormat[rightMarginProperty[keyIndex]] = wRowFormat.hasValue(
      'rightMargin'
    )
      ? wRowFormat.rightMargin
      : undefined;
    rowFormat[bottomMarginProperty[keyIndex]] = wRowFormat.hasValue(
      'bottomMargin'
    )
      ? wRowFormat.bottomMargin
      : undefined;
    rowFormat[leftIndentProperty[keyIndex]] = wRowFormat.hasValue('leftIndent')
      ? wRowFormat.leftIndent
      : undefined;
  }
  ...
  public writeTableFormat(wTableFormat: WTableFormat, keyIndex: number): any {
    let tableFormat: any = {};
    tableFormat[bordersProperty[keyIndex]] = this.writeBorders(
      wTableFormat.borders,
      keyIndex
    );
    tableFormat[shadingProperty[keyIndex]] = this.writeShading(
      wTableFormat.shading,
      keyIndex
    );
    tableFormat[cellSpacingProperty[keyIndex]] = wTableFormat.hasValue(
      'cellSpacing'
    )
      ? wTableFormat.cellSpacing
      : undefined;
    tableFormat[leftIndentProperty[keyIndex]] = wTableFormat.hasValue(
      'leftIndent'
    )
      ? wTableFormat.leftIndent
      : undefined;
    tableFormat[tableAlignmentProperty[keyIndex]] = wTableFormat.hasValue(
      'tableAlignment'
    )
      ? this.keywordIndex == 1
        ? this.getTableAlignmentEnumValue(wTableFormat.tableAlignment)
        : wTableFormat.tableAlignment
      : undefined;
    tableFormat[topMarginProperty[keyIndex]] = wTableFormat.hasValue(
      'topMargin'
    )
      ? wTableFormat.topMargin
      : undefined;
    tableFormat[rightMarginProperty[keyIndex]] = wTableFormat.hasValue(
      'rightMargin'
    )
      ? wTableFormat.rightMargin
      : undefined;
    tableFormat[leftMarginProperty[keyIndex]] = wTableFormat.hasValue(
      'leftMargin'
    )
      ? wTableFormat.leftMargin
      : undefined;
    tableFormat[bottomMarginProperty[keyIndex]] = wTableFormat.hasValue(
      'bottomMargin'
    )
      ? wTableFormat.bottomMargin
      : undefined;
    tableFormat[preferredWidthProperty[keyIndex]] = wTableFormat.hasValue(
      'preferredWidth'
    )
      ? wTableFormat.preferredWidth
      : undefined;
    tableFormat[preferredWidthTypeProperty[keyIndex]] = wTableFormat.hasValue(
      'preferredWidthType'
    )
      ? this.keywordIndex == 1
        ? this.getWidthTypeEnumValue(wTableFormat.preferredWidthType)
        : wTableFormat.preferredWidthType
      : undefined;
    tableFormat[bidiProperty[keyIndex]] = wTableFormat.hasValue('bidi')
      ? HelperMethods.getBoolInfo(wTableFormat.bidi, this.keywordIndex)
      : undefined;
    tableFormat[allowAutoFitProperty[keyIndex]] = wTableFormat.hasValue(
      'allowAutoFit'
    )
      ? HelperMethods.getBoolInfo(wTableFormat.allowAutoFit, this.keywordIndex)
      : undefined;
    tableFormat[styleNameProperty[keyIndex]] = !isNullOrUndefined(
      wTableFormat.styleName
    )
      ? wTableFormat.styleName
      : undefined;
    return tableFormat;
  ...
  private footnotes(documentHelper: DocumentHelper): void {
    ...
    for (
      let i: number = 0;
      i < documentHelper.footnotes.separator.length;
      i++
    ) {
  ...
  private seprators(documentHelper: any): any {
    if (documentHelper.footnotes.separator.length > 0) {
      ...
      this.document[footnotesProperty[this.keywordIndex]][
        separatorProperty[this.keywordIndex]
      ] = [];
      for (
        let i: number = 0;
        i < documentHelper.footnotes.separator.length;
        ...
        this.writeBlock(
          documentHelper.footnotes.separator[i],
          0,
          this.document[footnotesProperty[this.keywordIndex]][
            separatorProperty[this.keywordIndex]
          ]
    ...
    if (documentHelper.footnotes.continuationSeparator.length > 0) {
      this.document[footnotesProperty[this.keywordIndex]][
        continuationSeparatorProperty[this.keywordIndex]
      ] = [];
      for (
        let i: number = 0;
        i < documentHelper.footnotes.continuationSeparator.length;
        i++
      ) {
        this.writeBlock(
          documentHelper.footnotes.continuationSeparator[i],
          0,
          this.document[footnotesProperty[this.keywordIndex]][
            continuationSeparatorProperty[this.keywordIndex]
          ]
    ...
    if (documentHelper.footnotes.continuationNotice.length > 0) {
      this.document[footnotesProperty[this.keywordIndex]][
        continuationNoticeProperty[this.keywordIndex]
      ] = [];
      for (
        let i: number = 0;
        i < documentHelper.footnotes.continuationNotice.length;
        i++
      ) {
        this.writeBlock(
          documentHelper.footnotes.continuationNotice[i],
          0,
          this.document[footnotesProperty[this.keywordIndex]][
            continuationNoticeProperty[this.keywordIndex]
          ]
  ...
  private endnotes(documentHelper: DocumentHelper): void {
    ...
    for (
      let i: number = 0;
      i < this.documentHelper.endnotes.separator.length;
      i++
    ) {
  ...
  private endnoteSeparator(documentHelper: DocumentHelper): void {
    if (documentHelper.endnotes.separator.length > 0) {
      ...
      for (
        let i: number = 0;
        i < documentHelper.endnotes.separator.length;
        i++
      ) {
        this.writeBlock(
          documentHelper.endnotes.separator[i],
          0,
          this.document[endnotesProperty[this.keywordIndex]][
            separatorProperty[this.keywordIndex]
          ]
    ...
    if (documentHelper.endnotes.continuationSeparator.length > 0) {
      ...
      for (
        let i: number = 0;
        i < documentHelper.endnotes.continuationSeparator.length;
        i++
      ) {
        this.writeBlock(
          documentHelper.endnotes.continuationSeparator[i],
          0,
          this.document[endnotesProperty[this.keywordIndex]][
            continuationSeparatorProperty[this.keywordIndex]
          ]
    ...
    if (documentHelper.endnotes.continuationNotice.length > 0) {
      ...
      for (
        let i: number = 0;
        i < documentHelper.endnotes.continuationNotice.length;
        i++
      ) {
        this.writeBlock(
          documentHelper.endnotes.continuationNotice[i],
          0,
          this.document[endnotesProperty[this.keywordIndex]][
            continuationNoticeProperty[this.keywordIndex]
          ]
  ...
  private writeStyles(documentHelper: DocumentHelper): void {
    ...
    for (let i: number = 0; i < documentHelper.styles.length; i++) {
      this.document[stylesProperty[this.keywordIndex]].push(
        this.writeStyle(documentHelper.styles.getItem(i) as WStyle)
      );
    }
  }
  /**
  ...
  public writeStyle(style: WStyle): any {
    ...
    if (style.type === 'Paragraph') {
      wStyle[typeProperty[this.keywordIndex]] =
        this.keywordIndex == 1
          ? this.getStyleTypeEnumValue(style.type)
          : style.type;
      wStyle[paragraphFormatProperty[this.keywordIndex]] =
        this.writeParagraphFormat(
          (style as any).paragraphFormat,
          this.keywordIndex
        );
      wStyle[characterFormatProperty[this.keywordIndex]] =
        this.writeCharacterFormat(
  ...
  public writeRevisions(documentHelper: DocumentHelper): void {
    ...
    for (
      let i: number = 0;
      i < documentHelper.owner.revisions.changes.length;
      i++
    ) {
      if (
        this.isExport ||
        (!this.isExport &&
          !this.owner.enableTrackChanges &&
          this.selectedRevisionId.indexOf(
            documentHelper.owner.revisions.changes[i].revisionID
          ) !== -1)
      ) {
        this.document[revisionsProperty[this.keywordIndex]].push(
          this.writeRevision(documentHelper.owner.revisions.changes[i])
        );
      }
    }
  }
  private writeRevision(revisions: Revision): any {
    ...
    revision[revisionTypeProperty[this.keywordIndex]] =
      this.keywordIndex == 1
        ? this.getRevisionTypeEnumValue(revisions.revisionType)
  ...
  public writeComments(documentHelper: DocumentHelper): void {
    ...
    for (let i: number = 0; i < documentHelper.comments.length; i++) {
      if (
        this.isExport ||
        (!this.isExport &&
          this.selectedCommentsId.indexOf(
            this.documentHelper.comments[i].commentId
          ) !== -1)
      ) {
        this.document[commentsProperty[this.keywordIndex]].push(
          this.writeComment(this.documentHelper.comments[i])
        );
      }
    }
  }
  ...
  private writeComment(comments: CommentElementBox): any {
    ...
    comment[blocksProperty[this.keywordIndex]] = HelperMethods.commentInlines(
      comments.text,
      comments.mentions,
      this.keywordIndex
    );
    comment[doneProperty[this.keywordIndex]] = HelperMethods.getBoolInfo(
      comments.isResolved,
      this.keywordIndex
    );
    comment[replyCommentsProperty[this.keywordIndex]] = [];
    for (let i: number = 0; i < comments.replyComments.length; i++) {
      comment[replyCommentsProperty[this.keywordIndex]].push(
        this.writeComment(comments.replyComments[i])
      );
    }
    return comment;
  }
  ...
  private writeLists(documentHelper: DocumentHelper): void {
    ...
    for (let i: number = 0; i < documentHelper.lists.length; i++) {
      ...
      if (this.lists.indexOf(list.listId) > -1) {
        this.document[listsProperty[this.keywordIndex]].push(
          this.writeList(list)
        );
    ...
    for (let i: number = 0; i < documentHelper.abstractLists.length; i++) {
      ...
      if (abstractLists.indexOf(abstractList.abstractListId) > -1) {
        this.document[abstractListsProperty[this.keywordIndex]].push(
          this.writeAbstractList(abstractList)
        );
      }
    }
  }
  ...
  public writeAbstractList(wAbstractList: WAbstractList): any {
    ...
    abstractList[abstractListIdProperty[this.keywordIndex]] =
      wAbstractList.abstractListId;
    ...
    for (let i: number = 0; i < wAbstractList.levels.length; i++) {
      abstractList[levelsProperty[this.keywordIndex]][i] = this.writeListLevel(
        wAbstractList.levels[i]
      );
    }
    return abstractList;
  }
  ...
  public writeList(wList: WList): any {
    ...
    if (!isNullOrUndefined(wList)) {
      ...
      for (let i: number = 0; i < wList.levelOverrides.length; i++) {
        list[levelOverridesProperty[this.keywordIndex]].push(
          this.writeLevelOverrides(wList.levelOverrides[i])
        );
      }
  ...
  private writeLevelOverrides(wlevel: WLevelOverride): any {
    ...
    if (wlevel.overrideListLevel) {
      levelOverrides[overrideListLevelProperty[this.keywordIndex]] =
        this.writeListLevel(wlevel.overrideListLevel);
    }
  ...
  private writeListLevel(wListLevel: WListLevel): any {
    ...
    listLevel[characterFormatProperty[this.keywordIndex]] =
      this.writeCharacterFormat(wListLevel.characterFormat, this.keywordIndex);
    listLevel[paragraphFormatProperty[this.keywordIndex]] =
      this.writeParagraphFormat(wListLevel.paragraphFormat, this.keywordIndex);

    listLevel[isLegalStyleNumberingProperty[this.keywordIndex]] =
      HelperMethods.getBoolInfo(
        wListLevel.isLegalStyleNumbering,
        this.keywordIndex
      );
    listLevel[followCharacterProperty[this.keywordIndex]] =
      this.keywordIndex == 1
        ? this.getFollowCharacterType(wListLevel.followCharacter)
        : wListLevel.followCharacter;
    listLevel[listLevelPatternProperty[this.keywordIndex]] =
      this.keywordIndex == 1
        ? this.getListLevelPatternEnumValue(wListLevel.listLevelPattern)
        : wListLevel.listLevelPattern;
    listLevel[numberFormatProperty[this.keywordIndex]] =
      wListLevel.numberFormat;
    listLevel[paraStyleNameProperty[this.keywordIndex]] =
      wListLevel.paraStyleName;
    listLevel[restartLevelProperty[this.keywordIndex]] =
      wListLevel.restartLevel;
  ...
  private getFootnoteRestartIndexEnumValue(
    footnoteRestartIndex: FootnoteRestartIndex
  ): number {
  ...
  private getFootEndNoteNumberFormatEnumValue(
    footEndNoteNumberFormat: FootEndNoteNumberFormat
  ): number {
  ...
  private getTableVerticalPositionEnumValue(
    tableVerticalPosition: VerticalAlignment
  ): number {
  ...
  private getTableHorizontalPositionEnumValue(
    tableHorizontalPosition: HorizontalAlignment
  ): number {
  ...
  private getCheckBoxSizeTypeEnumValue(
    checkBoxSizeType: CheckBoxSizeType
  ): number {
  ...
  private getContentControlAppearanceEnumValue(
    contentControlAppearance: string
  ): number {
  ...
  private getFollowCharacterType(
    followCharacterType: FollowCharacterType
  ): number {
