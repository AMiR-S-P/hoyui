...
export class Paragraph {
  ...
  //Event Handlers
  private numberedAndBulletNoneClickHandler: EventListenerOrEventListenerObject =
    this.numberedNoneClick.bind(this);

  private numberedNumberDotClickHandler: EventListenerOrEventListenerObject =
    this.numberedNumberDotClick.bind(this);
  private numberedLowLetterClickHandler: EventListenerOrEventListenerObject =
    this.numberedLowLetterClick.bind(this);
  private numberedUpLetterClickHandler: EventListenerOrEventListenerObject =
    this.numberedUpLetterClick.bind(this);
  private numberedLowRomanClickHandler: EventListenerOrEventListenerObject =
    this.numberedLowRomanClick.bind(this);
  private numberedUpRomanClickHandler: EventListenerOrEventListenerObject =
    this.numberedUpRomanClick.bind(this);
  private numberSplitButtonBeforeOpenHandler: EventListenerOrEventListenerObject =
    this.numberSplitButtonBeforeOpen.bind(this);
  private bulletDotClickHandler: EventListenerOrEventListenerObject =
    this.bulletDotClick.bind(this);
  private bulletCircleClickHandler: EventListenerOrEventListenerObject =
    this.bulletCircleClick.bind(this);
  private bulletSquareClickHandler: EventListenerOrEventListenerObject =
    this.bulletSquareClick.bind(this);
  private bulletFlowerClickHandler: EventListenerOrEventListenerObject =
    this.bulletFlowerClick.bind(this);
  private bulletArrowClickHandler: EventListenerOrEventListenerObject =
    this.bulletArrowClick.bind(this);
  private bulletTickClickHandler: EventListenerOrEventListenerObject =
    this.bulletTickClick.bind(this);
  private onrightAlignmentClickHandler: EventListenerOrEventListenerObject =
    this.onrightAlignmentClick.bind(this);
  ...
  public initializeParagraphPropertiesDiv(
    ...
    this.paragraphDiv = this.createDivElement(
      element + '_paragraph',
      wholeDiv,
      ''
    );
    ...
    this.styleDiv = this.createDivElement(
      element + '_styleDiv',
      this.paragraphDiv
    );
    this.styleDiv.classList.add('e-de-ctnr-segment', 'e-de-ctnr-style-div');
    this.styleSelect = createElement('input', {
      id: element + '_style',
      styles: 'width:248px;letter-spacing: 0.05px;',
    }) as HTMLSelectElement;
    this.styleDiv.appendChild(this.styleSelect);
    this.createStyleDropDownList(this.styleSelect);
    this.indentWholeDiv = this.createDivElement(
      element + '_indentWholeDiv',
      this.paragraphDiv
    );
    ...
    this.indentDiv = this.createDivElement(
      element + '_indentDiv',
      this.indentWholeDiv,
      'display:flex;'
    );
    let indentClassName: string =
      'e-de-ctnr-group-btn e-de-char-fmt-btn-left e-btn-group';
    if (isRtl) {
      indentClassName = 'e-rtl ' + indentClassName;
    }
    this.indentDiv.className = indentClassName;
    this.leftAlignment = this.createButtonTemplate(
      element + '_leftIndent',
      'e-de-ctnr-alignleft e-icons',
      this.indentDiv,
      'e-de-prop-indent-button',
      '40.5',
      'Align left Tooltip'
    );
    this.centerAlignment = this.createButtonTemplate(
      element + '_centerIndent',
      'e-de-ctnr-aligncenter e-icons',
      this.indentDiv,
      'e-de-prop-indent-button',
      '40.5',
      'Center Tooltip'
    );
    this.rightAlignment = this.createButtonTemplate(
      element + '_rightIndent',
      'e-de-ctnr-alignright e-icons',
      this.indentDiv,
      'e-de-prop-indent-button',
      '40.5',
      'Align right Tooltip'
    );
    this.justify = this.createButtonTemplate(
      element + '_justify',
      'e-de-ctnr-justify e-icons',
      this.indentDiv,
    ...
    this.incDecIndentDiv = this.createDivElement(
      element + '_lineindentDiv',
      this.indentWholeDiv,
      'display:flex;'
    );
    ...
    this.decreaseIndent = this.createButtonTemplate(
      element + '_decreaseIndent',
      decreaseIndentIconCss,
      this.incDecIndentDiv,
      'e-de-prop-indent-button',
      '37',
      'Decrease indent'
    );
    this.increaseIndent = this.createButtonTemplate(
      element + '_increaseIndent',
    ...
    this.listDiv = this.createDivElement(
      element + '_listDiv',
      this.paragraphDiv,
      'display:flex;'
    );
    this.paraDiv = this.createDivElement(
      element + '_paraDiv',
      this.paragraphDiv,
      'display:flex'
    );
    ...
    if (isRtl) {
      classList(
        this.listDiv,
        ['e-de-ctnr-segment-rtl', 'e-de-ctnr-group-btn'],
        []
      );
      classList(
        this.paraDiv,
    ...
    this.lineHeight = createElement('button', {
      id: element + '_lineHeight',
      attrs: { type: 'button' },
    });
    this.listDiv.appendChild(this.lineHeight);
    this.lineSpacing = this.createLineSpacingDropdown(this.lineHeight);

    this.listDropDown = this.createDivElement(
      element + '_listDropDiv',
      this.listDiv
    );
    classList(
      this.listDropDown,
      ['de-split-button', 'e-de-ctnr-segment-list'],
      []
    );
    if (isRtl) {
    ...
    this.bulletButton = createElement('button', {
      id: element + '_bullet',
      attrs: { type: 'button' },
    });
    this.listDropDown.appendChild(this.bulletButton);
    this.numberingList = createElement('button', {
      id: element + '_numberingList',
      attrs: { type: 'button' },
    });
    ...
    this.borders = this.createButtonTemplate(
      element + '_borders',
      'e-de-ctnr-borders e-icons',
      this.paraDiv,
      'e-de-ctnr-group-btn',
      '37',
      'Borders'
    );
    this.showHiddenMarks = this.createButtonTemplate(
      element + '_paraMark',
      'e-de-e-paragraph-mark e-icons',
      this.paraDiv,
      'e-de-ctnr-group-btn',
      '37',
  ...
  private createSeparator(parentDiv: HTMLElement): void {
    const separator: HTMLElement = createElement('div', {
      className: 'e-de-prop-vline',
    });
  ...
  private createButtonTemplate(
    ...
    buttonElement.setAttribute(
      'aria-label',
      this.localObj.getConstant(toolTipText)
    );
    if (
      this.localObj.getConstant(toolTipText) !== 'Decrease indent' &&
      this.localObj.getConstant(toolTipText) !== 'Increase indent' &&
      this.localObj.getConstant(toolTipText) !== 'Borders'
    ) {
    ...
    const dropdown: DropDownButton = new DropDownButton({
      ...
      beforeItemRender: (args: MenuEventArgs) => {
        ...
        if (args.item.text === this.appliedLineSpacing) {
          ...
          span.setAttribute(
            'class',
            'e-de-selected-item e-icons e-de-linespacing'
          );
        } else {
          (args.element.children[0] as HTMLElement).style.marginRight = '25px';
          (args.element.children[0] as HTMLElement).classList.remove(
            'e-de-selected-item'
          );
        }
      },
  ...
  private createNumberListDropButton(
    ...
    this.numberListDropDiv = createElement('div', {
      id: 'target',
      styles: 'width: 211px;height: auto;display:none',
    });
    this.numberListDropUlTag = createElement('ul', {
      styles: 'display: block; outline: 0px;',
      id: 'listMenu',
      className:
        'e-de-floating-menu e-de-bullets-menu e-de-list-container e-de-list-thumbnail',
    });
    ...
    this.noneNumberTag.addEventListener(
      'click',
      this.numberedAndBulletNoneClickHandler
    );
    this.numberList = this.createNumberListTag(
      this.numberListDropUlTag,
      '1.',
      '2.',
      '3.'
    );
    this.numberList.addEventListener(
      'click',
      this.numberedNumberDotClickHandler
    );
    this.lowLetter = this.createNumberListTag(
      this.numberListDropUlTag,
      'a.',
      'b.',
      'c.'
    );
    this.lowLetter.addEventListener(
      'click',
      this.numberedLowLetterClickHandler
    );
    this.upLetter = this.createNumberListTag(
      this.numberListDropUlTag,
      'A.',
      'B.',
      'C.'
    ...
    this.lowRoman = this.createNumberListTag(
      this.numberListDropUlTag,
      'i.',
      'ii.',
      'iii.'
    ...
    this.upRoman = this.createNumberListTag(
      this.numberListDropUlTag,
      'I.',
      'II.',
      'III.'
    ...
    button.parentElement.setAttribute(
      'title',
      this.localObj.getConstant('Numbering')
    );
    button.parentElement.setAttribute(
      'aria-label',
      this.localObj.getConstant('Numbering')
  ...
  private numberSplitButtonBeforeOpen(): void {
    ...
    if (
      !isNullOrUndefined(this.documentEditor.selectionModule.paragraphFormat)
    ) {
      if (
        isNullOrUndefined(
        ...
        const abstractList: WAbstractList =
          this.documentEditor.documentHelper.getAbstractListById(
            list.abstractListId
          );
        const startParagraph: ParagraphWidget = this.documentEditor
          .selectionModule.isForward
          ? this.documentEditor.selectionModule.start.paragraph
          : this.documentEditor.selectionModule.end.paragraph;
        const level: WListLevel =
          abstractList.levels[
            startParagraph.paragraphFormat.listFormat.listLevelNumber
          ];
  ...
  private createBulletListDropButton(
    ...
    const div: HTMLElement = createElement('div', {
      id: 'bullet_list',
      styles: 'width: 196px;height: auto;display:none',
    });
    ...
    const menuOptions: SplitButtonModel = {
      ...
      beforeOpen: (): void => {
        ...
        if (
          ...
          this.updateSelectedBulletListType(
            this.documentEditor.selectionModule.paragraphFormat.listText
          );
        } else {
          const startParagraph: ParagraphWidget = this.documentEditor
            .selectionModule.isForward
            ...
            : this.documentEditor.selectionModule.end.paragraph;
          this.updateSelectedBulletListType(
            startParagraph.paragraphFormat.listFormat.listLevel.numberFormat
          );
        }
      },
      beforeClose: (): void => {
    ...
    button.parentElement.setAttribute(
      'title',
      this.localObj.getConstant('Bullets')
    );
    button.parentElement.setAttribute(
      'aria-label',
      this.localObj.getConstant('Bullets')
  ...
  private createNumberListTag(
    ...
    let innerHTML: string =
      '<div>' +
      text1 +
      '<span class="e-de-list-line"></span></div><div>' +
      text2 +
      '<span class="e-de-list-line">';
    innerHTML +=
      '</span></div><div>' +
      text3 +
      '<span class="e-de-list-line"> </span></div >';
  ...
  private createBulletListTag(
    ...
    const liTag: HTMLElement = createElement('li', {
      styles: 'display:block;',
      className:
        'e-de-floating-menuitem e-de-floating-bullet-menuitem-md e-de-list-items  e-de-list-item-size',
    });
    ulTag.appendChild(liTag);
    const liInnerDiv: HTMLElement = createElement('div', {
    ...
    const spanDiv: HTMLElement = createElement('div', {
      styles: isNone
        ? 'font-size:8px;text-align: center;top: 8px;line-height:normal'
        : '',
    });
  ...
  private createStyleDropDownList(selectElement: HTMLElement): void {
    this.style = new ComboBox({
      dataSource: [
        { StyleName: 'Normal', IconClass: 'e-de-e-paragraph-mark e-icons' },
      ],
    ...
    this.style.footerTemplate = initializeCSPTemplate((data: any): string => {
    ...
    selectElement.parentElement.setAttribute(
      'title',
      this.localObj.getConstant('Styles')
    );
  }
  /* eslint-disable @typescript-eslint/no-explicit-any */
  private updateOptions(args: any): void {
    args.popup.element
      .getElementsByClassName('e-de-ctnr-dropdown-ftr')[0]
      .addEventListener('click', this.createStyle.bind(this));
  }
  /* eslint-disable */
  public updateStyleNames(): void {
    this.styleName = !isNullOrUndefined((this.style as any).itemData)
      ? (this.style as any).itemData.StyleName
      : undefined;
    const stylesMap: any = this.documentEditor.documentHelper.stylesMap;
    let paraStyles: any[] = stylesMap.get('Paragraph')
      ? stylesMap.get('Paragraph')
      : [];
    let linkedStyles: any[] = stylesMap.get('Linked')
      ? stylesMap.get('Linked')
      : [];
    let charStyles: any[] = stylesMap.get('Character')
      ? stylesMap.get('Character')
      : [];
  ...
  private constructStyleDropItems(styles: unknown[]): any {
    ...
    const paraIcon: string =
      'e-list-icon e-de-listview-icon e-de-e-paragraph-style-mark e-icons';
    const charIcon: string =
      'e-list-icon e-de-listview-icon e-de-e-character-style-mark e-icons';
    const linkedIcon: string =
      'e-list-icon e-de-listview-icon e-de-e-linked-style-mark e-icons';
    for (const styleObj of styles) {
      const obj: any = {};
      const styleName: string = this.localObj.getConstant(
        (styleObj as any).name
      );
  ...
  private parseStyle(style: string): string {
    ...
    if (
      !isNullOrUndefined(styleObj.characterFormat.baselineAlignment) &&
      styleObj.characterFormat.baselineAlignment !== 'Normal'
    ) {
      let vAlign: string = '';
    ...
    if (
      !isNullOrUndefined(styleObj.characterFormat.underline) &&
      styleObj.characterFormat.underline !== 'None'
    ) {
      textDecoration += 'underline ';
    }
    if (
      !isNullOrUndefined(styleObj.characterFormat.strikethrough) &&
      styleObj.characterFormat.strikethrough !== 'None'
    ) {
    ...
    if (
      !isNullOrUndefined(styleObj.characterFormat.bold) &&
      styleObj.characterFormat.bold
    ) {
      domStyle += 'font-weight:bold;';
    }
    if (
      !isNullOrUndefined(styleObj.characterFormat.italic) &&
      styleObj.characterFormat.italic
    ) {
  ...
  public wireEvent(): void {
    this.leftAlignment.addEventListener(
      'click',
      this.onrightAlignmentClickHandler
    );
    ...
    this.showHiddenMarks.addEventListener('click', (): void => {
      this.container.documentEditorSettings.showHiddenMarks =
        !this.container.documentEditorSettings.showHiddenMarks;
  ...
  public unwireEvents(): void {
    this.leftAlignment.removeEventListener(
      'click',
      this.onrightAlignmentClickHandler
    );
  ...
  private setLineSpacing(): void {
    const lineSpacing: number =
      this.documentEditor.selectionModule.paragraphFormat.lineSpacing;
    if (lineSpacing === 1) {
  ...
  private selectStyleValue(args: any): void {
    if (this.container) {
      let treeViewResult: HTMLElement = document.getElementById(
        this.documentEditor.containerId + '_treeDiv'
      );
      if (
        !isNullOrUndefined(treeViewResult) &&
        !isNullOrUndefined(this.documentEditor.optionsPaneModule) &&
        this.documentEditor.optionsPaneModule.isOptionsPaneShow
      ) {
        treeViewResult.innerHTML = '';
        this.documentEditor.optionsPaneModule.data =
          this.documentEditor.optionsPaneModule.dataForTreeview();
  ...
  private applyStyleValue(args: any): void {
    if (!this.documentEditor.isReadOnly && this.documentEditor.editorModule) {
      let styleName: string =
        this.documentEditor.stylesDialogModule.getStyleName(
          SanitizeHtmlHelper.sanitize(args.itemData.StyleName)
        );
      if (
        !isNullOrUndefined(
          this.documentEditor.documentHelper.styles.findByName(styleName)
        )
      ) {
  ...
  private getLevelFormatNumber(): string {
    ...
    numberFormat =
      numberFormat +
      ((this.documentEditor.selectionModule.paragraphFormat.listLevelNumber <= 0
        ? 0
        : this.documentEditor.selectionModule.paragraphFormat.listLevelNumber) +
        1) +
      '.';
    return numberFormat;
  }
  private bulletDotClick(): void {
    ...
    if (this.documentEditor.editorModule) {
      ...
      this.documentEditor.editorModule.applyBullet(
        String.fromCharCode(61623),
        'Symbol'
      );
      setTimeout((): void => {
        this.documentEditor.focusIn();
  ...
  private bulletCircleClick(): void {
    ...
    if (this.documentEditor.editorModule) {
      ...
      this.documentEditor.editorModule.applyBullet(
        String.fromCharCode(61551) + String.fromCharCode(32),
        'Symbol'
      );
      setTimeout((): void => {
        this.documentEditor.focusIn();
  ...
  public onSelectionChange(): void {
    ...
    if (this.documentEditor.editorModule) {
      ...
      let style: string =
        this.documentEditor.selectionModule.characterFormat.styleName;
      if (
        this.documentEditor.selectionModule.characterFormat.styleName ===
      ...
      if (style) {
        ...
        this.style.value =
          isNullOrUndefined(localeValue) || localeValue == ''
            ? style
            : localeValue;
        // this.style.dataBind();
      } else {
      ...
      if (
        this.documentEditor.selectionModule.paragraphFormat.textAlignment ===
        'Left'
      ) {
        classList(this.leftAlignment, ['e-btn-toggle'], []);
