...
import { ColorPicker, ColorPickerEventArgs } from '@hoyui/inputs';
...
export class Text {
  ...
  public initializeTextPropertiesDiv(
    ...
    classList(
      textDiv,
      ['e-de-cntr-pane-padding', 'e-de-prop-separator-line'],
      []
    );
    const fontDiv: HTMLElement = this.createDiv(
      element + '_sizeStyle',
      textDiv,
      'display:inline-flex;'
    );
    ...
    const fontFamilyDiv: HTMLElement = this.createDiv(
      element + '_fontFamilyDiv',
      fontDiv
    );
    ...
    const fontSizeDiv: HTMLElement = this.createDiv(
      element + '_fontSizeDiv',
      fontDiv
    );
    ...
    this.bold = this.createButtonTemplate(
      element + '_bold',
      'e-de-ctnr-bold e-icons',
      leftDiv,
      'e-de-prop-font-button',
      '40.5',
      'Bold Tooltip'
    );
    this.italic = this.createButtonTemplate(
      element + '_italic',
      'e-de-ctnr-italic e-icons',
      leftDiv,
      'e-de-prop-font-button',
      '40.5',
      'Italic Tooltip'
    );
    this.underline = this.createButtonTemplate(
      element + '_underline',
      'e-de-ctnr-underline e-icons',
      leftDiv,
      'e-de-prop-font-button',
      '40.5',
      'Underline Tooltip'
    );
    this.strikethrough = this.createButtonTemplate(
      element + '_strikethrough',
      'e-de-ctnr-strikethrough e-icons',
      leftDiv,
    ...
    const rightDiv: HTMLElement = createElement('div', {
      id: element + '_rightDiv',
      className: divClassName,
      styles: 'display:inline-flex;',
    });
    propertiesDiv.appendChild(rightDiv);
    this.superscript = this.createButtonTemplate(
      element + '_superscript',
      'e-de-ctnr-superscript e-icons',
      rightDiv,
      'e-de-prop-font-button',
      '38.5',
      'Superscript Tooltip'
    );
    this.subscript = this.createButtonTemplate(
      element + '_subscript',
      'e-de-ctnr-subscript e-icons',
      rightDiv,
      'e-de-prop-font-last-button',
      '38.5',
      'Subscript Tooltip'
    ...
    const leftDiv2: HTMLElement = createElement('div', {
      id: element + '_color',
    ...
    this.fontColor = this.createFontColorPicker(
      element + '_textColor',
      40.5,
      leftDiv2,
      this.localObj.getConstant('Font color')
    );
    classList(
      leftDiv2.firstElementChild.lastElementChild.lastElementChild
        .firstChild as HTMLElement,
      ['e-de-ctnr-fontcolor', 'e-icons'],
      ['e-caret']
    );
    this.initializeHighlightColorElement();
    this.highlightColor = this.createHighlightColorSplitButton(
      element + '_highlightColor',
      34.5,
      leftDiv2,
      this.localObj.getConstant('Text highlight color')
    );
    classList(
      this.highlightColor.element.nextElementSibling.firstElementChild,
      ['e-de-ctnr-highlight', 'e-icons'],
      ['e-caret']
    );
    this.highlightColorInputElement = this.highlightColor.element
      .firstChild as HTMLElement;
    this.clearFormat = this.createButtonTemplate(
      element + '_clearFormat',
      'e-de-ctnr-clearall e-icons',
      leftDiv2,
      'e-de-prop-font-last-button',
      '40.5',
    ...
    const rightDiv2: HTMLElement = createElement('div', {
      id: element + '_rightDiv2',
      className: divClassName.replace('e-btn-group', ''),
      styles: 'display:inline-flex;',
    });
    if (isRtl) {
      classList(rightDiv2, ['e-rtl'], []);
    }
    rightDiv2.setAttribute(
      'title',
      this.container.localObj.getConstant('Change case Tooltip')
    );
  ...
  private createChangecase = (container: HTMLElement): void => {
    const items: ItemModel[] = [
      {
        text: this.localObj.getConstant('SentenceCase'),
        id: 'sentencecase',
      },
      {
      ...
      {
        text: this.localObj.getConstant('Lowercase'),
        id: 'lowercase',
      },
      {
        text: this.localObj.getConstant('CapitalizeEachWord'),
        id: 'capitalizeEachWord',
      },
      {
        text: this.localObj.getConstant('ToggleCase'),
        id: 'togglecase',
      },
    ];
  ...
  private createHighlightColorSplitButton(
    ...
    const hgltSplitObj: SplitButton = new SplitButton({
      ...
      target: this.highlightColorElement,
      close: this.closePopup.bind(this),
      beforeOpen: this.openPopup.bind(this),
      enableRtl: this.isRtl,
    });
    hgltSplitObj.appendTo(buttonElement);
    hgltSplitObj.click = (): void => {
      this.applyHighlightColor(
        this.highlightColorInputElement.style.backgroundColor
      );
    };
    (hgltSplitObj.element.firstChild as HTMLElement).style.backgroundColor =
      'rgb(255, 255, 0)';
  ...
  private initializeHighlightColorElement(): void {
    ...
    const yellowDiv: HTMLDivElement = this.createHightlighColorPickerDiv(
      '#ffff00',
      'yellowDiv'
    );
    const brightGreenDiv: HTMLDivElement = this.createHightlighColorPickerDiv(
      '#00ff00',
      'brightGreenDiv'
    );
    const turquoiseDiv: HTMLDivElement = this.createHightlighColorPickerDiv(
      '#00ffff',
      'turquoiseDiv'
    );
    const hotPinkDiv: HTMLDivElement = this.createHightlighColorPickerDiv(
      '#ff00ff',
      'hotPinkDiv'
    );
    const blueDiv: HTMLDivElement = this.createHightlighColorPickerDiv(
      '#0000ff',
      'blueDiv'
    );
    const redDiv: HTMLDivElement = this.createHightlighColorPickerDiv(
      '#ff0000',
      'redDiv'
    );
    const darkBlueDiv: HTMLDivElement = this.createHightlighColorPickerDiv(
      '#000080',
      'darkBlueDiv'
    );
    const tealDiv: HTMLDivElement = this.createHightlighColorPickerDiv(
      '#008080',
      'tealDiv'
    );
    const greenDiv: HTMLDivElement = this.createHightlighColorPickerDiv(
      '#008000',
      'greenDiv'
    );
    const violetDiv: HTMLDivElement = this.createHightlighColorPickerDiv(
      '#800080',
      'violetDiv'
    );
    const darkRedDiv: HTMLDivElement = this.createHightlighColorPickerDiv(
      '#800000',
      'darkRedDiv'
    );
    const darkYellowDiv: HTMLDivElement = this.createHightlighColorPickerDiv(
      '#808000',
      'darkYellowDiv'
    );
    const gray50Div: HTMLDivElement = this.createHightlighColorPickerDiv(
      '#808080',
      'gray50Div'
    );
    const gray25Div: HTMLDivElement = this.createHightlighColorPickerDiv(
      '#c0c0c0',
      'gray25Div'
    );
    const blackDiv: HTMLDivElement = this.createHightlighColorPickerDiv(
      '#000000',
      'blackDiv'
    );
    const nocolor: HTMLElement = createElement('div', {
      className: 'e-hglt-no-color',
    });
    ...
    const nocolorDivValue: HTMLElement = createElement('div', {
      innerHTML: this.localObj.getConstant('No color'),
  ...
  private createHightlighColorPickerDiv(
    ...
    const colorDiv: HTMLDivElement = createElement('div', {
      className: 'e-de-ctnr-hglt-btn',
      id: id,
    }) as HTMLDivElement;
  ...
  private applyHighlightColorAsBackground(color: HighlightColor): void {
    ...
    if (color === 'NoColor') {
      this.highlightColorElement
        .querySelector('#noColorDiv')
        .classList.add('e-color-selected');
    } else if (color === 'Yellow') {
      this.highlightColorElement
        .querySelector('#yellowDiv')
        .classList.add('e-color-selected');
    } else if (color === 'BrightGreen') {
      this.highlightColorElement
        .querySelector('#brightGreenDiv')
        .classList.add('e-color-selected');
    } else if (color === 'Turquoise') {
      this.highlightColorElement
        .querySelector('#turquoiseDiv')
        .classList.add('e-color-selected');
    } else if (color === 'Pink') {
      this.highlightColorElement
        .querySelector('#hotPinkDiv')
        .classList.add('e-color-selected');
    } else if (color === 'Red') {
      this.highlightColorElement
        .querySelector('#redDiv')
        .classList.add('e-color-selected');
    } else if (color === 'DarkBlue') {
      this.highlightColorElement
        .querySelector('#darkBlueDiv')
        .classList.add('e-color-selected');
    } else if (color === 'Teal') {
      this.highlightColorElement
        .querySelector('#tealDiv')
        .classList.add('e-color-selected');
    } else if (color === 'Green') {
      this.highlightColorElement
        .querySelector('#greenDiv')
        .classList.add('e-color-selected');
    } else if (color === 'Violet') {
      this.highlightColorElement
        .querySelector('#violetDiv')
        .classList.add('e-color-selected');
    } else if (color === 'DarkRed') {
      this.highlightColorElement
        .querySelector('#darkRedDiv')
        .classList.add('e-color-selected');
    } else if (color === 'DarkYellow') {
      this.highlightColorElement
        .querySelector('#darkYellowDiv')
        .classList.add('e-color-selected');
    } else if (color === 'Gray50') {
      this.highlightColorElement
        .querySelector('#gray50Div')
        .classList.add('e-color-selected');
    } else if (color === 'Gray25') {
      this.highlightColorElement
        .querySelector('#gray25Div')
        .classList.add('e-color-selected');
    } else if (color === 'Black') {
      this.highlightColorElement
        .querySelector('#blackDiv')
        .classList.add('e-color-selected');
    } else if (color === 'Blue') {
      this.highlightColorElement
        .querySelector('#blueDiv')
        .classList.add('e-color-selected');
    }
  }
  private removeSelectedColorDiv(): void {
    this.highlightColorElement
      .querySelector('#noColorDiv')
      .classList.remove('e-color-selected');
    this.highlightColorElement
      .querySelector('#yellowDiv')
      .classList.remove('e-color-selected');
    this.highlightColorElement
  ...
  private applyHighlightColor(color: string): void {
    ...
    this.documentEditor.selectionModule.characterFormat.highlightColor =
      hgltColor as HighlightColor;
  ...
  private createFontColorPicker(
    ...
    this.fontColorInputElement = new ColorPicker(
      {
        value: '#000000',
        enableRtl: this.isRtl,
    ...
    this.fontColorInputElement.element.parentElement.setAttribute(
      'title',
      toolTipText
    );
    this.fontColorInputElement.element.parentElement.setAttribute(
    ...
    this.documentEditor.documentHelper.fontColorInputElement =
      this.fontColorInputElement;
    return inputElement;
  }
  ...
  private createDropDownListForSize(fontSelectElement: HTMLElement): void {
    ...
    this.fontSize.focus = (): void => {
      ...
      (this.fontSize.element as HTMLInputElement).select();
    };
    this.fontSize.value =
      this.documentEditor.selectionModule.characterFormat.fontSize.toString();
    this.fontSize.appendTo(fontSelectElement);
    this.fontSize.element.parentElement.setAttribute(
      'title',
      this.localObj.getConstant('Font Size')
    );
  }
  ...
  private createDropDownListForFamily(fontSelectElement: HTMLElement): void {
    ...
    const fontFamilyValue: string[] =
      this.container.documentEditorSettings.fontFamilies;
    ...
    this.fontFamily.focus = (): void => {
      this.isRetrieving = false;
      (this.fontFamily.element as HTMLInputElement).select();
    };
    this.fontFamily.element.parentElement.setAttribute(
      'title',
      this.localObj.getConstant('Font')
    );
  }
  /* eslint-enable */
  public wireEvent(): void {
    ...
    this.fontColorInputElement.addEventListener(
      'change',
    ...
    this.changeCaseDropdown.addEventListener(
      'select',
      (args: MenuEventArgs): void => {
        this.isRetrieving = false;
  ...
  private changeFontColor(arg: ColorPickerEventArgs): void {
    ...
    if (
      !this.documentEditor.isReadOnly &&
      this.documentEditor.selectionModule
    ) {
      this.documentEditor.selectionModule.characterFormat.fontColor =
  ...
  private changeFontSize(): void {
    ...
    if (
      ...
      setTimeout((): void => {
        this.documentEditor.selectionModule.characterFormat.fontSize = this
  ...
  public onSelectionChange(): void {
    ...
    if (this.documentEditor.selectionModule) {
      ...
      if (this.documentEditor.selectionModule.characterFormat.fontFamily) {
        ...
        if (
          !isNullOrUndefined(
            this.documentEditor.selectionModule.characterFormat
              .renderedFontFamily
          ) &&
          !isNullOrUndefined(
            this.documentEditor.selectionModule.characterFormat.fontFamily
      ...
      if (
        this.documentEditor.selectionModule.characterFormat.underline &&
      ...
      if (
        this.documentEditor.selectionModule.characterFormat.strikethrough &&
        this.documentEditor.selectionModule.characterFormat.strikethrough !==
          'None'
      ) {
      ...
      if (
        this.documentEditor.selectionModule.characterFormat.baselineAlignment &&
        this.documentEditor.selectionModule.characterFormat
  ...
  public removeHTMLElement(): void {
    ...
    this.fontColor = null;
    this.highlightColorInputElement.childNodes.forEach(
      (element: HTMLElement) => {
