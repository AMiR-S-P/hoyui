...
import { Tab, TabItemModel, SelectingEventArgs } from '@hoyui/navigations';
import { TextProperties } from './text-properties-pane';
import { ImageProperties } from './image-properties-pane';
import { Button, IconPosition } from '@hoyui/buttons';
import {
  ItemModel,
  DropDownButton,
  DropDownButtonModel,
...
export class TableProperties {
  ...
  //Event Handler
  private onOutlineBorderClickHandler: EventListenerOrEventListenerObject =
    this.onOutlineBorder.bind(this);
  private onAllBorderHandler: EventListenerOrEventListenerObject =
    this.onAllBorder.bind(this);
  private onInsideBorderHandler: EventListenerOrEventListenerObject =
    this.onInsideBorder.bind(this);
  private onLeftBorderHandler: EventListenerOrEventListenerObject =
    this.onLeftBorder.bind(this);
  private onVerticalBorderHandler: EventListenerOrEventListenerObject =
    this.onVerticalBorder.bind(this);
  private onRightBorderHandler: EventListenerOrEventListenerObject =
    this.onRightBorder.bind(this);
  private onTopBorderHandler: EventListenerOrEventListenerObject =
    this.onTopBorder.bind(this);
  private onHorizontalBorderHandler: EventListenerOrEventListenerObject =
    this.onHorizontalBorder.bind(this);
  private onBottomBorderHandler: EventListenerOrEventListenerObject =
    this.onBottomBorder.bind(this);
  private onInsertRowAboveHandler: EventListenerOrEventListenerObject =
    this.onInsertRowAbove.bind(this);
  private onInsertRowBelowHandler: EventListenerOrEventListenerObject =
    this.onInsertRowBelow.bind(this);
  private onInsertColumnLeftHandler: EventListenerOrEventListenerObject =
    this.onInsertColumnLeft.bind(this);
  private onInsertColumnRightHandler: EventListenerOrEventListenerObject =
    this.onInsertColumnRight.bind(this);
  private onDeleteRowHandler: EventListenerOrEventListenerObject =
    this.onDeleteRow.bind(this);
  private onDeleteColumnHandler: EventListenerOrEventListenerObject =
    this.onDeleteColumn.bind(this);
  private onMergeCellHandler: EventListenerOrEventListenerObject =
    this.onMergeCell.bind(this);
  private applyAlignTopHandler: EventListenerOrEventListenerObject =
    this.applyAlignTop.bind(this);
  private applyAlignBottomHandler: EventListenerOrEventListenerObject =
    this.applyAlignBottom.bind(this);
  private applyAlignCenterHorizontalHandler: EventListenerOrEventListenerObject =
    this.applyAlignCenterHorizontal.bind(this);
  private onTopMarginHandler: EventListenerOrEventListenerObject =
    this.onTopMargin.bind(this);
  private onRightMarginHandler: EventListenerOrEventListenerObject =
    this.onRightMargin.bind(this);
  private onLeftMarginHandler: EventListenerOrEventListenerObject =
    this.onLeftMargin.bind(this);
  private onBottomMarginHandler: EventListenerOrEventListenerObject =
    this.onBottomMargin.bind(this);
  private onTopMarginClickHandler: EventListenerOrEventListenerObject =
    this.onTopMarginClick.bind(this);
  private onTopMarginBlurHandler: EventListenerOrEventListenerObject =
    this.onTopMarginBlur.bind(this);
  private onRightMarginClickHandler: EventListenerOrEventListenerObject =
    this.onRightMarginClick.bind(this);
  private onRightMarginBlurHandler: EventListenerOrEventListenerObject =
    this.onRightMarginBlur.bind(this);
  private onLeftMarginClickHandler: EventListenerOrEventListenerObject =
    this.onLeftMarginClick.bind(this);
  private onLeftMarginBlurHandler: EventListenerOrEventListenerObject =
    this.onLeftMarginBlur.bind(this);
  private onBottomMarginClickHandler: EventListenerOrEventListenerObject =
    this.onBottomMarginClick.bind(this);
  private onBottomMarginBlurHandler: EventListenerOrEventListenerObject =
    this.onBottomMarginBlur.bind(this);
  ...
  public constructor(
    ...
    this.tableTextProperties = new TextProperties(
      container,
      'textProperties',
      true,
      this.isRtl
  ...
  private initializeTablePropPane(): void {
    this.localObj = new L10n(
      'documenteditorcontainer',
      this.container.defaultLocale,
      this.container.locale
    );
    this.tableProperties = createElement('div', {
      className: 'e-de-scrollbar-hide',
  ...
  private addTablePropertyTab(): void {
    const tableHeader: HTMLElement = createElement('div', {
      innerHTML: this.localObj.getConstant('Table'),
    });
    const textHeader: HTMLElement = createElement('div', {
      innerHTML: this.localObj.getConstant('Text'),
    });
    this.parentElement = createElement('div', {
      styles: 'height:100%;overflow:auto;display:none',
      className: 'e-de-prop-pane e-de-scrollbar-hide',
    });
    this.element = createElement('div', {
      id: this.elementId + '_propertyTabDiv',
    ...
    const items: TabItemModel[] = [
      {
        ...
        content: this.tableTextProperties.element,
      },
      { header: { text: tableHeader }, content: this.tableProperties },
    ] as TabItemModel[];
    this.propertiesTab = new Tab({
      items: items,
      animation: { previous: { effect: 'None' }, next: { effect: 'None' } },
      selected: this.onTabSelection.bind(this),
    });
  ...
  private wireEvent(): void {
    ...
    this.borderBtn.addEventListener(
      'change',
      (args: ColorPickerEventArgs): void => {
        setTimeout((): void => {
    ...
    this.tableOutlineBorder.element.addEventListener(
      'click',
      this.onOutlineBorderClickHandler
    );
    this.tableAllBorder.element.addEventListener(
      'click',
      this.onAllBorderHandler
    );
    this.tableCenterBorder.element.addEventListener(
      'click',
      this.onInsideBorderHandler
    );
    this.tableLeftBorder.element.addEventListener(
      'click',
      this.onLeftBorderHandler
    );
    this.tableCenterVerticalBorder.element.addEventListener(
      'click',
      this.onVerticalBorderHandler
    );
    this.tableRightBorder.element.addEventListener(
      'click',
      this.onRightBorderHandler
    );
    this.tableTopBorder.element.addEventListener(
      'click',
      this.onTopBorderHandler
    );
    this.tableCenterHorizontalBorder.element.addEventListener(
      'click',
      this.onHorizontalBorderHandler
    );
    this.tableBottomBorder.element.addEventListener(
      'click',
      this.onBottomBorderHandler
    );
    this.insertRowAbove.element.addEventListener(
      'click',
      this.onInsertRowAboveHandler
    );
    this.insertRowBelow.element.addEventListener(
      'click',
      this.onInsertRowBelowHandler
    );
    this.insertColumnLeft.element.addEventListener(
      'click',
      this.onInsertColumnLeftHandler
    );
    this.insertColumnRight.element.addEventListener(
      'click',
      this.onInsertColumnRightHandler
    );
    this.deleteRow.element.addEventListener('click', this.onDeleteRowHandler);
    this.deleteColumn.element.addEventListener(
      'click',
      this.onDeleteColumnHandler
    );
    this.horizontalMerge.element.addEventListener(
      'click',
      this.onMergeCellHandler
    );
    this.alignTop.element.addEventListener('click', this.applyAlignTopHandler);
    this.alignBottom.element.addEventListener(
      'click',
      this.applyAlignBottomHandler
    );
    this.alignCenterHorizontal.element.addEventListener(
      'click',
      this.applyAlignCenterHorizontalHandler
    );
    ...
    this.topMargin.element.addEventListener(
      'click',
      this.onTopMarginClickHandler
    );
    this.rightMargin.element.addEventListener(
      'click',
      this.onRightMarginClickHandler
    );
    this.leftMargin.element.addEventListener(
      'click',
      this.onLeftMarginClickHandler
    );
    this.bottomMargin.element.addEventListener(
      'click',
      this.onBottomMarginClickHandler
    );
    this.topMargin.element.addEventListener('keydown', this.onTopMarginHandler);
    this.rightMargin.element.addEventListener(
      'keydown',
      this.onRightMarginHandler
    );
    this.leftMargin.element.addEventListener(
      'keydown',
      this.onLeftMarginHandler
    );
    this.bottomMargin.element.addEventListener(
      'keydown',
      this.onBottomMarginHandler
    );
    this.topMargin.element.addEventListener(
      'blur',
      this.onTopMarginBlurHandler
    );
    this.rightMargin.element.addEventListener(
      'blur',
      this.onRightMarginBlurHandler
    );
    this.leftMargin.element.addEventListener(
      'blur',
      this.onLeftMarginBlurHandler
    );
    this.bottomMargin.element.addEventListener(
      'blur',
      this.onBottomMarginBlurHandler
    );
  }
  ...
  private unWireEvent(): void {
    ...
    this.tableOutlineBorder.element.removeEventListener(
      'click',
      this.onOutlineBorderClickHandler
    );
    this.tableAllBorder.element.removeEventListener(
      'click',
      this.onAllBorderHandler
    );

    this.tableCenterBorder.element.removeEventListener(
      'click',
      this.onInsideBorderHandler
    );
    this.tableLeftBorder.element.removeEventListener(
      'click',
      this.onLeftBorderHandler
    );
    ...
    this.tableRightBorder.element.removeEventListener(
      'click',
      this.onRightBorderHandler
    );
    this.tableTopBorder.element.removeEventListener(
      'click',
      this.onTopBorderHandler
    );
    this.tableCenterHorizontalBorder.element.removeEventListener(
      'click',
      this.onHorizontalBorderHandler
    );
    this.tableBottomBorder.element.removeEventListener(
      'click',
      this.onBottomBorderHandler
    );
    ...
    this.insertRowBelow.element.removeEventListener(
      'click',
      this.onInsertRowBelowHandler
    );
    this.insertColumnLeft.element.removeEventListener(
      'click',
      this.onInsertColumnLeftHandler
    );
    this.insertColumnRight.element.removeEventListener(
      'click',
      this.onInsertColumnRightHandler
    );
    this.deleteRow.element.removeEventListener(
      'click',
      this.onDeleteRowHandler
    );
    ...
    this.alignTop.element.removeEventListener(
      'click',
      this.applyAlignTopHandler
    );
    this.alignBottom.element.removeEventListener(
      'click',
      this.applyAlignBottomHandler
    );
    this.alignCenterHorizontal.element.removeEventListener(
      'click',
      this.applyAlignCenterHorizontalHandler
    );
    ...
    this.bottomMargin.element.removeEventListener(
      'click',
      this.onBottomMarginClickHandler
    );
  ...
  private getBorder(border: BorderType): BorderSettings {
    const lineWidth: number =
      this.borderSize.content.indexOf('No Border') >= 0
        ? 0
        : parseFloat(this.borderSize.content);
  ...
  private onOutlineBorder(): void {
    this.documentEditor.editorModule.applyBorders(
      this.getBorder('OutsideBorders')
    );
  }
  ...
  private onVerticalBorder(): void {
    this.documentEditor.editorModule.applyBorders(
      this.getBorder('InsideVerticalBorder')
    );
  }
  private onRightBorder(): void {
    this.documentEditor.editorModule.applyBorders(
      this.getBorder('RightBorder')
    );
  }
  ...
  private onHorizontalBorder(): void {
    this.documentEditor.editorModule.applyBorders(
      this.getBorder('InsideHorizontalBorder')
    );
  }
  private onBottomBorder(): void {
    this.documentEditor.editorModule.applyBorders(
      this.getBorder('BottomBorder')
    );
  }
  ...
  private applyTopMargin(): void {
    ...
    this.documentEditor.selectionModule.cellFormat.topMargin =
      this.topMargin.value > this.topMargin.max
        ? this.topMargin.max
  ...
  private applyBottomMargin(): void {
    ...
    this.documentEditor.selectionModule.cellFormat.bottomMargin =
      this.bottomMargin.value > this.bottomMargin.max
  ...
  private applyLeftMargin(): void {
    ...
    this.documentEditor.selectionModule.cellFormat.leftMargin =
      this.leftMargin.value > this.leftMargin.max
        ? this.leftMargin.max
  ...
  private applyRightMargin(): void {
    ...
    this.documentEditor.selectionModule.cellFormat.rightMargin =
      this.rightMargin.value > this.rightMargin.max
        ? this.rightMargin.max
  ...
  public onSelectionChange(): void {
    if (this.documentEditor.selectionModule) {
      if (
        this.documentEditor.editorModule &&
        this.documentEditor.editorModule.canMergeCells()
      ) {
      ...
      if (
        this.documentEditor.selectionModule.contextType === 'TableText' ||
        this.documentEditor.selectionModule.contextType === 'TableImage'
      ) {
        this.shadingBtn.value = this.documentEditor.selectionModule.cellFormat
          .background
          ? this.documentEditor.selectionModule.cellFormat.background
          : '';
      }
      /* eslint-disable-next-line max-len */
      this.topMargin.value = this.documentEditor.selectionModule.cellFormat
        .topMargin
        ? this.documentEditor.selectionModule.cellFormat.topMargin
        : 0;
      /* eslint-disable-next-line max-len */
      this.bottomMargin.value = this.documentEditor.selectionModule.cellFormat
        .bottomMargin
        ? this.documentEditor.selectionModule.cellFormat.bottomMargin
        : 0;
      /* eslint-disable-next-line max-len */
      this.rightMargin.value = this.documentEditor.selectionModule.cellFormat
        .rightMargin
        ? this.documentEditor.selectionModule.cellFormat.rightMargin
        : 0;
      /* eslint-disable-next-line max-len */
      this.leftMargin.value = this.documentEditor.selectionModule.cellFormat
        .leftMargin
        ? this.documentEditor.selectionModule.cellFormat.leftMargin
        : 0;
    }
  ...
  private initFillColorDiv(): void {
    const fillDiv: HTMLElement = createElement('div', {
      id: this.elementId + '_fillColorDiv',
      className: 'e-de-property-div-padding de-tbl-fill-clr',
    });
    this.tableProperties.appendChild(fillDiv);
    const label: HTMLElement = createElement('label', {
      className: 'e-de-prop-sub-label',
    });
    ...
    this.shadingBtn = this.createColorPickerTemplate(
      this.elementId + '_tableShading',
      fillDiv,
      this.localObj.getConstant('Fill color'),
      false
    );
    classList(
      fillDiv.lastElementChild.lastElementChild.lastElementChild
        .firstChild as HTMLElement,
      ['e-de-ctnr-cellbg-clr-picker'],
      ['e-caret']
    );
    this.documentEditor.documentHelper.shadingBtn = this.shadingBtn;
  }
  private initBorderStylesDiv(): void {
    this.borderStyleDiv = createElement('div', {
      className: 'e-de-property-div-padding',
    });
    ...
    const styleDiv: HTMLElement = createElement('div', {
      styles: 'width:min-content;height:126px',
      className: 'e-de-grp-btn-ctnr',
    });
    const div1: HTMLElement = createElement('div', {
      className: this.groupButtonClass + ' e-de-ctnr-group-btn-top',
    });
    styleDiv.appendChild(div1);
    const div2: HTMLElement = createElement('div', {
      className: this.groupButtonClass + ' e-de-ctnr-group-btn-middle',
    });
    styleDiv.appendChild(div2);
    const div3: HTMLElement = createElement('div', {
      className: this.groupButtonClass + ' e-de-ctnr-group-btn-bottom',
    });
    ...
    this.tableOutlineBorder = this.createButtonTemplate(
      this.elementId + '_tableOutlineBorder',
      'e-de-ctnr-outsideborder e-icons',
      div1,
      'e-de-prop-font-button',
      btnStyle,
      this.localObj.getConstant('Outside borders')
    );
    this.tableAllBorder = this.createButtonTemplate(
      this.elementId + '_tableAllBorder',
      'e-de-ctnr-allborders e-icons',
      div1,
      'e-de-prop-font-button',
      btnStyle,
      this.localObj.getConstant('All borders')
    );
    this.tableCenterBorder = this.createButtonTemplate(
      this.elementId + '_tableCenterBorder',
      'e-de-ctnr-insideborders e-icons',
      div1,
      'e-de-prop-font-button',
      btnStyle,
      this.localObj.getConstant('Inside borders')
    );
    this.tableLeftBorder = this.createButtonTemplate(
      this.elementId + '_tableLeftBorder',
      'e-de-ctnr-leftborders e-icons',
      div2,
      'e-de-prop-font-button',
      btnStyle,
      this.localObj.getConstant('Left border')
    );
    this.tableCenterVerticalBorder = this.createButtonTemplate(
      this.elementId + '_tableCenterVBorder',
      'e-de-ctnr-insideverticalborder e-icons',
      div2,
      'e-de-prop-font-button',
      btnStyle,
      this.localObj.getConstant('Inside vertical border')
    );
    this.tableRightBorder = this.createButtonTemplate(
      this.elementId + '_tableRightBorder',
      'e-de-ctnr-rightborder e-icons',
      div2,
      'e-de-prop-font-button',
      btnStyle,
      this.localObj.getConstant('Right border')
    );
    this.tableTopBorder = this.createButtonTemplate(
      this.elementId + '_tableTopBorder',
      'e-de-ctnr-topborder e-icons',
      div3,
      'e-de-prop-font-button',
      btnStyle,
      this.localObj.getConstant('Top border')
    );
    this.tableCenterHorizontalBorder = this.createButtonTemplate(
      this.elementId + '_tableCenterHBorder',
      'e-de-ctnr-insidehorizondalborder e-icons',
      div3,
      'e-de-prop-font-button',
      btnStyle,
      this.localObj.getConstant('Inside horizontal border')
    );
    this.tableBottomBorder = this.createButtonTemplate(
      this.elementId + '_tableBottomBorder',
      'e-de-ctnr-bottomborder e-icons',
      div3,
      'e-de-prop-font-button',
      btnStyle,
      this.localObj.getConstant('Bottom border')
    );
    parentDiv.appendChild(styleDiv);
    const styleTypeDiv: HTMLElement = createElement('div', {
      className: 'de-tbl-fill-clr',
    });
    if (!this.isRtl) {
    ...
    this.borderBtn = this.createColorPickerTemplate(
      this.elementId + '_tableBorderColor',
      styleTypeDiv,
      this.localObj.getConstant('Border color'),
      true
    );
    this.documentEditor.documentHelper.borderBtn = this.borderBtn;
    this.borderBtn.value = '#000000';
    (
      styleTypeDiv.firstElementChild.lastElementChild
        .lastElementChild as HTMLElement
    ).style.width = '30px';
    (
      styleTypeDiv.firstElementChild.lastElementChild.firstElementChild
        .firstElementChild as HTMLElement
    ).style.width = '100%';
    classList(
      styleTypeDiv.lastElementChild.lastElementChild.lastElementChild
        .firstChild as HTMLElement,
      ['e-de-ctnr-highlightcolor'],
      ['e-caret']
    );
    this.borderSizeButton = createElement('button', {
      id: this.elementId + '_tableBorderSize',
      className: 'e-de-border-size-button',
      styles: 'font-size:10px;padding:0px;',
      attrs: { type: 'button' },
    });
    styleTypeDiv.appendChild(this.borderSizeButton);
    this.borderSize = this.createBorderSizeDropDown(
      'e-de-ctnr-strokesize e-icons',
      this.borderSizeButton
    );
    parentDiv.appendChild(styleTypeDiv);
    this.borderSizeColorElement =
      document.getElementsByClassName('e-de-border-width');
    this.borderStyleDiv.appendChild(parentDiv);
  }
  private initCellDiv(): void {
    const cellDiv: HTMLElement = createElement('div', {
      className: 'e-de-property-div-padding',
    });
    ...
    const btnStyle: string = '';
    this.horizontalMerge = this.createButtonTemplate(
      this.elementId + '_tableOutlineBorder',
      'e-de-ctnr-mergecell e-icons',
      parentDiv,
      'e-de-prop-font-button',
      btnStyle,
      this.localObj.getConstant('Merge cells')
    );
  ...
  private initInsertOrDelCell(): void {
    const tableOperationDiv: HTMLElement = createElement('div', {
      className: 'e-de-property-div-padding',
    });
    ...
    const parentDiv: HTMLElement = createElement('div', {
      className: 'e-de-insert-del-cell',
      styles: 'display:inline-flex',
    });
    const div1: HTMLElement = createElement('div', {
      className: this.groupButtonClass,
    });
    ...
    const btnStyle: string = '';
    this.insertColumnLeft = this.createButtonTemplate(
      this.elementId + '_insertColumnLeft',
      'e-de-ctnr-insertleft e-icons',
      div1,
      'e-de-prop-font-button',
      btnStyle,
      this.localObj.getConstant('Insert columns to the left')
    );
    this.insertColumnRight = this.createButtonTemplate(
      this.elementId + '_insertColumnRight',
      'e-de-ctnr-insertright e-icons',
      div1,
      'e-de-prop-font-button',
      btnStyle,
      this.localObj.getConstant('Insert columns to the right')
    );
    this.insertRowAbove = this.createButtonTemplate(
      this.elementId + '_insertRowAbove',
      'e-de-ctnr-insertabove e-icons',
      div1,
      'e-de-prop-font-button',
      btnStyle,
      this.localObj.getConstant('Insert rows above')
    );
    this.insertRowBelow = this.createButtonTemplate(
      this.elementId + '_insertRowBelow',
      'e-de-ctnr-insertbelow e-icons',
      div1,
      'e-de-prop-font-button',
      btnStyle,
      this.localObj.getConstant('Insert rows below')
    );
    this.deleteRow = this.createButtonTemplate(
      this.elementId + '_deleteRow',
      'e-de-ctnr-deleterows e-icons',
      div2,
      'e-de-prop-font-button',
      btnStyle,
      this.localObj.getConstant('Delete rows')
    );
    this.deleteColumn = this.createButtonTemplate(
      this.elementId + '_deleteColumn',
      'e-de-ctnr-deletecolumns e-icons',
      div2,
      'e-de-prop-font-button',
      btnStyle,
      this.localObj.getConstant('Delete columns')
    );
    tableOperationDiv.appendChild(parentDiv);
  }
  private initCellMargin(): void {
    const cellMarginDiv: HTMLElement = createElement('div', {
      className: 'e-de-property-div-padding e-de-cellmargin-text',
    });
    ...
    this.topMargin = this.createCellMarginTextBox(
      this.localObj.getConstant('Top'),
      this.elementId + '_topMargin',
      parentDiv,
      textboxDivStyle,
      textboxParentDivStyle,
      500,
      this.localObj.getConstant('Top margin')
    );
    this.bottomMargin = this.createCellMarginTextBox(
      this.localObj.getConstant('Bottom'),
      this.elementId + '_bottomMargin',
      parentDiv,
      textboxDivStyle,
      textboxParentDivStyle,
      500,
      this.localObj.getConstant('Bottom margin')
    );
    this.leftMargin = this.createCellMarginTextBox(
      this.localObj.getConstant('Left'),
      this.elementId + '_leftMargin',
      parentDiv,
      textboxDivStyle,
      textboxParentDivStyle,
      500,
      this.localObj.getConstant('Left margin')
    );
    this.rightMargin = this.createCellMarginTextBox(
      this.localObj.getConstant('Right'),
      this.elementId + '_rightMargin',
      parentDiv,
      textboxDivStyle,
      textboxParentDivStyle,
      500,
      this.localObj.getConstant('Right margin'),
      true
    );
    cellMarginDiv.appendChild(parentDiv);
  }
  private initAlignText(): void {
    const alignmentDiv: HTMLElement = createElement('div', {
      className: 'e-de-property-div-padding',
    ...
    const btnStyle: string = '';
    this.alignTop = this.createButtonTemplate(
      this.elementId + '_alignTop',
      'e-de-ctnr-aligntop e-icons',
      div,
      'e-de-prop-font-button',
      btnStyle,
      this.localObj.getConstant('Align top')
    );
    ...
    this.alignBottom = this.createButtonTemplate(
      this.elementId + '_alignBottom',
      'e-de-ctnr-alignbottom e-icons',
      div,
      'e-de-prop-font-button',
      btnStyle,
      this.localObj.getConstant('Align bottom')
    );
    ...
    this.alignCenterHorizontal = this.createButtonTemplate(
      this.elementId + '_alignCenterHorizontal',
      'e-de-ctnr-aligncenter-table e-icons',
      div,
      'e-de-prop-font-button',
      btnStyle,
      this.localObj.getConstant('Align center')
    );
    this.alignCenterHorizontal.addEventListener(
      'click',
      this.applyAlignCenterHorizontal.bind(this)
    );
  ...
  private createCellMarginTextBox(
    ...
    const cellMarginLabel: HTMLElement = createElement('label', {
      className: 'e-de-prop-sub-label',
    });
    cellMarginLabel.textContent = textboxLabel;
    cellMarginParentDiv.appendChild(cellMarginLabel);
    const cellMarginTextbox: HTMLInputElement = createElement('input', {
      className: 'e-textbox',
      id: textboxId,
      styles: styles,
    }) as HTMLInputElement;
    cellMarginParentDiv.appendChild(cellMarginTextbox);
    const cellMarginNumericText: NumericTextBox = new NumericTextBox(
      {
  ...
  private createBorderSizeDropDown(
    ...
    const noneOption: HTMLElement = this.createDropdownOption(
      ulTag,
      this.localObj.getConstant('No Border')
    );
    noneOption.addEventListener('click', (): void => {
      this.onBorderSizeChange('No Border');
    });
    const pixel: string = this.localObj.getConstant('px');
    const quaterOption: HTMLElement = this.createDropdownOption(
      ulTag,
      '.25' + pixel
    );
    ...
    const halfOption: HTMLElement = this.createDropdownOption(
      ulTag,
      '.5' + pixel
    );
    ...
    const threeQuatersOption: HTMLElement = this.createDropdownOption(
      ulTag,
      '.75' + pixel
    );
    ...
    const oneOption: HTMLElement = this.createDropdownOption(
      ulTag,
      '1' + pixel
    );
    ...
    const oneHalfOption: HTMLElement = this.createDropdownOption(
      ulTag,
      '1.5' + pixel
    );
    ...
    const twoOption: HTMLElement = this.createDropdownOption(
      ulTag,
      '2' + pixel
    );
    ...
    const threeOption: HTMLElement = this.createDropdownOption(
      ulTag,
      '3' + pixel
    );
    ...
    const fourOption: HTMLElement = this.createDropdownOption(
      ulTag,
      '4' + pixel
    );
    ...
    const fiveOption: HTMLElement = this.createDropdownOption(
      ulTag,
      '5' + pixel
    );
    ...
    const sixOption: HTMLElement = this.createDropdownOption(
      ulTag,
      '6' + pixel
    );
    ...
    dropdown.beforeOpen = (): void => {
      ...
      for (let i: number = 0; i < this.borderSizeColorElement.length; i++) {
        (
          this.borderSizeColorElement[parseInt(i.toString(), 10)] as HTMLElement
    ...
    dropdown.element.setAttribute(
      'title',
      this.localObj.getConstant('Border width')
    );
    return dropdown;
  }
  ...
  private createDropdownOption(ulTag: HTMLElement, text: string): HTMLElement {
    const liTag: HTMLElement = createElement('li', {
      ...
      className:
        'e-de-floating-menuitem e-de-floating-menuitem-md e-de-list-items  e-de-list-item-size',
    });
    ...
    if (text === 'No Border') {
      ...
      innerHTML =
        '<div>' +
        text +
        '<span class="e-de-list-line e-de-border-width"  style="margin-left:10px;border-bottom-width:' +
        text +
        ';' +
        '"' +
        '></span></div>';
      ...
      innerHTML =
        '<div>' +
        text +
        '<span class="e-de-list-line e-de-border-width" style="margin-left:20px;border-bottom-width:' +
        text +
        ';' +
        '"' +
        '></span></div>';
  ...
  private createButtonTemplate(
    ...
    const btn: Button = new Button({
      ...
      iconCss: iconcss,
      enableRtl: this.isRtl,
      iconPosition: iconPos ? (iconPos as IconPosition) : 'Left',
  ...
  private createColorPickerTemplate(
    ...
    const {
      ...
      presetColors,
      showButtons,
    } = this.documentEditor.documentEditorSettings.colorPickerSettings;
  ...
  public showTableProperties(isShow: boolean, propertyType: string): void {
    ...
    if (
      (!isShow && this.parentElement.style.display === 'none') ||
      (isShow && this.parentElement.style.display === 'block')
    ) {
      return;
    }
  ...
  public updateTabContainerHeight(): void {
    if (this.parentElement && this.parentElement.style.display === 'block') {
      const tabHeaderHeight: HTMLElement =
        this.parentElement.getElementsByClassName(
          'e-tab-header'
        )[0] as HTMLElement;
      if (tabHeaderHeight) {
        const paneHeight: number =
          this.parentElement.offsetHeight - tabHeaderHeight.offsetHeight;
