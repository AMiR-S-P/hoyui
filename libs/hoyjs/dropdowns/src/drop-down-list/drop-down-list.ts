...
import { IInput, Input, InputObject, FloatLabelType } from '@hoyui/inputs';
import {
  incrementalSearch,
  resetIncrementalSearchValues,
} from '../common/incremental-search';
import {
  DropDownBase,
  dropDownBaseClasses,
  SelectEventArgs,
...
import { DataManager, Query, Predicate, DataOptions } from '@hoyui/data';
...
export class DropDownList extends DropDownBase implements IInput {
  ...
  protected renderList(
    e?: MouseEvent | KeyboardEventArgs | TouchEvent,
    isEmptyData?: boolean
  ): void {
  ...
  private floatLabelChange(): void {
    if (
      ...
      const floatElement: HTMLElement = <HTMLElement>(
        this.inputWrapper.container.querySelector('.e-float-text')
      );
  ...
  protected resetFocusElement(): void {
    ...
    if (
      ...
      let li: Element = this.fields.disabled
        ? this.ulElement.querySelector(
            '.' + dropDownListClasses.li + ':not(.e-disabled)'
          )
        : this.ulElement.querySelector('.' + dropDownListClasses.li);
      if (this.enableVirtualization) {
  ...
  protected clearAll(
    e?: MouseEvent | KeyboardEventArgs | TouchEvent,
    properties?: DropDownListModel
  ): void {
    this.previousItemData = !isNullOrUndefined(this.itemData)
      ? this.itemData
      : null;
    if (
      ...
      (!isNullOrUndefined(properties) &&
        (isNullOrUndefined(properties.dataSource) ||
          (!(properties.dataSource instanceof DataManager) &&
    ...
    if (
      (!this.allowObjectBinding && this.previousValue === dataItem.value) ||
      (this.allowObjectBinding &&
        this.previousValue &&
        this.isObjectInArray(this.previousValue, [
          (this as any).allowCustom
            ? this.value
              ? this.value
              : dataItem
            : dataItem.value
    ...
    if (this.list) {
      if (
        ...
        if (
          this.allowFiltering &&
          this.getModuleName() !== 'autocomplete' &&
          !isNullOrUndefined(this.actionCompleteData.ulElement) &&
          !isNullOrUndefined(this.actionCompleteData.list) &&
          this.actionCompleteData.list.length > 0
        ) {
          this.onActionComplete(
            this.actionCompleteData.ulElement.cloneNode(true) as HTMLElement,
            this.actionCompleteData.list
          );
        }
    ...
    if (Object.keys(this.htmlAttributes).length) {
      for (const htmlAttr of Object.keys(this.htmlAttributes)) {
        if (htmlAttr === 'class') {
          ...
          htmlAttr === 'disabled' &&
          this.htmlAttributes[`${htmlAttr}`] === 'disabled'
        ) {
          this.enabled = false;
          this.setEnable();
        } else if (
          htmlAttr === 'readonly' &&
          !isNullOrUndefined(this.htmlAttributes[`${htmlAttr}`])
        ) {
          this.readonly = true;
          this.dataBind();
        } else if (htmlAttr === 'style') {
          this.inputWrapper.container.setAttribute(
            'style',
  ...
  protected targetElement(): HTMLElement | HTMLInputElement {
    return !isNullOrUndefined(this.inputWrapper)
      ? this.inputWrapper.container
      : null;
  }
   ...
   */
  protected isDisableItemValue(
    value: string | number | boolean | object
  ): boolean {
    if (typeof value === 'object') {
      const objectValue: string | number | boolean = JSON.parse(
  ...
  protected updateValues(): void {
    if (this.fields.disabled) {
      ...
      if (this.text != null) {
        this.text = !this.isDisabledItemByIndex(
      ...
      if (this.index != null) {
        this.index = !this.isDisabledItemByIndex(this.index)
          ? this.index
          : null;
        this.activeIndex = this.index;
      }
    ...
    if (!isNullOrUndefined(this.value)) {
      const value: string | number | boolean =
        this.allowObjectBinding && !isNullOrUndefined(this.value)
          ? getValue(this.fields.value ? this.fields.value : '', this.value)
          : this.value;
  ...
  protected onBlurHandler(e: MouseEvent): void {
    ...
    if (
      isPreventBlur &&
      !this.isDocumentClick &&
      this.isPopupOpen &&
      (!isNullOrUndefined(currentTarget) ||
    ...
    if (
      ...
      (!isNullOrUndefined(this.popupObj) &&
        ...
        this.popupObj.element.classList.contains(
          dropDownListClasses.mobileFilter
        ))
    ) {
        ...
        (document.activeElement !== target ||
          (document.activeElement === target &&
            currentTarget.classList.contains(
              dropDownListClasses.inputFocus
            )))) ||
      (isNullOrUndefined(target) &&
        this.getModuleName() === 'dropdownlist' &&
        this.allowFiltering &&
        currentTarget !== this.inputWrapper.container) ||
      (this.getModuleName() !== 'dropdownlist' &&
        !this.inputWrapper.container.contains(target)) ||
      this.isTabKey
    ) {
  ...
  protected onFocusOut(e?: MouseEvent | KeyboardEventArgs): void {
    ...
    if (this.inputWrapper.clearButton) {
      addClass(
        ...
        dropDownListClasses.clearIconHide
      );
    }
    this.trigger('blur');
  }
  ...
  protected unBindCommonEvent(): void {
    ...
    const formElement: HTMLFormElement =
      this.inputElement &&
      (closest(this.inputElement, 'form') as HTMLFormElement);
    if (formElement) {
  ...
  private onServerIncrementalSearch(e: KeyboardEventArgs): void {
    if (
      !this.isRequested &&
      !isNullOrUndefined(this.list) &&
      !isNullOrUndefined(this.list.querySelector('li')) &&
      this.enabled &&
      !this.readonly
    ) {
  ...
  private onMouseOver(e: MouseEvent): void {
    const currentLi: HTMLElement = <HTMLElement>(
  ...
  private setHover(li: HTMLElement): void {
    if (
      this.enabled &&
      this.isValidLI(li) &&
      !li.classList.contains(dropDownBaseClasses.hover)
    ) {
      this.removeHover();
  ...
  protected isValidLI(li: Element | HTMLElement): boolean {
    return (
      li && li.hasAttribute('role') && li.getAttribute('role') === 'option'
    );
  }

  protected updateIncrementalItemIndex(
    startIndex: number,
    endIndex: number
  ): void {
    ...
    if (this.liCollections.length > 0) {
      if (this.enableVirtualization) {
        ...
        const activeElement: Element =
          this.ulElement.getElementsByClassName('e-active')[0];
        const currentValue: string = activeElement
        ...
        if (this.incrementalQueryString === '') {
          ...
          String.fromCharCode(e.charCode).toLocaleLowerCase() ===
          this.incrementalPreQueryString.toLocaleLowerCase()
        ) {
        ...
        let li: Element = incrementalSearch(
          e.charCode,
        ...
        while (
          ...
          this.updateIncrementalItemIndex(
            this.incrementalEndIndex,
            this.incrementalEndIndex + 100 > this.totalItemCount
              ? this.totalItemCount
              : this.incrementalEndIndex + 100
        ...
        let index: number =
          li && this.getIndexByValue(li.getAttribute('data-value'));
        if (!index) {
          for (
            let i: number = 0;
            i < this.incrementalLiCollections.length;
            i++
          ) {
            if (
              !isNullOrUndefined(li) &&
              !isNullOrUndefined(li.getAttribute('data-value')) &&
              this.incrementalLiCollections[i as number].getAttribute(
                'data-value'
              ) === li.getAttribute('data-value').toString()
            ) {
              index = i;
        ...
        if (index) {
          if (
            !(this.viewPortInfo.startIndex >= index) ||
            !(index >= this.viewPortInfo.endIndex)
          ) {
            const startIndex: number =
              index - (this.itemCount / 2 - 2) > 0
                ? index - (this.itemCount / 2 - 2)
                : 0;
        ...
        if (!isNullOrUndefined(li)) {
          const index: number =
            this.getIndexByValue(li.getAttribute('data-value')) -
            this.skeletonCount;
            ...
            const selectedLiOffsetTop: number =
              this.virtualListInfo && this.virtualListInfo.startIndex
                ? this.selectedLI.offsetTop +
                  this.virtualListInfo.startIndex * this.selectedLI.offsetHeight
                : this.selectedLI.offsetTop;
            this.list.scrollTop =
              selectedLiOffsetTop -
              this.list.querySelectorAll('.e-virtual-list').length *
                this.selectedLI.offsetHeight;
          }
          this.incrementalPreQueryString = this.incrementalQueryString;
        } else {
          this.updateIncrementalView(0, this.itemCount);
        ...
        if (this.fields.disabled) {
          ...
          >this.list.querySelectorAll(
            '.' + dropDownBaseClasses.li + ':not(.e-disabled)'
          );
          li = incrementalSearch(
            e.charCode,
            enableLiCollections,
  ...
  public showSpinner(): void {
    if (isNullOrUndefined(this.spinnerElement)) {
      this.spinnerElement =
        (Browser.isDevice &&
          !isNullOrUndefined(this.filterInputObj) &&
          this.filterInputObj.buttons[1]) ||
        (!isNullOrUndefined(this.filterInputObj) &&
          this.filterInputObj.buttons[0]) ||
  ...
  protected keyActionHandler(e: KeyboardEventArgs): void {
    ...
    const preventAction: boolean =
      e.action === 'pageUp' || e.action === 'pageDown';
    const preventHomeEnd: boolean =
      this.getModuleName() !== 'dropdownlist' &&
    ...
    const isNavigation: boolean =
      ...
      e.action === 'end';
    if (
      (this.isEditTextBox() || preventAction || preventHomeEnd) &&
      !this.isPopupOpen
    ) {
      return;
    }
    if (!this.readonly) {
      ...
      this.isTyped =
        isNavigation || e.action === 'escape' ? false : this.isTyped;
      switch (e.action) {
        case 'down':
        case 'up':
  ...
  private updateUpDownAction(
    e: KeyboardEventArgs,
    isVirtualKeyAction?: boolean
  ): void {
    if (
      this.fields.disabled &&
      this.list &&
      this.list.querySelectorAll('.e-list-item:not(.e-disabled)').length === 0
    ) {
      return;
    }
    if (
    ...
    const focusEle: Element = this.list.querySelector(
      '.' + dropDownListClasses.focus
    );
    if (this.isSelectFocusItem(focusEle) && !isVirtualKeyAction) {
      this.setSelection(focusEle, e);
      if (this.enableVirtualization) {
        let selectedLiOffsetTop: number =
          this.virtualListInfo && this.virtualListInfo.startIndex
            ? this.selectedLI.offsetTop +
              this.virtualListInfo.startIndex * this.selectedLI.offsetHeight
            : this.selectedLI.offsetTop;
        if (this.fields.groupBy) {
          selectedLiOffsetTop =
            this.virtualListInfo && this.virtualListInfo.startIndex === 0
              ? this.selectedLI.offsetHeight - selectedLiOffsetTop
              : selectedLiOffsetTop - this.selectedLI.offsetHeight;
        }
        this.list.scrollTop =
          selectedLiOffsetTop -
          this.list.querySelectorAll('.e-virtual-list').length *
      ...
      let index: number =
        e.action === 'down' ? this.activeIndex + 1 : this.activeIndex - 1;
      index = isVirtualKeyAction ? virtualIndex : index;
      let startIndex: number = 0;
      if (this.getModuleName() === 'autocomplete') {
        startIndex =
          e.action === 'down' && isNullOrUndefined(this.activeIndex)
            ? 0
      ...
      if (
        this.getModuleName() !== 'autocomplete' ||
        (this.getModuleName() === 'autocomplete' && this.isPopupOpen)
      ) {
        if (!this.enableVirtualization) {
          nextItem = isNullOrUndefined(this.activeIndex)
            ? this.liCollections[startIndex as number]
          ...
          if (!isVirtualKeyAction) {
            nextItem = isNullOrUndefined(this.activeIndex)
              ...
              : this.liCollections[index as number];
            nextItem =
              !isNullOrUndefined(nextItem) &&
              !nextItem.classList.contains('e-virtual-list')
                ? nextItem
                : null;
          } else {
            if (this.getModuleName() === 'autocomplete') {
              const value: string | number | boolean = this.getFormattedValue(
                this.selectedLI.getAttribute('data-value')
              );
      ...
      if (!isNullOrUndefined(nextItem)) {
        const focusAtFirstElement: boolean =
          this.liCollections[this.skeletonCount] &&
          this.liCollections[this.skeletonCount].classList.contains(
            'e-item-focus'
          );
        ...
        if (
          ...
          selectedLiOffsetTop =
            ...
            this.virtualListInfo.startIndex === 0 &&
            this.fields.groupBy
              ? this.selectedLI.offsetHeight - selectedLiOffsetTop
              : selectedLiOffsetTop - this.selectedLI.offsetHeight;
          this.list.scrollTop =
        ...
        ((this.viewPortInfo.endIndex !== this.totalItemCount &&
          e.action === 'down') ||
          (this.viewPortInfo.startIndex !== 0 && e.action === 'up'))
      ) {
        if (e.action === 'down') {
          this.viewPortInfo.startIndex =
            this.viewPortInfo.startIndex + this.itemCount <
          ...
          this.isCustomFilter =
            this.getModuleName() === 'combobox' ? true : this.isCustomFilter;
          this.resetList(this.dataSource, this.fields, this.query);
          this.isCustomFilter =
            this.getModuleName() === 'combobox' ? false : this.isCustomFilter;
          const value: string | number | boolean =
            this.liCollections[0].getAttribute('data-value') !== 'null'
              ? this.getFormattedValue(
                  this.liCollections[0].getAttribute('data-value')
                )
              : null;
          const selectedData:
            | string
          ...
          this.isCustomFilter =
            this.getModuleName() === 'combobox' ? false : this.isCustomFilter;
          const value: string | number | boolean =
            this.liCollections[this.liCollections.length - 1].getAttribute(
              'data-value'
            ) !== 'null'
              ? this.getFormattedValue(
                  this.liCollections[
    ...
    if (
      ...
      const filterIndex: number = this.getIndexByValueFilter(
        value,
    ...
    if (
      ...
      if (
        ...
        !isNullOrUndefined(this.ulElement) &&
        !isNullOrUndefined(this.ulElement.getElementsByClassName('e-active')[0])
      ) {
        attributes(this.filterInput, {
          'aria-activedescendant':
            this.ulElement.getElementsByClassName('e-active')[0].id,
        });
      }
    }
    ...
    for (let index: number = 0; index < this.liCollections.length; index++) {
      if (
        this.liCollections[index as number].classList.contains(
          dropDownListClasses.focus
        ) ||
        this.liCollections[index as number].classList.contains(
          dropDownListClasses.selected
        )
      ) {
        itemIndex = index;
        break;
    ...
    if (
      itemIndex != null &&
      this.isDisabledElement(
        this.liCollections[itemIndex as number] as HTMLElement
      )
    ) {
      if (this.getModuleName() !== 'autocomplete') {
        if (
          this.liCollections.length - 1 === itemIndex &&
          e.action === 'down'
        ) {
          e.action = 'up';
        }
  ...
  protected handleVirtualKeyboardActions(
    ...
    switch (e.action) {
      ...
      case 'pageUp':
        this.activeIndex =
          this.getModuleName() === 'autocomplete'
            ? this.getIndexByValue(this.selectedLI.getAttribute('data-value')) +
              this.getPageCount() -
              1
        ...
        this.activeIndex =
          this.getModuleName() === 'autocomplete'
            ? this.getIndexByValue(this.selectedLI.getAttribute('data-value')) -
              this.getPageCount()
            : this.getIndexByValue(this.previousValue);
        this.pageDownSelection(
          !isNullOrUndefined(this.activeIndex)
            ? this.activeIndex + this.getPageCount()
            : 2 * this.getPageCount(),
          e,
          true
        );
  ...
  protected selectCurrentItem(e: KeyboardEventArgs): void {
    if (this.isPopupOpen) {
      const li: Element = this.list.querySelector(
        '.' + dropDownListClasses.focus
      );
  ...
  private pageUpSelection(
    ...
    let previousItem: Element =
      steps >= 0 ? this.liCollections[steps + 1] : this.liCollections[0];
    if (this.enableVirtualization && this.activeIndex == null) {
      previousItem =
        this.liCollections.length >= steps && steps >= 0
          ? this.liCollections[steps + this.skeletonCount + 1]
          : this.liCollections[0];
    }
    if (
  ...
  private PageUpDownSelection(
    ...
    if (this.enableVirtualization) {
      if (
        !isNullOrUndefined(previousItem) &&
        ((this.getModuleName() !== 'autocomplete' &&
          !previousItem.classList.contains('e-active')) ||
          (this.getModuleName() === 'autocomplete' &&
  ...
  protected onDocumentClick(e: MouseEvent): void {
    ...
    if (
      ...
      !isNullOrUndefined(this.inputWrapper) &&
      !this.inputWrapper.container.contains(e.target as Node)
    ) {
      if (
        this.inputWrapper.container.classList.contains(
          dropDownListClasses.inputFocus
        ) ||
        this.isPopupOpen
      ) {
        ...
        if (!isActive) {
          this.onFocusOut(e);
          this.inputWrapper.container.classList.remove(
            dropDownListClasses.inputFocus
          );
        }
      }
      ...
      target !== this.inputElement &&
      !(this.allowFiltering && target === this.filterInput) &&
      !(
        this.getModuleName() === 'combobox' &&
        !this.allowFiltering &&
        Browser.isDevice &&
        target === this.inputWrapper.buttons[0]
      )
    ) {
      this.isPreventBlur =
  ...
  protected dropDownClick(e: MouseEvent): void {
    ...
    this.keyboardEvent = null;
    if (
      this.targetElement().classList.contains(dropDownListClasses.disable) ||
      this.inputWrapper.clearButton === e.target
    ) {
      return;
    }
    const target: HTMLElement = <HTMLElement>e.target;
    ...
    if (!this.readonly) {
      ...
      const duration: number =
        this.element.tagName === this.getNgDirective() && this.itemTemplate
          ? 500
          : 100;
  ...
  protected updateSelectedItem(
    ...
    const value: string | number | boolean =
      li.getAttribute('data-value') !== null
        ? this.getFormattedValue(li.getAttribute('data-value'))
        : null;
    const selectedData:
      | string
      | number
  ...
  private selectEventCallback(
    ...
    if (this.itemData !== selectedData) {
      this.previousValue = !isNullOrUndefined(this.itemData)
        ? typeof this.itemData == 'object' && !this.allowObjectBinding
          ? this.checkFieldValue(
              this.itemData as any,
  ...
  protected setValue(e?: KeyboardEventArgs): boolean {
    ...
    if (this.valueTemplate && this.itemData !== null) {
      ...
      !isNullOrUndefined(this.valueTempElement) &&
      this.inputElement.previousSibling === this.valueTempElement
    ) {
      detach(this.valueTempElement);
      this.inputElement.style.display = 'block';
    }
    if (
      !isNullOrUndefined(dataItem.value) &&
      !this.enableVirtualization &&
      this.allowFiltering
    ) {
      this.activeIndex = this.getIndexByValueFilter(
        dataItem.value,
        this.actionCompleteData.ulElement
      );
    }
    const clearIcon: string = dropDownListClasses.clearIcon;
    const isFilterElement: boolean =
      this.isFiltering() &&
      this.filterInput &&
      this.getModuleName() === 'combobox';
    const clearElement: HTMLElement =
      isFilterElement &&
      this.filterInput.parentElement.querySelector('.' + clearIcon);
    ...
    if (
      ...
      (this.allowObjectBinding &&
        this.previousValue != null &&
        this.isObjectInArray(this.previousValue, [
          (this as any).allowCustom && this.isObjectCustomValue
            ? this.value
              ? this.value
              : dataItem
            : dataItem.value
  ...
  protected setSelection(
    ...
    if (
      ...
      if (this.enableVirtualization && this.value) {
        ...
        const currentValue: string | number | boolean =
          this.allowObjectBinding && !isNullOrUndefined(this.value)
            ? getValue(this.fields.value ? this.fields.value : '', this.value)
            : this.value;
        if (this.dataSource instanceof DataManager) {
  ...
  private setSelectOptions(
    li: Element,
    e?: MouseEvent | KeyboardEventArgs | KeyboardEvent | TouchEvent
  ): void {
    if (this.list) {
      this.removeHover();
    }
    this.previousSelectedLI = !isNullOrUndefined(this.selectedLI)
      ? this.selectedLI
      : null;
    ...
    if (
      (!this.isPopupOpen && !isNullOrUndefined(li)) ||
      (this.isPopupOpen &&
        !isNullOrUndefined(e) &&
        (e.type !== 'keydown' ||
          (e.type === 'keydown' &&
            (e as KeyboardEventArgs).action === 'enter')))
    ) {
      this.isSelectCustom = false;
      this.onChangeEvent(e);
    }
    if (
      this.isPopupOpen &&
      !isNullOrUndefined(this.selectedLI) &&
      this.itemData !== null &&
      (!e || e.type !== 'click')
    ) {
  ...
  private dropdownCompiler(dropdownTemplate: string | Function): boolean {
    ...
    if (typeof dropdownTemplate !== 'function' && dropdownTemplate) {
      try {
        checkTemplate = document.querySelectorAll(dropdownTemplate).length
          ? true
          : false;
      } catch (exception) {
        checkTemplate = false;
  ...
  private setValueTemplate(): void {
    ...
    if (typeof this.valueTemplate !== 'function' && valuecheck) {
      compiledString = compile(
        document.querySelector(this.valueTemplate).innerHTML.trim()
      );
    } else {
  ...
  protected getItemData(): { [key: string]: string } {
    ...
    const value: string = <string>(
      (!isNullOrUndefined(dataItem) && !isUndefined(dataValue)
        ? dataValue
        : dataItem)
    );
  ...
  protected onChangeEvent(
    eve: MouseEvent | KeyboardEvent | TouchEvent,
    ...
    if (this.enableVirtualization) {
      ...
      if (dataItem.value && datas && datas.length > 0) {
        const foundIndex: number = datas.findIndex(
          (data: any) =>
            !isNullOrUndefined(dataItem.value) &&
            getValue(this.fields.value, data) === dataItem.value
        );
        if (foundIndex !== -1) {
          index = foundIndex;
        }
  ...
  protected detachChangeEvent(
    eve: MouseEvent | KeyboardEvent | TouchEvent
  ): void {
    this.isSelected = false;
    this.previousValue = this.value;
    this.activeIndex = this.enableVirtualization
      ? this.getIndexByValue(this.value)
      : this.index;
    ...
    if (!this.initial) {
      ...
      if (
        typeof this.previousItemData === 'string' ||
    ...
    if (
      (isNullOrUndefined(this.value) || this.value === '') &&
  ...
  protected setHiddenValue(): void {
    if (!isNullOrUndefined(this.value)) {
      ...
      if (this.hiddenElement.querySelector('option')) {
        const selectedElement: HTMLElement =
          this.hiddenElement.querySelector('option');
  ...
  protected onFilterUp(e: KeyboardEventArgs): void {
    if (
      ...
      (this.isValidKey || e.keyCode === 40 || e.keyCode === 38)
    ) {
      this.isValidKey = false;
      this.firstItem =
      ...
      switch (e.keyCode) {
        ...
        case 8: //backspace
          ...
          if (
            (!this.isPopupOpen && this.typedString !== '') ||
            (this.isPopupOpen && this.queryString.length > 0)
          ) {
            this.preventAutoFill = true;
            this.searchLists(e);
          } else if (
  ...
  protected getQuery(query: Query): Query {
    ...
    if (!this.isCustomFilter && this.allowFiltering && this.filterInput) {
      ...
      const filterType: string =
        this.typedString === '' ? 'contains' : this.filterType;
      const dataType: string = <string>(
        this.typeOfData(this.dataSource as { [key: string]: Object }[]).typeof
      );
      if (
        (!(this.dataSource instanceof DataManager) && dataType === 'string') ||
        dataType === 'number'
      ) {
        filterQuery.where(
          '',
      ...
      filterQuery =
        this.enableVirtualization && !isNullOrUndefined(this.customFilterQuery)
          ? this.customFilterQuery.clone()
          : query
          ? query.clone()
          : this.query
          ? this.query.clone()
    ...
    if (this.enableVirtualization && this.viewPortInfo.endIndex !== 0) {
      ...
      if (
        !skipExists &&
        (this.allowFiltering || !this.isPopupOpen || !alreadySkipAdded)
      ) {
        if (querySkipValue > 0) {
  ...
  protected searchLists(e: KeyboardEventArgs | MouseEvent): void {
    ...
    if (
      this.filterInput.parentElement.querySelector(
        '.' + dropDownListClasses.clearIcon
      )
    ) {
      ...
      clearElement.style.visibility =
        this.filterInput.value === '' ? 'hidden' : 'visible';
    }
    ...
    if (this.isFiltering()) {
      ...
      this.trigger('filtering', eventArgs, (eventArgs: FilteringEventArgs) => {
        if (
          !eventArgs.cancel &&
          !this.isCustomFilter &&
          !eventArgs.preventDefaultAction
        ) {
          ...
          if (this.enableVirtualization) {
            ...
            if (
              ...
              if (!this.list.querySelector('.e-virtual-ddl')) {
                ...
                document
                  .getElementsByClassName('e-popup')[0]
  ...
  protected setSearchBox(popupElement: HTMLElement): InputObject {
    if (this.isFiltering()) {
      const parentElement: HTMLElement = popupElement.querySelector(
        '.' + dropDownListClasses.filterParent
      )
        ? popupElement.querySelector('.' + dropDownListClasses.filterParent)
      ...
      this.clearIconElement = this.filterInput.parentElement.querySelector(
        '.' + dropDownListClasses.clearIcon
      );
  ...
  protected onActionComplete(
    ...
    if (this.isActive || !isNullOrUndefined(ulElement)) {
      const selectedItem: HTMLElement = this.selectedLI
        ? <HTMLElement>this.selectedLI.cloneNode(true)
        : null;
      ...
      if (
        ...
        this.searchKeyEvent.type === 'keydown'
      ) {
      ...
      if (this.initialRemoteRender) {
        ...
        if (this.value && this.dataSource instanceof DataManager) {
          const checkField: string = isNullOrUndefined(this.fields.value)
            ? this.fields.text
            : this.fields.value;
          const value: string | number | boolean =
            this.allowObjectBinding && !isNullOrUndefined(this.value)
              ? getValue(checkField, this.value)
              : this.value;
          const fieldValue: string[] = this.fields.value.split('.');
          let checkVal: boolean = list.some(
            (x: { [key: string]: boolean | string | number }) =>
              isNullOrUndefined(x[checkField as string]) &&
              fieldValue.length > 1
                ? this.checkFieldValue(x, fieldValue) === value
                : x[checkField as string] === value
          );
          if (this.enableVirtualization && this.virtualGroupDataSource) {
            checkVal = (this.virtualGroupDataSource as any).some(
              (x: { [key: string]: boolean | string | number }) =>
                isNullOrUndefined(x[checkField as string]) &&
                fieldValue.length > 1
                  ? this.checkFieldValue(x, fieldValue) === value
          ...
          if (!checkVal) {
            this.dataSource
              .executeQuery(
                this.getQuery(this.query).where(
                  new Predicate(checkField, 'equal', value)
                )
              )
              .then((e: Object) => {
      ...
      if (
        ...
        if (
          !this.actionCompleteData.isUpdated ||
          (!this.isCustomFilter && !this.isFilterFocus) ||
          (isNullOrUndefined(this.itemData) &&
            this.allowFiltering &&
            (this.dataSource instanceof DataManager ||
              (!isNullOrUndefined(this.dataSource) &&
                !isNullOrUndefined(this.dataSource.length) &&
        ...
        if (
          ((this as any).allowCustom ||
            (this.allowFiltering &&
              !this.isValueInList(list, this.value) &&
              this.dataSource instanceof DataManager)) &&
          !this.enableVirtualization
        ) {
        ...
        // eslint-disable-next-line @typescript-eslint/no-explicit-any
          ...
          ((this as any).allowCustom ||
            (this.allowFiltering && this.isValueInList(list, this.value))) &&
          !this.enableVirtualization
        ) {
          this.addNewItem(list, selectedItem);
        }
        if (
          !isNullOrUndefined(this.itemData) ||
          (isNullOrUndefined(this.itemData) && this.enableVirtualization)
        ) {
  ...
  private checkFieldValue(
    list: { [key: string]: boolean | string | number },
    fieldValue: string[]
  ): any {
    // eslint-disable-next-line @typescript-eslint/no-explicit-any
  ...
  private updateActionCompleteDataValues(
    ...
    this.actionCompleteData = {
      ulElement: ulElement.cloneNode(true) as HTMLElement,
      list: list,
      isUpdated: true,
    };
    if (
      this.actionData.list !== this.actionCompleteData.list &&
      this.actionCompleteData.ulElement &&
      this.actionCompleteData.list
    ) {
  ...
  private addNewItem(
    ...
    if (!isNullOrUndefined(this.itemData) && !isNullOrUndefined(newElement)) {
      const value: string | number = this.getItemData().value;
      const isExist: boolean = listData.some(
  ...
  private actionCompleteDataUpdate(
    ...
    if (index !== null) {
      this.actionCompleteData.ulElement.insertBefore(
        li.cloneNode(true),
        this.actionCompleteData.ulElement.childNodes[index as number]
      );
    } else {
    ...
    if (
      this.isFiltering() &&
      this.actionCompleteData.list &&
      this.actionCompleteData.list.indexOf(item) < 0
    ) {
  ...
  private focusIndexItem(): void {
    const value: string | number = this.getItemData().value;
    this.activeIndex =
      (this.enableVirtualization && !isNullOrUndefined(value)) ||
      !this.enableVirtualization
  ...
  protected updateSelection(): void {
    const selectedItem: Element = this.list.querySelector(
    ...
    if (selectedItem) {
      ...
      this.removeFocus();
      this.list
        .querySelector('.' + dropDownBaseClasses.li)
        .classList.add(dropDownListClasses.focus);
    }
  }

  private updateSelectionList(): void {
    const selectedItem: HTMLElement =
      this.list && this.list.querySelector('.' + 'e-active');
    if (!selectedItem && !isNullOrUndefined(this.value)) {
      const value: string | number | boolean = this.allowObjectBinding
        ? getValue(this.fields.value ? this.fields.value : '', this.value)
        : this.value;
      const findEle: HTMLElement = this.findListElement(
        this.list,
        'li',
        'data-value',
        value
  ...
  protected removeFocus(): void {
    const highlightedItem: Element[] = <NodeListOf<Element> & Element[]>(
      this.list.querySelectorAll('.' + dropDownListClasses.focus)
    );
    ...
    this.trigger('beforeOpen', args, (args: BeforeOpenEventArgs) => {
      if (!args.cancel) {
        const popupEle: HTMLElement = this.createElement('div', {
          id: this.element.id + '_popup',
          className:
            'e-ddl e-popup ' + (this.cssClass !== null ? this.cssClass : ''),
        });
        ...
        this.listContainerHeight =
          ...
          this.getModuleName() === 'dropdownlist' &&
          Browser.isDevice
            ? formatUnit(Math.round(window.outerHeight).toString() + 'px')
            : formatUnit(this.popupHeight);
        ...
        if (this.enableVirtualization && this.itemTemplate) {
          const listitems: NodeListOf<Element> = popupEle.querySelectorAll(
            'li.e-list-item:not(.e-virtual-list)'
          );
          this.listItemHeight =
            listitems.length > 0
              ? Math.ceil(listitems[0].getBoundingClientRect().height) +
                parseInt(window.getComputedStyle(listitems[0]).marginBottom, 10)
              : 0;
        }
        if (
          this.enableVirtualization &&
        ...
        if (this.popupHeight !== 'auto') {
          ...
          if (
            !isNullOrUndefined(searchBox.container) &&
            this.getModuleName() !== 'combobox' &&
            this.getModuleName() !== 'autocomplete'
          ) {
            this.searchBoxHeight =
              searchBox.container.parentElement.getBoundingClientRect().height;
            this.listContainerHeight =
              (
                parseInt(this.listContainerHeight, 10) - this.searchBoxHeight
              ).toString() + 'px';
          }
          if (this.headerTemplate) {
            this.header = this.header
              ? this.header
              : popupEle.querySelector('.e-ddl-header');
            const height: number = Math.round(
              this.header.getBoundingClientRect().height
            );
            this.listContainerHeight =
              (
                parseInt(this.listContainerHeight, 10) -
                (height + this.searchBoxHeight)
              ).toString() + 'px';
          }
          if (this.footerTemplate) {
            this.footer = this.footer
              ? this.footer
              : popupEle.querySelector('.e-ddl-footer');
            const height: number = Math.round(
          ...
          this.list.style.maxHeight =
            (parseInt(this.listContainerHeight, 10) - 2).toString() + 'px'; // due to box-sizing property
        ...
        if (
          ...
          const firstItem: HTMLElement = this.isEmptyList()
            ? this.list
            : this.liCollections[0];
          if (!isNullOrUndefined(this.inputElement)) {
            left = -(
              parseInt(getComputedStyle(firstItem).textIndent, 10) -
              parseInt(getComputedStyle(this.inputElement).paddingLeft, 10) +
              parseInt(
                getComputedStyle(this.inputElement.parentElement)
                  .borderLeftWidth,
                10
              )
            );
        ...
        if (Browser.isDevice) {
          if (
            parseInt(this.popupWidth.toString(), 10) > window.outerWidth &&
            !(this.getModuleName() === 'dropdownlist' && this.allowFiltering)
          ) {
          ...
          if (this.isFilterLayout() && this.isDeviceFullScreen) {
            this.popupObj.element.classList.add(
              dropDownListClasses.mobileFilter
            );
            ...
            addClass(
              ...
              dropDownListClasses.popupFullScreen
            );
            this.setSearchBoxPosition();
            this.backIconElement =
              searchBox.container.querySelector('.e-back-icon');
            this.clearIconElement = searchBox.container.querySelector(
              '.' + dropDownListClasses.clearIcon
            );
            EventHandler.add(
              this.backIconElement,
        ...
        const scrollParentElements: HTMLElement[] =
          this.popupObj.getScrollableParent(this.inputWrapper.container);
        ...
        if (
          this.getModuleName() !== 'dropdownlist' &&
          this.list.classList.contains('e-nodata')
        ) {
          attributes(this.targetElement(), {
            'aria-activedescendant': 'no-record',
          });
        ...
        this.inputElement.setAttribute(
          'aria-controls',
          this.element.id + '_popup'
        );
        const inputParent: HTMLElement = this.isFiltering()
        ...
        this.trigger('open', eventArgs, (eventArgs: PopupEventArgs) => {
          if (!eventArgs.cancel) {
            if (!isNullOrUndefined(this.inputWrapper)) {
              addClass(
                [this.inputWrapper.container],
                [dropDownListClasses.iconAnimation]
              );
            }
            this.renderReactTemplates();
            if (!isNullOrUndefined(this.popupObj)) {
              this.popupObj.show(
                new Animation(eventArgs.animation),
  ...
  private checkCollision(popupEle: HTMLElement): void {
    if (
      !Browser.isDevice ||
      (Browser.isDevice &&
        !(this.getModuleName() === 'dropdownlist' || this.isDropDownClick))
    ) {
    ...
    this.popupObj = new Popup(element, {
      ...
      close: () => {
        ...
        if (
          this.isFiltering() &&
          this.actionCompleteData.list &&
          this.actionCompleteData.list[0]
        ) {
          this.isActive = true;
          if (this.enableVirtualization) {
            this.onActionComplete(
      ...
      open: () => {
        ...
        if (
          ...
          actionList &&
          ulElement &&
          actionList.textContent !== ulElement.textContent &&
          this.element.tagName !== 'EJS-COMBOBOX'
        ) {
          this.cloneElements();
        }
  ...
  private scrollHandler(): void {
    if (
      Browser.isDevice &&
      ((this.getModuleName() === 'dropdownlist' && !this.isFilterLayout()) ||
        (this.getModuleName() === 'combobox' &&
          !this.allowFiltering &&
          this.isDropDownClick))
    ) {
  ...
  private setSearchBoxPosition(): void {
    const searchBoxHeight: number =
      this.filterInput.parentElement.getBoundingClientRect().height;
    this.popupObj.element.style.maxHeight = '100%';
    this.popupObj.element.style.width = '100%';
    this.list.style.maxHeight = window.innerHeight - searchBoxHeight + 'px';
    this.list.style.height = window.innerHeight - searchBoxHeight + 'px';
    const clearElement: Element = this.filterInput.parentElement.querySelector(
      '.' + dropDownListClasses.clearIcon
    );
  ...
  private setPopupPosition(border?: number): number {
    ...
    const selectedLI: HTMLElement =
      <HTMLElement>this.list.querySelector('.' + dropDownListClasses.focus) ||
      this.selectedLI;
    const firstItem: HTMLElement = this.isEmptyList()
      ? this.list
      : this.liCollections[0];
    const lastItem: HTMLElement = this.isEmptyList()
      ? this.list
      : this.liCollections[this.getItems().length - 1];
    const liHeight: number = firstItem.getBoundingClientRect().height;
    this.listItemHeight =
      liHeight + parseInt(window.getComputedStyle(firstItem).marginBottom, 10);
    const listHeight: number = this.list.offsetHeight / 2;
    const height: number = isNullOrUndefined(selectedLI)
      ? firstItem.offsetTop
      : selectedLI.offsetTop;
    const lastItemOffsetValue: number = lastItem.offsetTop;
    if (
      lastItemOffsetValue - listHeight < height &&
      !isNullOrUndefined(this.liCollections) &&
      this.liCollections.length > 0 &&
      ...
      const paddingBottom: number = parseInt(
        getComputedStyle(this.list).paddingBottom,
        10
      );
      offsetValue =
        (count - (this.liCollections.length - this.activeIndex)) * liHeight -
        popupOffset +
        paddingBottom;
    ...
    offsetValue =
      offsetValue + liHeight + popupOffset - (liHeight - inputHeight) / 2;
    return -offsetValue;
  }
  ...
  private setWidth(): string {
    ...
    if (width.indexOf('%') > -1) {
      const inputWidth: number =
        (this.inputWrapper.container.offsetWidth * parseFloat(width)) / 100;
    ...
    if (
      ...
      width =
        ...
        (parseInt(getComputedStyle(firstItem).textIndent, 10) -
          parseInt(getComputedStyle(this.inputElement).paddingLeft, 10) +
          parseInt(
            getComputedStyle(this.inputElement.parentElement).borderLeftWidth,
            10
          )) *
          2 +
        'px';
  ...
  private scrollBottom(
    ...
    if (isNullOrUndefined(this.selectedLI) && this.enableVirtualization) {
      ...
      if (
        !isNullOrUndefined(this.selectedLI) &&
        this.selectedLI.classList.contains('e-virtual-list')
      ) {
    ...
    if (!isNullOrUndefined(this.selectedLI)) {
      const selectedListMargin: number =
        this.selectedLI &&
        !isNaN(
          parseInt(window.getComputedStyle(this.selectedLI).marginBottom, 10)
        )
          ? parseInt(window.getComputedStyle(this.selectedLI).marginBottom, 10)
          : 0;
      ...
      const virtualListCount: number =
        this.list.querySelectorAll('.e-virtual-list').length;
      const lastElementValue: string = this.list.querySelector(
        'li:last-of-type'
      )
        ...
        this.virtualListInfo && this.virtualListInfo.startIndex
          ? this.selectedLI.offsetTop +
            this.virtualListInfo.startIndex *
              (this.selectedLI.offsetHeight + selectedListMargin)
          : this.selectedLI.offsetTop;
      const currentOffset: number = this.list.offsetHeight;
      const nextBottom: number =
        selectedLiOffsetTop -
        virtualListCount * (this.selectedLI.offsetHeight + selectedListMargin) +
        (this.selectedLI.offsetHeight + selectedListMargin) -
        this.list.scrollTop;
      ...
      nextOffset = isInitial
        ? nextOffset + parseInt(getComputedStyle(this.list).paddingTop, 10) * 2
      ...
      if (this.activeIndex === 0 && !this.enableVirtualization) {
        ...
        const currentElementValue: string = this.selectedLI
          ? this.selectedLI.getAttribute('data-value')
          : null;
        let liCount: number =
          keyAction === 'pageDown' ? this.getPageCount() - 2 : 1;
        if (
          !this.enableVirtualization ||
          ...
          if (
            ...
            if (this.enableVirtualization && this.itemTemplate) {
              ...
              if (this.enableVirtualization) {
                liCount =
                  keyAction === 'pageDown' ? this.getPageCount() + 1 : liCount;
              }
              this.list.scrollTop +=
                (this.selectedLI.offsetHeight + selectedListMargin) * liCount;
            }
    ...
    if (!isNullOrUndefined(this.selectedLI)) {
      ...
      if (this.activeIndex === 0 && !this.enableVirtualization) {
        ...
        const currentElementValue: string = this.selectedLI
          ...
          : null;
        let liCount: number =
          keyAction === 'pageUp' ? this.getPageCount() - 2 : 1;
        if (this.enableVirtualization) {
  ...
  protected setScrollPosition(e?: KeyboardEventArgs): void {
    ...
    if (!isNullOrUndefined(e)) {
      switch (e.action) {
        ...
        default:
          this.isKeyBoardAction =
            e.action === 'up' || e.action === 'pageUp' || e.action === 'open';
  ...
  private setEleWidth(width: string | number): void {
    if (!isNullOrUndefined(width)) {
      if (typeof width === 'number') {
        ...
        this.inputWrapper.container.style.width = width.match(/px|%|em/)
          ? <string>width
  ...
  private closePopup(
    ...
    const isFilterValue: boolean =
      !isNullOrUndefined(this.filterInput) &&
      !isNullOrUndefined(this.filterInput.value) &&
      this.filterInput.value !== '';
    ...
    this.isDropDownClick = false;
    this.preventAutoFill = false;
    const scrollableParentElements: HTMLElement[] =
      this.popupObj.getScrollableParent(this.inputWrapper.container);
    ...
    if (this.enableVirtualization) {
      if (this.value == null || this.isTyped) {
        this.viewPortInfo.endIndex =
          this.viewPortInfo && this.viewPortInfo.endIndex > 0
            ? this.viewPortInfo.endIndex
            : this.itemCount;
        if (
          this.getModuleName() === 'autocomplete' ||
          (this.getModuleName() === 'dropdownlist' &&
            !isNullOrUndefined(this.typedString) &&
            this.typedString !== '') ||
          (this.getModuleName() === 'combobox' &&
            this.allowFiltering &&
            !isNullOrUndefined(this.typedString) &&
    ...
    this.trigger('close', eventArgs, (eventArgs: PopupEventArgs) => {
      if (
        ...
        const fixedHeader: HTMLElement =
          this.popupObj.element.querySelector('.e-fixed-head');
    ...
    if (
      Browser.isDevice &&
      !eventArgs.cancel &&
      this.popupObj.element.classList.contains('e-wide-popup')
    ) {
    ...
    if (this.dataSource instanceof DataManager) {
      ...
      dataSourceCount =
        this.virtualGroupDataSource &&
        (this.virtualGroupDataSource as any).length
          ? (this.virtualGroupDataSource as any).length
          : 0;
    } else {
      // eslint-disable-next-line @typescript-eslint/no-explicit-any
  ...
  private updateInitialData(): void {
    ...
    const ulElement: HTMLElement = this.renderItems(
      currentData as { [key: string]: object }[],
      this.fields
    );
    this.list.scrollTop = 0;
    this.virtualListInfo = {
    ...
    this.updateActionCompleteDataValues(
      ulElement,
      currentData as { [key: string]: object }[]
    );
    this.liCollections = <HTMLElement[] & NodeListOf<Element>>(
  ...
  public render(): void {
    ...
    this.inputWrapper = Input.createInput(
      {
        ...
        properties: {
          readonly:
            this.getModuleName() === 'dropdownlist' ? true : this.readonly,
    ...
    if (
      !isNullOrUndefined(this.inputWrapper.buttons[0]) &&
      this.inputWrapper.container.getElementsByClassName(
    ...
    this.wireEvent();
    this.tabIndex = this.element.hasAttribute('tabindex')
    ...
    if (
      ...
      (<HTMLSelectElement>this.element).options[0]
    ) {
      ...
      this.value = this.allowObjectBinding
        ...
        : selectElement.options[selectElement.selectedIndex].value;
      this.text = isNullOrUndefined(this.value)
        ? null
    ...
    const floatLabelElement: HTMLElement = <HTMLElement>(
      this.inputWrapper.container.getElementsByClassName('e-float-text')[0]
    );
    if (
      !isNullOrUndefined(this.element.id) &&
      this.element.id !== '' &&
      !isNullOrUndefined(floatLabelElement)
    ) {
  ...
  protected refreshPopup(): void {
    if (
      !isNullOrUndefined(this.popupObj) &&
      document.body.contains(this.popupObj.element) &&
      ((this.allowFiltering && !(Browser.isDevice && this.isFilterLayout())) ||
        this.getModuleName() === 'autocomplete')
    ) {
  ...
  protected checkData(newProp?: DropDownListModel): void {
    ...
    const isChangeValue: boolean =
      Object.keys(newProp).indexOf('value') !== -1 &&
      isNullOrUndefined(newProp.value);
    const isChangeText: boolean =
      Object.keys(newProp).indexOf('text') !== -1 &&
      isNullOrUndefined(newProp.text);
    if (
      this.getModuleName() !== 'autocomplete' &&
      this.allowFiltering &&
      (isChangeValue || isChangeText)
    ) {
      this.itemData = null;
    }
    if (
      ...
      this.allowFiltering &&
      newProp.query &&
      !isNullOrUndefined(Object.keys(newProp.query))
    ) {
      this.actionCompleteData =
        this.getModuleName() === 'combobox'
          ? { ulElement: null, list: null, isUpdated: false }
          : this.actionCompleteData;
      this.actionData = this.actionCompleteData;
    }
  }
  protected updateDataSource(
    props?: DropDownListModel,
    oldProps?: DropDownListModel
  ): void {
    if (
      this.inputElement.value !== '' ||
      (!isNullOrUndefined(props) &&
        (isNullOrUndefined(props.dataSource) ||
          (!(props.dataSource instanceof DataManager) &&
    ...
    if (
      ...
      (!isNullOrUndefined(props) &&
        ...
        !isNullOrUndefined(oldProps) &&
        Array.isArray(oldProps.dataSource) &&
        props.dataSource.length !== oldProps.dataSource.length)
    ) {
      this.typedString = '';
      this.resetList(this.dataSource);
    }
  ...
  protected checkCustomValue(): void {
    ...
    if (
      (isNullOrUndefined(index) && currentValue === value) ||
      this.isAngular
    ) {
      this.setProperties({
        text: dataItem.text ? dataItem.text.toString() : dataItem.text,
  ...
  public onPropertyChanged(
    newProp: DropDownListModel,
    oldProp: DropDownListModel
  ): void {
    if (
      !isNullOrUndefined(newProp.dataSource) &&
      !this.isTouched &&
      isNullOrUndefined(newProp.value) &&
      isNullOrUndefined(newProp.index) &&
      !isNullOrUndefined(this.preselectedIndex) &&
    ...
    for (const prop of Object.keys(newProp)) {
      switch (prop) {
        ...
        case 'placeholder':
          Input.setPlaceholder(
            newProp.placeholder,
            this.inputElement as HTMLInputElement
          );
          break;
        case 'filterBarPlaceholder':
          if (this.filterInput) {
            Input.setPlaceholder(
              newProp.filterBarPlaceholder,
              this.filterInput as HTMLInputElement
            );
          }
          break;
        case 'readonly':
        ...
        case 'text':
          if (this.fields.disabled) {
            newProp.text =
              ...
              !this.isDisabledItemByIndex(
                this.getIndexByValue(this.getValueByText(newProp.text))
              )
                ? newProp.text
                : null;
          }
          ...
          if (!this.initialRemoteRender) {
            ...
            if (!this.checkValidLi(li)) {
              if (
                this.liCollections &&
                this.liCollections.length === 100 &&
                this.getModuleName() === 'autocomplete' &&
                this.listData.length > 100
              ) {
                ...
                const checkField: string = isNullOrUndefined(this.fields.text)
                  ? this.fields.value
                  : this.fields.text;
                this.typedString = '';
                this.dataSource
                  .executeQuery(
                    this.getQuery(this.query).where(
                      new Predicate(checkField, 'equal', newProp.text)
                    )
                  )
                  .then((e: Object) => {
                    if ((e as ResultData).result.length > 0) {
        ...
        case 'value':
          if (this.fields.disabled) {
            newProp.value =
              newProp.value != null && !this.isDisableItemValue(newProp.value)
                ? newProp.value
                : null;
          }
          ...
          if (
            this.allowObjectBinding &&
            !isNullOrUndefined(newProp.value) &&
            !isNullOrUndefined(oldProp.value) &&
          ...
          if (!this.initialRemoteRender) {
            const value: string | number | boolean =
              this.allowObjectBinding && !isNullOrUndefined(newProp.value)
                ? getValue(
            ...
            if (!this.checkValidLi(item)) {
              if (
                ...
                const value: string | number | boolean =
                  this.allowObjectBinding && !isNullOrUndefined(newProp.value)
                    ? getValue(checkField, newProp.value)
                    : newProp.value;
                this.dataSource
                  .executeQuery(
                    this.getQuery(this.query).where(
        ...
        case 'index':
          if (this.fields.disabled) {
            newProp.index =
              newProp.index != null &&
              !this.isDisabledItemByIndex(newProp.index)
                ? newProp.index
                : null;
          }
          ...
          if (!this.initialRemoteRender && this.liCollections) {
            const element: Element = this.liCollections[
              newProp.index
            ] as Element;
        ...
        case 'allowFiltering':
          if (this.allowFiltering) {
            this.actionCompleteData = {
              ...
              list: this.listData as { [key: string]: Object }[],
              isUpdated: true,
            };
            this.actionData = this.actionCompleteData;
            this.updateSelectElementData(this.allowFiltering);
        ...
        case 'floatLabelType':
          ...
          if (
            ...
            this.inputWrapper.container
              .getElementsByClassName('e-float-text-overflow')[0]
              .classList.add('e-icon');
          }
          break;
        ...
        default:
          {
            // eslint-disable-next-line max-len
            const ddlProps: { [key: string]: Object } = this.getPropObject(
              prop,
  ...
  private setSelectionData(
    ...
    this.updateListValues = (): void => {
      if (prop === 'text') {
        ...
        const fields: string = this.fields.value ? this.fields.value : '';
        const value: string | number | boolean =
          this.allowObjectBinding && !isNullOrUndefined(newProp)
            ? getValue(fields, newProp)
            : newProp;
  ...
  private invokeRenderPopup(
    ...
    if (
      !isNullOrUndefined(this.list) &&
      (!isNullOrUndefined(this.list.children[0]) ||
        this.list.classList.contains(dropDownBaseClasses.noData))
    ) {
      this.renderPopup(e);
    }
  ...
  public destroy(): void {
    this.isActive = false;
    if (this.showClearButton) {
      this.clearButton = document.getElementsByClassName(
        'e-clear-icon'
      )[0] as HTMLElement;
    }
    ...
    if (
      this.element &&
      !this.element.classList.contains('e-' + this.getModuleName())
    ) {
      return;
    }
    ...
    if (
      this.inputWrapper.container &&
      this.inputWrapper.container.parentElement
    ) {
      if (
        this.inputWrapper.container.parentElement.tagName ===
        this.getNgDirective()
      ) {
    ...
    Input.destroy(
      {
        ...
        buttons: this.inputWrapper.container.querySelectorAll(
          '.e-input-group-icon'
        )[0] as any,
      },
      this.clearButton
