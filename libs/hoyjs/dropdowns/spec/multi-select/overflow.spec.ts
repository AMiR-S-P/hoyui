...
describe('MultiSelect Overflow', () => {
  ...
  describe('EJ2-14587 - Disable overflow mode', () => {
    ...
    it('Check Non- auto width adjustment - enableOverflowTemplate - true', () => {
      let containerEle: HTMLElement =
        listObj.element.parentElement.parentElement;
      expect(
        (<HTMLElement>(
          containerEle.querySelector('.e-delim-view.e-delim-values')
        )).offsetWidth
      ).toBeLessThan(200);
    });
  });
  ...
  describe('EJ2-14587 - Disable overflow mode - auto flow- - enableOverflowTemplate - true', () => {
    ...
    let parentEle: HTMLDivElement = <HTMLDivElement>(
      createElement('div', { styles: 'width:500px' })
    );
