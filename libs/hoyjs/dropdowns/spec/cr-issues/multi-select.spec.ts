...
describe('MultiSelect', () => {
  ...
  describe('EJ2-28369 - Hide the “Select All” checkbox if only one item exists in filtered state', () => {
    ...
    it('Select all text for after filtering', () => {
      ...
      (<any>listObj).keyUp(keyboardEventArgs);
      expect(
        listObj.checkBoxSelectionModule.checkAllParent.style.display == 'none'
      ).toBe(true);
    });
    ...
    it('Select all text for initial rendering', () => {
      ...
      listObj.showPopup();
      expect(
        listObj.checkBoxSelectionModule.checkAllParent.style.display == 'block'
      ).toBe(true);
    });
    it('Select all text for initial rendering with grouping', () => {
      ...
      listObj = new MultiSelect({
        ...
        filtering: function (e) {
          ...
          query =
            e.text != ''
              ? query.where('vegetable', 'startswith', e.text, true)
              : query;
          e.updateData(data, query);
        },
      });
      ...
      mObj = new MultiSelect({
        ...
        filtering: (e: FilteringEventArgs) => {
          if (e.text == '') e.updateData(searchData);
            ...
            query =
              e.text !== ''
                ? query.where('ContactName', 'startswith', e.text, true)
                : query;
    ...
    it('after the item selected focus the input wrapper', (done) => {
      atcObj.dataBound = function () {
        ...
        let elem: HTMLElement = (<any>(
          atcObj
        )).chipCollectionWrapper.querySelector('span[data-value="list4"]');
  ...
  describe('Remote data binding - pre select value', () => {
    ...
    xit('EJ2-13454- pre select value', () => {
      ...
      expect(
        (<any>listObj).liCollections[2].getAttribute('data-Value') === 'VINET'
      ).toBe(true);
    });
  });
  ...
  xdescribe('EJ2-14133 -Remote data binding', () => {
    ...
    it('Popup not open when update a data via updatedata', (done) => {
      ...
      (<any>listObj).keyUp(keyboardEventArgs);
      setTimeout(function () {
        expect(document.body.contains((<any>listObj).popupObj.element)).toBe(
          true
        );
        mouseEventArgs.target = (<any>listObj).liCollections[0];
        mouseEventArgs.type = 'click';
  ...
  describe('EJ2-14361 - Pre-selected item disappears from the popup list', () => {
    ...
    it('when removed using clear button in MultiSelect', () => {
      ...
      expect(mObj.isPopupOpen()).toBe(true);
      expect(
        mObj.ulElement.querySelectorAll('li[data-value="JAVA"]').length
      ).toBe(1);
      expect(
        mObj.ulElement.querySelector('li[data-value="JAVA"]').length
      ).not.toBe(null);
    });
  });
  ...
  describe(' EJ2-15135- clear All value.', () => {
    ...
    it(' clear the value maintain in list item', () => {
      ...
      expect(
        dropDowns.list.querySelector('li').getAttribute('data-value') ===
          'JavaScript'
      ).toBe(true);
    });
  });
  describe('EJ2-15629:change event is not triggered when focused out', () => {
    ...
    it(' select item and click wrapper ', () => {
      ...
      let list: Array<HTMLElement> = (<any>(
        dropDowns
  ...
  describe('EJ2-16410: Item disappears from avaible values if removed using backspace', () => {
    ...
    it(' show the preselected value in popuplist while press the backspace', (done) => {
      ...
      setTimeout(() => {
        ...
        let removeEle: HTMLElement = (<any>listObj).list.querySelector(
          'li[data-value="list1"]'
        );
  ...
  describe('EJ2-18072: multiselect popup width set to 0, when set value initial loading.', () => {
    ...
    beforeAll(() => {
      divContainer = createElement('dvi', {
        id: 'container-ele',
        styles: 'display:none',
      });
      element = <HTMLInputElement>(
    ...
    it(' popup width and component width same', (done) => {
      ...
      setTimeout(() => {
        expect(
          (listObj as any).overAllWrapper.offsetWidth ===
            (listObj as any).popupObj.element.offsetWidth
        ).toBe(true);
        done();
      }, 400);
    });
  ...
  describe(' EJ2-18283 - selectAll eventArgs', () => {
    ...
    it(' click on selectAll element', (done) => {
      ...
      setTimeout(() => {
        expect(
          listObj.checkBoxSelectionModule.checkAllParent.classList.contains(
            'e-selectall-parent'
          )
        ).toBe(true);
        expect(
        ...
        expect(
          listObj.checkBoxSelectionModule.checkAllParent.innerText ===
            'Select All'
        ).toBe(true);
        expect(
          listObj.checkBoxSelectionModule.checkAllParent.lastElementChild.classList.contains(
            'e-all-text'
          )
        ).toBe(true);
        listObj.dispatchEvent(
          listObj.checkBoxSelectionModule.checkAllParent,
          'mousedown'
        );
  ...
  describe('EJ2-31766:Performance issue arise while clearing larger number of selected items using clear button', () => {
    ...
    it(' select item and clear the value using icon ', () => {
      ...
      (<any>dropDowns).checkBoxSelectionModule.clickHandler({
        preventDefault: () => {},
        currentTarget: (<any>dropDowns).checkBoxSelectionModule.checkAllParent,
      });
      mouseEventArgs.target = dropDowns.componentWrapper;
      mouseEventArgs.type = 'mousedown';
      (<any>dropDowns).wrapperClick(mouseEventArgs);
      ...
      mouseEventArgs.type = 'mousedown';
      (<any>dropDowns).wrapperClick(mouseEventArgs);
      mouseEventArgs.target = dropDowns.componentWrapper.querySelector(
  ...
  describe('EJ2-18758 - UnSelectAll issue', () => {
    ...
    it(' click on unselectAll element', (done) => {
      ...
      listObj.open = (): void => {
        (<any>listObj).dispatchEvent(
          (<any>listObj).checkBoxSelectionModule.checkAllParent,
          'mousedown'
        );
      };
      listObj.selectedAll = (args: ISelectAllEventArgs): void => {
        expect(isNullOrUndefined(args.items[0].querySelector('.e-check'))).toBe(
          true
        );
        done();
      };
  ...
  describe('EJ2-24251 - placeholder', () => {
    ...
    it(' select and unselect all placeholder update', () => {
      expect(
        (listObj as any).inputElement.placeholder === listObj.placeholder
      ).toBe(true);
      listObj.selectAll(true);
  ...
  describe('EJ2-25259- browser freeze when click the clear all.', () => {
    ...
    it(' clear the value maintain in list item', () => {
      ...
      dropDowns.clearAll(keyboardEventArgs);
      expect(
        dropDowns.componentWrapper.querySelector('.e-delim-view.e-delim-values')
  ...
  describe('EJ2-25134 - popup open downward', () => {
    ...
    let divEle = createElement('div', {
      id: 'parent',
      styles: 'height: 1000px; overflow: auto;',
    });
    let element: HTMLInputElement = <HTMLInputElement>(
      createElement('input', { id: 'multiselect' })
    );
    ...
    it(' when select the items', () => {
      ...
      let list: Array<HTMLElement> = (<any>listObj).ulElement.querySelectorAll(
        'li'
      );
      mouseEventArgs.target = list[0];
      mouseEventArgs.type = 'click';
  ...
  describe('EJ2-24839- custom value with pre select not working', () => {
    ...
    it('when set empty data source.', () => {
      expect(
        listObj.componentWrapper.querySelector('.e-delim-view.e-delim-values')
          .innerText === 'JAVA'
      ).toBe(true);
  ...
  describe('EJ2-25818 -Grouping template text not updated ', () => {
    ...
    beforeAll(() => {
      ...
      listObj = new MultiSelect({
        ...
        allowFiltering: true,
        groupTemplate:
          "${if(groups==='false')}<span>Foo</span> ${else}<span>Bar</span>${/if}",
      });
      listObj.appendTo(element);
      listObj.componentWrapper.style.paddingTop = '700px';
    });
  ...
  describe('EJ2-31766 - Performance issue arises while clearing ', () => {
    ...
    it('larger number of selected items using a clear button', () => {
      ...
      listObj.hidePopup();
      listObj.selectAll(true);
      mouseEventArgs.target = (listObj as any).componentWrapper.querySelector(
        '.e-chips-close.e-close-hooker'
      );
  ...
  describe('EJ2-39000', () => {
    ...
    it('clear icon not working when filtering testcase', () => {
      ...
      expect((<any>mulObj).list.querySelectorAll('li').length === 10).toBe(
        true
      );
  ...
  describe('EJ2-39447', () => {
    ...
    it('Filtering popup using paste testcase', () => {
      ...
      setTimeout(function () {
        expect((<any>mulObj).list.querySelectorAll('li').length === 1).toBe(
          true
        );
  ...
  describe('EJ2-39642', () => {
    ...
    it('clear icon not working when filtering testcase', () => {
      ...
      mulObj.showPopup();
      expect((<any>mulObj).isPopupOpen()).toBe(true);
      expect((<any>mulObj).list.querySelectorAll('li').length === 19).toBe(
        true
      );
      mulObj.hidePopup();
      // Changing query
  ...
  describe('EJ2-39448', () => {
    ...
    it('Outline class for filter input', () => {
      ...
      expect(
        (<any>(
          mulInstance
        )).checkBoxSelectionModule.filterInputObj.container.classList.contains(
          'e-outline'
        )
      ).toBe(true);
    });
  ...
  describe('EJ2-44516', () => {
    ...
    let element1: HTMLInputElement = <HTMLInputElement>(
      createElement('input', { id: 'multiselect1', attrs: { type: 'text' } })
    );
    beforeAll(() => {
      document.body.appendChild(element);
  ...
  describe('EJ2-44639', () => {
    ...
    it('Arrow up not workig in firefox.', () => {
      ...
      listObj.onKeyDown(keyboardEventArgs);
      expect(
        listObj.popupWrapper.querySelector('.e-item-focus').innerText
      ).toBe('Australia');
      keyboardEventArgs.keyCode = 40;
      listObj.onKeyDown(keyboardEventArgs);
      expect(
  ...
  describe('EJ2-36805', () => {
    ...
    it('Chip not created when change value dynamically when control is in focus', () => {
      ...
      expect(listObj.chipCollectionWrapper.firstElementChild.innerText).toBe(
        'India'
      );
    });
  });
