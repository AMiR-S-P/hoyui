import { setCulture, createElement } from '@hoyui/base';
  ...
  describe('List datasource property-change testing', () => {
    ...
    beforeEach((): void => {
      ...
      let ele: HTMLInputElement = <HTMLInputElement>(
        createElement('input', { id: 'ddtree' })
      );
      document.body.appendChild(ele);
      ddtreeObj = undefined;
    });
    afterEach((): void => {
      if (ddtreeObj) ddtreeObj.destroy();
    ...
    it('enableRtl', () => {
      ...
      ele.dispatchEvent(e);
      expect(
        ddtreeObj.element.parentElement.classList.contains('e-rtl')
      ).toEqual(true);
      expect(
        (ddtreeObj as any).popupObj.element.classList.contains('e-rtl')
      ).toBe(true);
      expect((ddtreeObj as any).popupObj.enableRtl).toEqual(true);
      expect(
        (ddtreeObj as any).treeObj.element.classList.contains('e-rtl')
      ).toBe(true);
      ...
      ele.dispatchEvent(e);
      expect(
        (ddtreeObj as any).element.parentElement.classList.contains('e-rtl')
      ).toEqual(false);
      expect(
        (ddtreeObj as any).popupObj.element.classList.contains('e-rtl')
      ).toBe(false);
    ...
    it('cssClass', () => {
      ...
      ele.dispatchEvent(e);
      expect(
        (ddtreeObj as any).element.parentElement.classList.contains(
          'custom-dropdowntree'
        )
      ).toBe(true);
      expect(
        (ddtreeObj as any).popupObj.element.classList.contains(
          'custom-dropdowntree'
        )
      ).toBe(true);
    ...
    it('enabled', () => {
      ...
      expect(
        ddtreeObj.element.parentElement.classList.contains('e-disabled')
      ).toBe(true);
      ...
      expect(
        ddtreeObj.element.parentElement.getAttribute('aria-disabled')
      ).toBe('true');
      var ele = ddtreeObj.element;
      var e = new MouseEvent('mousedown', {
        view: window,
      ...
      expect(
        document.querySelector('.e-popup').classList.contains('e-popup-open')
      ).toBe(true);
      ddtreeObj.hidePopup();
      ...
      expect(
        ddtreeObj.element.nextElementSibling.classList.contains('e-icon-hide')
      ).toBe(false);
    ...
    it('value ES-901525 checkbox', () => {
      ...
      let checkEle: Element[] = <Element[] & NodeListOf<Element>>(
        ddtreeObj.treeObj.element.querySelectorAll('li')
      );
      var e = new MouseEvent('mousedown', {
        view: window,
        bubbles: true,
    ...
    it('dynamic autocheck', () => {
      ...
      ddtreeObj.dataBind();
      expect(
        ddtreeObj.element.parentElement
          .querySelector('.e-chips-wrapper')
          .classList.contains('e-icon-hide')
      ).toBe(true);
      expect(ddtreeObj.value.length).toBe(4);
    });
    it('dynamic autocheck in react', () => {
      ddtreeObj = new DropDownTree(
        {
          width: '600px',
          fields: {
    ...
    it('popupHeight and popupWidth', () => {
      ddtreeObj = new DropDownTree(
        { width: '100%', popupHeight: '300px', popupWidth: '300px' },
        '#ddtree'
      );
    ...
    it('zIndex', () => {
      ...
      ddtreeObj.dataBind();
      ddtreeObj.showPopup();
      expect((ddtreeObj as any).popupObj.element.style.zIndex === '1333').toBe(
        true
      );
    });
    ...
    it('placeholder with valid name ', () => {
      ...
      expect(ddtreeObj.element.getAttribute('placeholder')).toEqual(
        'Placeholder'
      );
    ...
    it('floatLabelType', () => {
      ...
      let floatElement = (ddtreeObj as any).inputWrapper.querySelector(
        '.e-float-text'
      );
      var ele = ddtreeObj.element;
      var e = new MouseEvent('mousedown', {
      ...
      ddtreeObj.dataBind();
      mouseEventArgs.target = document.body;
      let floatElement1 = (ddtreeObj as any).inputWrapper.querySelector(
        '.e-float-text'
      );
      ...
      ddtreeObj.dataBind();
      mouseEventArgs.target = document.body;
      let floatElement2 = (ddtreeObj as any).inputWrapper.querySelector(
        '.e-float-text'
      );
    ...
    it('ShowDropDownIcon disabled ', () => {
      ...
      expect(
        ddtreeObj.element.parentElement.lastElementChild.classList.contains(
          'e-clear-icon'
        )
      ).toBe(true);
    ...
    it('showClearButton disabled ', () => {
      ...
      expect(
        ddtreeObj.element.nextElementSibling.classList.contains('e-clear-icon')
      ).toBe(false);
    ...
    it('showClearButton Enabled ', () => {
      ...
      expect(
        (ddtreeObj as any).element.nextElementSibling.classList.contains(
          'e-clear-icon'
        )
      ).toBe(true);
      expect(
    ...
    it('allowMultiSelection enabled with Delimiter mode', () => {
      ...
      ele.dispatchEvent(e);
      let li: Element[] = <Element[] & NodeListOf<Element>>(
        (ddtreeObj as any).treeObj.element.querySelectorAll('li')
      );
      // ctrl key pressed
      ...
      expect(
        ddtreeObj.element.previousElementSibling.firstElementChild.getAttribute(
          'value'
        )
      ).toBe('1');
      expect(
        ddtreeObj.element.previousElementSibling.firstElementChild.nextElementSibling.getAttribute(
          'value'
        )
      ).toBe('3');
      // checking shift key
      ...
      (ddtreeObj as any).treeObj.touchClickObj.tap(tapEvent);
      expect(ddtreeObj.text).toBe(
        'Victoria,South Australia,Western Australia,Brazil'
      );
      expect(ddtreeObj.value.length).toBe(4);
      ...
      ele1.dispatchEvent(e);
      expect(
        document.querySelector('.e-popup').classList.contains('e-popup-close')
      ).toBe(true);
    ...
    it('allowMultiSelection enabled with Box mode', () => {
      ...
      expect(chips[0].querySelector('.e-chipcontent').textContent).toBe(
        'Australia'
      );
      expect(ddtreeObj.value[0]).toBe('1');
      expect(
      ...
      expect(chips_1[0].querySelector('.e-chipcontent').textContent).toBe(
        'Australia'
      );
      expect(chips_1[1].querySelector('.e-chipcontent').textContent).toBe(
        'Victoria'
      );
      expect(ddtreeObj.value.length).toBe(2);
      expect(ddtreeObj.value[1]).toBe('3');
      ...
      expect(chips_2[0].querySelector('.e-chipcontent').textContent).toBe(
        'Victoria'
      );
      expect(chips_2[1].querySelector('.e-chipcontent').textContent).toBe(
        'South Australia'
      );
      expect(chips_2[2].querySelector('.e-chipcontent').textContent).toBe(
        'Western Australia'
      );
      expect(chips_2[3].querySelector('.e-chipcontent').textContent).toBe(
        'Brazil'
      );
      let ele1 = ddtreeObj.element;
      var e = new MouseEvent('mousedown', {
    ...
    it('Switching between various mode', () => {
      ...
      expect(chips_3[1].querySelector('.e-chipcontent').textContent).toBe(
        'Victoria'
      );
    ...
    it('showCheckBox enabled with Box mode', () => {
      ...
      expect(nchips[1].querySelector('.e-chipcontent').textContent).toBe(
        'New South Wales'
      );
      var e = new MouseEvent('mousedown', {
        view: window,
      ...
      expect(chips_1[2].querySelector('.e-chipcontent').textContent).toBe(
        'Brazil'
      );
      expect(ddtreeObj.value[2]).toBe('7');
      ddtreeObj.showCheckBox = false;
    ...
    it('loadOnDemand dynamically disabled', () => {
      ...
      expect(nchips_1[4].querySelector('.e-chipcontent').textContent).toBe(
        'Acre'
      );
      (ddtreeObj as any).onFocusOut();
      expect(ddtreeObj.text).toBe('Victoria,Brazil,Paraná,Ceará,Acre');
    ...
    it('showCheckBox enabled dynamically with Delimiter mode', () => {
      ...
      expect(selectAllElement.classList.contains('e-selectall-parent')).toBe(
        true
      );
      expect(selectAllElement.querySelector('.e-all-text').textContent).toBe(
        'Select All'
      );
      ddtreeObj.showCheckBox = false;
      ddtreeObj.dataBind();
    ...
    it('autoCheck enabled', () => {
      ...
      expect(chips[4].querySelector('.e-chipcontent').textContent).toBe(
        'Western Australia'
      );
      expect(
        document.querySelector('.e-popup').classList.contains('e-popup-open')
      ...
      expect(chipElement.classList.contains('e-icon-hide')).toBe(true);
      expect(ddtreeObj.text).toBe(
        'Australia,New South Wales,Victoria,South Australia,Western Australia'
      );
      expect(
        document.querySelector('.e-popup').classList.contains('e-popup-close')
      ).toBe(true);
      ...
      expect(nchips[7].querySelector('.e-chipcontent').textContent).toBe(
        'Ceará'
      );
      (ddtreeObj as any).onFocusOut();
      expect(chipElement.classList.contains('e-icon-hide')).toBe(true);
      expect(ddtreeObj.text).toBe(
        'Australia,New South Wales,Victoria,South Australia,Western Australia,Brazil,Paraná,Ceará,Acre'
      );
      expect(
        document.querySelector('.e-popup').classList.contains('e-popup-close')
      ).toBe(true);
      ...
      expect(nchips_1[9].querySelector('.e-chipcontent').textContent).toBe(
        'China'
      );
      (ddtreeObj as any).onFocusOut();
      expect(ddtreeObj.text).toBe(
        'Australia,New South Wales,Victoria,South Australia,Western Australia,Brazil,Paraná,Ceará,Acre,China'
      );
      ddtreeObj.showPopup();
      ddtreeObj.showCheckBox = false;
      ddtreeObj.dataBind();
    ...
    it('ShowSelectAll testing', (done: Function) => {
      ...
      let checkEle: Element = <Element & NodeListOf<Element>>(
        selectAllElement.querySelector('.e-checkbox-wrapper')
      );
      var e = new MouseEvent('mousedown', {
        view: window,
        bubbles: true,
      ...
      setTimeout(function () {
        ...
        let ncheckEle: Element = <Element & NodeListOf<Element>>(
          selectAllElement.querySelector('.e-checkbox-wrapper')
        );
        var e = new MouseEvent('mousedown', {
          view: window,
        ...
        setTimeout(function () {
          ...
          expect(
            selectAllElement.querySelector('.e-all-text').textContent
          ).toBe('Select All');
          ...
          let nwcheckEle: Element = <Element & NodeListOf<Element>>(
            selectAllElement.querySelector('.e-checkbox-wrapper')
          );
          var e = new MouseEvent('mousedown', {
            view: window,
          ...
          setTimeout(function () {
            ...
            setTimeout(function () {
              ...
              ddtreeObj.dataBind();
              expect(
                ddtreeObj.popupEle.firstElementChild.classList.contains(
                  'e-selectall-parent'
                )
              ).toBe(false);
              done();
    ...
    describe('Template', () => {
      ...
      it('headerTemplate support with string', () => {
        ...
        ddtreeObj.headerTemplate =
          '<div class="new headerString"><span>HEADER VIA STRING</span></div>';
        ddtreeObj.dataBind();
        ddtreeObj.showPopup();
        expect(ddtreeObj.headerTemplate).not.toBe(null);
        expect(
          ddtreeObj.popupObj.element.firstChild.classList.contains(
            'e-ddt-header'
          )
        ).toBe(true);
        expect(ddtreeObj.popupObj.element.firstChild.innerText).toEqual(
          'HEADER VIA STRING'
        );
        ddtreeObj.hidePopup();
      ...
      it('headerTemplate support with script', () => {
        let headerTemplate: Element = createElement('div', {
          id: 'headerTemplate',
        });
        headerTemplate.innerHTML =
          '<div class="header"><span >HEADER Via SCRIPT</span></div>';
      ...
      it('footerTemplate support with string', () => {
        ...
        ddtreeObj.footerTemplate =
          '<div class="new headerString"><span>FOOTER VIA STRING</span></div>';
        ddtreeObj.dataBind();
        ddtreeObj.showPopup();
        expect(ddtreeObj.footerTemplate).not.toBe(null);
        expect(
          ddtreeObj.popupObj.element.lastElementChild.classList.contains(
            'e-ddt-footer'
          )
        ).toBe(true);
        expect(ddtreeObj.popupObj.element.lastElementChild.innerText).toEqual(
          'FOOTER VIA STRING'
        );
        ddtreeObj.hidePopup();
      ...
      it('footerTemplate support with script', () => {
        let footerTemplate: Element = createElement('div', {
          id: 'footerTemplate',
        });
        footerTemplate.innerHTML =
          '<div class="footer"><span >FOOTER Via SCRIPT</span></div>';
      ...
      it('itemtemplate', () => {
        ...
        template.innerHTML =
          '${if(hasChild == undefined)}<b>${nodeText}</b>${else}<i>${nodeText}</i>${/if}';
        ...
        ddtreeObj = new DropDownTree(
          {
            fields: {
              ...
              text: 'nodeText',
              hasChildren: 'hasChild',
              expanded: 'nodeExpanded1',
            },
          },
          '#ddtree'
        );
        let li: Element[] = <Element[] & NodeListOf<Element>>(
          ddtreeObj.treeObj.element.querySelectorAll('.e-text-content')
        );
        expect(li[0].querySelector('i')).toBe(null);
        expect(li[0].querySelector('b')).toBe(null);
        ddtreeObj.itemTemplate = 'template';
        ddtreeObj.dataBind();
        let nli: Element[] = <Element[] & NodeListOf<Element>>(
          ddtreeObj.treeObj.element.querySelectorAll('.e-text-content')
        );
        ...
        ddtreeObj.dataBind();
        let mli: Element[] = <Element[] & NodeListOf<Element>>(
          ddtreeObj.treeObj.element.querySelectorAll('.e-text-content')
        );
        ...
        ddtreeObj.itemTemplate = '#template';
        ddtreeObj.dataBind();
        let ali: Element[] = <Element[] & NodeListOf<Element>>(
          ddtreeObj.treeObj.element.querySelectorAll('.e-text-content')
        );
        expect(ali[0].querySelector('i')).not.toBe(null);
        expect(ali[0].querySelector('b')).toBe(null);
        ddtreeObj.itemTemplate =
          '${if(hasChild == undefined)}<b>${nodeText}</b>${else}<i>${nodeText}</i>${/if}';
        ddtreeObj.dataBind();
        let bli: Element[] = <Element[] & NodeListOf<Element>>(
          ddtreeObj.treeObj.element.querySelectorAll('.e-text-content')
        );
    ...
    describe('- noRecordTemplate', () => {
      ...
      let element: HTMLInputElement = <HTMLInputElement>(
        createElement('input', { id: 'dropdowntree' })
      );
      let mouseEventArgs: any = {
      ...
      beforeAll(() => {
        ...
        ddtreeObj = new DropDownTree({
          ...
          noRecordsTemplate:
            '<div> There is no records to rendering the list items</div>',
        });
      ...
      it('with custom value', () => {
        ...
        expect(
          (
            ddtreeObj as any
          ).popupObj.element.firstElementChild.classList.contains('e-no-data')
        ).toBe(true);
        expect(
          (ddtreeObj as any).popupObj.element.firstElementChild.innerText
        ).toBe('There is no records to rendering the list items');
        ddtreeObj.hidePopup();
    ...
    describe('- fields', () => {
      ...
      it('dataSource property', () => {
        ...
        expect(
          ddtreeObj.treeObj.element.querySelector('.e-list-text').innerHTML
        ).toBe('Music');
        expect(
          ddtreeObj.treeObj.element
        ...
        expect(
          ddtreeObj.treeObj.element
            .querySelector('.e-list-img')
            .src.indexOf('images/Shooting.png')
        ).not.toBe(-1);
        expect(
          ddtreeObj.treeObj.element.querySelector('.e-list-item').title
        ).toBe('This is Music node');
        expect(
          ddtreeObj.treeObj.element
            .querySelectorAll('li')[1]
            .classList.contains('firstnode')
        ).toBe(true);
        expect(
          ddtreeObj.treeObj.element.querySelectorAll('li')[1].style
            .backgroundColor
        ).toBe('red');
      ...
      it('fields parentValue property', () => {
        ...
        expect(
          li[0].querySelector('.e-list-parent').querySelector('.e-list-text')
            .innerHTML
        ).toBe('Wind.jpg');
        expect(
          li[0]
        ...
        let cli: Element[] = <Element[] & NodeListOf<Element>>(
          ddtreeObj.treeObj.element.querySelectorAll('li')
        );
        ...
        ddtreeObj.dataBind();
        let newli: Element[] = <Element[] & NodeListOf<Element>>(
          ddtreeObj.treeObj.element.querySelectorAll('li')
        );
        ...
        expect(
          newli[0].querySelector('.e-list-parent').querySelector('.e-list-text')
            .innerHTML
        ).toBe('Wind.jpg');
        expect(
          newli[0]
        ...
        let dli: Element[] = <Element[] & NodeListOf<Element>>(
          ddtreeObj.treeObj.element.querySelectorAll('li')
        );
      ...
      it('fields imageUrl property', () => {
        ...
        expect(
          ddtreeObj.treeObj.element
            .querySelector('.e-list-img')
            .src.indexOf('images/Cricket.png')
        ).not.toBe(-1);
        expect(
          ddtreeObj.treeObj.element.querySelector('.e-list-item').title
        ).toBe('This is Music node');
      ...
      it('fields expanded property', () => {
        ...
        expect(
          ddtreeObj.treeObj.element.querySelectorAll('li')[0].childElementCount
        ).toBe(3);
        expect(
          ddtreeObj.treeObj.element.querySelector('.e-list-text').innerHTML
        ).toBe('Music');
        ...
        expect(
          ddtreeObj.treeObj.element.querySelectorAll('li')[2].style
            .backgroundColor
        ).toBe('red');
      });
      ...
      it('sortOrder', (done: Function) => {
        ...
        jasmine.DEFAULT_TIMEOUT_INTERVAL = 10000;
        setTimeout(function () {
          let li1: Element[] = <Element[] & NodeListOf<Element>>(
            ddtreeObj.treeObj.element.querySelectorAll('li')
          );
          expect(li1.length).toBe(2);
          expect(li1[0].querySelector('.e-list-text').innerHTML).toBe(
            'Downloads'
          );
          ...
          jasmine.DEFAULT_TIMEOUT_INTERVAL = 10000;
          setTimeout(function () {
            let li2: Element[] = <Element[] & NodeListOf<Element>>(
              ddtreeObj.treeObj.element.querySelectorAll('li')
            );
            expect(li2.length).toBe(2);
            expect(li2[0].querySelector('.e-list-text').innerHTML).toBe(
              'Music'
            );
            ...
            jasmine.DEFAULT_TIMEOUT_INTERVAL = 10000;
            setTimeout(function () {
              let li3: Element[] = <Element[] & NodeListOf<Element>>(
                ddtreeObj.treeObj.element.querySelectorAll('li')
              );
              expect(li3.length).toBe(2);
              expect(li3[0].querySelector('.e-list-text').innerHTML).toBe(
                'Downloads'
              );
              ...
              jasmine.DEFAULT_TIMEOUT_INTERVAL = 10000;
              setTimeout(function () {
                let li4: Element[] = <Element[] & NodeListOf<Element>>(
                  ddtreeObj.treeObj.element.querySelectorAll('li')
                );
                expect(li4.length).toBe(2);
                expect(li4[0].querySelector('.e-list-text').innerHTML).toBe(
                  'Music'
                );
      ...
      it('click', (done: Function) => {
        ...
        mouseEventArgs.target = li[0].querySelector('.e-list-text');
        expect(
          (li[0].querySelector('.e-icons') as Element).classList.contains(
            'e-icon-expandable'
          )
        ).toBe(true);
        expect(
