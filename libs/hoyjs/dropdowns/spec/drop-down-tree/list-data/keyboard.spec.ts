...
describe('DropDown Tree control List datasource', () => {
  ...
  describe('keyboard event testing', () => {
    ...
    it('space key pressed on showSelectAll', () => {
      ...
      keyboardEventArgs.action = 'moveDown';
      ddtreeObj.keyActionHandler(keyboardEventArgs);
      keyboardEventArgs.currentTarget =
        ddtreeObj.popupObj.element.querySelector('.e-selectall-parent');
      keyboardEventArgs.action = 'space';
      ddtreeObj.checkAllAction(keyboardEventArgs);
      expect(
        ddtreeObj.popupObj.element
    ...
    it('right arrow key pressed', (done: Function) => {
      ...
      ddtreeObj.treeObj.keyActionHandler(keyboardEventArgs);
      expect(
        li[5].querySelector('.e-icons').classList.contains('e-icon-expandable')
      ).toBe(true);
    ...
    it('allowFiltering with shiftTab key pressed', () => {
      ...
      expect(
        document
          .querySelector('.e-control-wrapper')
    ...
    it('TreeView items with selectable field false', () => {
      ...
      ddtreeObj = new DropDownTree(
        {
          fields: { dataSource: treeData, value: 'id', text: 'name' },
          destroyPopupOnHide: false,
        },
        '#ddtree'
      );
