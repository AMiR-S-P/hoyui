      ...
      setTimeout(function () {
        ...
        setTimeout(function () {
          ...
          setTimeout(function () {
            ...
            expect(
              document.querySelectorAll('.e-chips-wrapper .e-chipcontent')
                .length
            ).toBe(1);
            expect(
              (
            ...
            expect(ddtreeObj.treeObj.checkedNodes.indexOf('01') !== -1).toBe(
              true
            );
            done();
          }, 100);
