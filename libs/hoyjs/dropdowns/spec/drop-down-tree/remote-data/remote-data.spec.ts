...
xdescribe('DropDownTree control remote datasource', () => {
  ...
  describe('with id as number', () => {
    ...
    it('functionality testing', (done: Function) => {
      ...
      expect(
        ddtreeObj.treeObj.element.querySelector('.e-list-item')
          .childElementCount
      ).toBe(2);
      expect(
        ddtreeObj.treeObj.element
      ...
      setTimeout(function () {
        ...
        expect(
          newli[0]
            .querySelector('.e-icons')
            .classList.contains('e-icons-spinner')
        ).toBe(true);
        this.request = jasmine.Ajax.requests.mostRecent();
        this.request.respondWith({
          status: 200,
  ...
  describe('Remote data Offline', () => {
    ...
    it('functionality testing', (done: Function) => {
      ...
      setTimeout(function () {
        ...
        expect(ddtreeObj.getData('01')[0].nodeChild[0].nodeText).toBe(
          'Gouttes.mp3'
        );
        done();
      }, 450);
  ...
  describe('overflow testing', () => {
    ...
    it('for showCheckBox', () => {
      ...
      let oveflowElement =
        ddtreeObj.inputWrapper.firstElementChild.nextElementSibling;
