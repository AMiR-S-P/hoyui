...
xdescribe('DropDown Tree control Remote datasource', () => {
  describe('property change testing', () => {
    ...
    it('for text', (done: Function) => {
      ...
      expect(
        li[0].querySelector('.e-icons').classList.contains('e-icon-expandable')
      ).toBe(true);
      expect(
        li[0].querySelector('.e-icons').classList.contains('e-icon-collapsible')
      ).toBe(false);
  ...
  describe('property change testing', () => {
    ...
    it('for header template', (done: Function) => {
      ...
      expect(
        ddtreeObj.popupObj.element.firstChild.classList.contains('e-ddt-header')
      ).toBe(true);
  ...
  describe('property change testing', () => {
    ...
    it('footer template', (done: Function) => {
      ...
      expect(ddtreeObj.footerTemplate).toBe(null);
      expect(
        ddtreeObj.popupObj.element.firstChild.classList.contains('e-ddt-footer')
      ).toBe(false);
      let footerTemplate: Element = createElement('div', {
        id: 'footerTemplate',
      });
  ...
  describe('property change testing', () => {
    ...
    let dataManager2: DataManager = new DataManager({
      url: '/TreeView/remoteData2',
    });
    let originalTimeout: any;
    beforeEach((done: Function) => {
      originalTimeout = jasmine.DEFAULT_TIMEOUT_INTERVAL;
  ...
  describe('property change testing for actionFailureTemplate', () => {
    ...
    beforeEach((done: Function) => {
      ...
      let ele: HTMLElement = createElement('input', { id: 'tree1' });
      document.body.appendChild(ele);
      let actionTemplate: Element = createElement('div', {
        id: 'actionTemplate',
      });
