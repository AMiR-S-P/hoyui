...
} from '../../../src/drop-down-tree/drop-down-tree';
import {
  hierarchicalData3,
  filteredhierarchicalData3,
  hierarchicalData3filtering,
  filterData,
...
describe('Hierarchial data filter testing', () => {
  describe('filter basic testing ', () => {
    ...
    it('filter element initial', () => {
      ...
      ddtreeObj.showPopup();
      expect(
        document.querySelectorAll('#' + ddtreeObj.element.id + '_filter_wrap')
          .length
      ).toBe(1);
      expect(
        document.querySelectorAll('#' + ddtreeObj.element.id + '_filter').length
      ).toBe(1);
    });
    ...
    it('filter contains', (done) => {
      ...
      expect(
        ddtreeObj.treeObj.element.querySelectorAll('li.e-list-item').length
      ).toBe(9);
      let filterEle: any = ddtreeObj.popupObj.element.querySelector(
        '#' + ddtreeObj.element.id + '_filter'
      );
      ...
      setTimeout(function () {
        ...
        let li: Element[] = (ddtreeObj as any).treeObj.element.querySelectorAll(
          'li'
        );
          ...
          expect(
            (
              ddtreeObj.treeObj.element
                .querySelector('li.e-list-item.e-active')
                .querySelector('.e-list-text') as HTMLElement
            ).innerText
          ).toBe('China');
    ...
    it('filter StartsWith', (done) => {
      ...
      setTimeout(function () {
        ...
        ddtreeObj.showPopup();
        setTimeout(function () {
          filterEle = ddtreeObj.popupObj.element.querySelector(
            '#' + ddtreeObj.element.id + '_filter'
          );
    ...
    it('filter StartsWith (empty)', (done) => {
      ...
      expect(ddtreeObj.popupDiv.querySelectorAll('li.e-list-item').length).toBe(
        9
      );
      let filterEle: any = ddtreeObj.popupObj.element.querySelector(
        '#' + ddtreeObj.element.id + '_filter'
      ...
      setTimeout(function () {
        expect(
          ddtreeObj.popupDiv.querySelectorAll('li.e-list-item').length
        ).toBe(0);
    ...
    it('filter StartsWith (empty-2)', (done) => {
      ddtreeObj = new DropDownTree(
        {
          fields: {
            dataSource: hierarchicalData3filtering,
            value: 'id',
            text: 'name',
            parentValue: 'pid',
            hasChildren: 'hasChild',
      ...
      setTimeout(function () {
        ...
        expect(ddtreeObj.popupDiv.classList.contains('e-no-data')).toBe(true);
        expect(
          ddtreeObj.popupDiv.querySelectorAll('.e-ddt-nodata').length
        ).toBe(1);
        filterEle.value = '';
        filterObj.value = '';
        let eventArgs: any = { value: '', container: filterEle };
        ...
        setTimeout(function () {
          ...
          setTimeout(function () {
            ...
            expect(ddtreeObj.popupDiv.classList.contains('e-no-data')).toBe(
              true
            );
            expect(
              ddtreeObj.popupDiv.querySelectorAll('.e-ddt-nodata').length
    ...
    it('filter EndsWith to StartWidth', (done) => {
      ...
      setTimeout(function () {
        ...
        setTimeout(function () {
          ...
          expect(ddtreeObj.treeObj.selectedNodes.length).toBe(0);
          expect(
            ddtreeObj.treeObj.element.querySelectorAll(
    ...
    it('filter No Records Found testing', (done) => {
      ...
      setTimeout(function () {
        expect(
          (ddtreeObj as any).popupObj.element.lastChild.classList.contains(
            'e-no-data'
          )
        ).toBe(true);
        expect((ddtreeObj as any).popupObj.element.lastChild.innerText).toBe(
          'No Records Found'
        );
  ...
  describe('filter (multi-selection) testing ', () => {
      ...
      setTimeout(function () {
        ...
        setTimeout(function () {
          ...
          expect(
            (
              ddtreeObj.treeObj.element
                .querySelectorAll('li.e-list-item.e-active')[0]
                .querySelector('.e-list-text') as HTMLElement
            ).innerText
          ).toBe('China');
          expect(
            (
              ddtreeObj.treeObj.element
                .querySelectorAll('li.e-list-item.e-active')[1]
                .querySelector('.e-list-text') as HTMLElement
            ).innerText
          ).toBe('India');
          expect(ddtreeObj.treeObj.selectedNodes.indexOf('11') !== -1).toBe(
            true
          );
          expect(ddtreeObj.treeObj.selectedNodes.indexOf('21') !== -1).toBe(
            true
          );
          expect(
            document.querySelectorAll('.e-chips-wrapper .e-chipcontent').length
          ).toBe(2);
          expect(
            (
              document.querySelectorAll(
                '.e-chips-wrapper .e-chipcontent'
              )[0] as HTMLElement
            ).innerText
          ).toBe('China');
          expect(
    ...
    it('filter with selected item (multiselect)', (done) => {
      ...
      expect(ddtreeObj.treeObj.selectedNodes.length).toBe(1);
      expect(
        ddtreeObj.treeObj.element.querySelectorAll('li.e-list-item.e-active')
          .length
      ).toBe(1);
      expect(
        (
      ...
      setTimeout(function () {
        ...
        setTimeout(function () {
          ...
          expect(
            (
              ddtreeObj.treeObj.element
                .querySelectorAll('li.e-list-item.e-active')[2]
                .querySelector('.e-list-text') as HTMLElement
            ).innerText
          ).toBe('India');
          expect(ddtreeObj.treeObj.selectedNodes.indexOf('1') !== -1).toBe(
            true
          );
          expect(ddtreeObj.treeObj.selectedNodes.indexOf('11') !== -1).toBe(
            true
    ...
    it('closing selected chip on filter', (done) => {
      ...
      setTimeout(function () {
        ...
        let checkEle: Element = document.querySelectorAll(
          '.e-chips-wrapper .e-chips-close'
        )[1];
        let e: MouseEvent = new MouseEvent('mousedown', {
          view: window,
          bubbles: true,
          cancelable: true,
        });
        ...
        setTimeout(function () {
          ...
          setTimeout(function () {
            expect(
              ddtreeObj.treeObj.element.querySelectorAll('li.e-list-item')
                .length
            ).toBe(9);
            expect(ddtreeObj.treeObj.selectedNodes.length).toBe(2);
            expect(ddtreeObj.value.length).toBe(2);
    ...
    it('filter with checkbox', (done) => {
      ...
      setTimeout(function () {
        ...
        setTimeout(function () {
          ...
          expect(
            ddtreeObj.treeObj.element.querySelectorAll(
              'li.e-list-item .e-frame.e-check'
            ).length
          ).toBe(2);
          expect(
            (
          ...
          expect(
            (
              ddtreeObj.treeObj.element.querySelectorAll(
                'li.e-list-item .e-frame.e-check'
              )[1].parentElement.parentElement as HTMLElement
            ).innerText
          ).toBe('India');
          expect(
            document.querySelectorAll('.e-chips-wrapper .e-chipcontent').length
          ...
          expect(ddtreeObj.treeObj.checkedNodes.indexOf('11') !== -1).toBe(
            true
          );
          expect(ddtreeObj.treeObj.checkedNodes.indexOf('21') !== -1).toBe(
            true
          );
          done();
        }, 350);
    ...
    it('filter with selectall', (done) => {
      ...
      expect(
        document
          ...
          .classList.contains('e-hide-selectall')
      ).toBe(false);
      expect(
        ddtreeObj.treeObj.element.querySelectorAll('li.e-list-item').length
      ).toBe(9);
        ...
        setTimeout(function () {
          ...
          expect(
            (
              ddtreeObj.treeObj.element.querySelectorAll(
                'li.e-list-item .e-frame.e-check'
              )[2].parentElement.parentElement as HTMLElement
            ).innerText
          ).toBe('India');
          expect(
            (
