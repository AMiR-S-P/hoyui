import { createElement, setCulture } from '@hoyui/base';
...
describe('DropDown Tree control hierarchical datasource', () => {
  describe('Property testing', () => {
    ...
    it('for selectAllText and unSelectAllText with the node click', () => {
      ...
      expect(
        selectAllElement.querySelector('.e-frame').classList.contains('e-check')
      ).toBe(true);
      var li = (ddtreeObj as any).treeObj.element.querySelectorAll('li');
      mouseEventArgs.target = li[0].querySelector('.e-list-text');
      tapEvent.tapCount = 1;
    ...
    it('button click in headerTemplate', function (done: Function) {
      ...
      setTimeout(function () {
        ...
        ddtreeObj.popupObj.element.firstChild
          .querySelector('#btn')
          .dispatchEvent(e);
        expect(temp).toBe(1);
        ddtreeObj.hidePopup();
    ...
    it('button click in footerTemplate', (done: Function) => {
      ...
      setTimeout(function () {
        ...
        ddtreeObj.popupObj.element.lastElementChild
          .querySelector('#btn')
          .dispatchEvent(e);
        expect(temp).toBe(1);
        ddtreeObj.hidePopup();
  ...
  describe('Performance testing', () => {
    ...
    afterEach((): void => {
      if (ddtreeObj1) ddtreeObj1.destroy();
      jasmine.DEFAULT_TIMEOUT_INTERVAL = originalTimeout;
      document.body.innerHTML = '';
    });
    it('with 1000 nodes', (done) => {
      ...
      setTimeout(() => {
        let li: Element[] = (
          ddtreeObj1.element as any
        ).ej2_instances[0].tree.querySelectorAll('li');
        mouseEventArgs.target = li[0].querySelector('.e-list-text');
