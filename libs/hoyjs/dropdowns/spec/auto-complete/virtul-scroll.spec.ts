...
describe('Autocomplete_Virtualization', () => {
  ...
  let css: string =
    ".e-spinner-pane::after { content: 'Material'; display: none;} .e-list-item{height:36px} .e-dropdownbase.e-content{overflow: auto;max-height: 200px;} ";
  ...
  describe('virtualization key actions', () => {
    ...
    it('virtualization Down key pressed ', (done) => {
      dropObj.showPopup();
      expect(
        dropObj.list.querySelectorAll('li:not(.e-virtual-list)').length
      ).toBe(30);
      ...
      let li: Element[] = dropObj.list.querySelectorAll(
      ...
      expect(
        dropObj.list
          .querySelectorAll('li:not(.e-virtual-list)')[1]
          .classList.contains('e-item-focus')
      ).toBe(true);
      dropObj.isPopupOpen = true;
      setTimeout(function () {
        ...
        setTimeout(function () {
          ...
          expect(dropObj.list.querySelectorAll('.e-virtual-list').length).toBe(
            15
          );
    ...
    it('virtualization Page_down and Page_up key pressed ', (done) => {
      ...
      setTimeout(() => {
        ...
        keyEventArgs.action = 'pageUp';
        dropObj.keyActionHandler(keyEventArgs);
        expect((li[7] as Element).classList.contains('e-item-focus')).toBe(
          true
        );
        keyEventArgs.action = 'pageUp';
        dropObj.keyActionHandler(keyEventArgs);
        expect((li[2] as Element).classList.contains('e-item-focus')).toBe(
          true
        );
        done();
      }, 500);
      ...
      it('virtualization up actions scroll by manually', (done) => {
        ...
        setTimeout(() => {
          ...
          setTimeout(() => {
            ...
            keyEventArgs.action = 'down';
            dropObj.keyActionHandler(keyEventArgs);
            expect((li[2] as Element).classList.contains('e-active')).toBe(
              true
            );
            done();
          }, 500);
    ...
    describe('virtualization remote filtering actions', () => {
      ...
      it('filter a not present item', (done) => {
        ...
        setTimeout(() => {
          ...
          dropObj.onFilterUp(keyEventArgs);
          setTimeout(() => {
            let isNoDataElement: boolean =
              dropObj.list.classList.contains('e-nodata');
      ...
      it('down actions scroll by manually with clear value', (done) => {
        ...
        setTimeout(() => {
          ...
          setTimeout(() => {
            ...
            keyEventArgs.action = 'down';
            dropObj.keyActionHandler(keyEventArgs);
            expect((li[1] as Element).classList.contains('e-active')).toBe(
              true
            );
            done();
          }, 500);
    ...
    describe('Virtualization with clear value', () => {
      ...
      it('clear text value', (done) => {
        ...
        setTimeout(() => {
          ...
          dropObj.clearAll();
          var clearElement =
            dropObj.filterInput.parentElement.querySelector('.e-clear-icon');
  ...
  describe('Custom filtering action', () => {
    ...
    it('', (done) => {
      ...
      //setTimeout(function () {
      var activeElement = dropDowns.list.querySelectorAll(
        'li:not(.e-virtual-list)'
      );
