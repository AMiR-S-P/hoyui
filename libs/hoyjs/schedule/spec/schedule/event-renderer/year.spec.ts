...
import { Browser, createElement, remove } from '@hoyui/base';
import {
  Schedule,
  ScheduleModel,
  Day,
...
describe('Year and TimelineYear View Event Render Module', () => {
  ...
  describe('Testing the year view rendering', () => {
    ...
    it('DOM elements checking', () => {
      const monthCalendar: NodeListOf<Element> =
        schObj.element.querySelectorAll('.e-month-calendar');
    ...
    it('weekNumber elements checking in DOM', (done: DoneFn) => {
      schObj.dataBound = () => {
        const weekNumber: NodeListOf<Element> =
          schObj.element.querySelectorAll('.e-week-number');
    ...
    it('year range checking', (done: DoneFn) => {
      ...
      util.triggerMouseEvent(
        schObj.element.querySelector('.e-schedule-toolbar .e-next'),
        'click'
      );
    });
    ...
    it('more popup events checking', () => {
      ...
      util.triggerMouseEvent(
        schObj.element.querySelector('.e-work-cells:not(.e-other-month)'),
        'click'
      );
      expect(
        schObj.element
  ...
  describe('Testing the min/max date in year view', () => {
    ...
    it('year view min/maxDate checking', (done: Function) => {
      schObj.dataBound = function () {
        util.triggerMouseEvent(
          schObj.element.querySelectorAll('.e-cell.e-work-cells')[6]
        ...
        expect(
          schObj.element
            .querySelectorAll('.e-cell.e-work-cells')[6]
            .classList.contains('e-disable-dates')
        ).toBe(true);
        expect(
          schObj.element.querySelectorAll('.e-cell.e-work-cells')[6].children
            .length
        ).toEqual(1);
        util.triggerMouseEvent(
        ...
        const appointment: HTMLElement = schObj.element.querySelectorAll(
          '.e-cell.e-work-cells'
        )[21].children[1] as HTMLElement;
      ...
      expect(
        schObj.element
          .querySelectorAll('.e-cell.e-work-cells')[6]
          .children[1].classList.contains('e-appointment')
      ).toEqual(true);
  ...
  describe('Testing the min/max dates with resources in Timeline year view', () => {
    ...
    it('Horizontal year checking', (done: Function) => {
      schObj.dataBound = () => {
        util.triggerMouseEvent(
          schObj.element.querySelector('[data-id="Appointment_2"]'),
          'click'
        );
        expect(
          schObj.element
    ...
    it('Vertical year checking', (done: Function) => {
      ...
      util.triggerMouseEvent(
        schObj.element.querySelector('.e-icon-timeline-year-vertical'),
        'click'
      );
      done();
    });
  ...
  describe('Testing the min/max dates without resources in Timeline year view', () => {
    ...
    it('Horizontal year checking', (done: Function) => {
      schObj.dataBound = () => {
        expect(
          schObj.element.querySelectorAll('.e-appointment-wrapper')[0]
            .childNodes.length
        ).toEqual(0);
        expect(
          schObj.element
            .querySelectorAll('.e-work-cells')[106]
            .classList.contains('e-disable-dates')
        ).toBe(true);
        util.triggerMouseEvent(
          schObj.element.querySelector('[data-id="Appointment_3"]'),
          'click'
        );
        expect(
          schObj.element
      ...
      expect(
        schObj.element
          .querySelectorAll('.e-work-cells')[111]
          .classList.contains('e-disable-dates')
      ).toBe(false);
      util.triggerMouseEvent(
        schObj.element.querySelector('[data-id="Appointment_3"]'),
  ...
  describe('Testing the year view rendering in mobile with resources', () => {
    ...
    it('DOM elements checking', () => {
      ...
      const resourceToolbar: NodeListOf<Element> =
  ...
  describe('Testing the more indicators in mobile with resources', () => {
    ...
    it('More indicators checking', () => {
      ...
      expect(
        schObj.element
          .querySelector('.e-more-indicator')
      ...
      const MorePopupWrapper: HTMLElement = document.querySelector(
        '.e-more-popup-wrapper'
      ) as HTMLElement;
      expect(MorePopupWrapper.classList.contains('e-popup-open')).toEqual(true);
      expect(MorePopupWrapper.classList.contains('e-popup-close')).toEqual(
        false
      );
      expect(
        document.querySelector('.e-more-appointment-wrapper').childElementCount
      ).toEqual(2);
      util.triggerMouseEvent(
        document.querySelector('.e-more-event-close'),
        'click'
      );
      expect(MorePopupWrapper.classList.contains('e-popup-open')).toEqual(
        false
      );
      expect(MorePopupWrapper.classList.contains('e-popup-close')).toEqual(
        true
    ...
    it('Spanned appointment checking in mobile mode', () => {
      const spannedApp: HTMLElement = schObj.element.querySelectorAll(
        '.e-appointment'
      )[1] as HTMLElement;
  ...
  describe('Testing the timeline year view appointments rendering without resources', () => {
    ...
    it('Rendered appointments elements checking', () => {
      const appointments: NodeListOf<Element> =
        schObj.element.querySelectorAll('.e-appointment');
      expect(appointments.length).toEqual(8);
      const recurrenceApps: NodeListOf<Element> =
        schObj.element.querySelectorAll('[data-id="Appointment_18"]');
  ...
  describe('Testing the timeline year view rendering with default orientation', () => {
    ...
    it('DOM elements checking', () => {
      const monthHeader: NodeListOf<Element> =
        schObj.element.querySelectorAll('.e-month-header');
      expect(monthHeader.length).toEqual(12);
      const headerCells: NodeListOf<Element> = schObj.element.querySelectorAll(
        '.e-date-header-wrap .e-header-cells'
      );
      expect(headerCells.length).toEqual(36);
      const totalWorkCells: NodeListOf<Element> =
        schObj.element.querySelectorAll('.e-work-cells');
      expect(totalWorkCells.length).toEqual(432);
      const currentMonthCells: NodeListOf<Element> =
        schObj.element.querySelectorAll('.e-work-cells:not(.e-other-month)');
      expect(currentMonthCells.length).toEqual(365);
      const otherMonthCells: NodeListOf<Element> =
        schObj.element.querySelectorAll('.e-work-cells.e-other-month');
    ...
    it('decade calendar testing', () => {
      const dateRange: HTMLElement = schObj.element.querySelector(
        '.e-date-range'
      ) as HTMLElement;
      util.triggerMouseEvent(dateRange, 'click');
      const headerPopup: HTMLElement = schObj.element.querySelector(
      ...
      const headerCalendar: HTMLElement = schObj.element.querySelector(
        '.e-schedule .e-header-calendar'
      ) as HTMLElement;
      expect(headerCalendar.querySelector('.e-day.e-title').innerHTML).toEqual(
        '2010 - 2019'
      );
      util.triggerMouseEvent(dateRange, 'click');
    ...
    it('Scroll dimension checking', (done: DoneFn) => {
      ...
      setTimeout(() => {
        expect(
          schObj.element.querySelector('.e-month-header-wrapper').scrollTop
        ).toEqual(100);
        expect(
          schObj.element.querySelector('.e-date-header-wrap').scrollLeft
        ).toEqual(100);
        done();
      }, 400);
    });
  ...
  describe('Testing the timeline year view rendering with resource in default orientation', () => {
    ...
    it('DOM elements checking', () => {
      const resourceCells: NodeListOf<Element> =
        schObj.element.querySelectorAll(
  ...
  describe('Testing the timeline year view rendering with vertical orientation', () => {
    ...
    it('Current date testing', (done: DoneFn) => {
      schObj.dataBound = () => {
        expect(
          schObj.element.querySelectorAll('.e-month-header.e-current-day')
            .length
        ).toEqual(1);
        expect(
          schObj.element.querySelectorAll('.e-work-cells.e-current-day').length
        ).toEqual(1);
        done();
      };
      expect(
        schObj.element.querySelectorAll('.e-month-header.e-current-day').length
      ).toEqual(0);
      expect(
        schObj.element.querySelectorAll('.e-work-cells.e-current-day').length
      ).toEqual(0);
  ...
  describe('Testing the long spanned event in timeline year view horizontal orientation', () => {
    ...
    it('Testing long spanned event in horizontal year view', () => {
      expect(
        schObj.element.querySelectorAll('[data-id="Appointment_1"]').length
      ).toEqual(5);
    });
  ...
  describe('EJ2-70151 - Event misalignment in timeline year view', () => {
    ...
    beforeAll((done: DoneFn) => {
      ...
      const parentElement: HTMLElement = createElement('div', {
        id: 'ScheduleParent',
        styles: 'height: 1297px',
      });
  ...
  describe('EJ2-70151 - Event misalignment in timeline year view with resources', () => {
    ...
    beforeAll((done: DoneFn) => {
      ...
      const parentElement: HTMLElement = createElement('div', {
        id: 'ScheduleParent',
        styles: 'height: 1297px; width: 1250px;',
      });
      const schEle: HTMLElement = createElement('div', { id: 'Schedule' });
      parentElement.appendChild(schEle);
      schObj = new Schedule(model, schEle);
  ...
  describe('EJ2-855763 - Overlapping different appointments when they are on same date in vertical year view', () => {
    ...
    it('Checking appointment rendering in year view vertical orientation', () => {
      ...
      expect(eventElements[0].offsetTop != eventElements[1].offsetTop).toEqual(
        true
      );
    });
  });
