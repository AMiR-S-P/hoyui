 ...
 */
import { isNullOrUndefined, Browser } from '@hoyui/base';
...
describe('Schedule Resources', () => {
  ...
  describe('Multiple resource with group', () => {
    ...
    it('resource details in quick event popup', () => {
      util.triggerMouseEvent(
        schObj.element.querySelectorAll('.e-appointment')[3] as HTMLElement,
        'click'
      );
    ...
    it('current time indicator testing without group by-date', (done: DoneFn) => {
      schObj.dataBound = () => {
        expect(
          schObj.element.querySelector('.e-current-timeline')
        ).not.toBeNull();
        expect(
      ...
      schObj.dataBound = () => {
        expect(
          schObj.element.querySelectorAll(
            '.e-date-header-wrap .e-schedule-table tbody tr'
          ).length
        ).toBe(4);
        expect(
          schObj.element.querySelectorAll(
        ...
        expect(
          schObj.element.querySelectorAll('.e-date-header-wrap .e-header-cells')
            .length
        ).toBe(7);
        expect(
          schObj.element.querySelector('.e-current-timeline')
  ...
  describe('Multiple resource group with custom workdays and hours', () => {
    ...
    it('setmodel - byDate testing', () => {
      ...
      expect(
        schObj.element.querySelectorAll('.e-work-cells:not(.e-work-hours)')
          .length
      ).toEqual(34 * 5 + 30 * 5);
    });
  });
  ...
  describe('Resource expand/collapse icon checking', () => {
    ...
    it('checking resource expand/collapse icon when it has no child', () => {
      const resourceRow: HTMLElement[] = [].slice.call(
        schObj.element.querySelectorAll('.e-resource-cells.e-parent-node')
      );
      expect(
        resourceRow[1].parentElement.classList.contains('e-hidden')
      ).toEqual(false);
      expect(
        resourceRow[1].children[0].classList.contains('e-resource-tree-icon')
      ).toEqual(true);
      expect(
        resourceRow[1].children[0].classList.contains('e-resource-collapse')
      ).toEqual(true);
      expect(
        resourceRow[2].parentElement.classList.contains('e-hidden')
      ).toEqual(false);
      expect(
        resourceRow[2].children[0].classList.contains('e-resource-tree-icon')
      ).toEqual(false);
      expect(
        resourceRow[2].children[0].classList.contains('e-resource-collapse')
      ).toEqual(false);
      util.triggerMouseEvent(
        resourceRow[0].children[0] as HTMLElement,
        'click'
      );
      expect(
        resourceRow[1].parentElement.classList.contains('e-hidden')
      ...
      expect(
        schObj.eventWindow.dialogObject.element.querySelectorAll('.e-resources')
          .length
      ).toEqual(3);
    });
    ...
    it('setting group resource as empty', (done: DoneFn) => {
      ...
      schObj.dataBound = () => {
        expect(
          schObj.eventWindow.dialogObject.element.querySelectorAll(
            '.e-resources'
          ).length
        ).toEqual(3);
        done();
  ...
  describe('Public methods for resource expand/collapse ', () => {
    ...
    it('To check for resource expand', () => {
      ...
      expect(
        schObj.element.querySelectorAll('.e-resource-expand').length
      ).toEqual(1);
      expect(
        schObj.element.querySelectorAll(
          '.e-resource-column-wrap tbody tr:not(.e-hidden)'
      ...
      expect(
        schObj.element
          .querySelector('[data-group-index="0"]')
          .classList.contains('e-parent-node')
      ).toEqual(true);
      expect(
        schObj.element
          .querySelector('[data-group-index="0"] .e-resource-tree-icon')
          .classList.contains('e-resource-collapse')
      ).toEqual(true);
    });
    it('To check for resource collapse', () => {
      schObj.collapseResource(2, 'Rooms');
      expect(
        schObj.element.querySelectorAll('.e-resource-collpase').length
      ).toEqual(0);
      expect(
        schObj.element.querySelectorAll(
          '.e-resource-column-wrap tbody tr:not(.e-hidden)'
      ...
      expect(
        schObj.element
          .querySelector('[data-group-index="3"]')
          .classList.contains('e-parent-node')
      ).toEqual(true);
      expect(
        schObj.element
          .querySelector('[data-group-index="3"] .e-resource-tree-icon')
          .classList.contains('e-resource-expand')
      ).toEqual(true);
    });
  });
  ...
  describe('Public methods checking for resources', () => {
    ...
    it('Initial resource testing', () => {
      expect(
        (<Record<string, any>[]>schObj.resources.slice(-1)[0].dataSource).length
      ).toEqual(3);
    });
    ...
    it('quick cell popup testing', () => {
      ...
      const quickPopup: HTMLElement = schObj.element.querySelector(
        '.e-quick-popup-wrapper'
      ) as HTMLElement;
    ...
    it('Public method for add resource', () => {
      schObj.addResource(
        { Text: 'New Resource', Id: 11, GroupID: 1, Color: '#7499e1' },
        'Owners',
        1
      );
      expect(
        (<Record<string, any>[]>(
          schObj.resourceCollection.slice(-1)[0].dataSource
        )).length
      ).toEqual(4);
    });
    ...
    it('Public method setWorkHours checking with resource', () => {
      ...
      schObj.dataBind();
      expect(
        schObj.element.querySelectorAll('.e-work-hours[data-group-index="1"]')
          .length
      ).toEqual(0);
  ...
  describe('Add resources dynamically', () => {
    ...
    it('Test eventwindow and datasource length', (done: DoneFn) => {
      schObj.dataBound = () => {
        ...
        expect(
          (schObj.resourceCollection[0].dataSource as Record<string, any>[])
            .length
        ).toEqual(1);
        done();
      };
  ...
  describe('Multiple resource grouping rendering in mobile device', () => {
    ...
    const androidUserAgent: string =
      'Mozilla/5.0 (Linux; Android 9; Pixel XL Build/PPP3.180510.008) ' +
    ...
    it('resource menu click testing', () => {
      const treePopup: Popup = (
        schObj.element.querySelector('.e-resource-tree-popup') as EJ2Instance
      ).ej2_instances[0] as Popup;
    ...
    xit('document click testing', () => {
      ...
      const popupWrapper: HTMLElement = schObj.element.querySelector(
      ...
      const resourceToolbar: HTMLElement = schObj.element.querySelector(
    ...
    it('resource node click testing - child node', (done: DoneFn) => {
      ...
      const nodeElement: Element = schObj.element.querySelector(
        '.e-resource-tree .e-list-item:not(.e-has-child):not(.e-active)'
      );
      (schObj.resourceBase as any).resourceClick({
    ...
    it('Negative case for resource with timescale', (done: DoneFn) => {
      schObj.dataBound = () => {
        ...
        const emptyCell: HTMLElement[] = [].slice.call(
          schObj.element.querySelectorAll('.e-work-cells')
        );
  ...
  describe('Negative testcases for resource grouping rendering in mobile device', () => {
    ...
    it('last level resource datasource is defined', (done: DoneFn) => {
      schObj.dataBound = () => {
        expect(
          schObj.element.querySelectorAll('.e-work-cells').length
        ).toBeGreaterThan(0);
        done();
      };
      expect(schObj.element.querySelectorAll('.e-work-cells').length).toEqual(
  ...
  describe('Checking scroll to resource public method', () => {
    ...
    it('Checking scroll to resource method on Timeline month view', () => {
      schObj.scrollToResource(3);
      const conWrap: HTMLElement = schObj.element.querySelector(
        '.e-content-wrap'
      ) as HTMLElement;
      ...
      (
        schObj.element.querySelector(
          '.e-resource-tree-icon.e-resource-collapse'
        ) as HTMLElement
      ).click();
      schObj.scrollToResource(1, 'Categories');
      expect(conWrap.scrollTop).toBeGreaterThanOrEqual(59);
  ...
  describe('EJ2-55924-Resource appointments are rendered in default appointment colors', () => {
    ...
    it('Checking resource appointment color', () => {
      const appElements: NodeListOf<Element> = schObj.element.querySelectorAll(
        '[data-id="Appointment_1"]'
      );
      expect((appElements[0] as HTMLElement).style.backgroundColor).toEqual(
        'rgb(255, 170, 0)'
      );
      expect((appElements[1] as HTMLElement).style.backgroundColor).toEqual(
        'rgb(116, 153, 225)'
      );
      expect((appElements[2] as HTMLElement).style.backgroundColor).toEqual(
        'rgb(248, 163, 152)'
      );
    });
  });
  ...
  describe('custom workDays with group by date support for vertical views', () => {
    ...
    it('checked resources and dates checked for week view', () => {
      ...
      expect(
        schObj.element.querySelectorAll('.e-header-day')[0].innerHTML
      ).toEqual('Mon');
      expect(
        schObj.element.querySelectorAll('.e-header-day')[1].innerHTML
      ).toEqual('Tue');
      expect(
        schObj.element.querySelectorAll('.e-header-day')[2].innerHTML
      ).toEqual('Wed');
      expect(
        schObj.element.querySelectorAll('.e-header-day')[3].innerHTML
      ).toEqual('Thu');
      expect(
        schObj.element.querySelectorAll('.e-header-day')[4].innerHTML
      ).toEqual('Sat');
      expect(
        schObj.element.querySelector('[data-id="Appointment_5"]').children[1]
      ...
      const saveButton: HTMLElement = schObj.element.querySelector(
        '.e-event-create'
      ) as HTMLElement;
      saveButton.click();
      expect(schObj.element.querySelectorAll('.e-appointment').length).toEqual(
    ...
    it('checked for different resource for week view ', () => {
      const middleResource: HTMLCollection =
        schObj.element.querySelectorAll('.e-header-row')[2].children;
    ...
    it('checked for resources length for week view', () => {
      expect(
        schObj.element.querySelectorAll('.e-header-row')[2].children.length
      ).toEqual(16);
    });

    it('checked colspan for week view', () => {
      const firstLevelResource: NodeListOf<Element> =
    ...
    it('checked resources and dates for day view', (done: DoneFn) => {
      ...
      schObj.dataBound = () => {
        expect(
          schObj.element.querySelectorAll('.e-header-cells').length
        ).toEqual(2);
        expect(
          schObj.element.querySelectorAll('.e-header-day')[0].innerHTML
        ).toEqual('Mon');
        expect(firstLevelResource[1].getAttribute('colspan')).toEqual('2');
        expect(
          schObj.element.querySelectorAll('.e-header-row')[2].firstElementChild
            .firstElementChild.innerHTML
        ).toEqual('Nancy');
        expect(
          schObj.element.querySelectorAll('.e-header-row')[2].children.length
    ...
    it('checked next date checked for day view', (done: DoneFn) => {
      ...
      schObj.dataBound = () => {
        ...
        expect(
          schObj.element.querySelectorAll('.e-header-row')[2].lastElementChild
            .firstElementChild.innerHTML
        ).toEqual('Michael');
        expect(
          schObj.element.querySelectorAll('.e-header-row')[2].children.length
    ...
    it('checked previous date checked for day view', (done: DoneFn) => {
      const previousElement: HTMLElement =
        schObj.element.querySelector('.e-prev');
  ...
  describe('custom workDays with group by date support for month view', () => {
    ...
    it('checked layout rendering with enabled hideNonWorkingDays property', (done: DoneFn) => {
      schObj.dataBound = () => {
        ...
        expect(
          schObj.element.querySelectorAll('.e-work-cells')[20].lastElementChild
            .classList
        ).toContain('e-appointment-wrapper');
        done();
      };
      expect(schObj.element.querySelectorAll('.e-header-cells').length).toEqual(
        5
      ...
      expect(
        (schObj.element.querySelectorAll('.e-header-cells')[0] as HTMLElement)
          .innerText
      ).toEqual('Mon');
      expect(
        (schObj.element.querySelectorAll('.e-header-cells')[4] as HTMLElement)
          .innerText
      ).toEqual('Sat');
      expect(
        schObj.element.querySelectorAll('.e-date-header-wrap tbody tr')[1]
          .childElementCount
      ).toEqual(7);
      expect(
        schObj.element.querySelectorAll('.e-date-header-wrap tbody tr')[2]
          .childElementCount
      ).toEqual(8);
      expect(schObj.element.querySelectorAll('.e-appointment').length).toEqual(
        4
      ...
      expect(
        schObj.element
          .querySelector('.e-work-cells')
          .getAttribute('data-group-index')
      ).toEqual('0');
      expect(
        schObj.element
          .querySelectorAll('.e-work-cells')[4]
          .getAttribute('data-group-index')
      ).toEqual('2');
      util.triggerMouseEvent(
        schObj.element.querySelectorAll('.e-work-cells')[20] as HTMLElement,
        'click'
      );
      const saveButton: HTMLElement = schObj.element.querySelector(
        '.e-event-create'
    ...
    it('checked layout rendering with enabled hideNonWorkingDays and disabled showWeekend property', (done: DoneFn) => {
      schObj.dataBound = () => {
        ...
        expect(
          (schObj.element.querySelectorAll('.e-header-cells')[3] as HTMLElement)
            .innerText
        ).toEqual('Thu');
        expect(
          schObj.element.querySelectorAll('.e-date-header-wrap tbody tr')[1]
        ...
        expect(
          schObj.element
            .querySelectorAll('.e-work-cells')[6]
            .getAttribute('data-group-index')
        ).toEqual('2');
        expect(
          schObj.element.querySelectorAll('.e-week-number-wrapper tbody tr')
            .length
        ).toBe(5);
        expect(
          schObj.element.querySelector('.e-week-number').innerHTML
        ).toEqual('14');
        done();
      };
    ...
    it('checked layout rendering with enabled hideNonWorkingDays and schedule workdays property', (done: DoneFn) => {
      schObj.dataBound = () => {
        ...
        expect(
          (schObj.element.querySelectorAll('.e-header-cells')[2] as HTMLElement)
            .innerText
        ).toEqual('Sat');
        expect(
          schObj.element.querySelectorAll('.e-date-header-wrap tbody tr')[1]
        ...
        expect(
          schObj.element
            .querySelectorAll('.e-work-cells')[3]
            .getAttribute('data-group-index')
        ).toEqual('1');
        expect(
          schObj.element.querySelectorAll('.e-week-number').length
        ).toEqual(0);
        done();
      };
    ...
    it('checked layout rendering with enabled hideNonWorkingDays and firstDayOfWeek property', (done: DoneFn) => {
      schObj.dataBound = () => {
        ...
        expect(
          schObj.element
            .querySelectorAll('.e-header-cells')[0]
            .getAttribute('colspan')
        ).toEqual('2');
        expect(
          schObj.element
            .querySelectorAll('.e-header-cells')[1]
            .getAttribute('colspan')
        ).toEqual('1');
        done();
      };
    ...
    it('Adding inline appointments with hideNonWorkingDays', (done: DoneFn) => {
      schObj.dataBound = () => {
        ...
        expect(
          (eventElementList[4].querySelector('.e-subject') as HTMLElement)
            .innerHTML
        ).toBe('Testing');
        done();
      };
      const targetWorkCell: HTMLElement = schObj.element.querySelectorAll(
        '.e-work-cells'
      )[19] as HTMLElement;
  ...
  describe('custom workDays with group by date support for Week view', () => {
    ...
    it('checked layout rendering with enabled hideNonWorkingDays property', (done: DoneFn) => {
      ...
      expect(schObj.element.querySelectorAll('.e-header-row').length).toEqual(
        3
      );
      expect(
        schObj.element.querySelector('.e-header-row').childElementCount
      ).toEqual(5);
      expect(
        (
          schObj.element.querySelector('.e-header-row td')
            .firstElementChild as HTMLElement
        ).innerText
      ).toEqual('Mon');
      expect(
        (
          schObj.element.querySelector('.e-header-row').lastElementChild
            .firstElementChild as HTMLElement
        ).innerText
      ).toEqual('Sat');
      expect(
      ...
      util.triggerMouseEvent(
        schObj.element.querySelectorAll('.e-work-cells')[180] as HTMLElement,
        'click'
      );
      expect(
        schObj.element.querySelectorAll('.e-appointment-wrapper')[4]
    ...
    it('checked layout rendering with enabled hideNonWorkingDays and disabled showWeekend property', (done: DoneFn) => {
      schObj.dataBound = () => {
        ...
        expect(
          schObj.element.querySelector('.e-left-indent-wrap td').classList
        ).toContain('e-week-number');
        expect(
          (schObj.element.querySelector('.e-week-number') as HTMLElement)
            .innerText
        ).toEqual('14');
        expect(
          (
    ...
    it('checked layout rendering with enabled hideNonWorkingDays and schedule workdays property', (done: DoneFn) => {
      schObj.dataBound = () => {
        ...
        expect(
          schObj.element
            .querySelector('.e-left-indent-wrap td')
    ...
    it('checked layout rendering with enabled hideNonWorkingDays and firstDayOfWeek property', (done: DoneFn) => {
      schObj.dataBound = () => {
        ...
        expect(
          schObj.element
            .querySelectorAll('.e-header-row td')[0]
            .getAttribute('colspan')
        ).toEqual('2');
        expect(
          schObj.element
            .querySelectorAll('.e-header-row')[1]
            .firstElementChild.getAttribute('colspan')
        ).toEqual('1');
        expect(
          (
            schObj.element.querySelector(
    ...
    it('Adding allday inline appointments with hideNonWorkingDays', (done: DoneFn) => {
      schObj.dataBound = () => {
        ...
        const alldayApp: Element[] = [].slice.call(
          schObj.element.querySelectorAll('.e-all-day-appointment')
        );
        expect(eventElementList.length).toEqual(7);
        expect(alldayApp.length).toEqual(2);
        expect(
          (alldayApp[0].querySelector('.e-subject') as HTMLElement).innerHTML
        ).toBe('Allday appointment');
        done();
      };
      const targetWorkCell: HTMLElement = schObj.element.querySelectorAll(
        '.e-all-day-cells'
    ...
    it('checked hideNonWorkingDays property without providing workdays field in resource datasource', (done: DoneFn) => {
      schObj.dataBound = () => {
        ...
        expect(
          schObj.element.querySelectorAll('.e-header-row')[1].childElementCount
        ).toEqual(10);
        expect(
          schObj.element.querySelectorAll('.e-header-row')[2].childElementCount
        ).toEqual(15);
        expect(
          schObj.element.querySelector('.e-all-day-row').childElementCount
        ).toEqual(15);
        expect(schObj.element.querySelectorAll('.e-work-cells').length).toEqual(
          720
        );
        expect(
          schObj.element
            .querySelectorAll('.e-work-cells')[0]
            .getAttribute('data-group-index')
        ).toEqual('0');
        expect(
          schObj.element
            .querySelectorAll('.e-work-cells')[1]
            .getAttribute('data-group-index')
        ).toEqual('1');
        expect(
          schObj.element
            .querySelectorAll('.e-work-cells')[2]
            .getAttribute('data-group-index')
        ).toEqual('2');
        done();
      };
  ...
  describe('custom workDays with group byDate hideNonWorkingDays property for Week view', () => {
    ...
    it('Checking Timescale disabled layout', (done: DoneFn) => {
      schObj.dataBound = () => {
        ...
        expect(
          schObj.element.querySelectorAll('.e-work-cells')[4].childElementCount
        ).toBe(1);
        done();
      };
      expect(schObj.element.querySelectorAll('.e-header-row').length).toEqual(
      ...
      util.triggerMouseEvent(
        schObj.element.querySelectorAll('.e-work-cells')[4] as HTMLElement,
        'click'
      );
      const saveButton: HTMLElement = schObj.element.querySelector(
        '.e-event-create'
