 ...
 */
import { createElement, HijriParser } from '@hoyui/base';
import { Islamic, Calendar, DateTimePicker } from '@hoyui/calendars';
import {
  Schedule,
  Day,
  Week,
...
describe('Schedule Islamic Calendar', () => {
  ...
  describe('Islamic in Day view', () => {
    ...
    it('hijri date checking', () => {
      ...
      const hijriObject: Record<string, any> = HijriParser.getHijriDate(
        date
    ...
    it('checking gregorian date', () => {
      ...
      expect(
        ...
        '<div class="e-header-day">Wed</div><div class="e-header-date e-navigate" role="link">9</div>'
      );
      expect(
        schObj.element.querySelector('.e-date-range .e-tbar-btn-text').innerHTML
      ).toEqual('January 9, 2019');
    });
  });
  describe('Islamic in Week view', () => {
    ...
    it('hijri date checking', () => {
      ...
      expect(
        schObj.element.querySelector('.e-date-range .e-tbar-btn-text').innerHTML
      ).toEqual('Rabiʻ II 30 - 06, 1440');
      let hijriObject: Record<string, any> = HijriParser.getHijriDate(
        date
      ) as Record<string, any>;
      ...
      const lastDate: Date = new Date(
        parseInt(
          schObj.element
            .querySelector('.e-date-header-wrap table tr td:nth-child(7)')
            .getAttribute('data-date'),
          10
        )
      );
    ...
    it('checking gregorian date', () => {
      ...
      expect(
        ...
        '<div class="e-header-day">Sun</div><div class="e-header-date e-navigate" role="link">6</div>'
      );
      expect(
        schObj.element.querySelector('.e-date-range .e-tbar-btn-text').innerHTML
      ).toEqual('January 06 - 12, 2019');
      expect(
  ...
  describe('Islamic in Work Week view', () => {
    ...
    it('hijri date checking', () => {
      ...
      const lastDate: Date = new Date(
        parseInt(
          schObj.element
            .querySelector('.e-date-header-wrap table tr td:nth-child(5)')
            .getAttribute('data-date'),
          10
        )
      );
    ...
    it('checking gregorian date', () => {
      ...
      expect(
        ...
        '<div class="e-header-day">Mon</div><div class="e-header-date e-navigate" role="link">7</div>'
      );
      expect(
        schObj.element.querySelector('.e-date-range .e-tbar-btn-text').innerHTML
      ).toEqual('January 07 - 11, 2019');
      expect(
        schObj.element.querySelector(
          '.e-time-cells-wrap .e-schedule-table tr td'
        ).innerHTML
  ...
  describe('Islamic in Month view', () => {
    ...
    it('elements count', () => {
      expect(
        schObj.element.querySelectorAll('.e-content-wrap tr td').length
      ).toBe(35);
    });
    it('(Muharram1440) month element checking', () => {
      ...
      expect(
        schObj.element.querySelector('.e-date-range .e-tbar-btn-text').innerHTML
      ).toEqual('Muharram 1440');
      expect(
        schObj.element.querySelectorAll('tr td.e-other-month').length
      ).toBe(6);
    });
  ...
  describe('Check locale objects in default culture', () => {
    ...
    it('checking day names', () => {
      expect(
        (
          schObj.element.querySelector(
            '.e-date-header-container .e-header-cells .e-header-day'
          ) as HTMLElement
        ).innerText
      ).toEqual('Sun');
    });
    it('checking date format', () => {
      expect(
        schObj.element.querySelector(
          '.e-date-header-container .e-header-cells .e-header-date'
        ).innerHTML
      ).toEqual('16');
    });
    ...
    it('Checking locale object in recurrence editor window', () => {
      ...
      const weekPos: DropDownList = (
        dialogElement.querySelector('.e-month-pos') as EJ2Instance
      ).ej2_instances[0] as DropDownList;
      ...
      const month: DropDownList = (
        dialogElement.querySelector('.e-year-expander-element') as EJ2Instance
      ).ej2_instances[0] as DropDownList;
  ...
  describe('checking rule', () => {
    ...
    beforeAll(() => {
      ...
      recObj = new RecurrenceEditor({
        startDate: new Date('Tue, 06 May 2014'),
        firstDayOfWeek: 1,
        calendarMode: 'Islamic',
      });
    ...
    it('getRuleSummary', () => {
      recObj.setRecurrenceRule(
        'FREQ=YEARLY;BYDAY=MO;BYSETPOS=4;BYMONTH=4;INTERVAL=2;COUNT=10;'
      );
      expect(recObj.getRecurrenceRule()).toBe(
        'FREQ=YEARLY;BYDAY=MO;BYSETPOS=4;BYMONTH=4;INTERVAL=2;COUNT=10;'
      );
      expect('every 2 year(s) on Rab. II Fourth Mon, 10 time(s)').toBe(
        recObj.getRuleSummary()
      );
      recObj.calendarMode = 'Gregorian';
      expect('every 2 year(s) on Apr Fourth Mon, 10 time(s)').toBe(
        recObj.getRuleSummary()
      );
    });
  });
