...
describe('Keyboard interaction', () => {
  ...
  describe('vertical view', () => {
    ...
    beforeAll((done: DoneFn) => {
      const elem: HTMLElement = createElement('div', {
        id: 'Schedule',
        attrs: { tabIndex: '1' },
      });
    ...
    it('ctrl right arrow key', () => {
      ...
      (
        schObj.headerModule.element.querySelector(
          '.e-next button'
        ) as HTMLElement
      ).focus();
      expect(
    ...
    it('Es-832039 - keyboard arrow keys scroll action will move the selected cell beyond viewport', () => {
      const scrollTop: number =
        schObj.element.querySelector('.e-content-wrap').scrollTop;
      ...
      expect(schObj.element.querySelector('.e-content-wrap').scrollTop).toBe(
        scrollTop
      );
      keyModule.keyActionHandler({
        action: 'upArrow',
  ...
  describe('vertical view with appointments', () => {
    ...
    it('Tab key work cell to appointment selection', () => {
      const allDayRowCells: HTMLElement[] = [].slice.call(
        schObj.element.querySelector('.e-all-day-row').children
      );
      ...
      let target: HTMLElement[] = [].slice.call(
      ...
      expect(target[0].classList.contains('e-appointment-border')).toEqual(
        false
      );
      ...
      expect(target[0].getAttribute('data-guid')).not.toEqual(
        document.activeElement.getAttribute('data-guid')
      );
      target = [].slice.call(schObj.element.querySelectorAll('.e-appointment'));
      keyModule.keyActionHandler({
        action: 'tab',
      ...
      expect(target.slice(-1)[0].getAttribute('data-guid')).not.toEqual(
        document.activeElement.getAttribute('data-guid')
      );
    });
    it('Escape key', () => {
      (schObj.element.querySelector('.e-appointment') as HTMLElement).click();
      const firstWorkCell: HTMLElement[] = [].slice.call(
        schObj.element.querySelectorAll('.e-appointment-border')
      );
      ...
      const popup: HTMLElement = schObj.element.querySelector(
        '.e-quick-popup-wrapper'
      ) as HTMLElement;
      expect(popup.classList.contains('e-popup-open')).toEqual(true);
      keyModule.keyActionHandler({ action: 'escape' });
      expect(
        schObj.element.querySelectorAll('.e-appointment-border').length
      ).toEqual(1);
    });
    it('Enter key', () => {
      ...
      keyModule.keyActionHandler({
        action: 'enter',
        target: schObj.element.querySelector('.e-work-cells'),
      });
      expect(popup.classList).toContain('e-popup-open');
      keyModule.keyActionHandler({ action: 'escape' });
      expect(popup.classList).toContain('e-popup-close');
    ...
    it('Enter key for edit option', () => {
      ...
      let popup: HTMLElement = schObj.element.querySelector(
        '.e-quick-popup-wrapper'
      ) as HTMLElement;
      expect(popup).toBeTruthy();
      keyModule.keyActionHandler({
        action: 'enter',
        target: popup.querySelector('.e-event-edit'),
        shiftKey: false,
        preventDefault: (): void => {
          /** Null */
        },
      ...
      appointments[0].click();
      popup = schObj.element.querySelector(
        '.e-quick-popup-wrapper'
      ) as HTMLElement;
      expect(popup).toBeTruthy();
      keyModule.keyActionHandler({
        action: 'enter',
        target: popup.querySelector('.e-event-delete'),
        shiftKey: false,
        preventDefault: (): void => {
          /** Null */
        },
    ...
    it('Enter key to work cell for create option', () => {
      ...
      expect(firstWorkCell[firstWorkCell.length - 10].classList).not.toContain(
        'e-selected-cell'
      );
      expect(
        firstWorkCell[firstWorkCell.length - 10].getAttribute('aria-selected')
      ).toEqual('false');
      ...
      keyModule.keyActionHandler({
        action: 'enter',
        target: popup.querySelector('.e-event-details'),
        shiftKey: false,
        preventDefault: (): void => {
          /** Null */
        },
      ...
      keyModule.keyActionHandler({
        action: 'enter',
        target: popup.querySelector('.e-event-create'),
        shiftKey: false,
        preventDefault: (): void => {
          /** Null */
        },
      ...
      keyModule.keyActionHandler({
        action: 'enter',
        target: popup.querySelector('.e-subject'),
        shiftKey: false,
        preventDefault: (): void => {
          /** Null */
        },
    ...
    it('ShiftTab key work cell to appointment selection', () => {
      ...
      const workCell: HTMLElement = allDayRowCells[
        allDayRowCells.length - 1
      ] as HTMLElement;
      workCell.click();
      keyModule.keyActionHandler({ action: 'escape' });
      keyModule.keyActionHandler({
  ...
  describe('vertical view with appointments-month view', () => {
    ...
    it('Escape key', () => {
      const moreIndicator: HTMLElement = schObj.element.querySelector(
        '.e-more-indicator'
      ) as HTMLElement;
      moreIndicator.click();
      const popup: HTMLElement = schObj.element.querySelector(
      ...
      keyModule.keyActionHandler({
        action: 'tab',
        target: popup.querySelector('.e-header-date'),
        shiftKey: false,
        preventDefault: (): void => {
          /** Null */
        },
    ...
    it('Enter key to close more event list', () => {
      ...
      keyModule.keyActionHandler({
        action: 'enter',
        target: popup.querySelector('.e-more-event-close'),
      });
      expect(popup).toBeTruthy();
      expect(
        schObj.element.querySelectorAll('.e-selected-cell').length
    ...
    it('Tab key for more event list', () => {
      const moreIndicator: HTMLElement[] = [].slice.call(
      ...
      const apps: HTMLElement[] = [].slice.call(
        popup.querySelectorAll('.e-appointment')
      );
      apps[apps.length - 1].focus();
      keyModule.keyActionHandler({
        action: 'tab',
        target: apps[apps.length - 1],
        shiftKey: false,
        preventDefault: (): void => {
          /** Null */
        },
  ...
  describe('vertical view with appointments for agenda view', () => {
    ...
    it('Right arrow key with appointment selection', () => {
      ...
      expect(
        schObj.element.querySelectorAll('.e-active-appointment-agenda').length
      ).toEqual(1);
      expect(
        schObj.element.querySelectorAll('.e-appointment-border').length
      ).toEqual(1);
  ...
  describe('vertical arrow keys', () => {
    ...
    it('multiple allday cells selection via mouse', () => {
      const alldayCells: HTMLElement[] = [].slice.call(
        schObj.element.querySelectorAll(
          '.e-date-header-container .e-all-day-cells'
        )
      );
    ...
    it('mouse move out of schedule while selection via mouse', () => {
      ...
      util.triggerMouseEvent(workCells[2], 'mousedown');
      util.triggerMouseEvent(
        schObj.element.querySelector('.e-time-cells') as HTMLElement,
        'mousemove'
      );
    ...
    it('down arrow', () => {
      keyModule.keyActionHandler({ action: 'home' });
      const targetCell: HTMLElement = schObj.element.querySelector(
        '.e-work-cells'
      ) as HTMLElement;
      keyModule.keyActionHandler({
        action: 'downArrow',
    ...
    it('down arrow - last row cell', () => {
      const target: HTMLElement = schObj.element.querySelectorAll(
        '.e-work-cells'
      )[335] as HTMLElement;
      target.click();
      keyModule.keyActionHandler({ action: 'escape' });
    ...
    it('up arrow', () => {
      const targetCell: HTMLElement = schObj.element.querySelectorAll(
        '.e-work-cells'
      )[18] as HTMLElement;
      targetCell.click();
      keyModule.keyActionHandler({ action: 'escape' });
  ...
  describe('vertical month view arrow keys', () => {
    ...
    it('down arrow - last row cell', () => {
      const workCell: HTMLElement[] = [].slice.call(
        schObj.element.querySelectorAll('.e-work-cells')
      );
    ...
    it('right arrow', () => {
      ...
      keyModule.keyActionHandler({
        action: 'rightArrow',
        target: schObj.element.querySelector('.e-header-cells'),
      });
    });
  ...
  describe('Event Navigation in resource grouping through ctrl plus shift keys', () => {
    ...
    it('Ctrl plus Shift plus Right arrow', () => {
      const targetEvent: HTMLElement = schObj.element.querySelectorAll(
        '.e-appointment'
      )[0] as HTMLElement;
      targetEvent.click();
      ...
      expect(
        schObj.element
          .querySelector('.e-appointment-border')
          .getAttribute('data-group-index')
      ).toBe('0');
      keyModule.keyActionHandler({
        action: 'ctrlShiftRightArrow',
        shiftKey: true,
        target: targetEvent,
      });
      expect(
  ...
  describe('Cell selection with Resource', () => {
    ...
    it('shiftRight arrow', () => {
      ...
      const lastCell: HTMLTableCellElement =
        document.activeElement as HTMLTableCellElement;
    ...
    it('EJ2-69432 - select event not invoked for single cell navigation', (done: DoneFn) => {
      ...
      schObj.select = (args: SelectEventArgs) => {
        ...
        expect(
          workCells[406].classList.contains('e-selected-cell')
        ).toBeFalsy();
        done();
      };
  ...
  describe('Timeline view with appointments', () => {
    ...
    it('Tab key work cell to appointment selection', () => {
      ...
      const eventCell: HTMLElement =
        schObj.element.querySelector('.e-event-table');
      keyModule.keyActionHandler({
        action: 'tab',
        target: eventCell,
        shiftKey: false,
    ...
    it('ShiftTab key work cell to appoitnment selection', () => {
      const workCells: HTMLElement[] = [].slice.call(
        schObj.element.querySelectorAll('.e-event-table .e-appointment-wrapper')
      );
    ...
    it('Negative case for Tab key work cell selection', () => {
      const workCells: HTMLElement[] = [].slice.call(
        schObj.element.querySelector('.e-content-wrap table tr').children
      );
  ...
  describe('Cell selection with Resource', () => {
    ...
    it('tab key on resource cells', () => {
      const targetEle: HTMLElement[] = [].slice.call(
        schObj.element.querySelectorAll('.e-resource-tree-icon')
      );
      targetEle[0].click();
      targetEle[1].click();
      (
        schObj.element.querySelector(
          '.e-resource-cells[data-group-index="' + 10 + '"]'
        ) as HTMLElement
      ).focus();
      expect(schObj.element.querySelector('.e-content-wrap').scrollTop).toEqual(
        0
      );
      keyModule.keyActionHandler({
        action: 'tab',
      ...
      keyModule.keyActionHandler({
        action: 'tab',
        target: schObj.element.querySelector('.e-resource-cells'),
        shiftKey: false,
      });
      expect(schObj.element.querySelector('.e-content-wrap').scrollTop).toEqual(
        0
  ...
  describe('Keyboard interaction with enabled virtual scroll', () => {
    ...
    it('Tab key with enabled virtual scroll', (done: DoneFn) => {
      keyModule.keyActionHandler({
        action: 'tab',
        target: schObj.element.querySelector('.e-schedule-toolbar button'),
        shiftKey: false,
        preventDefault: (): void => {
          /** Null */
        },
      ...
      expect(
        schObj.element
          .querySelectorAll('.e-resource-cells')[1]
          .getAttribute('tabindex')
      ).toBe('0');
      expect(
        schObj.element
      ...
      expect(
        schObj.element
          .querySelectorAll('.e-resource-cells')[3]
          .classList.contains('e-child-node')
      ).toBe(true);
      keyModule.keyActionHandler({
        action: 'tab',
        target: schObj.element.querySelectorAll('.e-resource-cells')[2],
        shiftKey: false,
        preventDefault: (): void => {
          /** Null */
        },
    ...
    it('Resource cells updated with work cells on tab key', (done: DoneFn) => {
      ...
      expect(
        schObj.element
          .querySelectorAll('.e-resource-cells')[2]
          .classList.contains('e-parent-node')
      ).toBe(false);
      (
        schObj.element.querySelector(
          '.e-resource-cells[data-group-index="' + 9 + '"]'
        ) as HTMLElement
      ).focus();
      const contentArea: HTMLElement = schObj.element.querySelector(
        '.e-content-wrap'
    ...
    it('Resource cells updated after virtual scroll', () => {
      ...
      expect(
        document.activeElement.classList.contains('e-resource-cells')
      ).toBe(true);
  ...
  describe('Year view', () => {
    ...
    it('home key', () => {
      const firstWorkCell: HTMLElement = schObj.element.querySelector(
        '.e-work-cells:not(.e-other-month)'
      ) as HTMLElement;
      expect(firstWorkCell.classList).not.toContain('e-selected-cell');
      keyModule.keyActionHandler({ action: 'home' });
      expect(firstWorkCell.classList).toContain('e-selected-cell');
    ...
    it('right and left arrow key', () => {
      ...
      keyModule.keyActionHandler({ action: 'rightArrow', target: targetCell });
      let focusedEle: HTMLTableCellElement =
        document.activeElement as HTMLTableCellElement;
      expect(
        schObj.element.querySelectorAll('.e-selected-cell').length
      ).toEqual(1);
      ...
      expect(
        (focusedEle.parentNode as HTMLTableRowElement).sectionRowIndex
      ).toEqual(0);
    ...
    it('navigate to next and previous month using right and left arrow', () => {
      keyModule.keyActionHandler({ action: 'home' });
      const target: HTMLTableCellElement = [].slice.call(
        schObj.element.querySelectorAll('.e-work-cells')
      )[30];
      keyModule.keyActionHandler({ action: 'rightArrow', target: target });
      let focusedEle: HTMLTableCellElement =
  ...
  describe('Horizontal year view', () => {
    ...
    it('navigate to next month using shift right arrow', () => {
      ...
      let focuesdEle: HTMLTableCellElement =
        document.activeElement as HTMLTableCellElement;
      expect(
        schObj.element.querySelectorAll('.e-selected-cell').length
      ).toEqual(32);
  ...
  describe('Horizontal year view with resource', () => {
    ...
    it('down arrow', () => {
      ...
      const focusedEle: HTMLTableCellElement =
        document.activeElement as HTMLTableCellElement;
      expect(
        schObj.element.querySelectorAll('.e-selected-cell').length
      ).toEqual(1);
  ...
  describe('Vertical year view', () => {
    ...
    it('Checking popup open on enter key pressing on other month date', () => {
      ...
      keyModule.keyActionHandler({
        action: 'rightArrow',
        target: firstWorkCell,
      });
      keyModule.keyActionHandler({
        action: 'enter',
        target: schObj.element.querySelector('.e-selected-cell'),
      });
      expect(
        schObj.quickPopup.quickPopup.element.classList.contains('e-popup-close')
      ).toBe(true);
  ...
  describe('F12 key for inline editing', () => {
    ...
    it('allow inline appointment creation', (done: Function) => {
      schObj.dataBound = () => {
        ...
        expect(
          (eventElementList[1].querySelector('.e-subject') as HTMLElement)
            .innerHTML
        ).toBe('Testing');
        done();
      };
    ...
    it('allow inline edit action', (done: Function) => {
      ...
      keyModule.keyActionHandler({
        action: 'fTwelve',
        target: schObj.element.querySelector('.e-appointment'),
        preventDefault: (): void => {
          /** Null */
        },
      });
  ...
  describe('EJ2-59285 - Event deselection issue checking', () => {
    ...
    it('Ensuring event deselection', () => {
      ...
      expect((document.activeElement as HTMLElement).dataset.id).toEqual(
        'Appointment_2'
      );
  ...
  describe('EJ2-69775 - Cell Selection order is wrong in getSelectedElements public method', () => {
    ...
    it('Check the order of cell selection', () => {
      ...
      expect(selectedCells[0].getAttribute('data-date')).toEqual(
        '1679999400000'
      );
      expect(
        selectedCells[selectedCells.length - 1].getAttribute('data-date')
      ).toEqual('1680082200000');
      const selectedCellDetails: CellClickEventArgs =
        schObj.getCellDetails(selectedCells);
      expect(selectedCellDetails.startTime.getTime()).toEqual(
        new Date(1679999400000).getTime()
      );
      expect(selectedCellDetails.endTime.getTime()).toEqual(
        new Date(1680084000000).getTime()
      );
  ...
  describe('should prevent escape key in selected cell', () => {
    ...
    it('Escape key', () => {
      ...
      focusedEle = document.activeElement as HTMLTableCellElement;
      keyModule.keyActionHandler({ action: 'escape' });
      const fourthWorkCell: HTMLElement = schObj.element.querySelectorAll(
        '.e-work-cells'
      )[3] as HTMLElement;
    ...
    it('ES- 837309 - Check with AllowInline Property', () => {
      let workCells: HTMLElement[] = [].slice.call(
        schObj.element.querySelectorAll('.e-work-cells')
      );
      workCells[16].click();
      expect(
        schObj.element.querySelectorAll('.e-appointment.e-inline-appointment')
          .length
      ).toEqual(1);
      keyModule.keyActionHandler({ action: 'escape' });
      expect(
  ...
  describe('ES-845365 - Checking showQuickinfoOnSelectionEnd property', () => {
    ...
    it('Checking on unselected Resource cell', () => {
      ...
      expect(
        (quickPopup.querySelector('.e-resource-details') as HTMLElement)
          .innerText
      ).toBe('Nancy');
    });
  });
  ...
  describe('ES-845365 - Checking showQuickinfoOnSelectionEnd property without resources', () => {
    ...
    it('Checking on unselected Resource cell', () => {
      ...
      expect(quickPopup.classList).toContain('e-popup-open');
      expect(
        (quickPopup.querySelector('.e-date-time-details') as HTMLElement)
          .innerText
      ).toBe('August 29, 2023 (10:00 AM - 12:30 PM)');
    });
  });
  ...
  describe('Keyboard action in agenda view', () => {
    ...
    it('Down key press', () => {
      ...
      const calendarEle: HTMLElement = schObj.element.querySelector(
        '.e-toolbar-items .e-toolbar-item.e-date-range'
      ) as HTMLElement;
  ...
  describe('Appointment Navigation through tab key in timeline vertical year view', () => {
    ...
    it('Tab key', function () {
      schObj.element.focus();
      var workCells: HTMLElement[] = [].slice.call(
        schObj.element.querySelectorAll('.e-work-cells')
      ) as HTMLElement[];
      var workCell = workCells[0];
      workCell.click();
      keyModule.keyActionHandler({ action: 'escape' });
      var eventCell: HTMLElement = schObj.element.querySelector(
        '.e-event-table'
      ) as HTMLElement;
      keyModule.keyActionHandler({
        action: 'tab',
      ...
      let target: HTMLElement = schObj.element.querySelector(
  ...
  describe('Shift + Alt + Y to navigate today Date', () => {
    ...
    it('navigate to today Date', () => {
      const todayButton: HTMLElement = schObj.element.querySelector(
        '.e-today'
      ) as HTMLElement;
  ...
  describe('Shift+Alt+Y to open editor window', () => {
    ...
    it('open editor window with default value', function () {
      ...
      const editorWindow: HTMLElement = document.querySelector(
        '.e-dialog.e-schedule-dialog.e-popup'
      ) as HTMLElement;
      expect(editorWindow.classList.contains('e-popup-open')).toEqual(true);
      const startTime: string = (
        document.querySelector('.e-start.e-datetimepicker') as HTMLInputElement
      ).value;
      const endTime: string = (
        document.querySelector('.e-end.e-datetimepicker') as HTMLInputElement
      ).value;
      expect(startTime).toEqual('11/2/17 9:00 AM');
      expect(endTime).toEqual('11/2/17 9:30 AM');
      (
        editorWindow.querySelector('.e-dlg-closeicon-btn') as HTMLElement
      ).click();
    });
    it('open editor window with workcell', function () {
      ...
      expect(editorWindow.classList.contains('e-popup-open')).toEqual(true);
      const cellData: any = schObj.activeCellsData as {
        startTime: Date;
        endTime: Date;
        isAllDay: boolean;
      };
    ...
    it('open editor window with multiple workcells', function () {
      const workCell: HTMLTableCellElement = schObj.element.querySelector(
        '.e-work-cells'
    ...
    it('open editor window with appointment', function () {
      ...
      expect(editorWindow.classList.contains('e-popup-open')).toEqual(true);
      const cellData: any = schObj.activeEventData.event as {
        StartTime: Date;
        EndTime: Date;
        IsAllDay: boolean;
      };
    ...
    it('open editor window with all-day cells', function () {
      const allDayCell: HTMLElement[] = [].slice.call(
        schObj.element.querySelectorAll('.e-all-day-cells')
      ) as HTMLElement[];
      allDayCell[1].click();
      keyModule.keyActionHandler({ action: 'escape' });
      keyModule.keyActionHandler({
