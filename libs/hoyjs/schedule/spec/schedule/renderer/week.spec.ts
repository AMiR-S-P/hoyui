...
describe('Schedule Week view', () => {
  ...
  describe('Initial load', () => {
    ...
    it('time cells', () => {
      expect(
        schObj.element.querySelectorAll(
          '.e-time-cells-wrap .e-schedule-table tr'
        ).length
      ).toEqual(
        schObj.element.querySelectorAll(
          '.e-content-wrap .e-content-table tbody tr'
        ).length
      );
      expect(
        schObj.element.querySelector(
          '.e-time-cells-wrap .e-schedule-table tr td'
        ).innerHTML
    ...
    it('navigate next date', () => {
      ...
      expect(
        ...
        '<div class="e-header-day">Sun</div><div class="e-header-date e-navigate" role="link">8</div>'
      );
    });
  ...
  describe('Dependent properties', () => {
    ...
    it('show weekend', () => {
      ...
      expect(
        ...
        '<div class="e-header-day">Mon</div><div class="e-header-date e-navigate" role="link">2</div>'
      );
      (
        schObj.element.querySelector('.e-toolbar-item.e-next') as HTMLElement
      ).click();
      expect(
        ...
        '<div class="e-header-day">Mon</div><div class="e-header-date e-navigate" role="link">9</div>'
      );
      (
        schObj.element.querySelector('.e-toolbar-item.e-next') as HTMLElement
      ).click();
      expect(
        ...
        '<div class="e-header-day">Mon</div><div class="e-header-date e-navigate" role="link">16</div>'
      );
      (
        schObj.element.querySelector('.e-toolbar-item.e-prev') as HTMLElement
      ).click();
    ...
    it('first day of Week', () => {
      ...
      expect(
        ...
        '<div class="e-header-day">Tue</div><div class="e-header-date e-navigate" role="link">3</div>'
      );
    ...
    it('Week Number and firstDayofWeek Combination', () => {
      ...
      expect(
        ...
        '<div class="e-header-day">Sun</div><div class="e-header-date e-navigate" role="link">30</div>'
      );
      expect(
        schObj.element.querySelectorAll('.e-week-number')[0].innerHTML
      ).toBe('<span title="Week 1">1</span>');
      (
        schObj.element.querySelector('.e-toolbar-item.e-prev') as HTMLElement
      ).click();
      expect(
        ...
        '<div class="e-header-day">Sun</div><div class="e-header-date e-navigate" role="link">23</div>'
      );
      expect(
        schObj.element.querySelectorAll('.e-week-number')[0].innerHTML
      ).toBe('<span title="Week 52">52</span>');
      ...
      expect(
        ...
        '<div class="e-header-day">Sat</div><div class="e-header-date e-navigate" role="link">22</div>'
      );
      expect(
        schObj.element.querySelectorAll('.e-week-number')[0].innerHTML
      ).toBe('<span title="Week 52">52</span>');
    ...
    it('cell template', () => {
      ...
      ).toEqual('<span>10/4/17, 12:00 AM</span>');
    });
  ...
  describe('Client side events', () => {
    ...
    it('validate start and end time on multi cell select', () => {
      ...
      expect(schObj.activeCellsData.startTime).toEqual(
        new Date(2017, 9, 3, 9, 30, 0)
      );
      expect(schObj.activeCellsData.endTime).toEqual(
        new Date(2017, 9, 3, 11, 0, 0)
      );
      expect(eventName).toEqual('select');
    });
    ...
    it('date navigating', () => {
      ...
      const navArgs: NavigatingEventArgs = {
        ...
        cancel: false,
        name: 'navigating',
        currentDate: new Date(2017, 9, 12),
  ...
  describe('method for interval count', () => {
    ...
    it('interval count', () => {
      ...
      expect(
        ...
        '<div class="e-header-day">Sun</div><div class="e-header-date e-navigate" role="link">15</div>'
      );
      (
        schObj.element.querySelector('.e-toolbar-item.e-prev') as HTMLElement
      ).click();
  ...
  describe('Time format testing by changing timeFormat property', () => {
    ...
    it('checking format of the time value displayed in schedule', () => {
      ...
      schObj.dataBind();
      expect(
        schObj.element.querySelectorAll('.e-time-slots')[0].innerHTML
      ).toEqual('<span>00:00</span>');
      schObj.timeFormat = 'hh:mm:ss';
      schObj.dataBind();
      expect(
        schObj.element.querySelectorAll('.e-time-slots')[0].innerHTML
      ).toEqual('<span>12:00:00</span>');
      schObj.timeFormat = 'hh:mm:ss a';
      schObj.dataBind();
      expect(
        schObj.element.querySelectorAll('.e-time-slots')[0].innerHTML
      ).toEqual('<span>12:00:00 AM</span>');
    });
  });
  ...
  describe('checking indent template with resources in vertical views', () => {
    ...
    beforeAll((done: DoneFn) => {
      const model: ScheduleModel = {
        ...
        views: [{ option: 'Day' }, { option: 'Week' }, { option: 'WorkWeek' }],
    ...
    it('Checking indent template', () => {
      ...
      expect(
        schObj.element.querySelector('.e-all-day-cells').lastElementChild
          .innerHTML
      ).toEqual('Resources');
      expect(
        schObj.element
          .querySelector('.e-all-day-cells')
          .lastElementChild.classList.contains('temp-wrap')
      ).toBeTruthy();
    });
    ...
    it('checking indentTemplate property', () => {
      ...
      expect(
        schObj.element
          .querySelector('.e-all-day-cells')
          .lastElementChild.classList.contains('template-wrap')
      ).toBeTruthy();
    });
  });
