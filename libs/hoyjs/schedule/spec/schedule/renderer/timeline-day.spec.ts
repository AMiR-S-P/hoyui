import { createElement, Browser } from '@hoyui/base';
...
describe('Schedule timeline day view', () => {
  ...
  describe('Initial load', () => {
    ...
    it('work cells', () => {
      ...
      expect(firstWorkCell.getAttribute('data-date')).toEqual(
        new Date(2017, 9, 4).getTime().toString()
      );
      ...
      ).toEqual('Timeline Day of Wednesday, October 4, 2017');
    ...
    it('Checking right indicator icon', () => {
      ...
      expect(
        eventElementList[13].querySelectorAll(
          '.e-appointment-details .e-indicator'
        )[0].classList
      ).toContain('e-right-icon');
    });
    ...
    it('Checking recurrence icon', () => {
      ...
      expect(
        eventElementList[0].querySelectorAll(
          '.e-appointment-details .e-icons'
        )[1].classList
      ).toContain('e-recurrence-icon');
    });
  ...
  describe('Start and End hour', () => {
    ...
    it('Checking elements', (done: DoneFn) => {
      schObj.dataBound = () => {
        ...
        expect(
          schObj.element.querySelectorAll('.e-header-row td')[1].innerHTML
    ...
    it('Checking right indicator icon', () => {
      ...
      expect(
        eventElementList[1]
          .querySelectorAll('.e-appointment-details .e-indicator')[1]
  ...
  describe('Dependent properties', () => {
    ...
    it('dateRange template', () => {
      ...
      expect(
        schObj.element.querySelector('.e-tbar-btn-text').innerHTML
      ).toEqual('<div>10/5/17, 12:00 AM-10/5/17, 12:00 AM</div>');
    });
    ...
    it('cell template', () => {
      ...
      ).toEqual('<span>10/5/17, 1:30 AM</span>');
    });
    ...
    it('read only on cell click', () => {
      ...
      schObj.dataBind();
      const firstWorkCell1: HTMLElement = schObj.element.querySelector(
        '.e-work-cells'
      ) as HTMLElement;
  ...
  describe('Client side events', () => {
    ...
    it('validate start and end time on multi cell select', () => {
      ...
      expect(schObj.activeCellsData.startTime).toEqual(
        new Date(2018, 5, 5, 1, 30, 0)
      );
      expect(schObj.activeCellsData.endTime).toEqual(
        new Date(2018, 5, 5, 3, 0, 0)
      );
      expect(eventName).toEqual('select');
    });
  ...
  describe('Multi level resource rendering with expanded property', () => {
    ...
    it('Checking rowAutoHeight property', (done: DoneFn) => {
      schObj.dataBound = () => {
        ...
        expect(
          schObj.element.querySelectorAll('.e-appointment-wrapper').length
        ).toEqual(7);
        expect(
          schObj.element.querySelectorAll('.e-more-indicator').length
        ).toEqual(0);
    ...
    it('timeline day view changing to timeline work week view using toolbar click', (done: DoneFn) => {
      schObj.dataBound = () => {
        ...
        expect(
          schObj.element.querySelector('.e-schedule-toolbar .e-active-view')
            .classList
      ...
      util.triggerMouseEvent(
        schObj.element.querySelector(
          '.e-schedule-toolbar .e-timeline-work-week button'
        ),
        'click'
      );
    });
    it('timeline work week view changing to timeline day view using toolbar click', (done: DoneFn) => {
      ...
      util.triggerMouseEvent(
        schObj.element.querySelector(
          '.e-schedule-toolbar .e-timeline-day button'
        ),
        'click'
      );
    });
  ...
  describe('Multiple resource grouping rendering compact view in mobile device ', () => {
    ...
    it('initial layout testing', () => {
      ...
      expect(workCells[18].getAttribute('data-date')).toEqual(
        new Date(2018, 3, 1, 9, 0).getTime().toString()
      );
    });
  ...
  describe('Grouped events', () => {
    ...
    it('Checking right icon', () => {
      ...
      expect(
        eventElementList[9].querySelector('.e-inner-wrap .e-subject').innerHTML
      ).toEqual('Spanned Event - Greater than 24');
      expect(
        eventElementList[9]
          .querySelectorAll('.e-appointment-details .e-indicator')[0]
  ...
  describe('Year, Month, Week, Day, Hour header rows', () => {
    ...
    it('check year rows', () => {
      ...
      expect(headTrs[0].children[0].innerHTML).toEqual(
        '<span class="e-header-year" style="left: 900px;">2018</span>'
      );
    });
    ...
    it('check month rows', () => {
      ...
      expect(headTrs[1].children[0].innerHTML).toEqual(
        '<span class="e-header-month" style="left: 900px;">May</span>'
      );
    });
    ...
    it('check week rows', () => {
      ...
      expect(headTrs[2].children[0].innerHTML).toEqual(
        '<span class="e-header-week" style="left: 900px;">18</span>'
      );
    });
    ...
    it('check day rows', () => {
      ...
      expect(headTrs[3].children[0].innerHTML).toEqual(
        '<span class="e-header-date e-navigate" style="left: 900px;">May 1, Tuesday</span>'
      );
    ...
    it('check work cells', () => {
      ...
      expect(data.endTime.getTime()).toEqual(
        new Date(2018, 4, 1, 0, 30).getTime()
      );
    ...
    it('check events rendering', () => {
      ...
      expect(
        eventElementList[11].querySelector('.e-inner-wrap .e-subject').innerHTML
      ).toEqual('Spanned Event - Greater than 24');
      expect(
        eventElementList[11].querySelectorAll(
          '.e-appointment-details .e-indicator'
        )[0].classList
      ).toContain('e-right-icon');
    ...
    it('navigate next date', (done: DoneFn) => {
      schObj.dataBound = () => {
        ...
        expect(headTrs[3].children[0].getAttribute('colSpan')).toEqual('48');
        expect(headTrs[3].children[0].innerHTML).toEqual(
          '<span class="e-header-date e-navigate" style="left: 900px;">May 2, Wednesday</span>'
        );
        expect(headTrs[3].children[0].getAttribute('data-date')).toEqual(
          new Date(2018, 4, 2).getTime().toString()
        );
  ...
  describe('Year, Month, Week, Day, Hour header rows with template', () => {
    ...
    it('check year rows', () => {
      ...
      expect(headTrs[0].children[0].getAttribute('colSpan')).toEqual('48');
      expect(headTrs[0].children[0].innerHTML).toEqual(
        '<span style="left: 900px;">yearHeader</span>'
      );
    });
    ...
    it('check month rows', () => {
      ...
      expect(headTrs[1].children[0].getAttribute('colSpan')).toEqual('48');
      expect(headTrs[1].children[0].innerHTML).toEqual(
        '<span style="left: 900px;">monthHeader</span>'
      );
    });
    ...
    it('check week rows', () => {
      ...
      expect(headTrs[2].children[0].getAttribute('colSpan')).toEqual('48');
      expect(headTrs[2].children[0].innerHTML).toEqual(
        '<span style="left: 900px;">weekHeader</span>'
      );
    });
    ...
    it('check day rows', () => {
      ...
      expect(headTrs[3].children[0].getAttribute('colSpan')).toEqual('48');
      expect(headTrs[3].children[0].innerHTML).toEqual(
        '<span style="left: 900px;">dateHeader</span>'
      );
      expect(headTrs[3].children[0].getAttribute('data-date')).toEqual(
        new Date(2018, 4, 1).getTime().toString()
      );
  ...
  describe('Year, Month, Week, Day header rows', () => {
    ...
    it('check day rows', () => {
      ...
      expect(headTrs[3].children[0].innerHTML).toEqual(
        '<span class="e-header-date e-navigate">May 1, Tuesday</span>'
      );
      expect(headTrs[3].children[0].getAttribute('data-date')).toEqual(
        new Date(2018, 4, 1).getTime().toString()
      );
  ...
  describe('Year, Month, Week, Day, Hour header rows with single resource', () => {
    ...
    it('check more indicator', () => {
      ...
      expect(moreIndicators[0].getAttribute('data-start-date')).toEqual(
        new Date(2018, 4, 1, 10).getTime().toString()
      );
      expect(moreIndicators[0].getAttribute('data-end-date')).toEqual(
        new Date(2018, 4, 1, 10, 30).getTime().toString()
      );
      moreIndicators[0].click();
      const morePopup: HTMLElement = schObj.element.querySelector(
        '.e-more-popup-wrapper'
    ...
    it('navigate next date', (done: DoneFn) => {
      schObj.dataBound = () => {
        ...
        expect(data.startTime.getTime()).toEqual(
          new Date(2018, 4, 2).getTime()
        );
        expect(data.endTime.getTime()).toEqual(
          new Date(2018, 4, 2, 0, 30).getTime()
        );
        expect(data.isAllDay).toEqual(false);
        expect(data.groupIndex).toBe(0);
        expect(
  ...
  describe('Show weekend as False', () => {
    ...
    it('Checking Rendered Dates are Weekdays', () => {
      ...
      expect(
        schObj.element.querySelectorAll('.e-header-date.e-navigate')[0]
          .innerHTML
      ).toEqual('Apr 2, Monday');
      expect(
        schObj.element.querySelectorAll('.e-header-date.e-navigate')[1]
          .innerHTML
      ).toEqual('Apr 3, Tuesday');
      expect(
        schObj.element.querySelectorAll('.e-header-date.e-navigate')[2]
          .innerHTML
      ).toEqual('Apr 4, Wednesday');
      (
        schObj.element.querySelector('.e-toolbar-item.e-next') as HTMLElement
      ).click();
      expect(
      ...
      expect(
        schObj.element.querySelectorAll('.e-header-date.e-navigate')[0]
          .innerHTML
      ).toEqual('Apr 5, Thursday');
      expect(
        schObj.element.querySelectorAll('.e-header-date.e-navigate')[1]
          .innerHTML
      ).toEqual('Apr 6, Friday');
      expect(
        schObj.element.querySelectorAll('.e-header-date.e-navigate')[2]
          .innerHTML
      ).toEqual('Apr 9, Monday');
      (
        schObj.element.querySelector('.e-toolbar-item.e-prev') as HTMLElement
      ).click();
      expect(
  ...
  describe('EJ2-50635 - Rendering timeline day view with header rows breaks the layout', () => {
    ...
    it('Checking appointment and more indicator count', () => {
      ...
      expect(eventElementList.length).toEqual(8);
      expect(
        (schObj.element.querySelector('.e-more-indicator') as HTMLElement)
          .innerText
      ).toEqual('+7 more');
    });
  });
