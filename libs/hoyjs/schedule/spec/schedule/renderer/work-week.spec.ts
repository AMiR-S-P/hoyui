...
describe('Schedule work week view', () => {
  ...
  describe('time scale property', () => {
    ...
    it('majorSlotTemplate and minorSlotTemplate', () => {
      ...
      expect(
        schObj.element.querySelector(
          '.e-time-cells-wrap .e-schedule-table .e-time-cells'
        ).innerHTML
  ...
  describe('Dependent properties', () => {
    ...
    it('Week Number and firstDayofWeek Combination', () => {
      ...
      expect(
        ...
        '<div class="e-header-day">Mon</div><div class="e-header-date e-navigate" role="link">31</div>'
      );
      expect(
      ...
      expect(
        ...
        '<div class="e-header-day">Mon</div><div class="e-header-date e-navigate" role="link">24</div>'
      );
      expect(
        schObj.element.querySelectorAll('.e-week-number')[0].innerHTML
