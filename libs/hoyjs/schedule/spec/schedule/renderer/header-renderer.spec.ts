 ...
 */
import { Browser, remove } from '@hoyui/base';
...
describe('Schedule header bar', () => {
  ...
  describe('Initial load', () => {
    ...
    it('toolbar bar class testing', () => {
      expect(
        schObj.element.querySelectorAll('.e-schedule-toolbar-container')
      ).toBeTruthy();
      expect(
    ...
    it('calendar navigation', () => {
      ...
      expect(
        popupEle
          .querySelector('.e-header-calendar')
          .classList.contains('e-calendar')
      ).toEqual(true);
      expect(
        popupEle.querySelector('.e-content').classList.contains('e-month')
      ).toEqual(true);
    ...
    it('calendar date navigation', () => {
      ...
      expect(popupEle.classList.contains('e-popup-open')).toEqual(true);
      expect(
        calendarEle.querySelector('.e-header').classList.contains('e-year')
      ).toEqual(true);
    ...
    it('view navigations', () => {
      ...
      (
        schObj.element.querySelector(
          '.e-schedule-toolbar .e-work-week'
        ) as HTMLElement
      ).click();
      expect(
        schObj.element.querySelector('.e-active-view').classList
  ...
  describe('View items based on property change', () => {
    ...
    it('toolbar items', () => {
      ...
      expect(
        schObj.element.querySelector('.e-schedule-toolbar .e-month')
      ).toBeFalsy();
    });
    ...
    it('views on property change', () => {
      ...
      expect(
        schObj.element.querySelector('.e-schedule-toolbar .e-day')
      ).toBeTruthy();
      expect(
        schObj.element.querySelector('.e-schedule-toolbar .e-week')
      ).toBeTruthy();
    });
    ...
    it('displayName on views change', () => {
      ...
      expect(
        schObj.element.querySelector('.e-schedule-toolbar .e-work-week')
      ).toBeTruthy();
      expect(
        schObj.element.querySelector('.e-schedule-toolbar .e-month')
      ).toBeTruthy();
      ...
      expect(
        schObj.element
          .querySelectorAll('.e-week')[0]
          .querySelector('.e-tbar-btn-text').innerHTML
      ).toEqual('3 Weeks');
      ...
      expect(
        schObj.element
          .querySelectorAll('.e-work-week')[0]
          .querySelector('.e-tbar-btn-text').innerHTML
      ).toEqual('2 WorkWeeks');
  ...
  describe('RTL mode', () => {
    ...
    it('toolbar bar rtl class testing', () => {
      ...
      expect(
        schObj.element.querySelector('.e-schedule-toolbar').classList
      ).toContain('e-rtl');
      expect(schObj.element.querySelectorAll('.e-toolbar-item').length).toEqual(
        10
      );
      ...
      expect(
        schObj.element
          .querySelector('.e-schedule-toolbar')
          .classList.contains('e-rtl')
      ).toEqual(true);
      expect(popupEle.classList.contains('e-rtl')).toEqual(true);
      expect(
        popupEle.querySelector('.e-header-calendar').classList.contains('e-rtl')
      ).toEqual(true);
    });
    ...
    it('toolbar bar rtl mode property change', (done: DoneFn) => {
      ...
      schObj.dataBound = () => {
        ...
        expect(
          schObj.element.querySelectorAll('.e-toolbar-item').length
        ).toEqual(10);
        done();
      };
  ...
  describe('Mobile view', () => {
    ...
    it('close toolbar popup while select items', () => {
      (
        schObj.element.querySelector(
          '.e-schedule-toolbar .e-hor-nav'
        ) as HTMLElement
      ).click();
      const toolbarPopupEle: Element = schObj.element.querySelector(
        '.e-schedule-toolbar-container .e-toolbar-pop'
      );
  ...
  describe('Header date range on default culture', () => {
    ...
    it('dates on same month and year', () => {
      ...
      expect(
        schObj.element
          .querySelector('.e-schedule-toolbar .e-date-range')
  ...
  describe('Add custom items and remove default items to toolbar', () => {
    ...
    it('check custom item', () => {
      ...
      expect(
        schObj.element.querySelectorAll('.e-schedule-print').length
      ).toEqual(1);
    });
    ...
    it('month-agenda view testing', (done: DoneFn) => {
      schObj.dataBound = () => {
        ...
        expect(
          schObj.element.querySelector('.e-table-wrap').classList
        ).toContain('e-month-agenda-view');
        done();
      };
      (
        schObj.element.querySelector(
          '.e-schedule-toolbar .e-month-agenda'
        ) as HTMLElement
      ).click();
    });
  ...
  describe('Custom toolbar with default align', () => {
    ...
    beforeAll((done: DoneFn): void => {
      const model: ScheduleModel = {
        ...
        toolbarItems: [
          ...
          { name: 'NewEvent', disabled: true, visible: false },
          {
            id: 'dropdown',
            type: 'Input',
            template:
              '<div class="e-input-group"><input id="dropdown"></input></div>',
          },
          {
            id: 'button',
            template:
              '<div class="e-input-group"><button id="btn">Custom button</button></div>',
            click: function () {
    ...
    it('checking click actions', () => {
      ...
      (
        schObj.element.querySelectorAll('.e-toolbar-item')[4] as HTMLElement
      ).click();
      (
        schObj.element.querySelectorAll('.e-toolbar-item')[7] as HTMLElement
      ).click();
      (
        schObj.element.querySelectorAll('.e-toolbar-item')[0] as HTMLElement
      ).click();
  ...
  describe('Custom toolbar with user given align properties', () => {
    ...
    beforeAll((done: DoneFn): void => {
      const model: ScheduleModel = {
        ...
        selectedDate: new Date(2017, 9, 4),
        toolbarItems: [
          { name: 'Today', text: 'Today', align: 'Right' },
          { name: 'Previous', text: 'previous', align: 'Right' },
          { name: 'Next', text: 'Next', align: 'Right' },
          { name: 'DateRangeText', align: 'Right' },
          {
            prefixIcon: 'e-icons e-cut',
            tooltipText: 'Cut',
            click: function () {
