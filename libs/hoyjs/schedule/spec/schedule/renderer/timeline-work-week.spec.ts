...
describe('Schedule timeline work week view', () => {
  ...
  describe('Initial load', () => {
    ...
    it('work cells', () => {
      ...
      expect(
        ...
        'Timeline Work Week Start Monday, October 2, 2017 Ends At Friday, October 6, 2017'
      );
      expect(firstWorkCell.getAttribute('data-date')).toEqual(
        new Date(2017, 9, 2).getTime().toString()
      );
  ...
  describe('Start and end hour', () => {
    ...
    it('Checking elements', (done: DoneFn) => {
      schObj.dataBound = () => {
        ...
        expect(
          schObj.element.querySelectorAll('.e-header-row td')[5].innerHTML
  ...
  describe('Dependent properties', () => {
    ...
    it('dateRange template', () => {
      ...
      expect(
        schObj.element.querySelector('.e-tbar-btn-text').innerHTML
      ).toEqual('<div>10/2/17, 12:00 AM-10/6/17, 12:00 AM</div>');
    });
    ...
    it('cell template', () => {
      ...
      ).toEqual('<span>10/2/17, 1:30 AM</span>');
    });
    ...
    it('minDate and maxDate', () => {
      ...
      expect(
        schObj.element.querySelector('.e-date-range .e-tbar-btn-text').innerHTML
      ).toEqual('October 02 - 06, 2017');
      (
        schObj.element.querySelector('.e-toolbar-item.e-prev') as HTMLElement
      ).click();
      expect(
        schObj.element.querySelector('.e-date-range .e-tbar-btn-text').innerHTML
      ).toEqual('September 25 - 29, 2017');
      ...
      (
        schObj.element.querySelectorAll(
          '.e-date-header-container .e-header-cells .e-navigate'
        )[0] as HTMLElement
      ).click();
  ...
  describe('Template', () => {
    ...
    it('Events template', () => {
      ...
      expect(eventElementList.length).toEqual(23);
      expect(
        eventElementList[1].querySelector('.e-appointment-details').innerHTML
      ).toEqual(
        '<div class="e-indicator e-icons e-left-icon"></div><span>Spanned Event - Previous week</span>'
      );
      expect(
        eventElementList[3].querySelector('.e-appointment-details span')
          .innerHTML
  ...
  describe('Client side events', () => {
    ...
    it('validate start and end time on multi cell select', () => {
      ...
      expect(schObj.activeCellsData.startTime).toEqual(
        new Date(2018, 5, 4, 1, 30, 0)
      );
      expect(schObj.activeCellsData.endTime).toEqual(
        new Date(2018, 5, 4, 3, 0, 0)
      );
      expect(eventName).toEqual('select');
    });
  ...
  describe('Multi level resource rendering', () => {
    ...
    it('Checking right icon', () => {
      ...
      expect(
        eventElementList[7].querySelector('.e-inner-wrap .e-subject').innerHTML
  ...
  describe('Custom work days of Resources in group', () => {
    ...
    it('work hours count', () => {
      ...
      expect(
        (<Element>contentTable[1].childNodes[15]).classList.contains(
          'e-work-hours'
        )
      ).toEqual(false);
      expect(
        (<Element>contentTable[1].childNodes[16]).classList.contains(
          'e-work-hours'
        )
      ).toEqual(true);
    });
  ...
  describe('Multiple resource grouping rendering compact view in mobile device ', () => {
    ...
    it('initial layout testing', () => {
      ...
      expect(workCells[126].getAttribute('data-date')).toEqual(
        new Date(2018, 3, 4, 15, 0).getTime().toString()
      );
    });
  ...
  describe('Grouped events', () => {
    ...
    it('Checking right icon', () => {
      ...
      expect(
        eventElementList[25].querySelector('.e-inner-wrap .e-subject').innerHTML
      ).toEqual('Recurrence Event - Next week');
      expect(
        eventElementList[25]
          .querySelectorAll('.e-appointment-details .e-indicator')[0]
  ...
  describe('Year, Month, Week, Day, Hour header rows', () => {
    ...
    it('check year rows', () => {
      ...
      expect(headTrs[0].children[0].innerHTML).toEqual(
        '<span class="e-header-year" style="left: 3300px;">2018</span>'
      );
    });
    ...
    it('check week rows', () => {
      ...
      expect(headTrs[2].children[0].innerHTML).toEqual(
        '<span class="e-header-week" style="left: 3300px;">18</span>'
      );
    });
    ...
    it('check day rows', () => {
      ...
      expect(headTrs[3].children[0].innerHTML).toEqual(
        '<span class="e-header-date e-navigate">Apr 30, Monday</span>'
      );
      expect(headTrs[3].children[0].getAttribute('data-date')).toEqual(
        new Date(2018, 3, 30).getTime().toString()
      );
    });
    ...
    it('check work cells', () => {
      ...
      expect(data.endTime.getTime()).toEqual(
        new Date(2018, 3, 30, 0, 30).getTime()
      );
    ...
    it('navigate next date', (done: DoneFn) => {
      ...
      schObj.dataBound = () => {
        ...
        expect(headTrs[1].children[0].innerHTML).toEqual(
          '<span class="e-header-month" style="left: 3300px;">May</span>'
        );
        expect(headTrs[2].children.length).toEqual(1);
        expect(headTrs[2].children[0].getAttribute('colSpan')).toEqual('240');
        expect(headTrs[2].children[0].innerHTML).toEqual(
          '<span class="e-header-week" style="left: 3300px;">19</span>'
        );
        expect(headTrs[3].children.length).toEqual(5);
        expect(headTrs[3].children[0].getAttribute('colSpan')).toEqual('48');
        expect(headTrs[3].children[0].innerHTML).toEqual(
          '<span class="e-header-date e-navigate">May 7, Monday</span>'
        );
        expect(headTrs[3].children[0].getAttribute('data-date')).toEqual(
          new Date(2018, 4, 7).getTime().toString()
        );
        expect(headTrs[4].children.length).toEqual(48 * daysLength);
        expect(headTrs[4].children[0].getAttribute('colSpan')).toBeNull();
  ...
  describe('Year, Month, Week, Day, Hour header rows with template', () => {
    ...
    it('check year rows', () => {
      ...
      expect(headTrs[0].children[0].getAttribute('colSpan')).toEqual('240');
      expect(headTrs[0].children[0].innerHTML).toEqual(
        '<span style="left: 3300px;">yearHeader</span>'
      );
    });
    ...
    it('check week rows', () => {
      ...
      expect(headTrs[2].children[0].getAttribute('colSpan')).toEqual('240');
      expect(headTrs[2].children[0].innerHTML).toEqual(
        '<span style="left: 3300px;">weekHeader</span>'
      );
    });
    ...
    it('navigate next date', (done: DoneFn) => {
      ...
      schObj.dataBound = () => {
        ...
        expect(data.startTime.getTime()).toEqual(
          new Date(2018, 4, 7).getTime()
        );
        expect(data.endTime.getTime()).toEqual(
          new Date(2018, 4, 7, 0, 30).getTime()
        );
        expect(data.isAllDay).toEqual(false);
        expect(data.groupIndex).toBe(0);
        expect(
