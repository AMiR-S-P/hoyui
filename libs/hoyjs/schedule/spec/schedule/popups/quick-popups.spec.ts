...
describe('Quick Popups', () => {
  ...
  describe('Tooltip and Dialog for vertical view', () => {
    ...
    it('Event Click and Delete event', () => {
      ...
      (<HTMLElement>(
        document.body.querySelector('.e-quick-dialog-cancel')
      )).click();
    });
    ...
    it('Cell Click and Save new event', (done: DoneFn) => {
      ...
      (<HTMLInputElement>cellPopup.querySelector('.e-subject')).value =
        'Welcome';
    ...
    it('Event Dialog Delete Click', (done: DoneFn) => {
      ...
      (<HTMLElement>(
        document.body.querySelector('.e-quick-dialog-delete')
      )).click();
    });
    ...
    it('Prevent event click quickInfo', () => {
      schObj.popupOpen = (args: PopupOpenEventArgs) =>
        (args.cancel =
          args.type === 'QuickInfo' &&
          args.target.classList.contains(cls.APPOINTMENT_CLASS));
      (schObj.element.querySelector('.e-appointment') as HTMLElement).click();
      expect(schObj.quickPopup.quickPopup.element.classList).toContain(
        'e-popup-close'
      );
    });
    ...
    it('Prevent delete alert', () => {
      schObj.popupOpen = (args: PopupOpenEventArgs) =>
        (args.cancel = args.type === 'DeleteAlert');
      (schObj.element.querySelector('.e-appointment') as HTMLElement).click();
      const eventPopup: HTMLElement = schObj.element.querySelector(
        '.e-quick-popup-wrapper'
      ) as HTMLElement;
    ...
    it('Cell Click and open event window with subject value', () => {
      ...
      eventElements[1].click();
      const editEventPoup: HTMLElement = schObj.element.querySelector(
        '.e-quick-popup-wrapper'
      ) as HTMLElement;
      ...
      (
        schObj.element
          ...
          .querySelector('.e-close') as HTMLElement
      ).click();
      const workCells: HTMLElement[] = [].slice.call(
        schObj.element.querySelectorAll('.' + cls.WORK_HOURS_CLASS)
      );
      workCells[1].click();
      const eventPopup: HTMLElement = schObj.element.querySelector(
        '.e-quick-popup-wrapper'
      ...
      (<HTMLInputElement>(
        eventPopup.querySelector('.' + cls.QUICK_POPUP_EVENT_DETAILS_CLASS)
      )).click();
      const dialogElement: HTMLElement = document.querySelector(
        '.' + cls.EVENT_WINDOW_DIALOG_CLASS
      ) as HTMLElement;
  ...
  describe('Tooltip and Dialog for timeline view', () => {
    ...
    it('Event click client side event', () => {
      ...
      expect(eventElements).toBeTruthy();
      eventElements[1].click();
      schObj.eventClick = (args: EventClickArgs) => {
        args.cancel = false;
      };
      schObj.dataBind();
    });
  ...
  describe('checking quickInfoTemplate for cellClick', () => {
    ...
    beforeAll((done: DoneFn) => {
      const headerScript: HTMLElement = createElement('script', {
        ...
        innerHTML:
          '<div class="header-template">${if(elementType === "cell")}<div class="e-cell-header">' +
      ...
      const contentScript: HTMLElement = createElement('script', {
        ...
        attrs: { type: 'text/x-template' },
        innerHTML:
          '<div class="content-template">${if (elementType === "cell")}<div class="e-cell-content"><form class=' +
      ...
      const footerScript: HTMLElement = createElement('script', {
        ...
        attrs: { type: 'text/x-template' },
        innerHTML:
          '<div class="footer-template">${if (elementType === "cell")}<div class="e-cell-footer"><button class=' +
      ...
      append(
        [headerScript, contentScript, footerScript],
    ...
    it('checking header, content and footer area for cell-quick popup', () => {
      ...
      const contentFieldEle: HTMLElement[] = [].slice.call(
        schObj.element.querySelectorAll('.e-field')
      );
      ...
      const footerEle: HTMLElement = cellPopup.querySelector(
        '.e-cell-footer'
      ) as HTMLElement;
      expect(footerEle.firstElementChild.classList).toContain(
        'e-event-details'
      );
  ...
  describe('checking quickInfoTemplate for eventClick', () => {
    ...
    it('checking header, content and footer area for event-quick popup', () => {
      ...
      expect(cellPopup.querySelector('.content-template')).toBeTruthy();
      const contentFieldEle: HTMLElement[] = [].slice.call(
        cellPopup.querySelectorAll('.content-template')
      );
  ...
  describe('checking quickInfoTemplate for both cell and eventClick', () => {
    ...
    it('checking header, content and footer area for cell and event quick popup', () => {
      ...
      expect(cellPopup.querySelector('.header-template')).toBeTruthy();
      expect(
        cellPopup.querySelector('.header-template .e-cell-header')
      ).toBeTruthy();
      expect(
        cellPopup.querySelector('.header-template .e-event-header')
      ).toBeNull();
      expect(cellPopup.querySelector('.content-template')).toBeTruthy();
      expect(
        cellPopup.querySelector('.content-template .e-cell-content')
      ).toBeTruthy();
      expect(
        cellPopup.querySelector('.content-template .e-event-content')
      ).toBeNull();
      expect(cellPopup.querySelector('.footer-template')).toBeTruthy();
      expect(
        cellPopup.querySelector('.footer-template .e-cell-footer')
      ).toBeTruthy();
      expect(
        cellPopup.querySelector('.footer-template .e-event-footer')
      ).toBeNull();
      const contentFieldEle: HTMLElement[] = [].slice.call(
        cellPopup.querySelectorAll('.e-field')
      );
      expect(contentFieldEle.length).toEqual(2);
      expect(contentFieldEle[0].classList.contains('e-subject')).toEqual(true);
      expect(contentFieldEle[1].classList.contains('e-location')).toEqual(true);
      ...
      const eventContentEle: HTMLElement[] = [].slice.call(
        eventPopup.querySelectorAll('.e-event-content')
      );
      ...
      const eventFooterEle: HTMLElement = eventPopup.querySelector(
        '.e-event-footer'
      ) as HTMLElement;
      expect(eventFooterEle.firstElementChild.classList).toContain(
        'e-event-edit'
      );
      expect(eventFooterEle.lastElementChild.classList).toContain(
        'e-event-delete'
      );
      (<HTMLElement>eventPopup.querySelector('.e-close')).click();
    });
  ...
  describe('Read only test cases', () => {
    ...
    it('Enter key', () => {
      const firstWorkCell: HTMLElement =
      ...
      expect(
        schObj.element.querySelector('.e-quick-popup-wrapper').childElementCount
      ).toBe(0);
      expect(
        schObj.quickPopup.quickPopup.element.classList.contains('e-popup-close')
      ).toEqual(true);
      expect(
        schObj.element.querySelector('.e-work-cells').classList
      ).not.toContain('e-selected-cell');
    });
    it('quick popup - left arrow', () => {
      ...
      keyModule.keyActionHandler({
        action: 'leftArrow',
        target: schObj.element.querySelector(
  ...
  describe('More Indicator Popup', () => {
    ...
    it('More Indicator click', () => {
      ...
      const moreEventPopup: Element = schObj.element.querySelector(
    ...
    it('Event click edit action', (done: DoneFn) => {
      ...
      const eventElements: HTMLElement = schObj.element.querySelector(
        '.e-more-event-content .e-appointment'
      );
      eventElements.click();
      const eventPopup: HTMLElement = schObj.element.querySelector(
        '.e-quick-popup-wrapper'
    ...
    it('Delete key', () => {
      ...
      keyModule.keyActionHandler({
        action: 'delete',
        target: '.e-more-appointment-wrapper',
      });
      (<HTMLElement>(
        schObj.quickPopup.quickDialog.element.querySelector(
          '.e-dlg-closeicon-btn'
    ...
    it('More Indicator Day view navigation click', () => {
      ...
      (
        moreEventPopup.querySelector('.e-more-event-close') as HTMLElement
      ).click();
      (
        schObj.element.querySelector('.e-more-indicator') as HTMLElement
      ).click();
  ...
  describe('More Indicator with resource', () => {
    ...
    it('CR Issue EJ2-21532 - Appointment time was wrong when it move on to the more indicator popup', () => {
      (
        schObj.element.querySelectorAll('.e-more-indicator')[5] as HTMLElement
      ).click();
      expect(
        schObj.quickPopup.morePopup.element.classList.contains('e-popup-open')
      ).toEqual(true);
      expect(schObj.quickPopup.morePopup.element.getAttribute('role')).toEqual(
        'dialog'
      );
      expect(
        schObj.quickPopup.morePopup.element.getAttribute('aria-labelledby')
      ).toEqual(
        schObj.element
          .querySelector('.e-more-event-date-header')
          .querySelector('.e-header-day').id
      );
      const morePopupEvents: NodeListOf<Element> =
        schObj.quickPopup.morePopup.element.querySelectorAll('.e-appointment');
      expect(morePopupEvents.length).toEqual(2);
      (morePopupEvents[0] as HTMLElement).click();
      const popupEle: HTMLElement = schObj.quickPopup.quickPopup
        .element as HTMLElement;
      expect(popupEle.classList.contains('e-popup-open')).toEqual(true);
      expect(
        popupEle.querySelector('.e-date-time-details').textContent
      ).toEqual('December 7, 2018 (10:00 AM - 11:30 AM)');
      (morePopupEvents[1] as HTMLElement).click();
      expect(
        popupEle.querySelector('.e-date-time-details').textContent
      ).toEqual('December 7, 2018 (10:12 AM - 11:38 AM)');
      (popupEle.querySelector('.e-close') as HTMLElement).click();
      expect(popupEle.classList.contains('e-popup-close')).toEqual(true);
      (
        schObj.quickPopup.morePopup.element.querySelector(
          '.e-more-event-close'
        ) as HTMLElement
      ).click();
      expect(
        schObj.quickPopup.morePopup.element.classList.contains('e-popup-close')
      ).toEqual(true);
    });

    it('CR Issue EJ2-21478 - Spanned Appointment with Same Hours, Minutes and Seconds Do not display correctly in quick popup', () => {
      const spanEventEle: HTMLElement = schObj.element.querySelector(
    ...
    it('CR Issue EJ2-21478 - Recurrence event summary in quick popup', () => {
      ...
      expect(popupEle.classList.contains('e-popup-open')).toEqual(true);
      expect(
        popupEle.querySelector('.e-recurrence-summary ').textContent
      ).toEqual('Every day(s), 5 time(s)');
      (popupEle.querySelector('.e-close') as HTMLElement).click();
      expect(popupEle.classList.contains('e-popup-close')).toEqual(true);
    });
    ...
    it('CR Issue EJ2-19844 - timeline week more popup display position', () => {
      ...
      schObj.popupOpen = (args: PopupOpenEventArgs) => {
        ...
        const element: Element = proxy.element.querySelector(
          '.' +
        ...
        const currentCellData: CellClickEventArgs =
          proxy.getCellDetails(element);
        expect(element).toBeTruthy();
        expect(parseInt(element.getAttribute('data-date'), 10)).toEqual(
          new Date(2018, 11, 7, 12, 30).getTime()
        );
        ...
        expect(currentCellData.startTime.getTime()).toEqual(
          new Date(2018, 11, 7, 12, 30).getTime()
        );
        expect(currentCellData.endTime.getTime()).toEqual(
          new Date(2018, 11, 7, 13, 0).getTime()
        );
      };
      (
        schObj.element.querySelector('.e-more-indicator') as HTMLElement
  ...
  describe('EJ2-70306 - e-subject element missing in more popup apointment elements', () => {
    ...
    it('e-subject element missing in more popup apointment elements', () => {
      ...
      expect(morePopupEvents.length).toEqual(2);
      expect(
        morePopupEvents[0].firstElementChild.classList.contains('e-subject')
      ).toEqual(true);
      expect((morePopupEvents[0] as HTMLElement).innerText).toEqual(
        'Time Rounded'
      );
    });
  });
  ...
  describe('Quick Popup validation', () => {
    ...
    it('Cell click and insert event', () => {
      (
        schObj.element.querySelector('.' + cls.WORK_HOURS_CLASS) as HTMLElement
      ).click();
      const eventPopup: HTMLElement = schObj.element.querySelector(
        '.e-quick-popup-wrapper'
      ) as HTMLElement;
      ...
      (<HTMLInputElement>(
        eventPopup.querySelector('.' + cls.EVENT_CREATE_CLASS)
      )).click();
      expect(
        (<HTMLElement>document.querySelector('.e-schedule-error')).style.display
      ).toEqual('');
    });
  });
  ...
  describe('Popup for recurrence rule appointment for vertical view', () => {
    ...
    it('Single appointment select using click or tap', () => {
      const target: Element[] = [].slice.call(
        schObj.element.querySelectorAll('.e-appointment')
      );
  ...
  describe('Quick info display for vertical view', () => {
    ...
    it('Normal appointment click', () => {
      const appointment: HTMLElement = schObj.element.querySelector(
      ...
      expect(
        eventPopup.querySelector('.e-date-time-details').textContent
    ...
    it('All day appointment click', () => {
      ...
      expect(
        eventPopup.querySelector('.e-date-time-details').textContent
      ).toEqual('October 31, 2017 (All day)');
      (<HTMLElement>eventPopup.querySelector('.e-close')).click();
    });

    it('Spanned appointment click', () => {
      const appointment: HTMLElement = schObj.element.querySelector(
        '[data-id="Appointment_12"]'
      ) as HTMLElement;
      appointment.click();
      const eventPopup: HTMLElement = schObj.element.querySelector(
        '.e-quick-popup-wrapper'
  ...
  describe('Popup for mobile view', () => {
    ...
    it('Single appointment select using click or tap and close', () => {
      const target: HTMLElement = schObj.element.querySelector(
    ...
    it('Appointment select with details', () => {
      ...
      expect(eventPopup).toBeTruthy();
      expect(
        eventPopup.querySelector('.e-location-details').textContent
      ).toEqual('India');
      (eventPopup.querySelector('.e-close') as HTMLElement).click();
    });
  ...
  describe('Multiple resource grouping', () => {
    ...
    it('resource event checking', () => {
      ...
      expect(eventPopup.classList).toContain('e-popup-open');
      const resourceElement: HTMLElement = eventPopup.querySelector(
        '.e-resource'
      ) as HTMLElement;
      expect(resourceElement).toBeTruthy();
      expect(
        resourceElement.querySelector('.e-resource-details').innerHTML
      ).toEqual('Nancy');
      (<HTMLElement>eventPopup.querySelector('.e-close')).click();
    });
    ...
    it('quick event popup checking', () => {
      schObj.popupOpen = (args: PopupOpenEventArgs) => {
        (<HTMLElement>(
          args.element.querySelector('.e-popup-header .e-edit')
        )).style.display = 'none';
        (<HTMLElement>(
          args.element.querySelector('.e-popup-header .e-delete')
        )).style.display = 'none';
        (<HTMLElement>(
          args.element.querySelector('.e-popup-footer')
        )).style.display = 'block';
      };
      util.triggerMouseEvent(
        schObj.element.querySelector('[data-id="Appointment_1"]'),
    ...
    it('more events checking in multiple resource grouping', (done: DoneFn) => {
      schObj.dataBound = () => {
        ...
        util.triggerMouseEvent(
          schObj.element.querySelector('.e-more-indicator'),
          'click'
        );
      ...
      (<HTMLInputElement>eventPopup.querySelector('.e-subject')).value =
        'Conference Meeting';
      util.triggerMouseEvent(
        eventPopup.querySelector('.e-event-create'),
        'click'
      );
    });
    ...
    it('normal event edit checking in more events with multiple resource grouping', (done: DoneFn) => {
      schObj.dataBound = () => {
        expect(schObj.eventsData.length).toEqual(10);
        expect(morePopup.classList).toContain('e-popup-open');
        const recurrenceIcon: Element =
          morePopup.querySelector('.e-recurrence-icon');
      ...
      expect(morePopup.classList).toContain('e-popup-open');
      const appElement: HTMLElement = morePopup.querySelector(
        '.e-appointment'
      ) as HTMLElement;
      expect(appElement.getAttribute('data-group-index')).toEqual('1');
      ...
      const recObj: RecurrenceEditor = (
        eventWindow.querySelector('.e-recurrenceeditor') as EJ2Instance
      ).ej2_instances[0] as RecurrenceEditor;
      recObj.value = 'FREQ=DAILY;INTERVAL=1;COUNT=5';
      recObj.dataBind();
      util.triggerMouseEvent(
        eventWindow.querySelector('.e-event-save'),
        'click'
      );
    ...
    it('recurrence event edit checking in more events with multiple resource grouping', (done: DoneFn) => {
      schObj.dataBound = () => {
        ...
        expect(morePopup.classList).toContain('e-popup-open');
        const recurrenceIcon: Element = morePopup.querySelector(
      ...
      expect(morePopup.classList).toContain('e-popup-open');
      const appElement: HTMLElement = closest(
        morePopup.querySelector('.e-recurrence-icon'),
        '.e-appointment'
      ) as HTMLElement;
      expect(appElement.getAttribute('data-group-index')).toEqual('1');
      ...
      util.triggerMouseEvent(
        quickDialog.querySelector('.e-quick-dialog-occurrence-event'),
        'click'
      );
    ...
    it('eventRendered event checking for more event popup with multiple resource grouping', () => {
      ...
      expect(morePopup.classList).toContain('e-popup-open');
      const appElement: HTMLElement[] = [].slice.call(
        morePopup.querySelectorAll('.e-appointment')
      );
    ...
    it('popupOpen event checking in more events with multiple resource grouping', () => {
      ...
      expect(
        schObj.element.querySelector('.e-more-popup-wrapper').classList
      ).toContain('e-popup-close');
    });

    it('selected date changed to current date', (done: DoneFn) => {
      schObj.dataBound = () => {
        expect(
          schObj.element.querySelectorAll('.e-header-cells.e-current-day')
            .length
        ).toEqual(3);
        done();
      };
      ...
      const generateData: CallbackFunction = () => {
        ...
        for (let i: number = 0; i < 5; i++) {
          dataCol.push({
            ...
            EndTime: new Date(
              currentDate.getTime() + (i * 60 + 60) * (1000 * 60)
            ),
            IsAllDay: false,
            RoomId: 1,
            OwnerId: 3,
  ...
  describe('Event actions in mobile device', () => {
    ...
    it('checking multiple events delete in mobile', (done: DoneFn) => {
      ...
      (schObj.scheduleTouchModule as any).tapHoldHandler({
        originalEvent: { target: appElements[0], type: 'touchstart' },
      });
      ...
      util.triggerMouseEvent(
        eventPopup.querySelector('.e-delete-icon'),
        'click'
      );
      const quickDialog: Element = document.querySelector(
        '.e-dialog.e-quick-dialog'
      );
      expect(quickDialog.classList).toContain('e-popup-open');
      expect(quickDialog.querySelector('.e-dlg-header').innerHTML).toEqual(
        'Delete Multiple Events'
      );
      expect(quickDialog.querySelector('.e-dlg-content').innerHTML).toEqual(
        'Are you sure you want to delete the selected events?'
      );
      const deleteButton: HTMLElement = quickDialog.querySelector(
  ...
  describe('Ignore Edited Occurrences Scenarios', () => {
    ...
    it('Edit Single Occurrence', (done: DoneFn) => {
      ...
      (eventWindow.querySelector('.e-subject') as HTMLInputElement).value =
        'Recurrence - Edited';
      util.triggerMouseEvent(
        eventWindow.querySelector('.e-event-save'),
        'click'
    ...
    it('Edit Single Occurrence as Series and ignore edited occurrence', (done: DoneFn) => {
      ...
      expect(quickDialog.classList.contains('e-popup-open')).toEqual(true);
      util.triggerMouseEvent(
        quickDialog.querySelector('.e-quick-dialog-series-event'),
        'click'
      );
      expect(quickDialog.classList.contains('e-popup-open')).toEqual(false);
      const eventWindow: HTMLElement = schObj.eventWindow.dialogObject.element;
      ...
      expect(quickDialog.classList.contains('e-popup-open')).toEqual(true);
      expect(
        quickDialog.querySelectorAll('.e-footer-content button').length
      ).toEqual(3);
      util.triggerMouseEvent(
        quickDialog.querySelector('.e-quick-dialog-cancel'),
        'click'
      );
      expect(quickDialog.classList.contains('e-popup-open')).toEqual(false);
      expect(eventWindow.classList.contains('e-popup-open')).toEqual(true);
      util.triggerMouseEvent(
        quickDialog.querySelector('.e-quick-alertcancel '),
        'click'
      );
      expect(quickDialog.classList.contains('e-popup-open')).toEqual(false);
      expect(eventWindow.classList.contains('e-popup-open')).toEqual(false);
    ...
    it('Edit Single Occurrence as Series and include edited occurrence', (done: DoneFn) => {
      ...
      expect(eventWindow.classList.contains('e-popup-open')).toEqual(true);
      util.triggerMouseEvent(
        quickDialog.querySelector('.e-quick-alertok '),
        'click'
      );
      expect(quickDialog.classList.contains('e-popup-open')).toEqual(false);
      expect(eventWindow.classList.contains('e-popup-open')).toEqual(false);
  ...
  describe('Edit Following Events', () => {
    ...
    beforeAll((done: DoneFn) => {
      const model: ScheduleModel = {
        height: '500px',
        selectedDate: new Date(2019, 1, 4),
    ...
    it('Edit Series excluding with ignore occurrence event and without following events', (done: DoneFn) => {
      schObj.dataBound = () => {
        ...
        >[];
        expect(
          (<string>dataObj[0].RecurrenceException).split(',').length
        ).toEqual(1);
        expect(dataObj[0].Subject).toEqual('Recurrence Series');
        expect(dataObj[0].RecurrenceException as string).toEqual(
          '20190205T100000Z'
        );
    ...
    it('Edit Following Event', (done: DoneFn) => {
      ...
      expect(quickDialog.classList.contains('e-popup-open')).toEqual(true);
      util.triggerMouseEvent(
        quickDialog.querySelector('.e-quick-dialog-following-events'),
        'click'
      );
      expect(quickDialog.classList.contains('e-popup-open')).toEqual(false);
      const eventWindow: HTMLElement = schObj.eventWindow.dialogObject.element;
    ...
    it('Edit single occurrence in following series', (done: DoneFn) => {
      schObj.dataBound = () => {
        ...
        expect(dataObj[3].Subject).toEqual(
          'Recurrence - Edited in following series'
        );
    ...
    it('Edit Following Series and include edited occurrence', (done: DoneFn) => {
      schObj.dataBound = () => {
        ...
        expect(dataObj[3].Subject).toEqual(
          'Include Edited Occurrences in Following Edit'
        );
    ...
    it('Edit More Single Occurrence to ensure Delete Functionality', (done: DoneFn) => {
      schObj.dataBound = () => {
        ...
        expect(dataObj[0].Id).toEqual(1);
        expect(dataObj[0].RecurrenceException).toEqual(
          '20190205T100000Z,20190208T100000Z'
        );
        expect(dataObj[0].Subject).toEqual('Recurrence');
        expect(dataObj[1].Id).toEqual(2);
        expect(dataObj[1].RecurrenceID).toEqual(1);
    ...
    it('Delete Single Occurrence', (done: DoneFn) => {
      schObj.dataBound = () => {
        ...
        expect(dataObj[0].Id).toEqual(1);
        expect(dataObj[0].RecurrenceException).toEqual(
          '20190205T100000Z,20190208T100000Z,20190209T100000Z'
        );
        expect(dataObj[0].Subject).toEqual('Recurrence');
        done();
      };
    ...
    it('Delete Following Events', (done: DoneFn) => {
      schObj.dataBound = () => {
        ...
        expect(
          (<string>dataObj[1].RecurrenceException).split(',').length
        ).toEqual(1);
        expect(dataObj[1].Subject).toEqual('Recurrence - Edited1');
        done();
      };
  ...
  describe('Create Following Events as Separate Series When Time Changes', () => {
    ...
    it('ES-827815 - Check Following Edit Button Availability for Recurrence Edited Event', (done: DoneFn) => {
      ...
      expect(
        quickDialog
          .querySelector('.e-footer-content .e-quick-dialog-following-events')
    ...
    it('Edit Following Event', (done: DoneFn) => {
      schObj.dataBound = () => {
        ...
        expect(dataObj[0].Subject).toEqual('Recurrence');
        expect(dataObj[0].RecurrenceException as string).toEqual(
          '20190205T100000Z,20190204T100000Z'
        );
        expect(dataObj[0].Id).toEqual(1);
      ...
      const startDate: DateTimePicker = (
        (<HTMLElement>dialogElement.querySelector('.e-start')) as EJ2Instance
  ...
  describe('Multiple resource grouping without enableRtl', () => {
    ...
    it('agenda view quick popup backgroud check without enableRtl', () => {
      const resourceEvent: HTMLElement = schObj.element.querySelector(
        '[data-id="Appointment_1"]'
      ) as HTMLElement;
    ...
    it('agenda view quick popup backgroud check with enableRtl', (done: DoneFn) => {
      schObj.dataBound = () => {
        ...
        expect(resourceEvent.style.borderRightColor).toEqual(
          'rgb(255, 170, 0)'
        );
        done();
      };
  ...
  describe('closeQuickInfoPopup public method testing', () => {
    ...
    it('Checking for cell click quick info popup', () => {
      ...
      util.triggerMouseEvent(workCell, 'click');
      expect(
        schObj.quickPopup.quickPopup.element.querySelectorAll('.e-cell-popup')
          .length
      ).toEqual(1);
    ...
    it('Checking for event click quick info popup', () => {
      ...
      expect(
        schObj.quickPopup.quickPopup.element.querySelectorAll('.e-event-popup')
          .length
      ).toEqual(1);
      schObj.closeQuickInfoPopup();
      expect(
  ...
  describe('CRUD Actions Using API', () => {
    ...
    it('Cell click and insert event', () => {
      util.triggerMouseEvent(
        schObj.element.querySelector('.' + cls.WORK_HOURS_CLASS),
        'click'
      );
      expect(
        schObj.element
    ...
    it('Event Click and Delete event', () => {
      util.triggerMouseEvent(
        schObj.element.querySelector('.e-appointment:nth-child(2)'),
        'click'
      );
      expect(
        schObj.element
  ...
  describe('isMorePopup property checking on mobile view', () => {
    ...
    it('More event popup checking on the month view', () => {
      (
        schObj.element.querySelectorAll('.e-more-indicator')[2] as HTMLElement
      ).click();
      const moreEventPopup: Element = document.querySelector(
        '.e-more-popup-wrapper'
      );
      expect(isVisible(moreEventPopup)).toBe(true);
      const moreEventWrapper: HTMLElement = document.querySelector(
    ...
    it('isMorePopup property is set to false and check the more indicator click navigation on timeline day view', (done: DoneFn) => {
      schObj.moreEventsClick = (args: MoreEventsClickArgs) =>
        (args.isPopupOpen = false);
      schObj.dataBound = () => {
        expect(schObj.currentView).toEqual('TimelineDay');
        expect(isVisible(document.querySelector('.e-more-popup-wrapper'))).toBe(
          false
        );
        done();
      };
  ...
  describe('EJ2-60854, EJ2-72151 - appointment subject, description as HTML elements with enableHtmlSanitizer set to true', () => {
    ...
    const data: Record<string, any>[] = [
      {
        Id: 1,
        Subject:
          '<a href="https://www.milletsoftware.com" title="Millet Software" target="_blank">&#x1F50E MS User Group</a>',
        StartTime: new Date(2023, 3, 12, 10, 0),
        EndTime: new Date(2023, 3, 12, 12, 0),
        Location: '<b>Syncfusion</b>',
        Description:
          '<p>FARE SOPRALLUOGO PER UNIPOLSAI</p><p>RG) NAPIONE 6 P.<p><p>AC) GAREFFA 5 P. LO AVVERTE NAPIONE' +
          ' - no decorazioni</p>',
        RoomId: 1,
      },
      {
    ...
    it('CRIssue EJ2-60854 - subject passed as link', () => {
      const resourceHeader: HTMLElement = schObj.element.querySelector(
      ...
      const apps: HTMLElement[] = [].slice.call(
        schObj.element.querySelectorAll('.e-appointment, .e-block-appointment')
      );
      ...
      expect(subjectEle.getAttribute('title')).toBe(
        "<a href='https://www.milletsoftware.com' title='Millet Software' target='_blank'>🔎 MS User Group</a>"
      );
      locationEle = eventPopup.querySelector('.e-location-details');
      expect(locationEle.innerHTML).toEqual('&lt;b&gt;Syncfusion&lt;/b&gt;');
      expect(locationEle.innerText).toEqual('<b>Syncfusion</b>');
      const descriptionEle: HTMLElement = eventPopup.querySelector(
        '.e-description-details'
      );
      expect(descriptionEle.innerHTML).toEqual(
        '&lt;p&gt;FARE SOPRALLUOGO PER UNIPOLSAI&lt;/p&gt;&lt;p&gt;RG) NAPIONE 6 P.' +
          '&lt;/p&gt;&lt;p&gt;&lt;/p&gt;&lt;p&gt;AC) GAREFFA 5 P. LO AVVERTE NAPIONE - no decorazioni&lt;/p&gt;'
      );
      expect(descriptionEle.innerText).toEqual(
        '<p>FARE SOPRALLUOGO PER UNIPOLSAI</p><p>RG) NAPIONE 6 P.' +
          '</p><p></p><p>AC) GAREFFA 5 P. LO AVVERTE NAPIONE - no decorazioni</p>'
      );
      const resourceEle: HTMLElement = eventPopup.querySelector(
        '.e-resource-details'
      );
  ...
  describe('EJ2-72151 - appointment subject, description as HTML elements with enableHtmlSanitizer set to false', () => {
    ...
    it('subject and description as HTML elements', () => {
      ...
      expect(descriptionEle.innerText).toEqual(
        'FARE SOPRALLUOGO PER UNIPOLSAI\n\nRG) NAPIONE 6 P.\n\nAC) GAREFFA 5 P.' +
  ...
  describe('appointment colour was not applied read-only events in year view', () => {
    ...
    it('More event popup checking read only on the year view', () => {
      util.triggerMouseEvent(
        schObj.element.querySelectorAll('.e-cell.e-work-cells')[21]
          .firstElementChild as HTMLElement,
        'click'
      );
      const morePopup: HTMLElement = schObj.element.querySelector(
      ...
      expect(morePopup.classList).toContain('e-popup-open');
      const appElement: NodeListOf<Element> =
        morePopup.querySelectorAll('.e-appointment');
