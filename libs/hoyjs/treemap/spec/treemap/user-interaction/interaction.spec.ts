...
import {
  TreeMapHighlight,
  TreeMapSelection,
} from '../../../src/treemap/user-interaction/highlight-selection';
...
} from '../../../src/treemap/model/interface';
...
describe('TreeMap component Spec', () => {
    ...
    it('Checking with drilldown for each levels ', () => {
      treemap.loaded = (args: ILoadedEventArgs) => {
        let rectEle: Element = document.getElementById(
          args.treemap.element.id + '_Level_Index_0_Item_Index_0_RectPath'
        );
        let eventObj: Object = {
          target: rectEle,
          type: 'mouseup',
        ...
        treemap.mouseEndOnTreeMap(<PointerEvent>eventObj);
        treemap.mouseEndOnTreeMap(<PointerEvent>eventObj);
        rectEle = document.getElementById(
          args.treemap.element.id + '_Level_Index_0_Item_Index_1_RectPath'
        );
        eventObj = {
          target: rectEle,
          type: 'mouseup',
        ...
        treemap.mouseEndOnTreeMap(<PointerEvent>eventObj);
        rectEle = document.getElementById(
          args.treemap.element.id + '_Level_Index_1_Item_Index_1_RectPath'
        );
        eventObj = {
          target: rectEle,
          type: 'mouseup',
        ...
        treemap.mouseEndOnTreeMap(<PointerEvent>eventObj);
        rectEle = document.getElementById(
          args.treemap.element.id + '_Level_Index_1_Item_Index_0_RectPath'
        );
        eventObj = {
          target: rectEle,
          type: 'mouseup',
  ...
  describe('Checking with drilldown spec to generate Legend in each level', () => {
    ...
    it('Checking with drilldown to generate legend for each levels ', () => {
      treemap.loaded = (args: ILoadedEventArgs) => {
        let rectEle: Element = document.getElementById(
          'drill-container_Level_Index_0_Item_Index_0_RectPath'
        );
        let eventObj: Object = {
          target: rectEle,
          type: 'mouseup',
        ...
        treemap.mouseEndOnTreeMap(<PointerEvent>eventObj);
        rectEle = document.getElementById(
          'drill-container_Level_Index_1_Item_Index_1_RectPath'
        );
        eventObj = {
          target: rectEle,
          type: 'mouseup',
  ...
  describe('TreeMap highlight spec', () => {
    ...
    it('Checking with highlight - item mode', () => {
      treemap.loaded = (args: ILoadedEventArgs) => {
        let layoutID: string =
          args.treemap.element.id +
          '_TreeMap_' +
          args.treemap.layoutType +
          '_Layout';
    ...
    it('Checking with mouse move on title', () => {
      treemap.loaded = (args: ILoadedEventArgs) => {
        let titleEle: Element = document.getElementById(
  ...
  describe('TreeMap highlight and selection spec with legendsettings', () => {
    ...
    it('Checking with highlight enable on outside of the node', () => {
      treemap.loaded = (args: ILoadedEventArgs) => {
        ...
        let eventObj: Object = {};
        rectEle = document.getElementById(
          args.treemap.element.id + '_TreeMap_Border'
        );
        eventObj = {
          target: rectEle,
          type: 'mousemove',
    ...
    it('Checking with multi node highlight enable with default mode', () => {
      treemap.loaded = (args: ILoadedEventArgs) => {
        ...
        treemap.mouseMoveOnTreeMap(<PointerEvent>eventObj);
        rectEle = document.getElementById(
          'container_Level_Index_0_Item_Index_2_RectPath'
        );
        eventObj = {
          target: rectEle,
          type: 'mousemove',
    ...
    it('', () => {
      treemap.loaded = (args: ILoadedEventArgs) => {
        ...
        treemap.mouseMoveOnTreeMap(<PointerEvent>eventObj);
        rectEle = document.getElementById(
          args.treemap.element.id + '_Level_Index_0_Item_Index_18_RectPath'
        );
        eventObj = {
          target: rectEle,
          type: 'mousemove',
    ...
    it('Checking with legend highlight enable with default mode', () => {
      treemap.loaded = (args: ILoadedEventArgs) => {
        ...
        let eventObj: Object = {};
        rectEle = document.getElementById(
          args.treemap.element.id + '_Legend_Shape_Index_1'
        );
        eventObj = {
          target: rectEle,
          type: 'mousemove',
    ...
    it('Checking with multi legend highlight enable with default mode', () => {
      treemap.loaded = (args: ILoadedEventArgs) => {
        ...
        treemap.mouseMoveOnTreeMap(<PointerEvent>eventObj);
        rectEle = document.getElementById(
          args.treemap.element.id + '_Legend_Shape_Index_0'
        );
        eventObj = {
          target: rectEle,
          type: 'mousemove',
    ...
    it('Checking with legend highlight enable with intreactive mode', () => {
      treemap.loaded = (args: ILoadedEventArgs) => {
        ...
        let eventObj: Object = {};
        rectEle = document.getElementById(
          args.treemap.element.id + '_Legend_Index_0'
        );
        eventObj = {
          target: rectEle,
          type: 'mousemove',
    ...
    it('Checking with legend selection enable with interactive mode', () => {
      treemap.loaded = (args: ILoadedEventArgs) => {
        ...
        let eventObj: Object = {};
        rectEle = document.getElementById(
          args.treemap.element.id + '_Legend_Index_1'
        );
        eventObj = {
          target: rectEle,
          type: 'mousedown',
  ...
  describe('TreeMap selection spec with legendsettings', () => {
    ...
    it('Checking with node selection without highlight', () => {
      treemap.loaded = (args: ILoadedEventArgs) => {
        ...
        let eventObj: Object = {};
        rectEle = document.getElementById(
          'container_Level_Index_0_Item_Index_13_RectPath'
        );
        eventObj = {
          target: rectEle,
          type: 'mousemove',
  ...
  describe('TreeMap highlight spec with legendsettings', () => {
    ...
    it('Checking with node highlight without selection with interactive legend', () => {
      treemap.loaded = (args: ILoadedEventArgs) => {
        ...
        let eventObj: Object = {};
        rectEle = document.getElementById(
          args.treemap.element.id + '_Level_Index_0_Item_Index_7_RectPath'
        );
        eventObj = {
          target: rectEle,
          type: 'mousemove',
    ...
    it('Checking with node selection with highlight', () => {
      treemap.loaded = (args: ILoadedEventArgs) => {
        ...
        treemap.mouseDownOnTreeMap(<PointerEvent>eventObj);
        rectEle = document.getElementById(
          args.treemap.element.id + '_Level_Index_0_Item_Index_10_RectPath'
        );
        eventObj = {
          target: rectEle,
          type: 'mousemove',
        ...
        treemap.mouseMoveOnTreeMap(<PointerEvent>eventObj);
        rectEle = document.getElementById(
          args.treemap.element.id + '_Level_Index_0_Item_Index_8_RectPath'
        );
        eventObj = {
          target: rectEle,
          type: 'mousemove',
    ...
    it('Checking with legend selection with node highlight', () => {
      treemap.loaded = (args: ILoadedEventArgs) => {
        ...
        treemap.mouseDownOnTreeMap(<PointerEvent>eventObj);
        rectEle = document.getElementById(
          args.treemap.element.id + '_Level_Index_0_Item_Index_4_RectPath'
        );
        eventObj = {
          target: rectEle,
          type: 'mousemove',
        ...
        treemap.mouseMoveOnTreeMap(<PointerEvent>eventObj);
        rectEle = document.getElementById(
          args.treemap.element.id + '_Level_Index_0_Item_Index_2_RectPath'
        );
        eventObj = {
          target: rectEle,
          type: 'mousemove',
  ...
  describe('Checking drilldown with RTL', () => {
    ...
    it('Checking drilldown with RTL for each levels ', () => {
      treemap.loaded = (args: ILoadedEventArgs) => {
        ...
        treemap.mouseEndOnTreeMap(<PointerEvent>eventObj);
        rectEle = document.getElementById(
          'drill-container_Level_Index_1_Item_Index_0_Text_0'
        );
        eventObj = {
          target: rectEle,
          type: 'mousedown',
  ...
  describe('Checking drilldown view', () => {
    ...
    it('Checking drilldown view as false with breadcrumb as true by clicking the drill levels', () => {
      treemap.loaded = (args: ILoadedEventArgs) => {
        ...
        treemap.mouseEndOnTreeMap(<PointerEvent>eventObj);
        rectEle = document.getElementById(
          'drill-container_Level_Index_1_Item_Index_1_Text'
        );
        eventObj = {
          target: rectEle,
          type: 'mousedown',
        ...
        treemap.mouseEndOnTreeMap(<PointerEvent>eventObj);
        rectEle = document.getElementById(
          'drill-container_Level_Index_1_Item_Index_0_Text_1'
        );
        eventObj = {
          target: rectEle,
          type: 'mousedown',
    ...
    it('Checking drilldown view by clicking the drill levels', () => {
      treemap.loaded = (args: ILoadedEventArgs) => {
        ...
        treemap.mouseEndOnTreeMap(<PointerEvent>eventObj);
        rectEle = document.getElementById(
          'drill-container_Level_Index_0_Item_Index_0_Text_0'
        );
        eventObj = {
          target: rectEle,
          type: 'mousedown',
        ...
        treemap.mouseEndOnTreeMap(<PointerEvent>eventObj);
        rectEle = document.getElementById(
          'drill-container_Level_Index_0_Item_Index_1_Text'
        );
        eventObj = {
          target: rectEle,
          type: 'mousedown',
  ...
  describe('TreeMap onDemand Process drill down spec', () => {
      ...
      treemap = new TreeMap(
        {
          ...
          drillStart: (args: IDrillStartEventArgs) => {
            var xx = findChildren(args.item)['values'];
            var yy;
            if (!xx[0]['isDrilled']) {
              yy = xx;
            } else {
    ...
    it('Checking with onDemand drilldown process ', () => {
      treemap.loaded = (args: ILoadedEventArgs) => {
        ...
        treemap.mouseEndOnTreeMap(<PointerEvent>eventObj);
        let rectElem: Element = document.getElementById(
          args.treemap.element.id + '_Level_Index_0_Item_Index_0_Text'
        );
