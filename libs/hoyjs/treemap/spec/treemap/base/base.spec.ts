...
describe('TreeMap Component Base Spec', () => {
  ...
  describe('TreeMap testing spec', () => {
    ...
    it('Checking with tree map data when item text is substring of another tree map item', () => {
      treemap.loaded = (args: ILoadedEventArgs) => {
        let element: Element = document.getElementById(
          args.treemap.element.id + '_Level_Index_1_Item_Index_20_Group'
        );
        expect(element.getAttribute('tabindex')).toBe(null);
        element = document.getElementById(
          args.treemap.element.id + '_Level_Index_1_Item_Index_18_Group'
        );
        expect(element.getAttribute('tabindex')).toBe(null);
      };
    ...
    it('Checking with label template', () => {
      ...
      treemap.leafItemSettings = {
        ...
        labelTemplate:
          '<div><img src="https://js.syncfusion.com/demos/web/images/treemap/{{:GameImage}}"></img></div>',
      };
      treemap.levels = [];
      treemap.refresh();
    });
    ...
    it('Checking with horizontal layout', () => {
      ...
      treemap.levels = [
        {
          groupPath: 'GameName',
          headerTemplate: '<div><p>{{:GameName}}</p></div>',
        },
      ];
      treemap.refresh();
    });
  ...
  describe('TreeMap title testing spec', () => {
    ...
    it('check title element', () => {
      treemap.loaded = (args: ILoadedEventArgs) => {
        let element: Element = document.getElementById(
          args.treemap.element.id + '_Title_Group'
        );
    ...
    it('check title alignment Center ', () => {
      treemap.loaded = (args: ILoadedEventArgs) => {
        ...
        let rect: ClientRect = element.children[0].getBoundingClientRect();
        expect(rect.left + rect.width).toBeGreaterThan(
          args.treemap.availableSize.width / 2
        );
      };
    ...
    it('Check subtitle alignment with Near', () => {
      treemap.loaded = (args: ILoadedEventArgs) => {
        ...
        let titleRect: ClientRect = element.children[0].getBoundingClientRect();
        let subTitleRect: ClientRect =
          element.children[1].getBoundingClientRect();
        expect(subTitleRect.left).toBeLessThanOrEqual(
    ...
    it('Check subtitle alignment with Center', () => {
      treemap.loaded = (args: ILoadedEventArgs) => {
        ...
        let subTitleRect: ClientRect =
          element.children[1].getBoundingClientRect();
        expect(subTitleRect.left + subTitleRect.width).toBeGreaterThanOrEqual(
          titleRect.left + titleRect.width / 2
        );
      };
