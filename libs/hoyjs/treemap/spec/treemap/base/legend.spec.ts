...
describe('TreeMap Component Base Spec', () => {
  ...
  describe('TreeMap Default legend spec', () => {
    ...
    it('Checking with default legend without any customization', () => {
      treemap.loaded = (args: ILoadedEventArgs) => {
        let element: Element = document.getElementById(
          'legend-container_Legend_Text_Index_0'
        );
    ...
    it('Checking with legend height and width ', () => {
      treemap.loaded = (args: ILoadedEventArgs) => {
        let element: Element = document.getElementById(
          'legend-container_Legend_Text_Index_1'
        );
    ...
    it('Checking with legend orientation', () => {
      treemap.loaded = (args: ILoadedEventArgs) => {
        ...
        expect(legendBounds.left).toBeLessThan(
          args.treemap.areaRect.x + args.treemap.areaRect.width / 2
        );
      };
    ...
    it('Checking with legend position - top ', () => {
      treemap.loaded = (args: ILoadedEventArgs) => {
        element = document.getElementById('legend-container_Legend_Group');
        let legendBounds: ClientRect = element.getBoundingClientRect();
        expect(legendBounds.top).toBeLessThan(
          args.treemap.areaRect.y + args.treemap.areaRect.height / 2
        );
      };
    ...
    it('Checking with legend position - Right ', () => {
      treemap.loaded = (args: ILoadedEventArgs) => {
        element = document.getElementById(
          'legend-container_Legend_Shape_Index_0'
        );
        expect(element.getAttribute('fill')).toBe('#ff9900');
        element = document.getElementById(
          'legend-container_Legend_Shape_Index_1'
        );
    ...
    it('Checking with legend orientation as vertical', () => {
      treemap.loaded = (args: ILoadedEventArgs) => {
        element = document.getElementById(
          'legend-container_Legend_Text_Index_2'
        );
        expect(element.innerHTML).toBe('40 - 50');
        element = document.getElementById(
          'legend-container_Legend_Shape_Index_2'
        );
    ...
    it('Checking with legend paging', () => {
      treemap.loaded = (args: ILoadedEventArgs) => {
        ...
        treemap.treeMapLegendModule.changeNextPage(<PointerEvent>eventObj);
        expect(
          document.getElementById('legend-container_Legend_Paging_Group')
            .childElementCount
        ).toBeGreaterThan(1);
      };
      treemap.legendSettings.position = 'Top';
    ...
    it('Range color mappping testing spec with multi colors', () => {
      treemap.loaded = (args: ILoadedEventArgs) => {
        ...
        let element1: Element = document.getElementById(
          id + '_Level_Index_0_Item_Index_2_RectPath'
        );
  ...
  describe('TreeMap Interactive legend with multi colors spec', () => {
    ...
    it('Checking with interactive legend with multi colors ', () => {
      treemap.loaded = (args: ILoadedEventArgs) => {
        element = document.getElementById(
          'interactive-container_Legend_Index_0'
        );
  ...
  describe('TreeMap Interactive legend spec', () => {
    ...
    it('Checking with interactive legend without any customization', () => {
      treemap.loaded = (args: ILoadedEventArgs) => {
        ...
        expect(element.getAttribute('fill')).toBe('#ff9900');
        element = document.getElementById(
          'interactive-container_Legend_Index_0_Text'
        );
        expect(element.innerHTML).toBe('20 - 30');
      };
      treemap.legendSettings.mode = 'Interactive';
    ...
    it('Checking with legend height and width ', () => {
      treemap.loaded = (args: ILoadedEventArgs) => {
        element = document.getElementById(
          'interactive-container_Legend_Index_2'
        );
        expect(element.getAttribute('fill')).toBe('#669900');
        element = document.getElementById(
          'interactive-container_Legend_Index_2_Text'
        );
        expect(element.innerHTML).toBe('40 - 50');
      };
    ...
    it('Checking with legend orientation ', () => {
      treemap.loaded = (args: ILoadedEventArgs) => {
        element = document.getElementById(
          'interactive-container_Legend_Index_5'
        );
        expect(element.getAttribute('fill')).toBe('#006680');
        element = document.getElementById(
          'interactive-container_Legend_Index_5_Text'
        );
    ...
    it('Checking with label placement', () => {
      treemap.loaded = (args: ILoadedEventArgs) => {
        element = document.getElementById(
          'interactive-container_Legend_Index_1_Text'
        );
    ...
    it('Checking with interactive cursor', () => {
      treemap.loaded = (args: ILoadedEventArgs) => {
        // put the spec here //
        let element: Element = document.getElementById(
          args.treemap.element.id + '_Level_Index_0_Item_Index_0_Group'
        );
        let eventObj: Object = {
          target: element,
          type: 'mousemove',
        ...
        treemap.treeMapLegendModule.renderInteractivePointer(
          <PointerEvent>eventObj
        );
        let legendElement = document.getElementById(
          'interactive-container_Interactive_Legend'
        );
        expect(legendElement != null).toBe(true);
        element = document.getElementById(
          args.treemap.element.id + '_TreeMap_title'
        );
        eventObj = {
          target: element,
          type: 'mousemove',
        ...
        expect(
          document.getElementById('interactive-container_Interactive_Legend') ==
            null
        ).toBe(true);
      };
      treemap.refresh();
  ...
  describe('TreeMap legend customization spec', () => {
    ...
    it('Checking with legend shape - circle ', () => {
      treemap.loaded = (args: ILoadedEventArgs) => {
        element = document.getElementById(
          'interactive-container_Legend_Shape_Index_0'
        );
    ...
    it('Checking with legend shape - Cross ', () => {
      treemap.loaded = (args: ILoadedEventArgs) => {
        element = document.getElementById(
          'interactive-container_Legend_Shape_Index_2'
        );
        expect(element.getAttribute('fill')).toBe('#669900');
      };
    ...
    it('Checking with legend shape - VerticalLine ', () => {
      treemap.loaded = (args: ILoadedEventArgs) => {
        element = document.getElementById(
          'interactive-container_Legend_Shape_Index_4'
        );
    ...
    it('Checking with legend shape - Diamond ', () => {
      treemap.loaded = (args: ILoadedEventArgs) => {
        element = document.getElementById(
          'interactive-container_Legend_Shape_Index_3'
        );
        expect(element.getAttribute('fill')).toBe('#669900');
      };
    ...
    it('Checking with legend shape - Rectangle ', () => {
      treemap.loaded = (args: ILoadedEventArgs) => {
        element = document.getElementById(
          'interactive-container_Legend_Shape_Index_5'
        );
        expect(element.getAttribute('fill')).toBe('#006680');
      };
    ...
    it('Checking with legend shape - Triangle ', () => {
      treemap.loaded = (args: ILoadedEventArgs) => {
        element = document.getElementById(
          'interactive-container_Legend_Shape_Index_6'
        );
    ...
    it('Checking with legend shape - InvertedTriangle ', () => {
      treemap.loaded = (args: ILoadedEventArgs) => {
        element = document.getElementById(
          'interactive-container_Legend_Shape_Index_1'
        );
        expect(element.getAttribute('fill')).toBe('#999966');
      };
    ...
    it('Checking with legend shape - Image ', () => {
      ...
      treemap.legendSettings.imageUrl =
  ...
  describe('TreeMap legend testing spec', () => {
    ...
    it('Checking with palette legend ', () => {
      treemap.loaded = (args: ILoadedEventArgs) => {
        expect(
          document.getElementById('legend_Palette_container_Legend_Group')
            .childElementCount
        ).toBeGreaterThan(1);
      };
      treemap.palette = [
  ...
  describe('TreeMap Default legend spec', () => {
    ...
    it('Checking color mapping from datasource', () => {
      treemap.loaded = (args: ILoadedEventArgs) => {
        element = document.getElementById(
          'container_Level_Index_0_Item_Index_0_RectPath'
        );
  ...
  describe('TreeMap Default legend spec with RTL', () => {
    ...
    it('Checking default legend with RTL position as left', () => {
      treemap.loaded = (args: ILoadedEventArgs) => {
        elementShape = document.getElementById(
          'container_Legend_Shape_Index_3'
        );
  ...
  describe('TreeMap Interactive legend spec with RTL', () => {
    ...
    it('Checking Mouse Leave on Interactive legend', () => {
      treemap.loaded = (args: ILoadedEventArgs) => {
        debugger;
        let rectEle: Element = document.getElementById(
          args.treemap.element.id + '_Level_Index_1_Item_Index_14_RectPath'
        );
        let eventObj: Object = {
          target: rectEle,
          type: 'mousemove',
