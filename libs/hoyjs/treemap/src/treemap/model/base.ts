 ...
 * Maps base doc
 */
import { Property, ChildProperty, Complex, Collection } from '@hoyui/base';
import {
  LabelPosition,
  Alignment,
  HighLightMode,
...
export class LeafItemSettings extends ChildProperty<LeafItemSettings> {
   ...
   */
  @Complex<FontModel>({ color: null, size: null }, Font)
...
export class TooltipSettings extends ChildProperty<TooltipSettings> {
   ...
   */
  @Complex<FontModel>(
    { fontFamily: null, size: null, fontWeight: null, opacity: null },
    Font
  )
  public textStyle: FontModel;
}
