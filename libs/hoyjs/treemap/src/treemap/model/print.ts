...
export class Print {
  ...
  public print(treeMap: TreeMap, elements?: string[] | string | Element): void {
    ...
    const argsData: IPrintEventArgs = {
      cancel: false,
      htmlContent: this.getHTMLContent(treeMap, elements),
      name: beforePrint,
    };
  ...
  public getHTMLContent(
    treeMap: TreeMap,
    elements?: string[] | string | Element
  ): Element {
    ...
    if (elements) {
      ...
      const exportElement: HTMLElement = treeMap.element.cloneNode(
        true
      ) as HTMLElement;
      // eslint-disable-next-line @typescript-eslint/no-explicit-any
      let backgroundElement: HTMLElement = exportElement.getElementsByTagName(
        'svg'
