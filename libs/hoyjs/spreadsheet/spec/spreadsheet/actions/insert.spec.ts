...
import { L10n, EventHandler } from '@hoyui/base';
...
describe('Insert & Delete ->', () => {
  ...
  describe('public method ->', () => {
    ...
    it('Insert', (done: Function) => {
      ...
      setTimeout(() => {
        ...
        expect(helper.invoke('getCell', [4, 0]).textContent).toBe(
          'Sports Shoes'
        );
        ...
        setTimeout(() => {
          ...
          expect(helper.getInstance().sheets[0].rows[0].cells[5].value).toEqual(
            'Quantity'
          );
          ...
          setTimeout(() => {
            ...
            expect(
              helper
                .getElementFromSpreadsheet('.e-sheet-tab')
                .getElementsByClassName('e-toolbar-item').length
            ).toBe(3);
            done();
          });
        });
    ...
    it('Delete', (done: Function) => {
      ...
      setTimeout(() => {
        expect(helper.getInstance().sheets[0].rows[6].cells[0].value).toBe(
          'Flip- Flops & Slippers'
        );
        expect(helper.invoke('getCell', [6, 0]).textContent).toBe(
          'Flip- Flops & Slippers'
        );
  ...
  describe('UI interaction ->', () => {
    ...
    it('Insert row between borders', (done: Function) => {
      ...
      expect(spreadsheet.sheets[0].rows[2].cells[1].style).toEqual(
        jasmine.objectContaining({ borderLeft: '1px solid #000000' })
      );
      expect(spreadsheet.sheets[0].rows[2].cells[3].style).toEqual(
        jasmine.objectContaining({ borderRight: '1px solid #000000' })
      );
      expect(spreadsheet.sheets[0].rows[2].cells[6].style).toEqual(
        jasmine.objectContaining({
          borderBottom: '1px solid #000000',
          borderRight: '1px solid #000000',
        })
      );
      expect(spreadsheet.sheets[0].rows[2].cells[7].style).toEqual(
        jasmine.objectContaining({
      ...
      expect(spreadsheet.sheets[0].rows[2].cells[8].style).toEqual(
        jasmine.objectContaining({
          borderBottom: '1px solid #000000',
          borderLeft: '1px solid #000000',
        })
    ...
    it('Insert column between borders', (done: Function) => {
      ...
      expect(spreadsheet.sheets[0].rows[1].cells[7].style).toEqual(
        jasmine.objectContaining({
          borderBottom: '1px solid #000000',
          borderRight: '1px solid #000000',
        })
      ...
      expect(spreadsheet.sheets[0].rows[3].cells[7].style).toEqual(
        jasmine.objectContaining({
          borderBottom: '1px solid #000000',
      ...
      expect(spreadsheet.sheets[0].rows[5].cells[7].style).toEqual(
        jasmine.objectContaining({
          borderTop: '1px solid #000000',
          borderRight: '1px solid #000000',
        })
  ...
  describe('UI-Interaction->', () => {
    ...
    it('Delete Column->', (done: Function) => {
      ...
      setTimeout(() => {
        expect(helper.getInstance().sheets[0].rows[0].cells[1].value).toBe(
          'Date'
        );
  ...
  describe('UI-Interaction with Localization and Protect Sheet->', () => {
    ...
    it('Insert/Delete Row Checking ->', (done: Function) => {
      ...
      setTimeout(() => {
        expect(
          helper.getElement('#' + helper.id + '_contextmenu li:nth-child(6)')
            .classList
        ).toContain('e-disabled');
        expect(
          helper.getElement('#' + helper.id + '_contextmenu li:nth-child(7)')
            .classList
        ).toContain('e-disabled');
        done();
      });
    ...
    it('Hyperlink Checking ->', (done: Function) => {
      ...
      setTimeout(() => {
        expect(
          helper.getElement('#' + helper.id + '_contextmenu li:nth-child(11)')
            .classList
        ).toContain('e-disabled');
        done();
      });
  ...
  describe('UI_Interaction for Delete/Insert Row/Column with Freeze Pane', () => {
    ...
    it('Delete Row above Freeze pane applied row->', (done: Function) => {
      helper.invoke('selectRange', ['A2']);
      expect(helper.getInstance().sheets[0].rows[2].cells[0].value).toBe(
        'Sports Shoes'
      );
    ...
    it('Delete Row below Freeze pane applied row->', (done: Function) => {
      ...
      setTimeout(() => {
        expect(helper.getInstance().sheets[0].rows[5].cells[0].value).toBe(
          'Running Shoes'
        );
    ...
    it('Delete Column before Freeze pane applied Column->', (done: Function) => {
      helper.invoke('selectRange', ['B1']);
      expect(helper.getInstance().sheets[0].rows[0].cells[2].value).toBe(
        'Time'
      );
    ...
    it('Delete Column after Freeze pane applied Column->', (done: Function) => {
      ...
      expect(helper.getInstance().sheets[0].rows[0].cells[5].value).toBe(
        'Discount'
      );
      ...
      setTimeout(() => {
        expect(helper.getInstance().sheets[0].rows[0].cells[4].value).toBe(
          'Discount'
        );
    ...
    it('Insert Row before Freeze Column applied Cell->', (done: Function) => {
      ...
      setTimeout(() => {
        ...
        setTimeout(() => {
          ...
          expect(helper.getInstance().sheets[0].rows[4].cells[0].value).toBe(
            'Sandals & Floaters'
          );
          expect(helper.invoke('getCell', [4, 0]).textContent).toBe(
            'Sandals & Floaters'
    ...
    it('Insert Row before Freeze Row applied Cell->', (done: Function) => {
      ...
      setTimeout(() => {
        ...
        expect(helper.getInstance().sheets[0].rows[7].cells[0].value).toBe(
          'Running Shoes'
        );
        helper.setAnimationToNone('#' + helper.id + '_contextmenu');
        helper.openAndClickCMenuItem(6, 0, [6, 2], true);
        setTimeout(() => {
          expect(helper.getInstance().sheets[0].rows[8].cells[0].value).toBe(
            'Running Shoes'
          );
          expect(helper.invoke('getCell', [8, 0]).textContent).toBe(
            'Running Shoes'
          );
          done();
        });
  ...
  describe('UI_Interaction for Delete with Enable Virtualization - false', () => {
    ...
    it('EJ2-895900 - Formatting not applied while inserting the row between the formatted rows', (done: Function) => {
      ...
      expect(spreadsheet.sheets[0].rows[4].cells[0].style).toEqual({
        backgroundColor: '#FFFF00',
        fontWeight: 'bold',
        borderLeft: '1px solid #000000',
        borderRight: '1px solid #000000',
      ...
      expect(spreadsheet.sheets[0].rows[5].cells[0].style).toEqual({
        backgroundColor: '#FFFF00',
        fontWeight: 'bold',
        borderLeft: '1px solid #000000',
        borderRight: '1px solid #000000',
      ...
      expect(spreadsheet.sheets[0].rows[11].cells[0].style).toEqual({
        backgroundColor: '#FFFF00',
        fontWeight: 'bold',
        borderLeft: '1px solid #000000',
        borderRight: '1px solid #000000',
      ...
      expect(spreadsheet.sheets[0].rows[12].cells[0].style).toEqual({
        backgroundColor: '#FFFF00',
        fontWeight: 'bold',
      });
      expect(
        spreadsheet.sheets[0].rows[12].cells[0].style.borderLeft
      ).toBeUndefined();
      expect(
        spreadsheet.sheets[0].rows[12].cells[0].style.borderRight
      ).toBeUndefined();
      expect(
        spreadsheet.sheets[0].rows[12].cells[0].style.borderTop
      ).toBeUndefined();
      expect(
        spreadsheet.sheets[0].rows[12].cells[0].style.borderBottom
      ).toBeUndefined();
      done();
    });
    ...
    it('EJ2-895900 - Formatting not applied while inserting the column between the formatted columns', (done: Function) => {
      ...
      expect(spreadsheet.sheets[0].rows[2].cells[4].style).toEqual({
        backgroundColor: '#FFFF00',
        fontWeight: 'bold',
        borderLeft: '1px solid #000000',
        borderRight: '1px solid #000000',
      ...
      expect(spreadsheet.sheets[0].rows[2].cells[9].style).toEqual({
        backgroundColor: '#FFFF00',
        fontWeight: 'bold',
      });
      expect(
        spreadsheet.sheets[0].rows[2].cells[9].style.borderLeft
      ).toBeUndefined();
      expect(
        spreadsheet.sheets[0].rows[2].cells[9].style.borderRight
      ).toBeUndefined();
      expect(
        spreadsheet.sheets[0].rows[2].cells[9].style.borderTop
      ).toBeUndefined();
      expect(
        spreadsheet.sheets[0].rows[2].cells[9].style.borderBottom
      ).toBeUndefined();
      done();
    });
  ...
  describe('UI_Interaction for Delete with Image', () => {
    ...
    it('Delete Column with enable virtualization False->', (done: Function) => {
      ...
      let image: ImageModel =
        helper.getInstance().sheets[0].rows[2].cells[3].image[0];
      ...
      EventHandler.remove(
        document,
        'mouseup',
        helper.getInstance().serviceLocator.services.shape.overlayMouseUpHandler
      );
      helper.invoke('selectRange', ['B1']);
      helper.setAnimationToNone('#' + helper.id + '_contextmenu');
      helper.openAndClickCMenuItem(0, 1, [7], false, true);
  ...
  describe('UI_Interaction', () => {
    ...
    it('Delete 1st Column in Merged Cell->', (done: Function) => {
      ...
      setTimeout(() => {
        ...
        setTimeout(() => {
          expect(
            helper.getInstance().sheets[0].rows[0].cells[1].value
          ).toBeUndefined();
          expect(helper.getInstance().sheets[0].rows[0].cells[2].value).toBe(
            'Quantity'
          );
    ...
    it('Delete by selecting cf applied and non cf applied column ->', (done: Function) => {
      ...
      setTimeout((): void => {
        const cfRule: ConditionalFormatModel[] =
          spreadsheet.sheets[0].conditionalFormats;
  ...
  describe('CR-Issues ->', () => {
      ...
      it('Issue with data updation in the inserted column ', (done: Function) => {
        ...
        setTimeout((): void => {
          ...
          cellsModel.forEach((cell: CellModel): void => {
            spreadsheet.updateCell(cell, getCellAddress(rowIndex, 1));
            rowIndex++;
          });
          expect(spreadsheet.sheets[0].rows[1].cells[1].value).toBe(
            'Unit Price'
          );
          expect(helper.invoke('getCell', [1, 1]).textContent).toBe(
            'Unit Price'
          );
          expect(spreadsheet.sheets[0].rows[2].cells[1].value.toString()).toBe(
            '18'
          );
          expect(helper.invoke('getCell', [2, 1]).textContent).toBe('18');
          expect(spreadsheet.sheets[0].rows[11].cells[1].value.toString()).toBe(
            '97'
          );
    ...
    describe('fb16095, I284821, I309406, F161227, I282799, I282799 ->', () => {
        ...
        helper.initializeSpreadsheet(
          {
            showSheetTabs: false,
            definedNames: [
              { name: 'definedRange', refersTo: "='Sheet1'!A1:C3" },
            ],
            sheets: [
              {
                rows: [
      ...
      it('After insert new row cell edit is not working and update formula while insert/delete the rows/columns in calculate library', (done: Function) => {
        ...
        expect(spreadsheet.sheets[0].rows[2].cells[0].formula).toBe(
          '=SUM(A1:A2)'
        );
        spreadsheet.insertRow(1);
        setTimeout((): void => {
          expect(spreadsheet.definedNames[0].refersTo).toBe("='Sheet1'!A1:C4");
          expect(spreadsheet.sheets[0].rows[3].cells[0].formula).toBe(
            '=SUM(A1:A3)'
          );
          helper.edit('A2', '20');
          setTimeout((): void => {
            expect(
              spreadsheet.sheets[0].rows[1].cells[0].value.toString()
            ).toBe('20');
            expect(helper.invoke('getCell', [1, 0]).textContent).toBe('20');
            expect(
              spreadsheet.sheets[0].rows[3].cells[0].value.toString()
            ).toBe('35');
    ...
    describe('I312024 ->', () => {
      beforeEach((done: Function) => {
        helper.initializeSpreadsheet(
          { sheets: [{ name: 'Default' }, { name: 'Deleted' }] },
          done
        );
      });
      afterEach(() => {
      ...
      it('Sheets property issue in delete method', (done: Function) => {
        ...
        setTimeout((): void => {
          ...
          expect(
            helper.getElements(
              '#' + helper.id + ' .e-sheet-tab .e-toolbar-item'
            ).length
          ).toBe(1);
          done();
        });
    ...
    describe('I309292 ->', () => {
      ...
      it('Insert delete disable issues in context menu', (done: Function) => {
        ...
        helper.triggerMouseAction(
          'contextmenu',
          {
            x: cell.getBoundingClientRect().left + 1,
            y: cell.getBoundingClientRect().top + 1,
          },
          null,
          cell
        );
        setTimeout((): void => {
          expect(
            helper.getElement('#' + helper.id + '_cmenu_insert_column')
              .classList
          ).toContain('e-disabled');
          expect(
            helper.getElement('#' + helper.id + '_cmenu_delete_column')
              .classList
          ).toContain('e-disabled');
          done();
        });
    ...
    describe('SF-359221 ->', () => {
      beforeEach((done: Function) => {
        helper.initializeSpreadsheet(
          {
            sheets: [{ rowCount: 100, colCount: 100 }],
            scrollSettings: { enableVirtualization: false },
          },
          done
        );
        ...
        setTimeout((): void => {
          ...
          expect(
            spreadsheet
              ...
              .getElementsByClassName('e-header-cell')[0].textContent
          ).toBe('A');
          done();
        });
      });
    ...
    describe('Insert column with conditional formatting ->', () => {
        ...
        helper.initializeSpreadsheet(
          {
            sheets: [
              {
                name: 'Inventory List',
                ranges: [{ dataSource: InventoryList, startCell: 'A2' }],
                conditionalFormats: [
      ...
      it('Insert column before - 1 using contextmenu', (done: Function) => {
        ...
        spreadsheet.selectRange(
          getRangeAddress([0, 0, spreadsheet.sheets[0].rowCount, 1])
        );
        helper.setAnimationToNone('#' + helper.id + '_contextmenu');
        helper.openAndClickCMenuItem(0, 1, [6, 1], false, true);
        setTimeout((): void => {
      ...
      it('Insert column before - 2 using contextmenu', (done: Function) => {
        const spreadsheet: Spreadsheet = helper.getInstance();
        spreadsheet.selectRange(
          getRangeAddress([0, 3, spreadsheet.sheets[0].rowCount, 4])
        ); //D1:E200
        helper.setAnimationToNone('#' + helper.id + '_contextmenu');
        helper.openAndClickCMenuItem(0, 4, [6, 1], false, true);
        setTimeout((): void => {
      ...
      it('Insert column before - 3 using contextmenu', (done: Function) => {
        const spreadsheet: Spreadsheet = helper.getInstance();
        spreadsheet.selectRange(
          getRangeAddress([0, 6, spreadsheet.sheets[0].rowCount, 6])
        ); //G1:G200
        helper.setAnimationToNone('#' + helper.id + '_contextmenu');
      ...
      it('Insert column before - 4 using contextmenu', (done: Function) => {
        const spreadsheet: Spreadsheet = helper.getInstance();
        spreadsheet.selectRange(
          getRangeAddress([0, 7, spreadsheet.sheets[0].rowCount, 8])
        ); //H1:I200
        helper.setAnimationToNone('#' + helper.id + '_contextmenu');
      ...
      it('Insert column before - 5 using contextmenu', (done: Function) => {
        const spreadsheet: Spreadsheet = helper.getInstance();
        spreadsheet.selectRange(
          getRangeAddress([0, 11, spreadsheet.sheets[0].rowCount, 12])
        ); //L1:M200
        helper.setAnimationToNone('#' + helper.id + '_contextmenu');
      ...
      it('Insert column before - 6 using contextmenu', (done: Function) => {
        const spreadsheet: Spreadsheet = helper.getInstance();
        spreadsheet.selectRange(
          getRangeAddress([0, 14, spreadsheet.sheets[0].rowCount, 15])
        ); //O1:P200
        helper.setAnimationToNone('#' + helper.id + '_contextmenu');
      ...
      it('Insert column before - 7 using contextmenu', (done: Function) => {
        const spreadsheet: Spreadsheet = helper.getInstance();
        spreadsheet.selectRange(
          getRangeAddress([0, 17, spreadsheet.sheets[0].rowCount, 18])
        ); //R1:S200
        helper.setAnimationToNone('#' + helper.id + '_contextmenu');
      ...
      it('Insert column after - 2 - using contextmenu', (done: Function) => {
        const spreadsheet: Spreadsheet = helper.getInstance();
        spreadsheet.selectRange(
          getRangeAddress([0, 4, spreadsheet.sheets[0].rowCount, 4])
        ); //E1:E200
        helper.setAnimationToNone('#' + helper.id + '_contextmenu');
      ...
      it('Insert column after - 3 - using contextmenu', (done: Function) => {
        const spreadsheet: Spreadsheet = helper.getInstance();
        spreadsheet.selectRange(
          getRangeAddress([0, 4, spreadsheet.sheets[0].rowCount, 5])
        ); //E1:F200
        helper.setAnimationToNone('#' + helper.id + '_contextmenu');
      ...
      it('Insert column after - 4 - using contextmenu', (done: Function) => {
        const spreadsheet: Spreadsheet = helper.getInstance();
        spreadsheet.selectRange(
          getRangeAddress([0, 10, spreadsheet.sheets[0].rowCount, 11])
        ); //K1:L200
        helper.setAnimationToNone('#' + helper.id + '_contextmenu');
      ...
      it('Insert column after - 5 - using contextmenu', (done: Function) => {
        const spreadsheet: Spreadsheet = helper.getInstance();
        spreadsheet.selectRange(
          getRangeAddress([0, 9, spreadsheet.sheets[0].rowCount, 9])
        ); //J1:J200
        helper.setAnimationToNone('#' + helper.id + '_contextmenu');
      ...
      it('Insert column after - 6 - using contextmenu', (done: Function) => {
        const spreadsheet: Spreadsheet = helper.getInstance();
        spreadsheet.selectRange(
          getRangeAddress([0, 12, spreadsheet.sheets[0].rowCount, 12])
        ); //M1:M200
        helper.setAnimationToNone('#' + helper.id + '_contextmenu');
      ...
      it('Insert column after - 7 - using contextmenu', (done: Function) => {
        const spreadsheet: Spreadsheet = helper.getInstance();
        spreadsheet.selectRange(
          getRangeAddress([0, 4, spreadsheet.sheets[0].rowCount, 6])
        ); //D1:F200
        helper.setAnimationToNone('#' + helper.id + '_contextmenu');
    ...
    describe('Insert row above with conditional formatting ->', () => {
      ...
      it('Insert row above - 1 - using contextmenu', (done: Function) => {
        const spreadsheet: Spreadsheet = helper.getInstance();
        spreadsheet.selectRange(
          getRangeAddress([1, 0, 1, spreadsheet.sheets[0].colCount])
        ); //A2:Z2
        helper.setAnimationToNone('#' + helper.id + '_contextmenu');
        helper.openAndClickCMenuItem(1, 0, [6, 1], true);
        setTimeout((): void => {
      ...
      it('Insert row above - 2 - using contextmenu', (done: Function) => {
        const spreadsheet: Spreadsheet = helper.getInstance();
        spreadsheet.selectRange(
          getRangeAddress([3, 0, 3, spreadsheet.sheets[0].colCount])
        ); //A4:AA4
        helper.setAnimationToNone('#' + helper.id + '_contextmenu');
      ...
      it('Insert row above - 3 - using contextmenu', (done: Function) => {
        const spreadsheet: Spreadsheet = helper.getInstance();
        spreadsheet.selectRange(
          getRangeAddress([2, 0, 4, spreadsheet.sheets[0].colCount])
        ); //A3:AA5
        helper.setAnimationToNone('#' + helper.id + '_contextmenu');
        helper.openAndClickCMenuItem(4, 0, [6, 1], true);
        setTimeout((): void => {
      ...
      it('Insert row above - 4 - using contextmenu', (done: Function) => {
        const spreadsheet: Spreadsheet = helper.getInstance();
        spreadsheet.selectRange(
          getRangeAddress([10, 0, 11, spreadsheet.sheets[0].colCount])
        ); //A11:AA12
        helper.setAnimationToNone('#' + helper.id + '_contextmenu');
      ...
      it('Insert row above - 5 - using contextmenu', (done: Function) => {
        const spreadsheet: Spreadsheet = helper.getInstance();
        spreadsheet.selectRange(
          getRangeAddress([14, 0, 15, spreadsheet.sheets[0].colCount])
        ); //A15:AA16
        helper.setAnimationToNone('#' + helper.id + '_contextmenu');
      ...
      it('Insert row above - 6 - using contextmenu', (done: Function) => {
        const spreadsheet: Spreadsheet = helper.getInstance();
        spreadsheet.selectRange(
          getRangeAddress([18, 0, 19, spreadsheet.sheets[0].colCount])
        ); //A19:AA20
        helper.setAnimationToNone('#' + helper.id + '_contextmenu');
      ...
      it('Insert row above - 7 - using contextmenu', (done: Function) => {
        const spreadsheet: Spreadsheet = helper.getInstance();
        spreadsheet.selectRange(
          getRangeAddress([9, 0, 17, spreadsheet.sheets[0].colCount])
        ); //A10:AA18
        helper.setAnimationToNone('#' + helper.id + '_contextmenu');
            ...
            sheets: [
              {
                ranges: [{ dataSource: defaultData }],
                rows: [
                  { index: 11, cells: [{ index: 4, formula: '=SUM(D2:E11)' }] },
                ],
                selectedRange: 'D3',
              },
            ],
    ...
    describe('EJ2-64171 ->', () => {
            ...
            sheets: [
              {
                rows: [
                  ...
                  { cells: [{ value: '2' }] },
                  { cells: [{ value: '3' }] },
                  { cells: [{ formula: '=SUM(A1:A3)' }] },
                  { cells: [{ formula: '=SUM(A3:A1)' }] },
                ],
              },
            ],
          },
      ...
      it('Reverse ranges used in formulas not works properly while inserting rows', (done: Function) => {
        ...
        setTimeout(function () {
          expect(getCell(4, 0, helper.getInstance().sheets[0]).formula).toBe(
            '=SUM(A1:A4)'
          );
          expect(helper.invoke('getCell', [4, 0]).textContent).toBe('6');
          expect(getCell(5, 0, helper.getInstance().sheets[0]).formula).toBe(
            '=SUM(A4:A1)'
          );
          expect(helper.invoke('getCell', [5, 0]).textContent).toBe('6');
          expect(getCell(0, 4, helper.getInstance().sheets[0]).formula).toBe(
            '=SUM(A1:D1)'
          );
          expect(helper.invoke('getCell', [0, 4]).textContent).toBe('6');
          expect(getCell(0, 5, helper.getInstance().sheets[0]).formula).toBe(
            '=SUM(D1:A1)'
          );
      ...
      it('Values are not updated properly to the cell after deleting the row in finite mode', (done: Function) => {
        ...
        setTimeout((): void => {
          ...
          setTimeout(() => {
            ...
            expect(helper.invoke('getCell', [39, 0]).textContent).toBe(
              'Test-Delete'
            );
            ...
            setTimeout(() => {
              ...
              expect(helper.invoke('getCell', [44, 0]).textContent).toBe(
                'Test-Hide'
              );
              done();
            });
  ...
  describe('Insert row below with conditional formatting ->', () => {
          ...
          sheets: [
            {
              name: 'Inventory List',
              ranges: [{ dataSource: InventoryList, startCell: 'A2' }],
              conditionalFormats: [{ type: 'GYRColorScale', range: 'A3:AA3' }],
            },
          ],
          created: (): void => {
            const spreadsheet: Spreadsheet = helper.getInstance();
    ...
    it('Insert row below - 3 - using contextmenu', (done: Function) => {
      const spreadsheet: Spreadsheet = helper.getInstance();
      spreadsheet.selectRange(
        getRangeAddress([4, 0, 5, spreadsheet.sheets[0].colCount])
      ); //A2:Z2
      ...
      helper.initializeSpreadsheet(
        {
          sheets: [
            {
              name: 'defaultData',
              ranges: [{ dataSource: defaultData, startCell: 'A2' }],
              conditionalFormats: [
                {
                  type: 'ContainsText',
                  cFColor: 'RedFT',
  ...
  describe('Delete column with conditional formatting ->', () => {
          ...
          sheets: [
            {
              name: 'Inventory List',
              ranges: [{ dataSource: InventoryList, startCell: 'A2' }],
              conditionalFormats: [{ type: 'GYRColorScale', range: 'C3:C18' }],
            },
          ],
          created: (): void => {
            const spreadsheet: Spreadsheet = helper.getInstance();
    ...
    it('Delete column - 1 - using contextmenu', (done: Function) => {
      const spreadsheet: Spreadsheet = helper.getInstance();
      spreadsheet.selectRange(
        getRangeAddress([0, 1, spreadsheet.sheets[0].rowCount, 1])
      ); //B1:B200
      helper.setAnimationToNone('#' + helper.id + '_contextmenu');
      helper.openAndClickCMenuItem(0, 1, [7], false, true);
      setTimeout((): void => {
    ...
    it('Delete column - 3 - using contextmenu', (done: Function) => {
      const spreadsheet: Spreadsheet = helper.getInstance();
      spreadsheet.selectRange(
        getRangeAddress([0, 2, spreadsheet.sheets[0].rowCount, 2])
      ); //C1:C200
      helper.openAndClickCMenuItem(0, 2, [7], false, true);
      setTimeout((): void => {
        const cfRule: ConditionalFormatModel[] =
    ...
    it('Delete column - 4 - using contextmenu', (done: Function) => {
      const spreadsheet: Spreadsheet = helper.getInstance();
      spreadsheet.selectRange(
        getRangeAddress([0, 2, spreadsheet.sheets[0].rowCount, 3])
      ); //C1:D200
      helper.openAndClickCMenuItem(0, 2, [7], false, true);
      setTimeout((): void => {
        const cfRule: ConditionalFormatModel[] =
    ...
    it('Delete column - 6 - using contextmenu', (done: Function) => {
      const spreadsheet: Spreadsheet = helper.getInstance();
      spreadsheet.selectRange(
        getRangeAddress([0, 0, spreadsheet.sheets[0].rowCount, 2])
      ); //A1:C200
      helper.openAndClickCMenuItem(0, 2, [7], false, true);
      setTimeout((): void => {
        const cfRule: ConditionalFormatModel[] =
  ...
  describe('Delete row with conditional formatting ->', () => {
    ...
    it('Delete row - 2 - using contextmenu', (done: Function) => {
      const spreadsheet: Spreadsheet = helper.getInstance();
      spreadsheet.selectRange(
        getRangeAddress([1, 0, 2, spreadsheet.sheets[0].colCount])
      ); //A2:
      helper.openAndClickCMenuItem(2, 0, [7], true);
      setTimeout((): void => {
        const cfRule: ConditionalFormatModel[] =
    ...
    it('Delete row - 4 - using contextmenu', (done: Function) => {
      const spreadsheet: Spreadsheet = helper.getInstance();
      spreadsheet.selectRange(
        getRangeAddress([5, 0, 5, spreadsheet.sheets[0].colCount])
      ); //A2:
    ...
    it('Delete row - 5 - using contextmenu', (done: Function) => {
      const spreadsheet: Spreadsheet = helper.getInstance();
      spreadsheet.selectRange(
        getRangeAddress([2, 0, 5, spreadsheet.sheets[0].colCount])
      ); //A2:
      helper.openAndClickCMenuItem(5, 0, [7], true);
      setTimeout((): void => {
        const cfRule: ConditionalFormatModel[] =
  ...
  describe('CR - Issues->', () => {
    describe('EJ2-50688, EJ2-53476, EJ2-54600, EJ2-50688, EJ2-51865', () => {
      ...
      it('EJ2-51865 - Delete empty row is not working', (done: Function) => {
        ...
        helper.invoke('copy', ['A1:H1']).then(function () {
          ...
          expect(helper.getInstance().sheets[0].rows[14].cells[0].value).toBe(
            'Item Name'
          );
          ...
          setTimeout(() => {
            expect(helper.getInstance().sheets[0].rows[13].cells[0].value).toBe(
              'Item Name'
            );
            done();
          });
      ...
      it('EJ2-50565 - cut paste not working for inserted column in spreadsheet', (done: Function) => {
        helper.invoke('cut', ['H1:H20']).then(function () {
          ...
          setTimeout(() => {
            ...
            expect(
              helper.getInstance().sheets[0].rows[0].cells[4].value.toString()
            ).toBe('Profit');
            expect(
              helper.getInstance().sheets[0].rows[1].cells[4].value.toString()
            ).toBe('10');
            done();
          });
        });
      ...
      it('EJ2-50688 - data loss in cut paste for newly inserted column', (done: Function) => {
        ...
        spreadsheet.applyFilter([
          { field: 'F', predicate: 'or', operator: 'contains', value: '10' },
        ]);
        setTimeout(() => {
          ...
          setTimeout(() => {
            helper.invoke('cut', ['F1:F20']).then(function () {
              ...
              expect(
                helper.invoke('getCell', [0, 6]).querySelector('.e-filtered')
              ).toBeNull();
              expect(
                helper.getInstance().sheets[0].rows[5].cells[6].value
              ).toBe(10);
              expect(
                helper.getInstance().sheets[0].rows[7].cells[6].value
              ).toBe(10);
              done();
            });
          });
    ...
    describe('EJ2-54284, EJ2-52375->', () => {
      ...
      it('EJ2-52375 - Update row height based on cell template and update range and formula cell reference on insert row->', (done: Function) => {
        helper.invoke('updateCell', [
          {
            formula: `=${'Reserves & Resources'}!A5+${'Reserves & Resources'}!A6`,
          },
          'B2',
        ]);
        const spreadsheet: Spreadsheet = helper.getInstance();
        expect(spreadsheet.sheets[0].rows[1].cells[1].formula).toBe(
          `=${'Reserves & Resources'}!A5+${'Reserves & Resources'}!A6`
        );
        ...
        helper.openAndClickCMenuItem(1, 0, [6, 2], true);
        setTimeout(() => {
          expect(spreadsheet.sheets[0].rows[10].cells[0].value.toString()).toBe(
            '10'
          );
          expect(spreadsheet.sheets[0].rowCount).toBe(12);
          expect(spreadsheet.sheets[0].rows[1].cells[1].formula).toBe(
            `=${'Reserves & Resources'}!A6+${'Reserves & Resources'}!A7`
          );
          expect(spreadsheet.sheets[0].rows[1].cells[1].value).toBe('11');
          done();
        });
      ...
      it('Formula cell reference on insert column and delete row/column->', (done: Function) => {
        ...
        const spreadsheet: Spreadsheet = helper.getInstance();
        expect(spreadsheet.sheets[0].rows[1].cells[2].formula).toBe(
          `=${'Reserves & Resources'}!B6+${'Reserves & Resources'}!B7`
        );
        ...
        helper.initializeSpreadsheet(
          {
            sheets: [
              {
                ranges: [{ dataSource: defaultData, showFieldAsHeader: false }],
              },
            ],
          },
          done
    ...
    describe('EJ2-850911->', () => {
            ...
            sheets: [
              {
                rows: [
                  {
                    cells: [
                      { formula: '=UNIQUE(Sheet2!D1:E2)' },
                      { index: 3, formula: '=UNIQUE(G1:H2)' },
                      { index: 6, value: 'column1' },
                      { value: 'column2' },
                      { index: 10, formula: '22' },
                    ],
                  },
      ...
      it('Spreadsheet control restricts to insert new column before the unique formula applied column->', (done: Function) => {
        ...
        setTimeout(() => {
          expect(helper.invoke('getCell', [0, 3]).textContent).toBe('');
          expect(helper.getInstance().sheets[0].rows[0].cells[4].formula).toBe(
            '=UNIQUE(H1:I2)'
          );
          ...
          setTimeout(() => {
            expect(
              helper.getInstance().sheets[0].rows[0].cells[4].formula
            ).toBe('=UNIQUE(I1:J2)');
            expect(helper.invoke('getCell', [0, 4]).textContent).toBe(
              'column1'
            );
            expect(helper.invoke('getCell', [0, 5]).textContent).toBe(
              'column2'
            );
            ...
            setTimeout(() => {
              ...
              expect(helper.invoke('getCell', [0, 6]).textContent).toBe(
                'column2'
              );
              expect(helper.invoke('getCell', [0, 8]).textContent).toBe(
                'column1'
