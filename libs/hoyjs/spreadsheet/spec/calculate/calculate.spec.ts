...
describe('Calculate basic flow', () => {
  ...
  it('Set key value', () => {
    ...
    expect(calculate.storedData.get('C').getFormulaText() === formula.value)
      .toBeTruthy;
  });
  it('Set key value', () => {
...
describe('Cell dependency handling', () => {
  ...
  it('Check multiple cell dependency', () => {
    ...
    let cellRef1: string =
      calculate.sheetToken + sheetId + calculate.sheetToken + 'A1';
    calculate.updateDependentCell(cellRef1);
    calculate.getDependentCells().set(cellRef1, ['10']);
    let cellRef2: string =
      calculate.sheetToken + sheetId + calculate.sheetToken + 'A2';
    calculate.updateDependentCell(cellRef2);
    calculate.getDependentCells().set(cellRef2, ['A1']);
    let cellRef3: string =
      calculate.sheetToken + sheetId + calculate.sheetToken + 'A3';
    calculate.updateDependentCell(cellRef3);
    calculate.getDependentCells().set(cellRef3, ['A2']);
    expect(calculate.getDependentCells().get(cellRef1).toString() === '10')
      .toBeTruthy;
    expect(calculate.getDependentCells().get(cellRef2).toString() === '10')
      .toBeTruthy;
    expect(calculate.getDependentCells().get(cellRef3).toString() === '10')
      .toBeTruthy;
