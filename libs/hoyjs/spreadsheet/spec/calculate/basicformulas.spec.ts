...
describe('Calculate SUM Formula', () => {
  ...
  afterEach(() => {
    ...
    document.body
      ...
      .forEach((elem: HTMLInputElement) => elem.remove());
  });
  ...
  it('Simple formula using key values ', () => {
    ...
    expect(calculate.storedData.get('A').getFormulaText() === input1.value)
      .toBeTruthy;
    expect(calculate.storedData.get('B').getFormulaText() === input2.value)
      .toBeTruthy;
    expect(calculate.storedData.get('C').getFormulaText() === input3.value)
      .toBeTruthy;
    expect(calculate.storedData.get('D').getFormulaText() === input4.value)
      .toBeTruthy;
  ...
  it('Simple product formula', () => {
    ...
    calculate.setKeyValue('F', formula.value);
    result = calculate.getKeyValue('F');
    expect(calculate.storedData.get('F').getFormulaValue() === '#NAME?')
      .toBeTruthy;
  });
});
describe('Calculate PRODUCT Formula', () => {
  ...
  it('Simple formula using key values ', () => {
    ...
    calculate.setKeyValue('F', formula.value);
    result = calculate.getKeyValue('F');
    expect(calculate.storedData.get('F').getFormulaValue() === '150')
      .toBeTruthy;
  });
  it('calculate numbers using method ', () => {
    formula.value = '=2*4*6*8';
  ...
  it('Simple product formula', () => {
    ...
    calculate.setKeyValue('F', formula.value);
    result = calculate.getKeyValue('F');
    expect(calculate.storedData.get('F').getFormulaValue() === '#VALUE!')
      .toBeTruthy;
  });
  it('Simple product formula', () => {
    formula.value = '=product(mnop)';
...
describe('Calculate IF Formula', () => {
  ...
  it('Simple formula using key values ', () => {
    ...
    expect(calculate.storedData.get('B').getFormulaText() === input2.value)
      .toBeTruthy;
    result = calculate.getKeyValue('F');
    expect(calculate.storedData.get('F').getFormulaValue() === 'FALSE')
      .toBeTruthy;
  });
  it('Invalid arguments', () => {
    ...
    result = calculate.getKeyValue('F');
    expect(
      calculate.storedData.get('F').getFormulaValue() ===
...
describe('Calculate MAX Formula', () => {
  ...
  it('Find Maximum value', () => {
    ...
    calculate.setKeyValue('F', formula.value);
    result = calculate.getKeyValue('F');
    expect(calculate.storedData.get('F').getFormulaValue() === '253')
      .toBeTruthy;
  });
  it('Negative arguments', () => {
    formula.value = '=Max(100,-253,54,66)';
...
describe('Calculate AND Formula', () => {
  ...
  it('Check AND using given Key values', () => {
    ...
    calculate.setKeyValue('F', formula.value);
    result = calculate.getKeyValue('F');
    expect(calculate.storedData.get('F').getFormulaValue() === 'TRUE')
      .toBeTruthy;
  });
  it('Check AND using given Key values', () => {
...
describe('Calculate RAND Formula', () => {
  ...
  it('check rand formula', () => {
    ...
    calculate.setKeyValue('F', formula.value);
    result = calculate.getKeyValue('F');
    expect(calculate.storedData.get('F').getFormulaValue() === result)
      .toBeTruthy;
  });
  it('check rand formula', () => {
...
describe('Calculate AVERAGE Formula', () => {
  ...
  it('Simple formula using key values ', () => {
    ...
    calculate.setKeyValue('F', formula.value);
    result = calculate.getKeyValue('F');
    expect(calculate.storedData.get('F').getFormulaValue() === '17.5')
      .toBeTruthy;
  });
  it('calculate numbers using method', () => {
...
describe('Calculate IFS Formula', () => {
  ...
  it('Check Ifs condition ', () => {
    formula.value =
      '=ifs(3=1,"A",4=2,"3",2=3,"4",2=4,"5",2=5,"6",2=2,"7",3=7,"8")';
    document.body.appendChild(formula);
    result = calculate.computeFormula(formula.value);
  ...
  it('check all condition is false', () => {
    formula.value =
      '=ifs(3=1,"A",4=2,"3",2=3,"4",2=4,"5",2=5,"6",2=5,"7",3=7,"8")';
    document.body.appendChild(formula);
    result = calculate.computeFormula(formula.value);
...
describe('Calculate CONCATENATE Formula', () => {
  ...
  it('Simple formula using key values ', () => {
    ...
    calculate.setKeyValue('F', formula.value);
    result = calculate.getKeyValue('F');
    expect(calculate.storedData.get('F').getFormulaValue() === 'Hello World')
      .toBeTruthy;
  });
  it('Simple concatenate formula', () => {
    ...
    result = calculate.getKeyValue('F');
    expect(
      calculate.storedData.get('F').getFormulaValue() === 'invalid arguments'
    ).toBeTruthy;
  });
  it('Simple concatenate formula', () => {
    formula.value =
      '=CONCATENATE("The"," ","sun"," ","will"," ","come"," ","up"," ","tomorrow.")';
    document.body.appendChild(formula);
    calculate.setKeyValue('F', formula.value);
    result = calculate.getKeyValue('F');
    expect(
  ...
  it('Simple concatenate formula', () => {
    ...
    expect(
      calculate.storedData.get('F').getFormulaValue() ===
        'Please Enter the value 10 to 20'
    ).toBeTruthy;
  });
  it('Simple concatenate formula', () => {
  ...
  it('Simple concatenate formula', () => {
    ...
    calculate.setKeyValue('F', formula.value);
    result = calculate.getKeyValue('F');
    expect(calculate.storedData.get('F').getFormulaValue() === 'mnop')
      .toBeTruthy;
  });
  it('Simple concatenate formula', () => {
    formula.value = '=CONCATENATE(mnop)';
...
describe('Calculate CONCAT Formula', () => {
  ...
  it('Simple concatenate formula', () => {
    ...
    calculate.setKeyValue('F', formula.value);
    result = calculate.getKeyValue('F');
    expect(calculate.storedData.get('F').getFormulaValue() === 'HelloWorld')
      .toBeTruthy;
  });
  it('Simple concatenate formula', () => {
...
describe('Calculate IFERROR Formula', () => {
  ...
  it('Simple formula using key values ', () => {
    ...
    result = calculate.getKeyValue('F');
    expect(
      calculate.storedData.get('F').getFormulaValue() === 'Error in calculation'
    ).toBeTruthy;
  });
  it('Simple ifs formula', () => {
...
describe('Calculate SUMIF Formula', () => {
  ...
  it('Simple formula using key values ', () => {
    ...
    result = calculate.getKeyValue('F');
    expect(
      calculate.storedData.get('F').getFormulaValue() === 'improper formula'
    ).toBeTruthy;
  });
...
describe('Calculate AVERAGEA Formula', () => {
  ...
  it('Simple formula using key values ', () => {
    ...
    calculate.setKeyValue('F', formula.value);
    result = calculate.getKeyValue('F');
    expect(calculate.storedData.get('F').getFormulaValue() === '6.5')
      .toBeTruthy;
  });
  it('check Valid Error', () => {
...
describe('Calculate CHOOSE Formula', () => {
  ...
  it('calculate numbers using method', () => {
    ...
    calculate.setKeyValue('F', formula.value);
    result = calculate.getKeyValue('F');
    expect(calculate.storedData.get('F').getFormulaValue() === '9/10/2019')
      .toBeTruthy;
  });
  it('calculate numbers using method', () => {
...
describe('Calculate LOOKUP Formula', () => {
  ...
  it('Simple formula using key values ', () => {
    ...
    calculate.setKeyValue('F', formula.value);
    result = calculate.getKeyValue('F');
    expect(calculate.storedData.get('F').getFormulaValue() === '2.5')
      .toBeTruthy;
  });
  it('Invalid arguments', () => {
...
describe('Calculate VLOOKUP Formula', () => {
  ...
  it('Simple formula using key values ', () => {
    ...
    calculate.setKeyValue('F', formula.value);
    result = calculate.getKeyValue('F');
    expect(calculate.storedData.get('F').getFormulaValue() === '#N/A')
      .toBeTruthy;
  });
  it('Invalid arguments', () => {
...
describe('Calculate RADIANS Formula', () => {
  ...
  it('Arguments with Key value', () => {
    ...
    expect(calculate.storedData.get('A') instanceof FormulaInfo).toBeTruthy;
    expect(calculate.storedData.get('F') instanceof FormulaInfo).toBeTruthy;
    expect(calculate.storedData.get('A').getFormulaValue() === input1.value)
      .toBeTruthy;
    result = calculate.getKeyValue('F');
    expect(
      calculate.storedData.get('F').getFormulaValue() === 0.3490658503988659
    ).toBeTruthy;
  });
  it('Negative arguments with Key value', () => {
    formula.value = '=radians(-A)';
