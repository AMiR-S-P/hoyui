...
import { createElement, selectAll } from '@hoyui/base';
...
describe('Ribbon ->', () => {
  ...
  let items: RibbonItemModel[] = [
    {
      ...
      content: [
        ...
        {
          prefixIcon: 'e-aligncenter-icon e-icons',
    ...
    },
    {
      header: { text: 'Insert' },
      content: [
        { text: 'Link', tooltipText: 'Hyperlink' },
        { type: 'Separator' },
        { text: 'Picture', tooltipText: 'Picture' },
      ],
    },
    {
      header: { text: 'View' },
      content: [
        { text: 'Hide Headers', tooltipText: 'Hide Headers' },
        { type: 'Separator' },
  ...
  describe('DOM checking ->', () => {
    ...
    it('Initial load with menu items', () => {
      ...
      ribbon.appendTo(element);
      let tbarItems: HTMLElement[] = selectAll(
        '.e-toolbar-item',
  ...
  describe('Menu collapsed state->', () => {
    ...
    it('Initial load with collapsed state', () => {
      ...
      (
        document.getElementsByClassName('e-ribbon')[0]
          .children[1] as HTMLElement
      ).click();
      let spredElem: HTMLElement = document.getElementsByClassName(
        'e-ribbon'
      )[0] as HTMLElement;
  ...
  describe('Menu Item Disable->', () => {
    ...
    it('enableMenuItems->', (done: Function) => {
      document.getElementsByTagName('span')[0].click();
      (
        document.getElementsByClassName('e-menu')[0]
  ...
  describe('Add Menu Item ->', () => {
    ...
    it('addMenuItems->', (done: Function) => {
      ...
      setTimeout(function () {
        let menuElemCount: number = document
          .getElementsByClassName('e-menu-parent e-ul')[0]
          .querySelectorAll('.e-menu-item').length;
  ...
  describe('Hide Tab Item ->', () => {
    ...
    it('hideRibbonTab->', (done: Function) => {
      ...
      setTimeout(function () {
        let menuElemCount: number = document
          .getElementsByClassName('e-toolbar-items')[0]
          .querySelectorAll('.e-hide').length;
  ...
  describe('Add Tab Item ->', () => {
    ...
    it('addRibbonTab->', (done: Function) => {
      document.getElementsByTagName('span')[0].click();
      setTimeout(function () {
        let toolbarElemCount: number = document
          .getElementsByClassName('e-toolbar-items')[0]
          .querySelectorAll('.e-template').length;
        ...
        spreadsheet.addRibbonTabs(
          [
            {
              header: { text: 'Custom' },
              content: [{ text: 'Custom', tooltipText: 'Custom Btn' }],
            },
          ],
          'Data'
        );
        toolbarElemCount = document
          .getElementsByClassName('e-toolbar-items')[0]
          .querySelectorAll('.e-template').length;
  ...
  describe('Add Toolbar Items ->', () => {
    ...
    it('addtoolbaritems->', (done: Function) => {
      ...
      setTimeout(function () {
        let toolbarElemCount: number = document
          .getElementsByClassName('e-toolbar-items')[1]
    ...
    it('ribbonItemSelection->', (done: Function) => {
      ...
      setTimeout(function () {
        ...
        (
          document
            .getElementsByClassName('e-toolbar-items')[0]
            .querySelectorAll('.e-toolbar-item')[2] as HTMLElement
        ).click();
        toolbarElem = document
          .getElementsByClassName('e-toolbar-items')[0]
          .querySelectorAll('.e-toolbar-item')[2];
