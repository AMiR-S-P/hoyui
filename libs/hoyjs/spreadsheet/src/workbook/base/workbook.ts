import { Component, Property, NotifyPropertyChanges, INotifyPropertyChanged, Collection, Complex, EmitType } from '@hoyui/base';
...
import { Event, ModuleDeclaration, merge, L10n, isNullOrUndefined } from '@hoyui/base';
...
     */
    ...
    public calculateNow(scope?: string, sheet?: number | string): Promise<void> {
        ...
        const calcArgs: { action: string, sheets: SheetModel[], promise: Promise<void> } = { action: 'calculateNow', sheets: sheets,
