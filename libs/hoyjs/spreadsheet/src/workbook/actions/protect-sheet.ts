...
export class WorkbookProtectSheet {
  ...
  private protectsheetHandler(args: {
    ...
    const sheetIndex: number = isNullOrUndefined(args.sheetIndex)
  ...
  private unprotectsheetHandler(args: UnprotectArgs): void {
    ...
    sheet.protectSettings.formatCells = sheet.protectSettings.formatColumns =
      false;
    sheet.protectSettings.formatRows = sheet.protectSettings.selectCells =
      false;
