...
import {
  ...
  StrokeSettings,
  TextSettings,
} from '../src/image-editor/index';
import { createElement, remove, isNullOrUndefined, extend } from '@hoyui/base';
...
describe('ImageEditor', () => {
  ...
  let imageEditor: any;
  const wrapper: HTMLInputElement = createElement('div', {
    className: 'wrapper',
  }) as HTMLInputElement;
  wrapper.style.width = '96vw';
  wrapper.style.height = '95vh';
  const element: HTMLInputElement = wrapper.appendChild(
    createElement('div', {
      id: 'image-editor',
      className: 'e-image-editor',
    }) as HTMLInputElement
  );
  const templateElem: HTMLElement = wrapper.appendChild(
    createElement('div', { id: 'toolbarTemplate' }) as HTMLElement
  );
  ...
  describe('Dom', () => {
    ...
    it('Find Target', (done) => {
      ...
      setTimeout(() => {
        ...
        imageEditor.notify('shape', {
          prop: 'applyActObj',
          value: { isMouseDown: null },
        });
        //  expect(imageEditor.objColl.length).toEqual(1);
        (<HTMLCanvasElement>(
          document.getElementById(imageEditor.element.id + '_upperCanvas')
    ...
    it('Canvas Mouse Down Events', (done) => {
      ...
      setTimeout(() => {
        (<HTMLCanvasElement>(
          document.getElementById(imageEditor.element.id + '_lowerCanvas')
        )).dispatchEvent(mousemoveEvent);
        setTimeout(function () {});
        (<HTMLCanvasElement>(
          document.getElementById(imageEditor.element.id + '_lowerCanvas')
        ...
        setTimeout(function () {});
        (imageEditor as any).dragStart = true;
        (imageEditor as any).dragCanvas = true;
        (<HTMLCanvasElement>(
          document.getElementById(imageEditor.element.id + '_lowerCanvas')
        )).dispatchEvent(mousemoveEvent);
        setTimeout(function () {});
    ...
    it('Keydown Events', (done) => {
      ...
      setTimeout(() => {
        ...
        let event: any = new KeyboardEvent('keydown', {
          key: 'Delete',
          code: 'delete',
        });
    ...
    it('Rotate with Annotation', (done) => {
      ...
      setTimeout(() => {
        ...
        expect(
          imageEditor.objColl[imageEditor.objColl.length - 1].shape
        ).toEqual('rectangle');
        imageEditor.notify('shape', {
          prop: 'applyActObj',
          value: { isMouseDown: null },
        ...
        expect(
          imageEditor.objColl[imageEditor.objColl.length - 1].keyHistory
        ).toEqual('Syncfusion');
        ...
        imageEditor.notify('freehand-draw', {
          prop: 'apply-pen-draw',
    ...
    it('resizing', (done) => {
      ...
      setTimeout(() => {
        ...
        imageEditor.notify('selection', {
          prop: 'updateActivePoint',
          onPropertyChange: false,
    ...
    it('Text Click', (done) => {
      ...
      setTimeout(() => {
        const annotationBtn: any = document.querySelectorAll(
          '#image-editor_annotationBtn'
        )[0];
        annotationBtn.click();
        setTimeout(() => {});
        let ul: any = document.querySelectorAll(
          '#image-editor_annotationBtn-popup'
        );
        ...
        imageEditor.drawText();
        imageEditor.selectShape(
          imageEditor.objColl[imageEditor.objColl.length - 1].currIndex
        );
        expect(imageEditor.activeObj.shape).toEqual('text');
        let drpDownBtn: any = document.getElementById(
          'image-editor_fontFamilyBtn'
        );
        drpDownBtn.click();
        setTimeout(() => {});
        ...
        setTimeout(() => {});
        (
          document.getElementById('image-editor_text_font') as any
    ...
    it('Shape with border Size Click', (done) => {
      ...
      setTimeout(() => {
        ...
        ul = document.querySelectorAll(
          '#image-editor_annotationBtn-popup.e-popup-open'
        )[0];
        ul.children[0].children[2].click();
        expect(imageEditor.activeObj.shape).toEqual('rectangle');
        setTimeout(() => {});
        let drpDownBtn: any = document.getElementById(
          'image-editor_borderWidthBtn'
        );
        drpDownBtn.click();
        setTimeout(() => {});
        ul = document.querySelectorAll(
          '#image-editor_borderWidthBtn-popup.e-popup-open'
        )[0];
    ...
    it('Text Area Click', (done) => {
      ...
      setTimeout(() => {
        let annotationBtn: any = document.querySelectorAll(
          '#image-editor_annotationBtn'
        )[0];
        annotationBtn.click();
        setTimeout(() => {});
        ...
        expect(imageEditor.activeObj.shape).toEqual('text');
        (
          document.querySelector('#image-editor_editText') as HTMLElement
        ).click();
        setTimeout(() => {});
        (
          document.querySelector('#image-editor_textArea') as HTMLElement
        ...
        okBtn.click();
        setTimeout(() => {});
        annotationBtn = document.querySelectorAll(
          '#image-editor_annotationBtn'
        )[0];
        annotationBtn.click();
        setTimeout(() => {});
        ...
        (
          document.querySelectorAll('#image-editor_cancel')[0] as HTMLElement
        ).click();
        setTimeout(() => {});
        done();
      }, 100);
    ...
    it('Canvas double Click Hor Ver', (done) => {
      ...
      setTimeout(() => {
        ...
        let boundRect: any = (
          document.querySelector('#image-editor_upperCanvas') as HTMLElement
        ).getBoundingClientRect();
        const obj: Object = { width: 0, height: 0 };
        imageEditor.notify('crop', {
          prop: 'calcRatio',
          onPropertyChange: false,
          value: { obj: obj },
        });
    ...
    it('Shape Click', (done) => {
      ...
      setTimeout(() => {
        ...
        setTimeout(() => {});
        (
          document.getElementById('image-editor_shape_fill') as any
        ).ej2_instances[0].dataBind();
        ...
        setTimeout(() => {});
        (
          document.getElementById('image-editor_shape_stroke') as any
        ).ej2_instances[0].dataBind();
    ...
    it('Shape Click after zoom', (done) => {
      ...
      setTimeout(() => {
        ...
        setTimeout(function () {});
        expect(imageEditor.activeObj.shape).toEqual('rectangle');
        const drpDownBtn: any = document.getElementById(
          'image-editor_borderWidthBtn'
        );
        drpDownBtn.click();
        setTimeout(() => {});
    ...
    it('Crop Select Click', (done) => {
      ...
      setTimeout(() => {
        let cropBtn: any = document.querySelectorAll(
          '#image-editor_cropTransform'
        )[0];
        cropBtn.click();
        setTimeout(() => {});
        ...
        ul = document.querySelectorAll('#image-editor_cropBtn-popup')[
          ul.length - 1
        ];
        ul.children[0].children[1].click();
        setTimeout(() => {});
        expect(imageEditor.activeObj.shape).toEqual('crop-circle');
        const cancelBtn: any = document.querySelectorAll(
          '#image-editor_cancel'
        )[0];
        cancelBtn.click();
        setTimeout(() => {});
    ...
    it('Transform Click for Rotate', (done) => {
      ...
      setTimeout(() => {
        const cropBtn: any = document.querySelectorAll(
          '#image-editor_cropTransform'
        )[0];
        cropBtn.click();
        setTimeout(() => {});
        let transformBtn: any = document.querySelectorAll(
          '#image-editor_rotateRight'
        )[0];
        transformBtn.click();
        setTimeout(() => {});
        expect(imageEditor.transform.degree).toEqual(90);
        transformBtn = document.querySelectorAll(
          '#image-editor_rotateRight'
        )[0];
        transformBtn.click();
        setTimeout(() => {});
    ...
    it('Transform Click for Flip', (done) => {
      ...
      setTimeout(() => {
        ...
        setTimeout(() => {});
        let transformBtn: any = document.querySelectorAll(
          '#image-editor_horizontalFlip'
        )[0];
        transformBtn.click();
        setTimeout(() => {});
        expect(imageEditor.transform.currFlipState).toEqual('horizontal');
        transformBtn = document.querySelectorAll(
          '#image-editor_verticalFlip'
        )[0];
        transformBtn.click();
        setTimeout(() => {});
        expect(imageEditor.transform.currFlipState).toEqual('vertical');
  ...
  describe('Pen Click Event', () => {
    ...
    it('Pen Click', (done) => {
      ...
      setTimeout(() => {
        let annotationBtn: any = imageEditor.element.querySelectorAll(
          '#image-editor_annotationBtn'
        )[0];
        annotationBtn.click();
        setTimeout(() => {});
        ...
        //  expect(imageEditor.togglePen).toEqual(true);
        const drpDownBtn: any = document.getElementById(
          'image-editor_penColorBtn'
        );
        drpDownBtn.click();
        setTimeout(function () {});
        (
          document.getElementById('image-editor_pen_stroke') as any
        ).ej2_instances[0].dataBind();
        ...
        setTimeout(() => {});
        annotationBtn = imageEditor.element.querySelectorAll(
          '#image-editor_annotationBtn'
        )[0];
        annotationBtn.click();
        setTimeout(() => {});
  ...
  describe('Mouse Right Click on Selection', () => {
    ...
    it('NW Point Click', (done) => {
      ...
      setTimeout(() => {
        ...
        let ratio: any = obj;
        let x: any =
          imageEditor.activeObj.activePoint.startX / ratio.width +
          boundRect.left;
        let y: any =
          imageEditor.activeObj.activePoint.startY / ratio.height +
          boundRect.top;
        dblClickEvent.initMouseEvent(
          'dblclick',
          true,
  ...
  describe('Rotate With Annotations', () => {
    ...
    it('90 Degree Combination', (done) => {
      ...
      setTimeout(() => {
        const value: any = {
          ...
          strokeColor: 'red',
          fillColor: 'white',
          start: { x: 553.6052631578948, y: 50 },
          width: 100,
          height: 75,
        };
        ...
        expect(imageEditor.objColl[0].activePoint.startX).toEqual(
          405.91999999999996
        );
        expect(imageEditor.objColl[0].activePoint.startY).toEqual(
          217.49999999999994
        );
        expect(imageEditor.objColl[0].activePoint.endX).toEqual(
          462.91999999999996
        );
        expect(imageEditor.objColl[0].activePoint.endY).toEqual(
          293.49999999999994
        );
        expect(imageEditor.objColl[1].shape).toEqual('text');
        expect(imageEditor.objColl[1].activePoint.startX).toEqual(303.32);
        expect(imageEditor.objColl[1].activePoint.startY).toEqual(
          24.93203124999995
        );
        expect(imageEditor.objColl[1].activePoint.endX).toEqual(
          348.91999999999996
        );
        expect(imageEditor.objColl[1].activePoint.endY).toEqual(
          293.49999999999994
        );
        done();
      }, 100);
    ...
    it('180 Degree Combination', (done) => {
      ...
      setTimeout(() => {
        ...
        expect(imageEditor.objColl[1].shape).toEqual('text');
        expect(imageEditor.objColl[1].activePoint.startX).toEqual(
          200.60526315789474
        );
        expect(imageEditor.objColl[1].activePoint.startY).toEqual(
          48.99999999999997
  ...
  describe('Rotate With Zoom', () => {
    ...
    it('90 Degree Rotate With Zoom', (done) => {
      ...
      setTimeout(() => {
        ...
        expect(imageEditor.objColl[0].activePoint.width).toEqual(
          62.700000000000045
        );
        expect(imageEditor.objColl[0].activePoint.height).toEqual(
          83.60000000000002
        );
        imageEditor.zoom(3);
  ...
  describe('Rotate With Crop', () => {
    ...
    it('180 Degree Rotate With Crop', (done) => {
      ...
      setTimeout(() => {
        ...
        expect(Math.round(imageEditor.objColl[0].activePoint.endX)).toEqual(
          296
        );
        expect(imageEditor.objColl[0].activePoint.endY).toEqual(
          265.48859315589345
  ...
  describe('Flip With Zoom', () => {
    ...
    it('Horizontal and Vertical Flip With Zoom', (done) => {
      ...
      setTimeout(() => {
        ...
        expect(imageEditor.transform.currFlipState).toEqual('horizontal');
        expect(imageEditor.objColl[0].shape).toEqual('rectangle');
        expect(Math.round(imageEditor.objColl[0].activePoint.startX)).toEqual(
          201
        );
        expect(Math.round(imageEditor.objColl[0].activePoint.startY)).toEqual(
          50
        );
        expect(imageEditor.objColl[0].activePoint.endX).toEqual(
          300.6052631578949
        ...
        expect(Math.round(imageEditor.objColl[0].activePoint.endY)).toEqual(
          122
        );
        imageEditor.zoom(3);
        expect(imageEditor.transform.zoomFactor).toEqual(0.2);
  ...
  describe('Random Combination', () => {
    ...
    it('Shape Combination', (done) => {
      ...
      setTimeout(() => {
        ...
        expect(imageEditor.lowerCanvas.getContext('2d').filter).toEqual(
          'brightness(1.25) contrast(100%) hue-rotate(0deg) saturate(100%) opacity(0.7) blur(0px) sepia(0%) grayscale(0%) invert(0%)'
        );
        imageEditor.finetuneImage('Contrast', 50);
        expect(imageEditor.lowerCanvas.getContext('2d').filter).toEqual(
          'brightness(1.25) contrast(125%) hue-rotate(0deg) saturate(100%) opacity(0.7) blur(0px) sepia(0%) grayscale(0%) invert(0%)'
        );
        imageEditor.applyImageFilter('Invert');
        expect(imageEditor.lowerCanvas.getContext('2d').filter).toEqual(
          'brightness(1.25) contrast(125%) hue-rotate(0deg) saturate(100%) opacity(0.7) blur(0px) sepia(0%) grayscale(0%) invert(100%)'
        );
        done();
      }, 100);
    });
    it('Text Combination', (done) => {
      ...
      setTimeout(() => {
        imageEditor.drawText(
          imageEditor.img.destLeft,
          imageEditor.img.destTop,
          'Syncfusion',
          'Arial',
          20,
          true,
        ...
        expect(
          imageEditor.objColl[imageEditor.objColl.length - 1].activePoint.startX
        ).toEqual(imageEditor.img.destLeft);
        expect(
          imageEditor.objColl[imageEditor.objColl.length - 1].activePoint.startY
        ).toEqual(imageEditor.img.destTop);
        imageEditor.rotate(90);
        expect(imageEditor.transform.degree).toEqual(90);
        imageEditor.flip('Horizontal');
        expect(imageEditor.transform.currFlipState).toEqual('horizontal');
    ...
    it('Coverage improvement - Random Combination 3', (done) => {
      ...
      setTimeout(() => {
        ...
        expect(imageEditor.objColl[0].strokeSettings.strokeColor).toEqual(
          'yellow'
        );
        imageEditor.select('custom');
        imageEditor.discard();
    ...
    it('Coverage improvement - image annotation combination 4', (done) => {
      ...
      setTimeout(() => {
        ...
        imageEditor.drawLine(350, 300, 300, 100, 20, 'red');
        imageEditor.notify('selection', {
          prop: 'updateCursorStyles',
          value: { x: 350, y: 300, type: 'touchstart' },
        });
        imageEditor.reset();
        imageEditor.drawPath(
          [
        ...
        imageEditor.notify('selection', {
          prop: 'updateCursorStyles',
          value: { x: 400, y: 300, type: 'touchstart' },
        });
        imageEditor.reset();
        done();
      }, 100);
    ...
    it('Finetune Combination', (done) => {
      ...
      setTimeout(() => {
        ...
        imageEditor.finetuneImage('Hue', 50);
        expect(imageEditor.lowerCanvas.getContext('2d').filter).toEqual(
          'brightness(1.25) contrast(125%) hue-rotate(150deg) saturate(100%) opacity(0.7) blur(0px) sepia(0%) grayscale(0%) invert(0%)'
        );
        imageEditor.finetuneImage('Saturation', 50);
        expect(imageEditor.lowerCanvas.getContext('2d').filter).toEqual(
          'brightness(1.25) contrast(125%) hue-rotate(150deg) saturate(150%) opacity(0.7) blur(0px) sepia(0%) grayscale(0%) invert(0%)'
        );
        imageEditor.finetuneImage('Exposure', 50);
        expect(imageEditor.lowerCanvas.getContext('2d').filter).toEqual(
          'brightness(1.5) contrast(125%) hue-rotate(150deg) saturate(150%) opacity(0.7) blur(0px) sepia(0%) grayscale(0%) invert(0%)'
        );
        imageEditor.finetuneImage('Opacity', 50);
        expect(imageEditor.lowerCanvas.getContext('2d').filter).toEqual(
          'brightness(1.5) contrast(125%) hue-rotate(150deg) saturate(150%) opacity(0.3) blur(0px) sepia(0%) grayscale(0%) invert(0%)'
        );
        imageEditor.finetuneImage('Blur', 50);
        expect(imageEditor.lowerCanvas.getContext('2d').filter).toEqual(
          'brightness(1.5) contrast(125%) hue-rotate(150deg) saturate(150%) opacity(0.3) blur(3px) sepia(0%) grayscale(0%) invert(0%)'
        );
        done();
      }, 100);
    });
    it('Filter Combination', (done) => {
      ...
      setTimeout(() => {
        imageEditor.applyImageFilter('Chrome');
        expect(imageEditor.lowerCanvas.getContext('2d').filter).toEqual(
          'brightness(1) contrast(100%) hue-rotate(0deg) saturate(140%) opacity(1) blur(0px) sepia(0%) grayscale(0%) invert(0%)'
        );
        imageEditor.applyImageFilter('Cold');
        expect(imageEditor.lowerCanvas.getContext('2d').filter).toEqual(
          'brightness(0.9) contrast(150%) hue-rotate(0deg) saturate(100%) opacity(1) blur(0px) sepia(0%) grayscale(0%) invert(0%)'
        );
        imageEditor.applyImageFilter('Warm');
        expect(imageEditor.lowerCanvas.getContext('2d').filter).toEqual(
          'brightness(1) contrast(100%) hue-rotate(0deg) saturate(140%) opacity(1) blur(0px) sepia(25%) grayscale(0%) invert(0%)'
        );
        imageEditor.applyImageFilter('Grayscale');
        expect(imageEditor.lowerCanvas.getContext('2d').filter).toEqual(
          'brightness(1) contrast(100%) hue-rotate(0deg) saturate(100%) opacity(1) blur(0px) sepia(0%) grayscale(100%) invert(0%)'
        );
        imageEditor.applyImageFilter('Sepia');
        expect(imageEditor.lowerCanvas.getContext('2d').filter).toEqual(
          'brightness(1) contrast(100%) hue-rotate(0deg) saturate(100%) opacity(1) blur(0px) sepia(100%) grayscale(0%) invert(0%)'
        );
        imageEditor.applyImageFilter('Invert');
        expect(imageEditor.lowerCanvas.getContext('2d').filter).toEqual(
          'brightness(1) contrast(100%) hue-rotate(0deg) saturate(100%) opacity(1) blur(0px) sepia(0%) grayscale(0%) invert(100%)'
        );
        imageEditor.applyImageFilter('Default');
        expect(imageEditor.lowerCanvas.getContext('2d').filter).toEqual(
          'brightness(1) contrast(100%) hue-rotate(0deg) saturate(100%) opacity(1) blur(0px) sepia(0%) grayscale(0%) invert(0%)'
        );
        done();
      }, 100);
    });
    it('Finetune and Filter Combination', (done) => {
      ...
      setTimeout(() => {
        ...
        imageEditor.applyImageFilter('Chrome');
        expect(imageEditor.lowerCanvas.getContext('2d').filter).toEqual(
          'brightness(1.5) contrast(125%) hue-rotate(150deg) saturate(210%) opacity(0.3) blur(3px) sepia(0%) grayscale(0%) invert(0%)'
        );
        imageEditor.applyImageFilter('Cold');
        expect(imageEditor.lowerCanvas.getContext('2d').filter).toEqual(
          'brightness(1.125) contrast(187.5%) hue-rotate(150deg) saturate(150%) opacity(0.3) blur(3px) sepia(0%) grayscale(0%) invert(0%)'
        );
        imageEditor.applyImageFilter('Warm');
        expect(imageEditor.lowerCanvas.getContext('2d').filter).toEqual(
          'brightness(1.5) contrast(125%) hue-rotate(150deg) saturate(210%) opacity(0.3) blur(3px) sepia(25%) grayscale(0%) invert(0%)'
        );
        imageEditor.applyImageFilter('Grayscale');
        expect(imageEditor.lowerCanvas.getContext('2d').filter).toEqual(
          'brightness(1.5) contrast(125%) hue-rotate(150deg) saturate(150%) opacity(0.3) blur(3px) sepia(0%) grayscale(100%) invert(0%)'
        );
        imageEditor.applyImageFilter('Sepia');
        expect(imageEditor.lowerCanvas.getContext('2d').filter).toEqual(
          'brightness(1.5) contrast(125%) hue-rotate(150deg) saturate(150%) opacity(0.3) blur(3px) sepia(100%) grayscale(0%) invert(0%)'
        );
        imageEditor.applyImageFilter('Invert');
        expect(imageEditor.lowerCanvas.getContext('2d').filter).toEqual(
          'brightness(1.5) contrast(125%) hue-rotate(150deg) saturate(150%) opacity(0.3) blur(3px) sepia(0%) grayscale(0%) invert(100%)'
        );
        imageEditor.applyImageFilter('Default');
        expect(imageEditor.lowerCanvas.getContext('2d').filter).toEqual(
          'brightness(1.5) contrast(125%) hue-rotate(150deg) saturate(150%) opacity(0.3) blur(3px) sepia(0%) grayscale(0%) invert(0%)'
  ...
  describe('Combination testing', () => {
    ...
    it('To adjust brightness', (done) => {
      ...
      setTimeout(() => {
        ...
        expect(imageEditor.lowerCanvas.getContext('2d').filter).toEqual(
          'brightness(1.5) contrast(100%) hue-rotate(0deg) saturate(100%) opacity(0.7) blur(0px) sepia(0%) grayscale(0%) invert(0%)'
        );
        imageEditor.rotate(90);
        expect(imageEditor.transform.degree).toEqual(90);
        done();
    ...
    it('Text misalignment', (done) => {
      ...
      setTimeout(() => {
        ...
        imageEditor.finetuneImage('Hue', 50);
        expect(imageEditor.lowerCanvas.getContext('2d').filter).toEqual(
          'brightness(1) contrast(100%) hue-rotate(150deg) saturate(100%) opacity(1) blur(0px) sepia(0%) grayscale(0%) invert(0%)'
        );
        imageEditor.zoom(1);
        expect(imageEditor.transform.zoomFactor).toEqual(0);
        done();
    ...
    it('Text size improper', (done) => {
      ...
      setTimeout(() => {
        ...
        expect(imageEditor.transform.degree).toEqual(-180);
        expect(
          imageEditor.objColl[imageEditor.objColl.length - 1].textSettings
            .fontSize
        ).toEqual(20.99999999999999);
        done();
      }, 100);
    });
    ...
    it('Crop combination', (done) => {
      ...
      setTimeout(() => {
        ...
        if (!isNullOrUndefined(ul.children[0].children[2])) {
          ul.children[0].children[2].click();
        }
        setTimeout(() => {});
        expect(imageEditor.activeObj.shape).toEqual('crop-square');
        ...
        if (!isNullOrUndefined(cancelBtn)) {
          cancelBtn.click();
        }
        done();
      }, 100);
    ...
    it('Freehanddraw and flip combination', (done) => {
      ...
      setTimeout(() => {
        ...
        let points = [
          {
            x: 710.0539748224719,
            y: 25.105363438047213,
            ratioX: 0.8839387453519381,
            ratioY: 0.05938697025693696,
            time: 1674043575063,
          },
          {
            x: 713.9229403397133,
            y: 25.105363438047213,
            ratioX: 0.8993233607365535,
            ratioY: 0.05938697025693696,
            time: 1674043575090,
          },
          {
          ...
          },
          {
            x: 723.380411604081,
            y: 25.105363438047213,
            ratioX: 0.9369301983433911,
            ratioY: 0.05938697025693696,
            time: 1674043575123,
          },
          {
            x: 729.3988024086788,
            y: 24.675478380575946,
            ratioX: 0.960861822275015,
            ratioY: 0.05708811968222432,
            time: 1674043575139,
          },
          {
            x: 733.6976529833914,
            y: 24.675478380575946,
            ratioX: 0.9779558393690321,
            ratioY: 0.05708811968222432,
            time: 1674043575156,
          },
        ];
        ...
        imageEditor.notify('freehand-draw', {
          prop: 'freehandRedraw',
          value: {
            context: imageEditor.lowerCanvas.getContext('2d'),
            points: points,
          },
        });
        imageEditor.flip('Horizontal');
        ...
        imageEditor.zoom(2);
        expect(imageEditor.transform.zoomFactor).toEqual(0.1);
        expect(imageEditor.pointColl[0].points[0].x).toEqual(
          24.290627695280847
        );
        //  imageEditor.select('square');
        //  imageEditor.crop();
    ...
    it('crop and flip combination', (done) => {
      ...
      setTimeout(() => {
        ...
        imageEditor.notify('transform', {
          prop: 'drawPannImage',
          value: { point: { x: -10, y: 0 } },
        });
        ...
        imageEditor.activeObj.activePoint.width =
          imageEditor.activeObj.activePoint.endX -
          imageEditor.activeObj.activePoint.startX;
        imageEditor.activeObj.activePoint.height =
          imageEditor.activeObj.activePoint.endY -
          imageEditor.activeObj.activePoint.startY;
        imageEditor.upperContext.clearRect(
          0,
          0,
          imageEditor.upperCanvas.width,
          imageEditor.upperCanvas.height
        );
        imageEditor.notify('draw', {
          prop: 'drawObject',
          onPropertyChange: false,
    ...
    it('Pan combination', (done) => {
      ...
      setTimeout(() => {
        ...
        imageEditor.notify('transform', {
          prop: 'drawPannImage',
          value: { point: { x: 50, y: 0 } },
        });
        expect(imageEditor.activeObj.activePoint.startX).toBeGreaterThanOrEqual(
          0
        );
        done();
      }, 100);
    ...
    it('Render Image with cancel combination', (done) => {
      ...
      setTimeout(() => {
        ...
        imageEditor.notify('draw', {
          prop: 'performPointZoom',
          value: { x: 150, y: 150, type: 'zoomOut' },
        });
        done();
      }, 100);
    });
    ...
    it('Filter combination', (done) => {
      imageEditor = new ImageEditor(
        {
          height: '350px',
          finetuneSettings: {
            brightness: { min: 0, max: 100, defaultValue: 50 },
            contrast: { min: 0, max: 100, defaultValue: 50 },
            hue: { min: 0, max: 100, defaultValue: 50 },
            saturation: { min: 0, max: 100, defaultValue: 50 },
            exposure: { min: 0, max: 100, defaultValue: 50 },
            opacity: { min: 0, max: 100, defaultValue: 50 },
      ...
      setTimeout(() => {
        imageEditor.notify('filter', {
          prop: 'set-current-adjustment',
          value: { type: 'brightness', value: 70 },
        });
        imageEditor.notify('filter', {
          prop: 'set-current-adjustment',
          value: { type: 'contrast', value: 70 },
        });
        imageEditor.notify('filter', {
          prop: 'set-current-adjustment',
          value: { type: 'hue', value: 70 },
        });
        imageEditor.notify('filter', {
          prop: 'set-current-adjustment',
          value: { type: 'saturation', value: 70 },
        });
        imageEditor.notify('filter', {
          prop: 'set-current-adjustment',
          value: { type: 'exposure', value: 70 },
        });
        imageEditor.notify('filter', {
          prop: 'set-current-adjustment',
          value: { type: 'opacity', value: 70 },
        });
        imageEditor.notify('filter', {
          prop: 'set-current-adjustment',
          value: { type: 'blur', value: 70 },
        });
        done();
      }, 100);
    });
    it('FreehandDraw combination', (done) => {
      ...
      setTimeout(() => {
        ...
        imageEditor.activeObj.strokeSettings = {
          strokeColor: 'black',
          fillColor: '',
          strokeWidth: null,
        };
        ...
        imageEditor.notify('freehand-draw', {
          prop: 'hoverFreehandraw',
          value: { strokeColor: '#fff', strokeWidth: 4 },
        });
        obj = { selPointColl: imageEditor.pointColl };
        imageEditor.notify('freehand-draw', {
          prop: 'setSelPointColl',
        ...
        imageEditor.notify('freehand-draw', {
          prop: 'hoverFreehandraw',
          value: { strokeColor: '#fff', strokeWidth: null },
        });
        obj = { selPointColl: imageEditor.pointColl };
        imageEditor.notify('freehand-draw', {
          prop: 'setSelPointColl',
        ...
        imageEditor.notify('freehand-draw', {
          prop: 'hoverFreehandraw',
          value: { strokeColor: null, strokeWidth: 4 },
        });
        imageEditor.notify('freehand-draw', {
          prop: 'setFreehandSelectedIndex',
          value: { index: 0 },
        });
        ...
        let penColor: HTMLCanvasElement = document.querySelector(
          '#image-editor_penColorBtn'
        );
        penColor.click();
        setTimeout(function () {});
    ...
    it('Selection combination', (done) => {
      ...
      setTimeout(() => {
        ...
        imageEditor.notify('selection', {
          prop: 'setCursor',
          value: { x: 713.9229403397133, y: 25.105363438047213 },
        });
        imageEditor.notify('freehand-draw', {
          prop: 'setFreehandSelectedIndex',
          value: { index: 0 },
        ...
        imageEditor.notify('selection', {
          prop: 'updateActivePoint ',
          value: { x: 300, y: 100, isCropSelection: false },
        });
        done();
      }, 100);
    });
    it('Shape combination', (done) => {
      ...
      setTimeout(() => {
        ...
        imageEditor.notify('shape', {
          prop: 'renderTextArea',
          value: { x: 100, y: 100, actObj: imageEditor.activeObj },
        });
        imageEditor.notify('shape', {
          prop: 'applyFontStyle',
          value: { item: 'default' },
    ...
    it('Transform combination', (done) => {
      ...
      setTimeout(() => {
        imageEditor.notify('transform', {
          ...
          value: { xDiff: 5, yDiff: 5 },
        });
        imageEditor.zoom(5);
        imageEditor.notify('transform', {
          prop: 'setPanMove',
          value: { point: { x: 100, y: 50 } },
        });
        imageEditor.notify('transform', {
          prop: 'setTempPanMove',
          value: { point: { x: 120, y: 110 } },
        });
        imageEditor.notify('transform', {
          prop: 'drawPannedImage',
        ...
        imageEditor.notify('transform', {
          prop: 'updatePanPoints',
          value: { panRegion: 'horizontal', obj: null },
        });
        imageEditor.notify('transform', {
          prop: 'updatePanPoints',
          value: { panRegion: 'vertical', obj: null },
        });
        imageEditor.notify('transform', {
          prop: 'updatePanPoints',
          value: { panRegion: 'horizontalVertical', obj: null },
        });
        imageEditor.notify('transform', {
          prop: 'updatePanPoints',
          value: { panRegion: 'verticalHorizontal', obj: null },
        });
    ...
    it('Undo-Redo combination', (done) => {
      ...
      setTimeout(() => {
        ...
        imageEditor.notify('undo-redo', {
          prop: 'refresh-undo-redo',
          value: { bool: null },
        });
        const tempStrokeSettings: StrokeSettings = extend(
          {},
          imageEditor.activeObj.strokeSettings,
          {},
          true
        ...
        const tempTextSettings: TextSettings = extend(
          {},
          imageEditor.activeObj.textSettings,
          {},
          true
        ) as TextSettings;
        imageEditor.notify('draw', {
          prop: 'setTempTextSettings',
          onPropertyChange: false,
          value: { tempTextSettings: tempTextSettings },
        });
        imageEditor.notify('draw', {
          prop: 'setTempAdjustmentValue',
          value: {
            tempAdjustmentValue:
              imageEditor.lowerCanvas.getContext('2d').filter,
          },
        });
        imageEditor.notify('draw', {
          prop: 'setTempFilter',
          value: {
            tempFilter: imageEditor.lowerCanvas.getContext('2d').filter,
          },
        });
        imageEditor.notify('draw', {
          prop: 'setTempUndoRedoStep',
          value: { tempUndoRedoStep: 0 },
        });
        done();
      }, 100);
    });
    ...
    it('Draw module Combination', (done) => {
      ...
      setTimeout(() => {
        ...
        imageEditor.notify('shape', {
          prop: 'setTextBoxPos',
          value: {
            actObj: imageEditor.activeObj,
            degree: imageEditor.transform.degree,
            flip: imageEditor.transform.currFlipState,
            x: 100,
            y: 100,
          },
        });
        imageEditor.notify('shape', {
          prop: 'setTextBoxPoints',
          value: {
            actObj: imageEditor.activeObj,
            degree: imageEditor.transform.degree,
            flip: imageEditor.transform.currFlipState,
        ...
        imageEditor.notify('shape', {
          prop: 'renderTextArea',
          value: {
            x: imageEditor.activeObj.activePoint.startX,
            y: imageEditor.activeObj.activePoint.startY,
            actObj: imageEditor.activeObj,
          },
        });
        imageEditor.notify('shape', {
        ...
        imageEditor.notify('shape', {
          ...
          value: { obj: imageEditor.activeObj },
        });
        done();
      }, 100);
    });
    it('FreehandDraw combination', (done) => {
      ...
      setTimeout(() => {
        ...
        prevObj.pointColl = extend(
          [],
          imageEditor.pointColl,
          [],
          true
        ) as Point[];
        prevObj.afterCropActions = extend(
          [],
          imageEditor.afterCropActions,
          [],
          true
        ) as string[];
        let points = [
        ...
        imageEditor.notify('undo-redo', {
          prop: 'update-current-undo-redo-coll',
          value: { type: 'ok' },
        });
        imageEditor.undo();
        imageEditor.redo();
    ...
    it('Toolbar combination', (done) => {
      ...
      setTimeout(() => {
        ...
        imageEditor.notify('toolbar', {
          prop: 'performDefToolbarClickAction',
          onPropertyChange: false,
          value: {
            type: 'pan',
            isContextualToolbar: false,
            isDisabledAdjustment: false,
        ...
        imageEditor.notify('toolbar', {
          prop: 'toolbarTemplateFn',
          onPropertyChange: false,
        });
        imageEditor.notify('toolbar', {
          prop: 'quickAccessToolbarTemplateFn',
          onPropertyChange: false,
        });
        imageEditor.toolbarTemplate = null;
        imageEditor.quickAccessToolbarTemplate = null;
        imageEditor.reset();
        eventargs = {
          type: 'filter',
          isApplyBtn: null,
        ...
        //imageEditor.notify('toolbar', { prop: 'refresh-toolbar', onPropertyChange: false, value: eventargs});
        imageEditor.notify('toolbar', {
          prop: 'setTempFilterProperties',
          onPropertyChange: false,
        });
        imageEditor.notify('toolbar', {
          prop: 'getCurrAdjustmentValue',
          onPropertyChange: false,
        ...
        imageEditor.notify('toolbar', {
          prop: 'setCurrAdjustmentValue',
          onPropertyChange: false,
          value: { type: 'brightness', value: 50 },
        });
        imageEditor.notify('toolbar', {
          prop: 'setCurrAdjustmentValue',
          onPropertyChange: false,
          value: { type: 'contrast', value: 50 },
        });
        imageEditor.notify('toolbar', {
          prop: 'setCurrAdjustmentValue',
          onPropertyChange: false,
          value: { type: 'hue', value: 50 },
        });
        imageEditor.notify('toolbar', {
          prop: 'setCurrAdjustmentValue',
          onPropertyChange: false,
          value: { type: 'saturation', value: 50 },
        });
        imageEditor.notify('toolbar', {
          prop: 'setCurrAdjustmentValue',
          onPropertyChange: false,
          value: { type: 'blur', value: 50 },
        });
        imageEditor.notify('toolbar', {
          prop: 'setCurrAdjustmentValue',
          onPropertyChange: false,
          value: { type: 'exposure', value: 50 },
        });
        done();
      }, 100);
    });
    it('Selection module combination', (done) => {
      ...
      setTimeout(() => {
        ...
        imageEditor.notify('selection', {
          ...
          onPropertyChange: false,
          value: {
            x: imageEditor.objColl[0].activePoint.startX,
            y: imageEditor.objColl[0].activePoint.startY,
          },
        });
        imageEditor.notify('selection', {
          prop: 'setCursor',
          onPropertyChange: false,
          value: {
            x: imageEditor.objColl[0].activePoint.endX,
            y: imageEditor.objColl[0].activePoint.startY,
          },
        });
        imageEditor.notify('selection', {
          ...
          value: {
            x: imageEditor.objColl[0].activePoint.startX,
            y: imageEditor.objColl[0].activePoint.endY,
          },
        });
        imageEditor.notify('selection', {
          prop: 'setCursor',
        ...
        imageEditor.notify('selection', {
          ...
          onPropertyChange: false,
          value: {
            x: imageEditor.objColl[0].activePoint.startX + 100,
            y: imageEditor.objColl[0].activePoint.startY + 100,
          },
        });
        imageEditor.selectShape('shape_1');
        imageEditor.notify('selection', {
        ...
        imageEditor.notify('selection', {
          ...
          onPropertyChange: false,
          value: {
            x: imageEditor.activeObj.activePoint.endX,
            y: imageEditor.activeObj.activePoint.startY,
          },
        });
        imageEditor.notify('selection', {
          ...
          value: {
            x: imageEditor.activeObj.activePoint.startX,
            y: imageEditor.activeObj.activePoint.endY,
          },
        });
        imageEditor.notify('selection', {
          prop: 'setCursor',
        ...
        imageEditor.notify('selection', {
          ...
          onPropertyChange: false,
          value: {
            x: imageEditor.activeObj.activePoint.startX + 100,
            y: imageEditor.activeObj.activePoint.startY + 100,
          },
        });
        imageEditor.reset();
        let points = [
    ...
    it('Toolbar combination', (done) => {
      ...
      setTimeout(() => {
        ...
        imageEditor.notify('selection', {
          prop: 'updatePointCollForShapeRotation',
          onPropertyChange: false,
          value: { obj: imageEditor.activeObj },
        });
        imageEditor.rotateFlipColl.push(90);
        imageEditor.notify('selection', {
          prop: 'getCurrentFlipState',
          onPropertyChange: false,
        });
        imageEditor.reset();
        done();
    ...
    it('Coverage improvement for new features', (done) => {
      ...
      setTimeout(() => {
        ...
        ul.children[0].children[2].click();
        setTimeout(() => {});
        let qatBtn: any = document.querySelectorAll(
          '#image-editor_duplicate'
        )[0];
        qatBtn.click();
        setTimeout(() => {});
    ...
    it('Coverage improvement for filter finetune toolbar', (done) => {
      imageEditor = new ImageEditor(
        {
          ...
          finetuneSettings: {
            brightness: { min: 0, max: 200, defaultValue: 10 },
            contrast: { min: 0, max: 200, defaultValue: 10 },
            hue: { min: 0, max: 200, defaultValue: 10 },
            saturation: { min: 0, max: 200, defaultValue: 10 },
            exposure: { min: 0, max: 200, defaultValue: 10 },
            opacity: { min: 0, max: 200, defaultValue: 10 },
      ...
      setTimeout(() => {
        let finetuneBtn: any = document.querySelectorAll(
          '#image-editor_adjustment'
        )[0];
        finetuneBtn.click();
        setTimeout(() => {});
        ...
        finetuneBtn.click();
        setTimeout(() => {});
        finetuneBtn = document.querySelectorAll(
          '#image-editor_chromeCanvas'
        )[0];
        finetuneBtn.click();
        setTimeout(() => {});
        ...
        setTimeout(() => {});
        finetuneBtn = document.querySelectorAll(
          '#image-editor_invertCanvas'
        )[0];
        finetuneBtn.click();
        setTimeout(() => {});
        finetuneBtn = document.querySelectorAll(
          '#image-editor_defaultCanvas'
        )[0];
        finetuneBtn.click();
        setTimeout(() => {});
        done();
    ...
    it('Coverage improvement for error loading', (done) => {
      ...
      imageEditor.open(
        'https://www.shutterstock.com/image-photo/linked-together-life-cropped-shot-600w-214926422.jpg'
      );
      setTimeout(() => {
        done();
      }, 100);
    ...
    it('Coverage improvement for draw module', (done) => {
      ...
      setTimeout(() => {
        ...
        setTimeout(() => {});
        let ul: any = document.querySelectorAll(
          '#image-editor_fontFamilyBtn-popup'
        );
        ul = document.querySelectorAll('#image-editor_fontFamilyBtn-popup')[
          ul.length - 1
        ];
        ul.children[0].children[1].click();
        setTimeout(() => {});
    ...
    it('Coverage improvement for selection module', (done) => {
      ...
      setTimeout(() => {
        ...
        imageEditor.notify('selection', {
          ...
          onPropertyChange: false,
          value: {
            rectangle: imageEditor.activeObj.activePoint,
            x: 400,
            y: 300,
            angle: 1.25,
          },
        ...
        imageEditor.notify('selection', {
          prop: 'setResizedElement',
          onPropertyChange: false,
          value: { value: 'e-resize' },
        });
        imageEditor.notify('selection', {
          prop: 'getResizeDirection',
          onPropertyChange: false,
          value: {
            rectangle: imageEditor.activeObj.activePoint,
            x: 400,
    ...
    it('resize image using toolbar', (done) => {
      ...
      setTimeout(() => {
        setTimeout(function () {});
        let resizeBtn: any = document.querySelectorAll(
          '#image-editor_resize'
        )[0];
        resizeBtn.click();
        setTimeout(function () {});
        imageEditor.notify('transform', {
          prop: 'resize',
          value: { width: 400, height: 300, isAspectRatio: true },
        });
        ...
        resizeBtn.click();
        setTimeout(function () {});
        let aspectratiobtn: any = document.querySelectorAll(
          '#image-editor_aspectratio'
        )[0];
        aspectratiobtn.click();
        setTimeout(function () {});
        let cancelBtn: any = document.querySelectorAll(
          '#image-editor_cancel'
        )[0];
        cancelBtn.click();
        setTimeout(() => {});
    ...
    it('resized Image rotation', (done) => {
      ...
      setTimeout(() => {
        ...
        okBtn.click();
        setTimeout(() => {});
        const resizeBtn: any = document.querySelectorAll(
          '#image-editor_resize'
        )[0];
        resizeBtn.click();
        setTimeout(function () {});
    ...
    it('Image Annotation', (done) => {
      ...
      setTimeout(() => {
        setTimeout(function () {
          expect(Math.round(imageEditor.objColl[0].activePoint.width)).toEqual(
            200
          );
          expect(Math.round(imageEditor.objColl[0].activePoint.startX)).toEqual(
            500
    ...
    it('frame using Toolbar', (done) => {
      ...
      setTimeout(() => {
        const filterBtn: any = document.querySelectorAll(
          '#image-editor_frame'
        )[0];
        filterBtn.click();
        const matFrame: HTMLCanvasElement =
          document.querySelector('#image-editor_mat');
        matFrame.click();
        ...
        filterBtn.click();
        const bevelFrame: HTMLCanvasElement = document.querySelector(
          '#image-editor_bevel'
        );
        bevelFrame.click();
        expect(imageEditor.frameObj.amount).toEqual(1);
        ...
        expect(imageEditor.frameObj.inset).toEqual(20);
        expect(imageEditor.frameObj.offset).toEqual(20);
        const lineFrame: HTMLCanvasElement =
          document.querySelector('#image-editor_line');
        lineFrame.click();
        expect(imageEditor.frameObj.amount).toEqual(1);
        expect(imageEditor.frameObj.type).toEqual('line');
        expect(imageEditor.frameObj.inset).toEqual(20);
        expect(imageEditor.frameObj.offset).toEqual(20);
        const insetFrame: HTMLCanvasElement = document.querySelector(
          '#image-editor_inset'
        );
        insetFrame.click();
        expect(imageEditor.frameObj.amount).toEqual(1);
        ...
        const hookFrame: HTMLCanvasElement =
          document.querySelector('#image-editor_hook');
        hookFrame.click();
        expect(imageEditor.frameObj.amount).toEqual(1);
    ...
    it('frameLine using toolbar', (done) => {
      ...
      setTimeout(() => {
        ...
        lineFrame.click();
        setTimeout(function () {});
        const frameColor: HTMLCanvasElement = document.querySelector(
          '#image-editor_frameColorBtn'
        );
        frameColor.click();
        setTimeout(function () {});
        (
          document.getElementById('image-editor_frame_fill') as any
        ).ej2_instances[0].dataBind();
        let ul: any = document.querySelector(
          '#image-editor_frameColorBtn-popup'
        );
        (ul.querySelectorAll('.e-tile')[5] as HTMLElement).click();
        setTimeout(() => {}, 10);
        const frameGradient: HTMLCanvasElement = document.querySelector(
          '#image-editor_frameGradientColorBtn'
        );
        frameGradient.click();
        setTimeout(function () {});
        (
          document.getElementById('image-editor_frame_gradient_fill') as any
        ).ej2_instances[0].dataBind();
        ul = document.querySelector(
          '#image-editor_frameGradientColorBtn-popup'
        );
        (ul.querySelectorAll('.e-tile')[4] as HTMLElement).click();
        setTimeout(() => {}, 10);
        const frameAmount: HTMLCanvasElement = document.querySelector(
          '#image-editor_frameAmountBtn'
        );
        frameAmount.click();
        setTimeout(function () {});
        ...
        ul.children[0].children[1].click();
        setTimeout(function () {});
        const frameBorder: HTMLCanvasElement = document.querySelector(
          '#image-editor_frameBorderBtn'
        );
        frameBorder.click();
        setTimeout(function () {});
        ...
        ul.children[0].children[1].click();
        setTimeout(function () {});
        const frameInset: HTMLCanvasElement = document.querySelector(
          '#image-editor_frameInsetBtn'
        );
        frameInset.click();
        setTimeout(function () {});
        ...
        ul.children[0].children[1].click();
        setTimeout(function () {});
        const frameOffset: HTMLCanvasElement = document.querySelector(
          '#image-editor_frameOffsetBtn'
        );
        frameOffset.click();
        setTimeout(function () {});
        ...
        ul.children[0].children[1].click();
        setTimeout(function () {});
        const frameSize: HTMLCanvasElement = document.querySelector(
          '#image-editor_frameSizeBtn'
        );
        frameSize.click();
        setTimeout(function () {});
        ...
        ul.children[0].children[1].click();
        setTimeout(function () {});
        const frameRadius: HTMLCanvasElement = document.querySelector(
          '#image-editor_frameRadiusBtn'
        );
        frameRadius.click();
        setTimeout(function () {});
    ...
    it('text rotation', (done) => {
      ...
      setTimeout(() => {
        ...
        expect(imageEditor.activeObj.strokeSettings.strokeColor).toEqual(
          '#40e040'
        );
        expect(imageEditor.transform.currFlipState).toEqual('vertical');
        imageEditor.reset();
    ...
    it('Add Additional Font Families', (done) => {
      ...
      setTimeout(() => {
        ...
        ul.children[0].children[7].click();
        setTimeout(() => {}, 50);
        expect(imageEditor.activeObj.textSettings.fontFamily).toEqual(
          'Consolas'
        );
        setTimeout(() => {});
    ...
    it('Coverage improvement - random combinations 2', (done) => {
      ...
      setTimeout(() => {
        ...
        const finetuneBtn: any = document.querySelectorAll(
          '#image-editor_adjustment'
        )[0];
        finetuneBtn.click();
        setTimeout(() => {});
    ...
    it('Coverage improvement - Z-Order Support and Clear Image', (done) => {
      ...
      setTimeout(() => {
        ...
        expect(imageEditor.objColl[0].shape).toEqual('rectangle');
        expect(imageEditor.objColl[0].order).toEqual(
          imageEditor.objColl.length
        );
    ...
    it('Coverage improvement - Shape Id Customization', (done) => {
      ...
      setTimeout(() => {
        imageEditor.drawRectangle(350, 200, 650, 400, 15, 'red', 'green');
        expect(imageEditor.getShapeSettings()[0].id).toEqual(
          'shape_sync-custom-shape'
        );
        done();
      }, 100);
    });
    it('Coverage improvement - Z-Order and Image Compression', (done) => {
      ...
      setTimeout(() => {
        ...
        setTimeout(() => {});
        let ul: any = document.querySelectorAll(
          '#image-editor_zOrderBtn-popup.e-popup-open'
        )[0];
        ul.children[0].children[0].click();
        setTimeout(() => {});
        imageEditor.reset();
        ...
        setTimeout(() => {});
        (
          document.querySelector('#image-editor_saveDropdownbtn') as any
        ).click();
        setTimeout(() => {});
        ul = document.querySelectorAll(
          '#image-editor_saveDropdownbtn-popup.e-popup-open'
        )[0];
        ul.children[0].children[0].click();
        setTimeout(() => {});
    ...
    it('Coverage improvement - image annotation combination', (done) => {
      ...
      setTimeout(() => {
        setTimeout(() => {
          ...
          setTimeout(() => {});
          const flatBtn: HTMLCollectionOf<Element> =
            document.getElementsByClassName('e-control e-btn e-lib e-flat');
          if (flatBtn && flatBtn[0]) {
            (flatBtn[0] as HTMLElement).click();
          }
        }, 500);
        imageEditor.drawImage(
          'https://www.shutterstock.com/image-photo/linked-together-life-cropped-shot-600w-2149264221.jpg',
    ...
    it('Coverage improvement - Draw module', (done) => {
      ...
      setTimeout(() => {
        ...
        imageEditor.selectShape('shape_1');
        imageEditor.reset();
        let filterBtn: any = document.querySelectorAll(
          '#image-editor_frame'
        )[0];
        filterBtn.click();
        let matFrame: HTMLCanvasElement =
          document.querySelector('#image-editor_mat');
        matFrame.click();
        imageEditor.apply();
        imageEditor.select('custom');
      ...
      imageEditor = new ImageEditor(
        {
          ...
          shapeChanging: function (args) {
            if (
              args.action === 'draw-end' &&
              args.currentShapeSettings.type === 'FreehandDraw'
            ) {
              var tempShapeSettings = imageEditor.getShapeSetting(
                args.currentShapeSettings.id
              );
    ...
    it('Rectangle Border radius', function (done) {
      ...
      setTimeout(() => {
        ...
        expect(imageEditor.activeObj.shape).toEqual('rectangle');
        const drpDownBtn: any = document.getElementById(
          'image-editor_rectangleRadiusBtn'
        );
        drpDownBtn.click();
        setTimeout(function () {});
    ...
    it('Text annotation Stroke color and width', (done) => {
      ...
      setTimeout(() => {
        ...
        expect(imageEditor.activeObj.shape).toEqual('text');
        let drpDownBtn: any = document.getElementById(
          'image-editor_strokeTextColorBtn'
        );
        drpDownBtn.click();
        setTimeout(() => {});
        (
          document.getElementById('image-editor_stroke_text') as any
        ).ej2_instances[0].dataBind();
    ...
    it('Text annotation Background color', (done) => {
      ...
      setTimeout(() => {
        ...
        expect(imageEditor.activeObj.shape).toEqual('text');
        let drpDownBtn: any = document.getElementById(
          'image-editor_bgColorBtn'
        );
        drpDownBtn.click();
        setTimeout(() => {});
        (
          document.getElementById('image-editor_text_bgColor') as any
        ).ej2_instances[0].dataBind();
    ...
    it('Toolbar Coverage Improvement2', (done) => {
      ...
      setTimeout(() => {
        ...
        imageEditor.notify('toolbar', {
          prop: 'widthAspectRatio',
          onPropertyChange: false,
          value: { e: event },
        });
        imageEditor.notify('toolbar', {
          prop: 'heightAspectRatio',
          onPropertyChange: false,
          value: { e: event },
        });
        imageEditor.reset();
    ...
    it('Redact Coverage Improvement2', (done) => {
      ...
      setTimeout(() => {
        let redactBtn: any = document.querySelectorAll(
          '#image-editor_redact'
        )[0];
        redactBtn.click();
        let dimension: any = imageEditor.getImageDimension();
    ...
    it('Filter toolbar opened while opening redact toolbar', (done) => {
      ...
      setTimeout(() => {
        ...
        setTimeout(() => {});
        expect(
          document.querySelector('#image-editor_contextualToolbarArea')
            .clientHeight
