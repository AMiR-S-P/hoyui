import { extend, Browser, detach, select, MouseEventArgs } from '@hoyui/base';
import { EventHandler, getComponent, isNullOrUndefined, L10n } from '@hoyui/base';
import { ActivePoint, ModeSwitchEventArgs, NumericTextBox, PaletteTileEventArgs, SliderChangeEventArgs } from '@hoyui/inputs';
import { ItemModel, Toolbar, ClickEventArgs, BeforeOpenCloseMenuEventArgs } from '@hoyui/navigations';
import { Button } from '@hoyui/buttons';
import { DropDownButton, ItemModel as DropDownButtonItemModel, MenuEventArgs, OpenCloseMenuEventArgs } from '@hoyui/splitbuttons';
import { ColorPicker, ColorPickerEventArgs, Uploader, Slider, TextBox } from '@hoyui/inputs';
