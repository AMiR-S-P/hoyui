import { Component, NotifyPropertyChanges, INotifyPropertyChanged, Property, addClass, removeClass, ModuleDeclaration, extend } from '@hoyui/base';@hoyui/@hoyui/@hoyui/@hoyui/@hoyui/@hoyui/
import { Event, EmitType, Even@hoyui/ponent, isNullOrUndefined, getUniqueID, setValue } from '@syncfusion/ej2-base';
