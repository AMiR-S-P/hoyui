  ...
  implements INotifyPropertyChanged
{
  ...
  private renderElements(): void {
    ...
    barCode.mIsUserMentionedErrorCorrectionLevel =
      this.errorCorrectionLevel !== undefined ? true : false;
    barCode.mErrorCorrectionLevel =
      this.errorCorrectionLevel !== undefined
    ...
    const validInput: boolean = barCode.draw(
      this.value,
      this.barcodeCanvas,
      this.element.offsetHeight as number,
      this.element.offsetWidth as number,
      this.margin,
      this.displayText,
      mode,
      this.foreColor,
  ...
  public onPropertyChanged(
    newProp: QRCodeGeneratorModel,
    oldProp: QRCodeGeneratorModel
  ): void {
