...
describe('Barcode Control ', () => {
  describe('EAN8 bar testing for all lines check  EAN8 barcode', () => {
    ...
    it('EAN8 bar testing for all lines check  EAN8 barcode', (done: Function) => {
      ...
      expect(
        Math.round(Number(children.children[0].getAttribute('x'))) === 41 &&
      ...
      for (var j = 0; j < children.children.length - 2; j++) {
        expect(
          Math.round(Number(children.children[j + 2].getAttribute('x'))) ===
            output1[j].x &&
            Math.round(Number(children.children[j + 2].getAttribute('y'))) ===
              output1[j].y &&
            parseFloat(children.children[j + 2].getAttribute('width')).toFixed(
              2
            ) === output1[j].width &&
            parseFloat(children.children[j + 2].getAttribute('height')).toFixed(
              2
            ) === output1[j].height
        ).toBe(true);
      }
  ...
  describe('EAN13 bar testing for all lines check  EAN13 barcode', () => {
    ...
    it('EAN13 bar testing for all lines check  EAN13 barcode', (done: Function) => {
      ...
      let children: HTMLElement = barcode.children[0] as HTMLElement;
      expect(
        Math.round(Number(children.children[0].getAttribute('x'))) === 0 &&
          Math.round(Number(children.children[2].getAttribute('y'))) === 22 &&
          Math.round(Number(children.children[1].getAttribute('y'))) === 22 &&
          Math.round(Number(children.children[0].getAttribute('y'))) === 22 &&
          (children.children[0] as HTMLElement).style.fontSize === '20px'
      ).toBe(true);
      for (var j = 0; j < children.children.length - 3; j++) {
        expect(
          Math.round(Number(children.children[j + 3].getAttribute('x'))) ===
            output1[j].x &&
            Math.round(Number(children.children[j + 3].getAttribute('y'))) ===
              output1[j].y &&
            parseFloat(children.children[j + 3].getAttribute('width')).toFixed(
              2
            ) === output1[j].width &&
            parseFloat(children.children[j + 3].getAttribute('height')).toFixed(
              2
            ) === output1[j].height
        ).toBe(true);
      }
    ...
    it('upcA bar testing for all lines check  upcA barcode', (done: Function) => {
      ...
      expect(
        Math.round(Number(children.children[1].getAttribute('y'))) === 22 &&
          ...
          (children.children[0] as HTMLElement).style.fontSize === '14.6px'
      ).toBe(true);
