...
describe('Code128A - Barcode', () => {
    ...
    it('checking Code128A barcode rendering', (done: Function) => {
      ...
      expect(
        children.childElementCount === 44 &&
          Math.round(Number(children.children[0].getAttribute('x'))) === 40 &&
  ...
  describe('checking Code128A barcode rendering with width in %', () => {
    ...
    it('checking Code128A barcode rendering', (done: Function) => {
      ...
      console.log(
        Number(
          children.children[children.childElementCount - 1].getAttribute('x')
        )
      );
      console.log(
        Math.round(
      ...
      expect(
        (children.childElementCount === 44 &&
          Math.round(Number(children.children[0].getAttribute('x'))) === 123) ||
          Math.round(Number(children.children[0].getAttribute('x'))) === 126 ||
          (Math.round(Number(children.children[0].getAttribute('x'))) === 125 &&
            Math.round(Number(children.children[1].getAttribute('x'))) === 10 &&
            Math.round(Number(children.children[1].getAttribute('width'))) ===
              5 &&
            Math.round(
    ...
    it('checking Code128A barcode rendering with positive margin', (done: Function) => {
      ...
      expect(
        children.childElementCount === 44 &&
          ...
          Math.round(Number(children.children[1].getAttribute('height'))) === 27
      ).toBe(true);
  ...
  describe('checking Code128A barcode rendering all lines check', () => {
    ...
    it('checking Code128A barcode rendering with display text margin and barcode margin', (done: Function) => {
      ...
      let children: HTMLElement = barcode.children[0] as HTMLElement;
      expect(
        Math.round(Number(children.children[0].getAttribute('x'))) === 160 &&
          (children.children[0] as HTMLElement).style.fontSize === '20px'
      ).toBe(true);
      for (let j: number = 1; j < children.children.length - 1; j++) {
        expect(
