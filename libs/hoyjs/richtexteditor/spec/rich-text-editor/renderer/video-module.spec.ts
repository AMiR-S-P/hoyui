...
describe('Video Module ', () => {
  describe('video resize', () => {
    ...
    it('video dialog', () => {
      ...
      (
        dialogEle.querySelector('.e-video-url-wrap input#webURL') as HTMLElement
      ).click();
      (dialogEle.querySelector('.e-video-url') as HTMLInputElement).value =
        window.origin + '/base/spec/content/video/RTE-Ocean-Waves.mp4';
      (
        dialogEle.querySelector('.e-video-url') as HTMLInputElement
    ...
    it('resize start', () => {
      ...
      expect(
        rteObj.contentModule.getEditPanel().querySelector('.e-vid-resize')
      ).not.toBe(null);
      expect(
        rteObj.contentModule
          .getEditPanel()
          .querySelectorAll('.e-rte-videoboxmark').length
      ).toBe(4);
    });
    it('resize end', () => {
      ...
      expect(
        rteObj.contentModule.getDocument().body.contains(vidResizeDiv)
      ).toBe(false);
    });
    it('resizing - mousemove - bottom right', () => {
      ...
      let width = (rteObj.element.querySelector('.e-rte-video') as HTMLElement)
        .offsetWidth;
      (<any>rteObj.videoModule).resizeBtnStat.botRight = true;
  ...
  describe('percentage resize', () => {
    ...
    it('resizing - mousemove - bottom right', (done) => {
      ...
      setTimeout(() => {
        let width = (
          rteObj.element.querySelector('.e-rte-video') as HTMLElement
        ).offsetWidth;
        (<any>rteObj.videoModule).resizeBtnStat.botRight = true;
        (rteObj.videoModule as any).resizing({ target: resizeBot, pageX: 300 });
        setTimeout(() => {
          width += 100;
          (<any>rteObj.videoModule).resizeBtnStat.botRight = true;
          (rteObj.videoModule as any).resizing({
            target: resizeBot,
            pageX: 100,
          });
          setTimeout(() => {
...
`;
    ...
    it('resizing', () => {
      ...
      (<any>rteObj.videoModule).resizeBtnStat.botRight = true;
      (rteObj.videoModule as any).resizing({ target: resizeBot, pageX: 200 });
      let width = (rteObj.element.querySelector('video') as HTMLElement)
        .offsetWidth;
      (<any>rteObj.videoModule).resizeBtnStat.botRight = true;
      (rteObj.videoModule as any).resizing({ target: resizeBot, pageX: 300 });
      width += 100;
  ...
  describe('mobile resize', () => {
    ...
    it('mobile UI', () => {
      ...
      (rteObj.videoModule as any).resizeStart({
        target: resizeBot,
        preventDefault: function () {},
      ...
      (rteObj.videoModule as any).onDocumentClick({
  ...
  describe('868583 - The resize bar not shown while Rich Textbox Editor inside the iframe', () => {
    ...
    it('The resize bar not shown while Rich Textbox Editor inside the iframe', () => {
      ...
      const styles = rteObj.contentModule
        .getDocument()
        .defaultView.getComputedStyle(
          rteObj.contentModule
            .getEditPanel()
            .querySelectorAll('.e-rte-videoboxmark')[0]
        );
  ...
  describe('video resize events', () => {
    ...
    it('resize end and resizing events', () => {
      ...
      expect(width).toEqual(
        parseInt(getComputedStyle(trg as HTMLVideoElement).width)
      );
    });
  });
  ...
  describe('Video change aspect ratio when resized to smallest possible and back larger again - ', () => {
    ...
    beforeEach((done: Function) => {
      rteObj = renderRTE({
        value:
          '<p><span class="e-video-wrap" contenteditable="false" title="mov_bbb.mp4"><video class="e-rte-video e-video-inline" controls=""><source src="https://www.w3schools.com/html/mov_bbb.mp4" type="video/mp4"></video></span></p>',
      });
      done();
    });
    ...
    it(' Resizing with offsetHeight test ', (done: Function) => {
      ...
      expect(vidHeight <= document.querySelector('video').offsetHeight).toBe(
        true
      );
      done();
    });
  ...
  describe('div content-rte testing', () => {
    ...
    it('video dialog', (done: Function) => {
      ...
      expect(
        dialogEle
          .querySelector('.e-vid-uploadwrap')
      ...
      let args: any = {
        item: {
          url: window.origin + '/base/spec/content/video/RTE-Ocean-Waves.mp4',
          selection: save,
        },
        preventDefault: function () {},
      };
    ...
    it('insert video url', () => {
      ...
      (<any>rteObj).videoModule.editAreaClickHandler({ args: eventsArg });
      let videoPop: HTMLElement = <HTMLElement>(
        document.querySelectorAll('.e-rte-quick-popup')[0]
      );
      ...
      expect(
        (<any>rteObj).element
          .querySelector('.e-rte-video')
          .classList.contains('e-video-left')
      ).toBe(true);
      ...
      expect(
        (<any>rteObj).element
          .querySelector('.e-rte-video')
          .classList.contains('e-video-right')
      ).toBe(true);
      ...
      rteObj.formatter.editorManager.nodeSelection.setSelectionNode(
        document,
        rteObj.element.querySelector('.e-rte-video')
      );
      (<any>rteObj).videoModule.editAreaClickHandler({ args: eventsArg });
    });
  });
  ...
  describe('876602 - Double quick toolbar open when click the video', () => {
    ...
    it('Double quick toolbar open when click the video', () => {
      ...
      let target = <HTMLElement>(
        (rteObj as any).element.querySelectorAll('.e-content')[0]
      );
      let clickEvent: any = document.createEvent('MouseEvents');
      clickEvent.initEvent('mousedown', false, true);
      ...
      ).querySelector('.e-video-clickelem');
      ...
      expect(
        !isNullOrUndefined(
          document.querySelector('.e-video-wrap') as HTMLElement
        )
      ).toBe(true);
      expect(
        !isNullOrUndefined(
  ...
  describe('BLAZ-25388 - Inserting video in firefox', () => {
    ...
    it('BLAZ-25388 - Inserting video', (done: Function) => {
      ...
      (<any>rteObj).formatter.editorManager.videoObj.createVideo(args);
      (<any>rteObj).formatter.editorManager.videoObj.editAreaVideoClick({
        callBack: function () {},
      });
      setTimeout(() => {
        expect(rteObj.inputElement.querySelectorAll('video').length > 0).toBe(
          true
        );
        done();
      }, 100);
  ...
  describe('div content-rte testing', () => {
    ...
    it('upload the video while use save url', (done) => {
      ...
      let fileObj: File = new File(['Nice One'], 'sample.mp3', {
        lastModified: 0,
  ...
  describe('video dialog - documentClick', () => {
    ...
    it('open video dialog - click on video item in toolbar', () => {
      ...
      (<any>rteObj).videoModule.onKeyDown({ args: keyboardEventArgs });
      expect(
        document.body.contains((<any>rteObj).videoModule.dialogObj.element)
      ).toBe(true);

      let eventsArgs: any = {
        target: rteObj.element.querySelector('.e-video'),
        preventDefault: function () {},
      };
      ...
      eventsArgs = {
        target: document.querySelector('[title="Insert Video (Ctrl+Alt+V)"]'),
        preventDefault: function () {},
      };
      (<any>rteObj).videoModule.onDocumentClick(eventsArgs);
      expect(
  ...
  describe('Removing the video', () => {
    ...
    it('video remove with quickToolbar check', (done: Function) => {
      ...
      target = (
        rteObj.contentModule.getEditPanel() as HTMLElement
      ).querySelector('.e-video-wrap video');
      (rteObj as any).formatter.editorManager.nodeSelection.setSelectionNode(
        rteObj.contentModule.getDocument(),
        target
      );
      ...
      target.dispatchEvent(clickEvent);
      (<any>rteObj).videoModule.editAreaClickHandler({ args: eventsArg });
      (<any>rteObj).videoModule.videoEle = rteObj.contentModule
        .getEditPanel()
        .querySelector('.e-video-wrap video');
      setTimeout(function () {
  ...
  describe('Video deleting when press backspace button', () => {
    ...
    it('Video delete action checking using backspace key', (done: Function) => {
      ...
      expect((<any>rteObj).inputElement.querySelector('.e-video-wrap')).toBe(
        null
      );
      done();
    });
  ...
  describe('Video with inline applied', () => {
    ...
    it('classList testing for inline', (done: Function) => {
      ...
      setTimeout(function () {
        ...
        let video: HTMLElement = rteObj.element.querySelector(
          '.e-rte-video'
        ) as HTMLElement;
  ...
  describe('Dimension testing', () => {
    ...
    it('video dialog', (done: Function) => {
      ...
      setTimeout(() => {
        ...
        let dialogEle: Element = rteObj.element.querySelector('.e-dialog');
        expect(
          dialogEle.firstElementChild.querySelector('.e-dlg-header')
            .innerHTML === 'Video Size'
        ).toBe(true);
        expect(
          dialogEle
        ...
        (dialogEle.querySelector('.e-vid-width') as HTMLInputElement).value =
          '200';
        (dialogEle.querySelector('.e-vid-height') as HTMLInputElement).value =
          '200';
        (
          rteObj.element.querySelector(
            '.e-rte-video-dialog .e-footer-content button'
          ) as HTMLButtonElement
        ).click();
        expect((<any>rteObj).element.querySelector('video').style.width).toBe(
          '200px'
        );
        expect((<any>rteObj).element.querySelector('video').style.height).toBe(
          '200px'
        );
        done();
      }, 400);
  ...
  describe('Video quick toolbar - ', () => {
    ...
    it(' Dimension dialog rendering and testing ', (done: Function) => {
      ...
      setTimeout(() => {
        let videoBtn: HTMLElement = document.getElementById(
          controlId + '_quick_VideoDimension'
        );
  ...
  describe('Video quick toolbar - iframe', () => {
    ...
    it(' Dimension dialog rendering and testing in iframe', (done: Function) => {
      let video: HTMLElement =
        rteObj.element.querySelector('.e-video-clickelem');
      setCursorPoint(video, 0);
      dispatchEvent(video, 'mousedown');
      video.click();
      dispatchEvent(video, 'mouseup');
      setTimeout(() => {
        ...
        let args: any = {
          item: {
            url: window.origin + '/base/spec/content/video/mov_bbb.mp4',
            selection: save,
          },
          preventDefault: function () {},
        };
        args.item = {
          ...
          height: 200,
          selectNode: [
            rteObj.element.querySelector('.e-video-clickelem') as HTMLElement,
          ],
        };
        (<any>rteObj).formatter.editorManager.videoObj.videoDimension(args);
        (dialogEle.querySelector('.e-vid-width') as HTMLInputElement).value =
  ...
  describe('video dialog - Short cut key', () => {
    ...
    it('close video dialog - escape', (done: Function) => {
      ...
      expect(isNullOrUndefined((<any>rteObj).videoModule.dialogObj)).toBe(
        false
      );
      (<any>rteObj).videoModule.onKeyDown({ args: keyboardEventArgs });
  ...
  describe('Testing input disabled for  - ', () => {
    ...
    it('url input for source and embed urls disabled dynamically', (done: Function) => {
      ...
      (
        dialogEle.querySelector('.e-embed-video-url') as HTMLInputElement
      ).value = 'https://www.youtube.com/embed/QJqNYhiHysM';
      (
        dialogEle.querySelector('.e-embed-video-url') as HTMLInputElement
      ).dispatchEvent(new Event('input'));
      expect(
        (
          dialogEle.querySelector('.e-embed-video-url') as HTMLButtonElement
  ...
  describe('Mouse Click for video testing when showOnRightClick enabled', () => {
    ...
    it(' Test - for mouse click to focus video element', (done) => {
      let target: HTMLElement = rteObj.element.querySelector(
        '.e-video-wrap video'
      );
      let clickEvent: any = document.createEvent('MouseEvents');
      let eventsArg: any = { pageX: 50, pageY: 300, target: target, which: 1 };
  ...
  describe(' quickToolbarSettings property - video quick toolbar - ', () => {
    ...
    it(' Test - Replace the video ', (done) => {
      ...
      setTimeout(() => {
        ...
        (
          dialog.querySelector('.e-video-url-wrap input#webURL') as HTMLElement
        ).click();
        let urlInput: HTMLInputElement = dialog.querySelector('.e-video-url');
        urlInput.value = png;
        let insertButton: HTMLElement = dialog.querySelector(
          '.e-insertVideo.e-primary'
        );
        urlInput.dispatchEvent(new Event('input'));
        insertButton.click();
        let updateVideo: HTMLSourceElement = rteObj.element.querySelector(
          '.e-video-wrap source'
        );
  ...
  describe('Video with break applied', () => {
    ...
    it('classList testing for break', (done: Function) => {
      ...
      target = (
        rteObj.contentModule.getEditPanel() as HTMLElement
      ).querySelector('.e-embed-video-wrap video');
      (rteObj as any).formatter.editorManager.nodeSelection.setSelectionNode(
        rteObj.contentModule.getDocument(),
        target
      );
      ...
      setTimeout(function () {
        (<any>rteObj).videoModule.videoEle = rteObj.contentModule
          .getEditPanel()
          .querySelector('.e-video-wrap video');
        (<any>rteObj).videoModule.videoWrapNode = rteObj.contentModule
          .getEditPanel()
          .querySelector('.e-video-wrap video');
        (<any>rteObj).videoModule.videoClickElem = rteObj.contentModule
          .getEditPanel()
          .querySelector('.e-rte-video');
        let mouseEventArgs = {
          item: { command: 'Videos', subCommand: 'Break' },
  ...
  describe('Disable the insert video dialog button when the video is uploading', () => {
    ...
    it(' Button disabled with improper file extension', (done) => {
      ...
      (dialogEle.querySelector('.e-video-url') as HTMLInputElement).value =
        'https://www.w3schools.com/html/mov_bbb.mp43';
      let fileObj: File = new File(['mov_bob'], 'mov_bob.mp43', {
        lastModified: 0,
        type: 'overide/mimetype',
      });
      let eventArgs = {
      ...
      setTimeout(() => {
        expect(
          (
            dialogEle.querySelector('.e-insertVideo') as HTMLButtonElement
          ).hasAttribute('disabled')
        ).toBe(true);
        done();
      }, 100);
  ...
  describe('Getting error while insert the video after applied the  lower case or  upper case commands in Html Editor  - ', () => {
    ...
    beforeEach((done: Function) => {
      rteObj = renderRTE({
        ...
        toolbarSettings: {
          items: ['LowerCase', 'UpperCase', '|', 'Video'],
        },
      });
      controlId = rteObj.element.id;
      done();
    ...
    it(' Apply uppercase and then insert an video  ', (done) => {
      ...
      setTimeout(() => {
        let dialogEle: any = rteObj.element.querySelector('.e-dialog');
        (
          dialogEle.querySelector(
            '.e-video-url-wrap input#webURL'
          ) as HTMLElement
        ).click();
        (dialogEle.querySelector('.e-video-url') as HTMLInputElement).value =
          window.origin + '/base/spec/content/video/RTE-Ocean-Waves.mp4';
  ...
  describe('Inserting Video as Base64 - ', () => {
    ...
    it(' Test the inserted video in the component ', (done) => {
      ...
      let fileObj: File = new File(['mov_bob'], 'mov_bob.mp4', {
        lastModified: 0,
        type: 'overide/mimetype',
      });
      let eventArgs = {
      ...
      setTimeout(() => {
        expect(
          rteObj
            .getContent()
            .querySelector('.e-rte-video.e-video-inline source')
            .getAttribute('src')
            .indexOf('blob') == -1
        ).toBe(true);
        evnArg.selectNode = [rteObj.element];
  ...
  describe('Insert video mediaRemoving event - ', () => {
    ...
    it(' Test the component insert video events - case 2 ', (done) => {
      ...
      setTimeout(() => {
        evnArg.selectNode = [rteObj.element];
        (<any>rteObj).videoModule.deleteVideo(evnArg);
        (<any>rteObj).videoModule.uploadObj.upload(
          (<any>rteObj).videoModule.uploadObj.filesData[0]
        );
        done();
      }, 4000);
    });
  ...
  describe('Insert video mediaUploadFailed event - ', () => {
    let rteObj: RichTextEditor;
    let mediaUploadFailedSpy: jasmine.Spy =
      jasmine.createSpy('onFileUploadFailed');
    beforeEach((done: Function) => {
      rteObj = renderRTE({
  ...
  describe('Testing allowed extension in video upload - ', () => {
    ...
    it(' Test the component insert video with allowedExtension property', (done) => {
      ...
      (dialogEle.querySelector('.e-video-url') as HTMLInputElement).value =
        'https://www.w3schools.com/html/horse.m4a';
      let fileObj: File = new File(['mov_bob'], 'horse.m4a', {
        lastModified: 0,
        type: 'overide/mimetype',
      });
      let eventArgs = {
  ...
  describe('beforeMediaUpload event - ', () => {
    let rteObj: RichTextEditor;
    let beforeMediaUploadSpy: jasmine.Spy =
      jasmine.createSpy('onBeforeFileUpload');
    beforeEach((done: Function) => {
      rteObj = renderRTE({
    ...
    it(' Event and arguments test ', (done) => {
      ...
      (dialogEle.querySelector('.e-video-url') as HTMLInputElement).value =
        window.origin + '/base/spec/content/video/RTE-Ocean-Waves.mp4';
      let fileObj: File = new File(['Header'], 'mov_bob.mp4', {
        lastModified: 0,
        type: 'overide/mimetype',
      });
      let eventArgs = {
  ...
  describe('Checking video replace, using the video dialog', () => {
    ...
    it('video dialog', (done) => {
      ...
      let fileObj: File = new File(['Testing'], 'test.mp3', {
        lastModified: 0,
        type: 'overide/mimetype',
      });
      let eventArgs = {
  ...
  describe('Video outline style testing, while focus other content or video', () => {
    ...
    beforeAll((done: Function) => {
      rteObj = renderRTE({
        ...
        value:
          '<p>Sample Text</p> <p><span class="e-video-wrap" contenteditable="false" title="mov_bbb.mp4"><video class="e-rte-video e-videoinline" controls=""><source src="https://www.w3schools.com/html/mov_bbb.mp4" type="video/mp4"></video></span><span class="e-video-wrap" contenteditable="false" title="mov_bbb.mp4"><video class="e-rte-video e-videoinline" controls=""><source src="https://www.w3schools.com/html/mov_bbb.mp4" type="video/mp4"></video></span></p>',
      });
    ...
    it('first video click with focus testing', (done) => {
      ...
      dispatchEvent(
        rteObj.element.querySelectorAll('.e-content video')[0] as HTMLElement,
        'mousedown'
      );
      expect(
        (
          rteObj.element.querySelectorAll(
            '.e-content .e-video-wrap video'
          )[0] as HTMLElement
    ...
    it('second video click with focus testing', (done) => {
      (<any>QTBarModule).renderQuickToolbars(rteObj.videoModule);
      dispatchEvent(
        rteObj.element.querySelectorAll('.e-content video')[1] as HTMLElement,
        'mousedown'
      );
      expect(
        (
  ...
  describe('Video focus not working after outside click then again click a video', () => {
    ...
    beforeAll((done: Function) => {
      rteObj = renderRTE({
        ...
        value:
          '<p>Sample Text</p> <span class="e-video-wrap" contenteditable="false" title="mov_bbb.mp4"><video class="e-rte-video e-videoinline" controls=""><source src="https://www.w3schools.com/html/mov_bbb.mp4" type="video/mp4"></video></span><br><span class="e-video-wrap" contenteditable="false" title="mov_bbb.mp4"><video class="e-rte-video e-videoinline" controls=""><source src="https://www.w3schools.com/html/mov_bbb.mp4" type="video/mp4"></video></span>',
      });
      QTBarModule = getQTBarModule(rteObj);
      done();
    });
  ...
  describe('ShowDialog, CloseDialog method testing', () => {
    ...
    it('show/hide dialog testing', (done) => {
      ...
      setTimeout(() => {
        expect(
          document.body.querySelectorAll('.e-rte-video-dialog.e-dialog').length
        ).toBe(1);
        rteObj.closeDialog(DialogType.InsertVideo);
        setTimeout(() => {
          expect(
            document.body.querySelectorAll('.e-rte-video-dialog.e-dialog')
              .length
          ).toBe(0);
          done();
        }, 100);
  ...
  describe('EJ2-65777 Not able to insert Embed video using Keyboard Shortcut', () => {
    ...
    it('Should insert Embed video in the RTE content editable div', (done: Function) => {
      ...
      const inputElem: HTMLElement =
        document.querySelector('.e-embed-video-url');
  ...
  describe('836851 - Change the video size using video quick toolbar dimention dialog', () => {
    ...
    it('Change the video size using video quick toolbar dimention dialog', (done: Function) => {
      ...
      let videoQTBarEle = <HTMLElement>(
        document.querySelector('.e-rte-quick-popup')
      );
      (
        videoQTBarEle.querySelector("[title='Dimension']") as HTMLElement
      ).click();
      let dialogEle = <HTMLElement>(
        document.querySelector('.e-rte-video-dialog')
      );
      (dialogEle.querySelector('.e-vid-width') as HTMLInputElement).value =
        '200px';
      (dialogEle.querySelector('.e-vid-width') as HTMLElement).dispatchEvent(
        new Event('input')
      );
      (dialogEle.querySelector('.e-vid-height') as HTMLInputElement).value =
        '200px';
      (dialogEle.querySelector('.e-vid-height') as HTMLElement).dispatchEvent(
        new Event('input')
      );
      (dialogEle.querySelector('.e-update-size') as HTMLElement).click();
      expect(
        isNullOrUndefined(document.querySelector('.e-rte-quick-popup'))
      ).toBe(true);
      done();
    });
  });
  ...
  describe('836851 - insertVideoUrl', function () {
    ...
    it('Check the insertVideoUrl', (done: Function) => {
      (<any>QTBarModule).renderQuickToolbars(rteObj.videoModule);
      (<any>rteObj).videoModule.uploadUrl = {
        url: 'https://www.w3schools.com/html/mov_bbb.mp4',
      };
      (
        (<HTMLElement>(
          document.querySelector('[title="Insert Video (Ctrl+Alt+V)"]')
        )) as HTMLElement
      ).click();
      let dialogEle: any = rteObj.element.querySelector('.e-dialog');
      (
      ...
      (dialogEle.querySelector('.e-video-url') as HTMLInputElement).value =
        window.origin + '/base/spec/content/video/RTE-Ocean-Waves.mp4';
      (dialogEle.querySelector('.e-video-url') as HTMLElement).dispatchEvent(
        new Event('input')
      );
      (
        document.querySelector('.e-insertVideo.e-primary') as HTMLElement
      ).click();
      expect(!isNullOrUndefined(document.querySelector('.e-rte-video'))).toBe(
        true
      );
      done();
    });
  ...
  describe('836851 - Check the insert button - without input URL', function () {
    ...
    it('Check the insert button - without input URL', (done: Function) => {
      ...
      (
        dialogEle.querySelector(
          '.e-video-url-wrap input#embedURL'
        ) as HTMLElement
      ).click();
      (
        dialogEle.querySelector('.e-video-url-wrap input#webURL') as HTMLElement
      ...
      (
        ...
        '<iframe width="560" height="315" src="https://www.youtube.com/embed/4U2ZxO7b8iM" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>';
      (
        dialogEle.querySelector('.e-embed-video-url') as HTMLElement
      ).dispatchEvent(new Event('keyup'));
      (
        dialogEle.querySelector('.e-embed-video-url') as HTMLInputElement
      ).value = '';
      ...
      expect(
        !isNullOrUndefined(document.querySelector('.e-video-clickelem'))
      ).toBe(true);
      (
        (<HTMLElement>(
          document.querySelectorAll('.e-toolbar-item')[0]
        )) as HTMLElement
      ).click();
      (
        (<HTMLElement>(
          document.querySelectorAll('.e-browsebtn')[0]
        )) as HTMLElement
      ).click();
  ...
  describe(' Mobile video interaction', () => {
    ...
    it('check the video click', (done: Function) => {
      ...
      let eventsArgs: any = {
        target: rteObj.element.querySelector('.e-rte-video') as HTMLElement,
        preventDefault: function () {},
      };
      (<any>rteObj).videoModule.videoClick(eventsArgs);
      expect(
        !isNullOrUndefined(
          rteObj.contentModule.getEditPanel().querySelector('.e-rte-video')
        )
      ).toBe(true);
      done();
    });
  ...
  describe('836851 - Insert video', function () {
    ...
    it('Close the dialog while video insert', (done: Function) => {
      ...
      expect(
        !isNullOrUndefined(document.querySelector('.e-rte-video-dialog'))
      ).toBe(true);
      done();
    });
  });
  ...
  describe('836851 - Iframe video delete ', () => {
    ...
    it('Delete video using quick toolbar', (done: Function) => {
      ...
      expect(
        !isNullOrUndefined(
          document.querySelector('.e-embed-video-wrap') as HTMLElement
        )
      ).toBe(true);
      expect(
        !isNullOrUndefined(
  ...
  describe('836851 - Video quick toolbar hide', () => {
    ...
    it('Quick toolbar hide while resize', (done: Function) => {
      ...
      (<any>rteObj).videoModule.editAreaClickHandler({ args: clickEvent });
      target = (<HTMLElement>(
        document.querySelector('.e-rte-botRight')
      )) as HTMLElement;
      target.dispatchEvent(clickEvent);
      (<any>rteObj).videoModule.resizeStart(clickEvent);
      expect(
  ...
  describe('836851 - Video resize element hide', () => {
    ...
    it('Check resize element hide on document click', (done: Function) => {
      ...
      target.dispatchEvent(clickEvent);
      (<any>rteObj).videoModule.onDocumentClick(clickEvent);
      expect(isNullOrUndefined(document.querySelector('.e-vid-resize'))).toBe(
        true
      );
      done();
    });
  ...
  describe('836851 - Video keyup', function () {
    ...
    it('check the video keyup - backspace', function (done) {
      let startContainer = rteObj.contentModule
        .getEditPanel()
        .querySelector('p').childNodes[0];
      ...
      expect(
        !isNullOrUndefined(rteObj.element.querySelector('.e-video-wrap'))
      ).toBe(true);
      done();
    });
  });
  describe('836851 - Video keyup in iframe', function () {
    ...
    it('check the video keyup - backspace in iframe', function (done) {
      ...
      (<any>rteObj).videoModule.onKeyUp();
      expect(
        !isNullOrUndefined(rteObj.element.querySelector('.e-embed-video-wrap'))
      ).toBe(true);
      done();
    });
  });
  ...
  describe('837380: The web url is empty when trying to edit after being inserted into the Rich Text Editor', function () {
    ...
    beforeEach(function (done) {
      rteObj = renderRTE({
        value:
          '<p>Testing<span class="e-video-wrap" contenteditable="false" title="movie.mp4"><video class="e-rte-video e-video-inline" controls=""><source src="https://www.w3schools.com/html/mov_bbb.mp4" type="video/mp4"></video></span><br></p>',
      });
      controlId = rteObj.element.id;
      done();
    });
  ...
  describe('876592: Video not replaced ', function () {
    ...
    it('Replace the embeded video to web url', function (done) {
      ...
      setTimeout(function () {
        ...
        (
          dialog.querySelector('.e-video-url') as HTMLInputElement
        ).dispatchEvent(new Event('input'));
        (
          dialog.querySelector('.e-insertVideo.e-primary') as HTMLElement
        ).click();
        setTimeout(function () {
          let result = rteObj.inputElement.querySelector('video');
          expect(
            result.querySelector('source').src ===
    ...
    it('Replace the web url to embeded video', function (done) {
      ...
      setTimeout(function () {
        ...
        let urlInput: HTMLTextAreaElement =
          dialog.querySelector('.e-embed-video-url');
        urlInput.value =
          `<iframe width="560" height="315" src="https://www.youtube.com/embed/4U2ZxO7b8iM" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>` as string;
        (
          dialog.querySelector('.e-embed-video-url') as HTMLTextAreaElement
        ).dispatchEvent(new Event('keyup'));
        (
          dialog.querySelector('.e-insertVideo.e-primary') as HTMLElement
        ).click();
