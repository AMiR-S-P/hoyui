...
describe('Link Module', () => {
  describe('div content mobile ui', () => {
    ...
    it('mobile UI', () => {
      ...
      expect(
        (<any>rteObj).linkModule.dialogObj.headerEle.innerHTML === 'Insert Link'
      ).toBe(true);
  ...
  describe('exe command', () => {
    ...
    it('show link quick toolbar testing', () => {
      ...
      let eventArgs: any = {
        ...
        isNotify: true,
        type: 'Links',
        elements: [document.querySelector('.e-toolbar-item'), document.body],
      };
      (<any>rteObj).linkModule.showLinkQuickToolbar(eventArgs);
      expect(
        document
          .querySelectorAll('.e-rte-quick-popup')[0]
          .id.indexOf('Link_Quick_Popup') >= 0
      ).toBe(true);
  ...
  describe('div content-rte testing', () => {
    ...
    it('insert link, editlink, openlink', (done) => {
      ...
      expect(
        (<any>(
          rteObj
        )).linkModule.dialogObj.contentEle.firstElementChild.classList.contains(
          'e-rte-linkcontent'
        )
      ).toBe(true);
      expect(
      ...
      expect(
        (<any>rteObj).linkModule.dialogObj.primaryButtonEle.classList.contains(
          'e-insertLink'
        )
      ).toBe(true);
      setTimeout(() => {
        ...
        setTimeout(function () {
          ...
          expect(
            (<any>rteObj).contentModule
              .getEditPanel()
              .querySelector('.e-rte-anchor').title === 'http://data'
          ).toBe(true);
          expect(
            (<any>rteObj).contentModule
              .getEditPanel()
              .querySelector('.e-rte-anchor').innerHTML === 'http://data'
          ).toBe(true);
          (<any>rteObj).contentModule
            .getEditPanel()
            .querySelector('.e-rte-anchor')
          ...
          (<any>rteObj).contentModule
            .getEditPanel()
            .querySelector('.e-rte-anchor').target = '';
          (<any>rteObj).linkModule.linkDialog(evnArg);
          setTimeout(() => {
            evnArg.target = (<any>(
              rteObj
            )).linkModule.dialogObj.primaryButtonEle.nextElementSibling;
            (<any>(
              rteObj
            )).linkModule.dialogObj.primaryButtonEle.nextElementSibling.click(
              evnArg
            );
            (<any>rteObj).linkModule.linkDialog(evnArg);
            setTimeout(() => {
  ...
  describe('Link actions with LinkPath API property set as Relative', () => {
    ...
    it('insert link, editlink, openlink', () => {
      ...
      expect(
        (<any>rteObj).contentModule
          .getEditPanel()
          .querySelector('.e-rte-anchor').title === 'relativelink/link'
      ).toBe(true);
      expect(
        (<any>rteObj).contentModule
          .getEditPanel()
          .querySelector('.e-rte-anchor').innerHTML === 'relativelink/link'
      ).toBe(true);
      (<any>rteObj).contentModule
        .getEditPanel()
        .querySelector('.e-rte-anchor')
  ...
  describe('Insert link in HTML Tag IFRAME throws error', () => {
    ...
    it('insert link, editlink, openlink in HTML Tag IFRAME', () => {
      ...
      (<any>rteObj).linkModule.dialogObj.contentEle.querySelector(
        '.e-rte-linkText'
      ).value = 'Provides <IFRAME> and <DIV> modes';
      evnArg.target = (<any>rteObj).linkModule.dialogObj.primaryButtonEle;
      (<any>rteObj).linkModule.dialogObj.primaryButtonEle.click(evnArg);
      (<any>rteObj).contentModule
        .getEditPanel()
      ...
      (<any>rteObj).linkModule.dialogObj.contentEle.querySelector(
        '.e-rte-linkText'
      ).value = 'Provides <IFRAME> and <DIV> modes Value';
      evnArg.target = (<any>rteObj).linkModule.dialogObj.primaryButtonEle;
      (<any>rteObj).linkModule.dialogObj.primaryButtonEle.click(evnArg);
      expect(
        (<any>rteObj).contentModule.getEditPanel().innerText ===
          `Provides <IFRAME> and <DIV> modes Value`
      ).toBe(true);
    });
  });
    ...
    it('link dialog', () => {
      ...
      (
        rteObj.toolbarModule
          .getToolbarElement()
          .querySelectorAll('.e-toolbar-item button')[8] as HTMLElement
      ).click();
      expect(
        (<any>rteObj).linkModule.dialogObj.headerEle.innerHTML === 'Insert Link'
      ).toBe(true);
      ...
      (<any>rteObj).linkModule.quickToolObj.linkQTBar.element
        .querySelectorAll('.e-toolbar-item')[0]
        .click();
      (<any>rteObj).linkModule.quickToolObj.linkQTBar.element
        .querySelectorAll('.e-toolbar-item')[1]
        .click();
      let cancelBtn: HTMLElement = rteObj.element.querySelectorAll(
        '.e-rte-link-dialog .e-footer-content button'
      )[1] as HTMLElement;
      cancelBtn.click();
      ...
      let node: any =
        rteObj.contentModule.getEditPanel().childNodes[0].childNodes[1];
  ...
  describe('link dialog open - Short cut key', () => {
    ...
    it('open link dialog - ctrl+l', () => {
      ...
      expect(
        document.body.contains((<any>rteObj).linkModule.dialogObj.element)
      ).toBe(true);
    });
  ...
  describe('link dialog - documentClick', () => {
    ...
    it('open link dialog - click on link item in toolbar', () => {
      ...
      let eventsArgs: any = {
        target: rteObj.element.querySelector('.e-create-link'),
        preventDefault: function () {},
      };
      (<any>rteObj).linkModule.onDocumentClick(eventsArgs);
      expect(
      ...
      eventsArgs = {
        target: document.querySelector('[title="Insert Link (Ctrl+K)"]'),
        preventDefault: function () {},
      };
      (<any>rteObj).linkModule.onDocumentClick(eventsArgs);
      expect(
  ...
  describe('insert link with selected text', () => {
    ...
    it('check link text', () => {
      ...
      selObj.setSelectionNode(
        rteObj.contentModule.getDocument(),
        rteObj.contentModule.getEditPanel().childNodes[0]
      );
      (
        (<HTMLElement>(
      ...
      (rteObj as any).linkModule.dialogObj.contentEle.querySelector(
        '.e-rte-linkurl'
      ...
      (<any>rteObj).linkModule.dialogObj.primaryButtonEle.click({
        target: target,
        preventDefault: function () {},
      });
      expect(
        rteObj.contentModule.getEditPanel().querySelector('a').text ===
          'syncfusion'
      ).toBe(true);
    ...
    it('check display text', () => {
      ...
      expect(
        (rteObj as any).element.getElementsByTagName('a')[0].firstChild
          .textContent
      ).toBe('syncfusion');
    });
    it('Apply link to the link element along with extra text', () => {
      ...
      expect(
        rteObj.contentModule.getEditPanel().querySelector('p').children[0]
          .tagName === 'A'
      ).toBe(true);
    });
  ...
  describe('EJ2-59865 - css class dependency component - Link Module', () => {
    ...
    it(' css class dependency initial load and dynamic change ', () => {
      ...
      expect(
        document
          .querySelector('.e-rte-link-dialog')
  ...
  describe('EJ2-59194 - More space between the text and Inserting a new link removes the space between the words issue', () => {
    ...
    it('More space between the text and Inserting a new link removes the space between the words issue', () => {
      ...
      expect(
        rteObj.contentModule.getEditPanel().querySelector('a').text === 'side.'
      ).toBe(true);
    });
  });
  ...
  describe('EJ2-51959- Link is not generated properly, when pasteCleanUpModule is imported', () => {
    ...
    beforeAll(() => {
      rteObj = renderRTE({
        value:
          '<p>syncfusion 1</p><p><span>syncfusion 2</span></p><p><span>syncfusion 3</span></p><p><span>syncfusion 4</span></p>',
        toolbarSettings: {
          items: ['CreateLink', 'Bold'],
        },
      });
    ...
    it('Applying link for multiple nodes selected', () => {
      ...
      rteObj.formatter.editorManager.nodeSelection.setSelectionText(
        ...
        (rteObj.contentModule.getEditPanel().childNodes[3] as any)
      ...
      expect(
        (<any>rteObj).linkModule.dialogObj.contentEle.querySelector(
          '.e-rte-linkText'
        ).value === 'syncfusion 1syncfusion 2syncfusion 3syncfusion 4'
      ).toBe(true);
      let target: any = (<any>rteObj).linkModule.dialogObj.primaryButtonEle;
      (<any>rteObj).linkModule.dialogObj.primaryButtonEle.click({
        target: target,
      ...
      expect(
        (
          rteObj.contentModule.getEditPanel().childNodes[0] as any
        ).querySelector('a').text === 'syncfusion 1'
      ).toBe(true);
      expect(
        (
          rteObj.contentModule.getEditPanel().childNodes[1] as any
        ).querySelector('a').text === 'syncfusion 2'
      ).toBe(true);
      expect(
        (
          rteObj.contentModule.getEditPanel().childNodes[2] as any
        ).querySelector('a').text === 'syncfusion 3'
      ).toBe(true);
      expect(
        (
          rteObj.contentModule.getEditPanel().childNodes[3] as any
        ).querySelector('a').text === 'syncfusion 4'
      ).toBe(true);
      keyboardEventArgs.ctrlKey = true;
      keyboardEventArgs.keyCode = 90;
      keyboardEventArgs.action = 'undo';
  ...
  describe(' toolbarSettings property - Items - ', () => {
    ...
    it(' Test - Click the CreateLink item - set the disable the new window option', (done) => {
      ...
      let item: HTMLElement = rteObj.element.querySelector(
        '#' + controlId + '_toolbar_CreateLink'
      );
      item.click();
      let dialogEle: any = rteObj.element.querySelector('.e-dialog');
      (dialogEle.querySelector('.e-rte-linkurl') as HTMLInputElement).value =
        'https://ej2.syncfusion.com';
      let check: HTMLInputElement =
        dialogEle.querySelector('.e-rte-linkTarget');
      check.click();
      setTimeout(() => {
        (
          document.querySelector('.e-insertLink.e-primary') as HTMLElement
        ).click();
  ...
  describe(' quickToolbarSettings property - link quick toolbar - ', () => {
    ...
    it(' Test - open quickToolbar after applied selection command (italic)', (done) => {
      ...
      rteObj.formatter.editorManager.nodeSelection.setSelectionText(
        document,
        link.childNodes[0].childNodes[0],
        link.childNodes[0].childNodes[0],
        0,
        3
      );
      let item: HTMLElement = rteObj.element.querySelector(
        '#' + controlId + '_toolbar_Italic'
      );
      item.click();
      ...
      setTimeout(() => {
        let linkBtn: HTMLElement = document.getElementById(
          controlId + '_quick_EditLink'
        );
  ...
  describe(' quickToolbarSettings property - inlineMode - link quick toolbar - ', () => {
    ...
    it(' EJ2-19934:  edit the link with open link in new window as disabled', (done) => {
      ...
      setTimeout(() => {
        ...
        let checkbox: HTMLInputElement = dialog.querySelector(
  ...
  describe(' Quick Toolbar showOnRightClick property testing', () => {
    ...
    it(" leftClick with `which` as '1' with quickpopup availability testing ", (done: Function) => {
      ...
      cntTarget.dispatchEvent(clickEvent);
      let target: HTMLElement = ele.querySelector('#link-container a');
      new NodeSelection().setSelectionText(
        document,
        target.childNodes[0].childNodes[0],
        target.childNodes[0].childNodes[0],
        0,
        0
      );
  ...
  describe('EJ2-27228 - Remove link not working', () => {
    ...
    it('insert link, editlink, openlink', () => {
      ...
      let clickEvent: any = document.createEvent('MouseEvents');
      clickEvent.initEvent('mousedown', false, true);
      (rteObj.contentModule.getEditPanel() as HTMLElement).dispatchEvent(
        clickEvent
      );
      rteObj.selectAll();
      (rteEle.querySelector('.e-toolbar-item button') as HTMLElement).click();
      (
        rteEle.querySelector(
          '.e-rte-link-dialog .e-rte-linkurl'
        ) as HTMLInputElement
      ).value = 'https://www.test.com';
      (
        rteEle.querySelector(
          '.e-rte-link-dialog .e-insertLink.e-primary'
        ) as HTMLButtonElement
      ).click();
      expect(
        rteEle.querySelectorAll('.e-rte-content .e-content a').length
      ).toBe(1);
      expect(
        (
          rteEle.querySelector(
            '.e-rte-content .e-content a'
      ...
      (
        quickPop.querySelectorAll('.e-toolbar-item button')[1] as HTMLElement
      ).click();
      (
        rteEle.querySelector(
          '.e-rte-link-dialog .e-rte-linkurl'
      ...
      ).toBe('https://www.testing.com/');
      quickPop = document.querySelector('.e-rte-quick-popup');
      expect(isNullOrUndefined(quickPop)).toBe(false);
      (
        quickPop.querySelectorAll('.e-toolbar-item button')[2] as HTMLElement
      ).click();
      quickPop = document.querySelector('.e-rte-quick-popup');
      expect(isNullOrUndefined(quickPop)).toBe(true);
      expect(
  ...
  describe('Checking tags while applying link', function () {
    ...
    beforeAll(function () {
      rteObj = renderRTE({
        value:
          '<p>sync<strong>fusion</strong></p><p><strong>Chennai</strong></p>',
        toolbarSettings: {
          items: ['CreateLink', 'Bold'],
        },
      });
    ...
    it('For Multiple block elements', function () {
      ...
      rteObj.linkModule.dialogObj.contentEle.querySelector(
        '.e-rte-linkurl'
      ).value = 'https://www.syncfusion.com';
      let target: HTMLElement = rteObj.linkModule.dialogObj.primaryButtonEle;
      rteObj.linkModule.dialogObj.primaryButtonEle.click({
        target: target,
        preventDefault: function () {},
      });
      let firstChild: string =
        '<a class="e-rte-anchor" href="https://www.syncfusion.com" title="https://www.syncfusion.com" target="_blank" aria-label="Open in new window">sync<strong>fusion</strong></a>';
      expect((pEle.childNodes[0] as HTMLElement).innerHTML === firstChild).toBe(
        true
      );
      let secondChild: string =
        '<strong><a class="e-rte-anchor" href="https://www.syncfusion.com" title="https://www.syncfusion.com" target="_blank" aria-label="Open in new window">Chennai</a></strong>';
      expect(
        (pEle.childNodes[1] as HTMLElement).innerHTML === secondChild
      ).toBe(true);
    });
    it('For single element with bold and image', function () {
      rteObj.value =
        '<p style="cursor: auto;">Sync<strong>fusion</strong><img class="e-rte-image e-imginline e-resize" width="109" height="42" alt="undefined"' +
      ...
      (rteEle.querySelectorAll('.e-toolbar-item')[0] as HTMLElement).click();
      let firstChild: string =
        '<a class="e-rte-anchor" href="https://www.syncfusion.com" title="https://www.syncfusion.com" target="_blank" aria-label="Open in new window">Sync<strong>fusion</strong>' +
      ...
      expect(rteObj.inputElement.childNodes[0].innerHTML === firstChild).toBe(
        true
      );
    });
  });
  ...
  describe(' quickToolbarSettings property - link quick toolbar - ', function () {
    ...
    beforeEach(function (done) {
      rteObj = renderRTE({
        value:
          '<p><a id="link" href="https://ej2.syncfusion.com/home/" target=\'_blank\'><strong>HTML</strong></a></p><p><a href="https://ej2.syncfusion.com/home/" target=\'_blank\'>sync</a></p>',
      });
      controlId = rteObj.element.id;
      done();
    });
    ...
    it(' Test - open quickToolbar after applied selection command (italic)', function (done) {
      ...
      rteObj.formatter.editorManager.nodeSelection.setSelectionText(
        document,
        linkNodes[0].childNodes[0].childNodes[0],
        linkNodes[1].childNodes[0],
        0,
        3
      );
      let item: any = rteObj.element.querySelector(
        '#' + controlId + '_toolbar_Italic'
      );
      item.click();
      dispatchEvent(link, 'mousedown');
  ...
  describe('EJ2-40770 - Insert link on the already pasted link throws console error', () => {
    ...
    beforeAll(() => {
      rteObj = renderRTE({
        value:
          '<p><a href="https://www.syncfusion.com">https://www.syncfusion.com</a><br></p>',
        toolbarSettings: {
          items: ['CreateLink', 'Bold'],
        },
      });
    ...
    it('apply same url through inert link dialog', () => {
      ...
      expect(
        rteObj.contentModule.getEditPanel().querySelector('a').href ===
          'https://www.syncfusion.com/'
      ).toBe(true);
    });
  });
  ...
  describe('EJ2-49981 - ShowDialog, CloseDialog method testing', () => {
    ...
    it('beforeDialogOpen event trigger testing', (done) => {
      ...
      setTimeout(() => {
        expect(
          document.body.querySelectorAll('.e-rte-link-dialog.e-dialog').length
        ).toBe(1);
  ...
  describe('EJ2-71006 - Insert link in list ', () => {
    ...
    it('insert link in list', () => {
      rteObj.formatter.editorManager.nodeSelection.setCursorPoint(
        document,
        rteObj.inputElement.lastElementChild.lastChild as Element,
        7
      );
      let args: any = {
        preventDefault: function () {},
  ...
  describe('849561- Unable to do any formatting action for the link content in the RTE', () => {
    ...
    it('Should not disable the toolbar items after the link is clicked', (done: DoneFn) => {
      ...
      setTimeout(() => {
        ...
        expect(
          rteObj.element.querySelectorAll('.e-toolbar-item.e-overlay').length
        ).toBe(0);
        done();
      }, 200);
    });
  ...
  describe('849062 - The link should open in a new tab when the link is clicked with the ctrl key in the Rich Text Editor', () => {
    ...
    it('check the link open in new tab', () => {
      let target = <HTMLElement>(
        rteObj.element.querySelectorAll('.e-content')[0]
      );
      ...
      expect(rteObj.element.querySelectorAll('.e-rte-quick-popup').length).toBe(
        0
      );
    });
  });
  ...
  describe('876805 - Bold format reverted if we edit the link which has bold style', function () {
    ...
    it('edit the dispaly text of link using quick toolbar ', (done: Function) => {
      ...
      setTimeout(() => {
        const editlink: HTMLElement = document.querySelector(
          '[title="Edit Link"]'
        );
        (editlink.childNodes[0] as HTMLElement).click();
        (document.querySelector('.e-rte-linkText') as HTMLInputElement).value =
          'Editor';
        let target: any = (<any>rteObj).linkModule.dialogObj.primaryButtonEle;
        (<any>rteObj).linkModule.dialogObj.primaryButtonEle.click({
          target: target,
