...
import {
  ARROW_DOWN_EVENT_INIT,
  ARROW_LEFT_EVENT_INIT,
  ARROW_UP_EVENT_INIT,
  ARROWRIGHT_EVENT_INIT,
  BASIC_MOUSE_EVENT_INIT,
  INSRT_TABLE_EVENT_INIT,
  SHIFT_ARROW_DOWN_EVENT_INIT,
  SHIFT_ARROW_LEFT_EVENT_INIT,
  SHIFT_ARROW_RIGHT_EVENT_INIT,
  SHIFT_ARROW_UP_EVENT_INIT,
} from '../../constant.spec';
...
describe('Table Module', () => {
  describe('CSS property change testing, Coverage improvement ', () => {
    ...
    it('Update the CSS property dynamically Dialog test', () => {
      ...
      editor.inputElement.dispatchEvent(
        new MouseEvent('mousedown', BASIC_MOUSE_EVENT_INIT)
      );
      editor.inputElement.dispatchEvent(
        new KeyboardEvent('keydown', INSRT_TABLE_EVENT_INIT)
      );
      editor.cssClass = 'crm-editor';
      editor.dataBind();
      expect(
        editor.tableModule.editdlgObj.cssClass.includes('crm-editor')
      ).toBe(true);
      editor.cssClass = 'internal-process-editor';
      editor.dataBind();
      expect(
        editor.tableModule.editdlgObj.cssClass.includes(
          'internal-process-editor'
        )
      ).toBe(true);
    });
    ...
    it('Update the CSS property dynamically Popup test', () => {
      ...
      editor.dataBind();
      expect(
        editor.tableModule.popupObj.element.className.includes('crm-editor')
      ).toBe(true);
      editor.cssClass = 'internal-process-editor';
      editor.dataBind();
      expect(
        editor.tableModule.popupObj.element.className.includes(
          'internal-process-editor'
        )
      ).toBe(true);
    });
    ...
    it('focus of the table cells and then arrow key action to navigate.', () => {
      ...
      document.getSelection().addRange(range);
      (editor.tableModule as any).previousTableElement =
        editor.inputElement.querySelector('table');
      editor.inputElement.dispatchEvent(
        new KeyboardEvent('keydown', ARROWRIGHT_EVENT_INIT)
      );
      editor.inputElement.dispatchEvent(
        new KeyboardEvent('keyup', ARROWRIGHT_EVENT_INIT)
      );
      editor.inputElement.dispatchEvent(
        new KeyboardEvent('keydown', ARROW_LEFT_EVENT_INIT)
      );
      editor.inputElement.dispatchEvent(
        new KeyboardEvent('keyup', ARROW_LEFT_EVENT_INIT)
      );
      editor.inputElement.dispatchEvent(
        new KeyboardEvent('keydown', ARROW_DOWN_EVENT_INIT)
      );
      editor.inputElement.dispatchEvent(
        new KeyboardEvent('keyup', ARROW_DOWN_EVENT_INIT)
      );
      editor.inputElement.dispatchEvent(
        new KeyboardEvent('keydown', ARROW_UP_EVENT_INIT)
      );
      editor.inputElement.dispatchEvent(
        new KeyboardEvent('keyup', ARROW_UP_EVENT_INIT)
      );
    ...
    it('focus of the table cells and then shift + arrow keys to select cells.', (done: DoneFn) => {
      ...
      document.getSelection().addRange(range);
      editor.inputElement.dispatchEvent(
        new KeyboardEvent('keydown', SHIFT_ARROW_RIGHT_EVENT_INIT)
      );
      editor.inputElement.dispatchEvent(
        new KeyboardEvent('keyup', SHIFT_ARROW_RIGHT_EVENT_INIT)
      );
      ...
      document.getSelection().addRange(range);
      editor.inputElement.dispatchEvent(
        new KeyboardEvent('keydown', SHIFT_ARROW_LEFT_EVENT_INIT)
      );
      editor.inputElement.dispatchEvent(
        new KeyboardEvent('keyup', SHIFT_ARROW_LEFT_EVENT_INIT)
      );
      range = document.createRange();
      range.setStart(editor.inputElement.querySelector('.e-cell-select'), 0);
      range.setEnd(editor.inputElement.querySelector('.e-cell-select'), 0);
      ...
      document.getSelection().addRange(range);
      editor.inputElement.dispatchEvent(
        new KeyboardEvent('keydown', SHIFT_ARROW_DOWN_EVENT_INIT)
      );
      editor.inputElement.dispatchEvent(
        new KeyboardEvent('keyup', SHIFT_ARROW_DOWN_EVENT_INIT)
      );
      range = document.createRange();
      range.setStart(editor.inputElement.querySelector('.e-cell-select'), 0);
      range.setEnd(editor.inputElement.querySelector('.e-cell-select'), 0);
      ...
      document.getSelection().addRange(range);
      editor.inputElement.dispatchEvent(
        new KeyboardEvent('keydown', SHIFT_ARROW_UP_EVENT_INIT)
      );
      editor.inputElement.dispatchEvent(
        new KeyboardEvent('keyup', SHIFT_ARROW_UP_EVENT_INIT)
      );
  ...
  describe('div content ', () => {
    ...
    it('table creation', (done: Function) => {
      ...
      let tar: HTMLElement = rteObj.contentModule
        .getEditPanel()
      ...
      setTimeout(() => {
        ...
        var popupElement = document.querySelectorAll(
        ...
        expect(
          popupElement.children[0].children[0].children[0].classList.contains(
            'e-insert-row-before'
          )
        ).toBe(true);
        ...
        popupElement = document.querySelectorAll(
          '.e-rte-dropdown-popup.e-popup-open'
        )[0];
        mouseEventArgs = {
        ...
        expect(
          popupElement.children[0].children[1].children[0].classList.contains(
            'e-insert-row-after'
          )
        ).toBe(true);
        (mouseEventArgs.target as HTMLElement).click();
        ...
        expect(
          popupElement.children[0].children[2].children[0].classList.contains(
            'e-delete-row'
          )
        ).toBe(true);
        ...
        expect(
          table.querySelector('tr').querySelectorAll('td').length === 4
        ).toBe(true);
        (mouseEventArgs.target as HTMLElement).click();
        expect(
          table.querySelector('tr').querySelectorAll('td').length === 5
        ).toBe(true);
        (rteObj.tableModule as any).editAreaClickHandler({ args: eventsArg });
        (tableTBItems.item(2).childNodes[0] as HTMLElement).click();
        popupElement = document.querySelectorAll(
        ...
        (mouseEventArgs.target as HTMLElement).click();
        expect(
          table.querySelector('tr').querySelectorAll('td').length === 6
        ).toBe(true);
        (rteObj.tableModule as any).editAreaClickHandler({ args: eventsArg });
        (tableTBItems.item(2).childNodes[0] as HTMLElement).click();
        popupElement = document.querySelectorAll(
        ...
        (rteObj.tableModule as any).cellSelect({
          args: { target: tar, preventDefault: function () {} },
        });
        selObj.setSelectionText(
        ...
        expect(
          document.querySelectorAll(
            '.e-rte-backgroundcolor-dropdown.e-popup-open'
          ).length > 0
        ).toBe(true);
        (
          document.querySelectorAll(
            '.e-rte-backgroundcolor-dropdown.e-popup-open .e-custom-palette .e-palette .e-row'
          )[1].children[4] as HTMLElement
        ).click();
        eventsArg = { pageX: 50, pageY: 300, target: tar };
        (rteObj.tableModule as any).editAreaClickHandler({ args: eventsArg });
        var bottomColor = (
          document.getElementsByClassName(
            'e-background-color e-rte-elements e-icons'
          )[0] as HTMLElement
        ...
        expect(
          popupElement.children[0].children[3].children[0].classList.contains(
            'e-justify-full'
          )
        ).toBe(true);
        (mouseEventArgs.target as HTMLElement).click();
        ...
        (mouseEventArgs.target as HTMLElement).click();
        expect(
          closest(tar, 'table').classList.contains('e-dashed-border')
        ).toBe(true);
        expect(closest(tar, 'table').classList.contains('e-dashed-test')).toBe(
          true
        );
        (rteObj.tableModule as any).editAreaClickHandler({ args: eventsArg });
        (tableTBItems.item(8).childNodes[0] as HTMLElement).click();
        ...
        (mouseEventArgs.target as HTMLElement).click();
        expect(
          closest(tar, 'table').classList.contains('e-alternate-border')
        ).toBe(true);
        expect(
          closest(tar, 'table').classList.contains('e-alternate-test')
        ).toBe(true);
        (rteObj.tableModule as any).editAreaClickHandler({ args: eventsArg });
        (tableTBItems.item(8).childNodes[0] as HTMLElement).click();
        popupElement = document.querySelectorAll(
        ...
        (mouseEventArgs.target as HTMLElement).click();
        expect(closest(tar, 'table').classList.contains('e-no-border')).toBe(
          true
        );
        tar = rteObj.contentModule.getEditPanel().querySelector('table');
        rteObj.inputElement.dispatchEvent(clickEvent);
        ...
        var backgroundColorPickerItem =
          document.querySelectorAll('.e-primary.e-apply')[0];
        var msEventArgs = {
          target: backgroundColorPickerItem,
        };
        clickEvent.initEvent('click', false, true);
        (
          (tableTBItems.item(3).childNodes[0] as HTMLElement).querySelector(
            '.e-background-color'
          ) as HTMLElement
        ).click();
        ...
        expect(rteObj.contentModule.getEditPanel().querySelector('table')).toBe(
          null
        );
        var eventArgs = {
          args: { target: document, preventDefault: function () {} },
        };
  ...
  describe('Checking the width for the table elements added', () => {
    ...
    it('2*2 table creation with width configured', (done: Function) => {
      ...
      let event: any = {
        target: (rteObj as any).tableModule.popupObj.element
          .querySelectorAll('.e-rte-table-row')[1]
          .querySelectorAll('.e-rte-tablecell')[1],
        preventDefault: function () {},
      };
      (rteObj as any).tableModule.tableCellSelect(event);
      (rteObj as any).tableModule.tableCellLeave(event);
    ...
    it('4*2 table creation with width configured', (done: Function) => {
      ...
      let tar: HTMLElement = rteObj.contentModule
        .getEditPanel()
        .querySelectorAll('table')[1] as HTMLElement;
      expect(tar).not.toBe(null);
      expect(tar.querySelectorAll('tr').length === 2).toBe(true);
      expect(tar.querySelectorAll('td').length === 8).toBe(true);
  ...
  describe('Table properties quicktoolbar ', () => {
    ...
    it('Cellpadding and cellSpacing style in table', (done: Function) => {
      ...
      (<any>rteObj).tableModule.editAreaClickHandler({ args: eventsArg });
      setTimeout(() => {
        let tablePop: any = <HTMLElement>(
          document.querySelectorAll('.e-rte-quick-popup')[0]
        );
        expect(tablePop.classList.contains('e-rte-quick-popup')).toBe(true);
        ...
        (<any>rteObj).tableModule.editAreaClickHandler({ args: eventsArg });
        (
          (<HTMLElement>tableTBItems.item(0)).childNodes[0] as HTMLElement
        ).click();
  ...
  describe('table dialog  ', () => {
    ...
    it('table creation - dialog', () => {
      ...
      expect(
        (
          rteObj.element.querySelectorAll('.rte-placeholder')[0] as HTMLElement
      ...
      expect(
        rteObj.contentModule.getEditPanel().querySelectorAll('.e-column-resize')
          .length === 4
      ).toBe(true);
      expect(
        rteObj.contentModule.getEditPanel().querySelectorAll('.e-row-resize')
          .length === 3
      ).toBe(true);
      expect(
      ...
      let reCol1: any = rteObj.contentModule
        .getEditPanel()
        .querySelectorAll('.e-column-resize')[1];
      clickEvent.initEvent('mousedown', false, true);
    ...
    it('Percentage Check-While resizing', () => {
      ...
      (
        document.getElementsByClassName('e-column-resize')[1] as HTMLElement
      ).dispatchEvent(mouseEvent);
      mouseEvent.initEvent('mousemove', true, true);
      document.dispatchEvent(mouseEvent);
      mouseEvent.initEvent('mouseup', true, true);
      document.dispatchEvent(mouseEvent);
      let colWidth: string = (table as HTMLTableElement).rows[0].cells[0].style
        .width;
      expect(colWidth.indexOf('%') !== -1).toBe(true);
      expect(position).toEqual(window.getSelection().anchorNode);
    });
    it('resize end', () => {
      let resizeBot: HTMLElement = rteObj.contentModule
        .getEditPanel()
        .querySelector('.e-column-resize') as HTMLElement;
      let table: HTMLElement = rteObj.contentModule
        .getEditPanel()
        .querySelector('table') as HTMLElement;
      (rteObj.tableModule as any).resizeEnd({ target: resizeBot });
      expect(
        rteObj.contentModule.getEditPanel().querySelector('.e-column-resize')
      ).toBe(null);
    ...
    it('resizing', () => {
      ...
      (rteObj.tableModule as any).resizeStart({
        target: reCol1,
        pageX: 100,
        pageY: 0,
        preventDefault: function () {},
      ...
      (rteObj.tableModule as any).resizing({
        target: reCol1,
        pageX: 200,
        pageY: 200,
        preventDefault: function () {},
      ...
      let resRow1: HTMLElement = rteObj.contentModule
        .getEditPanel()
        .querySelector('.e-row-resize') as HTMLElement;
      clickEvent.initEvent('mousedown', false, true);
      ...
      let tableBox: HTMLElement = rteObj.contentModule
        .getEditPanel()
  ...
  describe('EJ2-60291 - Table First Column Resize check ', () => {
    ...
    it('Resize Start Event check with first column', () => {
      ...
      let reCol1: any = rteObj.contentModule
        .getEditPanel()
        .querySelectorAll('.e-column-resize')[0];
      clickEvent.initEvent('mousedown', false, true);
      reCol1.dispatchEvent(clickEvent);
      (rteObj.tableModule as any).resizeStart(clickEvent);
    });
    it('Percentage Check-While resizing first column', () => {
      ...
      mouseEvent.initEvent('mousedown', true, true);
      (
        document.getElementsByClassName('e-column-resize')[0] as HTMLElement
      ).dispatchEvent(mouseEvent);
      mouseEvent.initEvent('mousemove', true, true);
      document.dispatchEvent(mouseEvent);
      mouseEvent.initEvent('mouseup', true, true);
  ...
  describe('EJ2-60291 - Table Last Column Resize check ', () => {
    ...
    it('Resize Start Event check with Last column', () => {
      ...
      let reCol1: any = rteObj.contentModule
        .getEditPanel()
        .querySelectorAll('.e-column-resize')[3];
      clickEvent.initEvent('mousedown', false, true);
      reCol1.dispatchEvent(clickEvent);
      (rteObj.tableModule as any).resizeStart(clickEvent);
    });
    it('Percentage Check-While resizing Last column', () => {
      ...
      mouseEvent.initEvent('mousedown', true, true);
      (
        document.getElementsByClassName('e-column-resize')[3] as HTMLElement
      ).dispatchEvent(mouseEvent);
      mouseEvent.initEvent('mousemove', true, true);
      document.dispatchEvent(mouseEvent);
      mouseEvent.initEvent('mouseup', true, true);
    ...
    it('resizing first column', () => {
      ...
      expect(
        table.querySelector('tr').querySelectorAll('td')[2].style.width !==
          '33.3333%'
      ).toBe(true);
    });
  });
  ...
  describe('table keyboard support ', () => {
    ...
    it('key navigation', () => {
      ...
      (table as HTMLElement)
        ...
        .classList.add('e-cell-select');
      selObj.setSelectionText(
        rteObj.contentModule.getDocument(),
        table.querySelectorAll('td')[8],
        table.querySelectorAll('td')[8],
        0,
        0
      );
      ...
      (<any>rteObj).tableModule.keyDown({ args: keyboardEventArgs });
      expect(
        table.querySelectorAll('td')[10] ===
          selObj.getRange(rteObj.contentModule.getDocument()).startContainer
      ).toBe(true);
      keyboardEventArgs.keyCode = 37;
      (<any>rteObj).tableModule.keyDown({ args: keyboardEventArgs });
      expect(
        table.querySelectorAll('td')[9] ===
          selObj.getRange(rteObj.contentModule.getDocument()).startContainer
      ).toBe(true);
  ...
  describe('Table tabKey pressed for new rows', () => {
    ...
    it('Tabkey at end of table td', () => {
      ...
      table.querySelectorAll('td')[0].classList.remove('e-cell-select');
      table.querySelectorAll('td')[6].innerHTML =
        'test1' + table.querySelectorAll('td')[6].innerHTML;
      table.querySelectorAll('td')[7].innerHTML =
        'test2' + table.querySelectorAll('td')[7].innerHTML;
      table.querySelectorAll('td')[8].innerHTML =
        'test3' + table.querySelectorAll('td')[8].innerHTML;
      (<any>rteObj).tableModule.keyDown({ args: keyboardEventArgs });
  ...
  describe('874515 - Pasted table tabKey press', () => {
    ...
    it('Pasted table tabKey press', () => {
      ...
      (<any>rteObj).tableModule.keyDown({ args: keyboardEventArgs });
      expect(table.querySelector('td').nextSibling.nodeName === '#text').toBe(
        false
      );
      expect(table.querySelector('tr').nextSibling.nodeName === '#text').toBe(
        false
      );
    });
  });
...
`;
  ...
  describe('mobile resize', () => {
    ...
    it('mobile UI', () => {
      ...
      (rteObj.tableModule as any).docClick({
        args: { target: rteObj.contentModule.getEditPanel() },
      });
      expect(
        rteObj.contentModule.getEditPanel().querySelector('.e-column-resize')
      ).toBe(null);
    ...
    describe('IE browser table ', () => {
      ...
      it('table insert', () => {
        expect(rteObj.element.querySelectorAll('.e-rte-content').length).toBe(
          1
        );
        (
          (<HTMLElement>(
  ...
  describe('table Inline Quick toolbar - showPopup method with popup open testing', () => {
    ...
    it('show inline toolbar', (done: Function) => {
      ...
      setTimeout(() => {
        let pop: HTMLElement = <HTMLElement>(
          document.querySelectorAll('.e-rte-quick-popup')[0]
        );
        expect(pop).not.toBe(undefined);
        (<HTMLElement>(
          pop.querySelectorAll('.e-toolbar-item button')[1]
        )).click();
  ...
  describe('table header', () => {
    ...
    it('check table heeader', (done: Function) => {
      ...
      setTimeout(() => {
        ...
        let table: any = rteObj.contentModule
          .getEditPanel()
          .querySelector('table');
        expect(table.querySelectorAll('thead').length > 0).toBe(true);
        expect(table.querySelectorAll('thead tr').length === 1).toBe(true);
  ...
  describe('TABLE with parent based selection', () => {
    describe('Apply to empty table td', () => {
      ...
      it(' OrderedList format', (done) => {
        ...
        let item: HTMLElement = rteObj.element.querySelector(
          '#' + controlId + '_toolbar_OrderedList'
        ) as HTMLElement;
        item.click();
      ...
      it('  Indent format', (done) => {
        ...
        expect(node.firstChild.nodeName === 'P').toBe(true);
        expect(
          (node.firstChild as HTMLElement).style.marginLeft === '20px'
        ).toBe(true);
        done();
      });
    });
    ...
    describe(' Apply to selected two lines within a TD', () => {
      ...
      it('  Alignments format ', (done) => {
        ...
        expect(applied.length === 2).toBe(true);
        expect((applied[0] as HTMLElement).style.textAlign === 'center').toBe(
          true
        );
        expect((applied[1] as HTMLElement).style.textAlign === 'center').toBe(
          true
        );
        done();
      });
      ...
      it('  Indent format', (done) => {
        ...
        let applied: any = node.querySelectorAll('p');
        expect(applied.length === 2).toBe(true);
        expect((applied[0] as HTMLElement).style.marginLeft === '20px').toBe(
          true
        );
        expect((applied[1] as HTMLElement).style.marginLeft === '20px').toBe(
          true
        );
        done();
      });
    ...
    describe(' Apply to selected three lines within a TD', () => {
      ...
      it('  Alignments format ', (done) => {
        ...
        expect((applied[2] as HTMLElement).style.textAlign === 'center').toBe(
          true
        );
        done();
      });
      ...
      it('  Indent format', (done) => {
        ...
        expect((applied[2] as HTMLElement).style.marginLeft === '20px').toBe(
          true
        );
        done();
      });
    ...
    describe(' Apply to selection of table  in between of paragraph', () => {
      ...
      it('  Alignments format ', (done) => {
        ...
        expect((applied[3] as HTMLElement).style.textAlign === 'center').toBe(
          true
        );
        done();
      });
      ...
      it('  Indent format', (done) => {
        ...
        expect((applied[3] as HTMLElement).style.marginLeft === '20px').toBe(
          true
        );
        done();
      });
      it('Bold the text and applying table to it', (done) => {
        rteObj.value =
          '<p>Bold the richtexteditor text and applying table to it testing</p>';
        rteObj.dataBind();
        let nodeSelection: NodeSelection = new NodeSelection();
        let firstNode: HTMLElement = rteObj.element.querySelectorAll('p')[0];
        nodeSelection.setSelectionText(
        ...
        (
          (<HTMLElement>(
            rteEle.querySelector('.e-insert-table-btn')
          )) as HTMLElement
        ).click();
        (
          (<HTMLElement>(
            rteEle.querySelectorAll('.e-insert-table')[0]
          )) as HTMLElement
        ).click();
        let firstSplittedNode: HTMLElement =
          rteObj.element.querySelectorAll('p')[0];
        let tableNode: HTMLElement =
          rteObj.element.querySelectorAll('table')[0];
        let lastSplittedNode: HTMLElement =
          rteObj.element.querySelectorAll('p')[1];
        expect(firstSplittedNode.querySelectorAll('strong').length === 0).toBe(
          true
        );
        expect(lastSplittedNode.querySelectorAll('strong').length === 0).toBe(
          true
        );
    ...
    describe(' Insert row from table header.', () => {
      ...
      it(' test the insert row from table header', (done) => {
        let node: HTMLElement = (rteObj as any).inputElement.querySelector(
          'th'
        );
        ...
        setTimeout(() => {
          ...
          let insertBtn: HTMLElement = tablePop.querySelector(
            '#' + controlId + '_quick_TableRows'
          );
          insertBtn.click();
          ...
          insertBtn = tablePop.querySelector(
            '#' + controlId + '_quick_TableRows'
          );
          insertBtn.click();
          ...
          expect(
            (rteObj as any).inputElement.querySelectorAll('td').length === 6
          ).toBe(true);
          expect(
            (
    ...
    describe(' Insert row to select the header element.', () => {
      ...
      it(' test the insert row after select the h1 element', (done) => {
        ...
        expect(
          (rteObj as any).inputElement.querySelectorAll('h1').length === 1
        ).toBe(true);
        let nodeSelection: NodeSelection = new NodeSelection();
        nodeSelection.setSelectionText(
          document,
        ...
        target.dispatchEvent(clickEvent);
        expect(
          (rteObj as any).inputElement.querySelectorAll('h1').length === 2
        ).toBe(true);
        done();
      });
    });
    ...
    describe('tab and shift+tab', () => {
      ...
      it('Multiline text cell', (done) => {
        setTimeout(() => {
          let tdNode: Element = rteObj.element.querySelector('td');
          (tdNode as HTMLElement).innerText =
    ...
    describe('EJ2-57672: List apply when insert table popup opened', () => {
      ...
      it(' List apply when insert table popup opened', (done) => {
        ...
        let item: HTMLElement = rteObj.element.querySelector(
          '#' + controlId + '_toolbar_CreateTable'
        ) as HTMLElement;
        item.click();
        let listItem: HTMLElement = rteObj.element.querySelector(
          '#' + controlId + '_toolbar_OrderedList'
        ) as HTMLElement;
        listItem.click();
        expect(
          (window.getSelection().anchorNode as any).firstElementChild
            .nodeName === 'BR'
        ).toBe(true);
        done();
      });
    ...
    describe(' EJ2-19873:  Inserting table in the list produces one extra empty list', () => {
      ...
      it(' insert the table at selection of end of li', (done) => {
        ...
        setCursorPoint(
          firstNode.childNodes[0] as Element,
          firstNode.textContent.length - 1
        );
        let item: HTMLElement = rteObj.element.querySelector(
          '#' + controlId + '_toolbar_CreateTable'
        ) as HTMLElement;
        item.click();
        let cell: Element = document
          .getElementById(controlId + '_table')
          .querySelectorAll('.e-rte-tablecell')[0];
  ...
  describe(' Quick Toolbar showOnRightClick property testing', () => {
    ...
    it(" leftClick with `which` as '1' with quickpopup availability testing ", (done: Function) => {
      ...
      rteObj.mouseUp(eventsArg);
      setTimeout(() => {
        let quickPop: any = document.querySelectorAll(
          '.e-rte-quick-popup'
        ) as NodeList;
    ...
    it(' iPhone - false with quickpopup availability testing', (done: Function) => {
      ...
      let eventsArg: any = {
        ...
        target: target,
        which: 1,
        clientX: rteObj.clickPoints.clientX,
        clientY: rteObj.clickPoints.clientY,
      };
      rteObj.mouseUp(eventsArg);
      setTimeout(() => {
        let quickPop: any = document.querySelectorAll(
  ...
  describe(' EJ2-19935: RTE text align property is not working properly in table cell', () => {
    ...
    it(' apply the right alignment to table td', (done) => {
      ...
      setTimeout(() => {
        ...
        let insertBtn: HTMLElement = tablePop.querySelector(
          '#' + controlId + '_quick_Alignments'
        );
        insertBtn.click();
        let dropdown: HTMLElement = document.querySelector(
          '#' + controlId + '_quick_Alignments-popup'
        );
        (dropdown.querySelectorAll('.e-item')[2] as HTMLElement).click();
        expect(
          (
            (rteObj as any).inputElement.querySelectorAll(
              'td'
            )[0] as HTMLElement
  ...
  describe('- EJ2-54390: Align Top in the table cell vertical align quickToolbar of table is always disabled', () => {
    ...
    it('- Align top in the table cell vertical align quickToolbar of table is always disabled', (done) => {
      ...
      setTimeout(() => {
        ...
        let insertBtn: HTMLElement = tablePop.querySelector(
          '#' + controlId + '_quick_TableCellVerticalAlign'
        );
        insertBtn.click();
        expect(
          document
            .querySelector(
              '#' + controlId + '_quick_TableCellVerticalAlign-popup'
            )
            .querySelector('li')
  ...
  describe("EJ2-49389: Table quick toolbar not hide while 'ctrl + a' after  backspace key action", () => {
    ...
    it('- checking toolbar hidden after backspace', (done) => {
      ...
      setTimeout(() => {
        ...
        (<any>rteObj).tableModule.keyDown({ args: keyboardEventArgs });
        expect(
          (document.querySelectorAll('.e-rte-quick-popup') as any).length
        ).toBe(0);
        done();
      }, 600);
    });
  ...
  describe('EJ2-49385: Table cell focus style not removed when interact outside of the RTE in Iframe Mode', () => {
    ...
    it('- checking table focus being removed', (done) => {
      ...
      setTimeout(() => {
        ...
        expect(
          (document.querySelectorAll('.e-cell-select') as any).length
        ).toBe(0);
        done();
      }, 600);
    });
  ...
  describe(' IE - table delete testing', () => {
    ...
    it(' delete column', (done) => {
      ...
      let tableCell: Element = document
      ...
      setTimeout(() => {
        ...
        (
          document.querySelectorAll(
            '.e-rte-quick-popup .e-toolbar-item button'
          )[2] as HTMLElement
        ).click();
        (rows[1].querySelectorAll('td')[1] as HTMLElement).classList.add(
          'e-cell-select'
        );
        (
          document.querySelectorAll(
            '.e-rte-dropdown-items.e-dropdown-popup ul .e-item'
          )[2] as HTMLElement
        ).click();
  ...
  describe(' IPhone - iFrame alignments testing', () => {
    ...
    it(' apply the right alignment to table th', () => {
      ...
      let insertBtn: HTMLElement = toolbar.querySelector(
        '#' + controlId + '_toolbar_Alignments'
      );
      insertBtn.click();
      let dropdown: HTMLElement = document.querySelector(
      ...
      (dropdown.querySelectorAll('.e-item')[2] as HTMLElement).click();
      expect(
        ((rteObj as any).inputElement.querySelector('p') as HTMLElement).style
          .textAlign === 'right'
      ).toBe(true);
    });
  });
  ...
  describe(' EJ2-28564:  Applying heading to table after inserting table inside another table not works properly', () => {
    ...
    it(' Insert header to child table', (done) => {
      expect(
        (rteObj as any).inputElement.querySelectorAll('thead').length
      ).toBe(0);
      let node: HTMLElement = (rteObj as any).inputElement.querySelectorAll(
        'td'
      )[1];
      setCursorPoint(node, 0);
      node.focus();
    ...
    it(' Insert header to root table', (done: Function) => {
      ...
      setTimeout(() => {
        ...
        expect(
          (rteObj as any).inputElement
            .querySelectorAll('thead')[1]
            .querySelectorAll('th').length
        ).toBe(3);
        expect(
          (rteObj as any).inputElement.querySelectorAll('thead th').length
        ).toBe(6);
        done();
      }, 600);
    });
      ...
      setTimeout(function () {
        ...
        setTimeout(() => {
          ...
          setTimeout(() => {
            ...
            expect(rteEle.querySelectorAll('.e-content > table').length).toBe(
              1
            );
            expect(rteEle.querySelector('.e-content').childNodes.length).toBe(
              2
            );
            let table: HTMLElement = rteObj.contentModule
              .getEditPanel()
  ...
  describe(' EJ2-43332 - Table getting removed while using bulleting/numbering', () => {
    ...
    it(' Apply OrderedList and check table availability ', (done: Function) => {
      ...
      setTimeout(function () {
        expect(
          rteEle.querySelector('.e-content').innerHTML
        ).toBe(`<table class="e-rte-table" style="width: 100%; min-width: 0px;">
                <tbody>
                    <tr>
  ...
  describe('Table code coverage', () => {
    ...
    it('Table code coverage', (done: Function) => {
      ...
      (rteObj as any).formatter.editorManager.tableObj.tableMove(args);
      expect(target.classList.contains('e-cell-select-end')).toBe(false);
      (rteObj as any).tableModule.curTable =
        rteEle.querySelector('.e-rte-table');
      const cssText = (
      ...
      expect(
        document.querySelector('#' + rteObj.element.id + '_tabledialog') !==
          null
      ).toBe(true);
      document.body.appendChild(
        (rteObj as any).tableModule.quickToolObj.inlineQTBar.element
      );
      ...
      expect(
        (rteObj as any).formatter.editorManager.tableObj.getCorrespondingIndex(
          null,
          []
        ).length === 0
      ).toBe(true);
      ...
      expect(
        (
          rteObj as any
        ).formatter.editorManager.tableObj.curTable.querySelectorAll(
          '.e-cell-select'
        ).length === 0
      ).toBe(true);
      (rteObj as any).formatter.editorManager.tableObj.curTable = null;
      const element: HTMLElement =
        rteObj.contentModule.getEditPanel().parentElement;
      let range: Range = document.createRange();
      range.setStart(element, 0);
      (rteObj as any).formatter.editorManager.nodeSelection.save(
        range,
        document
      );
      (rteObj as any).formatter.editorManager.tableObj.removeTable({
        item: { selection: rteObj.formatter.editorManager.nodeSelection },
      });
      expect(document.querySelectorAll('.e-rte-table').length === 2).toBe(true);
      (rteObj as any).focusIn();
      const tdElement: HTMLElement = rteObj.contentModule
        .getEditPanel()
        .querySelector('table')
        .querySelector('tr');
      tdElement.setAttribute('valign', 'top');
      (rteObj as any).formatter.editorManager.tableObj.tableVerticalAlign({
        item: { tableCell: tdElement, subCommand: 'AlignTop' },
      });
  ...
  describe('EJ2-56516 - Table cell merge with empty columns', () => {
    ...
    it('Merge two columns with content and one empty', (done: Function) => {
      ...
      setTimeout(function () {
        ...
        expect(
          (rteObj as any).inputElement.querySelector('table td').innerHTML
        ).toBe('test 2<br>test 3');
        done();
      }, 400);
    });
  });
 ...
 <tr height="19" style="height:14.5pt;">
  ...
  <td>c3</td>
    ...
    it(' Merge two rows with content and to verify empty row is removed from the dom', (done: Function) => {
      ...
      setTimeout(function () {
        ...
        expect(
          (rteObj as any).inputElement.querySelectorAll('table tr').length === 2
        ).toBe(true);
        done();
      }, 400);
    });
  ...
  describe('Table remove rows with cell merge', () => {
    ...
    it('Remove the row when the cells are merged', (done: Function) => {
      ...
      setTimeout(function () {
        ...
        expect(
          (rteObj as any).inputElement.querySelector('table tr')
            .childElementCount === 4
        ).toBe(true);
        done();
      }, 400);
  ...
  describe('Table cell merge', () => {
    ...
    it('Merge first two cell', (done: Function) => {
      ...
      setTimeout(function () {
        ...
        expect((rows[0].children[0] as HTMLElement).style.width).toEqual(
          '66.6666%'
        );
        expect((rows[0].children[1] as HTMLElement).style.width).toEqual(
          '33.3333%'
        );
        ...
        expect((rows[1].children[0] as HTMLElement).style.width).toEqual(
          '33.3333%'
        );
        expect((rows[1].children[0] as HTMLElement).style.width).toEqual(
          '33.3333%'
  ...
  describe('EJ2-56516 - Table cell merge with row of contents', () => {
    ...
    it('Merge three columns with content', (done: Function) => {
      ...
      setTimeout(function () {
        ...
        expect(
          (rteObj as any).inputElement.querySelector('table td').innerHTML
        ).toBe('test 1<br>test 2<br>test 3');
        done();
      }, 400);
    });
  });
  ...
  describe('877970 && 878643 - Table cell selection background color and resize helper restriction during the multiple cell selection', () => {
    ...
    it('Table cell selection background color and resize helper restriction during the multiple cell selection', (done: Function) => {
      ...
      setTimeout(function () {
        expect(
          document.querySelectorAll('.e-cell-select.e-multi-cells-select')
            .length > 1
        ).toBe(true);
        expect(
          document.querySelectorAll('.e-rte-table-resize').length === 0
        ).toBe(true);
        done();
      }, 400);
    });
    it('Table mouse move event with not td element', (done: Function) => {
      ...
      (rteObj as any).mouseUp(eventsArg);
      setTimeout(function () {
        expect(document.querySelectorAll('.e-cell-select').length === 1).toBe(
          true
        );
        done();
      }, 400);
  ...
  describe('Table cell horizontal split', () => {
    ...
    it('Split first cell', (done: Function) => {
      ...
      setTimeout(function () {
        ...
        expect(rows[0].children[0].classList.contains('e-cell-select')).toEqual(
          true
        );
        expect((rows[0].children[0] as HTMLElement).style.width).toEqual(
          '33.3333%'
  ...
  describe('Table cell vertical split', () => {
    ...
    it('Split first cell', (done: Function) => {
      ...
      setTimeout(function () {
        ...
        expect((rows[0].children[2] as HTMLElement).style.width).toEqual(
          '33.3333%'
        );
        expect((rows[0].children[3] as HTMLElement).style.width).toEqual(
          '33.3333%'
        );
        expect(rows[0].children[0].classList.contains('e-cell-select')).toEqual(
          true
  ...
  describe('872207 - Table cells are collapsed while apply the vertical split.', () => {
    ...
    it('Table cells are collapsed while apply the vertical split.', (done: Function) => {
      ...
      setTimeout(function () {
        ...
        expect(table.rows[1].children.length).toBe(3);
        expect(
          parseFloat((rows[0].children[0] as HTMLElement).style.width)
        ).toBeGreaterThan(30);
        expect(
          parseFloat((rows[0].children[1] as HTMLElement).style.width)
        ).toBeGreaterThan(30);
        expect(
          parseFloat((rows[0].children[2] as HTMLElement).style.width)
        ).toBeGreaterThan(30);
        expect(rows[0].children[0].classList.contains('e-cell-select')).toEqual(
          true
        );
  ...
  describe('Resizing elements are removed while mouse click in iframe document', () => {
    ...
    it('Resizing elements are removed while mouse click in iframe document', () => {
      let table: Element = rteObj.contentModule
        .getEditPanel()
  ...
  describe(' table row delete testing', () => {
    ...
    it(' delete row', (done) => {
      ...
      setTimeout(() => {
        ...
        (rows[2].querySelectorAll('td')[2] as HTMLElement).classList.add(
          'e-cell-select'
        );
        (
          document.querySelectorAll(
    ...
    it('- insert column when table column have different size -', (done) => {
      ...
      setTimeout(() => {
        ...
        (rows[0].querySelectorAll('td')[0] as HTMLElement).classList.add(
          'e-cell-select'
        );
        (
          document.querySelectorAll(
  ...
  describe('EJ2-49981 - ShowDialog, CloseDialog method testing', () => {
    ...
    it('beforeDialogOpen event trigger testing', (done) => {
      ...
      setTimeout(() => {
        expect(
          document.body.querySelectorAll('.e-rte-edit-table.e-dialog').length
        ).toBe(1);
  ...
  describe('Remove the table at initial render with text node type', () => {
    ...
    it('Remove the table at initial render with text node type', () => {
      ...
      domSelection.setSelectionText(
        rteObj.contentModule.getDocument(),
        tableCell.childNodes[0].childNodes[0],
        tableCell.childNodes[0].childNodes[0],
        0,
        0
      );
  ...
  describe('table resize', function () {
    ...
    it('Remove the table using the Quicktoolbar with the enter key DIV', function (done) {
      ...
      setTimeout(function () {
        var tablePop = document.querySelectorAll('.e-rte-quick-popup')[0];
        (
          tablePop.querySelectorAll(
            '.e-rte-quick-toolbar.e-rte-toolbar .e-toolbar-items .e-toolbar-item .e-tbar-btn'
          )[5] as HTMLElement
        ).click();
        setTimeout(() => {
          expect(
            rteObj.contentModule.getEditPanel().innerHTML === '<div><br></div>'
          ).toBe(true);
          done();
        }, 100);
      }, 100);
    ...
    it('Remove the table using the Quicktoolbar with the enter key DIV <BR>', function (done) {
      ...
      setTimeout(function () {
        ...
        setTimeout(() => {
          expect(rteObj.contentModule.getEditPanel().innerHTML === '<br>').toBe(
            true
          );
          done();
        }, 100);
  ...
  describe('836937 - Checking with the Mozilla Browser', function () {
    ...
    it('Table module selection on Mozilla', function (done) {
      rteObj.focusIn();
      var tbElement: any = rteObj.contentModule
        .getEditPanel()
      ...
      setTimeout(function () {
        expect(
          (rteObj.contentModule.getEditPanel() as any).contentEditable == 'true'
        ).toBe(true);
        done();
      }, 100);
    });
  ...
  describe('836937 - Improve coverage for the table module in the Rich Text Editor', () => {
    ...
    it('Nested table resize', () => {
      var table = rteObj.contentModule
        .getEditPanel()
        .querySelector('table table');
      var clickEvent = document.createEvent('MouseEvents');
      (<any>rteObj).tableModule.resizeHelper({
        target: table,
        preventDefault: function () {},
      });
      var reCol1 = rteObj.contentModule
        .getEditPanel()
        .querySelectorAll('.e-column-resize')[0];
      (<any>rteObj).tableModule.resizeStart({
        target: reCol1,
        pageX: 100,
        pageY: 0,
        preventDefault: function () {},
      ...
      (<any>rteObj).tableModule.resizing({
        target: reCol1,
        pageX: -10,
        pageY: -10,
        preventDefault: function () {},
  ...
  describe('When you press backspace while the focus is on the tbody, the table will be deleted from the Rich Text Editor', function () {
    ...
    beforeEach(function () {
      rteObj = renderRTE({
        ...
        value:
          '<p><b>Description:</b></p><p>The Rich Text Editor (RTE) control is an easy to render in\n                client side.</p><table class="e-rte-table" style="width: 100%;"><thead><tr><th class="e-cell-select"><br></th><th><br></th></tr></thead><tbody><tr><td style="width: 50%;" class=""><br></td><td style="width: 50%;"><br></td></tr><tr><td style="width: 50%;"><br></td><td style="width: 50%;"><br></td></tr></tbody></table>\n                ',
      });
    });
    afterEach(function () {
      destroy(rteObj);
    ...
    it('The focus is in the tbody, the table will be removed in the Rich Text Editor', function (done) {
      ...
      expect(rteObj.inputElement.querySelectorAll('table').length == 0).toBe(
        true
      );
      done();
    });
    ...
    it('The table style is removed through the Quick Toolbar', function (done) {
      ...
      setTimeout(function () {
        ...
        expect(
          !rteObj.inputElement
            .querySelector('table')
            .classList.contains('e-dashed-borders')
        ).toBe(true);
        done();
      }, 0);
    });
  ...
  describe('Nested list inside the table using the TAB key in the Rich Text Editor', function () {
    ...
    it('Nested list with block node inside the table using the TAB key', function (done) {
      ...
      var tdElement = rteObj.contentModule
        .getDocument()
        .getElementsByClassName('liElement');
      ...
      expect(
        rteObj.inputElement.querySelector('table tr td li ul') != null
      ).toBe(true);
      done();
    });
    it('Nested list inside the table using the TAB key', function (done) {
      ...
      (rteObj as any).keyUp(keyBoardEvent);
      expect(
        rteObj.inputElement.querySelector('table tr td li ol li') != null
      ).toBe(true);
      done();
    });
  ...
  describe('Checking the table insert without the br tag', function () {
    ...
    it('Checking the table insert without the br tag', function (done) {
      ...
      var event = {
        target: rteObj.tableModule.popupObj.element
          .querySelectorAll('.e-rte-table-row')[1]
          .querySelectorAll('.e-rte-tablecell')[1],
        preventDefault: function () {},
      };
      ...
      event.target.dispatchEvent(clickEvent);
      expect(
        rteObj.inputElement.querySelectorAll('p')[1].innerHTML == '<br>'
      ).toBe(true);
      done();
    });
  });
  ...
  describe('Table dialogClose event trigger testing', () => {
    ...
    it('dialogClose event trigger testing', (done) => {
      (
        rteObj.element.querySelector('.e-toolbar-item button') as HTMLElement
      ).click();
      (
        document.querySelector(
          '.e-rte-table-popup button.e-insert-table-btn'
        ) as HTMLElement
      ).click();
      setTimeout(() => {
  ...
  describe('876566 - The cursor focuses on the previous or next element when you press back space or delete.', function () {
    ...
    it('The cursor focuses on the next element when you press delete', function (done) {
      const element: HTMLElement = rteObj.contentModule
        .getDocument()
        .querySelector('.start');
      element.focus();
      var range = document.createRange();
      ...
      (<any>rteObj).tableModule.keyDown({ args: keyboardEventArgs });
      expect(
        (window.getSelection().anchorNode as HTMLElement).classList.contains(
          'e-table-fake-selection'
        )
      ).toBe(true);
      const fakeEle = rteObj.contentModule
        .getDocument()
        .querySelector('.e-table-fake-selection');
      fakeEle.remove();
      const tableEle = rteObj.contentModule
        .getDocument()
  ...
  describe('Add the custom class in the table dialog through the cssClass property.', () => {
    ...
    it('Add the custom class in the table dialog through the cssClass property', (done) => {
      ...
      setTimeout(() => {
        expect(
          document.querySelector('.e-rte-table-popup.rich_Text_Editor') != null
        ).toBe(true);
        done();
      }, 100);
    });
  ...
  describe('A custom class added the button element for the table dialog', function () {
    ...
    it('A custom class added the button element for the table dialog', function (done) {
      ...
      setTimeout(function () {
        expect(
          document
            .querySelector('.e-rte-edit-table .e-footer-content button')
            .classList.contains('rich_Text_Editor')
        ).toBe(true);
        done();
      }, 100);
    });
  ...
  describe('When you open the table dialog, you need to close the existing one', function () {
    ...
    it('When you open the table dialog, you need to close the existing one', function (done) {
      ...
      setTimeout(function () {
        (rteObj as any).tableModule.insertTableDialog({
          target: document.querySelector('.e-rte-edit-table'),
          pageX: 100,
          pageY: 0,
          preventDefault: function () {},
        });
  ...
  describe('Cursor with empty text in the table when pressing the upper arrow', function () {
    ...
    it('Cursor with empty text in the table when pressing the upper arrow', function (done) {
      var tdElement =
        rteObj.inputElement.querySelector('table tbody td').childNodes[3];
      var selectioncursor = new NodeSelection();
      var range = document.createRange();
      range.setStart(tdElement, 0);
      selectioncursor.setRange(document, range);
  ...
  describe('Background colour applied for the selected table td element', function () {
    ...
    beforeEach(function () {
      rteObj = renderRTE({
        ...
        value:
          '<table class="e-rte-table e-dashed-borders" style="width: 100%; min-width: 0px;"><tbody><tr><td class="tdElement" style="width: 25%;"><br></td><td style="width: 25%;" class=""><br></td><td style="width: 25%;"><br></td><td style="width: 25%;"><br></td></tr><tr><td style="width: 25%;" class="e-cell-select"><br></td><td style="width: 25%;" class=""><br></td><td style="width: 25%;"><br></td><td style="width: 25%;"><br></td></tr><tr><td style="width: 25%;"><br></td><td style="width: 25%;"><br></td><td style="width: 25%;"><br></td><td style="width: 25%;"><br></td></tr></tbody></table>',
      });
    });
    afterEach(function () {
      destroy(rteObj);
  ...
  describe('Table dialog popup position', function () {
    ...
    it('Table dialog popup position', function (done) {
      ...
      var eventsArg = {
        ...
        which: 1,
        touches: { length: 0 },
        changedTouches: [{ pageX: 0, pageY: 0, clientX: 0 }],
      };
      (rteObj as any).mouseDownHandler(eventsArg);
      (rteObj as any).mouseUp(eventsArg);
      expect(
        !isNullOrUndefined(document.querySelector('.e-rte-quick-toolbar'))
      ).toBe(true);
      Browser.userAgent = currentBrowserUA;
      done();
    });
  ...
  describe('Remove the table helper element when selecting the table', function () {
    ...
    it('Remove the table helper element when selecting the table', function (done) {
      ...
      range.setStart(tdElement, 0);
      selectioncursor.setRange(document, range);
      var tableElement = rteObj.contentModule
        .getEditPanel()
        .querySelector('table');
      var eventsArg = { pageX: 50, pageY: 300, target: tdElement, which: 1 };
      (rteObj as any).tableModule.resizeHelper({
        target: tableElement,
        preventDefault: function () {},
      });
      var resizeCol = rteObj.contentModule
        .getEditPanel()
        .querySelectorAll('.e-column-resize')[0];
      (rteObj as any).tableModule.resizeStart({
        target: resizeCol,
        pageX: 100,
        pageY: 0,
        preventDefault: function () {},
      ...
      (rteObj as any).mouseDownHandler(eventsArg);
      expect(
        document.querySelectorAll('.e-table-rhelper.e-column-helper').length < 2
      ).toBe(true);
      done();
    });
  });
  ...
  describe('Add table element padding', function () {
    ...
    it('Add table element padding', function (done) {
      ...
      (
        document.querySelector(
          '.e-rte-quick-toolbar .e-toolbar-item button'
        ) as any
      ).click();
      setTimeout(function () {
        (
          document.querySelector(
            '.e-rte-edit-table .e-footer-content button'
          ) as any
        ).click();
        expect(
          (document.querySelector('table td') as any).style.padding == '2px'
        ).toBe(true);
        done();
      }, 500);
    });
  ...
  describe('The dialog popup is closed when set to beforeClose args.cancel to true', function () {
    ...
    it('The dialog popup is closed when set to beforeClose args.cancel to true', function (done) {
      ...
      (
        document.querySelector(
          '.e-rte-toolbar .e-toolbar-items .e-toolbar-item button'
        ) as any
      ).click();
      (
        document.querySelector(
      ...
      setTimeout(function () {
        document
          .querySelector('.e-rte-edit-table.e-dialog.e-rte-elements.e-popup')
        ...
        (
          document.querySelector(
            '.e-rte-edit-table .e-footer-content .e-rte-elements.e-cancel'
          ) as any
        ).click();
        expect(
          document
  ...
  describe('When the enter key action is DIV, the inserted table next to it is a div element.', function () {
    ...
    it('When the enter key action is DIV, the inserted table next to it is a div element.', function (done) {
      ...
      setTimeout(function () {
        (
          document.querySelector(
            '.e-rte-edit-table .e-footer-content .e-rte-elements.e-insert-table'
          ) as any
        ).click();
        expect(
          document.querySelector('.e-content table').nextSibling != null
        ).toBe(true);
        done();
      }, 100);
    });
  ...
  describe('An empty LI tag was removed while inserting the table', function () {
    ...
    it('An empty LI tag was removed while inserting the table', function (done) {
      ...
      setTimeout(function () {
        ...
        expect(
          rteObj.inputElement.querySelectorAll('li *:empty:not(img)').length ==
            4
        ).toBe(true);
        done();
      }, 100);
  ...
  describe("When you set the table width ('300') as a string, it's converted to the PX.", function () {
    ...
    it("When you set the table width ('300') as a string, it's converted to the PX.", function (done) {
      ...
      setTimeout(function () {
        ...
        expect(
          rteObj.inputElement.querySelector('table').style.width == '300px'
        ).toBe(true);
        done();
      }, 100);
    });
  ...
  describe('Table last column resizing is not working when table is pasted from MS Word.', () => {
    ...
    it('resizing last column in a table which has no width', () => {
      ...
      let reCol: any = rteObj.contentModule
        .getEditPanel()
        .querySelectorAll('.e-column-resize')[3];
      ...
      let width: any = table
        .querySelectorAll('tr')[0]
        .querySelectorAll('td')[2].offsetWidth;
      (rteObj.tableModule as any).resizing({
        target: reCol1,
        pageX: 200,
        pageY: 200,
  ...
  describe('850000 - In iframe mode table popup doesnot close properly', () => {
    ...
    it('Should close the Create table popup on the edit area click', () => {
      ...
      expect(
        rteObj.element
          .querySelector('.e-rte-table-popup')
  ...
  describe('850230 - CTRL + SHIFT + E Does not insert the table at the current cursor position ', () => {
    ...
    it('Check that the inserted table is in the current cursor position.', () => {
      ...
      let clickEvent: MouseEvent = document.createEvent('MouseEvents');
      let target = rteObj.tableModule.editdlgObj.element.querySelector(
        '.e-insert-table'
      ) as HTMLElement;
      clickEvent = document.createEvent('MouseEvents');
      clickEvent.initEvent('click', false, true);
      target.dispatchEvent(clickEvent);
      let focusNode: Element = (rteObj as any).inputElement.querySelector(
        '.focusNode'
  ...
  describe('850079 - Link and table Quick toolbar has open while .Paste the bolded link inside the table ', () => {
    ...
    it('Check the number of quick toolbar open', () => {
      ...
      (rteObj as any).mouseDownHandler(eventsArg);
      (rteObj as any).mouseUp(eventsArg);
      expect(document.querySelectorAll('.e-rte-quick-popup').length == 1).toBe(
        true
      );
    });
  });
  ...
  describe('Table coverage case with inline mode', () => {
    ...
    it('Table coverage case with inline mode', (done) => {
      ...
      (
        document.querySelector(
          '#' + rteObj.element.id + '_quick_TableEditProperties'
        ) as HTMLElement
      ).click();
      done();
    });
  ...
  describe('860995 - The List items get removed when inserting a table inside the list..', () => {
    ...
    it('Should not remove the list items when inserting a table inside the list.', (done: DoneFn) => {
      editor.focusIn();
      setCursorPoint(
        editor.element.querySelector('li').firstChild as Element,
        1
      );
      ...
      const insertButton: HTMLElement = document.querySelector(
        '.e-insert-table-btn'
      );
      insertButton.click();
      setTimeout(() => {
        expect(editor.inputElement.querySelectorAll('li').length).toBe(
          listCount
        );
        done();
      }, 200);
  ...
  describe('873562 - When the cursor is at the end of the List item Inserted table has an additional list item.', () => {
    ...
    it('Should not add an additional list item when inserting a table at the end of the list item.', (done: DoneFn) => {
      ...
      range.setStart(
        editor.inputElement.querySelector('li').childNodes[1].firstChild,
        editor.inputElement.querySelector('li').childNodes[1].firstChild
          .textContent.length
      );
      range.collapse(true);
      document.getSelection().removeAllRanges();
      document.getSelection().addRange(range);
      const tableBtn = editor.element.querySelectorAll(
        '.e-toolbar-item button'
      )[0];
      ...
      setTimeout(() => {
        expect(
          editor.inputElement
            .querySelector('li')
            .childNodes[1].childNodes[1].nodeName.toLowerCase()
        ).toBe('table');
        expect(editor.inputElement.querySelectorAll('li').length).toBe(5);
        done();
      }, 200);
  ...
  describe('837479 - Redo doesn’t works properly in table', () => {
    ...
    it('Redo doesn’t works properly in table', () => {
      ...
      (<any>rteObj).formatter.editorManager.undoRedoManager.keyDown({
        event: keyboardEventArgs,
      });
      let tableAfterUndo: HTMLElement = rteObj.contentModule
        .getEditPanel()
        .querySelector('table') as HTMLElement;
  ...
  describe('837483 - Cells gets deleted after merged with header.', function () {
    ...
    beforeEach(function () {
      rteObj = renderRTE({
        ...
        value:
          '<table class="e-rte-table tdElement" style="width: 100%; min-width: 0px;"><thead><tr><th class="e-cell-select"><br></th></tr></thead><tbody><tr><td class="e-cell-select tdEle" style="width: 100%;"><br></td></tr></tbody></table>',
      });
    });
    afterEach(function () {
      destroy(rteObj);
    ...
    it('Cells gets deleted after merged with header', function (done) {
      ...
      setTimeout(function () {
        ...
        expect(
          document
            .querySelector('#' + rteObj.element.id + '_quick_TableCell-popup')
  ...
  describe('876830 - The table header was moved while press enter key in RTE', () => {
    ...
    beforeAll(() => {
      rteObj = renderRTE({
        ...
        value:
          '<table class="e-rte-table" style="width: 100%; min-width: 0px;"><thead><tr><th class="e-cell-select"><br></th><th class="e-cell-select"><br></th></tr></thead><tbody><tr><td class="e-cell-select" style="width: 50%;"><br></td><td style="width: 50%;" class="e-cell-select"><br></td></tr></tbody></table>',
      });
      rteEle = rteObj.element;
    });
    afterAll(() => {
    ...
    it('The table header was moved while press enter key in RTE', () => {
      ...
      expect(
        table.querySelectorAll('table tr')[0].firstChild.nodeName !== 'P'
      ).toBe(true);
    });
  });
    ...
    it('press back space ', (done: DoneFn) => {
      ...
      setTimeout(() => {
        expect(rteObj.value).toBe(
          '<h1>Welcome to the Syncfusion Rich Text Editor</h1><p>The Rich Text Editor, a WYSIWYG (what you see is what you get) editor, is a user interface that allows you to create, edit, and format rich text content. You can try out a demo of this editor here.</p><h2>Do you know the key features of the editor?</h2>'
        );
        done();
      }, 100);
    });
  ...
  describe('904465 - Cell is not properly visible and cursor is not at correct position in cell after merging the all the cells in single row', () => {
    ...
    it('Merge two columns in single row', (done: Function) => {
      let target = rteEle.querySelector('.e-rte-table td');
      let eventsArg = { pageX: 50, pageY: 300, target: target, which: 1 };
      let height: any = (rteObj as any).inputElement.querySelector(
        'table td'
      ).offsetHeight;
      (rteObj as any).mouseDownHandler(eventsArg);
      let ev = new MouseEvent('mousemove', {
      ...
      setTimeout(function () {
        ...
        expect(
          (rteObj as any).inputElement.querySelector('table td').offsetHeight
        ).toBe(22);
        expect(height + 2).toEqual(
          (rteObj as any).inputElement.querySelector('table td').offsetHeight
        );
        done();
      }, 400);
