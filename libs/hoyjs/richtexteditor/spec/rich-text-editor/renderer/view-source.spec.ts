 ...
 * View source spec
 */
import { Browser, L10n } from '@hoyui/base';
...
describe('Toolbar - view html', () => {
  describe('div content source code', () => {
    ...
    it('open view html', () => {
      ...
      trgEle.click();
      expect(
        (<any>rteObj).element.querySelector('.e-rte-srctextarea')
      ).not.toBe(null);
      expect(
        (<any>rteObj).element.querySelector('.e-rte-srctextarea').value ===
          '<p>data</p>'
      ).toBe(true);
  ...
  describe('EJ2-67309 - Source Code and preview toolbar icon localization text are not shown properly when you hover the icons', () => {
    ...
    it('check tooltiptext update with locale value', () => {
      rteObj.focusIn();
      let sourceCode: HTMLElement = <HTMLElement>(
  ...
  describe('RTE iframe source code', () => {
    ...
    it('iframe open view html', () => {
      ...
      rteObj.contentModule.getEditPanel().innerHTML = '<p>data</p>';
      let trgEle: HTMLElement = <HTMLElement>(
        elem.querySelectorAll('.e-toolbar-item')[0]
      );
  ...
  describe('Value null with textarea value testing', () => {
    ...
    it('DIV', () => {
      ...
      (
        (<any>rteObj).element.querySelector(
          '.e-rte-srctextarea'
        ) as HTMLTextAreaElement
      ).value = '<p>datamanager</p>';
      expect(
        (<any>rteObj).element.querySelector('.e-rte-srctextarea').value ===
          '<p>datamanager</p>'
      ).toBe(true);
      trgEle = <HTMLElement>rteEle.querySelectorAll('.e-toolbar-item')[0];
      trgEle.click();
      expect(rteObj.contentModule.getEditPanel().innerHTML).toBe(
        '<p>datamanager</p>'
      );
  ...
  describe(' SourceCode item changes - ', () => {
    ...
    it(' Test - Click the SourceCode item and click the Preview item', () => {
      ...
      item = rteObj.element.querySelector('#' + controlId + '_toolbar_Preview');
      item.click();
      expect((rteObj as any).inputElement.innerHTML === '<p><br></p>').toBe(
        true
      );
    });
  });
  ...
  describe('EJ2-62919 - Checking the table class is added in the preview mode to code view', () => {
    ...
    it('Test - Checking the table class is added in the preview to code view', () => {
      ...
      rteObj.contentModule.getEditPanel().innerHTML =
        '<table><tbody><tr><td><p>Provide the tool bar support, its also customizable.</p></td></tr></tbody></table>';
      let trgEle: HTMLElement = <HTMLElement>(
        rteEle.querySelectorAll('.e-toolbar-item')[0]
      );
      trgEle.click();
      ...
      expect(
        (<any>rteObj).value ===
          '&lt;table class="e-rte-table"&gt;&lt;tbody&gt;&lt;tr&gt;&lt;td&gt;&lt;p&gt;Provide the tool bar support, its also customizable.&lt;/p&gt;&lt;/td&gt;&lt;/tr&gt;&lt;/tbody&gt;&lt;/table&gt;'
      ).toBe(true);
      expect(
        (<any>rteObj).getHtml() ===
          '&lt;table class="e-rte-table"&gt;&lt;tbody&gt;&lt;tr&gt;&lt;td&gt;&lt;p&gt;Provide the tool bar support, its also customizable.&lt;/p&gt;&lt;/td&gt;&lt;/tr&gt;&lt;/tbody&gt;&lt;/table&gt;'
