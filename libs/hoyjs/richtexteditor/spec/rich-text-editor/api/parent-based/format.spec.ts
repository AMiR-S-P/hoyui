...
describe('RTE PARENT BASED - formats - ', () => {
  ...
  describe(' PROPERTIES - ', () => {
    describe(' toolbarSettings property - ', () => {
      ...
      it(' Test - apply the "Code" format to selected node', () => {
        ...
        dispatchEvent(
          popup.querySelectorAll('.e-item')[1] as HTMLElement,
          'mousedown'
        );
      ...
      it(' Test - apply the "Quotation" format to selected node', () => {
        ...
        dispatchEvent(
          popup.querySelectorAll('.e-item')[2] as HTMLElement,
          'mousedown'
        );
        (popup.querySelectorAll('.e-item')[2] as HTMLElement).click();
        let tag: HTMLElement = rteObj.element.querySelector('#rte');
        expect(tag.parentElement.parentElement.tagName === 'BLOCKQUOTE').toBe(
          true
        );
      });
      ...
      it(' Test - apply the "H2" format to selected node', () => {
        ...
        dispatchEvent(
          popup.querySelectorAll('.e-item')[4] as HTMLElement,
          'mousedown'
        );
      ...
      it(' Test - apply the "H3" format to selected node', () => {
        ...
        dispatchEvent(
          popup.querySelectorAll('.e-item')[5] as HTMLElement,
          'mousedown'
        );
      ...
      it(' Test - apply the "H4" format to selected node', () => {
        ...
        dispatchEvent(
          popup.querySelectorAll('.e-item')[6] as HTMLElement,
          'mousedown'
        );
      ...
      it(' Test - apply the "P" format to selected node', (done) => {
        ...
        setTimeout(() => {
          let item: HTMLElement = document.getElementById(
            controlId + '_quick_Formats'
          );
          item.click();
          let popup: HTMLElement = document.getElementById(
            controlId + '_quick_Formats-popup'
          );
          dispatchEvent(
            popup.querySelectorAll('.e-item')[0] as HTMLElement,
            'mousedown'
  ...
  describe(' public methods - ', () => {
    describe(' getHtml and getText method - ', () => {
      ...
      it(' Test - apply the "P" format to selected node', () => {
        ...
        expect(rteObj.getHtml() === '<p><span id="rte">RTE</span></p>').toBe(
          true
        );
      ...
      it(' Test - apply the "Code" format to selected node', () => {
        ...
        dispatchEvent((rteObj as any).inputElement, 'focusout');
        expect(
          rteObj.getHtml() === '<pre><span id="rte">RTE</span></pre>'
        ).toBe(true);
        expect(rteObj.getText() === 'RTE').toBe(true);
      });
      ...
      it(' Test - apply the "Quotation" format to selected node', () => {
        ...
        expect(
          rteObj.getHtml() ===
            '<blockquote><p><span id="rte">RTE</span></p></blockquote>'
        ).toBe(true);
        expect(rteObj.getText() === 'RTE').toBe(true);
      });
      it(' Test - apply the "H1" format to selected node', () => {
        ...
        dispatchEvent(document.body, 'mousedown');
        dispatchEvent((rteObj as any).inputElement, 'focusout');
        expect(rteObj.getHtml() === '<h1><span id="rte">RTE</span></h1>').toBe(
          true
        );
        expect(rteObj.getText() === 'RTE').toBe(true);
      });
      it(' Test - apply the "H2" format to selected node', () => {
        ...
        dispatchEvent(document.body, 'mousedown');
        dispatchEvent((rteObj as any).inputElement, 'focusout');
        expect(rteObj.getHtml() === '<h2><span id="rte">RTE</span></h2>').toBe(
          true
        );
        expect(rteObj.getText() === 'RTE').toBe(true);
      });
      it(' Test - apply the "H3" format to selected node', () => {
        ...
        dispatchEvent(document.body, 'mousedown');
        dispatchEvent((rteObj as any).inputElement, 'focusout');
        expect(rteObj.getHtml() === '<h3><span id="rte">RTE</span></h3>').toBe(
          true
        );
        expect(rteObj.getText() === 'RTE').toBe(true);
      });
      it(' Test - apply the "H4" format to selected node', () => {
        ...
        dispatchEvent(document.body, 'mousedown');
        dispatchEvent((rteObj as any).inputElement, 'focusout');
        expect(rteObj.getHtml() === '<h4><span id="rte">RTE</span></h4>').toBe(
          true
        );
        expect(rteObj.getText() === 'RTE').toBe(true);
      });
    ...
    describe(' showSourceCode method - ', () => {
      ...
      it(' Test - apply the "P" format to selected node', () => {
        ...
        expect(textArea.value === '<p><span id="rte">RTE</span></p>').toBe(
          true
        );
      });
      ...
      it(' Test - apply the "Code" format to selected node', () => {
        ...
        let textArea: HTMLTextAreaElement =
          rteObj.element.querySelector('.e-rte-srctextarea');
        expect(textArea.value === '<pre><span id="rte">RTE</span></pre>').toBe(
          true
        );
      });
      ...
      it(' Test - apply the "H1" format to selected node', () => {
        ...
        let textArea: HTMLTextAreaElement =
          rteObj.element.querySelector('.e-rte-srctextarea');
        expect(textArea.value === '<h1><span id="rte">RTE</span></h1>').toBe(
          true
        );
      });
      ...
      it(' Test - apply the "H2" format to selected node', () => {
        ...
        let textArea: HTMLTextAreaElement =
          rteObj.element.querySelector('.e-rte-srctextarea');
        expect(textArea.value === '<h2><span id="rte">RTE</span></h2>').toBe(
          true
        );
      });
      ...
      it(' Test - apply the "H3" format to selected node', () => {
        ...
        let textArea: HTMLTextAreaElement =
          rteObj.element.querySelector('.e-rte-srctextarea');
        expect(textArea.value === '<h3><span id="rte">RTE</span></h3>').toBe(
          true
        );
      });
      ...
      it(' Test - apply the "H4" format to selected node', () => {
        ...
        let textArea: HTMLTextAreaElement =
          rteObj.element.querySelector('.e-rte-srctextarea');
        expect(textArea.value === '<h4><span id="rte">RTE</span></h4>').toBe(
          true
        );
      });
    });
    ...
    describe(' destroy method - ', () => {
      ...
      it(' Test the formats dropdown element after destroy the component ', () => {
        rteObj.destroy();
        let popupEle: HTMLElement = document.getElementById(
          controlId + '_toolbar_Formats-popup'
        );
  ...
  describe('851566 - Heading backspace not working in the Rich Text Editor Smart suggestions sample', () => {
    ...
    it('Should insert <h1><br></h1> instead of <h1>&#65279;&#65279;<br></h1> when a format is selected with the dropdown button', () => {
      ...
      let popup: HTMLElement = document.getElementById(
        rteObj.element.id + '_toolbar_Formats-popup'
      );
      dispatchEvent(
        popup.querySelectorAll('.e-item')[2] as HTMLElement,
        'mousedown'
  ...
  describe('Apply Format to a Block node surrounded by a Paragraph on top and bottom', () => {
    ...
    it('Should insert <h1><br></h1> instead of <h1>&#65279;&#65279;<br></h1> when a format is selected with the dropdown button', () => {
      ...
      rteObj.formatter.editorManager.nodeSelection.setSelectionText(
        document,
        rteObj.element.querySelector('.target'),
        rteObj.element.querySelector('.target'),
        0,
        0
      );
