...
describe('RTE BASIC PROPERTIES - enableHtmlEncode - ', () => {
  ...
  describe(' PUBLIC METHODS - ', () => {
    describe(' refresh  - ', () => {
      ...
      it(' Test the value maintain with encoded after refreshed the component ', () => {
        ...
        rteObj.dataBind();
        rteObj.refresh();
        expect(rteObj.value === '&lt;p id="encode"&gt;Encode&lt;/p&gt;').toBe(
          true
        );
      });
    });
  ...
  describe(' PROPERTIES - ', () => {
    describe(' Encoded value at initial render - ', () => {
      ...
      it(' Test with getHtml public method ', () => {
        expect(
          rteObj.getHtml() === '&lt;p id="encode"&gt;Encode&lt;/p&gt;'
        ).toBe(true);
      });
      ...
      it(' Test sourceCode textarea value ', () => {
        let sourceBtn: HTMLElement = rteObj.element.querySelector(
          '#' + controlID + '_toolbar_SourceCode'
        );
        sourceBtn.click();
        let sourceCode: HTMLTextAreaElement =
          rteObj.element.querySelector('.e-rte-srctextarea');
        expect(
          sourceCode.value === '&lt;p id="encode"&gt;Encode&lt;/p&gt;'
        ).toBe(true);
      });
    });
  ...
  describe(' onPropertyChange  - ', () => {
    ...
    it(' Test with getHtml public method ', () => {
      expect(rteObj.getHtml() === '&lt;p id="encode"&gt;Encode&lt;/p&gt;').toBe(
        true
      );
    });
    ...
    it(' Test sourceCode textarea value ', () => {
      ...
      let sourceCode: HTMLTextAreaElement =
        rteObj.element.querySelector('.e-rte-srctextarea');
      expect(sourceCode.value === '&lt;p id="encode"&gt;Encode&lt;/p&gt;').toBe(
        true
      );
    });
  });
