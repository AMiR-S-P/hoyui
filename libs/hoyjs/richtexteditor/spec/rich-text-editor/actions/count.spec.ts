...
describe('Count module', () => {
  ...
  describe('showCharCount property and maxLenth visibility testing', () => {
    ...
    it('Initial rendering', () => {
      ...
      expect(
        rteObj.element.querySelectorAll('.e-rte-character-count').length === 1
      ).toBe(true);
    });
  });
  ...
  describe('Character count with showCharCount as true', () => {
    ...
    it('default character count with data bind', () => {
      ...
      rteObj.dataBind();
      expect(
        rteObj.element.querySelectorAll('.e-rte-character-count').length === 0
      ).toBe(true);
    });
    it('default character count with data bind', () => {
  ...
  describe('Character count with showCharCount as true and enabling maxLength', () => {
    ...
    it('default character count with background', () => {
      rteObj.contentModule.getEditPanel().innerHTML =
        '<p><b>Description:</b></p> <p>The Rich Text Editor (RTE) control is an easy to render in client side. Customer easy to edit the contents and get the HTML content for the displayed. </p>';
      (<any>rteObj).countModule.refresh();
      let charLen: string = (
        rteObj.element.querySelectorAll(
          '.e-rte-character-count'
      ...
      expect(
        rteObj.element
          .querySelectorAll('.e-rte-character-count')[0]
          .classList.contains('e-warning')
      ).toBe(false);
      expect(
        rteObj.element
          .querySelectorAll('.e-rte-character-count')[0]
    ...
    it('Warning character count with background', () => {
      rteObj.contentModule.getEditPanel().innerHTML =
        '<p>The Rich Text Editor component is a WYSIWYG editor that provides the best user experience to create and update the content. Users can format their content using toolbar command</p>';
      (<any>rteObj).countModule.refresh();
      expect(
        rteObj.element
          .querySelectorAll('.e-rte-character-count')[0]
    ...
    it('error character count with background', () => {
      rteObj.contentModule.getEditPanel().innerHTML =
        '<p><b>Description:</b></p> <p>The Rich Text Editor (RTE) control is an easy to render in client side. Customer easy to edit the contents and get the HTML content for the displayed content. Warning class. </p>';
      (<any>rteObj).countModule.refresh();
      expect(
        rteObj.element
          .querySelectorAll('.e-rte-character-count')[0]
    ...
    it('error character count with background', () => {
      ...
      expect((<any>rteObj.countModule).element.style.display === 'none').toBe(
        true
      );
      (<any>rteObj.countModule).toggle({ member: 'updateSource' });
      expect((<any>rteObj.countModule).element.style.display === 'block').toBe(
        true
      );
    });
    it('keyboard restriction testing', () => {
      ...
      rteObj.contentModule.getEditPanel().innerHTML =
        '<p><b>Description:</b></p><p>The Rich Text Editor (RTE) control is an easy to render in client side. Customer easy to edit the contents and get the HTML content for the displayed content.It renders the content the abc</p>';
      (<any>rteObj).countModule.refresh();
      expect(
        (rteObj.contentModule.getEditPanel() as HTMLElement).textContent.trim()
          .length
      ).toBe(200);
    ...
    it('maximum length exceeded', () => {
      rteObj.contentModule.getEditPanel().innerHTML =
        '<p><b>Description:</b></p><p>The Rich Text Editor (RTE) control is an easy to render in client side. Customer easy to edit the contents and get the HTML content for the displayed content.It renders the content in the panel.abc </p>';
      (<any>rteObj).countModule.refresh();
      expect(
        (rteObj.contentModule.getEditPanel() as HTMLElement).textContent.length
      ).toBe(210);
    });
    ...
    it(' EJ2-17460 - change the maxLength value dynamically', () => {
      ...
      expect(
        rteObj.element
          .querySelector('.e-rte-character-count')
          .innerHTML.split('/ ')[1] === '500'
      ).toBe(true);
    });
  });
  ...
  describe('Character count restiction testing in Markdown ', () => {
    ...
    beforeAll(() => {
      rteObj = renderRTE({
        ...
        maxLength: 100,
        value:
          'The sample is added to showcase **markdown editing**. The sample is added to showcase markdown edit.',
      });
    });
    afterAll(() => {
      destroy(rteObj);
  ...
  describe('EJ2-51592-Character count testing when bold, italic, underline format applied for -', () => {
    ...
    it('character value with bold enabled', () => {
      rteObj.contentModule.getEditPanel().innerHTML =
        '<p><strong>&ZeroWidthSpace;Test</strong></p>';
      (<any>rteObj).countModule.refresh();
      let charLen: string = (
        rteObj.element.querySelectorAll(
          '.e-rte-character-count'
