...
describe("'FontColor and BackgroundColor' - ColorPicker render testing", () => {
  ...
  it(' fontColor DropDown button target element as span', () => {
    let item: HTMLElement = rteEle.querySelector(
      '#' + rteEle.id + '_toolbar_FontColor'
    );
...
describe(' RTE content selection with ', () => {
  ...
  it('ColorPicker - Font selection', () => {
    ...
    (
      document.querySelector('.e-control.e-colorpicker') as any
    ).ej2_instances[0].showButtons = true;
    (
      document.querySelector('.e-control.e-colorpicker') as any
    ).ej2_instances[0].dataBind();
    let fontColorPickerItem: HTMLElement = <HTMLElement>(
    ...
    (
      rteObj.toolbarModule as any
    ).colorPickerModule.fontColorPicker.btnClickHandler(mouseEventArgs);
    selectNode = editNode.querySelector('.first-p-node');
    expect(
      (selectNode.childNodes[0] as HTMLElement).style.color ===
        'rgb(28, 188, 81)'
    );
  });
  afterAll(() => {
...
describe(' RTE content selection with ', () => {
  ...
  it('ColorPicker - Background selection', () => {
    ...
    let backgroundColorPicker: HTMLElement = <HTMLElement>(
      rteEle.querySelectorAll('.e-toolbar-item .e-dropdown-btn')[1]
    );
    backgroundColorPicker.click();
    (
      document.querySelectorAll('.e-control.e-colorpicker')[1] as any
    ).ej2_instances[0].showButtons = true;
    (
      document.querySelectorAll('.e-control.e-colorpicker')[1] as any
    ).ej2_instances[0].dataBind();
    let backgroundColorPickerItem: HTMLElement = <HTMLElement>(
      document.querySelectorAll('.e-primary.e-apply')[0]
    );
    mouseEventArgs = {
    ...
    (
      rteObj.toolbarModule as any
    ).colorPickerModule.backgroundColorPicker.btnClickHandler(mouseEventArgs);
    selectNode = editNode.querySelector('.first-p-node');
    expect(
      (selectNode.childNodes[0] as HTMLElement).style.backgroundColor ===
        'rgb(255, 255, 0)'
    );
    backgroundColorPicker.click();
  });
...
describe(' Readonly ', () => {
  ...
  it('font color -selection', () => {
    rteObj.notify('selection-save', {});
    let backgroundColorPicker: HTMLElement = <HTMLElement>(
      rteEle.querySelectorAll('.e-toolbar-item .e-dropdown-btn')[2]
    );
    backgroundColorPicker.click();
    expect((backgroundColorPicker as HTMLElement).style.background === '');
  });
...
describe("'FontColor and BackgroundColor' - ColorPicker DROPDOWN", () => {
  ...
  it('Color Picker initial rendering testing - 1', (done) => {
    ...
    rteObj.notify('selection-save', {});
    let backgroundColorPicker: HTMLElement = <HTMLElement>(
      rteEle.querySelector('.e-rte-backgroundcolor-dropdown')
    );
    backgroundColorPicker.click();
    (
      document.querySelector('.e-control.e-colorpicker') as any
    ...
    dispatchEvent(
      document.querySelectorAll(
        '.e-control-wrapper.e-numeric.e-float-input.e-input-group'
      )[7].firstElementChild,
      'focusin'
    );
    (
    ...
    setTimeout(() => {
      let backgroundColorPickerItem: HTMLElement = <HTMLElement>(
        document.querySelectorAll('.e-primary.e-apply')[1]
      );
      mouseEventArgs = {
        target: backgroundColorPickerItem,
      };
      ...
      expect(selectNode.childNodes[0].nodeName.toLocaleLowerCase()).toBe(
        'span'
      );
      expect(
        (selectNode.childNodes[0] as HTMLElement).getAttribute('style')
      ).toBe('background-color: rgba(255, 255, 0, 0.5);');
      done();
    }, 200);
  });
  ...
  it('Color Picker initial rendering testing', () => {
    ...
    let backgroundColorPicker: HTMLElement = <HTMLElement>(
      rteEle.querySelectorAll(
        '.e-toolbar-item .e-dropdown-btn .e-icons.e-icon-right'
      )[1]
    );
    backgroundColorPicker.click();
    (
    ...
    (
      document
        .querySelector('.e-rte-backgroundcolor-colorpicker')
        .querySelector('.e-cancel') as HTMLElement
    ).click();
  ...
  it('Color Picker initial rendering testing - 1', () => {
    ...
    backgroundColorPicker.click();
    (
      backgroundColorPicker.querySelector('.e-background-color') as HTMLElement
    ).click();
  ...
  it('Color Picker initial rendering testing - 2', () => {
    ...
    rteObj.notify('selection-save', {});
    let backgroundColorPicker: HTMLElement = <HTMLElement>(
      rteEle.querySelector('.e-background-color.e-rte-elements')
    );
...
describe("EJ2-16252: 'FontColor and BackgroundColor' - selection state", () => {
  ...
  it(' Test the default value selection in FontColor popup', () => {
    ...
    fontColorPicker.click();
    let colorPickerPopup: HTMLElement = document.getElementById(
      id + '_toolbar_FontColor-popup'
    );
    let selectPalette: HTMLElement =
      colorPickerPopup.querySelector('.e-selected');
    expect(selectPalette).not.toBeNull();
    expect(
      selectPalette.style.backgroundColor === 'rgb(255, 0, 0)'
    ).not.toBeNull();
  });
  it(' Test the default value selection in BackgroundColor popup', () => {
    ...
    fontColorPicker.click();
    let colorPickerPopup: HTMLElement = document.getElementById(
      id + '_toolbar_BackgroundColor-popup'
    );
    let selectPalette: HTMLElement =
      colorPickerPopup.querySelector('.e-selected');
    expect(selectPalette).not.toBeNull();
    expect(
      selectPalette.style.backgroundColor === 'rgb(255, 255, 0)'
    ).not.toBeNull();
  });
});
...
describe("EJ2-16252: 'FontColor and BackgroundColor' - Default value set", () => {
  ...
  it(' Test the default value selection in FontColor popup', () => {
    ...
    expect(selectPalette).not.toBeNull();
    expect(
      selectPalette.style.backgroundColor === 'rgb(130, 59, 11)'
    ).not.toBeNull();
  });
  ...
  it(' Test the default value selection in BackgroundColor popup', () => {
    ...
    expect(selectPalette).not.toBeNull();
    expect(
      selectPalette.style.backgroundColor === 'rgb(0, 102, 102)'
    ).not.toBeNull();
  });
  ...
  describe('854808 - Not able to open the Font and Background popup while pressing enter key ', () => {
    ...
    it('The font dropdown is open when you click the enter key.', () => {
      ...
      keyBoardEvent.target = rteObj.element.querySelector(
        '.e-toolbar-item .e-rte-fontcolor-dropdown'
      );
      (rteObj.toolbarModule as any).toolBarKeyDown(keyBoardEvent);
      rteObj.dataBind();
      expect(
        document.querySelector('.e-dropdown-popup.e-rte-fontcolor-dropdown') !=
          null
      ).toBe(true);
    });
    ...
    it('The background dropdown is open when you click the enter key.', () => {
      ...
      keyBoardEvent.action = 'enter';
      keyBoardEvent.target = rteObj.element.querySelector(
        '.e-toolbar-item .e-rte-backgroundcolor-dropdown'
      );
      (rteObj.toolbarModule as any).toolBarKeyDown(keyBoardEvent);
      rteObj.dataBind();
      expect(
