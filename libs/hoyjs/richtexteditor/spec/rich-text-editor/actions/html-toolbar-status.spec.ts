...
describe(' HTML editor update toolbar ', () => {
  ...
  describe(' RTE tools update ', () => {
    ...
    it('Check single Bold tag', () => {
      ...
      expect(
        (rteObj.htmlEditorModule as any).toolbarUpdate.toolbarStatus.bold
      ).toEqual(true);
      expect(status.bold).toEqual(true);
      expect(
        (rteObj.htmlEditorModule as any).toolbarUpdate.toolbarStatus.italic
      ).toEqual(false);
    ...
    it('Check single Italic tag', () => {
      ...
      expect(
        (rteObj.htmlEditorModule as any).toolbarUpdate.toolbarStatus.underline
      ).toEqual(false);
    ...
    it('Check single underline tag', () => {
      ...
      expect(
        (rteObj.htmlEditorModule as any).toolbarUpdate.toolbarStatus
          .strikethrough
      ).toEqual(false);
    ...
    it('Check single strikethrough tag', () => {
      ...
      expect(
        (rteObj.htmlEditorModule as any).toolbarUpdate.toolbarStatus.superscript
      ).toEqual(false);
    ...
    it('Check single Superscript tag', () => {
      ...
      expect(
        (rteObj.htmlEditorModule as any).toolbarUpdate.toolbarStatus.subscript
      ).toEqual(false);
    ...
    it('Check single subscript tag', () => {
      ...
      expect(
        (rteObj.htmlEditorModule as any).toolbarUpdate.toolbarStatus.fontname
      ).toEqual(null);
    ...
    it('Check single font name tag without specfic family', () => {
      ...
      expect(
        (rteObj.htmlEditorModule as any).toolbarUpdate.toolbarStatus.fontsize
      ).toEqual(null);
    ...
    it('Check single font name tag with specific incoorect family', () => {
      ...
      rteObj.fontFamily = {
        default: 'Arial',
        items: [{ text: 'Arial', value: 'Arial,Helvetica,sans-serif' }],
      };
      (rteObj as any).mouseUp({ target: editNode });
      expect(
        (rteObj.htmlEditorModule as any).toolbarUpdate.toolbarStatus.fontname
      ...
      expect(status.fontname).toEqual(null);
      expect(
        (rteObj.htmlEditorModule as any).toolbarUpdate.toolbarStatus.fontcolor
      ).toEqual('rgb(0, 0, 0)');
    ...
    it('Check single font color tag ', () => {
      ...
      expect(
        (rteObj.htmlEditorModule as any).toolbarUpdate.toolbarStatus.fontcolor
      ).toEqual('rgb(231, 231, 231)');
      expect(status.fontcolor).toEqual('rgb(231, 231, 231)');
      expect(
        (rteObj.htmlEditorModule as any).toolbarUpdate.toolbarStatus.orderedlist
      ).toEqual(false);
    ...
    it('Check single alignment left tag ', () => {
      ...
      (rteObj as any).mouseUp({ target: editNode });
      expect(
        (rteObj.htmlEditorModule as any).toolbarUpdate.toolbarStatus.alignments
      ).toEqual('justifyleft');
  ...
  describe('854829 - Quick toolbar tooltip is hidden behind popup while opening it ', () => {
    ...
    it('Check the Tooltip when click toolbar items', (done: Function) => {
      ...
      (
        ...
        ).querySelector('.e-icon-right') as HTMLElement
      ).click();
      setTimeout(function () {
