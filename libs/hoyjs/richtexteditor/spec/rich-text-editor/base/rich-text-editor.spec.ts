...
import {
  ...
  HtmlEditor,
  Toolbar,
} from '../../../src/rich-text-editor/index';
...
describe('RTE Base module ', () => {
      ...
      setTimeout(() => {
        expect(
          (rteObj as any).inputElement.innerHTML ===
            `<ul><li><strong class="focusNode">List parent</strong><ul><li>Nested List</li><li>Nested List﻿﻿<br></li></ul></li></ul>`
        ).toBe(true);
        done();
      }, 100);
    });
  ...
  describe('831600: When using the mention with the Rich Text Editor, the backspace is not working properly.', () => {
    ...
    it('contenteditable div false element before the backspace key press', (done: Function) => {
      ...
      let node: any =
        rteObj.inputElement.querySelector('.e-mention-chip').nextSibling;
      ...
      setTimeout(() => {
        expect((rteObj as any).inputElement.innerHTML).toBe(
          `<p>sdvdsvsdv</p><p>sdvsdv <span contenteditable="false" class="e-mention-chip"><a title="maria@gmail.com">@Maria</a></span>&nbsp;sdvsdvdsv</p>`
        );
        done();
      }, 100);
    });
  ...
  describe('870158: Pressing backspace inside the list', () => {
    ...
    it('Pressing backspace key after pressing the shift enter inside the list with styles', (done: Function) => {
      ...
      setTimeout(() => {
        expect((rteObj as any).inputElement.innerHTML).toBe(
          `<ol><li>List node content</li><li>List node <span style="background-color: rgb(255, 255, 0);">content</span><br></li><li><span style="background-color: transparent;">List node content<br></span><span class="focusNode" style="background-color: transparent;">Shift enter pressed</span></li></ol>`
        );
        done();
      }, 100);
    });
  ...
  describe('840133: Backspace key not working properly when placed cursor in the element with br inside the 2 text nodes', () => {
    ...
    it('The backspace not working properly on the line break text', (done: Function) => {
      ...
      setTimeout(() => {
        expect((rteObj as any).inputElement.innerHTML).toBe(
          `<p>This is the first line</p><p>This is the secod line</p><p class="focusNode">This is the thirdline<br>This is also the third line</p>`
        );
        done();
      }, 100);
    });
  ...
  describe('EJ2-44314: Improvement with backSpaceKey action in the Rich Text Editor', () => {
    ...
    it('Checking the backspacekey between two nodes', (done: Function) => {
      ...
      (rteObj as any).keyDown(keyBoardEvent);
      setTimeout(() => {
        expect((rteObj as any).inputElement.childNodes[0].innerHTML).toBe(
          'Testing 1Testing 2'
        );
        expect(
          (rteObj as any).inputElement.childNodes[0].parentElement.hasAttribute(
            'style'
          )
        ).toBe(false);
        done();
  ...
  describe('EJ2-44314: Improvement with backSpaceKey action in the Rich Text Editor', () => {
    ...
    it('Checking the li element skipping for nested LI', (done: Function) => {
      ...
      setTimeout(() => {
        expect(
          (rteObj as any).inputElement.childNodes[1].childNodes[1].innerHTML ===
            'Testing 2﻿﻿<br>'
        ).toBe(true);
        done();
      }, 100);
  ...
  describe('EJ2-44314: Improvement with backSpaceKey action in the Rich Text Editor', () => {
    ...
    it('Checking the keyboard enter inside the table', (done: Function) => {
      ...
      let node: any = (rteObj as any).element
        .querySelector('table')
        .querySelector('tr').firstElementChild.firstChild;
  ...
  describe('827539: Random spaces got removed while pressing backspace key in RichTextEditor', () => {
    ...
    it('Checking the randowm node being removed in the editor', (done: Function) => {
      ...
      let node: any = (rteObj.inputElement.childNodes[3] as HTMLElement)
      ...
      setTimeout(() => {
        expect(
          (
            (rteObj as any).inputElement.childNodes[2] as HTMLElement
          ).firstElementChild.querySelectorAll('BR').length === 2
        ).toBe(true);
        done();
      }, 100);
    });
  ...
  describe('EJ2-69674 - Deleting bullet list using backspace key doesnt delete the list issue testing', () => {
    ...
    it('Checking the keyboard enter inside the nodes', (done: Function) => {
      ...
      (rteObj as any).keyDown(keyBoardEvent);
      setTimeout(() => {
        expect((rteObj as any).inputElement.querySelectorAll('li').length).toBe(
          0
        );
        done();
      }, 100);
  ...
  describe('EJ2-65467: Backspace key press inbetween 2 inline nodes seperated by BR', () => {
    ...
    it('Backspace key press inbetween 2 inline nodes seperated by BR', (done: Function) => {
      ...
      expect(
        (rteObj as any).inputElement.innerHTML ===
          `<p style="margin-bottom:7.5pt;line-height:normal;background:\n            white;margin-top:0in;margin-right:0in;margin-left:0in;font-size:11.0pt;font-family:&quot;Calibri&quot;,sans-serif;"><b><u><span lang="EN-IN" style="font-size:12.0pt;font-family:&quot;Arial&quot;,sans-serif;color:#333333;">Lower abdomen</span></u></b><b><span lang="EN-IN" style="font-size:12.0pt;font-family:&quot;Arial&quot;,sans-serif;color:#333333;">:</span></b></p><p style="margin-bottom:7.5pt;line-height:normal;background:\n            white;margin-top:0in;margin-right:0in;margin-left:0in;font-size:11.0pt;font-family:&quot;Calibri&quot;,sans-serif;"><span lang="EN-IN" style="font-size:12.0pt;font-family:&quot;Arial&quot;,sans-serif;color:#333333;">Axial</span><br><span lang="EN-IN" style="font-size:12.0pt;font-family:&quot;Arial&quot;,sans-serif;color:#333333;" class="focusNode">-</span><br><span lang="EN-IN" style="font-size:12.0pt;font-family:&quot;Arial&quot;,sans-serif;color:#333333;">T2FS, T1</span></p>`
      ).toBe(true);
      done();
    });
    afterAll((done) => {
  ...
  describe('EJ2-44314: Improvement with backSpaceKey action in the Rich Text Editor', () => {
    ...
    it('Checking the LI element with blocknodes', (done: Function) => {
      ...
      keyBoardEvent.code = 'Backspace';
      (rteObj as any).keyDown(keyBoardEvent);
      expect((rteObj as any).inputElement.childNodes[1].childElementCount).toBe(
        2
      );
      done();
    });
  ...
  describe('EJ2-44314: Improvement with backSpaceKey action in the Rich Text Editor', () => {
    ...
    it('Checking the LI element with text nodes', (done: Function) => {
      ...
      let node: any = (rteObj as any).inputElement.childNodes[1].childNodes[2]
        .firstChild;
      setCursorPoint(document, node, 0);
      keyBoardEvent.keyCode = 8;
      keyBoardEvent.code = 'Backspace';
      ...
      setTimeout(() => {
        expect(
          (rteObj as any).inputElement.childNodes[1].childElementCount
        ).toBe(4);
        expect(
          (rteObj as any).inputElement.innerHTML ===
            `<p><b>Functional\n            Specifications/Requirements:</b></p><ol><li><p>Provide\n            the tool bar support, it’s also customizable.</p></li><li><p>Options\n            to get the HTML elements with styles.</p></li><li>Support\n            to insert image from a defined path.</li><li><p>Footer\n            elements and styles(tag / Element information , Action button (Upload, Cancel))</p></li></ol><p><br></p>`
        ).toBe(true);
        done();
      }, 100);
    });
  ...
  describe('EJ2-56125: backSpaceKey action at start of list with previous list empty issue', () => {
    ...
    it('Checking the LI element with text nodes', (done: Function) => {
      ...
      (rteObj as any).keyDown(keyBoardEvent);
      setTimeout(() => {
        expect(rteObj.inputElement.textContent).toBe(
          'List Content 1List Content 3'
        );
        done();
      }, 100);
    });
  ...
  describe('EJ2-61099: Link in the list reverted when press ctrl+C', () => {
    ...
    it('clearing all list maintains the list element', (done: Function) => {
      ...
      let node: any = (rteObj as any).inputElement.querySelector(
        '.e-rte-anchor'
      ).childNodes[0];
      let sel = new NodeSelection().setSelectionText(
        document,
  ...
  describe('EJ2-57616: clearing all list maintains the list element', () => {
    ...
    it('clearing all list maintains the list element', (done: Function) => {
      ...
      let node2: any = (rteObj as any).inputElement.querySelector(
        '.focusNodelast'
      ).childNodes[0];
      let sel = new NodeSelection().setSelectionText(
        document,
  ...
  describe('EJ2-50975: Improvement with deleteKey action in the Rich Text Editor', () => {
    ...
    it('Checking the delete key between two LI nodes with no childNodes', (done: Function) => {
      ...
      setTimeout(() => {
        expect(
          rteObj.inputElement.childNodes[1].childNodes[0].textContent ===
            'Testing 1'
        ).toBe(true);
        done();
      }, 100);
  ...
  describe('EJ2-50975: Improvement with deleteKey action in the Rich Text Editor', () => {
    ...
    it('Checking the deletekey between two nodes with child elements', (done: Function) => {
      ...
      let node: any =
        rteObj.inputElement.childNodes[1].childNodes[0].childNodes[0]
          .firstChild;
      setCursorPoint(
        document,
        node,
  ...
  describe('EJ2-50975: Improvement with deleteKey action in the Rich Text Editor', () => {
    ...
    it('Checking the deletekey between two nodes one with child elements and other with no child', (done: Function) => {
      ...
      let node: any =
        rteObj.inputElement.childNodes[1].childNodes[1].firstChild;
      setCursorPoint(
        document,
        node.firstChild,
        node.firstChild.textContent.length
      );
      (rteObj as any).mouseUp({ target: rteObj.inputElement, isTrusted: true });
      keyBoardEvent.keyCode = 46;
      keyBoardEvent.code = 'Delete';
      ...
      setTimeout(() => {
        expect(
          rteObj.inputElement.childNodes[1].childNodes[1].textContent ===
  ...
  describe('EJ2-57112: Delete Key not working when image is focused and deleted', () => {
    ...
    it('Delete Key not working when image is focused and deleted', (done: Function) => {
      ...
      setTimeout(() => {
        expect(
          (rteObj as any).inputElement.innerHTML ===
            `<ol><li><p>image</p></li></ol><p class="focusNode"><img alt="Logo" src="https://ej2.syncfusion.com/angular/demos/assets/rich-text-editor/images/RTEImage-Feather.png" class="e-rte-image e-imginline" style="width: 300px;"></p><p>Content</p>`
        ).toBe(true);
        done();
      }, 100);
    });
  ...
  describe('RTE base module', () => {
    beforeAll(() => {
      let css: string =
        '.e-richtexteditor { margin-top: 100px; height: 200px }' +
    ...
    describe('RTE without iframe', () => {
      ...
      it('getContent public method', () => {
        expect(rteObj.getContent().classList.contains('e-rte-content')).toBe(
          true
        );
      });
      ...
      it('selectRange public method', () => {
        ...
        range.setEnd(
          ...
          rteObj.contentModule.getEditPanel().childNodes.length
        );
        rteObj.selectRange(range);
        let selection: Selection =
          rteObj.formatter.editorManager.nodeSelection.get(
      ...
      it('getSelectedHtml public method', () => {
        rteObj.value =
          '<p>RTE</p><p>This is a sample content used in the RTE test cases</p><ol><li>list samples</li></ol>';
        rteObj.dataBind();
        let range: Range = rteObj.contentModule.getDocument().createRange();
        range.setStart(rteObj.contentModule.getEditPanel(), 0);
        range.setEnd(
      ...
      it('show inline quick toolbar public method', () => {
        rteObj.value =
          '<p>RTE sample content</p><p id="p2">This is a sample content used in the RTE test cases</p><ol><li>list samples</li></ol>';
    ...
    describe('DIV - RTE value property testing', () => {
      ...
      it('check value Html Encode property', () => {
        expect(
          rteObj.value !== rteObj.contentModule.getEditPanel().innerHTML
        ).toBe(true);
      });
      it('check value Html Encode property', () => {
    ...
    describe('Inline mode fontFamily and fontSize testing -', () => {
      ...
      it('Default mode RTE in initial render', () => {
        expect(
          (rteObj.contentModule.getEditPanel() as HTMLElement).style
            .fontFamily === 'Verdana'
        ).toBe(true);
        expect(
          (rteObj.contentModule.getEditPanel() as HTMLElement).style
    ...
    describe('Default RTE fontFamily and fontSize testing -', () => {
      ...
      it('Default mode RTE testing fontfamily', (done: Function) => {
        ...
        let nodetext: any =
          rteObj.contentModule.getEditPanel().childNodes[0].firstChild;
        let sel = new NodeSelection().setSelectionText(
          document,
          nodetext,
          nodetext,
          nodetext.textContent.length,
          nodetext.textContent.length
        );
        (<any>rteObj).keyDown(EnterkeyboardEventArgs);
        (
          (
            elem.querySelectorAll('.e-toolbar-item')[0] as HTMLElement
          ).querySelector('button') as HTMLButtonElement
        ).click();
        (
          (document.querySelector('.e-font-name-tbar-btn ul') as HTMLElement)
            .childNodes[0] as HTMLElement
        ).click();
        expect(
          (
            (
              (<any>rteObj).contentModule.getEditPanel()
      ...
      it('Default mode RTE testing fontSize', (done: Function) => {
        ...
        (
          (
            elem.querySelectorAll('.e-toolbar-item')[1] as HTMLElement
          ).querySelector('button') as HTMLButtonElement
        ).click();
        (
          (document.querySelector('.e-font-size-tbar-btn ul') as HTMLElement)
            .childNodes[2] as HTMLElement
        ).click();
        expect(
          (
    ...
    describe('EJ2-62642 - Blur called when @amp; is on the RTE content', () => {
      ...
      beforeAll(() => {
        rteObj = renderRTE({
          value:
            '<p>The custom command "insert special character" is configured as the last item of the too&amp;lbar. Click on the command and choo😒se the special character you want to include from the popup.</p>',
          focus: () => {
            focusIn = true;
          },
          blur: () => {
      ...
      it('Blur called when @amp; is on the RTE content with individual text nodes', () => {
        ...
        expect(
          rteObj.inputElement.textContent ===
            'The custom command "insert special character" is configured as the last item of the too&lbar. Click on the command and choo😒se the special character you want to include from the popup.'
        ).toBe(true);
      });
    });
    ...
    describe('RTE toolbar', () => {
      ...
      it('ensure the module', () => {
        expect(
          rteObj.ensureModuleInjected(rteObj.getInjectedModules()[0] as any)
        ).toBe(true);
      });
    ...
    describe('setContentHeight method testing', () => {
      ...
      it('Content element height testing', (done) => {
        ...
        expect(
          (<HTMLElement>elem.querySelector('.e-rte-content')).clientHeight
        ).toBe(52);
        ...
        let parentNodes = new NodeSelection().getParentNodeCollection(
          new NodeSelection().getRange(document)
        );
        ...
        setTimeout(() => {
          ...
          let focusEle: HTMLElement =
            rteObj.toolbarModule.baseToolbar.toolbarObj.element.querySelector(
              'button'
            );
      ...
      it('tab key', () => {
        ...
        actionBegin = false;
        (keyboardEventArgs.shiftKey = false), (keyboardEventArgs.keyCode = 9);
        (<any>rteObj.htmlEditorModule).onKeyDown({ args: keyboardEventArgs });
        expect(actionBegin).toBe(false);
        actionBegin = false;
      });
      it('Enter key', function () {
        rteObj.contentModule.getEditPanel().innerHTML =
          'datamanager https://www.google.com';
        ...
        expect(rteObj.contentModule.getEditPanel().querySelector('a')).not.toBe(
          null
        );
      ...
      it('Enter key quicktoolbar hide testing', function () {
        ...
        keyboardEventArgs.keyCode = 13;
        (<any>rteObj).keyDown(keyboardEventArgs);
        let popupElement: HTMLCollectionOf<Element> =
          document.getElementsByClassName('e-rte-quick-popup');
      ...
      it('space key with content', function () {
        rteObj.contentModule.getEditPanel().innerHTML =
          'datamanager https://www.google.comlinkis created';
        let nodetext: any = rteObj.contentModule.getEditPanel().childNodes[0];
        let sel = new NodeSelection().setSelectionText(
          document,
          nodetext,
      ...
      it('Link Spacing', function () {
        ...
        expect(
          rteObj.contentModule.getEditPanel().innerHTML === expectedElement
        ).toBe(true);
        expect(
          rteObj.contentModule.getEditPanel().textContent === expectedString
        ).toBe(true);
      });
      it('Link Spacing', function () {
        rteObj.contentModule.getEditPanel().innerHTML =
          'datamanager www.google.com';
        let nodetext: any = rteObj.contentModule.getEditPanel().childNodes[0];
        let sel = new NodeSelection().setSelectionText(
          document,
          nodetext,
    ...
    describe('rte Iframe mode', () => {
      ...
      it('focus method testing', () => {
        rteObj.focusIn();
        expect(document.activeElement === rteObj.contentModule.getPanel()).toBe(
          true
        );
      });
    ...
    describe('EJ2-49452- Disable toolbar when quicktoolbar is opened', () => {
      ...
      beforeAll(() => {
        rteObj = renderRTE({
          ...
          value:
            '<p><img src="https://media.sproutsocial.com/uploads/2017/02/10x-featured-social-media-image-size.png" class="e-resize e-rte-image e-imginline"></p>',
        });
      ...
      it('When the custom command is configured', () => {
        expect(
          (rteObj as any).element
            .querySelectorAll('.e-template')[0]
    ...
    describe('EJ2-49452- Disable multiple toolbar when quicktoolbar is opened', () => {
      ...
      it('When the custom command is configured for multiple toolbars', () => {
        ...
        expect(
          (rteObj as any).element
            .querySelectorAll('.e-template')[3]
            .classList.contains('e-overlay')
        ).toBe(true);
        expect(
          (rteObj as any).element
            .querySelectorAll('.e-template')[4]
            .classList.contains('e-overlay')
        ).toBe(true);
      });
    ...
    describe('RTE Events', () => {
      ...
      it('backspace key press inside the pre tag', () => {
        rteObj.contentModule.getEditPanel().innerHTML =
          '<pre id="p1"><br>Paragraph 4<br>Paragraph 5<br>Para&#8203;<br><br></pre>';
        let start: HTMLElement = rteObj.contentModule
          .getEditPanel()
          .querySelector('#p1');
      ...
      it('backspace key press while <P> content in editable element - Firefox', () => {
        ...
        (rteObj as any).keyUp(keyBoardEvent);
        expect(
          rteObj.contentModule.getEditPanel().innerHTML === '<p><br></p>'
        ).toBe(true);
        expect(
          (rteObj.contentModule.getEditPanel().childNodes[0] as Element)
            .tagName === 'P'
      ...
      it('delete key press while <p> with text content and image elemnt in editable element - Firefox', () => {
        ...
        rteObj.formatter.editorManager.nodeSelection.setSelectionText(
          document,
          selectNode.childNodes[0],
          selectNode.childNodes[2].childNodes[0],
          0,
          2
        );
        keyBoardEvent.which = 46;
      ...
      it('delete key press for the image element by selecting all', () => {
        ...
        setCursorPoint(
          curDocument,
          selectNode.childNodes[0].childNodes[0] as Element,
          4
        );
        keyBoardEvent.which = 46;
        keyBoardEvent.action = 'delete';
      ...
      it('Backspace key press for the image element by selecting all', () => {
        ...
        setCursorPoint(
          curDocument,
          selectNode.childNodes[0].childNodes[2] as Element,
          0
        );
        keyBoardEvent.which = 8;
        keyBoardEvent.code = 'Backspace';
    ...
    describe('EJ2-60047 - typing by selecting 3 empty p tag elements which is prefix of other element with content in firefox', () => {
      ...
      it('EJ2-60047 - typing by selecting 3 empty p tag elements which is prefix of other element with content in firefox', () => {
        ...
        let sel1 = new NodeSelection().setSelectionText(
          document,
          editNode.childNodes[0],
          editNode.childNodes[0],
          1,
          1
        );
        ...
        (rteObj as any).keyUp(keyBoardEvent);
        expect(
          (editNode.childNodes[0] as HTMLElement).outerHTML === `<p>a</p>`
        ).toBe(true);
      });
    ...
    describe('826826 - Placing cursor at the and entering the space key', () => {
      ...
      it('826826 - Placing cursor at the and entering the space key', () => {
        ...
        expect(
          rteObj.contentModule.getEditPanel().innerHTML ===
            `<p class="focusNode">Your order nr. <span contenteditable="false" class="pds-content-variable" id="847c7ece-b25a-4467-a0e8-394c1607f8af" data-id="6661" data-format-id="0" data-strict="true">orderNo</span> has been passed to the<span class="pds-conditional-text" id="41b565d9-dc61-4d76-842f-44d7b6ec15be" data-visible="true" data-condition="f4aa50d8-f8c4-4573-b3bd-8bdf9f6675d2">courier 1</span><span class="pds-conditional-text" id="125a73b2-fe16-4966-bd0c-fc05a10d3b95" data-visible="true" data-condition="0b4f1f5b-e998-496d-8625-1df7914f4e4d">courier 2</span><span class="pds-conditional-text" id="40231106-eb29-490c-a60a-822c9e0a60ad" data-visible="true" data-condition="8b342740-6ada-4781-a0df-9ecf8ad38303">courier 3</span><span class="pds-conditional-text" id="9dad2442-8c88-4f4c-b19d-bb29d81a9362" data-visible="true" data-condition="2574340a-7373-463b-a954-68bb274e6e8f">courier 4</span><span class="pds-conditional-text" id="68fa59d5-6cc0-46f0-a8e6-d89238b5ff29" data-visible="true" data-condition="c2373318-e19b-46bd-8ff6-35987648646a">courier 5</span><span class="pds-conditional-text" id="dc2ed81f-ff45-4bca-818e-c6c17fbafa87" data-visible="true" data-condition="056d33f8-7c44-485d-9728-6cf69af0993a">courier 6</span><span class="pds-conditional-text" id="e3c25d06-35d1-4510-8724-878ba1b70225" data-visible="true" data-condition="da0e33e1-33ca-431d-8cb0-805d4f82c557">courier 7</span><span class="pds-conditional-text" id="6725b011-d01a-4489-a1e7-53e533267783" data-visible="true" data-condition="b065c7d4-f486-4ec0-9f42-50442af4120e">technician</span>. <span class="pds-conditional-text" id="28ef3e2d-9197-4455-9e45-6fc11f7cdd23" data-visible="true" data-condition="0ac52b7e-9634-4cf8-9a81-06a983c5b645">You can now track it yourself under the number <span contenteditable="false" class="pds-content-variable" id="d5ad50eb-0cad-4861-84a9-edb87855db5f" data-id="1517" data-format-id="0" data-strict="true">ID</span> at <span contenteditable="false" class="pds-content-variable" id="d2a761c1-59bb-4c10-9b63-bb1de454ec34" data-id="1451" data-format-id="0" data-strict="true">courierID</span> .</span>&nbsp;</p>`
        ).toBe(true);
      });
    ...
    describe('Toolbar - Print Module', () => {
      describe('Print rendering testing', () => {
        ...
        it('with cancel is false', () => {
          expect(
            rteEle.querySelectorAll('.e-toolbar-item')[3].getAttribute('title')
          ).toBe('Print');
          let trgEle: HTMLElement = <HTMLElement>(
            rteEle.querySelectorAll('.e-toolbar-item')[3]
          );
          trgEle.click();
    ...
    describe('actionBegin and actionComplete testing', () => {
      ...
      beforeAll(() => {
        rteObj = renderRTE({
          ...
          actionBegin: (args: any) => {
            if (
              args.originalEvent &&
              args.originalEvent.action == 'paste' &&
              args.originalEvent.pastePrevent
            ) {
              args.cancel = true;
            }
            beforeCount = true;
      ...
      it(' trigger the actionBegin and actionComplete while pressing the action key in paste', (done) => {
        ...
        setTimeout(() => {
          ...
          expect(
            allElem.children[0].childNodes[0].childNodes[0].childNodes[1].tagName.toLowerCase() ===
              'a'
          ).toBe(true);
          expect(
            allElem.children[0].childNodes[0].childNodes[0].childNodes[1].getAttribute(
              'href'
    ...
    describe('div with inner element', () => {
      ...
      it('check name attribute in textarea', () => {
        expect(
          (rteObj as any).inputElement.getAttribute('name') === 'RTEName'
        ).not.toBe(null);
      });
      afterAll(() => {
        destroy(rteObj);
    ...
    describe('RTE text area', () => {
      ...
      it('check textarea', () => {
        ...
        expect((rteObj.valueContainer as HTMLTextAreaElement).value).not.toBe(
          null
        );
        expect(rteObj.valueContainer.classList.contains('e-rte-hidden')).toBe(
          true
        );
      });
      it('value property', () => {
    ...
    describe('RTE - Public Methods', () => {
      ...
      it('focus method', () => {
        rteObj.focusIn();
        expect(document.activeElement.classList.contains('e-content')).toBe(
          true
        );
        rteObj.focusOut();
      });
      ...
      it('getHtml method', () => {
        expect(rteObj.getHtml()).toBe(
          '<p> adsafasdfsd <span> fdsfds </span></p>'
        );
      });
      it('refresh method', () => {
        rteObj.refresh();
      ...
      it('showFullScreen method', () => {
        ...
        expect(rteObj.element.classList.contains('e-rte-full-screen')).toBe(
          true
        );
      });
      it('showSourceCode method', () => {
        rteObj.showSourceCode();
        let ele: HTMLTextAreaElement =
    ...
    describe('enable/disable ToolbarItem public method testing', () => {
      ...
      it('Single item with disable and enable ToolbarItem method testing', () => {
        expect(
          rteEle
            .querySelectorAll('.e-toolbar-item')[0]
            .classList.contains('e-overlay')
        ).toBe(false);
      ...
      it('Array of item with disable and enable ToolbarItem method testing', () => {
        ...
        expect(
          rteEle
            .querySelectorAll('.e-toolbar-item')[1]
            .classList.contains('e-overlay')
        ).toBe(false);
    ...
    describe('removeToolbarItem public method testing', () => {
      ...
      it('Single item with disable and enable ToolbarItem method testing', () => {
        expect(
          rteEle
            .querySelectorAll('.e-toolbar-item')[0]
            .firstElementChild.id.indexOf('Bold') > 0
        ).toBe(true);
        rteObj.removeToolbarItem('Bold');
        expect(
          rteEle
            .querySelectorAll('.e-toolbar-item')[0]
            .firstElementChild.id.indexOf('Italic') > 0
        ).toBe(true);
        expect(
          rteEle
            .querySelectorAll('.e-toolbar-item')[1]
            .firstElementChild.id.indexOf('Underline') > 0
        ).toBe(true);
      });
      ...
      it('Array of item with disable and enable ToolbarItem method testing', () => {
        ...
        expect(
          rteEle.querySelectorAll('.e-toolbar-item')[1].firstElementChild
        ).toBe(null);
        expect(
          rteEle
            .querySelectorAll('.e-toolbar-item')[0]
        ...
        expect(
          rteEle
            .querySelectorAll('.e-toolbar-item')[1]
            .classList.contains('e-separator')
        ).toBe(true);
        expect(
          rteEle
            .querySelectorAll('.e-toolbar-item')[2]
            .firstElementChild.id.indexOf('Formats') > 0
        ).toBe(true);
        expect(
          rteEle
            .querySelectorAll('.e-toolbar-item')[3]
            .firstElementChild.id.indexOf('Alignments') > 0
        ).toBe(true);
      });
    ...
    describe('Toolbar module addTBarItem private method testing', () => {
      ...
      it('addTBarItem method testing with text as empty string', () => {
        ...
        rteObj.toolbarModule.addTBarItem(
          {
            updateItem: 'Undo',
            targetItem: 'Undo',
            baseToolbar: rteObj.getBaseToolbarObject(),
          },
          0
        );
        ...
        expect(
          rteEle
            .querySelectorAll('.e-toolbar-item')[0]
            .firstElementChild.id.indexOf('Undo') > 0
        ).toBe(true);
        expect(
          rteEle
            .querySelectorAll('.e-toolbar-item')[1]
    ...
    describe('EJ2-59865 - CSS class property', () => {
      ...
      it('Ensure cssClass property for dropdownpopup', () => {
        ...
        let allDropDownPopups: NodeListOf<Element> =
          document.querySelectorAll('.e-dropdown-popup');
    ...
    describe('EJ2-59865 - CSS class property in Inline toolbar', () => {
      ...
      it('Ensure cssClass property in inline toolbar', (done) => {
        ...
        expect(
          document
            .querySelector('.e-rte-quick-toolbar')
        ...
        for (let i: number = 0; i < allDropDownPopups.length; i++) {
          setTimeout(() => {
            expect(allDropDownPopups[i].classList.contains('myClass')).toBe(
              true
            );
            done();
          }, 100);
      ...
      it('through onproperty change cssClass property in inline toolbar', (done) => {
        ...
        expect(
          document
            .querySelector('.e-rte-quick-toolbar')
            .classList.contains('textClass')
        ).toBe(true);
        let allDropDownPopups: NodeListOf<Element> =
          document.querySelectorAll('.e-dropdown-popup');
        for (let i: number = 0; i < allDropDownPopups.length; i++) {
          setTimeout(() => {
            expect(allDropDownPopups[i].classList.contains('textClass')).toBe(
              true
            );
            expect(allDropDownPopups[i].classList.contains('myClass')).toBe(
              false
    ...
    describe('RTE Properties', () => {
      ...
      beforeAll((done: Function) => {
        ...
        elem = rteObj.element;
        toolWrap = rteObj.element.querySelector(
          '#' + rteObj.element.id + '_toolbar_wrapper'
        );
        view = rteObj.element.querySelector(
          '#' + rteObj.element.id + 'rte-view'
        );
        done();
      });
      ...
      it('through onproperty change height property', () => {
        ...
        let currentToolWrap: HTMLElement = rteObj.element.querySelector(
          '#' + rteObj.element.id + '_toolbar_wrapper'
        );
        let currentView: HTMLElement = rteObj.element.querySelector(
          '#' + rteObj.element.id + 'rte-view'
        );
        expect(toolWrap.style.height === currentToolWrap.style.height).toBe(
          true
        );
      ...
      it('Ensure placeholderClassName', () => {
        expect(
          rteObj.element.getElementsByClassName('e-rte-placeholder').length > 0
        ).toBe(true);
      });
      ...
      it('through onproperty change enabled property', () => {
        ...
        expect(rteObj.element.classList.contains('e-rte-readonly')).not.toBe(
          true
        );
      });
      ...
      it('Ensure Locale property', () => {
        ...
        expect(
          rteEle.querySelectorAll('.e-toolbar-item')[0].getAttribute('title')
        ).toBe('fett');
        expect(
          rteEle.querySelectorAll('.e-toolbar-item')[1].getAttribute('title')
        ).toBe('kursiv');
      });
      ...
      it('Ensure placeholder property', () => {
        expect(
          (
            (rteObj as any).placeHolderWrapper as HTMLElement
          ).classList.contains('enabled')
        ).toBe(true);
        expect((rteObj as any).placeHolderWrapper.innerText).toBe(
          'type something'
        );
      });
      ...
      it('ensure insert image on execute command', () => {
        ...
        expect((rteObj as any).inputElement.querySelector('img').src).toBe(
          'https://ej2.syncfusion.com/demos/src/rich-text-editor/images/RTEImage-Feather.png'
        );
      });
      ...
      it('ensure insert video using execute command', () => {
        ...
        expect(
          (rteObj as any).inputElement.querySelectorAll('video').length
        ).toBe(1);
      });
      ...
      it('ensure insert audio using execute command', () => {
        ...
        expect(
          (rteObj as any).inputElement.querySelectorAll('audio').length
        ).toBe(1);
      });
      ...
      it('EJ2-59978 - Insert image after Max char count - Execute Command Module', () => {
        ...
        (rteObj as any).inputElement.focus();
        rteObj.executeCommand('insertImage', el);
        expect(rteObj.inputElement.querySelectorAll('img').length === 0).toBe(
          true
        );
      });
      ...
      it('ensure insert image on execute command with arguments', () => {
        ...
        expect(imgElem.getAttribute('src')).toBe(
          'https://ej2.syncfusion.com/javascript/demos/src/rich-text-editor/images/RTEImage-Feather.png'
        );
        ...
        expect(imgElem.getAttribute('style')).toBe(
          'min-width: 200px; max-width: 200px; min-height: 200px; max-height: 600px;'
        );
      });
      ...
      it('ensure edit image on execute command with arguments', () => {
        ...
        expect(editImg.getAttribute('src')).toBe(
          'https://ej2.syncfusion.com/javascript/demos/src/rich-text-editor/images/RTEImage-Feather.png'
        );
        ...
        expect(editImg.getAttribute('style')).toBe(
          'min-width: 200px; max-width: 200px; min-height: 200px; max-height: 600px;'
        );
        ...
        expect(imgElem.getAttribute('style')).toBe(
          'min-width: 100px; max-width: 300px; min-height: 100px; max-height: 700px;'
        );
      });
      ...
      it('ensure insert table on execute command with all the arguments', () => {
        ...
        expect((rteObj as any).inputElement.querySelector('table')).not.toBe(
          null
        );
        expect((rteObj as any).inputElement.querySelectorAll('tr').length).toBe(
          2
        );
        expect(
          (rteObj as any).inputElement
        ...
        expect(
          (rteObj as any).inputElement
            .querySelector('table')
            .getAttribute('style')
        ).toBe('width: 40px; min-width: 20px; max-width: 100px;');
      });
    ...
    describe('Inserting image after the Inline node testing for RTE elements', () => {
      ...
      it('Inserting image after hr tags', () => {
        ...
        expect(
          (rteObj.contentModule.getEditPanel() as any).childNodes[0].tagName
        ).toBe('HR');
        expect(
          (rteObj.contentModule.getEditPanel() as any).childNodes[1]
    ...
    describe('RTE enablePersistence Properties in textarea mode', () => {
      ...
      beforeAll((done: Function) => {
        element = createElement('div', {
          id: 'Wrapper',
          innerHTML: `<textarea id="defaultRTE_28695"></textarea>`,
        });
      ...
      it('Ensure enablePersistence property', () => {
        ...
        window.localStorage.setItem(
          'value',
          '<p>Richtexteditor value updated</p>'
        );
        expect(rteObj.value).toBe(window.localStorage.getItem('value'));
        window.localStorage.removeItem('value');
    ...
    describe('RTE IFRame htmlAttributes Properties', () => {
      ...
      it('Iframe resource', () => {
        ...
        let scriptSheet: HTMLScriptElement =
          iframeHeader.querySelector('script');
    ...
    describe('RTE shortcut key - HTML', () => {
      ...
      it('indents: ctrl+]', () => {
        ...
        keyBoardEvent.action = 'indents';
        (rteObj as any).keyDown(keyBoardEvent);
        expect((selectNode as HTMLElement).style.marginLeft === '20px').toBe(
          true
        );
      });
      ...
      it('outdents: ctrl+[', () => {
        ...
        keyBoardEvent.action = 'outdents';
        (rteObj as any).keyDown(keyBoardEvent);
        expect((selectNode as HTMLElement).style.marginLeft === '0px').toBe(
          true
        );
      });
      ...
      it('justify-center: ctrl+e', () => {
        ...
        keyBoardEvent.action = 'justify-center';
        (rteObj as any).keyDown(keyBoardEvent);
        expect((selectNode as HTMLElement).style.textAlign === 'center').toBe(
          true
        );
      });
      ...
      it('justify-full: ctrl+j', () => {
        ...
        keyBoardEvent.action = 'justify-full';
        (rteObj as any).keyDown(keyBoardEvent);
        expect((selectNode as HTMLElement).style.textAlign === 'justify').toBe(
          true
        );
      });
      ...
      it('justify-left: ctrl+l', () => {
        ...
        keyBoardEvent.action = 'justify-left';
        (rteObj as any).keyDown(keyBoardEvent);
        expect((selectNode as HTMLElement).style.textAlign === 'left').toBe(
          true
        );
      });
      it('justify-right: ctrl+r', () => {
        ...
        keyBoardEvent.action = 'justify-right';
        (rteObj as any).keyDown(keyBoardEvent);
        expect((selectNode as HTMLElement).style.textAlign === 'right').toBe(
          true
        );
      });
      it('clear-format: ctrl+shift+r', () => {
        ...
        (rteObj as any).keyDown(keyBoardEvent);
        selectNode = editNode.querySelector('.first-p');
        expect(!isNullOrUndefined(selectNode.querySelector('strong'))).toBe(
          true
        );
        selectNode = editNode.querySelector('.first-p');
        rteObj.formatter.editorManager.nodeSelection.setSelectionText(
      ...
      it('ordered-list: ctrl+shift+o', () => {
        ...
        (rteObj as any).keyDown(keyBoardEvent);
        selectNode = editNode.querySelector('.first-p');
        expect((selectNode as HTMLElement).parentElement.tagName === 'OL').toBe(
          true
        );
      });
      ...
      it('unordered-list: ctrl+alt+o', () => {
        ...
        (rteObj as any).keyDown(keyBoardEvent);
        selectNode = editNode.querySelector('.first-p');
        expect((selectNode as HTMLElement).parentElement.tagName === 'UL').toBe(
          true
        );
      });
      ...
      it('html-source: ctrl+shift+h - Preview mode', () => {
        ...
        (rteObj as any).keyDown(keyBoardEvent);
        expect(
          !isNullOrUndefined(rteObj.element.querySelector('.e-content'))
        ).toBe(true);
      });
      ...
      it('insert-table: ctrl+shift+e', (done: Function) => {
        ...
        (rteObj as any).keyDown(keyBoardEvent);
        setTimeout(() => {
          let dialog: HTMLElement = document.getElementById(
            elem.id + '_tabledialog'
          );
    ...
    describe('RTE shortcut key - Markdown', () => {
      ...
      it('bold: ctrl+b', () => {
        ...
        (rteObj as any).keyDown(keyBoardEvent);
        let line =
          rteObj.formatter.editorManager.markdownSelection.getSelectedLine(
            editNode
          );
      ...
      it('uppercase: ctrl+shift+u', () => {
        ...
        rteObj.formatter.editorManager.markdownSelection.restore(editNode);
        let prev =
          rteObj.formatter.editorManager.markdownSelection.getSelectedText(
            editNode
          );
        keyBoardEvent.ctrlKey = true;
        keyBoardEvent.shiftKey = true;
  ...
  describe('EJ2-52200-Rich Text Editor character count increased when bold, italic, underline format applied in empty content and accessing using getCharCount -', () => {
    ...
    beforeAll(() => {
      rteObj = renderRTE({
        showCharCount: true,
        value:
          '<p><strong>&ZeroWidthSpace;<em>&ZeroWidthSpace;<span style="text-decoration: underline;">&ZeroWidthSpace;</span></em></strong></p>',
      });
    });
    afterAll(() => {
      destroy(rteObj);
    ...
    it('character value with underline enabled', () => {
      (<any>rteObj).value =
        "<p><span style='text-decoration: underline;'>&ZeroWidthSpace;Test</span></p>";
      (<any>rteObj).dataBind();
      (<any>rteObj).getCharCount();
      let charLen: string = (
        rteObj.element.querySelectorAll(
    ...
    it('character value with strikethrough enabled', () => {
      (<any>rteObj).value =
        "<span style='text-decoration: line-through;'>&ZeroWidthSpace;Test</span>";
      (<any>rteObj).dataBind();
      (<any>rteObj).getCharCount();
      let charLen: string = (
        rteObj.element.querySelectorAll(
  ...
  describe('RTE ExecuteCommand public method testing', () => {
    ...
    it('check OL Executecommand public method', () => {
      ...
      expect(
        document
          .getElementById('pnode2')
          .nextSibling.nodeName.toLocaleLowerCase()
      ).toBe('ol');
      expect(
        (
          document.getElementById('pnode2').nextSibling as HTMLElement
    ...
    it('check Font color Executecommand public method', () => {
      ...
      expect((node.childNodes[0] as HTMLElement).style.color).toBe(
        'rgb(102, 102, 0)'
      );
    });
    ...
    it(' EJ2-19209: insertText selection points Executecommand public method', () => {
      ...
      nodeSelection.setSelectionText(
        document,
        nodes[1].childNodes[0],
        nodes[2].childNodes[0],
        1,
        1
      );
      rteObj.executeCommand('insertText', 'RichTextEditor');
    ...
    it(' EJ2-27469: createLink using executeCommand not working propery issue', () => {
      ...
      let save: NodeSelection = nodeSelection.save(
        range,
        rteObj.contentModule.getDocument()
      );
      rteObj.executeCommand('createLink', {
      ...
      expect(node.firstElementChild.tagName.toLocaleLowerCase() === 'a').toBe(
        true
      );
      expect(node.firstElementChild.textContent === 'www.google.com').toBe(
        true
      );
    });
    ...
    it('Insert video using InsertHTML', () => {
      ...
      rteObj.dataBind();
      let videosrc =
        '<video><source src = "https://www.w3schools.com/html/movie.mp4"> <source src="https://www.w3schools.com/html/movie.ogg" type="video/ogg">Your browser does not support the video tag.</video><br />';
    ...
    it('Insert HR tag using InsertHTML', () => {
      ...
      expect(rteObj.inputElement.querySelectorAll('hr').length === 1).toBe(
        true
      );
    });
    ...
    it('Insert HR tag using InsertHorizontalRule', () => {
      ...
      rteObj.executeCommand('insertHorizontalRule');
      expect(rteObj.inputElement.querySelectorAll('hr').length === 2).toBe(
        true
      );
      rteObj.executeCommand('insertHorizontalRule');
      expect(rteObj.inputElement.querySelectorAll('hr').length === 3).toBe(
        true
      );
      rteObj.executeCommand('insertHorizontalRule');
      expect(rteObj.inputElement.querySelectorAll('hr').length === 4).toBe(
        true
      );
    });
  });
  ...
  describe('EJ2-58355 - RTE insert HTML', () => {
    ...
    it('check insertHtml with input element', () => {
      ...
      rteObj.executeCommand(
        'insertHTML',
        `<div>inserted</div><p><input type="checkbox" id="lname" name="lname"></p>`
      );
      expect(rteObj.inputElement.querySelectorAll('input').length === 1).toBe(
        true
      );
    });
  });
  ...
  describe('EJ2-59978 - Insert HTML and Text after Max char count - Execute Command', () => {
    ...
    it('Insert HTML after Max char count - Execute Command', () => {
      ...
      expect(
        rteObj.inputElement.innerHTML ===
          `<p class="focusNode">RTE Content with RTE</p>`
      ).toBe(true);
    });
    ...
    it('Insert Text & insert horizontal ruler and insert BR after Max char count - Execute Command', () => {
      ...
      expect(rteObj.inputElement.textContent === `RTE Content with RTE`).toBe(
        true
      );
    });
  ...
  describe('RTE Form reset', () => {
    ...
    it(' Check the value property while click on reset button', () => {
      ...
      expect((rteObj as any).inputElement.innerHTML).toEqual(
        '<div><p>First p node-0</p></div>'
      );
    });
    afterAll(() => {
      destroy(rteObj);
  ...
  describe('EJ2-13507: RTE ng feature matrix - Markdown two way binding is not working', () => {
    ...
    it(' update the value through onPropertyChange', () => {
      ...
      expect((rteObj as any).inputElement.value !== innerHTML).toBe(true);
      expect(
        (rteObj as any).inputElement.value === 'Markdown content updated'
      ).toBe(true);
    });
    afterAll(() => {
      destroy(rteObj);
...
<ul class='ul-third-node'><li>one-node</li><li>two-node</li><li>three-node</li></ul>`;
  ...
  describe(' Paste url', () => {
    ...
    it(' paste the url with create a anchor tag', (done) => {
      ...
      setTimeout(() => {
        ...
        expect(
          selectNode.getAttribute('title') === 'https://ej2.syncfusion.com'
        ).toBe(true);
        done();
      }, 10);
    });
  ...
  describe(' Paste action events', () => {
    ...
    it(' clipboard action in actionBegin and actionComplete', (done) => {
      selectNode = (rteObj as any).inputElement.querySelector('.first-p');
      setCursorPoint(curDocument, selectNode, 0);
      (rteObj as any).inputElement.dispatchEvent(
        new ClipboardEvent('paste', keyBoardEvent)
      );
      setTimeout(() => {
        expect(actionBegin).toBe(true);
  ...
  describe('EJ2-52326 - Cannot cancel fullscreen event in Maximize', () => {
    ...
    it(' Preventing the fullscreen mode with args.cancel as true', (done) => {
      ...
      expect(actionBegin).toBe(true);
      expect(
        (rteObj as any).element.classList.contains('e-rte-full-screen')
      ).toBe(false);
      expect(actionComplete).toBe(false);
      done();
    });
  ...
  describe('EJ2-52870-Pasting the text content for the second time after clearing the value, hangs the editor', () => {
    ...
    it('Pasting the content for the second time', (done) => {
      ...
      (
        rteObj.element.querySelectorAll('.e-toolbar-item')[2] as HTMLElement
      ).click();
      setCursorPoint(
        curDocument,
        (rteObj as any).inputElement.lastElementChild.lastElementChild
  ...
  describe('EJ2-23205 Revert the headings and blockquotes format while applying the inline code in Markdown editor', () => {
    ...
    it(' Remove the all applied format synatx', () => {
      rteObj.formatter.editorManager.markdownSelection.save(
        0,
      ...
      let popup: HTMLElement = document.getElementById(
        controlId + '_toolbar_Formats-popup'
      );
      dispatchEvent(
        popup.querySelectorAll('.e-item')[3] as HTMLElement,
        'mousedown'
      );
      item = <HTMLElement>popup.querySelectorAll('.e-item')[3];
      item.click();
      item = rteObj.element.querySelector(
        '#' + controlId + '_toolbar_UnorderedList'
      );
      item.click();
      item = rteObj.element.querySelector(
        '#' + controlId + '_toolbar_ClearFormat'
      );
      item.click();
  ...
  describe('EJ2-26042 - ExecuteCommand method performs wrongly to insert the bold command while focusing the outside of RTE. ', () => {
    ...
    it(' apply bold command through executeCommand - EditorMode as markdown ', () => {
      ...
      rteObj.executeCommand('bold');
      expect(
        (rteObj.inputElement as HTMLTextAreaElement).value === '****'
      ).toBe(true);
    });
  ...
  describe('EJ2-26545 Empty P tag create while give the value with empty space in RichTextEditor', () => {
    ...
    it("don't create the p tag to empty text node ", (done) => {
      let emptyNode: NodeListOf<Element> = <NodeListOf<Element>>(
        rteObj.inputElement.querySelectorAll('p:empty')
      );
      setTimeout(() => {
  ...
  describe('EJ2-29801 Tab and shift+tab key combination should have same behavior', () => {
    ...
    it('check whether the provided tabindex in the element is added to editable input', function () {
      expect(
        rteObj.htmlAttributes.tabindex ===
          rteObj.inputElement.getAttribute('tabindex')
      ).toBe(true);
    });
    afterAll((done) => {
      destroy(rteObj);
  ...
  describe('Value property when xhtml is enabled', function () {
    ...
    it('value property checking when xhtml is enabled', function () {
      expect(rteObj.value).toBe(
        '<div><p>ad<br/></p><hr/>asd<p><br/></p></div>'
      );
  ...
  describe('XHTML validation', function () {
    ...
    it('clean', function () {
      rteObj.value =
        '<!-- sit amet --><div><!-- sit amet --><p>adasd</p></div>';
    ...
    it('AddRootElement', function () {
      ...
      expect(rteObj.inputElement.innerHTML).toBe(
        '<div><p>adasd</p></div><div><p>adasd</p></div>'
      );
    });
    it('ImageTags', function () {
      rteObj.value =
        ' <img src="image.jpg"><p> dfg<img src="image.jpg"> ds</p> ';
      rteObj.enableXhtml = false;
      rteObj.enableXhtml = true;
      rteObj.dataBind();
      expect(rteObj.inputElement.innerHTML).toBe(
        '<p> <img src="image.jpg" class="e-rte-image e-imginline" alt=""></p><p> dfg<img src="image.jpg" class="e-rte-image e-imginline" alt=""> ds</p><p> </p>'
      );
    });
    it('removeTags', function () {
      rteObj.value =
        '<ul> <li>Coffee</li> <br>   <li>Tea</li> <br>   <li>Milk</li> <br>  </ul> <ol>   <li>Coffee</li>    <li>Tea</li>    <li>Milk</li>  </ol>   ';
      rteObj.enableXhtml = false;
      rteObj.enableXhtml = true;
      rteObj.dataBind();
      expect(rteObj.inputElement.innerHTML).toBe(
        '<ul> <li>Coffee</li>    <li>Tea</li>    <li>Milk</li>   </ul><p> </p><ol>   <li>Coffee</li>    <li>Tea</li>    <li>Milk</li>  </ol><p>   </p>'
      );
      rteObj.value =
        '<span><p>dfsddfsdf</p> <table></table></span>   <span><p>asdasdsd </p></span>';
      rteObj.enableXhtml = false;
      rteObj.enableXhtml = true;
      rteObj.dataBind();
      expect(rteObj.inputElement.innerHTML).toBe(
        '<p><span></span></p><p>dfsddfsdf</p> <table class="e-rte-table"></table>   <span></span><p></p>'
      );
      rteObj.value =
        '<div><div contenteditable="true"><p contenteditable="true">text</p><div><p>text</p></div></div></div>';
      rteObj.enableXhtml = false;
      rteObj.enableXhtml = true;
      rteObj.dataBind();
      expect(rteObj.inputElement.innerHTML).toBe(
        '<div><div><p>text</p><div><p>text</p></div></div></div>'
      );
    });
    it('RemoveUnsupported', function () {
      rteObj.value =
        "<div contenteditable='true'><table contenteditable='true'> </table></div>";
      rteObj.enableXhtml = false;
      rteObj.enableXhtml = true;
      rteObj.dataBind();
      expect(rteObj.inputElement.innerHTML).toBe(
        '<div><table contenteditable="true" class="e-rte-table"> </table></div>'
      );
    });
    it('Underline tag', function () {
      ...
      rteObj.dataBind();
      expect(rteObj.inputElement.innerHTML).toBe(
        '<p>Rich <span style="text-decoration: underline;">Text</span> Editor</p><p>Sync<span style="text-decoration: underline;">fusion</span></p>'
      );
    });
    it('Underline tag', function () {
      rteObj.value =
        '<p>Rich<strong>Text</strong> Editor</p><p>Sync<strong>fusion</srong></p>';
      rteObj.enableXhtml = false;
      rteObj.enableXhtml = true;
      rteObj.dataBind();
      expect(rteObj.inputElement.innerHTML).toBe(
        '<p>Rich<b>Text</b> Editor</p><p>Sync<b>fusion</b></p>'
      );
    });
    it('v:image', function () {
      rteObj.value =
        '<p>sync<v:image src="zip.gif"></v:image>sync</p><v:image src="zip.gif"></v:image>';
      rteObj.enableXhtml = false;
      rteObj.enableXhtml = true;
      rteObj.dataBind();
  ...
  describe('IFrame - Util - setEditFrameFocus method testing', function () {
    ...
    it('Set focus with active element testing', function (done) {
      ...
      setTimeout(() => {
        expect(
          (rteObj.contentModule.getPanel() as HTMLIFrameElement).contentWindow
  ...
  describe('Check undo in execCommand', () => {
    ...
    it('Image insert execCommand method', () => {
      ...
      expect(
        rteObj.element
          .querySelector('[title="Undo (Ctrl+Z)"]')
          .classList.contains('e-overlay')
      ).toBe(false);
    });
    afterAll((done) => {
  ...
  describe('RTE content element height check-percentage', function () {
    ...
    beforeAll(function (done) {
      ...
      elem.id = 'defaultRTE';
      document.body.appendChild(elem);
      (document.getElementById('defaultRTE') as HTMLElement).style.display =
        'none';
      rteObj = new RichTextEditor({
        height: '50%',
        toolbarSettings: {
  ...
  describe('EJ2-46060: EJ2CORE-606: 8203 character not removed after start typing', () => {
    ...
    it(' DIV', () => {
      ...
      expect(
        (
          rteObj.element.querySelector('.e-content') as HTMLElement
        ).innerText.search(/\u200B/g) === 0
      ).toBe(true);
      ...
      dispatchKeyEvent(rteObj.element.querySelector('.e-content'), 'keypress', {
        key: 'a',
        keyCode: 65,
      });
      ...
      expect(
        (rteObj.element.querySelector('.e-content') as HTMLElement).innerHTML
      ).toBe(`<p><strong id="focusNode">r</strong></p>`);
    });
    afterEach(() => {
      destroy(rteObj);
    });
  ...
  describe('EJ2-47075: Applying heading to the content in the Rich Text Editor applies heading to the next element', () => {
    ...
    it('Checking the heading format applied for element.', (done: Function) => {
      ...
      rteObj.formatter.editorManager.nodeSelection.setSelectionText(
        ...
        (node as any).nextElementSibling,
        0,
        0
      );
      ...
      expect(
        (rteObj.inputElement.querySelector('#node1') as any).style.textAlign
      ).toBe('right');
      done();
    });
    afterEach(() => {
  ...
  describe('Initial audio and video loading', () => {
    ...
    it('audio and video with BR tags and wrapper loaded', (done: Function) => {
      expect(rteObj.inputElement.querySelector('.e-audio-wrap') !== null).toBe(
        true
      );
      expect(
        rteObj.inputElement.querySelector('.e-audio-wrap').nextElementSibling
          .outerHTML === '<br>'
      ).toBe(true);
      expect(rteObj.inputElement.querySelector('.e-video-wrap') !== null).toBe(
        true
      );
      expect(
        rteObj.inputElement.querySelector('.e-video-wrap').nextElementSibling
          .outerHTML === '<br>'
      ).toBe(true);
      done();
    });
  ...
  describe('Dialog textbox aria-lable checking', () => {
    ...
    it('Dialog textbox aria-lable checking for image, link, audio, video', (done: Function) => {
      ...
      expect(
        rteObj.element
          .querySelector('.e-dialog')
          .querySelector('.e-img-url')
          .getAttribute('aria-label')
      ).toBe('You can also provide a link from the web');
      ...
      expect(
        rteObj.element
          .querySelector('.e-dialog')
          .querySelector('.e-rte-linkurl')
          .getAttribute('aria-label')
      ).toBe('Web address');
      expect(
        rteObj.element
          .querySelector('.e-dialog')
          .querySelector('.e-rte-linkText')
          .getAttribute('aria-label')
      ).toBe('Display text');
      expect(
        rteObj.element
          .querySelector('.e-dialog')
          .querySelector('.e-rte-linkTitle')
          .getAttribute('aria-label')
      ).toBe('Enter a title');
      rteObj.closeDialog(DialogType.InsertLink);
      (
        (<HTMLElement>(
          rteObj.element.querySelectorAll('.e-toolbar-item')[2]
        )) as HTMLElement
      ).click();
      expect(
        rteObj.element
          .querySelector('.e-dialog')
          .querySelector('.e-audio-url')
          .getAttribute('aria-label')
      ).toBe('You can also provide a link from the web');
      rteObj.closeDialog(DialogType.InsertAudio);
      (
        (<HTMLElement>(
          rteObj.element.querySelectorAll('.e-toolbar-item')[3]
        )) as HTMLElement
      ).click();
      expect(
        rteObj.element
          .querySelector('.e-dialog')
          .querySelector('.e-embed-video-url')
          .getAttribute('aria-label')
      ).toBe('Media Embed URL');
  ...
  describe('fontfamily testing after default value set -', () => {
        ...
        fontFamily: {
          ...
          items: [
            ...
            },
            {
              text: 'Verdana',
              value:
                'verdana, "Myriad Pro", Myriad, Helvetica,Arial, sans-serif',
              command: 'Font',
              subCommand: 'FontName',
            },
          ],
    ...
    it('Dynamic mode RTE testing fontfamily', (done: Function) => {
      ...
      nodetext = (
        (<any>rteObj).contentModule.getEditPanel().childNodes[1] as HTMLElement
      ).firstElementChild.firstChild;
      setCursorPoint(document, nodetext, nodetext.textContent.length);
      (<any>rteObj).keyDown(EnterkeyboardEventArgs);
      (
  ...
  describe('Toobar item focus testing -', () => {
    ...
    it('checking the toolbar item is in active state', (done: Function) => {
      ...
      expect(
        ...
        ).parentElement.classList.contains('e-active')
      ).toBe(true);
      (
        (
          elem.querySelectorAll('.e-toolbar-item')[0] as HTMLElement
      ...
      (
        (
          elem.querySelectorAll('.e-toolbar-item')[2] as HTMLElement
        ).querySelector('button') as HTMLButtonElement
      ).click();
      expect(
        (
  ...
  describe('EJ2-71449 - The placeholder and enter text values have merged', function () {
    ...
    it('The placeholder needs to be removed when entering the value', function (done) {
      ...
      let SourceCodePicker: HTMLElement = <HTMLElement>(
      ...
      rteObj.focusIn();
      setTimeout(() => {
        expect((rteObj as any).element.querySelector('rte-placeholder')).toBe(
          null
        );
        done();
      }, 100);
  ...
  describe('836937 - Rich Text Editor Table Module', function () {
    ...
    it('Table selection', function (done) {
      rteObj.focusIn();
      let element: Element = rteObj.contentModule
        .getDocument()
        .getElementById('elementCursorPosition');
      ...
      setTimeout(() => {
        expect(
          (window.getSelection().anchorNode as any).closest('td') == null
        ).toBe(true);
        done();
      }, 100);
    });
    it('Remove the selection from the previous table', function (done) {
      rteObj.focusIn();
      var tdElement = rteObj.contentModule
        .getDocument()
        .getElementsByClassName('tdElement');
      let selectioncursor: NodeSelection = new NodeSelection();
      let range: Range = document.createRange();
      ...
      rteObj.mouseDownHandler({
        target: rteObj.element.querySelectorAll('.tdElement')[0],
        isTrusted: true,
      });
      ...
      setTimeout(() => {
        expect(
          rteObj.element
            .querySelectorAll('.tdElement')[0]
            .classList.contains('e-cell-select') == false
        ).toBe(true);
        done();
      }, 100);
    });
  ...
  describe('842745 - Space Keypress causes the console error and the cursor position is removed', () => {
    ...
    it('826826 - Space Keypress causes the console error and the cursor position is removed', () => {
      ...
      setCursorPoint(
        document,
        focusNode.childNodes[1],
        focusNode.childNodes[1].textContent.length
      );
      keyBoardEvent.type = 'keyup';
      (rteObj as any).keyUp(keyBoardEvent);
  ...
  describe('846696 - Ctrl+Z undo doesn’t works in smart suggestion sample', () => {
    ...
    it('Undo with keyboard action initial status', () => {
      ...
      rteObj.dataBind();
      expect(
        rteObj.formatter.editorManager.undoRedoManager.undoRedoStack[0] != null
      ).toBe(true);
    });
    afterAll(() => {
      destroy(rteObj);
  ...
  describe('820213 - Text get deleted while applying bold', () => {
    ...
    it('apply the bold to the text', () => {
      ...
      let boldEle: HTMLElement = document.querySelector(
        '[title="Bold (Ctrl+B)"]'
      );
      boldEle.click();
      ...
      expect(
        rteObj.inputElement.innerHTML ===
          '<p class="focusNode">Rich <strong>Text</strong>​ Editor</p>'
      ).toBe(true);
    });
    afterAll(() => {
      destroy(rteObj);
  ...
  describe('852045 - Not able to resize the table when having saveInterval as 1.', function () {
    ...
    it('Table resize gripper element', function (done) {
      let table: any = (rteObj.tableModule as any).contentModule
        .getEditPanel()
        .querySelector('table');
      (rteObj.tableModule as any).resizeHelper({
        target: table,
        preventDefault: function () {},
      });
      expect(
        rteObj.contentModule.getEditPanel().querySelectorAll('.e-table-box') !==
          null
      ).toBe(true);
      rteObj.focusIn();
      setTimeout(function () {
        ...
        expect(resizeElement.querySelectorAll('.e-table-box').length == 0).toBe(
          true
        );
        done();
      }, 400);
      ...
      setTimeout(() => {
        expect(
          editor.contentModule
            .getEditPanel()
            .querySelectorAll(
              '.e-column-resize, .e-row-resize, .e-table-box, .e-table-rhelper, .e-img-resize'
            ).length
        ).toBe(0);
        done();
      }, 100);
  ...
  describe('872399 - Close the table popup using esc key, the focus does not move table icon ', () => {
    ...
    it('Should focus on the toolbar element instead of the Editor content.', (done: DoneFn) => {
      editor.focusIn();
      const tableButton: HTMLElement = editor.element.querySelector(
        '.e-rte-toolbar .e-toolbar-item button'
      );
      tableButton.click();
      const escapekeyUpEvent: KeyboardEvent = new KeyboardEvent('keyup', {
        key: 'Escape',
        code: 'Escape',
        bubbles: true,
        cancelable: true,
  ...
  describe('852939 - Undo redo is enabled by default in the quick format toolbar sample issue', () => {
    ...
    it('Checking the undo and rendo is in the disable state when the toolbar type is multi-row.', () => {
      ...
      expect(
        elem
          .querySelectorAll('.e-toolbar-item')[14]
          .classList.contains('e-overlay')
      ).toBe(true);
      expect(
        elem
          .querySelectorAll('.e-toolbar-item')[15]
          .classList.contains('e-overlay')
      ).toBe(true);
    });
  ...
  describe('865021 - in smart suggestions Tab key press on the list is not working properly.', () => {
    let elem: string =
      '<div class="e-content e-lib e-keyboard e-mention" id="smartSuggestionRTE_rte-edit-view" contenteditable="true" tabindex="0" role="textbox" aria-label="mention"><ol><li>Testing 1</li><li>Testing 2</li><li>Testing 3</li></ol></div>';
    let rteObj: RichTextEditor;
    let rteEle: HTMLElement;
    beforeAll(() => {
      rteObj = renderRTE({
    ...
    it(' in smart suggestions Tab key press on the list is not working properly', () => {
      let contentEditableDiv: HTMLElement = document.getElementById(
        'smartSuggestionRTE_rte-edit-view'
      );
      let range = document.createRange();
      let selection = window.getSelection();
      range.setStart(
        (contentEditableDiv as HTMLElement).firstChild.firstChild,
        0
      );
      ...
      expect(
        contentEditableDiv.outerHTML ===
          '<div class="e-content e-lib e-keyboard e-mention" id="smartSuggestionRTE_rte-edit-view" contenteditable="true" tabindex="0" role="textbox" aria-label="mention"><ol><li style="list-style-type: none;"><ol><li>Testing 1</li></ol></li><li>Testing 2</li><li>Testing 3</li></ol></div>'
      ).toBe(true);
    });
    afterAll(() => {
      destroy(rteObj);
  ...
  describe('850064 -  Quotation format not changed while changing the format', () => {
    ...
    it('toggle option to list for blockquotes', (done: Function) => {
      setCursorPoint(
        document,
        rteObj.inputElement.querySelector('li').childNodes[0] as Element,
        0
      );
      let formatsDropDown: HTMLElement = rteObj.element.querySelector(
        '#' + rteObj.element.id + '_toolbar_Formats'
      );
      formatsDropDown.click();
      (
        document
          .querySelector('#' + rteObj.element.id + '_toolbar_Formats-popup')
          .querySelector('.e-item.e-quote') as HTMLElement
      ).click();
      expect(
        rteObj.inputElement
          .querySelector('li')
          .parentElement.parentElement.nodeName.toLowerCase() === 'blockquote'
      ).toBe(true);
      formatsDropDown.click();
      (
        document
    ...
    it('toggle option to paragraph for blockquotes', (done: Function) => {
      ...
      setCursorPoint(
        document,
        rteObj.inputElement.querySelector('blockquote')
      ...
      expect(
        isNullOrUndefined(rteObj.inputElement.querySelector('blockquote'))
      ).toBe(true);
      done();
    });
    it('toggle option to paragraph for blockquotes', (done: Function) => {
    ...
    it('revert from blockquotes while pressing enter key', (done: Function) => {
      ...
      setCursorPoint(
        document,
        rteObj.inputElement.querySelector('ol').nextSibling.nextSibling
          .childNodes[0] as Element,
        0
      );
      let keyBoardEvent: any = {
      ...
      expect(
        !isNullOrUndefined(
          rteObj.inputElement.querySelector('blockquote').nextSibling
        )
      ).toBe(false);
      (rteObj as any).keyDown(keyBoardEvent);
      expect(
    ...
    it('revert from blockquotes while pressing enter key while configuring zerowidthspace', (done: Function) => {
      ...
      expect(
        rteObj.inputElement.innerHTML ===
          `<blockquote><ol><li>testing</li></ol><p>​</p></blockquote><p><br></p>`
      ).toBe(true);
      done();
    });
    ...
    it('revert from blockquotes while pressing enter key while configuring zerowidthspace', (done: Function) => {
      ...
      expect(
        rteObj.inputElement.innerHTML ===
          `<blockquote><ol><li>testing</li></ol><p>testing</p></blockquote><p><br></p>`
      ).toBe(true);
      done();
    });
    afterEach((done) => {
  ...
  describe('876271 - Checking the tooltip is notshown when the dropdown is in open state', () => {
    ...
    it('Checking the tooltip is notshown when the dropdown is in open state', (done: Function) => {
      ...
      expect((dropButton[0] as HTMLElement).getAttribute('data-content')).toBe(
        null
      );
      done();
    });
  ...
  describe('881576 - The tooltips are not destroyed when the dialog with the editor is closed by a keyboard action.', () => {
    ...
    it('Tooltip hide while Esc key is pressed', (done: Function) => {
      const toolbarItems: NodeListOf<Element> =
        document.querySelectorAll('.e-toolbar-item');
      event = new MouseEvent('mouseover', { bubbles: true, cancelable: true });
  ...
  describe('Null or undefined value testing', () => {
    ...
    it('emojiPickerSettings', () => {
      ...
      rteObj.destroy();
      rteObj = new RichTextEditor({
        emojiPickerSettings: { iconsSet: undefined },
      });
      rteObj.appendTo('#rteTarget');
      expect(rteObj.emojiPickerSettings.iconsSet.length === 7).toBe(true);
      rteObj.destroy();
      rteObj = new RichTextEditor({
        emojiPickerSettings: { showSearchBox: null },
      });
      rteObj.appendTo('#rteTarget');
      expect(rteObj.emojiPickerSettings.showSearchBox).toBe(null);
      rteObj.destroy();
      rteObj = new RichTextEditor({
        emojiPickerSettings: { showSearchBox: undefined },
      });
      rteObj.appendTo('#rteTarget');
    ...
    it('fileManagerSettings', () => {
      ...
      rteObj.destroy();
      rteObj = new RichTextEditor({
        fileManagerSettings: { enable: undefined },
      });
      rteObj.appendTo('#rteTarget');
      ...
      //rteObj.fileManagerSettings.path
      rteObj = new RichTextEditor({
        fileManagerSettings: { ajaxSettings: null },
      });
      rteObj.appendTo('#rteTarget');
      expect(rteObj.fileManagerSettings.ajaxSettings).not.toBe(null);
      rteObj.destroy();
      rteObj = new RichTextEditor({
        fileManagerSettings: { ajaxSettings: undefined },
      });
      rteObj.appendTo('#rteTarget');
      expect(rteObj.fileManagerSettings.ajaxSettings).not.toBe(null);
      rteObj.destroy();
      ...
      rteObj = new RichTextEditor({
        fileManagerSettings: { contextMenuSettings: null },
      });
      rteObj.appendTo('#rteTarget');
      expect(rteObj.fileManagerSettings.contextMenuSettings).not.toBe(null);
      rteObj.destroy();
      rteObj = new RichTextEditor({
        fileManagerSettings: { contextMenuSettings: undefined },
      });
      rteObj.appendTo('#rteTarget');
      expect(rteObj.fileManagerSettings.contextMenuSettings).not.toBe(null);
      rteObj.destroy();
      ...
      rteObj = new RichTextEditor({
        fileManagerSettings: { navigationPaneSettings: null },
      });
      rteObj.appendTo('#rteTarget');
      expect(rteObj.fileManagerSettings.navigationPaneSettings).not.toBe(null);
      rteObj.destroy();
      rteObj = new RichTextEditor({
        fileManagerSettings: { navigationPaneSettings: undefined },
      });
      rteObj.appendTo('#rteTarget');
      expect(rteObj.fileManagerSettings.navigationPaneSettings).not.toBe(null);
      rteObj.destroy();
      ...
      rteObj = new RichTextEditor({
        fileManagerSettings: { toolbarSettings: null },
      });
      rteObj.appendTo('#rteTarget');
      expect(rteObj.fileManagerSettings.toolbarSettings).not.toBe(null);
      rteObj.destroy();
      rteObj = new RichTextEditor({
        fileManagerSettings: { toolbarSettings: undefined },
      });
      rteObj.appendTo('#rteTarget');
      expect(rteObj.fileManagerSettings.toolbarSettings).not.toBe(null);
      rteObj.destroy();
      ...
      rteObj = new RichTextEditor({
        fileManagerSettings: { uploadSettings: null },
      });
      rteObj.appendTo('#rteTarget');
      expect(rteObj.fileManagerSettings.uploadSettings).not.toBe(null);
      rteObj.destroy();
      rteObj = new RichTextEditor({
        fileManagerSettings: { uploadSettings: undefined },
      });
      rteObj.appendTo('#rteTarget');
      expect(rteObj.fileManagerSettings.uploadSettings).not.toBe(null);
      rteObj.destroy();
    ...
    it('formatPainterSettings', () => {
      ...
      rteObj = new RichTextEditor({
        formatPainterSettings: { allowedFormats: null },
      });
      rteObj.appendTo('#rteTarget');
      expect(rteObj.formatPainterSettings.allowedFormats).toBe(null);
      rteObj.destroy();
      rteObj = new RichTextEditor({
        formatPainterSettings: { allowedFormats: undefined },
      });
      rteObj.appendTo('#rteTarget');
      expect(rteObj.formatPainterSettings.allowedFormats).toBe(
        'b; em; font; sub; sup; kbd; i; s; u; code; strong; span; p; div; h1; h2; h3; h4; h5; h6; blockquote; ol; ul; li; pre;'
      );
      rteObj.destroy();
      // formatPainterSettings.deniedFormats
      rteObj = new RichTextEditor({
        formatPainterSettings: { deniedFormats: null },
      });
      rteObj.appendTo('#rteTarget');
      expect(rteObj.formatPainterSettings.deniedFormats).toBe(null);
      rteObj.destroy();
      rteObj = new RichTextEditor({
        formatPainterSettings: { deniedFormats: undefined },
      });
      rteObj.appendTo('#rteTarget');
      expect(rteObj.formatPainterSettings.deniedFormats).toBe(null);
      rteObj.destroy();
    ...
    it('iframeSettings', () => {
      ...
      rteObj.destroy();
      rteObj = new RichTextEditor({
        iframeSettings: { attributes: undefined },
      });
      rteObj.appendTo('#rteTarget');
      expect(rteObj.iframeSettings.attributes).toBe(null);
      rteObj.destroy();
    ...
    it('insertAudioSettings', () => {
      ...
      rteObj = new RichTextEditor({
        insertAudioSettings: { allowedTypes: null },
      });
      rteObj.appendTo('#rteTarget');
      ...
      rteObj = new RichTextEditor({
        insertAudioSettings: { layoutOption: null },
      });
      rteObj.appendTo('#rteTarget');
      ...
      rteObj = new RichTextEditor({
        insertAudioSettings: { saveFormat: null },
      });
      rteObj.appendTo('#rteTarget');
    ...
    it('insertImageSettings', () => {
      ...
      rteObj = new RichTextEditor({
        insertImageSettings: { allowedTypes: null },
      });
      rteObj.appendTo('#rteTarget');
      ...
      rteObj = new RichTextEditor({
        insertImageSettings: { saveFormat: null },
      });
      rteObj.appendTo('#rteTarget');
    ...
    it('insertVideoSettings', () => {
      ...
      rteObj = new RichTextEditor({
        insertVideoSettings: { allowedTypes: null },
      });
      rteObj.appendTo('#rteTarget');
      ...
      rteObj = new RichTextEditor({
        insertVideoSettings: { layoutOption: null },
      });
      rteObj.appendTo('#rteTarget');
      ...
      rteObj = new RichTextEditor({
        insertVideoSettings: { saveFormat: null },
      });
      rteObj.appendTo('#rteTarget');
    ...
    it('quickToolbarSettings', () => {
      ...
      rteObj.destroy();
      rteObj = new RichTextEditor({
        quickToolbarSettings: { enable: undefined },
      });
      rteObj.appendTo('#rteTarget');
      ...
      rteObj = new RichTextEditor({
        quickToolbarSettings: { actionOnScroll: null },
      });
      rteObj.appendTo('#rteTarget');
      expect(rteObj.quickToolbarSettings.actionOnScroll).toBe(null);
      rteObj.destroy();
      rteObj = new RichTextEditor({
        quickToolbarSettings: { actionOnScroll: undefined },
      });
      rteObj.appendTo('#rteTarget');
      ...
      rteObj.destroy();
      rteObj = new RichTextEditor({
        quickToolbarSettings: { link: undefined },
      });
      rteObj.appendTo('#rteTarget');
      ...
      rteObj.destroy();
      rteObj = new RichTextEditor({
        quickToolbarSettings: { image: undefined },
      });
      rteObj.appendTo('#rteTarget');
      ...
      rteObj.destroy();
      rteObj = new RichTextEditor({
        quickToolbarSettings: { text: undefined },
      });
      rteObj.appendTo('#rteTarget');
      expect(rteObj.quickToolbarSettings.text).toBe(null);
      rteObj.destroy();
      ...
      rteObj.destroy();
      rteObj = new RichTextEditor({
        quickToolbarSettings: { table: undefined },
      });
      rteObj.appendTo('#rteTarget');
      ...
      rteObj.destroy();
      rteObj = new RichTextEditor({
        quickToolbarSettings: { audio: undefined },
      });
      rteObj.appendTo('#rteTarget');
      ...
      rteObj.destroy();
      rteObj = new RichTextEditor({
        quickToolbarSettings: { video: undefined },
      });
      rteObj.appendTo('#rteTarget');
    ...
    it('toolbarSettings', () => {
      ...
      rteObj = new RichTextEditor({
        toolbarSettings: { enableFloating: null },
      });
      rteObj.appendTo('#rteTarget');
