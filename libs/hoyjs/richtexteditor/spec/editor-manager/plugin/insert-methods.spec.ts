...
describe('Insert- Methods', () => {
  ...
  it('WrapBefore method with existing node', () => {
    ...
    expect(
      document.getElementById('span1').childNodes[0].nodeName.toLowerCase()
    ).toEqual('strong');
  });

  it('WrapBefore method with Non - existing node', () => {
    let node: Text = document.createTextNode('Text Node');
    let textnode: Text = InsertMethods.WrapBefore(
      node,
  ...
  it('WrapAfter method with existing node', () => {
    ...
    expect(
      document.getElementById('span2').childNodes[2].nodeName.toLowerCase()
    ).toEqual('strong');
  });
  ...
  it('Wrap method with existing node', () => {
    let node: HTMLElement = document.getElementById('span3')
      .childNodes[0] as HTMLElement;
    InsertMethods.Wrap(node, document.createElement('strong'));
    expect(
      document.getElementById('span3').childNodes[0].nodeName.toLowerCase()
    ).toEqual('strong');
  });
