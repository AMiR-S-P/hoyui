...
describe('Alignments plugin', () => {
  ...
  describe('873565 - Alignment not working when enter key is configured as BR', () => {
    ...
    it('Checking the alignments', () => {
      ...
      expect(
        editNode.innerHTML ===
          `Content 1&nbsp;<strong>line</strong><br><div style="text-align: right;"><strong class="startFocus">Content 2 line</strong></div><div style="text-align: right;"><strong class="endFocus">Content 3&nbsp;</strong>line</div>Content 4&nbsp;<strong>line</strong>`
      ).toBe(true);
    });
    ...
    it('Checking the alignments with bold in the content ', () => {
      ...
      expect(
        editNode.innerHTML ===
          `Content 1 line<br><div style="text-align: right;">Content 2&nbsp;<strong class="startFocus">line&nbsp;</strong>extended</div><div style="text-align: right;">Content 3 line</div><div style="text-align: right;">Content 4 line</div>`
      ).toBe(true);
    });
    afterAll(() => {
      detach(elem);
