 ...
 * Indents plugin spec
 */
import { createElement, detach, isNullOrUndefined } from '@hoyui/base';
...
describe('Indents plugin', () => {
  ...
  describe(' apply Indents to List element testing', () => {
    ...
    it(' Outdent format to list', () => {
      ...
      expect(!isNullOrUndefined(start.parentElement.querySelector('ul'))).toBe(
        false
      );
      editorObj.execCommand('Indents', 'Outdent', null);
      start = elem.querySelector('.second-p-node');
  ...
  describe('873565 - Indent not working when enter key is configured as BR', () => {
    ...
    let elem: HTMLElement = createElement('div', {
      id: 'dom-node',
      innerHTML: `<div id="content-edit" contenteditable="true">Content 1&nbsp;<strong>line</strong><br><strong class="startFocus">Content 2 line</strong><br><strong class="endFocus">Content 3&nbsp;</strong>line<br>Content 4&nbsp;<strong>line</strong></div>`,
    });
    beforeAll(() => {
      document.body.appendChild(elem);
      editorObj = new EditorManager({
    ...
    it('Checking the indent when BR configured', () => {
      ...
      expect(
        editNode.innerHTML ===
          `Content 1&nbsp;<strong>line</strong><br><div style="margin-left: 20px;"><strong class="startFocus">Content 2 line</strong></div><div style="margin-left: 20px;"><strong class="endFocus">Content 3&nbsp;</strong>line</div>Content 4&nbsp;<strong>line</strong>`
      ).toBe(true);
    });
    ...
    it('Checking the indent with bold in the content ', () => {
      ...
      expect(
        editNode.innerHTML ===
          `Content 1 line<br><div style="margin-left: 20px;">Content 2&nbsp;<strong class="startFocus">line&nbsp;</strong>extended</div><div style="margin-left: 20px;">Content 3 line</div><div style="margin-left: 20px;">Content 4 line</div>`
      ).toBe(true);
    });
    afterAll(() => {
      detach(elem);
