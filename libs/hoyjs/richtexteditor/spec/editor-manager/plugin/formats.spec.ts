...
describe('Formats plugin', () => {
  ...
  describe(' BlockQuote Formats testing', () => {
    ...
    it(' apply blockquote format', () => {
      ...
      expect(
        changeNode.parentElement.tagName.toLowerCase() === 'blockquote'
      ).toBe(true);
      ...
      expect(start.parentElement.tagName.toLowerCase() === 'blockquote').toBe(
        true
      );
      expect(end.parentElement.tagName.toLowerCase() === 'blockquote').toBe(
        true
      );
      ...
      expect(
        (start as Element).parentElement.tagName.toLowerCase() === 'blockquote'
      ).toBe(true);
  ...
  describe(' Header 6 Formats testing', () => {
    ...
    it('select all with last element as table', () => {
      ...
      editorObj.nodeSelection.setSelectionText(
        document,
        start.childNodes[0],
        editorObj.editableElement,
        0,
        4
      );
      editorObj.execCommand('Formats', 'h6', null);
      expect(window.getSelection().focusNode.textContent === 'Cell 2 2').toBe(
        true
      );
  ...
  describe(' Pre format testing', () => {
    ...
    it('select all with last element as table', () => {
      ...
      editorObj.execCommand('Formats', 'pre', null);
      expect(
        elem.querySelector('#p1').innerHTML ===
          'Paragraph 1<br>Paragraph 2<br>Paragraph 3'
      ).toBe(true);
      expect(
        elem.querySelector('table').querySelectorAll('pre').length === 4
      ).toBe(true);
      editorObj.nodeSelection.Clear(document);
    });
    afterAll(() => {
  ...
  describe(' Pre format Enter key testing', () => {
    ...
    it('Enter key at the start of the pre text', () => {
      let elem: HTMLElement = editorObj.editableElement as HTMLElement;
      let start: HTMLElement = elem.querySelector('#p1');
      editorObj.nodeSelection.setCursorPoint(
        document,
      ...
      expect(
        start.innerHTML ===
          'Paragraph 1<br>Paragraph 2<br>Paragraph 3<br>Paragraph 4<br>Paragraph 5<br>Paragraph 6'
      ).toBe(true);
      (editorObj as any).editorKeyDown(keyBoardEvent);
      expect(
        start.innerHTML ===
          '<br>Paragraph 1<br>Paragraph 2<br>Paragraph 3<br>Paragraph 4<br>Paragraph 5<br>Paragraph 6'
      ).toBe(true);
    });
    it('Enter key at the middle of the pre text', () => {
      ...
      expect(
        expectedElem.innerHTML ===
          '<br>Para<br>graph 1<br>Paragraph 2<br>Paragraph 3<br>Paragraph 4<br>Paragraph 5<br>Paragraph 6'
      ).toBe(true);
    });
    it('Enter key at the middle of the pre text but at the end of the current line', () => {
      ...
      expect(
        expectedElem.innerHTML ===
          '<br>Para<br><br>graph 1<br>Paragraph 2<br>Paragraph 3<br>Paragraph 4<br>Paragraph 5<br>Paragraph 6'
      ).toBe(true);
    });
    it('Enter key at the start of the pre textbefore br tag', () => {
      ...
      expect(
        expectedElem.innerHTML ===
          '<br><br>Para<br><br>graph 1<br>Paragraph 2<br>Paragraph 3<br>Paragraph 4<br>Paragraph 5<br>Paragraph 6'
      ).toBe(true);
    });
    it('Enter key at the middle of the pre text inbetween br tag', () => {
      ...
      expect(
        expectedElem.innerHTML ===
          '<br><br>Para<br><br><br>graph 1<br>Paragraph 2<br>Paragraph 3<br>Paragraph 4<br>Paragraph 5<br>Paragraph 6'
      ).toBe(true);
    });
    it('Enter key with selection at the middle of the pre tag', () => {
      ...
      expect(
        expectedElem.innerHTML ===
          '<br><br>P<br>ph 1<br>Paragraph 2<br>Paragraph 3<br>Paragraph 4<br>Paragraph 5<br>Paragraph 6'
      ).toBe(true);
    });
    it('Enter key with selection as start to middle of the pre tag', () => {
      ...
      expect(
        expectedElem.innerHTML ===
          '<br>Paragraph 4<br>Paragraph 5<br>Paragraph 6'
      ).toBe(true);
    });
    it('Enter key with end of the pre tag', () => {
      ...
      editorObj.nodeSelection.setCursorPoint(
        document,
        start.childNodes[5] as Element,
        11
      );
      expect(
        start.innerHTML === '<br>Paragraph 4<br>Paragraph 5<br>Paragraph 6'
      ).toBe(true);
      (editorObj as any).editorKeyDown(keyBoardEvent);
      let expectedElem: HTMLElement = elem.querySelector('#p1');
      expect(
        expectedElem.innerHTML ===
          '<br>Paragraph 4<br>Paragraph 5<br>Paragraph 6<br><br>'
      ).toBe(true);
    });
    it('Double enter key press at the end of the pre tag', () => {
      ...
      expect(
        expectedElem.innerHTML ===
          `<br>Paragraph 4<br>Paragraph 5<br>Paragraph 6<br>`
      ).toBe(true);
  ...
  describe(' Pre format Enter key testing - 2', () => {
    ...
    it('Enter key at the start of the pre text', () => {
      ...
      expect(
        elem.querySelector('#p1').innerHTML === 'graph 1<br>Paragraph 2'
      ).toBe(true);
    });
    it('Enter key at the start of the pre text', () => {
      let elem: HTMLElement = editorObj.editableElement as HTMLElement;
      ...
      expect(elem.querySelector('#p1').innerHTML === 'graph 1<br>Para').toBe(
        true
      );
    });
  ...
  describe(' Apply blockquotes after improvement', () => {
    ...
    it(' - select all content and applying blockquote', () => {
      ...
      expect(
        elem.querySelector('#startNode').parentElement.tagName === 'BLOCKQUOTE'
      ).toBe(true);
      expect(
        elem.querySelector('#endNode').parentElement.tagName === 'BLOCKQUOTE'
      ).toBe(true);
    ...
    it(' - few lines(middle) of selection and then applying blockquotes to the content that already blockquotes', () => {
      ...
      expect(
        elem.innerHTML ===
          `<blockquote><p>Content 1</p></blockquote><p id="startNode">Content 2</p><p id="endNode">Content 3</p><blockquote><p>Content 4</p><p>Content 5</p></blockquote>`
      ).toBe(true);
      editorObj.nodeSelection.Clear(document);
    });
    ...
    it(' - applying blockquotes for selection start as normal text and end has blockquotes content ', () => {
      ...
      expect(
        elem.innerHTML ===
          `<blockquote><p>Content 1</p></blockquote><p>Content 2</p><blockquote><p id="startNode">Content 3</p><p id="endNode">Content 4</p><p>Content 5</p></blockquote>`
      ).toBe(true);
      editorObj.nodeSelection.Clear(document);
    });
    ...
    it(' - applying blockquotes for selection start as blockquote text and end has normal text ', () => {
      ...
      expect(
        elem.innerHTML ===
          `<blockquote><p id="startNode">Content 1</p><p id="endNode">Content 2</p></blockquote><p>Content 3</p><blockquote><p>Content 4</p><p>Content 5</p></blockquote>`
      ).toBe(true);
      editorObj.nodeSelection.Clear(document);
    });
    ...
    it(' - applying blockquotes for selection start as blockquote text and end has blockquote text with text content as middle', () => {
      ...
      expect(
        elem.innerHTML ===
          `<blockquote><p>Content 1</p></blockquote><p id="startNode">Content 2</p><p>Content 3</p><p id="endNode">Content 4</p><blockquote><p>Content 5</p></blockquote>`
      ).toBe(true);
      editorObj.nodeSelection.Clear(document);
    });
    ...
    it(' - applying blockquotes for selection start as normal text and end has normal text with blockquote content as middle', () => {
      ...
      expect(
        elem.innerHTML ===
          `<p>Content 1</p><blockquote><p id="startNode">Content 2</p><p>Content 3</p><p id="endNode">Content 4</p></blockquote><p>Content 5</p><p>Content 6</p>`
      ).toBe(true);
      editorObj.nodeSelection.Clear(document);
    });
    ...
    it(' - applying blockquotes for selection start as normal text and end has list text', () => {
      ...
      expect(
        elem.innerHTML ===
          `<blockquote><p id="startNode">Content 1</p><p>Content 2</p><p>Content 3</p><ol><li>List 1</li><li>List 2</li><li id="endNode">List 3</li></ol></blockquote>`
      ).toBe(true);
      editorObj.nodeSelection.Clear(document);
    });
    ...
    it(' - applying blockquotes for selection start as normal text and end has normal text with enter action as BR', () => {
      ...
      expect(
        elem.innerHTML ===
          `<blockquote>Content 1<br>Content 2<br>Content 3<br>Content 4<br>Content 5</blockquote>`
      ).toBe(true);
      editorObj.nodeSelection.Clear(document);
    });
    ...
    it(' - applying blockquotes for by focusing the first table TD cell', () => {
      ...
      expect(
        elem.innerHTML ===
          `<table class="e-rte-table" style="width: 100%; min-width: 0px;"><tbody><tr><td class="" style="width: 50%;" id="startNode"><blockquote><p><br></p></blockquote></td><td style="width: 50%;"><br></td></tr><tr><td style="width: 50%;"><br></td><td style="width: 50%;"><br></td></tr></tbody></table><p><br></p>`
      ).toBe(true);
      editorObj.nodeSelection.Clear(document);
    });
    ...
    it(' - enter key press inside list when blockquote is applied to the list', () => {
      ...
      expect(
        elem.innerHTML ===
          `<blockquote><ol><li>List 1</li><li>List 2</li><li>List 3</li></ol><br></blockquote>`
      ).toBe(true);
      editorObj.nodeSelection.Clear(document);
    });
    ...
    it(' - reverting the blockquotes for the list with blockquotes', () => {
      ...
      expect(
        elem.innerHTML ===
          `<ol><li id="startNode">List 1</li><li>List 2</li><li>List 3</li></ol>`
      ).toBe(true);
      editorObj.nodeSelection.Clear(document);
    });
