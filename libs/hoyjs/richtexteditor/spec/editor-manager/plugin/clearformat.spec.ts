...
describe('Clear Format commands', () => {
  ...
  it('Clear OL LI img element', () => {
    ...
    ClearFormat.clear(document, divElement, 'P');
    expect(
      document.getElementById('div2').childNodes[0].nodeName.toLowerCase()
    ).toEqual('p');
  });
  it('Clear OL LI textnode element', () => {
    ...
    ClearFormat.clear(document, divElement, 'P');
    expect(
      document.getElementById('div3').childNodes[0].nodeName.toLowerCase()
    ).toEqual('p');
  });
  it('Clear inline element', () => {
    ...
    domSelection.setSelectionText(
      ...
      node2,
      2,
      node2.childNodes.length - 1
    );
    ClearFormat.clear(document, divElement, 'P');
    expect(
      document.getElementById('div5').childNodes[1].nodeName.toLowerCase()
    ).toEqual('#text');
    expect(
      document.getElementById('div5').querySelectorAll('b').length
    ).toEqual(0);
  });
  it('Clear LI  element', () => {
    new ClearFormat();
    ...
    ClearFormat.clear(document, divElement, 'P');
    expect(
      document.getElementById('div4').childNodes[0].nodeName.toLowerCase()
    ).toEqual('p');
    expect(
      document
        .getElementById('div4')
  ...
  it('Paragraph with bold  element specific selection', () => {
    ...
    ClearFormat.clear(document, divElement, 'P');
    expect(
      document.getElementById('paragraph3').childNodes[0].nodeName.toLowerCase()
    ).toEqual('b');
  });
  ...
  it('mulitple Paragraph with specific selection', () => {
    ...
    ClearFormat.clear(document, divElement, 'P');
    expect(
      document.getElementById('paragraph1').childNodes[1].nodeName.toLowerCase()
    ).toEqual('#text');
  });
...
describe('Clear Format commands', () => {
  ...
  it('Clear format when enter key is configured as `div` - ', () => {
    new ClearFormat();
    let node1: Node =
      document.getElementById('divElement').childNodes[0].childNodes[0]
        .childNodes[0];
    domSelection.setSelectionText(
      document,
      node1,
      node1,
      0,
      node1.textContent.length
    );
    ClearFormat.clear(document, divElement, 'DIV');
    expect(
      document.getElementById('divElement').children[0].nodeName !== 'P'
    ).toBe(true);
    expect(
      document.getElementById('divElement').children[0].nodeName === 'DIV'
    ).toBe(true);
  });
});
...
describe('Clear Format with image caption', () => {
  ...
  it('EJ2-56310 - Clear format testing for the image caption', () => {
    ...
    expect(document.querySelector('.e-img-inner').childElementCount === 0).toBe(
      true
    );
  });
});
  ...
  it(' - double line with p tags and blockquote', () => {
    ...
    let node1: Node =
      document.getElementById('divElement').childNodes[0].childNodes[0]
        .childNodes[0];
    let node2: Node =
      document.getElementById('divElement').childNodes[0].childNodes[1]
        .childNodes[0];
    domSelection.setSelectionText(
      document,
      node1,
    ...
    ClearFormat.clear(document, divElement, 'P');
    expect(
      document.getElementById('divElement').children[0].childElementCount
    ).toBe(2);
  });
