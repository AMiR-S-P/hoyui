...
describe('Insert HTML  Exec plugin', () => {
  describe('apply bold testing', () => {
    ...
    it('Insert a Span', () => {
      ...
      expect(
        document
          .querySelector('.first-p-node')
          .childNodes[5].nodeName.toLowerCase()
      ).toBe('span');
    });
    it('Insert an Image', () => {
    ...
    it('selecting an Image selection', () => {
      ...
      editorObj.execCommand('InsertHtml', null, null, null, img);
      expect(
        document.getElementById('span1').childNodes[1].nodeName.toLowerCase()
      ).toBe('img');
    });
    it('last an Image selection', () => {
      ...
      expect(
        document
          ...
          .nextElementSibling.children[0].getAttribute('id')
      ).toBe(spanElem.getAttribute('id'));
    });
    it('Insert a Span', () => {
