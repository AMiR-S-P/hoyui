import { Property, ChildProperty, Complex, Event, EmitType } from '@hoyui/base';
import {
  AjaxSettings,
  AjaxSettingsModel,
  ContextMenuSettings,
...
import {
  ToolbarSettingsModel as FileToolbarSettingsModel,
  ToolbarSettings as FileToolbarSettings,
} from '@hoyui/filemanager';
import {
  UploadSettings,
  UploadSettingsModel,
...
export class FileManagerSettings extends ChildProperty<FileManagerSettings> {
   ...
   * }
   */
  @Complex<AjaxSettingsModel>(
    { getImageUrl: null, url: null, uploadUrl: null },
    AjaxSettings
  )
   ...
   * }
   */
  @Complex<ContextMenuSettingsModel>(
    {
      visible: true,
      file: [
        'Open',
   ...
   */
  @Complex<NavigationPaneSettingsModel>(
    { maxWidth: '650px', minWidth: '240px', visible: true },
    NavigationPaneSettings
  )
   ...
   */
  @Complex<FileToolbarSettingsModel>(
    {
      visible: true,
      items: [
        'NewFolder',
