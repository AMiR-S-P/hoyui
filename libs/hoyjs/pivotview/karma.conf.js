...
module.exports = function (config) {
  config.set({
    ...
    files: [
      ...
      {
        pattern: 'spec/pivotview/conditional-formatting.spec.js',
        included: false,
      },
      ...
      { pattern: 'node_modules/@hoyui/charts/**/*.js', included: false },
