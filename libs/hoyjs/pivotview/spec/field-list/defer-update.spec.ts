...
import { DragAndDropEventArgs } from '@hoyui/navigations';
...
describe('Pivot Field List Rendering - Defer Update', () => {
  ...
  describe('Check pivot button drag and drop Actions', () => {
    ...
    let grid: HTMLElement = createElement('div', {
      id: 'PivotView',
      styles: 'width: 58%; height: 100%',
    });
    let fieldlist: HTMLElement = createElement('div', {
      id: 'PivotFieldList',
      styles: 'width: 42%; height: 100%',
    });
    let elem: HTMLElement = createElement('div', { className: 'container' });
    elem.appendChild(grid);
    elem.appendChild(fieldlist);
    ...
    it('drag and drop pivot button to body', (done: Function) => {
      ...
      let leftAxisPanel: HTMLElement =
        fieldListObj.axisTableModule.axisTable.querySelector(
          '.e-left-axis-fields'
        );
      ...
      let dragElement: HTMLElement =
        pivotButton[0].querySelector('.e-draggable');
    ...
    it('Cancel button', (done: Function) => {
      ...
      setTimeout(() => {
        expect(
          pivotGridObj.element.querySelectorAll('.e-pivot-button').length
        ).toBe(8);
        done();
      });
    });
    ...
    it('Sort Click', () => {
      ...
      expect(
        document
          .querySelector('.e-pivotfieldlist .e-pivot-button.state .e-sort')
          .classList.contains('e-descend')
      ).toBeTruthy;
    });
    it('Cancel button', () => {
      document.getElementById('PivotFieldList_DeferUpdateButton2').click();
    ...
    it('check include type filter field', (done: Function) => {
      ...
      let pivotButtons: HTMLElement[] = [].slice.call(
        leftAxisPanel.querySelectorAll('.e-pivot-button')
      );
      ...
      setTimeout(() => {
        expect(
          fieldListObj.pivotCommon.filterDialog.dialogPopUp.element.classList.contains(
            'e-popup-open'
          )
        ).toBe(true);
        done();
    ...
    it('check all nodes on filter popup', () => {
      let treeObj: TreeView =
        fieldListObj.pivotCommon.filterDialog.allMemberSelect;
      let memberTreeObj: TreeView =
        fieldListObj.pivotCommon.filterDialog.memberTreeView;
      ...
      (
        fieldListObj.pivotCommon.filterDialog.dialogPopUp.element.querySelector(
          '.e-ok-btn'
        ) as HTMLElement
      ).click();
    });
    it('check filter state after update', (done: Function) => {
      ...
      expect(
        pivotButtons[0]
          .querySelector('.e-btn-filter')
          .classList.contains('e-pv-filter')
      ).toBeTruthy;
      jasmine.DEFAULT_TIMEOUT_INTERVAL = 10000;
      setTimeout(() => {
        done();
    ...
    it('Cancel button', () => {
      ...
      expect(
        document
          .querySelector('.e-pivot-button .e-sort')
          .classList.contains('e-descend')
      ).toBeFalsy;
    });
    it('check include type filter field', (done: Function) => {
    ...
    it('check all nodes on filter popup', () => {
      ...
      expect(checkEle.length).toEqual(2);
      expect(
        fieldListObj.pivotCommon.filterDialog.dialogPopUp.element
          .querySelector('.e-ok-btn')
    ...
    it('Remove Click', () => {
      (
        fieldListObj.element.querySelector(
          '.e-pivot-button .e-remove'
        ) as HTMLElement
      ).click();
      expect(document.querySelectorAll('.e-pivot-button').length === 12)
        .toBeTruthy;
    });
    it('Cancel button', () => {
      document.getElementById('PivotFieldList_DeferUpdateButton2').click();
      expect(document.querySelectorAll('.e-pivot-button').length === 14)
        .toBeTruthy;
    });
    it('Remove Click', () => {
      (
    ...
    it('Check defer update', (done: Function) => {
      ...
      setTimeout(() => {
        expect(
          (
            fieldListObj.element.querySelector(
              '#PivotFieldList_DeferUpdateButton1'
    ...
    it('testing row axis using drop args', () => {
      ...
      let pivotButton: HTMLElement[] = [].slice.call(
        rowsAxisContent.querySelectorAll('.e-pivot-button')
      );
      expect(pivotButton.length).toEqual(1);
      let args: any = {
        target: rowsAxisContent,
        cancel: true,
        event: util.getEventObject(
          'MouseEvents',
          'mouseup',
          treeObj.element,
          rowsAxisContent
      ...
      expect(pivotButton.length).toEqual(2);
      expect(pivotButton[pivotButton.length - 1].getAttribute('data-uid')).toBe(
        'pno'
      );
    });
    it('Cancel button', () => {
    ...
    it('testing row axis using drop args', (done: Function) => {
      ...
      setTimeout(() => {
        ...
        expect(pivotButton.length).toEqual(2);
        expect(
          pivotButton[pivotButton.length - 1].getAttribute('data-uid')
        ).toBe('pno');
        done();
      });
    });
    ...
    it('testing column axis using drop args', (done: Function) => {
      let treeObj: TreeView = fieldListObj.treeViewModule.fieldTable;
      let rightAxisPanel: HTMLElement =
        fieldListObj.axisTableModule.axisTable.querySelector(
          '.e-right-axis-fields'
        );
      let columnAxisContent: HTMLElement =
        rightAxisPanel.querySelector('.e-columns');
      let pivotButton: HTMLElement[] = [].slice.call(
  ...
  describe('- Field List with injected Module - ', () => {
    ...
    beforeAll((done: Function) => {
      ...
      util.disableDialogAnimation(
        pivotGridObj.pivotFieldListModule.dialogRenderer.fieldListDialog
      );
    });
    ...
    it('check dropdown icon', (done: Function) => {
      let valueField: HTMLElement =
        pivotGridObj.element.querySelector('.e-group-values');
      let pivotButtons: HTMLElement[] = [].slice.call(
        valueField.querySelectorAll('.e-pivot-button')
      );
      expect(pivotButtons.length).toBeGreaterThan(0);
      ...
      jasmine.DEFAULT_TIMEOUT_INTERVAL = 10000;
      setTimeout(() => {
        expect(document.getElementById('PivotGridvalueFieldContextMenu'))
          .toBeTruthy;
        done();
      }, 1000);
    });
    it('select context Menu', (done: Function) => {
      let menuObj: any = (pivotGridObj.pivotButtonModule.menuOption as any)
        .menuInfo[0];
      let li: Element[] = <Element[] & NodeListOf<HTMLLIElement>>(
        menuObj.element.querySelectorAll('li')
      );
      let menu: any = {
        element: li[1],
      ...
      let buttonText: HTMLElement = pivotButtons[0].querySelector(
        '.e-pvt-btn-content'
      ) as HTMLElement;
      jasmine.DEFAULT_TIMEOUT_INTERVAL = 10000;
      setTimeout(() => {
    ...
    it('select context Menu', (done: Function) => {
      let menuObj: any = (
        document.getElementById('PivotGridvalueFieldContextMenu') as any
      ).ej2_instances[0];
      let li: Element[] = <Element[] & NodeListOf<HTMLLIElement>>(
        menuObj.element.querySelectorAll('li')
      );
    ...
    it('check dropdown icon', (done: Function) => {
      let valueField: HTMLElement =
        pivotGridObj.pivotFieldListModule.axisTableModule.axisTable.querySelector(
          '.e-field-list-values'
        );
      let pivotButtons: HTMLElement[] = [].slice.call(
        valueField.querySelectorAll('.e-pivot-button')
    ...
    it('select context Menu', (done: Function) => {
      let menuObj: any = (
        pivotGridObj.pivotFieldListModule.pivotButtonModule.menuOption as any
      ).menuInfo[0];
      let li: Element[] = <Element[] & NodeListOf<HTMLLIElement>>(
        menuObj.element.querySelectorAll('li')
      );
    ...
    it('check sorting order field', (done: Function) => {
      ...
      setTimeout(() => {
        let pivotButtons: HTMLElement[] = [].slice.call(
          pivotGridObj.pivotFieldListModule.dialogRenderer.fieldListDialog.element
    ...
    it('check filtering field', (done: Function) => {
      ...
      setTimeout(() => {
        let filterDialog: Dialog =
          pivotGridObj.pivotFieldListModule.pivotCommon.filterDialog
            .dialogPopUp;
    ...
    it('check all nodes on filter popup', (done: Function) => {
      ...
      setTimeout(() => {
        ...
        expect(
          filterDialog.element
            .querySelector('.e-ok-btn')
            .getAttribute('disabled')
        ).toBe(null);
        (
          filterDialog.element.querySelector('.e-ok-btn') as HTMLElement
        ).click();
        done();
      }, 1000);
    });
    ...
    it('check drag and drop pivot button', (done: Function) => {
      let rowAxiscontent: HTMLElement =
        pivotGridObj.pivotFieldListModule.dialogRenderer.fieldListDialog.element.querySelector(
          '.e-rows'
        );
    ...
    it('Check defer update', (done: Function) => {
      ...
      setTimeout(() => {
        expect(
          (
            pivotGridObj.pivotFieldListModule.dialogRenderer.fieldListDialog.element.querySelector(
              '#PivotGrid_PivotFieldList_DeferUpdateButton1'
            ) as HTMLButtonElement
          ).style.display === 'none'
        ).toBe(true);
        done();
  ...
  describe('Pop Field list with defer update ', () => {
    ...
    it('check spinner cleared', () => {
      ...
      expect(
        document
          .querySelectorAll('.e-spinner-pane')[2]
  ...
  describe('Disable deferLayoutUpdate at runtime', () => {
    let pivotGridObj: PivotView;
    let elem: HTMLElement = createElement('div', {
      id: 'PivotGrid',
      styles: 'height:200px; width:500px',
    ...
    it('check sorting order', (done: Function) => {
      jasmine.DEFAULT_TIMEOUT_INTERVAL = 10000;
      setTimeout(() => {
        let pivotButtons: HTMLElement[] = [].slice.call(
          pivotGridObj.pivotFieldListModule.dialogRenderer.fieldListDialog.element
    ...
    it('Close fieldlist', (done: Function) => {
      jasmine.DEFAULT_TIMEOUT_INTERVAL = 10000;
      setTimeout(() => {
        (document.querySelector('.e-cancel-btn') as HTMLElement).click();
        expect(true).toBe(true);
