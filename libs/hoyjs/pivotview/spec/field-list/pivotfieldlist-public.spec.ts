  ...
  describe('Field List -public property testing', () => {
    ...
    beforeAll((done: Function) => {
      ...
      util.disableDialogAnimation(
        fieldListObj11.dialogRenderer.fieldListDialog
      );
    });
    ...
    it('dataSourceSettings - public property-1', () => {
      ...
      expect(fieldListObj11.dataSourceSettings.alwaysShowValueHeader).toBe(
        null
      );
      expect(fieldListObj11.dataSourceSettings.emptyCellsTextContent).toBe(
        null
      );
      ...
      expect(
        fieldListObj11.dataSourceSettings.showAggregationOnValueField
      ).toBe(null);
      expect(fieldListObj11.dataSourceSettings.showColumnGrandTotals).toBe(
        null
      );
    ...
    it('dataSourceSettings - public property-2', () => {
      expect(fieldListObj11.dataSourceSettings.allowLabelFilter).toBe(
        undefined
      );
      expect(fieldListObj11.dataSourceSettings.allowMemberFilter).toBe(
        undefined
      );
      expect(fieldListObj11.dataSourceSettings.allowValueFilter).toBe(
        undefined
      );
      expect(fieldListObj11.dataSourceSettings.alwaysShowValueHeader).toBe(
        undefined
      ...
      expect(fieldListObj11.dataSourceSettings.grandTotalsPosition).toBe(
        undefined
      );
      ...
      expect(fieldListObj11.dataSourceSettings.showColumnSubTotals).toBe(
        undefined
      );
      expect(fieldListObj11.dataSourceSettings.showGrandTotals).toBe(undefined);
      expect(fieldListObj11.dataSourceSettings.showHeaderWhenEmpty).toBe(
        undefined
      );
      expect(fieldListObj11.dataSourceSettings.showRowGrandTotals).toBe(
        undefined
      );
      expect(fieldListObj11.dataSourceSettings.showRowSubTotals).toBe(
        undefined
      );
      expect(fieldListObj11.dataSourceSettings.showSubTotals).toBe(undefined);
      expect(fieldListObj11.dataSourceSettings.subTotalsPosition).toBe(
        undefined
      );
