    ...
    beforeAll(() => {
      ...
      pivotGridObj = new PivotView({
        dataSourceSettings: {
          ...
          formatSettings: [
            { name: '[Measures].[Customer Count]', format: 'N2' },
          ],
          rows: [{ name: '[Date].[Date]', caption: 'Date Fiscal' }],
          columns: [
            {
  ...
  describe('Features ensures', () => {
    describe('NormalUI', () => {
      ...
      beforeAll((done: Function) => {
        ...
        pivotGridObj = new PivotView({
          dataSourceSettings: {
            ...
            sortSettings: [
              { name: '[Date].[Fiscal]', order: 'Ascending' },
              {
                name: '[Customer].[Customer Geography]',
                order: 'Descending',
                membersOrder: ['United States', 'Germany'],
              },
            ],
            valueAxis: 'column',
            valueSortSettings: {
            ...
            fieldMapping: [
              { name: '[Employee].[Base Rate]', dataType: 'string' },
      ...
      it('values testing', (done: Function) => {
        setTimeout(() => {
          expect(
            pivotGridObj.olapEngineModule.pivotValues[3][4].formattedText
          ).toBe('Internet Sales Amount');
          done();
        }, 2500);
      });
      ...
      it('Sub Total - position top', (done: Function) => {
        setTimeout(() => {
          let li = document.getElementById('PivotGridsubtotalpositions')
            .children[0] as HTMLElement;
          util.triggerEvent(li, 'mouseover');
          done();
        }, 500);
        ...
        setTimeout(() => {
          (
            document.querySelectorAll(
              '#PivotGridsub-top-position'
            )[0] as HTMLElement
          ).click();
          let li = document.getElementById('PivotGridsubtotal_menu')
            .children[0] as HTMLElement;
          expect(li.classList.contains('e-menu-caret-icon')).toBeTruthy();
          util.triggerEvent(li, 'mouseover');
          done();
      ...
      it('Grand Total - position top', (done: Function) => {
        setTimeout(() => {
          let li = document.getElementById('PivotGridgrandtotalpositions')
            .children[0] as HTMLElement;
          util.triggerEvent(li, 'mouseover');
          done();
        }, 500);
      ...
      it('filter testing02', (done: Function) => {
        setTimeout(() => {
          expect(
            pivotGridObj.olapEngineModule.pivotValues[0][1].formattedText
          ).toBe('Grand Total');
          done();
        }, 1000);
      });
    ...
    describe('Features ensuring - Drill', () => {
      ...
      beforeAll((done: Function) => {
        ...
        pivotGridObj = new PivotView({
          dataSourceSettings: {
            ...
            rows: [
              { name: '[Customer].[Gender]', caption: 'Gender' },
              { name: '[Customer].[Marital Status]', caption: 'Status' },
            ],
            values: [
              {
                name: '[Measures].[Internet Sales Amount]',
      ...
      it('Initial rendering', (done: Function) => {
        setTimeout(() => {
          expect(
            pivotGridObj.olapEngineModule.pivotValues[3][0].formattedText
          ).toBe('Single');
          done();
        }, 2000);
      });
      ...
      it('filter testing', (done: Function) => {
        setTimeout(() => {
          expect(
            pivotGridObj.olapEngineModule.pivotValues[4][0].formattedText
          ).toBe('Male');
          (
            document.querySelectorAll('.e-btn-filter')[1] as HTMLElement
          ).click();
      ...
      it('filter testing1', (done: Function) => {
        setTimeout(() => {
          expect(
            pivotGridObj.olapEngineModule.pivotValues[1][2].formattedText
          ).toBe('Total');
          (
