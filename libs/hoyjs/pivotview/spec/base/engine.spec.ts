...
import { MenuEventArgs } from '@hoyui/navigations';
import { Button } from '@hoyui/buttons';
import { MaskedTextBox } from '@hoyui/inputs';
  ...
  describe('PivotEngine population', () => {
    ...
    describe('getLabelFilterMembers', () => {
            ...
            calculatedFieldSettings: [
              {
                name: 'price',
                formula:
                  '(("Sum(balance)"*10^3+"Count(quantity)")/100)+"Sum(balance)"',
              },
            ],
            rows: [{ name: 'product' }, { name: 'date' }],
            formatSettings: [
              { name: 'balance', format: 'C' },
              { name: 'date', format: 'dd/MM/yyyy', type: 'date' },
            ],
            columns: [{ name: 'gender' }],
            values: [
              { name: 'balance' },
      ...
      it('Filter testing1', () => {
        ...
        expect(
          pivotGridObj.dataSourceSettings.filterSettings.length > 0
        ).toBeTruthy();
      });
      it('Filter testing2', (done: Function) => {
        setTimeout(function () {
          expect(
            (pivotGridObj.engineModule.pivotValues[2][2] as IDataSet)
              .formattedText
          ).toBe('14');
          pivotGridObj.dataSourceSettings.filterSettings = [
            {
      ...
      it('Filter testing5', (done: Function) => {
        setTimeout(function () {
          expect(
            (pivotGridObj.engineModule.pivotValues[3][3] as IDataSet)
              .formattedText
          ).toBe('52740.04999999999');
          pivotGridObj.dataSourceSettings.filterSettings = [
            {
              name: 'product',
              type: 'Label',
      ...
      it('Filter testing7', (done: Function) => {
        setTimeout(function () {
          expect(
            (pivotGridObj.engineModule.pivotValues[3][2] as IDataSet)
              .formattedText
          ).toBe('14');
          pivotGridObj.dataSourceSettings.filterSettings = [
            {
      ...
      it('date testing1', (done: Function) => {
        setTimeout(function () {
          expect(
            (pivotGridObj.engineModule.pivotValues[4][5] as IDataSet)
              .formattedText
          ).toBe('34');
          expect(
            (pivotGridObj.engineModule.pivotValues[5][5] as IDataSet)
              .formattedText
          ).toBe('50');
          ...
          pivotGridObj.dataSourceSettings.filterSettings = [
            {
              ...
              type: 'Date',
              condition: 'Before',
              value1: 'Sun Feb 10 1991 20:28:59 GMT+0530 (India Standard Time)',
            },
          ];
          done();
        }, 1000);
      ...
      it('date testing3', (done: Function) => {
        setTimeout(function () {
          expect(
            (pivotGridObj.engineModule.pivotValues[4][2] as IDataSet)
              .formattedText
          ).toBe('18');
          pivotGridObj.dataSourceSettings.filterSettings = [
            {
          ...
          pivotGridObj.dataSourceSettings.filterSettings = [
            {
              ...
              condition: 'Between',
              value1: 'Sun Feb 10 1991 20:28:59 GMT+0530 (India Standard Time)',
              value2: 'Tue Sep 09 2008 09:47:08 GMT+0530 (India Standard Time)',
            },
          ];
          done();
        }, 1000);
          ...
          pivotGridObj.dataSourceSettings.filterSettings = [
            {
              name: 'date',
              type: 'Date',
              value1: 'Tue Sep 09 2008 09:47:08 GMT+0530 (India Standard Time)',
            },
          ];
          done();
        }, 1000);
      ...
      it('date testing7', (done: Function) => {
        setTimeout(function () {
          ...
          pivotGridObj.dataSourceSettings.values = [
            { name: 'balance', type: 'DifferenceFrom' },
            { name: 'quantity', type: 'PercentageOfGrandTotal' },
            { name: 'price', type: 'CalculatedField' },
          ];
          pivotGridObj.dataSourceSettings.sortSettings = [
            { name: 'gender', order: 'Descending' },
            {
              name: 'advance',
              order: 'Descending',
              membersOrder: [6124, 7107],
            },
          ];
          done();
        }, 1000);
      ...
      it('data testing9', (done: Function) => {
        setTimeout(function () {
          ...
          (
            document.querySelectorAll('.e-icons.e-sort')[2] as HTMLElement
          ).click();
          done();
        }, 1000);
      });
      ...
      it('filter testing1 - 1', (done: Function) => {
        setTimeout(function () {
          ...
          (
            document.querySelectorAll('.e-btn-filter')[2] as HTMLElement
          ).click();
          done();
        }, 1000);
      });
      it('filter testing2', (done: Function) => {
        setTimeout(function () {
          let treeObj: TreeView =
            pivotGridObj.pivotCommon.filterDialog.memberTreeView;
          let checkEle: Element[] = <Element[] & NodeListOf<Element>>(
            treeObj.element.querySelectorAll('.e-checkbox-wrapper')
          );
          expect(checkEle.length).toBeGreaterThan(0);
          expect(
            treeObj.element
              .querySelector('.e-checkbox-wrapper')
              .classList.contains('e-small')
          ).toBe(false);
      ...
      it('filter testing3 - 1', (done: Function) => {
        setTimeout(function () {
          ...
          (
            document.querySelectorAll('.e-btn-filter')[1] as HTMLElement
          ).click();
          done();
        }, 1000);
      });
      ...
      it('filter testing3 - 3', (done: Function) => {
        setTimeout(function () {
          expect(
            (pivotGridObj.engineModule.pivotValues[7][2] as IDataSet)
              .formattedText
          ).toBe('70.21%');
          (
            document.querySelectorAll('.e-btn-filter')[3] as HTMLElement
          ).click();
          done();
        }, 1000);
      });
      ...
      it('filter testing5', (done: Function) => {
        setTimeout(function () {
          expect(
            (pivotGridObj.engineModule.pivotValues[6][2] as IDataSet)
              .formattedText
          ).toBe('70.21%');
          (
            document.querySelectorAll('.e-btn-filter')[4] as HTMLElement
          ).click();
          done();
        }, 1000);
      });
      ...
      it('aggreagation testing', (done: Function) => {
        setTimeout(function () {
          ...
          pivotGridObj.dataSourceSettings.values[0].type =
    ...
    describe('getLabelFilterMembers', () => {
      ...
      beforeAll((done: Function) => {
        ...
        pivotGridObj = new PivotView({
          dataSourceSettings: {
            ...
            values: [
              { name: 'balance', type: 'DifferenceFrom' },
              { name: 'quantity', type: 'DifferenceFrom' },
            ],
            filters: [{ name: 'index' }],
            allowValueFilter: true,
            allowLabelFilter: true,
      ...
      it('Paging testing', (done: Function) => {
        setTimeout(function () {
          expect(
            (pivotGridObj.engineModule.pivotValues[6][1] as IDataSet)
              .formattedText
          ).toBe('105');
          (
            document.querySelector('#PivotGrid_row_nextIcon') as HTMLElement
          ).click();
          done();
        }, 1000);
      });
      it('filter testing1', (done: Function) => {
        setTimeout(function () {
          expect(
            (pivotGridObj.engineModule.pivotValues[3][1] as IDataSet)
              .formattedText
          ).toBe('-104');
          (
            document.querySelectorAll('.e-btn-filter')[2] as HTMLElement
      ...
      it('filter testing2', (done: Function) => {
        ...
        setTimeout(function () {
          ...
          (
            document.querySelectorAll('.e-icons.e-sort')[0] as HTMLElement
          ).click();
          done();
        }, 1000);
      });
      ...
      it('filter testing4', (done: Function) => {
        ...
        setTimeout(function () {
          expect(
            (pivotGridObj.engineModule.pivotValues[4][0] as IDataSet)
              .formattedText
          ).toBe('Flight');
      ...
      it('filter testing5', (done: Function) => {
        ...
        setTimeout(function () {
          expect('1').toBe('1');
          (
            document.querySelectorAll('.e-icons.e-sort')[1] as HTMLElement
          ).click();
          done();
        }, 1000);
      });
      it('sort testing', (done: Function) => {
        (
          document.querySelectorAll('.e-icons.e-sort')[3] as HTMLElement
        ).click();
        setTimeout(function () {
          expect(
            (pivotGridObj.engineModule.pivotValues[3][0] as IDataSet)
              .formattedText
          ).toBe('Van');
          (
            document.querySelectorAll('.e-btn-filter')[3] as HTMLElement
      ...
      it('filter testing6', (done: Function) => {
        ...
        setTimeout(function () {
          expect(
            (pivotGridObj.engineModule.pivotValues[5][0] as IDataSet)
              .formattedText
          ).toBe('Flight');
          (
            document.querySelectorAll('.e-btn-filter')[2] as HTMLElement
    ...
    describe('FilterCommonUpdate', () => {
        ...
        filterSettings: [
          {
            ...
            type: 'Date',
            condition: 'Between',
            value1: new Date('02/16/2000'),
            value2: new Date('02/16/2002'),
          },
          {
            name: 'product',
            type: 'Exclude',
            items: ['Tempo', 'Jet', 'Bike', 'Car'],
          },
        ],
      };
      ...
      it('Ensure the page data', () => {
        expect(
          pivotEngine.pivotValues.length === 9 &&
            pivotEngine.pivotValues[2].length === 27
        ).toBeTruthy;
      });
      it('Ensure the row data', () => {
        expect(
          (pivotEngine.pivotValues[4][7] as IAxisSet).formattedText ===
            '$2,430.87'
        ).toBeTruthy;
      });
      it('Ensure the column data', () => {
        expect(
          (pivotEngine.pivotValues[0][1] as IAxisSet).formattedText === '20'
        ).toBeTruthy;
      });
      it('Ensure the filtered data1', () => {
        dataSourceSettings.filterSettings = [
          { name: 'product', type: 'Include', items: ['Bike', 'Car', 'Jet'] },
        ];
        let pageSettings: IPageSettings = {
          columnPageSize: 4,
          rowPageSize: 4,
        ...
        pivotEngine.renderEngine(dataSourceSettings, customProperties);
        expect(
          pivotEngine.pivotValues.length === 12 &&
            pivotEngine.pivotValues[2].length === 33
        ).toBeTruthy;
        expect(
          (pivotEngine.pivotValues[3][6] as IAxisSet).formattedText === '11'
        ).toBeTruthy;
      });
      ...
      it('Ensure the filtered data3', () => {
        dataSourceSettings.filterSettings = [
          { name: 'index', type: 'Include', items: ['0', '4', '6'] },
        ];
        pivotEngine = new PivotEngine();
        pivotEngine.renderEngine(dataSourceSettings, customProperties);
        expect(
    ...
    describe('dataCompression', () => {
      ...
      it('Ensure the page data', () => {
        expect(
          pivotEngine.pivotValues.length === 9 &&
            pivotEngine.pivotValues[2].length === 22
        ).toBeTruthy;
      });
      it('Ensure the row data', () => {
        expect(
          (pivotEngine.pivotValues[6][3] as IAxisSet).formattedText ===
            '14059.28'
        ).toBeTruthy;
      });
      it('Ensure the column data1', () => {
        expect(
          (pivotEngine.pivotValues[3][1] as IAxisSet).formattedText ===
            '$1,278.10'
        ).toBeTruthy;
      });
      it('Ensure the filtered data', () => {
        ...
        pivotEngine.renderEngine(dataSourceSettings, customProperties);
        expect(
          pivotEngine.pivotValues.length === 46 &&
            pivotEngine.pivotValues[2].length === 136
        ).toBeTruthy;
        expect(
          (pivotEngine.pivotValues[3][3] as IAxisSet).formattedText ===
            '14059.28'
        ).toBeTruthy;
      });
      it('Ensure the column data2', () => {
        expect(
          (pivotEngine.pivotValues[11][8] as IAxisSet).formattedText === '18'
        ).toBeTruthy;
      });
    });
    ...
    describe('calcfield', () => {
      ...
      it('Ensure the filtered data', () => {
        dataSourceSettings.calculatedFieldSettings = [
          { name: 'price', formula: '"Sum(balance)"' },
        ];
        let pageSettings: IPageSettings = {
          columnPageSize: 4,
          rowPageSize: 4,
        ...
        expect(
          (pivotEngine.pivotValues[3][3] as IAxisSet).formattedText === '1278.1'
        ).toBeTruthy;
      });
      it('Ensure the column data', () => {
        expect(
    ...
    describe('Calc-field', () => {
      ...
      it('Calculated field with simple calculation', () => {
        expect((pivotEngine.pivotValues[1][2] as IDataSet).formattedText).toBe(
          '28'
        );
      });
      it('Calculated field with complex calculation', () => {
        dataSourceSettings.calculatedFieldSettings[0].formula =
          '(("Sum(balance)"*10^3+"Count(quantity)")/100)+"Sum(balance)"';
        pivotEngine = new PivotEngine();
        pivotEngine.renderEngine(dataSourceSettings, customProperties);
        expect((pivotEngine.pivotValues[1][2] as IDataSet).formattedText).toBe(
      ...
      it('Calculated field using min function', () => {
        dataSourceSettings.calculatedFieldSettings[0].formula =
          'min("Sum(balance)","Count(quantity)")';
        pivotEngine = new PivotEngine();
        pivotEngine.renderEngine(dataSourceSettings, customProperties);
        expect((pivotEngine.pivotValues[1][2] as IDataSet).formattedText).toBe(
          '28'
      ...
      it('Calculated field using max function', () => {
        dataSourceSettings.calculatedFieldSettings[0].formula =
          'max("Sum(balance)","Count(quantity)")';
        pivotEngine = new PivotEngine();
        pivotEngine.renderEngine(dataSourceSettings, customProperties);
        expect((pivotEngine.pivotValues[1][2] as IDataSet).formattedText).toBe(
          '28'
      ...
      it('Calculated field using abs function', () => {
        dataSourceSettings.calculatedFieldSettings[0].formula =
          'abs("Sum(balance)") + "Count(quantity)"';
        pivotEngine = new PivotEngine();
        pivotEngine.renderEngine(dataSourceSettings, customProperties);
        expect((pivotEngine.pivotValues[1][2] as IDataSet).formattedText).toBe(
          '28'
      ...
      it('Calculated field using Math.min function', () => {
        dataSourceSettings.calculatedFieldSettings[0].formula =
          'Math.min("Sum(balance)","Count(quantity)")';
        pivotEngine = new PivotEngine();
        pivotEngine.renderEngine(dataSourceSettings, customProperties);
        expect((pivotEngine.pivotValues[1][2] as IDataSet).formattedText).toBe(
          '28'
      ...
      it('Calculated field using Math.max function', () => {
        dataSourceSettings.calculatedFieldSettings[0].formula =
          'Math.max("Sum(balance)","Count(quantity)")';
        pivotEngine = new PivotEngine();
        pivotEngine.renderEngine(dataSourceSettings, customProperties);
        expect((pivotEngine.pivotValues[1][2] as IDataSet).formattedText).toBe(
          '28'
      ...
      it('Calculated field using Math.abs function', () => {
        dataSourceSettings.calculatedFieldSettings[0].formula =
          'Math.abs("Sum(balance)") + "Count(quantity)"';
        pivotEngine = new PivotEngine();
        pivotEngine.renderEngine(dataSourceSettings, customProperties);
        expect((pivotEngine.pivotValues[1][2] as IDataSet).formattedText).toBe(
          '28'
      ...
      it('Calculated field using > condition', () => {
        dataSourceSettings.calculatedFieldSettings[0].formula =
          '"Sum(balance)" > "Count(quantity)" ? "Count(quantity)" : "Sum(balance)"';
        pivotEngine = new PivotEngine();
        pivotEngine.renderEngine(dataSourceSettings, customProperties);
        expect((pivotEngine.pivotValues[1][2] as IDataSet).formattedText).toBe(
          '28'
...
describe(' - VirtualScrolling', () => {
  ...
  describe(' - VirtualScrolling1', () => {
    ...
    it('scroll top3', () => {
      ...
      let args: MouseEvent = new MouseEvent('touchstart', {
        clientY: 317,
        view: window,
        bubbles: true,
        cancelable: true,
      ...
      document
        .querySelectorAll('.e-content-virtualtable')[0]
        .dispatchEvent(args);
      args = new MouseEvent('mouseup', {
        view: window,
        bubbles: true,
        cancelable: true,
      });
      ...
      expect(
        Math.round(
          document.querySelectorAll('.e-content-virtualtable')[0].scrollTop
        ) === 0
      ).toBeTruthy();
      expect(
        document
          .querySelectorAll('.e-content-virtualtable td')[0]
          .querySelector('td .e-cellvalue').textContent
      ).toBe('Flight');
      expect(
        document
          .querySelectorAll('.e-content-virtualtable td')[1]
          .querySelector('td .e-cellvalue').textContent
      ).toBe('$12,490.89');
    });
    ...
    it('scroll right false', () => {
      ...
      expect(
        document
          .querySelectorAll('.e-content-virtualtable tr')[0]
          .querySelector('td:not(.e-freezeleftborder) .e-cellvalue').textContent
      ).toBe('$12,490.89');
    });
    ...
    it('scroll top wheel', () => {
      ...
      pivotGridObj.virtualscrollModule.direction = 'vertical';
      let args: MouseEvent = new MouseEvent('wheel', {
        clientY: 0,
        view: window,
        bubbles: true,
        cancelable: true,
  ...
  describe(' - VirtualScrolling2', () => {
    ...
    it('pivotgrid render testing', (done: Function) => {
      setTimeout(() => {
        expect(
          document.querySelectorAll('.e-content-virtualtable tr').length
        ).toBe(30);
        expect(
          document
            .querySelectorAll('.e-content-virtualtable tr')[0]
            .querySelectorAll('td:not(.e-freezeleftborder)').length
        ).toBe(14);
        expect(
          document
            .querySelectorAll('.e-content-virtualtable td')[0]
    ...
    it('scroll right', (done: Function) => {
      ...
      pivotGridObj.virtualscrollModule.direction = 'horizondal';
      let args: MouseEvent = new MouseEvent('scroll', {
        view: window,
        bubbles: true,
        cancelable: true,
      });
      ...
      setTimeout(() => {
        expect(
          pivotGridObj.element.querySelectorAll('.e-headercontent')[0]
            .scrollLeft ===
            document.querySelectorAll('.e-content-virtualtable')[0].scrollLeft
        ).toBeTruthy();
        expect(
          document
            .querySelectorAll('.e-content-virtualtable td')[0]
    ...
    it('scroll bottom', (done: Function) => {
      pivotGridObj.element.querySelectorAll(
        '.e-content-virtualtable'
      )[0].scrollTop = 0;
      pivotGridObj.virtualscrollModule.direction = 'vertical';
      let args: MouseEvent = new MouseEvent('scroll', {
        view: window,
      ...
      setTimeout(() => {
        expect(
          pivotGridObj.element.querySelectorAll('.e-content-virtualtable')[0]
            .scrollTop
        ).toBe(0);
        expect(
          document
        ...
        expect(
          document
            .querySelectorAll('.e-content-virtualtable tr')[0]
            .querySelector('td:not(.e-freezeleftborder) .e-cellvalue')
            .textContent
        ).toBe('$32,045.16');
        done();
      }, 100);
    ...
    it('scroll left1', (done: Function) => {
      ...
      document.querySelector('.e-content-virtualtable').dispatchEvent(args);
      setTimeout(() => {
        let mCnt: HTMLElement = document.querySelector(
          '.e-content-virtualtable'
        ) as HTMLElement;
        expect(
          pivotGridObj.element.querySelectorAll('.e-headercontent')[0]
        ...
        expect(
          (mCnt.querySelectorAll('.e-virtualtrack')[0] as HTMLElement).style
            .height
        ).toBe('390.1px');
        expect(
          (mCnt.querySelectorAll('.e-virtualtrack')[0] as HTMLElement).style
    ...
    it('Collapse flight', (done: Function) => {
      (
        document.querySelectorAll(
          '.e-content-virtualtable tr .e-icons'
        )[0] as HTMLElement
      ).click();
      setTimeout(() => {
        let mCnt: HTMLElement = document.querySelector(
        ...
        expect(
          document.querySelectorAll('.e-headercontent')[0].scrollLeft === 0
        ).toBeTruthy();
        expect(
          (mCnt.querySelectorAll('.e-virtualtrack')[0] as HTMLElement).style
            .height
    ...
    it('Collapse male', (done: Function) => {
      (
        document.querySelectorAll(
          '.e-headercontent th .e-sortfilterdiv.e-icons'
        )[0] as HTMLElement
      ).click();
      setTimeout(() => {
        expect(
        ...
        expect(
          document.querySelectorAll('.e-headercontent th')[6].textContent
        ).toBe('male Total');
        expect(
          document
            .querySelectorAll('.e-content-virtualtable tr')[0]
            .querySelector('td:not(.e-leftfreeze) .e-cellvalue').textContent
        ).toBe('$12,490.89');
        done();
      }, 100);
    });
    ...
    it('Collapse bike', (done: Function) => {
      ...
      setTimeout(() => {
        expect(
          document.querySelectorAll('.e-headercontent')[0].scrollLeft
        ).toBe(0);
        done();
      }, 100);
    });
  ...
  describe(' - Grouping Bar', () => {
    ...
    it('pivotgrid render testing', (done: Function) => {
      setTimeout(() => {
        ...
        expect(
          document
            .querySelectorAll('.e-content-virtualtable tr')[0]
            .querySelectorAll('td:not(.e-leftfreeze)').length
        ).toBe(14);
        expect(
          document
            .querySelectorAll('.e-content-virtualtable td')[0]
    ...
    it('Collapse flight', (done: Function) => {
      ...
      setTimeout(() => {
        expect(
          document
            .querySelectorAll('.e-content-virtualtable tr')[1]
            .querySelector('td .e-cellvalue').textContent
        ).toBe('Jet');
        done();
      }, 500);
    ...
    it('filter', (done: Function) => {
      (
        document.querySelector(
          '#PivotGrid_product.e-pivot-button .e-pv-filter'
        ) as HTMLElement
      ).click();
      setTimeout(() => {
        let allNode: HTMLElement = document.querySelector(
          '.e-checkbox-wrapper'
        );
        let args: MouseEvent = new MouseEvent('mousedown', {
          view: window,
          bubbles: true,
          cancelable: true,
        });
        ...
        allNode.querySelector('.e-frame').dispatchEvent(args);
        let firstNode: HTMLElement = document.querySelectorAll(
          '.e-checkbox-wrapper'
        )[2] as HTMLElement;
        args = new MouseEvent('mousedown', {
          view: window,
          bubbles: true,
          cancelable: true,
        });
    ...
    it('value moved to row', (done: Function) => {
      let rowAxiscontent: HTMLElement =
        pivotGridObj.element.querySelector('.e-rows');
      let columnAxiscontent: HTMLElement =
        pivotGridObj.element.querySelector('.e-columns');
      let pivotButton: HTMLElement[] = [].slice.call(
        columnAxiscontent.querySelectorAll('.e-pivot-button')
      );
      expect(pivotButton.length).toEqual(3);
      let dragElement: HTMLElement =
        pivotButton[2].querySelector('.e-pvt-btn-content');
      let mousedown: any = util.getEventObject(
        'MouseEvents',
        'mousedown',
        dragElement,
        dragElement,
      ...
      let mousemove: any = util.getEventObject(
        'MouseEvents',
        'mousemove',
        dragElement,
        rowAxiscontent,
      ...
      let mouseUp: any = util.getEventObject(
        'MouseEvents',
        'mouseup',
        dragElement,
        rowAxiscontent
      ...
      setTimeout(() => {
        pivotButton = [].slice.call(
          rowAxiscontent.querySelectorAll('.e-pivot-button')
        );
        expect(pivotButton.length).toEqual(3);
        done();
      }, 100);
    ...
    it('values removed', (done: Function) => {
      let columnAxiscontent: HTMLElement =
        pivotGridObj.element.querySelector('.e-columns');
      let valueAxiscontent: HTMLElement =
        pivotGridObj.element.querySelector('.e-values');
      let pivotButton: HTMLElement[] = [].slice.call(
        columnAxiscontent.querySelectorAll('.e-pivot-button')
      );
      ...
      setTimeout(() => {
        pivotButton = [].slice.call(
          valueAxiscontent.querySelectorAll('.e-pivot-button')
        );
        (pivotButton[0].querySelector('.e-remove') as HTMLElement).click();
        (pivotButton[1].querySelector('.e-remove') as HTMLElement).click();
  ...
  describe(' - advanced filtering ', () => {
    ...
    it('product quantity > 100', (done: Function) => {
      (pivotGridObj.dataSourceSettings.filterSettings = [
        ...
        setTimeout(() => {
          expect(
            document.querySelectorAll('.e-headercontent th')[5].textContent
          ).toBe('male Total');
          done();
        }, 100);
    });
  ...
  describe(' - Coverage', () => {
    ...
    it('drop down menu (Sum of Amount) click', (done: Function) => {
      setTimeout(() => {
        expect(document.querySelectorAll('.e-values .e-dropdown-icon')).not
          .toBeUndefined;
        expect(
          document
            .querySelectorAll('.e-content-virtualtable tr')[0]
        ...
        document
          .querySelectorAll('.e-values .e-dropdown-icon')[0]
          .dispatchEvent(click);
        done();
      }, 500);
    });
    ...
    it('Sum of Amount -> Count of Amount _using grouping bar dropdown menu', () => {
      ...
      (
        pivotGridObj.pivotButtonModule.menuOption as any
    ...
    it('Country -> descending _using grouping bar sort icon', (done: Function) => {
      setTimeout(() => {
        document
          .querySelectorAll('.e-group-rows .e-sort')[0]
          .dispatchEvent(click);
        done();
      }, 1000);
    });
    ...
    it('Country -> Switch to ascending _result + open field list', (done: Function) => {
      setTimeout(function () {
        ...
        document
          .querySelectorAll('.e-toggle-field-list')[0]
          .dispatchEvent(click);
        done();
      }, 1000);
    });
    it('Open calculated field dialog', (done: Function) => {
      ...
      setTimeout(function () {
        expect(
          document.getElementsByClassName('e-dialog').length > 0
        ).toBeTruthy();
        done();
      }, 1000);
    });
    it('drag and drop Amount(Count) node to drop field', (done: Function) => {
      ...
      let filterAxiscontent: HTMLElement = document.getElementById(
        cf.parentID + 'droppable'
      );
      let li: Element[] = <Element[] & NodeListOf<HTMLLIElement>>(
        treeObj.element.querySelectorAll('li')
      );
      let mousedown: any = util.getEventObject(
        'MouseEvents',
        'mousedown',
        treeObj.element,
        li[0].querySelector('.e-drag'),
        15,
        10
      );
      ...
      setTimeout(function () {
        expect(
          (document.querySelector('.e-pivot-formula') as HTMLTextAreaElement)
            .value !== null
        ).toBeTruthy;
        done();
      }, 1000);
    ...
    it('set new field as "New" and close the dialog', () => {
      const calcField: any = document.querySelector(
        '#' + pivotGridObj.element.id + 'calculateddialog'
      );
      (
        getInstance(
          calcField.querySelector('#' + pivotGridObj.element.id + 'ddlelement'),
          MaskedTextBox
        ) as MaskedTextBox
      ).value = 'New';
      (
        document.querySelector('.e-pivot-calc-input') as HTMLInputElement
      ).value = 'New';
      ...
      (
        getInstance(
          calcField.querySelectorAll('.e-btn')[1] as HTMLElement,
          Button
        ) as Button
      ).click();
      document
        .querySelector('.e-pivotfieldlist-container .e-cancel-btn')
        .dispatchEvent(click);
    });
    it('Country -> open filter dialog + uncheck canada + click ok btn', (done: Function) => {
      setTimeout(() => {
        ...
        expect(
          document.querySelectorAll('.e-headercontent th')[12].textContent
        ).toBe('New');
        document
          .querySelectorAll(
            '#PivotGrid_PivotFieldList_Country .e-btn-filter'
          )[0]
          .dispatchEvent(click);
        done();
      }, 1000);
    ...
    it('Country -> open filter dialog + uncheck canada + click ok btn', (done: Function) => {
      setTimeout(() => {
        ...
        let firstNode: HTMLElement = document.querySelectorAll(
          '.e-member-editor-container .e-checkbox-wrapper'
        )[1] as HTMLElement;
        ...
        document
          .querySelector('.e-member-editor-dialog .e-ok-btn')
          .dispatchEvent(click);
        done();
      }, 1000);
    });
    it('Country -> open filter dialog + check canada + click ok btn', (done: Function) => {
      setTimeout(() => {
        ...
        expect(
          document.querySelectorAll(
            '.e-content-virtualtable td:not(.e-leftfreeze)'
          )[0].textContent
        ).toBe('6');
        document
          .querySelectorAll(
  ...
  describe('Scroll apperance', () => {
    describe('Scroll comparison ', () => {
      ...
      let elem: HTMLElement = createElement('div', {
        id: 'PivotGrid',
        styles: 'height:1000px; width:900px',
      });
      let data: IDataSet[] = [
      ...
      it('Compare scrollbar', () => {
        expect(document.querySelector('.e-content').scrollHeight).toBe(
          document.querySelector('.e-content').clientHeight
        );
      });
    ...
    describe('Scroll comparison - virtual scrolling', () => {
      ...
      it('Scroll compare', () => {
        expect(
          document.querySelector('.e-content-virtualtable').scrollHeight
        ).toBe(document.querySelector('.e-content-virtualtable').clientHeight);
      });
  ...
  describe('AutoFit Value Sorting', () => {
    ...
    it('Checking value sorting', function (done) {
      setTimeout(() => {
        expect(
          pivotGridObj.element.querySelectorAll(
            '.e-columnheader .e-value-sort-icon'
          ).length > 0
        ).toBeTruthy();
        done();
      }, 1000);
