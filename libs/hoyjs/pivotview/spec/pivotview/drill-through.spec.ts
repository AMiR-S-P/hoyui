...
describe('- Drill Through', () => {
  ...
  describe('- no data', () => {
    ...
    beforeAll((done: Function) => {
      ...
      pivotGridObj = new PivotView({
        dataSourceSettings: {
          ...
          expandAll: false,
          rows: [
            { name: 'Country', showNoDataItems: true },
            { name: 'State', showNoDataItems: true },
          ],
          columns: [
            { name: 'Product', showNoDataItems: true },
            { name: 'Date', showNoDataItems: true },
          ],
    ...
    it('state no data', (done: Function) => {
      setTimeout(() => {
        expect(document.querySelectorAll('.e-drillthrough-dialog').length).toBe(
          0
        );
        done();
      }, 1000);
    ...
    it('click balance', (done: Function) => {
      document
        .querySelectorAll('th[aria-colindex="2"]')[0]
    ...
    it('click Bike adaptive', (done: Function) => {
      document
        .querySelectorAll('th[aria-colindex="1"]')[0]
        .dispatchEvent(event);
      setTimeout(() => {
        expect(document.querySelectorAll('.e-drillthrough-dialog').length).toBe(
          0
  ...
  describe('- Virtual scrolling', () => {
    ...
    it('click car-quantity-male', (done: Function) => {
      document
        .querySelectorAll('td[aria-colindex="5"]')[1]
        .dispatchEvent(event);
      setTimeout(() => {
        expect(document.querySelectorAll('.e-drillthrough-dialog').length).toBe(
          1
        ...
        expect(
          document.querySelectorAll('.e-drillthrough-body-header-value')[0]
            .textContent
        ).toBe('Car');
        expect(
          document.querySelectorAll('.e-drillthrough-body-header-value')[1]
            .textContent
        ).toBe('male');
        expect(
          document.querySelectorAll('.e-drillthrough-body-header')[2]
            .textContent
        ).toBe('Sum of balance');
        expect(
          document.querySelectorAll('.e-drillthrough-body-header-value')[2]
            .textContent
        ).toBe('102234.66000000005');
        expect(
          document.querySelectorAll(
            '.e-drillthrough-grid td[aria-colindex="2"]'
          )[2].textContent
        ).toBe('Californiya');
        (
          document.querySelectorAll(
    ...
    it('click jet-price-female', (done: Function) => {
      document
        .querySelectorAll('td[aria-colindex="3"]')[3]
        .dispatchEvent(event);
      setTimeout(() => {
        expect(document.querySelectorAll('.e-drillthrough-dialog').length).toBe(
          1
    ...
    it('click bike-quantity', (done: Function) => {
      document
        .querySelectorAll('td[aria-colindex="8"]')[0]
        .dispatchEvent(event);
      setTimeout(() => {
        expect(document.querySelectorAll('.e-drillthrough-dialog').length).toBe(
          1
        ...
        expect(
          document.querySelectorAll('.e-drillthrough-body-header')[1]
            .textContent
        ).toBe('Sum of balance');
        expect(
          document.querySelectorAll('.e-drillthrough-body-header-value')[1]
            .textContent
        ).toBe('170737.21999999997');
        expect(
          document.querySelectorAll(
            '.e-drillthrough-grid td[aria-colindex="2"]'
          )[2].textContent
    ...
    it('click price', (done: Function) => {
      document
        .querySelectorAll('td[aria-colindex="9"]')[6]
        .dispatchEvent(event);
      setTimeout(() => {
        expect(document.querySelectorAll('.e-drillthrough-dialog').length).toBe(
          1
        ...
        expect(
          document.querySelectorAll('.e-drillthrough-body-header')[0]
            .textContent
        ).toBe('Sum of quantity');
        expect(
          document.querySelectorAll('.e-drillthrough-body-header-value')[0]
    ...
    it('click delhi-quantity-female', (done: Function) => {
      document
        .querySelectorAll('td[aria-colindex="2"]')[2]
        .dispatchEvent(event);
      setTimeout(() => {
        expect(document.querySelectorAll('.e-drillthrough-dialog').length).toBe(
          1
    ...
    it('click delhi-quantity-female', (done: Function) => {
      document
        .querySelectorAll('td[aria-colindex="2"]')[19]
        .dispatchEvent(event);
      setTimeout(() => {
        expect(document.querySelectorAll('.e-drillthrough-dialog').length).toBe(
          1
  ...
  describe('- Using CSV data', () => {
    ...
    it('Editing cell value', (done: Function) => {
      ...
      setTimeout(() => {
        document
          .querySelectorAll('.e-drillthrough-grid td[aria-colindex="2"]')[0]
          .dispatchEvent(new Event('dblclick', { bubbles: true }));
        document
          .querySelectorAll('.e-spin-up')[0]
          .dispatchEvent(new Event('mouseup', { bubbles: true }));
        document
          .getElementById('PivotGrid_drillthroughgrid_update')
          .dispatchEvent(new Event('click', { bubbles: true }));
        document
          .querySelectorAll('.e-drillthrough-dialog .e-dlg-closeicon-btn')[0]
          .dispatchEvent(new Event('click', { bubbles: true }));
        expect(
          document.querySelectorAll(
            '.e-drillthrough-grid td[data-colindex="1"]'
          )[0].textContent
        ).toBe('389040.42');
        done();
      }, 1000);
  ...
  describe('- normal', () => {
    ...
    it('click bike-male', (done: Function) => {
      ...
      setTimeout(() => {
        if (document.querySelectorAll('.e-drillthrough-dialog').length === 0) {
          expect(
            document.querySelectorAll('.e-drillthrough-dialog').length
          ).toBe(0);
        } else {
          expect(
            document.querySelectorAll('.e-drillthrough-dialog').length
    ...
    it('value axis to column filter bike alone', () => {
      ...
      pivotGridObj.dataSourceSettings.filterSettings = [
        { name: 'product', type: 'Include', items: ['Bike'] },
      ];
    });
    it('memory leak', () => {
      profile.sample();
