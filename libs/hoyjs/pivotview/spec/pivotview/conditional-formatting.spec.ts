...
describe('Conditional Formatting', () => {
  ...
  describe(' - Code Behind', () => {
    ...
    it('Check Default Format', () => {
      expect(
        (pivotGridObj.pivotValues[3][1] as any).cssClass === 'formatPivotGrid6'
      ).toBeTruthy();
    });
    it('Check Default Format', () => {
      expect(
        (pivotGridObj.pivotValues[3][2] as any).cssClass === 'formatPivotGrid8'
      ).toBeTruthy();
      pivotGridObj.dataSourceSettings.values.pop();
      pivotGridObj.engineModule.generateGridData(
    ...
    it('With Single Measure', () => {
      expect(
        (pivotGridObj.pivotValues[3][2] as any).cssClass === 'formatPivotGrid6'
      ).toBeTruthy();
      pivotGridObj.dataSourceSettings = {
        dataSource: pivot_dataset as IDataSet[],
        expandAll: false,
    ...
    it('Without Filtering', () => {
      expect(
        (pivotGridObj.pivotValues[3][1] as any).cssClass === 'formatPivotGrid0'
      ).toBeTruthy();
      pivotGridObj.dataSourceSettings = {
        dataSource: pivot_dataset as IDataSet[],
        expandAll: false,
    ...
    it('With Filtering', () => {
      ...
      pivotGridObj.dataSourceSettings = {
        ...
        calculatedFieldSettings: [
          { name: 'Price', formula: '"Sum(balance)" + "Sum(quantity)"' },
        ],
        filterSettings: [
          { name: 'product', type: 'Include', items: ['Car', 'Bike'] },
          { name: 'eyeColor', type: 'Include', items: ['blue', 'green'] },
    ...
    it('With Calculated Field', () => {
      expect(
        (pivotGridObj.pivotValues[3][3] as any).cssClass === 'formatPivotGrid0'
      ).toBeTruthy();
    ...
    it('With Default Sorting', () => {
      expect(
        (pivotGridObj.pivotValues[4][3] as any).cssClass === 'formatPivotGrid0'
      ).toBeTruthy();
      pivotGridObj.dataSourceSettings = {
        dataSource: pivot_dataset as IDataSet[],
        expandAll: true,
    ...
    it('Check empty cell', () => {
      expect(
        (pivotGridObj.pivotValues[5][1] as any).cssClass === 'formatPivotGrid0'
      ).toBeTruthy();
    });
    afterAll(() => {
      if (pivotGridObj) {
  ...
  describe(' - UI', () => {
    ...
    it('Check code behind format', () => {
      expect(
        (pivotGridObj.pivotValues[3][2] as any).cssClass === 'formatPivotGrid0'
      ).toBeTruthy();
      pivotGridObj.conditionalFormattingModule.showConditionalFormattingDialog();
    });
    it('Delete format', () => {
      ...
      (
        document.querySelector('.e-format-delete-button') as HTMLElement
      ).click();
    ...
    it('Add format', () => {
      ...
      (
        document.querySelector(
          '#' + pivotGridObj.element.id + 'conditionvalue10'
        ) as HTMLInputElement
      ).value = '500';
    ...
    it('Add format', () => {
      expect(true).toBeTruthy();
      const conditionalFormatting = document.querySelector(
        '#' + pivotGridObj.element.id + 'conditionalformatting'
      );
      let element = (conditionalFormatting as any).querySelector(
        '#' + pivotGridObj.element.id + 'measureinput' + 0
      );
      (
        getInstance(element as HTMLElement, DropDownList) as DropDownList
      ).value = 'balance';
      element = (conditionalFormatting as any).querySelector(
        '#' + pivotGridObj.element.id + 'conditioninput' + 0
      );
      (
        getInstance(element as HTMLElement, DropDownList) as DropDownList
      ).value = 'Between';
      element = (conditionalFormatting as any).querySelector(
        '#' + pivotGridObj.element.id + 'fontnameinput' + 0
      );
      (
        getInstance(element as HTMLElement, DropDownList) as DropDownList
      ).value = 'Serif';
      element = (conditionalFormatting as any).querySelector(
        '#' + pivotGridObj.element.id + 'fontsizeinput' + 0
      );
      (
        getInstance(element as HTMLElement, DropDownList) as DropDownList
      ).value = '16px';
      (pivotGridObj.conditionalFormattingModule as any).fontColor[0].value =
        '#f5dd05';
      (
        pivotGridObj.conditionalFormattingModule as any
      ).backgroundColor[0].value = '#cb04aa';
      (
        document.querySelector(
          '#' + pivotGridObj.element.id + 'conditionvalue10'
        ) as HTMLInputElement
      ...
      (
        document.querySelector(
          '#' + pivotGridObj.element.id + 'conditionvalue20'
        ) as HTMLInputElement
      ).value = '50000';
    });
    ...
    it('Add format', () => {
      ...
      (
        document.querySelectorAll('.e-check')[0] as HTMLInputElement
      ).dispatchEvent(click);
    });
    it('Click apply button', () => {
      expect(
    ...
    it('Check applied format', () => {
      expect(
        (pivotGridObj.pivotValues[5][1] as any).cssClass === undefined
      ).toBeTruthy();
      pivotGridObj.conditionalFormattingModule.showConditionalFormattingDialog();
    });
    it('Add format', () => {
  ...
  describe(' - Mobile', () => {
    ...
    it('Check applied format', () => {
      expect(
        (pivotGridObj.pivotValues[5][3] as any).cssClass === 'formatPivotGrid0'
      ).toBeTruthy();
      pivotGridObj.conditionalFormattingModule.showConditionalFormattingDialog();
    });
    it('Add format', () => {
