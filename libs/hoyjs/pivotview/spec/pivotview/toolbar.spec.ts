...
describe('Pivot Grid Toolbar', () => {
  ...
  describe(' -  Initial Rendering and Basic Operations', () => {
    ...
    it('Save As Report', () => {
      (
        document.querySelector(
          '.e-pivot-toolbar .e-saveas-report'
        ) as HTMLElement
      ).click();
      expect(
        (
      ...
      (
        document.querySelector('.e-pivotview-report-input') as HTMLInputElement
      ).value = 'Report2';
      (
        document.querySelectorAll(
          '.e-pivotview-report-dialog .e-btn'
        )[1] as HTMLElement
      ).click();
    });
    it('Save As Report1', () => {
      if (
        window.getComputedStyle(
          document.querySelector('.e-pivotview-report-dialog')
        ).display !== 'none'
      ) {
        expect(
          window.getComputedStyle(
    ...
    it('Save Report Dialog-check', function () {
      ...
      (
        document.querySelector(
          '.e-pivot-toolbar .e-remove-report'
        ) as HTMLElement
      ).click();
    });
    it('Remove Report Dialog - Cancel', () => {
      expect(
        window.getComputedStyle(document.querySelector('.e-pivot-error-dialog'))
          .display !== 'none'
      ).toBeTruthy();
      (
        document.querySelectorAll(
          '.e-pivot-error-dialog .e-btn'
        )[2] as HTMLElement
      ).click();
    });
    ...
    it('Rename Report Dialog - Cancel', () => {
      ...
      (
        document.querySelector(
          '.e-pivot-toolbar .e-rename-report'
        ) as HTMLElement
      ).click();
    });
    ...
    it('Rename Report Dialog - Cancel', () => {
      expect(
        document.querySelectorAll('.e-pivot-error-dialog').length > 0
      ).toBeTruthy();
      (
        document.querySelector(
          '.e-pivot-toolbar .e-rename-report'
    ...
    it('New Report', () => {
      ...
      (
        document.querySelector('.e-pivot-toolbar .e-new-report') as HTMLElement
      ).click();
    });
    it('New Report1', () => {
      expect(
    ...
    it('New Report6', () => {
      expect(
        document.querySelectorAll('#PivotGrid_ConfirmDialog').length > 0
      ).toBeTruthy();
      (document.querySelectorAll('.e-cancel-btn')[1] as HTMLElement).click();
    });
