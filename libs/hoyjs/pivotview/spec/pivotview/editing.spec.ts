...
describe('- Editing', () => {
  ...
  describe('- normal', () => {
    ...
    it('click california-quantity-female', (done: Function) => {
      expect(
        document.querySelectorAll('td[aria-colindex="5"]')[0].textContent
      ).toBe('1372.23');
      document
        .querySelectorAll('td[aria-colindex="5"]')[3]
        .dispatchEvent(event);
      setTimeout(() => {
        document
    ...
    it('remove tamilnadu single', (done: Function) => {
      expect(
        document.querySelectorAll('td[aria-colindex="3"]')[3].textContent
      ).toBe('');
      document
        .querySelectorAll('td[aria-colindex="3"]')[7]
        .dispatchEvent(event);
      setTimeout(() => {
        document
          .querySelectorAll('.e-drillthrough-grid tr')[2]
          .querySelector('td')
          .dispatchEvent(click);
        document
          .querySelectorAll('.e-drillthrough-grid .e-tbar-btn')[2]
          .dispatchEvent(click);
        done();
      }, 1000);
    });
    ...
    it('remove tamilnadu', (done: Function) => {
      expect(
        document.querySelectorAll('td[aria-colindex="3"]')[7].textContent
      ).toBe('35922.28');
      document
        .querySelectorAll('td[aria-colindex="3"]')[7]
        .dispatchEvent(event);
      ...
      setTimeout(() => {
        expect(
          document.querySelector(
            '#PivotGrid_drillthroughgridEditAlert_dialog-content'
          ).textContent
        ).toBe('No records selected for delete operation');
        done();
      }, 1000);
    });
    it('add tamilnadu', (done: Function) => {
      ...
      setTimeout(() => {
        document
          .querySelectorAll('.e-drillthrough-grid .e-tbar-btn')[0]
          .dispatchEvent(click);
        done();
      }, 1000);
    });
    it('add tamilnadu 1', (done: Function) => {
      setTimeout(() => {
        (
          document.querySelectorAll(
            '.e-drillthrough-grid .e-inline-edit .e-input'
        ...
        document
          ...
          .dispatchEvent(mouseup);
        document
          .querySelectorAll('.e-drillthrough-grid .e-numeric span')[3]
          .dispatchEvent(mousedown);
        document
          .querySelectorAll('.e-drillthrough-grid .e-numeric span')[3]
          .dispatchEvent(mouseup);
        document
          .querySelectorAll('.e-drillthrough-grid .e-numeric span')[5]
          .dispatchEvent(mousedown);
        document
          .querySelectorAll('.e-drillthrough-grid .e-numeric span')[5]
          .dispatchEvent(mouseup);
    ...
    it('batch click bike-female-balance', (done: Function) => {
      document
        .querySelectorAll('td[aria-colindex="2"]')[1]
        .dispatchEvent(event);
      setTimeout(() => {
        document
          .querySelectorAll('.e-drillthrough-grid td[aria-colindex="14"]')[0]
          .dispatchEvent(event);
        document
    ...
    it('batch remove tamilnadu single', (done: Function) => {
      ...
      setTimeout(() => {
        document
          ...
          .dispatchEvent(click);
        document
          .querySelectorAll('.e-drillthrough-grid .e-tbar-btn')[1]
          .dispatchEvent(click);
        document
          .querySelectorAll('.e-drillthrough-grid .e-tbar-btn')[2]
          .dispatchEvent(click);
    ...
    it('dialog click bike-female-balance', (done: Function) => {
      document
        .querySelectorAll('td[aria-colindex="5"]')[0]
        .dispatchEvent(event);
      setTimeout(() => {
        document
          .querySelectorAll('.e-drillthrough-grid td[aria-colindex="12"]')[0]
          .dispatchEvent(event);
        ...
        document
          .querySelectorAll('.e-edit-dialog button.e-primary')[0]
          .dispatchEvent(click);
        done();
      }, 1000);
    });
    it('dialog click bike-female-balance check', (done: Function) => {
      setTimeout(() => {
        expect(
          document.querySelectorAll(
            '.e-drillthrough-grid td[aria-colindex="12"]'
          )[0].textContent
        ).toBe('16');
        (
          document.querySelectorAll(
    ...
    it('cc click bike-female-balance', (done: Function) => {
      ...
      setTimeout(() => {
        document
          .querySelectorAll('.e-drillthrough-grid .e-editbutton')[0]
          .dispatchEvent(click);
        done();
      }, 1000);
    });
    it('cc click bike-female-balance save', (done: Function) => {
      setTimeout(() => {
        document
          .querySelectorAll('.e-drillthrough-grid .e-spin-down')[0]
          .dispatchEvent(mousedown);
        document
          .querySelectorAll('.e-drillthrough-grid .e-spin-down')[0]
          .dispatchEvent(mouseup);
        document
          .querySelectorAll('.e-drillthrough-grid .e-savebutton')[0]
          .dispatchEvent(click);
        done();
      }, 1000);
    });
    ...
    it('cc click california-quantity-female', (done: Function) => {
      expect(
        document.querySelectorAll('td[aria-colindex="4"]')[1].textContent
      ).toBe('14');
      document
        .querySelectorAll('td[aria-colindex="5"]')[3]
        .dispatchEvent(event);
    ...
    it('cc click california-quantity-female save', (done: Function) => {
      setTimeout(() => {
        document
          .querySelectorAll('.e-drillthrough-grid .e-spin-up')[0]
          .dispatchEvent(mousedown);
        document
          .querySelectorAll('.e-drillthrough-grid .e-spin-up')[0]
          .dispatchEvent(mouseup);
