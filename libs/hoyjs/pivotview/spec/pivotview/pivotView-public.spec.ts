...
import { createElement, EmitType, remove } from '@hoyui/base';
...
describe('Pivotview Public properties null or undefined value testing', () => {
  ...
  describe('PivotView public property testing', () => {
    ...
    it('pivotview-gridsettings-null-check', (done: Function) => {
      setTimeout(() => {
        ...
        expect(
          pivotGridObj.gridSettings.selectionSettings.cellSelectionMode
        ).toBe(null);
        // Test with undefined value
    ...
    it('pivotview-gridsettings-undefined-check', (done: Function) => {
      setTimeout(() => {
        ...
        expect(pivotGridObj.gridSettings.selectionSettings.mode).toBe(
          undefined
        );
        expect(pivotGridObj.gridSettings.selectionSettings.type).toBe(
          undefined
        );
        expect(
          pivotGridObj.gridSettings.selectionSettings.cellSelectionMode
    ...
    it('virtualscrollsettings-allowSinglePage-undefined-check', (done: Function) => {
      setTimeout(() => {
        expect(pivotGridObj.virtualScrollSettings.allowSinglePage).toBe(
          undefined
        );
        done();
      }, 100);
  ...
  describe(' PivotView DataSourceSettings - public property testing', () => {
    ...
    it('DataSourceSettings-public property-1', () => {
      ...
      expect(pivotGridObj1.dataSourceSettings.showAggregationOnValueField).toBe(
        null
      );
      // Test with undefined value
    ...
    it('DataSourceSettings-public property-2', () => {
      ...
      expect(pivotGridObj1.dataSourceSettings.allowMemberFilter).toBe(
        undefined
      );
      ...
      expect(pivotGridObj1.dataSourceSettings.showColumnSubTotals).toBe(
        undefined
      );
      expect(pivotGridObj1.dataSourceSettings.subTotalsPosition).toBe(
        undefined
      );
      expect(pivotGridObj1.dataSourceSettings.showGrandTotals).toBe(undefined);
      expect(pivotGridObj1.dataSourceSettings.grandTotalsPosition).toBe(
        undefined
      );
      expect(pivotGridObj1.dataSourceSettings.showRowGrandTotals).toBe(
        undefined
      );
      expect(pivotGridObj1.dataSourceSettings.showColumnGrandTotals).toBe(
        undefined
      );
      expect(pivotGridObj1.dataSourceSettings.alwaysShowValueHeader).toBe(
        undefined
      );
      expect(pivotGridObj1.dataSourceSettings.showHeaderWhenEmpty).toBe(
        undefined
      );
      expect(pivotGridObj1.dataSourceSettings.showAggregationOnValueField).toBe(
        undefined
    ...
    it('editsettings - public property-2', () => {
      ...
      expect(pivotGridObj1.editSettings.showDeleteConfirmDialog).toBe(
        undefined
      );
    ...
    it('groupingbarsettings - public property-2', () => {
      expect(pivotGridObj1.groupingBarSettings.allowDragAndDrop).toBe(
        undefined
      );
      ...
      expect(pivotGridObj1.groupingBarSettings.showValueTypeIcon).toBe(
        undefined
      );
    ...
    it('hyperlinkSettings - public property', () => {
      ...
      expect(pivotGridObj1.hyperlinkSettings.showColumnHeaderHyperlink).toBe(
        null
      );
      expect(pivotGridObj1.hyperlinkSettings.showValueCellHyperlink).toBe(null);
      expect(pivotGridObj1.hyperlinkSettings.showSummaryCellHyperlink).toBe(
        null
      );
    ...
    it('hyperlinkSettings - public property', () => {
      ...
      expect(pivotGridObj1.hyperlinkSettings.showRowHeaderHyperlink).toBe(
        undefined
      );
      expect(pivotGridObj1.hyperlinkSettings.showColumnHeaderHyperlink).toBe(
        undefined
      );
      expect(pivotGridObj1.hyperlinkSettings.showValueCellHyperlink).toBe(
        undefined
      );
      expect(pivotGridObj1.hyperlinkSettings.showSummaryCellHyperlink).toBe(
        undefined
  ...
  describe('ChartSettings public property testing', () => {
    ...
    it('chartsettings background public property-2', () => {
      ...
      expect(pivotGridObj2.chartSettings.accumulationSelectionMode).toBe(
        undefined
      );
      ...
      expect(pivotGridObj2.chartSettings.chartArea.backgroundImage).toBe(
        undefined
      );
    ...
    it('chartSettings-ChartArea public property-2', () => {
      expect(pivotGridObj2.chartSettings.chartArea.border.color).toBe(
        undefined
      );
      expect(pivotGridObj2.chartSettings.chartArea.border.dashArray).toBe(
        undefined
      );
      expect(pivotGridObj2.chartSettings.chartArea.border.width).toBe(
        undefined
      );
    });
    ...
    it('chartsettings-enableBorderOnMouseMove public property-2', () => {
      expect(pivotGridObj2.chartSettings.enableBorderOnMouseMove).toBe(
        undefined
      );
    });
    ...
    it('chartsettings-enableScrollOnMultiAxis public property-2', () => {
      expect(pivotGridObj2.chartSettings.enableScrollOnMultiAxis).toBe(
        undefined
      );
    });
    // Test case for the chartsettings-enableScrollOnMultiAxis public property.
    ...
    it('chartsettings-enableSideBySidePlacement public property-2', () => {
      expect(pivotGridObj2.chartSettings.enableSideBySidePlacement).toBe(
        undefined
      );
    });
    ...
    it('chartsettings-primaryXAxis.zoomFactor public property-2', () => {
      expect(pivotGridObj2.chartSettings.primaryXAxis.zoomFactor).toBe(
        undefined
      );
    });
    // Test case for the chartsettings-multipleAxisMode public property.
    ...
    it('chartsettings-primaryYAxis public property-1', () => {
      ...
      expect(pivotGridObj2.chartSettings.primaryYAxis.edgeLabelPlacement).toBe(
        null
      );
      // Test with undefined value
    ...
    it('chartsettings-primaryYAxis public property-2', () => {
      expect(pivotGridObj2.chartSettings.primaryYAxis.zoomFactor).toBe(
        undefined
      );
      expect(pivotGridObj2.chartSettings.primaryYAxis.edgeLabelPlacement).toBe(
        undefined
    ...
    it('chartsettings-showPointColorByMembers public property-2', () => {
      expect(pivotGridObj2.chartSettings.showPointColorByMembers).toBe(
        undefined
      );
    });
    ...
    it('chartsettings-zoomSettings public property-1', () => {
      expect(
        pivotGridObj2.chartSettings.zoomSettings.enableDeferredZooming
      ).toBe(null);
      expect(
        pivotGridObj2.chartSettings.zoomSettings.enableMouseWheelZooming
      ).toBe(null);
      expect(pivotGridObj2.chartSettings.zoomSettings.enablePan).toBe(null);
      expect(pivotGridObj2.chartSettings.zoomSettings.enablePinchZooming).toBe(
        null
      );
      expect(pivotGridObj2.chartSettings.zoomSettings.enableScrollbar).toBe(
        null
      );
      expect(
        pivotGridObj2.chartSettings.zoomSettings.enableSelectionZooming
      ).toBe(null);
    ...
    it('chartsettings-zoomSettings public property-2', () => {
      ...
      expect(pivotGridObj2.chartSettings.zoomSettings.enablePan).toBe(
        undefined
      );
      expect(pivotGridObj2.chartSettings.zoomSettings.enablePinchZooming).toBe(
        undefined
      ...
      expect(pivotGridObj2.chartSettings.zoomSettings.toolbarItems).toBe(
        undefined
      );
    });
  });
  describe('PivotView public datasourcesettings default item property- testing', () => {
    ...
    it('dataSourceSettings-conditionalFormatSettings public property-1', () => {
      expect(
        pivotGridObj4.dataSourceSettings.conditionalFormatSettings
      ).toEqual([]);
      // Test with undefined value
    ...
    it('dataSourceSettings-drilledMembers public property-1', () => {
      expect(
        pivotGridObj4.dataSourceSettings.valueSortSettings.headerDelimiter
      ).toBe(null);
      expect(
        pivotGridObj4.dataSourceSettings.valueSortSettings.headerText
      ).toBe(null);
      expect(pivotGridObj4.dataSourceSettings.valueSortSettings.measure).toBe(
        null
      );
      expect(pivotGridObj4.dataSourceSettings.valueSortSettings.sortOrder).toBe(
        null
      );
      // Test with undefined value.
      pivotGridObj4.dataSourceSettings.valueSortSettings.headerDelimiter =
