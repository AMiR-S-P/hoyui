...
describe('Server side pivot engine ', () => {
  describe('- Initial Rendering and Basic Operations', () => {
    ...
    it('Popup field list - ascend & descend', () => {
      expect(
        document.querySelectorAll(
          '.e-field-table .e-field-list-tree-outer-div .e-field-list ul li'
        )[0].textContent
      ).toBe('Product ID');
    ...
    it('Popup field list - ascend & descend-1', (done: Function) => {
      setTimeout(() => {
        ...
        (
          document.querySelectorAll('.e-sort-descend')[0] as HTMLElement
        ).click();
        done();
      }, 500);
    });
    ...
    it('Field list Filering - columns - 01', (done: Function) => {
      setTimeout(() => {
        expect(
          document.querySelectorAll('.e-member-editor-dialog').length
        ).toBe(1);
        done();
      }, 2000);
    });
    it('Field list Filering - columns - 001', (done: Function) => {
      setTimeout(() => {
        ...
        let checkEle: NodeListOf<Element> = <Element[] & NodeListOf<Element>>(
  ...
  describe('- Initial Rendering and Basic Operations-1', () => {
    ...
    it('Field list Filering - rows - 0002', (done: Function) => {
      setTimeout(() => {
        expect(
          document.querySelectorAll('.e-pivotfieldlist-container').length
        ).toBe(1);
        done();
      }, 500);
    });
