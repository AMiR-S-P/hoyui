...
describe('Pivot Grid - HyperLink', () => {
  ...
  it('Check on show all cells hyperlink', (done: Function) => {
    ...
    setTimeout(() => {
      expect(
        pivotGridObj.element.querySelectorAll('.e-gridheader,.e-gridcontent')
          .length > 1
      ).toBeTruthy();
      expect(
        pivotGridObj.element.querySelector('.e-gridcontent .e-content td a')
      ).toBeTruthy;
      done();
    }, 1000);
  });
    ...
    setTimeout(() => {
      ...
      expect(
        pivotGridObj.element.querySelector(
          '.e-gridheader .e-headercontent th a'
        )
      ).toBeTruthy;
      done();
    }, 1000);
    ...
    setTimeout(() => {
      ...
      expect(
        pivotGridObj.element
          ...
          .querySelectorAll('.e-valuescontent a')[30]
      ).toBeTruthy;
      done();
    }, 1000);
  });
  it('Check on show summary cells hyperlink only', (done: Function) => {
    ...
    setTimeout(() => {
      ...
      expect(
        pivotGridObj.element
          .querySelector('.e-content tr')
          .querySelectorAll('td a')[1]
      ).toBeTruthy;
      done();
    }, 1000);
  });
  it('Check on show hyperlink with conditional-based', (done: Function) => {
    ...
    setTimeout(() => {
      ...
      expect(
        pivotGridObj.element
          .querySelector('.e-content')
          .querySelectorAll('.e-valuescontent a')[20]
      ).toBeTruthy;
      done();
    }, 1000);
  });
