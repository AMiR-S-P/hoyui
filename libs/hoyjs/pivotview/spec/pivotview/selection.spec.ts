...
describe(' - selection', () => {
  ...
  describe(' - column_single', () => {
    ...
    it('FY 2005 mouse click', (done: Function) => {
      setTimeout(() => {
        expect(
          document.querySelector('[aria-colindex="1"][index="2"]').textContent
        ).toBe('Alberta');
        document
          .querySelector('[aria-colindex="2"][index="0"]')
          .dispatchEvent(click);
        done();
      }, 2000);
    });
    it('Canada.Alberta mouse click', function (done) {
      setTimeout(function () {
        ...
        document
          .querySelector('[aria-colindex="1"][index="2"]')
          .dispatchEvent(click);
        done();
      }, 2000);
    });
    it('Canada * FY 2005 value cell mouse click', function (done) {
      setTimeout(function () {
        expect(args.selectedCellsInfo[0].columnHeaders).toBe('FY 2005');
        document
          .querySelector('[aria-colindex="1"][index="1"]')
          .dispatchEvent(click);
        done();
      }, 2000);
    });
    ...
    it('FY 2006 mouse click', function (done) {
      setTimeout(function () {
        expect(args.selectedCellsInfo.length).toBe(0);
        document
          .querySelector('[aria-colindex="3"][index="0"]')
          .dispatchEvent(click);
        done();
      }, 2000);
    });
    ...
    it('Canada * FY 2005 value cell mouse click', function (done) {
      setTimeout(function () {
        expect(args.selectedCellsInfo[0].columnHeaders).toBe('FY 2006');
        document
          .querySelector('[aria-colindex="2"][index="1"]')
          .dispatchEvent(click);
        done();
      }, 2000);
    });
  ...
  describe(' - both_single', () => {
    ...
    it('Canada * FY 2007 value cell mouse click', function (done) {
      setTimeout(function () {
        document
          .querySelector('[aria-colindex="4"][index="1"]')
          .dispatchEvent(click);
        done();
      }, 2000);
    });
    ...
    it('FY 2007 keyboard ctrl + mouse click', function (done) {
      setTimeout(function () {
        ...
        document
          .querySelector('[aria-colindex="4"][index="0"]')
          .dispatchEvent(ctrlClick);
        done();
      }, 2000);
    });
  ...
  describe(' - keyboard_column_single', () => {
    ...
    it('-> FY 2006 using keyboard right arrow', function (done) {
      setTimeout(function () {
        expect(args.selectedCellsInfo[0].columnHeaders).toBe('FY 2005');
        (pivotGridObj.keyboardModule as any).keyActionHandler({
          action: 'rightArrow',
          target: document.querySelector('[aria-colindex="2"][index="0"]'),
          preventDefault: (): void => {
            /** Null */
          },
        });
    ...
    it('FY 2005 keyboard shift + mouse click', function (done) {
      setTimeout(function () {
        ...
        (pivotGridObj.keyboardModule as any).keyActionHandler({
          action: 'shiftLeft',
          shiftKey: true,
          target: document.querySelector('[aria-colindex="3"][index="0"]'),
          preventDefault: (): void => {
            /** Null */
          },
        });
    ...
    it('Canada.Alberta * FY 2006 value cell mouse click', function (done) {
      setTimeout(function () {
        ...
        document
          .querySelector('[aria-colindex="3"][index="2"]')
          .dispatchEvent(click);
        done();
      }, 2000);
    });
    ...
    it('-> FY 2005 using keyboard up arrow', function (done) {
      setTimeout(function () {
        ...
        (pivotGridObj.keyboardModule as any).keyActionHandler({
          action: 'upArrow',
          target: document.querySelector('[aria-colindex="2"][index="1"]'),
          preventDefault: (): void => {
            /** Null */
          },
        });
    ...
    it('-> 0th cell using keyboard up arrow', function (done) {
      setTimeout(function () {
        ...
        (pivotGridObj.keyboardModule as any).keyActionHandler({
          action: 'upArrow',
          target: document.querySelector('[aria-colindex="1"][index="2"]'),
          preventDefault: (): void => {
            /** Null */
          },
        });
    ...
    it('-> Canada.Alberta * FY 2005.Amount value cell using keyboard right arrow', function (done) {
      setTimeout(function () {
        ...
        (pivotGridObj.keyboardModule as any).keyActionHandler({
          action: 'rightArrow',
          target: document.querySelector('[aria-colindex="1"][index="3"]'),
          preventDefault: (): void => {
            /** Null */
          },
        });
    ...
    it('-> Canada.Alberta using keyboard left arrow', function (done) {
      setTimeout(function () {
        ...
        (pivotGridObj.keyboardModule as any).keyActionHandler({
          action: 'leftArrow',
          target: document.querySelector('[aria-colindex="2"][index="3"]'),
          preventDefault: (): void => {
            /** Null */
          },
        });
    ...
    it('FY 2006 mouse click + adaptive mode + Both + Multiple -> configured', function (done) {
      setTimeout(function () {
        ...
        pivotGridObj.setProperties({
          gridSettings: { selectionSettings: { mode: 'Both' } },
        });
        pivotGridObj.gridSettings.selectionSettings.type = 'Multiple';
