...
import { DataManager, ODataV4Adaptor, Query } from '@hoyui/data';
...
describe('PivotView spec', () => {
  ...
  describe('PivotEngine population', () => {
    ...
    describe('PagerUI', () => {
      ...
      it('filter testing', () => {
        expect(
          pivotGridObj.engineModule.pivotValues.length === 8 &&
            pivotGridObj.engineModule.pivotValues[2].length === 4
        ).toBeTruthy();
      ...
      it('sort testing04', () => {
        ...
        expect(
          pivotGridObj.engineModule.pivotValues.length === 8 &&
            pivotGridObj.engineModule.pivotValues[3].length === 4
        ).toBeTruthy();
      ...
      it('filter testing7', (done: Function) => {
        setTimeout(() => {
          ...
          expect(
            pivotGridObj.engineModule.pivotValues.length === 6 &&
              pivotGridObj.engineModule.pivotValues[2].length === 5
          ).toBeTruthy();
          (
            document.querySelectorAll('.e-btn-filter')[6] as HTMLElement
          ).click();
          done();
        }, 100);
      });
      ...
      it('drilldown testing010', () => {
        ...
        expect(
          pivotGridObj.engineModule.pivotValues.length === 7 &&
            pivotGridObj.engineModule.pivotValues[2].length === 5
        ).toBeTruthy();
      ...
      it('Sub Total', (done: Function) => {
        setTimeout(() => {
          let li: HTMLElement = document.getElementById(
            'PivotGridsubtotal_menu'
      ...
      it('Sub Total - True', (done: Function) => {
        setTimeout(() => {
          (
            document.querySelectorAll('.e-menu-popup li')[0] as HTMLElement
          ).click();
          let li: HTMLElement = document.getElementById(
            'PivotGridsubtotal_menu'
          ).children[0] as HTMLElement;
      ...
      it('Sub Total - False', (done: Function) => {
        setTimeout(() => {
          (
            document.querySelectorAll('.e-menu-popup li')[1] as HTMLElement
          ).click();
          let li: HTMLElement = document.getElementById(
            'PivotGridsubtotal_menu'
          ).children[0] as HTMLElement;
      ...
      it('Sub Total - Row', (done: Function) => {
        setTimeout(() => {
          (
            document.querySelectorAll('.e-menu-popup li')[2] as HTMLElement
          ).click();
          let li: HTMLElement = document.getElementById(
            'PivotGridsubtotal_menu'
          ).children[0] as HTMLElement;
      ...
      it('Sub Total - Column', (done: Function) => {
        setTimeout(() => {
          (
            document.querySelectorAll('.e-menu-popup li')[3] as HTMLElement
          ).click();
          let li: HTMLElement = document.getElementById(
            'PivotGridsubtotal_menu'
          ).children[0] as HTMLElement;
      ...
      it('Mouseover on chart icon', () => {
        expect(
          pivotGridObj.element.querySelector('.e-pivot-toolbar') !== undefined
        ).toBeTruthy();
        expect(
          (
            pivotGridObj.element.querySelector(
              '.e-chart-grouping-bar'
            ) as HTMLElement
          ).style.display === 'none'
        ).toBeTruthy();
        let li: HTMLElement = document.getElementById('PivotGridchart_menu')
          .children[0] as HTMLElement;
        expect(li.classList.contains('e-menu-caret-icon')).toBeTruthy();
        util.triggerEvent(li, 'mouseover');
      });
      it('Click Column Chart with chart grouping bar', () => {
        ...
        expect(
          (document.querySelector('.e-grid') as HTMLElement).style.display
        ).toBe('none');
        expect(
          (document.querySelector('.e-pivotchart') as HTMLElement).style
            .display === 'none'
        ).toBeFalsy();
        expect(
          pivotGridObj.element.querySelector('.e-chart-grouping-bar')
        ).toBeTruthy();
      });
      it('Switch to Grid with grouping bar', () => {
        (
          document.querySelector(
            '.e-pivot-toolbar .e-toolbar-grid'
          ) as HTMLElement
        ).click();
        expect(
          (document.querySelector('.e-grid') as HTMLElement).style.display ===
      ...
      it('Export', () => {
        let li: HTMLElement = document.getElementById('PivotGridexport_menu')
          .children[0] as HTMLElement;
        expect(li.classList.contains('e-menu-caret-icon')).toBeTruthy();
        util.triggerEvent(li, 'mouseover');
      });
    ...
    describe('VirtualUI', () => {
      ...
      it('filter testing03', (done: Function) => {
        setTimeout(() => {
          ...
          expect(
            pivotGridObj.engineModule.pivotValues.length === 23 &&
              pivotGridObj.engineModule.pivotValues[2].length === 17
          ).toBeTruthy();
          done();
        }, 100);
      });
      ...
      it('sort testing04', (done: Function) => {
        setTimeout(() => {
          ...
          expect(
            pivotGridObj.engineModule.pivotValues.length === 23 &&
              pivotGridObj.engineModule.pivotValues[3].length === 17
          ).toBeTruthy();
          done();
        }, 100);
      });
      ...
      it('filter testing07', (done: Function) => {
        setTimeout(() => {
          ...
          expect(
            pivotGridObj.engineModule.pivotValues.length === 23 &&
              pivotGridObj.engineModule.pivotValues[4].length === 17
          ).toBeTruthy();
          done();
        }, 100);
      });
      ...
      it('filter testing5', (done: Function) => {
        setTimeout(() => {
          expect(
            pivotGridObj.engineModule.pivotValues.length === 10 &&
              pivotGridObj.engineModule.pivotValues[5].length === 5
          ).toBeTruthy();
          (
            document.querySelectorAll('.e-icons.e-sort')[1] as HTMLElement
          ).click();
      ...
      it('drilldown testing013', (done: Function) => {
        setTimeout(() => {
          ...
          expect(
            pivotGridObj.engineModule.pivotValues.length === 42 &&
              pivotGridObj.engineModule.pivotValues[2].length === 21
          ).toBeTruthy();
          (document.querySelectorAll('.e-collapse')[1] as HTMLElement).click();
          done();
        }, 100);
      ...
      it('drillup testing014', (done: Function) => {
        setTimeout(() => {
          ...
          expect(
            pivotGridObj.engineModule.pivotValues.length === 27 &&
              pivotGridObj.engineModule.pivotValues[2].length === 5
          ).toBeTruthy();
          (document.querySelectorAll('.e-remove')[3] as HTMLElement).click();
          done();
      ...
      it('Sub Total', () => {
        let li: HTMLElement = document.getElementById('PivotGridsubtotal_menu')
          .children[0] as HTMLElement;
        expect(li.classList.contains('e-menu-caret-icon')).toBeTruthy();
        util.triggerEvent(li, 'mouseover');
      });
    ...
    describe('NormalUI', () => {
      ...
      it('values testing', (done: Function) => {
        setTimeout(() => {
          expect(
            (pivotGridObj.engineModule.pivotValues[3][4] as IDataSet)
              .formattedText
          ).toBe('-$2,775.31');
          done();
        }, 500);
      ...
      it('filter testing01', (done: Function) => {
        setTimeout(() => {
          expect(
            (pivotGridObj.engineModule.pivotValues[4][4] as IDataSet)
              .formattedText
          ).toBe('3');
          done();
        }, 1000);
      ...
      it('filter testing03', (done: Function) => {
        setTimeout(() => {
          ...
          expect(
            pivotGridObj.engineModule.pivotValues.length === 17 &&
              pivotGridObj.engineModule.pivotValues[2].length === 7
          ).toBeTruthy();
          done();
        }, 500);
      });
      ...
      it('sort testing3', (done: Function) => {
        setTimeout(() => {
          ...
          expect(
            pivotGridObj.engineModule.pivotValues.length === 17 &&
              pivotGridObj.engineModule.pivotValues[3].length === 7
          ).toBeTruthy();
          done();
        }, 1000);
      });
      ...
      it('filter testing4', (done: Function) => {
        setTimeout(() => {
          expect(
            pivotGridObj.engineModule.pivotValues.length === 11 &&
              pivotGridObj.engineModule.pivotValues[2].length === 6
          ).toBeTruthy();
          (
            document.querySelectorAll('.e-btn-filter')[4] as HTMLElement
          ).click();
      ...
      it('filter testing07', (done: Function) => {
        setTimeout(() => {
          ...
          expect(
            pivotGridObj.engineModule.pivotValues.length === 11 &&
              pivotGridObj.engineModule.pivotValues[4].length === 5
          ).toBeTruthy();
          done();
        }, 200);
      });
      ...
      it('drilldown testing013', (done: Function) => {
        setTimeout(() => {
          ...
          expect(
            pivotGridObj.engineModule.pivotValues.length === 8 &&
              pivotGridObj.engineModule.pivotValues[2].length === 11
          ).toBeTruthy();
          (document.querySelectorAll('.e-collapse')[1] as HTMLElement).click();
          done();
        }, 300);
    ...
    describe('Virtual-Popups', () => {
      ...
      beforeAll((done: Function) => {
        ...
        pivotGridObj = new PivotView({
          dataSourceSettings: {
            ...
            formatSettings: [
              { name: 'quantity', format: 'C' },
              { name: 'balance', format: '€ ###.0' },
              { name: 'date', format: 'dd/MM/yyyy', type: 'date' },
            ],
            columns: [{ name: 'gender' }],
            values: [
      ...
      it('Filter testing1', (done: Function) => {
        setTimeout(() => {
          expect(
            (pivotGridObj.engineModule.pivotValues[2][3] as IDataSet)
              .formattedText
          ).toBe('€ 1663.8');
          (
            document.querySelectorAll('.e-btn-filter')[2] as HTMLElement
      ...
      it('value filter03', (done: Function) => {
        setTimeout(() => {
          expect(
            pivotGridObj.engineModule.pivotValues.length === 5 &&
              pivotGridObj.engineModule.pivotValues[2].length === 5
          ).toBeTruthy();
          expect(
      ...
      it('value filter', () => {
        (
          document.querySelector(
            '#e-item-PivotGrid_FilterTabContainer_2'
          ) as HTMLElement
        ).click();
        (document.querySelector('.e-ok-btn') as HTMLElement).click();
      ...
      it('value filter04', (done: Function) => {
        setTimeout(() => {
          ...
          (
            document.querySelectorAll('.e-btn-filter')[0] as HTMLElement
          ).click();
          done();
        }, 600);
      });
      it('value filter0', () => {
        (
          document.querySelector('#PivotGrid_Sort_Descend') as HTMLElement
        ).click();
        (document.querySelector('.e-ok-btn') as HTMLElement).click();
      });
      it('aggregation value', (done: Function) => {
        setTimeout(() => {
          ...
          (
            document.querySelectorAll('.e-dropdown-icon')[0] as HTMLElement
          ).click();
          (document.querySelector('#PivotGrid_Avg') as HTMLElement).click();
          (
            document.querySelectorAll('.e-dropdown-icon')[1] as HTMLElement
          ).click();
          ...
          (
            document.querySelector('#PivotGrid_MoreOption') as HTMLElement
          ).click();
          (document.querySelector('.e-ok-btn') as HTMLElement).click();
          done();
        }, 600);
      ...
      it('conditionalformatting-filter05', (done: Function) => {
        setTimeout(() => {
          ...
          (
            document.querySelector('#PivotGridformatting') as HTMLElement
          ).click();
          (
            document.querySelector('.e-format-apply-button') as HTMLElement
          ).click();
          (
            document.querySelector('#PivotGridformatting') as HTMLElement
          ).click();
      ...
      it('conditionalformatting-filter', (done: Function) => {
        setTimeout(() => {
          (
            document.querySelector('.e-format-condition-button') as HTMLElement
          ).click();
          (
            document.querySelector('.e-format-cancel-button') as HTMLElement
          ).click();
          expect(
            pivotGridObj.engineModule.pivotValues.length === 5 &&
              pivotGridObj.engineModule.pivotValues[2].length === 5
      ...
      it('numberformatting-filter2', () => {
        (
          document.querySelector('#PivotGridnumberFormatting') as HTMLElement
        ).click();
        jasmine.DEFAULT_TIMEOUT_INTERVAL = 10000;
        (document.querySelector('.e-ok-btn') as HTMLElement).click();
      });
    ...
    describe('Virtual-Chart', () => {
      ...
      it('PNG Export', (done: Function) => {
        setTimeout(() => {
          (
            document.querySelectorAll('#PivotGridpng')[0] as HTMLElement
          ).click();
          let li: HTMLElement = document.getElementById('PivotGridexport_menu')
            .children[0] as HTMLElement;
          expect(li.classList.contains('e-menu-caret-icon')).toBeTruthy();
      ...
      it('JPEG Export', (done: Function) => {
        setTimeout(() => {
          (
            document.querySelectorAll('#PivotGridjpeg')[0] as HTMLElement
          ).click();
          let li: HTMLElement = document.getElementById('PivotGridexport_menu')
            .children[0] as HTMLElement;
          expect(li.classList.contains('e-menu-caret-icon')).toBeTruthy();
      ...
      it('SVG Export', (done: Function) => {
        setTimeout(() => {
          (
            document.querySelectorAll('#PivotGridsvg')[0] as HTMLElement
          ).click();
          let li: HTMLElement = document.getElementById('PivotGridexport_menu')
            .children[0] as HTMLElement;
          expect(li.classList.contains('e-menu-caret-icon')).toBeTruthy();
    ...
    describe('- Report management with diaplay option chart', () => {
      ...
      it('- Save and load chart data', (done: Function) => {
        document
          .getElementById(
            'PivotGrid_chart0_Axis_MultiLevelLabel_Level_0_Text_0'
          )
          .dispatchEvent(
  ...
  describe('Date-Filtering', () => {
    ...
    it('Filter testing1', (done: Function) => {
      setTimeout(() => {
        (document.querySelectorAll('.e-btn-filter')[3] as HTMLElement).click();
        expect(
          document.querySelectorAll('.e-text-content')[1].textContent
        ).toBe('20/01/1970');
    ...
    beforeAll((done: Function) => {
      ...
      pivotGridObj = new PivotView({
        dataSourceSettings: {
          ...
          values: [{ name: 'Sold', caption: 'Unit Sold', dataType: 'number' }],
          filters: [],
          groupSettings: [{ name: 'Amount', type: 'Number', rangeInterval: 3 }],
        },
        showGroupingBar: true,
        height: 500,
        width: 1000,
