  ...
  describe('PivotEngine population', () => {
    ...
    describe('Aggregation', () => {
      ...
      it('Initial', (done: Function) => {
        setTimeout(() => {
          expect(
            (pivotGridObj.engineModule.pivotValues[4][1] as IDataSet)
              .formattedText
          ).toBe('-');
          done();
        }, 100);
      ...
      it('AnotherType7', () => {
        ...
        pivotGridObj.dataSourceSettings.values[1].type =
          'PercentageOfColumnTotal';
      });
      it('AnotherType8', () => {
        expect(
