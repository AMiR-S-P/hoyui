    ...
    if (!this.parent.pivotCommon) {
      const args: CommonArgs = {
        ...
        dataSourceSettings: (<{ [key: string]: Object }>(
          ...
          ? (<{ [key: string]: Object }>this.parent.dataSourceSettings)
              .properties
          : this.parent.dataSourceSettings,
      ...
      this.parent.pivotCommon.engineModule =
        this.parent.dataType === 'olap'
          ? this.parent.olapEngineModule
          : this.parent.engineModule;
      this.parent.pivotCommon.parentID = this.parent.element.id;
      this.parent.pivotCommon.dataSourceSettings = (<{ [key: string]: object }>(
        this.parent.dataSourceSettings
      )).properties
        ? (<{ [key: string]: object }>this.parent.dataSourceSettings).properties
        : this.parent.dataSourceSettings;
