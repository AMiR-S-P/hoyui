...
export class FieldOptions
  extends ChildProperty<FieldOptions>
 ...
 */
export class ConditionalFormatSettings
  extends ChildProperty<ConditionalFormatSettings>
  implements IConditionalFormatSettings
{
  /**
...
export class FormatSettings
  extends ChildProperty<FormatSettings>
  implements NumberFormatOptions, DateFormatOptions, IFormatSettings
{
  /**
...
export class GroupSettings
  extends ChildProperty<GroupSettings>
...
export class CustomGroups
  extends ChildProperty<CustomGroups>
  implements ICustomGroups
{
  /**
 ...
 */
export class CalculatedFieldSettings
  extends ChildProperty<CalculatedFieldSettings>
  implements ICalculatedFieldSettings
{
  /**
 ...
 */
export class DrillOptions
  extends ChildProperty<DrillOptions>
  implements IDrillOptions
{
  /**
 ...
 */
export class ValueSortSettings
  extends ChildProperty<ValueSortSettings>
  implements IValueSortSettings
{
  /**
...
export class Authentication
  extends ChildProperty<Authentication>
...
export class DataSourceSettings
  extends ChildProperty<DataSourceSettings>
