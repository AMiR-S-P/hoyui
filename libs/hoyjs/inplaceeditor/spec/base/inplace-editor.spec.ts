...
import {
  ...
  EndEditEventArgs,
} from '../../src/inplace-editor/base/index';
...
describe('InPlace-Editor Control', () => {
  ...
  describe('Value element testing', () => {
    ...
    it('Overlay element availability testing', () => {
      expect(isNOU(select('.' + classes.OVERLAY_ICON, valueWrapper))).toEqual(
        false
      );
      expect(
        isNOU(
          select('.' + classes.OVERLAY_ICON + '.' + classes.ICONS, valueWrapper)
        )
      ).toEqual(false);
      expect(
        (<HTMLElement>(
          select('.' + classes.OVERLAY_ICON, valueWrapper)
        )).getAttribute('title')
      ).toEqual('Click to edit');
    });
  ...
  describe('template property testing', () => {
    ...
    beforeEach((): void => {
      document.body.appendChild(
        createElement('input', { className: 'test-input' })
      );
    ...
    it('String as null testing', () => {
      ...
      valueEle.click();
      expect((<HTMLElement>select('.' + classes.INPUT, ele)).innerHTML).toEqual(
        'hi'
      );
      editorObj.type = 'Text';
      editorObj.template = '';
      ...
      valueEle.click();
      expect(
        (<HTMLElement>select('.' + classes.INPUT, ele)).innerHTML
      ).not.toEqual('');
      expect(
        (<HTMLElement>select('.' + classes.INPUT, ele)).innerHTML
      ).not.toEqual('hi');
    ...
    it('Class selector testing', () => {
      ...
      valueEle = <HTMLElement>select('.' + classes.VALUE, ele);
      valueEle.click();
      expect(selectAll('.test-input', document.body).length === 1).toEqual(
        true
      );
    ...
    it('HtmlElement as template testing', () => {
      let trgEle: HTMLElement = <HTMLElement>(
        select('#myElement', document.body)
      );
      editorObj = renderEditor({
        mode: 'Inline',
        template: trgEle,
  ...
  describe('mode property testing', () => {
    ...
    it('Default model with testing', () => {
      ...
      valueEle.click();
      expect(
        selectAll('.' + classes.ROOT_TIP, document.body).length === 1
      ).toEqual(true);
  ...
  describe('editableOn property testing', () => {
    ...
    it('editableOn as "EditIconClick" with testing', () => {
      ...
      ele = editorObj.element;
      let editIconEle: HTMLElement = <HTMLElement>(
        select('.' + classes.OVERLAY_ICON, ele)
      );
  ...
  describe('actionOnBlur with document click testing', () => {
    ...
    it('Clear icon as target with docClickEvent testing', (done: Function) => {
      ...
      inputEle.focus();
      (<HTMLElement>select('.e-clear-icon', ele)).dispatchEvent(
  ...
  describe('Inline - showButtons property testing', () => {
    ...
    it('ShowButtons as "false" with testing', (done: Function) => {
      ...
      expect(editorObj.enableEditMode).toEqual(true);
      setTimeout(() => {
        expect(selectAll('.' + classes.BUTTONS, ele).length === 1).toEqual(
          false
        );
        done();
      }, 400);
  ...
  describe('PopupSettings property testing', () => {
    ...
    it('Default model with testing', () => {
      ...
      expect(editorObj.popupSettings.title).toEqual('');
      expect(
        selectAll('.' + classes.ROOT_TIP + ' .' + classes.TITLE, document.body)
          .length === 1
      ).toEqual(false);
  ...
  describe('saveButton property testing', () => {
    ...
    it('Default model with testing', () => {
      ...
      valueEle.click();
      expect(selectAll('button', ele).length === 2).toEqual(true);
      expect(select('button', ele).classList.contains('e-primary')).toEqual(
        true
      );
    });
    it('Modified model with testing', () => {
  ...
  describe('validate method testing', () => {
    ...
    it('Without rules property to validate testing', (done: Function) => {
      ...
      editorObj.validate();
      expect(
        select('.' + classes.FORM, this.element).classList.contains(
          classes.ERROR
        )
      ).toEqual(false);
      expect(
        select('.e-input-group', this.element).classList.contains(classes.ERROR)
      ).toEqual(false);
      done();
    });
  ...
  describe('Default value updated for the editor testing -', () => {
    ...
    it('Initial value not binded for the Maskedtextbox', (done: Function) => {
      ...
      (document.querySelector('.e-numerictextbox') as HTMLInputElement).value =
        '123456789';
      triggerKeyBoardEvent(
        select('.' + classes.BTN_SAVE, ele) as HTMLElement,
        13
      );
      expect(valueWrapper.classList.contains(classes.OPEN)).toEqual(true);
      expect(
      ...
      triggerKeyBoardEvent(
        select('.' + classes.BTN_CANCEL, ele) as HTMLElement,
        13
      );
      valueEle.click();
      expect(editorObj.model.value === editorObj.value).toBe(true);
  ...
  describe('destroy method testing', () => {
    ...
    it('destroy', () => {
      ...
      expect(isNOU(select('.' + classes.VALUE_WRAPPER, document.body))).toEqual(
        true
      );
      expect(isNOU(select('.' + classes.VALUE, document.body))).toEqual(true);
      expect(isNOU(select('.' + classes.OVERLAY_ICON, document.body))).toEqual(
        true
      );
    });
  });
  ...
  describe('Inline - Editor open and close testing', () => {
    ...
    it('Editable component inside loading element availability testing', () => {
      expect(
        selectAll('.' + classes.INPUT + ' .' + classes.LOADING, ele).length ===
          1
      ).toEqual(true);
    });
    ...
    it('Control group element availability testing', () => {
      expect(selectAll('.' + classes.CTRL_GROUP, ele).length === 1).toEqual(
        true
      );
    });
    it('Error display element availability testing', () => {
      expect(selectAll('.' + classes.EDITABLE_ERROR, ele).length === 1).toEqual(
        true
      );
    });
    ...
    it('Close with editor element availability testing', () => {
      (<HTMLElement>select('.' + classes.BTN_CANCEL, ele)).dispatchEvent(
        new MouseEvent('mousedown')
      );
      expect(selectAll('.' + classes.INLINE, ele).length === 1).toEqual(false);
    });
  ...
  describe('Popup - Editor open and close testing', () => {
    ...
    it('Tooltip element availability testing', () => {
      expect(selectAll('.e-tooltip-wrap', document.body).length === 1).toEqual(
        true
      );
      expect(selectAll('.e-popup', document.body).length === 1).toEqual(true);
      expect(selectAll('.e-popup-open', document.body).length === 1).toEqual(
        true
      );
    ...
    it('Tooltip content first child classList availability testing', () => {
      expect(
        select('.e-tip-content > div', tipEle).classList.length === 1
      ).toEqual(true);
    });
    it('Inline wrapper element availability testing', () => {
      expect(selectAll('.' + classes.WRAPPER, tipEle).length === 1).toEqual(
        true
      );
    });
    it('Loading element availability testing', () => {
      expect(selectAll('.' + classes.LOADING, tipEle).length === 1).toEqual(
        true
      );
    });
    ...
    it('Control group element availability testing', () => {
      expect(selectAll('.' + classes.CTRL_GROUP, tipEle).length === 1).toEqual(
        true
      );
    });
    it('Error display element availability testing', () => {
      expect(
        selectAll('.' + classes.EDITABLE_ERROR, tipEle).length === 1
      ).toEqual(true);
    });
    it('Input wrapper element availability testing', () => {
    ...
    it('Buttons wrapper element availability testing', () => {
      expect(selectAll('.' + classes.BUTTONS, tipEle).length === 1).toEqual(
        true
      );
    });
    it('Close with editor element availability testing', () => {
      (<HTMLElement>select('.' + classes.BTN_CANCEL, tipEle)).dispatchEvent(
        new MouseEvent('mousedown')
      );
      expect(
        selectAll('.' + classes.ROOT_TIP, document.body).length === 1
    ...
    it('Page scroll with testing', (done: Function) => {
      ...
      setTimeout(() => {
        expect(
          select(
            '.' + classes.ROOT + ' .' + classes.VALUE_WRAPPER,
            document.body
          ).classList.contains(classes.OPEN)
        ).toEqual(false);
        expect(
          selectAll('.' + classes.ROOT_TIP, document.body).length === 1
        ).toEqual(false);
  ...
  describe('Value submit testing', () => {
    ...
    it('Success testing', (done: Function) => {
      ...
      setTimeout(() => {
        expect(beginArgs).toEqual({
          data: { name: 'Game', primaryKey: 'text', value: 'Syncfusion' },
          name: 'actionBegin',
        });
    ...
    it('Success with data modify testing', (done: Function) => {
      ...
      setTimeout(() => {
        ...
        expect(successArgs['data']['result'][0]['Value']).toEqual(
          'Modified Syncfusion'
        );
        expect(successArgs['name']).toEqual('actionSuccess');
        expect(successArgs['value']).toEqual('Syncfusion');
      ...
      setTimeout(() => {
        expect(beginArgs).toEqual({
          data: {
            ...
            primaryKey: 'text',
            value: 'Syncfusion',
            custom: 'Syncfusion Custom Data',
          },
          name: 'actionBegin',
        });
        expect(successArgs['data'].result[0]['Custom']).toEqual(
          'Syncfusion Custom Data'
        );
        expect(successArgs['name']).toEqual('actionSuccess');
        expect(successArgs['value']).toEqual('Syncfusion');
        done();
    ...
    it('Type - Date with pass and get with success testing', (done: Function) => {
      ...
      setTimeout(() => {
        expect(beginArgs).toEqual({
          data: { name: 'Game', primaryKey: 3, value: date.toISOString() },
          name: 'actionBegin',
        });
        expect(successArgs['name']).toEqual('actionSuccess');
    ...
    it('primaryKey as "number" with success testing', (done: Function) => {
      ...
      setTimeout(() => {
        expect(beginArgs).toEqual({
          data: { name: 'Game', primaryKey: 3, value: 'Syncfusion' },
          name: 'actionBegin',
        });
  ...
  describe('EJ2-33526 prevent xss at initial render', () => {
    ...
    it('String as "<style>body{width:100px;}</style>" testing', () => {
      ...
      ele = editorObj.element;
      let inputEle: HTMLElement = <HTMLElement>(
        selectAll('.e-editable-overlay-icon', ele)[0]
      );
      inputEle.click();
      expect(
        (<HTMLElement>(
          selectAll('.e-editable-component', ele)[0]
  ...
  describe('EJ2-45911 - endEdit - Need event before exit mode in In-place Editor', () => {
    ...
    it('Outside click testing', (done: Function) => {
      ...
      ele = editorObj.element;
      let valueWrapper: any = <HTMLElement>(
        select('.' + classes.VALUE_WRAPPER, ele)
      );
      expect(valueWrapper.classList.contains(classes.OPEN)).toEqual(true);
  ...
  describe('EJ2-49882- Console error occurs when the large value is typed', () => {
    ...
    it('starting to edit with large values', () => {
      ...
      valueEle.click();
      expect(
        parseFloat(editorObj.model.value as any) ===
          parseFloat('2.2342432423423425e+58')
      ).toEqual(true);
    });
  });
