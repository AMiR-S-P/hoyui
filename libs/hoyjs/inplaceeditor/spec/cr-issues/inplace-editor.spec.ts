 ...
 */
import { select, selectAll, createElement, Browser } from '@hoyui/base';
import {
  InPlaceEditor,
  BeginEditEventArgs,
...
import { DataManager, WebApiAdaptor, Query } from '@hoyui/data';
import {
  MultiSelect,
  Rte,
  AutoComplete,
  ComboBox,
} from '../../src/inplace-editor/modules/index';
...
describe('CR ISSUE InPlace-Editor Control', () => {
  ...
  describe('EJ2-34914: In-place Editor - Type as MultiSelect with allowCustomValue not working issue testing.', () => {
    ...
    it('Check whether the popup is loaded with data', (done) => {
      ...
      setTimeout(() => {
        expect(document.querySelectorAll('.e-list-item').length).toEqual(9);
        let compObj: any = (
          document.querySelector('.e-multiselect.e-control') as any
        ).ej2_instances[0];
      ...
      setTimeout(() => {
        ...
        (
          document.querySelector(
            '.e-editable-action-buttons .e-btn-save'
  ...
  describe('EJ2-31305: In-place Editor - Type as MultiSelect with no initial value', () => {
    ...
    it('Check whether the input is focused and popup is loaded with data', (done) => {
      ...
      setTimeout(() => {
        expect(
          document
            .querySelector('.e-multiselect.e-input-group')
            .classList.contains('e-input-focus')
        ).toEqual(true);
        expect(document.querySelectorAll('.e-list-item').length).toEqual(9);
        done();
      }, 2000);
  ...
  describe('EJ2-31305: In-place Editor - Type as DropDownList with initial value', () => {
    ...
    it('Check whether the popup is loaded with data', (done) => {
      ...
      setTimeout(() => {
        expect(
          document
            .querySelector('.e-ddl.e-input-group')
            .classList.contains('e-input-focus')
        ).toEqual(true);
        expect(document.querySelectorAll('.e-list-item').length).toEqual(9);
        done();
  ...
  describe('EJ2-35418 - I258695: Preventing the editable action for inplace-editor', () => {
    ...
    it('Check ', (done) => {
      ...
      setTimeout(() => {
        ...
        expect(
          document.querySelectorAll('.' + classes.INLINE).length > 0
        ).toEqual(false);
  ...
  describe('EJ2-33001 - Value submit testing', () => {
    ...
    it('actionBegin eventArgs cancel as true testing', (done: Function) => {
      ...
      setTimeout(() => {
        ...
        expect(valueWrapper.classList.contains(classes.HIDE)).toEqual(true);
        expect(
          editorObj.element.querySelectorAll('.' + classes.INPUT).length > 0
        ).toEqual(true);
        done();
      }, 4500);
    });
    it('actionBegin eventArgs cancel as true with popup mode testing', (done: Function) => {
      ...
      setTimeout(() => {
        ...
        expect(valueWrapper.classList.contains(classes.HIDE)).toEqual(false);
        expect(
          document.querySelectorAll('.' + classes.ROOT_TIP).length > 0
        ).toEqual(true);
        done();
      }, 4500);
    });
  ...
  describe('EJ2-33001 - Without change value to submit prevent testing ', () => {
    ...
    it('Without change value to submit testing', (done: Function) => {
      ...
      setTimeout(() => {
        expect(beginArgs).toEqual({
          data: { name: 'Game', primaryKey: 'text', value: 'Syncfusion1' },
          name: 'actionBegin',
        });
        expect(successArgs['name']).toEqual('actionSuccess');
  ...
  describe('Check enableHtmlSanitizer for value property', () => {
    ...
    it('Text', () => {
      ...
      expect((editorObj as any).valueEle.innerText).toBe(
        '<img src="fail"> test'
      );
      expect((editorObj as any).valueEle.innerHTML).toBe(
        '&lt;img src="fail"&gt; test'
      );
    });
    it('RTE', () => {
  ...
  describe('Null or undefined value testing', () => {
    ...
    it('cancelButton', () => {
      ...
      expect(JSON.stringify(editorObj.cancelButton)).toBe(
    ...
    it('saveButton', () => {
      ...
      expect(JSON.stringify(editorObj.saveButton)).toBe(
