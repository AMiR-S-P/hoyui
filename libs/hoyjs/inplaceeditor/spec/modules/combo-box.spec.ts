 ...
 */
import { select, selectAll, isNullOrUndefined, L10n } from '@hoyui/base';
...
describe('ComboBox module', () => {
    ...
    describe('EJ2-34562 - ComboBox initial value render testing', () => {
        let editorObj: any;
    ...
    describe('BLAZ-4764 - New change event testing', () => {
        ...
        it('Without Fields & without initial value - Check changed value', (done) => {
            ...
            setTimeout(() => {
                expect(editorObj.value).toEqual(null);
                editorObj.comboBoxModule.compObj.value = "Badminton";
        ...
        it('With Fields & without initial value - Check changed value', (done) => {
            ...
            setTimeout(() => {
                expect(editorObj.value).toEqual(null);
                editorObj.comboBoxModule.compObj.value = "game1";
                (ele.querySelector('.e-editable-component') as HTMLElement).click();
                setTimeout(() => {
                    expect(changeArgs['name']).toEqual('change');
                    expect(changeArgs['previousValue']).toEqual(null);
