import { createElement, detach, getUniqueID } from '@hoyui/base';
...
export let safariMobileUA: string =
...
export let ieUA: string =
  'Mozilla/5.0 (Windows NT 10.0; WOW64; Trident/7.0; Touch; .NET4.0C;' +
