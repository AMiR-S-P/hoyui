import { Component, INotifyPropertyChanged, NotifyPropertyChanges, Property, Event, EmitType, select } from '@hoyui/base';
import { detach, addClass, removeClass, EventHandler, setStyleAttribute, Complex, ModuleDeclaration } from '@hoyui/base';
import { isNullOrUndefined as isNOU, closest, extend, L10n, compile, Browser, Touch, TapEventArgs } from '@hoyui/base';
import { updateBlazorTemplate, resetBlazorTemplate, SanitizeHtmlHelper, getValue, isBlazor } from '@hoyui/base';
import { DataManager, UrlAdaptor, Query, WebApiAdaptor, ODataV4Adaptor, ReturnOption, Predicate } from '@hoyui/data';
import { Button, ButtonModel } from '@hoyui/buttons';
import { RichTextEditorModel } from '@hoyui/richtexteditor';
import { DatePicker, DatePickerModel, DateTimePicker, DateRange, RangeEventArgs } from '@hoyui/calendars';
import { DateTimePickerModel, DateRangePickerModel, TimePickerModel } from '@hoyui/calendars';
import { createSpinner, hideSpinner, SpinnerArgs, showSpinner} from '@hoyui/popups';
import { Tooltip, TooltipEventArgs, TipPointerPosition } from '@hoyui/popups';
import { NumericTextBox, NumericTextBoxModel, TextBox, TextBoxModel, SliderChangeEventArgs, ValidArgs } from '@hoyui/inputs';
import { ColorPickerModel, FormValidator, MaskedTextBox, MaskedTextBoxModel, SliderModel } from '@hoyui/inputs';
import { ChangeEventArgs as InputChangeEventArgs, ColorPickerEventArgs } from '@hoyui/inputs';
import { AutoCompleteModel, ComboBoxModel, DropDownList, DropDownListModel, MultiSelectModel } from '@hoyui/dropdowns';
import { MultiSelectChangeEventArgs, ChangeEventArgs as DropDownsChangeEventArgs } from '@hoyui/dropdowns';
/* Inject modules */
