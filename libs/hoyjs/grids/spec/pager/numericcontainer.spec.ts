...
describe('Numericcontainer module testing', () => {
  ...
  describe('numericcontainer method and actions testing', () => {
    ...
    it('Navigate page testing', () => {
      (
        pagerObj.element.querySelectorAll('.e-numericcontainer')[0]
  ...
  describe('numericcontainer method and actions testing when pager has been resized', () => {
    ...
    it('Auxclick event checking', function () {
      ...
      let pagerlink = pagerObj.element.querySelectorAll(
        '.e-numericcontainer'
      )[0].childNodes[1] as HTMLElement;
