...
describe('Pagermessage module', () => {
  ...
  describe('Pager message method testing', () => {
    ...
    it('pagerMessage hide testing', () => {
      ...
      expect(
        (pagerObj.element.querySelector('.e-pagenomsg') as HTMLElement).style
          .display
      ).toBe('none');
      expect(
        (pagerObj.element.querySelector('.e-pagecountmsg') as HTMLElement).style
          .display
      ).toBe('none');
    });
  ...
  describe('Pager message disable testing', () => {
    ...
    it('pagerMessage element testing', () => {
      ...
      expect(pagerObj.element.querySelectorAll('.e-pagecountmsg').length).toBe(
        0
      );
    });
