...
import { createElement, remove, EmitType, select } from '@hoyui/base';
...
describe('context menu module', () => {
  describe('coverage improvement - pdf and excel exports', () => {
    ...
    it('build default item', () => {
      (gridObj.contextMenuModule as any).targetColumn =
        gridObj.getColumnByField('EmployeeID');
      (gridObj.contextMenuModule as any).eventArgs = {
        target: gridObj.getDataRows()[1].firstChild,
      };
      for (let item of gridObj.contextMenuItems) {
        let itemModel = (gridObj.contextMenuModule as any).defaultItems[
          item as string
        ];
        if ((item as string).toLocaleLowerCase().indexOf('delete') !== -1) {
          (gridObj.contextMenuModule as any).selectRow({
            target: gridObj.getDataRows()[1].firstChild,
          });
        }
        ...
        (gridObj.contextMenuModule as any).contextMenuItemClick({
          item: itemModel,
        });
      }
      if (
  ...
  describe('default items', () => {
    ...
    it('render', () => {
      ...
      expect((gridObj.contextMenuModule as any).element.id).toBe(
        gridObj.element.id + '_cmenu'
      );
      expect(gridObj.contextMenuModule.contextMenu.enableRtl).toBe(
        gridObj.enableRtl
      );
      expect(gridObj.contextMenuModule.contextMenu.locale).toBe(gridObj.locale);
      expect(gridObj.contextMenuModule.contextMenu.enablePersistence).toBe(
        gridObj.enablePersistence
      );
      expect(gridObj.contextMenuModule.contextMenu.target).toBe(
        '#' + gridObj.element.id
      );
      expect(gridObj.contextMenuModule.contextMenu.cssClass).toBe(
        'e-grid-menu'
      );
      expect(gridObj.contextMenuModule.contextMenu.items.length).toBe(
        gridObj.contextMenuItems.length - 3 + 1
      );
      expect((gridObj.contextMenuModule as any).getModuleName()).toBe(
        'contextMenu'
      );
      expect(gridObj.contextMenuModule.getContextMenu()).toBe(
        (gridObj.contextMenuModule as any).element
      );
    });
  ...
  describe('coverage - header default items', () => {
    ...
    it('build default item', () => {
      ...
      (gridObj.contextMenuModule as any).cell =
        gridObj.getDataRows()[1].firstChild;
      for (let item of gridObj.contextMenuItems) {
        let itemModel = (gridObj.contextMenuModule as any).defaultItems[
          item as string
        ];
  ...
  describe('coverage improvement- default items functionality', () => {
    ...
    it('header with sort test', () => {
      (gridObj.contextMenuModule as any).eventArgs = {
        target: gridObj.getHeaderTable().querySelector('th'),
      };
      let e = {
  ...
  describe('default items functionality', () => {
    ...
    it('header with sort test', (done) => {
      ...
      (gridObj.contextMenuModule as any).contextMenuBeforeOpen(e);
      expect(
        (gridObj.contextMenuModule as any).hiddenItems.length
      ).toBeGreaterThan(0);
      expect((gridObj.contextMenuModule as any).hiddenItems.length).toBe(10);
      expect(
        (gridObj.contextMenuModule as any).disableItems.indexOf(
          'Sort Ascending'
        )
    ...
    it('header with sort and group test', () => {
      (gridObj.contextMenuModule as any).eventArgs = {
        target: gridObj.getHeaderTable().querySelectorAll('th')[1],
      };
      let e = {
        event: (gridObj.contextMenuModule as any).eventArgs,
        items: gridObj.contextMenuModule.contextMenu.items,
    ...
    it('content', () => {
      (gridObj.contextMenuModule as any).eventArgs = {
        target: gridObj.getContent().querySelector('tr').querySelector('td'),
      };
      let e = {
        event: (gridObj.contextMenuModule as any).eventArgs,
        items: gridObj.contextMenuModule.contextMenu.items,
      ...
      (gridObj.contextMenuModule as any).contextMenuBeforeOpen(e);
      expect(
        (gridObj.contextMenuModule as any).disableItems.indexOf('Copy')
      ).toBeGreaterThanOrEqual(0);
      (gridObj.contextMenuModule as any).contextMenuOpen();
      (gridObj.contextMenuModule as any).contextMenuOnClose(e);
    });
    it('page 1 test', (done) => {
      (gridObj.contextMenuModule as any).eventArgs = {
        target: (gridObj.pagerModule as any).element,
      };
      let e = {
        event: (gridObj.contextMenuModule as any).eventArgs,
        items: gridObj.contextMenuModule.contextMenu.items,
      ...
      expect((gridObj.contextMenuModule as any).hiddenItems.length).toBe(12);
      expect(
        (gridObj.contextMenuModule as any).disableItems.indexOf('First Page')
      ).toBeGreaterThanOrEqual(0);
      expect(
        (gridObj.contextMenuModule as any).disableItems.indexOf('Previous Page')
      ).toBeGreaterThanOrEqual(0);
      (gridObj.contextMenuModule as any).contextMenuOpen();
      (gridObj.contextMenuModule as any).contextMenuOnClose(e);
      gridObj.goToPage(2);
    ...
    it('page 2 test', (done) => {
      ...
      expect(
        (gridObj.contextMenuModule as any).disableItems.indexOf('Next Page')
      ).toBe(-1);
      expect(
        (gridObj.contextMenuModule as any).disableItems.indexOf('Last Page')
      ).toBe(-1);
      (gridObj.contextMenuModule as any).contextMenuOpen();
      (gridObj.contextMenuModule as any).contextMenuOnClose(e);
    ...
    it('edited row', () => {
      gridObj.editModule.startEdit(
        gridObj.getContent().querySelectorAll('tr')[1]
      );
      (gridObj.contextMenuModule as any).eventArgs = {
        target: gridObj.getContentTable().querySelector('.e-inline-edit'),
      };
      let e = {
        event: (gridObj.contextMenuModule as any).eventArgs,
        items: gridObj.contextMenuModule.contextMenu.items,
      ...
      expect(
        (gridObj.contextMenuModule as any).disableItems.indexOf('Save')
      ).toBe(-1);
      expect(
        (gridObj.contextMenuModule as any).disableItems.indexOf('Cancel')
      ).toBe(-1);
      (gridObj.contextMenuModule as any).contextMenuOpen();
      (gridObj.contextMenuModule as any).contextMenuOnClose(e);
    ...
    it('sub menu', () => {
      let item = (gridObj.contextMenuModule as any).defaultItems['export']
        .items;
      (gridObj.contextMenuModule as any).eventArgs = {
        target: gridObj.getContent().querySelector('tr').querySelector('td'),
      };
    ...
    it('touch pop check', () => {
      (gridObj.contextMenuModule as any).eventArgs = {
        target: createElement('div', { className: 'e-gridpopup' }),
      };
      let e = {
        event: (gridObj.contextMenuModule as any).eventArgs,
        items: gridObj.contextMenuModule.contextMenu.items,
    ...
    it('EJ2-6536 group caption check', () => {
      (gridObj.contextMenuModule as any).eventArgs = {
        target: createElement('div', { className: 'e-groupcaption' }),
      };
      let e = {
        event: (gridObj.contextMenuModule as any).eventArgs,
        items: gridObj.contextMenuModule.contextMenu.items,
    ...
    it('EJ2-6536 summarycell check', () => {
      (gridObj.contextMenuModule as any).eventArgs = {
        target: createElement('div', { className: 'e-summarycell' }),
      };
      let e = {
        event: (gridObj.contextMenuModule as any).eventArgs,
        items: gridObj.contextMenuModule.contextMenu.items,
    ...
    it('EJ2-6604 filterbarcell check', () => {
      (gridObj.contextMenuModule as any).eventArgs = {
        target: createElement('div', { className: 'e-filterbarcell' }),
      };
      let e = {
        event: (gridObj.contextMenuModule as any).eventArgs,
        items: gridObj.contextMenuModule.contextMenu.items,
  ...
  describe('default items without required module', () => {
    ...
    it('sub menu', () => {
      ...
      (gridObj.contextMenuModule as any).contextMenuBeforeOpen(subE);
      expect(
        (gridObj.contextMenuModule as any).disableItems.indexOf('PDF Export')
      ).toBeGreaterThanOrEqual(0);
      expect(
        (gridObj.contextMenuModule as any).disableItems.indexOf('CSV Export')
      ).toBeGreaterThanOrEqual(0);
      expect(
        (gridObj.contextMenuModule as any).disableItems.indexOf('Excel Export')
      ).toBeGreaterThanOrEqual(0);
      (gridObj.contextMenuModule as any).contextMenuOpen();
      (gridObj.contextMenuModule as any).contextMenuOnClose(e);
    });
  ...
  describe('batch Edit', () => {
    ...
    it('batch editing', () => {
      ...
      (<HTMLInputElement>(
        document.getElementById(gridObj.element.id + 'CustomerID')
      )).value = 'Tomsp1';
      ...
      (gridObj.contextMenuModule as any).contextMenuOnClose(e);
      expect(
        (gridObj.contextMenuModule as any).hiddenItems.indexOf('save') !== -1
      );
    });
  ...
  describe('Context menu events', () => {
    ...
    it('context menu click', (done: Function) => {
      ...
      colMenu.contextMenuItemClick({
        item: colMenuObj.items[0],
  ...
  describe('context menu with frozen', () => {
    ...
    it('header test', () => {
      ...
      expect(
        (gridObj.contextMenuModule as any).ensureFrozenHeader(target)
      ).toBe(true);
    });
  ...
  describe('context menu with stacked header', () => {
      ...
      gridObj = createGrid(
        {
          ...
          allowPaging: true,
          contextMenuItems: [
            { text: 'Column', target: '.e-headercell' },
            { text: 'Row', target: 'td' },
            { text: 'Footer', target: '.e-gridpager' },
          ],
          columns: [
            {
              field: 'OrderID',
    ...
    it('context menu with Stacked header', () => {
      (gridObj.contextMenuModule as any).eventArgs = {
        target: gridObj.getHeaderTable().querySelector('.e-stackedheadercell'),
      };
      let e = {
        event: (gridObj.contextMenuModule as any).eventArgs,
        items: gridObj.contextMenuModule.contextMenu.items,
  ...
  describe('context menu with column template', () => {
    ...
    it('select multiple rows', () => {
      ...
      expect(
        gridObj.getContent().querySelectorAll('tr[aria-selected=true]').length
      ).toBe(3);
      let eventArgs = {
        target: gridObj.getContent().querySelector('tr').querySelector('span'),
      };
      let e = {
        event: eventArgs,
        items: gridObj.contextMenuModule.contextMenu.items,
