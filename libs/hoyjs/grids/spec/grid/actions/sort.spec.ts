...
describe('Sorting module => ', () => {
  describe('Sorting functionalities => ', () => {
    ...
    it('clear sorting', (done: Function) => {
      actionComplete = (args: Object): void => {
        expect(
          cols[0].parentElement.querySelectorAll('.e-sortnumber').length
        ).toBe(0);
        expect(
          cols[0].parentElement.querySelectorAll('.e-ascending').length
        ).toBe(0);
        expect(
          cols[0].parentElement.querySelectorAll('.e-descending').length
        ).toBe(0);
        done();
      };
      gridObj.actionComplete = actionComplete;
  ...
  describe('Sort with Grouping => ', () => {
    ...
    it('Sort and Group testing', (done: Function) => {
      actionComplete = (args?: Object) => {
        expect(
          gridObj
            .getHeaderContent()
            .querySelectorAll('.e-ascending.e-icon-ascending').length
        ).toBe(2);
        expect(
    ...
    it('Clear sorting', (done: Function) => {
      actionComplete = (args?: Object): void => {
        ...
        expect(
          gridObj.getHeaderContent().querySelectorAll('.e-descending').length
        ).toBe(0);
        expect(
          gridObj.getHeaderContent().querySelectorAll('.e-sortnumber').length
        ).toBe(0);
    ...
    it('remove Grouping', (done: Function) => {
      let actionComplete = (args: Object) => {
        ...
        expect(
          gridObj
            .getHeaderContent()
            .querySelectorAll('.e-descending.e-icon-descending').length
        ).toBe(0);
        done();
      };
      gridObj.actionComplete = actionComplete;
  ...
  describe('Keyboard operation', () => {
    ...
    it('Pressing enter key', (done: Function) => {
      ...
      (gridObj as any).mouseClickHandler(
        getClickObj(gridObj.element.querySelector('.e-headercell'))
      );
      gridObj.keyboardModule.keyAction(
        <any>(
          getKeyActionObj(
            'enter',
            <any>gridObj.element.querySelector('.e-headercell')
          )
        )
      );
    });
  ...
  describe('sort comparer', () => {
    let gridObj: Grid;
    let sortComparer = (reference: string, comparer: string) => {
      ...
      gridObj = createGrid(
        {
          ...
          pageSettings: { pageSize: 5 },
          columns: [
            { field: 'OrderID', sortComparer: sortComparer },
            { field: 'CustomerID' },
            { field: 'EmployeeID' },
            { field: 'Freight' },
            { field: 'ShipCity' },
  ...
  describe('Sorting with Freeze pane', () => {
    ...
    it('Single sort orderID asc testing', (done: Function) => {
      ...
      actionComplete = (args: Object): void => {
        ...
        expect(sortSettings.columns[0].direction).toBe('Ascending');
        expect(
          col1.parentElement.querySelectorAll('.e-sortnumber').length
        ).toBe(0);
  ...
  describe('initial sorting with initial grouping => ', () => {
    ...
    it('Initial sort settings testing', () => {
      ...
      (
        gridObj.element.querySelector('.e-columnheader .e-headercell') as any
      ).click();
    ...
    it('remove one column dynamically', (done: Function) => {
      actionComplete = (args: Object): void => {
        gridObj
          .getHeaderContent()
          .querySelectorAll('.e-columnheader')[0]
          .querySelectorAll('.e-sortnumber')[0].innerHTML = '1';
        gridObj
          .getHeaderContent()
          .querySelectorAll('.e-columnheader')[0]
          .querySelectorAll('.e-sortnumber')[1].innerHTML = '2';
        expect(
          gridObj
            .getHeaderContent()
            .querySelectorAll('.e-columnheader')[0]
