 ...
 */
import { ChildProperty, EventHandler, L10n } from '@hoyui/base';
...
describe('Excel Filter =>', () => {
  ...
  describe('Excel Filter =>', () => {
    ...
    it('pre-filter-settings', (done: Function) => {
      ...
      expect(getString(gridObj.filterSettings.columns)).toBe(
        '[{"field":"ShipCountry","operator":"contains","value":"a","predicate":"or","matchCase":false,"uid":"' +
          gridObj.filterSettings.columns[0].uid +
          '","ignoreAccent":false,"actualFilterValue":{},"actualOperator":{}}]'
      );
      done();
    });
    it('or-predicate', (done: Function) => {
      actionComplete = (args?: Object): void => {
        ...
        expect(getString(gridObj.filterSettings.columns)).toBe(
          '[{"field":"ShipCountry","operator":"contains","value":"a","predicate":"or","matchCase":false,"uid":"' +
            gridObj.filterSettings.columns[0].uid +
            '","ignoreAccent":false,"actualFilterValue":{},"actualOperator":{}},{"field":"OrderID","predicate":"or","matchCase":false,"ignoreAccent":false,"operator":"greaterthan","value":10249,"type":"number","uid":"' +
            gridObj.filterSettings.columns[1].uid +
            '"},{"field":"OrderID","predicate":"or","matchCase":false,"ignoreAccent":false,"operator":"lessthan","value":10280,"type":"number","uid":"' +
            gridObj.filterSettings.columns[1].uid +
            '"}]'
        );
        done();
      ...
      let excel: any = new (<any>gridObj.filterModule).type['Excel'](
        gridObj,
        gridObj.filterSettings,
        gridObj.serviceLocator,
        customOperators
      );
      ...
      excel.excelFilterBase.updateModel({
        ...
        filteredColumns: gridObj.filterSettings.columns,
        target: gridObj.element,
        query: gridObj.query,
        handler: test.filterHandler.bind(test),
        localizedStrings: {},
        column: column,
      });
      excel.excelFilterBase.filterByColumn(
        'OrderID',
        'greaterthan',
        10249,
        'or',
    ...
    it('and-predicate', (done: Function) => {
      actionComplete = (args?: Object): void => {
        ...
        expect(getString(gridObj.filterSettings.columns)).toBe(
          '[{"field":"ShipCountry","operator":"contains","value":"a","predicate":"or","matchCase":false,"uid":"' +
            gridObj.filterSettings.columns[0].uid +
            '","ignoreAccent":false,"actualFilterValue":{},"actualOperator":{}},{"field":"OrderID","predicate":"and","matchCase":false,"ignoreAccent":false,"operator":"greaterthan","value":10249,"type":"number","uid":"' +
            gridObj.filterSettings.columns[1].uid +
            '"},{"field":"OrderID","predicate":"and","matchCase":false,"ignoreAccent":false,"operator":"notequal","value":10250,"type":"number","uid":"' +
            gridObj.filterSettings.columns[1].uid +
            '"}]'
        );
        done();
    ...
    it('first value', (done: Function) => {
      actionComplete = (args?: Object): void => {
        ...
        expect(getString(gridObj.filterSettings.columns)).toBe(
          '[{"field":"ShipCountry","operator":"contains","value":"a","predicate":"or","matchCase":false,"uid":"' +
            gridObj.filterSettings.columns[0].uid +
            '","ignoreAccent":false,"actualFilterValue":{},"actualOperator":{}},{"field":"OrderID","predicate":"and","matchCase":false,"operator":"greaterthan","value":10249,"type":"number","uid":"' +
            gridObj.filterSettings.columns[1].uid +
            '","ignoreAccent":false}]'
        );
        done();
    ...
    it('EJ2-7602-Excel Filter For notequal string operator Not Working', (done: Function) => {
      let value = (<string>(
        gridObj.currentViewData[0]['ShipCountry']
      )).toLowerCase();
      let actionComplete = (args: any) => {
        expect(
          (<string>gridObj.currentViewData[0]['ShipCountry']).toLowerCase()
        ).not.toBe(value);
        done();
      };
      gridObj.actionComplete = actionComplete;
      ...
      let excel: any = new test.type['Excel'](
        gridObj,
        gridObj.filterSettings,
        gridObj.serviceLocator,
        customOperators
  ...
  describe('EJ2-6702 Script Error throws If we Check the match case and then click ok button', () => {
    ...
    it('EJ2-7609-Excel Filter For Equal Date Is Not Working', (done: Function) => {
      ...
      excel.excelFilterBase.updateModel({
        ...
        filteredColumns: grid.filterSettings.columns,
        target: grid.element,
        query: grid.query,
        handler: test.filterHandler.bind(test),
        localizedStrings: {},
  ...
  describe('complex data filtering=> ', () => {
    ...
    it('EJ2-12661 - Autocomplete checking for complex datas', () => {
      ...
      let returnedValue: string | object = performComplexDataOperation(
        'Details.Somethings',
        gridObj.dataSource[0]
      );
  ...
  describe('Customized the excel filter using filterTemplate => ', () => {
    ...
    it('compile filterTemplate in menu filter', () => {
      (<any>gridObj).element
        .querySelector('.e-headercell:nth-child(2)')
        .querySelector('.e-filtermenudiv')
        .click();
    ...
    it('BeforeCustomFilterOpen event Check with filterTemplate', (done: Function) => {
      ...
      (gridObj.filterModule as any).filterModule.excelFilterBase.renderDialogue(
        { element: '' }
      );
    ...
    it('Custom Filter Open on date type', (done: Function) => {
      (<any>gridObj).element
        .querySelector('.e-headercell:nth-child(3)')
        .querySelector('.e-filtermenudiv')
        .click();
      (gridObj.filterModule as any).filterModule.closeDialog();
      gridObj.on(events.beforeCustomFilterOpen, formFunc, this);
    ...
    it('Custom Filter Open on datetime type', (done: Function) => {
      (<any>gridObj).element
        .querySelector('.e-headercell:nth-child(4)')
        .querySelector('.e-filtermenudiv')
        .click();
      (gridObj.filterModule as any).filterModule.closeDialog();
      gridObj.on(events.beforeCustomFilterOpen, formFunc, this);
    ...
    it('Custom Filter Open on filtered column', (done: Function) => {
      (gridObj.filterModule as any).filterModule.excelFilterBase.completeAction(
        { result: ['a', 'b', 'b'] }
      );
      (<any>gridObj).element
        .querySelector('.e-headercell:nth-child(1)')
        .querySelector('.e-filtermenudiv')
        .click();
      (gridObj.filterModule as any).filterModule.closeDialog();
      gridObj.on(events.beforeCustomFilterOpen, formFunc, this);
  ...
  describe('Excel filter with Rtl mode', () => {
    ...
    it('open the filter dialog', (done: Function) => {
      ...
      (gridObj.filterModule as any).filterIconClickHandler(
        getClickObj(
          gridObj
            .getColumnHeaderByField('OrderID')
            .querySelector('.e-filtermenudiv')
        )
      );
    });
  ...
  describe('EJ2-26559 enable case sensitivity check for Excel filter', () => {
    ...
    it('Filter CustomerID testing for matchcase default value true', (done: Function) => {
      actionComplete = (args?: any): void => {
        ...
        expect(
          excelFilterObj(
            gridObj.filterSettings.columns[2],
            'CustomerID',
            'notequal',
            'ANATR',
            'and',
    ...
    it('Filter Freight dialog open testing', (done: Function) => {
      ...
      (gridObj.filterModule as any).filterIconClickHandler(
        getClickObj(
          gridObj
            .getColumnHeaderByField('Freight')
            .querySelector('.e-filtermenudiv')
        )
      );
    });
    ...
    it('Filter Freight testing for matchcase default value true', (done: Function) => {
      actionComplete = (args?: any): void => {
        ...
        expect(
          excelFilterObj(
            gridObj.filterSettings.columns[4],
            'Freight',
            'notequal',
            0.12,
            'and',
  ...
  describe('Excel filter test case => ', () => {
    ...
    it('action complete', (done: Function) => {
      ...
      actionComplete = (args?: any): void => {
        if (flag) {
          flag = false;
          (
            gridObj.filterModule as any
          ).filterModule.excelFilterBase.renderFilterUI(
            (gridObj.columns[1] as any).field,
            args.filterModel.dlg
          );
          done();
        }
        done();
      ...
      gridObj.actionComplete = actionComplete;
      (
        gridObj.element.querySelectorAll('.e-filtermenudiv')[1] as HTMLElement
      ).click();
    });
    ...
    it('comparing operator with default value', (done: Function) => {
      expect(
        (
          gridObj.element.querySelector('.e-xlfl-optrdiv').firstChild
            .firstChild as any
        ).value
      ).toBe((gridObj.columns[1] as any).filter.operator);
      done();
    });
  ...
  describe('Excel filter test case => ', () => {
    ...
    it('BeforeCustomFilterOpen event Check', (done: Function) => {
      let fltrElement: Element =
        document.getElementsByClassName('e-filtermenudiv')[0];
      (gridObj.filterModule as any).filterDialogOpen(
        gridObj.getColumnByIndex(0),
        fltrElement,
        100,
        100
      );
  ...
  describe('EJ2-35295 custom filter operator testing => ', () => {
    ...
    it('Filtering with null operator testing', (done: Function) => {
      ...
      gridObj.actionComplete = actionComplete;
      (gridObj.filterModule as any).filterModule.excelFilterBase.filterByColumn(
        'OrderID',
        'equal',
        10248,
        'or',
  ...
  describe('EJ2-36547 => Scrolling while filter => ', () => {
    ...
    it('checking current focused element', (done: Function) => {
      ...
      actionComplete = (args?: any): void => {
        if (flag) {
          flag = false;
          expect(document.activeElement.getAttribute('data-colindex')).toBe(
            '4'
          );
          done();
        }
      ...
      gridObj.actionComplete = actionComplete;
      (
        gridObj.element.querySelectorAll('.e-filtermenudiv')[4] as HTMLElement
      ).click();
    });
...
describe('Sorting feature testing in excel filter ', () => {
  ...
  it('testing the list of sort in excel popup', (done: Function) => {
    actionComplete = (args?: any): void => {
      if (args.requestType === 'filterAfterOpen') {
        expect(
          gridObj.element.querySelectorAll('.e-excel-ascending').length
        ).toBe(1);
        expect(
          gridObj.element.querySelectorAll('.e-excel-descending').length
        ).toBe(1);
        (gridObj.filterModule as any).filterModule.closeDialog();
        gridObj.actionComplete = null;
        done();
    ...
    (
      gridObj.element
        .querySelector('.e-headercell:nth-child(1)')
        .querySelector('.e-filtermenudiv') as HTMLElement
    ).click();
  });
  ...
  it('Checking the sorting action in excel popup', (done: Function) => {
    ...
    gridObj.actionComplete = actionComplete;
    (
      gridObj.element.querySelectorAll('.e-excel-ascending')[0] as HTMLElement
    ).click();
  });
...
describe('EJ2-47491- Grid destroy with document click event ', () => {
  ...
  it('testing the destroy funtionality', (done: Function) => {
    (
      gridObj1.element.querySelectorAll('.e-filtermenudiv')[0] as HTMLElement
    ).click();
    gridObj2.destroy();
    document.onclick = () => {
      expect(gridObj1.element.querySelectorAll('.e-excelfilter').length).toBe(
        0
      );
...
describe('EJ2-51101 Custom excel filter Radio button alignment issue => ', () => {
  ...
  it('checking the class for label element', () => {
    expect(
      document
        .querySelector('.e-xlfl-radio')
        .querySelector('label')
        .classList.contains('e-xlfl-radio-and')
    ).toBeTruthy();
    expect(
      document
        .querySelector('.e-xlfl-radio')
        .querySelectorAll('label')[1]
        .classList.contains('e-xlfl-radio-or')
    ).toBeTruthy();
  });
...
describe('EJ2-52268 Filtering array of values on date column through filterByColumn method is not working => ', () => {
  ...
  let actionComplete: (args: any) => void;
  let data: object[] = [
    { OrderID: 10248, CustomerID: 'VINET', OrderDate: new Date('08/16/2021') },
  ...
  it('checking the filterByColumn in mutiple value', (done: Function) => {
    ...
    gridObj.actionComplete = actionComplete;
    gridObj.filterByColumn('OrderDate', 'equal', [
      new Date('08/16/2021'),
      new Date('08/18/2021'),
    ]);
  });
...
describe('EJ2-52360 => In lazyload grouping enabled grid while hiding columns in column chooser throws script error => ', () => {
  ...
  it('checking the rowsObject length', (done: Function) => {
    ...
    gridObj.actionComplete = actionComplete;
    (
      gridObj.element.getElementsByClassName(
...
describe('Excel Filter on demand load and selection maintain for filter', () => {
  ...
  it('OrderID filter dialog open testing', (done: Function) => {
    actionComplete = (args?: any): void => {
      if (args.requestType === 'filterAfterOpen') {
        expect(
          gridObj.element.querySelector('.e-checkboxlist').children.length
        ).toBe(gridObj.filterSettings.itemsCount * 3);
        actionComplete = null;
        done();
  ...
  it('OrderID filter dialog open testing - 1', (done: Function) => {
    actionComplete = (args?: any): void => {
      if (args.requestType === 'filterAfterOpen') {
        ...
        expect(
          gridObj.element
            .querySelector('.e-checkboxlist')
            .querySelectorAll('.e-check').length
        ).toBe(0);
        expect(
          (<any>(
            gridObj.element.querySelector('.e-checkboxlist').parentElement
              .previousSibling
          )).querySelectorAll('.e-uncheck').length
        ).toBe(1);
        expect(
          (<any>gridObj.filterModule).filterModule.excelFilterBase
            .infiniteManualSelectMaintainPred.length
        ).toBe(0);
        expect(
          (<any>gridObj.filterModule).filterModule.excelFilterBase
            .infiniteUnloadParentExistPred.length
        ).toBe(0);
        actionComplete = null;
        done();
      } else if (args.requestType === 'filterchoicerequest') {
  ...
  it('OrderID filter dialog open testing and down scroll', (done: Function) => {
    ...
    (<any>(
      gridObj.filterModule
    )).filterModule.excelFilterBase.infiniteScrollHandler();
  ...
  it('checkbox selection', () => {
    let checkBoxList: Element =
      gridObj.element.querySelector('.e-checkboxlist');
    let checkBox: Element = checkBoxList.children[10].querySelector('input');
    (<any>gridObj.filterModule).filterModule.excelFilterBase.clickHandler({
      target: checkBox,
    });
    expect(
      (<any>gridObj.filterModule).filterModule.excelFilterBase
...
describe('code coverage for excel filter file - 1 => ', () => {
  ...
  it('excel filter open code coverage', (done: Function) => {
    ...
    gridObj.actionComplete = actionComplete;
    (
      gridObj.element.getElementsByClassName('e-filtermenudiv')[1] as any
    ).click();
  });
  ...
  it('excel filter file method and fucntion code coverage', () => {
    ...
    (
      gridObj.filterModule as any
    ).filterModule.excelFilterBase.focusNextOrPrevElement({}, [], []);
    (gridObj.filterModule as any).filterModule.excelFilterBase.keyDown({
      key: 'ArrowDown',
      preventDefault: preventDefault,
    });
    (
      gridObj.filterModule as any
    ).filterModule.excelFilterBase.cmenu.appendChild(
      gridObj.createElement('div', { className: 'e-excel' })
    );
    (gridObj.filterModule as any).filterModule.excelFilterBase.excelSetFocus(
      gridObj.element,
      'e-excel'
    ...
    (
      gridObj.filterModule as any
    ).filterModule.excelFilterBase.options.isResponsiveFilter = true;
    (gridObj.filterModule as any).filterModule.excelFilterBase.hoverHandler({
      type: 'mouseover',
    });
    (
      gridObj.filterModule as any
    ).filterModule.excelFilterBase.options.isResponsiveFilter = false;
    (gridObj.filterModule as any).filterModule.excelFilterBase.keyUp({});
    (gridObj.filterModule as any).filterModule.excelFilterBase.keyUp({
      shiftKey: true,
      key: 'Tab',
      target: document.querySelector('.e-chk-hidden'),
    });
    (gridObj.filterModule as any).filterModule.excelFilterBase.keyUp({
      shiftKey: true,
      key: 'Tab',
      target: document.querySelector('.e-menu-item'),
    });
    (gridObj.filterModule as any).filterModule.excelFilterBase.keyUp({
      shiftKey: true,
      key: 'ArrowDown',
    ...
    (gridObj.filterModule as any).filterModule.excelFilterBase.keyUp({
      shiftKey: true,
      code: 'ArrowRight',
      target: document.querySelector('.e-submenu.e-menu-item'),
      preventDefault: preventDefault,
    });
    (
      gridObj.filterModule as any
    ).filterModule.excelFilterBase.contextKeyDownHandler({});
    (
      gridObj.filterModule as any
    ).filterModule.excelFilterBase.contextKeyDownHandler({
      shiftKey: true,
    ...
    (gridObj.filterModule as any).filterModule.excelFilterBase.dropDownOpen({
      popup: { element: gridObj.element.querySelector('.e-dialog') },
    });
    gridObj.isDestroyed = true;
    (gridObj.filterModule as any).filterModule.excelFilterBase.removeObjects([
      gridObj,
    ]);
    gridObj.isDestroyed = false;
    (gridObj.filterModule as any).filterModule.excelFilterBase.clickExHandler({
      target: document.querySelector('.e-excl-filter-icon'),
    });
  });
