...
describe('Scrolling module', () => {
  ...
  describe('Enable scrolling', () => {
    ...
    it('check content class', () => {
      expect(
        (<HTMLElement>grid.getContent().firstChild).classList.contains(
          'e-content'
        )
      ).toBeTruthy();
    });
    ...
    it('check header class', () => {
      expect(
        (<HTMLElement>grid.getHeaderContent().firstChild).classList.contains(
          'e-headercontent'
        )
      ).toBeTruthy();
    });
  ...
  describe('Scrolling with settings', () => {
    ...
    it('check element height', () => {
      expect((<HTMLElement>grid.getContent().firstChild).style.height).toBe(
        '50%'
      );
    });
  ...
  describe('EJ2-6045-height issue set heigth as 100%', () => {
    ...
    it('check sibling height', () => {
      var siblingheight: number = gridObj.widthService.getSiblingsHeight(
        <HTMLElement>gridObj.getContent()
      );
  ...
  describe('Scrolling scroll event', () => {
    ...
    it('check sticky class without scroll', () => {
      expect(
        grid.getHeaderContent().classList.contains('e-sticky')
      ).toBeFalsy();
    });
