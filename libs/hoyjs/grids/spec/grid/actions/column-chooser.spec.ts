...
describe('Column chooser module', () => {
  describe('Column chooser testing', () => {
      ...
      gridObj = createGrid(
        {
          dataSource: data,
          columns: [
            { field: 'OrderID', showInColumnChooser: false },
            { field: 'CustomerID' },
            { field: 'EmployeeID' },
            { field: 'Freight' },
            { field: 'ShipCity' },
    ...
    it('Column chooser testing', (done: Function) => {
      beforeOpenColumnChooser = (args?: { element: Element }): void => {
        expect(
          args.element.querySelectorAll('.e-columnchooser-btn').length
        ).toBe(1);
        done();
      };
      beforeOpenColumnChooser = (args?: { element: Element }): void => {
      ...
      setTimeout(() => {
        select(
          '#' + gridObj.element.id + '_columnchooser',
  ...
  describe('Column chooser Custom testing', () => {
    ...
    it('Column chooser open  testing', (done: Function) => {
      ...
      setTimeout(() => {
        ...
        (<HTMLElement>(
          gridObj.element.querySelectorAll('.e-rowcell')[0]
        )).click();
        (<any>gridObj).columnChooserModule.destroy();
        (<any>gridObj).destroy();
        done();
  ...
  describe('column chooser single field search', () => {
    ...
    it('column chooser single field search', (done: Function) => {
      setTimeout(() => {
        ...
        (gridObj.columnChooserModule as any).columnChooserManualSearch(e);
        expect(
          document.querySelector('.e-cc_okbtn').hasAttribute('disabled')
        ).toBeFalsy();
  ...
  describe('Column chooser rtl testing', () => {
    ...
    it('rtl', (done: Function) => {
      ...
      setTimeout(() => {
        ...
        let sel: HTMLElement = (<any>gridObj).element.querySelector(
          '.e-columnchooser-btn'
        );
        e = { target: sel };
  ...
  describe('Colum chooser enable throw set model => ', () => {
    ...
    it('EJ2-7683==>checking whether rtl is enabled', () => {
      ...
      expect(columnChooser.querySelectorAll('.e-rtl').length).toBeGreaterThan(
        5
      );
  ...
  describe('Select all added in column chooser =>', function () {
    ...
    it('Update select all- uncheck', function () {
      ...
      expect(document.querySelectorAll('.e-uncheck.e-selectall').length).toBe(
        1
      );
      expect(
        (gridObj.columnChooserModule as any).ulElement.querySelectorAll(
          '.e-uncheck'
        ).length
      ).toBe(4);
      expect(
    ...
    it('Update intermediate button', function () {
      (gridObj.columnChooserModule as any).ulElement
        .querySelectorAll('.e-check')[1]
    ...
    it('enter key disabled', () => {
      expect(
        document.querySelector('.e-ccdlg').classList.contains('e-popup-close')
      ).toBeTruthy();
      gridObj.columnChooserModule.openColumnChooser();
      ...
      expect(
        document.querySelector('.e-ccdlg').classList.contains('e-popup-open')
      ).toBeTruthy();
    });
  ...
  describe('EJ2-36229 => column chooser ok button click check', () => {
    ...
    it('check ok button click when unselect all with ShowInColumnChooser False', (done: Function) => {
      gridObj.columnChooserModule.openColumnChooser();
      let cheEle: any = document.querySelectorAll(
        '.e-cc-selectall .e-selectall'
      )[0];
      cheEle.click();
  ...
  describe('EJ2-37361 => Columns does not render properly while using column chooser to select columns', () => {
    ...
    it('check ok button are disable', (done: Function) => {
      let columnchooser: HTMLElement = select(
        '#' + gridObj.element.id + '_columnchooser',
        gridObj.toolbarModule.getToolbar()
      );
      columnchooser.click();
  ...
  describe("EJ2-56865 => Table content width didn't cover full grid width after hiding column on using frozenColumn", () => {
      ...
      gridObj = createGrid(
        {
          ...
          columns: [
            ...
            },
            {
              ...
              width: '120',
              template:
                '<br /><br /><br /><div>${FirstName}</div><br /><br /><br />',
            },
    ...
    it('coverage - 1', () => {
      ...
      let cell: any = gridObj.getContent().querySelector('.e-row')
        .childNodes[1];
      cell.click();
    });
    it('coverage - 2', () => {
      gridObj.setProperties({ enableRtl: true }, true);
      (gridObj.columnChooserModule as any).createCheckBox(
        'Select All',
        true,
        'Grid-selectAll'
      );
