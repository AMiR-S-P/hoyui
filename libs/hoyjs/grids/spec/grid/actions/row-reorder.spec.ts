...
describe('Row Drag and Drop module', () => {
  ...
  describe('Reorder row functionalities with mouse and touch', () => {
    ...
    it('set drop target ID', () => {
      ...
      gridObj.dataBind();
      expect(document.getElementById(gridObj1.element.id)).toEqual(
        gridObj1.element
      );
    });
  ...
  describe('EJ2-36585 => AllowRowDragAndDrop on property changing', () => {
    ...
    it('disabling rowDrag and drop', (done: Function) => {
      actionComplete = (args: any): any => {
        expect(
          gridObj.element.getElementsByClassName('e-rowdragheader').length
        ).toBe(0);
        expect(
          gridObj.element.getElementsByClassName('e-rowdragdrop').length
        ).toBe(0);
        done();
      };
      gridObj.actionComplete = actionComplete;
    ...
    it('enabling rowDrag and drop', (done: Function) => {
      actionComplete = (args: any): any => {
        ...
        expect(
          gridObj.element.getElementsByClassName('e-rowdragdrop').length
        ).toBe(gridObj.currentViewData.length);
        done();
      };
      gridObj.actionComplete = actionComplete;
      gridObj.allowRowDragAndDrop = true;
  ...
  describe('EJ2-38600-SetCellValue-IsNot-Work-RowDD-Grid-to-Grid', () => {
    ...
    it('set drop target ID', () => {
      ...
      expect(
        gridObj.getContent().querySelector('tbody').children[0].children[1]
          .innerHTML
      ).toEqual('JHON');
      gridObj.setCellValue(10249, 'Freight', 7);
      expect(
        gridObj.getContent().querySelector('tbody').children[1].children[3]
          .innerHTML
      ).toEqual('$7.00');
    });
    afterAll(() => {
  ...
  describe('EJ2-55353 - ActionComplete event is not triggered after row reorder is performed ', () => {
    ...
    it('reorderRows and check the actionComplete event', (done: Function) => {
      ...
      gridObj.actionComplete = actionComplete;
      gridObj.reorderRows(
        gridObj.getSelectedRowIndexes(),
        gridObj.getSelectedRowIndexes()[0] - 1
      );
    });
    afterAll(() => {
      destroy(gridObj);
  ...
  describe('virtualscroll Grouped Row Reorder functionalities', () => {
    ...
    it('check group caption and summary before reorder', () => {
      const captionRow: NodeListOf<Element> = gridObj
        .getContentTable()
        .querySelectorAll('.e-groupcaptionrow .e-groupcaption');
      const captionSummary: NodeListOf<Element> = gridObj
        .getContentTable()
        .querySelectorAll('.e-groupcaptionrow .e-summarycell.e-templatecell');
      const groupFooterRow: NodeListOf<Element> = gridObj
        .getContentTable()
        .querySelectorAll(
          '.e-groupfooterrow.e-summaryrow .e-summarycell.e-templatecell'
        );
    ...
    it('drag and drop row action', (done: Function) => {
      const dragRowElem: Element = gridObj
        .getRowByIndex(0)
        .querySelector('.e-rowdragdrop.e-rowdragdropcell');
      ...
      gridObj.rowDrop = rowDrop;
      (gridObj.rowDragAndDropModule as any).draggable.currentStateTarget =
        dragRowElem;
      ...
      const dropClone: HTMLElement = gridObj.element.querySelector(
        '.e-cloneproperties.e-draganddrop.e-grid.e-dragclone'
      );
      (gridObj.rowDragAndDropModule as any).dragStart({
        target: dragRowElem,
        dragElement: dropClone,
        event: {
          clientX: dragClient.x,
          clientY: dragClient.y,
          target: dragRowElem,
        },
      });
  ...
  describe('Grouped Row Reorder functionalities', () => {
    ...
    it('for coverage', () => {
      ...
      const dropRowElem: Element = gridObj
        .getContentTable()
        .querySelector('tr');
  ...
  describe('Code Coverage - drag and drop selected rows within grid with data', () => {
    ...
    it('coverage improvement single grid with data drag and drop - 1', () => {
      ...
      const dragRowElem: Element = gridObj1
        .getRowByIndex(2)
        .querySelector('.e-rowdragdrop.e-rowdragdropcell');
      const dropRowElem: Element = gridObj1
        .getRowByIndex(1)
        .querySelector('.e-rowdragdrop.e-rowdragdropcell');
      const dragClient: any = dragRowElem.getBoundingClientRect();
      const dropClient: any = dropRowElem.getBoundingClientRect();
      ...
      dragRowElem.classList.add('e-rowcell');
      (gridObj1.rowDragAndDropModule as any).draggable.currentStateTarget =
        dragRowElem;
      (gridObj1.rowDragAndDropModule as any).helper({
        target: gridObj1.getContentTable().querySelector('tr'),
        sender: { clientX: 10, clientY: 10, target: dragRowElem },
      });
      const dropClone: HTMLElement = gridObj1.element.querySelector(
        '.e-cloneproperties.e-draganddrop.e-grid.e-dragclone'
      );
    ...
    it('coverage improvement single grid with data drag and drop - 2', () => {
      ...
      const dragRowElem: Element = gridObj1
        .getRowByIndex(11)
        .querySelector('.e-rowdragdrop.e-rowdragdropcell');
      let dropRowElem: Element = gridObj1
        .getRowByIndex(0)
        .querySelector('.e-rowdragdrop.e-rowdragdropcell');
      const dragClient: any = dragRowElem.getBoundingClientRect();
      ...
      let dropClone: HTMLElement = gridObj1.element.querySelector(
        '.e-cloneproperties.e-draganddrop.e-grid.e-dragclone'
      );
      (gridObj1.rowDragAndDropModule as any).dragStart({
        target: dragRowElem,
      ...
      dropClone = gridObj1.element.querySelector(
        '.e-cloneproperties.e-draganddrop.e-grid.e-dragclone'
      );
      (gridObj1.rowDragAndDropModule as any).dragStart({
        target: dragRowElem,
    ...
    it('coverage improvement single grid with data drag and drop - 3', () => {
      ...
      document
        .getElementById('captiontemplate')
        .querySelector('div')
        .classList.add('e-dlg-overlay');
      (gridObj1.rowDragAndDropModule as any).dragStop({
        target: dropRowElem,
        element: gridObj1.getContentTable(),
        helper: dropClone,
      ...
      document
        .getElementById('captiontemplate')
        .querySelector('div')
        .classList.remove('e-dlg-overlay');
      (gridObj1.rowDragAndDropModule as any).helper({
        target: gridObj1.getContentTable().querySelector('tr'),
        sender: { clientX: 10, clientY: 10, target: dragRowElem },
      });
  ...
  describe('Code Coverage - drag and drop selected rows outside of grid without data', () => {
    ...
    it('coverage improvement 2nd grid empty data', () => {
      ...
      const dragRowElem: Element = gridObj1
        .getRowByIndex(0)
        .querySelector('.e-rowdragdrop.e-rowdragdropcell');
      const dropRowElem: Element = gridObj2
        .getContentTable()
        .querySelector('tr');
      const dragClient: any = dragRowElem.getBoundingClientRect();
      const dropClient: any = dropRowElem.getBoundingClientRect();
      ...
      (
        gridObj1.rowDragAndDropModule as any
      ).startedRow.cells[0].classList.remove('e-selectionbackground');
      (gridObj1.rowDragAndDropModule as any).dragStart({
        target: dragRowElem,
        event: {
          clientX: dragClient.x,
  ...
  describe('Code Coverage - Hierarchy row drag and drop testing', () => {
    ...
    it('coverage child grid row drag and drop', () => {
      ...
      const dragRowElem: Element = childGrid
        .getRowByIndex(2)
        .querySelector('.e-rowdragdrop.e-rowdragdropcell');
      const dropRowElem: Element = childGrid
        .getRowByIndex(1)
        .querySelector('.e-rowdragdrop.e-rowdragdropcell');
      const dragClient: any = dragRowElem.getBoundingClientRect();
      const dropClient: any = dropRowElem.getBoundingClientRect();
      ...
      dragRowElem.classList.add('e-rowcell');
      (childGrid.rowDragAndDropModule as any).draggable.currentStateTarget =
        dragRowElem;
      (childGrid.rowDragAndDropModule as any).helper({
        target: childGrid.getContentTable().querySelector('tr'),
        sender: { clientX: 10, clientY: 10, target: dragRowElem },
      });
      const dropClone: HTMLElement = childGrid.element.querySelector(
        '.e-cloneproperties.e-draganddrop.e-grid.e-dragclone'
      );
  ...
  describe('EJ2-847896 - DataSource not updated when row drag and drop performed in-between grids', () => {
    ...
    it('coverage improvement 2nd grid empty data', (done: Function) => {
      ...
      const dropRowElem: Element = gridObj2
        .getContentTable()
        .querySelector('tr');
      const dropElem: Element =
        gridObj2.element.querySelector('.e-gridcontent');
      const dragClient: any = dragRowElem.getBoundingClientRect();
      const dropClient: any = dropRowElem.getBoundingClientRect();
      gridObj1.selectRow(0);
      dragRowElem.classList.add('e-rowcell');
      ...
      (gridObj2.rowDragAndDropModule as any).columnDrop({
        target: dropRowElem,
        droppedElement: dropClone,
      });
      (gridObj2.rowDragAndDropModule as any).columnDrop({
  ...
  describe('EJ2-867031: Empty grid message does not display correctly when drag and drop is enabled', () => {
    ...
    it('Check colspan when no records to display', () => {
      expect(
        parseInt(
          (
            gridObj.getContentTable().querySelector('.e-emptyrow')
