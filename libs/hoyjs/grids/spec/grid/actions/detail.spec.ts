...
describe('Detail template module', () => {
  function detail(e: any): void {
    ...
    grid1.appendTo(
      (e.detailElement as Element).querySelector('#detailgrid') as HTMLElement
    );
  }
  ...
  describe('Render with invalid id testing', () => {
    ...
    it('Detail row render testing', () => {
      expect(
        gridObj.getContentTable().querySelectorAll('.e-detailrowcollapse')
          .length
      ).toBe(12);
      expect(
        gridObj.getHeaderTable().querySelectorAll('.e-detailheadercell').length
      ).toBe(1);
      expect(
        gridObj.getHeaderTable().querySelectorAll('.e-mastercell').length
      ).toBe(1);
      expect(
        gridObj
          .getHeaderTable()
          .querySelectorAll('.e-mastercell')[0]
    ...
    it('Detail row expand testing', () => {
      (
        gridObj
          .getDataRows()[0]
          .querySelector('.e-detailrowcollapse') as HTMLElement
      ).click();
      expect(
        gridObj.getContentTable().querySelectorAll('.e-detailrow').length
      ).toBe(1);
      expect(
        gridObj.getDataRows()[0].querySelectorAll('.e-detailrowexpand').length
      ).toBe(1);
    });
    ...
    it('Detail collapse testing', () => {
      (
        gridObj
          .getDataRows()[0]
          .querySelector('.e-detailrowexpand') as HTMLElement
      ).click();
      expect(
        gridObj.getDataRows()[0].querySelectorAll('.e-detailrowexpand').length
      ).toBe(0);
      expect(
        gridObj.getDataRows()[0].querySelectorAll('.e-detailrowcollapse').length
      ).toBe(1);
    });
  ...
  describe('Render testing', () => {
    let gridObj: Grid;
    let template: HTMLElement = createElement('script', {
      id: 'detailtemplate',
    });
    ...
    it('Detail row expand testing', () => {
      expect(
        gridObj
          .getDataRows()[0]
          .querySelectorAll('.e-detailrowcollapse')[0]
      ...
      expect(
        (
          gridObj
            .getContentTable()
            .querySelectorAll('.e-detailrow')[0] as HTMLElement
        ).style.display
      ).toBe('');
      expect(
        gridObj.getDataRows()[0].querySelectorAll('.e-detailrowexpand').length
      ...
      expect(
        gridObj
          .getDataRows()[0]
          .querySelectorAll('.e-detailrowexpand')[0]
          .getAttribute('aria-expanded')
      ).toBe('true');
    });
    ...
    it('Expand method testing', () => {
      ...
      expect(
        gridObj.getDataRows()[1].querySelectorAll('.e-detailrowexpand').length
      ).toBe(1);
      expect(
        (
          gridObj
            .getContentTable()
            .querySelectorAll('.e-detailrow')[1] as HTMLElement
        ).style.display
      ).toBe('');
    ...
    it('Collapse method testing', () => {
      ...
      expect(
        gridObj.getDataRows()[1].querySelectorAll('.e-detailrowcollapse').length
      ).toBe(1);
      expect(
        (
          gridObj
    ...
    it('Alt Down shortcut testing', (done: Function) => {
      ...
      gridObj.rowSelected = () => {
        ...
        expect(
          gridObj.getDataRows()[2].querySelectorAll('.e-detailrowexpand').length
        ).toBe(1);
        expect(
          (
            gridObj
              .getContentTable()
              .querySelectorAll('.e-detailrow')[2] as HTMLElement
          ).style.display
        ).toBe('');
        gridObj.keyboardModule.keyAction(args);
        expect(
    ...
    it('Alt Up shortcut testing', () => {
      ...
      expect(
        gridObj.getDataRows()[2].querySelectorAll('.e-detailrowcollapse').length
      ).toBe(1);
      expect(
        (
          gridObj
    ...
    it('ctrlDownArrow shortcut testing', () => {
      ...
      expect(
        gridObj.getDataRows()[3].querySelectorAll('.e-detailrowexpand').length
      ).toBe(1);
      expect(
        gridObj.getDataRows()[4].querySelectorAll('.e-detailrowexpand').length
      ).toBe(1);
      expect(
        (
          gridObj
            .getContentTable()
            .querySelectorAll('.e-detailrow')[3] as HTMLElement
        ).style.display
      ).toBe('');
      expect(
        (
          gridObj
            .getContentTable()
            .querySelectorAll('.e-detailrow')[4] as HTMLElement
        ).style.display
      ).toBe('');
    });
    ...
    it('ctrlUpArrow shortcut testing', () => {
      ...
      expect(
        gridObj.getDataRows()[3].querySelectorAll('.e-detailrowcollapse').length
      ).toBe(1);
      expect(
        gridObj.getDataRows()[4].querySelectorAll('.e-detailrowcollapse').length
      ).toBe(1);
      expect(
        (
          gridObj
    ...
    it('Single column group testing', (done: Function) => {
      actionComplete = (args?: any): void => {
        if (args.requestType === 'grouping') {
          ...
          expect(
            gridObj.getHeaderTable().querySelectorAll('.e-detailheadercell')
              .length
          ).toBe(1);
    ...
    it('expandcollapse group rows method testing', () => {
      gridObj.groupModule.expandCollapseRows(
        gridObj.getContent().querySelectorAll('.e-recordplusexpand')[4]
      );
    ...
    it('toogleExpandcollapse with invalid element testing', () => {
      (gridObj.detailRowModule as any).toogleExpandcollapse(
        gridObj.getDataRows()[1].querySelector('.e-rowcell')
      );
      expect(
        gridObj.getContentTable().querySelectorAll('.e-detailrow').length
      ).toBe(2);
  ...
  describe('Hierarchy Render testing', () => {
    ...
    it('Hierarchy row expand testing', () => {
      ...
      expect(
        gridObj
          .getContentTable()
          .querySelectorAll('.e-detailrow')[0]
          .querySelectorAll('.e-grid').length
      ).toBe(1);
      expect(
        (
          gridObj
    ...
    it('Expand method testing', () => {
      ...
      expect(
        gridObj
          .getContentTable()
          .querySelectorAll('.e-detailrow')[1]
          .querySelectorAll('.e-grid').length
      ).toBe(1);
      expect(
        (
    ...
    it('Alt Down shortcut testing', () => {
      ...
      expect(
        gridObj
          .getContentTable()
          .querySelectorAll('.e-detailrow')[2]
          .querySelectorAll('.e-grid').length
      ).toBe(1);
      expect(
        (
    ...
    it('ctrlDownArrow shortcut testing', () => {
      ...
      expect(gridObj.getContentTable().querySelectorAll('.e-grid').length).toBe(
        9
      );
      expect(
        (
  ...
  describe('Keyboard operation', () => {
    ...
    it('Detail expand testing', () => {
      let target: any = gridObj
        .getDataRows()[0]
        .querySelector('.e-detailrowcollapse') as HTMLElement;
      gridObj.keyboardModule.keyAction(<any>{
        action: 'enter',
        target: target,
        preventDefault: () => {},
      });
    ...
    it('Hierarchy row with expand-RowDD', () => {
      ...
      expect(
        gridObj
          .getContentTable()
          .querySelectorAll('.e-detailrow')[0]
          .children[1].getAttribute('colspan')
      ).toBe('6');
    });
    afterAll(() => {
      destroy(gridObj);
  ...
  describe('EJ2-49020 - minWidth is not working', () => {
    ...
    it('Test script error', (done: Function) => {
      expect(
        gridObj.getHeaderTable().querySelectorAll('col')[1].style.width
      ).toBe('100px');
      expect(
        gridObj.getHeaderTable().querySelectorAll('col')[4].style.width
      ).toBe('120px');
      expect(
        gridObj.getContentTable().querySelectorAll('col')[1].style.width
      ).toBe('100px');
      expect(
        gridObj.getContentTable().querySelectorAll('col')[4].style.width
      ).toBe('120px');
      done();
    });
    afterAll(() => {
  ...
  describe('Code Coverage - Hierarchy Render testing', () => {
    ...
    it('keypress testing', () => {
      (
        gridObj.getDataRows()[0].querySelector('.e-rowcell') as HTMLElement
      ).click();
  ...
  describe('On property change detail template', () => {
    ...
    it('Bind detail template', (done: Function) => {
      dataBound = function (e: any) {
        expect(
          gridObj.element.querySelector('.e-detailrowcollapse')
        ).not.toBeNull();
        gridObj.dataBound = null;
        done();
      };
  ...
  describe('Code Coverage - Hierarchy Render testing', () => {
    ...
    it('auxilaryclickHandler coverage', () => {
      (gridObj as any).detailRowModule.auxilaryclickHandler({
        button: 1,
        preventDefault: () => {},
        target: gridObj.element.querySelector('.e-icon-grightarrow'),
      });
      (gridObj as any).detailRowModule.auxilaryclickHandler({
        button: 1,
        preventDefault: () => {},
    ...
    it('auxilaryclickHandler coverage', () => {
      ...
      (gridObj as any).detailRowModule.clickHandler({
        button: 1,
        preventDefault: () => {},
        target: gridObj.element.querySelector('.e-icon-grightarrow'),
      });
