...
describe('Checkbox Filter module => ', () => {
  ...
  describe('Checkbox dialog functionalities => ', () => {
    ...
    it('dialog open testing', (done: Function) => {
      actionComplete = (args?: any): void => {
        if (args.requestType === 'filterAfterOpen') {
          ...
          expect(checkBoxFilter.querySelectorAll('.e-searchinput').length).toBe(
            1
          );
          expect(checkBoxFilter.querySelectorAll('.e-selectall').length).toBe(
            1
          );
          expect(checkBoxFilter.querySelectorAll('.e-chk-hidden').length).toBe(
            72
          );
    ...
    it('intermediate state testing', () => {
      (
        checkBoxFilter.querySelectorAll('.e-checkbox-wrapper')[1] as any
      ).click();
      expect(checkBoxFilter.querySelectorAll('.e-stop').length).toBe(1);
      (
        checkBoxFilter.querySelectorAll('.e-checkbox-wrapper')[2] as any
      ).click();
      expect(checkBoxFilter.querySelectorAll('.e-stop').length).toBe(1);
      (
        checkBoxFilter.querySelectorAll('.e-checkbox-wrapper')[1] as any
    ...
    it('search box keyup testing', (done: Function) => {
      actionComplete = (args?: any): void => {
        if (args.requestType === 'filterchoicerequest') {
          expect(
            document
              .querySelector('.e-searchcontainer')
              .querySelectorAll('.e-searchinput').length
          ).toBe(1);
          expect(checkBoxFilter.querySelectorAll('.e-selectall').length).toBe(
            1
          );
          expect(checkBoxFilter.querySelectorAll('.e-add-current').length).toBe(
            1
          );
          expect(checkBoxFilter.querySelectorAll('.e-chk-hidden').length).toBe(
            4
          ...
          expect(
            checkBoxFilter.querySelectorAll('.e-uncheck:not(.e-add-current)')
              .length
          ).toBe(0);
          expect(checkBoxFilter.querySelectorAll('.e-stop').length).toBe(0);
          gridObj.actionComplete = null;
    ...
    it('search box keyup invalid input testing', (done: Function) => {
      actionComplete = (args?: any): void => {
        if (args.requestType === 'filterchoicerequest') {
          ...
          expect(checkBoxFilter.querySelectorAll('.e-stop').length).toBe(0);
          expect(
            checkBoxFilter.querySelector('.e-checkfltrnmdiv').children[0]
              .innerHTML
    ...
    it('search box keyup invalid - corrected input testing', (done: Function) => {
      actionComplete = (args?: any): void => {
        if (args.requestType === 'filterchoicerequest') {
          ...
          expect(checkBoxFilter.querySelectorAll('.e-stop').length).toBe(0);
          expect(checkBoxFilter.children[0].tagName.toLowerCase()).not.toBe(
            'span'
          );
          gridObj.actionComplete = null;
          done();
    ...
    it('select all testing', () => {
      (
        checkBoxFilter.querySelectorAll('.e-checkbox-wrapper')[0] as any
      ).click();
      expect(checkBoxFilter.querySelectorAll('.e-stop').length).toBe(0);
      expect(checkBoxFilter.querySelectorAll('.e-check').length).toBe(0);
      ...
      expect(
        checkBoxFilter.querySelectorAll('button')[0].getAttribute('disabled')
      ).not.toBeNull();
    ...
    it('Filter orderID testing', (done: Function) => {
      ...
      (
        checkBoxFilter.querySelectorAll('.e-checkbox-wrapper')[3] as any
      ).click();
      (
        checkBoxFilter.querySelectorAll('.e-checkbox-wrapper')[4] as any
      ).click();
      checkBoxFilter.querySelectorAll('button')[0].click();
    });
    ...
    it('Filter CustomerID testing', (done: Function) => {
      actionComplete = (args?: any): void => {
        ...
        expect(
          checkFilterObj(
            gridObj.filterSettings.columns[5],
            'CustomerID',
            'equal',
            'TOMSP',
            'or',
    ...
    it('Filter Freight testing', (done: Function) => {
      actionComplete = (args?: any): void => {
        ...
        expect(
          checkFilterObj(
            gridObj.filterSettings.columns[6],
            'Freight',
            'equal',
            11.61,
            'or',
    ...
    it('Filter orderID testing', (done: Function) => {
      ...
      (
        checkBoxFilter.querySelectorAll('.e-checkbox-wrapper')[5] as any
      ).click();
      checkBoxFilter.querySelectorAll('button')[0].click();
    });
    ...
    it('EJ2-6971-Date filter search checking ', (done: Function) => {
      actionComplete = (args?: any): void => {
        if (args.requestType === 'filterAfterOpen') {
          ...
          checkBoxFilter = document.querySelector('.e-checkboxfilter');
          (<any>gridObj.filterModule).filterModule.checkBoxBase.sInput.value =
            '7/9/1996';
          (<any>(
            gridObj.filterModule
          )).filterModule.checkBoxBase.refreshCheckboxes();
          expect(
            checkBoxFilter.querySelector('.e-checkboxlist.e-fields').children
              .length
    ...
    it('EJ2-7690-Search In Filtering Dialog Box Get Closed While Press "Enter Key" ', (done: Function) => {
      actionComplete = (args?: any): void => {
        if (args.requestType === 'filterAfterOpen') {
          (<any>gridObj.filterModule).filterModule.checkBoxBase.sInput.value =
            'Vinet';
          (<any>gridObj.filterModule).filterModule.checkBoxBase.btnClick({
            target: (<any>gridObj.filterModule).filterModule.checkBoxBase
              .sInput,
          });
        }
  ...
  describe('EJ2-34831  parent query check for Checkbox filter searchlist ', function () {
    ...
    it('clear OrderID search testing for searchlist length', function (done) {
      actionComplete = (args?: any): void => {
        expect(checkBoxFilter.querySelectorAll('.e-selectall').length).toBe(1);
        expect(checkBoxFilter.querySelectorAll('.e-chk-hidden').length).toBe(
          gridObj.currentViewData.length + 1
        );
        expect(checkBoxFilter.querySelectorAll('.e-check').length).toBe(
          gridObj.currentViewData.length + 1
        );
        expect(checkBoxFilter.querySelectorAll('.e-uncheck').length).toBe(0);
        gridObj.actionComplete = null;
  ...
  describe('EJ2-36047- Incorrect datetime filter predicates ', function () {
    ...
    let fData: Object[] = [
      {
        OrderID: 10248,
        OrderDate: new Date(2019, 8, 28, 18, 33, 36),
        Freight: 32.38,
      },
      {
        OrderID: 10249,
        OrderDate: new Date(2019, 8, 28, 18, 33, 37),
        Freight: 11.61,
      },
      {
        OrderID: 10250,
        OrderDate: new Date(2019, 8, 28, 18, 33, 38),
        Freight: 65.83,
      },
      {
        OrderID: 10251,
        OrderDate: new Date(2019, 8, 28, 18, 35, 53),
        Freight: 41.34,
      },
    ];
    let actionComplete: () => void;
    ...
    it('OrderDate dialog filter testing', (done: Function) => {
      ...
      (
        document.querySelectorAll(
          '.e-checkboxlist .e-frame:not(.e-selectall)'
        )[0] as any
      ).click();
      (
        document.querySelectorAll(
  ...
  describe('EJ2-37831 checkbox filtering with enter key', () => {
    ...
    it('Filter OrderID testing', () => {
      ...
      gridObj.keyboardModule.keyAction({
        action: 'enter',
        target: checkBoxFilter.querySelectorAll('.e-checkbox-wrapper')[1],
      } as any);
    });
  ...
  describe('EJ2-37912 - Checkbox selection not maintain properly in overview sample', () => {
    ...
    it('Checkbox state filtering', (done: Function) => {
      ...
      gridObj.actionComplete = actionComplete;
      chkAll = document.querySelector('.e-checkselectall')
    ...
    it('checking the locale text', (done: Function) => {
      gridObj.actionComplete = actionComplete = (args?: any): void => {
        if (args.requestType === 'filterchoicerequest') {
          checkBoxFilter = document.querySelector('.e-checkboxfilter');
          expect(
            checkBoxFilter.querySelectorAll('.e-checkboxfiltertext')[1]
              .innerHTML
          ).toBe('Falsch');
          expect(
            checkBoxFilter.querySelectorAll('.e-checkboxfiltertext')[2]
              .innerHTML
          ).toBe('Wahr');
          done();
        }
  ...
  it('Searching blank value', (done: Function) => {
    actionComplete = (args?: any): void => {
      if (args.requestType === 'filterchoicerequest') {
        ...
        expect(
          (
            checkBoxFilter.querySelector('.e-checkboxlist')
...
describe('Checkbox Filter on demand load and selection maintain for filter', () => {
  ...
  it('OrderID filter dialog open testing', (done: Function) => {
    actionComplete = (args?: any): void => {
      if (args.requestType === 'filterAfterOpen') {
        expect(document.querySelector('.e-checkboxlist').children.length).toBe(
          gridObj.filterSettings.itemsCount * 3
        );
        actionComplete = null;
        done();
  ...
  it('OrderID filter dialog open testing and down scroll', (done: Function) => {
    ...
    (<any>(
      gridObj.filterModule
    )).filterModule.checkBoxBase.infiniteScrollHandler();
  ...
  it('OrderID filter dialog open testing and down scroll - 1', (done: Function) => {
    actionComplete = (args?: any): void => {
      if (args.requestType === 'filterAfterOpen') {
        expect(document.querySelector('.e-checkboxlist').children.length).toBe(
          gridObj.filterSettings.itemsCount * 3 - 2
        );
        actionComplete = null;
        done();
      } else if (args.requestType === 'filterchoicerequest') {
  ...
  it('checkbox selection', () => {
    ...
    (<any>gridObj.filterModule).filterModule.checkBoxBase.clickHandler({
      target: checkBox,
    });
    expect(
      (<any>gridObj.filterModule).filterModule.checkBoxBase
    ...
    let selectAllCheckBox: Element = (<any>(
      document.querySelector('.e-checkboxlist').parentElement.previousSibling
    )).querySelector('input');
    (<any>gridObj.filterModule).filterModule.checkBoxBase.clickHandler({
  ...
  it('search checkbox selection', () => {
    ...
    expect(
      (<any>gridObj.filterModule).filterModule.checkBoxBase.infiniteSearchPred
    ).not.toBe(undefined);
  });
  ...
  it('checkbox selection after search for coverage', () => {
    ...
    let addCurrSelection: Element = <any>(
      checkBoxList.parentElement.previousSibling
    );
    (<any>gridObj.filterModule).filterModule.checkBoxBase.clickHandler({
      target: addCurrSelection,
    });
  });
  ...
  it('EJ2-857348 - Filter popup closed on pressing the Enter key when No record found.', () => {
    expect(
      (gridObj.filterModule as any).filterModule.checkBoxBase.filterState
    ).toBe(false);
  });
  ...
  it('clear search', (done: Function) => {
    actionComplete = (args?: any): void => {
      if (args.requestType === 'filterchoicerequest') {
        expect(
          args.filterModel.dlg.querySelectorAll('.e-searchinput').length
        ).toBe(1);
        document.querySelector('.e-checkboxlist').scrollTop = 500;
        gridObj.actionComplete = null;
        done();
  ...
  it('checkbox selection after down scroll', () => {
    ...
    let checkBox: Element =
      checkBoxList.children[checkBoxList.children.length - 4].querySelector(
        'input'
      );
    (<any>gridObj.filterModule).filterModule.checkBoxBase.clickHandler({
      target: checkBox,
    ...
    checkBox =
      checkBoxList.children[checkBoxList.children.length - 3].querySelector(
        'input'
      );
    (<any>gridObj.filterModule).filterModule.checkBoxBase.clickHandler({
      target: checkBox,
  ...
  it('OrderID filter dialog open after filter testing - 3', (done: Function) => {
    actionComplete = (args?: any): void => {
      if (args.requestType === 'filterAfterOpen') {
        ...
        expect(
          document.querySelector('.e-checkboxlist').querySelectorAll('.e-check')
            .length
        ).toBe(0);
        expect(
          (<any>(
            document.querySelector('.e-checkboxlist').parentElement
              .previousSibling
    ...
    let options: Object = {
      ...
      columns: [
        ...
        { field: 'OrderDate', width: 120 },
        {
          field: 'CustomerID',
          width: 100,
          foreignKeyValue: 'City',
          foreignKeyField: 'CustomerID',
          dataSource: fCustomerData.slice(0, 50),
          filter: { itemTemplate: '${foreignKeyData.City}' },
        },
  ...
  it('EmployeeID filter dialog open testing', (done: Function) => {
    ...
    actionComplete = (args?: any): void => {
      if (args.requestType === 'filterAfterOpen') {
        expect(
          document
            .querySelector('.e-excelfilter')
            .querySelector('.e-checkboxlist').innerHTML
        ).toBe('');
        done();
      }
    };
    ...
    (gridObj.filterModule as any).filterIconClickHandler(
      getClickObj(
        gridObj
          .getColumnHeaderByField('EmployeeID')
          .querySelector('.e-filtermenudiv')
      )
    );
  });
...
describe('coverage improvemnet.', () => {
  ...
  describe('checkbox filter with foreign key =>', () => {
      ...
      let options: Object = {
        ...
        columns: [
          ...
          { field: 'OrderDate', width: 120 },
          {
            ...
            foreignKeyValue: 'City',
            foreignKeyField: 'CustomerID',
            dataSource: fCustomerData.slice(0, 20),
            filter: { itemTemplate: '${foreignKeyData.City}' },
          },
          { field: 'ShipCountry', width: 120 },
        ],
    ...
    it('open filter dialog - 3 (boolean column)', (done: Function) => {
      actionComplete = (args?: any): void => {
        if (
          ...
          args.filterModel.dlg.querySelector('.e-searchinput').value == '' &&
          !isDlgOpened
        ) {
      ...
      (gridObj.filterModule as any).filterIconClickHandler(
        getClickObj(
          gridObj
            .getColumnHeaderByField('Verified')
            .querySelector('.e-filtermenudiv')
        )
      );
    });
    ...
    it('clear search', (done: Function) => {
      ...
      gridObj.actionComplete = actionComplete;
      (
        document.querySelector('.e-checkboxfilter .e-searchclear') as any
      ).click();
    });
    ...
    it('open filter dialog - 6', (done: Function) => {
      ...
      (gridObj.filterModule as any).filterIconClickHandler(
        getClickObj(
          gridObj
            .getColumnHeaderByField('ShipCountry')
            .querySelector('.e-filtermenudiv')
        )
      );
    });
    ...
    it('add current selection filter', (done: Function) => {
      (
        document.querySelector('.e-checkboxfilter .e-add-current') as any
      ).click();
      (
        document.querySelector(
          '.e-checkboxfilter .e-footer-content .e-primary'
        ) as any
      ).click();
      expect(document.querySelectorAll('.e-checkboxfilter').length).toBe(0);
      done();
  ...
  describe('on property change =>', () => {
    ...
    it('check updateDateFilter ', () => {
      (CheckBoxFilterBase as any).updateDateFilter({
        type: null,
        value: new Date(),
      });
    });
  ...
  describe('Checkbox filter base file code coverage =>', () => {
    ...
    it('updateSearchIcon and keyupHandler coverage', () => {
      (gridObj.filterModule as any).filterModule.checkBoxBase.keyupHandler({
        key: 'ArrowDown',
    ...
    it('searchBoxClick coverage', () => {
      ...
      ).filterModule.checkBoxBase.isCheckboxFilterTemplate = true;
      (gridObj.filterModule as any).filterModule.checkBoxBase.searchBoxClick({
        target: target,
      });
    });
    ...
    it('searchBoxKeyUp coverage', () => {
      ...
      (
        gridObj.filterModule as any
      ).filterModule.checkBoxBase.infiniteScrollMouseKeyDownHandler();
      document.body.querySelector('.e-searchclear.e-search-icon').remove();
      (
        gridObj.filterModule as any
      ).filterModule.checkBoxBase.updateSearchIcon();
    });
  ...
  describe('EJ2-900938: The "Blanks" filter option is not working properly => ', () => {
    ...
    beforeAll((done: Function) => {
      gridObj = createGrid(
        {
          dataSource: [
            { OrderID: 10251, ShipCountry: 'France', Freight: 41.34 },
