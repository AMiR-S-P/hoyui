...
describe('Dialog Template Editing module', () => {
  ...
  describe('Dialog Template editing render => ', () => {
      ...
      gridObj = createGrid(
        {
          ...
          columns: [
            ...
            },
            {
              ...
              edit: {
                write: (args: any) => {
                  Input.createInput({ element: args.element });
                },
              },
            },
    ...
    it('column edit object check', () => {
      expect(
        (<Column>gridObj.columns[0]).edit instanceof TemplateEditCell
      ).toBeTruthy();
    });
    ...
    it('Save Check =>', (done: Function) => {
      gridObj.actionBegin = (args: any) => {
        ...
        expect(args.form.elements['CustomerID___CustomerID'].value).toBe(
          'WELLI'
        );
      };
      gridObj.actionComplete = (args: any) => {
    ...
    it('new Record save check => ', (done: Function) => {
      ...
      spyOn((<Column>gridObj.columns[4]).edit, 'read');
      spyOn((<Column>gridObj.columns[4]).edit, 'destroy');
      (<HTMLInputElement>document.querySelector('#' + 'OrderID')).value =
        '10333';
      gridObj.endEdit();
    });
...
describe('Edit Template Editing module', () => {
  ...
  describe('Dialog Template editing render => ', () => {
    ...
    it('column edit object check', () => {
      expect(
        (<Column>gridObj.columns[1]).edit instanceof TemplateEditCell
      ).toBeTruthy();
    });
    ...
    it('new Record save check => ', (done: Function) => {
      ...
      spyOn((<Column>gridObj.columns[4]).edit, 'read');
      (<HTMLInputElement>document.querySelector('[name=OrderID]')).value =
        '10333';
      (<HTMLInputElement>(
        document.querySelector('[name=CustomerID___CustomerID]')
      )).value = 'hello';
      gridObj.endEdit();
    });
    it('memory leak', () => {
