...
describe('Data module', () => {
  ...
  describe('datamanager offline - failure testing', () => {
    ...
    beforeAll((done: Function) => {
      ...
      let actionFailure: EmitType<Object> = () => {
        done();
      };
      document.body.appendChild(elem);
      gridObj = new Grid({
    ...
    it('EJ2-7420- Get Column by field test', () => {
      expect(
        (<any>gridObj.getDataModule()).getColumnByField('ShipCity').field
      ).toBe('ShipCity');
    });
  ...
  describe('Custom Data Source with Batch editing =>', () => {
    ...
    it('Batch Editing a record =>', (done: Function) => {
      ...
      (select('#' + gridObj.element.id + 'EditConfirm', gridObj.element) as any)
