import { createElement, getUniqueID, EmitType, remove } from '@hoyui/base';
...
export function createGrid(options: GridModel, done: Function): Grid {
  ...
  options.dataSource =
    options.dataSource instanceof Array
      ? DataUtil.parse.parseJson(JSON.stringify(options.dataSource))
      : options.dataSource;
