...
describe('Util module', () => {
  describe('Method testing', () => {
    ...
    it('doesImplementInterface testing', () => {
      ...
      setCssInGridPopUp(
        div,
        { target: div, clientX: 0, clientY: 100 } as any,
        'e-downtail e-uptail'
      );
      setCssInGridPopUp(
        div,
        { target: div, changedTouches: [{ clientX: 0, clientY: 100 }] } as any,
        'e-downtail e-uptail'
      );
      prepareColumns(['a', 'b']);
    });
  ...
  describe('Get methods from Window =>', () => {
    ...
    let customAggFunc: (data: Object) => any = ((<any>(
      window
    )).customAggregateFn = (data: Object) =>
      data['result'].filter((item: Object) => item['ShipCountry'] === 'Brazil')
        .length);
