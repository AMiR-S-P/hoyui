 ...
 */
import { EventHandler, ChildProperty, EmitType, Browser } from '@hoyui/base';
...
import { DropDownList, AutoComplete } from '@hoyui/dropdowns';
...
describe('filter menu module =>', () => {
  ...
  describe('filter menu with ui render test =>', () => {
    ...
    it('filter icon render based on column visibility', () => {
      expect(
        gridObj.element.querySelectorAll('.e-icon-filter').length
      ).toBeLessThan(gridObj.getColumns().length);
    });
      ...
      actionComplete = (args?: any): void => {
        if (args.requestType === 'filterAfterOpen') {
          let flm: FilterMenuRenderer = new FilterMenuRenderer(
            gridObj,
            gridObj.filterSettings as FilterSettings,
            gridObj.serviceLocator
          );
          expect(
            (gridObj.filterModule as any).filterModule.isDialogOpen
          ).toEqual(true);
          let instances: string = 'ej2_instances';
          let element: Element;
          let numberuiObj: NumericTextBox = document.querySelector(
            '#numberui-' + gridObj.getColumns()[0].uid
          )[instances][0];
          ...
          expect(gridObj.element.querySelectorAll('.e-filtered').length).toBe(
            1
          );
    ...
    it('number filter functionalites testing', (done: Function) => {
      ...
      actionComplete = (args?: any): void => {
        if (args.requestType === 'filterAfterOpen') {
          let numberuiObj1: NumericTextBox = document.querySelector(
            '#numberui-' + gridObj.getColumns()[0].uid
          )[instances][0];
          expect(gridObj.filterSettings.columns[0].value).toEqual(
            numberuiObj1.value
          );
          (<HTMLInputElement>(
            document.querySelector('.e-flmenu-cancelbtn')
          )).click();
    ...
    it('string filter ui render testing', (done: Function) => {
      actionComplete = (args?: any): void => {
        if (args.requestType === 'filterAfterOpen') {
          ...
          let instances: string = 'ej2_instances';
          let struiObj: AutoComplete = document.querySelector(
            '#strui-' + gridObj.getColumns()[1].uid
          )[instances][0];
    ...
    it('string filter functionalites testing', (done: Function) => {
      ...
      actionComplete = (args?: any): void => {
        if (args.requestType === 'filterAfterOpen') {
          let struiObj1: AutoComplete = document.querySelector(
            '#strui-' + gridObj.getColumns()[1].uid
          )[instances][0];
          expect(gridObj.filterSettings.columns[0].value).toEqual(
            struiObj1.value as string | number | boolean | Date
          );
          (<HTMLInputElement>(
            document.querySelector('.e-flmenu-cancelbtn')
          )).click();
    ...
    it('date filter ui render testing', (done: Function) => {
      actionComplete = (args?: any): void => {
        if (args.requestType === 'filterAfterOpen') {
          ...
          let instances: string = 'ej2_instances';
          let element: Element;
          let dateObj: DatePicker = document.querySelector(
            '#dateui-' + gridObj.getColumns()[3].uid
          )[instances][0];
    ...
    it('date filter functionalites testing', (done: Function) => {
      ...
      actionComplete = (args?: any): void => {
        if (args.requestType === 'filterAfterOpen') {
          let dateObj1: DatePicker = document.querySelector(
            '#dateui-' + gridObj.getColumns()[3].uid
          )[instances][0];
          expect(gridObj.filterSettings.columns[0].value.toString()).toEqual(
            dateObj1.value.toString()
          );
          (<HTMLInputElement>(
            document.querySelector('.e-flmenu-cancelbtn')
          )).click();
    ...
    it('boolean filter ui render testing', (done: Function) => {
      actionComplete = (args?: any): void => {
        if (args.requestType === 'filterAfterOpen') {
          ...
          let instances: string = 'ej2_instances';
          let boolObj: DropDownList = document.querySelector(
            '#bool-ui-' + gridObj.getColumns()[4].uid
          )[instances][0];
          boolObj.value = 'true';
          (<HTMLInputElement>document.querySelector('.e-flmenu-okbtn')).click();
    ...
    it('boolean filter functionalites testing', (done: Function) => {
      ...
      actionComplete = (args?: any): void => {
        if (args.requestType === 'filterAfterOpen') {
          expect(gridObj.filterSettings.columns[0].value).toEqual(
            gridObj.filterSettings.columns[0].value
          );
          (<HTMLInputElement>(
            document.querySelector('.e-flmenu-cancelbtn')
          )).click();
    ...
    it('number filter ui change render testing', (done: Function) => {
      actionComplete = (args?: any): void => {
        ...
        if (args.requestType === 'filterAfterOpen') {
          ...
          let instances: string = 'ej2_instances';
          const dd: DropDownList =
            document.querySelector('.e-dropdownlist')[instances][0];
          dd.value = 'isnull';
          const valInput: HTMLElement = document
            .querySelector('.e-flmenu-valuediv')
            .querySelector('input');
    ...
    it('datetime filter ui render testing', (done: Function) => {
      actionComplete = (args?: any): void => {
        if (args.requestType === 'filterAfterOpen') {
          ...
          let instances: string = 'ej2_instances';
          let element: Element;
          let dateObj: DateTimePicker = document.querySelector(
            '#dateui-' + gridObj.getColumns()[3].uid
          )[instances][0];
      ...
      gridObj = createGrid(
        {
          ...
          filterSettings: {
            ...
            operators: {
              ...
              numberOperator: [{ value: 'equal', text: 'equal' }],
            },
          },
          allowReordering: true,
          columns: [
  ...
  describe('EJ2-38311 ==> filtering menu with object type format  =>', () => {
    ...
    it('filtering menu open based on its column type =>', (done: Function) => {
      actionComplete = (args?: any): void => {
        if (args.requestType === 'filterAfterOpen') {
          expect(
            (gridObj.filterModule as any).filterModule.dlgDiv.querySelector(
              '.e-numerictextbox'
  ...
  describe('EJ2-41242 ==> filtering menu with custom data  =>', () => {
    ...
    it('autocomplete data check =>', () => {
      expect(
        (document.querySelector('.e-autocomplete') as any).ej2_instances[0]
          .dataSource
      ).not.toBe(0);
    });
  ...
  describe('EJ2-43342 ==> filtering menu with checkbox  =>', () => {
    ...
    let actionBegin: any = (args?: any) => {
      if (args.requestType == 'filterBeforeOpen') {
        gridObj.filterModule.menuOperator = [
      ...
      gridObj = createGrid(
        {
          ...
          columns: [
            ...
            {
              field: 'CustomerID',
              filterTemplate: '${renderCheckBoxMenu(data)}',
            },
          ],
          actionBegin: actionBegin,
        },
    ...
    it('filtering menu checkbox ui testing =>', (done: Function) => {
      actionComplete = (args?: any): void => {
        if (args.requestType === 'filterAfterOpen') {
          let menuCheckBoxFilter: HTMLElement =
            gridObj.element.querySelector('.e-menucheckbox');
          let flm: FilterMenuRenderer = new FilterMenuRenderer(
            gridObj,
            gridObj.filterSettings as FilterSettings,
            gridObj.serviceLocator
          );
          expect(menuCheckBoxFilter.querySelector('.e-searchbox')).not.toBe(
            null
          );
          expect(menuCheckBoxFilter.querySelector('.e-spinner')).not.toBe(null);
          expect(menuCheckBoxFilter.querySelector('.e-flm_optrdiv')).not.toBe(
            null
          );
          expect(menuCheckBoxFilter.querySelectorAll('.e-check').length).toBe(
            44
          );
          (<HTMLInputElement>(
            menuCheckBoxFilter.querySelectorAll('.e-check')[1]
          )).click();
          (
            menuCheckBoxFilter.querySelector('.e-dropdownlist') as any
          ).ej2_instances[0].value = 'notequal';
  ...
  describe('Code Coverage for BooleanFilterUI =>', () => {
    ...
    it('boolean filter ui render testing', (done: Function) => {
      actionComplete = (args?: any): void => {
        if (args.requestType === 'filterAfterOpen') {
          let dropDownList: DropDownList = document
            .querySelector('.e-filter-popup')
            .querySelectorAll('.e-dropdownlist')[1]['ej2_instances'][0];
  ...
  describe('Code Coverage for date FilterUI =>', () => {
    ...
    it('date filter ui render testing', (done: Function) => {
      let filter: BooleanFilterUI = new BooleanFilterUI(
        undefined,
        undefined,
        undefined
      );
      let string: StringFilterUI = new StringFilterUI(
        undefined,
        undefined,
        undefined
      );
      let menu: FlMenuOptrUI = new FlMenuOptrUI(
        undefined,
        undefined,
        undefined
      );
      actionComplete = (args?: any): void => {
        if (args.requestType === 'filterAfterOpen') {
          let datepicker: DatePicker = document
            .querySelector('.e-filter-popup')
            .querySelectorAll('.e-datepicker')[0]['ej2_instances'][0];
          datepicker.show();
          gridObj.actionComplete = null;
          done();
        }
      ...
      (gridObj.filterModule as any).filterIconClickHandler(
        getClickObj(
          gridObj
            .getColumnHeaderByField('ShippedDate')
            .querySelector('.e-filtermenudiv')
        )
      );
    });
  ...
  describe('Filter Menu Opertor test case', () => {
    ...
    it('field and foreignkeyvalue as same- multiple filtering', (done: Function) => {
      actionComplete = (e: any) => {
        e.filterModel.flMuiObj.renderResponsiveDropDownList({
          popup: { element: document.querySelector('.e-responsive-dialog') },
        });
        done();
      };
      gridObj.actionComplete = actionComplete;
    ...
    it('field and foreignkeyvalue as same- multiple filtering', () => {
      let dropdown: DropDownList = document
        .querySelector('.e-responsive-dialog')
  ...
  describe('Filter Menu file Code Coverage - 1 => ', () => {
    ...
    it('clearCustomFilter coverage', (done: Function) => {
      ...
      gridObj.actionComplete = actionComplete;
      gridObj.filterModule.filterModule.clearCustomFilter(
        (gridObj as any).filterModule.column
      );
      (
        gridObj.element.querySelectorAll('.e-filtermenudiv')[1] as HTMLElement
      ).click();
    ...
    it('applyCustomFilter coverage', () => {
      ...
      gridObj.filterModule.filterModule.applyCustomFilter({
        col: (gridObj as any).filterModule.column,
      });
    });
    ...
    it('filter menu afterRenderFilterUI coverage - 2', () => {
      (
        gridObj as any
      ).filterModule.filterModule.currentDialogCreatedColumn.showColumnMenu =
        false;
      (gridObj as any).filterModule.filterModule.dlgObj.element
        .querySelector('.e-flm_optrdiv')
        .querySelector('input').value = 'Empty';
  ...
  describe('Filter Menu file Code Coverage - 2 => ', () => {
    ...
    let template2 =
      '<div><input type="checkbox" id="Boolean" name="Boolean" class="e-control" /></div>';
    beforeAll((done: Function) => {
      gridObj = createGrid(
        {
          dataSource: filterData,
          ...
          columns: [
            ...
            },
            {
              ...
              width: 150,
              filterTemplate: template1,
            },
            {
              field: 'Verified',
              headerText: 'Boolean',
              width: 150,
              filterTemplate: template2,
            },
          ],
          actionComplete: actionComplete,
        },
    ...
    it('template filter - 2', (done: Function) => {
      (gridObj as any).filterModule.filterModule.dlgDiv.querySelector(
        '.e-flmenu-valuediv'
      ).children[0].value = 'a';
      actionComplete = (e: any) => {
        done();
          ...
          columns: [
            { field: 'OrderID', type: 'number', visible: true },
            {
              ...
              filter: {
                ui: {
                  create: (args: { target: Element; column: Object }) => {
                    let flValInput: HTMLElement = gridObj.createElement(
                      'input',
                      { className: 'flm-input' }
                    );
                    args.target.appendChild(flValInput);
    ...
    it('Filter template isempty testing', () => {
      (<HTMLInputElement>(
        document
          ...
          .querySelector('[data-value="isempty"]')
      )).click();
    });
