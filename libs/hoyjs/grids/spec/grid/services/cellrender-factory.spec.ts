...
describe('CellRendererFactory module', () => {
  describe('Register and get service', () => {
    ...
    it('Check fallback', () => {
      expect(() =>
        gridObj.serviceLocator
          .getService<CellRendererFactory>('cellRendererFactory')
          .getCellRenderer('hi')
      ).toThrow('The cellRenderer hi is not found');
    });
    ...
    it('Check string register', () => {
      ...
      let factory: CellRendererFactory =
        gridObj.serviceLocator.getService<CellRendererFactory>(
          'cellRendererFactory'
        );
