...
import { KeyboardEventArgs as BaseKeyboardEventArgs, L10n } from '@hoyui/base';
import { Query, DataManager, Group, Predicate } from '@hoyui/data';
import {
  ItemModel,
  MenuItemModel,
...
import { ButtonModel, CheckBoxModel, SwitchModel } from '@hoyui/buttons';
...
import { NumericTextBoxModel, MaskedTextBoxModel } from '@hoyui/inputs';
...
import { PdfPaddings } from '@hoyui/pdf-export';
import { AutoCompleteModel } from '@hoyui/dropdowns';
...
export interface IGrid extends Component<HTMLElement> {
  ...
  changeDataSource?(
    columns?: Column[] | string[] | ColumnModel[],
    data?: Object | DataManager | DataResult
  ): void;
  clearSorting?(): void;
