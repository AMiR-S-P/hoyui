  ...
  describe('context menu testing', () => {
    ...
    function addCustomItems(args: MenuOpenEventArgs) {
      for (var item = 0; item < args.items.length; item++) {
        if (
          args.items[item].text == 'Custom1' &&
          args.items[item].items.length === 0
        ) {
  ...
  describe('access control context menu testing', () => {
    ...
    it('mouse click on new folder button', (done: Function) => {
      ...
      setTimeout(function () {
        ...
        let aGridLi: any = document
          .getElementById('file_grid')
          .querySelectorAll('.e-row.e-fe-hidden');
    ...
    it('mouse click on refresh button', (done: Function) => {
      ...
      setTimeout(function () {
        ...
        setTimeout(function () {
          ...
          expect(gridLi1.length).toEqual(9);
          let aTreeLi1: any =
            treeObj.element.querySelectorAll('li.e-fe-hidden');
          let aGridLi1: any = document
            .getElementById('file_grid')
            .querySelectorAll('.e-row.e-fe-hidden');
          expect(aTreeLi1.length).toEqual(2);
    ...
    it('mouse click on details button', (done: Function) => {
      ...
      setTimeout(function () {
        ...
        setTimeout(function () {
          ...
          expect(dialogObj.element.querySelectorAll('td')[8].innerHTML).toEqual(
            'Permission'
          );
          done();
        }, 500);
    ...
    it('mouse click on open button with access folder/files', (done: Function) => {
      ...
      setTimeout(function () {
        ...
        setTimeout(function () {
          ...
          document.getElementById('file_cm_open').click();
          let dialogObj1: any = (
            document.getElementById('file_img_dialog') as any
          ).ej2_instances[0];
          expect(
            dialogObj1.element.querySelector('.e-dlg-header').innerHTML
          ).toEqual('4.jpg');
          done();
        }, 500);
      }, 500);
