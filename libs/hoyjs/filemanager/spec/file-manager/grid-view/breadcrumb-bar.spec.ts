  ...
  describe('with breadcrumb bar testing', () => {
    ...
    it('breadCrumb navigation data testing', (done: Function) => {
      ...
      setTimeout(function () {
        check = true;
        (<HTMLElement>(
          document.getElementsByClassName('e-addressbar-ul')[0]
    ...
    it('Search sort testing (navigate)', (done: Function) => {
      ...
      setTimeout(function () {
        ...
        (<HTMLElement>(
          document.querySelector('.e-headercell.e-lastcell')
        )).click();
    ...
    it('Search (empty) refresh testing', (done: Function) => {
      ...
      setTimeout(function () {
        ...
        expect(gridLi.length).toEqual(0);
        expect(
          document.getElementById('file_grid').querySelectorAll('.e-empty')
            .length
        ).toBe(1);
    ...
    it('Search file column refresh testing', (done: Function) => {
      ...
      setTimeout(function () {
        ...
        setTimeout(function () {
          ...
          expect(
            feObj.detailsviewModule.gridObj.element
              .querySelector('.e-sortfilter .e-columnheader')
              .querySelectorAll('.e-headercell').length
          ).toEqual(5);
          expect(feObj.detailsviewModule.gridObj.getColumns().length).toEqual(
            5
          );
          done();
        }, 500);
    ...
    it('Search file and layout change testing', function (done) {
      var treeObj = (document.getElementById('file_tree') as any)
        .ej2_instances[0];
      ...
      setTimeout(function () {
        let gridObj: any = (document.getElementById('file') as any)
          .ej2_instances[0];
      ...
      setTimeout(function () {
        ...
        let args = {
          rowData: {
            name: 'docs',
            size: 0,
            dateModified: '2019-03-14T09:27:45.346Z',
            dateCreated: '2019-03-13T07:28:06.117Z',
            hasChild: true,
            isFile: false,
            type: '',
      ...
      setTimeout(function () {
        ...
        let args = {
          rowData: {
            name: 'Documents',
            size: 0,
            dateModified: '2019-03-14T14:55:22.5808132+05:30',
            dateCreated: '2019-03-07T14:49:02.6184375+05:30',
            hasChild: true,
            isFile: false,
            type: '',
            filterPath: '\\',
        ...
        setTimeout(function () {
          ...
          setTimeout(function () {
            ...
            setTimeout(function () {
              ...
              expect(treeLi.length).toEqual(5);
              expect(gridLi.length).toEqual(3);
              expect(gridLi[0].querySelector('.e-fe-text').textContent).toBe(
                'docs1'
              );
              done();
            }, 500);
      ...
      setTimeout(
        function () {
          ...
          let treeObj: any = (document.getElementById('file_tree') as any)
            .ej2_instances[0];
          let li: any =
            feObj.navigationpaneModule.treeObj.element.querySelectorAll(
              'li'
            )[1];
      ...
      setTimeout(
        function () {
          ...
          setTimeout(function () {
            ...
            clear.click();
            setTimeout(function () {
              var searchObj1: HTMLInputElement = <HTMLInputElement>(
                feObj.breadCrumbBarNavigation.querySelector('#file_search')
              );
