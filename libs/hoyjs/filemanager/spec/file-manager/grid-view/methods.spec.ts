...
import { ColumnModel } from '@hoyui/grids';
...
describe('FileManager control Grid view', () => {
  describe('methods testing', () => {
    ...
    it('for getPersistData', () => {
      expect(feObj.getPersistData()).toBe(
        '{"view":"Details","path":"/","selectedItems":[]}'
      );
    });
      ...
      setTimeout(function () {
        ...
        expect(
          document
            ...
            .querySelectorAll('.e-fe-grid-name.e-active').length
        ).toEqual(5);
        ...
        expect(
          (<any>(
            document
              ...
              .getElementsByClassName('e-layout')[0]
          )).style.height
        ).toBe('0px');
        expect(
          (<any>(
  ...
  describe('methods testing', () => {
    ...
    it('for getSelectedFiles', (done: Function) => {
      ...
      setTimeout(function () {
        ...
        expect(feObj.selectedItems).toEqual(
          jasmine.arrayContaining(['Documents', '1.png'])
        );
    ...
    it('for getSelectedFiles with id base', (done: Function) => {
      ...
      setTimeout(function () {
        feObj.detailsviewModule.gridObj.selectRows([0, 4]);
        expect(feObj.selectedItems).toEqual(
          jasmine.arrayContaining(['6171', '6175'])
        );
        let data: any = feObj.getSelectedFiles();
        expect(data.length).toBe(2);
        expect(data[0]['name']).toBe('Documents');
    ...
    it('for deleteFiles', (done: Function) => {
      ...
      setTimeout(function () {
        ...
        feObj.deleteFiles();
        let dialogObj: any = (document.getElementById('file1_dialog') as any)
          .ej2_instances[0];
        expect(
          dialogObj.element.querySelector('.e-dlg-header').innerHTML
        ).toEqual('Delete Multiple Items');
        (
          document
            .getElementById('file1_dialog')
        ...
        setTimeout(function () {
          let nli: any = document
            .getElementById('file1_tree')
            .querySelectorAll('li');
          let ntr: any = document
            .getElementById('file1_grid')
    ...
    it('for renameFile', (done: Function) => {
      ...
      setTimeout(function () {
        ...
        expect(feObj.selectedItems).toEqual(
          jasmine.arrayContaining(['Documents'])
        );
        feObj.renameFile();
        let dialogObj: any = (document.getElementById('file1_dialog') as any)
          .ej2_instances[0];
        ...
        setTimeout(function () {
          ...
          expect(ntr[2].querySelector('.e-fe-grid-name').textContent).toBe(
            'My Folder'
          );
          done();
        }, 500);
  ...
  describe('Custom method testing', () => {
    ...
    it('for filterFiles', (done: Function) => {
      ...
      setTimeout(function () {
        ...
        let columnData: ColumnModel[] = JSON.parse(
          JSON.stringify(feObj.detailsviewModule.gridObj.columns)
        );
