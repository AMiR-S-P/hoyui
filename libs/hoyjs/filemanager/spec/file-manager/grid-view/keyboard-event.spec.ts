...
describe('FileManager control Grid view', () => {
  describe('keyboard event testing', () => {
    ...
    it('ctrl + U key pressed', (done: Function) => {
      ...
      let fileObj: File[] = [];
      fileObj[0] = new File(['Nice One'], 'sample.txt', {
        lastModified: 0,
      ...
      setTimeout(function () {
        expect(document.querySelector('.e-file-status').innerHTML).toBe(
      ...
      setTimeout(function () {
        ...
        setTimeout(function () {
          expect(
            ...
            'Cannot rename "File1.txt" to "File.png": destination already exists.'
          );
          done();
        }, 500);
      }, 500);
  ...
  describe('Access control to test ctrl + D testing', () => {
    ...
    it('Ctrl + D testing', (done: Function) => {
      ...
      setTimeout(function () {
        ...
        (feObj.detailsviewModule as any).keyupHandler(keyboardEventArgs);
        let dialogObj: any = (document.getElementById('file_dialog') as any)
          .ej2_instances[0];
        expect(
          dialogObj.element.querySelector('.e-dlg-header').innerText
  ...
  describe('for details View', () => {
    ...
    it('home key testing', () => {
      ...
      feObj.detailsviewModule.gridObj.selectionModule.selectRowsByRange(
        li.length - 1,
        li.length - 2
      );
      expect(li[0].getAttribute('aria-selected')).toBe(null);
    ...
    it('continous shift + Up key testing', () => {
      ...
      feObj.detailsviewModule.keyupHandler(keyboardEventArgs);
      expect(
        feObj.detailsviewModule.gridObj.getSelectedRowIndexes().toString()
      ).toBe('4,3');
      feObj.detailsviewModule.keyupHandler(keyboardEventArgs);
      expect(
        feObj.detailsviewModule.gridObj.getSelectedRowIndexes().toString()
    ...
    it('tab key testing', function () {
      let icon: any = document
        .getElementById('file_grid')
        .querySelector('th.e-fe-grid-icon');
      let name: any = document
        .getElementById('file_grid')
        .querySelector('th.e-fe-grid-name');
    ...
    it('ctrl + A key testing', () => {
      ...
      let li: any = document
        .getElementById('file_grid')
        .querySelectorAll('tr.e-row');
      let gridContent: HTMLElement = document
        .getElementById('file_grid')
        .querySelector('.e-gridcontent .e-content');
      ...
      expect(
        document
          .querySelector('.e-headercell .e-frame')
    ...
    it('alt + enter key testing', () => {
      ...
      expect(popupContent.querySelector('.e-dlg-header').innerText).toBe(
        'Upload Files'
      );
    });
    ...
    it('shift + delete key testing', () => {
      ...
      var deleteOption = deletePopup
        .querySelector('.e-footer-content')
        .querySelector('.e-btn').innerText;
    ...
    it('getRecords method testing', () => {
      ...
      expect(
        feObj.detailsviewModule.parent.breadcrumbbarModule.searchObj.element
          .value
      ).toBe('');
      feObj.detailsviewModule.parent.hasId = true;
    });
    ...
    it('moveFunction method testing', () => {
      let li: any = document
        ...
        .querySelectorAll('tr.e-row');
      keyboardEventArgs.action = 'moveDown';
      feObj.detailsviewModule.moveFunction(
        li,
        keyboardEventArgs,
        li.length - 1
      );
    ...
    it('ctrlMoveFunction method testing', () => {
      let li: any = document
        ...
        .querySelectorAll('tr.e-row');
      keyboardEventArgs.action = 'moveDown';
      feObj.detailsviewModule.ctrlMoveFunction(
        li,
        keyboardEventArgs,
        li.length - 1
      );
