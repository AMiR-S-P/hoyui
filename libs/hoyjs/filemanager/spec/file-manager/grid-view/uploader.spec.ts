...
import { Uploader } from '@hoyui/inputs';
...
describe('FileManager control Details view', () => {
  describe('Uploader testing', () => {
    ...
    it('upload process testing', (done) => {
      setTimeout(function () {
        expect(feObj.detailsviewModule.gridObj.contentModule.rows.length).toBe(
          5
        );
        ...
        setTimeout(function () {
          expect(
            feObj.detailsviewModule.gridObj.contentModule.rows.length
          ).toBe(6);
          done();
        }, 500);
      }, 500);
    ...
    it('upload process(multiple files) testing', (done) => {
      setTimeout(function () {
        ...
        fileObj[1] = new File(['Nice Demo'], 'demo.txt', {
          lastModified: 0,
          type: 'overide/mimetype',
        });
        let eventArgs: any = {
    ...
    it('upload process(multiple files) testing', (done) => {
      setTimeout(function () {
        ...
        let uploadObj: Uploader = (<any>(
          document.querySelector('#' + feObj.element.id + '_upload')
        )).ej2_instances[0];
        ...
        (<HTMLElement>(
          feObj.uploadDialogObj.element.querySelector('.e-file-remove-btn')
        )).click();
        (<HTMLElement>(
          feObj.uploadDialogObj.element.querySelector('.e-file-remove-btn')
        )).click();
      ...
      setTimeout(function () {
        ...
        setTimeout(function () {
          ...
          setTimeout(function () {
            ...
            expect(feObj.extDialogObj.btnObj[1].element.textContent).toBe(
              'Replace'
            );
      ...
      setTimeout(function () {
        ...
        setTimeout(function () {
          ...
          setTimeout(function () {
            ...
            expect(feObj.extDialogObj.btnObj[0].element.textContent).toBe(
              'Keep both'
            );
