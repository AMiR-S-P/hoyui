...
describe('FileManager control Details view', () => {
  describe('Cut Copy Paste testing', () => {
    ...
    beforeEach((done: Function): void => {
      ...
      setTimeout(function () {
        let menuObj: any = (
          document.getElementById(feObj.element.id + '_contextmenu') as any
        ).ej2_instances[0];
    ...
    it('folder context menu testing', () => {
      ...
      let Li: Element = feObj.detailsviewModule.gridObj
        .getRowByIndex(1)
      ...
      expect(sourceElement.element.querySelectorAll('li')[0].innerText).toBe(
        'Cut'
      );
      expect(
        (<Element>(
          sourceElement.element.querySelectorAll('li')[0]
        )).classList.contains('e-disabled')
      ).toBe(false);
      expect(sourceElement.element.querySelectorAll('li')[1].innerText).toBe(
        'Copy'
      );
      expect(
        (<Element>(
          sourceElement.element.querySelectorAll('li')[1]
        )).classList.contains('e-disabled')
      ).toBe(false);
      expect(sourceElement.element.querySelectorAll('li')[2].innerText).toBe(
        'Paste'
      );
      expect(
        (<Element>(
          sourceElement.element.querySelectorAll('li')[2]
        )).classList.contains('e-disabled')
      ).toBe(true);
    });
    ...
    it('Layout context menu testing', () => {
      let el: any = document.getElementById(feObj.element.id + '_contextmenu');
      feObj.detailsviewModule.gridObj.selectRows([4]);
      let Li: Element = (<any>feObj.detailsviewModule.gridObj.contentModule)
        .contentPanel.firstElementChild;
      let sourceElement: any = el.ej2_instances[0];
      let evt = document.createEvent('MouseEvents');
      evt.initEvent('contextmenu', true, true);
      Li.dispatchEvent(evt);
    ...
    it('Treeview (Root Folder) context menu testing', () => {
      let el: any = document.getElementById(feObj.element.id + '_contextmenu');
      let li: any =
        feObj.navigationpaneModule.treeObj.element.querySelectorAll('li')[0];
      let sourceElement: any = el.ej2_instances[0];
      let evt = document.createEvent('MouseEvents');
      evt.initEvent('contextmenu', true, true);
    ...
    it('Treeview (Sub-Folder) context menu testing', () => {
      let el: any = document.getElementById(feObj.element.id + '_contextmenu');
      let li: any =
        feObj.navigationpaneModule.treeObj.element.querySelectorAll('li')[1];
      let sourceElement: any = el.ej2_instances[0];
      let evt = document.createEvent('MouseEvents');
      evt.initEvent('contextmenu', true, true);
      li.querySelector('.e-fullrow').dispatchEvent(evt);
    ...
    it('Toolbar testing', () => {
      expect(
        closest(
          document.getElementsByClassName('e-fe-cut')[0],
          'div'
        ).classList.contains('e-hidden')
      ).toBe(true);
      expect(
        closest(
          document.getElementsByClassName('e-fe-copy')[0],
          'div'
        ).classList.contains('e-hidden')
      ).toBe(true);
      expect(
        closest(
          document.getElementsByClassName('e-fe-paste')[0],
          'div'
        ).classList.contains('e-hidden')
      ).toBe(true);
      feObj.detailsviewModule.gridObj.selectRows([1]);
    ...
    it('Toolbar file copy paste testing', (done) => {
      ...
      feObj.detailsviewModule.gridObj.element
        ...
        .firstElementChild.dispatchEvent(dblclickevent);
      this.request = jasmine.Ajax.requests.mostRecent();
      this.request.respondWith({
        status: 200,
    ...
    it('Toolbar file copy paste layout change testing', (done) => {
      ...
      setTimeout(function () {
        ...
        setTimeout(function () {
          expect(feObj.detailsviewModule.gridObj.getRows().length).toBe(4);
          expect(feObj.detailsviewModule.gridObj.getSelectedRows().length).toBe(
            1
          );
          ...
          setTimeout(function () {
            expect(
              document.getElementById('file_largeicons').querySelectorAll('li')
                .length
            ).toBe(4);
            expect(
              document
                .getElementById('file_largeicons')
                .querySelectorAll('li.e-active').length
            ).toBe(1);
            done();
          }, 500);
        }, 500);
    ...
    it('Toolbar file cut paste testing', (done) => {
      ...
      expect(
        feObj.detailsviewModule.gridObj.element
          .querySelectorAll('.e-row')[4]
          .classList.contains('e-blur')
      ).toBe(true);
      expect(feObj.selectedNodes.length).toBe(1);
      expect(feObj.actionRecords.length).toBe(1);
      feObj.detailsviewModule.gridObj.element
    ...
    it('Toolbar file cut path change testing', (done) => {
      ...
      setTimeout(function () {
        ...
        let treeObj: any = (document.getElementById('file_tree') as any)
          .ej2_instances[0];
    ...
    it('Keyboard file cut paste (sub folder) testing', (done) => {
      ...
      setTimeout(function () {
        ...
        expect(
          document
            .getElementById('file_dialog')
            .querySelectorAll('.e-fe-errorcontent').length
        ).toBe(1);
    ...
    it('Keyboard file cut paste (sub folder - multiple folder) testing', (done) => {
      ...
      setTimeout(function () {
        ...
        expect(feObj.detailsviewModule.gridObj.getRows().length).toBe(3);
        expect(
          (<HTMLElement>document.querySelector('.e-fe-errorcontent')).innerText
        ).toBe('The destination folder is the subfolder of the source folder.');
        done();
      }, 500);
    });
    ...
    it('Toolbar folder copy paste testing', (done) => {
      ...
      evt.initEvent('contextmenu', true, true);
      Li.dispatchEvent(evt);
      expect(sourceElement.element.querySelectorAll('li')[4].innerText).toBe(
        'Open'
      );
    ...
    it('TreeView cut paste testing', (done) => {
      ...
      setTimeout(function () {
        ...
        setTimeout(function () {
          ...
          expect(
            sourceElement.element.querySelectorAll('li')[2].innerText
          ).toBe('Paste');
          ...
          setTimeout(function () {
            expect(feObj.detailsviewModule.gridObj.getRows().length).toBe(4);
            expect(
              document.getElementById('file_tree').querySelectorAll('li')[1]
                .textContent
            ).toBe('Employees');
            done();
          }, 500);
      ...
      setTimeout(function () {
        ...
        setTimeout(function () {
          expect(
            document
              .getElementById('file_dialog')
              .querySelector('#file_dialog_title').textContent
          ).toBe('Error');
          document
            .getElementById('file_dialog')
            .querySelectorAll('button')[1]
      ...
      setTimeout(function () {
        ...
        setTimeout(function () {
          ...
          expect(
            document
              .getElementById('file_extn_dialog')
              .querySelector('#file_extn_dialog_title').textContent
          ).toBe('File/Folder exists');
          done();
        }, 500);
      }, 500);
    });
  ...
  describe('Drag and Drop testing', () => {
    ...
    it('drag and drop same folder tree', () => {
      ...
      let mousedown: any = getEventObject(
        'MouseEvents',
        'mousedown',
        li[1].querySelector('.e-fullrow'),
        li[1].querySelector('.e-fullrow'),
        rect[0].x + 4,
        rect[0].y + 4
      );
      EventHandler.trigger(treeObj.element, 'mousedown', mousedown);
      let mousemove: any = getEventObject(
        'MouseEvents',
        'mousemove',
        li[1].querySelector('.e-fullrow'),
        li[1].querySelector('.e-fullrow'),
      ...
      mousemove = setMouseCordinates(mousemove, rect[0].x + 5, rect[0].y + 5);
      EventHandler.trigger(<any>document, 'mousemove', mousemove);
      let mouseup: any = getEventObject(
        'MouseEvents',
        'mouseup',
        li[1].querySelector('.e-fullrow'),
        li[1].querySelector('.e-fullrow'),
    ...
    it('drag and drop sub folder tree', (done) => {
      ...
      setTimeout(function () {
        let nli: Element[] = <Element[] & NodeListOf<HTMLLIElement>>(
          treeObj.element.querySelectorAll('li')
        );
    ...
    it('drag and drop same folder grid', () => {
      ...
      let mousedown: any = getEventObject(
        'MouseEvents',
        'mousedown',
        li[1].querySelector('.e-fe-grid-name'),
        li[1].querySelector('.e-fe-grid-name'),
        rect[0].x + 4,
        rect[0].y + 4
      );
      ...
      mousemove.srcElement =
        mousemove.target =
        mousemove.toElement =
          li[2].querySelector('.e-fe-grid-name');
      mousemove = setMouseCordinates(mousemove, rect[0].x + 5, rect[0].y + 5);
      EventHandler.trigger(<any>document, 'mousemove', mousemove);
      ...
      mousemove.srcElement =
        mousemove.target =
        mousemove.toElement =
          li[3].querySelector('.e-fe-grid-name');
      mousemove = setMouseCordinates(mousemove, rect[0].x + 5, rect[0].y + 5);
      EventHandler.trigger(<any>document, 'mousemove', mousemove);
      rect = li[2].querySelector('.e-fe-grid-name').getClientRects();
      mousemove.srcElement =
    ...
    it('auto scroll in drag and drop', (done) => {
      ...
      setTimeout(function () {
        ...
        mousemove.srcElement =
          mousemove.target =
          mousemove.toElement =
            li[4].querySelector('.e-fe-grid-name');
        mousemove = setMouseCordinates(mousemove, rect[0].x + 5, rect[0].y + 5);
        mousemove.screenY = rect[0].y + 5;
        EventHandler.trigger(<any>document, 'mousemove', mousemove);
        let mouseup: any = getEventObject(
    ...
    it('drag and drop different folder tree', (done) => {
      ...
      expect(
        treeObj.element
          .querySelector('[title="Documents"]')
          .classList.contains('e-level-2')
      ).toBe(true);
      let li: Element[] = <Element[] & NodeListOf<HTMLLIElement>>(
        treeObj.element.querySelectorAll('li')
      );
    ...
    it('drag and drop grid to undroppable area', () => {
      ...
      let mouseup: any = getEventObject(
        'MouseEvents',
        'mouseup',
        feObj.toolbarModule.toolbarObj.element,
        feObj.toolbarModule.toolbarObj.element,
        rect[0].x + 5,
        rect[0].y + 5
      );
      ...
      EventHandler.trigger(<any>document, 'mousemove', mousemove);
      mouseup = getEventObject(
        'MouseEvents',
        'mouseup',
        feObj.navigationpaneModule.treeObj.element,
        feObj.navigationpaneModule.treeObj.element,
        rect[0].x + 5,
        rect[0].y + 5
      );
    ...
    it('drag and drop different tree location to grid folder ', (done) => {
      ...
      setTimeout(function () {
        ...
        mousemove.srcElement =
          mousemove.target =
          mousemove.toElement =
            li[0].querySelector('.e-fe-grid-name');
        mousemove = setMouseCordinates(mousemove, rect[0].x + 5, rect[0].y + 5);
        EventHandler.trigger(<any>document, 'mousemove', mousemove);
        let mouseup: any = getEventObject(
          'MouseEvents',
    ...
    it('drag and drop searched grid file to same tree location ', (done) => {
      ...
      setTimeout(function () {
        ...
        expect(
          (<HTMLElement>document.querySelector('.e-fe-errorcontent')).innerText
        ).toBe('The destination folder is the same as the source folder.');
        done();
      }, 100);
    });
    ...
    it('Multiple Item drag and drop with duplicate items(1) testing', (done) => {
      ...
      setTimeout(function () {
        ...
        expect(feObj.detailsviewModule.gridObj.getRows().length).toBe(4);
        expect(
          document.getElementById('file_extn_dialog').querySelectorAll('button')
            .length
        ).toBe(3);
        document
          .getElementById('file_extn_dialog')
    ...
    it('drag and drop cancel at dragstart event', () => {
      ...
      feObj.allowDragAndDrop = true;
      feObj.dataBind();
      feObj.fileDragStart = (args: FileDragEventArgs) => {
        args.cancel = true;
        flag = true;
      };
      let gridObj: any = feObj.detailsviewModule.gridObj;
    ...
    it('drag and drop cancel at dragstop event', () => {
      ...
      feObj.allowDragAndDrop = true;
      feObj.dataBind();
      feObj.fileDragStop = (args: FileDragEventArgs) => {
        args.cancel = true;
        flag = true;
      };
      let gridObj: any = feObj.detailsviewModule.gridObj;
    ...
    it('drag and drop with showFileExtension as false', () => {
      ...
      EventHandler.trigger(<any>document, 'mousemove', mousemove);
      let cloneElementName = document
        .querySelector('.e-fe-clone')
        .querySelector('.e-fe-name')
        .innerHTML.split('.')
        .slice(0, -1)
        .join('.');
      let selectedGridRow = feObj.detailsviewModule.gridObj
        .getSelectedRows()[0]
        .querySelector('.e-fe-grid-name').innerHTML;
