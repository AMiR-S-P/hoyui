...
describe('FileManager control Grid view', () => {
  ...
  describe('events testing popup event', () => {
    ...
    it('for BeforeFolderCreate cancel testing', (done) => {
      name = 'Create Folder';
      feObj.beforeFolderCreate = (args: FolderCreateEventArgs) => {
        args.cancel = true;
      };
      expect(
    ...
    it('for BeforeDelete cancel testing', (done) => {
      name = 'Delete';
      feObj.beforeDelete = (args: DeleteEventArgs) => {
        args.cancel = true;
      };
      expect(
        document.getElementById('file_grid').querySelectorAll('.e-row').length
    ...
    it('for BeforeRename cancel testing', (done) => {
      name = 'Rename';
      feObj.beforeRename = (args: RenameEventArgs) => {
        args.cancel = true;
      };
      feObj.detailsviewModule.gridObj.selectRows([0]);
      let itemName: string = (
        document
          ...
          .querySelector('.e-fe-text') as HTMLElement
      ).innerText;
      let item: any = document.getElementById('file_tb_rename');
      item.click();
      (<any>document.querySelector('.e-fe-popup .e-input')).value =
    ...
    it('for BeforeMove cancel testing', (done) => {
      feObj.beforeMove = (args: MoveEventArgs) => {
        args.cancel = true;
      };
      expect(
        document.getElementById('file_grid').querySelectorAll('.e-row').length
