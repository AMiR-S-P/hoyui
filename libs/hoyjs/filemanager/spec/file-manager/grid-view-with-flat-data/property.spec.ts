...
describe('FileManager control Grid view', () => {
  describe('property testing', () => {
    ...
    it('for toolbarSettings', () => {
      ...
      feObj.appendTo('#file');
      expect(
        document.getElementById('file_toolbar').classList.contains('e-toolbar')
      ).toEqual(false);
      ...
      expect(
        feObj.element.querySelectorAll('.e-toolbar-item.e-overlay').length
      ).toEqual(1);
      expect(
        feObj.element
    ...
    it('for width', () => {
      ...
      expect(
        (feObj.element.querySelector('.e-toolbar') as HTMLElement).offsetWidth
      ).toBeLessThanOrEqual(feObj.element.offsetWidth);
      feObj.destroy();
    ...
    it('for rootAliasName', () => {
      ...
      expect(
        (<HTMLElement>(
          document.querySelector('#file_tree  .e-text-content .e-list-text')
        )).innerText
      ).toEqual('My Drive');
      feObj.destroy();
    });
    it('for enableRtl', () => {
      ...
      expect(
        feObj.element.querySelector('.e-treeview').classList.contains('e-rtl')
      ).toEqual(true);
      expect(
        feObj.element.querySelector('.e-toolbar').classList.contains('e-rtl')
      ).toEqual(true);
      expect(
        feObj.element.querySelector('.e-grid').classList.contains('e-rtl')
      ).toEqual(true);
      expect(
        feObj.contextmenuModule.contextMenu.element.parentElement.classList.contains(
          'e-rtl'
        )
      ).toEqual(true);
      feObj.destroy();
    ...
    it('for showFileExtension', (done) => {
      ...
      setTimeout(function () {
        expect(
          document.getElementById('file_grid').querySelectorAll('.e-row').length
        ).toEqual(6);
        expect(
          document.getElementById('file_grid').querySelectorAll('.e-row')[3]
      ...
      feObj = new FileManager({
        ...
        detailsViewSettings: {
          columns: [
            ...
            {
              field: 'name',
              template: '<div class="e-fe-text">${name}</div>',
    ...
    it('for path with id', (done: Function) => {
      ...
      setTimeout(function () {
        ...
        let gridLi: any = document
          .getElementById('file_grid')
          .querySelectorAll('.e-row');
        let addressLi: any = document
          .getElementById('file_breadcrumbbar')
          .querySelectorAll('.e-address-list-item');
        ...
        expect(
          (document.getElementById('file_search') as any).placeholder
        ).toBe('Search New folder');
        done();
      }, 500);
    });
    it('for selectedItems with id', (done: Function) => {
      ...
      feObj.appendTo('#file');
      setTimeout(function () {
        expect(feObj.selectedItems).toEqual(
          jasmine.arrayContaining(['1', '6'])
    ...
    it('for detailsViewSettings', (done: Function) => {
      ...
      setTimeout(function () {
        ...
        expect(
          document.getElementById('file_grid').querySelectorAll('.e-headercell')
            .length
        ).toEqual(6);
        done();
      }, 400);
    ...
    it('for detailsviewsettings name column width', (done) => {
      ...
      setTimeout(function () {
        ...
        expect(
          (
            feObj.element.querySelectorAll(
              'th.e-fe-grid-name'
            )[0] as HTMLElement
          ).offsetWidth
        ).toBeGreaterThan(150);
    ...
    it('for sorting - Default value', (done) => {
      ...
      setTimeout(function () {
        ...
        expect(
          document
            .getElementById('file_ddl_ascending')
            .children[0].classList.contains('e-fe-tick')
        ).toBe(true);
        expect(
          document.getElementById('file_grid').querySelectorAll('.e-row').length
        ).toEqual(6);
        expect(
          document.getElementById('file_grid').querySelectorAll('.e-row')[0]
            .children[2].textContent
        ).toBe('Base');
        expect(
          document.getElementById('file_grid').querySelectorAll('.e-row')[1]
            .children[2].textContent
        ).toBe('Documents');
        done();
      }, 400);
    ...
    it('for sorting - Descending value', (done) => {
      ...
      setTimeout(function () {
        ...
        expect(
          document
            .getElementById('file_ddl_descending')
            .children[0].classList.contains('e-fe-tick')
        ).toBe(true);
        expect(
          document.getElementById('file_grid').querySelectorAll('.e-row').length
        ...
        expect(
          document.getElementById('file_grid').querySelectorAll('.e-row')[2]
            .children[2].textContent
        ).toBe('Base');
        done();
      }, 400);
  ...
  describe('popupTarget property testing', () => {
    ...
    it('for BeforeOpen cancel testing', () => {
      name = 'Create Folder';
      feObj.beforePopupOpen = (args: BeforePopupOpenCloseEventArgs) => {
        args.cancel = true;
        j++;
        target = args.popupModule.target;
      };
    ...
    it('for upload and for Upload retry', (done) => {
      name = 'Upload';
      expect(
        (<any>feObj.detailsviewModule.gridObj.contentModule).rows.length
      ).toBe(6);
    ...
    it('for details', (done: Function) => {
      ...
      expect(target).not.toBe('#' + feObj.element.id);
      setTimeout(function () {
        expect(document.getElementById('file_dialog_title').textContent).toBe(
          'Downloads'
        );
        expect(
          (<any>document.querySelectorAll('.e-fe-value')[0]).textContent
        ).toBe('Folder');
    ...
    it('for Extension', () => {
      ...
      items[0].click();
      let ntr: any = document
        .getElementById('file_grid')
        .querySelectorAll('.e-rowcell.e-rowcell.e-fe-grid-name');
      ...
      (<HTMLElement>(
        document.getElementById('file_dialog').querySelectorAll('.e-btn')[1]
      )).click();
      let item: any = document
    ...
    it('for continous multiple dialogs', (done) => {
      ...
      setTimeout(function () {
        ...
        expect(ntr.length).toEqual(3);
        expect(ntr[1].textContent).toBe('Adam.png');
        (<HTMLInputElement>document.getElementById('rename')).value =
          'Adam.pnga';
        name = 'Extension Change';
        item = document
          .getElementById('file_dialog')
