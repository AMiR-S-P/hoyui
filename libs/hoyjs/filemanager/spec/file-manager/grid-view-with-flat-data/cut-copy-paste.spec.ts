  ...
  describe('Cut Copy Paste testing', () => {
    ...
    it('Toolbar file cut paste testing with rename files', (done) => {
      ...
      setTimeout(function () {
        ...
        (<HTMLElement>document.getElementsByClassName('e-fe-cut')[0]).click();
        (<HTMLElement>(
          document.getElementsByClassName('e-address-list-item')[0]
            .firstElementChild
        )).click();
        setTimeout(function () {
          feObj.detailsviewModule.gridObj.element
          ...
          setTimeout(function () {
            ...
            setTimeout(function () {
              (<HTMLElement>(
                document.querySelector('.e-fe-popup.e-btn.e-primary')
              )).click();
              setTimeout(function () {
                expect(feObj.detailsviewModule.gridObj.getRows().length).toBe(
                  6
                );
                done();
              }, 500);
    ...
    it('Toolbar file details with rootAliasName', (done) => {
      ...
      setTimeout(function () {
        ...
        (
          (<HTMLElement>(
            document.querySelectorAll('#file_dialog_dialog-content tr')[2]
              .firstChild
    ...
    it('Toolbar folder create', (done) => {
      expect(feObj.detailsviewModule.gridObj.getRows().length).toBe(2);
      feObj.createFolder();
      (<any>document.querySelector('.e-fe-popup .e-input')).value =
        'New folder';
      (<HTMLElement>(
        document.querySelector('.e-fe-popup.e-btn.e-primary')
      )).click();
    ...
    it('Toolbar file copy paste testing with access details', (done) => {
      ...
      feObj.fileSystemData.filter(
        (file: any) => file.name === 'Downloads'
