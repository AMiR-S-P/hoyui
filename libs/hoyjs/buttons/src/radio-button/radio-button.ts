  ...
  implements INotifyPropertyChanged
{
  ...
  private getRadioGroup(): NodeListOf<Element> {
    return document.querySelectorAll(
      'input.e-radio[name="' + this.element.getAttribute('name') + '"]'
    );
  }
  ...
  private initWrapper(): void {
    ...
    const label: HTMLElement = this.createElement('label', {
  ...
  public onPropertyChanged(
    newProp: RadioButtonModel,
    oldProp: RadioButtonModel
  ): void {
        ...
        case 'value':
          ...
          if (
            ...
            (this.htmlAttributes.value ||
              (type === 'boolean' && !this.htmlAttributes.value))
          ) {
            break;
          }
  ...
  protected preRender(): void {
    ...
    if (this.tagName === 'EJS-RADIOBUTTON') {
      const formControlName: string = this.element.getAttribute(
        'formcontrolname'
      ) as string;
      if (formControlName) {
