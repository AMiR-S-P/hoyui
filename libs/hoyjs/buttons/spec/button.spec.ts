...
describe('Button', () => {
  ...
  describe('DOM', () => {
    ...
    it('Content testing', () => {
      button = new Button(
        {
          content:
            '<span class="e-icons e-btn-icon e-add-icon e-icon-left"></span>Button',
        },
        '#button'
      );
    ...
    it('Content and IconCss Testing', () => {
      button = new Button(
        { content: 'Button', iconCss: 'e-icons e-add-icon' },
        '#button'
      );
      expect(element.childNodes[0].nodeName).toEqual('SPAN');
      expect(element.textContent).toEqual('Button');
  ...
  describe('Property', () => {
    ...
    it('Enable Html Sanitizer testing', () => {
      button = new Button(
        { content: 'Button<style>body{background:rgb(0, 0, 255)}</style>' },
        '#button'
      );
      const htmlele: Element = document.body;
      expect(button.content).toEqual(
        'Button<style>body{background:rgb(0, 0, 255)}</style>'
      );
    ...
    it('Enable Html Sanitizer disabled testing', () => {
      button = new Button(
        {
          content: '<style>body{background:rgb(0, 0, 255)}</style>',
  ...
  describe('notify property changes of', () => {
    ...
    it('IconPosition right in onPropertyChanged', () => {
      ...
      button.dataBind();
      expect(element.textContent).toEqual('Button');
      expect(element.children[0].classList.contains('icon-right')).toEqual(
        true
      );
      expect(element.children[0].classList.contains('e-icon-right')).toEqual(
        true
      );
    });
