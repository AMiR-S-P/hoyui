...
describe('Speed Dial', () => {
  ...
  describe('Null or Undefined value', () => {
    ...
    beforeEach(() => {
      ...
      tarEle = createElement('div', {
        id: 'speedDialtarget',
        styles:
          'margin:10px;border:1px solid red; height:400px; width:400px; position: relative;',
      });
  ...
  describe('SpeedDial button DOM', () => {
    ...
    it('openicon + closeicon', () => {
      speedDial = new SpeedDial({
        openIconCss: 'open-icon',
        closeIconCss: 'close-icon',
      });
      speedDial.appendTo('#speedDial');
    ...
    it('disabled', () => {
      ...
      speedDial.appendTo('#speedDial');
      expect(isNullOrUndefined(speedDialEle.getAttribute('disabled'))).toBe(
        false
      );
  ...
  describe('SpeedDial DOM', () => {
    ...
    it('default classes with target as wrong selector', () => {
      ...
      expect(speedDialEle.classList.contains('e-fab-fixed')).toEqual(true);
      expect(
        (speedDial as any).popupEle.classList.contains('e-speeddial-fixed')
      ).toBe(true);
      expect(tarEle.querySelector('.e-speeddial') === null).toEqual(true);
      expect(tarEle.querySelector('.e-speeddial-popup') === null).toEqual(true);
      expect(document.querySelector('.e-speeddial-popup') === null).toEqual(
        false
      );
    });
    ...
    it('speeddial with popup template', () => {
      ...
      expect(isNullOrUndefined((speedDial as any).popupEle)).toEqual(false);
      expect(
        (speedDial as any).popupEle.classList.contains('e-speeddial-template')
      ).toBe(true);
      expect(document.querySelector('.e-speeddial-popup') === null).toEqual(
        false
      );
      ...
      let tempContent =
        '<div class="e-speeddial-template-container">' + template + '</div>';
      expect(document.querySelector('.e-speeddial-popup').innerHTML).toBe(
        tempContent
      );
    });
    it('template as HTMLElement ', () => {
      let template = '<span class="tempContent">Hello World!</span>';
      let tempContent = createElement('div', {
        id: 'fabTemp',
        className: 'tempContent',
        innerHTML: template,
      });
      ...
      expect(document.querySelector('.tempContent') === null).toEqual(false);
      let tempContent1 =
        '<div class="e-speeddial-template-container">' +
      ...
      speedDial.dataBind();
      let tempContent2 =
        '<div class="e-speeddial-template-container">' + '#fabtemp1' + '</div>';
      expect(document.querySelector('.e-speeddial-popup').innerHTML).toBe(
        tempContent2
      );
      remove(tempContent);
    ...
    it('template as js renderer ', () => {
      let template = '<span class="tempContent">Hello World!</span>';
      let renderer = createElement('script', {
        id: 'fabTemp',
        innerHTML: template,
      });
    ...
    it('speeddial with aria-attributes', () => {
      ...
      expect(
        (
          (speedDial as any).popupEle.querySelector(
            '.e-speeddial-ul'
          ) as HTMLElement
        ).getAttribute('role')
      ).toBe('menu');
      ...
      expect(speedDialEle.getAttribute('aria-controls')).toBe(
        (speedDial as any).popupEle.id
      );
      expect(
        (
          (speedDial as any).popupEle.querySelector(
      ...
      speedDial.destroy();
      expect(
        isNullOrUndefined(speedDialEle.getAttribute('aria-haspopup'))
      ).toBe(true);
      expect(
        isNullOrUndefined(speedDialEle.getAttribute('aria-expanded'))
      ).toBe(true);
      expect(
        isNullOrUndefined(speedDialEle.getAttribute('aria-controls'))
      ).toBe(true);
      speedDial = new SpeedDial({ items: data, animation: NoAnimation });
      speedDial.appendTo('#speedDial');
    });
    ...
    it('speeddial with item props', () => {
      ...
      expect(
        (
          (speedDial as any).popupEle.querySelectorAll(
            '.e-speeddial-li'
          )[1] as HTMLElement
        ).getAttribute('aria-label')
      ).toBe(null);
      ...
      expect(
        (speedDial as any).popupEle
          .querySelectorAll('.e-speeddial-li')[1]
          .querySelector('.e-speeddial-li-text') === null
      ).toBe(true);
      expect(
        (speedDial as any).popupEle
          .querySelectorAll('.e-speeddial-li')[1]
          .querySelector('.e-speeddial-li-icon') === null
      ).toBe(false);
      expect(
        (speedDial as any).popupEle
          .querySelectorAll('.e-speeddial-li')[3]
          .querySelector('.e-speeddial-li-text') === null
      ).toBe(false);
      expect(
        (speedDial as any).popupEle
      ...
      expect(
        (speedDial as any).popupEle
          .querySelectorAll('.e-speeddial-li')[3]
          .classList.contains('e-speeddial-text-li')
      ).toBe(true);
      expect(
        (
          (speedDial as any).popupEle.querySelectorAll(
    ...
    it('speeddial with text only items', () => {
      ...
      expect(
        (speedDial as any).popupEle.querySelectorAll('.e-speeddial-text-li')
          .length
      ).toBe(5);
    });
    ...
    it('speeddial with itemTemplate', () => {
      let template =
        ...
        ' <div class="empimg"> <span class="icon' +
        ' ' +
        ' ${iconCss}"> </span> </div>' +
      ...
      speedDialEle.click();
      expect(
        (speedDial as any).popupEle.querySelector('.e-speeddial-li-text') ===
          null
      ).toBe(true);
      expect(
        (speedDial as any).popupEle.querySelector('.e-speeddial-li-icon') ===
          null
      ).toBe(true);
      expect(
        (speedDial as any).popupEle.querySelectorAll('.empimg').length
      ).toBe(5);
      expect(
        (speedDial as any).popupEle.querySelectorAll('span.text').length
      ).toBe(5);
    });
    ...
    it('default classes without target', () => {
      ...
      expect(
        (speedDial as any).popupEle.classList.contains('e-speeddial-popup')
      ).toEqual(true);
      expect(
        (speedDial as any).popupEle.classList.contains('e-speeddial-hidden')
      ).toEqual(true);
      expect(document.querySelector('.e-speeddial-popup') === null).toEqual(
        false
      );
      expect(document.querySelector('.e-speeddial-overlay') === null).toEqual(
        false
      );
      expect(tarEle.querySelector('.e-speeddial-popup') === null).toEqual(true);
      expect(tarEle.querySelector('.e-speeddial-overlay') === null).toEqual(
        true
      );
    });
    ...
    it('default classes with target', () => {
      ...
      expect(tarEle.querySelector('.e-speeddial-popup') === null).toEqual(
        false
      );
      expect(tarEle.querySelector('.e-speeddial-overlay') === null).toEqual(
        false
    ...
    it('default classes on different modes + template + opensonhover', () => {
      ...
      expect(popupEle.classList.contains('e-speeddial-hover-open')).toEqual(
        true
      );
      ...
      expect(popupEle.classList.contains('e-speeddial-template')).toEqual(
        false
      );
    ...
    it('cssClass', () => {
      ...
      speedDial.appendTo('#speedDial');
      expect(tarEle.querySelector('.e-speeddial-popup').classList).toContain(
        'testClass'
      );
      expect(tarEle.querySelector('.e-speeddial-overlay').classList).toContain(
        'testClass'
      );
      speedDial.cssClass = 'NewClass';
      speedDial.dataBind();
      ...
      expect(
        tarEle
          .querySelector('.e-speeddial-popup')
          .classList.contains('testClass')
      ).toBe(false);
      expect(
        tarEle
          .querySelector('.e-speeddial-overlay')
          .classList.contains('testClass')
      ).toBe(false);
      speedDial.cssClass = '';
      speedDial.dataBind();
    ...
    it('open action without overlay', () => {
      ...
      expect(
        tarEle
          .querySelector('.e-speeddial-popup')
          .classList.contains('e-speeddial-hidden')
      ).toBe(false);
      expect(tarEle.querySelector('.e-speeddial-overlay')).toBeNull;
    ...
    it('target Change with overlay', () => {
      ...
      expect(tarEle.querySelector('.e-speeddial-popup') === null).toBe(true);
      expect(document.querySelector('.e-speeddial-popup') !== null).toBe(true);
      expect(document.querySelector('.e-speeddial-overlay') !== null).toBe(
        true
      );
      speedDial.target = '#speedDialtarget';
      speedDial.dataBind();
    ...
    it('speeddial with popup template and dyanmic properties', () => {
      ...
      speedDial.itemTemplate =
        '<span class="tempContent">Hello World! ${text} </span>';
      speedDial.popupTemplate =
        '<span class="tempContent">Hello Syncfusion!</span>';
      speedDial.dataBind();
      expect(popupEle.classList.contains('e-speeddial-left')).toBe(true);
      expect(popupEle.classList.contains('e-speeddial-top')).toBe(false);
      expect(popupEle.classList.contains('e-speeddial-right')).toBe(false);
    ...
    it('speeddial with dyanmic popup Template', () => {
      ...
      expect(
        (speedDial as any).popupEle.classList.contains('e-speeddial-linear')
      ).toBe(true);
      let popupEle = (speedDial as any).popupEle as HTMLElement;
      expect(popupEle.classList.contains('e-speeddial-left')).toBe(false);
      expect(popupEle.classList.contains('e-speeddial-top')).toBe(false);
  ...
  describe('Methods and Events', () => {
    ...
    it('open/hide with method', () => {
      ...
      expect(
        tarEle.querySelector('.e-speeddial-popup').getAttribute('tabindex')
      ).toBe(null);
      speedDial.show();
      expect(
        tarEle.querySelector('.e-speeddial-popup').getAttribute('tabindex')
    ...
    it('All events', () => {
      ...
      speedDialEle.click();
      (speedDial as any).popupEle
        .querySelectorAll('.e-speeddial-li')[0]
        .click();
      (speedDial as any).popupEle
        .querySelectorAll('.e-speeddial-li')[1]
        .click();
      (speedDial as any).popupEle
        .querySelectorAll('.e-speeddial-li')[2]
        .click();
      (speedDial as any).popupEle
        .querySelectorAll('.e-speeddial-li')[3]
        .click();
  ...
  describe('Keyboard Actions', () => {
    ...
    it('Enter Key', () => {
      ...
      expect(
        popupEle
          .querySelectorAll('.e-speeddial-li')[0]
          .classList.contains('e-speeddial-li-active')
      ).toBe(true);
      keyboardEventArgs.action = 'enter';
      (speedDial as any).keyActionHandler(keyboardEventArgs);
      expect(isClicked).toBe(true);
    ...
    it('end + home keys', () => {
      ...
      expect(
        popupEle
          .querySelectorAll('.e-speeddial-li')[4]
          .classList.contains('e-speeddial-li-active')
      ).toBe(true);
      keyboardEventArgs.action = 'home';
      (speedDial as any).keyActionHandler(keyboardEventArgs);
      ...
      (speedDial as any).keyActionHandler(keyboardEventArgs);
      expect(
        popupEle.querySelectorAll('e-speeddial-li-active').length === 0
      ).toBe(true);
      keyboardEventArgs.action = 'home';
      (speedDial as any).keyActionHandler(keyboardEventArgs);
      expect(
  ...
  describe('Keyboard Navigation + Radial', () => {
    ...
    it('TopLeft + Clockwise', () => {
      speedDial = new SpeedDial({
        ...
        target: '#speedDialtarget',
        animation: NoAnimation,
        radialSettings: { direction: 'Clockwise' },
      });
      speedDial.appendTo('#speedDial');
      let popupEle = (speedDial as any).popupEle;
      expect(popupEle.classList.contains('e-speeddial-hidden')).toBe(true);
  ...
  describe('position and direction', () => {
    ...
    function getBottom(
      ...
      return (
        tarEle.clientHeight -
        btnEle.offsetTop -
        (isVertical ? 0 : btnEle.offsetHeight) +
        'px'
      );
    }
    function getMidddleCenterUp(
      btnEle: HTMLElement,
      tarEle: HTMLElement,
      isVertical: boolean = true
    ): string {
    ...
    function getHorizontalAlignCenter(
      btnEle: HTMLElement,
      tarEle: HTMLElement,
      isVertical: boolean = true
    ): string {
    ...
    function getVerticalAlignCenter(
      btnEle: HTMLElement,
      tarEle: HTMLElement,
      isVertical: boolean = true
    ): string {
      return (
        btnEle.offsetTop +
        (isVertical ? btnEle.offsetHeight : 0) -
        btnEle.offsetHeight / 2 +
        'px'
      );
    }
    function getHorizontalRightPosition(
      btnEle: HTMLElement,
      tarEle: HTMLElement,
      isVertical: boolean = true
    ): string {
    ...
    function getHorizontalLeftPosition(
      btnEle: HTMLElement,
      tarEle: HTMLElement,
      isVertical: boolean = true
    ): string {
      return (
        tarEle.clientHeight -
        btnEle.offsetLeft -
        (isVertical ? btnEle.offsetWidth : 0) +
        btnEle.offsetWidth / 2 +
        'px'
      );
    }
    function getUpDirectionPos(
      btnEle: HTMLElement,
      tarEle: HTMLElement,
      isVertical: boolean = true
    ): string {
    ...
    function getWinMiddleTop(
      btnEle: HTMLElement,
      isVertical: boolean = true
    ): string {
      return btnEle.offsetTop - btnEle.offsetHeight / 2 + 'px';
    }
    function getWinMiddleDown(
      btnEle: HTMLElement,
      isVertical: boolean = true
    ): string {
      return (
    ...
    function getWinMiddleLeft(
      btnEle: HTMLElement,
      isVertical: boolean = true
    ): string {
      return (
        btnEle.offsetLeft +
        (isVertical ? 0 : btnEle.offsetWidth) +
        btnEle.offsetWidth / 2 +
        'px'
      );
    }
    function getWinRight(
      btnEle: HTMLElement,
      isVertical: boolean = true
    ): string {
      return (
    ...
    function getWinHorizontalCenter(
      btnEle: HTMLElement,
      isVertical: boolean = true
    ): string {
      return btnEle.offsetLeft - btnEle.offsetWidth / 2 + 'px';
    }
    function getWinHorizontalCenterRight(
      btnEle: HTMLElement,
      isVertical: boolean = true
    ): string {
      return btnEle.offsetLeft + btnEle.offsetWidth / 2 + 'px';
    ...
    it('All Direction + TopCenter without target', () => {
      ...
      LeftPos =
        window.document.documentElement.scrollWidth -
        speedDialEle.offsetLeft +
        speedDialEle.offsetWidth / 2 +
        'px';
      TopPos = getWinTop(speedDialEle, false);
      expect(popupEle.style.getPropertyValue('--speeddialHorzDist')).toBe(
        LeftPos
    ...
    it('All Direction + BottomRight', () => {
      ...
      RightPos = getRight(speedDialEle, tarEle, false);
      BottomPos = getBottom(speedDialEle, tarEle, false);
      expect(popupEle.classList.contains('e-speeddial-vert-bottom')).toBe(
        false
      );
      expect(popupEle.style.getPropertyValue('--speeddialHorzDist')).toBe(
        RightPos
    ...
    it('position Change Default + Top', () => {
      speedDial = new SpeedDial({
        items: data,
        target: '#speedDialtarget',
        position: FabPosition.MiddleLeft,
      });
      speedDial.appendTo('#speedDial');
      let popupEle = (speedDial as any).popupEle as HTMLElement;
  ...
  describe('PopupTemplate position', () => {
    ...
    beforeAll(() => {
      ...
      let styleEle: HTMLElement = createElement('style');
      styleEle.append(
        'body{margin:0;} .tempClass{display:none;} .e-speeddial-popup .tempClass{display:block;}'
      );
      append([styleEle], document.body);
    });
    beforeEach(() => {
      ...
      tempEle = createElement('div', {
        id: 'speedDialPopupTemp',
        className: 'tempClass',
        styles: 'border:2px solid greenYellow; height:200px; width:150px',
        innerHTML:
          "<span styles='font-size:20px; text-align:center;'>Hello <br/> World!!</span>",
      });
    ...
    it('popupTemplate + Top', () => {
      speedDial = new SpeedDial({
        popupTemplate: '#speedDialPopupTemp',
        position: 'TopLeft',
      });
      speedDial.appendTo('#speedDial');
      let popupEle = (speedDial as any).popupEle as HTMLElement;
  ...
  describe('Radial Mode items position', () => {
    ...
    it('RadialMode + TopLeft', () => {
      ...
      expect(popupEle.classList.contains('e-speeddial-bottom-right')).toBe(
        false
      );
      expect(popupEle.classList.contains('e-speeddial-bottom-left')).toBe(
        false
      );
      speedDial.opensOnHover = false;
      speedDial.dataBind();
      ...
      for (let index = 0; index < li.length; index++) {
        ...
        expect(element.style.getPropertyValue('--speeddialRadialAngle')).toBe(
          90 - 30 * index + 'deg'
        );
      }
      ...
      speedDial.dataBind();
      expect(
        (li[0] as HTMLElement).style.getPropertyValue('--speeddialRadialAngle')
      ).toBe('90deg');
  ...
  describe('Radial Mode props +  Combination test', () => {
    ...
    it('RadialMode props + icon data', () => {
      ...
      expect(
        popupEle.style.getPropertyValue('--speeddialRadialMinHeight')
      ).toBe(height);
      expect(popupEle.style.getPropertyValue('--speeddialRadialMinWidth')).toBe(
        width
      );
      for (let index = 0; index < li.length; index++) {
        const element = li[index] as HTMLElement;
