...
import { createElement, attributes } from '@hoyui/base';
...
describe('Switch', () => {
  ...
  describe('DOM', () => {
    ...
    it('Normal Switch', () => {
      ...
      expect(
        element.parentElement.classList.contains('e-switch-wrapper')
      ).toEqual(true);
      expect(element.parentElement.classList.contains('e-wrapper')).toEqual(
        true
      );
      expect(
        element.parentElement.children[1].classList.contains('e-switch-inner')
      ).toEqual(true);
      expect(
        element.parentElement.children[1].children[0].classList.contains(
          'e-switch-on'
        )
      ).toEqual(true);
      expect(
        element.parentElement.children[1].children[1].classList.contains(
          'e-switch-off'
        )
      ).toEqual(true);
      expect(
        element.parentElement.children[2].classList.contains('e-switch-handle')
      ).toEqual(true);
    });
    ...
    it('Switch with checked state', () => {
      ...
      expect(
        element.parentElement.children[1].classList.contains('e-switch-active')
      ).toEqual(true);
      expect(
        element.parentElement.children[2].classList.contains('e-switch-active')
      ).toEqual(true);
    });
    it('Switch with disabled state', () => {
      ...
      expect(
        element.parentElement.classList.contains('e-switch-disabled')
      ).toEqual(true);
    });
  ...
  describe('Notify property Changes', () => {
    ...
    it('onLabel checking', () => {
      ...
      specSwitch.dataBind();
      expect(specSwitch.onLabel).toEqual('ON');
      expect(element.parentElement.children[1].children[0].textContent).toEqual(
        'ON'
      );
    });
    it('offLabel checking', () => {
      ...
      expect(element.parentElement.children[1].children[1].textContent).toEqual(
        'NO'
      );
    });
    it('Switch with checked state', () => {
    ...
    it('Switch with cssClass', () => {
      ...
      expect(element.parentElement.classList.contains('customCSS')).toEqual(
        true
      );
      specSwitch.cssClass = 'newClass';
      specSwitch.dataBind();
      expect(element.parentElement.classList.contains('newClass')).toEqual(
        true
      );
    });
  });
  describe('Notify Html Attributes property changes of', () => {
    ...
    it('Switch with Class', () => {
      specSwitch = new Switch(
        { htmlAttributes: { class: 'e-switch-syncfusion' } },
        '#specSwitch'
      );
      expect(
        element.parentElement.classList.contains('e-switch-syncfusion')
      ).toEqual(true);
      specSwitch.htmlAttributes = { class: 'e-new-switch' };
      specSwitch.dataBind();
      expect(element.parentElement.classList.contains('e-new-switch')).toEqual(
        true
      );
    });
    ...
    it('Switch with Title', () => {
      specSwitch = new Switch(
        { htmlAttributes: { title: 'ejswitch' } },
        '#specSwitch'
      );
      expect(
        element.parentElement.getAttribute('title').indexOf('ejswitch')
      ).toEqual(0);
      specSwitch.htmlAttributes = { title: 'e-new-switch' };
      specSwitch.dataBind();
      expect(
        element.parentElement.getAttribute('title').indexOf('e-new-switch')
      ).toEqual(0);
    });
  ...
  describe('Methods test', () => {
    ...
    it('Keyboard Event', () => {
      ...
      expect(element.parentElement.classList.contains('e-focus')).toEqual(
        false
      );
    });
    ...
    it('Pre render method', () => {
      document.body.appendChild(
        createElement('EJS-SWITCH', { id: 'ngswitch' })
      );
      specSwitch = new Switch({}, '#ngswitch');
      expect(specSwitch.element.parentElement.tagName).toEqual('EJS-SWITCH');
      expect(specSwitch.element.parentElement.children[0].tagName).toEqual(
        'INPUT'
      );
      specSwitch.destroy();
