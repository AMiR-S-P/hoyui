...
import { enableRipple } from '@hoyui/base';
...
describe('RadioButton', () => {
  ...
  describe('DOM', () => {
    ...
    it('RadioButton Testing With State', () => {
      ...
      expect(
        element.parentElement.classList.contains('e-radio-wrapper')
      ).toEqual(true);
    });
    ...
    it('RadioButton with Label', () => {
      ...
      expect(
        element.nextElementSibling.children[0].classList.contains('e-label')
      ).toEqual(true);
      expect(element.nextElementSibling.children[0].textContent).toEqual(
        'radiobutton'
      );
    });
    ...
    it('RadioButton with RTL', () => {
      ...
      expect(element.nextElementSibling.classList.contains('e-rtl')).toEqual(
        true
      );
    });
    ...
    it('RadioButton with labelPosition', () => {
      radio = new RadioButton(
        { label: 'RadioButton', labelPosition: 'Before' },
        '#radio'
      );
  ...
  describe('Property', () => {
    ...
    it('Enable Html Attributes testing', () => {
      radio = new RadioButton(
        {
          htmlAttributes: { title: 'Choose Option' },
          label: '<style>body{background:rgb(0, 0, 255)}</style>',
        },
        '#radio'
      );
  ...
  describe('Notify property changes of', () => {
    ...
    it('RadioButton with labelPosition', () => {
      ...
      radio.dataBind();
      expect(
        element.parentElement.children[1].classList.contains('e-right')
      ).toEqual(true);
  ...
  describe('Methods', () => {
    ...
    it('Keyboard Event', () => {
      ...
      radio.focusHandler();
      radio.keyUpHandler();
      expect(element.nextElementSibling.classList.contains('e-focus')).toEqual(
        true
      );
    ...
    it('Mouse Event', () => {
      ...
      expect(
        element.parentElement.children[0].classList.contains(
          'e-ripple-container'
        )
      ).toEqual(false);
    });
    ...
    it('Pre render method', () => {
      ...
      radio.element.click();
      radio.destroy();
      expect(document.getElementById('ngradiobutton').tagName).toBe(
        'EJS-RADIOBUTTON'
      );
      radio = new RadioButton(
        {},
    ...
    it('getSelectedValue method', () => {
      document.body.appendChild(
        createElement('input', { id: 'group1', attrs: { type: 'radio' } })
      );
      document.body.appendChild(
        createElement('input', { id: 'group2', attrs: { type: 'radio' } })
      );
    ...
    it('HtmlAttributes property not working properly in RadioButton', () => {
      ...
      expect(
        radio.element.parentElement
          .getAttribute('data-containerid')
          .indexOf('error-agreement')
      ).toEqual(0);
      expect(
        radio.element.parentElement.getAttribute('test').indexOf('test')
      ).toEqual(0);
    });
  });
