...
} from '../src/chips/index';
import { createElement, extend } from '@hoyui/base';
...
let jsonArray: ChipModel[] = [
  { text: 'chip1' },
  { text: 'chip2' },
  { text: 'chip3' },
];
let jsonArrayValue: ChipModel[] = [
  { text: 'chip1', value: '11' },
  { text: 'chip2', value: '22' },
  { text: 'chip3', value: '33' },
];
  ...
  describe('DOM Structure', () => {
    describe('Chip component (single)', () => {
      ...
      it('Chip component - leadingicon Element', () => {
        chips = new ChipList(
          { text: 'chip content', leadingIconCss: 'icon' },
          '#chip'
        );
        expect(element.children.length).toBe(2);
        expect(element.classList.contains('e-chip-icon-wrap')).toBe(true);
        let leadingIconElement: HTMLElement = element
      ...
      it('Chip component - trailingicon Element', () => {
        chips = new ChipList(
          { text: 'chip content', trailingIconCss: 'icon' },
          '#chip'
        );
        expect(element.children.length).toBe(2);
      ...
      it('Chip component - combined', () => {
        ...
        expect(element.children[0].classList.contains('e-chip-avatar')).toBe(
          true
        );
        expect(element.children[1].classList.contains('e-chip-text')).toBe(
          true
        );
        expect(element.children[2].classList.contains('e-chip-delete')).toBe(
          true
        );
      });
      ...
      it('Chip component - combined without avatar', () => {
        ...
        expect(element.children[0].classList.contains('e-chip-icon')).toBe(
          true
        );
        expect(element.children[1].classList.contains('e-chip-text')).toBe(
          true
    ...
    describe('ChipList component (set)', () => {
      ...
      it('Chip component - class', () => {
        ...
        expect(element.classList.contains('e-chip')).toBe(false);
        expect(element.classList.contains('e-chip-set')).toBe(true);
        let chipCollection: HTMLElement[] = Array.prototype.slice.call(
          element.querySelectorAll('.e-chip')
        );
      ...
      it('Chip component - Text Element', () => {
        ...
        let firstChipTextElement: HTMLElement = chipCollection[0]
          .children[0] as HTMLElement;
        expect(firstChipTextElement.tagName).toBe('SPAN');
        expect(firstChipTextElement.classList.contains('e-chip-text')).toBe(
          true
        );
      ...
      it('Chip component - leadingicon Element', () => {
        chips = new ChipList(
          { chips: stringArray.slice(), leadingIconCss: 'icon' },
          '#chip'
        );
        let chipCollection: HTMLElement[] = Array.prototype.slice.call(
          element.querySelectorAll('.e-chip')
        ...
        expect(chipCollection[0].classList.contains('e-chip-icon-wrap')).toBe(
          true
        );
        let leadingIconElement: HTMLElement = chipCollection[0]
          .children[0] as HTMLElement;
        expect(leadingIconElement.tagName).toBe('SPAN');
        expect(leadingIconElement.classList.contains('e-chip-icon')).toBe(true);
        expect(leadingIconElement.classList.contains('icon')).toBe(true);
      ...
      it('Chip component - Avatar Element', () => {
        ...
        expect(chipCollection[0].children.length).toBe(2);
        expect(chipCollection[0].classList.contains('e-chip-avatar-wrap')).toBe(
          true
        );
        let avatarElement: HTMLElement = chipCollection[0]
          .children[0] as HTMLElement;
        expect(avatarElement.tagName).toBe('SPAN');
        expect(avatarElement.classList.contains('e-chip-avatar')).toBe(true);
        expect(avatarElement.classList.contains('avatar')).toBe(true);
      ...
      it('Chip component - trailingicon Element', () => {
        chips = new ChipList(
          { chips: stringArray.slice(), trailingIconCss: 'icon' },
          '#chip'
        );
        let chipCollection: HTMLElement[] = Array.prototype.slice.call(
          element.querySelectorAll('.e-chip')
        ...
        expect(chipCollection[0].children.length).toBe(2);
        let trailingicon: HTMLElement = chipCollection[0]
      ...
      it('Chip component - combined', () => {
        ...
        expect(
          chipCollection[0].children[0].classList.contains('e-chip-avatar')
        ).toBe(true);
        expect(
          chipCollection[0].children[1].classList.contains('e-chip-text')
        ).toBe(true);
        expect(
          chipCollection[0].children[2].classList.contains('e-chip-delete')
        ).toBe(true);
      });
      ...
      it('Chip component - combined without avatar', () => {
        ...
        expect(
          chipCollection[0].children[0].classList.contains('e-chip-icon')
        ).toBe(true);
        expect(
          chipCollection[0].children[1].classList.contains('e-chip-text')
        ).toBe(true);
  ...
  describe('chips property', () => {
    describe('chip(single) - property', () => {
      ...
      it('Chip component - avatarIconCss', () => {
        chips = new ChipList(
          { text: 'chip content', avatarIconCss: 'avataricon icon1' },
          '#chip'
        );
        let avatarIconelement: HTMLElement =
          element.querySelector('.e-chip-avatar');
      ...
      it('Chip component - avatarText', () => {
        chips = new ChipList(
          {
            text: 'chip content',
            avatarIconCss: 'avataricon icon1',
            avatarText: 'MR',
          },
          '#chip'
        );
      ...
      it('Chip component - leadingIconCss', () => {
        chips = new ChipList(
          { text: 'chip content', leadingIconCss: 'leadingicon icon1' },
          '#chip'
        );
        let leadingIconelement: HTMLElement =
          element.querySelector('.e-chip-icon');
        ...
        expect(leadingIconelement.classList.contains('leadingicon3')).toBe(
          true
        );
        expect(leadingIconelement.classList.contains('io')).toBe(true);
        expect(leadingIconelement.classList.contains('leadingicon')).toBe(
          false
        );
      ...
      it('Chip component - trailingIconCss', () => {
        chips = new ChipList(
          { text: 'chip content', trailingIconCss: 'trailingicon icon1' },
          '#chip'
        );
        let trailingIconelement: HTMLElement =
          element.querySelector('.e-chip-delete');
        expect(trailingIconelement.classList.contains('trailingicon')).toBe(
          true
        );
        ...
        expect(trailingIconelement.classList.contains('trailingicon3')).toBe(
          true
        );
      ...
      it('Chip component - iconCss', () => {
        chips = new ChipList(
          { text: 'chip content', cssClass: 'iconcss icon1' },
          '#chip'
        );
      ...
      it('Chip component - enableRTL', () => {
        chips = new ChipList(
          { text: 'chip content', enableRtl: true },
          '#chip'
        );
      ...
      it('Chip component - enableDelete should not work', () => {
        chips = new ChipList(
          { text: 'chip content', enableDelete: true },
          '#chip'
        );
      ...
      it('Chip component - selection(Single) should not work', () => {
        chips = new ChipList(
          { text: 'chip content', selection: 'Single' },
          '#chip'
        );
      ...
      it('Chip component - selection(Multiple) should not work', () => {
        chips = new ChipList(
          { text: 'chip content', selection: 'Multiple' },
          '#chip'
        );
        expect(element.getAttribute('aria-multiselectable')).toBe(null);
        fireEvent(element, 'click');
      ...
      it('Chip component - selectedChips should not work', () => {
        chips = new ChipList(
          { text: 'chip content', selection: 'Single', selectedChips: 0 },
          '#chip'
        );
        expect(element.getAttribute('aria-multiselectable')).toBe(null);
        let activeElement: HTMLElement = element.querySelector('.e-active');
      ...
      it('Chip component - enablePersistance', () => {
        chips = new ChipList(
          { text: 'chip content', enablePersistence: true },
          '#chip'
        );
      });
    });
    describe('chiplist(set) - property', () => {
      ...
      it('Chip component - text', () => {
        chips = new ChipList(
          { text: 'chip content', chips: deepCloning(jsonArray) },
          '#chip'
        );
        let chipCollection: HTMLElement[] = Array.prototype.slice.call(
          element.querySelectorAll('.e-chip')
        ...
        chips.dataBind();
        chipCollection = Array.prototype.slice.call(
          element.querySelectorAll('.e-chip')
        );
      ...
      it('Chip component - avatarIconCss (common)', () => {
        ...
        let avatarIconelement: HTMLElement =
          chipCollection[0].querySelector('.e-chip-avatar');
        expect(avatarIconelement.classList.contains('avataricon')).toBe(true);
        expect(avatarIconelement.classList.contains('icon1')).toBe(true);
        chips.avatarIconCss = 'avataricon3 io';
        chips.dataBind();
      ...
      it('Chip component - avatarIconCss (Json)', () => {
        let ds: ChipModel[] = [
          { text: 'chip1' },
          { text: 'chip2', avatarIconCss: 'avataricon2 icon2' },
        ];
        chips = new ChipList(
          { text: 'chip content', chips: ds, avatarIconCss: 'avataricon icon' },
          '#chip'
        );
        let chipCollection: HTMLElement[] = Array.prototype.slice.call(
          element.querySelectorAll('.e-chip')
        );
        let avatarIconelement1: HTMLElement =
          chipCollection[0].querySelector('.e-chip-avatar');
        let avatarIconelement2: HTMLElement =
          chipCollection[1].querySelector('.e-chip-avatar');
      ...
      it('Chip component - avatarText (Json)', () => {
        let ds: ChipModel[] = [
          ...
          {
            text: 'chip2',
            avatarIconCss: 'avataricon2 icon2',
            avatarText: 'AR',
          },
        ];
        chips = new ChipList(
      ...
      it('Chip component - leadingIconCss (common)', () => {
        chips = new ChipList(
          {
            text: 'chip content',
            chips: stringArray.slice(),
            leadingIconCss: 'leadingicon icon1',
          },
          '#chip'
        );
        let chipCollection: HTMLElement[] = Array.prototype.slice.call(
        ...
        let leadingIconelement: HTMLElement =
          chipCollection[0].querySelector('.e-chip-icon');
        expect(leadingIconelement.classList.contains('leadingicon')).toBe(true);
        expect(leadingIconelement.classList.contains('icon1')).toBe(true);
        chips.leadingIconCss = 'leadingicon3 io';
        chips.dataBind();
      ...
      it('Chip component - leadingIconCss (Json)', () => {
        let ds: ChipModel[] = [
          { text: 'chip1' },
          { text: 'chip2', leadingIconCss: 'leadingicon2 icon2' },
        ];
        chips = new ChipList(
          {
            text: 'chip content',
            chips: ds,
            leadingIconCss: 'leadingicon icon',
          },
          '#chip'
        );
        let chipCollection: HTMLElement[] = Array.prototype.slice.call(
        ...
        let leadingIconelement1: HTMLElement =
          chipCollection[0].querySelector('.e-chip-icon');
        let leadingIconelement2: HTMLElement =
          chipCollection[1].querySelector('.e-chip-icon');
        expect(leadingIconelement1.classList.contains('leadingicon')).toBe(
          true
        );
        expect(leadingIconelement1.classList.contains('icon')).toBe(true);
        expect(leadingIconelement2.classList.contains('leadingicon2')).toBe(
          true
        );
      ...
      it('Chip component - trailingIconCss (common)', () => {
        chips = new ChipList(
          {
            text: 'chip content',
            chips: stringArray.slice(),
            trailingIconCss: 'trailingicon icon1',
          },
          '#chip'
        );
        let chipCollection: HTMLElement[] = Array.prototype.slice.call(
        ...
        let trailingIconelement: HTMLElement =
          chipCollection[0].querySelector('.e-chip-delete');
        expect(trailingIconelement.classList.contains('trailingicon')).toBe(
          true
        );
        expect(trailingIconelement.classList.contains('icon1')).toBe(true);
      ...
      it('Chip component - trailingIconCss (Json)', () => {
        let ds: ChipModel[] = [
          { text: 'chip1' },
          { text: 'chip2', trailingIconCss: 'trailingicon2 icon2' },
        ];
        chips = new ChipList(
          {
            text: 'chip content',
            chips: ds,
            trailingIconCss: 'trailingicon icon',
          },
          '#chip'
        );
        let chipCollection: HTMLElement[] = Array.prototype.slice.call(
        ...
        let trailingIconelement1: HTMLElement =
          chipCollection[0].querySelector('.e-chip-delete');
        let trailingIconelement2: HTMLElement =
          chipCollection[1].querySelector('.e-chip-delete');
        expect(trailingIconelement1.classList.contains('trailingicon')).toBe(
          true
        );
        expect(trailingIconelement1.classList.contains('icon')).toBe(true);
        expect(trailingIconelement2.classList.contains('trailingicon2')).toBe(
          true
        );
      ...
      it('Chip component - cssClass (Json)', () => {
        let ds: ChipModel[] = [
          { text: 'chip1' },
          { text: 'chip2', cssClass: 'iconcss2 icon2' },
        ];
        chips = new ChipList(
          { text: 'chip content', chips: ds, cssClass: 'iconcss icon' },
          '#chip'
        );
        let chipCollection: HTMLElement[] = Array.prototype.slice.call(
          element.querySelectorAll('.e-chip')
      ...
      it('Chip component - enabled (common)', () => {
        chips = new ChipList(
          { text: 'chip content', chips: stringArray.slice(), enabled: false },
          '#chip'
        );
        let chipCollection: HTMLElement[] = Array.prototype.slice.call(
          element.querySelectorAll('.e-chip')
      ...
      it('Chip component - enabled (Json)', () => {
        let ds: ChipModel[] = [
          { text: 'chip1' },
          { text: 'chip2', enabled: true },
          { text: 'chip2', enabled: false },
        ];
        chips = new ChipList(
          { text: 'chip content', chips: ds, enabled: false },
          '#chip'
        );
        let chipCollection: HTMLElement[] = Array.prototype.slice.call(
          element.querySelectorAll('.e-chip')
      ...
      it('Chip component - enableRTL', () => {
        chips = new ChipList(
          { text: 'chip content', chips: stringArray.slice(), enableRtl: true },
          '#chip'
        );
        expect(element.classList.contains('e-rtl')).toBe(true);
        chips.enableRtl = false;
      ...
      it('Chip component - selection(Single)', () => {
        ...
        let activeElement: HTMLElement[] = Array.prototype.slice.call(
          element.querySelectorAll('.e-active')
        );
        expect(activeElement.length).toBe(1);
        expect(activeElement[0]).toBe(chipCollection[0]);
        fireEvent(chipCollection[1], 'click');
        activeElement = Array.prototype.slice.call(
          element.querySelectorAll('.e-active')
        );
        expect(activeElement.length).toBe(1);
      ...
      it('Chip component - selectedChips(Single)', () => {
        ...
        let resultantdata: SelectedItem =
          chips.getSelectedChips() as SelectedItem;
      ...
      it('Chip component - selectedChips(Multiple)', () => {
        ...
        expect(activeElement[0]).toBe(chipCollection[0]);
        expect(activeElement[1]).toBe(chipCollection[1]);
        let resultantdata: SelectedItems =
          chips.getSelectedChips() as SelectedItems;
  ...
  describe('chips APIs', () => {
    ...
    describe('chiplist(set)  - APIs', () => {
      ...
      it('Add method - string[] data', () => {
        ...
        expect(chipCollection[4].children[0].classList.contains('avatar')).toBe(
          true
        );
        expect(chips.chips[5]).toBe('chip6');
        expect(chipCollection[5].innerText).toBe('chip6');
        expect(chipCollection[5].children[2].classList.contains('icon')).toBe(
          true
        );
      });
      ...
      it('Add method - json data', () => {
        ...
        //array of data
        chips.add([
          { text: 'chip5', avatarIconCss: 'avatar' },
          { text: 'chip6', trailingIconCss: 'icon' },
        ]);
        chipCollection = Array.prototype.slice.call(
          element.querySelectorAll('.e-chip')
        );
        ...
        expect(chipCollection[5].innerText).toBe('chip6');
        expect(chipCollection[5].children[1].classList.contains('icon')).toBe(
          true
        );
      });
      ...
      it('Find method without text', () => {
        chips = new ChipList(
          { chips: [{ leadingIconCss: 'icon1' }, { leadingIconCss: 'icon2' }] },
          '#chip'
        );
        let chipCollection: HTMLElement[] = Array.prototype.slice.call(
          element.querySelectorAll('.e-chip')
      ...
      it('select & getSelectedChips method using index [Single selection]', () => {
        chips = new ChipList(
          { chips: deepCloning(jsonArray), selection: 'Single' },
          '#chip'
        );
        let chipCollection: HTMLElement[] = Array.prototype.slice.call(
          element.querySelectorAll('.e-chip')
      ...
      it('select & getSelectedChips method using htmlElement [Single selection]', () => {
        chips = new ChipList(
          { chips: stringArray.slice(), selection: 'Single' },
          '#chip'
        );
        let chipCollection: HTMLElement[] = Array.prototype.slice.call(
          element.querySelectorAll('.e-chip')
      ...
      it('select & getSelectedChips method using index [Multiple selection]', () => {
        chips = new ChipList(
          { chips: stringArray.slice(), selection: 'Multiple' },
          '#chip'
        );
        let chipCollection: HTMLElement[] = Array.prototype.slice.call(
          element.querySelectorAll('.e-chip')
      ...
      it('select & getSelectedChips method using htmlElement [Multiple selection]', () => {
        chips = new ChipList(
          { chips: deepCloning(jsonArray), selection: 'Multiple' },
          '#chip'
        );
        let chipCollection: HTMLElement[] = Array.prototype.slice.call(
          element.querySelectorAll('.e-chip')
      ...
      it('Multiple selection using value property', () => {
        chips = new ChipList(
          { chips: deepCloning(jsonArrayValue), selection: 'Multiple' },
          '#chip'
        );
        let chipCollection: HTMLElement[] = Array.prototype.slice.call(
          element.querySelectorAll('.e-chip')
  ...
  describe('chip - Events', () => {
    describe('chip component - Mouse', () => {
      describe('Click Event', () => {
        ...
        it('click event (Chip)- selection(none)', () => {
          chips = new ChipList(
            { text: 'chip content', click: onClick },
            '#chip'
          );
          fireEvent(element, 'click');
    ...
    describe('chip - keyboardEvents', () => {
      ...
      describe('Focus handler', () => {
          ...
          chips = new ChipList(
            {
              text: 'chip content',
              leadingIconUrl:
                'http://ej2.syncfusion.com/demos/src/chips/images/anne.png',
              trailingIconUrl:
                'http://ej2.syncfusion.com/demos/src/chips/images/anne.png',
            },
            '#chip'
        ...
        it('chipset focus', () => {
          chips = new ChipList(
            { text: 'chip content', chips: stringArray.slice() },
            '#chip'
          );
          let chipCollection: HTMLElement[] = Array.prototype.slice.call(
            element.querySelectorAll('.e-chip')
