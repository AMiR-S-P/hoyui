...
describe('Gantt spec for critical path', () => {
  ...
  describe('Right resizing taskbar', () => {
    ...
    it('Right Resizing', () => {
      ...
      let dragElement: HTMLElement = ganttObj.element.querySelector(
        '#' +
          ganttObj.element.id +
          'GanttTaskTableBody > tr:nth-child(41) > td > div.e-taskbar-main-container > div.e-taskbar-right-resizer.e-icon'
      ) as HTMLElement;
      triggerMouseEvent(
        dragElement,
        'mousedown',
    ...
    it('Progress Resizing', () => {
      ...
      let dragElement: HTMLElement = ganttObj.element.querySelector(
        '#' +
          ganttObj.element.id +
          'GanttTaskTableBody > tr:nth-child(12) > td > div.e-taskbar-main-container > div.e-child-progress-resizer'
      ) as HTMLElement;
      triggerMouseEvent(
        dragElement,
        'mousedown',
    ...
    it('Delete dependency', () => {
      ...
      let $tr: HTMLElement = ganttObj.element.querySelector(
        '#treeGrid' +
          ganttObj.element.id +
          '_gridcontrol_content_table > tbody > tr:nth-child(20) > td:nth-child(2)'
      ) as HTMLElement;
    ...
    it('Add record child', () => {
      ...
      let $tr: HTMLElement = ganttObj.element.querySelector(
        '#treeGrid' +
          ganttObj.element.id +
          '_gridcontrol_content_table > tbody > tr:nth-child(39)'
      ) as HTMLElement;
      triggerMouseEvent($tr, 'contextmenu', 0, 0, false, false, 2);
  ...
  describe('critical path rendering for FF and SF', () => {
    ...
    it('Right Resizing SF', () => {
      ...
      let dragElement: HTMLElement = ganttObj.element.querySelector(
        '#' +
          ganttObj.element.id +
          'GanttTaskTableBody > tr:nth-child(4) > td > div.e-taskbar-main-container > div.e-taskbar-right-resizer.e-icon'
      ) as HTMLElement;
      triggerMouseEvent(
        dragElement,
        'mousedown',
    ...
    it('Right Resizing FF', () => {
      ...
      let dragElement: HTMLElement = ganttObj.element.querySelector(
        '#' +
          ganttObj.element.id +
          'GanttTaskTableBody > tr:nth-child(6) > td > div.e-taskbar-main-container > div.e-taskbar-right-resizer.e-icon'
      ) as HTMLElement;
      triggerMouseEvent(
        dragElement,
        'mousedown',
    ...
    it('Right Resizing SS', () => {
      ...
      let dragElement: HTMLElement = ganttObj.element.querySelector(
        '#' +
          ganttObj.element.id +
          'GanttTaskTableBody > tr:nth-child(7) > td > div.e-taskbar-main-container > div.e-taskbar-right-resizer.e-icon'
      ) as HTMLElement;
      triggerMouseEvent(
        dragElement,
        'mousedown',
  ...
  describe('critical path rendering with offset value for SS', () => {
    ...
    it('Critical path after resizing with offset value', () => {
      ...
      let dragElement: HTMLElement = ganttObj.element.querySelector(
        '#' +
          ganttObj.element.id +
          'GanttTaskTableBody > tr:nth-child(6) > td > div.e-taskbar-main-container'
      ) as HTMLElement;
      triggerMouseEvent(
        dragElement,
        'mousedown',
  ...
  describe('taskbar resize for diff taskmode', () => {
    ...
    it('Custom taskmode', () => {
      ...
      let dragElement: HTMLElement = ganttObj.element.querySelector(
        '#' +
          ganttObj.element.id +
          'GanttTaskTableBody > tr:nth-child(12) > td > div.e-taskbar-main-container > div.e-taskbar-right-resizer.e-icon'
      ) as HTMLElement;
      triggerMouseEvent(
        dragElement,
        'mousedown',
  ...
  describe('critical path rendering', () => {
    ...
    it('Initial rendering critical path ', () => {
      ...
      let criticalpath: HTMLElement = ganttObj.element.querySelector(
  ...
  describe('Critical path rendering for resource view', () => {
    ...
    it('Multitaskbar Resource view', () => {
      expect(ganttObj.currentViewData[15].ganttProperties.isCritical).toBe(
        true
      );
    });
    it('Multitaskbar Resource view', () => {
      ganttObj.actionComplete = function (args: any): void {
        if (args.requestType === 'save') {
          expect(ganttObj.currentViewData[1].ganttProperties.isCritical).toBe(
            true
          );
          expect(ganttObj.currentViewData[2].ganttProperties.isCritical).toBe(
            true
          );
        }
      };
...
describe('Critical path is not working properly when the baseline is changed dynamically', () => {
  ...
  it('check critical path class', () => {
    ...
    ganttObj.dataBind();
    expect(
      ganttObj.element.getElementsByClassName(
...
describe('CR: 883874-Critical path of task connected dependent tasks have not changed to critical path', () => {
  ...
  it('Verifying the critical path if offset is 1-Day', () => {
    ...
    expect(
      ganttObj.currentViewData[1].ganttProperties.predecessor[0].offset
    ).toBe(1);
  });
  afterAll(() => {
    if (ganttObj) {
...
describe('Invalid critical task', () => {
  ...
  it('Verifying the critical path task', () => {
    ...
    let predecessor: HTMLElement = ganttObj.element.querySelector(
      '#treeGrid' +
        ganttObj.element.id +
        '_gridcontrol_content_table > tbody > tr:nth-child(12) > td:nth-child(6)'
    ) as HTMLElement;
    ...
    let element: HTMLElement = ganttObj.element.querySelector(
      '#treeGrid' +
        ganttObj.element.id +
        '_gridcontrol_content_table > tbody > tr:nth-child(13) > td:nth-child(6)'
    ) as HTMLElement;
    triggerMouseEvent(element, 'click');
  });
  afterAll(() => {
