 ...
 */
import { getValue, isNullOrUndefined, L10n } from '@hoyui/base';
import {
  Gantt,
  Selection,
  Toolbar,
...
import {
  ...
  MT887459,
  resourcesDatas1,
  resourceCollections1,
  editingResources,
  workMT887459,
  resourceData,
  dialogEditDataLocale,
  showcaseDatasource,
...
import { ClickEventArgs, Tab } from '@hoyui/navigations';
import { TextBox } from '@hoyui/inputs';
import { actionComplete } from '@hoyui/treegrid';
import { EJ2Intance, Grid } from '@hoyui/grids';
Gantt.Inject(
  Selection,
  Toolbar,
  DayMarkers,
...
let ganttModel: Object = {
  ...
  columns: [
    ...
    { field: 'Notes', width: 100 },
    {
      ...
      headerText: 'Custom Column1',
      width: 100,
    },
    {
      field: 'Customcol2',
      editType: 'maskededit',
      headerText: 'Custom Column2',
      width: 100,
    },
    {
      field: 'Customcol3',
      editType: 'booleanedit',
      headerText: 'Custom Column3',
      width: 100,
    },
    {
      field: 'Customcol4',
...
describe('Dialog editing - resoruce selection', () => {
  ...
  it('Resources editing', () => {
    ...
    let checkbox: HTMLElement = document.querySelector(
      '#' +
        ganttObj.element.id +
        'ResourcesTabContainer_gridcontrol_content_table > tbody > tr:nth-child(2) > td.e-rowcell.e-gridchkbox > div > span.e-frame.e-icons.e-uncheck'
    ) as HTMLElement;
    triggerMouseEvent(checkbox, 'click');
    let saveRecord: HTMLElement = document.querySelector(
  ...
  it('Resources editing', () => {
    ...
    let checkbox1: HTMLElement = document.querySelector(
      '#' +
        ganttObj.element.id +
        'ResourcesTabContainer_gridcontrol_content_table > tbody > tr:nth-child(1) > td.e-rowcell.e-gridchkbox > div > span.e-frame.e-icons.e-check'
    ) as HTMLElement;
    triggerMouseEvent(checkbox1, 'click');
    let checkbox: HTMLElement = document.querySelector(
      '#' +
        ganttObj.element.id +
        'ResourcesTabContainer_gridcontrol_content_table > tbody > tr:nth-child(2) > td.e-rowcell.e-gridchkbox > div > span.e-frame.e-icons.e-check'
    ) as HTMLElement;
    triggerMouseEvent(checkbox, 'click');
    let checkbox2: HTMLElement = document.querySelector(
      '#' +
        ganttObj.element.id +
        'ResourcesTabContainer_gridcontrol_content_table > tbody > tr:nth-child(3) > td.e-rowcell.e-gridchkbox > div > span.e-frame.e-icons.e-uncheck'
    ) as HTMLElement;
    triggerMouseEvent(checkbox2, 'click');
    let checkbox3: HTMLElement = document.querySelector(
      '#' +
        ganttObj.element.id +
        'ResourcesTabContainer_gridcontrol_content_table > tbody > tr:nth-child(4) > td.e-rowcell.e-gridchkbox > div > span.e-frame.e-icons.e-uncheck'
    ) as HTMLElement;
  ...
  it('Resources editing', () => {
    ...
    let checkbox1: HTMLElement = document.querySelector(
      '#' +
        ganttObj.element.id +
        'ResourcesTabContainer_gridcontrol_content_table > tbody > tr:nth-child(3) > td.e-rowcell.e-gridchkbox > div > span.e-frame.e-icons.e-check'
    ) as HTMLElement;
    triggerMouseEvent(checkbox1, 'click');
    let checkbox: HTMLElement = document.querySelector(
      '#' +
        ganttObj.element.id +
        'ResourcesTabContainer_gridcontrol_content_table > tbody > tr:nth-child(4) > td.e-rowcell.e-gridchkbox > div > span.e-frame.e-icons.e-check'
    ) as HTMLElement;
    triggerMouseEvent(checkbox, 'click');
    let saveRecord: HTMLElement = document.querySelector(
      '#' + ganttObj.element.id + '_dialog > div.e-footer-content > button'
  ...
  it('Resources editing', () => {
    let cancelRecord: HTMLElement = document.querySelectorAll(
      '#' +
        ganttObj.element.id +
...
describe('Gantt dialog module', () => {
  describe('Dialog editing - General Tab', () => {
    ...
    it('Schedule validation- duration', () => {
      ...
      let durationField: any = document.querySelector(
        '#' + ganttObj.element.id + 'Duration'
      ) as HTMLInputElement;
      if (durationField) {
        ...
        textObj.dataBind();
        let SD: any = (<EJ2Instance>(
          document.getElementById(ganttObj.element.id + 'StartDate')
        )).ej2_instances[0];
        expect(ganttObj.getFormatedDate(SD.value, 'M/d/yyyy')).toBe('4/4/2019');
        let ED: any = (<EJ2Instance>(
          document.getElementById(ganttObj.element.id + 'EndDate')
        )).ej2_instances[0];
        expect(ganttObj.getFormatedDate(ED.value, 'M/d/yyyy')).toBe(
          '4/11/2019'
        );
        let cancelRecord: HTMLElement = document.querySelectorAll(
          '#' +
    ...
    it('Unschedule validation- Duration', () => {
      let durationField: any = (<EJ2Instance>(
        document.getElementById(ganttObj.element.id + 'Duration')
      )).ej2_instances[0];
    ...
    it('Unschedule to schedule- StartDate', () => {
      ...
      let cancel: HTMLElement = document.querySelectorAll(
        '#' +
          ganttObj.element.id +
          '_dialog > div.e-footer-content > button.e-control'
      )[1] as HTMLElement;
    ...
    it('Schedule validation- Null values', () => {
      ...
      let element: HTMLElement = ganttObj.element.querySelector(
        '#' +
          ganttObj.element.id +
          'GanttTaskTableBody > tr.gridrowtaskIdlevel0:nth-Child(5) > td > div.e-left-label-container'
      );
  ...
  describe('Dialog editing with work mapping - General Tab', () => {
    ...
    it('Work editing', () => {
      let workField: any = ganttObj.element.querySelector(
        '#' + ganttObj.element.id + 'EstimatedWork'
      ) as HTMLInputElement;
      if (workField) {
        let inputObj: any = (<EJ2Instance>(
          document.getElementById(ganttObj.element.id + 'EstimatedWork')
        )).ej2_instances[0];
        inputObj.value = 40;
        let durationFocus: any = document.querySelector(
          '#' + ganttObj.element.id + 'Duration'
        ) as HTMLInputElement;
  ...
  describe('Task Type changing in Dialogue edit', () => {
    ...
    it('Task type editing', () => {
      let inputObj: any = (<EJ2Instance>(
        document.getElementById(ganttObj.element.id + 'taskType')
      )).ej2_instances[0];
      inputObj.value = 'FixedDuration';
      inputObj.dataBind();
      let saveRecord: HTMLElement = document.querySelector(
  ...
  describe('Dialog editing - predecessor Tab', () => {
    ...
    it('Dependency tab editing', () => {
      ganttObj.actionComplete = (args: any): void => {
        if (args.requestType === 'save') {
          expect(
            ganttObj.currentViewData[3].ganttProperties.predecessorsName
          ).toBe('3FS');
        }
      };
      let row: HTMLElement = document.querySelector(
        '#' +
          ganttObj.element.id +
          'DependencyTabContainer_content_table > tbody > tr > td:nth-child(2)'
      ) as HTMLElement;
      if (row) {
        triggerMouseEvent(row, 'dblclick');
        let input: any = (<EJ2Instance>(
          document.getElementById(
            ganttObj.element.id + 'DependencyTabContainername'
          )
        )).ej2_instances[0];
        input.dataSource = input.dataSource.dataSource.json;
        input.value = '3-Child Task 2';
        input.dataBind();
        let idInput: any = (<EJ2Instance>(
          document.getElementById(
            ganttObj.element.id + 'DependencyTabContainerid'
          )
        )).ej2_instances[0];
        idInput.value = '3';
        idInput.dataBind();
        let toolbar: HTMLElement = document.querySelector(
          '#' + ganttObj.element.id + 'DependencyTabContainer_toolbarItems'
        ) as HTMLElement;
  ...
  describe('Dialog editing - Resource Tab', () => {
    ...
    it('Resource tab editing', () => {
      ...
      ganttObj.actionComplete = (args: any): void => {
        if (args.requestType === 'save') {
          expect(
            ganttObj.currentViewData[1].ganttProperties.resourceNames
          ).toBe('Resource 1');
          ...
          expect(ganttObj.currentViewData[1].ganttProperties.workUnit).toBe(
            'hour'
          );
          expect(ganttObj.currentViewData[1].ganttProperties.taskType).toBe(
            'FixedUnit'
      ...
      let checkbox: HTMLElement = document.querySelector(
        '#' +
          ganttObj.element.id +
          'ResourcesTabContainer_gridcontrol_content_table > tbody > tr:nth-child(1) > td.e-rowcell.e-gridchkbox > div > span.e-frame.e-icons.e-uncheck'
      ) as HTMLElement;
      if (checkbox) {
        triggerMouseEvent(checkbox, 'click');
        let saveRecord: HTMLElement = document.querySelector(
    ...
    it('Resource unit editing', () => {
      ...
      triggerMouseEvent(checkbox, 'click');
      let unit: HTMLElement = document.querySelector(
        '#' +
          ganttObj.element.id +
          'ResourcesTabContainer_gridcontrol_content_table > tbody > tr:nth-child(1) > td:nth-child(4)'
      ) as HTMLElement;
      if (unit) {
        triggerMouseEvent(unit, 'dblclick');
        let input: any = (<EJ2Instance>(
          document.getElementById(
            ganttObj.element.id + 'ResourcesTabContainer_gridcontrolunit'
          )
        )).ej2_instances[0];
        input.value = 50;
        input.dataBind();
  ...
  describe('Dialog editing - Resource Tab with unit mapping', () => {
    ...
    it('Resource unit editing with unit mapping', () => {
      ...
      let unit: HTMLElement = document.querySelector(
        '#' +
          ganttObj.element.id +
          'ResourcesTabContainer_gridcontrol_content_table > tbody > tr:nth-child(2) > td:nth-child(4)'
      ) as HTMLElement;
      if (unit) {
        triggerMouseEvent(unit, 'dblclick');
        let input: any = (<EJ2Instance>(
          document.getElementById(
            ganttObj.element.id +
              'ResourcesTabContainer_gridcontrolresourceUnit'
          )
        )).ej2_instances[0];
        input.value = 50;
        input.dataBind();
  ...
  describe('Custom tab', () => {
    ...
    it('Custom Editor for custom column', () => {
      let customColumn: any = document.querySelector(
        '#' + ganttObj.element.id + 'Customcol4'
      ) as HTMLInputElement;
      if (customColumn) {
        triggerMouseEvent(customColumn, 'click');
        let customValue: any = (<EJ2Instance>(
          document.getElementById(ganttObj.element.id + 'Customcol4')
        )).ej2_instances[0];
  ...
  describe('Add Dialog', () => {
    ...
    beforeEach(() => {
      let add: HTMLElement = ganttObj.element.querySelector(
        '#' + ganttObj.element.id + '_add'
      ) as HTMLElement;
    ...
    it('Add new record beyond project dates', () => {
      ganttObj.actionComplete = (args: any): void => {
        if (args.action === 'TimescaleUpdate') {
          expect(
            ganttObj.getFormatedDate(ganttObj.cloneProjectStartDate, 'M/d/yyyy')
          ).toEqual('3/18/2019');
        }
      };
      let SD: any = (<EJ2Instance>(
  ...
  describe('Dialog tab', () => {
    ...
    it('Dynamic property change', () => {
      ...
      ganttObj.dataBind();
      let cancelRecord1: HTMLElement = document.querySelectorAll(
        '#' +
          ganttObj.element.id +
          '_dialog > div.e-footer-content > button.e-control'
      )[1] as HTMLElement;
      ...
      let name: any = (<EJ2Instance>(
        document.getElementById(ganttObj.element.id + 'TaskName')
      )).ej2_instances[0];
      name.value = 'updated';
      name.dataBind();
      let cancelRecord2: HTMLElement = document.querySelectorAll(
        '#' +
          ganttObj.element.id +
          '_dialog > div.e-footer-content > button.e-control'
      )[1] as HTMLElement;
    ...
    it('Click event', () => {
      ganttObj.isAdaptive = true;
      ganttObj.dataBind();
      let tab: HTMLElement = document.querySelector(
        '#' +
          ganttObj.element.id +
          '_dialog > div.e-dlg-content > div > div > div > div:nth-Child(3)'
      ) as HTMLElement;
    ...
    it('Restrict dialog rendering when allowediting is set as false', () => {
      ...
      let row: HTMLElement = ganttObj.element.querySelector(
        '#' + ganttObj.element.id + 'GanttTaskTableBody > tr:nth-child(3) > td'
      ) as HTMLElement;
      triggerMouseEvent(row, 'dblclick');
  ...
  describe('Schedule mode', () => {
    ...
    it('Changing taskmode of a task to manual', (done: Function) => {
      ...
      ganttObj.openEditDialog(2);
      let taskMode: any = document.querySelector(
        '#' + ganttObj.element.id + 'isManual'
      ) as HTMLInputElement;
      if (taskMode) {
        let inputObj: any = (<EJ2Instance>(
          document.getElementById(ganttObj.element.id + 'isManual')
        )).ej2_instances[0];
        inputObj.value = true;
        inputObj.dataBind();
        let saveRecord: HTMLElement = document.querySelector(
  ...
  describe('CR-issues', function () {
    ...
    it('EJ2-48224 - Schedule validation- endDate', () => {
      ...
      ganttObj.openEditDialog(4);
      let ED1: any = (<EJ2Instance>(
        document.getElementById(ganttObj.element.id + 'EndDate')
      )).ej2_instances[0];
      ED1.value = new Date('04/12/2019');
      ED1.dataBind();
      let saveRecord1: HTMLElement = document.querySelector(
        '#' + ganttObj.element.id + '_dialog > div.e-footer-content > button'
      ) as HTMLElement;
  ...
  describe('MT-issues', function () {
    ...
    it('Selection maintain after adding record', () => {
      ...
      let addToolbar: HTMLElement = ganttObj.element.querySelector(
        '#' + ganttObj.element.id + '_add'
      ) as HTMLElement;
  ...
  describe('Split task', function () {
    ...
    it('end date validation when remove all segments', () => {
      expect(
        ganttObj.element.getElementsByClassName('e-row')[2].children[3]
          .innerHTML
      ).toBe('2/8/2019');
      ganttObj.openEditDialog(3);
      let selectSegment: HTMLElement = document.querySelector(
        '#' +
          ganttObj.element.id +
          '_Tab > div.e-tab-header.e-control.e-toolbar.e-lib.e-keyboard > div > div:nth-child(4)'
      ) as HTMLElement;
      triggerMouseEvent(selectSegment, 'click');
      let selectRow: HTMLElement = document.querySelector(
        '#' +
          ganttObj.element.id +
          'SegmentsTabContainer_content_table > tbody > tr:nth-child(1)'
      ) as HTMLElement;
      triggerMouseEvent(selectRow, 'click');
      let deleteSegment: HTMLElement = document.querySelector(
        '#' +
          ganttObj.element.id +
          'SegmentsTabContainer_delete > span.e-tbar-btn-text'
      ) as HTMLElement;
  ...
  describe('Split task', function () {
    ...
    it('end date validation when remove all segments', () => {
      let selectRow: HTMLElement = document.querySelector(
        '#' +
          ganttObj.element.id +
          'SegmentsTabContainer_content_table > tbody > tr:nth-child(3)'
      ) as HTMLElement;
  ...
  describe('Custom Tab with defaultedit editType', function () {
    ...
    it('defaultedit type', () => {
      let customColumn: any = document.querySelector(
        '#' + ganttObj.element.id + 'Customcolumn'
      ) as HTMLInputElement;
      if (customColumn) {
        triggerMouseEvent(customColumn, 'click');
        let customValue: any = (<EJ2Instance>(
          document.getElementById(ganttObj.element.id + 'Customcolumn')
        )).ej2_instances[0];
        customValue.value = 'Tracker 4';
        customValue.dataBind();
        let saveRecord: HTMLElement = document.querySelector(
        ...
        triggerMouseEvent(saveRecord, 'click');
        expect(getValue('Customcolumn', ganttObj.flatData[3])).toBe(
          'Tracker 4'
        );
      }
    });
  ...
  describe('Localization', function () {
    ...
    it('localization for the word New Task', () => {
      ganttObj.openAddDialog();
      let taskname: HTMLElement = document.getElementById(
        ganttObj.element.id + 'TaskName'
      ) as HTMLElement;
  ...
  describe('Add Dialog for Bottom position', () => {
    ...
    it('Add new record as Bottom', () => {
      ganttObj.actionComplete = (args: any): void => {
        if (args.action === 'add') {
          expect(
            ganttObj.dataSource[ganttObj.dataSource['length'] - 1]
              .ganttProperties
          ).toBe(undefined);
        }
      };
  ...
  describe('Baseline - ', function () {
    ...
    it('End date validation', () => {
      ...
      ganttObj.openEditDialog();
      let sdate: any = (<EJ2Instance>(
        document.getElementById(ganttObj.element.id + 'BaselineStartDate')
      )).ej2_instances[0];
      sdate.value = new Date('04/02/2019');
      sdate.dataBind();
      let edate: any = (<EJ2Instance>(
        document.getElementById(ganttObj.element.id + 'BaselineEndDate')
      )).ej2_instances[0];
      ...
      expect(
        ganttObj.currentViewData[0].ganttProperties.baselineEndDate.getDate()
      ).toBe(10);
    });
  });
  describe('Edit Duration of milestone', function () {
    ...
    it('Edit duration of milestone', () => {
      ...
      if (durationField) {
        ...
        expect(ganttObj.getFormatedDate(SD.value, 'M/d/yyyy')).toBe(
          '3/26/2019'
        );
      }
    });
    ...
    it('Edit duration of new task', () => {
      ...
      ganttObj.actionComplete = (args: any): void => {
        if (args.requestType == 'add') {
          expect(
            args.data.EndDate.getDate() - args.data.StartDate.getDate()
          ).toBe(1);
        }
      };
      ganttObj.openAddDialog();
  ...
  describe('Edit custom column values in edit dialog', function () {
    ...
    let data = [{ name: 'deliver' }, { name: 'stage' }, { name: 'task' }];
    beforeAll(function (done) {
      ganttObj = createGantt(
        {
          dataSource: projectData1,
  ...
  describe('Dialogue edit with Shimmer effect', function () {
    ...
    it('edit dialogue shimmer effect', () => {
      ganttObj.actionComplete = (args: any): void => {
        if (args.requestType === 'openEditDialog') {
          expect(
            document.getElementsByClassName('e-table e-masked-table').length
          ).toBe(2);
        }
      };
      ganttObj.openEditDialog(2);
    ...
    it('convert to milestone shimmer effect', () => {
      ...
      let $tr: HTMLElement = ganttObj.element.querySelector(
        '#treeGrid' +
          ganttObj.element.id +
          '_gridcontrol_content_table > tbody > tr:nth-child(1)'
      ) as HTMLElement;
      triggerMouseEvent($tr, 'contextmenu', 0, 0, false, false, 2);
      ganttObj.actionComplete = (args: any): void => {
        if (args.requestType === 'save') {
    ...
    it('Task information shimmer effect', () => {
      ...
      let taskInfo: HTMLElement = document.getElementById(
        ganttObj.element.id + '_contextMenu_TaskInformation'
      );
      ...
      ganttObj = createGantt(
        {
          ...
          actionComplete(args) {
            if (args.requestType == 'openEditDialog') {
              expect(document.getElementsByClassName('e-disabled').length).toBe(
                8
              );
            }
          },
    ...
    it('Change dates of predecessor record', () => {
      ganttObj.actionComplete = function (args: any): void {
        if (args.action === 'DialogEditng') {
          expect(
            ganttObj.getFormatedDate(
              args.modifiedRecords[1].ganttProperties.startDate,
              'M/d/yyyy'
            )
          ).toBe('4/2/2019');
        }
      };
      let startDateField: any = document.querySelector(
        '#' + ganttObj.element.id + 'StartDate'
      ) as HTMLInputElement;
      if (startDateField) {
        let textObj: any = (<EJ2Instance>(
          document.getElementById(ganttObj.element.id + 'StartDate')
  ...
  describe('Cant able to convert the taskbar to milestone', () => {
    ...
    it('Check the task is milestone', () => {
      ...
      triggerMouseEvent(saveRecord, 'click');
      expect(ganttObj.currentViewData[1].ganttProperties.isMilestone).toBe(
        true
      );
    });
  });
...
describe('Issues in Unscheduled tasks sample', function () {
  ...
  it('check start date after changing in dialog edit', () => {
    ...
    ganttObj.openEditDialog(1);
    let dateField: any = document.querySelector(
      '#' + ganttObj.element.id + 'StartDate'
    ) as HTMLInputElement;
    if (dateField) {
      let textObj: any = (<EJ2Instance>(
...
describe('Update custom field in general tab', function () {
  ...
  it('change custom field value in general tab', () => {
    ...
    ganttObj.openEditDialog(3);
    let textObj: any = (<EJ2Instance>(
      document.getElementById(ganttObj.element.id + 'CustomField')
    )).ej2_instances[0];
...
describe('Validation Rule in Edit Dialog', function () {
  ...
  it('Duration Validation Rule', () => {
    ...
    if (durationField) {
      ...
      let textObj1: any = (<EJ2Instance>(
        document.getElementById(ganttObj.element.id + 'Duration')
      )).ej2_instances[0];
      textObj1.value = '3 days';
      textObj1.dataBind();
      let saveRecord1: HTMLElement = document.querySelectorAll(
        '#' +
          ganttObj.element.id +
          '_dialog > div.e-footer-content > button.e-control'
      )[0] as HTMLElement;
...
describe('Bug-850397: Work column is not properly updating in Resource sample', () => {
  ...
  beforeEach((done) => {
    setTimeout(done, 500);
    ganttObj.openAddDialog();
    let resourceTab: any = (<EJ2Instance>(
      document.getElementById(ganttObj.element.id + '_Tab')
    )).ej2_instances[0];
  ...
  it('Verifying total parent work while adding New record with resource', () => {
    let inputObj: any = (
      document.getElementById(ganttObj.element.id + 'work') as any
    ).ej2_instances[0];
    inputObj.value = 8;
...
describe('Edit baseline dates', function () {
  ...
  it('change baseline dates', () => {
    ganttObj.actionComplete = (args) => {
      if (args.requestType === 'save') {
        expect(
          ganttObj.flatData[0].ganttProperties.baselineEndDate.getHours()
        ).toBe(8);
      }
    };
    ganttObj.openEditDialog(1);
    ...
    durationField.dataBind();
    let baselineStartdateField: any = (<EJ2Instance>(
      document.getElementById(ganttObj.element.id + 'BaselineStartDate')
    )).ej2_instances[0];
    baselineStartdateField.value = '05/22/2023';
    baselineStartdateField.dataBind();
    let baselineEnddateField: any = (<EJ2Instance>(
      document.getElementById(ganttObj.element.id + 'BaselineEndDate')
    )).ej2_instances[0];
  ...
  it('change baseline dates', () => {
    ganttObj.actionBegin = (args) => {
      if (args.requestType === 'beforeSave') {
        ...
        args.data.ganttProperties.baselineStartDate =
          args.data.ganttProperties.startDate;
...
describe('Change progress', function () {
  ...
  it('change progress value', () => {
    ...
    ganttObj.actionComplete = (args) => {
      if (args.requestType == 'save') {
        expect(args.data.ganttProperties.progressWidth > currentWidth).toBe(
          true
        );
      }
    };
...
describe('End Edit before open dialog', function () {
  ...
  it('Edit task name and open dialog', () => {
    ...
    triggerMouseEvent(TaskName, 'dblclick');
    triggerMouseEvent(
      document.querySelector('.e-taskbar-main-container '),
      'dblclick'
    );
    ...
    ganttObj = createGantt(
      {
        ...
        editDialogFields: [
          {
            type: 'General',
            fields: ['TaskID', 'TaskName', 'newinput', 'newinput1'],
          },
          {
            type: 'Dependency',
            additionalParams: {
  ...
  it(' actionbegin action with edittab', () => {
    ...
    ganttObj.actionComplete = (args) => {
      let print = document.getElementById(
        'ganttContainerDependencyTabContainer_print'
      );
      let button = document.getElementById(
        'ganttContainerDependencyTabContainer_searchbar'
      );
...
describe('Dialog editing - predecessor Tab with decimal', () => {
  ...
  it('Dependency tab editing with decimal', () => {
    ...
    let addIcon: HTMLElement = document
      .querySelector(
        '#' + ganttObj.element.id + 'DependencyTabContainer_toolbarItems'
      )
      .querySelector('#Gantt_0DependencyTabContainer_add') as HTMLElement;
    triggerMouseEvent(addIcon, 'click');
    let inputElement: HTMLElement = document.getElementById(
      ganttObj.element.id + 'DependencyTabContainername'
    ) as HTMLElement;
    if (inputElement) {
      ...
      idInput.value = '1';
      idInput.dataBind();
      let offset: any = (<EJ2Instance>(
        document.getElementById('Gantt_0DependencyTabContaineroffset')
      )).ej2_instances[0];
...
describe('CR-875373:Start date defaulting to incorrect value when remove the startDate in add dialog issues', function () {
  ...
  it('Verifying endDate after dialog add without startDate', () => {
    ...
    expect(
      ganttObj.getFormatedDate(
        ganttObj.flatData[0].ganttProperties.endDate,
        'M/d/yyyy'
      )
    ).toEqual('4/2/2019');
  });
...
describe('Duration column Dialog editing with decimal', () => {
  ...
  it('editing with decimal', () => {
    ...
    if (durationField) {
      ...
      textObj.value = '0.25';
      textObj.dataBind();
      let save: HTMLElement = document.querySelectorAll(
        '#' +
          ganttObj.element.id +
          '_dialog > div.e-footer-content > button.e-control'
      )[1] as HTMLElement;
        ...
        addDialogFields: [
          {
            type: 'General',
            headerText: 'General',
            fields: ['TaskID', 'TaskName', 'CustomColumn'],
          },
          { type: 'Dependency' },
          { type: 'Resources' },
          { type: 'Notes' },
...
describe('Edit cell with timeline virtualization', () => {
  ...
  let SelfReferenceData = [
    ...
    {
      TaskID: 2,
      TaskName: 'Identify Site location Empty note',
      StartDate: new Date('03/29/2019'),
      Duration: 4,
      Progress: 50,
      ParentId: 1,
    ...
    ganttObj = createGantt(
      {
        ...
        toolbar: [
          ...
          'ExcelExport',
          'PdfExport',
          { text: 'Quick Filter', id: 'Quick Filter' },
          { text: 'Clear Filter', id: 'Clear Filter' },
        ],
        columns: [
  ...
  it('edit start date cell', () => {
    ganttObj.actionComplete = (args: any): void => {
      if (args.action === 'DialogEditing')
        expect(
          ganttObj.getFormatedDate(
            ganttObj.timelineModule.timelineEndDate,
            'MM/dd/yyyy'
          )
        ).toBe('04/07/2024');
    };
    let StartDate: any = document.querySelector(
      '#' + ganttObj.element.id + 'StartDate'
    ) as HTMLInputElement;
    if (StartDate) {
      let SD: any = (<EJ2Instance>(
    ...
    ganttObj = createGantt(
      {
        ...
        editDialogFields: [{ type: 'General', headerText: 'General' }],
        addDialogFields: [{ type: 'General', headerText: 'General' }],
        renderBaseline: true,
        baselineColor: 'red',
        editSettings: {
          allowAdding: true,
        ...
        columns: [
          ...
          { field: 'StartDate' },
          {
            ...
            editType: 'numericedit',
            format: 'yMd',
            validationRules: { estimatedTimeValidation },
          },
          {
            field: 'logTime',
            editType: 'numericedit',
            format: 'yMd',
            validationRules: { logTimeValidation },
          },
        ],
        toolbar: [
          'Add',
...
describe('Split task-875295:Console error occurs when try to save with one day duration in segments', () => {
  ...
  it('Verifying with one day segment', () => {
    ...
    tab.selectedItem = 2;
    tab.dataBind();
    let addIcon: HTMLElement = document.querySelector(
      '#' +
        ganttObj.element.id +
        'SegmentsTabContainer_toolbarItems > div > div.e-toolbar-right > div:nth-child(1)'
    );
    addIcon.click();
    let saveRecord: HTMLElement = document.querySelector(
      '#' + ganttObj.element.id + '_dialog > div.e-footer-content > button'
...
describe('Split task', function () {
  ...
  it('when give a taskid as id getting console error', () => {
    expect(
      ganttObj.element.getElementsByClassName('e-row')[2].children[3].innerHTML
    ).toBe('2/8/2019');
    ganttObj.openEditDialog(3);
    let selectSegment: HTMLElement = document.querySelector(
      '#' +
...
describe('CR:886052-Editing issue for the grid rendered inside a custom column', function () {
            ...
            edit: {
              ...
              write: (args: Object) => {
                if ((args as any).rowData.Indicators) {
                  indicatorData = (args as any).rowData.Indicators.map(
  ...
  it('Opening Indicator tab and save action', () => {
    ganttObj.openEditDialog(2);
    let selectIndicator: HTMLElement = document.querySelector(
      '#' +
        ganttObj.element.id +
        '_Tab > div.e-tab-header.e-control.e-toolbar.e-lib.e-keyboard > div > div:nth-child(3)'
    ) as HTMLElement;
...
describe('MT:887459-Page is automatically getting refreshed after pressing ENTER Key in custom column tab ', function () {
  ...
  it('Dialog Custom Tab', () => {
    let selectCustomTab: HTMLElement = document.querySelector(
      '#' +
        ganttObj.element.id +
        '_Tab > div.e-tab-header.e-control.e-toolbar.e-lib.e-keyboard > div > div:nth-child(4)'
    ) as HTMLElement;
    triggerMouseEvent(selectCustomTab, 'click');
    let customField: any = document.querySelector(
      '#' + ganttObj.element.id + 'CustomColumn'
    ) as HTMLInputElement;
    ...
    if (customField) {
      ...
      expect(
        document.getElementById(ganttObj.element.id + '_dialog')
      ).toBeDefined();
    }
  });
});
describe('CR-890587 actionBegin event used for canceling edit actions is not working properly', () => {
  ...
  it('Schedule validation- duration', () => {
    ...
    const dialogElement: HTMLElement =
      ganttObj.editModule.dialogModule.dialog.querySelector(
        '#' + ganttObj.element.id + 'DependencyTabContainer'
      );
...
describe('CR- 886123: disable "Add" and "Delete" button in dependency tab when not necessary', () => {
  ...
  it('Dependency tab editing', () => {
    ...
    tab.selectedItem = 1;
    tab.dataBind();
    const dialog: any = document.getElementById(
      ganttObj.element.id + 'DependencyTabContainer'
    )['ej2_instances'][0];
...
describe('Validation Rule for dependency tab', function () {
  ...
  it('Checking Validation on custom column', () => {
    let add: HTMLElement = document
      .getElementById(
        ganttObj.element.id + 'DependencyTabContainer_toolbarItems'
      )
      .querySelector('.e-toolbar-item') as HTMLElement;
    triggerMouseEvent(add, 'click');
    let saveRecord: HTMLElement = document.querySelectorAll(
      '#' +
        ganttObj.element.id +
...
describe('Dependency tab as first column', function () {
  ...
  it('Checking is dependency tab present', () => {
    expect(
      document.getElementById(ganttObj.element.id + 'DependencyTabContainer') !=
        null
    ).toBe(true);
  });
  afterAll(function () {
...
describe('Switching to General tab', function () {
  ...
  it('Checking if general tab is present', () => {
    let selectGeneralTab: HTMLElement = document.querySelector(
      '#' +
        ganttObj.element.id +
        '_Tab > div.e-tab-header.e-control.e-toolbar.e-lib.e-keyboard > div > div:nth-child(3)'
    ) as HTMLElement;
    ...
    expect(
      document.getElementById('e-content-' + ganttObj.element.id + '_Tab_1') !=
        null
    ).toBe(true);
  });
  afterAll(function () {
...
describe('Changing Notes Tab Edit type', function () {
  ...
  it('Checking if general tab is present', () => {
    expect(
      document.getElementById(ganttObj.element.id + 'NotesTabContainer')[
        'ej2_instances'
      ][0].editorMode
    ).toBe('HTML');
  });
...
describe('Resource tab property change', function () {
        ...
        addDialogFields: [
          {
            ...
            additionalParams: {
              ...
              allowReordering: true,
              toolbar: ['PdfExport', 'ExcelExport', 'Search', 'Print'],
            },
          },
          { type: 'General', headerText: 'General' },
        ],
  ...
  it('Checking if general tab is present', () => {
    expect(
      document.getElementById(ganttObj.element.id + 'ResourcesTabContainer')[
        'ej2_instances'
      ][0].allowSorting
    ).toBe(true);
    expect(
...
describe('Update Notes tab with disableHtmlEncode true', function () {
  ...
  it('Checking Notes Tab Value', (done: Function) => {
    ...
    ganttObj.actionBegin = function (args: any): void {
      if (args.requestType === 'beforeSave') {
        expect(args.data.ganttProperties.notes).toBe(
...
describe('Checking Duration', function () {
  ...
  it('Checking Duration with work zero', (done: Function) => {
    ...
    (
      document.getElementById(ganttObj.element.id + 'Duration') as any
    ).ej2_instances[0].value = 3;
    let saveRecord: HTMLElement = document.querySelectorAll(
      '#' +
        ganttObj.element.id +
        '_dialog > div.e-footer-content > button.e-control'
...
describe('Validation Rule on Custom Column', () => {
  ...
  it('edit start date', () => {
    let startdate: HTMLElement = document.querySelector(
      '#' +
        ganttObj.element.id +
        'SegmentsTabContainer_content_table > tbody > tr:nth-child(1) > td:nth-child(1)'
    );
    triggerMouseEvent(startdate, 'dblclick');
    let input = (
      document.getElementById(
        ganttObj.element.id + 'SegmentsTabContainer' + 'StartDate'
      ) as any
    ).ej2_instances[0];
    input.value = '2/5/2019';
    input.dataBind();
    let duration1: HTMLElement = document.querySelector(
      '#' +
        ganttObj.element.id +
        'SegmentsTabContainer_content_table > tbody > tr:nth-child(2) > td:nth-child(1)'
    );
    triggerMouseEvent(duration1, 'click');
    expect(
      ganttObj.currentViewData[2].ganttProperties.segments[0].duration
    ).toBe(2);
    let saveRecord: HTMLElement = document.querySelectorAll(
      '#' +
        ganttObj.element.id +
  ...
  it('edit end date', () => {
    ...
    let input = (
      document.getElementById(
        ganttObj.element.id + 'SegmentsTabContainer' + 'EndDate'
      ) as any
    ).ej2_instances[0];
    input.value = '2/5/2019';
    input.dataBind();
    let duration1: HTMLElement = document.querySelector(
      '#' +
        ganttObj.element.id +
        'SegmentsTabContainer_content_table > tbody > tr:nth-child(2) > td:nth-child(2)'
    );
    triggerMouseEvent(duration1, 'click');
    expect(
      ganttObj.currentViewData[2].ganttProperties.segments[0].duration
        ...
        addDialogFields: [
          {
            ...
            additionalParams: {
              ...
              toolbar: ['ExcelExport', 'PdfExport', 'Print', 'Search'],
            },
          },
        ],
        editSettings: {
...
describe('validate end date', () => {
  ...
  it('validate end date', () => {
    ...
    args['rows'] = {};
    args['rows'].length = 6;
    ganttObj.editModule.dialogModule['preTableCollection'] = [
      0, 1, 2, 3, 4, 5,
    ] as any;
    ...
    ganttObj = createGantt(
      {
        ...
        addDialogFields: [{ type: 'Resources' }],
        allowResizing: true,
        allowSelection: true,
        highlightWeekends: true,
        treeColumnIndex: 1,
        ...
        editDialogFields: [
          {
            ...
            additionalParams: {
              columns: [
                { field: 'id', visible: false, headerText: 'Iv value' },
              ],
            },
          },
        ],
...
describe('Segment adding issue', () => {
  ...
  it('Opening Add Dialog', () => {
    ganttObj.openAddDialog();
    const tabObj: Tab = (<EJ2Intance>(
      document.getElementById(ganttObj.element.id + '_Tab')
    )).ej2_instances[0];
    tabObj.selectedItem = 2;
  });
  it('Add segments', () => {
    let addSegment: HTMLElement = document.querySelector(
      '#' +
        ganttObj.element.id +
        'SegmentsTabContainer_add > span.e-tbar-btn-text'
    ) as HTMLElement;
    triggerMouseEvent(addSegment, 'click');
    ganttObj.editModule.dialogModule.dialog
      .querySelector('#' + ganttObj.element.id + 'SegmentsTabContainer')
      ['ej2_instances'][0].endEdit();
  });
  it('Delete segments', () => {
    let deleteSegment: HTMLElement = document.querySelector(
      '#' +
  ...
  it('Cancel Dialog', () => {
    ...
    expect(
      ganttObj.editModule.dialogModule.dialog.querySelector('.e-row')
    ).toBe(null);
    triggerMouseEvent(cancel, 'click');
  });
  afterAll(() => {
...
describe('Additional params', () => {
  ...
  it('Schedule validation- duration', () => {
    let addRecord: HTMLElement =
      ganttObj.editModule.dialogModule.dialog.querySelector(
        '#' + ganttObj.element.id + 'SegmentsTabContainer_add'
      ) as HTMLElement;
    if (addRecord) {
      triggerMouseEvent(addRecord, 'click');
      expect(
        ganttObj.editModule.dialogModule.dialog.querySelector(
          '#' + ganttObj.element.id + 'SegmentsTabContainerStartDate'
        )['value']
      ).toBe('2/7/2019');
      let cancel: HTMLElement = document.querySelectorAll(
        '#' +
  ...
  it('Checking for dialog element', () => {
    ganttObj.actionBegin = function (args: any): void {
      if (args.requestType === 'beforeSave') {
        args.cancel = true;
        expect(
          ganttObj.editModule.dialogModule.dialog['ej2_instances'][0] != null
        ).toBe(true);
      }
    };
    let saveRecord: HTMLElement = document.querySelector(
...
describe('Add predecessor for unscheduled tasks', () => {
  ...
  it('Checking for predecessor name', () => {
    ...
    let dependency: HTMLElement = ganttObj.element.querySelector(
      '#treeGrid' +
        ganttObj.element.id +
        '_gridcontrol_content_table > tbody > tr:nth-child(6) > td:nth-child(7)'
    ) as HTMLElement;
