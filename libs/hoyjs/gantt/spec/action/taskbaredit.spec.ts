...
describe('Gantt taskbar edit action', () => {
  ...
  it('Left resizing - drop on weekends', () => {
    ...
    ganttObj.taskbarEdited = (args: ITaskbarEditedEventArgs) => {
      ...
      ).toBe('10/23/2017 08:00');
      expect(args['name']).toBe('taskbarEdited');
      expect(args.taskBarEditAction).toBe('LeftResizing');
      expect(
        ganttObj.getFormatedDate(
          args.previousData.startDate,
          'MM/dd/yyyy HH:mm'
        )
      ).toBe('10/23/2017 08:00');
    };
    ...
    let dragElement: HTMLElement = ganttObj.element.querySelector(
      '#' +
        ganttObj.element.id +
        'GanttTaskTableBody > tr:nth-child(2) > td > div.e-taskbar-main-container > div.e-taskbar-left-resizer.e-icon'
    ) as HTMLElement;
    triggerMouseEvent(
      dragElement,
      'mousedown',
...
describe('Gantt taskbar edit action', () => {
  ...
  it('Left resizing -  drop on weekdays', () => {
    ganttObj.taskbarEditing = (args: ITaskbarEditedEventArgs) => {
      ...
      expect(args.taskBarEditAction).toBe('LeftResizing');
      expect(
        ganttObj.getFormatedDate(args.data['StartDate'], 'MM/dd/yyyy HH:mm')
      ).toBe('10/23/2017 08:00');
    };
...
describe('Gantt taskbar edit action', () => {
  ...
  it('progress with 0% - editing cancel', () => {
    ...
    let dragElement: HTMLElement = ganttObj.element.querySelector(
      '#' +
        ganttObj.element.id +
        'GanttTaskTableBody > tr:nth-child(2) > td > div.e-taskbar-main-container > div.e-child-progress-resizer'
    ) as HTMLElement;
    triggerMouseEvent(
      dragElement,
      'mousedown',
...
describe('Gantt taskbar edit action', () => {
  ...
  it('Milestone drag action', () => {
    ...
    let dragElement: HTMLElement = ganttObj.element.querySelector(
      '#' +
        ganttObj.element.id +
        'GanttTaskTableBody > tr:nth-child(3) > td > div.e-taskbar-main-container > div'
    ) as HTMLElement;
    triggerMouseEvent(
      dragElement,
      'mousedown',
...
describe('Gantt taskbar edit action', () => {
  ...
  it('Parent drag action', () => {
    ...
    let dragElement: HTMLElement = ganttObj.element.querySelector(
      '#' +
        ganttObj.element.id +
        'GanttTaskTableBody > tr.gridrowtaskIdlevel0.e-chart-row > td > div.e-taskbar-main-container'
    ) as HTMLElement;
    triggerMouseEvent(
      dragElement,
      'mousedown',
...
describe('Gantt taskbar edit action', () => {
  ...
  it('Right resizing - editing cancel', () => {
    ...
    let dragElement: HTMLElement = ganttObj.element.querySelector(
      '#' +
        ganttObj.element.id +
        'GanttTaskTableBody > tr:nth-child(2) > td > div.e-taskbar-main-container > div.e-taskbar-right-resizer.e-icon'
    ) as HTMLElement;
    triggerMouseEvent(
      dragElement,
      'mousedown',
  ...
  it('Right resizing - edited cancel', () => {
    ...
    expect(
      ganttObj.getFormatedDate(
        ganttObj.flatData[1].ganttProperties.endDate,
        'MM/dd/yyyy HH:mm'
      )
    ).toBe('10/26/2017 17:00');
  });
...
describe('Gantt taskbar edit action', () => {
  ...
  it('Right resizing', () => {
    ...
    ganttObj.taskbarEditing = (args: ITaskbarEditedEventArgs) => {
      expect(
        ganttObj.getFormatedDate(args.data['EndDate'], 'MM/dd/yyyy HH:mm')
      ).toBe('10/26/2017 17:00');
      expect(args.taskBarEditAction).toBe('RightResizing');
    };
  ...
  it('Connector Line Left drag - drop outside the Gantt container', () => {
    ...
    let dragElement: HTMLElement = ganttObj.element.querySelector(
      '#' +
        ganttObj.element.id +
        'GanttTaskTableBody > tr:nth-child(5) > td > div.e-taskbar-main-container > div'
    ) as HTMLElement;
    triggerMouseEvent(
      dragElement,
      'mousedown',
    ...
    dragElement = ganttObj.element.querySelector(
      '#' +
        ganttObj.element.id +
        'GanttTaskTableBody > tr:nth-child(5) > td > div.e-taskbar-main-container > div.e-left-connectorpoint-outer-div > div.e-connectorpoint-left'
    ) as HTMLElement;
    triggerMouseEvent(
      dragElement,
      'mousedown',
...
describe('Gantt taskbar edit action', () => {
  ...
  it('Connector Line Right drag - drop inside the Gantt container', () => {
    ...
    dragElement = ganttObj.element.querySelector(
      '#' +
        ganttObj.element.id +
        'GanttTaskTableBody > tr:nth-child(5) > td > div.e-taskbar-main-container > div.e-right-connectorpoint-outer-div > div.e-connectorpoint-right'
    ) as HTMLElement;
    triggerMouseEvent(
      dragElement,
      'mousedown',
...
describe('Gantt taskbar edit action', () => {
  ...
  it('Connector Line drag - spec coverage', () => {
    let element: Element = ganttObj.element.querySelector(
      '#' +
        ganttObj.element.id +
        'GanttTaskTableBody > tr:nth-child(5) > td > div.e-taskbar-main-container'
    ) as Element;
    ganttObj.editModule.taskbarEditModule.showHideTaskBarEditingElements(
      null,
      element,
      false
    );
    ...
    element = ganttObj.element.querySelector(
      '#' +
        ganttObj.element.id +
        'GanttTaskTableBody > tr:nth-child(4) > td > div.e-taskbar-main-container'
    ) as Element;
    ganttObj.editModule.taskbarEditModule.showHideTaskBarEditingElements(
      null,
      element,
  ...
  it('Converting to milestone', () => {
    let dragElement: HTMLElement = ganttObj.element.querySelector(
      '#' +
        ganttObj.element.id +
        'GanttTaskTableBody > tr:nth-child(5) > td > div.e-taskbar-main-container > div.e-taskbar-right-resizer.e-icon'
    ) as HTMLElement;
    triggerMouseEvent(
      dragElement,
      'mousedown',
...
describe('Gantt taskbar edit action', () => {
  ...
  it('Check start date after dragging parent task', () => {
    let dragParentElement: HTMLElement = ganttObj.element.querySelector(
      '#' +
        ganttObj.element.id +
        'GanttTaskTableBody > tr:nth-child(4) > td > div.e-taskbar-main-container'
    ) as HTMLElement;
    triggerMouseEvent(
      dragParentElement,
      'mousedown',
      dragParentElement.offsetLeft,
      dragParentElement.offsetTop
    );
    triggerMouseEvent(
      dragParentElement,
      'mousemove',
      dragParentElement.offsetLeft + 40,
      0
    );
  ...
  it('Check parent milestone drag action', () => {
    let dragParentElement: HTMLElement = ganttObj.element.querySelector(
      '#' +
        ganttObj.element.id +
        'GanttTaskTableBody > tr:nth-child(8) > td > div.e-taskbar-main-container'
    ) as HTMLElement;
    triggerMouseEvent(
      dragParentElement,
      'mousedown',
...
describe('Disable offset validation', () => {
  ...
  it('Child right drag action', () => {
    ...
    let dragElement: HTMLElement = ganttObj.element.querySelector(
      '#' +
        ganttObj.element.id +
        'GanttTaskTableBody > tr:nth-child(4) > td > div.e-taskbar-main-container > div.e-gantt-child-taskbar-inner-div.e-gantt-child-taskbar'
    ) as HTMLElement;
    triggerMouseEvent(
      dragElement,
      'mousedown',
...
describe('milestone drop date', () => {
  ...
  it('Milestone drag action', () => {
    ganttObj.taskbarEdited = (args: ITaskbarEditedEventArgs) => {
      ...
      ).toBe('04/03/2019 17:00');
    };
    let dragElement: HTMLElement = ganttObj.element.querySelector(
      '#' +
        ganttObj.element.id +
        'GanttTaskTableBody > tr:nth-child(2) > td >div.e-taskbar-main-container'
    ) as HTMLElement;
    triggerMouseEvent(
      dragElement,
      'mousedown',
...
describe('Validate link CR issue', () => {
  ...
  it('Child drag action', () => {
    ganttObj.actionComplete = () => {
      expect(
        ganttObj.currentViewData[2].ganttProperties.predecessor.length
      ).toBe(0);
    };
    let dragElement: HTMLElement = ganttObj.element.querySelector(
      '#' +
...
describe('Disable progress resizer', () => {
  ...
  it('Progress Resizer disable when progress not mapped', () => {
    let dragElement: HTMLElement = ganttObj.element.querySelector(
      '#' +
        ganttObj.element.id +
        'GanttTaskTableBody > tr:nth-child(3) > td > div.e-taskbar-main-container > div.e-gantt-child-taskbar-inner-div.e-gantt-child-taskbar'
    ) as HTMLElement;
    triggerMouseEvent(
      dragElement,
      'mousemove',
      dragElement.offsetLeft + 5,
      dragElement.offsetTop + 5
    );
    expect(
      ganttObj.element
        .querySelector(
          '#' +
            ganttObj.element.id +
            'GanttTaskTableBody >tr:nth-child(3) > td > div.e-taskbar-main-container> div.e-child-progress-resizer'
        )
        .classList.contains('e-progress-resize-gripper')
    ).toBe(false);
    expect(
      document.getElementsByClassName('e-connectorpoint-right-hover').length
    ).toBe(1);
  });
});
describe('Schedule mode', () => {
  ...
  it('Manual parent task-right resizing', () => {
    ...
    let dragElement: HTMLElement = ganttObj.element.querySelector(
      '#' +
        ganttObj.element.id +
        'GanttTaskTableBody > tr:nth-child(1) > td > div.e-taskbar-main-container > div.e-manualparent-main-container > div.e-gantt-manualparenttaskbar-right'
    ) as HTMLElement;
    triggerMouseEvent(
      dragElement,
      'mousedown',
  ...
  it('Manual parent task-dragging', () => {
    ...
    let dragElement: HTMLElement = ganttObj.element.querySelector(
      '#' +
        ganttObj.element.id +
        'GanttTaskTableBody > tr:nth-child(1) > td > div.e-taskbar-main-container > div.e-manualparent-main-container'
    ) as HTMLElement;
    triggerMouseEvent(
      dragElement,
      'mousedown',
...
describe('parent child end date mismatch', () => {
  ...
  it('task end date check after parent drag', () => {
    let dragParentElement: HTMLElement = ganttObj.element.querySelector(
      '#' +
        ganttObj.element.id +
        'GanttTaskTableBody > tr:nth-child(1) > td > div.e-taskbar-main-container'
    ) as HTMLElement;
    triggerMouseEvent(
      dragParentElement,
      'mousedown',
    ...
    triggerMouseEvent(
      dragParentElement,
      'mousemove',
      dragParentElement.offsetLeft - 30,
      0
    );
    triggerMouseEvent(dragParentElement, 'mouseup');
    expect(
...
describe('CR issues', () => {
  ...
  it('dynamically enabling allowTaskbarEditing proprty', () => {
    ...
    let dragElement: HTMLElement = ganttObj.element.querySelector(
      '#' +
        ganttObj.element.id +
        'GanttTaskTableBody > tr:nth-child(2) > td > div.e-taskbar-main-container > div.e-gantt-milestone'
    ) as HTMLElement;
    triggerMouseEvent(
      dragElement,
      'mousedown',
...
describe('Split task -', () => {
  ...
  it('Merging tasks', () => {
    ...
    let dragElement: HTMLElement = ganttObj.element.querySelector(
      '#' +
        ganttObj.element.id +
        'GanttTaskTableBody > tr:nth-child(3) > td > div.e-taskbar-main-container > div.e-gantt-child-taskbar-inner-div.e-segment-first.e-gantt-child-taskbar.e-segmented-taskbar > div.e-taskbar-right-resizer.e-icon'
    ) as HTMLElement;
    triggerMouseEvent(
      dragElement,
      'mousedown',
  ...
  it('Date time picker in dialog segment tab', () => {
    ...
    addIcon.click();
    var timerExistence = document.querySelector(
      '#' +
        ganttObj.element.id +
        'SegmentsTabContainerEditForm > table > tbody > tr > td:nth-child(1) > div > span.e-input-group-icon.e-time-icon.e-icons'
    );
...
describe('Split task - with self data', () => {
  ...
  var segmentCollection = [
    { segmentId: 3, startDate: new Date('02/04/2019'), duration: 2 },
    { segmentId: 3, startDate: new Date('02/07/2019'), duration: 3 },
  ];
  beforeAll((done: Function) => {
    ganttObj = createGantt(
      {
...
describe('Multitaskbar issue', () => {
    ...
    ganttObj = createGantt(
      {
        ...
        actionComplete(args: any) {
          if (args.requestType == 'save') {
            expect(ganttObj.timelineModule.timelineStartDate.getDate()).toBe(
              28
            );
          }
        },
  ...
  it('Timespan gets changed', () => {
    ...
    let save: HTMLElement = document.querySelector(
...
describe('Split task -', () => {
  ...
  it('split over weekends', () => {
    ...
    expect(
      ganttObj.getFormatedDate(
        ganttObj.currentViewData[0].ganttProperties.segments[1].startDate,
        'MM/dd/yyyy'
      )
    ).toBe('02/12/2019');
  });
...
describe('Invalid Connector line', () => {
  ...
  it('Dependency editing - parent to parent', () => {
    ...
    let dragElement: HTMLElement = ganttObj.element.querySelector(
      '#' +
        ganttObj.element.id +
        'GanttTaskTableBody > tr:nth-child(1) > td > div.e-taskbar-main-container > div'
    ) as HTMLElement;
    triggerMouseEvent(
      dragElement,
      'mousedown',
    ...
    dragElement = ganttObj.element.querySelector(
      '#' +
        ganttObj.element.id +
        'GanttTaskTableBody > tr:nth-child(1) > td > div.e-taskbar-main-container > div.e-left-connectorpoint-outer-div > div.e-connectorpoint-left'
    ) as HTMLElement;
    triggerMouseEvent(
      dragElement,
      'mousedown',
  ...
  it('Dependency editing - parent to child', () => {
    ...
    let dragElement: HTMLElement = ganttObj.element.querySelector(
      '#' +
        ganttObj.element.id +
        'GanttTaskTableBody > tr:nth-child(2) > td > div.e-taskbar-main-container > div'
    ) as HTMLElement;
    triggerMouseEvent(
      dragElement,
      'mousedown',
    ...
    dragElement = ganttObj.element.querySelector(
      '#' +
        ganttObj.element.id +
        'GanttTaskTableBody > tr:nth-child(2) > td > div.e-taskbar-main-container > div.e-left-connectorpoint-outer-div > div.e-connectorpoint-left'
    ) as HTMLElement;
    triggerMouseEvent(
      dragElement,
      'mousedown',
...
describe('Custom task mode Connector line', () => {
  ...
  it('Dependency editing - manual parent to manual parent', () => {
    ...
    let dragElement = ganttObj.element.querySelector(
      '#' +
        ganttObj.element.id +
        'GanttTaskTableBody > tr:nth-child(1) > td > div.e-taskbar-main-container > div.e-manualparent-main-container > div.e-left-connectorpoint-outer-div > div.e-connectorpoint-left'
    ) as HTMLElement;
    triggerMouseEvent(
      dragElement,
      'mousedown',
    ...
    triggerMouseEvent(dragElement, 'mouseup');
    expect(ganttObj.flatData[4].ganttProperties.predecessorsName).toBe(
      '1SS+5 days'
    );
  });
  it('Dependency editing - manual parent to parent', () => {
    ...
    let dragElement = ganttObj.element.querySelector(
      '#' +
        ganttObj.element.id +
        'GanttTaskTableBody > tr:nth-child(5) > td > div.e-taskbar-main-container > div.e-manualparent-main-container > div.e-left-connectorpoint-outer-div > div.e-connectorpoint-left'
    ) as HTMLElement;
    triggerMouseEvent(
      dragElement,
      'mousedown',
  ...
  it('Dependency editing - child to manual parent', () => {
    ...
    let dragElement = ganttObj.element.querySelector(
      '#' +
        ganttObj.element.id +
        'GanttTaskTableBody > tr:nth-child(8) > td > div.e-taskbar-main-container > div.e-left-connectorpoint-outer-div > div.e-connectorpoint-left'
    ) as HTMLElement;
    triggerMouseEvent(
      dragElement,
      'mousedown',
...
describe('Dialog Edit for custom taskmode', () => {
  ...
  it('Dependency tab editing', () => {
    ...
    let add: any = document.getElementById(
      ganttObj.element.id + 'DependencyTabContainer_add'
    );
...
describe('Taskbar drag action', () => {
  ...
  it('Child Drag', () => {
    ...
    let dragElement: HTMLElement = ganttObj.element.querySelector(
      '#' +
        ganttObj.element.id +
        'GanttTaskTableBody > tr:nth-child(5) > td > div.e-taskbar-main-container > div.e-gantt-child-taskbar-inner-div.e-gantt-child-taskbar'
    ) as HTMLElement;
    triggerMouseEvent(
      dragElement,
      'mousedown',
...
describe('Splittasks data with day/hour mode', () => {
  ...
  it('Splittasks data with day/hour mode', () => {
    ...
    let dragElement: HTMLElement = ganttObj.element.querySelector(
      '#' +
        ganttObj.element.id +
        'GanttTaskTableBody > tr:nth-child(8) > td > div.e-taskbar-main-container > div.e-gantt-child-taskbar-inner-div.e-segment-last.e-gantt-child-taskbar.e-segmented-taskbar > div.e-taskbar-left-resizer.e-icon'
    ) as HTMLElement;
    triggerMouseEvent(
      dragElement,
      'mousedown',
...
describe('Taskbar drag drop', () => {
  ...
  it('Taskbar Drag and drop', () => {
    ...
    let dragElement: HTMLElement = ganttObj.element
      .querySelector(
        '#' + ganttObj.element.id + 'GanttTaskTableBody > tr:nth-child(1)'
      )
      .getElementsByClassName('e-taskbar-main-container')[1] as HTMLElement;
    triggerMouseEvent(
      dragElement,
      'mousedown',
      dragElement.offsetLeft,
...
describe('offset value not updating issue', () => {
  ...
  it('check offset value after connecting predecessors', () => {
    let dragElement: HTMLElement = ganttObj.element.querySelector(
      '#' +
        ganttObj.element.id +
        'GanttTaskTableBody > tr:nth-child(9) > td > div.e-taskbar-main-container > div'
    ) as HTMLElement;
    triggerMouseEvent(
      dragElement,
      'mousedown',
    ...
    dragElement = ganttObj.element.querySelector(
      '#' +
        ganttObj.element.id +
        'GanttTaskTableBody > tr:nth-child(9) > td > div.e-taskbar-main-container > div.e-right-connectorpoint-outer-div > div.e-connectorpoint-right'
    ) as HTMLElement;
    triggerMouseEvent(
      dragElement,
      'mousedown',
    ...
    let dragElement1: HTMLElement = ganttObj.element.querySelector(
      '#' +
        ganttObj.element.id +
        'GanttTaskTableBody > tr:nth-child(8) > td > div.e-taskbar-main-container > div'
    ) as HTMLElement;
    triggerMouseEvent(
      dragElement1,
      'mousedown',
      dragElement1.offsetLeft,
      dragElement1.offsetTop
    );
    dragElement1 = ganttObj.element.querySelector(
      '#' +
        ganttObj.element.id +
        'GanttTaskTableBody > tr:nth-child(8) > td > div.e-taskbar-main-container > div.e-right-connectorpoint-outer-div > div.e-connectorpoint-right'
    ) as HTMLElement;
    triggerMouseEvent(
      dragElement1,
      'mousedown',
...
describe('cloneTaskbar drag drop', () => {
  ...
  it('Taskbar Drag and drop', () => {
    ...
    triggerMouseEvent(dragElement, 'mousemove', 70, 150);
    var cloneElement =
      ganttObj.element.getElementsByClassName('e-clone-taskbar');
    expect(!isNullOrUndefined(cloneElement)).toBe(true);
    var resizeCheck =
      ganttObj.ganttChartModule.chartBodyContainer.querySelector(
...
describe('clone taskbar edit action', () => {
  ...
  it('Left resizing -  edited cancel', () => {
    ...
    expect(
      ganttObj.getFormatedDate(
        ganttObj.flatData[1].ganttProperties.startDate,
        'MM/dd/yyyy HH:mm'
      )
    ).toBe('10/20/2017 08:00');
  });
...
describe('Split task- Unable to merge two segments lies between holidays', () => {
  ...
  it('Merging tasks while lies between holidays', () => {
    let dragElement: HTMLElement = ganttObj.element.querySelector(
      '#' +
        ganttObj.element.id +
        'GanttTaskTableBody > tr:nth-child(1) > td > div.e-taskbar-main-container > div.e-gantt-child-taskbar-inner-div.e-segment-last.e-gantt-child-taskbar.e-segmented-taskbar > div.e-taskbar-left-resizer.e-icon'
    ) as HTMLElement;
    triggerMouseEvent(
      dragElement,
      'mousedown',
...
describe('Overallocation container not rendered after taskbar resize', () => {
  ...
  it('check range container rendered', () => {
    ganttObj.taskbarEdited = (args: ITaskbarEditedEventArgs) => {
      expect(
        document.getElementsByClassName('e-rg-rangdiv e-leftarc').length
      ).toBe(1);
    };
    ...
    let dragElement: HTMLElement = ganttObj.element.querySelector(
      '#' +
        ganttObj.element.id +
        'GanttTaskTableBody > tr:nth-child(4) > td > div.e-taskbar-main-container > div.e-taskbar-left-resizer.e-icon'
    ) as HTMLElement;
    triggerMouseEvent(
      dragElement,
      'mousedown',
...
describe('Incorrect offset update while dragging taskbar', () => {
  ...
  it('checking offset', () => {
    let dragElement: HTMLElement = ganttObj.element.querySelector(
      '#' +
        ganttObj.element.id +
        'GanttTaskTableBody > tr:nth-child(9) > td > div.e-taskbar-main-container > div.e-gantt-child-taskbar-inner-div.e-gantt-child-taskbar'
    ) as HTMLElement;
    triggerMouseEvent(
      dragElement,
      'mousedown',
...
describe('Slow update multiple connector lines', () => {
  ...
  it('Checking updated value', () => {
    let dragElement: HTMLElement = ganttObj.element.querySelector(
      '#' +
        ganttObj.element.id +
        'GanttTaskTableBody > tr:nth-child(1) > td > div.e-taskbar-main-container > div.e-gantt-child-taskbar-inner-div.e-gantt-child-taskbar'
    ) as HTMLElement;
    triggerMouseEvent(
      dragElement,
      'mousedown',
...
describe('Disable Overlap and child Drag in Resource view', () => {
  ...
  it('Child Drag', () => {
    ganttObj.actionComplete = (args) => {
      expect(parseInt(ganttObj.currentViewData[2].ganttProperties.taskId)).toBe(
        3
      );
    };
    ...
    let dragElement: HTMLElement = ganttObj.element.querySelector(
      '#' +
        ganttObj.element.id +
        'GanttTaskTableBody > tr:nth-child(3) > td > div.e-taskbar-main-container'
    ) as HTMLElement;
    triggerMouseEvent(
      dragElement,
      'mousedown',
...
describe('Incorrect offset update while dragging taskbar - CR 544540', () => {
  ...
  it('checking offset', () => {
    let dragElement: HTMLElement = ganttObj.element.querySelector(
      '#' +
        ganttObj.element.id +
        'GanttTaskTableBody > tr:nth-child(7) > td > div.e-taskbar-main-container > div.e-gantt-child-taskbar-inner-div.e-gantt-child-taskbar'
    ) as HTMLElement;
    triggerMouseEvent(
      dragElement,
      'mousedown',
    ...
    triggerMouseEvent(dragElement, 'mouseup');
    let storeOffset: any =
      ganttObj.currentViewData[6].ganttProperties.predecessor[0].offset;
    let dragElement1: HTMLElement = ganttObj.element.querySelector(
      '#' +
        ganttObj.element.id +
        'GanttTaskTableBody > tr:nth-child(6) > td > div.e-taskbar-main-container > div.e-gantt-child-taskbar-inner-div.e-gantt-child-taskbar'
    ) as HTMLElement;
    triggerMouseEvent(
      dragElement1,
      'mousedown',
...
describe('CR-882787 Dependency ', () => {
  ...
  it('Checking updated value', () => {
    let dragElement: HTMLElement = ganttObj.element.querySelector(
      '#' +
        ganttObj.element.id +
        'GanttTaskTableBody > tr:nth-child(13) > td > div.e-taskbar-main-container > div.e-gantt-child-taskbar-inner-div.e-gantt-child-taskbar'
    ) as HTMLElement;
    triggerMouseEvent(
      dragElement,
      'mousedown',
    ...
    expect(
      ganttObj.getFormatedDate(
        ganttObj.currentViewData[12].ganttProperties.startDate,
        'MM/dd/yyyy'
      )
    ).toBe('04/04/2022');
  });
...
describe('Split task left resize', () => {
  ...
  it('duration calculation', () => {
    ...
    let dragElement: HTMLElement = ganttObj.element.querySelector(
      '#' +
        ganttObj.element.id +
        'GanttTaskTableBody > tr:nth-child(2) > td > div.e-taskbar-main-container > div.e-gantt-child-taskbar-inner-div.e-segment-last.e-gantt-child-taskbar.e-segmented-taskbar > div.e-taskbar-left-resizer.e-icon'
    ) as HTMLElement;
    triggerMouseEvent(
      dragElement,
      'mousedown',
...
describe('Validating predecessor with preserveLinkWithEditing to false', () => {
  ...
  it('Checking for dependency offset SS', (done: Function) => {
    ...
    triggerMouseEvent(dragElement, 'mouseup');
    document
      .getElementById(ganttObj.element.id + '_dialogValidationRule')
      .querySelector('#' + ganttObj.element.id + '_ValidationAddlineOffset')[
      'checked'
    ] = true;
...
describe('Validating predecessor with removeLink to true', () => {
  ...
  it('Removing parent dependency', (done: Function) => {
    ...
    let dragElement: HTMLElement = ganttObj.element.querySelector(
      '#' +
        ganttObj.element.id +
        'GanttTaskTableBody > tr:nth-child(3) > td > div.e-taskbar-main-container > div.e-gantt-parent-taskbar-inner-div.e-gantt-parent-taskbar'
    ) as HTMLElement;
    triggerMouseEvent(
      dragElement,
      'mousedown',
...
describe('Show active predecessor', () => {
  ...
  it('Check if the correct class is added', () => {
    ...
    ganttObj.editModule.taskbarEditModule.taskBarEditElement =
      ganttObj.chartPane.querySelectorAll(
        '.e-taskbar-main-container'
      )[1] as HTMLElement;
    ganttObj.editModule.taskbarEditModule['showHideActivePredecessors'](true);
    expect(
      document.getElementsByClassName('e-active-child-task').length > 0
    ).toBe(true);
  });
  afterAll(() => {
    if (ganttObj) {
...
describe('Hiding Pop up', () => {
  ...
  it('Check if the correct class is removed', () => {
    ...
    expect(
      document.getElementsByClassName('e-gridpopup')[0]['style'].display
    ).toBe('none');
  });
  afterAll(() => {
    if (ganttObj) {
...
describe('Getting co-ordinates', () => {
  ...
  it('Checking obtained co-ordinate', () => {
    ...
    const coordinates =
      ganttObj.editModule.taskbarEditModule['getCoordinate'](touchMoveEvent);
  ...
  it('Checking for taskbar end date', (done: Function) => {
    ganttObj.actionComplete = function (args: any): void {
      if (args.requestType === 'save') {
        expect(
          ganttObj.getFormatedDate(
            ganttObj.flatData[5].ganttProperties.startDate,
            'M/d/yyyy'
          )
        ).toBe('4/8/2019');
        done();
    ...
    let dragElement: HTMLElement = ganttObj.element.querySelector(
      '#' +
        ganttObj.element.id +
        'GanttTaskTableBody > tr:nth-child(3) > td > div.e-taskbar-main-container > div.e-gantt-parent-taskbar'
    ) as HTMLElement;
    triggerMouseEvent(
      dragElement,
      'mousedown',
...
describe('Changing first segment position', () => {
  ...
  it('Checking segment length', () => {
    ganttObj.taskbarEdited = () => {
      expect(
        ganttObj.getFormatedDate(
          ganttObj.flatData[2].ganttProperties.startDate,
          'M/d/yyyy'
        )
      ).toBe('2/6/2019');
    };
    let dragElement: HTMLElement = ganttObj.element.querySelector(
      '#' +
        ganttObj.element.id +
        'GanttTaskTableBody > tr:nth-child(3) > td > div.e-taskbar-main-container > div.e-gantt-child-taskbar'
    ) as HTMLElement;
    triggerMouseEvent(
      dragElement,
      'mousedown',
...
describe('Trigerring dependency event', () => {
  ...
  it('Checking for predecessor tooltip', () => {
    ...
    ganttObj.editModule.taskbarEditModule.connectorSecondAction =
      'ConnectorPointLeftDrag';
    ganttObj.editModule.taskbarEditModule.connectorSecondElement =
      document.getElementsByClassName('e-taskbar-main-container')[5];
    ...
    expect(document.getElementsByClassName('e-gantt-tooltip').length > 0).toBe(
      true
    );
  });
  afterAll(() => {
...
describe('890951 - Duration column is not working properly when using editType as numericedit ', () => {
  ...
  it('Right resizing', () => {
    ...
    let dragElement: HTMLElement = ganttObj.element.querySelector(
      '#' +
        ganttObj.element.id +
        'GanttTaskTableBody > tr:nth-child(2) > td > div.e-taskbar-main-container > div.e-segment-last > div.e-taskbar-right-resizer.e-icon'
    ) as HTMLElement;
    triggerMouseEvent(
      dragElement,
      'mousedown',
...
describe('Checking for offset in autoCalculateDateScheduling to false', () => {
  ...
  it('Moving Taskbar', () => {
    let dragElement: HTMLElement = ganttObj.element.querySelector(
      '#' +
        ganttObj.element.id +
        'GanttTaskTableBody > tr:nth-child(4) > td > div.e-taskbar-main-container >div.e-gantt-child-taskbar'
    ) as HTMLElement;
    triggerMouseEvent(
      dragElement,
      'mousedown',
...
describe('taskbar drag and drop', () => {
  ...
  it('progress resize', () => {
    let dragElement: any = ganttObj.element.querySelector(
      '#' +
        ganttObj.element.id +
        'GanttTaskTableBody > tr:nth-child(3) > td > div.e-taskbar-main-container > div.e-child-progress-resizer'
    );
  ...
  it('left resize', () => {
    let dragElement: any = ganttObj.element.querySelector(
      '#' +
        ganttObj.element.id +
        'GanttTaskTableBody > tr:nth-child(3) > td > div.e-taskbar-main-container > div.e-gantt-child-taskbar-inner-div.e-segment-first.e-gantt-child-taskbar.e-segmented-taskbar > div.e-taskbar-left-resizer.e-icon'
    );
    triggerMouseEvent(
      dragElement,
      'mousedown',
  ...
  it('child drag', () => {
    let dragElement: any = ganttObj.element.querySelector(
      '#' +
        ganttObj.element.id +
        'GanttTaskTableBody > tr:nth-child(3) > td > div.e-taskbar-main-container > div.e-gantt-child-taskbar-inner-div.e-segment-first.e-gantt-child-taskbar.e-segmented-taskbar'
    );
    triggerMouseEvent(
      dragElement,
      'mousedown',
  ...
  it('last child drag', () => {
    let dragElement: any = ganttObj.element.querySelector(
      '#' +
        ganttObj.element.id +
        'GanttTaskTableBody > tr:nth-child(3) > td > div.e-taskbar-main-container > div.e-gantt-child-taskbar-inner-div.e-segment-last.e-gantt-child-taskbar.e-segmented-taskbar'
    );
    triggerMouseEvent(
      dragElement,
      'mousedown',
  ...
  it('connetor point left drag', () => {
    let dragElement: any = ganttObj.element.querySelector(
      '#' +
        ganttObj.element.id +
        'GanttTaskTableBody > tr:nth-child(3) > td > div.e-taskbar-main-container > div.e-left-connectorpoint-outer-div > div.e-connectorpoint-left'
    ) as HTMLElement;
    triggerMouseEvent(
      dragElement,
      'mousedown',
  ...
  it('connetor point right drag', () => {
    let dragElement: any = ganttObj.element.querySelector(
      '#' +
        ganttObj.element.id +
        'GanttTaskTableBody > tr:nth-child(3) > td > div.e-taskbar-main-container > div.e-right-connectorpoint-outer-div > div.e-connectorpoint-right'
    ) as HTMLElement;
    triggerMouseEvent(
      dragElement,
      'mousedown',
...
describe('resource view taskbar drag and drop', () => {
  ...
  it('connetor point right drag', () => {
    let dragElement: any = ganttObj.element.querySelector(
      '#' +
        ganttObj.element.id +
        'GanttTaskTableBody > tr:nth-child(2) > td > div.e-taskbar-main-container > div.e-right-connectorpoint-outer-div > div.e-connectorpoint-right'
    ) as HTMLElement;
    triggerMouseEvent(
      dragElement,
      'mousedown',
...
describe('taskbar drag and drop', () => {
  ...
  it('roundoffstart', () => {
    ganttObj.editModule.taskbarEditModule.taskBarEditRecord =
      ganttObj.flatData[2];
    ganttObj.editModule.taskbarEditModule['getRoundOffEndLeft'](
      ganttObj.flatData[2],
      true
    );
    ganttObj.editModule.taskbarEditModule['getRoundOffEndLeft'](
    ...
    ganttObj.editModule.taskbarEditModule.getRoundOffStartLeft(
      ganttObj.flatData[2],
      true
    );
    ganttObj.editModule.taskbarEditModule.getRoundOffStartLeft(
  ...
  it('split task leftresize', () => {
    ...
    ganttObj.editModule.taskbarEditModule.taskBarEditRecord =
      ganttObj.flatData[2];
    ganttObj.editModule.taskbarEditModule['enableSplitTaskLeftResize'](
      ganttObj.flatData[2].ganttProperties
    );
  ...
  it('validate width', () => {
    ...
    ganttObj.editModule.taskbarEditModule['validateProgressWidth'](
      ganttObj.flatData[2].ganttProperties,
      50,
      500
    );
...
describe('Checking update segmentData', () => {
  ...
  it('Moving Taskbar', () => {
    let dragElement: HTMLElement = ganttObj.element.querySelector(
      '#' +
        ganttObj.element.id +
        'GanttTaskTableBody > tr:nth-child(2) > td > div.e-taskbar-main-container >div.e-segment-last'
    ) as HTMLElement;
    triggerMouseEvent(
      dragElement,
      'mousedown',
...
describe('Taskbar drag action', () => {
  ...
  it('Date check', () => {
    ...
    triggerMouseEvent(dragElement, 'mouseup');
    let date = ganttObj.getFormatedDate(
      ganttObj.flatData[4].ganttProperties.startDate,
      'MM/dd/yyyy'
    );
    let dragElement1: HTMLElement = ganttObj.element.querySelector(
      '#' +
    ...
    triggerMouseEvent(
      dragElement1,
      'mousemove',
      dragElement1.offsetLeft + 200,
      0
    );
    triggerMouseEvent(dragElement1, 'mouseup');
    let date1 = ganttObj.getFormatedDate(
      ganttObj.flatData[4].ganttProperties.startDate,
      'MM/dd/yyyy'
    );
