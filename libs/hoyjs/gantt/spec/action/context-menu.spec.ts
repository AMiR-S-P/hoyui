...
import { ItemModel } from '@hoyui/navigations';
import { ContextMenuItemModel } from '@hoyui/grids';
let contextMenuItems: (string | ContextMenuItemModel)[] = [
  'AutoFitAll',
  'AutoFit',
  'TaskInformation',
  'DeleteTask',
...
describe('Context-', () => {
  ...
  describe('Content menu -', () => {
    ...
    beforeEach((done: Function) => {
      let $tr: HTMLElement = ganttObj.element.querySelector(
        '#treeGrid' +
          ganttObj.element.id +
          '_gridcontrol_content_table > tbody > tr:nth-child(2)'
      ) as HTMLElement;
    ...
    it('indent record', () => {
      ...
      expect(
        (ganttObj.flatData[10] as IGanttData).taskData[ganttObj.taskFields.id]
      ).toBe(10);
    });
  });
  ...
  describe('header menu -', () => {
    ...
    beforeEach((done: Function) => {
      let taskName: HTMLElement = ganttObj.element.querySelectorAll(
        '.e-headercell'
      )[1] as HTMLElement;
    ...
    it('Rendering', () => {
      let contextmenu: HTMLElement = document.getElementById(
        'treeGrid' + ganttObj.element.id + '_gridcontrol_cmenu'
      );
    ...
    it('Sorting', () => {
      ...
      let sortID: string =
        'treeGrid' + ganttObj.element.id + '_gridcontrol_cmenu_SortDescending';
      let sortElement: HTMLElement = document.getElementById(sortID);
      triggerMouseEvent(sortElement, 'click');
    });
    it('AutoFit', () => {
      let AutoFit: string =
        'treeGrid' + ganttObj.element.id + '_gridcontrol_cmenu_AutoFit';
  ...
  describe('Content menu -', () => {
    ...
    it('Parent record', () => {
      let eventArgs = {
        target: ganttObj.element.querySelector(
          '#treeGrid' +
            ganttObj.element.id +
            '_gridcontrol_content_table > tbody > tr:nth-child(2)'
        ) as HTMLElement,
  ...
  describe('Content menu -', () => {
    ...
    beforeEach((done: Function) => {
      let $tr: HTMLElement = ganttObj.element.querySelector(
        '#treeGrid' +
          ganttObj.element.id +
          '_gridcontrol_content_table > tbody > tr:nth-child(8) > td:nth-child(2)'
      ) as HTMLElement;
      triggerMouseEvent($tr, 'contextmenu', 0, 0, false, false, 2);
      setTimeout(done, 500);
    });
    ...
    it('Delete Depedency', (done: Function) => {
      let $tr: HTMLElement = ganttObj.element.querySelector(
        '#treeGrid' +
          ganttObj.element.id +
          '_gridcontrol_content_table > tbody > tr:nth-child(6) > td:nth-child(2)'
      ) as HTMLElement;
      triggerMouseEvent($tr, 'contextmenu', 0, 0, false, false, 2);
      let e = {
      ...
      (ganttObj.contextMenuModule as any).contextMenuItemClick(e);
      expect(
        ganttObj.currentViewData[5].ganttProperties.predecessorsName
      ).toEqual('4FS+3 days,5FS');
      done();
    });
    it('Save & Cancel', (done: Function) => {
      ...
      expect(ganttObj.currentViewData[1].ganttProperties.taskName).toEqual(
        'Planning'
      );
      triggerMouseEvent(record, 'dblclick');
    ...
    it('Delete Record', (done: Function) => {
      ...
      (ganttObj.contextMenuModule as any).contextMenuItemClick(e);
      let ok: HTMLElement = ganttObj.element.querySelector(
        '#' +
          ganttObj.element.id +
          '_deleteConfirmDialog > div.e-footer-content > button'
      );
  ...
  describe('Context menu - spec coverage -', () => {
    ...
    it('Disable editing', () => {
      ...
      let $tr: HTMLElement = ganttObj.element.querySelector(
        '#' +
          ganttObj.element.id +
          'GanttTaskTableBody > tr:nth-Child(5) > td > div.e-left-label-container'
      ) as HTMLElement;
      triggerMouseEvent($tr, 'contextmenu', 0, 0, false, false, 2);
      let taskInfo: HTMLElement = document.getElementById(
        ganttObj.element.id + '_contextMenu_TaskInformation'
  ...
  describe('Schedule mode', () => {
    ...
    it('Changing taskmode of a task to auto', (done: Function) => {
      ...
      let $tr: HTMLElement = ganttObj.element.querySelector(
        '#treeGrid' +
          ganttObj.element.id +
          '_gridcontrol_content_table > tbody > tr:nth-child(3)'
      ) as HTMLElement;
      triggerMouseEvent($tr, 'contextmenu', 0, 0, false, false, 2);
      setTimeout(done, 500);
      let e: ContextMenuClickEventArgs = {
  ...
  describe('Modifying segments using custom context menu', () => {
    ...
    let editingData: Object[] = [
      {
        ...
        subtasks: [
          ...
          },
          {
            ...
            Progress: 50,
            resources: [
              { resourceId: 3, resourceUnit: 25 },
              { resourceId: 1, resourceUnit: 75 },
            ],
          },
        ],
      },
    ...
    it('Custom context menu', () => {
      ganttObj.contextMenuClick = function (args: ContextMenuClickEventArgs) {
        ...
        expect(ganttObj.currentViewData[16].ganttProperties.segments).toBe(
          null
        );
      };
  ...
  describe('Context menu -', () => {
    ...
    it('Convert  to milestone', () => {
      ...
      (ganttObj.contextMenuModule as any).contextMenuItemClick(e);
      expect(ganttObj.currentViewData[2].ganttProperties.isMilestone)
        .toBeTruthy;
    });
    it('merge Task', () => {
      let $tr: HTMLElement = ganttObj.element.querySelector(
        '#' +
          ganttObj.element.id +
          'GanttTaskTableBody > tr:nth-child(5) > td > div.e-taskbar-main-container > div.e-gantt-child-taskbar-inner-div'
      ) as HTMLElement;
      triggerMouseEvent($tr, 'contextmenu', 0, 0, false, false, 2);
      let e: ContextMenuClickEventArgs = {
      ...
      expect(
        ganttObj.getFormatedDate(
          ganttObj.currentViewData[4]['EndDate'],
          'MM/dd/yyyy'
        )
      ).toBe('02/15/2019');
    });
  ...
  describe('Context menu -', () => {
    ...
    it('Add record for splittask- Below', () => {
      ...
      (ganttObj.contextMenuModule as any).contextMenuItemClick(e);
      expect(
        ganttObj.currentViewData[3].ganttProperties.segments[0].width
      ).not.toBe(0);
    });
    afterAll(() => {
      destroyGantt(ganttObj);
  ...
  describe('Schedule mode Custom', () => {
    ...
    it('Changing Custom taskmode of a task to manual', (done: Function) => {
      expect(ganttObj.currentViewData[2].ganttProperties.isAutoSchedule).toBe(
        true
      );
      let taskName: HTMLElement = ganttObj.element.querySelector(
        '#treeGrid' +
  ...
  describe('Incorrect row height', () => {
    ...
    it('Changing taskmode of a task to manual', () => {
      expect(
        document.getElementsByClassName('e-gantt-manualparenttaskbar-right')[0][
          'style'
        ].height
      ).toBe('11.5px');
    });
  ...
  describe('Context_Menu - Unscheduled_Task', () => {
    ...
    it('unscheduled task', () => {
      expect(
        ganttObj.element
          .getElementsByClassName('e-taskbar-main-container')[3]
          .children[1].classList.contains('e-gantt-unscheduled-taskbar')
      ).toBe(true);
      let e: ContextMenuClickEventArgs = {
        item: { id: ganttObj.element.id + '_contextmenu_ToMilestone' },
        element: null,
    ...
    it('disable prevTimespan when adding child for unscheduledTasks', function () {
      expect(
        ganttObj.element
          .getElementsByClassName('e-timeline-top-header-cell')[0]
          .getAttribute('aria-label')
          .indexOf('Timeline cell 1/28/2019') > -1
      ).toBeTruthy();
      let e: ContextMenuClickEventArgs = {
        item: { id: ganttObj.element.id + '_contextmenu_Child' },
        element: null,
  ...
  describe('Hide Context Menu Items', () => {
      ...
      ganttObj = createGantt(
        {
          ...
          contextMenuOpen(args?: ContextMenuOpenEventArgs): void {
            ...
            if (args.type !== 'Header') {
              ...
              testItem.text = 'Test';
              testItem.items = [{}];
              let menuObj: any = (<EJ2Instance>(
                document.getElementById(ganttObj.element.id + '_contextmenu')
    ...
    it('disable Items', () => {
      let selectRow: HTMLElement = ganttObj.element.querySelector(
        '#treeGrid' +
          ganttObj.element.id +
          '_gridcontrol_content_table > tbody > tr:nth-child(3)'
      ) as HTMLElement;
    ...
    it('split task - margin left for parent div', () => {
      ganttObj.actionBegin = function (args: any): void {
        if (args.requestType === 'splitTaskbar') {
          args.splitDate = ganttObj.dateValidationModule.setTime(
            ganttObj.defaultEndTime,
            args.splitDate
          );
        }
      };
      let ganttElement: HTMLElement = document.querySelector(
        '#' + ganttObj.element.id
      ) as HTMLElement;
      ganttElement.style.marginLeft = '350px';
      ganttObj.splitTask(4, new Date('02/04/2019'));
      let segment: HTMLElement = document.querySelector(
        '#' +
          ganttObj.element.id +
          'GanttTaskTableBody > tr:nth-child(4) > td > div.e-taskbar-main-container > div.e-gantt-child-taskbar-inner-div.e-gantt-child-taskbar > div'
      ) as HTMLElement;
      ...
      (ganttObj.contextMenuModule as any).contextMenuItemClick(e);
      expect(ganttObj.currentViewData[3].ganttProperties.segments.length).toBe(
        2
      );
    });
    afterAll(() => {
    ...
    it('Baseline should remain same', () => {
      ganttObj.actionComplete = (args?: any): void => {
        if (args.requestType == 'save') {
          expect(
            ganttObj.currentViewData[0].ganttProperties.baselineWidth
          ).toBe(33);
        }
      };
  ...
  describe('Bug-837574-Can not open task information in the contextmenu', () => {
    ...
    it('Checking is TaskID value is string', () => {
      ganttObj.dataBind();
      expect(typeof ganttObj.currentViewData[0].ganttProperties.taskId).toBe(
        'string'
      );
    });
    afterAll(() => {
  ...
  describe('CR - 872834 : The context menu using "add child" for any task, dependency line validation is not working properly', () => {
    ...
    it('Add record - Child', () => {
      ...
      (ganttObj.contextMenuModule as any).contextMenuItemClick(e);
      expect(
        ganttObj.currentViewData[1].ganttProperties.predecessor.length
      ).toBe(0);
    });
  });
});
...
describe('Split taskbar date validation', () => {
  ...
  it('split task - date validation', () => {
    ...
    let segment: HTMLElement = document.querySelector(
      '#' +
        ganttObj.element.id +
        'GanttTaskTableBody > tr:nth-child(3) > td > div.e-taskbar-main-container > div.e-gantt-child-taskbar-inner-div.e-gantt-child-taskbar > div'
    ) as HTMLElement;
    triggerMouseEvent(segment, 'contextmenu', 0, 0, false, false, 2);
    let e: ContextMenuClickEventArgs = {
      item: { id: ganttObj.element.id + '_contextMenu_SplitTask' },
...
describe('Deleting task with adaptive', () => {
  ...
  beforeEach(() => {
    let $tr: HTMLElement = ganttObj.element.querySelector(
      '#treeGrid' +
        ganttObj.element.id +
        '_gridcontrol_content_table > tbody > tr:nth-child(4)'
    ) as HTMLElement;
    triggerMouseEvent($tr, 'contextmenu', 0, 0, false, false, 2);
  });
...
describe('Merging task left', () => {
  ...
  beforeEach(() => {
    let $tr: HTMLElement = ganttObj.chartPane.querySelector(
      '.e-segment-last'
    ) as HTMLElement;
    triggerMouseEvent($tr, 'contextmenu', 0, 0, false, false, 2);
  });
...
describe('Context menu on unschedule task', () => {
  ...
  it('Converting to task', () => {
    let $tr: HTMLElement = ganttObj.chartPane
      .querySelector('.e-gantt-unscheduled-task ')
      .querySelector('.e-gantt-unscheduled-taskbar') as HTMLElement;
    triggerMouseEvent($tr, 'contextmenu', 0, 0, false, false, 2);
