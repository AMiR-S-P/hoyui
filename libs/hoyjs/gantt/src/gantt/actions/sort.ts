import { TreeGrid, Sort as TreeGrdSort } from '@hoyui/treegrid';
import { Gantt } from '../base/gantt';
import { SortDirection, getActualProperties } from '@hoyui/grids';
...
export class Sort {
  ...
  constructor(gantt: Gantt) {
    ...
    this.parent.treeGrid.sortSettings = getActualProperties(
      this.parent.sortSettings
    );
