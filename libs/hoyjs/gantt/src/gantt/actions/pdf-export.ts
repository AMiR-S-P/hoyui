...
} from './../export/pdf-base/index';
import { isNullOrUndefined, getValue, extend } from '@hoyui/base';
...
export class PdfExport {
  ...
  private exportWithData(
    ...
    if (
      ...
      if (pdfExportProperties.exportType === 'CurrentViewData') {
        this.helper.beforeSinglePageExport['cloneFlatData'] = extend(
          [],
      ...
      this.helper.beforeSinglePageExport['cloneCurrentViewData'] = extend(
        [],
        this.parent.currentViewData,
        null,
        true
  ...
  private processExport(
    ...
    return new Promise((resolve: Function, reject: Function) => {
      ...
      const layouter: PdfTreeGridLayoutResult = this.gantt.drawGrid(
        this.pdfPage,
        0,
        0,
        format
      ...
      if (
        this.helper.exportProps &&
        this.helper.exportProps.fitToWidthSettings &&
        this.helper.exportProps.fitToWidthSettings.isFitToWidth
      ) {
        this.parent.zoomingProjectStartDate =
          this.helper.beforeSinglePageExport['zoomingProjectStartDate'];
        this.parent.zoomingProjectEndDate =
          this.helper.beforeSinglePageExport['zoomingProjectEndDate'];
        this.parent.cloneProjectStartDate =
          this.helper.beforeSinglePageExport['cloneProjectStartDate'];
        this.parent.cloneProjectEndDate =
          this.helper.beforeSinglePageExport['cloneProjectEndDate'];
        this.parent.timelineModule.customTimelineSettings =
          this.helper.beforeSinglePageExport['customTimelineSettings'];
        this.parent.isTimelineRoundOff =
          this.helper.beforeSinglePageExport['isTimelineRoundOff'];
        this.parent.timelineModule.topTier =
          this.helper.beforeSinglePageExport['topTier'];
        this.parent.timelineModule.topTierCellWidth =
          this.helper.beforeSinglePageExport['topTierCellWidth'];
        this.parent.timelineModule.topTierCollection =
          this.helper.beforeSinglePageExport['topTierCollection'];
        this.parent.timelineModule.bottomTier =
          this.helper.beforeSinglePageExport['bottomTier'];
        this.parent.timelineModule.bottomTierCellWidth =
          this.helper.beforeSinglePageExport['bottomTierCellWidth'];
        this.parent.timelineModule.bottomTierCollection =
          this.helper.beforeSinglePageExport['bottomTierCollection'];
        this.parent.timelineModule.totalTimelineWidth =
          this.helper.beforeSinglePageExport['totalTimelineWidth'];
        this.parent.timelineModule.timelineStartDate =
          this.helper.beforeSinglePageExport['timelineStartDate'];
        this.parent.timelineModule.timelineEndDate =
          this.helper.beforeSinglePageExport['timelineEndDate'];
        this.parent.timelineModule.timelineRoundOffEndDate =
          this.helper.beforeSinglePageExport['timelineRoundOffEndDate'];
        this.parent.perDayWidth =
          this.helper.beforeSinglePageExport['perDayWidth'];
        this.parent.updatedConnectorLineCollection =
          this.helper.beforeSinglePageExport['updatedConnectorLineCollection'];
      }
  ...
  private processSectionExportProperties(
    ...
    if (!isNullOrUndefined(pdfExportProperties)) {
      ...
      if (
        ...
        pdfExportProperties.pageOrientation === 'Portrait'
      ) {
      ...
      if (!isNullOrUndefined(pdfExportProperties.ganttStyle)) {
        const defaultGanttTheme: IGanttStyle = new PdfGanttTheme(
          pdfExportProperties.theme
        ).style;
        this.gantt.ganttStyle = extend(
          {},
          defaultGanttTheme,
          pdfExportProperties.ganttStyle,
          true
        );
      } else {
        this.gantt.ganttStyle = new PdfGanttTheme(
          pdfExportProperties.theme
        ).style;
      }
    } else {
