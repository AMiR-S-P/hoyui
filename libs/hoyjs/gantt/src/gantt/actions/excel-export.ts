import { TreeGrid, ExcelExport as TreeGridExcel } from '@hoyui/treegrid';
...
export class ExcelExport {
  ...
  private bindEvents(): void {
    ...
    this.parent.treeGrid.excelQueryCellInfo = (
      args: ExcelQueryCellInfoEventArgs
    ) => {
      this.parent.trigger('excelQueryCellInfo', args);
    };
    this.parent.treeGrid.excelHeaderQueryCellInfo = (
      args: ExcelHeaderQueryCellInfoEventArgs
    ) => {
      this.parent.trigger('excelHeaderQueryCellInfo', args);
    };
    this.parent.treeGrid.excelExportComplete = (
