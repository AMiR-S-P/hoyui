...
import { ContextMenuOpenEventArgs as GridContextMenuOpenEventArgs } from '@hoyui/grids';
import { ContextMenuClickEventArgs as GridContextMenuClickEventArgs } from '@hoyui/grids';
import { RecordDoubleClickEventArgs as GridRecordDoubleClickEventArgs } from '@hoyui/grids';
import { RowSelectingEventArgs as GridRowSelectingEventArgs } from '@hoyui/grids';
import { CellSelectingEventArgs as GridCellSelectingEventArgs } from '@hoyui/grids';
import { RowDeselectEventArgs as GridRowDeselectEventArgs } from '@hoyui/grids';
import {
  RowSelectEventArgs as GridRowSelectEventArgs,
  RowDataBoundEventArgs as GridRowDataBoundEventArgs,
} from '@hoyui/grids';
 ...
 */
export interface BeforeTooltipRenderEventArgsData
  extends IGanttData,
    PredecessorTooltip {}
...
export interface ContextMenuClickEventArgs
  extends GridContextMenuClickEventArgs {
  /** Defines the selected row record */
  rowData?: IGanttData;
  /** Defines the context menu type */
  type?: ContextMenuType;
...
export interface ActionCompleteArgs
  extends ZoomEventArgs,
...
export interface RecordDoubleClickEventArgs
  extends GridRecordDoubleClickEventArgs {
  /** Defines the row element. */
  row?: Element;
  /** Defines the data of record. */
  rowData?: IGanttData;
