...
import { attributes, prepend, isVisible, append, addClass } from '@hoyui/base';
import { compile } from '@hoyui/base';
...
export namespace ListBase {
  ...
  export function createListFromArray(
    ...
    const subChild: HTMLElement[] = createListItemFromArray(
      createElement,
      dataSource,
      isSingleLevel,
      options,
  ...
  export function createListItemFromJson(
    ...
    const curOpt: ListBaseOptions = extend({}, defaultListBaseOptions, options);
    cssClass = getModuleClass(curOpt.moduleName);
    const fields: FieldsMapping =
      componentInstance &&
      (componentInstance.getModuleName() === 'listview' ||
        componentInstance.getModuleName() === 'multiselect')
        ? curOpt.fields
        : extend({}, defaultMappedFields, curOpt.fields);
    const ariaAttributes: AriaAttributesMapping = extend(
      {},
      defaultAriaAttributes,
      curOpt.ariaAttributes
    ...
    if (
      dataSource &&
      dataSource.length &&
      !isNullOrUndefined(typeofData(dataSource).item) &&
      !Object.prototype.hasOwnProperty.call(
        typeofData(dataSource).item,
        fields.id
      )
    ) {
    ...
    for (let i: number = 0; i < dataSource.length; i++) {
      let fieldData: { [key: string]: Object } = <{ [key: string]: Object }>(
        getFieldValues(dataSource[i as number], fields)
      );
      if (isNullOrUndefined(dataSource[i as number])) {
        continue;
      }
      ...
      if (
        Object.prototype.hasOwnProperty.call(fieldData, fields.id) &&
      ...
      if (curOpt.showCheckBox) {
        if (
          curOpt.itemNavigable &&
          (fieldData[fields.url] || fieldData[fields.urlAttributes])
        ) {
      ...
      if (isSingleLevel === true) {
        if (
          curOpt.showIcon &&
          Object.prototype.hasOwnProperty.call(fieldData, fields.iconCss) &&
          !isNullOrUndefined(fieldData[fields.iconCss])
        ) {
          innerEle.push(
            createElement('span', {
              className:
                cssClass.icon + ' ' + <string>fieldData[fields.iconCss],
            })
          );
        }
        li = generateSingleLevelLI(
          ...
          Object.prototype.hasOwnProperty.call(curItem, 'isHeader') &&
            (curItem as { isHeader: Object } & { [key: string]: Object })
              .isHeader
            ? true
            : false,
          id,
        ...
        if (
          ...
          ariaAttributes.itemRole === 'presentation'
        ) {
        ...
        if (Object.prototype.hasOwnProperty.call(fieldData, fields.tooltip)) {
          ...
          if (options && options.enableHtmlSanitizer) {
            ...
            let tooltipTextElement: HTMLElement = createElement('span', {
        ...
        if (
          ...
          fieldData[fields.htmlAttributes]
        ) {
          ...
          if (
            'class' in htmlAttributes &&
            typeof htmlAttributes['class'] === 'string' &&
            htmlAttributes['class'].trim() === ''
          ) {
        ...
        if (
          Object.prototype.hasOwnProperty.call(fieldData, fields.enabled) &&
          fieldData[fields.enabled] === false
        ) {
          li.classList.add(cssClass.disabled);
        }
        if (
          Object.prototype.hasOwnProperty.call(fieldData, fields.isVisible) &&
          fieldData[fields.isVisible] === false
        ) {
          li.style.display = 'none';
        }
        if (
          Object.prototype.hasOwnProperty.call(fieldData, fields.imageUrl) &&
          !isNullOrUndefined(fieldData[fields.imageUrl]) &&
          !curOpt.template
        ) {
          const attr: { [key: string]: string } = {
            src: <string>fieldData[fields.imageUrl],
            alt: !isNullOrUndefined(<string>fieldData.name)
              ? 'Displaying ' + <string>fieldData.name + ' Image'
              : 'Displaying Image',
          };
          merge(attr, fieldData[fields.imageAttributes]);
          const imageElemnt: HTMLElement = createElement('img', {
        ...
        if (
          ...
          const iconElement: HTMLElement = createElement('div', {
            className: cssClass.icon + ' ' + <string>fieldData[fields.iconCss],
          });
          if (anchorElement) {
  ...
  export function createListFromJson(
    ...
    const curOpt: ListBaseOptions = extend({}, defaultListBaseOptions, options);
    const li: HTMLElement[] = createListItemFromJson(
      createElement,
      dataSource,
      options,
      level,
   ...
   */
  export function getSiblingLI(
    elementArray: Element[] | NodeList,
    element: Element,
    isPrevious?: boolean
  ): Element {
    ...
    while (
      siblingLI &&
      (!isVisible(siblingLI) || siblingLI.classList.contains(cssClass.disabled))
    ) {
  ...
  export function groupDataSource(
    ...
    for (let j: number = 0; j < ds.length; j++) {
      const itemObj: { [key: string]: Object }[] = (
        ds[j as number] as { items: { [key: string]: Object }[] } & {
          [key: string]: Object;
        }
      ).items;
      const grpItem: { [key: string]: Object } = {};
      const hdr: string = 'isHeader';
      grpItem[curFields.text] = (
        ds[j as number] as { key: string } & { [key: string]: Object }
      ).key;
      grpItem[`${hdr}`] = true;
      ...
      grpItem._id =
        'group-list-item-' +
        ((ds[j as number] as { [key: string]: Object }).key
          ? (ds[j as number] as { [key: string]: Object }).key.toString().trim()
          : 'undefined');
  ...
  export function getDataSource(
    ...
    return <{ [key: string]: Object }[]>(
      new DataManager(<{ [key: string]: Object }[]>dataSource).executeLocal(
        query
      )
    );
  }
  ...
  export function createJsonFromElement(
    ...
    const curOpt: ListBaseOptions = extend({}, defaultListBaseOptions, options);
    const fields: FieldsMapping = extend(
      {},
      defaultMappedFields,
      curOpt.fields
    );
    ...
    const childs: HTMLElement[] = <HTMLElement[] & NodeListOf<HTMLElement>>(
      curEle.querySelectorAll('.json-parent>li')
    );
  ...
  function typeofData(
    ...
    let match: { [key: string]: Object } = <{ [key: string]: Object }>{
      typeof: null,
      item: null,
    };
    for (let i: number = 0; i < data.length; i++) {
      if (!isNullOrUndefined(data[i as number])) {
        return (match = {
          typeof: typeof data[i as number],
          item: data[i as number],
        });
      }
    }
    return match;
  ...
  function getAllAttributes(element: HTMLElement): { [key: string]: string } {
    ...
    for (let index: number = 0; index < attr.length; index++) {
      attributes[attr[index as number].nodeName] =
        attr[index as number].nodeValue;
    }
    return attributes;
  }
  ...
  export function renderContentTemplate(
    ...
    for (let i: number = 0; i < dataSource.length; i++) {
      let fieldData: { [key: string]: Object } = <{ [key: string]: Object }>(
        getFieldValues(dataSource[i as number], curFields)
      );
      const curItem: { [key: string]: Object } | string | number =
        dataSource[i as number];
      const isHeader: Object = (
        curItem as { isHeader: Object } & { [key: string]: Object }
      ).isHeader;
      if (
        typeof dataSource[i as number] === 'string' ||
        typeof dataSource[i as number] === 'number'
      ) {
      ...
      if (isHeader) {
        ...
        const currentID: string = isHeader
  ...
  function processSubChild(
    ...
    // Get SubList
    const subDS: { [key: string]: Object }[] =
      <{ [key: string]: Object }[]>fieldData[fields.child] || [];
    ...
    if (subDS.length) {
      ...
      if (options.processSubChild) {
        const subLi: HTMLElement = <HTMLElement>(
          createListFromJson(createElement, subDS, options, ++level)
        );
    ...
    if (!!options.expandCollapse && hasChildren && !options.template) {
      ...
      const expandElement: Function =
        options.expandIconPosition === 'Left' ? prepend : append;
      expandElement(
        [
          createElement('div', {
  ...
  function generateSingleLevelLI(
    createElement: createElementParams,
    item: string | { [key: string]: Object } | number,
    fieldData: { [key: string]: Object },
    fields?: FieldsMapping,
    className?: string,
    ...
    if (
      ...
      text =
        typeof fieldData[fields.text] === 'boolean' ||
        typeof fieldData[fields.text] === 'number'
          ? <string>fieldData[fields.text]
          : <string>fieldData[fields.text] || '';
    ...
    const li: HTMLElement = createElement('li', {
      className:
        (grpLI === true ? cssClass.group : cssClass.li) +
        ' ' +
        (isNullOrUndefined(className) ? '' : className),
      id: elementID,
      attrs:
        ariaAttributes.groupItemRole !== '' && ariaAttributes.itemRole !== ''
          ? {
              role:
                grpLI === true
                  ? ariaAttributes.groupItemRole
                  : ariaAttributes.itemRole,
            }
          : {},
    });
    if (
      dataSource &&
      Object.prototype.hasOwnProperty.call(fieldData, fields.enabled) &&
      fieldData[fields.enabled].toString() === 'false'
    ) {
      li.classList.add(cssClass.disabled);
    }
    if (grpLI) {
      ...
      if (
        ...
        setAttribute(
          li,
          <{ [key: string]: string }>fieldData[fields.htmlAttributes]
        );
      }
      ...
      if (
        ...
        (fieldData[fields.url] ||
          (fieldData[fields.urlAttributes] &&
            (fieldData[fields.urlAttributes] as { [key: string]: Object })
              .href))
      ) {
        li.appendChild(
          anchorTag(
  ...
  function anchorTag(
    createElement: createElementParams,
    dataSource: { [key: string]: object } | { [key: string]: string },
    fields: FieldsMapping,
    text: string,
    innerElements: HTMLElement[],
    isFullNavigation: boolean
  ): HTMLElement {
    const fieldData: { [key: string]: Object } = <{ [key: string]: Object }>(
      getFieldValues(dataSource, fields)
    );
    const attr: { [key: string]: string } = {
      href: <string>fieldData[fields.url],
    };
    if (
      Object.prototype.hasOwnProperty.call(fieldData, fields.urlAttributes) &&
      fieldData[fields.urlAttributes]
    ) {
      merge(attr, fieldData[fields.urlAttributes]);
      attr.href = <string>fieldData[fields.url]
        ? <string>fieldData[fields.url]
        : ((fieldData[fields.urlAttributes] as { [key: string]: Object })
            .href as string);
    }
    ...
    if (!isFullNavigation) {
      ...
      const anchorWrapper: HTMLElement = createElement('div', {
  ...
  function generateLI(
    ...
    if (typeof item !== 'string' && typeof item !== 'number') {
      ...
      uID = isNullOrUndefined(<string>fieldData['_id'])
        ? <string>fieldData[fields.id]
        : <string>fieldData['_id'];
      grpLI =
        Object.prototype.hasOwnProperty.call(item, 'isHeader') &&
        (item as { isHeader: Object } & { [key: string]: Object }).isHeader
          ? true
          : false;
    }
    if (options && options.enableHtmlSanitizer) {
  ...
  export function generateUL(
    ...
    const ulElement: HTMLElement = createElement('ul', {
      className:
        cssClass.ul + ' ' + (isNullOrUndefined(className) ? '' : className),
      attrs:
        ariaAttributes.listRole !== '' ? { role: ariaAttributes.listRole } : {},
    });
  ...
  export function generateIcon(
    ...
    cssClass = getModuleClass(curOpt.moduleName);
    const expandElement: Function =
      curOpt.expandIconPosition === 'Left' ? prepend : append;
    expandElement(
      [
        createElement('div', {
          className:
            'e-icons ' +
            curOpt.expandIconClass +
            ' ' +
            (isNullOrUndefined(className) ? '' : className),
        }),
      ],
...
export function getFieldValues(
  dataItem: { [key: string]: Object } | string | number,
  fields: FieldsMapping
): { [key: string]: Object } | string | number {
  const fieldData: { [key: string]: Object } = {};
  if (
    isNullOrUndefined(dataItem) ||
    ...
    for (const field of Object.keys(fields)) {
      const dataField: string = (<{ [key: string]: Object }>fields)[
        `${field}`
      ] as string;
      const value: { [key: string]: Object } =
        !isNullOrUndefined(dataField) && typeof dataField === 'string'
          ? getValue(dataField, dataItem)
          : undefined;
