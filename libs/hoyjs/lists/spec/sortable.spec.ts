...
describe('Sortable', () => {
  ...
  describe('DOM', () => {
    ...
    it('Default - without item class', () => {
      ...
      expect(
        element.firstElementChild.classList.contains('e-sort-item')
      ).toBeTruthy();
    });
    it('Default - with item class', () => {
      ...
      expect(
        element.firstElementChild.classList.contains('e-item')
      ).toBeTruthy();
  ...
  describe('Property - callback functions', () => {
    ...
    it('helper', () => {
      ...
      sortable.helper = (args: any): HTMLElement => {
        (args.sender as HTMLElement).style.width =
    ...
    it('placeHolder', () => {
      sortable = new Sortable(element, {
        itemClass: 'e-item',
        dragStart: dragStartEvent,
        placeHolder: (args: any): HTMLElement => {
          (args.target as HTMLElement).style.width =
            args.element.offsetWidth + 'px';
          expect(args.element).toEqual(sortable.element);
  ...
  describe('Combined sortable', () => {
    ...
    it('With empty sortable', () => {
      ...
      let sortable2: any = new Sortable(element2, {
        itemClass: 'e-item2',
        scope: 'combined',
      });
    ...
    it('Drop - without placeholder', () => {
      sortable = new Sortable(element, {
        drop: (args: any) => {
          ...
          expect(args.helper).toEqual(
            element.querySelector('.e-sortableclone')
          );
  ...
  describe('onPropertyChanged', () => {
    it('itemClass', () => {
      ...
      expect(
        element.firstElementChild.classList.contains('new-item')
      ).toBeTruthy();
      sortable.itemClass = '';
      sortable.dataBind();
      expect(
